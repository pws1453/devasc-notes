...
class RtSum(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.RtSum")

    meta.moClassName = "hcbgpRtSum"
    meta.rnFormat = "rtsum-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 52242, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "attrmap", "attrmap", 52231, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 52230, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("as-set", "generate-as-set-information", 1)
    prop._addConstant("summary-only", "do-not-advertise-more-specifics", 2)
