...
# ##################################################
class RsBgpPeerTohcl3RoutedIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcbgp.RsBgpPeerTohcl3RoutedIf", "cobra.model.hcl3.RoutedIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hcbgpRsBgpPeerTohcl3RoutedIf"
    meta.rnFormat = "rsbgpPeerTohcl3RoutedIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "relation to routed interface that bgppeer uses"
    ...
    meta.rnPrefixes = [
        ('rsbgpPeerTohcl3RoutedIf', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51602, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51603, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51261, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14861
    prop.defaultValueStr = "hcl3RoutedIf"
    prop._addConstant("hcl3RoutedIf", None, 14861)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51260, PropCategory.REGULAR)
