...
# ##################################################
class RsBgpPeerTolbRoutedIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcbgp.RsBgpPeerTolbRoutedIf", "cobra.model.hcl3.LoopbackRoutedIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcbgpRsBgpPeerTolbRoutedIf"
    meta.rnFormat = "rsbgpPeerTolbRoutedIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "relation to loopback interface that bgppeer uses"
    ...
    meta.rnPrefixes = [
        ('rsbgpPeerTolbRoutedIf', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51598, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51599, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51267, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14865
    prop.defaultValueStr = "hcl3LoopbackRoutedIf"
    prop._addConstant("hcl3LoopbackRoutedIf", None, 14865)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51266, PropCategory.REGULAR)
