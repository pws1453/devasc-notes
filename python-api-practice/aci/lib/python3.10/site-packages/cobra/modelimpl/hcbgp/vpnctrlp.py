...
class VpnCtrlP(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.VpnCtrlP")

    meta.moClassName = "hcbgpVpnCtrlP"
    ...
    meta.childClasses.add("cobra.model.hcbgp.RtP")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.RtP", "rtp-"))
    ...
    prop = PropMeta("str", "type", "type", 50733, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
