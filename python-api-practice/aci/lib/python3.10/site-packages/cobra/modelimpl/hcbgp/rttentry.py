...
class RttEntry(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.RttEntry")

    meta.moClassName = "hcbgpRttEntry"
    ...
    meta.parentClasses.add("cobra.model.hcbgp.RtP")
    ...
    prop = PropMeta("str", "rtt", "rtt", 50233, PropCategory.REGULAR)
