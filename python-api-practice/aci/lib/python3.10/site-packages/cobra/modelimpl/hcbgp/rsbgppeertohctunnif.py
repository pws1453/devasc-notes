...
# ##################################################
class RsBgpPeerTohctunnIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcbgp.RsBgpPeerTohctunnIf", "cobra.model.hctunn.If")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hcbgpRsBgpPeerTohctunnIf"
    meta.rnFormat = "rsbgpPeerTohctunnIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "relation to tunnel interface that bgppeer uses"
    ...
    meta.rnPrefixes = [
        ('rsbgpPeerTohctunnIf', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51600, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51601, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51264, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51263, PropCategory.REGULAR)
