...
class DomAf(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.DomAf")

    meta.moClassName = "hcbgpDomAf"
    ...
    meta.childClasses.add("cobra.model.hcbgp.RtSum")
    meta.childClasses.add("cobra.model.hcbgp.VpnCtrlP")
    meta.childClasses.add("cobra.model.hcbgp.PfxLeakP")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.PfxLeakP", "pfxleak-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.RtSum", "rtsum-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.VpnCtrlP", "ctrl-"))
    ...
    prop = PropMeta("str", "type", "type", 50728, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
