...
class PfxLeakP(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.PfxLeakP")

    meta.moClassName = "hcbgpPfxLeakP"
    meta.rnFormat = "pfxleak-[%(pfx)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Prefix Route Leak Policy"
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 20931, PropCategory.REGULAR)
    prop.label = "Control"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("skip-rib-check", "skip-rib-route-check", 1)
    ...
    prop = PropMeta("str", "pfx", "pfx", 50730, PropCategory.REGULAR)
    prop.label = "Prefix"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "scope", "scope", 20686, PropCategory.REGULAR)
    prop.label = "Scope"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4
    prop.defaultValueStr = "pfx"
