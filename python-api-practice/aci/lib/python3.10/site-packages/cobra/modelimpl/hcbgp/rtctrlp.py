...
class RtCtrlP(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.RtCtrlP")

    meta.moClassName = "hcbgpRtCtrlP"
    ...
    meta.parentClasses.add("cobra.model.hcbgp.PeerAf")
    ...
    prop = PropMeta("str", "direction", "direction", 50731, PropCategory.REGULAR)
