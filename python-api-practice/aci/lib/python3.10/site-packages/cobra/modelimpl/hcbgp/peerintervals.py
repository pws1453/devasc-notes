...
# ##################################################
class PeerIntervals(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcbgp.PeerIntervals")

    meta.moClassName = "hcbgpPeerIntervals"
    meta.rnFormat = "peerintervals"
    meta.category = MoCategory.REGULAR
    meta.label = "Configured peer hold and keepalive intervals"
    ...
    prop = PropMeta("str", "holdIntvl", "holdIntvl", 50227, PropCategory.REGULAR)
    prop.label = "Configured Peer Hold Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "kaIntvl", "kaIntvl", 50228, PropCategory.REGULAR)
    prop.label = "Configured Peer Keepalive Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 3600)]
