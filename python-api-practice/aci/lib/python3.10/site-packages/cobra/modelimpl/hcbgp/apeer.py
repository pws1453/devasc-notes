...
# ##################################################
class APeer(Mo):
    meta = ClassMeta("cobra.model.hcbgp.APeer")

    meta.isAbstract = True
    meta.moClassName = "hcbgpAPeer"


    meta.moClassName = "hcbgpAPeer"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud BGP Peer super"
    ...
    prop = PropMeta("str", "addr", "addr", 55272, PropCategory.REGULAR)
    prop.label = "Address"
