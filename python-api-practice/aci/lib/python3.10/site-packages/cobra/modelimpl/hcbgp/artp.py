...
# ##################################################
class ARtP(Mo):
    meta = ClassMeta("cobra.model.hcbgp.ARtP")

    meta.isAbstract = True
    meta.moClassName = "hcbgpARtP"
    ...
    meta.concreteSubClasses.add("cobra.model.hcbgp.RtP")
    ...
    prop = PropMeta("str", "type", "type", 50232, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
