...
class PeerAf(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.PeerAf")

    meta.moClassName = "hcbgpPeerAf"
    meta.rnFormat = "af-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Peer Address Family"
    ...
    meta.childClasses.add("cobra.model.hcbgp.RtCtrlP")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.RtCtrlP", "rtctrl-"))
    ...
    meta.superClasses.add("cobra.model.hcbgp.Af")
    ...
    prop = PropMeta("str", "allowedSelfAsCnt", "allowedSelfAsCnt", 50230, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 50229, PropCategory.REGULAR)
    prop.label = "Control"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 50729, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "weight", "weight", 50231, PropCategory.REGULAR)
