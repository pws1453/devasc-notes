...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.Entity")

    meta.moClassName = "hcbgpEntity"
    meta.rnFormat = "bgp"
    meta.category = MoCategory.REGULAR
    meta.label = "Hybrid Cloud BGP Entity"
    ...
    meta.childClasses.add("cobra.model.hcbgp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.Inst", "inst"))
