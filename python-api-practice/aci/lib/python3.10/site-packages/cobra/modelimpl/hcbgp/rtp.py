...
class RtP(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.RtP")

    meta.moClassName = "hcbgpRtP"
    meta.rnFormat = "rtp-%(type)s"
    ...
    meta.childClasses.add("cobra.model.hcbgp.RttEntry")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.RttEntry", "ent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.hcbgp.VpnCtrlP")

    meta.superClasses.add("cobra.model.pol.Instr")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.hcbgp.ARtP")
    ...
    prop = PropMeta("str", "type", "type", 50732, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
