...
# ##################################################
class VmmFaultConfig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflexp.VmmFaultConfig")

    meta.moClassName = "opflexpVmmFaultConfig"
    meta.rnFormat = "vmmfault-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete class to collect vleaf issues from vPOD AVE"
    ...
    prop = PropMeta("str", "handle", "handle", 44511, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 44513, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
