...
class IpAddr(Mo):
    ...
    meta = ClassMeta("cobra.model.opflexp.IpAddr")

    meta.moClassName = "opflexpIpAddr"
    ...
    meta.parentClasses.add("cobra.model.opflexp.Ep")
    ...
    prop = PropMeta("str", "addr", "addr", 54608, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
