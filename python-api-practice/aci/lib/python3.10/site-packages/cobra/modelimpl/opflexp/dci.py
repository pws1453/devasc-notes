...
class Dci(Mo):
    """
      Dirty hack to pass around the DCI peer loopback IP to functions that take a Dn 

    """

    meta = ClassMeta("cobra.model.opflexp.Dci")

    meta.moClassName = "opflexpDci"
    meta.rnFormat = "dci-[%(ip)s]"
    ...
    prop = PropMeta("str", "ip", "ip", 25519, PropCategory.REGULAR)
    prop.label = "BGP peer loopback IP address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
