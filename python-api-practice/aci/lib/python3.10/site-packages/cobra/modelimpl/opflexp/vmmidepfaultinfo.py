...
# ##################################################
class VmmIDEpFaultInfo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflexp.VmmIDEpFaultInfo")

    meta.moClassName = "opflexpVmmIDEpFaultInfo"
    meta.rnFormat = "vmmidepfault-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete class to raise faults for IDEp Issues in vPOD AVE"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44520, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 44514, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
