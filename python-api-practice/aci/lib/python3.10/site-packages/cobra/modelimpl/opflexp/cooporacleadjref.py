...
# ##################################################
class CoopOracleAdjRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflexp.CoopOracleAdjRef")

    meta.moClassName = "opflexpCoopOracleAdjRef"
    meta.rnFormat = "oracleadj-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 50049, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 50053, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 50051, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 50054, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "grTime", "grTime", 50052, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "helloIntvl", "helloIntvl", 50050, PropCategory.REGULAR)
