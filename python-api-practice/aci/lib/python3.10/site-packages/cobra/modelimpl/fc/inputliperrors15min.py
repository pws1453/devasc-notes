...
# ##################################################
class InputLIPErrors15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrors15min", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrors15min"
    meta.rnFormat = "CDfcInputLIPErrors15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input lip errors stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fc.InputLIPErrors")

    meta.rnPrefixes = [
        ('CDfcInputLIPErrors15min', False),
    ]
