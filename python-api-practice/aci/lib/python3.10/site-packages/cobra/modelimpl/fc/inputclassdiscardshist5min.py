...
# ##################################################
class InputClassDiscardsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist5min", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist5min"
    meta.rnFormat = "HDfcInputClassDiscards5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDfcInputClassDiscards5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42791, PropCategory.REGULAR)
