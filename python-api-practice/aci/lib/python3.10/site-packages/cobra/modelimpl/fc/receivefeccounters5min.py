...
# ##################################################
class ReceiveFecCounters5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters5min", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters5min"
    meta.rnFormat = "CDfcReceiveFecCounters5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDfcReceiveFecCounters5min', False),
    ]
