...
class PinningP(Mo):
    ...
    meta = ClassMeta("cobra.model.fc.PinningP")

    meta.moClassName = "fcPinningP"
    meta.rnFormat = "pinningp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Fibre Channel Uplink Pinning Group Profile"
    ...
    meta.childClasses.add("cobra.model.fc.RsPinToPath")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fc.RsPinToPath", "rspinToPath-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38500, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40639, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 25995, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
