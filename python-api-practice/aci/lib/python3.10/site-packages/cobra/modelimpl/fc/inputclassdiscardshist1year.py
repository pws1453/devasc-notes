...
# ##################################################
class InputClassDiscardsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist1year", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist1year"
    meta.rnFormat = "HDfcInputClassDiscards1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDfcInputClassDiscards1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42790, PropCategory.REGULAR)
