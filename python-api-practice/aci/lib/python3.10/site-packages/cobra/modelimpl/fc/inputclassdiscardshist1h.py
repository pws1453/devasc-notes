...
# ##################################################
class InputClassDiscardsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist1h", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist1h"
    meta.rnFormat = "HDfcInputClassDiscards1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 42786, PropCategory.REGULAR)
