...
# ##################################################
class InputFramesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFramesHist15min", "input frames")
    ...
    meta.moClassName = "fcInputFramesHist15min"
    meta.rnFormat = "HDfcInputFrames15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input frames stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fc.InputFramesHist")

    meta.rnPrefixes = [
        ('HDfcInputFrames15min-', True),
    ]
    ...
    prop = PropMeta("str", "class2Avg", "class2Avg", 41425, PropCategory.IMPLICIT_AVG)
    prop.label = "input class2 frames average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Avg", prop)

    prop = PropMeta("str", "class2Cum", "class2Cum", 41421, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input class2 frames cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Cum", prop)

    prop = PropMeta("str", "class2Max", "class2Max", 41424, PropCategory.IMPLICIT_MAX)
    prop.label = "input class2 frames maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Max", prop)

    prop = PropMeta("str", "class2Min", "class2Min", 41423, PropCategory.IMPLICIT_MIN)
    prop.label = "input class2 frames minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Min", prop)

    prop = PropMeta("str", "class2Per", "class2Per", 41422, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input class2 frames periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Per", prop)

    prop = PropMeta("str", "class2Rate", "class2Rate", 41429, PropCategory.IMPLICIT_RATE)
    prop.label = "input class2 frames rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Rate", prop)

    prop = PropMeta("str", "class2Spct", "class2Spct", 41426, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input class2 frames suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Spct", prop)

    prop = PropMeta("str", "class2Thr", "class2Thr", 41427, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "class2Tr", "class2Tr", 41428, PropCategory.IMPLICIT_TREND)
    prop.label = "input class2 frames trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class2Tr", prop)

    prop = PropMeta("str", "class3Avg", "class3Avg", 41446, PropCategory.IMPLICIT_AVG)
    prop.label = "input class3 frames average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Avg", prop)

    prop = PropMeta("str", "class3Cum", "class3Cum", 41442, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input class3 frames cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Cum", prop)

    prop = PropMeta("str", "class3Max", "class3Max", 41445, PropCategory.IMPLICIT_MAX)
    prop.label = "input class3 frames maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Max", prop)

    prop = PropMeta("str", "class3Min", "class3Min", 41444, PropCategory.IMPLICIT_MIN)
    prop.label = "input class3 frames minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Min", prop)

    prop = PropMeta("str", "class3Per", "class3Per", 41443, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input class3 frames periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Per", prop)

    prop = PropMeta("str", "class3Rate", "class3Rate", 41450, PropCategory.IMPLICIT_RATE)
    prop.label = "input class3 frames rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Rate", prop)

    prop = PropMeta("str", "class3Spct", "class3Spct", 41447, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input class3 frames suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Spct", prop)

    prop = PropMeta("str", "class3Thr", "class3Thr", 41448, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "class3Tr", "class3Tr", 41449, PropCategory.IMPLICIT_TREND)
    prop.label = "input class3 frames trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("class3Tr", prop)

    prop = PropMeta("str", "classfAvg", "classfAvg", 41467, PropCategory.IMPLICIT_AVG)
    prop.label = "input classf frames average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("classfAvg", prop)

    prop = PropMeta("str", "classfCum", "classfCum", 41463, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input classf frames cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("classfCum", prop)

    prop = PropMeta("str", "classfMax", "classfMax", 41466, PropCategory.IMPLICIT_MAX)
    prop.label = "input classf frames maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("classfMax", prop)

    prop = PropMeta("str", "classfMin", "classfMin", 41465, PropCategory.IMPLICIT_MIN)
    prop.label = "input classf frames minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("classfMin", prop)

    prop = PropMeta("str", "classfPer", "classfPer", 41464, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input classf frames periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("classfPer", prop)

    prop = PropMeta("str", "classfRate", "classfRate", 41471, PropCategory.IMPLICIT_RATE)
    prop.label = "input classf frames rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("classfRate", prop)

    prop = PropMeta("str", "classfSpct", "classfSpct", 41468, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input classf frames suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("classfSpct", prop)

    prop = PropMeta("str", "classfThr", "classfThr", 41469, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "classfTr", "classfTr", 41470, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "index", "index", 41157, PropCategory.REGULAR)
