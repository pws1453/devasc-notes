...
# ##################################################
class InputLIPErrorsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrorsHist5min", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrorsHist5min"
    meta.rnFormat = "HDfcInputLIPErrors5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input lip errors stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 42807, PropCategory.REGULAR)
