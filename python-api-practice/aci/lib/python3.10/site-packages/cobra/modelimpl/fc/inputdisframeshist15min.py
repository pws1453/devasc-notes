...
# ##################################################
class InputDisFramesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist15min", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist15min"
    meta.rnFormat = "HDfcInputDisFrames15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fc.InputDisFramesHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDfcInputDisFrames15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 41149, PropCategory.REGULAR)
