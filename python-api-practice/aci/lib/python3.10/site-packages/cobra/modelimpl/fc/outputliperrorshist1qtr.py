...
# ##################################################
class OutputLIPErrorsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist1qtr", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist1qtr"
    meta.rnFormat = "HDfcOutputLIPErrors1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 42828, PropCategory.REGULAR)
