...
class RtFcIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fc.RtFcIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "fcRtFcIfPol"
    meta.rnFormat = "rtinfraFcIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26316, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26315, PropCategory.REGULAR)
