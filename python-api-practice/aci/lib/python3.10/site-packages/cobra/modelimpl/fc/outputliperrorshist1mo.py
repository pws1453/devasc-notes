...
# ##################################################
class OutputLIPErrorsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist1mo", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist1mo"
    meta.rnFormat = "HDfcOutputLIPErrors1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 42827, PropCategory.REGULAR)
