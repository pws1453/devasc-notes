...
# ##################################################
class InputClassDiscards1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards1d", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards1d"
    meta.rnFormat = "CDfcInputClassDiscards1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDfcInputClassDiscards1d', False),
    ]
