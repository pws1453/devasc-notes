...
# ##################################################
class InputOtherErrorsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist1qtr", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist1qtr"
    meta.rnFormat = "HDfcInputOtherErrors1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 42812, PropCategory.REGULAR)
