...
class DomP(Mo):
    ...
    meta = ClassMeta("cobra.model.fc.DomP")

    meta.moClassName = "fcDomP"
    meta.rnFormat = "fc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "FC Domain"
    meta.writeAccessMask = 0x1800611
    meta.readAccessMask = 0x80384001800613
    ...
    meta.childClasses.add("cobra.model.fc.RsVsanAttrDef")
    meta.childClasses.add("cobra.model.aaa.DomainRef")
    meta.childClasses.add("cobra.model.fc.RsVsanNsDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fc.RsVsanAttrDef", "rsvsanAttrDef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fc.RsVsanNsDef", "rsvsanNsDef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fc.RsVsanAttr", "rsvsanAttr"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.RsVlanNs", "rsvlanNs"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fc.RsVsanNs", "rsvsanNs"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40611, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25398, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 25317, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
