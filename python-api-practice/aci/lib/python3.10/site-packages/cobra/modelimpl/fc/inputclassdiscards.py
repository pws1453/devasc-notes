...
# ##################################################
class InputClassDiscards(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards"


    meta.moClassName = "fcInputClassDiscards"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards1d")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards15min")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards1h")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscards1qtr")
