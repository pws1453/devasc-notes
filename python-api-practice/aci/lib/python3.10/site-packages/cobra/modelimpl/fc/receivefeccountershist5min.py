...
# ##################################################
class ReceiveFecCountersHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist5min", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist5min"
    meta.rnFormat = "HDfcReceiveFecCounters5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDfcReceiveFecCounters5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45165, PropCategory.REGULAR)
