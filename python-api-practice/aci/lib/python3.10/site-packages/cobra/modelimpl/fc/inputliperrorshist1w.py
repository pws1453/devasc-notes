...
# ##################################################
class InputLIPErrorsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrorsHist1w", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrorsHist1w"
    meta.rnFormat = "HDfcInputLIPErrors1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input lip errors stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 42805, PropCategory.REGULAR)
