...
# ##################################################
class InputFramesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFramesHist1year", "input frames")
    ...
    meta.moClassName = "fcInputFramesHist1year"
    meta.rnFormat = "HDfcInputFrames1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input frames stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 41163, PropCategory.REGULAR)
