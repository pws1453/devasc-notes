...
# ##################################################
class InputClassDiscardsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist15min", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist15min"
    meta.rnFormat = "HDfcInputClassDiscards15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fc.InputClassDiscardsHist")

    meta.rnPrefixes = [
        ('HDfcInputClassDiscards15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42784, PropCategory.REGULAR)
