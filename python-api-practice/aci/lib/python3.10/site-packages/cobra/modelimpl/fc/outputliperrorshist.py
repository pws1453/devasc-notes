...
# ##################################################
class OutputLIPErrorsHist(Mo):
    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist"


    meta.moClassName = "fcOutputLIPErrorsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist1mo")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist1d")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist15min")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist5min")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist1h")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist1w")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrorsHist1year")
    ...
    prop = PropMeta("str", "f8LipErrorAvg", "f8LipErrorAvg", 43373, PropCategory.IMPLICIT_AVG)
    prop.label = "output f8 lip error average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorAvg", prop)

    prop = PropMeta("str", "f8LipErrorCum", "f8LipErrorCum", 43369, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "output f8 lip error cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorCum", prop)

    prop = PropMeta("str", "f8LipErrorMax", "f8LipErrorMax", 43372, PropCategory.IMPLICIT_MAX)
    prop.label = "output f8 lip error maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorMax", prop)

    prop = PropMeta("str", "f8LipErrorMin", "f8LipErrorMin", 43371, PropCategory.IMPLICIT_MIN)
    prop.label = "output f8 lip error minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorMin", prop)

    prop = PropMeta("str", "f8LipErrorPer", "f8LipErrorPer", 43370, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "output f8 lip error periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorPer", prop)

    prop = PropMeta("str", "f8LipErrorRate", "f8LipErrorRate", 43377, PropCategory.IMPLICIT_RATE)
    prop.label = "output f8 lip error rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorRate", prop)

    prop = PropMeta("str", "f8LipErrorSpct", "f8LipErrorSpct", 43374, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "output f8 lip error suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorSpct", prop)

    prop = PropMeta("str", "f8LipErrorThr", "f8LipErrorThr", 43375, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "f8LipErrorTr", "f8LipErrorTr", 43376, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "nonf8LipErrorAvg", "nonf8LipErrorAvg", 43394, PropCategory.IMPLICIT_AVG)
    prop.label = "output non f8 lip error average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorAvg", prop)

    prop = PropMeta("str", "nonf8LipErrorCum", "nonf8LipErrorCum", 43390, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "output non f8 lip error cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorCum", prop)

    prop = PropMeta("str", "nonf8LipErrorMax", "nonf8LipErrorMax", 43393, PropCategory.IMPLICIT_MAX)
    prop.label = "output non f8 lip error maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorMax", prop)

    prop = PropMeta("str", "nonf8LipErrorMin", "nonf8LipErrorMin", 43392, PropCategory.IMPLICIT_MIN)
    prop.label = "output non f8 lip error minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorMin", prop)

    prop = PropMeta("str", "nonf8LipErrorPer", "nonf8LipErrorPer", 43391, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "output non f8 lip error periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorPer", prop)

    prop = PropMeta("str", "nonf8LipErrorRate", "nonf8LipErrorRate", 43398, PropCategory.IMPLICIT_RATE)
    prop.label = "output non f8 lip error rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorRate", prop)

    prop = PropMeta("str", "nonf8LipErrorSpct", "nonf8LipErrorSpct", 43395, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "output non f8 lip error suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorSpct", prop)

    prop = PropMeta("str", "nonf8LipErrorThr", "nonf8LipErrorThr", 43396, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "nonf8LipErrorTr", "nonf8LipErrorTr", 43397, PropCategory.IMPLICIT_TREND)
