...
# ##################################################
class InputDisFramesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist1d", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist1d"
    meta.rnFormat = "HDfcInputDisFrames1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 41150, PropCategory.REGULAR)
