...
# ##################################################
class InputDisFramesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist1qtr", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist1qtr"
    meta.rnFormat = "HDfcInputDisFrames1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 41153, PropCategory.REGULAR)
