...
# ##################################################
class InputFrames5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFrames5min", "input frames")
    ...
    meta.moClassName = "fcInputFrames5min"
    meta.rnFormat = "CDfcInputFrames5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats in 5 minute"
