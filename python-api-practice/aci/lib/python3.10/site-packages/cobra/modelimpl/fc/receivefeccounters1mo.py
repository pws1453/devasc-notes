...
# ##################################################
class ReceiveFecCounters1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters1mo", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters1mo"
    meta.rnFormat = "CDfcReceiveFecCounters1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDfcReceiveFecCounters1mo', False),
    ]
