...
# ##################################################
class InputDisFramesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist1mo", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist1mo"
    meta.rnFormat = "HDfcInputDisFrames1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 41152, PropCategory.REGULAR)
