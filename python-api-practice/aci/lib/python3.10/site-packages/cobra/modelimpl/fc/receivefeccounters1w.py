...
# ##################################################
class ReceiveFecCounters1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters1w", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters1w"
    meta.rnFormat = "CDfcReceiveFecCounters1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDfcReceiveFecCounters1w', False),
    ]
