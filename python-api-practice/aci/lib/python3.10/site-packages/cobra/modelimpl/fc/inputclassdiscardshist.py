...
# ##################################################
class InputClassDiscardsHist(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist"


    meta.moClassName = "fcInputClassDiscardsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist1d")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist1h")
    meta.concreteSubClasses.add("cobra.model.fc.InputClassDiscardsHist15min")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "c2DiscardsAvg", "c2DiscardsAvg", 42995, PropCategory.IMPLICIT_AVG)
    prop.label = "input class2 discards average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsAvg", prop)

    prop = PropMeta("str", "c2DiscardsCum", "c2DiscardsCum", 42991, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input class2 discards cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsCum", prop)

    prop = PropMeta("str", "c2DiscardsMax", "c2DiscardsMax", 42994, PropCategory.IMPLICIT_MAX)
    prop.label = "input class2 discards maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsMax", prop)

    prop = PropMeta("str", "c2DiscardsMin", "c2DiscardsMin", 42993, PropCategory.IMPLICIT_MIN)
    prop.label = "input class2 discards minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsMin", prop)

    prop = PropMeta("str", "c2DiscardsPer", "c2DiscardsPer", 42992, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input class2 discards periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsPer", prop)

    prop = PropMeta("str", "c2DiscardsRate", "c2DiscardsRate", 42999, PropCategory.IMPLICIT_RATE)
    prop.label = "input class2 discards rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsRate", prop)

    prop = PropMeta("str", "c2DiscardsSpct", "c2DiscardsSpct", 42996, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input class2 discards suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsSpct", prop)

    prop = PropMeta("str", "c2DiscardsThr", "c2DiscardsThr", 42997, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "c2DiscardsTr", "c2DiscardsTr", 42998, PropCategory.IMPLICIT_TREND)
    prop.label = "input class2 discards trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c2DiscardsTr", prop)

    prop = PropMeta("str", "c3DiscardsAvg", "c3DiscardsAvg", 43016, PropCategory.IMPLICIT_AVG)
    prop.label = "input class3 discards average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsAvg", prop)

    prop = PropMeta("str", "c3DiscardsCum", "c3DiscardsCum", 43012, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input class3 discards cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsCum", prop)

    prop = PropMeta("str", "c3DiscardsMax", "c3DiscardsMax", 43015, PropCategory.IMPLICIT_MAX)
    prop.label = "input class3 discards maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsMax", prop)

    prop = PropMeta("str", "c3DiscardsMin", "c3DiscardsMin", 43014, PropCategory.IMPLICIT_MIN)
    prop.label = "input class3 discards minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsMin", prop)

    prop = PropMeta("str", "c3DiscardsPer", "c3DiscardsPer", 43013, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input class3 discards periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsPer", prop)

    prop = PropMeta("str", "c3DiscardsRate", "c3DiscardsRate", 43020, PropCategory.IMPLICIT_RATE)
    prop.label = "input class3 discards rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsRate", prop)

    prop = PropMeta("str", "c3DiscardsSpct", "c3DiscardsSpct", 43017, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input class3 discards suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsSpct", prop)

    prop = PropMeta("str", "c3DiscardsThr", "c3DiscardsThr", 43018, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "c3DiscardsTr", "c3DiscardsTr", 43019, PropCategory.IMPLICIT_TREND)
    prop.label = "input class3 discards trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("c3DiscardsTr", prop)

    prop = PropMeta("str", "cfDiscardsAvg", "cfDiscardsAvg", 43037, PropCategory.IMPLICIT_AVG)
    prop.label = "input classf discards average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cfDiscardsAvg", prop)

    prop = PropMeta("str", "cfDiscardsCum", "cfDiscardsCum", 43033, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input classf discards cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cfDiscardsCum", prop)

    prop = PropMeta("str", "cfDiscardsMax", "cfDiscardsMax", 43036, PropCategory.IMPLICIT_MAX)
    prop.label = "input classf discards maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cfDiscardsMax", prop)

    prop = PropMeta("str", "cfDiscardsMin", "cfDiscardsMin", 43035, PropCategory.IMPLICIT_MIN)
    prop.label = "input classf discards minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cfDiscardsMin", prop)

    prop = PropMeta("str", "cfDiscardsPer", "cfDiscardsPer", 43034, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input classf discards periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cfDiscardsPer", prop)

    prop = PropMeta("str", "cfDiscardsRate", "cfDiscardsRate", 43041, PropCategory.IMPLICIT_RATE)
    prop.label = "input classf discards rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cfDiscardsRate", prop)

    prop = PropMeta("str", "cfDiscardsSpct", "cfDiscardsSpct", 43038, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input classf discards suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cfDiscardsSpct", prop)

    prop = PropMeta("str", "cfDiscardsThr", "cfDiscardsThr", 43039, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "cfDiscardsTr", "cfDiscardsTr", 43040, PropCategory.IMPLICIT_TREND)
