...
# ##################################################
class RsDefPinToPath(Mo):
    """
     Represents uplink interfaces 

    """

    meta = SourceRelationMeta("cobra.model.fc.RsDefPinToPath", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fcRsDefPinToPath"
    meta.rnFormat = "rsdefPinToPath-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26042, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26041, PropCategory.REGULAR)
