...
# ##################################################
class OutputLIPErrorsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist1d", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist1d"
    meta.rnFormat = "HDfcOutputLIPErrors1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 42825, PropCategory.REGULAR)
