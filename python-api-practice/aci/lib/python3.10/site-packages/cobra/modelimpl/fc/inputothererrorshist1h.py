...
# ##################################################
class InputOtherErrorsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist1h", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist1h"
    meta.rnFormat = "HDfcInputOtherErrors1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 42810, PropCategory.REGULAR)
