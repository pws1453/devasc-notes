...
# ##################################################
class OutputLIPErrors1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors1h", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors1h"
    meta.rnFormat = "CDfcOutputLIPErrors1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats in 1 hour"
