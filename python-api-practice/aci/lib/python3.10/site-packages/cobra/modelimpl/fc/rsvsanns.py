...
class RsVsanNs(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fc.RsVsanNs", "cobra.model.fvns.VsanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fcRsVsanNs"
    meta.rnFormat = "rsvsanNs"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VSAN Pool"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38510, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40649, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26074, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26071, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8785
    prop.defaultValueStr = "fvnsVsanInstP"
    prop._addConstant("fvnsVsanInstP", None, 8785)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26070, PropCategory.REGULAR)
