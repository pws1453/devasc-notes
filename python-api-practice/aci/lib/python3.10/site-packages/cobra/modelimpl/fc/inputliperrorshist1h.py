...
# ##################################################
class InputLIPErrorsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrorsHist1h", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrorsHist1h"
    meta.rnFormat = "HDfcInputLIPErrors1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input lip errors stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 42802, PropCategory.REGULAR)
