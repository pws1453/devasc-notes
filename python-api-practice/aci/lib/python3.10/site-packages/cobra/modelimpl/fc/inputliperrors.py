...
# ##################################################
class InputLIPErrors(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputLIPErrors", "input lip errors")

    counter = CounterMeta("fragmentedFrames", CounterCategory.COUNTER, "link", "fragmented frames")
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "fragmentedFramesLast"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "fragmentedFramesBase"
    counter._propRefs[PropCategory.IMPLICIT_THRESHOLDED] = "fragmentedFramesThr"
    counter._propRefs[PropCategory.IMPLICIT_TREND_BASE] = "fragmentedFramesTrBase"
    ...
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "eofAbortsLast"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "eofAbortsBase"
    counter._propRefs[PropCategory.IMPLICIT_THRESHOLDED] = "eofAbortsThr"
    counter._propRefs[PropCategory.IMPLICIT_TREND_BASE] = "eofAbortsTrBase"
    ...
    meta.moClassName = "fcInputLIPErrors"


    meta.moClassName = "fcInputLIPErrors"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input lip errors stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors15min")
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors1h")
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputLIPErrors1d")
    ...
    prop = PropMeta("str", "eofAbortsAvg", "eofAbortsAvg", 43132, PropCategory.IMPLICIT_AVG)
    prop.label = "input eof aborts average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsAvg", prop)

    prop = PropMeta("str", "eofAbortsBase", "eofAbortsBase", 43127, PropCategory.IMPLICIT_BASELINE)
    prop.label = "input eof aborts baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsBase", prop)

    prop = PropMeta("str", "eofAbortsCum", "eofAbortsCum", 43128, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input eof aborts cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsCum", prop)

    prop = PropMeta("str", "eofAbortsLast", "eofAbortsLast", 43126, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "input eof aborts current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsLast", prop)

    prop = PropMeta("str", "eofAbortsMax", "eofAbortsMax", 43131, PropCategory.IMPLICIT_MAX)
    prop.label = "input eof aborts maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsMax", prop)

    prop = PropMeta("str", "eofAbortsMin", "eofAbortsMin", 43130, PropCategory.IMPLICIT_MIN)
    prop.label = "input eof aborts minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsMin", prop)

    prop = PropMeta("str", "eofAbortsPer", "eofAbortsPer", 43129, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input eof aborts periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsPer", prop)

    prop = PropMeta("str", "eofAbortsRate", "eofAbortsRate", 43137, PropCategory.IMPLICIT_RATE)
    prop.label = "input eof aborts rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsRate", prop)

    prop = PropMeta("str", "eofAbortsSpct", "eofAbortsSpct", 43133, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input eof aborts suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsSpct", prop)

    prop = PropMeta("str", "eofAbortsThr", "eofAbortsThr", 43134, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "eofAbortsTr", "eofAbortsTr", 43136, PropCategory.IMPLICIT_TREND)
    prop.label = "input eof aborts trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsTr", prop)

    prop = PropMeta("str", "eofAbortsTrBase", "eofAbortsTrBase", 43135, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "input eof aborts trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("eofAbortsTrBase", prop)

    prop = PropMeta("str", "f8LipErrorAvg", "f8LipErrorAvg", 43153, PropCategory.IMPLICIT_AVG)
    prop.label = "input f8 lip error average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorAvg", prop)

    prop = PropMeta("str", "f8LipErrorBase", "f8LipErrorBase", 43148, PropCategory.IMPLICIT_BASELINE)
    prop.label = "input f8 lip error baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorBase", prop)

    prop = PropMeta("str", "f8LipErrorCum", "f8LipErrorCum", 43149, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input f8 lip error cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorCum", prop)

    prop = PropMeta("str", "f8LipErrorLast", "f8LipErrorLast", 43147, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "input f8 lip error current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorLast", prop)

    prop = PropMeta("str", "f8LipErrorMax", "f8LipErrorMax", 43152, PropCategory.IMPLICIT_MAX)
    prop.label = "input f8 lip error maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorMax", prop)

    prop = PropMeta("str", "f8LipErrorMin", "f8LipErrorMin", 43151, PropCategory.IMPLICIT_MIN)
    prop.label = "input f8 lip error minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorMin", prop)

    prop = PropMeta("str", "f8LipErrorPer", "f8LipErrorPer", 43150, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input f8 lip error periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorPer", prop)

    prop = PropMeta("str", "f8LipErrorRate", "f8LipErrorRate", 43158, PropCategory.IMPLICIT_RATE)
    prop.label = "input f8 lip error rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorRate", prop)

    prop = PropMeta("str", "f8LipErrorSpct", "f8LipErrorSpct", 43154, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input f8 lip error suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorSpct", prop)

    prop = PropMeta("str", "f8LipErrorThr", "f8LipErrorThr", 43155, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "f8LipErrorTr", "f8LipErrorTr", 43157, PropCategory.IMPLICIT_TREND)
    prop.label = "input f8 lip error trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorTr", prop)

    prop = PropMeta("str", "f8LipErrorTrBase", "f8LipErrorTrBase", 43156, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "input f8 lip error trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("f8LipErrorTrBase", prop)

    prop = PropMeta("str", "fragmentedFramesAvg", "fragmentedFramesAvg", 43174, PropCategory.IMPLICIT_AVG)
    prop.label = "fragmented frames average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesAvg", prop)

    prop = PropMeta("str", "fragmentedFramesBase", "fragmentedFramesBase", 43169, PropCategory.IMPLICIT_BASELINE)
    prop.label = "fragmented frames baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesBase", prop)

    prop = PropMeta("str", "fragmentedFramesCum", "fragmentedFramesCum", 43170, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "fragmented frames cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesCum", prop)

    prop = PropMeta("str", "fragmentedFramesLast", "fragmentedFramesLast", 43168, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "fragmented frames current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesLast", prop)

    prop = PropMeta("str", "fragmentedFramesMax", "fragmentedFramesMax", 43173, PropCategory.IMPLICIT_MAX)
    prop.label = "fragmented frames maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesMax", prop)

    prop = PropMeta("str", "fragmentedFramesMin", "fragmentedFramesMin", 43172, PropCategory.IMPLICIT_MIN)
    prop.label = "fragmented frames minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesMin", prop)

    prop = PropMeta("str", "fragmentedFramesPer", "fragmentedFramesPer", 43171, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "fragmented frames periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesPer", prop)

    prop = PropMeta("str", "fragmentedFramesRate", "fragmentedFramesRate", 43179, PropCategory.IMPLICIT_RATE)
    prop.label = "fragmented frames rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesRate", prop)

    prop = PropMeta("str", "fragmentedFramesSpct", "fragmentedFramesSpct", 43175, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "fragmented frames suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesSpct", prop)

    prop = PropMeta("str", "fragmentedFramesThr", "fragmentedFramesThr", 43176, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fragmentedFramesTr", "fragmentedFramesTr", 43178, PropCategory.IMPLICIT_TREND)
    prop.label = "fragmented frames trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesTr", prop)

    prop = PropMeta("str", "fragmentedFramesTrBase", "fragmentedFramesTrBase", 43177, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "fragmented frames trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fragmentedFramesTrBase", prop)
    ...
    prop = PropMeta("str", "nonf8LipErrorAvg", "nonf8LipErrorAvg", 43195, PropCategory.IMPLICIT_AVG)
    prop.label = "input non f8 lip error average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorAvg", prop)

    prop = PropMeta("str", "nonf8LipErrorBase", "nonf8LipErrorBase", 43190, PropCategory.IMPLICIT_BASELINE)
    prop.label = "input non f8 lip error baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorBase", prop)

    prop = PropMeta("str", "nonf8LipErrorCum", "nonf8LipErrorCum", 43191, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input non f8 lip error cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorCum", prop)

    prop = PropMeta("str", "nonf8LipErrorLast", "nonf8LipErrorLast", 43189, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "input non f8 lip error current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorLast", prop)

    prop = PropMeta("str", "nonf8LipErrorMax", "nonf8LipErrorMax", 43194, PropCategory.IMPLICIT_MAX)
    prop.label = "input non f8 lip error maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorMax", prop)

    prop = PropMeta("str", "nonf8LipErrorMin", "nonf8LipErrorMin", 43193, PropCategory.IMPLICIT_MIN)
    prop.label = "input non f8 lip error minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorMin", prop)

    prop = PropMeta("str", "nonf8LipErrorPer", "nonf8LipErrorPer", 43192, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input non f8 lip error periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorPer", prop)

    prop = PropMeta("str", "nonf8LipErrorRate", "nonf8LipErrorRate", 43200, PropCategory.IMPLICIT_RATE)
    prop.label = "input non f8 lip error rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorRate", prop)

    prop = PropMeta("str", "nonf8LipErrorSpct", "nonf8LipErrorSpct", 43196, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input non f8 lip error suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorSpct", prop)

    prop = PropMeta("str", "nonf8LipErrorThr", "nonf8LipErrorThr", 43197, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "nonf8LipErrorTr", "nonf8LipErrorTr", 43199, PropCategory.IMPLICIT_TREND)
    prop.label = "input non f8 lip error trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("nonf8LipErrorTr", prop)

    prop = PropMeta("str", "nonf8LipErrorTrBase", "nonf8LipErrorTrBase", 43198, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "input non f8 lip error trend baseline"
    prop.isOper = True
    prop.isStats = True
