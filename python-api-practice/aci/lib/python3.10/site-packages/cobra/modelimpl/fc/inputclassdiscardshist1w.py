...
# ##################################################
class InputClassDiscardsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist1w", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist1w"
    meta.rnFormat = "HDfcInputClassDiscards1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 42789, PropCategory.REGULAR)
