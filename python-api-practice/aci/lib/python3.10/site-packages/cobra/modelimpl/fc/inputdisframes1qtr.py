...
# ##################################################
class InputDisFrames1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFrames1qtr", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames1qtr"
    meta.rnFormat = "CDfcInputDisFrames1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats in 1 quarter"
