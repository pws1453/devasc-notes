...
# ##################################################
class InputDisFramesHist(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist"


    meta.moClassName = "fcInputDisFramesHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist15min")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist1h")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFramesHist1d")
    ...
    prop = PropMeta("str", "crcAvg", "crcAvg", 41362, PropCategory.IMPLICIT_AVG)
    prop.label = "input crc frames average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcAvg", prop)

    prop = PropMeta("str", "crcCum", "crcCum", 41358, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input crc frames cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcCum", prop)

    prop = PropMeta("str", "crcMax", "crcMax", 41361, PropCategory.IMPLICIT_MAX)
    prop.label = "input crc frames maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcMax", prop)

    prop = PropMeta("str", "crcMin", "crcMin", 41360, PropCategory.IMPLICIT_MIN)
    prop.label = "input crc frames minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcMin", prop)

    prop = PropMeta("str", "crcPer", "crcPer", 41359, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input crc frames periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcPer", prop)

    prop = PropMeta("str", "crcRate", "crcRate", 41366, PropCategory.IMPLICIT_RATE)
    prop.label = "input crc frames rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcRate", prop)

    prop = PropMeta("str", "crcSpct", "crcSpct", 41363, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input crc frames suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcSpct", prop)

    prop = PropMeta("str", "crcThr", "crcThr", 41364, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "crcTr", "crcTr", 41365, PropCategory.IMPLICIT_TREND)
    prop.label = "input crc frames trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("crcTr", prop)

    prop = PropMeta("str", "discardsAvg", "discardsAvg", 41383, PropCategory.IMPLICIT_AVG)
    prop.label = "input discards frames average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("discardsAvg", prop)

    prop = PropMeta("str", "discardsCum", "discardsCum", 41379, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input discards frames cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("discardsCum", prop)

    prop = PropMeta("str", "discardsMax", "discardsMax", 41382, PropCategory.IMPLICIT_MAX)
    prop.label = "input discards frames maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("discardsMax", prop)

    prop = PropMeta("str", "discardsMin", "discardsMin", 41381, PropCategory.IMPLICIT_MIN)
    prop.label = "input discards frames minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("discardsMin", prop)

    prop = PropMeta("str", "discardsPer", "discardsPer", 41380, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input discards frames periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("discardsPer", prop)

    prop = PropMeta("str", "discardsRate", "discardsRate", 41387, PropCategory.IMPLICIT_RATE)
    prop.label = "input discards frames rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("discardsRate", prop)

    prop = PropMeta("str", "discardsSpct", "discardsSpct", 41384, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input discards frames suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("discardsSpct", prop)

    prop = PropMeta("str", "discardsThr", "discardsThr", 41385, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "discardsTr", "discardsTr", 41386, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "errorsAvg", "errorsAvg", 41404, PropCategory.IMPLICIT_AVG)
    prop.label = "input errors frames average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("errorsAvg", prop)

    prop = PropMeta("str", "errorsCum", "errorsCum", 41400, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "input errors frames cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("errorsCum", prop)

    prop = PropMeta("str", "errorsMax", "errorsMax", 41403, PropCategory.IMPLICIT_MAX)
    prop.label = "input errors frames maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("errorsMax", prop)

    prop = PropMeta("str", "errorsMin", "errorsMin", 41402, PropCategory.IMPLICIT_MIN)
    prop.label = "input errors frames minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("errorsMin", prop)

    prop = PropMeta("str", "errorsPer", "errorsPer", 41401, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "input errors frames periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("errorsPer", prop)

    prop = PropMeta("str", "errorsRate", "errorsRate", 41408, PropCategory.IMPLICIT_RATE)
    prop.label = "input errors frames rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("errorsRate", prop)

    prop = PropMeta("str", "errorsSpct", "errorsSpct", 41405, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "input errors frames suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("errorsSpct", prop)

    prop = PropMeta("str", "errorsThr", "errorsThr", 41406, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "errorsTr", "errorsTr", 41407, PropCategory.IMPLICIT_TREND)
