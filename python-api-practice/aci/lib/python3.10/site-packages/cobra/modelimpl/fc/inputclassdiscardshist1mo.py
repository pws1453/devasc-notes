...
# ##################################################
class InputClassDiscardsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist1mo", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist1mo"
    meta.rnFormat = "HDfcInputClassDiscards1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDfcInputClassDiscards1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42787, PropCategory.REGULAR)
