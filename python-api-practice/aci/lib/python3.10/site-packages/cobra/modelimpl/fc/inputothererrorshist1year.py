...
# ##################################################
class InputOtherErrorsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist1year", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist1year"
    meta.rnFormat = "HDfcInputOtherErrors1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDfcInputOtherErrors1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42814, PropCategory.REGULAR)
