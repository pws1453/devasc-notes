...
# ##################################################
class ReceiveFecCounters(Mo):
    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters"


    meta.moClassName = "fcReceiveFecCounters"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters1h")
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters1year")
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters1d")
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters15min")
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters1mo")
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters5min")
    meta.concreteSubClasses.add("cobra.model.fc.ReceiveFecCounters1w")
