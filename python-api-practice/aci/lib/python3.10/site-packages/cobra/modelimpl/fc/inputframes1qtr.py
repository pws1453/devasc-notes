...
# ##################################################
class InputFrames1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFrames1qtr", "input frames")
    ...
    meta.moClassName = "fcInputFrames1qtr"
    meta.rnFormat = "CDfcInputFrames1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats in 1 quarter"
