...
# ##################################################
class InputClassDiscards1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards1w", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards1w"
    meta.rnFormat = "CDfcInputClassDiscards1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDfcInputClassDiscards1w', False),
    ]
