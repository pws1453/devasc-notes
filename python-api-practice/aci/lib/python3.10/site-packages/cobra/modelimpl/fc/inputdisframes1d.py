...
# ##################################################
class InputDisFrames1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFrames1d", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames1d"
    meta.rnFormat = "CDfcInputDisFrames1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats in 1 day"
