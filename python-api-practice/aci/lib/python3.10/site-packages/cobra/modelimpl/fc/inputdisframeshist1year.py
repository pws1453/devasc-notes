...
# ##################################################
class InputDisFramesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist1year", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist1year"
    meta.rnFormat = "HDfcInputDisFrames1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 41155, PropCategory.REGULAR)
