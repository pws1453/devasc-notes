...
# ##################################################
class ReceiveFecCounters1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters1qtr", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters1qtr"
    meta.rnFormat = "CDfcReceiveFecCounters1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDfcReceiveFecCounters1qtr', False),
    ]
