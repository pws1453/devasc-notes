...
# ##################################################
class InputFramesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFramesHist5min", "input frames")
    ...
    meta.moClassName = "fcInputFramesHist5min"
    meta.rnFormat = "HDfcInputFrames5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input frames stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 41164, PropCategory.REGULAR)
