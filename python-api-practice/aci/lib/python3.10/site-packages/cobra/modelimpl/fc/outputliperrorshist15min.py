...
# ##################################################
class OutputLIPErrorsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist15min", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist15min"
    meta.rnFormat = "HDfcOutputLIPErrors15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fc.OutputLIPErrorsHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDfcOutputLIPErrors15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42824, PropCategory.REGULAR)
