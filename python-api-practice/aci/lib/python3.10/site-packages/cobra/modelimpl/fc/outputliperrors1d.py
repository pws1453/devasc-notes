...
# ##################################################
class OutputLIPErrors1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors1d", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors1d"
    meta.rnFormat = "CDfcOutputLIPErrors1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats in 1 day"
