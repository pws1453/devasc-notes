...
class RsVsanAttr(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fc.RsVsanAttr", "cobra.model.fc.VsanAttrP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fcRsVsanAttr"
    meta.rnFormat = "rsvsanAttr"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VSAN Attributes"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38473, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40612, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25391, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8737
    prop.defaultValueStr = "fcVsanAttrP"
    prop._addConstant("fcVsanAttrP", None, 8737)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25390, PropCategory.REGULAR)
