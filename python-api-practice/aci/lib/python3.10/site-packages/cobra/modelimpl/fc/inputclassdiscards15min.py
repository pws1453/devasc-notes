...
# ##################################################
class InputClassDiscards15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards15min", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards15min"
    meta.rnFormat = "CDfcInputClassDiscards15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDfcInputClassDiscards15min', False),
    ]
