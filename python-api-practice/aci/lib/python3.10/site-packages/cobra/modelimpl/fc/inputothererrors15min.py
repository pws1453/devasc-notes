...
# ##################################################
class InputOtherErrors15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors15min", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors15min"
    meta.rnFormat = "CDfcInputOtherErrors15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDfcInputOtherErrors15min', False),
    ]
