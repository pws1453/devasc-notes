...
# ##################################################
class ReceiveFecCountersHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist1d", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist1d"
    meta.rnFormat = "HDfcReceiveFecCounters1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 45159, PropCategory.REGULAR)
