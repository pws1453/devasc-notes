...
# ##################################################
class ReceiveFecCountersHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist1qtr", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist1qtr"
    meta.rnFormat = "HDfcReceiveFecCounters1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDfcReceiveFecCounters1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45162, PropCategory.REGULAR)
