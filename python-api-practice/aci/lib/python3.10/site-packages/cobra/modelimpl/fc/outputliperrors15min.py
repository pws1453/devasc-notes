...
# ##################################################
class OutputLIPErrors15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors15min", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors15min"
    meta.rnFormat = "CDfcOutputLIPErrors15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDfcOutputLIPErrors15min', False),
    ]
