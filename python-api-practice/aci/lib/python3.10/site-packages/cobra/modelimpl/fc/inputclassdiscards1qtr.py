...
# ##################################################
class InputClassDiscards1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards1qtr", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards1qtr"
    meta.rnFormat = "CDfcInputClassDiscards1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDfcInputClassDiscards1qtr', False),
    ]
