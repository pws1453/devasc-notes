...
# ##################################################
class InputOtherErrorsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist15min", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist15min"
    meta.rnFormat = "HDfcInputOtherErrors15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDfcInputOtherErrors15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42808, PropCategory.REGULAR)
