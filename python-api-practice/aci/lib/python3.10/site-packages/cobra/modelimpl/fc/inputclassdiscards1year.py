...
# ##################################################
class InputClassDiscards1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards1year", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards1year"
    meta.rnFormat = "CDfcInputClassDiscards1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDfcInputClassDiscards1year', False),
    ]
