...
# ##################################################
class InputLIPErrorsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrorsHist1mo", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrorsHist1mo"
    meta.rnFormat = "HDfcInputLIPErrors1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input lip errors stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 42803, PropCategory.REGULAR)
