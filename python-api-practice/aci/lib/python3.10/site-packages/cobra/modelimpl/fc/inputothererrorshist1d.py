...
# ##################################################
class InputOtherErrorsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist1d", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist1d"
    meta.rnFormat = "HDfcInputOtherErrors1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 42809, PropCategory.REGULAR)
