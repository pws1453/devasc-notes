...
# ##################################################
class InputOtherErrors1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors1qtr", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors1qtr"
    meta.rnFormat = "CDfcInputOtherErrors1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDfcInputOtherErrors1qtr', False),
    ]
