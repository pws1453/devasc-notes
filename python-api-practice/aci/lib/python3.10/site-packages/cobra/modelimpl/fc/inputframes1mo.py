...
# ##################################################
class InputFrames1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFrames1mo", "input frames")
    ...
    meta.moClassName = "fcInputFrames1mo"
    meta.rnFormat = "CDfcInputFrames1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats in 1 month"
