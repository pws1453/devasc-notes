...
# ##################################################
class OutputLIPErrorsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist1year", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist1year"
    meta.rnFormat = "HDfcOutputLIPErrors1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 42830, PropCategory.REGULAR)
