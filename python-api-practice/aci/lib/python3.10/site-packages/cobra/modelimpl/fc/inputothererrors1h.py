...
# ##################################################
class InputOtherErrors1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors1h", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors1h"
    meta.rnFormat = "CDfcInputOtherErrors1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats in 1 hour"
