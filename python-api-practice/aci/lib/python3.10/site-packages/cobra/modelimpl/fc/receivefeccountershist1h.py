...
# ##################################################
class ReceiveFecCountersHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist1h", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist1h"
    meta.rnFormat = "HDfcReceiveFecCounters1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 45160, PropCategory.REGULAR)
