...
# ##################################################
class RsPinToPath(Mo):
    """
     Represents uplink interfaces 

    """

    meta = SourceRelationMeta("cobra.model.fc.RsPinToPath", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fcRsPinToPath"
    meta.rnFormat = "rspinToPath-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Pinned Path"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38501, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40640, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 26038, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26037, PropCategory.REGULAR)
