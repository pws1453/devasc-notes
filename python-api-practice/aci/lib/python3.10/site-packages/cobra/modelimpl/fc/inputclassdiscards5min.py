...
# ##################################################
class InputClassDiscards5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards5min", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards5min"
    meta.rnFormat = "CDfcInputClassDiscards5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDfcInputClassDiscards5min', False),
    ]
