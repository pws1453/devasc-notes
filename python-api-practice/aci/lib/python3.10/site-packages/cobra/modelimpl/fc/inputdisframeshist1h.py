...
# ##################################################
class InputDisFramesHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist1h", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist1h"
    meta.rnFormat = "HDfcInputDisFrames1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 41151, PropCategory.REGULAR)
