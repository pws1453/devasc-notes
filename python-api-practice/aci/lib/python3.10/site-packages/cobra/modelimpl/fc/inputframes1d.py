...
# ##################################################
class InputFrames1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFrames1d", "input frames")
    ...
    meta.moClassName = "fcInputFrames1d"
    meta.rnFormat = "CDfcInputFrames1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats in 1 day"
