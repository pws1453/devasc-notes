...
# ##################################################
class InputLIPErrorsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrorsHist15min", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrorsHist15min"
    meta.rnFormat = "HDfcInputLIPErrors15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input lip errors stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 42800, PropCategory.REGULAR)
