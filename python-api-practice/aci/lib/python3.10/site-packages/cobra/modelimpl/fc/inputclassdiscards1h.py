...
# ##################################################
class InputClassDiscards1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscards1h", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscards1h"
    meta.rnFormat = "CDfcInputClassDiscards1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input class discards stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDfcInputClassDiscards1h', False),
    ]
