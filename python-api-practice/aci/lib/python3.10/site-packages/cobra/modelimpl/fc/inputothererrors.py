...
# ##################################################
class InputOtherErrors(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors"


    meta.moClassName = "fcInputOtherErrors"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors15min")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors1d")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors1h")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrors1qtr")
