...
# ##################################################
class RsVsanNsDef(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fc.RsVsanNsDef", "cobra.model.fvns.AVsanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fcRsVsanNsDef"
    meta.rnFormat = "rsvsanNsDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Unresolvable Relation to VSAN Pool"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26073, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8784
    prop.defaultValueStr = "fvnsAVsanInstP"
    prop._addConstant("fvnsAVsanInstP", None, 8784)
    prop._addConstant("fvnsVsanInstP", None, 8785)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26072, PropCategory.REGULAR)
