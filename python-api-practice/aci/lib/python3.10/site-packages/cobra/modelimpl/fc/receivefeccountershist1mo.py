...
# ##################################################
class ReceiveFecCountersHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist1mo", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist1mo"
    meta.rnFormat = "HDfcReceiveFecCounters1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDfcReceiveFecCounters1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45161, PropCategory.REGULAR)
