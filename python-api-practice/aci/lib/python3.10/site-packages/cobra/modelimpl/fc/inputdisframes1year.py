...
# ##################################################
class InputDisFrames1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFrames1year", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames1year"
    meta.rnFormat = "CDfcInputDisFrames1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats in 1 year"
