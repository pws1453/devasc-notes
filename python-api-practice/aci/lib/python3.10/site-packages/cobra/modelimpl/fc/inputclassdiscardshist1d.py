...
# ##################################################
class InputClassDiscardsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist1d", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist1d"
    meta.rnFormat = "HDfcInputClassDiscards1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 42785, PropCategory.REGULAR)
