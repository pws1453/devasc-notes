...
# ##################################################
class InputDisFrames(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputDisFrames", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames"


    meta.moClassName = "fcInputDisFrames"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames15min")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames1d")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputDisFrames1h")
