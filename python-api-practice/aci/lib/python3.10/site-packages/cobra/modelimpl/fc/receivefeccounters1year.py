...
# ##################################################
class ReceiveFecCounters1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters1year", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters1year"
    meta.rnFormat = "CDfcReceiveFecCounters1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDfcReceiveFecCounters1year', False),
    ]
