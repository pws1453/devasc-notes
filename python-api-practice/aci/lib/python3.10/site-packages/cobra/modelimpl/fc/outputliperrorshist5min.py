...
# ##################################################
class OutputLIPErrorsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist5min", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist5min"
    meta.rnFormat = "HDfcOutputLIPErrors5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 42831, PropCategory.REGULAR)
