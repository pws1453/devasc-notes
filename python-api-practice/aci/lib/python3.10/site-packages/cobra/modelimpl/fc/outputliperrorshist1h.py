...
# ##################################################
class OutputLIPErrorsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist1h", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist1h"
    meta.rnFormat = "HDfcOutputLIPErrors1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 42826, PropCategory.REGULAR)
