...
# ##################################################
class InputFrames1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFrames1year", "input frames")
    ...
    meta.moClassName = "fcInputFrames1year"
    meta.rnFormat = "CDfcInputFrames1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats in 1 year"
