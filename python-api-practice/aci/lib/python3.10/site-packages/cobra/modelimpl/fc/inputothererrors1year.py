...
# ##################################################
class InputOtherErrors1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors1year", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors1year"
    meta.rnFormat = "CDfcInputOtherErrors1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDfcInputOtherErrors1year', False),
    ]
