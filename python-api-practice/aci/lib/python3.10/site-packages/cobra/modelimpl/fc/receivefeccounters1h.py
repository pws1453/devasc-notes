...
# ##################################################
class ReceiveFecCounters1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters1h", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters1h"
    meta.rnFormat = "CDfcReceiveFecCounters1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDfcReceiveFecCounters1h', False),
    ]
