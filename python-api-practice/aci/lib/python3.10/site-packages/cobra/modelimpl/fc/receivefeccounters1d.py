...
# ##################################################
class ReceiveFecCounters1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCounters1d", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCounters1d"
    meta.rnFormat = "CDfcReceiveFecCounters1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Fec counters stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDfcReceiveFecCounters1d', False),
    ]
