...
# ##################################################
class InputClassDiscardsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputClassDiscardsHist1qtr", "input class discards")
    ...
    meta.moClassName = "fcInputClassDiscardsHist1qtr"
    meta.rnFormat = "HDfcInputClassDiscards1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input class discards stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDfcInputClassDiscards1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42788, PropCategory.REGULAR)
