...
# ##################################################
class OutputLIPErrorsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrorsHist1w", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrorsHist1w"
    meta.rnFormat = "HDfcOutputLIPErrors1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Output lip errors stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 42829, PropCategory.REGULAR)
