...
# ##################################################
class InputDisFrames5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFrames5min", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames5min"
    meta.rnFormat = "CDfcInputDisFrames5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats in 5 minute"
