...
# ##################################################
class InputOtherErrorsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist1mo", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist1mo"
    meta.rnFormat = "HDfcInputOtherErrors1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 42811, PropCategory.REGULAR)
