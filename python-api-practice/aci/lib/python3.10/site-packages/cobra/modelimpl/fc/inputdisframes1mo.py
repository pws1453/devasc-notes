...
# ##################################################
class InputDisFrames1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFrames1mo", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames1mo"
    meta.rnFormat = "CDfcInputDisFrames1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats in 1 month"
