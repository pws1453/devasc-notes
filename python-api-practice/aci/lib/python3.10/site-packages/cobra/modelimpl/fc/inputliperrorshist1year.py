...
# ##################################################
class InputLIPErrorsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrorsHist1year", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrorsHist1year"
    meta.rnFormat = "HDfcInputLIPErrors1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input lip errors stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 42806, PropCategory.REGULAR)
