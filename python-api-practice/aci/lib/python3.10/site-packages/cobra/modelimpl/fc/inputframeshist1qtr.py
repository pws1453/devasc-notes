...
# ##################################################
class InputFramesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFramesHist1qtr", "input frames")
    ...
    meta.moClassName = "fcInputFramesHist1qtr"
    meta.rnFormat = "HDfcInputFrames1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input frames stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 41161, PropCategory.REGULAR)
