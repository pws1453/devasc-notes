...
# ##################################################
class InputOtherErrorsHist(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist"


    meta.moClassName = "fcInputOtherErrorsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist1d")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist1h")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist15min")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputOtherErrorsHist1qtr")
