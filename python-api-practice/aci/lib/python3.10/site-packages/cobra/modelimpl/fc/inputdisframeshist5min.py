...
# ##################################################
class InputDisFramesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist5min", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist5min"
    meta.rnFormat = "HDfcInputDisFrames5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 41156, PropCategory.REGULAR)
