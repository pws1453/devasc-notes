...
# ##################################################
class InputDisFrames1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFrames1w", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames1w"
    meta.rnFormat = "CDfcInputDisFrames1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats in 1 week"
