...
# ##################################################
class OutputLIPErrors1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors1year", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors1year"
    meta.rnFormat = "CDfcOutputLIPErrors1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDfcOutputLIPErrors1year', False),
    ]
