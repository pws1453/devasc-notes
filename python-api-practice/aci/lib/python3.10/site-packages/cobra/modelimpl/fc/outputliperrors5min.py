...
# ##################################################
class OutputLIPErrors5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors5min", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors5min"
    meta.rnFormat = "CDfcOutputLIPErrors5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats in 5 minute"
