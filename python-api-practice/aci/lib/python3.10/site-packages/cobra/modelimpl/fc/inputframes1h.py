...
# ##################################################
class InputFrames1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFrames1h", "input frames")
    ...
    meta.moClassName = "fcInputFrames1h"
    meta.rnFormat = "CDfcInputFrames1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats in 1 hour"
