...
# ##################################################
class InputDisFrames15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFrames15min", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFrames15min"
    meta.rnFormat = "CDfcInputDisFrames15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input discards frames stats in 15 minute"
