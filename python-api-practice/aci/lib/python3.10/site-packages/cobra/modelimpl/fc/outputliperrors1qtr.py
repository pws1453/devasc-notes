...
# ##################################################
class OutputLIPErrors1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors1qtr", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors1qtr"
    meta.rnFormat = "CDfcOutputLIPErrors1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats in 1 quarter"
