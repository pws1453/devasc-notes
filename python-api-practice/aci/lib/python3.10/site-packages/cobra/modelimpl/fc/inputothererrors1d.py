...
# ##################################################
class InputOtherErrors1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors1d", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors1d"
    meta.rnFormat = "CDfcInputOtherErrors1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats in 1 day"
