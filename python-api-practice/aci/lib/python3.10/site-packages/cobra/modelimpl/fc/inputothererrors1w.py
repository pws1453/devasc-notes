...
# ##################################################
class InputOtherErrors1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors1w", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors1w"
    meta.rnFormat = "CDfcInputOtherErrors1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats in 1 week"
