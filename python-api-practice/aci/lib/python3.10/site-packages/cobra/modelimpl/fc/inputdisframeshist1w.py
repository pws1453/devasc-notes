...
# ##################################################
class InputDisFramesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputDisFramesHist1w", "input discards frames")
    ...
    meta.moClassName = "fcInputDisFramesHist1w"
    meta.rnFormat = "HDfcInputDisFrames1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input discards frames stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 41154, PropCategory.REGULAR)
