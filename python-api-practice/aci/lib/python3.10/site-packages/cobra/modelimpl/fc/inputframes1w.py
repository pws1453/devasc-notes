...
# ##################################################
class InputFrames1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFrames1w", "input frames")
    ...
    meta.moClassName = "fcInputFrames1w"
    meta.rnFormat = "CDfcInputFrames1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats in 1 week"
