...
# ##################################################
class ReceiveFecCountersHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist15min", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist15min"
    meta.rnFormat = "HDfcReceiveFecCounters15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fc.ReceiveFecCountersHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDfcReceiveFecCounters15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45158, PropCategory.REGULAR)
