...
# ##################################################
class InputLIPErrorsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputLIPErrorsHist1d", "input lip errors")
    ...
    meta.moClassName = "fcInputLIPErrorsHist1d"
    meta.rnFormat = "HDfcInputLIPErrors1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input lip errors stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 42801, PropCategory.REGULAR)
