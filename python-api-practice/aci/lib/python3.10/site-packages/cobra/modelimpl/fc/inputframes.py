...
# ##################################################
class InputFrames(Mo):
    meta = StatsClassMeta("cobra.model.fc.InputFrames", "input frames")
    ...
    meta.moClassName = "fcInputFrames"


    meta.moClassName = "fcInputFrames"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input frames stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames1mo")
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames5min")
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames1w")
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames1h")
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames1year")
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames15min")
    meta.concreteSubClasses.add("cobra.model.fc.InputFrames1d")
