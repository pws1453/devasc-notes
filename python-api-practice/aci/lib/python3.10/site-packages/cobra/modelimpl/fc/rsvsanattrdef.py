...
# ##################################################
class RsVsanAttrDef(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fc.RsVsanAttrDef", "cobra.model.fc.VsanAttrP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fcRsVsanAttrDef"
    meta.rnFormat = "rsvsanAttrDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Unresolvable Relation to VSAN Attributes"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25394, PropCategory.REGULAR)
