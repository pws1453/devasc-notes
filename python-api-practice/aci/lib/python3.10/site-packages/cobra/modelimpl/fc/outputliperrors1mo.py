...
# ##################################################
class OutputLIPErrors1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors1mo", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors1mo"
    meta.rnFormat = "CDfcOutputLIPErrors1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats in 1 month"
