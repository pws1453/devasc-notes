...
# ##################################################
class ReceiveFecCountersHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist1year", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist1year"
    meta.rnFormat = "HDfcReceiveFecCounters1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDfcReceiveFecCounters1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45164, PropCategory.REGULAR)
