...
# ##################################################
class ReceiveFecCountersHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.ReceiveFecCountersHist1w", "Fec counters")
    ...
    meta.moClassName = "fcReceiveFecCountersHist1w"
    meta.rnFormat = "HDfcReceiveFecCounters1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fec counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 45163, PropCategory.REGULAR)
