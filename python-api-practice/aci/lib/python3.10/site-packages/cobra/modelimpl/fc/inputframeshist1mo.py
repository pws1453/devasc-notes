...
# ##################################################
class InputFramesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputFramesHist1mo", "input frames")
    ...
    meta.moClassName = "fcInputFramesHist1mo"
    meta.rnFormat = "HDfcInputFrames1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input frames stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 41160, PropCategory.REGULAR)
