...
# ##################################################
class OutputLIPErrors(Mo):
    meta = StatsClassMeta("cobra.model.fc.OutputLIPErrors", "Output lip errors")
    ...
    meta.moClassName = "fcOutputLIPErrors"


    meta.moClassName = "fcOutputLIPErrors"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Output lip errors stats"
    ...
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors1mo")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors1qtr")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors1year")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors5min")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors1w")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors1h")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors1d")
    meta.concreteSubClasses.add("cobra.model.fc.OutputLIPErrors15min")
