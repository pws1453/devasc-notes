...
# ##################################################
class InputOtherErrors5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrors5min", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrors5min"
    meta.rnFormat = "CDfcInputOtherErrors5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current input other errors stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDfcInputOtherErrors5min', False),
    ]
