...
# ##################################################
class RtToInterfacePolProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtToInterfacePolProfile", "cobra.model.infra.NodeCfg")

    meta.moClassName = "infraRtToInterfacePolProfile"
    meta.rnFormat = "rttoInterfacePolProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22046, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22045, PropCategory.REGULAR)
