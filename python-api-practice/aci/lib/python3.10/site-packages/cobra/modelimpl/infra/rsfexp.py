...
class RsFexp(Mo):
    """
    A source relation to the FEX profile.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFexp", "cobra.model.infra.FexP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsFexp"
    meta.rnFormat = "rsfexp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13138, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4369
    prop.defaultValueStr = "infraFexP"
    prop._addConstant("infraFexP", None, 4369)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13137, PropCategory.REGULAR)
