...
# ##################################################
class ClusterStatsHist1h(Mo):
    """
    A class that represents historical statistics for cluster in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist1h", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist1h"
    meta.rnFormat = "HDinfraClusterStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6624, PropCategory.REGULAR)
