...
# ##################################################
class NodeCfgTask(Mo):
    """
    An internal task object.

    """

    meta = ClassMeta("cobra.model.infra.NodeCfgTask")

    meta.moClassName = "infraNodeCfgTask"
    meta.rnFormat = "infraNodeCfgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5694, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ManageVpcId", "managevpcid", 456)
