...
# ##################################################
class RsMstInstPol(Mo):
    """
    A source relation to a spanning tree protocol policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsMstInstPol", "cobra.model.stp.InstPol")
    meta.targetNameProps["name"] = "tnStpInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMstInstPol"
    meta.rnFormat = "rsmstInstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MST Instance Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37892, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40031, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13189, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnStpInstPolName", "tnStpInstPolName", 13188, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnStpInstPolName", prop)
