...
# ##################################################
class RsOLeafSToAccNodePGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsOLeafSToAccNodePGrp", "cobra.model.infra.AccNodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOLeafSToAccNodePGrp"
    meta.rnFormat = "rsOLeafSToAccNodePGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Node Policy Group"
    ...
    meta.rnPrefixes = [
        ('rsOLeafSToAccNodePGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38509, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40648, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26067, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26058, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4370
    prop.defaultValueStr = "infraAccNodePGrp"
    prop._addConstant("infraAccNodePGrp", None, 4370)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26057, PropCategory.REGULAR)
