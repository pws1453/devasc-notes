...
# ##################################################
class RsSpineCoppProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSpineCoppProfile", "cobra.model.copp.SpineProfile")
    meta.targetNameProps["name"] = "tnCoppSpineProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSpineCoppProfile"
    meta.rnFormat = "rsspineCoppProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "CoPP Profile for Spines"
    ...
    meta.rnPrefixes = [
        ('rsspineCoppProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38664, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40803, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30522, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30519, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10012
    prop.defaultValueStr = "coppSpineProfile"
    ...
    prop = PropMeta("str", "tnCoppSpineProfileName", "tnCoppSpineProfileName", 30543, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCoppSpineProfileName", prop)
