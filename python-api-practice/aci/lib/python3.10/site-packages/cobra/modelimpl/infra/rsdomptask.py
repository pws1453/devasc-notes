...
class RsDomPTask(Mo):
    """
    A task to send physical infrastructure policies from one process to another. This object is generated and used only by internal processes.

    """

    meta = ClassMeta("cobra.model.infra.RsDomPTask")

    meta.moClassName = "infraRsDomPTask"
    meta.rnFormat = "infraRsDomPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5695, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendAttEntityPToVmmDomP", "sendattentityptovmmdomp", 703)
