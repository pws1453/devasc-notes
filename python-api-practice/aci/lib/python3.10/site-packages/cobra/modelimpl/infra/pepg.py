...
class PEPg(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.PEPg")

    meta.moClassName = "infraPEPg"
    meta.rnFormat = "pepg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Function Provider"
    ...
    meta.childClasses.add("cobra.model.dhcp.PEp")
    ...
    meta.childClasses.add("cobra.model.vsvc.ProvLbl")
    ...
    meta.childClasses.add("cobra.model.infra.RsInfraBD")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.RsInfraBD", "rsinfraBD"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.PEp", "dpep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vsvc.ProvLbl", "prov-"))
    ...
    meta.superClasses.add("cobra.model.infra.EPg")
    meta.superClasses.add("cobra.model.pol.Comp")
    meta.superClasses.add("cobra.model.fv.EPg")
    meta.superClasses.add("cobra.model.infra.APEPg")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37881, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40020, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14693, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6657, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
