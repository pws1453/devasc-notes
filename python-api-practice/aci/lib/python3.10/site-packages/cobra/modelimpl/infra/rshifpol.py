...
class RsHIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsHIfPol", "cobra.model.fabric.HIfPol")
    meta.targetNameProps["name"] = "tnFabricHIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsHIfPol"
    meta.rnFormat = "rshIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Host Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37902, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40041, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14724, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13218, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricHIfPolName", "tnFabricHIfPolName", 13217, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricHIfPolName", prop)
