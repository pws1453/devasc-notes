...
class CEPg(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.CEPg")

    meta.moClassName = "infraCEPg"
    meta.rnFormat = "cepg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Client EPg"
    ...
    meta.childClasses.add("cobra.model.dhcp.CEp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.CEp", "dcep-"))
    ...
    meta.superClasses.add("cobra.model.infra.ACEPg")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37882, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40021, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14694, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6619, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
