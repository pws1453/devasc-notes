...
# ##################################################
class RsConnPortS(Mo):
    """
    A source relation to the host connectivity port selector.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsConnPortS", "cobra.model.infra.HConnPortS")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsConnPortS"
    meta.rnFormat = "rsconnPortS-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Interface Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37864, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40003, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14680, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13109, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4299
    prop.defaultValueStr = "infraHConnPortS"
    prop._addConstant("infraHConnPortS", None, 4299)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13108, PropCategory.REGULAR)
