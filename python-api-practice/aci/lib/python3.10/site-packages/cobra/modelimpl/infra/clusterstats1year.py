...
# ##################################################
class ClusterStats1year(Mo):
    """
    A class that represents the most current statistics for cluster in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats1year", "cluster")
    ...
    meta.moClassName = "infraClusterStats1year"
    meta.rnFormat = "CDinfraClusterStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDinfraClusterStats1year', False),
    ]
