...
# ##################################################
class RsToInfraPathS(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToInfraPathS", "cobra.model.fabric.APathS")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsToInfraPathS"
    meta.rnFormat = "rstoInfraPathS-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18186, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18182, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18181, PropCategory.REGULAR)
