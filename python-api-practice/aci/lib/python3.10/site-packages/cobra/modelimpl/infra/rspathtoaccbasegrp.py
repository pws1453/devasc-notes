...
# ##################################################
class RsPathToAccBaseGrp(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.infra.RsPathToAccBaseGrp", "cobra.model.infra.AccBaseGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsPathToAccBaseGrp"
    meta.rnFormat = "rspathToAccBaseGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Base Group"
    ...
    meta.rnPrefixes = [
        ('rspathToAccBaseGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38186, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40325, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18172, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18163, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18162, PropCategory.REGULAR)
