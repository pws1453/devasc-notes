...
class RsAccCardP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsAccCardP", "cobra.model.infra.AccCardP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsAccCardP"
    meta.rnFormat = "rsaccCardP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access Module Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37885, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40024, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14704, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13177, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4366
    prop.defaultValueStr = "infraAccCardP"
    prop._addConstant("infraAccCardP", None, 4366)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13176, PropCategory.REGULAR)
