...
class ClP(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.ClP")

    meta.moClassName = "infraClP"
    meta.rnFormat = "clp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Client Profile"
    ...
    meta.childClasses.add("cobra.model.infra.CEPg")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.dhcp.CRelPg")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.CRelPg", "cdhcp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.CEPg", "cepg-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37928, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40067, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14770, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6621, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
