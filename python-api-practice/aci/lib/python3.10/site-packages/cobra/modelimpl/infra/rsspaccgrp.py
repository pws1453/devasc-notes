...
class RsSpAccGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsSpAccGrp", "cobra.model.infra.SpAccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSpAccGrp"
    meta.rnFormat = "rsspAccGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine Access Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38429, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40568, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24371, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 24356, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24355, PropCategory.REGULAR)
