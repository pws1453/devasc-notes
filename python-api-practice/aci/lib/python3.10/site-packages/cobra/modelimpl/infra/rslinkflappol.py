...
# ##################################################
class RsLinkFlapPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLinkFlapPol", "cobra.model.fabric.LinkFlapPol")
    meta.targetNameProps["name"] = "tnFabricLinkFlapPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLinkFlapPol"
    meta.rnFormat = "rslinkFlapPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Link Flap Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 57472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57473, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57468, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 57464, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricLinkFlapPolName", "tnFabricLinkFlapPolName", 57463, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricLinkFlapPolName", prop)
