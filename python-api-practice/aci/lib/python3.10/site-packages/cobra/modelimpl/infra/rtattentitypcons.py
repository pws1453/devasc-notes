...
# ##################################################
class RtAttEntityPCons(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.infra.RtAttEntityPCons", "cobra.model.l1.EthIf")

    meta.moClassName = "infraRtAttEntityPCons"
    meta.rnFormat = "rtl1AttEntityPCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18274, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18273, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 18280, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
