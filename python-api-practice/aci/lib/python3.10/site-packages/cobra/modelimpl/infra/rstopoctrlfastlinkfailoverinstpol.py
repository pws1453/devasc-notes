...
# ##################################################
class RsTopoctrlFastLinkFailoverInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsTopoctrlFastLinkFailoverInstPol", "cobra.model.topoctrl.FastLinkFailoverInstPol")
    meta.targetNameProps["name"] = "tnTopoctrlFastLinkFailoverInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsTopoctrlFastLinkFailoverInstPol"
    meta.rnFormat = "rstopoctrlFastLinkFailoverInstPol"
    ...
    meta.rnPrefixes = [
        ('rstopoctrlFastLinkFailoverInstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38778, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40917, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTopoctrlFastLinkFailoverInstPolName", "tnTopoctrlFastLinkFailoverInstPolName", 35398, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTopoctrlFastLinkFailoverInstPolName", prop)
