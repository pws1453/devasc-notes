...
class IfLblDef(Mo):
    """
    The tenant/provider's external connection characteristics of the port.

    """

    meta = ClassMeta("cobra.model.infra.IfLblDef")

    meta.moClassName = "infraIfLblDef"
    meta.rnFormat = "ilbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Interface Label"
    ...
    meta.parentClasses.add("cobra.model.infra.NodeLblDef")
    ...
    prop = PropMeta("str", "name", "name", 6645, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
