...
# ##################################################
class ReplicaStatsHist1qtr(Mo):
    """
    A class that represents historical statistics for replica in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ReplicaStatsHist1qtr", "replica")
    ...
    meta.moClassName = "infraReplicaStatsHist1qtr"
    meta.rnFormat = "HDinfraReplicaStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical replica stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6667, PropCategory.REGULAR)
