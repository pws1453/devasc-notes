...
class RsFcLagPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsFcLagPol", "cobra.model.lacp.LagPol")
    meta.targetNameProps["name"] = "tnLacpLagPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsFcLagPol"
    meta.rnFormat = "rsfcLagPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Link Aggregation Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 39195, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40994, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 39180, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 39139, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLacpLagPolName", "tnLacpLagPolName", 39138, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
