...
# ##################################################
class RsL2PortSecurityPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsL2PortSecurityPol", "cobra.model.l2.PortSecurityPol")
    meta.targetNameProps["name"] = "tnL2PortSecurityPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsL2PortSecurityPol"
    meta.rnFormat = "rsl2PortSecurityPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L2 PortSecurity Policy"
    ...
    meta.rnPrefixes = [
        ('rsl2PortSecurityPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38499, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40638, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25976, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25960, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL2PortSecurityPolName", "tnL2PortSecurityPolName", 25959, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL2PortSecurityPolName", prop)
