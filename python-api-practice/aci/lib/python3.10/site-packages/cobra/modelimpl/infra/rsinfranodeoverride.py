...
# ##################################################
class RsInfraNodeOverride(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsInfraNodeOverride", "cobra.model.infra.AONodeS")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsInfraNodeOverride"
    meta.rnFormat = "rsinfraNodeOverride-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26068, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26034, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8999
    prop.defaultValueStr = "infraAONodeS"
    ...
    prop = PropMeta("str", "tDn", "tDn", 26033, PropCategory.REGULAR)
