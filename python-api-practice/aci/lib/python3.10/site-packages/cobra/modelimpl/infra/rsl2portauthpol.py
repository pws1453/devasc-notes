...
# ##################################################
class RsL2PortAuthPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsL2PortAuthPol", "cobra.model.l2.PortAuthPol")
    meta.targetNameProps["name"] = "tnL2PortAuthPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsL2PortAuthPol"
    meta.rnFormat = "rsl2PortAuthPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Interface Authentication (802.1x) policy"
    ...
    meta.rnPrefixes = [
        ('rsl2PortAuthPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38695, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40834, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33250, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33241, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL2PortAuthPolName", "tnL2PortAuthPolName", 33240, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL2PortAuthPolName", prop)
