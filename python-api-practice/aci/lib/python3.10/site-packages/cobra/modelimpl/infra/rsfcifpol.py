...
class RsFcIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsFcIfPol", "cobra.model.fc.IfPol")
    meta.targetNameProps["name"] = "tnFcIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsFcIfPol"
    meta.rnFormat = "rsfcIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38525, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40664, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26317, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26314, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFcIfPolName", "tnFcIfPolName", 26313, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFcIfPolName", prop)
