...
class PreProv(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.PreProv")

    meta.moClassName = "infraPreProv"
    meta.rnFormat = "preprov-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EpP pre-provision"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18394, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 18350, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
