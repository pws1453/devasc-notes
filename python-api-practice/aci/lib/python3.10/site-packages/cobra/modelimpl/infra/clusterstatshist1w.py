...
# ##################################################
class ClusterStatsHist1w(Mo):
    """
    A class that represents historical statistics for cluster in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist1w", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist1w"
    meta.rnFormat = "HDinfraClusterStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6627, PropCategory.REGULAR)
