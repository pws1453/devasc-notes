...
# ##################################################
class RsSpanVSrcGrp(Mo):
    """
    A source relation to all endpoints with traffic that will be spanned.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSpanVSrcGrp", "cobra.model.span.VSrcGrp")
    meta.targetNameProps["name"] = "tnSpanVSrcGrpName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsSpanVSrcGrp"
    meta.rnFormat = "rsspanVSrcGrp-%(tnSpanVSrcGrpName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access VSPAN Source Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37900, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40039, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14722, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13238, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4183
    prop.defaultValueStr = "spanVSrcGrp"
    ...
    prop = PropMeta("str", "tnSpanVSrcGrpName", "tnSpanVSrcGrpName", 13237, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnSpanVSrcGrpName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnSpanVSrcGrpName"))
    ...
    def __init__(self, parentMoOrDn, tnSpanVSrcGrpName, markDirty=True, **creationProps):
        namingVals = [tnSpanVSrcGrpName]
