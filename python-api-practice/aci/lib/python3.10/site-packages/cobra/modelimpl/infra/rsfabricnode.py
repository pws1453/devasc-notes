...
# ##################################################
class RsFabricNode(Mo):
    """
    A source relation to the root node for the APIC.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFabricNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsFabricNode"
    meta.rnFormat = "rsfabricNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38090, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40229, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15468, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15461, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15460, PropCategory.REGULAR)
