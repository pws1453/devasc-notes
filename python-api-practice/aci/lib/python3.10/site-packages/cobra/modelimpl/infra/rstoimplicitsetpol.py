...
# ##################################################
class RsToImplicitSetPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToImplicitSetPol", "cobra.model.infra.ImplicitSetPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToImplicitSetPol"
    meta.rnFormat = "rstoImplicitSetPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "To ImplicitSetPol"
    ...
    meta.parentClasses.add("cobra.model.infra.ImplicitSetPol")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rstoImplicitSetPol', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 44925, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12998
    prop.defaultValueStr = "infraImplicitSetPol"
    prop._addConstant("infraImplicitSetPol", None, 12998)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 44924, PropCategory.REGULAR)
