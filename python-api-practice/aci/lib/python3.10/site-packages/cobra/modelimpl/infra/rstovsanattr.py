...
# ##################################################
class RsToVsanAttr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToVsanAttr", "cobra.model.fc.VsanAttrP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsToVsanAttr"
    meta.rnFormat = "rstoVsanAttr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25343, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25342, PropCategory.REGULAR)
