...
class NodeLblDef(Mo):
    """
    The tenant or provider's external connection characteristics of the port.

    """

    meta = ClassMeta("cobra.model.infra.NodeLblDef")

    meta.moClassName = "infraNodeLblDef"
    meta.rnFormat = "nlbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Switch Label"
    ...
    meta.childClasses.add("cobra.model.infra.IfLblDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.infra.IfLblDef", "ilbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.extnw.AccGrpCont")

    meta.superClasses.add("cobra.model.infra.Lbl")
    ...
    prop = PropMeta("str", "name", "name", 6655, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
