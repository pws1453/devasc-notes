...
# ##################################################
class RsVlanNsDef(Mo):
    """
    A source relation to the namespace policy is used for managing the Encap (VXLAN, NVGRE, VLAN) ranges.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsVlanNsDef", "cobra.model.fvns.AInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsVlanNsDef"
    meta.rnFormat = "rsvlanNsDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Unresolvable Relation to VLAN Pool"
    ...
    meta.superClasses.add("cobra.model.infra.ToAInstP")
    ...
    prop = PropMeta("str", "tCl", "tCl", 16049, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4558
    prop.defaultValueStr = "fvnsAInstP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 16048, PropCategory.REGULAR)
