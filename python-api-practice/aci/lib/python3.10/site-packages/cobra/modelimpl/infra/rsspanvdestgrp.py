...
# ##################################################
class RsSpanVDestGrp(Mo):
    """
    A source relation to all end points (or IP in the case of ERSPAN) to which the SPAN packets will be spanned.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSpanVDestGrp", "cobra.model.span.VDestGrp")
    meta.targetNameProps["name"] = "tnSpanVDestGrpName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsSpanVDestGrp"
    meta.rnFormat = "rsspanVDestGrp-%(tnSpanVDestGrpName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access VSPAN Destination Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37901, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40040, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14723, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13234, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4186
    prop.defaultValueStr = "spanVDestGrp"
    ...
    prop = PropMeta("str", "tnSpanVDestGrpName", "tnSpanVDestGrpName", 13233, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnSpanVDestGrpName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnSpanVDestGrpName"))
    ...
    def __init__(self, parentMoOrDn, tnSpanVDestGrpName, markDirty=True, **creationProps):
        namingVals = [tnSpanVDestGrpName]
