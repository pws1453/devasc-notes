...
# ##################################################
class RsToMcpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToMcpIfPol", "cobra.model.mcp.IfPol")
    meta.targetNameProps["name"] = "tnMcpIfPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToMcpIfPol"
    meta.rnFormat = "rstoMcpIfPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21026, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21018, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMcpIfPolName", "tnMcpIfPolName", 21017, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
