...
# ##################################################
class RsMonModuleInfraPol(Mo):
    """
    A source relation to the monitoring policy model.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsMonModuleInfraPol", "cobra.model.mon.InfraPol")
    meta.targetNameProps["name"] = "tnMonInfraPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMonModuleInfraPol"
    meta.rnFormat = "rsmonModuleInfraPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Monitoring Policy"
    meta.writeAccessMask = 0xc0100000000001
    meta.readAccessMask = 0xc0100000000001
    ...
    meta.rnPrefixes = [
        ('rsmonModuleInfraPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37895, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40034, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14717, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13205, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonInfraPolName", "tnMonInfraPolName", 13204, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
