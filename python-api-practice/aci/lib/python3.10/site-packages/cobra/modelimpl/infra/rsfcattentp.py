...
# ##################################################
class RsFcAttEntP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFcAttEntP", "cobra.model.infra.AttEntityP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsFcAttEntP"
    meta.rnFormat = "rsfcAttEntP"
    ...
    prop = PropMeta("str", "annotation", "annotation", 39194, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40993, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 39179, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 39128, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39127, PropCategory.REGULAR)
