...
class RsStpIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsStpIfPol", "cobra.model.stp.IfPol")
    meta.targetNameProps["name"] = "tnStpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsStpIfPol"
    meta.rnFormat = "rsstpIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access STP Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37904, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40043, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14726, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13242, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnStpIfPolName", "tnStpIfPolName", 13241, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnStpIfPolName", prop)
