...
# ##################################################
class RsToMcpInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToMcpInstPol", "cobra.model.mcp.InstPol")
    meta.targetNameProps["name"] = "tnMcpInstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToMcpInstPol"
    meta.rnFormat = "rstoMcpInstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21027, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21021, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMcpInstPolName", "tnMcpInstPolName", 21020, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMcpInstPolName", prop)
