...
# ##################################################
class RtDomDefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.RtDomDefTask")

    meta.moClassName = "infraRtDomDefTask"
    meta.rnFormat = "infraRtDomDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 43754, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpPDUpdList", "eppdupdlist", 3172)
