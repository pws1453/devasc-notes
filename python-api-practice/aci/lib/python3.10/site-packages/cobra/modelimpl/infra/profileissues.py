...
# ##################################################
class ProfileIssues(Mo):
    """
    Infrastructure Profile Configuration Issues. The delegatable class is infra:Profile, which should be a super  class of all infra profiles such as Attachable Profile, Node Profile, Port Profile, Function Profile, etc.

    """

    meta = ClassMeta("cobra.model.infra.ProfileIssues")

    meta.moClassName = "infraProfileIssues"
    meta.rnFormat = "profileissues"
    meta.category = MoCategory.REGULAR
    meta.label = "Infrastructure Profile Configuration Issues"
    ...
    meta.superClasses.add("cobra.model.infra.AConfIssues")
    ...
    prop = PropMeta("str", "configQual", "configQual", 15491, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("overlapping-encap-namespace", "overlapping-encap-namespace", 1)
