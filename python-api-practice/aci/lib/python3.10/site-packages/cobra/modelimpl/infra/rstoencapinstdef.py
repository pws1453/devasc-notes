...
# ##################################################
class RsToEncapInstDef(Mo):
    """
    This is an internal object used to keep track of which namespaces are allowed on a set of ports.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToEncapInstDef", "cobra.model.stp.EncapInstDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsToEncapInstDef"
    meta.rnFormat = "rstoEncapInstDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15613, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13173, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 570
    prop.defaultValueStr = "stpEncapInstDef"
    prop._addConstant("stpEncapInstDef", None, 570)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13172, PropCategory.REGULAR)
