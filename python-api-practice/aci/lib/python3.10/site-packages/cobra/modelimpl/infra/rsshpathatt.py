...
# ##################################################
class RsSHPathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsSHPathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "infraRsSHPathAtt"
    meta.rnFormat = "rsSHPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Host Path"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38435, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40574, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 24364, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24363, PropCategory.REGULAR)
