...
# ##################################################
class RsSpineBfdIpv4InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSpineBfdIpv4InstPol", "cobra.model.bfd.Ipv4InstPol")
    meta.targetNameProps["name"] = "tnBfdIpv4InstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSpineBfdIpv4InstPol"
    meta.rnFormat = "rsspineBfdIpv4InstPol"
    ...
    meta.rnPrefixes = [
        ('rsspineBfdIpv4InstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38757, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40896, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34375, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34368, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnBfdIpv4InstPolName", "tnBfdIpv4InstPolName", 34367, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBfdIpv4InstPolName", prop)
