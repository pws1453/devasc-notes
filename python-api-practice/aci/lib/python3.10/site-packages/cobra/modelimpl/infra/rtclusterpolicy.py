...
# ##################################################
class RtClusterPolicy(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtClusterPolicy", "cobra.model.ap.Plugin")

    meta.moClassName = "infraRtClusterPolicy"
    meta.rnFormat = "rtapClusterPolicy-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28240, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28239, PropCategory.REGULAR)
