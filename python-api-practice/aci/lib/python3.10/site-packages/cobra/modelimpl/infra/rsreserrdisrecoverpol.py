...
# ##################################################
class RsResErrDisRecoverPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResErrDisRecoverPol", "cobra.model.edr.ErrDisRecoverPol")
    meta.targetNameProps["name"] = "tnEdrErrDisRecoverPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResErrDisRecoverPol"
    meta.rnFormat = "rsresErrDisRecoverPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18225, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18219, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnEdrErrDisRecoverPolName", "tnEdrErrDisRecoverPolName", 18218, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
