...
class RsMcpIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsMcpIfPol", "cobra.model.mcp.IfPol")
    meta.targetNameProps["name"] = "tnMcpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMcpIfPol"
    meta.rnFormat = "rsmcpIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38148, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40287, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17545, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17520, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMcpIfPolName", "tnMcpIfPolName", 17519, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMcpIfPolName", prop)
