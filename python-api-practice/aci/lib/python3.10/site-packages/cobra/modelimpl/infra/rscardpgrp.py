...
class RsCardPGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsCardPGrp", "cobra.model.infra.AccCardPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsCardPGrp"
    meta.rnFormat = "rscardPGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Module Policy Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37875, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40014, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14687, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13117, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4375
    prop.defaultValueStr = "infraAccCardPGrp"
    prop._addConstant("infraAccCardPGrp", None, 4375)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13116, PropCategory.REGULAR)
