...
# ##################################################
class RsStormctrlIfPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsStormctrlIfPol", "cobra.model.stormctrl.IfPol")
    meta.targetNameProps["name"] = "tnStormctrlIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsStormctrlIfPol"
    meta.rnFormat = "rsstormctrlIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Storm Control Policy"
    ...
    meta.rnPrefixes = [
        ('rsstormctrlIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38132, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40271, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16554, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16547, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnStormctrlIfPolName", "tnStormctrlIfPolName", 16546, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnStormctrlIfPolName", prop)
