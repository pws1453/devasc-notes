...
# ##################################################
class ClusterStats5min(Mo):
    """
    A class that represents the most current statistics for cluster in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats5min", "cluster")
    ...
    meta.moClassName = "infraClusterStats5min"
    meta.rnFormat = "CDinfraClusterStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 5 minute"
