...
# ##################################################
class ClusterStats1h(Mo):
    """
    A class that represents the most current statistics for cluster in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats1h", "cluster")
    ...
    meta.moClassName = "infraClusterStats1h"
    meta.rnFormat = "CDinfraClusterStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 1 hour"
