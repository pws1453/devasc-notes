...
# ##################################################
class RsFcAccBndlGrpToFcAggrIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFcAccBndlGrpToFcAggrIf", "cobra.model.pc.FcAggrIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "infraRsFcAccBndlGrpToFcAggrIf"
    meta.rnFormat = "rsfcAccBndlGrpToFcAggrIf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "FC Aggregated Interface"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39136, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11909
    prop.defaultValueStr = "pcFcAggrIf"
    prop._addConstant("pcFcAggrIf", None, 11909)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 39135, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 39215, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
