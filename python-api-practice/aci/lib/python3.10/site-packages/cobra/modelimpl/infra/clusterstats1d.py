...
# ##################################################
class ClusterStats1d(Mo):
    """
    A class that represents the most current statistics for cluster in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats1d", "cluster")
    ...
    meta.moClassName = "infraClusterStats1d"
    meta.rnFormat = "CDinfraClusterStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 1 day"
