...
# ##################################################
class RsFcL2IfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsFcL2IfPol", "cobra.model.fc.IfPol")
    meta.targetNameProps["name"] = "tnFcIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsFcL2IfPol"
    meta.rnFormat = "rsfcL2IfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L2 FC Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 39193, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40992, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 39178, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 39132, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFcIfPolName", "tnFcIfPolName", 39131, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
