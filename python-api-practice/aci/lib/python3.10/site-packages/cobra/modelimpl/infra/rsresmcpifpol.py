...
# ##################################################
class RsResMcpIfPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResMcpIfPol", "cobra.model.mcp.IfPol")
    meta.targetNameProps["name"] = "tnMcpIfPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResMcpIfPol"
    meta.rnFormat = "rsresMcpIfPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17528, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMcpIfPolName", "tnMcpIfPolName", 17527, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
