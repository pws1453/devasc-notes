...
class Mgmt(Mo):
    """
    The Vcenter management connectivity. The Vcenter management encap is a regular VLAN.

    """

    meta = ClassMeta("cobra.model.infra.Mgmt")

    meta.moClassName = "infraMgmt"
    meta.rnFormat = "mgmt-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Management"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14750, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6651, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
