...
# ##################################################
class RsOverrideLacpPol(Mo):
    """
    A source relation to the LACP policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsOverrideLacpPol", "cobra.model.lacp.LagPol")
    meta.targetNameProps["name"] = "tnLacpLagPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOverrideLacpPol"
    meta.rnFormat = "rsoverrideLacpPol"
    ...
    meta.rnPrefixes = [
        ('rsoverrideLacpPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37920, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40059, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14757, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13278, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLacpLagPolName", "tnLacpLagPolName", 13277, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
