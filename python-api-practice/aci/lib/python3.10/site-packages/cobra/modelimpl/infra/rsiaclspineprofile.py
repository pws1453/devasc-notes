...
# ##################################################
class RsIaclSpineProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsIaclSpineProfile", "cobra.model.iacl.SpineProfile")
    meta.targetNameProps["name"] = "tnIaclSpineProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsIaclSpineProfile"
    meta.rnFormat = "rsiaclSpineProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "CoPP Prefilter Profile for Spines"
    ...
    meta.rnPrefixes = [
        ('rsiaclSpineProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38747, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40886, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34286, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10976
    prop.defaultValueStr = "iaclSpineProfile"
    ...
    prop = PropMeta("str", "tnIaclSpineProfileName", "tnIaclSpineProfileName", 34285, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnIaclSpineProfileName", prop)
