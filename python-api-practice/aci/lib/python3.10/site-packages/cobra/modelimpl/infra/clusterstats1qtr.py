...
# ##################################################
class ClusterStats1qtr(Mo):
    """
    A class that represents the most current statistics for cluster in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats1qtr", "cluster")
    ...
    meta.moClassName = "infraClusterStats1qtr"
    meta.rnFormat = "CDinfraClusterStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 1 quarter"
