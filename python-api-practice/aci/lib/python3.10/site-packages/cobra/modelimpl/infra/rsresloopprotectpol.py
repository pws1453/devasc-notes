...
# ##################################################
class RsResLoopProtectPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResLoopProtectPol", "cobra.model.ep.LoopProtectP")
    meta.targetNameProps["name"] = "tnEpLoopProtectPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResLoopProtectPol"
    meta.rnFormat = "rsresLoopProtectPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18117, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnEpLoopProtectPName", "tnEpLoopProtectPName", 18116, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
