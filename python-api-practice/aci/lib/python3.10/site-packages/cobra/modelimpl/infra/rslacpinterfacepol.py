...
# ##################################################
class RsLacpInterfacePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLacpInterfacePol", "cobra.model.lacp.IfPol")
    meta.targetNameProps["name"] = "tnLacpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLacpInterfacePol"
    meta.rnFormat = "rslacpInterfacePol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to LACP Interface Policy"
    ...
    meta.rnPrefixes = [
        ('rslacpInterfacePol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38338, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40477, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22051, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22048, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLacpIfPolName", "tnLacpIfPolName", 22047, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnLacpIfPolName", prop)
