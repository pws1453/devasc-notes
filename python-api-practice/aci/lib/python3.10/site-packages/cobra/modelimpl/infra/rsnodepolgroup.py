...
# ##################################################
class RsNodePolGroup(Mo):
    """
    A source relation to the node policy group. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsNodePolGroup", "cobra.model.infra.PolGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsNodePolGroup"
    meta.rnFormat = "rsnodePolGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14697, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13152, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4360
    prop.defaultValueStr = "infraPolGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13151, PropCategory.REGULAR)
