...
# ##################################################
class RsLeafPGrpToCdpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLeafPGrpToCdpIfPol", "cobra.model.cdp.IfPol")
    meta.targetNameProps["name"] = "tnCdpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLeafPGrpToCdpIfPol"
    meta.rnFormat = "rsleafPGrpToCdpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsleafPGrpToCdpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 54549, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54550, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54526, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnCdpIfPolName", "tnCdpIfPolName", 54525, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
