...
# ##################################################
class RsToBfdIpv6InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToBfdIpv6InstPol", "cobra.model.bfd.Ipv6InstPol")
    meta.targetNameProps["name"] = "tnBfdIpv6InstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToBfdIpv6InstPol"
    meta.rnFormat = "rstoBfdIpv6InstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25177, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25174, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnBfdIpv6InstPolName", "tnBfdIpv6InstPolName", 25173, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
