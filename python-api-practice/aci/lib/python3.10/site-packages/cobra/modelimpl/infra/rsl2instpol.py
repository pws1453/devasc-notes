...
# ##################################################
class RsL2InstPol(Mo):
    """
    A source relation to the Layer 2 instance policy information.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsL2InstPol", "cobra.model.l2.InstPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsL2InstPol"
    meta.rnFormat = "rsl2InstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L2 Instance Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37897, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40036, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14719, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13222, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 711
    prop.defaultValueStr = "l2InstPol"
    prop._addConstant("l2InstPol", None, 711)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15567, PropCategory.REGULAR)
