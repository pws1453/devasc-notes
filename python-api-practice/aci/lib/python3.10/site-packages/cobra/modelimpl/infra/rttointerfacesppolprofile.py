...
# ##################################################
class RtToInterfaceSpPolProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtToInterfaceSpPolProfile", "cobra.model.infra.NodeCfg")

    meta.moClassName = "infraRtToInterfaceSpPolProfile"
    meta.rnFormat = "rttoInterfaceSpPolProfile-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rttoInterfaceSpPolProfile-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 24385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24384, PropCategory.REGULAR)
