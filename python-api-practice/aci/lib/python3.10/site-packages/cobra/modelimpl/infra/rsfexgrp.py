...
class RsFexGrp(Mo):
    """
    A source relation to the FEX policy group.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFexGrp", "cobra.model.infra.FexGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsFexGrp"
    meta.rnFormat = "rsfexGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13165, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4385
    prop.defaultValueStr = "infraFexGrp"
    prop._addConstant("infraFexBndlGrp", None, 4386)
    prop._addConstant("infraFexGrp", None, 4385)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13164, PropCategory.REGULAR)
