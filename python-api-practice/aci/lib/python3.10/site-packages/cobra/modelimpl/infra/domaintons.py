...
# ##################################################
class DomainToNs(Mo):
    meta = ClassMeta("cobra.model.infra.DomainToNs")

    meta.isAbstract = True
    meta.moClassName = "infraDomainToNs"


    meta.moClassName = "infraDomainToNs"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Each Domain to Namespace Relation"
    ...
    meta.concreteSubClasses.add("cobra.model.vmm.RsVxlanNs")
    meta.concreteSubClasses.add("cobra.model.infra.RsVlanNs")
    meta.concreteSubClasses.add("cobra.model.fc.RsVsanNs")
