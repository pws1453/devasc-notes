...
# ##################################################
class RsLldpIfPol(Mo):
    """
    A source relation to the LLDP policy parameters for the interface.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLldpIfPol", "cobra.model.lldp.IfPol")
    meta.targetNameProps["name"] = "tnLldpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLldpIfPol"
    meta.rnFormat = "rslldpIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to LLDP Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37898, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40037, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14720, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13226, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLldpIfPolName", "tnLldpIfPolName", 13225, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnLldpIfPolName", prop)
