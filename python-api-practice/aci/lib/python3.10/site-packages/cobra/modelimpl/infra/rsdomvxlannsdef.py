...
# ##################################################
class RsDomVxlanNsDef(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.infra.RsDomVxlanNsDef", "cobra.model.fvns.AInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsDomVxlanNsDef"
    meta.rnFormat = "rsdomVxlanNsDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Unresolvable Relation to VXLAN Pool"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17676, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17675, PropCategory.REGULAR)
