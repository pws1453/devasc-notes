...
class HostCfg(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.HostCfg")

    meta.moClassName = "infraHostCfg"
    meta.rnFormat = "host-[%(accGrpDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Host Connectivity Configuration"
    ...
    meta.childClasses.add("cobra.model.infra.RsConnectivityProfile")
    meta.childClasses.add("cobra.model.fabric.CreatedBy")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.infra.RsConnectivitySpProfile")

    meta.childNamesAndRnPrefix.append(("cobra.model.infra.RsConnectivitySpProfile", "rsconnectivitySpProfile"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.RsConnectivityProfile", "rsconnectivityProfile"))
    ...
    prop = PropMeta("str", "accGrpDn", "accGrpDn", 4884, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "deplSt", "deplSt", 4885, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14701, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "accGrpDn"))
    getattr(meta.props, "accGrpDn").needDelimiter = True

    def __init__(self, parentMoOrDn, accGrpDn, markDirty=True, **creationProps):
        namingVals = [accGrpDn]
