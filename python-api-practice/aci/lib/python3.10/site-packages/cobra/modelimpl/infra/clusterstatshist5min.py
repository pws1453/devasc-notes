...
# ##################################################
class ClusterStatsHist5min(Mo):
    """
    A class that represents historical statistics for cluster in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist5min", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist5min"
    meta.rnFormat = "HDinfraClusterStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6629, PropCategory.REGULAR)
