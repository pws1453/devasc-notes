...
# ##################################################
class RsQosSdIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsQosSdIfPol", "cobra.model.qos.SdIfPol")
    meta.targetNameProps["name"] = "tnQosSdIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsQosSdIfPol"
    meta.rnFormat = "rsqosSdIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38493, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40632, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25826, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25808, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosSdIfPolName", "tnQosSdIfPolName", 25807, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnQosSdIfPolName", prop)
