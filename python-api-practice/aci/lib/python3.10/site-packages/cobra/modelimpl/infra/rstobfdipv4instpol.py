...
# ##################################################
class RsToBfdIpv4InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToBfdIpv4InstPol", "cobra.model.bfd.Ipv4InstPol")
    meta.targetNameProps["name"] = "tnBfdIpv4InstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToBfdIpv4InstPol"
    meta.rnFormat = "rstoBfdIpv4InstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25176, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25171, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnBfdIpv4InstPolName", "tnBfdIpv4InstPolName", 25170, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
