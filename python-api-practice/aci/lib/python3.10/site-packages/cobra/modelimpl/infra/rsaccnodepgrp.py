...
# ##################################################
class RsAccNodePGrp(Mo):
    """
    A source relation to the node policy group.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsAccNodePGrp", "cobra.model.infra.AccNodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsAccNodePGrp"
    meta.rnFormat = "rsaccNodePGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37873, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40012, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14685, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13113, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13112, PropCategory.REGULAR)
