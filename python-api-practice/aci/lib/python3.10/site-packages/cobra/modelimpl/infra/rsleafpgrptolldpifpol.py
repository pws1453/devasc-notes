...
# ##################################################
class RsLeafPGrpToLldpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLeafPGrpToLldpIfPol", "cobra.model.lldp.IfPol")
    meta.targetNameProps["name"] = "tnLldpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLeafPGrpToLldpIfPol"
    meta.rnFormat = "rsleafPGrpToLldpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsleafPGrpToLldpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 54551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54552, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54544, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54530, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLldpIfPolName", "tnLldpIfPolName", 54529, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
