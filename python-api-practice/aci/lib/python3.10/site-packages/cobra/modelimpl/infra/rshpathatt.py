...
class RsHPathAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsHPathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "infraRsHPathAtt"
    meta.rnFormat = "rsHPathAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38185, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40324, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 18160, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18159, PropCategory.REGULAR)
