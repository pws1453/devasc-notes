...
# ##################################################
class RsResNwsFwPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResNwsFwPol", "cobra.model.nws.FwPol")
    meta.targetNameProps["name"] = "tnNwsFwPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResNwsFwPol"
    meta.rnFormat = "rsresNwsFwPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 19099, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNwsFwPolName", "tnNwsFwPolName", 19098, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
