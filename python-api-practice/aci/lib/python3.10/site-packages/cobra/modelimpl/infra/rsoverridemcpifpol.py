...
# ##################################################
class RsOverrideMcpIfPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsOverrideMcpIfPol", "cobra.model.mcp.IfPol")
    meta.targetNameProps["name"] = "tnMcpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOverrideMcpIfPol"
    meta.rnFormat = "rsoverrideMcpIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to MCP Interface Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17547, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17524, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMcpIfPolName", "tnMcpIfPolName", 17523, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
