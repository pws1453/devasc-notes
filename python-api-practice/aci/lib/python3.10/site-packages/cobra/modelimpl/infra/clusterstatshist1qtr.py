...
# ##################################################
class ClusterStatsHist1qtr(Mo):
    """
    A class that represents historical statistics for cluster in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist1qtr", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist1qtr"
    meta.rnFormat = "HDinfraClusterStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6626, PropCategory.REGULAR)
