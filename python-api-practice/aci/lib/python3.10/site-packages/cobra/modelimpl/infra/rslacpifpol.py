...
# ##################################################
class RsLacpIfPol(Mo):
    """
    The PortChannel member policy configured parameters.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLacpIfPol", "cobra.model.lacp.IfPol")
    meta.targetNameProps["name"] = "tnLacpIfPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsLacpIfPol"
    meta.rnFormat = "rslacpIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37910, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40049, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13262, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLacpIfPolName", "tnLacpIfPolName", 13261, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
