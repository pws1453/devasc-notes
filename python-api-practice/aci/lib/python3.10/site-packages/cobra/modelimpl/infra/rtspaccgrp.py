...
class RtSpAccGrp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.infra.RtSpAccGrp", "cobra.model.infra.SHPortS")

    meta.moClassName = "infraRtSpAccGrp"
    meta.rnFormat = "rtspAccGrp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Spine Access Port Selector"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24358, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8234
    prop.defaultValueStr = "infraSHPortS"
    prop._addConstant("infraSHPortS", None, 8234)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24357, PropCategory.REGULAR)
