...
# ##################################################
class RsMonIfInfraPol(Mo):
    """
    A source relation to the monitoring policy model.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsMonIfInfraPol", "cobra.model.mon.InfraPol")
    meta.targetNameProps["name"] = "tnMonInfraPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMonIfInfraPol"
    meta.rnFormat = "rsmonIfInfraPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access Monitoring Interface Policy"
    ...
    meta.rnPrefixes = [
        ('rsmonIfInfraPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37903, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40042, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14725, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13230, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 251
    prop.defaultValueStr = "monInfraPol"
    ...
    prop = PropMeta("str", "tnMonInfraPolName", "tnMonInfraPolName", 13229, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMonInfraPolName", prop)
