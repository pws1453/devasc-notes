...
# ##################################################
class RsProtGroup(Mo):
    """
    A source relation to a VPC protection group. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsProtGroup", "cobra.model.fabric.ProtGEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsProtGroup"
    meta.rnFormat = "rsprotGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13156, PropCategory.REGULAR)
