...
# ##################################################
class ClusterStatsHist1year(Mo):
    """
    A class that represents historical statistics for cluster in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist1year", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist1year"
    meta.rnFormat = "HDinfraClusterStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6628, PropCategory.REGULAR)
