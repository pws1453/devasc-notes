...
# ##################################################
class RsResMcpInstPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResMcpInstPol", "cobra.model.mcp.InstPol")
    meta.targetNameProps["name"] = "tnMcpInstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResMcpInstPol"
    meta.rnFormat = "rsresMcpInstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18084, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18082, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMcpInstPolName", "tnMcpInstPolName", 18081, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
