...
# ##################################################
class ClusterStatsHist15min(Mo):
    """
    A class that represents historical statistics for cluster in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist15min", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist15min"
    meta.rnFormat = "HDinfraClusterStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.infra.ClusterStatsHist")

    meta.rnPrefixes = [
        ('HDinfraClusterStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6622, PropCategory.REGULAR)
