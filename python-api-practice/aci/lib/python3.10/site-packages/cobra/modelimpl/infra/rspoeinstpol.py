...
# ##################################################
class RsPoeInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsPoeInstPol", "cobra.model.poe.InstPol")
    meta.targetNameProps["name"] = "tnPoeInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsPoeInstPol"
    meta.rnFormat = "rspoeInstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "POE Node Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40874, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnPoeInstPolName", "tnPoeInstPolName", 34078, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnPoeInstPolName", prop)
