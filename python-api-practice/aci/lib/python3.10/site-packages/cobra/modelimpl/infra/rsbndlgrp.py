...
class RsBndlGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsBndlGrp", "cobra.model.infra.AccBndlGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsBndlGrp"
    meta.rnFormat = "rsbndlGrp-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.infra.HPortSInfo")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.CreatedBy", "source-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.HPortSInfo", "portS-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20919, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20879, PropCategory.REGULAR)
