...
class RsModulePolProfile(Mo):
    """
    A source relation to the module profile.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsModulePolProfile", "cobra.model.infra.AccCardP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsModulePolProfile"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13147, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13146, PropCategory.REGULAR)
