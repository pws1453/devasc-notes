...
# ##################################################
class RsToEpLoopProtectP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToEpLoopProtectP", "cobra.model.ep.LoopProtectP")
    meta.targetNameProps["name"] = "tnEpLoopProtectPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToEpLoopProtectP"
    meta.rnFormat = "rstoEpLoopProtectP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21028, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21015, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6079
    prop.defaultValueStr = "epLoopProtectP"
    ...
    prop = PropMeta("str", "tnEpLoopProtectPName", "tnEpLoopProtectPName", 21014, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnEpLoopProtectPName", prop)
