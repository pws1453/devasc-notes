...
class ProvP(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.ProvP")

    meta.moClassName = "infraProvP"
    meta.rnFormat = "provp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Provider Profile"
    meta.writeAccessMask = 0x201
    meta.readAccessMask = 0x6000000000000701
    ...
    meta.childClasses.add("cobra.model.infra.PEPg")
    meta.childClasses.add("cobra.model.dhcp.PRelPg")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.PRelPg", "pdhcp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.PEPg", "pepg-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.fv.Tenant")

    meta.superClasses.add("cobra.model.fabric.InfrP")
    meta.superClasses.add("cobra.model.fabric.InfrExP")
    meta.superClasses.add("cobra.model.fabric.Pol")
    meta.superClasses.add("cobra.model.infra.ExP")
    meta.superClasses.add("cobra.model.fv.Up")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37927, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40066, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14769, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6662, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
