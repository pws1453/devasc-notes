...
# ##################################################
class RsPathToSpAccGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsPathToSpAccGrp", "cobra.model.infra.SpAccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsPathToSpAccGrp"
    meta.rnFormat = "rspathToSpAccGrp"
    ...
    meta.rnPrefixes = [
        ('rspathToSpAccGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38436, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40575, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24375, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 24367, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8242
    prop.defaultValueStr = "infraSpAccGrp"
    prop._addConstant("infraSpAccGrp", None, 8242)
    prop._addConstant("infraSpAccPortGrp", None, 8243)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24366, PropCategory.REGULAR)
