...
# ##################################################
class RsQosPfcIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsQosPfcIfPol", "cobra.model.qos.PfcIfPol")
    meta.targetNameProps["name"] = "tnQosPfcIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsQosPfcIfPol"
    meta.rnFormat = "rsqosPfcIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Interface Priority Flow Control"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38481, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40620, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25406, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25363, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosPfcIfPolName", "tnQosPfcIfPolName", 25362, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnQosPfcIfPolName", prop)
