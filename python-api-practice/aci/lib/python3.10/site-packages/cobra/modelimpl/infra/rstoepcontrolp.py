...
# ##################################################
class RsToEpControlP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToEpControlP", "cobra.model.ep.LoopProtectP")
    meta.targetNameProps["name"] = "tnEpLoopProtectPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToEpControlP"
    meta.rnFormat = "rstoEpControlP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnEpLoopProtectPName", "tnEpLoopProtectPName", 21561, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
