...
# ##################################################
class RsOverrideCdpIfPol(Mo):
    """
    A source relation to the CDP interface policy parameters.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsOverrideCdpIfPol", "cobra.model.cdp.IfPol")
    meta.targetNameProps["name"] = "tnCdpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOverrideCdpIfPol"
    meta.rnFormat = "rsoverrideCdpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsoverrideCdpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37919, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40058, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14756, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13274, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnCdpIfPolName", "tnCdpIfPolName", 13273, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
