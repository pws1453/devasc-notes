...
# ##################################################
class RsOverrideFwPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsOverrideFwPol", "cobra.model.nws.FwPol")
    meta.targetNameProps["name"] = "tnNwsFwPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOverrideFwPol"
    meta.rnFormat = "rsoverrideFwPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Firewall Policy"
    ...
    meta.rnPrefixes = [
        ('rsoverrideFwPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38229, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40368, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19104, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 19095, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6379
    prop.defaultValueStr = "nwsFwPol"
    ...
    prop = PropMeta("str", "tnNwsFwPolName", "tnNwsFwPolName", 19094, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnNwsFwPolName", prop)
