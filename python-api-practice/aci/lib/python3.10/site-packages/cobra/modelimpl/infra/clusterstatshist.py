...
# ##################################################
class ClusterStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist"


    meta.moClassName = "infraClusterStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats"
    ...
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.infra.ClusterStatsHist1w")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "a2uCountAvg", "a2uCountAvg", 9330, PropCategory.IMPLICIT_AVG)
    prop.label = "active to unavailable transitions average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("a2uCountAvg", prop)

    prop = PropMeta("str", "a2uCountCum", "a2uCountCum", 9326, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "active to unavailable transitions cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("a2uCountCum", prop)

    prop = PropMeta("str", "a2uCountMax", "a2uCountMax", 9329, PropCategory.IMPLICIT_MAX)
    prop.label = "active to unavailable transitions maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("a2uCountMax", prop)

    prop = PropMeta("str", "a2uCountMin", "a2uCountMin", 9328, PropCategory.IMPLICIT_MIN)
    prop.label = "active to unavailable transitions minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("a2uCountMin", prop)

    prop = PropMeta("str", "a2uCountPer", "a2uCountPer", 9327, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "active to unavailable transitions periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("a2uCountPer", prop)

    prop = PropMeta("str", "a2uCountRate", "a2uCountRate", 9334, PropCategory.IMPLICIT_RATE)
    prop.label = "active to unavailable transitions rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("a2uCountRate", prop)

    prop = PropMeta("str", "a2uCountSpct", "a2uCountSpct", 9331, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "active to unavailable transitions suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("a2uCountSpct", prop)

    prop = PropMeta("str", "a2uCountThr", "a2uCountThr", 9332, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "a2uCountTr", "a2uCountTr", 9333, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "uTimeAvg", "uTimeAvg", 9357, PropCategory.IMPLICIT_AVG)
    prop.label = "time in unavailable state average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("uTimeAvg", prop)

    prop = PropMeta("str", "uTimeMax", "uTimeMax", 9356, PropCategory.IMPLICIT_MAX)
    prop.label = "time in unavailable state maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("uTimeMax", prop)

    prop = PropMeta("str", "uTimeMin", "uTimeMin", 9355, PropCategory.IMPLICIT_MIN)
    prop.label = "time in unavailable state minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("uTimeMin", prop)

    prop = PropMeta("str", "uTimeSpct", "uTimeSpct", 9358, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "time in unavailable state suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("uTimeSpct", prop)

    prop = PropMeta("str", "uTimeThr", "uTimeThr", 9359, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "uTimeTr", "uTimeTr", 9360, PropCategory.IMPLICIT_TREND)
