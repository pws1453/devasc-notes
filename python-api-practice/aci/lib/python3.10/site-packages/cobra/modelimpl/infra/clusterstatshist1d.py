...
# ##################################################
class ClusterStatsHist1d(Mo):
    """
    A class that represents historical statistics for cluster in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist1d", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist1d"
    meta.rnFormat = "HDinfraClusterStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6623, PropCategory.REGULAR)
