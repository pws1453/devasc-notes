...
# ##################################################
class ReplicaStatsHist1year(Mo):
    """
    A class that represents historical statistics for replica in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ReplicaStatsHist1year", "replica")
    ...
    meta.moClassName = "infraReplicaStatsHist1year"
    meta.rnFormat = "HDinfraReplicaStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical replica stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6669, PropCategory.REGULAR)
