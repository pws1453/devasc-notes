...
# ##################################################
class ReplicaStatsHist1w(Mo):
    """
    A class that represents historical statistics for replica in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ReplicaStatsHist1w", "replica")
    ...
    meta.moClassName = "infraReplicaStatsHist1w"
    meta.rnFormat = "HDinfraReplicaStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical replica stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6668, PropCategory.REGULAR)
