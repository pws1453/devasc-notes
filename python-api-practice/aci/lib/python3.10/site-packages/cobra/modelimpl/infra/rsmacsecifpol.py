...
# ##################################################
class RsMacsecIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsMacsecIfPol", "cobra.model.macsec.IfPol")
    meta.targetNameProps["name"] = "tnMacsecIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMacsecIfPol"
    meta.rnFormat = "rsmacsecIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to MACsec Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38651, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40790, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30148, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30125, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMacsecIfPolName", "tnMacsecIfPolName", 30124, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMacsecIfPolName", prop)
