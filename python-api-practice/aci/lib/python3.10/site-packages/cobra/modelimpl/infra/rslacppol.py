...
class RsLacpPol(Mo):
    """
    A source relation to the LAG policy. This object indicates the LAG policy that is associated with this bundle group.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLacpPol", "cobra.model.lacp.LagPol")
    meta.targetNameProps["name"] = "tnLacpLagPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLacpPol"
    meta.rnFormat = "rslacpPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to LACP LAG Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37907, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40046, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14729, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13246, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 152
    prop.defaultValueStr = "lacpLagPol"
    ...
    prop = PropMeta("str", "tnLacpLagPolName", "tnLacpLagPolName", 13245, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnLacpLagPolName", prop)
