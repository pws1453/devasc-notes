...
# ##################################################
class RsToVsanEncapInstDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToVsanEncapInstDef", "cobra.model.fc.EncapInstDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsToVsanEncapInstDef"
    meta.rnFormat = "rstoVsanEncapInstDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Vsan Encap Namespace"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25347, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8741
    prop.defaultValueStr = "fcEncapInstDef"
    prop._addConstant("fcEncapInstDef", None, 8741)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25346, PropCategory.REGULAR)
