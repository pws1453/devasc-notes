...
class RsCdpIfPol(Mo):
    """
    A source relation to the CDP Interface Policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsCdpIfPol", "cobra.model.cdp.IfPol")
    meta.targetNameProps["name"] = "tnCdpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsCdpIfPol"
    meta.rnFormat = "rscdpIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to CDP Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37899, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40038, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14721, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13214, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnCdpIfPolName", "tnCdpIfPolName", 13213, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCdpIfPolName", prop)
