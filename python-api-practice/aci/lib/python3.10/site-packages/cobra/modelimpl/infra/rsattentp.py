...
class RsAttEntP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsAttEntP", "cobra.model.infra.AttEntityP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsAttEntP"
    meta.rnFormat = "rsattEntP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access Attach Entity Policy"
    ...
    meta.childClasses.add("cobra.model.infra.ConnFexS")
    ...
    meta.childClasses.add("cobra.model.infra.ConnNodeS")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.ConnNodeS", "nodes-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.ConnFexS", "fexs-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37905, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40044, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isUsingConnSel", "isUsingConnSel", 13210, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isUsingConnSel", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14727, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13209, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4441
    prop.defaultValueStr = "infraAttEntityP"
    prop._addConstant("infraAttEntityP", None, 4441)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13208, PropCategory.REGULAR)
