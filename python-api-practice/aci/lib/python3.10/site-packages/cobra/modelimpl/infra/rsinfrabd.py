...
class RsInfraBD(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsInfraBD", "cobra.model.fv.BD")
    meta.targetNameProps["name"] = "tnFvBDName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsInfraBD"
    meta.rnFormat = "rsinfraBD"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40019, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14692, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13130, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvBDName", "tnFvBDName", 13129, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
