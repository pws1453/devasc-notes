...
class Generic(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.Generic")

    meta.moClassName = "infraGeneric"
    meta.rnFormat = "gen-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Generic"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40055, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14753, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6640, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
