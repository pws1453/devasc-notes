...
# ##################################################
class ClusterStats1w(Mo):
    """
    A class that represents the most current statistics for cluster in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats1w", "cluster")
    ...
    meta.moClassName = "infraClusterStats1w"
    meta.rnFormat = "CDinfraClusterStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 1 week"
