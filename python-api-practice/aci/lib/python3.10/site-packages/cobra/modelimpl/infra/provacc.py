...
class ProvAcc(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.ProvAcc")

    meta.moClassName = "infraProvAcc"
    meta.rnFormat = "provacc"
    meta.category = MoCategory.REGULAR
    meta.label = "Vlan Encapsulation for Vxlan Traffic"
    ...
    meta.childClasses.add("cobra.model.infra.RsFuncToEpg")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.dhcp.InfraProvP")
    meta.childClasses.add("cobra.model.infra.EpPD")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.RsFuncToEpg", "rsfuncToEpg-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.InfraProvP", "infraprovp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.EpPD", "infeppd-"))
    ...
    meta.superClasses.add("cobra.model.infra.AFunc")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37915, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 4890, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40054, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14748, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6661, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "provacc"
    prop.defaultValueStr = "provacc"
