...
class EpPDDef(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.EpPDDef")

    meta.moClassName = "infraEpPDDef"
    meta.rnFormat = "infeppd-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Endpoint Policy Description"
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 6637, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14759, PropCategory.REGULAR)
