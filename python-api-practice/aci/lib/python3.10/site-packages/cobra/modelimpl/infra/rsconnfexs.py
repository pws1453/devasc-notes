...
class RsConnFexS(Mo):
    """
    A source relation to the connectivity FEX selector.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsConnFexS", "cobra.model.infra.ConnFexS")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsConnFexS"
    meta.rnFormat = "rsconnFexS-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "FEX Interface Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37865, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40004, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fexId", "fexId", 13105, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(101, 199)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13104, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4298
    prop.defaultValueStr = "infraConnFexS"
    prop._addConstant("infraConnFexS", None, 4298)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13103, PropCategory.REGULAR)
