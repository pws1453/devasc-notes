...
# ##################################################
class RsAccBndlSubgrp(Mo):
    """
    A source relation to the access bundle subgroup.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsAccBndlSubgrp", "cobra.model.infra.AccBndlSubgrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsAccBndlSubgrp"
    meta.rnFormat = "rsaccBndlSubgrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Bundle Sub Group"
    ...
    meta.rnPrefixes = [
        ('rsaccBndlSubgrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40018, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14691, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13126, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4416
    prop.defaultValueStr = "infraAccBndlSubgrp"
    prop._addConstant("infraAccBndlSubgrp", None, 4416)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13125, PropCategory.REGULAR)
