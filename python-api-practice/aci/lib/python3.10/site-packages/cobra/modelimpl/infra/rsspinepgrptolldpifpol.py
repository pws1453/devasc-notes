...
# ##################################################
class RsSpinePGrpToLldpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSpinePGrpToLldpIfPol", "cobra.model.lldp.IfPol")
    meta.targetNameProps["name"] = "tnLldpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSpinePGrpToLldpIfPol"
    meta.rnFormat = "rsspinePGrpToLldpIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to lldp interface policy for mgmt port"
    ...
    meta.rnPrefixes = [
        ('rsspinePGrpToLldpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 54547, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54548, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54542, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54538, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLldpIfPolName", "tnLldpIfPolName", 54537, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
