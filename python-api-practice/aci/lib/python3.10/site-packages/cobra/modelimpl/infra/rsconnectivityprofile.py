...
# ##################################################
class RsConnectivityProfile(Mo):
    """
    A source relation to an abstraction of the port functions.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsConnectivityProfile", "cobra.model.infra.AccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsConnectivityProfile"
    meta.rnFormat = "rsconnectivityProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access Policy Group"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13169, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13168, PropCategory.REGULAR)
