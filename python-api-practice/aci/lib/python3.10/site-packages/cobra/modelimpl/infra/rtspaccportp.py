...
# ##################################################
class RtSpAccPortP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtSpAccPortP", "cobra.model.infra.SpineP")

    meta.moClassName = "infraRtSpAccPortP"
    meta.rnFormat = "rtspAccPortP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24362, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8237
    prop.defaultValueStr = "infraSpineP"
    prop._addConstant("infraSpineP", None, 8237)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24361, PropCategory.REGULAR)
