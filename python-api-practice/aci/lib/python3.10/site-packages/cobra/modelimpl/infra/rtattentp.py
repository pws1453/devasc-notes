...
class RtAttEntP(Mo):
    """
    A target relation to the attached entity profile. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.infra.RtAttEntP", "cobra.model.infra.AAccGrp")

    meta.moClassName = "infraRtAttEntP"
    meta.rnFormat = "rtattEntP-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x80300000000417
    ...
    prop = PropMeta("str", "tCl", "tCl", 13212, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8241
    prop.defaultValueStr = "infraAAccGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13211, PropCategory.REGULAR)
