...
class RtLDevDomP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.infra.RtLDevDomP", "cobra.model.vns.SvcRelnHolder")

    meta.moClassName = "infraRtLDevDomP"
    meta.rnFormat = "rtvnsLDevDomP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Service Relations Holder"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x300000000601
    ...
    prop = PropMeta("str", "tCl", "tCl", 23310, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6645
    prop.defaultValueStr = "vnsSvcRelnHolder"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsSvcRelnHolder", None, 6645)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23309, PropCategory.REGULAR)
