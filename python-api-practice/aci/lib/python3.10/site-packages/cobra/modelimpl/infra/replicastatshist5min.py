...
# ##################################################
class ReplicaStatsHist5min(Mo):
    """
    A class that represents historical statistics for replica in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.infra.ReplicaStatsHist5min", "replica")
    ...
    meta.moClassName = "infraReplicaStatsHist5min"
    meta.rnFormat = "HDinfraReplicaStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical replica stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6670, PropCategory.REGULAR)
