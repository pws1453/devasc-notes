...
# ##################################################
class RsToInterfaceSpPolProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToInterfaceSpPolProfile", "cobra.model.infra.SpAccPortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsToInterfaceSpPolProfile"
    meta.rnFormat = "rstoInterfaceSpPolProfile-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoInterfaceSpPolProfile-', True),
    ]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24393, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 24383, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24382, PropCategory.REGULAR)
