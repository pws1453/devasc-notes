...
# ##################################################
class RsQosEgressDppIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsQosEgressDppIfPol", "cobra.model.qos.DppPol")
    meta.targetNameProps["name"] = "tnQosDppPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsQosEgressDppIfPol"
    meta.rnFormat = "rsQosEgressDppIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Data Plane Policy Egress"
    ...
    meta.rnPrefixes = [
        ('rsQosEgressDppIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40542, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23216, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23205, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosDppPolName", "tnQosDppPolName", 23204, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
