...
# ##################################################
class ReplicaStatsHist1h(Mo):
    """
    A class that represents historical statistics for replica in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.infra.ReplicaStatsHist1h", "replica")
    ...
    meta.moClassName = "infraReplicaStatsHist1h"
    meta.rnFormat = "HDinfraReplicaStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical replica stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6665, PropCategory.REGULAR)
