...
class RsPoeIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsPoeIfPol", "cobra.model.poe.IfPol")
    meta.targetNameProps["name"] = "tnPoeIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsPoeIfPol"
    meta.rnFormat = "rspoeIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to POE Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38736, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40875, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnPoeIfPolName", "tnPoeIfPolName", 34082, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnPoeIfPolName", prop)
