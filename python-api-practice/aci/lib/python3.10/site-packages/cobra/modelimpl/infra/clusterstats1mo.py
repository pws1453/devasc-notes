...
# ##################################################
class ClusterStats1mo(Mo):
    """
    A class that represents the most current statistics for cluster in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats1mo", "cluster")
    ...
    meta.moClassName = "infraClusterStats1mo"
    meta.rnFormat = "CDinfraClusterStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 1 month"
