...
class EpPD(Mo):
    """
    The endpoint group policy descriptor for infrastructure policies. For example, endpoint groups under tenant infra. This object is generated and used only by internal processes.

    """

    meta = ClassMeta("cobra.model.infra.EpPD")

    meta.moClassName = "infraEpPD"
    meta.rnFormat = "infeppd-[%(epgPKey)s]"
    ...
    meta.superClasses.add("cobra.model.infra.AEpPD")
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 6636, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14758, PropCategory.REGULAR)
