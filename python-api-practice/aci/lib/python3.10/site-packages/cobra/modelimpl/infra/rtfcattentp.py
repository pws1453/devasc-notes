...
# ##################################################
class RtFcAttEntP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtFcAttEntP", "cobra.model.infra.FcAccGrp")

    meta.moClassName = "infraRtFcAttEntP"
    meta.rnFormat = "rtfcAttEntP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39130, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39129, PropCategory.REGULAR)
