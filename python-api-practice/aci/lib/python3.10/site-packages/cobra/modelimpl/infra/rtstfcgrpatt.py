...
# ##################################################
class RtStFcGrpAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtStFcGrpAtt", "cobra.model.fv.APathAtt")

    meta.moClassName = "infraRtStFcGrpAtt"
    meta.rnFormat = "rtfvStFcGrpAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39118, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39117, PropCategory.REGULAR)
