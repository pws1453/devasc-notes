...
# ##################################################
class RsTopoctrlFwdScaleProfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsTopoctrlFwdScaleProfPol", "cobra.model.topoctrl.FwdScaleProfilePol")
    meta.targetNameProps["name"] = "tnTopoctrlFwdScaleProfilePolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsTopoctrlFwdScaleProfPol"
    meta.rnFormat = "rstopoctrlFwdScaleProfPol"
    ...
    meta.rnPrefixes = [
        ('rstopoctrlFwdScaleProfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38690, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40829, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33193, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33190, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTopoctrlFwdScaleProfilePolName", "tnTopoctrlFwdScaleProfilePolName", 33189, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTopoctrlFwdScaleProfilePolName", prop)
