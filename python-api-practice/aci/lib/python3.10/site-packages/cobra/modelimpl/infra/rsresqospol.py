...
# ##################################################
class RsResQoSPol(Mo):
    """
    A source relation to the QoS classification traffic descriptor and specifications used to categorize a packet within a specific group and making the packet accessible for QoS handling in the network. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResQoSPol", "cobra.model.qos.Class")
    meta.targetNameProps["prio"] = "tnQosClassPrio"
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "infraRsResQoSPol"
    meta.rnFormat = "rsresQoSPol-%(tnQosClassPrio)s"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14741, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13304, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 127
    prop.defaultValueStr = "qosClass"
    ...
    prop = PropMeta("str", "tnQosClassPrio", "tnQosClassPrio", 13303, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tnQosClassPrio", prop)

    meta.namingProps.append(getattr(meta.props, "tnQosClassPrio"))

    def __init__(self, parentMoOrDn, tnQosClassPrio, markDirty=True, **creationProps):
        namingVals = [tnQosClassPrio]
