...
# ##################################################
class RsAccBaseGrp(Mo):
    """
    A source relation to the access policy group providing port configuration.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsAccBaseGrp", "cobra.model.infra.AccBaseGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsAccBaseGrp"
    meta.rnFormat = "rsaccBaseGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Access Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37877, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40016, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fexId", "fexId", 13122, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(101, 199)]
    prop.defaultValue = 101
    prop.defaultValueStr = "101"
    meta.props.add("fexId", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14689, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13121, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4384
    prop.defaultValueStr = "infraAccBaseGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13120, PropCategory.REGULAR)
