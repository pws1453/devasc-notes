...
# ##################################################
class RsProtectionGrp(Mo):
    """
    A source relation to a VPC protection group. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsProtectionGrp", "cobra.model.fabric.ProtGEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsProtectionGrp"
    meta.rnFormat = "rsprotectionGrp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13134, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13133, PropCategory.REGULAR)
