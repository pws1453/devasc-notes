...
class RsL2IfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.infra.RsL2IfPol", "cobra.model.l2.IfPol")
    meta.targetNameProps["name"] = "tnL2IfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsL2IfPol"
    meta.rnFormat = "rsl2IfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L2 Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38195, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40334, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18255, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18252, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL2IfPolName", "tnL2IfPolName", 18251, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL2IfPolName", prop)
