...
# ##################################################
class RsSpineAccNodePGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsSpineAccNodePGrp", "cobra.model.infra.SpineAccNodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSpineAccNodePGrp"
    meta.rnFormat = "rsspineAccNodePGrp"
    ...
    meta.rnPrefixes = [
        ('rsspineAccNodePGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40805, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30524, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30515, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30514, PropCategory.REGULAR)
