...
class RtDomP(Mo):
    """
    A target relation to a physical or virtual domain. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.infra.RtDomP", "cobra.model.infra.AttEntityP")

    meta.moClassName = "infraRtDomP"
    meta.rnFormat = "rtdomP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13267, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13266, PropCategory.REGULAR)
