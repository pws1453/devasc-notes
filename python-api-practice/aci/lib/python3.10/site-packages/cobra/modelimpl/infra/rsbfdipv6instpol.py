...
# ##################################################
class RsBfdIpv6InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsBfdIpv6InstPol", "cobra.model.bfd.Ipv6InstPol")
    meta.targetNameProps["name"] = "tnBfdIpv6InstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsBfdIpv6InstPol"
    meta.rnFormat = "rsbfdIpv6InstPol"
    ...
    meta.rnPrefixes = [
        ('rsbfdIpv6InstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38366, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40505, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22878, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22837, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnBfdIpv6InstPolName", "tnBfdIpv6InstPolName", 22836, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
