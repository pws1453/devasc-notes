...
class RsDomP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsDomP", "cobra.model.infra.ADomP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsDomP"
    meta.rnFormat = "rsdomP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37913, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40052, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14746, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13265, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13264, PropCategory.REGULAR)
