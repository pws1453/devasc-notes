...
# ##################################################
class RsFuncToEpg(Mo):
    """
    A source relation to a set of endpoints.

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFuncToEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsFuncToEpg"
    meta.rnFormat = "rsfuncToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EPGs Using Function"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37914, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 13270, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40053, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "instrImedcy", "instrImedcy", 34156, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "mode", "mode", 26266, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14747, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "primaryEncap", "primaryEncap", 23500, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 13269, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13268, PropCategory.REGULAR)
