...
class RsNodeP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsNodeP", "cobra.model.infra.ANodeP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsNodeP"
    meta.rnFormat = "rsnodeP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "To Node Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38262, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40401, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20904, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8255
    prop.defaultValueStr = "infraANodeP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 20903, PropCategory.REGULAR)
