...
# ##################################################
class RsPortDirection(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsPortDirection", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "infraRsPortDirection"
    meta.rnFormat = "rsportDirection-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Port Direction"
    ...
    meta.rnPrefixes = [
        ('rsportDirection-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38761, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deployStat", "deployStat", 34377, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "deployable"
    prop._addConstant("deployable", "deployable", 0)
    prop._addConstant("not-applied-not-exist", "not-applied-not-exist", 4)
    prop._addConstant("not-applied-pc", "not-applied-pc", 2)
    prop._addConstant("not-registered", "not-registered", 1)
    meta.props.add("deployStat", prop)

    prop = PropMeta("str", "direc", "direc", 34378, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "UpLink"
    prop._addConstant("DownLink", "downlink", 2)
    prop._addConstant("UpLink", "uplink", 1)
    meta.props.add("direc", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40900, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34383, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34379, PropCategory.REGULAR)
