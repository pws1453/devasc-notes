...
class RtDomRef(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.infra.RtDomRef", "cobra.model.edm.DomainCont")

    meta.moClassName = "infraRtDomRef"
    meta.rnFormat = "rtedmDomRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43829, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12648
    prop.defaultValueStr = "edmDomainCont"
    prop._addConstant("edmDomainCont", None, 12648)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43828, PropCategory.REGULAR)
