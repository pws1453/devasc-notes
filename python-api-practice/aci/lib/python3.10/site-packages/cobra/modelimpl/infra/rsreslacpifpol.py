...
# ##################################################
class RsResLacpIfPol(Mo):
    """
    A source relation to the port level LACP member policy configured parameters. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResLacpIfPol", "cobra.model.lacp.IfPol")
    meta.targetNameProps["name"] = "tnLacpIfPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResLacpIfPol"
    meta.rnFormat = "rsresLacpIfPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14737, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13292, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLacpIfPolName", "tnLacpIfPolName", 13291, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
