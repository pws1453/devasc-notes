...
# ##################################################
class RsResCdpIfPol(Mo):
    """
    A source relation to a CDP interface policy. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResCdpIfPol", "cobra.model.cdp.IfPol")
    meta.targetNameProps["name"] = "tnCdpIfPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResCdpIfPol"
    meta.rnFormat = "rsresCdpIfPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14738, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13286, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnCdpIfPolName", "tnCdpIfPolName", 13285, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
