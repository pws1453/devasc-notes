...
# ##################################################
class RsSpineBfdIpv6InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSpineBfdIpv6InstPol", "cobra.model.bfd.Ipv6InstPol")
    meta.targetNameProps["name"] = "tnBfdIpv6InstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSpineBfdIpv6InstPol"
    meta.rnFormat = "rsspineBfdIpv6InstPol"
    ...
    meta.rnPrefixes = [
        ('rsspineBfdIpv6InstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38758, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40897, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34376, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34372, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnBfdIpv6InstPolName", "tnBfdIpv6InstPolName", 34371, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBfdIpv6InstPolName", prop)
