...
# ##################################################
class RsMonNodeInfraPol(Mo):
    """
    A source relation to the monitoring policy model.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsMonNodeInfraPol", "cobra.model.mon.InfraPol")
    meta.targetNameProps["name"] = "tnMonInfraPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMonNodeInfraPol"
    meta.rnFormat = "rsmonNodeInfraPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access Monitoring Policy"
    ...
    meta.rnPrefixes = [
        ('rsmonNodeInfraPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37893, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40032, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14712, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13185, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonInfraPolName", "tnMonInfraPolName", 13184, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
