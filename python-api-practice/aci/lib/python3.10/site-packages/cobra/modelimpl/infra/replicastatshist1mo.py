...
# ##################################################
class ReplicaStatsHist1mo(Mo):
    """
    A class that represents historical statistics for replica in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ReplicaStatsHist1mo", "replica")
    ...
    meta.moClassName = "infraReplicaStatsHist1mo"
    meta.rnFormat = "HDinfraReplicaStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical replica stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6666, PropCategory.REGULAR)
