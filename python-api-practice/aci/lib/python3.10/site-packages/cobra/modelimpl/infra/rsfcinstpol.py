...
# ##################################################
class RsFcInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsFcInstPol", "cobra.model.fc.InstPol")
    meta.targetNameProps["name"] = "tnFcInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsFcInstPol"
    meta.rnFormat = "rsfcInstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fibre Channel Instance Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38480, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40619, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25355, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFcInstPolName", "tnFcInstPolName", 25354, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFcInstPolName", prop)
