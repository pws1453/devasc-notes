...
class RsVlanNs(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsVlanNs", "cobra.model.fvns.VlanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsVlanNs"
    meta.rnFormat = "rsvlanNs"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VLAN Pool"
    meta.writeAccessMask = 0x1800611
    meta.readAccessMask = 0x1800611
    ...
    meta.superClasses.add("cobra.model.infra.DomainToNs")

    meta.rnPrefixes = [
        ('rsvlanNs', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37926, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40065, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14768, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13310, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4559
    prop.defaultValueStr = "fvnsVlanInstP"
    prop._addConstant("fvnsVlanInstP", None, 4559)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13309, PropCategory.REGULAR)
