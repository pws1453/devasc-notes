...
# ##################################################
class RsWwnInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsWwnInstPol", "cobra.model.wwn.InstPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsWwnInstPol"
    meta.rnFormat = "rswwnInstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access WWN Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55932, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55929, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16435
    prop.defaultValueStr = "wwnInstPol"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("wwnInstPol", None, 16435)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55928, PropCategory.REGULAR)
