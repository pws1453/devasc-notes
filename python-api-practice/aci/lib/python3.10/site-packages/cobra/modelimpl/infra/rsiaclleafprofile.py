...
# ##################################################
class RsIaclLeafProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsIaclLeafProfile", "cobra.model.iacl.LeafProfile")
    meta.targetNameProps["name"] = "tnIaclLeafProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsIaclLeafProfile"
    meta.rnFormat = "rsiaclLeafProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "CoPP Prefilter Profile for Leafs"
    ...
    meta.rnPrefixes = [
        ('rsiaclLeafProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38748, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40887, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34290, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34282, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10975
    prop.defaultValueStr = "iaclLeafProfile"
    ...
    prop = PropMeta("str", "tnIaclLeafProfileName", "tnIaclLeafProfileName", 34281, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnIaclLeafProfileName", prop)
