...
# ##################################################
class RsToErrDisRecoverPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsToErrDisRecoverPol", "cobra.model.edr.ErrDisRecoverPol")
    meta.targetNameProps["name"] = "tnEdrErrDisRecoverPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsToErrDisRecoverPol"
    meta.rnFormat = "rstoErrDisRecoverPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20417, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20412, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnEdrErrDisRecoverPolName", "tnEdrErrDisRecoverPolName", 20411, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnEdrErrDisRecoverPolName", prop)
