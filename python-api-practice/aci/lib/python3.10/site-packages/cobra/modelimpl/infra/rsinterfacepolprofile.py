...
class RsInterfacePolProfile(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsInterfacePolProfile", "cobra.model.infra.AccPortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsInterfacePolProfile"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14699, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13142, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13141, PropCategory.REGULAR)
