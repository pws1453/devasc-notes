...
# ##################################################
class RsFcFabricPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsFcFabricPol", "cobra.model.fc.FabricPol")
    meta.targetNameProps["name"] = "tnFcFabricPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsFcFabricPol"
    meta.rnFormat = "rsfcFabricPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38479, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40618, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25351, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFcFabricPolName", "tnFcFabricPolName", 25350, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFcFabricPolName", prop)
