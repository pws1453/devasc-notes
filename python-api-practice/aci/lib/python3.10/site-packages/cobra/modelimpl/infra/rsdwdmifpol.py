...
# ##################################################
class RsDwdmIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsDwdmIfPol", "cobra.model.dwdm.IfPol")
    meta.targetNameProps["name"] = "tnDwdmIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsDwdmIfPol"
    meta.rnFormat = "rsdwdmIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38790, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40929, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35588, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35578, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDwdmIfPolName", "tnDwdmIfPolName", 35577, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnDwdmIfPolName", prop)
