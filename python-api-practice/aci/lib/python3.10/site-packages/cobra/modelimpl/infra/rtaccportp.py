...
class RtAccPortP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.infra.RtAccPortP", "cobra.model.infra.NodeP")

    meta.moClassName = "infraRtAccPortP"
    meta.rnFormat = "rtaccPortP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13183, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13182, PropCategory.REGULAR)
