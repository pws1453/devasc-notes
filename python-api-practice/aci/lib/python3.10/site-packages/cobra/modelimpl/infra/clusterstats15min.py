...
# ##################################################
class ClusterStats15min(Mo):
    """
    A class that represents the most current statistics for cluster in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStats15min", "cluster")
    ...
    meta.moClassName = "infraClusterStats15min"
    meta.rnFormat = "CDinfraClusterStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cluster stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.infra.ClusterStats")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDinfraClusterStats15min', False),
    ]
