...
class RtDomAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.infra.RtDomAtt", "cobra.model.fv.AEPg")

    meta.moClassName = "infraRtDomAtt"
    meta.rnFormat = "rtfvDomAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12331, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12330, PropCategory.REGULAR)
