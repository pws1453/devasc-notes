...
# ##################################################
class RsMonBrkoutInfraPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsMonBrkoutInfraPol", "cobra.model.mon.InfraPol")
    meta.targetNameProps["name"] = "tnMonInfraPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMonBrkoutInfraPol"
    meta.rnFormat = "rsmonBrkoutInfraPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Breakout Infra Monitoring Policy"
    ...
    meta.rnPrefixes = [
        ('rsmonBrkoutInfraPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38534, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40673, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27078, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27073, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonInfraPolName", "tnMonInfraPolName", 27072, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
