...
# ##################################################
class RsToInterfacePolProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToInterfacePolProfile", "cobra.model.infra.AccPortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsToInterfacePolProfile"
    meta.rnFormat = "rstoInterfacePolProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22052, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22044, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22043, PropCategory.REGULAR)
