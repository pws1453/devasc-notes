...
class Image(Mo):
    """
    The port characteristics required for accessing storage. Note that this is only used for L2 storage.

    """

    meta = ClassMeta("cobra.model.infra.Image")

    meta.moClassName = "infraImage"
    meta.rnFormat = "img-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Image Download"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14752, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6646, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
