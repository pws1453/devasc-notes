...
# ##################################################
class RsOverrideStpPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsOverrideStpPol", "cobra.model.stp.IfPol")
    meta.targetNameProps["name"] = "tnStpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOverrideStpPol"
    meta.rnFormat = "rsoverrideStpPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to STP Policy"
    ...
    meta.rnPrefixes = [
        ('rsoverrideStpPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38235, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40374, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20124, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20121, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnStpIfPolName", "tnStpIfPolName", 20120, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
