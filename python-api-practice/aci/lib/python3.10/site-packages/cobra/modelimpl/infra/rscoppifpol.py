...
# ##################################################
class RsCoppIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsCoppIfPol", "cobra.model.copp.IfPol")
    meta.targetNameProps["name"] = "tnCoppIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsCoppIfPol"
    meta.rnFormat = "rscoppIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to per interface per protocol CoPP Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38652, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40791, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30165, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30162, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnCoppIfPolName", "tnCoppIfPolName", 30161, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCoppIfPolName", prop)
