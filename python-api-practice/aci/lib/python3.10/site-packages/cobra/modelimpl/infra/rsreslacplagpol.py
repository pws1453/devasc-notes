...
# ##################################################
class RsResLacpLagPol(Mo):
    """
    A source relation to the LACP policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResLacpLagPol", "cobra.model.lacp.LagPol")
    meta.targetNameProps["name"] = "tnLacpLagPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResLacpLagPol"
    meta.rnFormat = "rsresLacpLagPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14739, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLacpLagPolName", "tnLacpLagPolName", 13294, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
