...
# ##################################################
class RsLeafCoppProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLeafCoppProfile", "cobra.model.copp.LeafProfile")
    meta.targetNameProps["name"] = "tnCoppLeafProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLeafCoppProfile"
    meta.rnFormat = "rsleafCoppProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "CoPP Profile for Leafs"
    ...
    meta.rnPrefixes = [
        ('rsleafCoppProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40804, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30523, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30512, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10011
    prop.defaultValueStr = "coppLeafProfile"
    ...
    prop = PropMeta("str", "tnCoppLeafProfileName", "tnCoppLeafProfileName", 30541, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCoppLeafProfileName", prop)
