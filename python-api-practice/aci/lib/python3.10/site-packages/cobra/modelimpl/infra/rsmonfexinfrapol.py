...
# ##################################################
class RsMonFexInfraPol(Mo):
    """
    A source relation to the monitoring policy model for the infra semantic scope.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsMonFexInfraPol", "cobra.model.mon.InfraPol")
    meta.targetNameProps["name"] = "tnMonInfraPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsMonFexInfraPol"
    meta.rnFormat = "rsmonFexInfraPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to FEX Access Monitoring Policy"
    ...
    meta.rnPrefixes = [
        ('rsmonFexInfraPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38081, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40220, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15284, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonInfraPolName", "tnMonInfraPolName", 15283, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
