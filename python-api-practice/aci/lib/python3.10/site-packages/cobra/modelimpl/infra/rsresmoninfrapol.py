...
# ##################################################
class RsResMonInfraPol(Mo):
    """
    A source relation to the monitoring policy model for the Infra semantic scope.  Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResMonInfraPol", "cobra.model.mon.InfraPol")
    meta.targetNameProps["name"] = "tnMonInfraPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResMonInfraPol"
    meta.rnFormat = "rsresMonInfraPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Monitoring Policy Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13301, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonInfraPolName", "tnMonInfraPolName", 13300, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
