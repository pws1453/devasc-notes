...
# ##################################################
class RsFexBndlGrpToAggrIf(Mo):
    """
    A source relation to an aggregated interface (collection of physical ports).

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFexBndlGrpToAggrIf", "cobra.model.pc.AggrIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "infraRsFexBndlGrpToAggrIf"
    meta.rnFormat = "rsfexBndlGrpToAggrIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 15445, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 15444, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15443, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15451, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
