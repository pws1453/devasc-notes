...
# ##################################################
class RsQosLlfcIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsQosLlfcIfPol", "cobra.model.qos.LlfcIfPol")
    meta.targetNameProps["name"] = "tnQosLlfcIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsQosLlfcIfPol"
    meta.rnFormat = "rsqosLlfcIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Interface Link Level Flow Control"
    ...
    meta.rnPrefixes = [
        ('rsqosLlfcIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 62409, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62410, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62408, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 62405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosLlfcIfPolName", "tnQosLlfcIfPolName", 62404, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnQosLlfcIfPolName", prop)
