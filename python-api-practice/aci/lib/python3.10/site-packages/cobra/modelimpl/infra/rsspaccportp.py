...
# ##################################################
class RsSpAccPortP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsSpAccPortP", "cobra.model.infra.SpAccPortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsSpAccPortP"
    meta.rnFormat = "rsspAccPortP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38431, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40570, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24392, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 24360, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8240
    prop.defaultValueStr = "infraSpAccPortP"
    prop._addConstant("infraSpAccPortP", None, 8240)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24359, PropCategory.REGULAR)
