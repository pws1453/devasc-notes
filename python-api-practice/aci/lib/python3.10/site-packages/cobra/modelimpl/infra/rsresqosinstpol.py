...
# ##################################################
class RsResQosInstPol(Mo):
    """
    A source relation for resolving QOS policy. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResQosInstPol", "cobra.model.qos.InstPol")
    meta.targetNameProps["name"] = "tnQosInstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResQosInstPol"
    meta.rnFormat = "rsresQosInstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14742, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13307, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 126
    prop.defaultValueStr = "qosInstPol"
    ...
    prop = PropMeta("str", "tnQosInstPolName", "tnQosInstPolName", 13306, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnQosInstPolName", prop)
