...
class EpPDTask(Mo):
    """
    A task to send an infrastructure endpoint group policy descriptor from one process to another. This is object is generated and used only by internal process

    """

    meta = ClassMeta("cobra.model.infra.EpPDTask")

    meta.moClassName = "infraEpPDTask"
    meta.rnFormat = "infraEpPDTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5693, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendDomDefToEpP", "senddomdeftoepp", 558)
