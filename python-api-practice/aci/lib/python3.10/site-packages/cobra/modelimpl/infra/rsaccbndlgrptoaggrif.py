...
# ##################################################
class RsAccBndlGrpToAggrIf(Mo):
    """
    A source relation to an aggregated interface (collection of physical ports).

    """

    meta = SourceRelationMeta("cobra.model.infra.RsAccBndlGrpToAggrIf", "cobra.model.pc.AggrIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "infraRsAccBndlGrpToAggrIf"
    meta.rnFormat = "rsaccBndlGrpToAggrIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 15449, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 15448, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15447, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15453, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
