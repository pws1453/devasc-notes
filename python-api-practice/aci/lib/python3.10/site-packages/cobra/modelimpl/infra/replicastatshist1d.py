...
# ##################################################
class ReplicaStatsHist1d(Mo):
    """
    A class that represents historical statistics for replica in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.infra.ReplicaStatsHist1d", "replica")
    ...
    meta.moClassName = "infraReplicaStatsHist1d"
    meta.rnFormat = "HDinfraReplicaStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical replica stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6664, PropCategory.REGULAR)
