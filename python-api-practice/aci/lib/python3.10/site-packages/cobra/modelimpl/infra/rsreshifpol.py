...
class RsResHIfPol(Mo):
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14740, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricHIfPolName", "tnFabricHIfPolName", 13288, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
