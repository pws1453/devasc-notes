...
# ##################################################
class RsL2NodeAuthPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsL2NodeAuthPol", "cobra.model.l2.NodeAuthPol")
    meta.targetNameProps["name"] = "tnL2NodeAuthPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsL2NodeAuthPol"
    meta.rnFormat = "rsl2NodeAuthPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Authentication (802.1x) policy"
    meta.writeAccessMask = 0x80300000000001
    meta.readAccessMask = 0x80300000000001
    ...
    meta.rnPrefixes = [
        ('rsl2NodeAuthPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38715, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40854, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33491, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33486, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL2NodeAuthPolName", "tnL2NodeAuthPolName", 33485, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL2NodeAuthPolName", prop)
