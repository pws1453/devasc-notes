...
class Storage(Mo):
    """
    The hypervisor storage function provides the policies used for hypervisors and virtual machines to access the storage network. For example, the VLAN and endpoint group policies.

    """

    meta = ClassMeta("cobra.model.infra.Storage")

    meta.moClassName = "infraStorage"
    meta.rnFormat = "str-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Storage"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14751, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6671, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
