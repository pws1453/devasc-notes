...
# ##################################################
class RsVipAddrNs(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.infra.RsVipAddrNs", "cobra.model.fvns.AddrInst")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsVipAddrNs"
    meta.rnFormat = "rsvipAddrNs"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VIP Range"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38122, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40261, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16377, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16376, PropCategory.REGULAR)
