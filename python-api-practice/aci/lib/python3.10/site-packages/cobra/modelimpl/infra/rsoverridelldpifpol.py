...
# ##################################################
class RsOverrideLldpIfPol(Mo):
    """
    A source relation to the LLDP interface policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsOverrideLldpIfPol", "cobra.model.lldp.IfPol")
    meta.targetNameProps["name"] = "tnLldpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOverrideLldpIfPol"
    meta.rnFormat = "rsoverrideLldpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsoverrideLldpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40057, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14755, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13282, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLldpIfPolName", "tnLldpIfPolName", 13281, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
