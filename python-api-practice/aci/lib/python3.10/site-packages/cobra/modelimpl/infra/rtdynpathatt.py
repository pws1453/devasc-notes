...
# ##################################################
class RtDynPathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtDynPathAtt", "cobra.model.l3ext.VirtualLIfP")

    meta.moClassName = "infraRtDynPathAtt"
    meta.rnFormat = "rtl3extDynPathAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54081, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15819
    prop.defaultValueStr = "l3extVirtualLIfP"
    prop._addConstant("l3extVirtualLIfP", None, 15819)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54080, PropCategory.REGULAR)
