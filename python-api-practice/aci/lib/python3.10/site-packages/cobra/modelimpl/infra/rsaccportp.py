...
class RsAccPortP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.infra.RsAccPortP", "cobra.model.infra.AccPortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsAccPortP"
    meta.rnFormat = "rsaccPortP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37886, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40025, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14705, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13181, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4367
    prop.defaultValueStr = "infraAccPortP"
    prop._addConstant("infraAccPortP", None, 4367)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13180, PropCategory.REGULAR)
