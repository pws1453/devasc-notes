...
# ##################################################
class ClusterStatsHist1mo(Mo):
    """
    A class that represents historical statistics for cluster in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.infra.ClusterStatsHist1mo", "cluster")
    ...
    meta.moClassName = "infraClusterStatsHist1mo"
    meta.rnFormat = "HDinfraClusterStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cluster stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6625, PropCategory.REGULAR)
