...
# ##################################################
class RsBfdIpv4InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsBfdIpv4InstPol", "cobra.model.bfd.Ipv4InstPol")
    meta.targetNameProps["name"] = "tnBfdIpv4InstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsBfdIpv4InstPol"
    meta.rnFormat = "rsbfdIpv4InstPol"
    ...
    meta.rnPrefixes = [
        ('rsbfdIpv4InstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38365, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40504, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22877, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22833, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnBfdIpv4InstPolName", "tnBfdIpv4InstPolName", 22832, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
