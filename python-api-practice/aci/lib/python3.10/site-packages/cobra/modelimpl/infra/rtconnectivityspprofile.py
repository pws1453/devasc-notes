...
# ##################################################
class RtConnectivitySpProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.infra.RtConnectivitySpProfile", "cobra.model.infra.HostCfg")

    meta.moClassName = "infraRtConnectivitySpProfile"
    meta.rnFormat = "rtconnectivitySpProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24389, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24388, PropCategory.REGULAR)
