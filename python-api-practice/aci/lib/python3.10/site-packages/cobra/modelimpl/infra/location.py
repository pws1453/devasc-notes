...
class Location(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.Location")

    meta.moClassName = "infraLocation"
    meta.rnFormat = "loc"
    ...
    prop = PropMeta("str", "affected", "affected", 4926, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 37924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "data", "data", 4927, PropCategory.REGULAR)
    prop.label = "Data"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40063, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "shard", "shard", 4928, PropCategory.REGULAR)
    prop.label = "Shard ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "svcId", "svcId", 20269, PropCategory.REGULAR)
