...
# ##################################################
class RtStAttEntPAtt(Mo):
    """
    A target relation to the attached entity profile.

    """

    meta = TargetRelationMeta("cobra.model.infra.RtStAttEntPAtt", "cobra.model.fv.AttEntityPathAtt")

    meta.moClassName = "infraRtStAttEntPAtt"
    meta.rnFormat = "rtfvStAttEntPAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "EPG to Path Attachment"
    meta.writeAccessMask = 0x300000000001
    meta.readAccessMask = 0x300000000013
    ...
    prop = PropMeta("str", "tCl", "tCl", 12287, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1957
    prop.defaultValueStr = "fvAttEntityPathAtt"
    prop._addConstant("fvAttEntityPathAtt", None, 1957)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12286, PropCategory.REGULAR)
