...
# ##################################################
class RsConnectivitySpProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsConnectivitySpProfile", "cobra.model.infra.SpAccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsConnectivitySpProfile"
    meta.rnFormat = "rsconnectivitySpProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Spine Access Policy Group"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24387, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24386, PropCategory.REGULAR)
