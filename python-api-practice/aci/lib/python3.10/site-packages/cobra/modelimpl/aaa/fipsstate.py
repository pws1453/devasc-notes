...
class FipsState(Mo):
    ...
    meta = ClassMeta("cobra.model.aaa.FipsState")

    meta.moClassName = "aaaFipsState"
    meta.rnFormat = "fipsstate"
    ...
    prop = PropMeta("str", "fipsMode", "fipsMode", 32632, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "reboot", "reboot", 32633, PropCategory.REGULAR)
    prop.label = "Node reboot"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
