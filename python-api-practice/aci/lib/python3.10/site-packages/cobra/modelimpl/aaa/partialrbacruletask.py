...
# ##################################################
class PartialRbacRuleTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.aaa.PartialRbacRuleTask")

    meta.moClassName = "aaaPartialRbacRuleTask"
    meta.rnFormat = "aaaPartialRbacRuleTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 20170, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PushPartialRbacRulesToRbacEp", "pushpartialrbacrulestorbacep", 1735)
