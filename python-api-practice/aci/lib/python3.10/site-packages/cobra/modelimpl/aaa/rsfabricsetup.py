...
# ##################################################
class RsFabricSetup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsFabricSetup", "cobra.model.fabric.SetupPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsFabricSetup"
    meta.rnFormat = "rsfabricSetup"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22653, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22652, PropCategory.REGULAR)
