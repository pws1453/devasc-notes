...
# ##################################################
class IDomainRefTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.aaa.IDomainRefTask")

    meta.moClassName = "aaaIDomainRefTask"
    meta.rnFormat = "aaaIDomainRefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16868, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("reportDomainRefsToRbacEp", "reportdomainrefstorbacep", 1482)
