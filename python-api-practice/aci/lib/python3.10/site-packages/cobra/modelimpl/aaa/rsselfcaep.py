...
class RsSelfcaEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.aaa.RsSelfcaEp", "cobra.model.pki.FabricSelfCAEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsSelfcaEp"
    meta.rnFormat = "rsselfcaEp"
    ...
    meta.parentClasses.add("cobra.model.aaa.FabricSelfCAEpRelnHolder")
    ...
    prop = PropMeta("str", "tCl", "tCl", 34696, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34695, PropCategory.REGULAR)
