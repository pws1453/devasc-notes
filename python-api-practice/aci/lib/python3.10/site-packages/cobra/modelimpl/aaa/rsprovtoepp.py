...
# ##################################################
class RsProvToEpp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsProvToEpp", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsProvToEpp"
    meta.rnFormat = "rsProvToEpp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to AProvider Reachability EPP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25167, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25166, PropCategory.REGULAR)
