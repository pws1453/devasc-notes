...
# ##################################################
class RsNginxFabricNode(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsNginxFabricNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsNginxFabricNode"
    meta.rnFormat = "rsnginxFabricNode"
    ...
    meta.parentClasses.add("cobra.model.aaa.FabricNodeRelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsnginxFabricNode', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 16625, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16624, PropCategory.REGULAR)
