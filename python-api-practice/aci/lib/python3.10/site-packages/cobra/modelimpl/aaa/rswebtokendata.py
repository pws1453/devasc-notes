...
# ##################################################
class RsWebTokenData(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsWebTokenData", "cobra.model.pki.WebTokenData")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsWebTokenData"
    meta.rnFormat = "rswebTokenData"
    ...
    prop = PropMeta("str", "tCl", "tCl", 36828, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 36827, PropCategory.REGULAR)
