...
# ##################################################
class RsFvEppInband(Mo):
    """
    A source relation to an in-band management endpoint profile for a fabric node management endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsFvEppInband", "cobra.model.fv.InBEpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsFvEppInband"
    meta.rnFormat = "rsfvEppInband"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11988, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11987, PropCategory.REGULAR)
