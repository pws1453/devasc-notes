...
# ##################################################
class RsCertificateEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsCertificateEp", "cobra.model.pki.FabricCommunicationEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsCertificateEp"
    meta.rnFormat = "rscertificateEp"
    ...
    meta.parentClasses.add("cobra.model.aaa.SSLCertificateEpRelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rscertificateEp', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 22529, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7602
    prop.defaultValueStr = "pkiFabricCommunicationEp"
    prop._addConstant("pkiFabricCommunicationEp", None, 7602)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22528, PropCategory.REGULAR)
