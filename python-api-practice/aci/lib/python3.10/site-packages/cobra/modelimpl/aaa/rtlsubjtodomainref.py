...
# ##################################################
class RtLSubjToDomainRef(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtLSubjToDomainRef", "cobra.model.action.LSubj")

    meta.moClassName = "aaaRtLSubjToDomainRef"
    meta.rnFormat = "rtactionLSubjToDomainRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16384, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 25
    prop.defaultValueStr = "actionLSubj"
    prop._addConstant("actionLSubj", None, 25)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16383, PropCategory.REGULAR)
