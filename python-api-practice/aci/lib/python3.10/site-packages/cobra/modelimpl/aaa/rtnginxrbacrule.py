...
# ##################################################
class RtNginxRbacRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtNginxRbacRule", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "aaaRtNginxRbacRule"
    meta.rnFormat = "rtnginxRbacRule-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20199, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20198, PropCategory.REGULAR)
