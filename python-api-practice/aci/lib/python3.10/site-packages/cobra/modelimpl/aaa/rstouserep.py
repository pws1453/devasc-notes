...
class RsToUserEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.aaa.RsToUserEp", "cobra.model.aaa.UserEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsToUserEp"
    meta.rnFormat = "rstoUserEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22082, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22081, PropCategory.REGULAR)
