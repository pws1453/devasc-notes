...
# ##################################################
class TacacsPlusProvider(Mo):
    """
    A TACACS+ provider is a remote server supporting the TACACS+ protocol that will be used for authentication.

    """

    meta = ClassMeta("cobra.model.aaa.TacacsPlusProvider")

    meta.moClassName = "aaaTacacsPlusProvider"
    meta.rnFormat = "tacacsplusprovider-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TACACS+ Provider"
    ...
    meta.rnPrefixes = [
        ('tacacsplusprovider-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authProtocol", "authProtocol", 1398, PropCategory.REGULAR)
    prop.label = "TACACS+ Authentication Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39685, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 5777, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "port", "port", 1396, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 49
    prop.defaultValueStr = "49"
    ...
    prop = PropMeta("str", "timeout", "timeout", 1397, PropCategory.REGULAR)
