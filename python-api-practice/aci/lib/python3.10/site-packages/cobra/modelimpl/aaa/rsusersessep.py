...
# ##################################################
class RsUserSessEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsUserSessEp", "cobra.model.aaa.UserSessionEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsUserSessEp"
    meta.rnFormat = "rsuserSessEp"
    ...
    meta.parentClasses.add("cobra.model.aaa.UserSessionEpRelnHolder")
    ...
    prop = PropMeta("str", "tCl", "tCl", 34399, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11009
    prop.defaultValueStr = "aaaUserSessionEp"
    prop._addConstant("aaaUserSessionEp", None, 11009)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34398, PropCategory.REGULAR)
