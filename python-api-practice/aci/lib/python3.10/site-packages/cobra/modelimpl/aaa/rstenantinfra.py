...
# ##################################################
class RsTenantInfra(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsTenantInfra", "cobra.model.fv.Tenant")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsTenantInfra"
    meta.rnFormat = "rstenantInfra"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23114, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23113, PropCategory.REGULAR)
