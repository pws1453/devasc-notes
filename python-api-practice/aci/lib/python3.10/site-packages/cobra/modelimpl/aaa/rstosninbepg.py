...
# ##################################################
class RsToSnInbEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsToSnInbEpg", "cobra.model.mgmt.InB")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsToSnInbEpg"
    meta.rnFormat = "rstoSnInbEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Inband Management to be used for talking to service engine"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55625, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55626, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55621, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55620, PropCategory.REGULAR)
