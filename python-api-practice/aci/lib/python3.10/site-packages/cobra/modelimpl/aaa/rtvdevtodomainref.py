...
# ##################################################
class RtVDevToDomainRef(Mo):
    """
    A target relation to a reference to the domain that the parent object belongs.

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtVDevToDomainRef", "cobra.model.vns.VDev")

    meta.moClassName = "aaaRtVDevToDomainRef"
    meta.rnFormat = "rtvnsVDevToDomainRef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Virtual Device"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15646, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4899
    prop.defaultValueStr = "vnsVDev"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsVDev", None, 4899)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15645, PropCategory.REGULAR)
