...
# ##################################################
class RsSecProvToEpg(Mo):
    """
    A source relation to the endpoint group through which the provider server is reachable.

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsSecProvToEpg", "cobra.model.fv.ATg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsSecProvToEpg"
    meta.rnFormat = "rsSecProvToEpg"
    ...
    meta.rnPrefixes = [
        ('rsSecProvToEpg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39682, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12015, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12014, PropCategory.REGULAR)
