...
# ##################################################
class RtVDevDomainRefContToDomainRef(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtVDevDomainRefContToDomainRef", "cobra.model.vns.VDevDomainRefCont")

    meta.moClassName = "aaaRtVDevDomainRefContToDomainRef"
    meta.rnFormat = "rtvnsVDevDomainRefContToDomainRef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "VDev DomainRef Container"
    ...
    meta.rnPrefixes = [
        ('rtvnsVDevDomainRefContToDomainRef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 18096, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6070
    prop.defaultValueStr = "vnsVDevDomainRefCont"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsVDevDomainRefCont", None, 6070)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18095, PropCategory.REGULAR)
