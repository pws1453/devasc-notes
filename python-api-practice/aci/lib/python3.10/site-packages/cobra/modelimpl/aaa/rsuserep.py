...
class RsUserEp(Mo):
    """
    A source relation to a user endpoint. This object is managed internally and should not be modified by the user.

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsUserEp", "cobra.model.aaa.UserEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsUserEp"
    meta.rnFormat = "rsuserEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12007, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1491
    prop.defaultValueStr = "aaaUserEp"
    prop._addConstant("aaaUserEp", None, 1491)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12006, PropCategory.REGULAR)
