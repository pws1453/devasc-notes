...
# ##################################################
class RtTenantToDomainRef(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtTenantToDomainRef", "cobra.model.dbg.Tenant")

    meta.moClassName = "aaaRtTenantToDomainRef"
    meta.rnFormat = "rtdbgTenantToDomainRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16352, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4038
    prop.defaultValueStr = "dbgTenant"
    prop._addConstant("dbgTenant", None, 4038)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16351, PropCategory.REGULAR)
