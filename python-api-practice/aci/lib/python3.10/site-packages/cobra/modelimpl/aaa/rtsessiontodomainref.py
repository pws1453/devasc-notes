...
# ##################################################
class RtSessionToDomainRef(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtSessionToDomainRef", "cobra.model.span.Session")

    meta.moClassName = "aaaRtSessionToDomainRef"
    meta.rnFormat = "rtspanSessionToDomainRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16582, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16581, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 16585, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
