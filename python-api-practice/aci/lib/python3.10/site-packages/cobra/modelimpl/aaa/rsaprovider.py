...
# ##################################################
class RsaProvider(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.aaa.RsaProvider")

    meta.moClassName = "aaaRsaProvider"
    meta.rnFormat = "rsaprovider-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "RSA Provider"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38745, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authPort", "authPort", 34231, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop = PropMeta("str", "authProtocol", "authProtocol", 34233, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40884, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34241, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 34234, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "timeout", "timeout", 34232, PropCategory.REGULAR)
