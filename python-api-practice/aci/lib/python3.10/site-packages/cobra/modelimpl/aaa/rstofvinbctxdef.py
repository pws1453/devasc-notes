...
# ##################################################
class RsToFvInbCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsToFvInbCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsToFvInbCtxDef"
    meta.rnFormat = "rstoFvInbCtxDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55611, PropCategory.REGULAR)
