...
# ##################################################
class RsDomainRef(Mo):
    """
    A source relation to an AAA domain reference.

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsDomainRef", "cobra.model.aaa.DomainRef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsDomainRef"
    meta.rnFormat = "rsdomainRef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11984, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11983, PropCategory.REGULAR)
