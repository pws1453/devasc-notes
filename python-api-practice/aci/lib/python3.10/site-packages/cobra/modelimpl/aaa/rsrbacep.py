...
class RsRbacEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.aaa.RsRbacEp", "cobra.model.aaa.RbacEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsRbacEp"
    meta.rnFormat = "rsrbacEp"
    ...
    meta.parentClasses.add("cobra.model.aaa.RbacEpRelnHolder")
    ...
    prop = PropMeta("str", "tCl", "tCl", 16067, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5473
    prop.defaultValueStr = "aaaRbacEp"
    prop._addConstant("aaaRbacEp", None, 5473)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16066, PropCategory.REGULAR)
