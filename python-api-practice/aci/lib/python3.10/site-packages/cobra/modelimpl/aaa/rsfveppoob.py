...
class RsFvEppOob(Mo):
    """
    A source relation to an out-of-band management endpoint profile for a fabric node management endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsFvEppOob", "cobra.model.fv.OoBEpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsFvEppOob"
    meta.rnFormat = "rsfvEppOob"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11992, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11991, PropCategory.REGULAR)
