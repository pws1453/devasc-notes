...
# ##################################################
class RtNginxIRbacRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtNginxIRbacRule", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "aaaRtNginxIRbacRule"
    meta.rnFormat = "rtnginxIRbacRule-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.aaa.IRbacRule")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtnginxIRbacRule-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 20195, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20194, PropCategory.REGULAR)
