...
class CtrlrRetP(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RtAaaCtrlrRetLocalP", "rtfaultAaaCtrlrRetLocalP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RtAaaCtrlrRetP", "rtfaultAaaCtrlrRetP-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37528, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39667, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
