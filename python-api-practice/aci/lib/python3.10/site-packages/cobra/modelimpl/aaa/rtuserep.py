...
class RtUserEp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.aaa.RtUserEp", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "aaaRtUserEp"
    meta.rnFormat = "rtuserEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12009, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12008, PropCategory.REGULAR)
