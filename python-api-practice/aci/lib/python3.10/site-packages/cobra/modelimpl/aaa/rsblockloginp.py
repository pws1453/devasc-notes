...
# ##################################################
class RsBlockLoginP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsBlockLoginP", "cobra.model.aaa.BlockLoginProfile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsBlockLoginP"
    meta.rnFormat = "rsblockLoginP"
    ...
    meta.parentClasses.add("cobra.model.aaa.BlockLoginPRelnHolder")
    ...
    prop = PropMeta("str", "tCl", "tCl", 59775, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17712
    prop.defaultValueStr = "aaaBlockLoginProfile"
    prop._addConstant("aaaBlockLoginProfile", None, 17712)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 59774, PropCategory.REGULAR)
