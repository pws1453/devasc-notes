...
# ##################################################
class RsNginxRbacRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsNginxRbacRule", "cobra.model.aaa.RbacRule")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsNginxRbacRule"
    meta.rnFormat = "rsnginxRbacRule"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20197, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5475
    prop.defaultValueStr = "aaaRbacRule"
    prop._addConstant("aaaRbacRule", None, 5475)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20196, PropCategory.REGULAR)
