...
# ##################################################
class ADomainRefTask(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = ClassMeta("cobra.model.aaa.ADomainRefTask")

    meta.moClassName = "aaaADomainRefTask"
    meta.rnFormat = "aaaADomainRefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16061, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PushDomainRefsToRbacEp", "pushdomainrefstorbacep", 1363)
