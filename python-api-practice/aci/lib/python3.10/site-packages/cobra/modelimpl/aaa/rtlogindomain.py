...
# ##################################################
class RtLoginDomain(Mo):
    """
    A target relation to an AAA login domain for authentication and authorization.

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtLoginDomain", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "aaaRtLoginDomain"
    meta.rnFormat = "rtloginDomain-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11998, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11997, PropCategory.REGULAR)
