...
class FabricSec(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RtCtrlrFipsMode", "rtpolCtrlrFipsMode-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40650, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fipsReboot", "fipsReboot", 26115, PropCategory.REGULAR)
