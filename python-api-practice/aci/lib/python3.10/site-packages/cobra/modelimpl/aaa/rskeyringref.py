...
# ##################################################
class RsKeyringRef(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsKeyringRef", "cobra.model.pki.KeyRing")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsKeyringRef"
    meta.rnFormat = "rskeyringRef"
    ...
    meta.parentClasses.add("cobra.model.aaa.KeyringRelnHolder")
    ...
    prop = PropMeta("str", "tCl", "tCl", 16339, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16338, PropCategory.REGULAR)
