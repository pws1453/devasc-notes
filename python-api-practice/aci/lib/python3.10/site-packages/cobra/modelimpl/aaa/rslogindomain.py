...
# ##################################################
class RsLoginDomain(Mo):
    """
    A source relation to an AAA login domain for authentication and authorization.

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsLoginDomain", "cobra.model.aaa.LoginDomain")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsLoginDomain"
    meta.rnFormat = "rsloginDomain"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11996, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1593
    prop.defaultValueStr = "aaaLoginDomain"
    prop._addConstant("aaaLoginDomain", None, 1593)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11995, PropCategory.REGULAR)
