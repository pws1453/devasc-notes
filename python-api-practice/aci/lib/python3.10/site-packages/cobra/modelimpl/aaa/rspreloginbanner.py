...
# ##################################################
class RsPreLoginBanner(Mo):
    """
    A source relation to the informational banner displayed before user login authentication.

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsPreLoginBanner", "cobra.model.aaa.PreLoginBanner")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsPreLoginBanner"
    meta.rnFormat = "rspreLoginBanner"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Pre Login Banner"
    ...
    meta.parentClasses.add("cobra.model.aaa.SecRelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rspreLoginBanner', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12004, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1494
    prop.defaultValueStr = "aaaPreLoginBanner"
    prop._addConstant("aaaPreLoginBanner", None, 1494)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12003, PropCategory.REGULAR)
