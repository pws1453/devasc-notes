...
class UserTask(Mo):
    """
    The base class for user tasks.

    """

    meta = ClassMeta("cobra.model.aaa.UserTask")

    meta.moClassName = "aaaUserTask"
    meta.rnFormat = "aaaUserTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5656, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ResetAdminPasswd", "resetadminpasswd", 28)
