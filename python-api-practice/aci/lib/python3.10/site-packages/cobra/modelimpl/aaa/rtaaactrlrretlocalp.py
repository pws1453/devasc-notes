...
# ##################################################
class RtAaaCtrlrRetLocalP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtAaaCtrlrRetLocalP", "cobra.model.fault.RelnHolder")

    meta.moClassName = "aaaRtAaaCtrlrRetLocalP"
    meta.rnFormat = "rtfaultAaaCtrlrRetLocalP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28349, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28348, PropCategory.REGULAR)
