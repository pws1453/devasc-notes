...
# ##################################################
class RadiusProvider(Mo):
    """
    A RADIUS provider is a remote server supporting the RADIUS protocol that will be used for authentication.

    """

    meta = ClassMeta("cobra.model.aaa.RadiusProvider")

    meta.moClassName = "aaaRadiusProvider"
    meta.rnFormat = "radiusprovider-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "RADIUS Provider"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37544, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authPort", "authPort", 1386, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 1812
    prop.defaultValueStr = "1812"
    meta.props.add("authPort", prop)

    prop = PropMeta("str", "authProtocol", "authProtocol", 1388, PropCategory.REGULAR)
    prop.label = "Authentication Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "pap"
    prop._addConstant("chap", "chap", 1)
    prop._addConstant("mschap", "ms-chap", 2)
    prop._addConstant("pap", "pap", 0)
    meta.props.add("authProtocol", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39683, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14152, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 5772, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "timeout", "timeout", 1387, PropCategory.REGULAR)
