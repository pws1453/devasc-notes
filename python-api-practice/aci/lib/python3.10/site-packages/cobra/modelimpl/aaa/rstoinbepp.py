...
class RsToInbEpp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.aaa.RsToInbEpp", "cobra.model.fv.InBEpP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsToInbEpp"
    meta.rnFormat = "rstoInbEpp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55615, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55614, PropCategory.REGULAR)
