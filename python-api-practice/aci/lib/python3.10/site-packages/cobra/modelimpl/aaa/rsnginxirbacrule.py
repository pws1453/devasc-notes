...
# ##################################################
class RsNginxIRbacRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsNginxIRbacRule", "cobra.model.aaa.IRbacRule")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsNginxIRbacRule"
    meta.rnFormat = "rsnginxIRbacRule"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20193, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5476
    prop.defaultValueStr = "aaaIRbacRule"
    prop._addConstant("aaaIRbacRule", None, 5476)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20192, PropCategory.REGULAR)
