...
class PwdStrengthProfile(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 38724, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40863, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "pwdClassFlags", "pwdClassFlags", 33597, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pwdMaxLength", "pwdMaxLength", 33595, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pwdMinLength", "pwdMinLength", 33594, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pwdStrengthTestType", "pwdStrengthTestType", 33596, PropCategory.REGULAR)
