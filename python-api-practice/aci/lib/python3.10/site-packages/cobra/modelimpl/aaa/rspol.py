...
class RsPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.aaa.RsPol", "cobra.model.comm.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsPol"
    meta.rnFormat = "rspol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12000, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11999, PropCategory.REGULAR)
