...
class PartialRbacRule(Mo):
    ...
    prop = PropMeta("str", "allowWrites", "allowWrites", 20158, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38238, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40377, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "partialObjectDn", "partialObjectDn", 20156, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, partialObjectDn, domain, markDirty=True, **creationProps):
