...
# ##################################################
class RsToInbL3Dom(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsToInbL3Dom", "cobra.model.l3.Dom")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "aaaRsToInbL3Dom"
    meta.rnFormat = "rstoInbL3Dom"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55618, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3770
    prop.defaultValueStr = "l3Dom"
    ...
    prop = PropMeta("str", "tDn", "tDn", 55617, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 55627, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
