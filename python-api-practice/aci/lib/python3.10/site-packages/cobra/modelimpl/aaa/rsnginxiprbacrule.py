...
# ##################################################
class RsNginxIPRbacRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsNginxIPRbacRule", "cobra.model.aaa.IPRbacRule")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsNginxIPRbacRule"
    meta.rnFormat = "rsnginxIPRbacRule"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20189, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6800
    prop.defaultValueStr = "aaaIPRbacRule"
    prop._addConstant("aaaIPRbacRule", None, 6800)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20188, PropCategory.REGULAR)
