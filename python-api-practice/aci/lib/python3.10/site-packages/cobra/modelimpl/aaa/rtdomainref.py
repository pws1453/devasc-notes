...
# ##################################################
class RtDomainRef(Mo):
    """
    The target relation to resolve an RBAC domain.

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtDomainRef", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "aaaRtDomainRef"
    meta.rnFormat = "rtdomainRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11986, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11985, PropCategory.REGULAR)
