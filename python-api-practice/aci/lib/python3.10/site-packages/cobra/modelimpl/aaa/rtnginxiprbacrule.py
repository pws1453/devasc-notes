...
# ##################################################
class RtNginxIPRbacRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtNginxIPRbacRule", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "aaaRtNginxIPRbacRule"
    meta.rnFormat = "rtnginxIPRbacRule-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.aaa.IPRbacRule")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtnginxIPRbacRule-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 20191, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20190, PropCategory.REGULAR)
