...
# ##################################################
class RtAaaCtrlrRetP(Mo):
    """
    A target relation to resolve a controller audit retention policy.

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtAaaCtrlrRetP", "cobra.model.fault.RelnHolder")

    meta.moClassName = "aaaRtAaaCtrlrRetP"
    meta.rnFormat = "rtfaultAaaCtrlrRetP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13365, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13364, PropCategory.REGULAR)
