...
class RtToUserEp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.aaa.RtToUserEp", "cobra.model.aaa.UserEp")

    meta.moClassName = "aaaRtToUserEp"
    meta.rnFormat = "rttoUserEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22083, PropCategory.REGULAR)
