...
class AppUser(Mo):
    ...
    meta = ClassMeta("cobra.model.aaa.AppUser")

    meta.moClassName = "aaaAppUser"
    meta.rnFormat = "appuser-%(name)s"
    ...
    prop = PropMeta("str", "ciscoAvPair", "ciscoAvPair", 28490, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "descr", "descr", 29992, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28497, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 28495, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
