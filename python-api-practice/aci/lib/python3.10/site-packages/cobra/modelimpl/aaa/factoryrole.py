...
# ##################################################
class FactoryRole(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.aaa.FactoryRole")

    meta.moClassName = "aaaFactoryRole"
    meta.rnFormat = "factoryrole-%(name)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38156, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40295, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 17613, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "priv", "priv", 17614, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "resetToFactory", "resetToFactory", 17615, PropCategory.REGULAR)
