...
# ##################################################
class RtScriptHandlerStateToDomainRef(Mo):
    """
    A target relation to a reference to the domain that the parent object belongs.

    """

    meta = TargetRelationMeta("cobra.model.aaa.RtScriptHandlerStateToDomainRef", "cobra.model.vns.ScriptHandlerState")

    meta.moClassName = "aaaRtScriptHandlerStateToDomainRef"
    meta.rnFormat = "rtvnsScriptHandlerStateToDomainRef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvnsScriptHandlerStateToDomainRef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 15729, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4850
    prop.defaultValueStr = "vnsScriptHandlerState"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsScriptHandlerState", None, 4850)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15728, PropCategory.REGULAR)
