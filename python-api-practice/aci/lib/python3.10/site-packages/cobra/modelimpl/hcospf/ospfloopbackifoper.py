...
# ##################################################
class OspfLoopbackIfOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcospf.OspfLoopbackIfOper")

    meta.moClassName = "hcospfOspfLoopbackIfOper"
    meta.rnFormat = "oper"
    meta.category = MoCategory.REGULAR
    meta.label = "Ospf Loopback Oper Mo"
    ...
    prop = PropMeta("str", "address", "address", 55857, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "neighborId", "neighborId", 55856, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("neighborId", prop)
