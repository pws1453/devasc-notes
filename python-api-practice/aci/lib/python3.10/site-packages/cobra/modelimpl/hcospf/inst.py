...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.hcospf.Inst")

    meta.moClassName = "hcospfInst"
    ...
    meta.childClasses.add("cobra.model.hcospf.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcospf.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.hcospf.Entity")

    meta.superClasses.add("cobra.model.nw.Conn")
    meta.superClasses.add("cobra.model.l3.ProtInst")
    meta.superClasses.add("cobra.model.hcospf.AInst")
    ...
    prop = PropMeta("str", "name", "name", 50765, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
