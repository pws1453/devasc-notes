...
# ##################################################
class OspfTunnIfOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcospf.OspfTunnIfOper")

    meta.moClassName = "hcospfOspfTunnIfOper"
    meta.rnFormat = "oper"
    meta.category = MoCategory.REGULAR
    meta.label = "Ospf Tunnel Oper Mo"
    ...
    prop = PropMeta("str", "address", "address", 55855, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "neighborId", "neighborId", 55854, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
