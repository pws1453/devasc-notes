...
# ##################################################
class RsLoopbackIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcospf.RsLoopbackIf", "cobra.model.hcl3.LoopbackRoutedIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hcospfRsLoopbackIf"
    meta.rnFormat = "rsloopbackIf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Loopback If Attachment"
    ...
    meta.childClasses.add("cobra.model.hcospf.OspfLoopbackIfOper")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcospf.OspfLoopbackIfOper", "oper"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 51367, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51366, PropCategory.REGULAR)
