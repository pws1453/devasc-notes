...
class Area(Mo):
    ...
    meta = ClassMeta("cobra.model.hcospf.Area")

    meta.moClassName = "hcospfArea"
    ...
    meta.superClasses.add("cobra.model.hcospf.AArea")
    ...
    prop = PropMeta("str", "cost", "cost", 50432, PropCategory.REGULAR)
    prop.label = "Cost"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 50431, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "id", "id", 50763, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 50430, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
