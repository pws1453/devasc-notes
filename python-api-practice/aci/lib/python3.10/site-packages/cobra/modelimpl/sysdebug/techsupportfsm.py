...
# ##################################################
class TechSupportFsm(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.sysdebug.TechSupportFsm")

    meta.moClassName = "sysdebugTechSupportFsm"
    meta.rnFormat = "sysdebugTechSupportFsm-%(id)s"
    ...
    prop = PropMeta("str", "currStage", "currStage", 5722, PropCategory.REGULAR)
    prop.label = "Current Stage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("DeleteTechSupFileBegin", "deletetechsupfilebegin", 93)
    prop._addConstant("DeleteTechSupFileFail", "deletetechsupfilefail", 200)
    prop._addConstant("DeleteTechSupFileLocal", "deletetechsupfilelocal", 94)
    prop._addConstant("DeleteTechSupFilePeer", "deletetechsupfilepeer", 95)
    prop._addConstant("DeleteTechSupFileSuccess", "deletetechsupfilesuccess", 201)
    prop._addConstant("DownloadBegin", "downloadbegin", 96)
    prop._addConstant("DownloadCopyPrimary", "downloadcopyprimary", 98)
    prop._addConstant("DownloadCopySub", "downloadcopysub", 97)
    prop._addConstant("DownloadDeletePrimary", "downloaddeleteprimary", 100)
    prop._addConstant("DownloadDeleteSub", "downloaddeletesub", 99)
    prop._addConstant("DownloadFail", "downloadfail", 202)
    prop._addConstant("DownloadSuccess", "downloadsuccess", 203)
    prop._addConstant("InitiateBegin", "initiatebegin", 91)
    prop._addConstant("InitiateFail", "initiatefail", 204)
    prop._addConstant("InitiateLocal", "initiatelocal", 92)
    prop._addConstant("InitiateSuccess", "initiatesuccess", 205)
    ...
    prop = PropMeta("str", "flags", "flags", 60, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 5721, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("DeleteTechSupFile", "deletetechsupfile", 276)
    prop._addConstant("Download", "download", 277)
    prop._addConstant("Initiate", "initiate", 275)
    prop._addConstant("none", "none", 0)
    ...
    prop = PropMeta("str", "prevStage", "prevStage", 5723, PropCategory.REGULAR)
