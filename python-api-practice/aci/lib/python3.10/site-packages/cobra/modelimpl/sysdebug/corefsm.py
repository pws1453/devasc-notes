...
class CoreFsm(Mo):
    ...
    meta = ClassMeta("cobra.model.sysdebug.CoreFsm")

    meta.moClassName = "sysdebugCoreFsm"
    meta.rnFormat = "sysdebugCoreFsm-%(id)s"
    ...
    prop = PropMeta("str", "currStage", "currStage", 5713, PropCategory.REGULAR)
    prop.label = "Current Stage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("DownloadBegin", "downloadbegin", 101)
    prop._addConstant("DownloadCopyPrimary", "downloadcopyprimary", 103)
    prop._addConstant("DownloadCopySub", "downloadcopysub", 102)
    prop._addConstant("DownloadDeletePrimary", "downloaddeleteprimary", 105)
    prop._addConstant("DownloadDeleteSub", "downloaddeletesub", 104)
    prop._addConstant("DownloadFail", "downloadfail", 194)
    prop._addConstant("DownloadSuccess", "downloadsuccess", 195)
    ...
    prop = PropMeta("str", "id", "id", 5712, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("Download", "download", 278)
    prop._addConstant("none", "none", 0)
    ...
    prop = PropMeta("str", "prevStage", "prevStage", 5714, PropCategory.REGULAR)
