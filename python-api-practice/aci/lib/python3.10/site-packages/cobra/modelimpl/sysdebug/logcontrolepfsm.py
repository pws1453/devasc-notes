...
# ##################################################
class LogControlEpFsm(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.sysdebug.LogControlEpFsm")

    meta.moClassName = "sysdebugLogControlEpFsm"
    meta.rnFormat = "sysdebugLogControlEpFsm-%(id)s"
    ...
    prop = PropMeta("str", "currStage", "currStage", 5716, PropCategory.REGULAR)
    prop.label = "Current Stage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("LogControlPersistBegin", "logcontrolpersistbegin", 106)
    prop._addConstant("LogControlPersistFail", "logcontrolpersistfail", 196)
    prop._addConstant("LogControlPersistLocal", "logcontrolpersistlocal", 107)
    prop._addConstant("LogControlPersistPeer", "logcontrolpersistpeer", 108)
    prop._addConstant("LogControlPersistSuccess", "logcontrolpersistsuccess", 197)
    ...
    prop = PropMeta("str", "id", "id", 5715, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("LogControlPersist", "logcontrolpersist", 279)
    prop._addConstant("none", "none", 0)
    ...
    prop = PropMeta("str", "prevStage", "prevStage", 5717, PropCategory.REGULAR)
