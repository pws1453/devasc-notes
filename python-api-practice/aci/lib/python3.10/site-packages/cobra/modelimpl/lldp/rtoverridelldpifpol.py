...
# ##################################################
class RtOverrideLldpIfPol(Mo):
    """
    A target relation to the LLDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtOverrideLldpIfPol", "cobra.model.infra.AttPolicyGroup")

    meta.moClassName = "lldpRtOverrideLldpIfPol"
    meta.rnFormat = "rtinfraOverrideLldpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13284, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13283, PropCategory.REGULAR)
