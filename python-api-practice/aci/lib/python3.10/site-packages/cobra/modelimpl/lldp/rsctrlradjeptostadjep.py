...
# ##################################################
class RsCtrlrAdjEpToStAdjEp(Mo):
    """
    A source relation to the ARP static adjacency endpoint.

    """

    meta = SourceRelationMeta("cobra.model.lldp.RsCtrlrAdjEpToStAdjEp", "cobra.model.arp.StAdjEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "lldpRsCtrlrAdjEpToStAdjEp"
    meta.rnFormat = "rsCtrlrAdjEpToStAdjEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16135, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2541
    prop.defaultValueStr = "arpStAdjEp"
    prop._addConstant("arpStAdjEp", None, 2541)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16134, PropCategory.REGULAR)
