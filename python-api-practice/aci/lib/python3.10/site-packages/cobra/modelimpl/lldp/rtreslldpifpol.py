...
# ##################################################
class RtResLldpIfPol(Mo):
    """
    A target relation to the LLDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtResLldpIfPol", "cobra.model.infra.Infra")

    meta.moClassName = "lldpRtResLldpIfPol"
    meta.rnFormat = "rtresLldpIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13299, PropCategory.REGULAR)
