...
# ##################################################
class RtSpinePGrpToLldpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtSpinePGrpToLldpIfPol", "cobra.model.infra.SpineAccNodePGrp")

    meta.moClassName = "lldpRtSpinePGrpToLldpIfPol"
    meta.rnFormat = "rtinfraSpinePGrpToLldpIfPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtinfraSpinePGrpToLldpIfPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 54540, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54539, PropCategory.REGULAR)
