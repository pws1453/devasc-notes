...
# ##################################################
class RtVswitchOverrideLldpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtVswitchOverrideLldpIfPol", "cobra.model.vmm.VSwitchPolicyCont")

    meta.moClassName = "lldpRtVswitchOverrideLldpIfPol"
    meta.rnFormat = "rtvmmVswitchOverrideLldpIfPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvmmVswitchOverrideLldpIfPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23013, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7780
    prop.defaultValueStr = "vmmVSwitchPolicyCont"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmVSwitchPolicyCont", None, 7780)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23012, PropCategory.REGULAR)
