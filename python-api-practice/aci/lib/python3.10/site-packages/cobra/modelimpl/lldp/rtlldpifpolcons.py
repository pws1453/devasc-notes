...
# ##################################################
class RtLldpIfPolCons(Mo):
    """
    A target relation to the LLDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtLldpIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "lldpRtLldpIfPolCons"
    meta.rnFormat = "rtl1LldpIfPolCons-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Ethernet Interface"
    meta.writeAccessMask = 0x2000000000001
    meta.readAccessMask = 0x2100000000011
    ...
    prop = PropMeta("str", "tCl", "tCl", 12765, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12764, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15116, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
