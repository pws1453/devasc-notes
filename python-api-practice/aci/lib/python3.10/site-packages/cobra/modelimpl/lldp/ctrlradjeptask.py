...
# ##################################################
class CtrlrAdjEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.lldp.CtrlrAdjEpTask")

    meta.moClassName = "lldpCtrlrAdjEpTask"
    meta.rnFormat = "lldpCtrlrAdjEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 22527, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("handshakeWithApic", "handshakewithapic", 1955)
