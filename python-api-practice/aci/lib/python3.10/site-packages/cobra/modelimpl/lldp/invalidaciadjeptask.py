...
# ##################################################
class InvalidAciAdjEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.lldp.InvalidAciAdjEpTask")

    meta.moClassName = "lldpInvalidAciAdjEpTask"
    meta.rnFormat = "lldpInvalidAciAdjEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 61978, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("handshakeWithPeer", "handshakewithpeer", 4021)
