...
# ##################################################
class InstIfSendTaskTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.lldp.InstIfSendTaskTask")

    meta.moClassName = "lldpInstIfSendTaskTask"
    meta.rnFormat = "lldpInstIfSendTaskTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33118, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("apicIfSend", "apicifsend", 3660)
    prop._addConstant("nodeIfSend", "nodeifsend", 2727)
