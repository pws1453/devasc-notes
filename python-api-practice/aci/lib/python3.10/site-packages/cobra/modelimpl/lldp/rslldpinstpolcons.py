...
# ##################################################
class RsLldpInstPolCons(Mo):
    """
    A source relation to the node level LLDP policy.

    """

    meta = SourceRelationMeta("cobra.model.lldp.RsLldpInstPolCons", "cobra.model.lldp.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "lldpRsLldpInstPolCons"
    meta.rnFormat = "rslldpInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Lldp Instance Policy Consumption"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12669, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 689
    prop.defaultValueStr = "lldpInstPol"
    prop._addConstant("lldpInstPol", None, 689)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12668, PropCategory.REGULAR)
