...
class Entity(Mo):
    """
    LLDP allows network devices to advertise information about themselves to other devices on the network. This protocol runs over the data-link layer, which allows two systems running different network layer protocols to learn about each other.

    """

    meta = ClassMeta("cobra.model.lldp.Entity")

    meta.moClassName = "lldpEntity"
    meta.rnFormat = "lldp"
    meta.category = MoCategory.REGULAR
    meta.label = "LLDP Entity"
    ...
    meta.childClasses.add("cobra.model.lldp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.lldp.Inst", "inst"))
    ...
    meta.superClasses.add("cobra.model.l2.ProtEntity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14484, PropCategory.REGULAR)
