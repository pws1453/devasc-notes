...
# ##################################################
class RtResLldpInstPol(Mo):
    """
    A target relation to the node level LLDP policy.

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtResLldpInstPol", "cobra.model.fabric.Inst")

    meta.moClassName = "lldpRtResLldpInstPol"
    meta.rnFormat = "rtresLldpInstPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11744, PropCategory.REGULAR)
