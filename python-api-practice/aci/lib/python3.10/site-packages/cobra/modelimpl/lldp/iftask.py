...
class IfTask(Mo):
    ...
    meta = ClassMeta("cobra.model.lldp.IfTask")

    meta.moClassName = "lldpIfTask"
    meta.rnFormat = "lldpIfTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5666, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("lldpDiscovery", "lldpdiscovery", 226)
    prop._addConstant("none", "none", 0)
    prop._addConstant("updateLldpIf", "updatelldpif", 665)
