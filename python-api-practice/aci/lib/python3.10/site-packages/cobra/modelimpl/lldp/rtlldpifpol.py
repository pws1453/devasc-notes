...
# ##################################################
class RtLldpIfPol(Mo):
    """
    A target relation to the LLDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtLldpIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "lldpRtLldpIfPol"
    meta.rnFormat = "rtinfraLldpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13228, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13227, PropCategory.REGULAR)
