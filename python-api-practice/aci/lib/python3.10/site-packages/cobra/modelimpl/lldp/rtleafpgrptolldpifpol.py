...
# ##################################################
class RtLeafPGrpToLldpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtLeafPGrpToLldpIfPol", "cobra.model.infra.AccNodePGrp")

    meta.moClassName = "lldpRtLeafPGrpToLldpIfPol"
    meta.rnFormat = "rtinfraLeafPGrpToLldpIfPol-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x82100000000011
    ...
    meta.rnPrefixes = [
        ('rtinfraLeafPGrpToLldpIfPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 54532, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54531, PropCategory.REGULAR)
