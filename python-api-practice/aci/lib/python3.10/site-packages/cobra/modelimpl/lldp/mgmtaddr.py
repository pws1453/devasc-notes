...
class MgmtAddr(Mo):
    ...
    meta = ClassMeta("cobra.model.lldp.MgmtAddr")

    meta.moClassName = "lldpMgmtAddr"
    ...
    meta.superClasses.add("cobra.model.lldp.Addr")

    meta.rnPrefixes = [
        ('mgmt-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 6878, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
