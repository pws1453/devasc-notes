...
# ##################################################
class InstSendTaskTask(Mo):
    """
    A task returned by or provided to the application or task.

    """

    meta = ClassMeta("cobra.model.lldp.InstSendTaskTask")

    meta.moClassName = "lldpInstSendTaskTask"
    meta.rnFormat = "lldpInstSendTaskTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16262, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("nodeStart", "nodestart", 1850)
