...
# ##################################################
class RtDefaultLldpIfPol(Mo):
    """
    A target relation to the LLDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lldp.RtDefaultLldpIfPol", "cobra.model.vmm.DomP")

    meta.moClassName = "lldpRtDefaultLldpIfPol"
    meta.rnFormat = "rtvmmDefaultLldpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12478, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12477, PropCategory.REGULAR)
