...
class DomP(Mo):
    ...
    meta = ClassMeta("cobra.model.phys.DomP")

    meta.moClassName = "physDomP"
    meta.rnFormat = "phys-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Physical Domain"
    meta.writeAccessMask = 0x1800611
    meta.readAccessMask = 0x4080384001800613
    ...
    meta.childClasses.add("cobra.model.phys.RtALDevToPhysDomP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.phys.RtALDevToPhysDomP", "rtvnsALDevToPhysDomP-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37619, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39758, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14223, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7001, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
