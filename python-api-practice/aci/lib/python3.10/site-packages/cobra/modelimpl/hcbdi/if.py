...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbdi.If")

    meta.moClassName = "hcbdiIf"
    meta.rnFormat = "bdi"
    meta.category = MoCategory.REGULAR
    meta.label = "Bridge Domain Interface"
    ...
    meta.childClasses.add("cobra.model.hcbdi.IfOper")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcbdi.IfOper", "oper"))
    ...
    prop = PropMeta("str", "id", "id", 50265, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
