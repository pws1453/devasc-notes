...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.dot1x.Inst")

    meta.moClassName = "dot1xInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Dot1x Instance"
    ...
    meta.childClasses.add("cobra.model.dot1x.If")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dot1x.If", "if-"))
    ...
    prop = PropMeta("str", "aaaAuthGroup", "aaaAuthGroup", 32684, PropCategory.REGULAR)
    prop.label = "AAA Authentication Group"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("aaaAuthGroup", prop)
    ...
    prop = PropMeta("str", "failAuthEpg", "failAuthEpg", 34158, PropCategory.REGULAR)
    prop.label = "End Point Group"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("failAuthEpg", prop)

    prop = PropMeta("str", "failAuthVlan", "failAuthVlan", 34157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33316, PropCategory.REGULAR)
