...
class Nic(Mo):
    ...
    meta = ClassMeta("cobra.model.dot1x.Nic")

    meta.moClassName = "dot1xNic"
    meta.rnFormat = "dot1xnic-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "dot1x Nic Class"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33358, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 33357, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vlanType", "vlanType", 37107, PropCategory.REGULAR)
    prop.label = "VlanType"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
