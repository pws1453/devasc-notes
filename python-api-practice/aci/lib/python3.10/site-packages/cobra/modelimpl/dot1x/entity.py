...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.dot1x.Entity")

    meta.moClassName = "dot1xEntity"
    meta.rnFormat = "dot1x"
    meta.category = MoCategory.REGULAR
    meta.label = "Dot1x Entity"
    ...
    meta.childClasses.add("cobra.model.dot1x.Inst")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dot1x.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33315, PropCategory.REGULAR)
