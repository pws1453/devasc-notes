...
class VDAEpTask(Mo):
    ...
    meta = ClassMeta("cobra.model.dot1x.VDAEpTask")

    meta.moClassName = "dot1xVDAEpTask"
    meta.rnFormat = "dot1xVDAEpTask-%(id)s"
    meta.category = MoCategory.TASK
    meta.label = "None"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x4004000000001
    ...
    prop = PropMeta("str", "id", "id", 33314, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DAEpAttachorDetach", "daepattachordetach", 2772)
