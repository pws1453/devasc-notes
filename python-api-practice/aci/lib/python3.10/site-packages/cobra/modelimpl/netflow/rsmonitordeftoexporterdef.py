...
# ##################################################
class RsMonitorDefToExporterDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.netflow.RsMonitorDefToExporterDef", "cobra.model.netflow.ExporterPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "netflowRsMonitorDefToExporterDef"
    meta.rnFormat = "rsmonitorDefToExporterDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Exporter Def Policy Attachment"
    ...
    meta.rnPrefixes = [
        ('rsmonitorDefToExporterDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27379, PropCategory.REGULAR)
