...
# ##################################################
class RsExporterToTopSystem(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.netflow.RsExporterToTopSystem", "cobra.model.top.System")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "netflowRsExporterToTopSystem"
    meta.rnFormat = "rsexporterToTopSystem"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to TopSystem node to fetch manahement IPs on the leaf."
    ...
    prop = PropMeta("str", "tCl", "tCl", 33431, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    prop.defaultValueStr = "topSystem"
    prop._addConstant("topSystem", None, 3)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33430, PropCategory.REGULAR)
