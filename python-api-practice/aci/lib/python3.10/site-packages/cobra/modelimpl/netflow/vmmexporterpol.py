...
# ##################################################
class VmmExporterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.netflow.VmmExporterPol")

    meta.moClassName = "netflowVmmExporterPol"
    meta.rnFormat = "vmmexporterpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VMM External Collector Reachability"
    ...
    meta.childClasses.add("cobra.model.netflow.RtVswitchExporterPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.netflow.RtVswitchExporterPol", "rtvmmVswitchExporterPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38558, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40697, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 27559, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
