...
# ##################################################
class RsExporterToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.netflow.RsExporterToCtx", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "netflowRsExporterToCtx"
    meta.rnFormat = "rsexporterToCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Ctx behind which the Exporter resides"
    ...
    meta.rnPrefixes = [
        ('rsexporterToCtx', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38565, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40704, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27832, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27829, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1997
    prop.defaultValueStr = "fvCtx"
    prop._addConstant("fvCtx", None, 1997)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27828, PropCategory.REGULAR)
