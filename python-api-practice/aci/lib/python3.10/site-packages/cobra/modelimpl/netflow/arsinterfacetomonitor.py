...
# ##################################################
class ARsInterfaceToMonitor(Mo):
    meta = ClassMeta("cobra.model.netflow.ARsInterfaceToMonitor")

    meta.isAbstract = True
    meta.moClassName = "netflowARsInterfaceToMonitor"


    meta.moClassName = "netflowARsInterfaceToMonitor"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Relation from Interface to Monitor"
    ...
    meta.concreteSubClasses.add("cobra.model.infra.RsNetflowMonitorPol")
    meta.concreteSubClasses.add("cobra.model.l3ext.RsLIfPToNetflowMonitorPol")
    meta.concreteSubClasses.add("cobra.model.fv.RsBDToNetflowMonitorPol")
