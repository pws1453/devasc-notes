...
# ##################################################
class MonitorPolHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.netflow.MonitorPolHolder")

    meta.moClassName = "netflowMonitorPolHolder"
    meta.rnFormat = "monitorpolh-%(fltType)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Netflow Monitor Policy Dn Holder"
    ...
    prop = PropMeta("str", "fltType", "fltType", 27817, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monitorPolDn", "monitorPolDn", 27336, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    def __init__(self, parentMoOrDn, fltType, markDirty=True, **creationProps):
        namingVals = [fltType]
