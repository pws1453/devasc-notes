...
# ##################################################
class VmmExporterPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.netflow.VmmExporterPolDef")

    meta.moClassName = "netflowVmmExporterPolDef"
    meta.rnFormat = "vmmexporterpoldef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VMM Netflow Exporter Policy Definition"
    ...
    meta.rnPrefixes = [
        ('vmmexporterpoldef-', True),
    ]

    prop = PropMeta("str", "activeFlowTimeOut", "activeFlowTimeOut", 27506, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 27550, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "idleFlowTimeOut", "idleFlowTimeOut", 27507, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 27560, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "samplingRate", "samplingRate", 27508, PropCategory.REGULAR)
