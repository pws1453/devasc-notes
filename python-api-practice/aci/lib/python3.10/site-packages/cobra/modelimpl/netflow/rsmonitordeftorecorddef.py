...
# ##################################################
class RsMonitorDefToRecordDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.netflow.RsMonitorDefToRecordDef", "cobra.model.netflow.RecordPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "netflowRsMonitorDefToRecordDef"
    meta.rnFormat = "rsmonitorDefToRecordDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Record Def Policy Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27384, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9225
    prop.defaultValueStr = "netflowRecordPolDef"
    ...
    prop = PropMeta("str", "tDn", "tDn", 27383, PropCategory.REGULAR)
