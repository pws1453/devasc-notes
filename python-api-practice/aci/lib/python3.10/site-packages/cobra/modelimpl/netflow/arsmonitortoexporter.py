...
# ##################################################
class ARsMonitorToExporter(Mo):
    meta = ClassMeta("cobra.model.netflow.ARsMonitorToExporter")

    meta.isAbstract = True
    meta.moClassName = "netflowARsMonitorToExporter"


    meta.moClassName = "netflowARsMonitorToExporter"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Relation from Monitor to Exporter"
    ...
    meta.concreteSubClasses.add("cobra.model.netflow.RsMonitorDefToExporterDef")
    meta.concreteSubClasses.add("cobra.model.netflow.RsMonitorToExporter")
