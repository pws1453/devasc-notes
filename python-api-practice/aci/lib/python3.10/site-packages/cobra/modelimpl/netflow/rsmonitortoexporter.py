...
# ##################################################
class RsMonitorToExporter(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.netflow.RsMonitorToExporter", "cobra.model.netflow.ExporterPol")
    meta.targetNameProps["name"] = "tnNetflowExporterPolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "netflowRsMonitorToExporter"
    meta.rnFormat = "rsmonitorToExporter-%(tnNetflowExporterPolName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Exporter Policy Attachment"
    ...
    meta.superClasses.add("cobra.model.netflow.ARsMonitorToExporter")

    meta.rnPrefixes = [
        ('rsmonitorToExporter-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38550, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40689, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27393, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27372, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9207
    prop.defaultValueStr = "netflowExporterPol"
    ...
    prop = PropMeta("str", "tnNetflowExporterPolName", "tnNetflowExporterPolName", 27371, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnNetflowExporterPolName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnNetflowExporterPolName"))
    ...
    def __init__(self, parentMoOrDn, tnNetflowExporterPolName, markDirty=True, **creationProps):
        namingVals = [tnNetflowExporterPolName]
