...
# ##################################################
class RsMonitorToRecord(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.netflow.RsMonitorToRecord", "cobra.model.netflow.RecordPol")
    meta.targetNameProps["name"] = "tnNetflowRecordPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "netflowRsMonitorToRecord"
    meta.rnFormat = "rsmonitorToRecord"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Record Policy Attachment"
    ...
    meta.superClasses.add("cobra.model.netflow.ARsMonitorToRecord")
    meta.superClasses.add("cobra.model.pol.NToRef")

    meta.rnPrefixes = [
        ('rsmonitorToRecord', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38549, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40688, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27392, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27376, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9203
    prop.defaultValueStr = "netflowRecordPol"
    ...
    prop = PropMeta("str", "tnNetflowRecordPolName", "tnNetflowRecordPolName", 27375, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnNetflowRecordPolName", prop)
