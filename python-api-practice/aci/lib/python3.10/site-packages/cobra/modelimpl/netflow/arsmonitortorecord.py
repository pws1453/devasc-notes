...
# ##################################################
class ARsMonitorToRecord(Mo):
    meta = ClassMeta("cobra.model.netflow.ARsMonitorToRecord")

    meta.isAbstract = True
    meta.moClassName = "netflowARsMonitorToRecord"


    meta.moClassName = "netflowARsMonitorToRecord"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Relation from Monitor to Record"
    ...
    meta.concreteSubClasses.add("cobra.model.netflow.RsMonitorToRecord")
    meta.concreteSubClasses.add("cobra.model.netflow.RsMonitorDefToRecordDef")
