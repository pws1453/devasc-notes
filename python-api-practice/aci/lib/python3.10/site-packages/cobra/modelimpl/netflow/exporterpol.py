...
# ##################################################
class ExporterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.netflow.ExporterPol")

    meta.moClassName = "netflowExporterPol"
    meta.rnFormat = "exporterpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Collector Reachability"
    ...
    meta.childClasses.add("cobra.model.netflow.RtMonitorToExporter")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.netflow.RtMonitorToExporter", "rtmonitorToExporter-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40685, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27389, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 27339, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
