...
# ##################################################
class RsExporterToEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.netflow.RsExporterToEPg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "netflowRsExporterToEPg"
    meta.rnFormat = "rsexporterToEPg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to EPg behind which the Exporter resides"
    ...
    meta.rnPrefixes = [
        ('rsexporterToEPg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38545, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40684, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27388, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27368, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27367, PropCategory.REGULAR)
