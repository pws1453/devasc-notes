...
# ##################################################
class ExporterPolHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.netflow.ExporterPolHolder")

    meta.moClassName = "netflowExporterPolHolder"
    meta.rnFormat = "exporterpolh-[%(exporterPolDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Netflow Exporter Policy Dn Holder"
    ...
    prop = PropMeta("str", "exporterPolDn", "exporterPolDn", 31073, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
