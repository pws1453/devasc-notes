...
class Entity(Mo):
    """
     Holds PTP entity information 

    """

    meta = ClassMeta("cobra.model.ptp.Entity")

    meta.moClassName = "ptpEntity"
    meta.rnFormat = "ptp"
    meta.category = MoCategory.REGULAR
    meta.label = "PTP Entity"
    ...
    meta.childClasses.add("cobra.model.ptp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.ptp.Inst", "inst"))
