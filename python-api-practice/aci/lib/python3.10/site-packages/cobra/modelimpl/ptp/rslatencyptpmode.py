...
# ##################################################
class RsLatencyPtpMode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ptp.RsLatencyPtpMode", "cobra.model.latency.PtpMode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ptpRsLatencyPtpMode"
    meta.rnFormat = "rslatencyPtpMode"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to latencyPtpMode"
    ...
    meta.rnPrefixes = [
        ('rslatencyPtpMode', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 61894, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61895, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61893, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 61890, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9802
    prop.defaultValueStr = "latencyPtpMode"
    prop._addConstant("latencyPtpMode", None, 9802)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 61889, PropCategory.REGULAR)
