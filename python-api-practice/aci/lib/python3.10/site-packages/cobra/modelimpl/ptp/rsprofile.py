...
class RsProfile(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.ptp.RsProfile", "cobra.model.ptp.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ptpRsProfile"
    meta.rnFormat = "rsprofile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to PTP user profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 56447, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56448, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56446, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56443, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16560
    prop.defaultValueStr = "ptpProfile"
    prop._addConstant("ptpProfile", None, 16560)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56442, PropCategory.REGULAR)
