...
class Keyring(Mo):
    ...
    meta = ClassMeta("cobra.model.isakmp.Keyring")

    meta.moClassName = "isakmpKeyring"
    ...
    meta.childClasses.add("cobra.model.isakmp.RtProfileToKeyring")

    meta.childNamesAndRnPrefix.append(("cobra.model.isakmp.RtProfileToKeyring", "rtprofileToKeyring-"))
    ...
    prop = PropMeta("str", "address", "address", 50528, PropCategory.REGULAR)
    prop.label = "IP Address of peer that shares the key"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("address", prop)

    prop = PropMeta("str", "annotation", "annotation", 51740, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51741, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keyType", "keyType", 50527, PropCategory.REGULAR)
    prop.label = "Key Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50790, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
