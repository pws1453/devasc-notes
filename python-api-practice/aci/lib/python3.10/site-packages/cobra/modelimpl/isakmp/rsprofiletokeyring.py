...
# ##################################################
class RsProfileToKeyring(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.isakmp.RsProfileToKeyring", "cobra.model.isakmp.Keyring")
    meta.targetNameProps["name"] = "tnIsakmpKeyringName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "isakmpRsProfileToKeyring"
    meta.rnFormat = "rsprofileToKeyring"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Profile Attachment to Keyring"
    ...
    meta.rnPrefixes = [
        ('rsprofileToKeyring', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51744, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51745, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51489, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51457, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15125
    prop.defaultValueStr = "isakmpKeyring"
    ...
    prop = PropMeta("str", "tnIsakmpKeyringName", "tnIsakmpKeyringName", 51456, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnIsakmpKeyringName", prop)
