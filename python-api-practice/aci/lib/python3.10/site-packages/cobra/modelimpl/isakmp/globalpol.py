...
class GlobalPol(Mo):
    ...
    meta = ClassMeta("cobra.model.isakmp.GlobalPol")

    meta.moClassName = "isakmpGlobalPol"
    meta.rnFormat = "globalpol"
    meta.category = MoCategory.REGULAR
    meta.label = "Isakmp Cloud Router-Level Common Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51748, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51749, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keepalive", "keepalive", 50535, PropCategory.REGULAR)
    prop.label = "IsaKmp Keepalive interval"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(10, 3600)]
    prop.defaultValue = 10
    prop.defaultValueStr = "10"
    meta.props.add("keepalive", prop)
    ...
    prop = PropMeta("str", "retryInterval", "retryInterval", 50536, PropCategory.REGULAR)
    prop.label = "Number of seconds between keep alives"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(2, 60)]
    prop.defaultValue = 2
    prop.defaultValueStr = "2"
    meta.props.add("retryInterval", prop)
