...
class RtProfileToKeyring(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.isakmp.RtProfileToKeyring", "cobra.model.isakmp.Profile")

    meta.moClassName = "isakmpRtProfileToKeyring"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51459, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15126
    prop.defaultValueStr = "isakmpProfile"
    prop._addConstant("isakmpProfile", None, 15126)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51458, PropCategory.REGULAR)
