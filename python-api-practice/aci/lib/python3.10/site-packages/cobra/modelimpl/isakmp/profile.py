...
class Profile(Mo):
    ...
    meta = ClassMeta("cobra.model.isakmp.Profile")

    meta.moClassName = "isakmpProfile"
    meta.rnFormat = "isakmpp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Isakmp Profile"
    ...
    meta.childClasses.add("cobra.model.isakmp.RsProfileToKeyring")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.isakmp.RsProfileToKeyring", "rsprofileToKeyring"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51742, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51743, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51488, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 50791, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
