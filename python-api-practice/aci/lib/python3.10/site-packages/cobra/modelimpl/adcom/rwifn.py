...
class RwiFn(Mo):
    ...
    meta = ClassMeta("cobra.model.adcom.RwiFn")

    meta.moClassName = "adcomRwiFn"
    meta.rnFormat = "rwifn--%(svcId)s-%(shrdId)s-%(rplId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Replica Wire Impression FabricNode Version"
    ...
    meta.parentClasses.add("cobra.model.adcom.RwiContFn")
    ...
    prop = PropMeta("str", "currTerm", "currTerm", 1437, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "leMuid", "leMuid", 1441, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "leTs", "leTs", 1440, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 16412, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "osMuid", "osMuid", 16414, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "osTs", "osTs", 16413, PropCategory.REGULAR)
    prop.label = "OperSt Timestamp"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("osTs", prop)

    prop = PropMeta("str", "replSt", "replSt", 1436, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rplId", "rplId", 5865, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "shrdId", "shrdId", 5866, PropCategory.REGULAR)
    prop.label = "Shard ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "svcId", "svcId", 5867, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "verEnd", "verEnd", 1439, PropCategory.REGULAR)
    prop.label = "Version Field End"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("verEnd", prop)

    prop = PropMeta("str", "verStart", "verStart", 1438, PropCategory.REGULAR)
