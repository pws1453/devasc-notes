...
class RsMgrpp(Mo):
    """
    A source relation to the maintenance policy specification for a node or set of nodes.

    """

    meta = NamedSourceRelationMeta("cobra.model.maint.RsMgrpp", "cobra.model.maint.MaintP")
    meta.targetNameProps["name"] = "tnMaintMaintPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "maintRsMgrpp"
    meta.rnFormat = "rsmgrpp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Maintenance Policy Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37335, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39474, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13846, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11314, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 367
    prop.defaultValueStr = "maintMaintP"
    ...
    prop = PropMeta("str", "tnMaintMaintPName", "tnMaintMaintPName", 11313, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMaintMaintPName", prop)
