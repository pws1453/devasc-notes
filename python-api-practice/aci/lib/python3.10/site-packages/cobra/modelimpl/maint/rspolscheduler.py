...
# ##################################################
class RsPolScheduler(Mo):
    """
    A source relation to the scheduler policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.maint.RsPolScheduler", "cobra.model.trig.SchedP")
    meta.targetNameProps["name"] = "tnTrigSchedPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "maintRsPolScheduler"
    meta.rnFormat = "rspolScheduler"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Maintenence Scheduler Policy"
    ...
    meta.rnPrefixes = [
        ('rspolScheduler', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37330, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39469, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13841, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11305, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTrigSchedPName", "tnTrigSchedPName", 11304, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
