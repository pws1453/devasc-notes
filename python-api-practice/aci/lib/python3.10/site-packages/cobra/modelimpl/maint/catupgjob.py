...
class CatUpgJob(Mo):
    ...
    meta = ClassMeta("cobra.model.maint.CatUpgJob")

    meta.moClassName = "maintCatUpgJob"
    meta.rnFormat = "catupgjob"
    ...
    meta.parentClasses.add("cobra.model.firmware.CatFwStatusCont")
    ...
    prop = PropMeta("str", "creationDate", "creationDate", 635, PropCategory.REGULAR)
    prop.label = "Creation Date"
    prop.isOper = True
    meta.props.add("creationDate", prop)

    prop = PropMeta("str", "desiredVersion", "desiredVersion", 640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "endDate", "endDate", 637, PropCategory.REGULAR)
    prop.label = "End Date"
    prop.isOper = True
    meta.props.add("endDate", prop)

    prop = PropMeta("str", "iUrl", "iUrl", 638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scheduler", "scheduler", 639, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "startDate", "startDate", 636, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "upgradeStatus", "upgradeStatus", 634, PropCategory.REGULAR)
