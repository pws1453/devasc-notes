...
class MaintP(Mo):
    ...
    meta = ClassMeta("cobra.model.maint.MaintP")

    meta.moClassName = "maintMaintP"
    meta.rnFormat = "maintpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Maintenance Policy"
    ...
    meta.childClasses.add("cobra.model.maint.RsPolScheduler")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.maint.RsPolNotif")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.trig.RsTriggerable")
    meta.childClasses.add("cobra.model.maint.RtMgrpp")
    meta.childClasses.add("cobra.model.maint.RtMaintpol")
    meta.childClasses.add("cobra.model.maint.RtReltomaintp")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RsPolScheduler", "rspolScheduler"))
    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RtMaintpol", "rtpolMaintpol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RtReltomaintp", "rtreltomaintp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.trig.RsTriggerable", "rsTriggerable"))
    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RsPolNotif", "rspolNotif"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RtMgrpp", "rtmgrpp-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37327, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39466, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13839, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6911, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
