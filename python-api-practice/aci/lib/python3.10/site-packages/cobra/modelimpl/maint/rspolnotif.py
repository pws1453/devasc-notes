...
class RsPolNotif(Mo):
    """
    A source relation to the notification specification. Specifies a notification for maintenance policy.

    """

    meta = SourceRelationMeta("cobra.model.maint.RsPolNotif", "cobra.model.maint.UserNotif")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "maintRsPolNotif"
    meta.rnFormat = "rspolNotif"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Maintenance Notification Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37331, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39470, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13842, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11301, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 375
    prop.defaultValueStr = "maintUserNotif"
    ...
    prop = PropMeta("str", "tDn", "tDn", 11300, PropCategory.REGULAR)
