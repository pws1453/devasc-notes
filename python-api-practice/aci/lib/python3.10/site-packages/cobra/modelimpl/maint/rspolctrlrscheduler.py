...
# ##################################################
class RsPolCtrlrScheduler(Mo):
    """
    A source relation to the scheduler policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.maint.RsPolCtrlrScheduler", "cobra.model.trig.SchedP")
    meta.targetNameProps["name"] = "tnTrigSchedPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "maintRsPolCtrlrScheduler"
    meta.rnFormat = "rspolCtrlrScheduler"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Controller Schedule Policy"
    ...
    meta.rnPrefixes = [
        ('rspolCtrlrScheduler', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37340, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39479, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11322, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTrigSchedPName", "tnTrigSchedPName", 11321, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
