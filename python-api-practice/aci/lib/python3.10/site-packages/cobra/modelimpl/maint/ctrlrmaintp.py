...
# ##################################################
class CtrlrMaintP(Mo):
    """
    The controller maintenance policy specification describes when and how maintenance takes place.

    """

    meta = ClassMeta("cobra.model.maint.CtrlrMaintP")

    meta.moClassName = "maintCtrlrMaintP"
    meta.rnFormat = "ctrlrmaintpol"
    meta.category = MoCategory.REGULAR
    meta.label = "Controller Maintenance Policy"
    ...
    meta.childClasses.add("cobra.model.maint.RsPolCtrlrScheduler")
    meta.childClasses.add("cobra.model.maint.RtAectrlrmaintp")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.trig.RsTriggerable")
    meta.childClasses.add("cobra.model.maint.RsReltoCtrlrFirmwareP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RsReltoCtrlrFirmwareP", "rsreltoCtrlrFirmwareP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RsPolCtrlrScheduler", "rspolCtrlrScheduler"))
    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RtAectrlrmaintp", "rtpolAectrlrmaintp-"))
    ...
    prop = PropMeta("str", "adminState", "adminState", 656, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "annotation", "annotation", 37338, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39477, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13849, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "parallel", "parallel", 20268, PropCategory.REGULAR)
