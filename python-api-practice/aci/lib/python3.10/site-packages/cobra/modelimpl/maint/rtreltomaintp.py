...
# ##################################################
class RtReltomaintp(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.maint.RtReltomaintp", "cobra.model.maint.UpgStatus")

    meta.moClassName = "maintRtReltomaintp"
    meta.rnFormat = "rtreltomaintp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16406, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 388
    prop.defaultValueStr = "maintUpgStatus"
    prop._addConstant("maintUpgStatus", None, 388)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16405, PropCategory.REGULAR)
