...
# ##################################################
class RsFwinstlsrc(Mo):
    """
    A source relation to the system health.

    """

    meta = SourceRelationMeta("cobra.model.maint.RsFwinstlsrc", "cobra.model.top.System")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "maintRsFwinstlsrc"
    meta.rnFormat = "rsfwinstlsrc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37329, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39468, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 11309, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11308, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "version", "version", 11310, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
