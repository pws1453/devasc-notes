...
# ##################################################
class RsToMaintGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.maint.RsToMaintGrp", "cobra.model.maint.MaintGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "maintRsToMaintGrp"
    meta.rnFormat = "rstoMaintGrp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Maintanence Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38252, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40391, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20910, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20888, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 378
    prop.defaultValueStr = "maintMaintGrp"
    prop._addConstant("maintMaintGrp", None, 378)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20887, PropCategory.REGULAR)
