...
class MaintPOnD(Mo):
    """
    The On Demand Maintenance policy specification for the node, which describes when and how maintenance takes place.

    """

    meta = ClassMeta("cobra.model.maint.MaintPOnD")

    meta.moClassName = "maintMaintPOnD"
    meta.rnFormat = "maintpolond-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "On-Demand Maintenance Policy"
    ...
    meta.childClasses.add("cobra.model.maint.RsFwinstlsrc")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.trig.RsTriggerable", "rsTriggerable"))
    meta.childNamesAndRnPrefix.append(("cobra.model.maint.RsFwinstlsrc", "rsfwinstlsrc-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37328, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39467, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13840, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6912, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
