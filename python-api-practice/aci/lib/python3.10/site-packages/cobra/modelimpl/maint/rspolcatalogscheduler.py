...
# ##################################################
class RsPolCatalogScheduler(Mo):
    """
    A source relation to the scheduler policy.

    """

    meta = SourceRelationMeta("cobra.model.maint.RsPolCatalogScheduler", "cobra.model.trig.SchedP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "maintRsPolCatalogScheduler"
    meta.rnFormat = "rspolCatalogScheduler"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Catalog Schedule Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11326, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11325, PropCategory.REGULAR)
