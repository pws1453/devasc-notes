...
# ##################################################
class RsReltomaintp(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.maint.RsReltomaintp", "cobra.model.maint.MaintP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "maintRsReltomaintp"
    meta.rnFormat = "rsreltomaintp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Maintenance Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38126, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40265, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 16404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16403, PropCategory.REGULAR)
