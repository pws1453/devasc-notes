...
# ##################################################
class RsReltoCtrlrFirmwareP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.maint.RsReltoCtrlrFirmwareP", "cobra.model.firmware.CtrlrFwP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "maintRsReltoCtrlrFirmwareP"
    meta.rnFormat = "rsreltoCtrlrFirmwareP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Controller Firmware Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62290, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62289, PropCategory.REGULAR)
