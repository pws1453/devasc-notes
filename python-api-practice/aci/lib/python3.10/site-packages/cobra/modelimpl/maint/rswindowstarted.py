...
# ##################################################
class RsWindowStarted(Mo):
    """
    A source relation to the container for scheduled windows.

    """

    meta = SourceRelationMeta("cobra.model.maint.RsWindowStarted", "cobra.model.trig.Window")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "maintRsWindowStarted"
    meta.rnFormat = "rswindowStarted"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Window"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11318, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1815
    prop.defaultValueStr = "trigWindow"
    ...
    prop = PropMeta("str", "tDn", "tDn", 11317, PropCategory.REGULAR)
