...
# ##################################################
class NodeInMaintTask(Mo):
    """
    The node installation maintenance task.

    """

    meta = ClassMeta("cobra.model.maint.NodeInMaintTask")

    meta.moClassName = "maintNodeInMaintTask"
    meta.rnFormat = "maintNodeInMaintTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5648, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CanIUpgrade", "caniupgrade", 222)
    prop._addConstant("none", "none", 0)
    prop._addConstant("sendCtrlrUpgradeReq", "sendctrlrupgradereq", 70)
