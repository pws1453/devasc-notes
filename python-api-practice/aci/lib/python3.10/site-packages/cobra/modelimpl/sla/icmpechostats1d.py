...
# ##################################################
class ICMPEchoStats1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStats1d", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStats1d"
    meta.rnFormat = "CDslaICMPEchoStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ICMP Echo Operation Statistics stats in 1 day"
