...
# ##################################################
class ICMPEchoStatsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAg5min", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAg5min"
    meta.rnFormat = "CDslaICMPEchoStatsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ICMP Echo Operation Statistics stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDslaICMPEchoStatsAg5min', False),
    ]
