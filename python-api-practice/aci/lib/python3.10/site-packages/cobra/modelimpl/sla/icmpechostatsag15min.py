...
# ##################################################
class ICMPEchoStatsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAg15min", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAg15min"
    meta.rnFormat = "CDslaICMPEchoStatsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ICMP Echo Operation Statistics stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.sla.ICMPEchoStatsAg")
    meta.superClasses.add("cobra.model.stats.Curr")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDslaICMPEchoStatsAg15min', False),
    ]
