...
# ##################################################
class ICMPEchoStatsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist5min", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist5min"
    meta.rnFormat = "HDslaICMPEchoStatsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 49961, PropCategory.REGULAR)
