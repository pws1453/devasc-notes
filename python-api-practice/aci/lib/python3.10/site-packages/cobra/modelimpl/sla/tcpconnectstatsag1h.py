...
# ##################################################
class TCPConnectStatsAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAg1h", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAg1h"
    meta.rnFormat = "CDslaTCPConnectStatsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated TCP Connect Operation Statistics stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDslaTCPConnectStatsAg1h', False),
    ]
