...
# ##################################################
class ICMPEchoStatsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist1d", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist1d"
    meta.rnFormat = "HDslaICMPEchoStatsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 49955, PropCategory.REGULAR)
