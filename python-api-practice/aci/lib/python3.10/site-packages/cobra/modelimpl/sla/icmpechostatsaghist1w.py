...
# ##################################################
class ICMPEchoStatsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist1w", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist1w"
    meta.rnFormat = "HDslaICMPEchoStatsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 49959, PropCategory.REGULAR)
