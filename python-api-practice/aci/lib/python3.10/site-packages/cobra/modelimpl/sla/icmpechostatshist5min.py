...
# ##################################################
class ICMPEchoStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist5min", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist5min"
    meta.rnFormat = "HDslaICMPEchoStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 49467, PropCategory.REGULAR)
