...
# ##################################################
class ICMPEchoStats1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStats1year", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStats1year"
    meta.rnFormat = "CDslaICMPEchoStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ICMP Echo Operation Statistics stats in 1 year"
