...
# ##################################################
class TCPConnectStatsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAgHist1qtr", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAgHist1qtr"
    meta.rnFormat = "HDslaTCPConnectStatsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated TCP Connect Operation Statistics stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDslaTCPConnectStatsAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 49966, PropCategory.REGULAR)
