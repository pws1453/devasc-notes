...
# ##################################################
class ICMPEchoStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist1mo", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist1mo"
    meta.rnFormat = "HDslaICMPEchoStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 49463, PropCategory.REGULAR)
