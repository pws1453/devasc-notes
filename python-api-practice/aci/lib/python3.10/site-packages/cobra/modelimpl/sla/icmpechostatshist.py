...
# ##################################################
class ICMPEchoStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist"


    meta.moClassName = "slaICMPEchoStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats"
    ...
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsHist1w")
    ...
    prop = PropMeta("str", "failuresAvg", "failuresAvg", 49492, PropCategory.IMPLICIT_AVG)
    prop.label = "number of failed ICMP Echo probes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresAvg", prop)

    prop = PropMeta("str", "failuresCum", "failuresCum", 49488, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "number of failed ICMP Echo probes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresCum", prop)

    prop = PropMeta("str", "failuresMax", "failuresMax", 49491, PropCategory.IMPLICIT_MAX)
    prop.label = "number of failed ICMP Echo probes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresMax", prop)

    prop = PropMeta("str", "failuresMin", "failuresMin", 49490, PropCategory.IMPLICIT_MIN)
    prop.label = "number of failed ICMP Echo probes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresMin", prop)

    prop = PropMeta("str", "failuresPer", "failuresPer", 49489, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "number of failed ICMP Echo probes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresPer", prop)

    prop = PropMeta("str", "failuresRate", "failuresRate", 49496, PropCategory.IMPLICIT_RATE)
    prop.label = "number of failed ICMP Echo probes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresRate", prop)

    prop = PropMeta("str", "failuresSpct", "failuresSpct", 49493, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "number of failed ICMP Echo probes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresSpct", prop)

    prop = PropMeta("str", "failuresThr", "failuresThr", 49494, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "failuresTr", "failuresTr", 49495, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "rttAvg", "rttAvg", 49508, PropCategory.IMPLICIT_AVG)
    prop.label = "ICMP Echo Round Trip Time average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rttAvg", prop)

    prop = PropMeta("str", "rttMax", "rttMax", 49507, PropCategory.IMPLICIT_MAX)
    prop.label = "ICMP Echo Round Trip Time maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rttMax", prop)

    prop = PropMeta("str", "rttMin", "rttMin", 49506, PropCategory.IMPLICIT_MIN)
    prop.label = "ICMP Echo Round Trip Time minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rttMin", prop)

    prop = PropMeta("str", "rttSpct", "rttSpct", 49509, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ICMP Echo Round Trip Time suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rttSpct", prop)

    prop = PropMeta("str", "rttThr", "rttThr", 49510, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rttTr", "rttTr", 49511, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "txPktsTr", "txPktsTr", 49552, PropCategory.IMPLICIT_TREND)
