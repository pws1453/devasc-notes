...
# ##################################################
class ICMPEchoStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist1year", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist1year"
    meta.rnFormat = "HDslaICMPEchoStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 49466, PropCategory.REGULAR)
