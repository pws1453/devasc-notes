...
# ##################################################
class ICMPEchoStatsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist1year", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist1year"
    meta.rnFormat = "HDslaICMPEchoStatsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDslaICMPEchoStatsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 49960, PropCategory.REGULAR)
