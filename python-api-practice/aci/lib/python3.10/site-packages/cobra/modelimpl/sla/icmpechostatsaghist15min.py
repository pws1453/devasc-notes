...
# ##################################################
class ICMPEchoStatsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist15min", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist15min"
    meta.rnFormat = "HDslaICMPEchoStatsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.sla.ICMPEchoStatsAgHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDslaICMPEchoStatsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 49954, PropCategory.REGULAR)
