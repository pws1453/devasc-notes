...
# ##################################################
class TCPConnectStatsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAgHist1mo", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAgHist1mo"
    meta.rnFormat = "HDslaTCPConnectStatsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated TCP Connect Operation Statistics stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDslaTCPConnectStatsAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 49965, PropCategory.REGULAR)
