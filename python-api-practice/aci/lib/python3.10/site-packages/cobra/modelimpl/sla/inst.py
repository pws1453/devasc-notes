...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.sla.Inst")

    meta.moClassName = "slaInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "IP SLA Instance"
    ...
    meta.childClasses.add("cobra.model.sla.OpCont")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sla.OpCont", "opCont"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49635, PropCategory.REGULAR)
