...
# ##################################################
class TCPConnectStatsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAgHist1h", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAgHist1h"
    meta.rnFormat = "HDslaTCPConnectStatsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated TCP Connect Operation Statistics stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 49964, PropCategory.REGULAR)
