...
# ##################################################
class ICMPEchoStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist15min", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist15min"
    meta.rnFormat = "HDslaICMPEchoStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.sla.ICMPEchoStatsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDslaICMPEchoStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 49460, PropCategory.REGULAR)
