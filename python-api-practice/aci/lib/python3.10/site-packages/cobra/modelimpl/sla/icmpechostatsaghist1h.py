...
# ##################################################
class ICMPEchoStatsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist1h", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist1h"
    meta.rnFormat = "HDslaICMPEchoStatsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 49956, PropCategory.REGULAR)
