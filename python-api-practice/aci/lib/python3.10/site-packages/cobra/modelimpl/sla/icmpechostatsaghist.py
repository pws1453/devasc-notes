...
# ##################################################
class ICMPEchoStatsAgHist(Mo):
    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist"


    meta.moClassName = "slaICMPEchoStatsAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats"
    ...
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist1year")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist1d")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist15min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist1h")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist1w")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist5min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAgHist1qtr")
    ...
    prop = PropMeta("str", "failuresCum", "failuresCum", 49977, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "number of failed ICMP Echo probes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresCum", prop)

    prop = PropMeta("str", "failuresPer", "failuresPer", 49978, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "number of failed ICMP Echo probes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresPer", prop)

    prop = PropMeta("str", "failuresRate", "failuresRate", 49982, PropCategory.IMPLICIT_RATE)
    prop.label = "number of failed ICMP Echo probes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresRate", prop)

    prop = PropMeta("str", "failuresSpct", "failuresSpct", 49979, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "number of failed ICMP Echo probes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresSpct", prop)

    prop = PropMeta("str", "failuresThr", "failuresThr", 49980, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "failuresTr", "failuresTr", 49981, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "successCum", "successCum", 49990, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "number of successful ICMP Echo probes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successCum", prop)

    prop = PropMeta("str", "successPer", "successPer", 49991, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "number of successful ICMP Echo probes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successPer", prop)

    prop = PropMeta("str", "successRate", "successRate", 49995, PropCategory.IMPLICIT_RATE)
    prop.label = "number of successful ICMP Echo probes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successRate", prop)

    prop = PropMeta("str", "successSpct", "successSpct", 49992, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "number of successful ICMP Echo probes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successSpct", prop)

    prop = PropMeta("str", "successThr", "successThr", 49993, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "successTr", "successTr", 49994, PropCategory.IMPLICIT_TREND)
    prop.label = "number of successful ICMP Echo probes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successTr", prop)

    prop = PropMeta("str", "txPktsCum", "txPktsCum", 50003, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "number of transmitted ICMP Echo probes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsCum", prop)

    prop = PropMeta("str", "txPktsPer", "txPktsPer", 50004, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "number of transmitted ICMP Echo probes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsPer", prop)

    prop = PropMeta("str", "txPktsRate", "txPktsRate", 50008, PropCategory.IMPLICIT_RATE)
    prop.label = "number of transmitted ICMP Echo probes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsRate", prop)

    prop = PropMeta("str", "txPktsSpct", "txPktsSpct", 50005, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "number of transmitted ICMP Echo probes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsSpct", prop)

    prop = PropMeta("str", "txPktsThr", "txPktsThr", 50006, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txPktsTr", "txPktsTr", 50007, PropCategory.IMPLICIT_TREND)
