...
# ##################################################
class ICMPEchoStats1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStats1w", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStats1w"
    meta.rnFormat = "CDslaICMPEchoStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ICMP Echo Operation Statistics stats in 1 week"
