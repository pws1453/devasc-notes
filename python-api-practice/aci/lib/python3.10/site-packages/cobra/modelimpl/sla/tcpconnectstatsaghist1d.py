...
# ##################################################
class TCPConnectStatsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAgHist1d", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAgHist1d"
    meta.rnFormat = "HDslaTCPConnectStatsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated TCP Connect Operation Statistics stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 49963, PropCategory.REGULAR)
