...
# ##################################################
class ICMPEchoStatsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist1qtr", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist1qtr"
    meta.rnFormat = "HDslaICMPEchoStatsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 49958, PropCategory.REGULAR)
