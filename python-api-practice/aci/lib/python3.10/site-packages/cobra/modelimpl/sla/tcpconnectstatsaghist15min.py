...
# ##################################################
class TCPConnectStatsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAgHist15min", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAgHist15min"
    meta.rnFormat = "HDslaTCPConnectStatsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated TCP Connect Operation Statistics stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.sla.TCPConnectStatsAgHist")

    meta.rnPrefixes = [
        ('HDslaTCPConnectStatsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 49962, PropCategory.REGULAR)
