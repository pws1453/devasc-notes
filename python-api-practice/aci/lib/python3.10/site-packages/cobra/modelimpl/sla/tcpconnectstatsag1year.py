...
# ##################################################
class TCPConnectStatsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAg1year", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAg1year"
    meta.rnFormat = "CDslaTCPConnectStatsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated TCP Connect Operation Statistics stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDslaTCPConnectStatsAg1year', False),
    ]
