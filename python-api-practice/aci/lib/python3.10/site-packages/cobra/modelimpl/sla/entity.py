...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.sla.Entity")

    meta.moClassName = "slaEntity"
    meta.rnFormat = "sla"
    ...
    meta.childClasses.add("cobra.model.sla.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sla.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49634, PropCategory.REGULAR)
