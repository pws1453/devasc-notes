...
# ##################################################
class ICMPEchoStats5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStats5min", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStats5min"
    meta.rnFormat = "CDslaICMPEchoStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ICMP Echo Operation Statistics stats in 5 minute"
