...
# ##################################################
class ICMPEchoStats1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStats1h", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStats1h"
    meta.rnFormat = "CDslaICMPEchoStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ICMP Echo Operation Statistics stats in 1 hour"
