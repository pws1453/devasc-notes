...
# ##################################################
class ICMPEchoStatsAg(Mo):
    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAg", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAg"


    meta.moClassName = "slaICMPEchoStatsAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ICMP Echo Operation Statistics stats"
    ...
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg1w")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg5min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg15min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg1year")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg1qtr")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg1d")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg1mo")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStatsAg1h")
    ...
    prop = PropMeta("str", "failuresCum", "failuresCum", 49970, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "number of failed ICMP Echo probes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresCum", prop)

    prop = PropMeta("str", "failuresPer", "failuresPer", 49971, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "number of failed ICMP Echo probes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresPer", prop)

    prop = PropMeta("str", "failuresRate", "failuresRate", 49976, PropCategory.IMPLICIT_RATE)
    prop.label = "number of failed ICMP Echo probes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresRate", prop)

    prop = PropMeta("str", "failuresSpct", "failuresSpct", 49972, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "number of failed ICMP Echo probes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresSpct", prop)

    prop = PropMeta("str", "failuresThr", "failuresThr", 49973, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "failuresTr", "failuresTr", 49975, PropCategory.IMPLICIT_TREND)
    prop.label = "number of failed ICMP Echo probes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("failuresTr", prop)

    prop = PropMeta("str", "failuresTrBase", "failuresTrBase", 49974, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "successCum", "successCum", 49983, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "number of successful ICMP Echo probes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successCum", prop)

    prop = PropMeta("str", "successPer", "successPer", 49984, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "number of successful ICMP Echo probes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successPer", prop)

    prop = PropMeta("str", "successRate", "successRate", 49989, PropCategory.IMPLICIT_RATE)
    prop.label = "number of successful ICMP Echo probes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successRate", prop)

    prop = PropMeta("str", "successSpct", "successSpct", 49985, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "number of successful ICMP Echo probes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("successSpct", prop)

    prop = PropMeta("str", "successThr", "successThr", 49986, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txPktsTr", "txPktsTr", 50001, PropCategory.IMPLICIT_TREND)
    prop.label = "number of transmitted ICMP Echo probes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsTr", prop)

    prop = PropMeta("str", "txPktsTrBase", "txPktsTrBase", 50000, PropCategory.IMPLICIT_TREND_BASE)
