...
# ##################################################
class TCPConnectStatsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAg15min", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAg15min"
    meta.rnFormat = "CDslaTCPConnectStatsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated TCP Connect Operation Statistics stats in 15 minute"
    meta.writeAccessMask = 0x10010000000001
    meta.readAccessMask = 0x10010000000001
    ...
    meta.superClasses.add("cobra.model.sla.TCPConnectStatsAg")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDslaTCPConnectStatsAg15min', False),
    ]
