...
# ##################################################
class TCPConnectStatsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAgHist1year", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAgHist1year"
    meta.rnFormat = "HDslaTCPConnectStatsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated TCP Connect Operation Statistics stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDslaTCPConnectStatsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 49968, PropCategory.REGULAR)
