...
# ##################################################
class ICMPEchoStatsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAgHist1mo", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAgHist1mo"
    meta.rnFormat = "HDslaICMPEchoStatsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ICMP Echo Operation Statistics stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 49957, PropCategory.REGULAR)
