...
# ##################################################
class ICMPEchoStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist1h", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist1h"
    meta.rnFormat = "HDslaICMPEchoStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 49462, PropCategory.REGULAR)
