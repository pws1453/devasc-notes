...
# ##################################################
class ICMPEchoStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist1qtr", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist1qtr"
    meta.rnFormat = "HDslaICMPEchoStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 49464, PropCategory.REGULAR)
