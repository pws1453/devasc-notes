...
# ##################################################
class ICMPEchoStats1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStats1qtr", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStats1qtr"
    meta.rnFormat = "CDslaICMPEchoStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ICMP Echo Operation Statistics stats in 1 quarter"
