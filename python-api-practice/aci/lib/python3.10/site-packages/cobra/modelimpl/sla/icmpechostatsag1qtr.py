...
# ##################################################
class ICMPEchoStatsAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAg1qtr", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAg1qtr"
    meta.rnFormat = "CDslaICMPEchoStatsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ICMP Echo Operation Statistics stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDslaICMPEchoStatsAg1qtr', False),
    ]
