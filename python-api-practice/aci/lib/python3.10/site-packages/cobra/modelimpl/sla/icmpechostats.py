...
# ##################################################
class ICMPEchoStats(Mo):
    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStats", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStats"


    meta.moClassName = "slaICMPEchoStats"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ICMP Echo Operation Statistics stats"
    ...
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats1w")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats15min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats5min")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats1d")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats1qtr")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats1mo")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats1h")
    meta.concreteSubClasses.add("cobra.model.sla.ICMPEchoStats1year")
