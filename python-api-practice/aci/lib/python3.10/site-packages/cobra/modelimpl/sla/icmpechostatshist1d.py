...
# ##################################################
class ICMPEchoStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsHist1d", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsHist1d"
    meta.rnFormat = "HDslaICMPEchoStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ICMP Echo Operation Statistics stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 49461, PropCategory.REGULAR)
