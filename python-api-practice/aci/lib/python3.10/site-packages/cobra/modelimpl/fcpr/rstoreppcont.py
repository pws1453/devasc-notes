...
# ##################################################
class RsToREpPCont(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fcpr.RsToREpPCont", "cobra.model.fv.REpPCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fcprRsToREpPCont"
    meta.rnFormat = "rstoREpPCont-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fcpr.REpPContManager")
    ...
    prop = PropMeta("str", "tCl", "tCl", 22436, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1944
    prop.defaultValueStr = "fvREpPCont"
    prop._addConstant("fvREpPCont", None, 1944)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22435, PropCategory.REGULAR)
