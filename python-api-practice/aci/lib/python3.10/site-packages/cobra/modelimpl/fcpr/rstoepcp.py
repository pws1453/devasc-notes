...
class RsToEpCP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fcpr.RsToEpCP", "cobra.model.fv.EpCP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fcprRsToEpCP"
    meta.rnFormat = "rstoEpCP-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fcpr.EpCPManager")
    ...
    prop = PropMeta("str", "tCl", "tCl", 22448, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22447, PropCategory.REGULAR)
