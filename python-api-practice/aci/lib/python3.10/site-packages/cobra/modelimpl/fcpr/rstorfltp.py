...
class RsToRFltP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fcpr.RsToRFltP", "cobra.model.vz.AFilterableUnit")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fcprRsToRFltP"
    meta.rnFormat = "rstoRFltP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Relation used to pull policies to VMM"
    ...
    meta.parentClasses.add("cobra.model.fcpr.RFltPManager")
    ...
    prop = PropMeta("str", "tCl", "tCl", 22444, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22443, PropCategory.REGULAR)
