...
# ##################################################
class RsToCtrctEPgCont(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fcpr.RsToCtrctEPgCont", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fcprRsToCtrctEPgCont"
    meta.rnFormat = "rstoCtrctEPgCont-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.fcpr.Consumer")

    meta.childNamesAndRnPrefix.append(("cobra.model.fcpr.Consumer", "cons-"))

    meta.parentClasses.add("cobra.model.fcpr.CtrctEPgContManager")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.fcpr.ARs")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rstoCtrctEPgCont-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 22440, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22439, PropCategory.REGULAR)
