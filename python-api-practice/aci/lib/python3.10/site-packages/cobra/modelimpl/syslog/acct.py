...
class Acct(Mo):
    ...
    meta = ClassMeta("cobra.model.syslog.Acct")

    meta.moClassName = "syslogAcct"
    meta.rnFormat = "syslogacct"
    meta.category = MoCategory.REGULAR
    meta.label = "Syslog Accounting"
    ...
    prop = PropMeta("str", "timerTick", "timerTick", 17628, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
