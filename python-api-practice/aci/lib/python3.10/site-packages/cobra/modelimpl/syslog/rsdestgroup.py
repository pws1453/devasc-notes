...
class RsDestGroup(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.syslog.RsDestGroup", "cobra.model.syslog.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "syslogRsDestGroup"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37584, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39723, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14184, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12042, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12041, PropCategory.REGULAR)
