...
# ##################################################
class RsCeMonitorPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsCeMonitorPolCons", "cobra.model.netflow.MonitorPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsCeMonitorPolCons"
    meta.rnFormat = "rsceMonitorPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "CE Monitor Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 28705, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 28694, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28693, PropCategory.REGULAR)
