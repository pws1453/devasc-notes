...
# ##################################################
class RsMcpIfPolCons(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.l1.RsMcpIfPolCons", "cobra.model.mcp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsMcpIfPolCons"
    meta.rnFormat = "rsmcpIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MCP Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 17741, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 17738, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5720
    prop.defaultValueStr = "mcpIfPol"
    prop._addConstant("mcpIfPol", None, 5720)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17737, PropCategory.REGULAR)
