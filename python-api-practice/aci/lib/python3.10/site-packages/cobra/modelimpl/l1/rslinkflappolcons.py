...
# ##################################################
class RsLinkFlapPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsLinkFlapPolCons", "cobra.model.fabric.LinkFlapPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsLinkFlapPolCons"
    meta.rnFormat = "rslinkFlapPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Link Flap Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 57474, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 57457, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16918
    prop.defaultValueStr = "fabricLinkFlapPol"
    prop._addConstant("fabricLinkFlapPol", None, 16918)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 57456, PropCategory.REGULAR)
