...
# ##################################################
class RsPoeIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsPoeIfPolCons", "cobra.model.poe.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsPoeIfPolCons"
    meta.rnFormat = "rspoeIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "POE Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 34089, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 34075, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10931
    prop.defaultValueStr = "poeIfPol"
    prop._addConstant("poeIfPol", None, 10931)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34074, PropCategory.REGULAR)
