...
# ##################################################
class RsFIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsFIfPolCons", "cobra.model.fabric.FIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsFIfPolCons"
    meta.rnFormat = "rsfIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "FIF Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 59731, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 59722, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17699
    prop.defaultValueStr = "fabricFIfPol"
    prop._addConstant("fabricFIfPol", None, 17699)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 59721, PropCategory.REGULAR)
