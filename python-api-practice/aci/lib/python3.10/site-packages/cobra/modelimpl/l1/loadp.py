...
class LoadP(Mo):
    """
    A load interval policy.

    """

    meta = ClassMeta("cobra.model.l1.LoadP")

    meta.moClassName = "l1LoadP"
    meta.rnFormat = "loadp"
    meta.category = MoCategory.REGULAR
    meta.label = "Load Policy"
    ...
    prop = PropMeta("str", "loadIntvl1", "loadIntvl1", 3734, PropCategory.REGULAR)
    prop.label = "Load Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 300)]
    ...
    prop = PropMeta("str", "loadIntvl2", "loadIntvl2", 3735, PropCategory.REGULAR)
    prop.label = "Load Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 300)]
    ...
    prop = PropMeta("str", "loadIntvl3", "loadIntvl3", 3736, PropCategory.REGULAR)
    prop.label = "Load Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 300)]
