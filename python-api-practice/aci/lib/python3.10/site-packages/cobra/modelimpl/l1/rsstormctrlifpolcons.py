...
# ##################################################
class RsStormctrlIfPolCons(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.l1.RsStormctrlIfPolCons", "cobra.model.stormctrl.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsStormctrlIfPolCons"
    meta.rnFormat = "rsstormctrlIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Storm Control Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 16556, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 16541, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5606
    prop.defaultValueStr = "stormctrlIfPol"
    prop._addConstant("stormctrlIfPol", None, 5606)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16540, PropCategory.REGULAR)
