...
# ##################################################
class RsQosEgressDppIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsQosEgressDppIfPolCons", "cobra.model.qos.DppPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsQosEgressDppIfPolCons"
    meta.rnFormat = "rsQosEgressDppIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "QOS Dpp Policy Attachment Egress"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 23217, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 23197, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23196, PropCategory.REGULAR)
