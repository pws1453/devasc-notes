...
# ##################################################
class RsDwdmIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsDwdmIfPolCons", "cobra.model.dwdm.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsDwdmIfPolCons"
    meta.rnFormat = "rsdwdmIfPolCons"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 35553, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 35542, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11303
    prop.defaultValueStr = "dwdmIfPol"
    prop._addConstant("dwdmIfPol", None, 11303)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35541, PropCategory.REGULAR)
