...
# ##################################################
class RsLacpIfPolCons(Mo):
    """
    A source relation to the port-Level LACP member policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l1.RsLacpIfPolCons", "cobra.model.lacp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsLacpIfPolCons"
    meta.rnFormat = "rslacpIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "LACP Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15113, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12759, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 154
    prop.defaultValueStr = "lacpIfPol"
    prop._addConstant("lacpIfPol", None, 154)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12758, PropCategory.REGULAR)
