...
# ##################################################
class RsIpv4MonitorPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsIpv4MonitorPolCons", "cobra.model.netflow.MonitorPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsIpv4MonitorPolCons"
    meta.rnFormat = "rsipv4MonitorPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ipv4 Monitor Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 28707, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 28698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28697, PropCategory.REGULAR)
