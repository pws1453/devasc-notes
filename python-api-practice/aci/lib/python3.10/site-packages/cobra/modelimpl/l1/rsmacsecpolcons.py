...
# ##################################################
class RsMacsecPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsMacsecPolCons", "cobra.model.macsec.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsMacsecPolCons"
    meta.rnFormat = "rsmacsecPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MACSEC Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 30150, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 30121, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9882
    prop.defaultValueStr = "macsecIfPol"
    prop._addConstant("macsecIfPol", None, 9882)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 30120, PropCategory.REGULAR)
