...
# ##################################################
class RsCoppIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsCoppIfPolCons", "cobra.model.copp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsCoppIfPolCons"
    meta.rnFormat = "rscoppIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "coppIf Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 30168, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 30158, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9907
    prop.defaultValueStr = "coppIfPol"
    prop._addConstant("coppIfPol", None, 9907)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 30157, PropCategory.REGULAR)
