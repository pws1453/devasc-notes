...
# ##################################################
class RsIpv6MonitorPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsIpv6MonitorPolCons", "cobra.model.netflow.MonitorPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsIpv6MonitorPolCons"
    meta.rnFormat = "rsipv6MonitorPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ipv6 Monitor Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 28709, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 28702, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28701, PropCategory.REGULAR)
