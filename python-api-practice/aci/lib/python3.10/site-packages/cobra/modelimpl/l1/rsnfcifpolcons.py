...
# ##################################################
class RsNfcIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsNfcIfPolCons", "cobra.model.fc.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsNfcIfPolCons"
    meta.rnFormat = "rsnfcIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Native FC Interface Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39239, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 39167, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39166, PropCategory.REGULAR)
