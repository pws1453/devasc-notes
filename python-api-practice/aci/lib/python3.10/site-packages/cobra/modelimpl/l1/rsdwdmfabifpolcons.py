...
# ##################################################
class RsDwdmFabIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsDwdmFabIfPolCons", "cobra.model.dwdm.FabIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsDwdmFabIfPolCons"
    meta.rnFormat = "rsdwdmFabIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DWDM Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 35551, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 35538, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11304
    prop.defaultValueStr = "dwdmFabIfPol"
    prop._addConstant("dwdmFabIfPol", None, 11304)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35537, PropCategory.REGULAR)
