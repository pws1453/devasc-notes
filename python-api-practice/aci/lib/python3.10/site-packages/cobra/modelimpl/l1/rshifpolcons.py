...
# ##################################################
class RsHIfPolCons(Mo):
    """
    A source relation to the host interface policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l1.RsHIfPolCons", "cobra.model.fabric.HIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsHIfPolCons"
    meta.rnFormat = "rshIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "HIF Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15111, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12755, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 847
    prop.defaultValueStr = "fabricHIfPol"
    prop._addConstant("fabricHIfPol", None, 847)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12754, PropCategory.REGULAR)
