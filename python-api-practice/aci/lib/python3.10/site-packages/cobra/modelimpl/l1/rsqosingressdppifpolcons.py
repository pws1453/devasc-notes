...
# ##################################################
class RsQosIngressDppIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsQosIngressDppIfPolCons", "cobra.model.qos.DppPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsQosIngressDppIfPolCons"
    meta.rnFormat = "rsQosIngressDppIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "QOS Dpp Policy Attachment Ingress"
    ...
    meta.rnPrefixes = [
        ('rsQosIngressDppIfPolCons', False),
    ]
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 23219, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 23201, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7681
    prop.defaultValueStr = "qosDppPol"
    prop._addConstant("qosDppPol", None, 7681)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23200, PropCategory.REGULAR)
