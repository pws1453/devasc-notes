...
# ##################################################
class RsL2IfPolCons(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.l1.RsL2IfPolCons", "cobra.model.l2.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsL2IfPolCons"
    meta.rnFormat = "rsl2IfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L2 Interface Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 18268, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 18265, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6140
    prop.defaultValueStr = "l2IfPol"
    prop._addConstant("l2IfPol", None, 6140)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18264, PropCategory.REGULAR)
