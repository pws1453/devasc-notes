...
# ##################################################
class RsFcIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsFcIfPolCons", "cobra.model.fc.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsFcIfPolCons"
    meta.rnFormat = "rsfcIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "FC Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 26318, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 26310, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9058
    prop.defaultValueStr = "fcIfPol"
    prop._addConstant("fcIfPol", None, 9058)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26309, PropCategory.REGULAR)
