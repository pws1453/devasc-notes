...
# ##################################################
class RsL3IfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsL3IfPolCons", "cobra.model.l3.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsL3IfPolCons"
    meta.rnFormat = "rsl3IfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L3 Interface Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 33467, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 33463, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10735
    prop.defaultValueStr = "l3IfPol"
    prop._addConstant("l3IfPol", None, 10735)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33462, PropCategory.REGULAR)
