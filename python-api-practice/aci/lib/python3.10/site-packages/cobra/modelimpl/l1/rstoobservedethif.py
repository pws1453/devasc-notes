...
# ##################################################
class RsToObservedEthIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsToObservedEthIf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l1RsToObservedEthIf"
    meta.rnFormat = "rstoObservedEthIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21024, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21023, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 21029, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
