...
# ##################################################
class RsStpIfPolCons(Mo):
    """
    A source relation to the Spanning-Tree Protocol (STP) policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l1.RsStpIfPolCons", "cobra.model.stp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsStpIfPolCons"
    meta.rnFormat = "rsstpIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "STP Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15119, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12771, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 568
    prop.defaultValueStr = "stpIfPol"
    prop._addConstant("stpIfPol", None, 568)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12770, PropCategory.REGULAR)
