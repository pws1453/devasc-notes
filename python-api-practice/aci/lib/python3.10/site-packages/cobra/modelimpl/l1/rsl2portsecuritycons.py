...
# ##################################################
class RsL2PortSecurityCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsL2PortSecurityCons", "cobra.model.l2.PortSecurityPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsL2PortSecurityCons"
    meta.rnFormat = "rsl2PortSecurityCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L2 PortSecurity Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 25980, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 25956, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8936
    prop.defaultValueStr = "l2PortSecurityPol"
    prop._addConstant("l2PortSecurityPol", None, 8936)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25955, PropCategory.REGULAR)
