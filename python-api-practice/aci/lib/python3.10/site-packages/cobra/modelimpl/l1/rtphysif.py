...
class RtPhysIf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.l1.RtPhysIf", "cobra.model.synthetic.AContext")

    meta.moClassName = "l1RtPhysIf"
    meta.rnFormat = "rtPhysIf"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x100000000001
    meta.readAccessMask = 0x84784411022003
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15172, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 13088, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4239
    prop.defaultValueStr = "syntheticAContext"
