...
# ##################################################
class RsCdpIfPolCons(Mo):
    """
    A source relation to CDP interface policy parameters. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l1.RsCdpIfPolCons", "cobra.model.cdp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsCdpIfPolCons"
    meta.rnFormat = "rscdpIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "CDP Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15109, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12751, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 684
    prop.defaultValueStr = "cdpIfPol"
    prop._addConstant("cdpIfPol", None, 684)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12750, PropCategory.REGULAR)
