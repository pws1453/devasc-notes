...
# ##################################################
class RsAttEntityPCons(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.l1.RsAttEntityPCons", "cobra.model.infra.AttEntityP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsAttEntityPCons"
    meta.rnFormat = "rsattEntityPCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachable Entity Profile Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 18279, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 18272, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18271, PropCategory.REGULAR)
