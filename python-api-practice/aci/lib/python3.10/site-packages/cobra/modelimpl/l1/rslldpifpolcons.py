...
# ##################################################
class RsLldpIfPolCons(Mo):
    """
    A source relation to the LLDP policy parameters for the interface. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l1.RsLldpIfPolCons", "cobra.model.lldp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsLldpIfPolCons"
    meta.rnFormat = "rslldpIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "LLDP Policy Attachment"
    ...
    meta.superClasses.add("cobra.model.fabric.ProtoConsTo")

    meta.rnPrefixes = [
        ('rslldpIfPolCons', False),
    ]
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15115, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "selectorType", "selectorType", 18132, PropCategory.REGULAR)
    prop.label = "Selector Associated With The Source Relation"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("ALL", "all", 0)
    prop._addConstant("none", "none", 11)
    prop._addConstant("override", "none", 10)
    prop._addConstant("range", "range", 1)
    meta.props.add("selectorType", prop)

    prop = PropMeta("str", "sourceRelStateQual", "sourceRelStateQual", 18131, PropCategory.REGULAR)
    prop.label = "StateQual Of The Source Relation"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("sourceRelStateQual", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12763, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 691
    prop.defaultValueStr = "lldpIfPol"
    prop._addConstant("lldpIfPol", None, 691)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12762, PropCategory.REGULAR)
