...
# ##################################################
class RsMonPolIfPolCons(Mo):
    """
    A source relation to the base monitoring policy model. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l1.RsMonPolIfPolCons", "cobra.model.mon.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsMonPolIfPolCons"
    meta.rnFormat = "rsmonPolIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Monitoring Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15117, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12767, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4
    prop.defaultValueStr = "monPol"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12766, PropCategory.REGULAR)
