...
# ##################################################
class RsL2PortAuthCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsL2PortAuthCons", "cobra.model.l2.PortAuthPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsL2PortAuthCons"
    meta.rnFormat = "rsl2PortAuthCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L2 PortAuth Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 33368, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 33365, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10658
    prop.defaultValueStr = "l2PortAuthPol"
    prop._addConstant("l2PortAuthPol", None, 10658)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33364, PropCategory.REGULAR)
