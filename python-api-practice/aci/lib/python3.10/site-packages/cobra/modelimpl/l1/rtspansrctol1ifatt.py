...
# ##################################################
class RtSpanSrcToL1IfAtt(Mo):
    """
    A target relation to an abstraction for a layer-1 interface in the system. The properties apply to all types of interfaces. Note that this relation is an internal object. 

    """

    meta = TargetRelationMeta("cobra.model.l1.RtSpanSrcToL1IfAtt", "cobra.model.span.ASource")

    meta.moClassName = "l1RtSpanSrcToL1IfAtt"
    meta.rnFormat = "rtspanSpanSrcToL1IfAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15042, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12615, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2324
    prop.defaultValueStr = "spanASource"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12614, PropCategory.REGULAR)
