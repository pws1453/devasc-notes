...
# ##################################################
class RsFLinkFlapPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsFLinkFlapPolCons", "cobra.model.fabric.FLinkFlapPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsFLinkFlapPolCons"
    meta.rnFormat = "rsfLinkFlapPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Link Flap Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 61884, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 61875, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18263
    prop.defaultValueStr = "fabricFLinkFlapPol"
    prop._addConstant("fabricFLinkFlapPol", None, 18263)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 61874, PropCategory.REGULAR)
