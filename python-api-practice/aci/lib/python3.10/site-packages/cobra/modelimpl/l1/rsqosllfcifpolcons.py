...
# ##################################################
class RsQosLlfcIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsQosLlfcIfPolCons", "cobra.model.qos.LlfcIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsQosLlfcIfPolCons"
    meta.rnFormat = "rsqosLlfcIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "QoS LLFC Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 61502, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 61497, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18224
    prop.defaultValueStr = "qosLlfcIfPol"
    prop._addConstant("qosLlfcIfPol", None, 18224)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 61496, PropCategory.REGULAR)
