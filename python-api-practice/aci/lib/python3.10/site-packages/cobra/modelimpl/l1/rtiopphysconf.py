...
class RtIoPPhysConf(Mo):
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15064, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12680, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3001
    prop.defaultValueStr = "eqptIoP"
