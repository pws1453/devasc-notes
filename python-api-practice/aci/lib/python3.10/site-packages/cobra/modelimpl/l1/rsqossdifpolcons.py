...
# ##################################################
class RsQosSdIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsQosSdIfPolCons", "cobra.model.qos.SdIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsQosSdIfPolCons"
    meta.rnFormat = "rsqosSdIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "QoS Slow Drain Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 25833, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 25804, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8797
    prop.defaultValueStr = "qosSdIfPol"
    prop._addConstant("qosSdIfPol", None, 8797)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25803, PropCategory.REGULAR)
