...
# ##################################################
class RsQosPfcIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsQosPfcIfPolCons", "cobra.model.qos.PfcIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsQosPfcIfPolCons"
    meta.rnFormat = "rsqosPfcIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "QoS PFC Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 25419, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 25339, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8722
    prop.defaultValueStr = "qosPfcIfPol"
    prop._addConstant("qosPfcIfPol", None, 8722)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25338, PropCategory.REGULAR)
