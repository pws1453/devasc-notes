...
# ##################################################
class LacpAllow(Mo):
    meta = StatsClassMeta("cobra.model.copp.LacpAllow", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllow"


    meta.moClassName = "coppLacpAllow"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Lacp stats"
    ...
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow15min")
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow1year")
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow5min")
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow1w")
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow1d")
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow1qtr")
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow1h")
    meta.concreteSubClasses.add("cobra.model.copp.LacpAllow1mo")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 32058, PropCategory.IMPLICIT_AVG)
    prop.label = "LacpAllowed Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesBase", "bytesBase", 32053, PropCategory.IMPLICIT_BASELINE)
    prop.label = "LacpAllowed Bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesBase", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 32054, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "LacpAllowed Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesLast", "bytesLast", 32052, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "LacpAllowed Bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesLast", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 32057, PropCategory.IMPLICIT_MAX)
    prop.label = "LacpAllowed Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 32056, PropCategory.IMPLICIT_MIN)
    prop.label = "LacpAllowed Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 32055, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "LacpAllowed Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 32063, PropCategory.IMPLICIT_RATE)
    prop.label = "LacpAllowed Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 32076, PropCategory.IMPLICIT_AVG)
    prop.label = "LacpAllowed Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateLast", "bytesRateLast", 32073, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "LacpAllowed Bytes rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateLast", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 32075, PropCategory.IMPLICIT_MAX)
    prop.label = "LacpAllowed Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 32074, PropCategory.IMPLICIT_MIN)
    prop.label = "LacpAllowed Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 32077, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LacpAllowed Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 32079, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 32081, PropCategory.IMPLICIT_TREND)
    prop.label = "LacpAllowed Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesRateTrBase", "bytesRateTrBase", 32080, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "LacpAllowed Bytes rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTrBase", prop)

    prop = PropMeta("str", "bytesRateTtl", "bytesRateTtl", 32078, PropCategory.IMPLICIT_TOTAL)
    prop.label = "LacpAllowed Bytes rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTtl", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 32059, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LacpAllowed Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 32060, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 32062, PropCategory.IMPLICIT_TREND)
    prop.label = "LacpAllowed Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesTr", prop)

    prop = PropMeta("str", "bytesTrBase", "bytesTrBase", 32061, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "LacpAllowed Bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 32094, PropCategory.IMPLICIT_AVG)
    prop.label = "LacpAllowed Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsBase", "pktsBase", 32089, PropCategory.IMPLICIT_BASELINE)
    prop.label = "LacpAllowed Packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsBase", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 32090, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "LacpAllowed Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsLast", "pktsLast", 32088, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "LacpAllowed Packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsLast", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 32093, PropCategory.IMPLICIT_MAX)
    prop.label = "LacpAllowed Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 32092, PropCategory.IMPLICIT_MIN)
    prop.label = "LacpAllowed Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 32091, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "LacpAllowed Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 32099, PropCategory.IMPLICIT_RATE)
    prop.label = "LacpAllowed Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 32112, PropCategory.IMPLICIT_AVG)
    prop.label = "LacpAllowed Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateLast", "pktsRateLast", 32109, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "LacpAllowed Packets rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateLast", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 32111, PropCategory.IMPLICIT_MAX)
    prop.label = "LacpAllowed Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 32110, PropCategory.IMPLICIT_MIN)
    prop.label = "LacpAllowed Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 32113, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LacpAllowed Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 32115, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 32117, PropCategory.IMPLICIT_TREND)
    prop.label = "LacpAllowed Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsRateTrBase", "pktsRateTrBase", 32116, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "LacpAllowed Packets rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTrBase", prop)

    prop = PropMeta("str", "pktsRateTtl", "pktsRateTtl", 32114, PropCategory.IMPLICIT_TOTAL)
    prop.label = "LacpAllowed Packets rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTtl", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 32095, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LacpAllowed Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 32096, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 32098, PropCategory.IMPLICIT_TREND)
    prop.label = "LacpAllowed Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsTr", prop)

    prop = PropMeta("str", "pktsTrBase", "pktsTrBase", 32097, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "LacpAllowed Packets trend baseline"
    prop.isOper = True
    prop.isStats = True
