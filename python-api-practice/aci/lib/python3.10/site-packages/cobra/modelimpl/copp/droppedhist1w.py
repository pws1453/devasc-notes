...
class DroppedHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist1w", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist1w"
    meta.rnFormat = "HDcoppDropped1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 33683, PropCategory.REGULAR)
