...
# ##################################################
class RtCoppIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.copp.RtCoppIfPol", "cobra.model.infra.AAccGrp")

    meta.moClassName = "coppRtCoppIfPol"
    meta.rnFormat = "rtinfraCoppIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 30164, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30163, PropCategory.REGULAR)
