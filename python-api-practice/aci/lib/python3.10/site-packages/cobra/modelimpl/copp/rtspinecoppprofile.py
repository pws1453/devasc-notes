...
# ##################################################
class RtSpineCoppProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.copp.RtSpineCoppProfile", "cobra.model.infra.SpineAccNodePGrp")

    meta.moClassName = "coppRtSpineCoppProfile"
    meta.rnFormat = "rtinfraSpineCoppProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 30520, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30544, PropCategory.REGULAR)
