...
# ##################################################
class LacpAllowHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllowHist1w", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllowHist1w"
    meta.rnFormat = "HDcoppLacpAllow1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Lacp stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 31201, PropCategory.REGULAR)
