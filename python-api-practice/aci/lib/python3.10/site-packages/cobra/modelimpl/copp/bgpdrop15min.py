...
# ##################################################
class BgpDrop15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDrop15min", "Per Interface Drop Counters for Bgp")

    counter = CounterMeta("bytesRate", CounterCategory.GAUGE, "bytes-per-second", "BgpDropped Bytes rate")
    ...
    counter = CounterMeta("bytes", CounterCategory.COUNTER, "bytes", "BgpDropped Bytes")
    ...
    counter = CounterMeta("pktsRate", CounterCategory.GAUGE, "packets-per-second", "BgpDropped Packets rate")
    ...
    counter = CounterMeta("pkts", CounterCategory.COUNTER, "packets", "BgpDropped Packets")
    ...
    meta.moClassName = "coppBgpDrop15min"
    meta.rnFormat = "CDcoppBgpDrop15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Drop Counters for Bgp stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.copp.BgpDrop")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDcoppBgpDrop15min', False),
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 31626, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesBase", "bytesBase", 31621, PropCategory.IMPLICIT_BASELINE)
    prop.label = "BgpDropped Bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesBase", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 31622, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "BgpDropped Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesLast", "bytesLast", 31620, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "BgpDropped Bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesLast", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 31625, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 31624, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 31623, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "BgpDropped Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 31631, PropCategory.IMPLICIT_RATE)
    prop.label = "BgpDropped Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 31644, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateLast", "bytesRateLast", 31641, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "BgpDropped Bytes rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateLast", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 31643, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 31642, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 31645, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 31647, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 31649, PropCategory.IMPLICIT_TREND)
    prop.label = "BgpDropped Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesRateTrBase", "bytesRateTrBase", 31648, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "BgpDropped Bytes rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTrBase", prop)

    prop = PropMeta("str", "bytesRateTtl", "bytesRateTtl", 31646, PropCategory.IMPLICIT_TOTAL)
    prop.label = "BgpDropped Bytes rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTtl", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 31627, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 31628, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 31630, PropCategory.IMPLICIT_TREND)
    prop.label = "BgpDropped Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesTr", prop)

    prop = PropMeta("str", "bytesTrBase", "bytesTrBase", 31629, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 31662, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsBase", "pktsBase", 31657, PropCategory.IMPLICIT_BASELINE)
    prop.label = "BgpDropped Packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsBase", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 31658, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "BgpDropped Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsLast", "pktsLast", 31656, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "BgpDropped Packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsLast", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 31661, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 31660, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 31659, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "BgpDropped Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 31667, PropCategory.IMPLICIT_RATE)
    prop.label = "BgpDropped Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 31680, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateLast", "pktsRateLast", 31677, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "BgpDropped Packets rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateLast", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 31679, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 31678, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 31681, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 31683, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 31685, PropCategory.IMPLICIT_TREND)
    prop.label = "BgpDropped Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsRateTrBase", "pktsRateTrBase", 31684, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "BgpDropped Packets rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTrBase", prop)

    prop = PropMeta("str", "pktsRateTtl", "pktsRateTtl", 31682, PropCategory.IMPLICIT_TOTAL)
    prop.label = "BgpDropped Packets rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTtl", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 31663, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 31664, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 31666, PropCategory.IMPLICIT_TREND)
    prop.label = "BgpDropped Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsTr", prop)

    prop = PropMeta("str", "pktsTrBase", "pktsTrBase", 31665, PropCategory.IMPLICIT_TREND_BASE)
