...
# ##################################################
class AllowHist1d(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist1d", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist1d"
    meta.rnFormat = "HDcoppAllow1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 16642, PropCategory.REGULAR)
