...
# ##################################################
class LacpAllowHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllowHist1mo", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllowHist1mo"
    meta.rnFormat = "HDcoppLacpAllow1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Lacp stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 31199, PropCategory.REGULAR)
