...
# ##################################################
class AllowHist15min(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist15min", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist15min"
    meta.rnFormat = "HDcoppAllow15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.copp.AllowHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcoppAllow15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 16641, PropCategory.REGULAR)
