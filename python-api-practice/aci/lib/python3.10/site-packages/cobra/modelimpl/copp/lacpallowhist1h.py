...
# ##################################################
class LacpAllowHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllowHist1h", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllowHist1h"
    meta.rnFormat = "HDcoppLacpAllow1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Lacp stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 31198, PropCategory.REGULAR)
