...
# ##################################################
class BgpAllow15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllow15min", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllow15min"
    meta.rnFormat = "CDcoppBgpAllow15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Bgp stats in 15 minute"
