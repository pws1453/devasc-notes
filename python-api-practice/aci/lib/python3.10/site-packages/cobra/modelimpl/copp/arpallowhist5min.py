...
# ##################################################
class ArpAllowHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllowHist5min", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllowHist5min"
    meta.rnFormat = "HDcoppArpAllow5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Arp stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 31115, PropCategory.REGULAR)
