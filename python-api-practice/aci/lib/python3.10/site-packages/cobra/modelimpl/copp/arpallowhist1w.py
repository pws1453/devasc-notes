...
# ##################################################
class ArpAllowHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllowHist1w", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllowHist1w"
    meta.rnFormat = "HDcoppArpAllow1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Arp stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 31113, PropCategory.REGULAR)
