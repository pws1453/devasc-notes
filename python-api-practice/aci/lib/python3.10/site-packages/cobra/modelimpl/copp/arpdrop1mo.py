...
class ArpDrop1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.ArpDrop1mo", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDrop1mo"
    meta.rnFormat = "CDcoppArpDrop1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Drop Counters for Arp stats in 1 month"
