...
# ##################################################
class LacpAllowHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllowHist1qtr", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllowHist1qtr"
    meta.rnFormat = "HDcoppLacpAllow1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Lacp stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 31200, PropCategory.REGULAR)
