...
class Allow1h(Mo):
    """
    A class that represents the most current statistics for  Copp   Allow  Counters in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.copp.Allow1h", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllow1h"
    meta.rnFormat = "CDcoppAllow1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Copp  Allow Counters stats in 1 hour"
