...
class ArpDrop1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.ArpDrop1h", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDrop1h"
    meta.rnFormat = "CDcoppArpDrop1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Drop Counters for Arp stats in 1 hour"
