...
class Allow5min(Mo):
    """
    A class that represents the most current statistics for  Copp   Allow  Counters in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.copp.Allow5min", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllow5min"
    meta.rnFormat = "CDcoppAllow5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Copp  Allow Counters stats in 5 minute"
