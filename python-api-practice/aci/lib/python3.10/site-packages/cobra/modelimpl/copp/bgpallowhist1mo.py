...
# ##################################################
class BgpAllowHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllowHist1mo", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllowHist1mo"
    meta.rnFormat = "HDcoppBgpAllow1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Bgp stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 31143, PropCategory.REGULAR)
