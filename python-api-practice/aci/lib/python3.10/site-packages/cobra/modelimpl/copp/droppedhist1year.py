...
class DroppedHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist1year", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist1year"
    meta.rnFormat = "HDcoppDropped1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 33684, PropCategory.REGULAR)
