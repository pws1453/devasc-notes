...
# ##################################################
class ArpDropHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist1d", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist1d"
    meta.rnFormat = "HDcoppArpDrop1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 31117, PropCategory.REGULAR)
