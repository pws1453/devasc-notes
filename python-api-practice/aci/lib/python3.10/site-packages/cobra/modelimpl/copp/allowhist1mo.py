...
# ##################################################
class AllowHist1mo(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist1mo", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist1mo"
    meta.rnFormat = "HDcoppAllow1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 16644, PropCategory.REGULAR)
