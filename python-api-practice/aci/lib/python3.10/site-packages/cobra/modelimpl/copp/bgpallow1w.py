...
class BgpAllow1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.BgpAllow1w", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllow1w"
    meta.rnFormat = "CDcoppBgpAllow1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Bgp stats in 1 week"
