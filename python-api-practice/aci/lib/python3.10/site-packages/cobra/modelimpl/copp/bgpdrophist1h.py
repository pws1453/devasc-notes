...
# ##################################################
class BgpDropHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist1h", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist1h"
    meta.rnFormat = "HDcoppBgpDrop1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 31150, PropCategory.REGULAR)
