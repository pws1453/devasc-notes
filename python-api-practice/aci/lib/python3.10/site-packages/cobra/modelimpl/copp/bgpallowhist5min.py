...
# ##################################################
class BgpAllowHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllowHist5min", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllowHist5min"
    meta.rnFormat = "HDcoppBgpAllow5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Bgp stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 31147, PropCategory.REGULAR)
