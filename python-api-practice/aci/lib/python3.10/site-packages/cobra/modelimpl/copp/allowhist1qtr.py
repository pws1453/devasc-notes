...
# ##################################################
class AllowHist1qtr(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist1qtr", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist1qtr"
    meta.rnFormat = "HDcoppAllow1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 16645, PropCategory.REGULAR)
