...
# ##################################################
class ArpAllowHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllowHist1qtr", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllowHist1qtr"
    meta.rnFormat = "HDcoppArpAllow1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Arp stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 31112, PropCategory.REGULAR)
