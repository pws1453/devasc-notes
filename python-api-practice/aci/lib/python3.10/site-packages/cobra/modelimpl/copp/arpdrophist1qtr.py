...
# ##################################################
class ArpDropHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist1qtr", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist1qtr"
    meta.rnFormat = "HDcoppArpDrop1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 31120, PropCategory.REGULAR)
