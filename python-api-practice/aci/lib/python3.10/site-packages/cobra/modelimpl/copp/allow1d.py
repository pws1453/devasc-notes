...
class Allow1d(Mo):
    """
    A class that represents the most current statistics for  Copp   Allow  Counters in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.copp.Allow1d", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllow1d"
    meta.rnFormat = "CDcoppAllow1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Copp  Allow Counters stats in 1 day"
