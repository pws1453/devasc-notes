...
class DroppedHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist1qtr", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist1qtr"
    meta.rnFormat = "HDcoppDropped1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 33682, PropCategory.REGULAR)
