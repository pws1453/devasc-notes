...
# ##################################################
class LacpAllowHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllowHist1d", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllowHist1d"
    meta.rnFormat = "HDcoppLacpAllow1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Lacp stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 31197, PropCategory.REGULAR)
