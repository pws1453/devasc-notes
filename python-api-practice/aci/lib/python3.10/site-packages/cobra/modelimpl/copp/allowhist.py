...
# ##################################################
class AllowHist(Mo):
    meta = StatsClassMeta("cobra.model.copp.AllowHist", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist"


    meta.moClassName = "coppAllowHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats"
    ...
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist1qtr")
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist1w")
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist15min")
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist1mo")
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist1d")
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist1year")
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist1h")
    meta.concreteSubClasses.add("cobra.model.copp.AllowHist5min")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 16673, PropCategory.IMPLICIT_AVG)
    prop.label = "Allowed Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 16669, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Allowed Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 16672, PropCategory.IMPLICIT_MAX)
    prop.label = "Allowed Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 16671, PropCategory.IMPLICIT_MIN)
    prop.label = "Allowed Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 16670, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Allowed Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 16677, PropCategory.IMPLICIT_RATE)
    prop.label = "Allowed Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 16689, PropCategory.IMPLICIT_AVG)
    prop.label = "Allowed Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 16688, PropCategory.IMPLICIT_MAX)
    prop.label = "Allowed Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 16687, PropCategory.IMPLICIT_MIN)
    prop.label = "Allowed Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 16690, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Allowed Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 16691, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 16692, PropCategory.IMPLICIT_TREND)
    prop.label = "Allowed Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 16674, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Allowed Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 16675, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 16676, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 16709, PropCategory.IMPLICIT_AVG)
    prop.label = "Allowed Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 16705, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Allowed Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 16708, PropCategory.IMPLICIT_MAX)
    prop.label = "Allowed Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 16707, PropCategory.IMPLICIT_MIN)
    prop.label = "Allowed Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 16706, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Allowed Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 16713, PropCategory.IMPLICIT_RATE)
    prop.label = "Allowed Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 16725, PropCategory.IMPLICIT_AVG)
    prop.label = "Allowed Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 16724, PropCategory.IMPLICIT_MAX)
    prop.label = "Allowed Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 16723, PropCategory.IMPLICIT_MIN)
    prop.label = "Allowed Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 16726, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Allowed Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 16727, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 16728, PropCategory.IMPLICIT_TREND)
    prop.label = "Allowed Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 16710, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Allowed Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 16711, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 16712, PropCategory.IMPLICIT_TREND)
