...
# ##################################################
class LacpAllowHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllowHist15min", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllowHist15min"
    meta.rnFormat = "HDcoppLacpAllow15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Lacp stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 31196, PropCategory.REGULAR)
