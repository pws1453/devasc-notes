...
class ArpAllow1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.ArpAllow1w", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllow1w"
    meta.rnFormat = "CDcoppArpAllow1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Arp stats in 1 week"
