...
# ##################################################
class BgpAllowHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllowHist15min", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllowHist15min"
    meta.rnFormat = "HDcoppBgpAllow15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Bgp stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 31140, PropCategory.REGULAR)
