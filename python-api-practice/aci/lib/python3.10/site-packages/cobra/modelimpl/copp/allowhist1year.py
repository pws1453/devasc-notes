...
# ##################################################
class AllowHist1year(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist1year", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist1year"
    meta.rnFormat = "HDcoppAllow1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 16647, PropCategory.REGULAR)
