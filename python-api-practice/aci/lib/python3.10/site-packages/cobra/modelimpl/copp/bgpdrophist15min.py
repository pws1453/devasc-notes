...
# ##################################################
class BgpDropHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist15min", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist15min"
    meta.rnFormat = "HDcoppBgpDrop15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.copp.BgpDropHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcoppBgpDrop15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 31148, PropCategory.REGULAR)
