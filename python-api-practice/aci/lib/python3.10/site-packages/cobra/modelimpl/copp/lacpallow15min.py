...
# ##################################################
class LacpAllow15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllow15min", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllow15min"
    meta.rnFormat = "CDcoppLacpAllow15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Lacp stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.copp.LacpAllow")

    meta.rnPrefixes = [
        ('CDcoppLacpAllow15min', False),
    ]
