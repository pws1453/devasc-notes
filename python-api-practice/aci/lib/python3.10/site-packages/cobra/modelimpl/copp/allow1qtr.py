...
class Allow1qtr(Mo):
    """
    A class that represents the most current statistics for  Copp   Allow  Counters in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.Allow1qtr", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllow1qtr"
    meta.rnFormat = "CDcoppAllow1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Copp  Allow Counters stats in 1 quarter"
