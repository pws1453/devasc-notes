...
# ##################################################
class BgpAllow1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllow1qtr", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllow1qtr"
    meta.rnFormat = "CDcoppBgpAllow1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Bgp stats in 1 quarter"
