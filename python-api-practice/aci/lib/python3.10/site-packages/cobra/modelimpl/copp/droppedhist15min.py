...
class DroppedHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist15min", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist15min"
    meta.rnFormat = "HDcoppDropped15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.copp.DroppedHist")

    meta.rnPrefixes = [
        ('HDcoppDropped15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 33678, PropCategory.REGULAR)
