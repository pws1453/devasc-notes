...
# ##################################################
class BgpDropHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist5min", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist5min"
    meta.rnFormat = "HDcoppBgpDrop5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 31155, PropCategory.REGULAR)
