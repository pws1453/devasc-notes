...
# ##################################################
class ArpDrop1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDrop1qtr", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDrop1qtr"
    meta.rnFormat = "CDcoppArpDrop1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Drop Counters for Arp stats in 1 quarter"
