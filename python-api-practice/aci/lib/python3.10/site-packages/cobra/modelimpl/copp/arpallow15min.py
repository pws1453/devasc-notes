...
# ##################################################
class ArpAllow15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllow15min", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllow15min"
    meta.rnFormat = "CDcoppArpAllow15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Arp stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.copp.ArpAllow")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDcoppArpAllow15min', False),
    ]
