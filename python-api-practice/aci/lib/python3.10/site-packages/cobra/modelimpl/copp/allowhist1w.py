...
# ##################################################
class AllowHist1w(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist1w", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist1w"
    meta.rnFormat = "HDcoppAllow1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 16646, PropCategory.REGULAR)
