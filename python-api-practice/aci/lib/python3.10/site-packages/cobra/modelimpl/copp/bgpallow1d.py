...
class BgpAllow1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.BgpAllow1d", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllow1d"
    meta.rnFormat = "CDcoppBgpAllow1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Bgp stats in 1 day"
