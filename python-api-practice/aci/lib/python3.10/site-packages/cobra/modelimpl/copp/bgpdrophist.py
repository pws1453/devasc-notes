...
# ##################################################
class BgpDropHist(Mo):
    meta = StatsClassMeta("cobra.model.copp.BgpDropHist", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist"


    meta.moClassName = "coppBgpDropHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats"
    ...
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist1h")
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist1d")
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist15min")
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist1mo")
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist1qtr")
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist5min")
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist1w")
    meta.concreteSubClasses.add("cobra.model.copp.BgpDropHist1year")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 31636, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 31632, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "BgpDropped Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 31635, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 31634, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 31633, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "BgpDropped Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 31640, PropCategory.IMPLICIT_RATE)
    prop.label = "BgpDropped Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 31652, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 31651, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 31650, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 31653, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 31654, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 31655, PropCategory.IMPLICIT_TREND)
    prop.label = "BgpDropped Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 31637, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 31638, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 31639, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 31672, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 31668, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "BgpDropped Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 31671, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 31670, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 31669, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "BgpDropped Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 31676, PropCategory.IMPLICIT_RATE)
    prop.label = "BgpDropped Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 31688, PropCategory.IMPLICIT_AVG)
    prop.label = "BgpDropped Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 31687, PropCategory.IMPLICIT_MAX)
    prop.label = "BgpDropped Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 31686, PropCategory.IMPLICIT_MIN)
    prop.label = "BgpDropped Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 31689, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 31690, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 31691, PropCategory.IMPLICIT_TREND)
    prop.label = "BgpDropped Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 31673, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BgpDropped Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 31674, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 31675, PropCategory.IMPLICIT_TREND)
