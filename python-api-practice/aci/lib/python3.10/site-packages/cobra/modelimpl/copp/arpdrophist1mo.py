...
# ##################################################
class ArpDropHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist1mo", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist1mo"
    meta.rnFormat = "HDcoppArpDrop1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 31119, PropCategory.REGULAR)
