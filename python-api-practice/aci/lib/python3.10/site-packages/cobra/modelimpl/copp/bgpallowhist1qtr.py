...
# ##################################################
class BgpAllowHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllowHist1qtr", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllowHist1qtr"
    meta.rnFormat = "HDcoppBgpAllow1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Bgp stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 31144, PropCategory.REGULAR)
