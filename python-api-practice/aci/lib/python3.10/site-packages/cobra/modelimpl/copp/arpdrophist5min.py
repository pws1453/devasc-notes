...
# ##################################################
class ArpDropHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist5min", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist5min"
    meta.rnFormat = "HDcoppArpDrop5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 31123, PropCategory.REGULAR)
