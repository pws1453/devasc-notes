...
# ##################################################
class ArpAllowHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllowHist1mo", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllowHist1mo"
    meta.rnFormat = "HDcoppArpAllow1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Arp stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 31111, PropCategory.REGULAR)
