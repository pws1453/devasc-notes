...
# ##################################################
class ArpAllowHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllowHist1d", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllowHist1d"
    meta.rnFormat = "HDcoppArpAllow1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Arp stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 31109, PropCategory.REGULAR)
