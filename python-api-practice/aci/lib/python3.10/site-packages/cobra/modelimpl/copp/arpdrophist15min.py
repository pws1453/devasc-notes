...
# ##################################################
class ArpDropHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist15min", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist15min"
    meta.rnFormat = "HDcoppArpDrop15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.copp.ArpDropHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcoppArpDrop15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 31116, PropCategory.REGULAR)
