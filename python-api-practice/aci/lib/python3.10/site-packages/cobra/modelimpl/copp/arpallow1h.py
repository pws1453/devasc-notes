...
class ArpAllow1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.ArpAllow1h", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllow1h"
    meta.rnFormat = "CDcoppArpAllow1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Arp stats in 1 hour"
