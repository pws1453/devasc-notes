...
class Allow1w(Mo):
    """
    A class that represents the most current statistics for  Copp   Allow  Counters in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.Allow1w", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllow1w"
    meta.rnFormat = "CDcoppAllow1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Copp  Allow Counters stats in 1 week"
