...
# ##################################################
class BgpAllowHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllowHist1h", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllowHist1h"
    meta.rnFormat = "HDcoppBgpAllow1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Bgp stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 31142, PropCategory.REGULAR)
