...
# ##################################################
class BgpDropHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist1qtr", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist1qtr"
    meta.rnFormat = "HDcoppBgpDrop1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 31152, PropCategory.REGULAR)
