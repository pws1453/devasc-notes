...
# ##################################################
class AllowHist1h(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist1h", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist1h"
    meta.rnFormat = "HDcoppAllow1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 16643, PropCategory.REGULAR)
