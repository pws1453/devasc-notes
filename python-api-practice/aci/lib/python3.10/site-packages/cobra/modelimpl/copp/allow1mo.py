...
class Allow1mo(Mo):
    """
    A class that represents the most current statistics for  Copp   Allow  Counters in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.Allow1mo", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllow1mo"
    meta.rnFormat = "CDcoppAllow1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Copp  Allow Counters stats in 1 month"
