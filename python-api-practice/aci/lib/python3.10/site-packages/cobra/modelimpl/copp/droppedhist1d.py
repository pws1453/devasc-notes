...
class DroppedHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist1d", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist1d"
    meta.rnFormat = "HDcoppDropped1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 33679, PropCategory.REGULAR)
