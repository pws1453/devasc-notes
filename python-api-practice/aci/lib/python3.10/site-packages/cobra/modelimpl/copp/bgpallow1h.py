...
class BgpAllow1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.BgpAllow1h", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllow1h"
    meta.rnFormat = "CDcoppBgpAllow1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Bgp stats in 1 hour"
