...
# ##################################################
class BgpDropHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist1year", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist1year"
    meta.rnFormat = "HDcoppBgpDrop1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 31154, PropCategory.REGULAR)
