...
class DroppedHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist1h", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist1h"
    meta.rnFormat = "HDcoppDropped1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 33680, PropCategory.REGULAR)
