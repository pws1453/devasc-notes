...
# ##################################################
class BgpDropHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist1w", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist1w"
    meta.rnFormat = "HDcoppBgpDrop1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 31153, PropCategory.REGULAR)
