...
# ##################################################
class BgpDropHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist1d", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist1d"
    meta.rnFormat = "HDcoppBgpDrop1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 31149, PropCategory.REGULAR)
