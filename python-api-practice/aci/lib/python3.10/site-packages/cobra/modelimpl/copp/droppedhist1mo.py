...
class DroppedHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist1mo", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist1mo"
    meta.rnFormat = "HDcoppDropped1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 33681, PropCategory.REGULAR)
