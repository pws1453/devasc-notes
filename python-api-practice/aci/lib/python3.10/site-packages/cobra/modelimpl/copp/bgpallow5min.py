...
# ##################################################
class BgpAllow5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllow5min", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllow5min"
    meta.rnFormat = "CDcoppBgpAllow5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Bgp stats in 5 minute"
