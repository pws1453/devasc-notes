...
# ##################################################
class ArpDropHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist1year", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist1year"
    meta.rnFormat = "HDcoppArpDrop1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 31122, PropCategory.REGULAR)
