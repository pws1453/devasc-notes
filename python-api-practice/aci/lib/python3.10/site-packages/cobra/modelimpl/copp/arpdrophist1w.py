...
# ##################################################
class ArpDropHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist1w", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist1w"
    meta.rnFormat = "HDcoppArpDrop1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 31121, PropCategory.REGULAR)
