...
# ##################################################
class LacpAllowHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.LacpAllowHist1year", "Per Interface Allow Counters for Lacp")
    ...
    meta.moClassName = "coppLacpAllowHist1year"
    meta.rnFormat = "HDcoppLacpAllow1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Lacp stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 31202, PropCategory.REGULAR)
