...
# ##################################################
class BgpDropHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpDropHist1mo", "Per Interface Drop Counters for Bgp")
    ...
    meta.moClassName = "coppBgpDropHist1mo"
    meta.rnFormat = "HDcoppBgpDrop1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Bgp stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 31151, PropCategory.REGULAR)
