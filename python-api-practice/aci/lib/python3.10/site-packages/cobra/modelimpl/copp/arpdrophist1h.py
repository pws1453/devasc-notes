...
# ##################################################
class ArpDropHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDropHist1h", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist1h"
    meta.rnFormat = "HDcoppArpDrop1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 31118, PropCategory.REGULAR)
