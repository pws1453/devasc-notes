...
# ##################################################
class ArpAllowHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllowHist15min", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllowHist15min"
    meta.rnFormat = "HDcoppArpAllow15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Arp stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 31108, PropCategory.REGULAR)
