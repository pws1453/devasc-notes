...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.copp.Entity")

    meta.moClassName = "coppEntity"
    meta.rnFormat = "copp"
    meta.category = MoCategory.REGULAR
    meta.label = "CoPP Entity"
    ...
    meta.childClasses.add("cobra.model.copp.Class")
    meta.childClasses.add("cobra.model.copp.Rule")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.copp.Class", "classp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.copp.Rule", "rulep-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16802, PropCategory.REGULAR)
