...
# ##################################################
class ArpAllow(Mo):
    meta = StatsClassMeta("cobra.model.copp.ArpAllow", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllow"


    meta.moClassName = "coppArpAllow"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Arp stats"
    ...
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow1d")
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow1h")
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow1w")
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow1mo")
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow1qtr")
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow15min")
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow5min")
    meta.concreteSubClasses.add("cobra.model.copp.ArpAllow1year")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 31266, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpAllowed Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesBase", "bytesBase", 31261, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ArpAllowed Bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesBase", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 31262, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ArpAllowed Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesLast", "bytesLast", 31260, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ArpAllowed Bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesLast", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 31265, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpAllowed Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 31264, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpAllowed Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 31263, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ArpAllowed Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 31271, PropCategory.IMPLICIT_RATE)
    prop.label = "ArpAllowed Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 31284, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpAllowed Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateLast", "bytesRateLast", 31281, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ArpAllowed Bytes rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateLast", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 31283, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpAllowed Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 31282, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpAllowed Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 31285, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpAllowed Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 31287, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 31289, PropCategory.IMPLICIT_TREND)
    prop.label = "ArpAllowed Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesRateTrBase", "bytesRateTrBase", 31288, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "ArpAllowed Bytes rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTrBase", prop)

    prop = PropMeta("str", "bytesRateTtl", "bytesRateTtl", 31286, PropCategory.IMPLICIT_TOTAL)
    prop.label = "ArpAllowed Bytes rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTtl", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 31267, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpAllowed Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 31268, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 31270, PropCategory.IMPLICIT_TREND)
    prop.label = "ArpAllowed Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesTr", prop)

    prop = PropMeta("str", "bytesTrBase", "bytesTrBase", 31269, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "ArpAllowed Bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 31302, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpAllowed Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsBase", "pktsBase", 31297, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ArpAllowed Packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsBase", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 31298, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ArpAllowed Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsLast", "pktsLast", 31296, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ArpAllowed Packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsLast", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 31301, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpAllowed Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 31300, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpAllowed Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 31299, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ArpAllowed Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 31307, PropCategory.IMPLICIT_RATE)
    prop.label = "ArpAllowed Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 31320, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpAllowed Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateLast", "pktsRateLast", 31317, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ArpAllowed Packets rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateLast", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 31319, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpAllowed Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 31318, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpAllowed Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 31321, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpAllowed Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 31323, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 31325, PropCategory.IMPLICIT_TREND)
    prop.label = "ArpAllowed Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsRateTrBase", "pktsRateTrBase", 31324, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "ArpAllowed Packets rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTrBase", prop)

    prop = PropMeta("str", "pktsRateTtl", "pktsRateTtl", 31322, PropCategory.IMPLICIT_TOTAL)
    prop.label = "ArpAllowed Packets rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTtl", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 31303, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpAllowed Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 31304, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 31306, PropCategory.IMPLICIT_TREND)
    prop.label = "ArpAllowed Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsTr", prop)

    prop = PropMeta("str", "pktsTrBase", "pktsTrBase", 31305, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "ArpAllowed Packets trend baseline"
    prop.isOper = True
    prop.isStats = True
