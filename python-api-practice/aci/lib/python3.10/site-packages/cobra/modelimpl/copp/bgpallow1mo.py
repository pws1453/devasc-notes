...
# ##################################################
class BgpAllow1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllow1mo", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllow1mo"
    meta.rnFormat = "CDcoppBgpAllow1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Allow Counters for Bgp stats in 1 month"
