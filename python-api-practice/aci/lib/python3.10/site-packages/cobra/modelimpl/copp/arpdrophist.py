...
# ##################################################
class ArpDropHist(Mo):
    meta = StatsClassMeta("cobra.model.copp.ArpDropHist", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDropHist"


    meta.moClassName = "coppArpDropHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Drop Counters for Arp stats"
    ...
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist1qtr")
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist1w")
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist1year")
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist5min")
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist1d")
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist1mo")
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist15min")
    meta.concreteSubClasses.add("cobra.model.copp.ArpDropHist1h")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 31348, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpDropped Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 31344, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ArpDropped Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 31347, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpDropped Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 31346, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpDropped Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 31345, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ArpDropped Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 31352, PropCategory.IMPLICIT_RATE)
    prop.label = "ArpDropped Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 31364, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpDropped Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 31363, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpDropped Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 31362, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpDropped Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 31365, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpDropped Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 31366, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 31367, PropCategory.IMPLICIT_TREND)
    prop.label = "ArpDropped Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 31349, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpDropped Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 31350, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 31351, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 31384, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpDropped Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 31380, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ArpDropped Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 31383, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpDropped Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 31382, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpDropped Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 31381, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ArpDropped Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 31388, PropCategory.IMPLICIT_RATE)
    prop.label = "ArpDropped Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 31400, PropCategory.IMPLICIT_AVG)
    prop.label = "ArpDropped Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 31399, PropCategory.IMPLICIT_MAX)
    prop.label = "ArpDropped Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 31398, PropCategory.IMPLICIT_MIN)
    prop.label = "ArpDropped Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 31401, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpDropped Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 31402, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 31403, PropCategory.IMPLICIT_TREND)
    prop.label = "ArpDropped Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 31385, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ArpDropped Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 31386, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 31387, PropCategory.IMPLICIT_TREND)
