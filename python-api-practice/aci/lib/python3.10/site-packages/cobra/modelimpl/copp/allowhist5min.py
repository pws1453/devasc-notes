...
# ##################################################
class AllowHist5min(Mo):
    """
    A class that represents historical statistics for  Copp   Allow  Counters in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.copp.AllowHist5min", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllowHist5min"
    meta.rnFormat = "HDcoppAllow5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp  Allow Counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 16648, PropCategory.REGULAR)
