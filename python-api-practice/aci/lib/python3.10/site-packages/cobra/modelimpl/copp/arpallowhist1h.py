...
# ##################################################
class ArpAllowHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpAllowHist1h", "Per Interface Allow Counters for Arp")
    ...
    meta.moClassName = "coppArpAllowHist1h"
    meta.rnFormat = "HDcoppArpAllow1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Arp stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 31110, PropCategory.REGULAR)
