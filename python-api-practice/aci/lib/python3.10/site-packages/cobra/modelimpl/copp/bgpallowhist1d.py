...
# ##################################################
class BgpAllowHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllowHist1d", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllowHist1d"
    meta.rnFormat = "HDcoppBgpAllow1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Bgp stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 31141, PropCategory.REGULAR)
