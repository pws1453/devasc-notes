...
class Allow1year(Mo):
    """
    A class that represents the most current statistics for  Copp   Allow  Counters in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.copp.Allow1year", "Copp  Allow Counters")
    ...
    meta.moClassName = "coppAllow1year"
    meta.rnFormat = "CDcoppAllow1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Copp  Allow Counters stats in 1 year"
