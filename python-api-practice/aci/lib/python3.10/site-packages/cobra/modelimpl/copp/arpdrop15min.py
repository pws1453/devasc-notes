...
# ##################################################
class ArpDrop15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDrop15min", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDrop15min"
    meta.rnFormat = "CDcoppArpDrop15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Drop Counters for Arp stats in 15 minute"
