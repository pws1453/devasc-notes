...
# ##################################################
class ArpDrop5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.ArpDrop5min", "Per Interface Drop Counters for Arp")
    ...
    meta.moClassName = "coppArpDrop5min"
    meta.rnFormat = "CDcoppArpDrop5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Per Interface Drop Counters for Arp stats in 5 minute"
