...
# ##################################################
class BgpAllowHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.copp.BgpAllowHist1year", "Per Interface Allow Counters for Bgp")
    ...
    meta.moClassName = "coppBgpAllowHist1year"
    meta.rnFormat = "HDcoppBgpAllow1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Per Interface Allow Counters for Bgp stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 31146, PropCategory.REGULAR)
