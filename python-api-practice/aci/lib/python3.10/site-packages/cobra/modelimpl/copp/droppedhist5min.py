...
class DroppedHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.copp.DroppedHist5min", "Copp Dropped Counters")
    ...
    meta.moClassName = "coppDroppedHist5min"
    meta.rnFormat = "HDcoppDropped5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Copp Dropped Counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 33685, PropCategory.REGULAR)
