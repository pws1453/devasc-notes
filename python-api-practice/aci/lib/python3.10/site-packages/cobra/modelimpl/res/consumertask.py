...
# ##################################################
class ConsumerTask(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = ClassMeta("cobra.model.res.ConsumerTask")

    meta.moClassName = "resConsumerTask"
    meta.rnFormat = "resConsumerTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.res.ConsumerContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.res.ConsumerContext", "resConsumer"))
    ...
    prop = PropMeta("str", "id", "id", 5639, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Register", "register", 2)
    prop._addConstant("Unregister", "unregister", 3)
