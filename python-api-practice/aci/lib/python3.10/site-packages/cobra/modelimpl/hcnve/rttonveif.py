...
class RtToNveIf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hcnve.RtToNveIf", "cobra.model.hcl3.Vrf")

    meta.moClassName = "hcnveRtToNveIf"
    meta.rnFormat = "rthcl3ToNveIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51283, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14868
    prop.defaultValueStr = "hcl3Vrf"
    prop._addConstant("hcl3Vrf", None, 14868)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51282, PropCategory.REGULAR)
