...
# ##################################################
class RsSourceLoopbackRoutedIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcnve.RsSourceLoopbackRoutedIf", "cobra.model.hcl3.LoopbackRoutedIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcnveRsSourceLoopbackRoutedIf"
    meta.rnFormat = "rssourceLoopbackRoutedIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Source Interface Loopback"
    ...
    meta.rnPrefixes = [
        ('rssourceLoopbackRoutedIf', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51363, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51362, PropCategory.REGULAR)
