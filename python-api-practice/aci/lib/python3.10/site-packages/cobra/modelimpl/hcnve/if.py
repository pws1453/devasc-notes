...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.hcnve.If")

    meta.moClassName = "hcnveIf"
    meta.rnFormat = "nve-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VNE Interface for VxLAN Encapsulation"
    meta.writeAccessMask = 0x408421002001
    meta.readAccessMask = 0x408421002001
    ...
    meta.childClasses.add("cobra.model.hcnve.RsSourceLoopbackRoutedIf")
    meta.childClasses.add("cobra.model.hcnve.RtToNveIf")
    meta.childClasses.add("cobra.model.hcnve.IfOper")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcnve.RsSourceLoopbackRoutedIf", "rssourceLoopbackRoutedIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcnve.RtToNveIf", "rthcl3ToNveIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcnve.IfOper", "oper"))
    ...
    meta.superClasses.add("cobra.model.hcl3.BaseIf")
    ...
    prop = PropMeta("str", "addr", "addr", 50267, PropCategory.REGULAR)
    prop.label = "IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "adminSt", "adminSt", 50266, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 50762, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "port", "port", 50427, PropCategory.REGULAR)
    prop.label = "VxLAN UDP Port"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "protocol", "protocol", 50428, PropCategory.REGULAR)
    prop.label = "Host Reachability Protocol"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "bgp"
    prop._addConstant("bgp", "bgp-protocol", 0)
    meta.props.add("protocol", prop)

    prop = PropMeta("str", "publicAddr", "publicAddr", 50268, PropCategory.REGULAR)
    prop.label = "Public/NAT-ed IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("publicAddr", prop)
