...
# ##################################################
class RsNodeLocation(Mo):
    """
    A source relation to the node belonging to this rack.

    """

    meta = SourceRelationMeta("cobra.model.geo.RsNodeLocation", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "geoRsNodeLocation"
    meta.rnFormat = "rsnodeLocation-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Fabric Node"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37348, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39487, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 11348, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11347, PropCategory.REGULAR)
