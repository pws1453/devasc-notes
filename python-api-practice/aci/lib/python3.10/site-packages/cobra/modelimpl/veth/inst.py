...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.veth.Inst")

    meta.moClassName = "vethInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Veth Instance"
    meta.writeAccessMask = 0x2002008010001
    meta.readAccessMask = 0x2102008010001
    ...
    meta.childClasses.add("cobra.model.l1.VethIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l1.VethIf", "veth-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 39186, PropCategory.REGULAR)
