...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.smm.Entity")

    meta.moClassName = "smmEntity"
    meta.rnFormat = "smm"
    meta.category = MoCategory.REGULAR
    meta.label = "SMM Entity"
    ...
    meta.childClasses.add("cobra.model.smm.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.smm.Inst", "inst"))
