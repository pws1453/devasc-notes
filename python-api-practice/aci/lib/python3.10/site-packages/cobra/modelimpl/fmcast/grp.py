...
class Grp(Mo):
    """
    A multicast group entity.

    """

    meta = ClassMeta("cobra.model.fmcast.Grp")

    meta.moClassName = "fmcastGrp"
    meta.rnFormat = "fmgrp-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 6524, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
