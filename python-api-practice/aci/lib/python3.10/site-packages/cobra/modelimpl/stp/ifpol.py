...
class IfPol(Mo):
    ...
    meta.childClasses.add("cobra.model.stp.RtStpIfPol")
    meta.childClasses.add("cobra.model.stp.RtOverrideStpPol")
    meta.childClasses.add("cobra.model.stp.RtDefaultStpIfPol")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.stp.RtStpIfPolCons")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.stp.RtVswitchOverrideStpPol")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.stp.RtVswitchOverrideStpPol", "rtvmmVswitchOverrideStpPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.stp.RtOverrideStpPol", "rtinfraOverrideStpPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.stp.RtDefaultStpIfPol", "rtvmmDefaultStpIfPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.stp.RtStpIfPolCons", "rtl1StpIfPolCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.stp.RtStpIfPol", "rtinfraStpIfPol-"))
    ...
    meta.superClasses.add("cobra.model.stp.AIfPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37352, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 748, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("bpdu-filter", "bpdu-filter-enabled", 2)
    prop._addConstant("bpdu-guard", "bpdu-guard-enabled", 1)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39491, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13889, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7202, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
