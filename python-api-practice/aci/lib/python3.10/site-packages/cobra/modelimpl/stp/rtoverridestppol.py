...
# ##################################################
class RtOverrideStpPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.stp.RtOverrideStpPol", "cobra.model.infra.AttPolicyGroup")

    meta.moClassName = "stpRtOverrideStpPol"
    meta.rnFormat = "rtinfraOverrideStpPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20122, PropCategory.REGULAR)
