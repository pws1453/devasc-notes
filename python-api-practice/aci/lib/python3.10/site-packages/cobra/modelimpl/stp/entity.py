...
class Entity(Mo):
    """
    The spanning-tree protocol control plane entity information.

    """

    meta = ClassMeta("cobra.model.stp.Entity")

    meta.moClassName = "stpEntity"
    meta.rnFormat = "stp"
    meta.category = MoCategory.REGULAR
    meta.label = "STP Entity"
    ...
    meta.childClasses.add("cobra.model.stp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.stp.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14443, PropCategory.REGULAR)
