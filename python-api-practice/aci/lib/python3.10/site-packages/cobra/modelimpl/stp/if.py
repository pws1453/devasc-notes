...
class If(Mo):
    """
    A container for the MCP information that is operated at a interface level.

    """

    meta = ClassMeta("cobra.model.stp.If")

    meta.moClassName = "stpIf"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "STP Interface"
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 2444, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 7201, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 2443, PropCategory.REGULAR)
    prop.label = "Mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "edge"
    prop._addConstant("edge", "edge-(host)-port", 1)
    prop._addConstant("network", "network-port", 2)
    meta.props.add("mode", prop)

    prop = PropMeta("str", "monPolDn", "monPolDn", 14442, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "stpStQual", "stpStQual", 21258, PropCategory.REGULAR)
    prop.label = "STP State Qualifier"
    prop.isOper = True
    prop._addConstant("mstp-with-local-scope", "mstp-running-with-port-local-scope-configuration", 2)
    prop._addConstant("native-vlan-missing", "native-vlan-configuration-missing", 1)
    meta.props.add("stpStQual", prop)
