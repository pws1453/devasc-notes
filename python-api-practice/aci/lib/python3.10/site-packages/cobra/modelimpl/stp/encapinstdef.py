...
# ##################################################
class EncapInstDef(Mo):
    """
    The spanning-tree protocol encap instance profile definition. The segment IDs calculated using this profile are for spanning tree BPDU flooding within the fabric. It is implicitly managed by the IFC.

    """

    meta = ClassMeta("cobra.model.stp.EncapInstDef")

    meta.moClassName = "stpEncapInstDef"
    meta.rnFormat = "encapnsdef-[%(instPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Spanning Tree Encap NameSpace"
    meta.writeAccessMask = 0x100000000001
    meta.readAccessMask = 0x300000000011
    ...
    meta.childClasses.add("cobra.model.fvns.RtDomVxlanNsDef")
    meta.childClasses.add("cobra.model.infra.NsIssues")
    meta.childClasses.add("cobra.model.fvns.RtVxlanNsDef")
    meta.childClasses.add("cobra.model.stp.RtToEncapInstDef")
    meta.childClasses.add("cobra.model.stp.AllocEncapBlkDef")
    meta.childClasses.add("cobra.model.fvns.RtVlanNsDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.stp.RtToEncapInstDef", "rtinfraToEncapInstDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtDomVxlanNsDef", "rtinfraDomVxlanNsDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.stp.AllocEncapBlkDef", "allocencapblkdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtVlanNsDef", "rtinfraVlanNsDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtVxlanNsDef", "rtvmmVxlanNsDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.NsIssues", "nsissues"))
    ...
    meta.superClasses.add("cobra.model.fvns.AInstP")
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 4967, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "instPKey", "instPKey", 749, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("instPKey", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13890, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "instPKey"))
    getattr(meta.props, "instPKey").needDelimiter = True

    # Deployment Meta
    meta.deploymentQuery = True
    meta.deploymentType = "Path"

    def __init__(self, parentMoOrDn, instPKey, markDirty=True, **creationProps):
        namingVals = [instPKey]
