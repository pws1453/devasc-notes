...
# ##################################################
class RtDefaultStpIfPol(Mo):
    """
    A target relation to the spanning-tree protocol interface policy.

    """

    meta = TargetRelationMeta("cobra.model.stp.RtDefaultStpIfPol", "cobra.model.vmm.DomP")

    meta.moClassName = "stpRtDefaultStpIfPol"
    meta.rnFormat = "rtvmmDefaultStpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12482, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12481, PropCategory.REGULAR)
