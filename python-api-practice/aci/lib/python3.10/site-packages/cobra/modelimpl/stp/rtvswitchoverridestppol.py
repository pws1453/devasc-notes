...
# ##################################################
class RtVswitchOverrideStpPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.stp.RtVswitchOverrideStpPol", "cobra.model.vmm.VSwitchPolicyCont")

    meta.moClassName = "stpRtVswitchOverrideStpPol"
    meta.rnFormat = "rtvmmVswitchOverrideStpPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvmmVswitchOverrideStpPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23021, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23020, PropCategory.REGULAR)
