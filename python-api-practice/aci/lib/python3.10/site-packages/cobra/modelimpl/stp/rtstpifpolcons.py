...
# ##################################################
class RtStpIfPolCons(Mo):
    """
    A target relation to the spanning-tree protocol interface policy.

    """

    meta = TargetRelationMeta("cobra.model.stp.RtStpIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "stpRtStpIfPolCons"
    meta.rnFormat = "rtl1StpIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12773, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12772, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15120, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
