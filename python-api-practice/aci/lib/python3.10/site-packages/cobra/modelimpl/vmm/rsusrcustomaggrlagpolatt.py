...
# ##################################################
class RsUsrCustomAggrLagPolAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsUsrCustomAggrLagPolAtt", "cobra.model.lacp.EnhancedLagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsUsrCustomAggrLagPolAtt"
    meta.rnFormat = "rsUsrCustomAggrLagPolAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "User Custom End Point Group Aggregator Relationship to Enhanced Lag Policy"
    ...
    meta.rnPrefixes = [
        ('rsUsrCustomAggrLagPolAtt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56459, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56460, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56455, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12856
    prop.defaultValueStr = "lacpEnhancedLagPol"
    prop._addConstant("lacpEnhancedLagPol", None, 12856)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56454, PropCategory.REGULAR)
