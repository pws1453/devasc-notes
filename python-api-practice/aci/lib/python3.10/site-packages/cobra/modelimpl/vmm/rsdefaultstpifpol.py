...
class RsDefaultStpIfPol(Mo):
    ...
    meta.rnPrefixes = [
        ('rsdefaultStpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37676, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39815, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14327, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12480, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnStpIfPolName", "tnStpIfPolName", 12479, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
