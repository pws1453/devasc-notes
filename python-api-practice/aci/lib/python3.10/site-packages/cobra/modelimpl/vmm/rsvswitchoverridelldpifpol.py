...
# ##################################################
class RsVswitchOverrideLldpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchOverrideLldpIfPol", "cobra.model.lldp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVswitchOverrideLldpIfPol"
    meta.rnFormat = "rsvswitchOverrideLldpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsvswitchOverrideLldpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40524, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23023, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23011, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23010, PropCategory.REGULAR)
