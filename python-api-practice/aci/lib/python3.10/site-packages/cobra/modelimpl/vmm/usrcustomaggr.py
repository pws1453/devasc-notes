...
# ##################################################
class UsrCustomAggr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.UsrCustomAggr")

    meta.moClassName = "vmmUsrCustomAggr"
    meta.rnFormat = "usrcustomaggr-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "User Custom End Point Group Aggregator Definition"
    ...
    meta.childClasses.add("cobra.model.vmm.RsUsrCustomAggrLagPolAtt")
    meta.childClasses.add("cobra.model.comp.RsEpgAggr")

    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsUsrCustomAggrLagPolAtt", "rsUsrCustomAggrLagPolAtt"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38755, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40894, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "featureFlags", "featureFlags", 34337, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = "skip-encap-validation,skip-rel-to-eppd,skip-vlan-pool-inheritance"
    prop.defaultValueStr = "skip-encap-validation,skip-rel-to-eppd,skip-vlan-pool-inheritance"
    prop._addConstant("none", "none", 0)
    ...
    prop = PropMeta("str", "name", "name", 34340, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
