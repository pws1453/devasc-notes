...
# ##################################################
class RsBaseCompCtrlr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsBaseCompCtrlr", "cobra.model.comp.Ctrlr")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vmmRsBaseCompCtrlr"
    meta.rnFormat = "rsbaseCompCtrlr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39281, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39280, PropCategory.REGULAR)
