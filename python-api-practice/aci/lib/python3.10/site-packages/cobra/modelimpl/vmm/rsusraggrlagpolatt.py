...
# ##################################################
class RsUsrAggrLagPolAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsUsrAggrLagPolAtt", "cobra.model.lacp.EnhancedLagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsUsrAggrLagPolAtt"
    meta.rnFormat = "rsUsrAggrLagPolAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Trunk PortGroup Relationship to Enhanced Lag Policy"
    ...
    meta.rnPrefixes = [
        ('rsUsrAggrLagPolAtt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 53009, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 53010, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53008, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 53005, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53004, PropCategory.REGULAR)
