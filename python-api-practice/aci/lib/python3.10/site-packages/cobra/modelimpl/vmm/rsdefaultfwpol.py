...
# ##################################################
class RsDefaultFwPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.vmm.RsDefaultFwPol", "cobra.model.nws.FwPol")
    meta.targetNameProps["name"] = "tnNwsFwPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsDefaultFwPol"
    meta.rnFormat = "rsdefaultFwPol"
    ...
    meta.rnPrefixes = [
        ('rsdefaultFwPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38228, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40367, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 19087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNwsFwPolName", "tnNwsFwPolName", 19086, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
