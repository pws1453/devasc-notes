...
class SecP(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.SecP")

    meta.moClassName = "vmmSecP"
    meta.rnFormat = "sec"
    meta.category = MoCategory.REGULAR
    meta.label = "VMM Security Policy"
    ...
    meta.superClasses.add("cobra.model.comp.AVmmPltfmP")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.comp.AVmmSecP")
    ...
    prop = PropMeta("str", "allowPromiscuous", "allowPromiscuous", 21290, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38303, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40442, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "forgedTransmits", "forgedTransmits", 21291, PropCategory.REGULAR)
    prop.label = "Forged Transmits"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "reject"
    ...
    prop = PropMeta("str", "macChanges", "macChanges", 21292, PropCategory.REGULAR)
    prop.label = "MAC Address Changes"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "reject"
