...
class OrchsProv(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.OrchsProv")

    meta.moClassName = "vmmOrchsProv"
    meta.rnFormat = "orchs-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Orchestrator Prov for this VMMDom"
    ...
    meta.childClasses.add("cobra.model.vmm.OrchsProvPlan")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.OrchsProvPlan", "plan-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40262, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 16389, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
