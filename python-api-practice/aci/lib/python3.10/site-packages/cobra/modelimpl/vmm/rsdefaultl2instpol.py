...
# ##################################################
class RsDefaultL2InstPol(Mo):
    """
    A source relation to the Layer 2 instance policy information.

    """

    meta = NamedSourceRelationMeta("cobra.model.vmm.RsDefaultL2InstPol", "cobra.model.l2.InstPol")
    meta.targetNameProps["name"] = "tnL2InstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsDefaultL2InstPol"
    meta.rnFormat = "rsdefaultL2InstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L2 Instance Policy"
    ...
    meta.rnPrefixes = [
        ('rsdefaultL2InstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39814, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14326, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL2InstPolName", "tnL2InstPolName", 12471, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL2InstPolName", prop)
