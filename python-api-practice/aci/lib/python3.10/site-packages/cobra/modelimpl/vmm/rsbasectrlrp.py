...
# ##################################################
class RsBaseCtrlrP(Mo):
    """
    A source relation to the VMM controller profile. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsBaseCtrlrP", "cobra.model.vmm.CtrlrP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vmmRsBaseCtrlrP"
    meta.rnFormat = "rsbaseCtrlrP-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.vmm.CtrlrPDef")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12517, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12516, PropCategory.REGULAR)
