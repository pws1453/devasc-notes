...
class RsMgmtEPg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vmm.RsMgmtEPg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsMgmtEPg"
    meta.rnFormat = "rsmgmtEPg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37682, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39821, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12504, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12503, PropCategory.REGULAR)
