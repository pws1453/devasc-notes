...
# ##################################################
class RsDefaultCdpIfPol(Mo):
    """
    A source relation to the Cisco Discovery Channel interface policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.vmm.RsDefaultCdpIfPol", "cobra.model.cdp.IfPol")
    meta.targetNameProps["name"] = "tnCdpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsDefaultCdpIfPol"
    meta.rnFormat = "rsdefaultCdpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsdefaultCdpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37674, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39813, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14325, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12468, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnCdpIfPolName", "tnCdpIfPolName", 12467, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
