...
# ##################################################
class RtEncapAllctr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vmm.RtEncapAllctr", "cobra.model.vmm.EpPD")

    meta.moClassName = "vmmRtEncapAllctr"
    meta.rnFormat = "rtencapAllctr-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.vmm.EncapAllctr")
    ...
    prop = PropMeta("str", "tCl", "tCl", 23499, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2134
    prop.defaultValueStr = "vmmEpPD"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmEpPD", None, 2134)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23498, PropCategory.REGULAR)
