...
class AccGrpCont(Mo):
    """
    A container for capturing all access group policies. 

    """

    meta = ClassMeta("cobra.model.vmm.AccGrpCont")

    meta.moClassName = "vmmAccGrpCont"
    meta.rnFormat = "accgrpcont-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Group Policy Container"
    meta.writeAccessMask = 0x11
    meta.readAccessMask = 0x45041000020011
    ...
    prop = PropMeta("str", "accGrpDn", "accGrpDn", 15522, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("accGrpDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14338, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7290, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
