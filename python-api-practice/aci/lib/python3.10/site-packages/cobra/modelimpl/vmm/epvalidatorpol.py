...
# ##################################################
class EpValidatorPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.EpValidatorPol")

    meta.moClassName = "vmmEpValidatorPol"
    meta.rnFormat = "epv"
    meta.category = MoCategory.REGULAR
    meta.label = "End Point Validator Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38411, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "currentKey", "currentKey", 23386, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("currentKey", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40550, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26931, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "previousKey", "previousKey", 23387, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("previousKey", prop)
