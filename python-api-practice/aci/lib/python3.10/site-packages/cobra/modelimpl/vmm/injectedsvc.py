...
# ##################################################
class InjectedSvc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.InjectedSvc")

    meta.moClassName = "vmmInjectedSvc"
    ...
    meta.childClasses.add("cobra.model.vmm.InjectedSvcEp")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.vmm.InjectedSvcPort")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.InjectedSvcEp", "ep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.InjectedSvcPort", "p-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38730, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "clusterIp", "clusterIp", 33756, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40869, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "guid", "guid", 33754, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "lbIp", "lbIp", 33757, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34052, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 33837, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 33755, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
