...
# ##################################################
class RsVswitchOverrideCdpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchOverrideCdpIfPol", "cobra.model.cdp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVswitchOverrideCdpIfPol"
    meta.rnFormat = "rsvswitchOverrideCdpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsvswitchOverrideCdpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38386, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40525, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23024, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22998, PropCategory.REGULAR)
