...
# ##################################################
class UsrAggrContext(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.UsrAggrContext")

    meta.moClassName = "vmmUsrAggrContext"
    meta.rnFormat = "vmmUsrAggr"
    ...
    prop = PropMeta("str", "domName", "domName", 27869, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "operDelimiter", "operDelimiter", 27870, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 1)]
    ...
    prop = PropMeta("str", "type", "type", 30076, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
