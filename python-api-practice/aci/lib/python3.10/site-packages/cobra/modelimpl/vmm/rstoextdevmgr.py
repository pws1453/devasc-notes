...
# ##################################################
class RsToExtDevMgr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsToExtDevMgr", "cobra.model.extdev.MgrP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vmmRsToExtDevMgr"
    meta.rnFormat = "rstoExtDevMgr-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Extern device mgr profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 49898, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49899, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49885, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 49838, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12673
    prop.defaultValueStr = "extdevMgrP"
    prop._addConstant("extdevMgrP", None, 12673)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49837, PropCategory.REGULAR)
