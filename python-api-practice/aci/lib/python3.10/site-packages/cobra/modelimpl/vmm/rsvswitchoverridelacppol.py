...
# ##################################################
class RsVswitchOverrideLacpPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchOverrideLacpPol", "cobra.model.lacp.LagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVswitchOverrideLacpPol"
    meta.rnFormat = "rsvswitchOverrideLacpPol"
    ...
    meta.rnPrefixes = [
        ('rsvswitchOverrideLacpPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38388, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40527, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23026, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23007, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23006, PropCategory.REGULAR)
