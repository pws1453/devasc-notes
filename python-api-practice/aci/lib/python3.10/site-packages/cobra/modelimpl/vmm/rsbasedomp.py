...
class RsBaseDomP(Mo):
    ...
    prop = PropMeta("str", "tCl", "tCl", 12488, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12487, PropCategory.REGULAR)
