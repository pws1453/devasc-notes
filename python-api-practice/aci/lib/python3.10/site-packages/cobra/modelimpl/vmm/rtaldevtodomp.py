...
class RtALDevToDomP(Mo):
    ...
    prop = PropMeta("str", "tCl", "tCl", 13681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13680, PropCategory.REGULAR)
