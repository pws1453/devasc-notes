...
# ##################################################
class RsVswitchOverrideStpPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchOverrideStpPol", "cobra.model.stp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVswitchOverrideStpPol"
    meta.rnFormat = "rsvswitchOverrideStpPol"
    ...
    meta.rnPrefixes = [
        ('rsvswitchOverrideStpPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38389, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40528, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23027, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23019, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23018, PropCategory.REGULAR)
