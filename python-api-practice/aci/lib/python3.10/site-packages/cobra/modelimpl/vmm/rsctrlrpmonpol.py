...
# ##################################################
class RsCtrlrPMonPol(Mo):
    """
    A source relation to the monitoring policy model for the infra semantic scope.

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsCtrlrPMonPol", "cobra.model.mon.InfraPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsCtrlrPMonPol"
    meta.rnFormat = "rsctrlrPMonPol"
    ...
    meta.rnPrefixes = [
        ('rsctrlrPMonPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37683, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39822, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14334, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12496, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12495, PropCategory.REGULAR)
