...
# ##################################################
class RtCDevToCtrlrP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vmm.RtCDevToCtrlrP", "cobra.model.vns.CDev")

    meta.moClassName = "vmmRtCDevToCtrlrP"
    meta.rnFormat = "rtvnsCDevToCtrlrP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20447, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20446, PropCategory.REGULAR)
