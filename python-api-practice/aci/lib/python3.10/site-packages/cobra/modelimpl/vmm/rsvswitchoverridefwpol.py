...
# ##################################################
class RsVswitchOverrideFwPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchOverrideFwPol", "cobra.model.nws.FwPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVswitchOverrideFwPol"
    meta.rnFormat = "rsvswitchOverrideFwPol"
    ...
    meta.rnPrefixes = [
        ('rsvswitchOverrideFwPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38390, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40529, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23028, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23003, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23002, PropCategory.REGULAR)
