...
# ##################################################
class InjectedVnic(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.InjectedVnic")

    meta.moClassName = "vmmInjectedVnic"
    ...
    prop = PropMeta("str", "annotation", "annotation", 41090, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 41067, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 41091, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "guid", "guid", 41064, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "mac", "mac", 41065, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 41081, PropCategory.REGULAR)
