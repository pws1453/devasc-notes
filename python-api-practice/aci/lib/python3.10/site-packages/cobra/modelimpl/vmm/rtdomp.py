...
class RtDomP(Mo):
    """
    An internal object (in the comp domain scope) created as part of relation to a VMM domain profile.

    """

    meta = TargetRelationMeta("cobra.model.vmm.RtDomP", "cobra.model.comp.Dom")

    meta.moClassName = "vmmRtDomP"
    meta.rnFormat = "rtcompDomP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11787, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1271
    prop.defaultValueStr = "compDom"
    prop._addConstant("compDom", None, 1271)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11786, PropCategory.REGULAR)
