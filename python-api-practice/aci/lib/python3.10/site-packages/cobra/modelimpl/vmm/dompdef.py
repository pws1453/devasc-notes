...
class DomPDef(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.DomPDef")

    meta.moClassName = "vmmDomPDef"
    meta.rnFormat = "domD-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Domain Profile Definition"
    meta.writeAccessMask = 0x11
    meta.readAccessMask = 0x80384001000611
    ...
    meta.childClasses.add("cobra.model.vmm.CtrlrPDef")
    meta.childClasses.add("cobra.model.infra.RsDomVxlanNsDef")
    meta.childClasses.add("cobra.model.vmm.RsBaseDomP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsBaseDomP", "rsbaseDomP-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.CtrlrPDef", "ctrlrD-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14328, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7295, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
