...
# ##################################################
class RsMcastAddrNs(Mo):
    """
    A source relation to the policy definition of the multicast IP address ranges.

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsMcastAddrNs", "cobra.model.fvns.McastAddrInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsMcastAddrNs"
    meta.rnFormat = "rsmcastAddrNs"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39820, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14333, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12500, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12499, PropCategory.REGULAR)
