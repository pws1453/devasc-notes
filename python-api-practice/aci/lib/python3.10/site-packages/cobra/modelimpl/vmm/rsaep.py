...
class RsAEP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vmm.RsAEP", "cobra.model.infra.AttEntityP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "vmmRsAEP"
    meta.rnFormat = "rsAEP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Pre-provision AEP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18393, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18353, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18352, PropCategory.REGULAR)
