...
class EpPDContext(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.EpPDContext")

    meta.moClassName = "vmmEpPDContext"
    meta.rnFormat = "vmmEpPD"
    ...
    prop = PropMeta("str", "operDelimiter", "operDelimiter", 26225, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 1)]
    ...
    prop = PropMeta("str", "type", "type", 30074, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
