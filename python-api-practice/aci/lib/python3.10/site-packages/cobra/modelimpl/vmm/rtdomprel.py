...
class RtDompRel(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vmm.RtDompRel", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "vmmRtDompRel"
    meta.rnFormat = "rtpolDompRel-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Relation Holder"
    meta.writeAccessMask = 0x11
    meta.readAccessMask = 0x4734100002061f
    ...
    prop = PropMeta("str", "tCl", "tCl", 13414, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13413, PropCategory.REGULAR)
