...
# ##################################################
class InjectedOrg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.InjectedOrg")

    meta.moClassName = "vmmInjectedOrg"
    meta.rnFormat = "org-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Injected Org"
    ...
    meta.childClasses.add("cobra.model.vmm.InjectedOrgUnit")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.InjectedOrgUnit", "unit-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38808, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40947, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "guid", "guid", 36358, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36368, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 36362, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
