...
class RsAEPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.RsAEPTask")

    meta.moClassName = "vmmRsAEPTask"
    meta.rnFormat = "vmmRsAEPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 18349, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendPreProv", "sendpreprov", 1653)
