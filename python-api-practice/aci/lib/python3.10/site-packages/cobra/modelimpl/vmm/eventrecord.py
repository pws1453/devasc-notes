...
# ##################################################
class EventRecord(Mo):
    """
    A config object that is not persisted and is used to send messages from a worker thread to a doer.

    """

    meta = ClassMeta("cobra.model.vmm.EventRecord")

    meta.moClassName = "vmmEventRecord"
    meta.rnFormat = "evtRec"
    meta.category = MoCategory.REGULAR
    meta.label = "VMM Controller Events"
    ...
    prop = PropMeta("str", "chainId", "chainId", 1853, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("chainId", prop)
    ...
    prop = PropMeta("str", "ctrlrDn", "ctrlrDn", 1845, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "eventCollectorId", "eventCollectorId", 21407, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("eventCollectorId", prop)

    prop = PropMeta("str", "eventDescr", "eventDescr", 1849, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("eventDescr", prop)

    prop = PropMeta("str", "eventId", "eventId", 1846, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("eventId", prop)

    prop = PropMeta("str", "eventRcvdTs", "eventRcvdTs", 1848, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("eventRcvdTs", prop)

    prop = PropMeta("str", "eventTs", "eventTs", 1847, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("eventTs", prop)

    prop = PropMeta("str", "eventType", "eventType", 1850, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("eventType", prop)

    prop = PropMeta("str", "fromEvent", "fromEvent", 1851, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("fromEvent", prop)

    prop = PropMeta("str", "fromMO", "fromMO", 1852, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
