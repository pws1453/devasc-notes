...
# ##################################################
class AttEntityPCont(Mo):
    """
    A container for capturing all access groups. 

    """

    meta = ClassMeta("cobra.model.vmm.AttEntityPCont")

    meta.moClassName = "vmmAttEntityPCont"
    meta.rnFormat = "attentpcont-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vmm.AccGrpCont")
    meta.childClasses.add("cobra.model.vmm.EpPD")

    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.AccGrpCont", "accgrpcont-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14337, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7291, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
