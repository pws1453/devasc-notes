...
class RsAcc(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vmm.RsAcc", "cobra.model.vmm.UsrAccP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsAcc"
    meta.rnFormat = "rsacc"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "User Access Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37678, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39817, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14330, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12492, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2166
    prop.defaultValueStr = "vmmUsrAccP"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmUsrAccP", None, 2166)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12491, PropCategory.REGULAR)
