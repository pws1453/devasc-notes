...
class RtBaseDomP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vmm.RtBaseDomP", "cobra.model.vmm.DomPDef")

    meta.moClassName = "vmmRtBaseDomP"
    meta.rnFormat = "rtbaseDomP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Domain Profile Definition"
    meta.writeAccessMask = 0x11
    meta.readAccessMask = 0x4724100002061f
    ...
    prop = PropMeta("str", "tCl", "tCl", 12490, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2147
    prop.defaultValueStr = "vmmDomPDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmDomPDef", None, 2147)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12489, PropCategory.REGULAR)
