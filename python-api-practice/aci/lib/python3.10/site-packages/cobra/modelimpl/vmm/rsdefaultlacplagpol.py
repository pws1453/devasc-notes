...
# ##################################################
class RsDefaultLacpLagPol(Mo):
    """
    A source relation to the LLDP policy parameters for the interface. LLDP uses the logical link control (LLC) services to transmit and receive information to and from other LLDP agents.

    """

    meta = NamedSourceRelationMeta("cobra.model.vmm.RsDefaultLacpLagPol", "cobra.model.lacp.LagPol")
    meta.targetNameProps["name"] = "tnLacpLagPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsDefaultLacpLagPol"
    meta.rnFormat = "rsdefaultLacpLagPol"
    ...
    meta.rnPrefixes = [
        ('rsdefaultLacpLagPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38098, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40237, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15527, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15524, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLacpLagPolName", "tnLacpLagPolName", 15523, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
