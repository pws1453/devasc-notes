...
# ##################################################
class RsDefaultLldpIfPol(Mo):
    """
    A source relation to the LLDP policy parameters for the interface.

    """

    meta = NamedSourceRelationMeta("cobra.model.vmm.RsDefaultLldpIfPol", "cobra.model.lldp.IfPol")
    meta.targetNameProps["name"] = "tnLldpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsDefaultLldpIfPol"
    meta.rnFormat = "rsdefaultLldpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsdefaultLldpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39812, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14324, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12476, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLldpIfPolName", "tnLldpIfPolName", 12475, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
