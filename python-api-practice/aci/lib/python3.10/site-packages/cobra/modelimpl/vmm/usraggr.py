...
class UsrAggr(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.UsrAggr")

    meta.moClassName = "vmmUsrAggr"
    meta.rnFormat = "usraggr-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vmm.RsUsrAggrLagPolAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsUsrAggrLagPolAtt", "rsUsrAggrLagPolAtt"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38567, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40706, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 27866, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
