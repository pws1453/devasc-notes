...
# ##################################################
class IntCustomAggr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.IntCustomAggr")

    meta.moClassName = "vmmIntCustomAggr"
    meta.rnFormat = "intcustomaggr-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Internal Custom End Point Group Aggregator Definition"
    ...
    prop = PropMeta("str", "featureFlags", "featureFlags", 34338, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 34339, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
