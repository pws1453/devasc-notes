...
class RsVmmCtrlrP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vmm.RsVmmCtrlrP", "cobra.model.vmm.CtrlrP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vmmRsVmmCtrlrP"
    meta.rnFormat = "rsvmmCtrlrP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Vmm Controller Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37679, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "epgDeplPref", "epgDeplPref", 12509, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "local"
    prop._addConstant("both", "deploy-epg-on-both-local-and-associated-controller", 1)
    prop._addConstant("local", "deploy-epg-only-on-the-controller", 0)
    meta.props.add("epgDeplPref", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39818, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14331, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12508, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12507, PropCategory.REGULAR)
