...
class Object(Mo):
    """
    The base class of VMM classes.

    """

    meta = ClassMeta("cobra.model.vmm.Object")

    meta.moClassName = "vmmObject"
    meta.rnFormat = "obj"
    ...
    prop = PropMeta("str", "classId", "classId", 1844, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 1843, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
