...
# ##################################################
class RsEncapAllctr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsEncapAllctr", "cobra.model.vmm.EncapAllctr")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsEncapAllctr"
    meta.rnFormat = "rsEncapAllctr"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Encap Allocator"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38412, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40551, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23545, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23497, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8008
    prop.defaultValueStr = "vmmEncapAllctr"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmEncapAllctr", None, 8008)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23496, PropCategory.REGULAR)
