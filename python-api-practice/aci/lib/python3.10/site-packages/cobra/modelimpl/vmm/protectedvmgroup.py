...
# ##################################################
class ProtectedVmGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.ProtectedVmGroup")

    meta.moClassName = "vmmProtectedVmGroup"
    meta.rnFormat = "vmgroup-[%(tDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Protect VM Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 52148, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52149, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tDn", "tDn", 52123, PropCategory.REGULAR)
    prop.label = "VM Group DN"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
