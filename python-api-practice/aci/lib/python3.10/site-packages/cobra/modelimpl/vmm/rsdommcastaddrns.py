...
# ##################################################
class RsDomMcastAddrNs(Mo):
    """
    A source relation to the policy definition of the multicast IP address ranges.

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsDomMcastAddrNs", "cobra.model.fvns.McastAddrInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsDomMcastAddrNs"
    meta.rnFormat = "rsdomMcastAddrNs"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Multicast Addr Pool"
    ...
    meta.rnPrefixes = [
        ('rsdomMcastAddrNs', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38080, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40219, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15294, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15280, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4565
    prop.defaultValueStr = "fvnsMcastAddrInstP"
    prop._addConstant("fvnsMcastAddrInstP", None, 4565)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15279, PropCategory.REGULAR)
