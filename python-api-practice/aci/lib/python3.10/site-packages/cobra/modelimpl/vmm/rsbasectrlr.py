...
# ##################################################
class RsBaseCtrlr(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsBaseCtrlr", "cobra.model.comp.Ctrlr")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vmmRsBaseCtrlr"
    meta.rnFormat = "rsbaseCtrlr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19035, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19034, PropCategory.REGULAR)
