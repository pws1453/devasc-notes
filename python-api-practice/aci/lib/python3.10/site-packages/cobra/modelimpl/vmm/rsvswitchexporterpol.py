...
# ##################################################
class RsVswitchExporterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchExporterPol", "cobra.model.netflow.VmmExporterPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vmmRsVswitchExporterPol"
    meta.rnFormat = "rsvswitchExporterPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VMM Netflow Exporter Policy"
    ...
    meta.rnPrefixes = [
        ('rsvswitchExporterPol-', True),
    ]

    prop = PropMeta("str", "activeFlowTimeOut", "activeFlowTimeOut", 27872, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 3600)]
    ...
    prop = PropMeta("str", "annotation", "annotation", 38569, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40708, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "idleFlowTimeOut", "idleFlowTimeOut", 27873, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 600)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "samplingRate", "samplingRate", 27874, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 1000)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27876, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9278
    prop.defaultValueStr = "netflowVmmExporterPol"
    prop._addConstant("netflowVmmExporterPol", None, 9278)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27875, PropCategory.REGULAR)
