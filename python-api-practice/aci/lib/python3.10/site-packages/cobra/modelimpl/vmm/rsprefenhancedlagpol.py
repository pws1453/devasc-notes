...
# ##################################################
class RsPrefEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsPrefEnhancedLagPol", "cobra.model.lacp.EnhancedLagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsPrefEnhancedLagPol"
    meta.rnFormat = "rsprefEnhancedLagPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Preferred Enhanced Lag Policy"
    ...
    meta.rnPrefixes = [
        ('rsprefEnhancedLagPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44922, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44923, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44915, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 44901, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44900, PropCategory.REGULAR)
