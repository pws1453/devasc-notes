...
# ##################################################
class UplinkOrder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.UplinkOrder")

    meta.moClassName = "vmmUplinkOrder"
    meta.rnFormat = "uplinkorder"
    meta.category = MoCategory.REGULAR
    meta.label = "Uplink Failover order"
    ...
    prop = PropMeta("str", "activeUplink", "activeUplink", 54619, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "standbyUplink", "standbyUplink", 54620, PropCategory.REGULAR)
