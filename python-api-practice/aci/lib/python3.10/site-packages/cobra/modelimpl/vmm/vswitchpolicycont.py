...
# ##################################################
class VSwitchPolicyCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.VSwitchPolicyCont")

    meta.moClassName = "vmmVSwitchPolicyCont"
    meta.rnFormat = "vswitchpolcont"
    meta.category = MoCategory.REGULAR
    meta.label = "VSwitch Policy Group"
    meta.writeAccessMask = 0x11
    meta.readAccessMask = 0x2000000000011
    ...
    meta.childClasses.add("cobra.model.vmm.RsVswitchExporterPol")
    meta.childClasses.add("cobra.model.vmm.RsVswitchOverrideFwPol")
    meta.childClasses.add("cobra.model.vmm.RsVswitchOverrideStpPol")
    meta.childClasses.add("cobra.model.vmm.RsVswitchOverrideMtuPol")
    meta.childClasses.add("cobra.model.vmm.RsVswitchOverrideLldpIfPol")
    meta.childClasses.add("cobra.model.lacp.EnhancedLagPol")
    meta.childClasses.add("cobra.model.vmm.RsVswitchOverrideMcpIfPol")
    meta.childClasses.add("cobra.model.vmm.RsVswitchOverrideCdpIfPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vmm.RsVswitchOverrideLacpPol")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchOverrideLldpIfPol", "rsvswitchOverrideLldpIfPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchOverrideMcpIfPol", "rsvswitchOverrideMcpIfPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchOverrideCdpIfPol", "rsvswitchOverrideCdpIfPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchOverrideLacpPol", "rsvswitchOverrideLacpPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchOverrideStpPol", "rsvswitchOverrideStpPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchOverrideMtuPol", "rsvswitchOverrideMtuPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchOverrideFwPol", "rsvswitchOverrideFwPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsVswitchExporterPol", "rsvswitchExporterPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.EnhancedLagPol", "enlacplagp-"))
    ...
    meta.rnPrefixes = [
        ('vswitchpolcont', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38384, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40523, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23022, PropCategory.REGULAR)
