...
# ##################################################
class RsVswitchOverrideMcpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchOverrideMcpIfPol", "cobra.model.mcp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVswitchOverrideMcpIfPol"
    meta.rnFormat = "rsvswitchOverrideMcpIfPol"
    ...
    meta.rnPrefixes = [
        ('rsvswitchOverrideMcpIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38387, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40526, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23025, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23015, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23014, PropCategory.REGULAR)
