...
# ##################################################
class OrchsExtTenant(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.OrchsExtTenant")

    meta.moClassName = "vmmOrchsExtTenant"
    meta.rnFormat = "orchsTn-%(guid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Orchestrator External Tenant information"
    ...
    prop = PropMeta("str", "accountName", "accountName", 27881, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("accountName", prop)

    prop = PropMeta("str", "annotation", "annotation", 38570, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40709, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "guid", "guid", 27880, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "provider", "provider", 27882, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "MicrosoftSCVMM"
    prop._addConstant("MicrosoftSCVMM", "scvmm", 0)
    ...
    meta.namingProps.append(getattr(meta.props, "guid"))
    ...
    def __init__(self, parentMoOrDn, guid, markDirty=True, **creationProps):
        namingVals = [guid]
