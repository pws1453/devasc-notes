...
# ##################################################
class RsVswitchOverrideMtuPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVswitchOverrideMtuPol", "cobra.model.l2.InstPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVswitchOverrideMtuPol"
    meta.rnFormat = "rsvswitchOverrideMtuPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to MTU Policy"
    ...
    meta.rnPrefixes = [
        ('rsvswitchOverrideMtuPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 58981, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 58982, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 58980, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 58977, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58976, PropCategory.REGULAR)
