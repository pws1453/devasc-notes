...
# ##################################################
class IntAggrContext(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.IntAggrContext")

    meta.moClassName = "vmmIntAggrContext"
    meta.rnFormat = "vmmIntAggr"
    ...
    prop = PropMeta("str", "domName", "domName", 27867, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "operDelimiter", "operDelimiter", 27868, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 1)]
    ...
    prop = PropMeta("str", "type", "type", 30075, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
