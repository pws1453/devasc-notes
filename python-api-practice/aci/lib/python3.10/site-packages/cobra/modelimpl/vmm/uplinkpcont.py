...
# ##################################################
class UplinkPCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.UplinkPCont")

    meta.moClassName = "vmmUplinkPCont"
    meta.rnFormat = "uplinkpcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Uplink Policy Container"
    ...
    meta.childClasses.add("cobra.model.vmm.UplinkP")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.UplinkP", "uplinkp-"))
    ...
    meta.superClasses.add("cobra.model.vmm.AUplinkPCont")
    ...
    prop = PropMeta("str", "annotation", "annotation", 54173, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54174, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "numOfUplinks", "numOfUplinks", 54156, PropCategory.REGULAR)
    prop.label = "Number of Uplinks"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("numOfUplinks", prop)
