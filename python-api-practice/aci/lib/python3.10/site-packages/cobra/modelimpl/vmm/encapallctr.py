...
# ##################################################
class EncapAllctr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.EncapAllctr")

    meta.moClassName = "vmmEncapAllctr"
    meta.rnFormat = "allctr-[%(allocCtxtKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "None"
    meta.writeAccessMask = 0x11
    meta.readAccessMask = 0x415
    ...
    meta.childClasses.add("cobra.model.vmm.RtEncapAllctr")
    meta.childClasses.add("cobra.model.vmm.AllocEncap")

    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RtEncapAllctr", "rtencapAllctr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.AllocEncap", "encap-"))

    meta.parentClasses.add("cobra.model.vmm.DomP")

    meta.superClasses.add("cobra.model.vmm.AEncapAllctr")
    ...
    prop = PropMeta("str", "allocCtxtKey", "allocCtxtKey", 23472, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("allocCtxtKey", prop)
    ...
    prop = PropMeta("str", "deployIssues", "deployIssues", 23435, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "encapCtx", "encapCtx", 23440, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "nsName", "nsName", 23438, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("nsName", prop)

    prop = PropMeta("str", "reqSize", "reqSize", 23437, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("reqSize", prop)
    ...
    prop = PropMeta("str", "subjName", "subjName", 23439, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    meta.namingProps.append(getattr(meta.props, "allocCtxtKey"))
    getattr(meta.props, "allocCtxtKey").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, allocCtxtKey, markDirty=True, **creationProps):
        namingVals = [allocCtxtKey]
