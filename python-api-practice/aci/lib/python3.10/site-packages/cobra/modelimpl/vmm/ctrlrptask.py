...
class CtrlrPTask(Mo):
    """
    The task the policy manager sends to the VMM for controller creation and deletion.

    """

    meta = ClassMeta("cobra.model.vmm.CtrlrPTask")

    meta.moClassName = "vmmCtrlrPTask"
    meta.rnFormat = "vmmCtrlrPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5726, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Config", "config", 557)
