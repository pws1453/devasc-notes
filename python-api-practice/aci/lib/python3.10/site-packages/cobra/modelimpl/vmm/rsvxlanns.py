...
class RsVxlanNs(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vmm.RsVxlanNs", "cobra.model.fvns.VxlanInstP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vmmRsVxlanNs"
    meta.rnFormat = "rsvxlanNs"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37680, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39819, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14332, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12513, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12512, PropCategory.REGULAR)
