...
# ##################################################
class RsVxlanNsDef(Mo):
    """
    A source relation to the namespace policy is used for managing the encap (VXLAN, NVGRE, VLAN) ranges.

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsVxlanNsDef", "cobra.model.fvns.AInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsVxlanNsDef"
    meta.rnFormat = "rsvxlanNsDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16045, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16044, PropCategory.REGULAR)
