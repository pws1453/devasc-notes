...
class ServerInst(Mo):
    """
     This object holds TWAMP Server Configuration 

    """

    meta = ClassMeta("cobra.model.twamp.ServerInst")

    meta.moClassName = "twampServerInst"
    meta.rnFormat = "server"
    meta.category = MoCategory.REGULAR
    meta.label = "TWAMP Server Instance"
    ...
    meta.childClasses.add("cobra.model.twamp.RsServerPolCons")

    meta.childNamesAndRnPrefix.append(("cobra.model.twamp.RsServerPolCons", "rsserverPolCons"))
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 36995, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "inactivityTimer", "inactivityTimer", 36997, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37197, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 37191, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 37192, PropCategory.REGULAR)
    ...
    prop._addConstant("config-mismatch", "server-responder-config-mismatch", 3)
    prop._addConstant("up", "up", 1)
    meta.props.add("operStQual", prop)

    prop = PropMeta("str", "port", "port", 36996, PropCategory.REGULAR)
    prop.label = "TWAMP Server Port"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
