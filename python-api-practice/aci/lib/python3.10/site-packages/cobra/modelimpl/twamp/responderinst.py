...
# ##################################################
class ResponderInst(Mo):
    """
     This object holds TWAMP Responder Configuration 

    """

    meta = ClassMeta("cobra.model.twamp.ResponderInst")

    meta.moClassName = "twampResponderInst"
    meta.rnFormat = "responder"
    meta.category = MoCategory.REGULAR
    meta.label = "TWAMP Responder Instance"
    ...
    meta.childClasses.add("cobra.model.twamp.RsResponderPolCons")

    meta.childNamesAndRnPrefix.append(("cobra.model.twamp.RsResponderPolCons", "rsresponderPolCons"))
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 36998, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37198, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 37193, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 37194, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "timeout", "timeout", 36999, PropCategory.REGULAR)
