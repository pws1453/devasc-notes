...
# ##################################################
class RsResponderPolCons(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.twamp.RsResponderPolCons", "cobra.model.twamp.ResponderPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "twampRsResponderPolCons"
    meta.rnFormat = "rsresponderPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "TWAMP Server Policy Attachement"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39269, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11775
    prop.defaultValueStr = "twampResponderPol"
    prop._addConstant("twampResponderPol", None, 11775)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 39268, PropCategory.REGULAR)
