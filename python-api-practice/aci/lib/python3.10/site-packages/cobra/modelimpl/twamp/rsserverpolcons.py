...
# ##################################################
class RsServerPolCons(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.twamp.RsServerPolCons", "cobra.model.twamp.ServerPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "twampRsServerPolCons"
    meta.rnFormat = "rsserverPolCons"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39266, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11774
    prop.defaultValueStr = "twampServerPol"
    prop._addConstant("twampServerPol", None, 11774)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 39265, PropCategory.REGULAR)
