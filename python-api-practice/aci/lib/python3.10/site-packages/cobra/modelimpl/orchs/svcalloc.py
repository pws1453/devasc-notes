...
class SvcAlloc(Mo):
    ...
    meta = ClassMeta("cobra.model.orchs.SvcAlloc")

    meta.moClassName = "orchsSvcAlloc"
    meta.rnFormat = "alloc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Request to Allocate/De-Allocate Services for an EPG"
    ...
    meta.childClasses.add("cobra.model.orchs.RtSvcsIpToSvcAlloc")
    meta.childClasses.add("cobra.model.orchs.RtSvcsEncapToSvcAlloc")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.orchs.RsAllocLDev")

    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RtSvcsEncapToSvcAlloc", "rtsvcsEncapToSvcAlloc-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RtSvcsIpToSvcAlloc", "rtsvcsIpToSvcAlloc-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsAllocLDev", "rsallocLDev-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38618, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40757, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28688, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 28645, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "svcType", "svcType", 28643, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 3
