...
# ##################################################
class RsToFuncProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsToFuncProfile", "cobra.model.vns.AbsFuncProf")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsToFuncProfile"
    meta.rnFormat = "rstoFuncProfile-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Association to function profile"
    ...
    meta.rnPrefixes = [
        ('rstoFuncProfile-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38773, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "description", "description", 34627, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40912, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isDefault", "isDefault", 34628, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34644, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34630, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4644
    prop.defaultValueStr = "vnsAbsFuncProf"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsAbsFuncProf", None, 4644)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34629, PropCategory.REGULAR)
