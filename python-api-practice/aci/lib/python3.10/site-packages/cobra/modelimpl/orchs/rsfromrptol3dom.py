...
# ##################################################
class RsFromRPToL3Dom(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsFromRPToL3Dom", "cobra.model.l3ext.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "orchsRsFromRPToL3Dom"
    meta.rnFormat = "rsFromRPToL3Dom"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Encap Pool for Internal/External Services Stitching"
    ...
    meta.rnPrefixes = [
        ('rsFromRPToL3Dom', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38614, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40753, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28684, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28657, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1779
    prop.defaultValueStr = "l3extDomP"
    prop._addConstant("l3extDomP", None, 1779)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28656, PropCategory.REGULAR)
