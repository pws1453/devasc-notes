...
# ##################################################
class RsIpPoolRefv2(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsIpPoolRefv2", "cobra.model.fvns.AddrInst")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsIpPoolRefv2"
    meta.rnFormat = "rsipPoolRefv2-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "External/Public IP Address Pool"
    ...
    meta.childClasses.add("cobra.model.orchs.RtSvcsIpToIpPoolRef")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RtSvcsIpToIpPoolRef", "rtsvcsIpToIpPoolRef-"))
    ...
    prop = PropMeta("str", "allocDvcIps", "allocDvcIps", 35647, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("false", "false", True)
    prop._addConstant("no", None, False)
    prop._addConstant("true", "true", True)
    prop._addConstant("yes", None, True)
    meta.props.add("allocDvcIps", prop)

    prop = PropMeta("str", "allocGwIps", "allocGwIps", 35648, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("true", "true", True)
    prop._addConstant("yes", None, True)
    meta.props.add("allocGwIps", prop)

    prop = PropMeta("str", "allocNatIps", "allocNatIps", 35649, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("true", "true", True)
    prop._addConstant("yes", None, True)
    meta.props.add("allocNatIps", prop)

    prop = PropMeta("str", "allocVips", "allocVips", 35650, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("true", "true", True)
    prop._addConstant("yes", None, True)
    meta.props.add("allocVips", prop)

    prop = PropMeta("str", "annotation", "annotation", 38769, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40908, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "graphConnType", "graphConnType", 35651, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "l3-external"
    prop._addConstant("bridge-domain", "bridge-domain", 0)
    prop._addConstant("l3-external", "l3-external-network", 1)
    meta.props.add("graphConnType", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34624, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4548
    prop.defaultValueStr = "fvnsAddrInst"
    prop._addConstant("fvnsAddrInst", None, 4548)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34623, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 34622, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "external"
    prop._addConstant("external", "external", 0)
    prop._addConstant("internal", "internal", 1)
    prop._addConstant("public", "public", 2)
