...
class RsToMdev(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.orchs.RsToMdev", "cobra.model.vns.MDev")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsToMdev"
    meta.rnFormat = "rstoMdev-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Association to Mdev"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38772, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40911, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34643, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34634, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34633, PropCategory.REGULAR)
