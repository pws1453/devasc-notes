...
# ##################################################
class RsFromRPToL3OutInstP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsFromRPToL3OutInstP", "cobra.model.l3ext.InstP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsFromRPToL3OutInstP"
    meta.rnFormat = "rsfromRPToL3OutInstP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from L4-L7 Resource Pool to L3OutInstP"
    ...
    meta.rnPrefixes = [
        ('rsfromRPToL3OutInstP-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38613, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40752, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isDefault", "isDefault", 28660, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28683, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28662, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28661, PropCategory.REGULAR)
