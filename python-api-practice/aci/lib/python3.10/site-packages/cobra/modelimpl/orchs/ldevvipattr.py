...
# ##################################################
class LDevVipAttr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.orchs.LDevVipAttr")

    meta.moClassName = "orchsLDevVipAttr"
    meta.rnFormat = "attr-%(nodeAttr)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Orchestrated Device Feature Attributes"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38610, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40749, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "nodeAttr", "nodeAttr", 28642, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop._addConstant("dynPat", "dynamic-port-address-translation", 0)
    prop._addConstant("rnat", "reverse-network-address-translation", 2)
    prop._addConstant("staPat", "static-port-address-translation", 1)
    meta.props.add("nodeAttr", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "nodeAttr"))
    ...
    def __init__(self, parentMoOrDn, nodeAttr, markDirty=True, **creationProps):
        namingVals = [nodeAttr]
