...
# ##################################################
class RsSvcsIpToSvcAlloc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsSvcsIpToSvcAlloc", "cobra.model.orchs.SvcAlloc")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsSvcsIpToSvcAlloc"
    meta.rnFormat = "rssvcsIpToSvcAlloc-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rssvcsIpToSvcAlloc-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38621, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40760, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28691, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28653, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28652, PropCategory.REGULAR)
