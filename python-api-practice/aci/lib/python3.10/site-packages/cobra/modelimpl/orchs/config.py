...
class Config(Mo):
    ...
    meta = ClassMeta("cobra.model.orchs.Config")

    meta.moClassName = "orchsConfig"
    meta.rnFormat = "orcfg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Orchestration Related Config under Context"
    ...
    meta.childClasses.add("cobra.model.orchs.SvcsIp")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.orchs.SvcsEncap")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.SvcsEncap", "encap-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.SvcsIp", "ip-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38578, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40717, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28678, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 28293, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
