...
class LdevCont(Mo):
    ...
    meta = ClassMeta("cobra.model.orchs.LdevCont")

    meta.moClassName = "orchsLdevCont"
    meta.rnFormat = "ldevcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Container for LDevVips"
    ...
    meta.childClasses.add("cobra.model.orchs.RsLDevItem")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsLDevItem", "rsLDevItem-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38616, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40755, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28686, PropCategory.REGULAR)
