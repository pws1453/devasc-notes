...
# ##################################################
class RsSvcsIpToIpPoolRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsSvcsIpToIpPoolRef", "cobra.model.orchs.RsIpPoolRefv2")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsSvcsIpToIpPoolRef"
    meta.rnFormat = "rssvcsIpToIpPoolRef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Link IP Address to IP Pool Reference"
    ...
    meta.rnPrefixes = [
        ('rssvcsIpToIpPoolRef-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38776, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40915, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35390, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35387, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11074
    prop.defaultValueStr = "orchsRsIpPoolRefv2"
    prop._addConstant("orchsRsIpPoolRefv2", None, 11074)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35386, PropCategory.REGULAR)
