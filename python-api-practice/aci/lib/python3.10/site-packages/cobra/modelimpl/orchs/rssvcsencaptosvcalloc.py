...
# ##################################################
class RsSvcsEncapToSvcAlloc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsSvcsEncapToSvcAlloc", "cobra.model.orchs.SvcAlloc")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsSvcsEncapToSvcAlloc"
    meta.rnFormat = "rssvcsEncapToSvcAlloc-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Link IP Address to Allocated LDevVip"
    ...
    meta.rnPrefixes = [
        ('rssvcsEncapToSvcAlloc-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38620, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40759, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28690, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28649, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9576
    prop.defaultValueStr = "orchsSvcAlloc"
    prop._addConstant("orchsSvcAlloc", None, 9576)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28648, PropCategory.REGULAR)
