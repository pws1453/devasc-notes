...
# ##################################################
class RsAllocLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsAllocLDev", "cobra.model.vns.LDevVip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsAllocLDev"
    meta.rnFormat = "rsallocLDev-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Real Logical L4-L7 Device"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38619, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40758, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28689, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28674, PropCategory.REGULAR)
