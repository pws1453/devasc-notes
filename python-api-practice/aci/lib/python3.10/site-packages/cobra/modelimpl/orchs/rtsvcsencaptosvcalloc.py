...
# ##################################################
class RtSvcsEncapToSvcAlloc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.orchs.RtSvcsEncapToSvcAlloc", "cobra.model.orchs.SvcsEncap")

    meta.moClassName = "orchsRtSvcsEncapToSvcAlloc"
    meta.rnFormat = "rtsvcsEncapToSvcAlloc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28651, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9468
    prop.defaultValueStr = "orchsSvcsEncap"
    prop._addConstant("orchsSvcsEncap", None, 9468)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28650, PropCategory.REGULAR)
