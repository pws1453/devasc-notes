...
# ##################################################
class FuncProfileCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.orchs.FuncProfileCont")

    meta.moClassName = "orchsFuncProfileCont"
    meta.rnFormat = "funcProfCont-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Container for Function Profiles"
    ...
    meta.childClasses.add("cobra.model.orchs.RsToFuncProfile")
    meta.childClasses.add("cobra.model.orchs.RsToMdev")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsToFuncProfile", "rstoFuncProfile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsToMdev", "rstoMdev-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38771, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40910, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34642, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 34519, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
