...
class SvcsIp(Mo):
    ...
    meta = ClassMeta("cobra.model.orchs.SvcsIp")

    meta.moClassName = "orchsSvcsIp"
    meta.rnFormat = "ip-%(name)s"
    ...
    meta.childClasses.add("cobra.model.orchs.RsSvcsIpToSvcAlloc")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.orchs.RsSvcsIpToIpPoolRef")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsSvcsIpToIpPoolRef", "rssvcsIpToIpPoolRef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsSvcsIpToSvcAlloc", "rssvcsIpToSvcAlloc-"))
    ...
    prop = PropMeta("str", "address", "address", 28249, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("address", prop)

    prop = PropMeta("str", "annotation", "annotation", 38580, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40719, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "gateway", "gateway", 28251, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ipNsName", "ipNsName", 28252, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("ipNsName", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28680, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 28295, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "netmask", "netmask", 28250, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
