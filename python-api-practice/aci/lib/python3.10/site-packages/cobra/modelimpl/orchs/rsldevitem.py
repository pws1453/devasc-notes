...
class RsLDevItem(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.orchs.RsLDevItem", "cobra.model.vns.LDevVip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsLDevItem"
    meta.rnFormat = "rsLDevItem-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Logical L4-L7 Device"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38617, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40756, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28687, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28671, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28670, PropCategory.REGULAR)
