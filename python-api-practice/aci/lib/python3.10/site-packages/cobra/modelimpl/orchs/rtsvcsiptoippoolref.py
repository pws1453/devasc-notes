...
# ##################################################
class RtSvcsIpToIpPoolRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.orchs.RtSvcsIpToIpPoolRef", "cobra.model.orchs.SvcsIp")

    meta.moClassName = "orchsRtSvcsIpToIpPoolRef"
    meta.rnFormat = "rtsvcsIpToIpPoolRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 35389, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9469
    prop.defaultValueStr = "orchsSvcsIp"
    prop._addConstant("orchsSvcsIp", None, 9469)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35388, PropCategory.REGULAR)
