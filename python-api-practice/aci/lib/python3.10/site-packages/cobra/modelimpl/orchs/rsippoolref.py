...
# ##################################################
class RsIpPoolRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsIpPoolRef", "cobra.model.fvns.AddrInst")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "orchsRsIpPoolRef"
    meta.rnFormat = "rsIpPoolRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "External IP Address Pool"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40751, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28682, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28665, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
