...
# ##################################################
class SvcRsrcPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.orchs.SvcRsrcPool")

    meta.moClassName = "orchsSvcRsrcPool"
    meta.rnFormat = "svcs-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Services Resource Pool"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x1001
    ...
    meta.childClasses.add("cobra.model.orchs.FuncProfileCont")
    meta.childClasses.add("cobra.model.orchs.RsFromRPToL3OutInstP")
    meta.childClasses.add("cobra.model.orchs.RsIpPoolRef")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.orchs.TnSvcsSubnet")
    meta.childClasses.add("cobra.model.orchs.RsAbsGraphRef")
    meta.childClasses.add("cobra.model.orchs.RsFromRPToL3Dom")
    meta.childClasses.add("cobra.model.orchs.SvcAlloc")
    meta.childClasses.add("cobra.model.orchs.LdevCont")
    meta.childClasses.add("cobra.model.orchs.RsIpPoolRefv2")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsFromRPToL3OutInstP", "rsfromRPToL3OutInstP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsFromRPToL3Dom", "rsFromRPToL3Dom"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsAbsGraphRef", "rsabsGraphRef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsIpPoolRefv2", "rsipPoolRefv2-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.FuncProfileCont", "funcProfCont-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.RsIpPoolRef", "rsIpPoolRef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.LdevCont", "ldevcont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.TnSvcsSubnet", "subnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.SvcAlloc", "alloc-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38611, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "enableSharedGraphs", "enableSharedGraphs", 35686, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("enableSharedGraphs", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40750, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28681, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 28646, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "version", "version", 34484, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "classic"
    prop._addConstant("classic", "version-1-of-the-resource-pool", 0)
    prop._addConstant("normalized", "version-2-of-the-resource-pool", 1)
