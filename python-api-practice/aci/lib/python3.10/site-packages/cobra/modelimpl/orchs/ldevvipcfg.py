...
class LDevVipCfg(Mo):
    ...
    meta = ClassMeta("cobra.model.orchs.LDevVipCfg")

    meta.moClassName = "orchsLDevVipCfg"
    meta.rnFormat = "lls-%(nodeType)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Orchestrated Device Config"
    ...
    meta.childClasses.add("cobra.model.orchs.LDevVipAttr")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.orchs.LDevVipAttr", "attr-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38609, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40748, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 28254, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "nodeType", "nodeType", 28641, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop._addConstant("adc", "adc-single-vrf", 3)
    prop._addConstant("adcSplit", "adc-split-vrf", 2)
    prop._addConstant("fw", "firewall-single-vrf", 1)
    prop._addConstant("fwSplit", "firewall-split-vrf", 0)
    ...
    prop = PropMeta("str", "version", "version", 34485, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.namingProps.append(getattr(meta.props, "nodeType"))
    ...
    def __init__(self, parentMoOrDn, nodeType, markDirty=True, **creationProps):
        namingVals = [nodeType]
