...
# ##################################################
class RtSvcsIpToSvcAlloc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.orchs.RtSvcsIpToSvcAlloc", "cobra.model.orchs.SvcsIp")

    meta.moClassName = "orchsRtSvcsIpToSvcAlloc"
    meta.rnFormat = "rtsvcsIpToSvcAlloc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28655, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28654, PropCategory.REGULAR)
