...
# ##################################################
class RsAbsGraphRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.orchs.RsAbsGraphRef", "cobra.model.vns.AbsGraph")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "orchsRsAbsGraphRef"
    meta.rnFormat = "rsabsGraphRef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Common Graph Template"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38770, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40909, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34619, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34618, PropCategory.REGULAR)
