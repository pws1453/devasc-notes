...
class FilterTask(Mo):
    """
    A task for configuring a resolved filter.

    """

    meta = ClassMeta("cobra.model.vz.FilterTask")

    meta.moClassName = "vzFilterTask"
    meta.rnFormat = "vzFilterTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5740, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfRFltP", "confrfltp", 407)
