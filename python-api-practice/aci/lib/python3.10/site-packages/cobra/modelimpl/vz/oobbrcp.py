...
class OOBBrCP(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.OOBBrCP")

    meta.moClassName = "vzOOBBrCP"
    meta.rnFormat = "oobbrc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Out-Of-Band Contract"
    meta.writeAccessMask = 0x101
    meta.readAccessMask = 0x4701
    ...
    meta.childClasses.add("cobra.model.vz.RtOoBProv")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vz.RtOoBCons")
    meta.childClasses.add("cobra.model.vz.Subj")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vz.IntraEPgDef")
    meta.childClasses.add("cobra.model.vz.TrigCollectionCont")
    meta.childClasses.add("cobra.model.vz.InheritedDef")
    meta.childClasses.add("cobra.model.vz.DirAssDef")
    meta.childClasses.add("cobra.model.vz.Exception")
    meta.childClasses.add("cobra.model.vz.GraphCont")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.vz.RtIf")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vz.TrigCollectionCont", "trigCollectionDn-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RtOoBProv", "rtmgmtOoBProv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RtOoBCons", "rtmgmtOoBCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.InheritedDef", "inherited-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.GraphCont", "graphcont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.IntraEPgDef", "intraEpg"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.DirAssDef", "dirass"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.Subj", "subj-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.Exception", "excp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RtIf", "rtif-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.fv.Tenant")

    meta.superClasses.add("cobra.model.vz.ABrCP")
    meta.superClasses.add("cobra.model.vz.ACollection")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.vz.ACtrct")

    meta.rnPrefixes = [
        ('oobbrc-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37463, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 15216, PropCategory.REGULAR)
    prop.label = "Config Issues"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("any-to-prov-shared-service", "private-network-cannot-be-a-provider-in-shared-service-scenario", 8)
    prop._addConstant("filter-not-present", "filter-not-present", 1)
    prop._addConstant("none", "none", 0)
    prop._addConstant("subject-not-in-use-due-to-label", "no-epg-has-label-for-this-subject", 4)
    prop._addConstant("taboo-has-no-filter", "taboo-not-associated-to-any-filter", 2)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39602, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "intent", "intent", 55648, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14073, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7419, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 1044, PropCategory.REGULAR)
    prop.label = "QOS Class Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "reevaluateAll", "reevaluateAll", 16474, PropCategory.REGULAR)
    prop.label = "Reevaluate entire collection tree"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("reevaluateAll", prop)
    ...
    prop = PropMeta("str", "scope", "scope", 1043, PropCategory.REGULAR)
    prop.label = "Scope"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 22211, PropCategory.REGULAR)
    prop.label = "Contract Level Dscp"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
