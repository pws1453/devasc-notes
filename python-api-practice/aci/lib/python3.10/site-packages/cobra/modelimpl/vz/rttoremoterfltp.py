...
# ##################################################
class RtToRemoteRFltP(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vz.RtToRemoteRFltP", "cobra.model.fv.PndgRFltPCont")

    meta.moClassName = "vzRtToRemoteRFltP"
    meta.rnFormat = "rtfvToRemoteRFltP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17680, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5930
    prop.defaultValueStr = "fvPndgRFltPCont"
    prop._addConstant("fvPndgRFltPCont", None, 5930)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17679, PropCategory.REGULAR)
