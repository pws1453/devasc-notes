...
class Exception(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.Exception")

    meta.moClassName = "vzException"
    meta.rnFormat = "excp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Subject Exception Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38826, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "consRegex", "consRegex", 36917, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.regex = ['[a-zA-Z0-9_.:-^/+*-]*']
    meta.props.add("consRegex", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40965, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "field", "field", 36918, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 3
    prop.defaultValueStr = "Dn"
    prop._addConstant("Ctx", "ctx", 2)
    prop._addConstant("Dn", "dn", 3)
    prop._addConstant("EPg", "epg", 1)
    prop._addConstant("Tag", "tag", 4)
    prop._addConstant("Tenant", "tenant", 0)
    meta.props.add("field", prop)
    ...
    prop = PropMeta("str", "name", "name", 36915, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "provRegex", "provRegex", 36916, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.regex = ['[a-zA-Z0-9_.:-^/+*-]*']
    meta.props.add("provRegex", prop)
