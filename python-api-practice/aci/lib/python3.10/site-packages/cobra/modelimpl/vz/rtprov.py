...
class RtProv(Mo):
    """
    A target relation to a provider.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtProv", "cobra.model.fv.EPg")

    meta.moClassName = "vzRtProv"
    meta.rnFormat = "rtfvProv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12240, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12239, PropCategory.REGULAR)
