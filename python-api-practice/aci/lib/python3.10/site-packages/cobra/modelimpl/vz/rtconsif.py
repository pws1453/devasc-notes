...
class RtConsIf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtConsIf", "cobra.model.fv.EPg")

    meta.moClassName = "vzRtConsIf"
    meta.rnFormat = "rtfvConsIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12220, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12219, PropCategory.REGULAR)
