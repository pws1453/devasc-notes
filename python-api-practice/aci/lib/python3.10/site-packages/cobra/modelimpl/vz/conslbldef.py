...
class ConsLblDef(Mo):
    """
    A consumer label definition.

    """

    meta = ClassMeta("cobra.model.vz.ConsLblDef")

    meta.moClassName = "vzConsLblDef"
    meta.rnFormat = "cLblD-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 7412, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
