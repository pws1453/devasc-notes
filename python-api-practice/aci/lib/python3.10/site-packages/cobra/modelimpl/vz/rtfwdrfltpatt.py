...
# ##################################################
class RtFwdRFltPAtt(Mo):
    """
    A target relation to a forward remote filter profile.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtFwdRFltPAtt", "cobra.model.vz.Filter")

    meta.moClassName = "vzRtFwdRFltPAtt"
    meta.rnFormat = "rtfwdRFltPAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11900, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11899, PropCategory.REGULAR)
