...
class RsInTermGraphAtt(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsInTermGraphAtt", "cobra.model.vns.AbsGraph")
    meta.targetNameProps["name"] = "tnVnsAbsGraphName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsInTermGraphAtt"
    meta.rnFormat = "rsInTermGraphAtt"
    ...
    meta.rnPrefixes = [
        ('rsInTermGraphAtt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37475, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39614, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11846, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVnsAbsGraphName", "tnVnsAbsGraphName", 15755, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
