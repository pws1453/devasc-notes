...
# ##################################################
class FltTaskAggrTask(Mo):
    """
    A task to aggregate filter tasks.

    """

    meta = ClassMeta("cobra.model.vz.FltTaskAggrTask")

    meta.moClassName = "vzFltTaskAggrTask"
    meta.rnFormat = "vzFltTaskAggrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5741, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfRFltPAggr", "confrfltpaggr", 408)
