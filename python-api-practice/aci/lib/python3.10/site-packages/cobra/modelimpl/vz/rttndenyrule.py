...
# ##################################################
class RtTnDenyRule(Mo):
    """
    A target relation to a filter. A filter is a group of resolvable filter entries. Each filter entry is a combination of network traffic classification properties. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtTnDenyRule", "cobra.model.fv.Tenant")

    meta.moClassName = "vzRtTnDenyRule"
    meta.rnFormat = "rtfvTnDenyRule-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Tenant"
    meta.writeAccessMask = 0x101
    meta.readAccessMask = 0x1101
    ...
    prop = PropMeta("str", "tCl", "tCl", 12308, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1975
    prop.defaultValueStr = "fvTenant"
    prop._addConstant("fvTenant", None, 1975)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12307, PropCategory.REGULAR)
