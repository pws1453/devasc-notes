...
class Subj(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.Subj")

    meta.moClassName = "vzSubj"
    meta.rnFormat = "subj-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Contract Subject"
    ...
    meta.childClasses.add("cobra.model.vz.RsSubjGraphAtt")
    meta.childClasses.add("cobra.model.vz.RsSdwanPol")
    meta.childClasses.add("cobra.model.vz.RsSubjFiltAtt")
    ...
    meta.childClasses.add("cobra.model.vz.OutTerm")
    ...
    meta.childClasses.add("cobra.model.vz.InTerm")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsSubjGraphAtt", "rsSubjGraphAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsSubjFiltAtt", "rssubjFiltAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsSdwanPol", "rsSdwanPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.OutTerm", "outtmnl"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.InTerm", "intmnl"))
    ...
    meta.superClasses.add("cobra.model.vz.ASubj")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37468, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 15771, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "consMatchT", "consMatchT", 1048, PropCategory.REGULAR)
    prop.label = "Consumer Label Match Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    meta.props.add("consMatchT", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39607, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14080, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7430, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 1049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "provMatchT", "provMatchT", 1047, PropCategory.REGULAR)
    prop.label = "Provider Label Match Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "AtleastOne"
    ...
    prop._addConstant("AtmostOne", "atmostone", 3)
    prop._addConstant("None", "none", 4)
    meta.props.add("provMatchT", prop)

    prop = PropMeta("str", "revFltPorts", "revFltPorts", 1046, PropCategory.REGULAR)
    prop.label = "Reverse Filter Ports"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("revFltPorts", prop)
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 22212, PropCategory.REGULAR)
    prop.label = "Subject Level Dscp"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
