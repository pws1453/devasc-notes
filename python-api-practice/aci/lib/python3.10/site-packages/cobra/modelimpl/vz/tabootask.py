...
class TabooTask(Mo):
    """
    A task to process a taboo.

    """

    meta = ClassMeta("cobra.model.vz.TabooTask")

    meta.moClassName = "vzTabooTask"
    meta.rnFormat = "vzTabooTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5746, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CreateAnyTaboo", "createanytaboo", 435)
