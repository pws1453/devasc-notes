...
class RsFiltGraphAtt(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsFiltGraphAtt", "cobra.model.vns.InTerm")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsFiltGraphAtt"
    meta.rnFormat = "rsFiltGraphAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Filter Graph Attachment"
    ...
    meta.rnPrefixes = [
        ('rsFiltGraphAtt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37467, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39606, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "graphName", "graphName", 11825, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11824, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4655
    prop.defaultValueStr = "vnsInTerm"
