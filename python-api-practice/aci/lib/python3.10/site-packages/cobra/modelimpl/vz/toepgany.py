...
class ToEPgAny(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.ToEPgAny")

    meta.moClassName = "vzToEPgAny"
    meta.rnFormat = "to-[%(epgDn)s]"
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 16609, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19041, PropCategory.REGULAR)
