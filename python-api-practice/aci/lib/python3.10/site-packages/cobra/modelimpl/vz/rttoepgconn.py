...
# ##################################################
class RtToEpgConn(Mo):
    """
    A target relation to an endpoint group connection.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtToEpgConn", "cobra.model.actrl.ARule")

    meta.moClassName = "vzRtToEpgConn"
    meta.rnFormat = "rtactrlToEpgConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12629, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12628, PropCategory.REGULAR)
