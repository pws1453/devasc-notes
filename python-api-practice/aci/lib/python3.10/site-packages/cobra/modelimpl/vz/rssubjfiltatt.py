...
class RsSubjFiltAtt(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsSubjFiltAtt", "cobra.model.vz.Filter")
    meta.targetNameProps["name"] = "tnVzFilterName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsSubjFiltAtt"
    meta.rnFormat = "rssubjFiltAtt-%(tnVzFilterName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Subject Filter"
    ...
    meta.superClasses.add("cobra.model.vz.SubjectToFilter")
    ...
    prop = PropMeta("str", "action", "action", 36922, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "annotation", "annotation", 37469, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "directives", "directives", 25330, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39608, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14081, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "priorityOverride", "priorityOverride", 37168, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 11829, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1362
    prop.defaultValueStr = "vzFilter"
    ...
    prop = PropMeta("str", "tnVzFilterName", "tnVzFilterName", 11828, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVzFilterName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnVzFilterName"))
    ...
    def __init__(self, parentMoOrDn, tnVzFilterName, markDirty=True, **creationProps):
        namingVals = [tnVzFilterName]
