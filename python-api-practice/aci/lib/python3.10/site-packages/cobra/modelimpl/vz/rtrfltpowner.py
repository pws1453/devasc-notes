...
class RtRFltPOwner(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtRFltPOwner", "cobra.model.vz.RFltP")

    meta.moClassName = "vzRtRFltPOwner"
    meta.rnFormat = "rtRFltPOwner-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11908, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11907, PropCategory.REGULAR)
