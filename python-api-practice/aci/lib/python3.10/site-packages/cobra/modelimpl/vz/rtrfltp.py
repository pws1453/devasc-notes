...
class RtRFltP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtRFltP", "cobra.model.comp.RFltP")

    meta.moClassName = "vzRtRFltP"
    meta.rnFormat = "rtcompRFltP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23520, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23519, PropCategory.REGULAR)
