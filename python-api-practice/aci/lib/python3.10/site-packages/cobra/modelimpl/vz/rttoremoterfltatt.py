...
# ##################################################
class RtToRemoteRFltAtt(Mo):
    """
    A target relation to remote resolved filter profile.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtToRemoteRFltAtt", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "vzRtToRemoteRFltAtt"
    meta.rnFormat = "rtfvToRemoteRFltAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12455, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12454, PropCategory.REGULAR)
