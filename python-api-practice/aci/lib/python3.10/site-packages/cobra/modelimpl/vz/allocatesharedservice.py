...
# ##################################################
class AllocateSharedService(Mo):
    """
    Allocate shared service.

    """

    meta = ClassMeta("cobra.model.vz.AllocateSharedService")

    meta.moClassName = "vzAllocateSharedService"
    meta.rnFormat = "allocSharedServicePcTag"
    meta.category = MoCategory.REGULAR
    meta.label = "Re-allocate pcTag from Shared Service Pool"
    ...
    prop = PropMeta("str", "txId", "txId", 27324, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
