...
class RtCtxMcastTo(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtCtxMcastTo", "cobra.model.fv.Ctx")

    meta.moClassName = "vzRtCtxMcastTo"
    meta.rnFormat = "rtfvCtxMcastTo-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "VRF"
    meta.writeAccessMask = 0x101
    meta.readAccessMask = 0x3101
    ...
    prop = PropMeta("str", "tCl", "tCl", 12372, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12371, PropCategory.REGULAR)
