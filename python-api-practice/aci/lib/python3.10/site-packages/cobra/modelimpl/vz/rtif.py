...
class RtIf(Mo):
    """
    A target relation to an abstract resolvable contract.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtIf", "cobra.model.vz.CPIf")

    meta.moClassName = "vzRtIf"
    meta.rnFormat = "rtif-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11818, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11817, PropCategory.REGULAR)
