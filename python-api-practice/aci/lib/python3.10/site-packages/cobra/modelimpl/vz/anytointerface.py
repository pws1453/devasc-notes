...
# ##################################################
class AnyToInterface(Mo):
    meta = ClassMeta("cobra.model.vz.AnyToInterface")

    meta.isAbstract = True
    meta.moClassName = "vzAnyToInterface"


    meta.moClassName = "vzAnyToInterface"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Each any to Collection Interface Relation"
    ...
    meta.concreteSubClasses.add("cobra.model.vz.RsAnyToConsIf")
