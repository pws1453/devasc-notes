...
# ##################################################
class RsAnyToCons(Mo):
    """
    A source relation to the binary contract profile.

    """

    meta = NamedSourceRelationMeta("cobra.model.vz.RsAnyToCons", "cobra.model.vz.BrCP")
    meta.targetNameProps["name"] = "tnVzBrCPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsAnyToCons"
    meta.rnFormat = "rsanyToCons-%(tnVzBrCPName)s"
    ...
    meta.childClasses.add("cobra.model.vz.CollectionCont")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vz.ConsLbl")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.CollectionCont", "collectionDn-"))
    ...
    meta.superClasses.add("cobra.model.vz.AnyToCollection")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37486, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deplInfo", "deplInfo", 11858, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39625, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "intent", "intent", 55651, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14092, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 11859, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11857, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzBrCPName", "tnVzBrCPName", 11856, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "updateCollection", "updateCollection", 20831, PropCategory.REGULAR)
