...
# ##################################################
class AnyToCollection(Mo):
    meta = ClassMeta("cobra.model.vz.AnyToCollection")

    meta.isAbstract = True
    meta.moClassName = "vzAnyToCollection"


    meta.moClassName = "vzAnyToCollection"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Each any to Collection Relation"
    ...
    meta.concreteSubClasses.add("cobra.model.vz.RsAnyToCons")
    meta.concreteSubClasses.add("cobra.model.vz.RsAnyToProv")
