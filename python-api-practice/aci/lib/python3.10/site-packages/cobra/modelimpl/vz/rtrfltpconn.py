...
# ##################################################
class RtRfltpConn(Mo):
    """
    A target relation to the resolved filter profile.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtRfltpConn", "cobra.model.actrl.Flt")

    meta.moClassName = "vzRtRfltpConn"
    meta.rnFormat = "rtrfltpConn"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Access Control Filter"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12638, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2490
    prop.defaultValueStr = "actrlFlt"
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15054, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
