...
class BrCPTask(Mo):
    """
    An internal object that tracks a task on a binary contract profile.

    """

    meta = ClassMeta("cobra.model.vz.BrCPTask")

    meta.moClassName = "vzBrCPTask"
    meta.rnFormat = "vzBrCPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5737, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VzForceConfig", "vzforceconfig", 436)
