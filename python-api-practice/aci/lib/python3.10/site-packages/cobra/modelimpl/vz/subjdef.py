...
class SubjDef(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.SubjDef")

    meta.moClassName = "vzSubjDef"
    meta.rnFormat = "ctrct-[%(ctrctPKey)s]-subj-[%(subjPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Contract Dependency Container Def"
    ...
    prop = PropMeta("str", "ctrctPKey", "ctrctPKey", 1075, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "subjPKey", "subjPKey", 1074, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("subjPKey", prop)

    meta.namingProps.append(getattr(meta.props, "ctrctPKey"))
    getattr(meta.props, "ctrctPKey").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "subjPKey"))
    getattr(meta.props, "subjPKey").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, ctrctPKey, subjPKey, markDirty=True, **creationProps):
        namingVals = [ctrctPKey, subjPKey]
