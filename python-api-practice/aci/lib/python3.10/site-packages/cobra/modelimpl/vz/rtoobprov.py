...
class RtOoBProv(Mo):
    ...
    prop = PropMeta("str", "tCl", "tCl", 12546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12545, PropCategory.REGULAR)
