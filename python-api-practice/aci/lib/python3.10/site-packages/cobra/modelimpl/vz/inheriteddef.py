...
# ##################################################
class InheritedDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vz.InheritedDef")

    meta.moClassName = "vzInheritedDef"
    meta.rnFormat = "inherited-[%(relationDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Container Def for all EPgs Associating to Contract/Bundle/Group via Security Inheritance"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30565, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "relationDn", "relationDn", 30551, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("relationDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "relationDn"))
    getattr(meta.props, "relationDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, relationDn, markDirty=True, **creationProps):
        namingVals = [relationDn]
