...
class ProvSubjLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.ProvSubjLbl")

    meta.moClassName = "vzProvSubjLbl"
    meta.rnFormat = "provsubjlbl-%(name)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37480, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39619, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 7426, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
