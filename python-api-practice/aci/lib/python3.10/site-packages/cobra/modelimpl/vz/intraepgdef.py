...
# ##################################################
class IntraEPgDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vz.IntraEPgDef")

    meta.moClassName = "vzIntraEPgDef"
    meta.rnFormat = "intraEpg"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33377, PropCategory.REGULAR)
