...
class RtToEPgAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtToEPgAtt", "cobra.model.comp.ToEPg")

    meta.moClassName = "vzRtToEPgAtt"
    meta.rnFormat = "rtcompToEPgAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24285, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24284, PropCategory.REGULAR)
