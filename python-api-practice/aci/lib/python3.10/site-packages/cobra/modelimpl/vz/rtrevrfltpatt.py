...
# ##################################################
class RtRevRFltPAtt(Mo):
    """
    The reverse a resolved filter profile.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtRevRFltPAtt", "cobra.model.vz.Filter")

    meta.moClassName = "vzRtRevRFltPAtt"
    meta.rnFormat = "rtrevRFltPAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11904, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11903, PropCategory.REGULAR)
