...
# ##################################################
class RtConnToFlt(Mo):
    """
    A target relation to an abstraction of a filter object, which can be a filter, folder of filters , or a collection of filters.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtConnToFlt", "cobra.model.vns.AFuncConn")

    meta.moClassName = "vzRtConnToFlt"
    meta.rnFormat = "rtvnsConnToFlt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13547, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4676
    prop.defaultValueStr = "vnsAFuncConn"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13546, PropCategory.REGULAR)
