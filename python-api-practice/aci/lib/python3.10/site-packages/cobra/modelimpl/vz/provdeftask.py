...
# ##################################################
class ProvDefTask(Mo):
    """
    A task to handle a provider definition.

    """

    meta = ClassMeta("cobra.model.vz.ProvDefTask")

    meta.moClassName = "vzProvDefTask"
    meta.rnFormat = "vzProvDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5742, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ClassIdFromSharedPool", "classidfromsharedpool", 1326)
