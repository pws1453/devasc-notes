...
# ##################################################
class RsGraphDefToGraph(Mo):
    """
    A source relation to an abstract graph.

    """

    meta = SourceRelationMeta("cobra.model.vz.RsGraphDefToGraph", "cobra.model.vns.AbsGraph")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsGraphDefToGraph"
    meta.rnFormat = "rsgraphDefToGraph"
    ...
    meta.parentClasses.add("cobra.model.vz.GraphDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsgraphDefToGraph', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11935, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11934, PropCategory.REGULAR)
