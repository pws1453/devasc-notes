...
class RsRFltPOwner(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vz.RsRFltPOwner", "cobra.model.vz.Filter")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsRFltPOwner"
    meta.rnFormat = "rsRFltPOwner-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11906, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11905, PropCategory.REGULAR)
