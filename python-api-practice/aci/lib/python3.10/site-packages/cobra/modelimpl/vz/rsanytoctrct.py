...
# ##################################################
class RsAnyToCtrct(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vz.RsAnyToCtrct", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsAnyToCtrct"
    meta.rnFormat = "rsanyToCtrct"
    ...
    meta.parentClasses.add("cobra.model.vz.AnyREpPCtrct")
    ...
    prop = PropMeta("str", "tCl", "tCl", 16631, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16630, PropCategory.REGULAR)
