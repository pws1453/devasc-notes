...
class ConsSubjLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.ConsSubjLbl")

    meta.moClassName = "vzConsSubjLbl"
    meta.rnFormat = "conssubjlbl-%(name)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37481, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39620, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 7413, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
