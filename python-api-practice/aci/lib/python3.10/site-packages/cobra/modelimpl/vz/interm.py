...
class InTerm(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.InTerm")

    meta.moClassName = "vzInTerm"
    meta.rnFormat = "intmnl"
    meta.category = MoCategory.REGULAR
    meta.label = "InTerm Subject"
    ...
    meta.childClasses.add("cobra.model.vz.RsInTermGraphAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsInTermGraphAtt", "rsInTermGraphAtt"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37474, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39613, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14086, PropCategory.REGULAR)
