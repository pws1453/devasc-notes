...
class RsSubjGraphAtt(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsSubjGraphAtt", "cobra.model.vns.AbsGraph")
    meta.targetNameProps["name"] = "tnVnsAbsGraphName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsSubjGraphAtt"
    meta.rnFormat = "rsSubjGraphAtt"
    ...
    meta.rnPrefixes = [
        ('rsSubjGraphAtt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37470, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "directives", "directives", 25329, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39609, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14082, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11832, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4624
    prop.defaultValueStr = "vnsAbsGraph"
    ...
    prop = PropMeta("str", "tnVnsAbsGraphName", "tnVnsAbsGraphName", 15754, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVnsAbsGraphName", prop)
