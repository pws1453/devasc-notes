...
# ##################################################
class ToRFltP(Mo):
    meta = ClassMeta("cobra.model.vz.ToRFltP")

    meta.isAbstract = True
    meta.moClassName = "vzToRFltP"
    ...
    meta.concreteSubClasses.add("cobra.model.vz.RsRFltAtt")
    meta.concreteSubClasses.add("cobra.model.vz.RsTabooRFltAtt")
