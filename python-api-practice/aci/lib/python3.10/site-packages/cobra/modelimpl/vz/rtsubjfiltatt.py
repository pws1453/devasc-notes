...
class RtSubjFiltAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtSubjFiltAtt", "cobra.model.vz.Subj")

    meta.moClassName = "vzRtSubjFiltAtt"
    meta.rnFormat = "rtsubjFiltAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11831, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1319
    prop.defaultValueStr = "vzSubj"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzSubj", None, 1319)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11830, PropCategory.REGULAR)
