...
# ##################################################
class ProvCtrctLbl(Mo):
    """
    A label identifying a contract. A contract label can be parented by the relation between an endpoint group (EPG) and security group. The EPG is associated with a group and lists all contracts it provides out of the group, as well as, optionally, contracts that it chooses to consume. If no consumption contracts are indicated, all contracts are consumed. If no provider contracts are identified, the EPG provides no contracts out of this group.

    """

    meta = ClassMeta("cobra.model.vz.ProvCtrctLbl")

    meta.moClassName = "vzProvCtrctLbl"
    meta.rnFormat = "pCtrctLbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Provider Contract Label"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37482, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39621, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 7420, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
