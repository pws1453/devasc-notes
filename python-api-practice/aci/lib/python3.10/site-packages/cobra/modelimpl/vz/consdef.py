...
class ConsDef(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.ConsDef")

    meta.moClassName = "vzConsDef"
    meta.rnFormat = "cons-[%(epgDn)s]-any-%(isAny)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Consumer EPg"
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 7410, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "isAny", "isAny", 7409, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "isMsiteEPg", "isMsiteEPg", 37213, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14105, PropCategory.REGULAR)
