...
# ##################################################
class TrigCollectionCont(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vz.TrigCollectionCont")

    meta.moClassName = "vzTrigCollectionCont"
    meta.rnFormat = "trigCollectionDn-[%(collectionContDn)s]"
    ...
    prop = PropMeta("str", "collectionContDn", "collectionContDn", 16333, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("collectionContDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "collectionContDn"))
    getattr(meta.props, "collectionContDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, collectionContDn, markDirty=True, **creationProps):
        namingVals = [collectionContDn]
