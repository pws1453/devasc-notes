...
# ##################################################
class RsRevRFltPAtt(Mo):
    """
    The reverse resolved filter profile.

    """

    meta = SourceRelationMeta("cobra.model.vz.RsRevRFltPAtt", "cobra.model.vz.AFilterableUnit")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsRevRFltPAtt"
    meta.rnFormat = "rsRevRFltPAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11902, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11901, PropCategory.REGULAR)
