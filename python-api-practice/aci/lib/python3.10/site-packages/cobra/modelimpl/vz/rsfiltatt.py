...
class RsFiltAtt(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsFiltAtt", "cobra.model.vz.Filter")
    meta.targetNameProps["name"] = "tnVzFilterName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsFiltAtt"
    meta.rnFormat = "rsfiltAtt-%(tnVzFilterName)s"
    ...
    prop = PropMeta("str", "action", "action", 36923, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "annotation", "annotation", 37473, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "directives", "directives", 25802, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39612, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14085, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "priorityOverride", "priorityOverride", 37169, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 11843, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzFilterName", "tnVzFilterName", 11842, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
