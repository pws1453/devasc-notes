...
class RsOutTermGraphAtt(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsOutTermGraphAtt", "cobra.model.vns.AbsGraph")
    meta.targetNameProps["name"] = "tnVnsAbsGraphName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsOutTermGraphAtt"
    meta.rnFormat = "rsOutTermGraphAtt"
    ...
    meta.rnPrefixes = [
        ('rsOutTermGraphAtt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37477, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39616, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVnsAbsGraphName", "tnVnsAbsGraphName", 15756, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
