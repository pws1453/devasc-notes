...
class RtRFltAtt(Mo):
    """
    A target relation to a resolved filter profile.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtRFltAtt", "cobra.model.vz.ToEPg")

    meta.moClassName = "vzRtRFltAtt"
    meta.rnFormat = "rtrFltAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11933, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1380
    prop.defaultValueStr = "vzToEPg"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzToEPg", None, 1380)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11932, PropCategory.REGULAR)
