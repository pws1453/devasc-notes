...
class ProvDef(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.ProvDef")

    meta.moClassName = "vzProvDef"
    meta.rnFormat = "prov-[%(epgDn)s]-any-%(isAny)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Provider EPg"
    ...
    meta.childClasses.add("cobra.model.vz.AllocateSharedService")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.AllocateSharedService", "allocSharedServicePcTag"))
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 7423, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "hasTriggeredAlloc", "hasTriggeredAlloc", 1079, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("hasTriggeredAlloc", prop)

    prop = PropMeta("str", "intent", "intent", 55650, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "isAny", "isAny", 7422, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "isMsiteEPg", "isMsiteEPg", 37212, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isMsiteEPg", prop)
    ...
    prop = PropMeta("str", "matchT", "matchT", 1080, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14104, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "isAny"))
    ...
    def __init__(self, parentMoOrDn, epgDn, isAny, markDirty=True, **creationProps):
        namingVals = [epgDn, isAny]
