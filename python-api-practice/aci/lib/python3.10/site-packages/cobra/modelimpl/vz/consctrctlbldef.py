...
# ##################################################
class ConsCtrctLblDef(Mo):
    """
    A consumer contract label definition.

    """

    meta = ClassMeta("cobra.model.vz.ConsCtrctLblDef")

    meta.moClassName = "vzConsCtrctLblDef"
    meta.rnFormat = "cCtrctLblD-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 7408, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
