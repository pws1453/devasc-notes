...
class OutTerm(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.OutTerm")

    meta.moClassName = "vzOutTerm"
    meta.rnFormat = "outtmnl"
    meta.category = MoCategory.REGULAR
    meta.label = "OutTerm Subject"
    ...
    meta.childClasses.add("cobra.model.vz.RsOutTermGraphAtt")
    meta.childClasses.add("cobra.model.vz.RsFiltAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsOutTermGraphAtt", "rsOutTermGraphAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsFiltAtt", "rsfiltAtt-"))
    ...
    meta.superClasses.add("cobra.model.vz.ATerm")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Comp")
    meta.superClasses.add("cobra.model.vz.ASTerm")

    meta.rnPrefixes = [
        ('outtmnl', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37476, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39615, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prio", "prio", 1050, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 22213, PropCategory.REGULAR)
    prop.label = "Terminal Level Dscp"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
