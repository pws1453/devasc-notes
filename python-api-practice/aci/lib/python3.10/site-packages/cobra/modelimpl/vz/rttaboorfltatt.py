...
# ##################################################
class RtTabooRFltAtt(Mo):
    """
    A target relation to a taboo resolved filter profile.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtTabooRFltAtt", "cobra.model.vz.TabooDef")

    meta.moClassName = "vzRtTabooRFltAtt"
    meta.rnFormat = "rttabooRFltAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11915, PropCategory.REGULAR)
