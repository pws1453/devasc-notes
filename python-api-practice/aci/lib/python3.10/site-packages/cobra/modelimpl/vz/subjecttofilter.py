...
# ##################################################
class SubjectToFilter(Mo):
    meta = ClassMeta("cobra.model.vz.SubjectToFilter")

    meta.isAbstract = True
    meta.moClassName = "vzSubjectToFilter"


    meta.moClassName = "vzSubjectToFilter"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Subject-Filter relation"
    ...
    meta.concreteSubClasses.add("cobra.model.vz.RsFiltAtt")
    meta.concreteSubClasses.add("cobra.model.vz.RsSubjFiltAtt")
