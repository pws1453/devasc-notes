...
class GraphDef(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.GraphDef")

    meta.moClassName = "vzGraphDef"
    meta.rnFormat = "owner-[%(ownerDn)s]"
    ...
    meta.childClasses.add("cobra.model.vz.RsGraphDefToGraph")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsGraphDefToGraph", "rsgraphDefToGraph"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.vz.GraphCont")
    ...
    prop = PropMeta("str", "graphDn", "graphDn", 21983, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("graphDn", prop)

    prop = PropMeta("str", "graphTermDn", "graphTermDn", 1085, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("graphTermDn", prop)
    ...
    prop = PropMeta("str", "ownerDn", "ownerDn", 1084, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
