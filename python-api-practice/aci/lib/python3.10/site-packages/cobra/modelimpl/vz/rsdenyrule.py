...
class RsDenyRule(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsDenyRule", "cobra.model.vz.Filter")
    meta.targetNameProps["name"] = "tnVzFilterName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsDenyRule"
    meta.rnFormat = "rsdenyRule-%(tnVzFilterName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Deny Rule"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "directives", "directives", 11839, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39611, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14084, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11838, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzFilterName", "tnVzFilterName", 11837, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
