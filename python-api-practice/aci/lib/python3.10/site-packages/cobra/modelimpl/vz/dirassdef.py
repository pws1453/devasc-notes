...
class DirAssDef(Mo):
    """
    A direct association definition for a collection. A collection is a contract.

    """

    meta = ClassMeta("cobra.model.vz.DirAssDef")

    meta.moClassName = "vzDirAssDef"
    meta.rnFormat = "dirass"
    meta.category = MoCategory.REGULAR
    meta.label = "Container Def for all EPgs Associating Directly to Contract/Bundle/Group"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14100, PropCategory.REGULAR)
