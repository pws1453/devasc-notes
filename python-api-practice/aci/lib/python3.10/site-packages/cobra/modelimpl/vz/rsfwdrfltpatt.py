...
# ##################################################
class RsFwdRFltPAtt(Mo):
    """
    A source relation to forward a resolved filter profile. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vz.RsFwdRFltPAtt", "cobra.model.vz.AFilterableUnit")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsFwdRFltPAtt"
    meta.rnFormat = "rsFwdRFltPAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11898, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11897, PropCategory.REGULAR)
