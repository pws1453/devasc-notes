...
# ##################################################
class CollectionContTask(Mo):
    """
    The collection container task.

    """

    meta = ClassMeta("cobra.model.vz.CollectionContTask")

    meta.moClassName = "vzCollectionContTask"
    meta.rnFormat = "vzCollectionContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5738, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BringCollectionIntInfoIntoCtrct", "bringcollectionintinfointoctrct", 1420)
    prop._addConstant("BringInfoIntoCollectionShard", "bringinfointocollectionshard", 433)
