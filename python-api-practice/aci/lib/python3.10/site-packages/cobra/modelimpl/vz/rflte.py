...
class RFltE(Mo):
    """
    A remote filter entry. A filter entry is a combination of network traffic classification properties. Note that this relation is an internal object.

    """

    meta = ClassMeta("cobra.model.vz.RFltE")

    meta.moClassName = "vzRFltE"
    meta.rnFormat = "fe-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 7428, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
