...
class RtConnToFltInst(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtConnToFltInst", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "vzRtConnToFltInst"
    meta.rnFormat = "rtvnsConnToFltInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13637, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13636, PropCategory.REGULAR)
