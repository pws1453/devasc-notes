...
class RtDenyRule(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtDenyRule", "cobra.model.vz.TSubj")

    meta.moClassName = "vzRtDenyRule"
    meta.rnFormat = "rtdenyRule-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11841, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1324
    prop.defaultValueStr = "vzTSubj"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzTSubj", None, 1324)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11840, PropCategory.REGULAR)
