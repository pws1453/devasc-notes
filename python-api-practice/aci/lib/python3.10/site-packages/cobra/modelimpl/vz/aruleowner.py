...
# ##################################################
class ARuleOwner(Mo):
    meta = ClassMeta("cobra.model.vz.ARuleOwner")

    meta.isAbstract = True
    meta.moClassName = "vzARuleOwner"
    ...
    meta.concreteSubClasses.add("cobra.model.vz.ObservableRuleOwner")
    meta.concreteSubClasses.add("cobra.model.vz.RuleOwner")
    ...
    prop = PropMeta("str", "creatorDn", "creatorDn", 35591, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tag", "tag", 35592, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
