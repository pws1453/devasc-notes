...
class RsToAnyDef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vz.RsToAnyDef", "cobra.model.vz.AnyDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsToAnyDef"
    meta.rnFormat = "rstoAnyDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16611, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16610, PropCategory.REGULAR)
