...
# ##################################################
class GlobalPcTagRequestTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vz.GlobalPcTagRequestTask")

    meta.moClassName = "vzGlobalPcTagRequestTask"
    meta.rnFormat = "vzGlobalPcTagRequestTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21897, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReleaseGlobalPcTag", "releaseglobalpctag", 1902)
    prop._addConstant("RequestGlobalPcTag", "requestglobalpctag", 1901)
