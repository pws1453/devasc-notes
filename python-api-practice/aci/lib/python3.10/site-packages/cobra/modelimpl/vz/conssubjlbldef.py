...
# ##################################################
class ConsSubjLblDef(Mo):
    """
    A consumer subject label definition.

    """

    meta = ClassMeta("cobra.model.vz.ConsSubjLblDef")

    meta.moClassName = "vzConsSubjLblDef"
    meta.rnFormat = "cSubjLblD-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 7414, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
