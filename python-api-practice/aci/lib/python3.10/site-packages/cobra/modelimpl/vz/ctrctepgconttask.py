...
# ##################################################
class CtrctEPgContTask(Mo):
    """
    A task for sending contract updates. 

    """

    meta = ClassMeta("cobra.model.vz.CtrctEPgContTask")

    meta.moClassName = "vzCtrctEPgContTask"
    meta.rnFormat = "vzCtrctEPgContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5739, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CtrctToEpPUpd", "ctrcttoeppupd", 409)
    prop._addConstant("UpdateCtxDefWithAnyREpPCtrct", "updatectxdefwithanyreppctrct", 1476)
