...
class RsAnyToConsIf(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsAnyToConsIf", "cobra.model.vz.CPIf")
    meta.targetNameProps["name"] = "tnVzCPIfName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsAnyToConsIf"
    meta.rnFormat = "rsanyToConsIf-%(tnVzCPIfName)s"
    ...
    meta.superClasses.add("cobra.model.vz.AnyToInterface")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37487, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deplInfo", "deplInfo", 11875, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("No_Matching_Provider", "no_matching_provider", 8)
    prop._addConstant("No_Subjects", "no_subjects", 4)
    prop._addConstant("None", "none", 0)
    prop._addConstant("Not_Associated_To_Context", "not_associated_to_context", 2)
    prop._addConstant("PCTag_Not_Allocated", "pctag_not_allocated", 1)
    meta.props.add("deplInfo", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39626, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14093, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 11876, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11874, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1308
    prop.defaultValueStr = "vzCPIf"
    prop._addConstant("unspecified", "unspecified", 0)
    ...
    prop = PropMeta("str", "tnVzCPIfName", "tnVzCPIfName", 11873, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVzCPIfName", prop)
    ...
    prop = PropMeta("str", "updateCollection", "updateCollection", 20830, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "tnVzCPIfName"))
    ...
    def __init__(self, parentMoOrDn, tnVzCPIfName, markDirty=True, **creationProps):
        namingVals = [tnVzCPIfName]
