...
class RtOoBCons(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtOoBCons", "cobra.model.mgmt.InstP")

    meta.moClassName = "vzRtOoBCons"
    meta.rnFormat = "rtmgmtOoBCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12540, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12539, PropCategory.REGULAR)
