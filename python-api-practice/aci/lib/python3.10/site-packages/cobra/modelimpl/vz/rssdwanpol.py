...
class RsSdwanPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vz.RsSdwanPol", "cobra.model.extdev.SDWanSlaPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsSdwanPol"
    meta.rnFormat = "rsSdwanPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SDWAN SLA Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 49896, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49897, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49884, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 49834, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14269
    prop.defaultValueStr = "extdevSDWanSlaPol"
    prop._addConstant("extdevSDWanSlaPol", None, 14269)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49833, PropCategory.REGULAR)
