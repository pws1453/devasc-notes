...
# ##################################################
class ObservableRuleOwner(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vz.ObservableRuleOwner")

    meta.moClassName = "vzObservableRuleOwner"
    meta.rnFormat = "oown-[%(creatorDn)s]-ttag-%(tag)s"
    ...
    prop = PropMeta("str", "action", "action", 35593, PropCategory.REGULAR)
    prop.label = "Action"
    ...
    prop = PropMeta("str", "creatorDn", "creatorDn", 35600, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctrctName", "ctrctName", 42283, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "direction", "direction", 35597, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "intent", "intent", 55652, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "localDirection", "localDirection", 37214, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("bidir", "bidir", 3)
    prop._addConstant("bidirAny", "bidirany", 6)
    prop._addConstant("dest", "dest", 2)
    prop._addConstant("destAny", "destany", 5)
    prop._addConstant("src", "src", 1)
    prop._addConstant("srcAny", "srcany", 4)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("localDirection", prop)

    prop = PropMeta("str", "markDscp", "markDscp", 35596, PropCategory.REGULAR)
    prop.label = "Dscp"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "monitorDn", "monitorDn", 35598, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monitorDn", prop)
    ...
    prop = PropMeta("str", "observableDn", "observableDn", 35599, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("observableDn", prop)

    prop = PropMeta("str", "prio", "prio", 35594, PropCategory.REGULAR)
    prop.label = "Priority"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 23)]
    ...
    prop = PropMeta("str", "qosGrp", "qosGrp", 35595, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tag", "tag", 35601, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("arepp", "arepp", 5)
    prop._addConstant("bd", "bd", 2)
    prop._addConstant("filter", "filter", 8)
    prop._addConstant("mgmt", "mgmt", 9)
    prop._addConstant("taboo", "taboo", 7)
    prop._addConstant("to-epg", "to-epg", 3)
    prop._addConstant("to-epg-any", "to-epg-any", 4)
    prop._addConstant("unknown", "unknown", 0)
    prop._addConstant("vlanckt", "vlanckt", 6)
    prop._addConstant("vrf", "vrf", 1)
    meta.props.add("tag", prop)

    prop = PropMeta("str", "type", "type", 57375, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    meta.namingProps.append(getattr(meta.props, "tag"))

    def __init__(self, parentMoOrDn, creatorDn, tag, markDirty=True, **creationProps):
        namingVals = [creatorDn, tag]
