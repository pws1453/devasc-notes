...
# ##################################################
class InterfaceToCollection(Mo):
    meta = ClassMeta("cobra.model.vz.InterfaceToCollection")

    meta.isAbstract = True
    meta.moClassName = "vzInterfaceToCollection"


    meta.moClassName = "vzInterfaceToCollection"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Each Interface to Collection Relation"
    ...
    meta.concreteSubClasses.add("cobra.model.vz.RsIf")
    ...
    prop = PropMeta("str", "updateCollection", "updateCollection", 20829, PropCategory.REGULAR)
