...
# ##################################################
class ACollectionTask(Mo):
    """
    A task for rendering service graphs.

    """

    meta = ClassMeta("cobra.model.vz.ACollectionTask")

    meta.moClassName = "vzACollectionTask"
    meta.rnFormat = "vzACollectionTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5736, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ProcessContract", "processcontract", 842)
