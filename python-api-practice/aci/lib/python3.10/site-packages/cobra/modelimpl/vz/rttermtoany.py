...
# ##################################################
class RtTermToAny(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vz.RtTermToAny", "cobra.model.vns.ATerm")

    meta.moClassName = "vzRtTermToAny"
    meta.rnFormat = "rtvnsTermToAny-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Terminal Abstract Class"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x6000000000002701
    ...
    prop = PropMeta("str", "tCl", "tCl", 16850, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16849, PropCategory.REGULAR)
