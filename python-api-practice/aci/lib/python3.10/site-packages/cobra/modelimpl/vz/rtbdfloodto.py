...
class RtBdFloodTo(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtBdFloodTo", "cobra.model.fv.ABDPol")

    meta.moClassName = "vzRtBdFloodTo"
    meta.rnFormat = "rtfvBdFloodTo-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12181, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12180, PropCategory.REGULAR)
