...
# ##################################################
class RtAnyToCons(Mo):
    """
    A target relation to any consumer.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtAnyToCons", "cobra.model.vz.Any")

    meta.moClassName = "vzRtAnyToCons"
    meta.rnFormat = "rtanyToCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11861, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11860, PropCategory.REGULAR)
