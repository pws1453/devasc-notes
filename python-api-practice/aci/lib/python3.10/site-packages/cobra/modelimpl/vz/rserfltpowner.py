...
# ##################################################
class RsERFltPOwner(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vz.RsERFltPOwner", "cobra.model.vz.Filter")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsERFltPOwner"
    meta.rnFormat = "rsERFltPOwner-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16806, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16805, PropCategory.REGULAR)
