...
# ##################################################
class ConsCtrctLbl(Mo):
    """
    A consumer contract label. A contract label can be parented by the relation between an endpoint group (EPG) and security group. The EPG is associated with a group and lists all contracts it provides out of the group, as well as, optionally, contracts that it chooses to consume. If no consumption contracts are indicated, all contracts are consumed. If no provider contracts are identified, the EPG provides no contracts out of this group.

    """

    meta = ClassMeta("cobra.model.vz.ConsCtrctLbl")

    meta.moClassName = "vzConsCtrctLbl"
    meta.rnFormat = "cCtrctLbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Consumer Contract Label"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37483, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39622, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 7407, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
