...
class RtToRFltP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtToRFltP", "cobra.model.fcpr.RFltPManager")

    meta.moClassName = "vzRtToRFltP"
    meta.rnFormat = "rtfcprToRFltP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22446, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7592
    prop.defaultValueStr = "fcprRFltPManager"
    prop._addConstant("fcprRFltPManager", None, 7592)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22445, PropCategory.REGULAR)
