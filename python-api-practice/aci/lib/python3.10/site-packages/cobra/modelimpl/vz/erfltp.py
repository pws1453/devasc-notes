...
class ERFltP(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.ERFltP")

    meta.moClassName = "vzERFltP"
    meta.rnFormat = "efp-%(id)s"
    ...
    meta.childClasses.add("cobra.model.vz.RsERFltPOwner")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsERFltPOwner", "rsERFltPOwner-"))
    ...
    prop = PropMeta("str", "id", "id", 16804, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16809, PropCategory.REGULAR)
