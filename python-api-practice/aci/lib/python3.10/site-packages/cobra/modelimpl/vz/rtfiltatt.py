...
class RtFiltAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vz.RtFiltAtt", "cobra.model.vz.ASTerm")

    meta.moClassName = "vzRtFiltAtt"
    meta.rnFormat = "rtfiltAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11845, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1328
    prop.defaultValueStr = "vzASTerm"
    ...
    prop = PropMeta("str", "tDn", "tDn", 11844, PropCategory.REGULAR)
