...
# ##################################################
class RtPullRemotevVzRFltP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vz.RtPullRemotevVzRFltP", "cobra.model.resolution.RemotePolicyMgr")

    meta.moClassName = "vzRtPullRemotevVzRFltP"
    meta.rnFormat = "rtresolutionPullRemotevVzRFltP-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtresolutionPullRemotevVzRFltP-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51455, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51454, PropCategory.REGULAR)
