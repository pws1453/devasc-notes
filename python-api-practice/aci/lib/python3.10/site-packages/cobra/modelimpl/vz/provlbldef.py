...
class ProvLblDef(Mo):
    """
    A provider label definition.

    """

    meta = ClassMeta("cobra.model.vz.ProvLblDef")

    meta.moClassName = "vzProvLblDef"
    meta.rnFormat = "pLblD-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 7425, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
