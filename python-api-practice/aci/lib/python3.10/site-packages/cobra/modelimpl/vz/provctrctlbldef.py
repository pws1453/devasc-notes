...
# ##################################################
class ProvCtrctLblDef(Mo):
    """
    A provider contract label definition.

    """

    meta = ClassMeta("cobra.model.vz.ProvCtrctLblDef")

    meta.moClassName = "vzProvCtrctLblDef"
    meta.rnFormat = "pCtrctLblD-%(name)s"
    ...
    meta.superClasses.add("cobra.model.vz.ALblDef")
    ...
    prop = PropMeta("str", "name", "name", 7421, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
