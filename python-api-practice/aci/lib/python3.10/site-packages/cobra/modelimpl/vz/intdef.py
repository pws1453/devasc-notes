...
class IntDef(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.IntDef")

    meta.moClassName = "vzIntDef"
    meta.rnFormat = "int-[%(ifPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Contract/Bundle Interface Container Def"
    ...
    prop = PropMeta("str", "ifPKey", "ifPKey", 1073, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14102, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "useAnyDef", "useAnyDef", 16599, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.namingProps.append(getattr(meta.props, "ifPKey"))
    getattr(meta.props, "ifPKey").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, ifPKey, markDirty=True, **creationProps):
        namingVals = [ifPKey]
