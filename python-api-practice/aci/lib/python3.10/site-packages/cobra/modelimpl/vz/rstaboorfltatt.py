...
# ##################################################
class RsTabooRFltAtt(Mo):
    """
    A source relation to a taboo resolved filter profile.

    """

    meta = SourceRelationMeta("cobra.model.vz.RsTabooRFltAtt", "cobra.model.vz.AFilterableUnit")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsTabooRFltAtt"
    meta.rnFormat = "rstabooRFltAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Any Relation to RFltP"
    ...
    meta.superClasses.add("cobra.model.vz.ToRFltP")
    ...
    prop = PropMeta("str", "action", "action", 11911, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "direction", "direction", 11912, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "markDscp", "markDscp", 11913, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "prio", "prio", 11914, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11910, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1317
    prop.defaultValueStr = "vzAFilterableUnit"
    ...
    prop = PropMeta("str", "tDn", "tDn", 11909, PropCategory.REGULAR)
