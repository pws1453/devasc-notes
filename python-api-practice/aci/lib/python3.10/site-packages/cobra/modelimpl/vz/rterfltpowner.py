...
# ##################################################
class RtERFltPOwner(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vz.RtERFltPOwner", "cobra.model.vz.ERFltP")

    meta.moClassName = "vzRtERFltPOwner"
    meta.rnFormat = "rtERFltPOwner-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16808, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5695
    prop.defaultValueStr = "vzERFltP"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzERFltP", None, 5695)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16807, PropCategory.REGULAR)
