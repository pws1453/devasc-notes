...
class ToEPg(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.ToEPg")

    meta.moClassName = "vzToEPg"
    meta.rnFormat = "to-[%(epgDefDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "To EPG"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x505
    ...
    meta.childClasses.add("cobra.model.vz.LToEPg")
    meta.childClasses.add("cobra.model.vz.RtToEPgAtt")
    meta.childClasses.add("cobra.model.fv.StorageIssues")
    meta.childClasses.add("cobra.model.vz.RtToEpgConn")
    meta.childClasses.add("cobra.model.vz.RsToAnyDef")
    ...
    meta.childClasses.add("cobra.model.vz.RsRFltAtt")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.fv.CompIssues")

    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RtToEpgConn", "rtactrlToEpgConn-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RtToEPgAtt", "rtcompToEPgAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsToAnyDef", "rstoAnyDef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.SubnetDef", "extsubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsRFltAtt", "rsrFltAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.LToEPg", "lTo"))
    ...
    meta.superClasses.add("cobra.model.vz.AToEPg")
    ...
    prop = PropMeta("str", "ctxPcTag", "ctxPcTag", 16596, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "epgDefDn", "epgDefDn", 1069, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("epgDefDn", prop)
    ...
    prop = PropMeta("str", "intent", "intent", 55649, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "isCtxPcTagInUseForRules", "isCtxPcTagInUseForRules", 16634, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("isCtxPcTagInUseForRules", prop)

    prop = PropMeta("str", "isGraph", "isGraph", 16072, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15871, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prefGrMemb", "prefGrMemb", 27675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "txId", "txId", 33387, PropCategory.REGULAR)
    prop.label = "Transaction Id when EPg was created"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("txId", prop)

    meta.namingProps.append(getattr(meta.props, "epgDefDn"))
    getattr(meta.props, "epgDefDn").needDelimiter = True

    def __init__(self, parentMoOrDn, epgDefDn, markDirty=True, **creationProps):
        namingVals = [epgDefDn]
