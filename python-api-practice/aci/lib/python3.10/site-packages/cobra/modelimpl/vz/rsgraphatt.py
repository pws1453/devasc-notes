...
class RsGraphAtt(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.vz.RsGraphAtt", "cobra.model.vns.AbsGraph")
    meta.targetNameProps["name"] = "tnVnsAbsGraphName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsGraphAtt"
    meta.rnFormat = "rsGraphAtt"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37462, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39601, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14072, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVnsAbsGraphName", "tnVnsAbsGraphName", 15753, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
