...
class RtGraphDef(Mo):
    """
    A target relation to the graph container.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtGraphDef", "cobra.model.fv.AEPg")

    meta.moClassName = "vzRtGraphDef"
    meta.rnFormat = "rtfvGraphDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12335, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12334, PropCategory.REGULAR)
