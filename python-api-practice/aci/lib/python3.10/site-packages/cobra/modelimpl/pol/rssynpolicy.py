...
# ##################################################
class RsSynpolicy(Mo):
    """
    For internal testing

    """

    meta = SourceRelationMeta("cobra.model.pol.RsSynpolicy", "cobra.model.synthetic.Policy")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsSynpolicy"
    meta.rnFormat = "rssynpolicy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13474, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13473, PropCategory.REGULAR)
