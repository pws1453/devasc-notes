...
# ##################################################
class RsInfraOutRtdEpP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsInfraOutRtdEpP", "cobra.model.fv.RtdEpP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "polRsInfraOutRtdEpP"
    meta.rnFormat = "rsinfraOutRtdEpP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Infra l3Out Routed EpP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21449, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21448, PropCategory.REGULAR)
