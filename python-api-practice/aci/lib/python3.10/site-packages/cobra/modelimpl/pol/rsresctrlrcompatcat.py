...
# ##################################################
class RsResCtrlrCompatCat(Mo):
    """
    A source relation to the compatibility catalog. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsResCtrlrCompatCat", "cobra.model.compat.Cat")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsResCtrlrCompatCat"
    meta.rnFormat = "rsresCtrlrCompatCat"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Compatibility Catalogue"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13471, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 529
    prop.defaultValueStr = "compatCat"
    prop._addConstant("compatCat", None, 529)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13470, PropCategory.REGULAR)
