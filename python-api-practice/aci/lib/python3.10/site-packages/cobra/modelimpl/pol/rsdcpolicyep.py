...
# ##################################################
class RsDcpolicyep(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsDcpolicyep", "cobra.model.dc.Policy")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDcpolicyep"
    meta.rnFormat = "rsdcpolicyep"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54590, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16072
    prop.defaultValueStr = "dcPolicy"
    prop._addConstant("dcPolicy", None, 16072)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54589, PropCategory.REGULAR)
