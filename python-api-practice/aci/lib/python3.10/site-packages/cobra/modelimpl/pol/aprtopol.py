...
# ##################################################
class APrToPol(Mo):
    meta = ClassMeta("cobra.model.pol.APrToPol")

    meta.isAbstract = True
    meta.moClassName = "polAPrToPol"


    meta.moClassName = "polAPrToPol"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Abstract class for relations to resolved policies per shard"
    ...
    meta.concreteSubClasses.add("cobra.model.pol.RsPrToL3extProvLblDef")
    meta.concreteSubClasses.add("cobra.model.pol.RsPrToBDSubnetHolder")
