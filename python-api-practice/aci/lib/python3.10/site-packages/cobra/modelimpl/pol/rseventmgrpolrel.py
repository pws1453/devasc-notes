...
# ##################################################
class RsEventMgrPolRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsEventMgrPolRel", "cobra.model.fault.EventMgrCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsEventMgrPolRel"
    meta.rnFormat = "rseventMgrPolRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Container for Event Mgr Policies"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23333, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7905
    prop.defaultValueStr = "faultEventMgrCont"
    prop._addConstant("faultEventMgrCont", None, 7905)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23332, PropCategory.REGULAR)
