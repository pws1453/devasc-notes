...
# ##################################################
class RsMonToFvEppInband(Mo):
    """
    A source relation to the base monitoring policy model.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsMonToFvEppInband", "cobra.model.fv.InBEpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsMonToFvEppInband"
    meta.rnFormat = "rsmonToFvEppInband"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13455, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13454, PropCategory.REGULAR)
