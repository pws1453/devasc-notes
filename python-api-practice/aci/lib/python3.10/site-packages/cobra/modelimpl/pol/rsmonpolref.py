...
# ##################################################
class RsMonPolRef(Mo):
    """
    A source relation to the base monitoring policy model.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsMonPolRef", "cobra.model.mon.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsMonPolRef"
    meta.rnFormat = "rsmonPolRef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13451, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13450, PropCategory.REGULAR)
