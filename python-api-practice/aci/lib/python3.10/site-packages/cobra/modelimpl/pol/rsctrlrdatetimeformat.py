...
# ##################################################
class RsCtrlrDatetimeFormat(Mo):
    """
    A source relation to the format of the date/time values for the entire fabric. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsCtrlrDatetimeFormat", "cobra.model.datetime.Format")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsCtrlrDatetimeFormat"
    meta.rnFormat = "rsctrlrDatetimeFormat"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13398, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13397, PropCategory.REGULAR)
