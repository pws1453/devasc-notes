...
# ##################################################
class RsToInbMgmtBD(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToInbMgmtBD", "cobra.model.fv.BDHolder")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToInbMgmtBD"
    meta.rnFormat = "rstoInbMgmtBD"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56306, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 56305, PropCategory.REGULAR)
