...
# ##################################################
class RsVnschassis(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsVnschassis", "cobra.model.vns.Chassis")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsVnschassis"
    meta.rnFormat = "rsvnschassis"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23133, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23132, PropCategory.REGULAR)
