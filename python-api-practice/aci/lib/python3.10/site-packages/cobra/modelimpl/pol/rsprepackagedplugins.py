...
# ##################################################
class RsPrepackagedPlugins(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsPrepackagedPlugins", "cobra.model.ap.PrepackagedPlugins")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsPrepackagedPlugins"
    meta.rnFormat = "rsprepackagedPlugins"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to apPrepackagedPlugins"
    ...
    prop = PropMeta("str", "tCl", "tCl", 57003, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 57002, PropCategory.REGULAR)
