...
class RsCatalog(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsCatalog", "cobra.model.compat.Cat")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsCatalog"
    meta.rnFormat = "rscatalog"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13390, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13389, PropCategory.REGULAR)
