...
# ##################################################
class RsFabricSelfCAEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsFabricSelfCAEp", "cobra.model.pki.FabricSelfCAEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFabricSelfCAEp"
    meta.rnFormat = "rsFabricSelfCAEp"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42290, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 42287, PropCategory.REGULAR)
