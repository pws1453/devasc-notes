...
class RsSnmpGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsSnmpGrp", "cobra.model.snmp.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsSnmpGrp"
    meta.rnFormat = "rssnmpGrp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 60830, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 60829, PropCategory.REGULAR)
