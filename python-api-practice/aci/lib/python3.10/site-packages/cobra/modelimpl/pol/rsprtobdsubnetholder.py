...
# ##################################################
class RsPrToBDSubnetHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsPrToBDSubnetHolder", "cobra.model.fv.BDPublicSubnetHolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "polRsPrToBDSubnetHolder"
    meta.rnFormat = "rsprToBDSubnetHolder-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to BDHolder from policy resolver"
    ...
    meta.childClasses.add("cobra.model.pol.Consumer")

    meta.childNamesAndRnPrefix.append(("cobra.model.pol.Consumer", "polcons-"))

    meta.parentClasses.add("cobra.model.pol.Resolver")

    meta.superClasses.add("cobra.model.pol.APrToPol")
    meta.superClasses.add("cobra.model.reln.To")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rsprToBDSubnetHolder-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 20293, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6846
    prop.defaultValueStr = "fvBDPublicSubnetHolder"
    prop._addConstant("fvBDPublicSubnetHolder", None, 6846)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20292, PropCategory.REGULAR)
