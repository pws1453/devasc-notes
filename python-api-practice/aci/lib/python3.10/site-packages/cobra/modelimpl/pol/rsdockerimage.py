...
# ##################################################
class RsDockerImage(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsDockerImage", "cobra.model.ap.DockerImage")
    meta.targetNameProps["name"] = "tnApDockerImageName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDockerImage"
    meta.rnFormat = "rsDockerImage"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Docker Image"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28629, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28626, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9555
    prop.defaultValueStr = "apDockerImage"
    ...
    prop = PropMeta("str", "tnApDockerImageName", "tnApDockerImageName", 28625, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 128)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnApDockerImageName", prop)
