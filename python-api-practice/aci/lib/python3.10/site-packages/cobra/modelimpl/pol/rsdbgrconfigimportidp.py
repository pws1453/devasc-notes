...
# ##################################################
class RsDbgrConfigImportIdP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsDbgrConfigImportIdP", "cobra.model.config.ImportIdP")
    meta.targetNameProps["name"] = "tnConfigImportIdPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDbgrConfigImportIdP"
    meta.rnFormat = "rsDbgrConfigImportIdP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Config Import ID Policy Resolver"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21583, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7309
    prop.defaultValueStr = "configImportIdP"
    ...
    prop = PropMeta("str", "tnConfigImportIdPName", "tnConfigImportIdPName", 21582, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnConfigImportIdPName", prop)
