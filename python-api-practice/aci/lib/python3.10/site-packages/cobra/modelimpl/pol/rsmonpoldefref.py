...
# ##################################################
class RsMonPolDefRef(Mo):
    """
    A source relation to an observable shadow object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsMonPolDefRef", "cobra.model.stats.Subj")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsMonPolDefRef"
    meta.rnFormat = "rsmonPolDefRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Observable Shadow Object"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13447, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 337
    prop.defaultValueStr = "statsSubj"
    prop._addConstant("statsSubj", None, 337)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13446, PropCategory.REGULAR)
