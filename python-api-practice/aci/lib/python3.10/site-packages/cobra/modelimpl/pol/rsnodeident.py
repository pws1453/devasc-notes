...
# ##################################################
class RsNodeident(Mo):
    """
    A source relation to the node identity policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsNodeident", "cobra.model.fabric.NodeIdentPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsNodeident"
    meta.rnFormat = "rsnodeident"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13463, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 790
    prop.defaultValueStr = "fabricNodeIdentPol"
    prop._addConstant("fabricNodeIdentPol", None, 790)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13462, PropCategory.REGULAR)
