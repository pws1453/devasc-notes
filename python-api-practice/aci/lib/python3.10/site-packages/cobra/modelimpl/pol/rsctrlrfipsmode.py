...
# ##################################################
class RsCtrlrFipsMode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsCtrlrFipsMode", "cobra.model.aaa.FabricSec")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsCtrlrFipsMode"
    meta.rnFormat = "rsctrlrFipsMode"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Controller Fips Mode"
    ...
    meta.rnPrefixes = [
        ('rsctrlrFipsMode', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38575, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40714, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28055, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27977, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9013
    prop.defaultValueStr = "aaaFabricSec"
    prop._addConstant("aaaFabricSec", None, 9013)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27976, PropCategory.REGULAR)
