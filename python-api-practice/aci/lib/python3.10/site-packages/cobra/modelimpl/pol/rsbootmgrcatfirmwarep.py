...
# ##################################################
class RsBootmgrcatfirmwarep(Mo):
    """
    A source relation to the catalog firmware policy version.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsBootmgrcatfirmwarep", "cobra.model.firmware.CatFwP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsBootmgrcatfirmwarep"
    meta.rnFormat = "rsbootmgrcatfirmwarep"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15465, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15464, PropCategory.REGULAR)
