...
# ##################################################
class RsWebPolRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsWebPolRel", "cobra.model.comm.WebPolCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsWebPolRel"
    meta.rnFormat = "rswebPolRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20616, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20615, PropCategory.REGULAR)
