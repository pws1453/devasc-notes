...
class RsFirmware(Mo):
    """
    A source relation to the firmware specification. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsFirmware", "cobra.model.firmware.Firmware")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFirmware"
    meta.rnFormat = "rsfirmware"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13434, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13433, PropCategory.REGULAR)
