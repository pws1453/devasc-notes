...
# ##################################################
class RsInfraOutExp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsInfraOutExp", "cobra.model.l3ext.InfraOutExp")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsInfraOutExp"
    meta.rnFormat = "rsinfraOutExp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21446, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7245
    prop.defaultValueStr = "l3extInfraOutExp"
    prop._addConstant("l3extInfraOutExp", None, 7245)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21445, PropCategory.REGULAR)
