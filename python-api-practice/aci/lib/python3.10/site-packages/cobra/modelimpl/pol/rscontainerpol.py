...
# ##################################################
class RsContainerPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsContainerPol", "cobra.model.ap.ContainerPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsContainerPol"
    meta.rnFormat = "rsContainerPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to container config"
    ...
    prop = PropMeta("str", "tCl", "tCl", 37150, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11810
    prop.defaultValueStr = "apContainerPol"
    prop._addConstant("apContainerPol", None, 11810)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 37149, PropCategory.REGULAR)
