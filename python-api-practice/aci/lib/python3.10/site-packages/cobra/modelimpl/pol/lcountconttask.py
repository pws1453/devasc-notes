...
# ##################################################
class LCountContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pol.LCountContTask")

    meta.moClassName = "polLCountContTask"
    meta.rnFormat = "polLCountContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21253, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateCount", "updatecount", 1855)
