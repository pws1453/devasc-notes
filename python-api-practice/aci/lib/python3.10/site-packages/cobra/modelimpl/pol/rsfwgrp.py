...
class RsFwGrp(Mo):
    """
    A source relation to the firmware group.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsFwGrp", "cobra.model.firmware.FwGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFwGrp"
    meta.rnFormat = "rsfwGrp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15597, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15596, PropCategory.REGULAR)
