...
# ##################################################
class RsObsCtrlrSRel(Mo):
    """
    A source relation to the fabric controller group.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsObsCtrlrSRel", "cobra.model.fabric.CtrlrS")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsObsCtrlrSRel"
    meta.rnFormat = "rsObsCtrlrSRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15697, PropCategory.REGULAR)
