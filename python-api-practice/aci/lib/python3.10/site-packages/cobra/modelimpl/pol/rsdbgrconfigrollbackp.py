...
# ##################################################
class RsDbgrConfigRollbackP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsDbgrConfigRollbackP", "cobra.model.config.RollbackP")
    meta.targetNameProps["name"] = "tnConfigRollbackPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDbgrConfigRollbackP"
    meta.rnFormat = "rsDbgrConfigRollbackP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Config Rollback Policy Resolver"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20246, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20201, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6790
    prop.defaultValueStr = "configRollbackP"
    ...
    prop = PropMeta("str", "tnConfigRollbackPName", "tnConfigRollbackPName", 20200, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnConfigRollbackPName", prop)
