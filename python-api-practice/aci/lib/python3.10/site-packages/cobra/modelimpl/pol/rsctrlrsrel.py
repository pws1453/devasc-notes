...
# ##################################################
class RsCtrlrSRel(Mo):
    """
    A source relation to the fabric controller group.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsCtrlrSRel", "cobra.model.fabric.CtrlrS")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsCtrlrSRel"
    meta.rnFormat = "rsCtrlrSRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13344, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13343, PropCategory.REGULAR)
