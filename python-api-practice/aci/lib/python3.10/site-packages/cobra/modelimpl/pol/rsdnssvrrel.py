...
# ##################################################
class RsDnsSvrRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsDnsSvrRel", "cobra.model.dnsepg.SvrGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDnsSvrRel"
    meta.rnFormat = "rsdnsSvrRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DNS Server Info"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33295, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10672
    prop.defaultValueStr = "dnsepgSvrGrp"
    prop._addConstant("dnsepgSvrGrp", None, 10672)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33294, PropCategory.REGULAR)
