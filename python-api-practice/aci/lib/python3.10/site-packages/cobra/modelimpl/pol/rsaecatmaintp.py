...
# ##################################################
class RsAecatmaintp(Mo):
    """
    A source relation to the catalog maintenance specification. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAecatmaintp", "cobra.model.maint.CatMaintP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsAecatmaintp"
    meta.rnFormat = "rsaecatmaintp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13374, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13373, PropCategory.REGULAR)
