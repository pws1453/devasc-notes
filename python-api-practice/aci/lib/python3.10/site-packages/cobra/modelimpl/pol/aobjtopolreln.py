...
# ##################################################
class AObjToPolReln(Mo):
    meta = ClassMeta("cobra.model.pol.AObjToPolReln")

    meta.isAbstract = True
    meta.moClassName = "polAObjToPolReln"


    meta.moClassName = "polAObjToPolReln"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Abstract class for relations to locally resolved policies"
    ...
    meta.concreteSubClasses.add("cobra.model.l3ext.RsOutToBDPublicSubnetHolder")
    meta.concreteSubClasses.add("cobra.model.l3ext.RsProvLblDef")
