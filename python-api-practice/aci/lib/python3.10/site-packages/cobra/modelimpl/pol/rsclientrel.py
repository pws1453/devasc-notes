...
# ##################################################
class RsClientRel(Mo):
    """
    A source relation to a DHCP client. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsClientRel", "cobra.model.dhcp.Client")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsClientRel"
    meta.rnFormat = "rsclientRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13394, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1463
    prop.defaultValueStr = "dhcpClient"
    prop._addConstant("dhcpClient", None, 1463)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13393, PropCategory.REGULAR)
