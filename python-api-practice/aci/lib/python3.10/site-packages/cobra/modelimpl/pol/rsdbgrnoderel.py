...
# ##################################################
class RsDbgrNodeRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsDbgrNodeRel", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDbgrNodeRel"
    meta.rnFormat = "rsdbgrNodeRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53061, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53060, PropCategory.REGULAR)
