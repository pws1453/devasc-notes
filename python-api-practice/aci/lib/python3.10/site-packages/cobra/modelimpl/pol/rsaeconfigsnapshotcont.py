...
# ##################################################
class RsAeConfigSnapshotCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAeConfigSnapshotCont", "cobra.model.config.SnapshotCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsAeConfigSnapshotCont"
    meta.rnFormat = "rsAeConfigSnapshotCont"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Config Snapshot Container Policy Resolver"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23121, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6792
    prop.defaultValueStr = "configSnapshotCont"
    prop._addConstant("configSnapshotCont", None, 6792)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23120, PropCategory.REGULAR)
