...
# ##################################################
class RsSchedulerTokenPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsSchedulerTokenPol", "cobra.model.pki.SchedulerToken")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsSchedulerTokenPol"
    meta.rnFormat = "rsSchedulerTokenPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SchedulerToken"
    ...
    prop = PropMeta("str", "tCl", "tCl", 42225, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12261
    prop.defaultValueStr = "pkiSchedulerToken"
    prop._addConstant("pkiSchedulerToken", None, 12261)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 42224, PropCategory.REGULAR)
