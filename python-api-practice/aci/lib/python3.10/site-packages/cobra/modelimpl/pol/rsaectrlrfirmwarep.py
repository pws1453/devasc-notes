...
# ##################################################
class RsAectrlrfirmwarep(Mo):
    """
    A source relation to the controller firmware policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAectrlrfirmwarep", "cobra.model.firmware.CtrlrFwP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsAectrlrfirmwarep"
    meta.rnFormat = "rsaectrlrfirmwarep"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13378, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 365
    prop.defaultValueStr = "firmwareCtrlrFwP"
    prop._addConstant("firmwareCtrlrFwP", None, 365)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13377, PropCategory.REGULAR)
