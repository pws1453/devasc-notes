...
# ##################################################
class RsVnsmdfctcat(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsVnsmdfctcat", "cobra.model.vns.MDfctCat")
    meta.targetNameProps["name"] = "tnVnsMDfctCatName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsVnsmdfctcat"
    meta.rnFormat = "rsvnsmdfctcat"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L4-L7 Service Defect Category"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27413, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27410, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVnsMDfctCatName", "tnVnsMDfctCatName", 27409, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVnsMDfctCatName", prop)
