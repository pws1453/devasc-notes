...
class RsCatRel(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsCatRel", "cobra.model.compat.Cat")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsCatRel"
    meta.rnFormat = "rscatRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Catalog Firmware Version"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13386, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13385, PropCategory.REGULAR)
