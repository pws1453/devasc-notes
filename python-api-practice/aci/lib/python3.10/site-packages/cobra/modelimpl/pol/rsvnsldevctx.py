...
# ##################################################
class RsVnsldevctx(Mo):
    """
    A source relation to a device cluster context. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsVnsldevctx", "cobra.model.vns.LDevCtx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsVnsldevctx"
    meta.rnFormat = "rsvnsldevctx"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13482, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13481, PropCategory.REGULAR)
