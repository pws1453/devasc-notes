...
# ##################################################
class RsDnsAttrRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsDnsAttrRel", "cobra.model.fv.DnsAttr")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDnsAttrRel"
    meta.rnFormat = "rsdnsAttrRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DNS Attribute Info"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33291, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10667
    prop.defaultValueStr = "fvDnsAttr"
    prop._addConstant("fvDnsAttr", None, 10667)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33290, PropCategory.REGULAR)
