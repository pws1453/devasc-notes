...
class RsRepo(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsRepo", "cobra.model.firmware.RepoP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsRepo"
    meta.rnFormat = "rsrepo"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13467, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13466, PropCategory.REGULAR)
