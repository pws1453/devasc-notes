...
# ##################################################
class RsFabricipv4expg(Mo):
    """
    A source relation to the spine IPv4 explicit protection group. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsFabricipv4expg", "cobra.model.fabric.IPV4ExpG")
    meta.targetNameProps["name"] = "tnFabricIPV4ExpGName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFabricipv4expg"
    meta.rnFormat = "rsfabricipv4expg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Spine IPV4 Explicit Protection Group"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14835, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13423, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 992
    prop.defaultValueStr = "fabricIPV4ExpG"
    ...
    prop = PropMeta("str", "tnFabricIPV4ExpGName", "tnFabricIPV4ExpGName", 13422, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
    meta.props.add("tnFabricIPV4ExpGName", prop)
