...
# ##################################################
class RsDbgrTechSupDataContRel(Mo):
    """
    A source relation to the tech support data policy container. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsDbgrTechSupDataContRel", "cobra.model.dbgexp.TechSupDataCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDbgrTechSupDataContRel"
    meta.rnFormat = "rsdbgrTechSupDataContRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation between dbgr container and techsupport data container"
    ...
    meta.rnPrefixes = [
        ('rsdbgrTechSupDataContRel', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 13408, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13407, PropCategory.REGULAR)
