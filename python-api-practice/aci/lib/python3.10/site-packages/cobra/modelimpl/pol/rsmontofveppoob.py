...
# ##################################################
class RsMonToFvEppOob(Mo):
    """
    A source relation to an out-of-band management endpoint profile for a fabric node management endpoint group. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsMonToFvEppOob", "cobra.model.fv.OoBEpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsMonToFvEppOob"
    meta.rnFormat = "rsmonToFvEppOob"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13459, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1940
    prop.defaultValueStr = "fvOoBEpP"
    prop._addConstant("fvOoBEpP", None, 1940)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13458, PropCategory.REGULAR)
