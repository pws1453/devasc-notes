...
# ##################################################
class RsFabricExtConnPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsFabricExtConnPDef", "cobra.model.fv.FabricExtConnPDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsFabricExtConnPDef"
    meta.rnFormat = "rsfabricExtConnPDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23030, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23029, PropCategory.REGULAR)
