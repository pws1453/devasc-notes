...
# ##################################################
class RsAectrlrmaintp(Mo):
    """
    A source relation to the controller maintenance policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAectrlrmaintp", "cobra.model.maint.CtrlrMaintP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsAectrlrmaintp"
    meta.rnFormat = "rsaectrlrmaintp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13382, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 390
    prop.defaultValueStr = "maintCtrlrMaintP"
    prop._addConstant("maintCtrlrMaintP", None, 390)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13381, PropCategory.REGULAR)
