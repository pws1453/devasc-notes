...
# ##################################################
class RsTrackListReln(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsTrackListReln", "cobra.model.fv.RsOtmListMember")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsTrackListReln"
    meta.rnFormat = "rstrackListReln"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Track list to Track member relation"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52319, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13171
    prop.defaultValueStr = "fvRsOtmListMember"
    prop._addConstant("fvRsOtmListMember", None, 13171)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52318, PropCategory.REGULAR)
