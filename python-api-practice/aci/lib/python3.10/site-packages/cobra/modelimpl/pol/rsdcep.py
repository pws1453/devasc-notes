...
class RsDcep(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsDcep", "cobra.model.dc.Ep")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDcep"
    meta.rnFormat = "rsdcep"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54586, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16073
    prop.defaultValueStr = "dcEp"
    prop._addConstant("dcEp", None, 16073)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54585, PropCategory.REGULAR)
