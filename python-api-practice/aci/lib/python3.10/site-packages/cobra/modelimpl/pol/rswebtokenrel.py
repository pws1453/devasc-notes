...
# ##################################################
class RsWebtokenRel(Mo):
    """
    A source relation to the cryptographic data used for generating and verifying web tokens. Note that this relation is an internal object

    """

    meta = SourceRelationMeta("cobra.model.pol.RsWebtokenRel", "cobra.model.pki.WebTokenData")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsWebtokenRel"
    meta.rnFormat = "rswebtokenRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13496, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1480
    prop.defaultValueStr = "pkiWebTokenData"
    prop._addConstant("pkiWebTokenData", None, 1480)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13495, PropCategory.REGULAR)
