...
# ##################################################
class RsDbgrConfigExportP(Mo):
    """
    A source relation to the export policy used to setup the system configuration backup process. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsDbgrConfigExportP", "cobra.model.config.ExportP")
    meta.targetNameProps["name"] = "tnConfigExportPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDbgrConfigExportP"
    meta.rnFormat = "rsDbgrConfigExportP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Config Export Policy Resolver"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13808, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13348, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 258
    prop.defaultValueStr = "configExportP"
    ...
    prop = PropMeta("str", "tnConfigExportPName", "tnConfigExportPName", 13347, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnConfigExportPName", prop)
