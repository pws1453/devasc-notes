...
class RsDompRel(Mo):
    """
    A source relation to the VMM domain profile.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsDompRel", "cobra.model.vmm.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDompRel"
    meta.rnFormat = "rsdompRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13412, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13411, PropCategory.REGULAR)
