...
# ##################################################
class RsPluginPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsPluginPol", "cobra.model.ap.PluginPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsPluginPol"
    meta.rnFormat = "rsPluginPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to plugin config"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30176, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30173, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9914
    prop.defaultValueStr = "apPluginPol"
