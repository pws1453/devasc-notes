...
# ##################################################
class RsFabricSelfCAEpExplicit(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsFabricSelfCAEpExplicit", "cobra.model.pki.FabricSelfCAEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFabricSelfCAEpExplicit"
    meta.rnFormat = "rsFabricSelfCAEpExplicit"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to pkiFabricSelfCAEp"
    ...
    meta.rnPrefixes = [
        ('rsFabricSelfCAEpExplicit', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 55916, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11089
    prop.defaultValueStr = "pkiFabricSelfCAEp"
    prop._addConstant("pkiFabricSelfCAEp", None, 11089)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55915, PropCategory.REGULAR)
