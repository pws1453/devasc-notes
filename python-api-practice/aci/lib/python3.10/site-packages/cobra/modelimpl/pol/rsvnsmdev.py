...
class RsVnsmdev(Mo):
    """
    A source relation to definitions of the metadata for a service device type. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsVnsmdev", "cobra.model.vns.MDev")
    meta.targetNameProps["vendor"] = "tnVnsMDevVendor"
    meta.targetNameProps["model"] = "tnVnsMDevModel"
    meta.targetNameProps["version"] = "tnVnsMDevVersion"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsVnsmdev"
    meta.rnFormat = "rsvnsmdev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L4-L7 Service Meta Device Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14834, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13488, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4742
    prop.defaultValueStr = "vnsMDev"
    ...
    prop = PropMeta("str", "tnVnsMDevModel", "tnVnsMDevModel", 13486, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("tnVnsMDevModel", prop)

    prop = PropMeta("str", "tnVnsMDevVendor", "tnVnsMDevVendor", 13485, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("tnVnsMDevVendor", prop)

    prop = PropMeta("str", "tnVnsMDevVersion", "tnVnsMDevVersion", 13487, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("tnVnsMDevVersion", prop)
