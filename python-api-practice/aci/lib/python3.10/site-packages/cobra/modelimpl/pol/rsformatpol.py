...
class RsFormatPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsFormatPol", "cobra.model.datetime.Format")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFormatPol"
    meta.rnFormat = "rsFormatPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13356, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13355, PropCategory.REGULAR)
