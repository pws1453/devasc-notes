...
# ##################################################
class RsDbgrConfigSnapshotMgrP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsDbgrConfigSnapshotMgrP", "cobra.model.config.SnapshotMgrP")
    meta.targetNameProps["name"] = "tnConfigSnapshotMgrPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDbgrConfigSnapshotMgrP"
    meta.rnFormat = "rsDbgrConfigSnapshotMgrP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Config Snapshot Manager Policy Resolver"
    ...
    meta.rnPrefixes = [
        ('rsDbgrConfigSnapshotMgrP', False),
    ]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20435, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20432, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6890
    prop.defaultValueStr = "configSnapshotMgrP"
    ...
    prop = PropMeta("str", "tnConfigSnapshotMgrPName", "tnConfigSnapshotMgrPName", 20431, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnConfigSnapshotMgrPName", prop)
