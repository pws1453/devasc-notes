...
class RsVnsldev(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsVnsldev", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsVnsldev"
    meta.rnFormat = "rsvnsldev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Logical Device"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13478, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13477, PropCategory.REGULAR)
