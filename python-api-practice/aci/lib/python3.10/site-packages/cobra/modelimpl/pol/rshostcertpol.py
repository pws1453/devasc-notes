...
# ##################################################
class RsHostCertPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsHostCertPol", "cobra.model.pki.FabricSelfCAEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsHostCertPol"
    meta.rnFormat = "rsHostCertPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 42221, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 42220, PropCategory.REGULAR)
