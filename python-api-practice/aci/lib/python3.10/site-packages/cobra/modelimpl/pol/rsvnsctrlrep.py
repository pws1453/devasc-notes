...
# ##################################################
class RsVnsCtrlrEp(Mo):
    """
    A source relation to the controller appliance IP address and connectivity information.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsVnsCtrlrEp", "cobra.model.vns.CtrlrEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsVnsCtrlrEp"
    meta.rnFormat = "rsvnsCtrlrEp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Controller Endpoints"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15601, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4937
    prop.defaultValueStr = "vnsCtrlrEp"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsCtrlrEp", None, 4937)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15600, PropCategory.REGULAR)
