...
# ##################################################
class RsClusterPolRel(Mo):
    """
    An internal relation to admin cluster size policy. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsClusterPolRel", "cobra.model.infra.ClusterPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsClusterPolRel"
    meta.rnFormat = "rsClusterPolRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Admin Cluster Size Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14796, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13340, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4463
    prop.defaultValueStr = "infraClusterPol"
