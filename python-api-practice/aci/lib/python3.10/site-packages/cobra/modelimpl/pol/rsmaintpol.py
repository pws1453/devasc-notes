...
class RsMaintpol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsMaintpol", "cobra.model.maint.MaintP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsMaintpol"
    meta.rnFormat = "rsmaintpol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18575, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18574, PropCategory.REGULAR)
