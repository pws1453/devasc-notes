...
class RsInvPRef(Mo):
    """
    A source relation to the system inventory policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsInvPRef", "cobra.model.callhome.InvP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsInvPRef"
    meta.rnFormat = "rsInvPRef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13360, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13359, PropCategory.REGULAR)
