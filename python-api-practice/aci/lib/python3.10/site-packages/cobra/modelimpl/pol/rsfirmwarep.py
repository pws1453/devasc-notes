...
# ##################################################
class RsFirmwarep(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsFirmwarep", "cobra.model.firmware.FwP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFirmwarep"
    meta.rnFormat = "rsfirmwarep"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23576, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23575, PropCategory.REGULAR)
