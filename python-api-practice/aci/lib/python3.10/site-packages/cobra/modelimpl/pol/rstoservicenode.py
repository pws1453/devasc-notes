...
# ##################################################
class RsToServiceNode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToServiceNode", "cobra.model.aaa.ServiceNode")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToServiceNode"
    meta.rnFormat = "rstoServiceNode"
    ...
    prop = PropMeta("str", "tCl", "tCl", 60843, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16198
    prop.defaultValueStr = "aaaServiceNode"
    prop._addConstant("aaaServiceNode", None, 16198)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 60842, PropCategory.REGULAR)
