...
# ##################################################
class RsScriptHandlerLock(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsScriptHandlerLock", "cobra.model.fabric.ScriptHandlerDeployLock")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsScriptHandlerLock"
    meta.rnFormat = "rsscriptHandlerLock"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Resolve script handler lock"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21957, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21954, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7443
    prop.defaultValueStr = "fabricScriptHandlerDeployLock"
