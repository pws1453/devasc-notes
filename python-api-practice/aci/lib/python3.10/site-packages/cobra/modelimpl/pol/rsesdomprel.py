...
# ##################################################
class RsEsDompRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsEsDompRel", "cobra.model.extdev.GroupP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsEsDompRel"
    meta.rnFormat = "rsesDompRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43780, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12672
    prop.defaultValueStr = "extdevGroupP"
    prop._addConstant("extdevGroupP", None, 12672)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43779, PropCategory.REGULAR)
