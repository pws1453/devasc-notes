...
# ##################################################
class RsMgmtConnectivityPrefs(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsMgmtConnectivityPrefs", "cobra.model.mgmt.ConnectivityPrefs")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsMgmtConnectivityPrefs"
    meta.rnFormat = "rsmgmtConnectivityPrefs"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28053, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9423
    prop.defaultValueStr = "mgmtConnectivityPrefs"
    prop._addConstant("mgmtConnectivityPrefs", None, 9423)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28052, PropCategory.REGULAR)
