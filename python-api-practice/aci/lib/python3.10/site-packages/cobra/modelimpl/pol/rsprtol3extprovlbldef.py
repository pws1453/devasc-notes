...
# ##################################################
class RsPrToL3extProvLblDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsPrToL3extProvLblDef", "cobra.model.l3ext.ProvLblDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "polRsPrToL3extProvLblDef"
    meta.rnFormat = "rsprToL3extProvLblDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21456, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7250
    prop.defaultValueStr = "l3extProvLblDef"
    prop._addConstant("l3extProvLblDef", None, 7250)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21455, PropCategory.REGULAR)
