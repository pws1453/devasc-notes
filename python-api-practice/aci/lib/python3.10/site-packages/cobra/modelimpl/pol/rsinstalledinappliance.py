...
# ##################################################
class RsInstalledInAppliance(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsInstalledInAppliance", "cobra.model.ap.InstalledInAppliance")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsInstalledInAppliance"
    meta.rnFormat = "rsInstalledInAppliance"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to app InstalledInAppliance"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56186, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13021
    prop.defaultValueStr = "apInstalledInAppliance"
    prop._addConstant("apInstalledInAppliance", None, 13021)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56185, PropCategory.REGULAR)
