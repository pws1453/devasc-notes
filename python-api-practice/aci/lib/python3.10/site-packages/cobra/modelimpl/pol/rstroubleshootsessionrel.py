...
# ##################################################
class RsTroubleshootSessionRel(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsTroubleshootSessionRel", "cobra.model.troubleshoot.Session")
    meta.targetNameProps["name"] = "tnTroubleshootSessionName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsTroubleshootSessionRel"
    meta.rnFormat = "rstroubleshootSessionRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Troubleshoot Session Policy Resolver"
    ...
    meta.rnPrefixes = [
        ('rstroubleshootSessionRel', False),
    ]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18653, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18644, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6241
    prop.defaultValueStr = "troubleshootSession"
    ...
    prop = PropMeta("str", "tnTroubleshootSessionName", "tnTroubleshootSessionName", 20403, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTroubleshootSessionName", prop)
