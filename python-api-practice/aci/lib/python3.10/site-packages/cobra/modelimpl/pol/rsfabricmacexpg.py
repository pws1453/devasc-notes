...
# ##################################################
class RsFabricmacexpg(Mo):
    """
    A source relation to the spine MAC explicit protection group.

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsFabricmacexpg", "cobra.model.fabric.MacExpG")
    meta.targetNameProps["name"] = "tnFabricMacExpGName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFabricmacexpg"
    meta.rnFormat = "rsfabricmacexpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine Mac Explicit Protection Group"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14836, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13427, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 991
    prop.defaultValueStr = "fabricMacExpG"
    ...
    prop = PropMeta("str", "tnFabricMacExpGName", "tnFabricMacExpGName", 13426, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
    meta.props.add("tnFabricMacExpGName", prop)
