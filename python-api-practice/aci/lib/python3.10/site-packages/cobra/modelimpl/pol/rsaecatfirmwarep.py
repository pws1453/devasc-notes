...
# ##################################################
class RsAecatfirmwarep(Mo):
    """
    A source relation to the catalog firmware policy version. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAecatfirmwarep", "cobra.model.firmware.CatFwP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsAecatfirmwarep"
    meta.rnFormat = "rsaecatfirmwarep"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13370, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 364
    prop.defaultValueStr = "firmwareCatFwP"
    prop._addConstant("firmwareCatFwP", None, 364)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13369, PropCategory.REGULAR)
