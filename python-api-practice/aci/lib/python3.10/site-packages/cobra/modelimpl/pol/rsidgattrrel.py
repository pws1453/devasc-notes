...
# ##################################################
class RsIdgAttrRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsIdgAttrRel", "cobra.model.fv.IdGroupAttr")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsIdgAttrRel"
    meta.rnFormat = "rsidgAttrRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Identity group Attribute Info"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43784, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12632
    prop.defaultValueStr = "fvIdGroupAttr"
    prop._addConstant("fvIdGroupAttr", None, 12632)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43783, PropCategory.REGULAR)
