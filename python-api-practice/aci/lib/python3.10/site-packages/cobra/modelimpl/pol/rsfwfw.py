...
class RsFwFw(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsFwFw", "cobra.model.firmware.Firmware")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsFwFw"
    meta.rnFormat = "rsfwFw"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18275, PropCategory.REGULAR)
