...
# ##################################################
class RsPlgnFirmware(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.pol.RsPlgnFirmware", "cobra.model.firmware.Firmware")
    meta.targetNameProps["name"] = "tnFirmwareFirmwareName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsPlgnFirmware"
    meta.rnFormat = "rsplgnFirmware"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Firmware"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25883, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 351
    prop.defaultValueStr = "firmwareFirmware"
    ...
    prop = PropMeta("str", "tnFirmwareFirmwareName", "tnFirmwareFirmwareName", 25882, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("tnFirmwareFirmwareName", prop)
