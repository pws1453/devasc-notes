...
# ##################################################
class RsDbgrPolRel(Mo):
    """
    A source relation to resolve debugging policies from APIC.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsDbgrPolRel", "cobra.model.dbgexp.DbgrCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsDbgrPolRel"
    meta.rnFormat = "rsdbgrPolRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13403, PropCategory.REGULAR)
