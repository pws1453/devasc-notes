...
class RsPlugin(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsPlugin", "cobra.model.ap.Plugin")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsPlugin"
    meta.rnFormat = "rsPlugin"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to app plugin"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39354, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39353, PropCategory.REGULAR)
