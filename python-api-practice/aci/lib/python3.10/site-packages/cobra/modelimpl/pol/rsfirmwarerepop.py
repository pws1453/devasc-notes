...
# ##################################################
class RsFirmwareRepoP(Mo):
    """
    A source relation to the firmware repository population and maintenance information. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsFirmwareRepoP", "cobra.model.firmware.RepoP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsFirmwareRepoP"
    meta.rnFormat = "rsfirmwareRepoP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Firmware Repository"
    ...
    meta.rnPrefixes = [
        ('rsfirmwareRepoP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39597, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14047, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13438, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 344
    prop.defaultValueStr = "firmwareRepoP"
    prop._addConstant("firmwareRepoP", None, 344)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13437, PropCategory.REGULAR)
