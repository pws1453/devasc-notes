...
class RsSnmpCtrl(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsSnmpCtrl", "cobra.model.snmp.CtrlrInst")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsSnmpCtrl"
    meta.rnFormat = "rssnmpCtrl"
    ...
    prop = PropMeta("str", "tCl", "tCl", 60826, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18045
    prop.defaultValueStr = "snmpCtrlrInst"
    prop._addConstant("snmpCtrlrInst", None, 18045)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 60825, PropCategory.REGULAR)
