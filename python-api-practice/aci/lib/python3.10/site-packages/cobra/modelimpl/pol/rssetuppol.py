...
class RsSetupPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsSetupPol", "cobra.model.fabric.SetupPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsSetupPol"
    meta.rnFormat = "rssetupPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21452, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21451, PropCategory.REGULAR)
