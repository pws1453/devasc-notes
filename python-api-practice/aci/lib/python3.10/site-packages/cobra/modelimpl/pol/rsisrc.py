...
class RsIsrc(Mo):
    """
    A source relation to the internal source of firmware images.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsIsrc", "cobra.model.firmware.InternalSource")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsIsrc"
    meta.rnFormat = "rsisrc"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13444, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 349
    prop.defaultValueStr = "firmwareInternalSource"
    prop._addConstant("firmwareInternalSource", None, 349)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13443, PropCategory.REGULAR)
