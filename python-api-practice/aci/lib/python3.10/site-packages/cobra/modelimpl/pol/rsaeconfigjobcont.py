...
# ##################################################
class RsAeConfigJobCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAeConfigJobCont", "cobra.model.config.JobCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsAeConfigJobCont"
    meta.rnFormat = "rsAeConfigJobCont"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Config Job Container Policy Resolver"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23581, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 260
    prop.defaultValueStr = "configJobCont"
    prop._addConstant("configJobCont", None, 260)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23580, PropCategory.REGULAR)
