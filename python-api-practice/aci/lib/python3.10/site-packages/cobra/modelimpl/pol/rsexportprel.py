...
class RsExportPRel(Mo):
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14662, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13419, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDbgexpCorePName", "tnDbgexpCorePName", 13418, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
