...
# ##################################################
class RsAecatfirmwarepinternal(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAecatfirmwarepinternal", "cobra.model.firmware.CatFwPInternal")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsAecatfirmwarepinternal"
    meta.rnFormat = "rsaecatfirmwarepinternal"
    ...
    meta.rnPrefixes = [
        ('rsaecatfirmwarepinternal', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 28635, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9560
    prop.defaultValueStr = "firmwareCatFwPInternal"
    prop._addConstant("firmwareCatFwPInternal", None, 9560)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28634, PropCategory.REGULAR)
