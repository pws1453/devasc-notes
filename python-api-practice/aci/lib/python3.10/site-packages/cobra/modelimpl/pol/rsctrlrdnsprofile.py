...
# ##################################################
class RsCtrlrDnsProfile(Mo):
    """
    A source relation to the DNS profile. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsCtrlrDnsProfile", "cobra.model.dns.Profile")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsCtrlrDnsProfile"
    meta.rnFormat = "rsctrlrDnsProfile"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13400, PropCategory.REGULAR)
