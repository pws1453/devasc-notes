...
# ##################################################
class RsAeCtrlrL2InstPol(Mo):
    """
    A source relation to the layer 2 instance policy information. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.pol.RsAeCtrlrL2InstPol", "cobra.model.l2.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsAeCtrlrL2InstPol"
    meta.rnFormat = "rsaeCtrlrL2InstPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13367, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13366, PropCategory.REGULAR)
