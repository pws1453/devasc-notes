...
class RsSetPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pol.RsSetPol", "cobra.model.infra.SetPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsSetPol"
    meta.rnFormat = "rssetPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric-Wide Settings Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53872, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53871, PropCategory.REGULAR)
