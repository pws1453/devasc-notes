...
class RsDbgrConfigImportP(Mo):
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13809, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13352, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 269
    prop.defaultValueStr = "configImportP"
    ...
    prop = PropMeta("str", "tnConfigImportPName", "tnConfigImportPName", 13351, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnConfigImportPName", prop)
