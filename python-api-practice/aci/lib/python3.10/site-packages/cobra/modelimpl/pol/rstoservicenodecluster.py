...
# ##################################################
class RsToServiceNodeCluster(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToServiceNodeCluster", "cobra.model.aaa.ServiceNodeCluster")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToServiceNodeCluster"
    meta.rnFormat = "rstoServiceNodeCluster"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55973, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16197
    prop.defaultValueStr = "aaaServiceNodeCluster"
    prop._addConstant("aaaServiceNodeCluster", None, 16197)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55972, PropCategory.REGULAR)
