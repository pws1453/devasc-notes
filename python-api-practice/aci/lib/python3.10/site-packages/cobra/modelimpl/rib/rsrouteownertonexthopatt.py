...
class RsRouteOwnerToNexthopAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.rib.RsRouteOwnerToNexthopAtt", "cobra.model.rib.Nexthop")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "ribRsRouteOwnerToNexthopAtt"
    ...
    meta.parentClasses.add("cobra.model.uribv6.RouteOwner")
    ...
    prop = PropMeta("str", "tCl", "tCl", 17534, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5871
    prop.defaultValueStr = "ribNexthop"
    prop._addConstant("ribNexthop", None, 5871)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17533, PropCategory.REGULAR)
