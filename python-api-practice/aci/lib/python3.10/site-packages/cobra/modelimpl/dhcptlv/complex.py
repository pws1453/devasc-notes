...
class Complex(Mo):
    """
    The Complex type, length, and value (TLV), which contains basic TLVs.

    """

    meta = ClassMeta("cobra.model.dhcptlv.Complex")

    meta.moClassName = "dhcptlvComplex"
    meta.rnFormat = "complex-%(code)s-id-%(id)s"
    ...
    meta.superClasses.add("cobra.model.tlv.Complex")
    ...
    prop = PropMeta("str", "code", "code", 6152, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "id", "id", 6153, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, code, id, markDirty=True, **creationProps):
        namingVals = [code, id]
