...
class DTEp(Mo):
    ...
    meta = ClassMeta("cobra.model.svccopy.DTEp")

    meta.moClassName = "svccopyDTEp"
    meta.rnFormat = "dtep-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Configured Tunnel Endpoint"
    meta.writeAccessMask = 0x408400002001
    meta.readAccessMask = 0x408400002001
    ...
    meta.parentClasses.add("cobra.model.svccopy.SvcDb")
    ...
    prop = PropMeta("str", "id", "id", 27731, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "refCount", "refCount", 27728, PropCategory.REGULAR)
    prop.label = "Destination reference count"
    prop.isImplicit = True
    prop.isAdmin = True
