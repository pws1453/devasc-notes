...
# ##################################################
class RtToCopyDestGrp(Mo):
    """
     Relationship to the copy service object 

    """

    meta = TargetRelationMeta("cobra.model.svccopy.RtToCopyDestGrp", "cobra.model.actrl.ARule")

    meta.moClassName = "svccopyRtToCopyDestGrp"
    meta.rnFormat = "rtactrlToCopyDestGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22016, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22015, PropCategory.REGULAR)
