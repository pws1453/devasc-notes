...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.svccopy.Entity")

    meta.moClassName = "svccopyEntity"
    meta.rnFormat = "svccopy"
    ...
    meta.childClasses.add("cobra.model.svccopy.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.svccopy.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26391, PropCategory.REGULAR)
