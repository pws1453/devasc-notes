...
# ##################################################
class RsCopyDestAtt(Mo):
    """
     Attachment to Copy Destination 

    """

    meta = SourceRelationMeta("cobra.model.svccopy.RsCopyDestAtt", "cobra.model.svccopy.Dest")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "svccopyRsCopyDestAtt"
    meta.rnFormat = "rscopyDestAtt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.svccopy.DestGrp")
    ...
    prop = PropMeta("str", "tCl", "tCl", 22018, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7462
    prop.defaultValueStr = "svccopyDest"
    prop._addConstant("svccopyDest", None, 7462)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22017, PropCategory.REGULAR)
