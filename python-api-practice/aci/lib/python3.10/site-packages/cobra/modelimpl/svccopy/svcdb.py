...
class SvcDb(Mo):
    ...
    meta = ClassMeta("cobra.model.svccopy.SvcDb")

    meta.moClassName = "svccopySvcDb"
    meta.rnFormat = "svcdb-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Svccopy Database"
    ...
    meta.childClasses.add("cobra.model.svccopy.DTEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.svccopy.DTEp", "dtep-"))
    ...
    prop = PropMeta("str", "type", "type", 27729, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.defaultValue = 1
    prop.defaultValueStr = "dtep"
    prop._addConstant("dtep", "tunnel-endpoint-database", 1)
