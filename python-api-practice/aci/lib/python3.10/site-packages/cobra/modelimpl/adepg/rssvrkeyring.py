...
# ##################################################
class RsSvrKeyRing(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.adepg.RsSvrKeyRing", "cobra.model.pki.KeyRing")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "adepgRsSvrKeyRing"
    meta.rnFormat = "rssvrKeyRing"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43884, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43885, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43859, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43819, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43818, PropCategory.REGULAR)
