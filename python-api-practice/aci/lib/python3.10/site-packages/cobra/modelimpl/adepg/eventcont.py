...
class EventCont(Mo):
    ...
    meta = ClassMeta("cobra.model.adepg.EventCont")

    meta.moClassName = "adepgEventCont"
    meta.rnFormat = "evcont"
    meta.category = MoCategory.REGULAR
    meta.label = "AD event container"
    ...
    meta.childClasses.add("cobra.model.adepg.Event")

    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.Event", "ev-"))
