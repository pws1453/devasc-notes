...
class User(Mo):
    ...
    meta = ClassMeta("cobra.model.adepg.User")

    meta.moClassName = "adepgUser"
    meta.rnFormat = "usr-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.adepg.RtEvtUser")
    meta.childClasses.add("cobra.model.adepg.RsUsrGroup")

    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.RsUsrGroup", "rsusrGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.RtEvtUser", "rtevtUser-"))

    meta.parentClasses.add("cobra.model.adepg.UserCont")
    ...
    prop = PropMeta("str", "oid", "oid", 43760, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 43613, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
