...
# ##################################################
class AOrgUnit(Mo):
    meta = ClassMeta("cobra.model.adepg.AOrgUnit")

    meta.isAbstract = True
    meta.moClassName = "adepgAOrgUnit"


    meta.moClassName = "adepgAOrgUnit"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of an AD org unit"
    ...
    prop = PropMeta("str", "type", "type", 43610, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
