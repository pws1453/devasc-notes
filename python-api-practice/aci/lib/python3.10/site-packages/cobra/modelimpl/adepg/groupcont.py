...
class GroupCont(Mo):
    ...
    meta = ClassMeta("cobra.model.adepg.GroupCont")

    meta.moClassName = "adepgGroupCont"
    meta.rnFormat = "grpcont"
    meta.category = MoCategory.REGULAR
    meta.label = "AD OU container"
    ...
    meta.childClasses.add("cobra.model.adepg.Domain")

    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.Domain", "dom-"))
