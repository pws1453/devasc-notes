...
class RsFltIp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.adepg.RsFltIp", "cobra.model.adepg.Event")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "adepgRsFltIp"
    meta.rnFormat = "rsfltIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ip classified under filter"
    ...
    meta.parentClasses.add("cobra.model.adepg.ResFltAttr")
    ...
    prop = PropMeta("str", "grpKey", "grpKey", 43790, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("grpKey", prop)

    prop = PropMeta("str", "ip", "ip", 43791, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "relKey", "relKey", 43792, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("relKey", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43794, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12614
    prop.defaultValueStr = "adepgEvent"
    prop._addConstant("adepgEvent", None, 12614)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43793, PropCategory.REGULAR)
