...
class Uni(Mo):
    ...
    meta = ClassMeta("cobra.model.adepg.Uni")

    meta.moClassName = "adepgUni"
    meta.rnFormat = "adepg"
    ...
    meta.childClasses.add("cobra.model.adepg.Svr")

    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.Svr", "authsvr-"))
    ...
    meta.superClasses.add("cobra.model.adepg.ContE")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43858, PropCategory.REGULAR)
