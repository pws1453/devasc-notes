...
class ResCont(Mo):
    ...
    meta = ClassMeta("cobra.model.adepg.ResCont")

    meta.moClassName = "adepgResCont"
    meta.rnFormat = "rescont"
    meta.category = MoCategory.REGULAR
    meta.label = "Resolved subtree container"
    ...
    meta.childClasses.add("cobra.model.adepg.ResTenant")
    meta.childClasses.add("cobra.model.adepg.GroupUsrData")

    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.GroupUsrData", "data-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.ResTenant", "tn-"))

    meta.parentClasses.add("cobra.model.adepg.Svr")

    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.adepg.ACont")
