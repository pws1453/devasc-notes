...
# ##################################################
class RsSecAttrToGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.adepg.RsSecAttrToGroup", "cobra.model.adepg.Group")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "adepgRsSecAttrToGroup"
    meta.rnFormat = "rssecAttrToGroup-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Secondary attribute relation for group"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43802, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43801, PropCategory.REGULAR)
