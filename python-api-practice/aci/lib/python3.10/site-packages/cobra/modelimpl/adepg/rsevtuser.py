...
class RsEvtUser(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.adepg.RsEvtUser", "cobra.model.adepg.User")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "adepgRsEvtUser"
    meta.rnFormat = "rsevtUser"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "User associated with event"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43811, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12611
    prop.defaultValueStr = "adepgUser"
    prop._addConstant("adepgUser", None, 12611)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43810, PropCategory.REGULAR)
