...
class UserCont(Mo):
    ...
    meta = ClassMeta("cobra.model.adepg.UserCont")

    meta.moClassName = "adepgUserCont"
    meta.rnFormat = "usrcont"
    meta.category = MoCategory.REGULAR
    meta.label = "AD user container"
    ...
    meta.childClasses.add("cobra.model.adepg.User")

    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.User", "usr-"))
