...
class Group(Mo):
    ...
    meta = ClassMeta("cobra.model.adepg.Group")

    meta.moClassName = "adepgGroup"
    meta.rnFormat = "grp-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.adepg.RtPriAttrToGroup")
    meta.childClasses.add("cobra.model.adepg.RtUsrGroup")
    meta.childClasses.add("cobra.model.adepg.Group")
    meta.childClasses.add("cobra.model.adepg.RtFltIdGrp")
    meta.childClasses.add("cobra.model.adepg.RtSecAttrToGroup")

    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.RtPriAttrToGroup", "rtpriAttrToGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.RtSecAttrToGroup", "rtsecAttrToGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.RtFltIdGrp", "rtfvFltIdGrp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.RtUsrGroup", "rtusrGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.adepg.Group", "grp-"))

    meta.parentClasses.add("cobra.model.adepg.Domain")
    meta.parentClasses.add("cobra.model.adepg.Group")
    ...
    prop = PropMeta("str", "oid", "oid", 43757, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 43612, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "group"
