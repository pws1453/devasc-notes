...
# ##################################################
class RsPriAttrToGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.adepg.RsPriAttrToGroup", "cobra.model.adepg.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "adepgRsPriAttrToGroup"
    meta.rnFormat = "rspriAttrToGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Primary attribute relation for group"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43798, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43797, PropCategory.REGULAR)
