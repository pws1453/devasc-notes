...
# ##################################################
class RsSvrCertChain(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.adepg.RsSvrCertChain", "cobra.model.pki.TP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "adepgRsSvrCertChain"
    meta.rnFormat = "rssvrCertChain"
    ...
    meta.rnPrefixes = [
        ('rssvrCertChain', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43886, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43887, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43860, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43815, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1483
    prop.defaultValueStr = "pkiTP"
    prop._addConstant("pkiTP", None, 1483)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43814, PropCategory.REGULAR)
