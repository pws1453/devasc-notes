...
class RsUsrGroup(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.adepg.RsUsrGroup", "cobra.model.adepg.Group")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "adepgRsUsrGroup"
    meta.rnFormat = "rsusrGroup-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Group membership for AD user"
    ...
    meta.parentClasses.add("cobra.model.adepg.User")
    ...
    prop = PropMeta("str", "grpType", "grpType", 43805, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unknown"
    prop._addConstant("derived", "derived-group-type", 3)
    prop._addConstant("primary", "primary-group-type", 1)
    prop._addConstant("secondary", "secondary-group-type", 2)
    prop._addConstant("unknown", "unknown-group-type", 0)
    meta.props.add("grpType", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43807, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12610
    prop.defaultValueStr = "adepgGroup"
    prop._addConstant("adepgGroup", None, 12610)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43806, PropCategory.REGULAR)
