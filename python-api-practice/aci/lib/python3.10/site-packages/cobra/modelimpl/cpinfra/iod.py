...
class Iod(Mo):
    ...
    meta = ClassMeta("cobra.model.cpinfra.Iod")

    meta.moClassName = "cpinfraIod"
    meta.rnFormat = "iod-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "iod ifIndex Mapping"
    ...
    prop = PropMeta("str", "id", "id", 44481, PropCategory.REGULAR)
    prop.label = "ifIndex"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "iod", "iod", 44482, PropCategory.REGULAR)
    prop.label = "iod"
    prop.isOper = True
