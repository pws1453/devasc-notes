...
# ##################################################
class CoopHBProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cpinfra.CoopHBProfile")

    meta.moClassName = "cpinfraCoopHBProfile"
    meta.rnFormat = "coophbt"
    meta.category = MoCategory.REGULAR
    meta.label = "CoopHBProfile"
