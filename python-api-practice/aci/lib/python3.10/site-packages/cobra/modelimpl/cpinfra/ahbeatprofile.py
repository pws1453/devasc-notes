...
# ##################################################
class AHBeatProfile(Mo):
    meta = ClassMeta("cobra.model.cpinfra.AHBeatProfile")

    meta.isAbstract = True
    meta.moClassName = "cpinfraAHBeatProfile"


    meta.moClassName = "cpinfraAHBeatProfile"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract MO for Heartbeat"
    ...
    meta.concreteSubClasses.add("cobra.model.cpinfra.CoopHBProfile")
    meta.concreteSubClasses.add("cobra.model.cpinfra.BgpHBProfile")
    meta.concreteSubClasses.add("cobra.model.cpinfra.L3vmHBProfile")
    meta.concreteSubClasses.add("cobra.model.cpinfra.Uribv6HBProfile")
    meta.concreteSubClasses.add("cobra.model.cpinfra.NtpdHBProfile")
    meta.concreteSubClasses.add("cobra.model.cpinfra.Uribv4HBProfile")
    meta.concreteSubClasses.add("cobra.model.cpinfra.RpmHBProfile")
    meta.concreteSubClasses.add("cobra.model.cpinfra.SmmHBProfile")
