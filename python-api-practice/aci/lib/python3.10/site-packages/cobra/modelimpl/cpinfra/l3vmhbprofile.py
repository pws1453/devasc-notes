...
# ##################################################
class L3vmHBProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cpinfra.L3vmHBProfile")

    meta.moClassName = "cpinfraL3vmHBProfile"
    meta.rnFormat = "l3vmhbt"
    meta.category = MoCategory.REGULAR
    meta.label = "L3vmHBProfile"
