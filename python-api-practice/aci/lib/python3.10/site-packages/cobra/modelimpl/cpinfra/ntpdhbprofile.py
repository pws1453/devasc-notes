...
# ##################################################
class NtpdHBProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cpinfra.NtpdHBProfile")

    meta.moClassName = "cpinfraNtpdHBProfile"
    meta.rnFormat = "ntpdhbt"
    meta.category = MoCategory.REGULAR
    meta.label = "NtpdHBProfile"
