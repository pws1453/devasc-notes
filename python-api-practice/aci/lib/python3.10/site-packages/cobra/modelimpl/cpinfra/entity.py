...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.cpinfra.Entity")

    meta.moClassName = "cpinfraEntity"
    meta.rnFormat = "cpinfra"
    meta.category = MoCategory.REGULAR
    meta.label = "CP Infra Entity"
    ...
    meta.childClasses.add("cobra.model.cpinfra.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.cpinfra.Inst", "inst"))
