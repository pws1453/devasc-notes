...
class RsToObj(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.synthetic.RsToObj", "cobra.model.synthetic.ATestObj")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "syntheticRsToObj"
    meta.rnFormat = "rstoObj"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation To Object"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37858, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39997, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13100, PropCategory.REGULAR)
