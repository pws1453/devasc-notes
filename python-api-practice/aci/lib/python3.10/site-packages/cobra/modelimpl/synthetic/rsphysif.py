...
class RsPhysIf(Mo):
    """
    A source relation to the object that represents the Layer 1 physical Ethernet interface information.

    """

    meta = SourceRelationMeta("cobra.model.synthetic.RsPhysIf", "cobra.model.l1.PhysIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "syntheticRsPhysIf"
    meta.rnFormat = "rsPhysIf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37836, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39975, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13086, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15171, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
