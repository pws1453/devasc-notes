...
class RtToObj(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.synthetic.RtToObj", "cobra.model.synthetic.SwCTestObj")

    meta.moClassName = "syntheticRtToObj"
    meta.rnFormat = "rttoObj"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13102, PropCategory.REGULAR)
