...
# ##################################################
class RsUnenfPolicy(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.synthetic.RsUnenfPolicy", "cobra.model.synthetic.Policy")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "syntheticRsUnenfPolicy"
    meta.rnFormat = "rsunenfPolicy-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37840, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39979, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13090, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13089, PropCategory.REGULAR)
