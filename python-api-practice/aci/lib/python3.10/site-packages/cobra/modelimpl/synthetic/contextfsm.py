...
class ContextFsm(Mo):
    ...
    meta = ClassMeta("cobra.model.synthetic.ContextFsm")

    meta.moClassName = "syntheticContextFsm"
    meta.rnFormat = "syntheticContextFsm-%(id)s"
    ...
    meta.childClasses.add("cobra.model.synthetic.ContextContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.synthetic.ContextContext", "syntheticContext"))
    ...
    prop = PropMeta("str", "currStage", "currStage", 5706, PropCategory.REGULAR)
    prop.label = "Current Stage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("Test2Begin", "test2begin", 167)
    prop._addConstant("Test2Fail", "test2fail", 188)
    prop._addConstant("Test2Stage1", "test2stage1", 168)
    prop._addConstant("Test2Stage2", "test2stage2", 169)
    prop._addConstant("Test2Stage3", "test2stage3", 170)
    prop._addConstant("Test2Success", "test2success", 189)
    prop._addConstant("Test3Begin", "test3begin", 171)
    prop._addConstant("Test3Fail", "test3fail", 190)
    prop._addConstant("Test3Stage1", "test3stage1", 172)
    prop._addConstant("Test3Stage2", "test3stage2", 173)
    prop._addConstant("Test3Stage3", "test3stage3", 174)
    prop._addConstant("Test3Success", "test3success", 191)
    ...
    prop = PropMeta("str", "flags", "flags", 5708, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("ifc:policymgr:SyntheticContextTest3:a", "ifc:policymgr:syntheticcontexttest3:a", 16)
    prop._addConstant("ifc:policymgr:SyntheticContextTest3:b", "ifc:policymgr:syntheticcontexttest3:b", 32)
    meta.props.add("flags", prop)

    prop = PropMeta("str", "id", "id", 5705, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("Test2", "test2", 693)
    prop._addConstant("Test3", "test3", 694)
    prop._addConstant("none", "none", 0)
    ...
    prop = PropMeta("str", "prevStage", "prevStage", 5707, PropCategory.REGULAR)
