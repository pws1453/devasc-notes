...
class RsPolicy(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.synthetic.RsPolicy", "cobra.model.synthetic.Policy")
    meta.targetNameProps["name"] = "tnSyntheticPolicyName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "syntheticRsPolicy"
    meta.rnFormat = "rsPolicy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37842, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39981, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13094, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4253
    prop.defaultValueStr = "syntheticPolicy"
    ...
    prop = PropMeta("str", "tnSyntheticPolicyName", "tnSyntheticPolicyName", 13093, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnSyntheticPolicyName", prop)
