...
class RsToAObj(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.synthetic.RsToAObj", "cobra.model.synthetic.ATestObj")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "syntheticRsToAObj"
    meta.rnFormat = "rstoAObj"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation To A Object"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38246, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40385, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20611, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20609, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4266
    prop.defaultValueStr = "syntheticATestObj"
    ...
    prop = PropMeta("str", "tDn", "tDn", 20608, PropCategory.REGULAR)
