...
# ##################################################
class ContextTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.synthetic.ContextTask")

    meta.moClassName = "syntheticContextTask"
    meta.rnFormat = "syntheticContextTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5704, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("LocalTest", "localtest", 692)
    prop._addConstant("Test", "test", 691)
