...
# ##################################################
class ThrottleStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist1d", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist1d"
    meta.rnFormat = "HDospfThrottleStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47890, PropCategory.REGULAR)
