...
# ##################################################
class SelfStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist1w", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist1w"
    meta.rnFormat = "HDospfSelfStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47870, PropCategory.REGULAR)
