...
# ##################################################
class DropUnkStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStatsHist15min", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStatsHist15min"
    meta.rnFormat = "HDospfDropUnkStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Drop Unknown Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.ospf.DropUnkStatsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDospfDropUnkStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47761, PropCategory.REGULAR)
