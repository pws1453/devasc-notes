...
# ##################################################
class DropUnkStats1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats1h", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats1h"
    meta.rnFormat = "CDospfDropUnkStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats in 1 hour"
