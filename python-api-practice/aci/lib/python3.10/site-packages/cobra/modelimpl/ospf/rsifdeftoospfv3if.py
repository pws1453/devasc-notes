...
# ##################################################
class RsIfDefToOspfv3If(Mo):
    """
    A source relation to the OSPF v3 interfaces

    """

    meta = SourceRelationMeta("cobra.model.ospf.RsIfDefToOspfv3If", "cobra.model.ospfv3.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ospfRsIfDefToOspfv3If"
    meta.rnFormat = "rsIfDefToOspfv3If"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17576, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5828
    prop.defaultValueStr = "ospfv3If"
    prop._addConstant("ospfv3If", None, 5828)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17575, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 17605, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
