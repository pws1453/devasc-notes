...
# ##################################################
class DropUnkStats1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats1d", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats1d"
    meta.rnFormat = "CDospfDropUnkStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats in 1 day"
