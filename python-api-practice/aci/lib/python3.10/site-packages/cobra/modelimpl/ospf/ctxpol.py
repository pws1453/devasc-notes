...
class CtxPol(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.CtxPol")

    meta.moClassName = "ospfCtxPol"
    meta.rnFormat = "ospfCtxP-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Timers Policy"
    ...
    meta.childClasses.add("cobra.model.ospf.RtEppOspfCtxPol")
    meta.childClasses.add("cobra.model.ospf.RtCtxToOspfCtxPol")
    meta.childClasses.add("cobra.model.ospf.RtOspfCtxPol")
    meta.childClasses.add("cobra.model.ospf.RtEppOspfAfCtxPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtCtxToOspfCtxPol", "rtfvCtxToOspfCtxPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtEppOspfAfCtxPol", "rtfvEppOspfAfCtxPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtEppOspfCtxPol", "rtfvEppOspfCtxPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtOspfCtxPol", "rtfvOspfCtxPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37490, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39629, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 6984, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
