...
# ##################################################
class LsaStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsaStatsHist1h", "Ospf Lsa Packets")
    ...
    meta.moClassName = "ospfLsaStatsHist1h"
    meta.rnFormat = "HDospfLsaStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsa Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47827, PropCategory.REGULAR)
