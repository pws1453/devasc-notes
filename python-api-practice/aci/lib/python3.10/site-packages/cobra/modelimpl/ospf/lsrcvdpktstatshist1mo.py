...
# ##################################################
class LsRcvdPktStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist1mo", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist1mo"
    meta.rnFormat = "HDospfLsRcvdPktStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47812, PropCategory.REGULAR)
