...
# ##################################################
class InvalidStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist5min", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist5min"
    meta.rnFormat = "HDospfInvalidStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 47800, PropCategory.REGULAR)
