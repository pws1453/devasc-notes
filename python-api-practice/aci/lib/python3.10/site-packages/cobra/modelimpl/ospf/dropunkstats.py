...
# ##################################################
class DropUnkStats(Mo):
    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats"


    meta.moClassName = "ospfDropUnkStats"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats15min")
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats1qtr")
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats1year")
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats5min")
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats1w")
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats1h")
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats1mo")
    meta.concreteSubClasses.add("cobra.model.ospf.DropUnkStats1d")
