...
class AdjEp(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.AdjEp")

    meta.moClassName = "ospfAdjEp"
    ...
    meta.childClasses.add("cobra.model.ospf.GrSt")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.ospf.AdjStats")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.AdjStats", "adjstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.GrSt", "gr"))
    ...
    prop = PropMeta("str", "id", "id", 2739, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15784, PropCategory.REGULAR)
