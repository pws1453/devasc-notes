...
# ##################################################
class LsRcvdPktStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist1w", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist1w"
    meta.rnFormat = "HDospfLsRcvdPktStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47814, PropCategory.REGULAR)
