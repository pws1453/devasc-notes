...
# ##################################################
class SelfStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist1year", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist1year"
    meta.rnFormat = "HDospfSelfStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 47871, PropCategory.REGULAR)
