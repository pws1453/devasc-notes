...
class Entity(Mo):
    """
    The OSPF control plane entity information.

    """

    meta = ClassMeta("cobra.model.ospf.Entity")

    meta.moClassName = "ospfEntity"
    meta.rnFormat = "ospf"
    ...
    meta.childClasses.add("cobra.model.ospf.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.Inst", "inst-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14464, PropCategory.REGULAR)
