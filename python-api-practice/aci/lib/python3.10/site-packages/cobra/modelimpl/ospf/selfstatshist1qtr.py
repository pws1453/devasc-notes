...
# ##################################################
class SelfStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist1qtr", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist1qtr"
    meta.rnFormat = "HDospfSelfStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 47869, PropCategory.REGULAR)
