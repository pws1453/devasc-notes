...
# ##################################################
class DropUnkStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStatsHist1year", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStatsHist1year"
    meta.rnFormat = "HDospfDropUnkStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Drop Unknown Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 47767, PropCategory.REGULAR)
