...
# ##################################################
class ThrottleStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist1year", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist1year"
    meta.rnFormat = "HDospfThrottleStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 47895, PropCategory.REGULAR)
