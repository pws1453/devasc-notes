...
class ExtDef(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.ExtDef")

    meta.moClassName = "ospfExtDef"
    meta.rnFormat = "ospfExtP"
    meta.category = MoCategory.REGULAR
    meta.label = "External Profile Definition"
    ...
    meta.childClasses.add("cobra.model.ospf.RsExtDefToOspfArea")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RsExtDefToOspfArea", "rsExtDefToOspfArea"))
    ...
    meta.superClasses.add("cobra.model.ospf.AExtP")
    ...
    prop = PropMeta("str", "areaCost", "areaCost", 18632, PropCategory.REGULAR)
    prop.label = "Area Cost"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 16777215)]
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("areaCost", prop)

    prop = PropMeta("str", "areaCtrl", "areaCtrl", 17664, PropCategory.REGULAR)
    prop.label = "Area Type"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("areaCtrl", prop)

    prop = PropMeta("str", "areaId", "areaId", 1119, PropCategory.REGULAR)
    prop.label = "Area Id"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("areaId", prop)

    prop = PropMeta("str", "areaType", "areaType", 17663, PropCategory.REGULAR)
    prop.label = "Area Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "enabledAf", "enabledAf", 17569, PropCategory.REGULAR)
    prop.label = "Enabled OSPF Address Families"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("ipv4-ucast", "ipv4-unicast-address-family", 1)
    prop._addConstant("ipv6-ucast", "ipv6-unicast-address-family", 2)
    meta.props.add("enabledAf", prop)
    ...
    prop = PropMeta("str", "multipodInternal", "multipodInternal", 35428, PropCategory.REGULAR)
    prop.label = "Create Multipod Internal OSPF instance"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "False"
    prop._addConstant("no", "create-default-ospf-instance", True)
    prop._addConstant("yes", "create-multipod-internal-ospf-instance", True)
    meta.props.add("multipodInternal", prop)

    prop = PropMeta("str", "name", "name", 1118, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "ospf"
    prop.defaultValueStr = "ospf"
