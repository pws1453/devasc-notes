...
# ##################################################
class LsuStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStatsHist1qtr", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStatsHist1qtr"
    meta.rnFormat = "HDospfLsuStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsu Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 47837, PropCategory.REGULAR)
