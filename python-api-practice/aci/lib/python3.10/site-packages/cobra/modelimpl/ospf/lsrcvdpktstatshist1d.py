...
# ##################################################
class LsRcvdPktStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist1d", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist1d"
    meta.rnFormat = "HDospfLsRcvdPktStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47810, PropCategory.REGULAR)
