...
class IfP(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.IfP")

    meta.moClassName = "ospfIfP"
    meta.rnFormat = "ospfIfP"
    ...
    meta.childClasses.add("cobra.model.ospf.RsIfPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RsIfPol", "rsIfPol"))
    ...
    meta.superClasses.add("cobra.model.ospf.AIfP")

    meta.rnPrefixes = [
        ('ospfIfP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37492, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authKey", "authKey", 1108, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authKeyId", "authKeyId", 1109, PropCategory.REGULAR)
    ...
    meta.props.add("authKeyId", prop)

    prop = PropMeta("str", "authType", "authType", 1107, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39631, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14115, PropCategory.REGULAR)
