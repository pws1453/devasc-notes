...
# ##################################################
class ThrottleStats5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats5min", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats5min"
    meta.rnFormat = "CDospfThrottleStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats in 5 minute"
