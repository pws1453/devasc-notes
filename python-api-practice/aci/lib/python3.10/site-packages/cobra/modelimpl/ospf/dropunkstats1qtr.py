...
# ##################################################
class DropUnkStats1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats1qtr", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats1qtr"
    meta.rnFormat = "CDospfDropUnkStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats in 1 quarter"
