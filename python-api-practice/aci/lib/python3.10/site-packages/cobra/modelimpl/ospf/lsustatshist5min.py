...
# ##################################################
class LsuStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStatsHist5min", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStatsHist5min"
    meta.rnFormat = "HDospfLsuStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsu Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 47840, PropCategory.REGULAR)
