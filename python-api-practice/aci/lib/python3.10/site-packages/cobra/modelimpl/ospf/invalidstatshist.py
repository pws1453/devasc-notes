...
# ##################################################
class InvalidStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist"


    meta.moClassName = "ospfInvalidStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.ospf.InvalidStatsHist1w")
