...
# ##################################################
class LsaStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsaStatsHist15min", "Ospf Lsa Packets")
    ...
    meta.moClassName = "ospfLsaStatsHist15min"
    meta.rnFormat = "HDospfLsaStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsa Packets stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 47825, PropCategory.REGULAR)
