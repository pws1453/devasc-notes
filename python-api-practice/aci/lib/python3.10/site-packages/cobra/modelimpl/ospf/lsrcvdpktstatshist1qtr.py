...
# ##################################################
class LsRcvdPktStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist1qtr", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist1qtr"
    meta.rnFormat = "HDospfLsRcvdPktStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 47813, PropCategory.REGULAR)
