...
# ##################################################
class LsRcvdPktStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist1year", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist1year"
    meta.rnFormat = "HDospfLsRcvdPktStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDospfLsRcvdPktStats1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47815, PropCategory.REGULAR)
