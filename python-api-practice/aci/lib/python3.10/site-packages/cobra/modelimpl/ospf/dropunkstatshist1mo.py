...
# ##################################################
class DropUnkStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStatsHist1mo", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStatsHist1mo"
    meta.rnFormat = "HDospfDropUnkStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Drop Unknown Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47764, PropCategory.REGULAR)
