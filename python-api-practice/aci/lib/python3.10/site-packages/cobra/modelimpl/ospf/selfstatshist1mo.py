...
# ##################################################
class SelfStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist1mo", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist1mo"
    meta.rnFormat = "HDospfSelfStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47868, PropCategory.REGULAR)
