...
class RtSummPol(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.RtSummPol")

    meta.moClassName = "ospfRtSummPol"
    meta.rnFormat = "ospfrtsumm-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF route summarization policy"
    ...
    meta.childClasses.add("cobra.model.rtsum.RtSubnetToRtSumm")

    meta.childNamesAndRnPrefix.append(("cobra.model.rtsum.RtSubnetToRtSumm", "rtl3extSubnetToRtSumm-"))
    ...
    meta.superClasses.add("cobra.model.rtsum.ARtSummPol")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.ospf.ARtSummPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38410, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cost", "cost", 23358, PropCategory.REGULAR)
    prop.label = "Area range cost"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40549, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "interAreaEnabled", "interAreaEnabled", 23996, PropCategory.REGULAR)
    prop.label = "Inter Area Summarization enabled"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "False"
    prop._addConstant("no", "inter-area-summarization-not-enabled-(external)", True)
    prop._addConstant("yes", "inter-area-summarization-enabled", True)
    meta.props.add("interAreaEnabled", prop)
    ...
    prop = PropMeta("str", "name", "name", 23359, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tag", "tag", 23357, PropCategory.REGULAR)
    prop.label = "Summary Route Tag"
    prop.isConfig = True
    prop.isAdmin = True
