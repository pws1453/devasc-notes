...
# ##################################################
class LsuStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStatsHist1mo", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStatsHist1mo"
    meta.rnFormat = "HDospfLsuStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsu Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47836, PropCategory.REGULAR)
