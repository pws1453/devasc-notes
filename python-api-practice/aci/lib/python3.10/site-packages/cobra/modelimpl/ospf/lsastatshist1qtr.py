...
# ##################################################
class LsaStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsaStatsHist1qtr", "Ospf Lsa Packets")
    ...
    meta.moClassName = "ospfLsaStatsHist1qtr"
    meta.rnFormat = "HDospfLsaStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsa Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 47829, PropCategory.REGULAR)
