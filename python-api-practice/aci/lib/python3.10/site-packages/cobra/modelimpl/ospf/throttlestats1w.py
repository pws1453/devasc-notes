...
# ##################################################
class ThrottleStats1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats1w", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats1w"
    meta.rnFormat = "CDospfThrottleStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats in 1 week"
