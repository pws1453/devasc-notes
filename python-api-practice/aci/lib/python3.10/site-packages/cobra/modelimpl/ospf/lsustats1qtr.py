...
# ##################################################
class LsuStats1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStats1qtr", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStats1qtr"
    meta.rnFormat = "CDospfLsuStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Lsu Packets stats in 1 quarter"
