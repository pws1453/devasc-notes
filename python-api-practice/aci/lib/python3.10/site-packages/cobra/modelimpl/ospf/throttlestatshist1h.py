...
# ##################################################
class ThrottleStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist1h", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist1h"
    meta.rnFormat = "HDospfThrottleStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47891, PropCategory.REGULAR)
