...
# ##################################################
class DropUnkStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStatsHist1qtr", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStatsHist1qtr"
    meta.rnFormat = "HDospfDropUnkStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Drop Unknown Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 47765, PropCategory.REGULAR)
