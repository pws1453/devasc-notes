...
# ##################################################
class InvalidStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist1year", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist1year"
    meta.rnFormat = "HDospfInvalidStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 47799, PropCategory.REGULAR)
