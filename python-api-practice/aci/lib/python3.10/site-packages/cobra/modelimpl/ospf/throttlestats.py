...
# ##################################################
class ThrottleStats(Mo):
    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats"


    meta.moClassName = "ospfThrottleStats"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats15min")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats1mo")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats1year")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats1qtr")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats1w")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats1d")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats1h")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStats5min")
