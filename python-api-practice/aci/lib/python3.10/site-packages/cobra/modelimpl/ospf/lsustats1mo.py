...
# ##################################################
class LsuStats1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStats1mo", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStats1mo"
    meta.rnFormat = "CDospfLsuStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Lsu Packets stats in 1 month"
