...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.If")

    meta.moClassName = "ospfIf"
    ...
    meta.childClasses.add("cobra.model.ospf.Db")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.ospf.RtIfDefToOspfIf")
    meta.childClasses.add("cobra.model.ospf.AdjEp")
    meta.childClasses.add("cobra.model.ospf.IfStats")
    meta.childClasses.add("cobra.model.ospf.AuthP")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")
    meta.childClasses.add("cobra.model.ospf.TrafficStats")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtIfDefToOspfIf", "rtifDefToOspfIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.IfStats", "ifstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.TrafficStats", "trstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.AdjEp", "adj-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.AuthP", "auth"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.Db", "db-"))
    ...
    prop = PropMeta("str", "id", "id", 6986, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14463, PropCategory.REGULAR)
