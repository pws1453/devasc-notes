...
class IfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.IfPol")

    meta.moClassName = "ospfIfPol"
    meta.rnFormat = "ospfIfPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Interface Policy"
    ...
    meta.childClasses.add("cobra.model.ospf.RtEppOspfIfPol")
    ...
    meta.childClasses.add("cobra.model.ospf.RtIfPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtEppOspfIfPol", "rtfvEppOspfIfPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtIfPol", "rtifPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37491, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cost", "cost", 1105, PropCategory.REGULAR)
    prop.label = "Cost"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 1099, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deadIntvl", "deadIntvl", 1102, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39630, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "helloIntvl", "helloIntvl", 1101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14114, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6987, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nwT", "nwT", 1100, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pfxSuppress", "pfxSuppress", 23136, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prio", "prio", 1104, PropCategory.REGULAR)
    prop.label = "Prioriity"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "rexmitIntvl", "rexmitIntvl", 1103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "xmitDelay", "xmitDelay", 1106, PropCategory.REGULAR)
