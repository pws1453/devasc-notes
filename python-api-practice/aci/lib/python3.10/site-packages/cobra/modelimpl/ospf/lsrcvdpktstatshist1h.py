...
# ##################################################
class LsRcvdPktStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist1h", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist1h"
    meta.rnFormat = "HDospfLsRcvdPktStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47811, PropCategory.REGULAR)
