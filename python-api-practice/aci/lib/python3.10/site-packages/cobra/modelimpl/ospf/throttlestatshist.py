...
# ##################################################
class ThrottleStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist"


    meta.moClassName = "ospfThrottleStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.ospf.ThrottleStatsHist5min")
    ...
    prop = PropMeta("str", "floodPktSendIpThrottleAvg", "floodPktSendIpThrottleAvg", 49362, PropCategory.IMPLICIT_AVG)
    prop.label = "Flood Packet Send IP Throttle average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottleAvg", prop)

    prop = PropMeta("str", "floodPktSendIpThrottleCum", "floodPktSendIpThrottleCum", 49358, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Flood Packet Send IP Throttle cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottleCum", prop)

    prop = PropMeta("str", "floodPktSendIpThrottleMax", "floodPktSendIpThrottleMax", 49361, PropCategory.IMPLICIT_MAX)
    prop.label = "Flood Packet Send IP Throttle maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottleMax", prop)

    prop = PropMeta("str", "floodPktSendIpThrottleMin", "floodPktSendIpThrottleMin", 49360, PropCategory.IMPLICIT_MIN)
    prop.label = "Flood Packet Send IP Throttle minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottleMin", prop)

    prop = PropMeta("str", "floodPktSendIpThrottlePer", "floodPktSendIpThrottlePer", 49359, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Flood Packet Send IP Throttle periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottlePer", prop)

    prop = PropMeta("str", "floodPktSendIpThrottleRate", "floodPktSendIpThrottleRate", 49366, PropCategory.IMPLICIT_RATE)
    prop.label = "Flood Packet Send IP Throttle rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottleRate", prop)

    prop = PropMeta("str", "floodPktSendIpThrottleSpct", "floodPktSendIpThrottleSpct", 49363, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Flood Packet Send IP Throttle suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottleSpct", prop)

    prop = PropMeta("str", "floodPktSendIpThrottleThr", "floodPktSendIpThrottleThr", 49364, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodPktSendIpThrottleTr", "floodPktSendIpThrottleTr", 49365, PropCategory.IMPLICIT_TREND)
    prop.label = "Flood Packet Send IP Throttle trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendIpThrottleTr", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottleAvg", "floodPktSendTokenThrottleAvg", 49383, PropCategory.IMPLICIT_AVG)
    prop.label = "Flood Packet Send Token Throttle average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendTokenThrottleAvg", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottleCum", "floodPktSendTokenThrottleCum", 49379, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Flood Packet Send Token Throttle cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendTokenThrottleCum", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottleMax", "floodPktSendTokenThrottleMax", 49382, PropCategory.IMPLICIT_MAX)
    prop.label = "Flood Packet Send Token Throttle maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendTokenThrottleMax", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottleMin", "floodPktSendTokenThrottleMin", 49381, PropCategory.IMPLICIT_MIN)
    prop.label = "Flood Packet Send Token Throttle minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendTokenThrottleMin", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottlePer", "floodPktSendTokenThrottlePer", 49380, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Flood Packet Send Token Throttle periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendTokenThrottlePer", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottleRate", "floodPktSendTokenThrottleRate", 49387, PropCategory.IMPLICIT_RATE)
    prop.label = "Flood Packet Send Token Throttle rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendTokenThrottleRate", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottleSpct", "floodPktSendTokenThrottleSpct", 49384, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Flood Packet Send Token Throttle suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPktSendTokenThrottleSpct", prop)

    prop = PropMeta("str", "floodPktSendTokenThrottleThr", "floodPktSendTokenThrottleThr", 49385, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodPktSendTokenThrottleTr", "floodPktSendTokenThrottleTr", 49386, PropCategory.IMPLICIT_TREND)
