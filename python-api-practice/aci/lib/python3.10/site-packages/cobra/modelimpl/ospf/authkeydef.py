...
class AuthKeyDef(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.AuthKeyDef")

    meta.moClassName = "ospfAuthKeyDef"
    meta.rnFormat = "ospfAuthKeyDef"
    meta.category = MoCategory.REGULAR
    meta.label = "Clear Text Key Definition"
    ...
    prop = PropMeta("str", "authKeyText", "authKeyText", 31093, PropCategory.REGULAR)
    prop.label = "Authentication Key"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("authKeyText", prop)
