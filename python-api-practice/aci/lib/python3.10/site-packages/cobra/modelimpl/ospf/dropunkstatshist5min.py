...
# ##################################################
class DropUnkStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStatsHist5min", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStatsHist5min"
    meta.rnFormat = "HDospfDropUnkStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Drop Unknown Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 47768, PropCategory.REGULAR)
