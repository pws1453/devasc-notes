...
# ##################################################
class SelfStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist1h", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist1h"
    meta.rnFormat = "HDospfSelfStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47867, PropCategory.REGULAR)
