...
# ##################################################
class DropUnkStats1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats1w", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats1w"
    meta.rnFormat = "CDospfDropUnkStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats in 1 week"
