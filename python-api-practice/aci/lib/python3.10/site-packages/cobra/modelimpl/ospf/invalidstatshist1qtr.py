...
# ##################################################
class InvalidStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist1qtr", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist1qtr"
    meta.rnFormat = "HDospfInvalidStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 47797, PropCategory.REGULAR)
