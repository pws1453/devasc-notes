...
# ##################################################
class LsuStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStatsHist15min", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStatsHist15min"
    meta.rnFormat = "HDospfLsuStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsu Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.ospf.LsuStatsHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDospfLsuStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47833, PropCategory.REGULAR)
