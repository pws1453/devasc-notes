...
# ##################################################
class LsaStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsaStatsHist1d", "Ospf Lsa Packets")
    ...
    meta.moClassName = "ospfLsaStatsHist1d"
    meta.rnFormat = "HDospfLsaStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsa Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47826, PropCategory.REGULAR)
