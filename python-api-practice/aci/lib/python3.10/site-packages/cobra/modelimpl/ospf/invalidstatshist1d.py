...
# ##################################################
class InvalidStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist1d", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist1d"
    meta.rnFormat = "HDospfInvalidStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47794, PropCategory.REGULAR)
