...
# ##################################################
class LsuStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.ospf.LsuStatsHist", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStatsHist"


    meta.moClassName = "ospfLsuStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsu Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStatsHist1d")
    ...
    prop = PropMeta("str", "lsuFirstTxPktsAvg", "lsuFirstTxPktsAvg", 48900, PropCategory.IMPLICIT_AVG)
    prop.label = "LSU First Tx Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsAvg", prop)

    prop = PropMeta("str", "lsuFirstTxPktsCum", "lsuFirstTxPktsCum", 48896, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "LSU First Tx Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsCum", prop)

    prop = PropMeta("str", "lsuFirstTxPktsMax", "lsuFirstTxPktsMax", 48899, PropCategory.IMPLICIT_MAX)
    prop.label = "LSU First Tx Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsMax", prop)

    prop = PropMeta("str", "lsuFirstTxPktsMin", "lsuFirstTxPktsMin", 48898, PropCategory.IMPLICIT_MIN)
    prop.label = "LSU First Tx Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsMin", prop)

    prop = PropMeta("str", "lsuFirstTxPktsPer", "lsuFirstTxPktsPer", 48897, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "LSU First Tx Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsPer", prop)

    prop = PropMeta("str", "lsuFirstTxPktsRate", "lsuFirstTxPktsRate", 48904, PropCategory.IMPLICIT_RATE)
    prop.label = "LSU First Tx Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsRate", prop)

    prop = PropMeta("str", "lsuFirstTxPktsSpct", "lsuFirstTxPktsSpct", 48901, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LSU First Tx Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsSpct", prop)

    prop = PropMeta("str", "lsuFirstTxPktsThr", "lsuFirstTxPktsThr", 48902, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "lsuFirstTxPktsTr", "lsuFirstTxPktsTr", 48903, PropCategory.IMPLICIT_TREND)
    prop.label = "LSU First Tx Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuFirstTxPktsTr", prop)

    prop = PropMeta("str", "lsuForLsreqPktsAvg", "lsuForLsreqPktsAvg", 48921, PropCategory.IMPLICIT_AVG)
    prop.label = "LSU Packets For LSREQ Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsAvg", prop)

    prop = PropMeta("str", "lsuForLsreqPktsCum", "lsuForLsreqPktsCum", 48917, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "LSU Packets For LSREQ Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsCum", prop)

    prop = PropMeta("str", "lsuForLsreqPktsMax", "lsuForLsreqPktsMax", 48920, PropCategory.IMPLICIT_MAX)
    prop.label = "LSU Packets For LSREQ Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsMax", prop)

    prop = PropMeta("str", "lsuForLsreqPktsMin", "lsuForLsreqPktsMin", 48919, PropCategory.IMPLICIT_MIN)
    prop.label = "LSU Packets For LSREQ Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsMin", prop)

    prop = PropMeta("str", "lsuForLsreqPktsPer", "lsuForLsreqPktsPer", 48918, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "LSU Packets For LSREQ Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsPer", prop)

    prop = PropMeta("str", "lsuForLsreqPktsRate", "lsuForLsreqPktsRate", 48925, PropCategory.IMPLICIT_RATE)
    prop.label = "LSU Packets For LSREQ Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsRate", prop)

    prop = PropMeta("str", "lsuForLsreqPktsSpct", "lsuForLsreqPktsSpct", 48922, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LSU Packets For LSREQ Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsSpct", prop)

    prop = PropMeta("str", "lsuForLsreqPktsThr", "lsuForLsreqPktsThr", 48923, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "lsuForLsreqPktsTr", "lsuForLsreqPktsTr", 48924, PropCategory.IMPLICIT_TREND)
    prop.label = "LSU Packets For LSREQ Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuForLsreqPktsTr", prop)

    prop = PropMeta("str", "lsuPeerTxPktsAvg", "lsuPeerTxPktsAvg", 48942, PropCategory.IMPLICIT_AVG)
    prop.label = "LSU Packets To Peer average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsAvg", prop)

    prop = PropMeta("str", "lsuPeerTxPktsCum", "lsuPeerTxPktsCum", 48938, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "LSU Packets To Peer cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsCum", prop)

    prop = PropMeta("str", "lsuPeerTxPktsMax", "lsuPeerTxPktsMax", 48941, PropCategory.IMPLICIT_MAX)
    prop.label = "LSU Packets To Peer maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsMax", prop)

    prop = PropMeta("str", "lsuPeerTxPktsMin", "lsuPeerTxPktsMin", 48940, PropCategory.IMPLICIT_MIN)
    prop.label = "LSU Packets To Peer minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsMin", prop)

    prop = PropMeta("str", "lsuPeerTxPktsPer", "lsuPeerTxPktsPer", 48939, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "LSU Packets To Peer periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsPer", prop)

    prop = PropMeta("str", "lsuPeerTxPktsRate", "lsuPeerTxPktsRate", 48946, PropCategory.IMPLICIT_RATE)
    prop.label = "LSU Packets To Peer rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsRate", prop)

    prop = PropMeta("str", "lsuPeerTxPktsSpct", "lsuPeerTxPktsSpct", 48943, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LSU Packets To Peer suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsSpct", prop)

    prop = PropMeta("str", "lsuPeerTxPktsThr", "lsuPeerTxPktsThr", 48944, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "lsuPeerTxPktsTr", "lsuPeerTxPktsTr", 48945, PropCategory.IMPLICIT_TREND)
    prop.label = "LSU Packets To Peer trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuPeerTxPktsTr", prop)

    prop = PropMeta("str", "lsuRexmitPktsAvg", "lsuRexmitPktsAvg", 48963, PropCategory.IMPLICIT_AVG)
    prop.label = "LSU Retransmission Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuRexmitPktsAvg", prop)

    prop = PropMeta("str", "lsuRexmitPktsCum", "lsuRexmitPktsCum", 48959, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "LSU Retransmission Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuRexmitPktsCum", prop)

    prop = PropMeta("str", "lsuRexmitPktsMax", "lsuRexmitPktsMax", 48962, PropCategory.IMPLICIT_MAX)
    prop.label = "LSU Retransmission Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuRexmitPktsMax", prop)

    prop = PropMeta("str", "lsuRexmitPktsMin", "lsuRexmitPktsMin", 48961, PropCategory.IMPLICIT_MIN)
    prop.label = "LSU Retransmission Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuRexmitPktsMin", prop)

    prop = PropMeta("str", "lsuRexmitPktsPer", "lsuRexmitPktsPer", 48960, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "LSU Retransmission Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuRexmitPktsPer", prop)

    prop = PropMeta("str", "lsuRexmitPktsRate", "lsuRexmitPktsRate", 48967, PropCategory.IMPLICIT_RATE)
    prop.label = "LSU Retransmission Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuRexmitPktsRate", prop)

    prop = PropMeta("str", "lsuRexmitPktsSpct", "lsuRexmitPktsSpct", 48964, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "LSU Retransmission Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("lsuRexmitPktsSpct", prop)

    prop = PropMeta("str", "lsuRexmitPktsThr", "lsuRexmitPktsThr", 48965, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "lsuRexmitPktsTr", "lsuRexmitPktsTr", 48966, PropCategory.IMPLICIT_TREND)
