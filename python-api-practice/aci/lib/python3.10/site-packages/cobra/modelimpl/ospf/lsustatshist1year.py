...
# ##################################################
class LsuStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStatsHist1year", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStatsHist1year"
    meta.rnFormat = "HDospfLsuStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsu Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 47839, PropCategory.REGULAR)
