...
# ##################################################
class LsRcvdPktStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist5min", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist5min"
    meta.rnFormat = "HDospfLsRcvdPktStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 47816, PropCategory.REGULAR)
