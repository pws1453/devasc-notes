...
# ##################################################
class RsIfDefToOspfIf(Mo):
    """
    A source relation to the OSPF information that is operated at an interface level.

    """

    meta = SourceRelationMeta("cobra.model.ospf.RsIfDefToOspfIf", "cobra.model.ospf.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ospfRsIfDefToOspfIf"
    meta.rnFormat = "rsIfDefToOspfIf"
    ...
    meta.parentClasses.add("cobra.model.ospf.IfDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsIfDefToOspfIf', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11951, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2655
    prop.defaultValueStr = "ospfIf"
    prop._addConstant("ospfIf", None, 2655)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11950, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15025, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
