...
# ##################################################
class RtEppOspfIfPol(Mo):
    """
    A target relation to the OSPF interface-level policy.

    """

    meta = TargetRelationMeta("cobra.model.ospf.RtEppOspfIfPol", "cobra.model.fv.RtdEpP")

    meta.moClassName = "ospfRtEppOspfIfPol"
    meta.rnFormat = "rtfvEppOspfIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12262, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12261, PropCategory.REGULAR)
