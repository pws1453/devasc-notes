...
class RsIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.ospf.RsIfPol", "cobra.model.ospf.IfPol")
    meta.targetNameProps["name"] = "tnOspfIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ospfRsIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37493, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39632, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14116, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11947, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1418
    prop.defaultValueStr = "ospfIfPol"
    ...
    prop = PropMeta("str", "tnOspfIfPolName", "tnOspfIfPolName", 11946, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnOspfIfPolName", prop)
