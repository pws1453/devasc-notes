...
# ##################################################
class InvalidStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist1w", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist1w"
    meta.rnFormat = "HDospfInvalidStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47798, PropCategory.REGULAR)
