...
# ##################################################
class ThrottleStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist1mo", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist1mo"
    meta.rnFormat = "HDospfThrottleStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47892, PropCategory.REGULAR)
