...
# ##################################################
class InvalidStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist1mo", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist1mo"
    meta.rnFormat = "HDospfInvalidStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47796, PropCategory.REGULAR)
