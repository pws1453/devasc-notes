...
# ##################################################
class RtSummPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ospf.RtSummPolDef")

    meta.moClassName = "ospfRtSummPolDef"
    meta.rnFormat = "ospfrtsumm-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF route summarization internal policy"
    ...
    prop = PropMeta("str", "name", "name", 23360, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
