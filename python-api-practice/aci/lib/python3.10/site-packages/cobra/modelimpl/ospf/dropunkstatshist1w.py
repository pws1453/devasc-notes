...
# ##################################################
class DropUnkStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStatsHist1w", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStatsHist1w"
    meta.rnFormat = "HDospfDropUnkStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Drop Unknown Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47766, PropCategory.REGULAR)
