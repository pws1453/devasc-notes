...
# ##################################################
class LsaStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsaStatsHist1mo", "Ospf Lsa Packets")
    ...
    meta.moClassName = "ospfLsaStatsHist1mo"
    meta.rnFormat = "HDospfLsaStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsa Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47828, PropCategory.REGULAR)
