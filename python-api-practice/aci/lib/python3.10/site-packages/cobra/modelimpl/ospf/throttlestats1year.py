...
# ##################################################
class ThrottleStats1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats1year", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats1year"
    meta.rnFormat = "CDospfThrottleStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDospfThrottleStats1year', False),
    ]
