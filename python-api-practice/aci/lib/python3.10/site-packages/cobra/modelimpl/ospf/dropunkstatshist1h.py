...
# ##################################################
class DropUnkStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStatsHist1h", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStatsHist1h"
    meta.rnFormat = "HDospfDropUnkStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Drop Unknown Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47763, PropCategory.REGULAR)
