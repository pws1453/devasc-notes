...
# ##################################################
class LsRcvdPktStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsRcvdPktStatsHist15min", "Ospf LS Rcvd Packets")
    ...
    meta.moClassName = "ospfLsRcvdPktStatsHist15min"
    meta.rnFormat = "HDospfLsRcvdPktStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf LS Rcvd Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.ospf.LsRcvdPktStatsHist")

    meta.rnPrefixes = [
        ('HDospfLsRcvdPktStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47809, PropCategory.REGULAR)
