...
# ##################################################
class DropUnkStats5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats5min", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats5min"
    meta.rnFormat = "CDospfDropUnkStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats in 5 minute"
