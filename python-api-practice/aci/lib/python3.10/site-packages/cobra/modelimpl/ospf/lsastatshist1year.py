...
# ##################################################
class LsaStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsaStatsHist1year", "Ospf Lsa Packets")
    ...
    meta.moClassName = "ospfLsaStatsHist1year"
    meta.rnFormat = "HDospfLsaStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsa Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 47831, PropCategory.REGULAR)
