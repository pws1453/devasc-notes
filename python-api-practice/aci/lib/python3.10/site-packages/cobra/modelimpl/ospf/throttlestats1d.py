...
# ##################################################
class ThrottleStats1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats1d", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats1d"
    meta.rnFormat = "CDospfThrottleStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats in 1 day"
