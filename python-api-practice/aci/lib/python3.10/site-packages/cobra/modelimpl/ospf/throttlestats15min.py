...
# ##################################################
class ThrottleStats15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats15min", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats15min"
    meta.rnFormat = "CDospfThrottleStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDospfThrottleStats15min', False),
    ]
