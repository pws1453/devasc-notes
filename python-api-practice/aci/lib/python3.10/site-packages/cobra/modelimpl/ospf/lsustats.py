...
# ##################################################
class LsuStats(Mo):
    meta = StatsClassMeta("cobra.model.ospf.LsuStats", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStats"


    meta.moClassName = "ospfLsuStats"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Lsu Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats1mo")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats1w")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats5min")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats1qtr")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats1d")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats1year")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats15min")
    meta.concreteSubClasses.add("cobra.model.ospf.LsuStats1h")
