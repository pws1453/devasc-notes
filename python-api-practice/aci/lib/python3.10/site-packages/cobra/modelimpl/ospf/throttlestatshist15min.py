...
# ##################################################
class ThrottleStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist15min", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist15min"
    meta.rnFormat = "HDospfThrottleStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.ospf.ThrottleStatsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDospfThrottleStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47889, PropCategory.REGULAR)
