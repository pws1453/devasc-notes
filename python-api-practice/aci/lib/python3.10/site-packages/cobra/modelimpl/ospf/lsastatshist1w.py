...
# ##################################################
class LsaStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsaStatsHist1w", "Ospf Lsa Packets")
    ...
    meta.moClassName = "ospfLsaStatsHist1w"
    meta.rnFormat = "HDospfLsaStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Lsa Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47830, PropCategory.REGULAR)
