...
# ##################################################
class ThrottleStats1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats1qtr", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats1qtr"
    meta.rnFormat = "CDospfThrottleStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats in 1 quarter"
