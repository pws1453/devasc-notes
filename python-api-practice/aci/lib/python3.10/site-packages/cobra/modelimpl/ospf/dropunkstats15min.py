...
# ##################################################
class DropUnkStats15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats15min", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats15min"
    meta.rnFormat = "CDospfDropUnkStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats in 15 minute"
