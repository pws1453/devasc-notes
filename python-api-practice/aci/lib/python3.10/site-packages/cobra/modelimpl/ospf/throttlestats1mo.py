...
# ##################################################
class ThrottleStats1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStats1mo", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStats1mo"
    meta.rnFormat = "CDospfThrottleStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Throttle Packets stats in 1 month"
