...
# ##################################################
class ThrottleStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist1w", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist1w"
    meta.rnFormat = "HDospfThrottleStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47894, PropCategory.REGULAR)
