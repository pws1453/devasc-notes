...
# ##################################################
class InvalidStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.InvalidStatsHist15min", "Ospf Invalid Packets")
    ...
    meta.moClassName = "ospfInvalidStatsHist15min"
    meta.rnFormat = "HDospfInvalidStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Invalid Packets stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 47793, PropCategory.REGULAR)
