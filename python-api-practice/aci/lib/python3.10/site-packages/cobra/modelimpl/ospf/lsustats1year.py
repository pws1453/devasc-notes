...
# ##################################################
class LsuStats1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStats1year", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStats1year"
    meta.rnFormat = "CDospfLsuStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Lsu Packets stats in 1 year"
