...
# ##################################################
class LsuStats5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.LsuStats5min", "Ospf Lsu Packets")
    ...
    meta.moClassName = "ospfLsuStats5min"
    meta.rnFormat = "CDospfLsuStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Lsu Packets stats in 5 minute"
