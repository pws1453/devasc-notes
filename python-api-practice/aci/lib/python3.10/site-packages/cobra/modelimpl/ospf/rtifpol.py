...
class RtIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.ospf.RtIfPol", "cobra.model.ospf.IfP")

    meta.moClassName = "ospfRtIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11949, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1420
    prop.defaultValueStr = "ospfIfP"
    prop._addConstant("ospfIfP", None, 1420)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11948, PropCategory.REGULAR)
