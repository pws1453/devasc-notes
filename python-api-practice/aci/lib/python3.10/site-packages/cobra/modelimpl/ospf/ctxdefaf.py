...
class CtxDefAf(Mo):
    """
    The context-level OSPF definition per address family.

    """

    meta = ClassMeta("cobra.model.ospf.CtxDefAf")

    meta.moClassName = "ospfCtxDefAf"
    meta.rnFormat = "ospfCtxP-%(af)s"
    ...
    prop = PropMeta("str", "af", "af", 17568, PropCategory.REGULAR)
