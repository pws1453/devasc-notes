...
# ##################################################
class SelfStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist1d", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist1d"
    meta.rnFormat = "HDospfSelfStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47866, PropCategory.REGULAR)
