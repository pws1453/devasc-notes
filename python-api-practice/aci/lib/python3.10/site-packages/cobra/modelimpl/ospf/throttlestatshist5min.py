...
# ##################################################
class ThrottleStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist5min", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist5min"
    meta.rnFormat = "HDospfThrottleStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 47896, PropCategory.REGULAR)
