...
# ##################################################
class SelfStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist"


    meta.moClassName = "ospfSelfStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.ospf.SelfStatsHist15min")
