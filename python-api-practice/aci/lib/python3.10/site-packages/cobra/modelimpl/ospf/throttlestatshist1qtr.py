...
# ##################################################
class ThrottleStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.ThrottleStatsHist1qtr", "Ospf Throttle Packets")
    ...
    meta.moClassName = "ospfThrottleStatsHist1qtr"
    meta.rnFormat = "HDospfThrottleStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Throttle Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 47893, PropCategory.REGULAR)
