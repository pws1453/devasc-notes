...
# ##################################################
class DropUnkStats1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.DropUnkStats1year", "Ospf Drop Unknown Packets")
    ...
    meta.moClassName = "ospfDropUnkStats1year"
    meta.rnFormat = "CDospfDropUnkStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ospf Drop Unknown Packets stats in 1 year"
