...
# ##################################################
class SelfStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.ospf.SelfStatsHist15min", "Ospf Self Counter")
    ...
    meta.moClassName = "ospfSelfStatsHist15min"
    meta.rnFormat = "HDospfSelfStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ospf Self Counter stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 47865, PropCategory.REGULAR)
