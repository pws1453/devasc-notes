...
# ##################################################
class VlanInstDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fvns.VlanInstDef")

    meta.moClassName = "fvnsVlanInstDef"
    meta.rnFormat = "vlannsdef-[%(name)s]-%(allocMode)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VLAN Pool Defn."
    ...
    prop = PropMeta("str", "allocMode", "allocMode", 20384, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20386, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 20381, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
