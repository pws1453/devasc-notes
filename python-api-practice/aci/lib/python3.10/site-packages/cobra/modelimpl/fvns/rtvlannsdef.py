...
# ##################################################
class RtVlanNsDef(Mo):
    """
    A target relation to the namespace policy is used for managing the Encap (VXLAN, NVGRE, VLAN) ranges.

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtVlanNsDef", "cobra.model.infra.ADomP")

    meta.moClassName = "fvnsRtVlanNsDef"
    meta.rnFormat = "rtinfraVlanNsDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstraction of Access Domain"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16051, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4514
    prop.defaultValueStr = "infraADomP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 16050, PropCategory.REGULAR)
