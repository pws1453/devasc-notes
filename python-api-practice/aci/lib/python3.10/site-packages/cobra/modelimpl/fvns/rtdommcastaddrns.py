...
# ##################################################
class RtDomMcastAddrNs(Mo):
    """
    A target relation to the multicast address namespace policy.

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtDomMcastAddrNs", "cobra.model.vmm.DomP")

    meta.moClassName = "fvnsRtDomMcastAddrNs"
    meta.rnFormat = "rtvmmDomMcastAddrNs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15282, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15281, PropCategory.REGULAR)
