...
# ##################################################
class RtVxlanNsDef(Mo):
    """
    A target relation to the namespace policy is used for managing the Encap (VXLAN, NVGRE, VLAN) ranges.

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtVxlanNsDef", "cobra.model.vmm.CtrlrP")

    meta.moClassName = "fvnsRtVxlanNsDef"
    meta.rnFormat = "rtvmmVxlanNsDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16047, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16046, PropCategory.REGULAR)
