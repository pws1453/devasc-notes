...
# ##################################################
class UcastAddrBlk(Mo):
    """
    Defines the first and last unicast IP addresses in the namespace block.

    """

    meta = ClassMeta("cobra.model.fvns.UcastAddrBlk")

    meta.moClassName = "fvnsUcastAddrBlk"
    meta.rnFormat = "fromaddr-[%(from)s]-toaddr-[%(to)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Address Block"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37936, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40075, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "from", "from", 6579, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "to", "to", 6580, PropCategory.REGULAR)
