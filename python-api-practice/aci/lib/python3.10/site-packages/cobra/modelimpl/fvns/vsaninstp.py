...
class VsanInstP(Mo):
    ...
    meta = ClassMeta("cobra.model.fvns.VsanInstP")

    meta.moClassName = "fvnsVsanInstP"
    meta.rnFormat = "vsanns-[%(name)s]-%(allocMode)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VSAN Pool"
    meta.writeAccessMask = 0x300000000001
    meta.readAccessMask = 0x300001800611
    ...
    meta.childClasses.add("cobra.model.fvns.VsanEncapBlk")
    ...
    meta.childClasses.add("cobra.model.fvns.RtVsanNsDef")
    ...
    meta.childClasses.add("cobra.model.fvns.RtVsanNs")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtVsanNsDef", "rtfcVsanNsDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtVsanNs", "rtfcVsanNs-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.VsanEncapBlk", "vsanfrom-"))
    ...
    meta.superClasses.add("cobra.model.fvns.AVsanInstP")
    ...
    prop = PropMeta("str", "allocMode", "allocMode", 25324, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38483, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40622, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25412, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 25311, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
