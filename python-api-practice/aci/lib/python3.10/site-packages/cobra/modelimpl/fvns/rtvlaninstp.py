...
# ##################################################
class RtVlanInstP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtVlanInstP", "cobra.model.vns.SvcRelnHolder")

    meta.moClassName = "fvnsRtVlanInstP"
    meta.rnFormat = "rtvnsVlanInstP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21545, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21544, PropCategory.REGULAR)
