...
# ##################################################
class RtALDevToVlanInstP(Mo):
    """
    A target relation to the VLAN range namespace policy.

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtALDevToVlanInstP", "cobra.model.vns.ALDev")

    meta.moClassName = "fvnsRtALDevToVlanInstP"
    meta.rnFormat = "rtvnsALDevToVlanInstP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13689, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13688, PropCategory.REGULAR)
