...
class AddrInst(Mo):
    ...
    meta.readAccessMask = 0x4000900000002001
    ...
    meta.childClasses.add("cobra.model.fvns.RtIpPoolRefv2")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fvns.RtAddrInst")
    meta.childClasses.add("cobra.model.fvns.RtCDevTemplateToAddrInst")
    meta.childClasses.add("cobra.model.fvns.RtIpPoolRef")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtCDevTemplateToAddrInst", "rtvnsCDevTemplateToAddrInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtIpPoolRefv2", "rtorchsIpPoolRefv2-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtVipAddrNs", "rtinfraVipAddrNs-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtIpPoolRef", "rtorchsIpPoolRef-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37935, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40074, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
