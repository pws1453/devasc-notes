...
# ##################################################
class RtVsanNsDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtVsanNsDef", "cobra.model.fc.DomP")

    meta.moClassName = "fvnsRtVsanNsDef"
    meta.rnFormat = "rtfcVsanNsDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25384, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25383, PropCategory.REGULAR)
