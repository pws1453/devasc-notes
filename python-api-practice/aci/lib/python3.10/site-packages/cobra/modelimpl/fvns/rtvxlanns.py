...
class RtVxlanNs(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fvns.RtVxlanNs", "cobra.model.vmm.CtrlrP")

    meta.moClassName = "fvnsRtVxlanNs"
    meta.rnFormat = "rtvxlanNs"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12515, PropCategory.REGULAR)
