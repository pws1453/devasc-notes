...
class McastAddrInstP(Mo):
    ...
    meta = ClassMeta("cobra.model.fvns.McastAddrInstP")

    meta.moClassName = "fvnsMcastAddrInstP"
    meta.rnFormat = "maddrns-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Multicast Address Pool"
    meta.writeAccessMask = 0x300000000001
    meta.readAccessMask = 0x300000002011
    ...
    meta.childClasses.add("cobra.model.fvns.McastAddrBlk")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.fvns.RtDomMcastAddrNs")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.fvns.RtMcastAddrNs")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtDomMcastAddrNs", "rtvmmDomMcastAddrNs-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtMcastAddrNs", "rtvmmMcastAddrNs-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.McastAddrBlk", "fromaddr-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37941, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 15229, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40080, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14789, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6576, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
