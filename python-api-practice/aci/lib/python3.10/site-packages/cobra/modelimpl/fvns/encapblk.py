...
class EncapBlk(Mo):
    ...
    meta = ClassMeta("cobra.model.fvns.EncapBlk")

    meta.moClassName = "fvnsEncapBlk"
    meta.rnFormat = "from-[%(from)s]-to-[%(to)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Ranges"
    meta.writeAccessMask = 0x200000000001
    meta.readAccessMask = 0x200000000011
    ...
    meta.superClasses.add("cobra.model.fvns.AEncapBlk")
    ...
    prop = PropMeta("str", "allocMode", "allocMode", 20379, PropCategory.REGULAR)
    prop.label = "Override for the allocMode of the pool"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 3
    prop.defaultValueStr = "inherit"
    prop._addConstant("dynamic", "dynamic-allocation", 0)
    prop._addConstant("inherit", "inherit-allocmode-from-parent", 3)
    prop._addConstant("static", "static-allocation", 1)
    meta.props.add("allocMode", prop)

    prop = PropMeta("str", "annotation", "annotation", 37937, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40076, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "from", "from", 6567, PropCategory.REGULAR)
    prop.label = "Encap from Value"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26696, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "role", "role", 34675, PropCategory.REGULAR)
    prop.label = "Role"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "external"
    prop._addConstant("external", "external-or-on-the-wire-encapsulations", 0)
    ...
    prop = PropMeta("str", "to", "to", 6568, PropCategory.REGULAR)
    prop.label = "Encap to Value"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
