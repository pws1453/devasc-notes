...
class VxlanInstP(Mo):
    ...
    meta = ClassMeta("cobra.model.fvns.VxlanInstP")

    meta.moClassName = "fvnsVxlanInstP"
    meta.rnFormat = "vxlanns-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VXLAN Pool"
    ...
    meta.childClasses.add("cobra.model.fvns.RtVxlanNs")
    meta.childClasses.add("cobra.model.fvns.RtDomDefNs")
    meta.childClasses.add("cobra.model.fvns.RtVxlanNsDef")
    meta.childClasses.add("cobra.model.fvns.RtALDevToVxlanInstP")
    meta.childClasses.add("cobra.model.fvns.RtDomDefNsLocal")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtALDevToVxlanInstP", "rtvnsALDevToVxlanInstP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtDomVxlanNsDef", "rtinfraDomVxlanNsDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtDomDefNsLocal", "rtfvDomDefNsLocal-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtDomDefNs", "rtfvDomDefNs-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2cap.Prov", "l2capprov-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fvns.RtVxlanNs", "rtvxlanNs"))
    ...
    meta.superClasses.add("cobra.model.fvns.AVxlanInstP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37940, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40079, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14786, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6585, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
