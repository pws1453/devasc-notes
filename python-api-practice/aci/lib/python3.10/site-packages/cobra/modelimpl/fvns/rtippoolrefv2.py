...
# ##################################################
class RtIpPoolRefv2(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtIpPoolRefv2", "cobra.model.orchs.SvcRsrcPool")

    meta.moClassName = "fvnsRtIpPoolRefv2"
    meta.rnFormat = "rtorchsIpPoolRefv2-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34626, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34625, PropCategory.REGULAR)
