...
# ##################################################
class RtIpPoolRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtIpPoolRef", "cobra.model.orchs.SvcRsrcPool")

    meta.moClassName = "fvnsRtIpPoolRef"
    meta.rnFormat = "rtorchsIpPoolRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28668, PropCategory.REGULAR)
