...
# ##################################################
class RtVipAddrNs(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtVipAddrNs", "cobra.model.infra.ADomP")

    meta.moClassName = "fvnsRtVipAddrNs"
    meta.rnFormat = "rtinfraVipAddrNs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16379, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16378, PropCategory.REGULAR)
