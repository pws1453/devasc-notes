...
# ##################################################
class EncapBlkDef(Mo):
    """
    The encapsulation block definition.

    """

    meta = ClassMeta("cobra.model.fvns.EncapBlkDef")

    meta.moClassName = "fvnsEncapBlkDef"
    meta.rnFormat = "deffrom-[%(from)s]-to-[%(to)s]"
    ...
    prop = PropMeta("str", "from", "from", 6569, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "to", "to", 6570, PropCategory.REGULAR)
