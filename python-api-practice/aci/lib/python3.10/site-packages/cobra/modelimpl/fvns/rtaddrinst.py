...
class RtAddrInst(Mo):
    """
    A target relation to the IP address namespace/IP address range.

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtAddrInst", "cobra.model.mgmt.AZone")

    meta.moClassName = "fvnsRtAddrInst"
    meta.rnFormat = "rtmgmtAddrInst-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Managed Nodes Zone"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12523, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2170
    prop.defaultValueStr = "mgmtAZone"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12522, PropCategory.REGULAR)
