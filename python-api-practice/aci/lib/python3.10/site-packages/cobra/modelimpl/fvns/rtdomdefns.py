...
class RtDomDefNs(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fvns.RtDomDefNs", "cobra.model.fv.DomDef")

    meta.moClassName = "fvnsRtDomDefNs"
    meta.rnFormat = "rtfvDomDefNs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12155, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12154, PropCategory.REGULAR)
