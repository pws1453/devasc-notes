...
# ##################################################
class VxlanInstDefTask(Mo):
    """
    The VxLAN instance definition task.

    """

    meta = ClassMeta("cobra.model.fvns.VxlanInstDefTask")

    meta.moClassName = "fvnsVxlanInstDefTask"
    meta.rnFormat = "fvnsVxlanInstDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5763, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelFvnsInst", "addordelfvnsinst", 145)
