...
# ##################################################
class RtDomDefNsLocal(Mo):
    """
    A target relation to the VxLAN namespace policy definition.

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtDomDefNsLocal", "cobra.model.fv.DomDef")

    meta.moClassName = "fvnsRtDomDefNsLocal"
    meta.rnFormat = "rtfvDomDefNsLocal-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12159, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12158, PropCategory.REGULAR)
