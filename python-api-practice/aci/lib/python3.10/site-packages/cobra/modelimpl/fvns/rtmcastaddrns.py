...
# ##################################################
class RtMcastAddrNs(Mo):
    """
    A target relation to the policy definition of the multicast IP address ranges.

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtMcastAddrNs", "cobra.model.vmm.CtrlrP")

    meta.moClassName = "fvnsRtMcastAddrNs"
    meta.rnFormat = "rtvmmMcastAddrNs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12502, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12501, PropCategory.REGULAR)
