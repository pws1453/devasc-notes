...
# ##################################################
class VxlanInstDef(Mo):
    """
    The VxLAN instance definition.

    """

    meta = ClassMeta("cobra.model.fvns.VxlanInstDef")

    meta.moClassName = "fvnsVxlanInstDef"
    meta.rnFormat = "nsdef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VXLAN Pool Defn."
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14787, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6584, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
