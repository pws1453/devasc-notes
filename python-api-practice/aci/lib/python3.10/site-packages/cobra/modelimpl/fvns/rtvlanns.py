...
class RtVlanNs(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fvns.RtVlanNs", "cobra.model.infra.ADomP")

    meta.moClassName = "fvnsRtVlanNs"
    meta.rnFormat = "rtinfraVlanNs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13312, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13311, PropCategory.REGULAR)
