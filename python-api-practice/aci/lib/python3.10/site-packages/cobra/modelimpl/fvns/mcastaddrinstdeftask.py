...
# ##################################################
class McastAddrInstDefTask(Mo):
    """
    The multicast address instance definition task.

    """

    meta = ClassMeta("cobra.model.fvns.McastAddrInstDefTask")

    meta.moClassName = "fvnsMcastAddrInstDefTask"
    meta.rnFormat = "fvnsMcastAddrInstDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5762, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDel", "addordel", 146)
