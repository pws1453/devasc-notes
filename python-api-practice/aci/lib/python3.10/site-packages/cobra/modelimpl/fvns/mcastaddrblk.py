...
class McastAddrBlk(Mo):
    ...
    meta = ClassMeta("cobra.model.fvns.McastAddrBlk")

    meta.moClassName = "fvnsMcastAddrBlk"
    meta.rnFormat = "fromaddr-[%(from)s]-toaddr-[%(to)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of IP Address Block"
    meta.writeAccessMask = 0x300000002001
    ...
    meta.superClasses.add("cobra.model.fvns.AAddrBlk")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37938, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40077, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "from", "from", 6571, PropCategory.REGULAR)
    prop.label = "Starting IP Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "to", "to", 6572, PropCategory.REGULAR)
    prop.label = "Ending IP Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
