...
# ##################################################
class AVsanInstP(Mo):
    meta = ClassMeta("cobra.model.fvns.AVsanInstP")

    meta.isAbstract = True
    meta.moClassName = "fvnsAVsanInstP"
    ...
    meta.concreteSubClasses.add("cobra.model.fvns.VsanInstP")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "allocMode", "allocMode", 25310, PropCategory.REGULAR)
