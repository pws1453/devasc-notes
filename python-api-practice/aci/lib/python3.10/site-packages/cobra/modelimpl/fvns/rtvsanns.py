...
class RtVsanNs(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fvns.RtVsanNs", "cobra.model.fc.DomP")

    meta.moClassName = "fvnsRtVsanNs"
    meta.rnFormat = "rtfcVsanNs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25379, PropCategory.REGULAR)
