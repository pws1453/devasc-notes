...
# ##################################################
class RtCDevTemplateToAddrInst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fvns.RtCDevTemplateToAddrInst", "cobra.model.vns.CDev")

    meta.moClassName = "fvnsRtCDevTemplateToAddrInst"
    meta.rnFormat = "rtvnsCDevTemplateToAddrInst-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvnsCDevTemplateToAddrInst-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 44846, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44845, PropCategory.REGULAR)
