...
class RtEpgAggr(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtEpgAggr", "cobra.model.comp.AAppEpPD")

    meta.moClassName = "compRtEpgAggr"
    meta.rnFormat = "rtepgAggr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25801, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25800, PropCategory.REGULAR)
