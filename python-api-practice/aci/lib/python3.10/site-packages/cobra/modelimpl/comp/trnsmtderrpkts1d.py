...
# ##################################################
class TrnsmtdErrPkts1d(Mo):
    """
    A class that represents the most current statistics for transmitted error packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPkts1d", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPkts1d"
    meta.rnFormat = "CDcompTrnsmtdErrPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted error packets stats in 1 day"
