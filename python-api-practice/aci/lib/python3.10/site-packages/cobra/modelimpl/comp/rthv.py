...
class RtHv(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtHv", "cobra.model.comp.Vm")

    meta.moClassName = "compRtHv"
    meta.rnFormat = "rthv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11804, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11803, PropCategory.REGULAR)
