...
class CtrlrTask(Mo):
    """
    An internal system task to send controller information from one process to another.

    """

    meta = ClassMeta("cobra.model.comp.CtrlrTask")

    meta.moClassName = "compCtrlrTask"
    meta.rnFormat = "compCtrlrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5752, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelHealthProvider", "addordelhealthprovider", 3228)
    prop._addConstant("FindCluster", "findcluster", 171)
    prop._addConstant("HandleObjUpd", "handleobjupd", 178)
    prop._addConstant("PrepareLNode", "preparelnode", 181)
