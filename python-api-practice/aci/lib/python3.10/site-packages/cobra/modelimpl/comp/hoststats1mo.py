...
# ##################################################
class HostStats1mo(Mo):
    """
    A class that represents the most current statistics for host in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStats1mo", "host")
    ...
    meta.moClassName = "compHostStats1mo"
    meta.rnFormat = "CDcompHostStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host stats in 1 month"
