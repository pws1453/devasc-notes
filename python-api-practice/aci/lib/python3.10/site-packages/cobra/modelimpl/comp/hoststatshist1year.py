...
# ##################################################
class HostStatsHist1year(Mo):
    """
    A class that represents historical statistics for host in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist1year", "host")
    ...
    meta.moClassName = "compHostStatsHist1year"
    meta.rnFormat = "HDcompHostStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 5915, PropCategory.REGULAR)
