...
# ##################################################
class HvHealthDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvHealthDef")

    meta.moClassName = "compHvHealthDef"
    meta.rnFormat = "hvhealthdef-%(host)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Host Health Status"
    ...
    meta.childClasses.add("cobra.model.comp.RtHealthDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHealthDef", "rthealthDef"))
    ...
    prop = PropMeta("str", "aveHealth", "aveHealth", 44732, PropCategory.REGULAR)
    prop.label = "Hv Health based on AVE"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "gray"
    prop._addConstant("gray", "gray", 0)
    prop._addConstant("green", "green", 1)
    prop._addConstant("red", "red", 2)
    prop._addConstant("yellow", "yellow", 3)
    meta.props.add("aveHealth", prop)
    ...
    prop = PropMeta("str", "host", "host", 44729, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "hostOid", "hostOid", 44730, PropCategory.REGULAR)
    prop.label = "Host oid"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("hostOid", prop)
    ...
    prop = PropMeta("str", "remediation", "remediation", 44731, PropCategory.REGULAR)
    prop.label = "Health Remediation"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("remediation", prop)
    ...
    prop = PropMeta("str", "userHealth", "userHealth", 44733, PropCategory.REGULAR)
    prop.label = "User override for Hv Health"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "gray"
    ...
    prop._addConstant("red", "red", 2)
    prop._addConstant("yellow", "yellow", 3)
    meta.props.add("userHealth", prop)

    meta.namingProps.append(getattr(meta.props, "host"))

    def __init__(self, parentMoOrDn, host, markDirty=True, **creationProps):
        namingVals = [host]
