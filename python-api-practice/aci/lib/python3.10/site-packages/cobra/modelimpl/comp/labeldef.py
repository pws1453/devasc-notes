...
class LabelDef(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.LabelDef")

    meta.moClassName = "compLabelDef"
    meta.rnFormat = "lbldef-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.comp.RtDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtDef", "rtdef-"))
    ...
    prop = PropMeta("str", "oid", "oid", 19779, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
