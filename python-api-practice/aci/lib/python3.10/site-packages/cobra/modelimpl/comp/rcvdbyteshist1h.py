...
class RcvdBytesHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytesHist1h", "received bytes")
    ...
    meta.moClassName = "compRcvdBytesHist1h"
    meta.rnFormat = "HDcompRcvdBytes1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5925, PropCategory.REGULAR)
