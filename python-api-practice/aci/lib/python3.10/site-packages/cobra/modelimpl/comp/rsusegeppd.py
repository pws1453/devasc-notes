...
class RsUsegEpPD(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsUsegEpPD", "cobra.model.comp.EpPD")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsUsegEpPD"
    meta.rnFormat = "rsusegEpPD-[%(tDn)s]"
    ...
    prop = PropMeta("str", "attrDn", "attrDn", 23477, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("attrDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23538, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23479, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1262
    prop.defaultValueStr = "compEpPD"
    prop._addConstant("compEpPD", None, 1262)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23478, PropCategory.REGULAR)
