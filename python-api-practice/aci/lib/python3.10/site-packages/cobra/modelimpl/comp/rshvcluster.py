...
# ##################################################
class RsHvCluster(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsHvCluster", "cobra.model.comp.HvCluster")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsHvCluster"
    meta.rnFormat = "rshvCluster"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Host cluster"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52132, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 52131, PropCategory.REGULAR)
