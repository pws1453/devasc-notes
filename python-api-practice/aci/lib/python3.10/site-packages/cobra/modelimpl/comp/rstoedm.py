...
class RsToEdm(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsToEdm", "cobra.model.edm.Mgr")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsToEdm"
    meta.rnFormat = "rstoEdm"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to edmMgr"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49872, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 49871, PropCategory.REGULAR)
