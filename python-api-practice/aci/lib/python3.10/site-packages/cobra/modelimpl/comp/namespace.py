...
class Namespace(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Namespace")

    meta.moClassName = "compNamespace"
    ...
    meta.childClasses.add("cobra.model.comp.ContGrp")
    meta.childClasses.add("cobra.model.comp.Deployment")
    meta.childClasses.add("cobra.model.comp.ReplicaSet")
    meta.childClasses.add("cobra.model.comp.Service")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Deployment", "depl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ContGrp", "grp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Service", "svc-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ReplicaSet", "rs-"))
    ...
    prop = PropMeta("str", "domName", "domName", 34225, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 33765, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
