...
class TrnsmtdPktsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPktsHist15min", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPktsHist15min"
    meta.rnFormat = "HDcompTrnsmtdPkts15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5964, PropCategory.REGULAR)
