...
class TrnsmtdPktsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPktsHist1h", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPktsHist1h"
    meta.rnFormat = "HDcompTrnsmtdPkts1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5966, PropCategory.REGULAR)
