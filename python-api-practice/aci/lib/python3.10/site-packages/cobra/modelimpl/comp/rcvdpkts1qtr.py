...
class RcvdPkts1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPkts1qtr", "received packets")
    ...
    meta.moClassName = "compRcvdPkts1qtr"
    meta.rnFormat = "CDcompRcvdPkts1qtr"
