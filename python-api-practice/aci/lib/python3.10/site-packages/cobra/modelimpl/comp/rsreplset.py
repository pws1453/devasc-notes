...
class RsReplSet(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsReplSet", "cobra.model.comp.ReplicaSet")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsReplSet"
    meta.rnFormat = "rsreplSet"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34035, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34034, PropCategory.REGULAR)
