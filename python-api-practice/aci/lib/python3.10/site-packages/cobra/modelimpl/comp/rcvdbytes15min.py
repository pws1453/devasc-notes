...
class RcvdBytes15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytes15min", "received bytes")
    ...
    meta.moClassName = "compRcvdBytes15min"
    meta.rnFormat = "CDcompRcvdBytes15min"
