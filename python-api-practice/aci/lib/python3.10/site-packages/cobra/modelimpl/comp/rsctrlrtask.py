...
# ##################################################
class RsCtrlrTask(Mo):
    """
    An internal task to send policy from one process to another. This object is generated and used only by internal process. 

    """

    meta = ClassMeta("cobra.model.comp.RsCtrlrTask")

    meta.moClassName = "compRsCtrlrTask"
    meta.rnFormat = "compRsCtrlrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5759, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("GetAssocCtrlrInfo", "getassocctrlrinfo", 187)
