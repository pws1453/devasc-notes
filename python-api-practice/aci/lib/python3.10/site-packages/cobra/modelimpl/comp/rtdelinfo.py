...
class RtDelInfo(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtDelInfo", "cobra.model.comp.EpPD")

    meta.moClassName = "compRtDelInfo"
    meta.rnFormat = "rtdelInfo-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.comp.DelInfo")
    ...
    prop = PropMeta("str", "tCl", "tCl", 26230, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26229, PropCategory.REGULAR)
