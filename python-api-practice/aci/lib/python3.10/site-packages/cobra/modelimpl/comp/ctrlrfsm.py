...
class CtrlrFsm(Mo):
    """
    A finite state machine used internally by the process to connect to external controllers. This object is generated and used only by internal process.

    """

    meta = ClassMeta("cobra.model.comp.CtrlrFsm")

    meta.moClassName = "compCtrlrFsm"
    meta.rnFormat = "compCtrlrFsm-%(id)s"
    meta.category = MoCategory.FSM
    meta.label = "None"
    ...
    meta.childClasses.add("cobra.model.comp.CtrlrContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.CtrlrContext", "compCtrlr"))
    ...
    meta.superClasses.add("cobra.model.fsm.Inst")
    ...
    prop = PropMeta("str", "currStage", "currStage", 5749, PropCategory.REGULAR)
    prop.label = "Current Stage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("AddBegin", "addbegin", 29)
    prop._addConstant("AddConnect", "addconnect", 31)
    prop._addConstant("AddFail", "addfail", 206)
    prop._addConstant("AddGetInventory", "addgetinventory", 33)
    prop._addConstant("AddGetTimestamp", "addgettimestamp", 32)
    prop._addConstant("AddInit", "addinit", 30)
    prop._addConstant("AddOnline", "addonline", 36)
    prop._addConstant("AddPostInventory", "addpostinventory", 35)
    prop._addConstant("AddSubscribeEvents", "addsubscribeevents", 34)
    prop._addConstant("AddSuccess", "addsuccess", 207)
    prop._addConstant("RemoveBegin", "removebegin", 37)
    prop._addConstant("RemoveCleanup", "removecleanup", 38)
    prop._addConstant("RemoveCleanup2", "removecleanup2", 224)
    prop._addConstant("RemoveDisconnect", "removedisconnect", 40)
    prop._addConstant("RemoveFail", "removefail", 208)
    prop._addConstant("RemoveMitClean", "removemitclean", 42)
    prop._addConstant("RemoveOffline", "removeoffline", 41)
    prop._addConstant("RemoveSuccess", "removesuccess", 209)
    prop._addConstant("RemoveUnSubscribeEvents", "removeunsubscribeevents", 39)
    prop._addConstant("none", "none", 0)
    meta.props.add("currStage", prop)
    ...
    prop = PropMeta("str", "flags", "flags", 5751, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:CloudFoundry", "ifc:vmmmgr:compctrlradd:cloudfoundry", 512)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:Kubernetes", "ifc:vmmmgr:compctrlradd:kubernetes", 128)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:MicrosoftSCVMM", "ifc:vmmmgr:compctrlradd:microsoftscvmm", 8)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:OpenShift", "ifc:vmmmgr:compctrlradd:openshift", 1024)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:OpenStack", "ifc:vmmmgr:compctrlradd:openstack", 64)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:iaas", "ifc:vmmmgr:compctrlradd:iaas", 2)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:network", "ifc:vmmmgr:compctrlradd:network", 4)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:rhev", "ifc:vmmmgr:compctrlradd:rhev", 256)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:vm", "ifc:vmmmgr:compctrlradd:vm", 1)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:CloudFoundry", "ifc:vmmmgr:compctrlrremove:cloudfoundry", 512)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:Kubernetes", "ifc:vmmmgr:compctrlrremove:kubernetes", 128)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:MicrosoftSCVMM", "ifc:vmmmgr:compctrlrremove:microsoftscvmm", 8)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:OpenShift", "ifc:vmmmgr:compctrlrremove:openshift", 1024)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:OpenStack", "ifc:vmmmgr:compctrlrremove:openstack", 64)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:iaas", "ifc:vmmmgr:compctrlrremove:iaas", 2)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:network", "ifc:vmmmgr:compctrlrremove:network", 4)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:rhev", "ifc:vmmmgr:compctrlrremove:rhev", 256)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:vm", "ifc:vmmmgr:compctrlrremove:vm", 1)
    meta.props.add("flags", prop)

    prop = PropMeta("str", "id", "id", 5748, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("Add", "add", 54)
    prop._addConstant("Remove", "remove", 59)
    prop._addConstant("none", "none", 0)
    ...
    prop = PropMeta("str", "prevStage", "prevStage", 5750, PropCategory.REGULAR)
    prop.label = "Previous Stage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    ...
    prop._addConstant("RemoveUnSubscribeEvents", "removeunsubscribeevents", 39)
    prop._addConstant("none", "none", 0)
    meta.props.add("prevStage", prop)

    prop = PropMeta("str", "progr", "progr", 65, PropCategory.REGULAR)
    prop.label = "Progress"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 100)]
    ...
    prop = PropMeta("str", "seqId", "seqId", 61, PropCategory.REGULAR)
    prop.label = "Sequence ID"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("seqId", prop)

    prop = PropMeta("str", "stageDescr", "stageDescr", 64, PropCategory.REGULAR)
    prop.label = "Stage Description"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    prop.regex = ['[a-zA-Z0-9\\!#$%()*,-./:;@ _{|}~?&+]+']
    meta.props.add("stageDescr", prop)
