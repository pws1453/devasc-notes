...
class RcvdBytes1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytes1mo", "received bytes")
    ...
    meta.moClassName = "compRcvdBytes1mo"
    meta.rnFormat = "CDcompRcvdBytes1mo"
