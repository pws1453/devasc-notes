...
# ##################################################
class EpPConnTask(Mo):
    """
    A task to send endpoint connection information within the system. This is for internal use.

    """

    meta = ClassMeta("cobra.model.comp.EpPConnTask")

    meta.moClassName = "compEpPConnTask"
    meta.rnFormat = "compEpPConnTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.comp.EpPConnContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.EpPConnContext", "compEpPConn"))
    ...
    prop = PropMeta("str", "id", "id", 5753, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("resolveEPgAdj", "resolveepgadj", 163)
