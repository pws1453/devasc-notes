...
class RsToEPg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsToEPg", "cobra.model.comp.EpPD")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsToEPg"
    meta.rnFormat = "rsToEPg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to compEpPD"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23525, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23524, PropCategory.REGULAR)
