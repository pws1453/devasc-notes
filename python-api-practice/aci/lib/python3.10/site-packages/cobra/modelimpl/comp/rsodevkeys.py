...
class RsODevKeys(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsODevKeys", "cobra.model.opflex.ODevKeyRing")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsODevKeys"
    meta.rnFormat = "rsODevKeys"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "OpflexKeys"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26211, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7660
    prop.defaultValueStr = "opflexODevKeyRing"
    prop._addConstant("opflexODevKeyRing", None, 7660)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26210, PropCategory.REGULAR)
