...
# ##################################################
class HvClusterCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvClusterCont")

    meta.moClassName = "compHvClusterCont"
    meta.rnFormat = "hvClusterCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Host Cluster Policy Container"
    ...
    meta.childClasses.add("cobra.model.comp.HvClusterDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvClusterDef", "hvcluster-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52146, PropCategory.REGULAR)
