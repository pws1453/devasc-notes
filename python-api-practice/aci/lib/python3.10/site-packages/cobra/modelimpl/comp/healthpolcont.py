...
# ##################################################
class HealthPolCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HealthPolCont")

    meta.moClassName = "compHealthPolCont"
    meta.rnFormat = "healthPolCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Health Policy Container"
    ...
    meta.childClasses.add("cobra.model.comp.HvHealthDef")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvHealthDef", "hvhealthdef-"))
    ...
    prop = PropMeta("str", "enable", "enable", 44728, PropCategory.REGULAR)
    prop.label = "Enable the host health monitoring"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44751, PropCategory.REGULAR)
