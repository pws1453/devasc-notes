...
class EDMgrProxy(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.EDMgrProxy")

    meta.moClassName = "compEDMgrProxy"
    meta.rnFormat = "edmgr-[%(mgrKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "proxy for edmMgr MO"
    ...
    meta.childClasses.add("cobra.model.comp.LsNodeRef")
    meta.childClasses.add("cobra.model.comp.RsToEdm")
    meta.childClasses.add("cobra.model.comp.ManagedNic")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsToEdm", "rstoEdm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.LsNodeRef", "lnref-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ManagedNic", "mnic-"))
    ...
    prop = PropMeta("str", "isLooseNodePresent", "isLooseNodePresent", 49815, PropCategory.REGULAR)
    prop.label = "indicates existence of loose node corr to this proxy MO"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("isLooseNodePresent", prop)

    prop = PropMeta("str", "isUserCreated", "isUserCreated", 49816, PropCategory.REGULAR)
    prop.label = "indicates proxy MO is created by user action"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isUserCreated", prop)
    ...
    prop = PropMeta("str", "mgrKey", "mgrKey", 49814, PropCategory.REGULAR)
    prop.label = "Mgr Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("mgrKey", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49883, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "mgrKey"))
    getattr(meta.props, "mgrKey").needDelimiter = True

    def __init__(self, parentMoOrDn, mgrKey, markDirty=True, **creationProps):
        namingVals = [mgrKey]
