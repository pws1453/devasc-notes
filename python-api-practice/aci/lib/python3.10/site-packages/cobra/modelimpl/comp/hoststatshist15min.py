...
# ##################################################
class HostStatsHist15min(Mo):
    """
    A class that represents historical statistics for host in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist15min", "host")
    ...
    meta.moClassName = "compHostStatsHist15min"
    meta.rnFormat = "HDcompHostStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.comp.HostStatsHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDcompHostStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 5909, PropCategory.REGULAR)
