...
class RsDef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsDef", "cobra.model.comp.LabelDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsDef"
    meta.rnFormat = "rsdef"
    ...
    meta.parentClasses.add("cobra.model.comp.LabelVal")
    ...
    prop = PropMeta("str", "tCl", "tCl", 19786, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6613
    prop.defaultValueStr = "compLabelDef"
    prop._addConstant("compLabelDef", None, 6613)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 19785, PropCategory.REGULAR)
