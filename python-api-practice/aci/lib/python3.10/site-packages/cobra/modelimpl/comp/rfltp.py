...
class RFltP(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.RFltP")

    meta.moClassName = "compRFltP"
    meta.rnFormat = "rfltp-[%(fpDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Service group"
    ...
    meta.childClasses.add("cobra.model.comp.RtRFltPAtt")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.comp.RsRFltP")
    meta.childClasses.add("cobra.model.comp.RtRFltAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtRFltPAtt", "rtRFltPAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtRFltAtt", "rtRFltAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsRFltP", "rsRFltP"))
    ...
    prop = PropMeta("str", "fpDn", "fpDn", 24257, PropCategory.REGULAR)
    prop.label = "vzRFltP Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("fpDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24293, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "fpDn"))
    getattr(meta.props, "fpDn").needDelimiter = True

    def __init__(self, parentMoOrDn, fpDn, markDirty=True, **creationProps):
        namingVals = [fpDn]
