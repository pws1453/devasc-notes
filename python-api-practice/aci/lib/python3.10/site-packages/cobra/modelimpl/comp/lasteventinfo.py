...
class LastEventInfo(Mo):
    ...
    prop = PropMeta("str", "lastEventCollectorId", "lastEventCollectorId", 39373, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "lastEventId", "lastEventId", 39372, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastEventId", prop)

    prop = PropMeta("str", "lastEventTS", "lastEventTS", 39371, PropCategory.REGULAR)
    prop.label = "Status"
    prop.isImplicit = True
    prop.isAdmin = True
