...
class RcvdBytes1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytes1w", "received bytes")
    ...
    meta.moClassName = "compRcvdBytes1w"
    meta.rnFormat = "CDcompRcvdBytes1w"
