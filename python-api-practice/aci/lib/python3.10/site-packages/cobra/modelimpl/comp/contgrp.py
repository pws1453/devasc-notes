...
class ContGrp(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.ContGrp")

    meta.moClassName = "compContGrp"
    ...
    meta.childClasses.add("cobra.model.comp.RsContGrpDepl")
    meta.childClasses.add("cobra.model.comp.RtEndpoint")
    meta.childClasses.add("cobra.model.comp.RsReplSet")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsContGrpDepl", "rscontGrpDepl"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtEndpoint", "rtendpoint-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsReplSet", "rsreplSet"))

    meta.parentClasses.add("cobra.model.comp.OrgUnit")
    ...
    prop = PropMeta("str", "deploymentName", "deploymentName", 36356, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "guid", "guid", 33725, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "hostName", "hostName", 33726, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 33763, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "namespace", "namespace", 33727, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "replicaSetName", "replicaSetName", 33728, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
