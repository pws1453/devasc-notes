...
# ##################################################
class RsToInstPCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsToInstPCont", "cobra.model.comp.L3ExtInstPCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsToInstPCont"
    meta.rnFormat = "rsToInstPCont"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to pull the l3extinstp cont to compEpPd Shard"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54074, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15811
    prop.defaultValueStr = "compL3ExtInstPCont"
    prop._addConstant("compL3ExtInstPCont", None, 15811)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54073, PropCategory.REGULAR)
