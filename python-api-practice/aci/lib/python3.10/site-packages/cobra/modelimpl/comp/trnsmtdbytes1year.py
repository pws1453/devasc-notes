...
class TrnsmtdBytes1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdBytes1year", "transmitted bytes")
    ...
    meta.moClassName = "compTrnsmtdBytes1year"
    meta.rnFormat = "CDcompTrnsmtdBytes1year"
