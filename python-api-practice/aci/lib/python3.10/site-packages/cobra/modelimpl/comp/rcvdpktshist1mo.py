...
class RcvdPktsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPktsHist1mo", "received packets")
    ...
    meta.moClassName = "compRcvdPktsHist1mo"
    meta.rnFormat = "HDcompRcvdPkts1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5942, PropCategory.REGULAR)
