...
class RcvdBytesHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytesHist1year", "received bytes")
    ...
    meta.moClassName = "compRcvdBytesHist1year"
    meta.rnFormat = "HDcompRcvdBytes1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5929, PropCategory.REGULAR)
