...
class RsPvlan(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsPvlan", "cobra.model.comp.PvlanEntry")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsPvlan"
    meta.rnFormat = "rspvlan-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23483, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23482, PropCategory.REGULAR)
