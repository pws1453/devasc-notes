...
class HvGroup(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.HvGroup")

    meta.moClassName = "compHvGroup"
    meta.rnFormat = "hvgroup-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster Host Group"
    ...
    meta.childClasses.add("cobra.model.comp.RsHvGroupToHv")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsHvGroupToHv", "rshvGroupToHv-"))
    ...
    prop = PropMeta("str", "name", "name", 52128, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
