...
# ##################################################
class TrigRtdEpPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.TrigRtdEpPTask")

    meta.moClassName = "compTrigRtdEpPTask"
    meta.rnFormat = "compTrigRtdEpPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 54065, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("resolveL3ExtEPg", "resolvel3extepg", 3559)
