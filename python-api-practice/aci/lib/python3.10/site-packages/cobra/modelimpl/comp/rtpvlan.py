...
class RtPvlan(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtPvlan", "cobra.model.comp.EpPD")

    meta.moClassName = "compRtPvlan"
    meta.rnFormat = "rtpvlan-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23485, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23484, PropCategory.REGULAR)
