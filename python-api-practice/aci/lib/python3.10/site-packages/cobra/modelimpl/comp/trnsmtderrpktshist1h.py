...
# ##################################################
class TrnsmtdErrPktsHist1h(Mo):
    """
    A class that represents historical statistics for transmitted error packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPktsHist1h", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPktsHist1h"
    meta.rnFormat = "HDcompTrnsmtdErrPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical transmitted error packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 5958, PropCategory.REGULAR)
