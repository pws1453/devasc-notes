...
class RsToEPgAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsToEPgAtt", "cobra.model.vz.ToEPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsToEPgAtt"
    meta.rnFormat = "rsToEPgAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to vzToEPg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24283, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24282, PropCategory.REGULAR)
