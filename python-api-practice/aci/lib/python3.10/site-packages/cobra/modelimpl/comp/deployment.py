...
class Deployment(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Deployment")

    meta.moClassName = "compDeployment"
    meta.rnFormat = "depl-%(name)s"
    ...
    meta.childClasses.add("cobra.model.comp.RtDeployment")
    meta.childClasses.add("cobra.model.comp.RtContGrpDepl")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtContGrpDepl", "rtcontGrpDepl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtDeployment", "rtdeployment-"))
    ...
    prop = PropMeta("str", "guid", "guid", 33737, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 33764, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "namespace", "namespace", 34201, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "replicas", "replicas", 33738, PropCategory.REGULAR)
    prop.label = "Replicas"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("replicas", prop)
