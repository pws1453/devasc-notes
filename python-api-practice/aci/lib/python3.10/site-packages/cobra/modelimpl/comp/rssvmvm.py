...
class RsSvmVm(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsSvmVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsSvmVm"
    meta.rnFormat = "rsSvmVm"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SVM VM"
    ...
    prop = PropMeta("str", "tCl", "tCl", 36832, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 36831, PropCategory.REGULAR)
