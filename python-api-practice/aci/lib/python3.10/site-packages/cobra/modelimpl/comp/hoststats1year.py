...
# ##################################################
class HostStats1year(Mo):
    """
    A class that represents the most current statistics for host in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStats1year", "host")
    ...
    meta.moClassName = "compHostStats1year"
    meta.rnFormat = "CDcompHostStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host stats in 1 year"
