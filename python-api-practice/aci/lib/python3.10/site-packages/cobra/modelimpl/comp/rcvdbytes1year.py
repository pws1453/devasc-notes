...
class RcvdBytes1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytes1year", "received bytes")
    ...
    meta.moClassName = "compRcvdBytes1year"
    meta.rnFormat = "CDcompRcvdBytes1year"
