...
# ##################################################
class HostStats15min(Mo):
    """
    A class that represents the most current statistics for host in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStats15min", "host")
    ...
    meta.moClassName = "compHostStats15min"
    meta.rnFormat = "CDcompHostStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host stats in 15 minute"
