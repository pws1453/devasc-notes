...
# ##################################################
class PvlanContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.PvlanContTask")

    meta.moClassName = "compPvlanContTask"
    meta.rnFormat = "compPvlanContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 25159, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdPvlanMap", "updpvlanmap", 2187)
