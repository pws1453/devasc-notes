...
class ReplicaSet(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.ReplicaSet")

    meta.moClassName = "compReplicaSet"
    meta.rnFormat = "rs-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "ReplicaSet"
    ...
    meta.childClasses.add("cobra.model.comp.RtReplSet")
    meta.childClasses.add("cobra.model.comp.RsDeployment")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsDeployment", "rsdeployment"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtReplSet", "rtreplSet-"))
    ...
    prop = PropMeta("str", "deploymentName", "deploymentName", 33740, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "guid", "guid", 33739, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 33766, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "namespace", "namespace", 34202, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
