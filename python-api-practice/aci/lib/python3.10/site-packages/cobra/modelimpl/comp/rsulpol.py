...
class RsUlPol(Mo):
    """
    A source relation to the common policies for the interface connected to the node. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsUlPol", "cobra.model.hvs.ExtPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsUlPol"
    meta.rnFormat = "rsulPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11765, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 105
    prop.defaultValueStr = "hvsExtPol"
    prop._addConstant("hvsExtPol", None, 105)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11764, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "uplinkPort", "uplinkPort", 44899, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("uplinkPort", prop)
