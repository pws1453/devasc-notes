...
class HvTask(Mo):
    """
    An internal task to collect hypervisor information from the external system, such as a VMware vCenter. This object is generated and used only by internal process. 

    """

    meta = ClassMeta("cobra.model.comp.HvTask")

    meta.moClassName = "compHvTask"
    meta.rnFormat = "compHvTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5756, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("GetHpNicAdj", "gethpnicadj", 183)
    prop._addConstant("none", "none", 0)
    prop._addConstant("setConfigIssuesHv", "setconfigissueshv", 2427)
