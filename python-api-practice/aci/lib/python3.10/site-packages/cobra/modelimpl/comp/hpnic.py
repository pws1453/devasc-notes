...
class HpNic(Mo):
    """
    The physical interface information on the hypervisor.

    """

    meta = ClassMeta("cobra.model.comp.HpNic")

    meta.moClassName = "compHpNic"
    meta.rnFormat = "hpnic-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Hypervisor NIC"
    ...
    meta.childClasses.add("cobra.model.comp.RsPpNic")
    ...
    meta.childClasses.add("cobra.model.comp.RsUlPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsPpNic", "rsppNic"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsUlPol", "rsulPol"))
    ...
    prop = PropMeta("str", "displayName", "displayName", 22715, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("displayName", prop)
    ...
    prop = PropMeta("str", "duplexMode", "duplexMode", 974, PropCategory.REGULAR)
    prop.label = "Duplex Mode Status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("duplexMode", prop)
    ...
    prop = PropMeta("str", "hpNicOperIssues", "hpNicOperIssues", 972, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("adj-fail", "could-not-find-adjacency-for-nic.", 128)
    prop._addConstant("adj-fail-missing-nbr-key-cdp-leaf", "cdp-adjacency-with-leaf-is-missing-interface-name", 2048)
    prop._addConstant("adj-fail-missing-nbr-key-cdp-lnode", "cdp-adjacency-with-loose-node-is-missing-ip", 4096)
    prop._addConstant("adj-fail-missing-nbr-key-lldp-leaf", "lldp-adjacency-with-leaf-is-missing-interface-name", 512)
    prop._addConstant("adj-fail-missing-nbr-key-lldp-lnode", "lldp-adjacency-with-loose-node-is-missing-ip", 1024)
    prop._addConstant("api-add-vnic-fail", "api-call-for-adding-vnic-failed.", 2)
    prop._addConstant("config-set-error", "mo-not-found-in-config-set,-check-logs-for-details.", 1)
    prop._addConstant("dvs-not-found", "unable-to-find-dvs-object-on-controller.", 8)
    prop._addConstant("dvs-reconfig-failed", "unable-to-reconfigure-dvs-api-error.", 32)
    prop._addConstant("hostnws-not-found", "unable-to-find-host-network-system-on-controller.", 4)
    prop._addConstant("loose-node-task-failed", "loose-node-task-failed,-check-logs-for-details.", 64)
    prop._addConstant("nic-oper-state-down", "nic-operational-state-is-down.", 256)
    prop._addConstant("none", "none", 0)
    prop._addConstant("pg-not-found", "unable-to-find-port-group-on-controller.", 16)
    meta.props.add("hpNicOperIssues", prop)
    ...
    prop = PropMeta("str", "linkSpeed", "linkSpeed", 973, PropCategory.REGULAR)
    prop.label = "LinkSpeed in Mbps"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    prop.defaultValue = "unknown"
    prop.defaultValueStr = "unknown"
    meta.props.add("linkSpeed", prop)

    prop = PropMeta("str", "mac", "mac", 966, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14054, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 5917, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "setHpNicOperIssues", "setHpNicOperIssues", 16099, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("none", "none", 0)
    prop._addConstant("pg-not-found", "unable-to-find-port-group-on-controller.", 16)
    meta.props.add("setHpNicOperIssues", prop)
    ...
    prop = PropMeta("str", "type", "type", 971, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    prop.defaultValueStr = "hv"
    ...
    prop = PropMeta("str", "unsetHpNicOperIssues", "unsetHpNicOperIssues", 16100, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("none", "none", 0)
    prop._addConstant("pg-not-found", "unable-to-find-port-group-on-controller.", 16)
    meta.props.add("unsetHpNicOperIssues", prop)
