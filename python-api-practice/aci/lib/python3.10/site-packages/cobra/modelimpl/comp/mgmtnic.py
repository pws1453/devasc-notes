...
class MgmtNic(Mo):
    """
    An endpoint or NIC used for management connectivity on the host. For example, vmk interface of a VMware vCenter. 

    """

    meta = ClassMeta("cobra.model.comp.MgmtNic")

    meta.moClassName = "compMgmtNic"
    meta.rnFormat = "mgmtnic-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Management NIC"
    ...
    meta.childClasses.add("cobra.model.comp.RsMgmtPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsMgmtPol", "rsmgmtPol"))
    ...
    prop = PropMeta("str", "displayName", "displayName", 22716, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14057, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 5919, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tType", "tType", 978, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 977, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
