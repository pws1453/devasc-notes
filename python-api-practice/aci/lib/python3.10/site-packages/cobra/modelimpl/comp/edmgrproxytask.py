...
# ##################################################
class EDMgrProxyTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.EDMgrProxyTask")

    meta.moClassName = "compEDMgrProxyTask"
    meta.rnFormat = "compEDMgrProxyTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 49827, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateManagedNics", "updatemanagednics", 3323)
