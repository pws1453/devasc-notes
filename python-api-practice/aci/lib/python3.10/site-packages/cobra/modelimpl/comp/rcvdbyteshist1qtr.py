...
class RcvdBytesHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytesHist1qtr", "received bytes")
    ...
    meta.moClassName = "compRcvdBytesHist1qtr"
    meta.rnFormat = "HDcompRcvdBytes1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5927, PropCategory.REGULAR)
