...
class Taguse(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Taguse")

    meta.moClassName = "compTaguse"
    meta.rnFormat = "taguse-%(name)s"
    ...
    meta.parentClasses.add("cobra.model.comp.Categoryuse")
    ...
    prop = PropMeta("str", "name", "name", 54132, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tagDn", "tagDn", 54129, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("tagDn", prop)
