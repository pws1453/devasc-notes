...
class RsPpNic(Mo):
    """
    A source relation to a physical interface on the physical host.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsPpNic", "cobra.model.comp.PpNic")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "compRsPpNic"
    meta.rnFormat = "rsppNic"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11762, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1119
    prop.defaultValueStr = "compPpNic"
    prop._addConstant("compPpNic", None, 1119)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11761, PropCategory.REGULAR)
