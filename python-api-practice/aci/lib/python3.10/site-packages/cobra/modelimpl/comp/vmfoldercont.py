...
# ##################################################
class VmFolderCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.VmFolderCont")

    meta.moClassName = "compVmFolderCont"
    meta.rnFormat = "vmfoldercont"
    ...
    prop = PropMeta("str", "descr", "descr", 54112, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "issues", "issues", 54110, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
