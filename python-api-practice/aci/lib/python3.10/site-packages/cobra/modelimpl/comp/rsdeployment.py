...
# ##################################################
class RsDeployment(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsDeployment", "cobra.model.comp.Deployment")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsDeployment"
    meta.rnFormat = "rsdeployment"
    ...
    meta.parentClasses.add("cobra.model.comp.ReplicaSet")
    ...
    prop = PropMeta("str", "tCl", "tCl", 34043, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34042, PropCategory.REGULAR)
