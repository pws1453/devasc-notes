...
class Tag(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Tag")

    meta.moClassName = "compTag"
    meta.rnFormat = "tag-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.comp.RsAssocObj")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsAssocObj", "rsassocObj-"))

    meta.parentClasses.add("cobra.model.comp.Category")
    ...
    prop = PropMeta("str", "description", "description", 30038, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "oid", "oid", 30042, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
