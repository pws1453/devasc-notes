...
# ##################################################
class HostStatsHist1mo(Mo):
    """
    A class that represents historical statistics for host in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist1mo", "host")
    ...
    meta.moClassName = "compHostStatsHist1mo"
    meta.rnFormat = "HDcompHostStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 5912, PropCategory.REGULAR)
