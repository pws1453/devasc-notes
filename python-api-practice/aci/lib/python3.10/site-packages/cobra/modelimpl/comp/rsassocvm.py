...
class RsAssocVm(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsAssocVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsAssocVm"
    meta.rnFormat = "rsassocVm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 37256, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 37255, PropCategory.REGULAR)
