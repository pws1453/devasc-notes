...
class PendEp(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.PendEp")

    meta.moClassName = "compPendEp"
    meta.rnFormat = "pendEp-[%(epPConnDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Pending Ep Resolve"
    ...
    meta.parentClasses.add("cobra.model.comp.PendResEpCont")
    ...
    prop = PropMeta("str", "attachType", "attachType", 30538, PropCategory.REGULAR)
    prop.label = "Attach Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("Attach", "attach", 0)
    prop._addConstant("Detach", "detach", 1)
    meta.props.add("attachType", prop)
    ...
    prop = PropMeta("str", "createdTS", "createdTS", 30539, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "epPConnDn", "epPConnDn", 30537, PropCategory.REGULAR)
    prop.label = "EpPConn Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("epPConnDn", prop)
    ...
    prop = PropMeta("str", "verifyCount", "verifyCount", 34208, PropCategory.REGULAR)
    prop.label = "How many times have we tried to verify the Ep"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("verifyCount", prop)

    meta.namingProps.append(getattr(meta.props, "epPConnDn"))
    getattr(meta.props, "epPConnDn").needDelimiter = True

    def __init__(self, parentMoOrDn, epPConnDn, markDirty=True, **creationProps):
        namingVals = [epPConnDn]
