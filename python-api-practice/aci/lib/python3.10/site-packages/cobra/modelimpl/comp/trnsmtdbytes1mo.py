...
class TrnsmtdBytes1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdBytes1mo", "transmitted bytes")
    ...
    meta.moClassName = "compTrnsmtdBytes1mo"
    meta.rnFormat = "CDcompTrnsmtdBytes1mo"
