...
# ##################################################
class TrnsmtdErrPktsHist5min(Mo):
    """
    A class that represents historical statistics for transmitted error packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPktsHist5min", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPktsHist5min"
    meta.rnFormat = "HDcompTrnsmtdErrPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical transmitted error packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 5963, PropCategory.REGULAR)
