...
# ##################################################
class AveHealthInst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.AveHealthInst")

    meta.moClassName = "compAveHealthInst"
    meta.rnFormat = "aveHealthInst-%(nodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "AVE Health Inst"
    ...
    meta.parentClasses.add("cobra.model.comp.AveHealth")
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 45571, PropCategory.REGULAR)
