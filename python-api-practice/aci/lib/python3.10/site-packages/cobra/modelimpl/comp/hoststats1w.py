...
# ##################################################
class HostStats1w(Mo):
    """
    A class that represents the most current statistics for host in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStats1w", "host")
    ...
    meta.moClassName = "compHostStats1w"
    meta.rnFormat = "CDcompHostStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host stats in 1 week"
