...
class RcvdBytesHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytesHist5min", "received bytes")
    ...
    meta.moClassName = "compRcvdBytesHist5min"
    meta.rnFormat = "HDcompRcvdBytes5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5930, PropCategory.REGULAR)
