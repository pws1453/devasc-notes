...
# ##################################################
class RsHvGroupToHv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsHvGroupToHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsHvGroupToHv"
    meta.rnFormat = "rshvGroupToHv-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.comp.HvGroup")
    ...
    prop = PropMeta("str", "tCl", "tCl", 52143, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 52142, PropCategory.REGULAR)
