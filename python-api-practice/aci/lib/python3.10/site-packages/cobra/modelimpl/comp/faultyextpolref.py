...
# ##################################################
class FaultyExtPolRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.FaultyExtPolRef")

    meta.moClassName = "compFaultyExtPolRef"
    meta.rnFormat = "faultyExtPolRef-[%(extPolDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "FaultyExtPol Information"
    ...
    meta.parentClasses.add("cobra.model.comp.FaultyExtPolCont")
    ...
    prop = PropMeta("str", "extPolDn", "extPolDn", 27126, PropCategory.REGULAR)
    prop.label = "Portgroup Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("extPolDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "extPolDn"))
    getattr(meta.props, "extPolDn").needDelimiter = True

    def __init__(self, parentMoOrDn, extPolDn, markDirty=True, **creationProps):
        namingVals = [extPolDn]
