...
class FolderDef(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.FolderDef")

    meta.moClassName = "compFolderDef"
    meta.rnFormat = "folderdef-%(oid)s"
    ...
    meta.parentClasses.add("cobra.model.comp.VmFolderDefCont")
    ...
    prop = PropMeta("str", "folderKey", "folderKey", 54425, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("folderKey", prop)
    ...
    prop = PropMeta("str", "oid", "oid", 54427, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "path", "path", 54424, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
