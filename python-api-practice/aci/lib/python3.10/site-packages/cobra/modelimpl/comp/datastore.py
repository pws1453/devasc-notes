...
class DataStore(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.DataStore")

    meta.moClassName = "compDataStore"
    meta.rnFormat = "dstore-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.comp.RtRpToDataStore")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtRpToDataStore", "rtRpToDataStore"))
    ...
    prop = PropMeta("str", "dsName", "dsName", 42668, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("dsName", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42712, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 42691, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
