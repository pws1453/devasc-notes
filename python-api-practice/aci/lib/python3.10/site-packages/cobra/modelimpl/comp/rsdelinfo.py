...
class RsDelInfo(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsDelInfo", "cobra.model.comp.DelInfo")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsDelInfo"
    meta.rnFormat = "rsDelInfo"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26228, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9041
    prop.defaultValueStr = "compDelInfo"
    prop._addConstant("compDelInfo", None, 9041)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26227, PropCategory.REGULAR)
