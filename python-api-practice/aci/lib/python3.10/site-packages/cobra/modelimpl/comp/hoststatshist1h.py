...
# ##################################################
class HostStatsHist1h(Mo):
    """
    A class that represents historical statistics for host in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist1h", "host")
    ...
    meta.moClassName = "compHostStatsHist1h"
    meta.rnFormat = "HDcompHostStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 5911, PropCategory.REGULAR)
