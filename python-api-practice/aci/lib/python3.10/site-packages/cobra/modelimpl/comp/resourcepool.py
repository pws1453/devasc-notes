...
# ##################################################
class ResourcePool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ResourcePool")

    meta.moClassName = "compResourcePool"
    meta.rnFormat = "rpool-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Service VM requirments"
    ...
    meta.childClasses.add("cobra.model.comp.RsRpToDataStore")
    meta.childClasses.add("cobra.model.comp.HostResourcePool")
    meta.childClasses.add("cobra.model.comp.RsRpToHost")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsRpToDataStore", "rsrpToDataStore-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsRpToHost", "rsrpToHost-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostResourcePool", "hostRpool-"))
    ...
    prop = PropMeta("str", "hostOrClusterName", "hostOrClusterName", 42672, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("hostOrClusterName", prop)
    ...
    prop = PropMeta("str", "isHost", "isHost", 42671, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42713, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 42693, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "rpName", "rpName", 42670, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("rpName", prop)
