...
# ##################################################
class TrnsmtdErrPktsHist1w(Mo):
    """
    A class that represents historical statistics for transmitted error packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPktsHist1w", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPktsHist1w"
    meta.rnFormat = "HDcompTrnsmtdErrPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical transmitted error packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 5961, PropCategory.REGULAR)
