...
# ##################################################
class HealthPolContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HealthPolContTask")

    meta.moClassName = "compHealthPolContTask"
    meta.rnFormat = "compHealthPolContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44740, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("postHvHealthUpdate", "posthvhealthupdate", 3230)
