...
# ##################################################
class EpPDContext(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.EpPDContext")

    meta.moClassName = "compEpPDContext"
    meta.rnFormat = "compEpPD"
    ...
    meta.parentClasses.add("cobra.model.comp.EpPDTask")
    ...
    prop = PropMeta("str", "operDelimiter", "operDelimiter", 26224, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 1)]
    ...
    prop = PropMeta("str", "type", "type", 30073, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
