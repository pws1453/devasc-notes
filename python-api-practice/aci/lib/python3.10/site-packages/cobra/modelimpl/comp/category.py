...
class Category(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Category")

    meta.moClassName = "compCategory"
    meta.rnFormat = "cat-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.comp.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Tag", "tag-"))
    ...
    prop = PropMeta("str", "cardinality", "cardinality", 30037, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("multiple", "multiple", 1)
    prop._addConstant("single", "single", 0)
    ...
    prop = PropMeta("str", "description", "description", 30036, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "oid", "oid", 30041, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
