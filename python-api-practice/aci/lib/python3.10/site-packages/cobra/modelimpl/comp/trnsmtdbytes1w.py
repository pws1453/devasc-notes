...
class TrnsmtdBytes1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdBytes1w", "transmitted bytes")
    ...
    meta.moClassName = "compTrnsmtdBytes1w"
    meta.rnFormat = "CDcompTrnsmtdBytes1w"
