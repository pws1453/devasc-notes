...
class TrnsmtdPktsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPktsHist1year", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPktsHist1year"
    meta.rnFormat = "HDcompTrnsmtdPkts1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5970, PropCategory.REGULAR)
