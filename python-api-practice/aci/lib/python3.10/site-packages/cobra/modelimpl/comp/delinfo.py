...
class DelInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.DelInfo")

    meta.moClassName = "compDelInfo"
    meta.rnFormat = "delInfo-[%(delimiter)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Delimiter Information"
    ...
    meta.childClasses.add("cobra.model.comp.RtDelInfo")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtDelInfo", "rtdelInfo-"))

    meta.parentClasses.add("cobra.model.comp.DelCont")
    ...
    prop = PropMeta("str", "delimiter", "delimiter", 26222, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "delimiter"))
    getattr(meta.props, "delimiter").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, delimiter, markDirty=True, **creationProps):
        namingVals = [delimiter]
