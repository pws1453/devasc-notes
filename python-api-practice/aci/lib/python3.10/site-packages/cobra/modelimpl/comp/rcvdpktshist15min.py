...
class RcvdPktsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPktsHist15min", "received packets")
    ...
    meta.moClassName = "compRcvdPktsHist15min"
    meta.rnFormat = "HDcompRcvdPkts15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5939, PropCategory.REGULAR)
