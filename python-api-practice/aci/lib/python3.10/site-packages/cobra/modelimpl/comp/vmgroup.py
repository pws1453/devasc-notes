...
class VmGroup(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.VmGroup")

    meta.moClassName = "compVmGroup"
    meta.rnFormat = "vmgroup-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster VM Group"
    ...
    prop = PropMeta("str", "name", "name", 52130, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
