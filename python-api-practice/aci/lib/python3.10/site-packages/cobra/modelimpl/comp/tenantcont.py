...
class TenantCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.TenantCont")

    meta.moClassName = "compTenantCont"
    meta.rnFormat = "tenantCont-[%(tenantDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Pending Data path verification Tenant Container"
    ...
    meta.childClasses.add("cobra.model.comp.PendEp")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.PendEp", "pendEp-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34212, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantDn", "tenantDn", 34207, PropCategory.REGULAR)
    prop.label = "Tenant Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    def __init__(self, parentMoOrDn, tenantDn, markDirty=True, **creationProps):
        namingVals = [tenantDn]
