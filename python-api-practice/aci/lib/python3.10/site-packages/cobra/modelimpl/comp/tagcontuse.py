...
class TagContuse(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.TagContuse")

    meta.moClassName = "compTagContuse"
    meta.rnFormat = "tagcontuse"
    ...
    meta.childClasses.add("cobra.model.comp.Categoryuse")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Categoryuse", "catuse-"))
    ...
    prop = PropMeta("str", "descr", "descr", 54130, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "issues", "issues", 54127, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
