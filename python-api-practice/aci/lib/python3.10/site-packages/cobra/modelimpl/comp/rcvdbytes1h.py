...
class RcvdBytes1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytes1h", "received bytes")
    ...
    meta.moClassName = "compRcvdBytes1h"
    meta.rnFormat = "CDcompRcvdBytes1h"
