...
class RcvdPktsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPktsHist1h", "received packets")
    ...
    meta.moClassName = "compRcvdPktsHist1h"
    meta.rnFormat = "HDcompRcvdPkts1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5941, PropCategory.REGULAR)
