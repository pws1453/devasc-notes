...
# ##################################################
class HostStatsHist1w(Mo):
    """
    A class that represents historical statistics for host in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist1w", "host")
    ...
    meta.moClassName = "compHostStatsHist1w"
    meta.rnFormat = "HDcompHostStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 5914, PropCategory.REGULAR)
