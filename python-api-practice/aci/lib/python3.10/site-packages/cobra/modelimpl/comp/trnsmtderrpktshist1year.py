...
# ##################################################
class TrnsmtdErrPktsHist1year(Mo):
    """
    A class that represents historical statistics for transmitted error packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPktsHist1year", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPktsHist1year"
    meta.rnFormat = "HDcompTrnsmtdErrPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical transmitted error packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcompTrnsmtdErrPkts1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 5962, PropCategory.REGULAR)
