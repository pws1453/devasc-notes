...
class ToEPgTask(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.ToEPgTask")

    meta.moClassName = "compToEPgTask"
    meta.rnFormat = "compToEPgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24263, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegRule", "addordelusegrule", 2134)
