...
class RtToNic(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtToNic", "cobra.model.fv.Ep")

    meta.moClassName = "compRtToNic"
    meta.rnFormat = "rtfvToNic-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27654, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27653, PropCategory.REGULAR)
