...
class TagCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.TagCont")

    meta.moClassName = "compTagCont"
    meta.rnFormat = "tagcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Tag Container"
    ...
    meta.childClasses.add("cobra.model.comp.Category")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Category", "cat-"))
    ...
    prop = PropMeta("str", "descr", "descr", 30040, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "issues", "issues", 37101, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37102, PropCategory.REGULAR)
