...
class RtUsegEpPD(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtUsegEpPD", "cobra.model.comp.Nic")

    meta.moClassName = "compRtUsegEpPD"
    meta.rnFormat = "rtusegEpPD-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23481, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23480, PropCategory.REGULAR)
