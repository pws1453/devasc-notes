...
class PolCont(Mo):
    """
    An abstraction of the container for various policies. This object is generated and used only by internal process. 

    """

    meta = ClassMeta("cobra.model.comp.PolCont")

    meta.moClassName = "compPolCont"
    meta.rnFormat = "polCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Controller Policy Container"
    meta.writeAccessMask = 0x5
    meta.readAccessMask = 0x45041000020005
    ...
    meta.childClasses.add("cobra.model.cdp.IfPolDef")
    meta.childClasses.add("cobra.model.comp.DelCont")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.lacp.EnhancedLagPolDef")
    meta.childClasses.add("cobra.model.stp.IfPolDef")
    meta.childClasses.add("cobra.model.comp.StatsPol")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.span.VDestGrpDef")
    meta.childClasses.add("cobra.model.span.VSrcGrpDef")
    meta.childClasses.add("cobra.model.aaa.IDomainRef")
    meta.childClasses.add("cobra.model.comp.PvlanCont")
    meta.childClasses.add("cobra.model.lldp.IfPolDef")
    meta.childClasses.add("cobra.model.netflow.VmmExporterPolDef")
    meta.childClasses.add("cobra.model.comp.UplinkPContDef")
    meta.childClasses.add("cobra.model.lacp.LagPolDef")
    meta.childClasses.add("cobra.model.comp.InstPol")
    meta.childClasses.add("cobra.model.l2.InstPolDef")
    meta.childClasses.add("cobra.model.nws.FwPolDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.netflow.VmmExporterPolDef", "vmmexporterpoldef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.UplinkPContDef", "uplinkpcontdef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.VDestGrpDef", "vdestgrpdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.VSrcGrpDef", "vsrcgrpdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.PvlanCont", "pvlancont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.lldp.IfPolDef", "lldpIfPD-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cdp.IfPolDef", "cdpIfPD-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.EnhancedLagPolDef", "enlagPD-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.StatsPol", "statsPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.IDomainRef", "idomain-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.InstPol", "instPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.DelCont", "delCont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.stp.IfPolDef", "ifPolD-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.InstPolDef", "l2polD-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.LagPolDef", "lagPD-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nws.FwPolDef", "fwPD-"))

    meta.parentClasses.add("cobra.model.vmm.CtrlrP")
    meta.parentClasses.add("cobra.model.comp.Ctrlr")

    meta.superClasses.add("cobra.model.comp.ContE")
    ...
    prop = PropMeta("str", "inherited", "inherited", 55844, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14063, PropCategory.REGULAR)
