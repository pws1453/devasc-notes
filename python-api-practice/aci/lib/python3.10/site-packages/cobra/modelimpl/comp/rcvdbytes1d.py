...
# ##################################################
class RcvdBytes1d(Mo):
    """
    A class that represents the most current statistics for received bytes in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comp.RcvdBytes1d", "received bytes")
    ...
    meta.moClassName = "compRcvdBytes1d"
    meta.rnFormat = "CDcompRcvdBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats in 1 day"
