...
class RsRFltP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsRFltP", "cobra.model.vz.RFltP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsRFltP"
    meta.rnFormat = "rsRFltP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to vzRFltP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24288, PropCategory.REGULAR)
