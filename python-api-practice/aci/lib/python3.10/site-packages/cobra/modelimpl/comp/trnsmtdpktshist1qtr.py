...
class TrnsmtdPktsHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPktsHist1qtr", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPktsHist1qtr"
    meta.rnFormat = "HDcompTrnsmtdPkts1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5968, PropCategory.REGULAR)
