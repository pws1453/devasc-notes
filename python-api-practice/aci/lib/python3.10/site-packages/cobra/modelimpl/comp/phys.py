...
class Phys(Mo):
    """
    A physical host or a compute server.

    """

    meta = ClassMeta("cobra.model.comp.Phys")

    meta.moClassName = "compPhys"
    meta.rnFormat = "phost-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Physical Host"
    ...
    meta.childClasses.add("cobra.model.comp.PpNic")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.comp.LabelVal")
    meta.childClasses.add("cobra.model.comp.RtPhys")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.LabelVal", "lblval-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtPhys", "rtphys"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.PpNic", "nic-"))
    ...
    meta.superClasses.add("cobra.model.comp.PHost")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14067, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 5920, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 1039, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "phys"
