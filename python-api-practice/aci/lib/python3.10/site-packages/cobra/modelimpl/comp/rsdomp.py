...
class RsDomP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsDomP", "cobra.model.vmm.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsDomP"
    meta.rnFormat = "rsdomP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11785, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11784, PropCategory.REGULAR)
