...
class RcvdPkts1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPkts1year", "received packets")
    ...
    meta.moClassName = "compRcvdPkts1year"
    meta.rnFormat = "CDcompRcvdPkts1year"
