...
class TrnsmtdPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPktsHist1w", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPktsHist1w"
    meta.rnFormat = "HDcompTrnsmtdPkts1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5969, PropCategory.REGULAR)
