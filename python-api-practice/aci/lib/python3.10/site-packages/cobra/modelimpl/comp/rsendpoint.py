...
class RsEndpoint(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsEndpoint", "cobra.model.comp.ContGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsEndpoint"
    meta.rnFormat = "rsendpoint-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Service Endpoint"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34039, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34038, PropCategory.REGULAR)
