...
# ##################################################
class TrnsmtdErrPkts1year(Mo):
    """
    A class that represents the most current statistics for transmitted error packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPkts1year", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPkts1year"
    meta.rnFormat = "CDcompTrnsmtdErrPkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted error packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcompTrnsmtdErrPkts1year', False),
    ]
