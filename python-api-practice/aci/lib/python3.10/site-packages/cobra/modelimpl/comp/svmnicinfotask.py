...
# ##################################################
class SvmNicInfoTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.SvmNicInfoTask")

    meta.moClassName = "compSvmNicInfoTask"
    meta.rnFormat = "compSvmNicInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 34691, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendCloudSvmUpdate", "sendcloudsvmupdate", 3199)
    prop._addConstant("sendSvmUpdate", "sendsvmupdate", 2893)
