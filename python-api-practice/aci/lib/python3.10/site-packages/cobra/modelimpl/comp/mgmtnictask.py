...
# ##################################################
class MgmtNicTask(Mo):
    """
    An internal task to collect management NIC information from the external system. For example, a VMware vCenter. This object is generated and used only by internal process

    """

    meta = ClassMeta("cobra.model.comp.MgmtNicTask")

    meta.moClassName = "compMgmtNicTask"
    meta.rnFormat = "compMgmtNicTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5757, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("GetMgmtNicIp", "getmgmtnicip", 184)
