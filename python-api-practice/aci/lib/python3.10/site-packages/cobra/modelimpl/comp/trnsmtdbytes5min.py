...
class TrnsmtdBytes5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdBytes5min", "transmitted bytes")
    ...
    meta.moClassName = "compTrnsmtdBytes5min"
    meta.rnFormat = "CDcompTrnsmtdBytes5min"
