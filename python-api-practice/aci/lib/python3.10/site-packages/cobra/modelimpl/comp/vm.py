...
class Vm(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Vm")

    meta.moClassName = "compVm"
    meta.rnFormat = "vm-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Virtual Machine"
    meta.writeAccessMask = 0x25
    meta.readAccessMask = 0x4000000000000625
    ...
    meta.childClasses.add("cobra.model.comp.RtCDevToVm")
    meta.childClasses.add("cobra.model.comp.TrnsmtdPkts1d")
    meta.childClasses.add("cobra.model.comp.RtAssocObj")
    ...
    meta.childClasses.add("cobra.model.comp.HostStatsHist15min")
    ...
    meta.childClasses.add("cobra.model.comp.HostStats1year")
    ...
    meta.childClasses.add("cobra.model.comp.Cdrom")
    meta.childClasses.add("cobra.model.comp.HostStatsHist1qtr")
    ...
    meta.childClasses.add("cobra.model.comp.RsHv")
    meta.childClasses.add("cobra.model.comp.RtNestedInVm")
    ...
    meta.childClasses.add("cobra.model.comp.LabelVal")
    ...
    meta.childClasses.add("cobra.model.comp.RtFolderToVm")
    meta.childClasses.add("cobra.model.comp.RtVm")
    ...
    meta.childClasses.add("cobra.model.comp.HostStats1w")
    meta.childClasses.add("cobra.model.comp.HostStatsHist1mo")
    meta.childClasses.add("cobra.model.comp.TrnsmtdErrPkts1h")
    meta.childClasses.add("cobra.model.comp.TrnsmtdErrPktsHist1d")
    meta.childClasses.add("cobra.model.comp.RtSvmVm")
    meta.childClasses.add("cobra.model.comp.RcvdPkts1qtr")
    meta.childClasses.add("cobra.model.comp.RtAssocVm")
    ...
    meta.childClasses.add("cobra.model.comp.HostStats1mo")
    meta.childClasses.add("cobra.model.comp.TrnsmtdErrPkts15min")
    meta.childClasses.add("cobra.model.comp.RtToVm")
    meta.childClasses.add("cobra.model.comp.TrnsmtdErrPktsHist1h")
    meta.childClasses.add("cobra.model.comp.VNic")
    ...
    meta.childClasses.add("cobra.model.comp.HostStats15min")
    meta.childClasses.add("cobra.model.comp.TrnsmtdBytes1mo")
    meta.childClasses.add("cobra.model.comp.TrnsmtdErrPktsHist1year")
    meta.childClasses.add("cobra.model.comp.HostStatsHist1w")
    meta.childClasses.add("cobra.model.comp.HostStats1qtr")
    meta.childClasses.add("cobra.model.comp.HostStatsHist1year")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStatsHist15min", "HDcompHostStats15min-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStatsHist1year", "HDcompHostStats1year-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStats1year", "CDcompHostStats1year"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStatsHist1qtr", "HDcompHostStats1qtr-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStats15min", "CDcompHostStats15min"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStatsHist1mo", "HDcompHostStats1mo-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RcvdPkts1year", "CDcompRcvdPkts1year"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStats1qtr", "CDcompHostStats1qtr"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStats1mo", "CDcompHostStats1mo"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStatsHist1w", "HDcompHostStats1w-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStatsHist1d", "HDcompHostStats1d-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStatsHist1h", "HDcompHostStats1h-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStats1w", "CDcompHostStats1w"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStats1d", "CDcompHostStats1d"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RcvdBytes1d", "CDcompRcvdBytes1d"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HostStats1h", "CDcompHostStats1h"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtNestedInVm", "rtnestedInVm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtFolderToVm", "rtFolderToVm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtAssocObj", "rtassocObj-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtCDevToVm", "rtcDevToVm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtAssocVm", "rtassocVm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtToVm", "rtfvToVm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtSvmVm", "rtsvmVm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.LabelVal", "lblval-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtVm", "rtfvVm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Cdrom", "cdrom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsHv", "rshv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.VNic", "vnic-"))
    ...
    meta.superClasses.add("cobra.model.comp.Host")
    ...
    prop = PropMeta("str", "cfgdOs", "cfgdOs", 18597, PropCategory.REGULAR)
    prop.label = "Configured Operating System"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("cfgdOs", prop)
    ...
    prop = PropMeta("str", "ftRole", "ftRole", 45344, PropCategory.REGULAR)
    prop.label = "Fault Tolerance role"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unset"
    prop._addConstant("primary", "primary", 1)
    prop._addConstant("secondary", "secondary", 2)
    prop._addConstant("unset", "ft-not-enabled", 0)
    meta.props.add("ftRole", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14069, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 5974, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "os", "os", 18596, PropCategory.REGULAR)
    prop.label = "Runtime Operating System"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("os", prop)
    ...
    prop = PropMeta("str", "state", "state", 1038, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    prop.defaultValueStr = "disconnected"
    ...
    prop = PropMeta("str", "template", "template", 42656, PropCategory.REGULAR)
    prop.label = "Is it a template or not"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("template", prop)

    prop = PropMeta("str", "type", "type", 1042, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
