...
# ##################################################
class PolContTask(Mo):
    """
    An internal task to send a policy container from one process to another. This object is generated and used only by internal process. 

    """

    meta = ClassMeta("cobra.model.comp.PolContTask")

    meta.moClassName = "compPolContTask"
    meta.rnFormat = "compPolContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5758, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateCtrlrNoOfUplinksPol", "updatectrlrnoofuplinkspol", 3594)
    prop._addConstant("UpdateCtrlrPol", "updatectrlrpol", 143)
