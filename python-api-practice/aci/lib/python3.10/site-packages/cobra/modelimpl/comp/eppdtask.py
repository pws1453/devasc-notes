...
class EpPDTask(Mo):
    """
    An internal system task to send endpoint group description information from one process to another. This object is generated and used only by internal process. 

    """

    meta = ClassMeta("cobra.model.comp.EpPDTask")

    meta.moClassName = "compEpPDTask"
    meta.rnFormat = "compEpPDTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.comp.EpPDContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.EpPDContext", "compEpPD"))
    ...
    prop = PropMeta("str", "id", "id", 5754, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelExtPol", "addordelextpol", 139)
