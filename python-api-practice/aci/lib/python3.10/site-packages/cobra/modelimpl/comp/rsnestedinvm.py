...
# ##################################################
class RsNestedInVm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsNestedInVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "compRsNestedInVm"
    meta.rnFormat = "rsnestedInVm"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Nested In VM"
    ...
    prop = PropMeta("str", "tCl", "tCl", 35535, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 35534, PropCategory.REGULAR)
