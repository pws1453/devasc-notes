...
class VmTask(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.VmTask")

    meta.moClassName = "compVmTask"
    meta.rnFormat = "compVmTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 42690, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PowerOnOrOffVm", "poweronoroffvm", 3231)
    prop._addConstant("none", "none", 0)
    prop._addConstant("updateState", "updatestate", 3122)
