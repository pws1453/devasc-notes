...
# ##################################################
class HvClusterDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvClusterDef")

    meta.moClassName = "compHvClusterDef"
    ...
    meta.childClasses.add("cobra.model.comp.HvGroupDef")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.comp.HvClusterRuleDef")
    meta.childClasses.add("cobra.model.comp.RsHvClusterDefToHvCluster")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsHvClusterDefToHvCluster", "rshvClusterDefToHvCluster"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvGroupDef", "hvgroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvClusterRuleDef", "rule-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52147, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 52126, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
