...
# ##################################################
class RsHvClusterDefToHvCluster(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsHvClusterDefToHvCluster", "cobra.model.comp.HvCluster")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "compRsHvClusterDefToHvCluster"
    meta.rnFormat = "rshvClusterDefToHvCluster"
    ...
    meta.rnPrefixes = [
        ('rshvClusterDefToHvCluster', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 52136, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15258
    prop.defaultValueStr = "compHvCluster"
    prop._addConstant("compHvCluster", None, 15258)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52135, PropCategory.REGULAR)
