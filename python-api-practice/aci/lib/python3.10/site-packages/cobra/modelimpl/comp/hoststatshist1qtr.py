...
# ##################################################
class HostStatsHist1qtr(Mo):
    """
    A class that represents historical statistics for host in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist1qtr", "host")
    ...
    meta.moClassName = "compHostStatsHist1qtr"
    meta.rnFormat = "HDcompHostStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 5913, PropCategory.REGULAR)
