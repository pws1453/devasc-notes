...
# ##################################################
class RsRpToDataStore(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsRpToDataStore", "cobra.model.comp.DataStore")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "compRsRpToDataStore"
    meta.rnFormat = "rsrpToDataStore-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DataStore"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44848, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12364
    prop.defaultValueStr = "compDataStore"
    prop._addConstant("compDataStore", None, 12364)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 44847, PropCategory.REGULAR)
