...
class RcvdPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPktsHist1w", "received packets")
    ...
    meta.moClassName = "compRcvdPktsHist1w"
    meta.rnFormat = "HDcompRcvdPkts1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5944, PropCategory.REGULAR)
