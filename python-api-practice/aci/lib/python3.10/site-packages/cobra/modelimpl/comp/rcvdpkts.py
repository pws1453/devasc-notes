...
# ##################################################
class RcvdPkts(Mo):
    meta = StatsClassMeta("cobra.model.comp.RcvdPkts", "received packets")
    ...
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts1year")
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts1qtr")
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts1w")
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts5min")
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts1h")
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts15min")
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts1mo")
    meta.concreteSubClasses.add("cobra.model.comp.RcvdPkts1d")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bcastAvg", "bcastAvg", 7655, PropCategory.IMPLICIT_AVG)
    prop.label = "received broadcast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastAvg", prop)

    prop = PropMeta("str", "bcastBase", "bcastBase", 7650, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received broadcast packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastBase", prop)

    prop = PropMeta("str", "bcastCum", "bcastCum", 7651, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received broadcast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastCum", prop)

    prop = PropMeta("str", "bcastLast", "bcastLast", 7649, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received broadcast packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastLast", prop)

    prop = PropMeta("str", "bcastMax", "bcastMax", 7654, PropCategory.IMPLICIT_MAX)
    prop.label = "received broadcast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastMax", prop)

    prop = PropMeta("str", "bcastMin", "bcastMin", 7653, PropCategory.IMPLICIT_MIN)
    prop.label = "received broadcast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastMin", prop)

    prop = PropMeta("str", "bcastPer", "bcastPer", 7652, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received broadcast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastPer", prop)

    prop = PropMeta("str", "bcastRate", "bcastRate", 7660, PropCategory.IMPLICIT_RATE)
    prop.label = "received broadcast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastRate", prop)

    prop = PropMeta("str", "bcastSpct", "bcastSpct", 7656, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received broadcast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastSpct", prop)

    prop = PropMeta("str", "bcastThr", "bcastThr", 7657, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bcastTr", "bcastTr", 7659, PropCategory.IMPLICIT_TREND)
    prop.label = "received broadcast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bcastTr", prop)

    prop = PropMeta("str", "bcastTrBase", "bcastTrBase", 7658, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "mcastAvg", "mcastAvg", 7676, PropCategory.IMPLICIT_AVG)
    prop.label = "received multicast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastAvg", prop)

    prop = PropMeta("str", "mcastBase", "mcastBase", 7671, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received multicast packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastBase", prop)

    prop = PropMeta("str", "mcastCum", "mcastCum", 7672, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received multicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastCum", prop)

    prop = PropMeta("str", "mcastLast", "mcastLast", 7670, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received multicast packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastLast", prop)

    prop = PropMeta("str", "mcastMax", "mcastMax", 7675, PropCategory.IMPLICIT_MAX)
    prop.label = "received multicast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastMax", prop)

    prop = PropMeta("str", "mcastMin", "mcastMin", 7674, PropCategory.IMPLICIT_MIN)
    prop.label = "received multicast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastMin", prop)

    prop = PropMeta("str", "mcastPer", "mcastPer", 7673, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received multicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastPer", prop)

    prop = PropMeta("str", "mcastRate", "mcastRate", 7681, PropCategory.IMPLICIT_RATE)
    prop.label = "received multicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastRate", prop)

    prop = PropMeta("str", "mcastSpct", "mcastSpct", 7677, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received multicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastSpct", prop)

    prop = PropMeta("str", "mcastThr", "mcastThr", 7678, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "mcastTr", "mcastTr", 7680, PropCategory.IMPLICIT_TREND)
    prop.label = "received multicast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("mcastTr", prop)

    prop = PropMeta("str", "mcastTrBase", "mcastTrBase", 7679, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "totalAvg", "totalAvg", 7697, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalAvg", prop)

    prop = PropMeta("str", "totalBase", "totalBase", 7692, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalBase", prop)

    prop = PropMeta("str", "totalCum", "totalCum", 7693, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCum", prop)

    prop = PropMeta("str", "totalLast", "totalLast", 7691, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalLast", prop)

    prop = PropMeta("str", "totalMax", "totalMax", 7696, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMax", prop)

    prop = PropMeta("str", "totalMin", "totalMin", 7695, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMin", prop)

    prop = PropMeta("str", "totalPer", "totalPer", 7694, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalPer", prop)

    prop = PropMeta("str", "totalRate", "totalRate", 7702, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalRate", prop)

    prop = PropMeta("str", "totalSpct", "totalSpct", 7698, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalSpct", prop)

    prop = PropMeta("str", "totalThr", "totalThr", 7699, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalTr", "totalTr", 7701, PropCategory.IMPLICIT_TREND)
    prop.label = "received packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalTr", prop)

    prop = PropMeta("str", "totalTrBase", "totalTrBase", 7700, PropCategory.IMPLICIT_TREND_BASE)
