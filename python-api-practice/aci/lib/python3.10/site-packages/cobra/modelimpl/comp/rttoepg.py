...
class RtToEPg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtToEPg", "cobra.model.comp.ToEPg")

    meta.moClassName = "compRtToEPg"
    meta.rnFormat = "rttoEPg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23527, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23526, PropCategory.REGULAR)
