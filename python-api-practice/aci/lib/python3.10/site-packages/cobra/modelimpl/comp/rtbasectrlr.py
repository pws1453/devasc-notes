...
# ##################################################
class RtBaseCtrlr(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.comp.RtBaseCtrlr", "cobra.model.vmm.CtrlrPDef")

    meta.moClassName = "compRtBaseCtrlr"
    meta.rnFormat = "rtvmmBaseCtrlr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19037, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19036, PropCategory.REGULAR)
