...
class RsHv(Mo):
    """
    A source relation to the compute hypervisor.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsHv"
    meta.rnFormat = "rshv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11802, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11801, PropCategory.REGULAR)
