...
class RcvdPkts1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPkts1mo", "received packets")
    ...
    meta.moClassName = "compRcvdPkts1mo"
    meta.rnFormat = "CDcompRcvdPkts1mo"
