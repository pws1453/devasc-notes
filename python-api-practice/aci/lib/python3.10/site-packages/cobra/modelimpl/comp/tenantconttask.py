...
# ##################################################
class TenantContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.TenantContTask")

    meta.moClassName = "compTenantContTask"
    meta.rnFormat = "compTenantContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 34209, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ValidateEp", "validateep", 2845)
