...
class LabelVal(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.LabelVal")

    meta.moClassName = "compLabelVal"
    meta.rnFormat = "lblval-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Custom Attributes"
    ...
    meta.childClasses.add("cobra.model.comp.RsDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsDef", "rsdef"))
    ...
    meta.parentClasses.add("cobra.model.comp.VmFolder")
    ...
    meta.superClasses.add("cobra.model.comp.ALabel")
    ...
    prop = PropMeta("str", "oid", "oid", 19780, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 19778, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
