...
class VmFolder(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.VmFolder")

    meta.moClassName = "compVmFolder"
    meta.rnFormat = "vmFolder-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Virtual Machine Folder"
    ...
    meta.childClasses.add("cobra.model.comp.RsAssocVm")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsAssocVm", "rsassocVm-"))
    ...
    prop = PropMeta("str", "oid", "oid", 37248, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 1037, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
