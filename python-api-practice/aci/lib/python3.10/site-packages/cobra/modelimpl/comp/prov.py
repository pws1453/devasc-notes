...
class Prov(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Prov")

    meta.moClassName = "compProv"
    ...
    meta.childClasses.add("cobra.model.comp.Ctrlr")
    meta.childClasses.add("cobra.model.comp.Dom")
    meta.childClasses.add("cobra.model.comp.RsProvP")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsProvP", "rsprovP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Ctrlr", "ctrlr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14061, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 5922, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vendor", "vendor", 1007, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
