...
class RsCtrlr(Mo):
    """
    A source relation to the VM management system controller. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsCtrlr", "cobra.model.comp.Ctrlr")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsCtrlr"
    meta.rnFormat = "rsctrlr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "hostOrIp", "hostOrIp", 11790, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14065, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "oid", "oid", 11791, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11789, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1275
    prop.defaultValueStr = "compCtrlr"
    prop._addConstant("compCtrlr", None, 1275)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11788, PropCategory.REGULAR)
