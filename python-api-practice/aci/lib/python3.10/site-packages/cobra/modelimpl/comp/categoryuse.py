...
# ##################################################
class Categoryuse(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.Categoryuse")

    meta.moClassName = "compCategoryuse"
    meta.rnFormat = "catuse-%(name)s"
    ...
    meta.childClasses.add("cobra.model.comp.Taguse")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Taguse", "taguse-"))

    meta.parentClasses.add("cobra.model.comp.TagContuse")
    ...
    prop = PropMeta("str", "categoryDn", "categoryDn", 54128, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("categoryDn", prop)
    ...
    prop = PropMeta("str", "name", "name", 54131, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
