...
# ##################################################
class HvClusterRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvClusterRule")

    meta.moClassName = "compHvClusterRule"
    meta.rnFormat = "rule-%(key)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster affinity rule"
    ...
    meta.parentClasses.add("cobra.model.comp.HvCluster")

    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.comp.Entity")
    meta.superClasses.add("cobra.model.naming.NamedIdentifiedObject")
    meta.superClasses.add("cobra.model.comp.NameIdentEntity")

    meta.rnPrefixes = [
        ('rule-', True),
    ]

    prop = PropMeta("str", "antiAffinity", "antiAffinity", 52121, PropCategory.REGULAR)
    prop.label = "None"
    ...
    meta.props.add("antiAffinity", prop)
    ...
    prop = PropMeta("str", "enabled", "enabled", 52122, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("enabled", prop)

    prop = PropMeta("str", "hvGroup", "hvGroup", 52119, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("hvGroup", prop)
    ...
    prop = PropMeta("str", "key", "key", 52117, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mandatory", "mandatory", 52120, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "name", "name", 52110, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 80)]
    ...
    prop = PropMeta("str", "vmGroup", "vmGroup", 52118, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("vmGroup", prop)
