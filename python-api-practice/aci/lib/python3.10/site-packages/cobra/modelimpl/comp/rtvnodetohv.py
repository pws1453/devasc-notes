...
# ##################################################
class RtVNodeToHv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.comp.RtVNodeToHv", "cobra.model.fv.VNode")

    meta.moClassName = "compRtVNodeToHv"
    meta.rnFormat = "rtfvVNodeToHv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27804, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27803, PropCategory.REGULAR)
