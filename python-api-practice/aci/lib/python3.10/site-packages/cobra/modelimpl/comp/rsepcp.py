...
class RsEpCP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsEpCP", "cobra.model.fv.EpCP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsEpCP"
    meta.rnFormat = "rsEpCP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to fvEpCP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24287, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24286, PropCategory.REGULAR)
