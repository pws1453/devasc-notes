...
# ##################################################
class TrnsmtdErrPkts1w(Mo):
    """
    A class that represents the most current statistics for transmitted error packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPkts1w", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPkts1w"
    meta.rnFormat = "CDcompTrnsmtdErrPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted error packets stats in 1 week"
