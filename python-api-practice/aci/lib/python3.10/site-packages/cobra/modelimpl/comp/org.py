...
class Org(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Org")

    meta.moClassName = "compOrg"
    ...
    meta.childClasses.add("cobra.model.comp.OrgUnit")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.OrgUnit", "unit-"))
    ...
    prop = PropMeta("str", "domName", "domName", 36352, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "guid", "guid", 36351, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 36360, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
