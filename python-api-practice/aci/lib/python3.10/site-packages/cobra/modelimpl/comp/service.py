...
class Service(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsEndpoint", "rsendpoint-"))
    ...
    prop = PropMeta("str", "clusterIp", "clusterIp", 33731, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "namespace", "namespace", 34200, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
