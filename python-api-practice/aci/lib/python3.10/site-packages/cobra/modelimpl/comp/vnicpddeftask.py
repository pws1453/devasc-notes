...
# ##################################################
class VNicPDDefTask(Mo):
    """
    An internal task to send vNIC policy from one process to another. This object is generated and used only by internal process. 

    """

    meta = ClassMeta("cobra.model.comp.VNicPDDefTask")

    meta.moClassName = "compVNicPDDefTask"
    meta.rnFormat = "compVNicPDDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5761, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VNicUpdate", "vnicupdate", 140)
