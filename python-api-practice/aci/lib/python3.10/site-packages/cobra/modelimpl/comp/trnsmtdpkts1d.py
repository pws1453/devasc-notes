...
class TrnsmtdPkts1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPkts1d", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPkts1d"
    meta.rnFormat = "CDcompTrnsmtdPkts1d"
