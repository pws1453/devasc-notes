...
# ##################################################
class HostStatsHist1d(Mo):
    """
    A class that represents historical statistics for host in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist1d", "host")
    ...
    meta.moClassName = "compHostStatsHist1d"
    meta.rnFormat = "HDcompHostStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 5910, PropCategory.REGULAR)
