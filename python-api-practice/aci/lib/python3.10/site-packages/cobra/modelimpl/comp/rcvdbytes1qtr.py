...
class RcvdBytes1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytes1qtr", "received bytes")
    ...
    meta.moClassName = "compRcvdBytes1qtr"
    meta.rnFormat = "CDcompRcvdBytes1qtr"
