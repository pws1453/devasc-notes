...
# ##################################################
class HvClusterDefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvClusterDefTask")

    meta.moClassName = "compHvClusterDefTask"
    meta.rnFormat = "compHvClusterDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 52124, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PostHvClusterRules", "posthvclusterrules", 3476)
