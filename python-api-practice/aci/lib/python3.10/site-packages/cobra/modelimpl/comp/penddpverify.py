...
# ##################################################
class PendDpVerify(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.PendDpVerify")

    meta.moClassName = "compPendDpVerify"
    meta.rnFormat = "pendDpVerify"
    meta.category = MoCategory.REGULAR
    meta.label = "Pending Data path verification Container"
    ...
    meta.childClasses.add("cobra.model.comp.TenantCont")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.TenantCont", "tenantCont-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34211, PropCategory.REGULAR)
