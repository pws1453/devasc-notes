...
class RcvdPktsHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPktsHist5min", "received packets")
    ...
    meta.moClassName = "compRcvdPktsHist5min"
    meta.rnFormat = "HDcompRcvdPkts5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5946, PropCategory.REGULAR)
