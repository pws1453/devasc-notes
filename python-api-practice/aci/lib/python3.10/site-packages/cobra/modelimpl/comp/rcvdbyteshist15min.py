...
class RcvdBytesHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdBytesHist15min", "received bytes")
    ...
    meta.moClassName = "compRcvdBytesHist15min"
    meta.rnFormat = "HDcompRcvdBytes15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5923, PropCategory.REGULAR)
