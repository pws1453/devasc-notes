...
# ##################################################
class RsHealthDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsHealthDef", "cobra.model.comp.HvHealthDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "compRsHealthDef"
    meta.rnFormat = "rshealthDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Health Status"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44744, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12970
    prop.defaultValueStr = "compHvHealthDef"
    prop._addConstant("compHvHealthDef", None, 12970)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 44743, PropCategory.REGULAR)
