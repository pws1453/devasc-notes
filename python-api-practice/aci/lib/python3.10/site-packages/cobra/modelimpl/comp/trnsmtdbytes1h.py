...
class TrnsmtdBytes1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdBytes1h", "transmitted bytes")
    ...
    meta.moClassName = "compTrnsmtdBytes1h"
    meta.rnFormat = "CDcompTrnsmtdBytes1h"
