...
class RcvdPktsHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPktsHist1qtr", "received packets")
    ...
    meta.moClassName = "compRcvdPktsHist1qtr"
    meta.rnFormat = "HDcompRcvdPkts1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5943, PropCategory.REGULAR)
