...
class LsNodeRef(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.LsNodeRef")

    meta.moClassName = "compLsNodeRef"
    meta.rnFormat = "lnref-[%(lsnodeKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Reference MO to track loose node"
    ...
    prop = PropMeta("str", "lsnodeKey", "lsnodeKey", 49819, PropCategory.REGULAR)
    prop.label = "fabricLooseNode Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("lsnodeKey", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "lsnodeKey"))
    getattr(meta.props, "lsnodeKey").needDelimiter = True

    def __init__(self, parentMoOrDn, lsnodeKey, markDirty=True, **creationProps):
        namingVals = [lsnodeKey]
