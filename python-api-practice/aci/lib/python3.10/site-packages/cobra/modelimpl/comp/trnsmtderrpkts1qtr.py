...
# ##################################################
class TrnsmtdErrPkts1qtr(Mo):
    """
    A class that represents the most current statistics for transmitted error packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPkts1qtr", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPkts1qtr"
    meta.rnFormat = "CDcompTrnsmtdErrPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted error packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcompTrnsmtdErrPkts1qtr', False),
    ]
