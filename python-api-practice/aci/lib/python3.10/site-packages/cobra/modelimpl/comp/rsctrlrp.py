...
class RsCtrlrP(Mo):
    """
    A source relation to the VMM controller profile.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsCtrlrP", "cobra.model.vmm.CtrlrP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsCtrlrP"
    meta.rnFormat = "rsctrlrP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VMM Controller Profile"
    ...
    prop = PropMeta("str", "deployIssues", "deployIssues", 16110, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14058, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11777, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2150
    prop.defaultValueStr = "vmmCtrlrP"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmCtrlrP", None, 2150)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11776, PropCategory.REGULAR)
