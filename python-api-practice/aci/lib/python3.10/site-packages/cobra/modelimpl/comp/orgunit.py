...
class OrgUnit(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.OrgUnit")

    meta.moClassName = "compOrgUnit"
    ...
    meta.parentClasses.add("cobra.model.comp.Org")
    ...
    prop = PropMeta("str", "domName", "domName", 36354, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "guid", "guid", 36353, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 36361, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "orgName", "orgName", 36355, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
