...
# ##################################################
class MigratingVmCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.MigratingVmCont")

    meta.moClassName = "compMigratingVmCont"
    meta.rnFormat = "migratingVmCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Migrating VM Container"
    ...
    meta.childClasses.add("cobra.model.comp.MigratingVm")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.MigratingVm", "migratingVm-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44668, PropCategory.REGULAR)
