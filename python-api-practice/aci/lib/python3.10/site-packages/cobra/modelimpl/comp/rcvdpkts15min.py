...
class RcvdPkts15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPkts15min", "received packets")
    ...
    meta.moClassName = "compRcvdPkts15min"
    meta.rnFormat = "CDcompRcvdPkts15min"
    ...
    meta.superClasses.add("cobra.model.comp.RcvdPkts")

    meta.rnPrefixes = [
        ('CDcompRcvdPkts15min', False),
    ]
