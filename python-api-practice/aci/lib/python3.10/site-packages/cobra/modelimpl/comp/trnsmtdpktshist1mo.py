...
class TrnsmtdPktsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPktsHist1mo", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPktsHist1mo"
    meta.rnFormat = "HDcompTrnsmtdPkts1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5967, PropCategory.REGULAR)
