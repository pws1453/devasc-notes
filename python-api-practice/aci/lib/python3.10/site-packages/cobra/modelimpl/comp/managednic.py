...
class ManagedNic(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.ManagedNic")

    meta.moClassName = "compManagedNic"
    meta.rnFormat = "mnic-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "managed HpNic MO"
    ...
    prop = PropMeta("str", "hostId", "hostId", 52324, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "mac", "mac", 49817, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nicKey", "nicKey", 49818, PropCategory.REGULAR)
    prop.label = "HpNic Dn"
    prop.isImplicit = True
    prop.isAdmin = True
