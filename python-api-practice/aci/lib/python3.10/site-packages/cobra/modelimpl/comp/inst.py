...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Inst")

    meta.moClassName = "compInst"
    meta.rnFormat = "inst-[%(cDevDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 device"
    ...
    meta.childClasses.add("cobra.model.comp.VNicConf")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.VNicConf", "vnicConf-"))
    ...
    prop = PropMeta("str", "cDevDn", "cDevDn", 42663, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("cDevDn", prop)
    ...
    prop = PropMeta("str", "host", "host", 44762, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "instPolDn", "instPolDn", 42664, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("instPolDn", prop)
    ...
    prop = PropMeta("str", "ldev", "ldev", 44763, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("ldev", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "password", "password", 43592, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "policyChangeCount", "policyChangeCount", 44552, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "remoteErrMsg", "remoteErrMsg", 42666, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "state", "state", 42665, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "userName", "userName", 43591, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "vmDeploymentStatus", "vmDeploymentStatus", 42667, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("deploymentfailure", "deploymentfailure", 3)
    prop._addConstant("prepisofile", "prepisofile", 1)
    prop._addConstant("redeploying", "redeploying", 4)
    prop._addConstant("vmcreated", "vmcreated", 2)
    meta.props.add("vmDeploymentStatus", prop)

    prop = PropMeta("str", "vmName", "vmName", 42662, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    meta.namingProps.append(getattr(meta.props, "cDevDn"))
    getattr(meta.props, "cDevDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, cDevDn, markDirty=True, **creationProps):
        namingVals = [cDevDn]
