...
class EpCPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.EpCPTask")

    meta.moClassName = "compEpCPTask"
    meta.rnFormat = "compEpCPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24261, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegEpCP", "addordelusegepcp", 2136)
