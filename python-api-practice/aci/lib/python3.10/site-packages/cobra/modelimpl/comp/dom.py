...
class Dom(Mo):
    """
    An abstract base class for a VM management system domain.

    """

    meta = ClassMeta("cobra.model.comp.Dom")

    meta.moClassName = "compDom"
    ...
    meta.childClasses.add("cobra.model.comp.RsDomP")
    meta.childClasses.add("cobra.model.aaa.DomainRef")
    meta.childClasses.add("cobra.model.comp.RtDom")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsDomP", "rsdomP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtDom", "rtdom-"))
    ...
    prop = PropMeta("str", "enableAVE", "enableAVE", 35606, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 1008, PropCategory.REGULAR)
    prop.label = "Mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14062, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 5907, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
