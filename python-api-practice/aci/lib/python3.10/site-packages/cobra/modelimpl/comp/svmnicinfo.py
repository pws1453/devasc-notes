...
class SvmNicInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.SvmNicInfo")

    meta.moClassName = "compSvmNicInfo"
    meta.rnFormat = "svm-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SVM NIC Info"
    ...
    meta.childClasses.add("cobra.model.comp.RsSvmVm")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsSvmVm", "rsSvmVm"))
    ...
    prop = PropMeta("str", "lNodeDn", "lNodeDn", 34690, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 34689, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "svmMgmtIp", "svmMgmtIp", 36830, PropCategory.REGULAR)
    prop.label = "IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("svmMgmtIp", prop)

    prop = PropMeta("str", "type", "type", 44506, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "vmPKey", "vmPKey", 34688, PropCategory.REGULAR)
    prop.label = "vm DN"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("vmPKey", prop)
