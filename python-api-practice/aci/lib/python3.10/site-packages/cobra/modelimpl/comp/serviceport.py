...
# ##################################################
class ServicePort(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ServicePort")

    meta.moClassName = "compServicePort"
    meta.rnFormat = "p-%(port)s-prot-%(protocol)s-t-%(targetPort)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Service Port"
    ...
    meta.parentClasses.add("cobra.model.comp.Service")
    ...
    prop = PropMeta("str", "nodePort", "nodePort", 33736, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    ...
    meta.props.add("nodePort", prop)

    prop = PropMeta("str", "port", "port", 33733, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "protocol", "protocol", 33734, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "targetPort", "targetPort", 33735, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.range = [(1, 512)]
    meta.props.add("targetPort", prop)

    meta.namingProps.append(getattr(meta.props, "port"))
    meta.namingProps.append(getattr(meta.props, "protocol"))
    meta.namingProps.append(getattr(meta.props, "targetPort"))

    def __init__(self, parentMoOrDn, port, protocol, targetPort, markDirty=True, **creationProps):
        namingVals = [port, protocol, targetPort]
