...
# ##################################################
class HostResourcePool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HostResourcePool")

    meta.moClassName = "compHostResourcePool"
    meta.rnFormat = "hostRpool-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.hvs.StdExtPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.StdExtPol", "stdExtpol-"))
    ...
    prop = PropMeta("str", "oid", "oid", 45210, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
