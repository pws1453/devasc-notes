...
class DNic(Mo):
    """
    A discovered network interface card or an endpoint. Note that this is an internal object.

    """

    meta = ClassMeta("cobra.model.comp.DNic")

    meta.moClassName = "compDNic"
    meta.rnFormat = "dnic-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Discovered NIC"
    ...
    prop = PropMeta("str", "mac", "mac", 5906, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14056, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "physIf", "physIf", 976, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("physIf", prop)
