...
class TrnsmtdBytes1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdBytes1d", "transmitted bytes")
    ...
    meta.moClassName = "compTrnsmtdBytes1d"
    meta.rnFormat = "CDcompTrnsmtdBytes1d"
