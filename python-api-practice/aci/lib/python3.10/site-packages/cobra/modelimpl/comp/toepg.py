...
class ToEPg(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.ToEPg")

    meta.moClassName = "compToEPg"
    meta.rnFormat = "toepg-[%(epgDn)s]"
    ...
    meta.childClasses.add("cobra.model.comp.RsToEPgAtt")
    meta.childClasses.add("cobra.model.comp.RsRFltAtt")
    meta.childClasses.add("cobra.model.comp.RtToEPgAtt")
    meta.childClasses.add("cobra.model.comp.RsToEPg")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsToEPgAtt", "rsToEPgAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsRFltAtt", "rsRFltAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtToEPgAtt", "rtToEPgAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsToEPg", "rsToEPg"))
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 23411, PropCategory.REGULAR)
    prop.label = "To EPg Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23542, PropCategory.REGULAR)
