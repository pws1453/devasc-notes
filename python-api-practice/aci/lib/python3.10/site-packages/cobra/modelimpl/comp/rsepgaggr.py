...
class RsEpgAggr(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsEpgAggr", "cobra.model.comp.AAppEpPD")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsEpgAggr"
    meta.rnFormat = "rsepgAggr-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EPG aggregator membership"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25799, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1261
    prop.defaultValueStr = "compAAppEpPD"
    ...
    prop = PropMeta("str", "tDn", "tDn", 25798, PropCategory.REGULAR)
