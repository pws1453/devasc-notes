...
# ##################################################
class HostStats1d(Mo):
    """
    A class that represents the most current statistics for host in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStats1d", "host")
    ...
    meta.moClassName = "compHostStats1d"
    meta.rnFormat = "CDcompHostStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host stats in 1 day"
