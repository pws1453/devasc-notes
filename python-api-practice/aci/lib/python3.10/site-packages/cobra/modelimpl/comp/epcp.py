...
class EpCP(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.EpCP")

    meta.moClassName = "compEpCP"
    meta.rnFormat = "epcp"
    ...
    meta.childClasses.add("cobra.model.comp.RsEpCP")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.comp.RtEpCPAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtEpCPAtt", "rtEpCPAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsEpCP", "rsEpCP"))
    ...
    prop = PropMeta("str", "CrtrnEnabled", "CrtrnEnabled", 24255, PropCategory.REGULAR)
    prop.label = "whether attribute EPG"
    ...
    prop = PropMeta("str", "epcpDn", "epcpDn", 24254, PropCategory.REGULAR)
    prop.label = "vzEpCP Dn"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("epcpDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24292, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "remoteOperIssues", "remoteOperIssues", 24256, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
