...
class RsAssocObj(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsAssocObj", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsAssocObj"
    meta.rnFormat = "rsassocObj-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.comp.Tag")
    ...
    prop = PropMeta("str", "tCl", "tCl", 30044, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30043, PropCategory.REGULAR)
