...
class RcvdPkts5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPkts5min", "received packets")
    ...
    meta.moClassName = "compRcvdPkts5min"
    meta.rnFormat = "CDcompRcvdPkts5min"
