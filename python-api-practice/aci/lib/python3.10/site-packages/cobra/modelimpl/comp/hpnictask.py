...
class HpNicTask(Mo):
    """
    A task to pull physical interface information. This is used internally by the system.

    """

    meta = ClassMeta("cobra.model.comp.HpNicTask")

    meta.moClassName = "compHpNicTask"
    meta.rnFormat = "compHpNicTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5755, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelVtepNic", "addordelvtepnic", 153)
    prop._addConstant("UpdateHostVendorConfig", "updatehostvendorconfig", 159)
