...
class RsNicAdj(Mo):
    """
    A source relation to the connectivity to the external network. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsNicAdj", "cobra.model.hvs.Adj")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsNicAdj"
    meta.rnFormat = "rsnicAdj-[%(tDn)s]"
    ...
    prop = PropMeta("str", "ifId", "ifId", 32639, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11758, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 111
    prop.defaultValueStr = "hvsAdj"
    prop._addConstant("hvsAdj", None, 111)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11757, PropCategory.REGULAR)
