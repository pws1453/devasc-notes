...
# ##################################################
class TrnsmtdErrPktsHist1qtr(Mo):
    """
    A class that represents historical statistics for transmitted error packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPktsHist1qtr", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPktsHist1qtr"
    meta.rnFormat = "HDcompTrnsmtdErrPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical transmitted error packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 5960, PropCategory.REGULAR)
