...
# ##################################################
class DomP(Mo):
    meta = ClassMeta("cobra.model.comp.DomP")

    meta.isAbstract = True
    meta.moClassName = "compDomP"


    meta.moClassName = "compDomP"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Domain Profile"
    ...
    prop = PropMeta("str", "name", "name", 1030, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
