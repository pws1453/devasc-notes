...
class Folder(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Folder")

    meta.moClassName = "compFolder"
    meta.rnFormat = "folder-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.comp.RsFolderToVm")
    meta.childClasses.add("cobra.model.comp.Folder")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsFolderToVm", "rsfolderToVm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Folder", "folder-"))

    meta.parentClasses.add("cobra.model.comp.Folder")
    meta.parentClasses.add("cobra.model.comp.VmFolderCont")
    ...
    prop = PropMeta("str", "oid", "oid", 54113, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "path", "path", 54111, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
