...
# ##################################################
class TrnsmtdErrPkts1mo(Mo):
    """
    A class that represents the most current statistics for transmitted error packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPkts1mo", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPkts1mo"
    meta.rnFormat = "CDcompTrnsmtdErrPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted error packets stats in 1 month"
