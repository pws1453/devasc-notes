...
# ##################################################
class HostStats1qtr(Mo):
    """
    A class that represents the most current statistics for host in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStats1qtr", "host")
    ...
    meta.moClassName = "compHostStats1qtr"
    meta.rnFormat = "CDcompHostStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host stats in 1 quarter"
