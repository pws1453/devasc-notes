...
# ##################################################
class MigratingVm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.MigratingVm")

    meta.moClassName = "compMigratingVm"
    meta.rnFormat = "migratingVm-[%(vmDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "pointer to migrating Vm"
    ...
    prop = PropMeta("str", "vmDn", "vmDn", 44666, PropCategory.REGULAR)
    prop.label = "compVm Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("vmDn", prop)

    meta.namingProps.append(getattr(meta.props, "vmDn"))
    getattr(meta.props, "vmDn").needDelimiter = True

    def __init__(self, parentMoOrDn, vmDn, markDirty=True, **creationProps):
        namingVals = [vmDn]
