...
class RFltPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.RFltPTask")

    meta.moClassName = "compRFltPTask"
    meta.rnFormat = "compRFltPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24262, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegRfltp", "addordelusegrfltp", 2135)
