...
class RsRpToHost(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsRpToHost", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "compRsRpToHost"
    meta.rnFormat = "rsrpToHost-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44850, PropCategory.REGULAR)
