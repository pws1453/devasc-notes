...
# ##################################################
class FaultyExtPolCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.FaultyExtPolCont")

    meta.moClassName = "compFaultyExtPolCont"
    meta.rnFormat = "faultyExtPolCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Faulty ExtPol Container"
    ...
    meta.childClasses.add("cobra.model.comp.FaultyExtPolRef")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.FaultyExtPolRef", "faultyExtPolRef-"))
