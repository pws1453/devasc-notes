...
# ##################################################
class TrnsmtdErrPktsHist15min(Mo):
    """
    A class that represents historical statistics for transmitted error packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPktsHist15min", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPktsHist15min"
    meta.rnFormat = "HDcompTrnsmtdErrPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical transmitted error packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDcompTrnsmtdErrPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 5956, PropCategory.REGULAR)
