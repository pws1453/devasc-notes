...
class TrnsmtdBytes15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.TrnsmtdBytes15min", "transmitted bytes")
    ...
    meta.moClassName = "compTrnsmtdBytes15min"
    meta.rnFormat = "CDcompTrnsmtdBytes15min"
