...
class RsMgmtPol(Mo):
    """
    A source relation to the common policies for the VM interfaces. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsMgmtPol", "cobra.model.hvs.ExtPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsMgmtPol"
    meta.rnFormat = "rsmgmtPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11773, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11772, PropCategory.REGULAR)
