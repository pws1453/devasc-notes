...
class RsPhys(Mo):
    """
    A source relation to a physical host or compute server. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsPhys", "cobra.model.comp.Phys")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "compRsPhys"
    meta.rnFormat = "rsphys"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11799, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1290
    prop.defaultValueStr = "compPhys"
    prop._addConstant("compPhys", None, 1290)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11798, PropCategory.REGULAR)
