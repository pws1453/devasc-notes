...
# ##################################################
class PendResEpCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.PendResEpCont")

    meta.moClassName = "compPendResEpCont"
    meta.rnFormat = "pendResEpCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Pending Resolve Container"
