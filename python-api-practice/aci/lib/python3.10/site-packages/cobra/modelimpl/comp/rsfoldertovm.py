...
# ##################################################
class RsFolderToVm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsFolderToVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "compRsFolderToVm"
    meta.rnFormat = "rsfolderToVm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54114, PropCategory.REGULAR)
