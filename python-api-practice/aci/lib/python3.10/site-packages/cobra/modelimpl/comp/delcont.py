...
class DelCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.DelCont")

    meta.moClassName = "compDelCont"
    meta.rnFormat = "delCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Delimiter Container"
    ...
    meta.childClasses.add("cobra.model.comp.DelInfo")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.DelInfo", "delInfo-"))
