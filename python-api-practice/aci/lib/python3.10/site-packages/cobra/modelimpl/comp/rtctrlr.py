...
class RtCtrlr(Mo):
    """
    A target relation to the VM management system controller. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.comp.RtCtrlr", "cobra.model.comp.Ctrlr")

    meta.moClassName = "compRtCtrlr"
    meta.rnFormat = "rtctrlr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11793, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11792, PropCategory.REGULAR)
