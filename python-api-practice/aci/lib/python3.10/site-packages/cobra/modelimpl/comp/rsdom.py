...
class RsDom(Mo):
    """
    A source relation to the VM management system domain. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsDom", "cobra.model.comp.Dom")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsDom"
    meta.rnFormat = "rsDom"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11795, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11794, PropCategory.REGULAR)
