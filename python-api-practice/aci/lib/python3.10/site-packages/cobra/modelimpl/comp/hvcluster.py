...
class HvCluster(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.HvCluster")

    meta.moClassName = "compHvCluster"
    meta.rnFormat = "hvcluster-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Hypervisor Cluster"
    ...
    meta.childClasses.add("cobra.model.comp.HvGroup")
    meta.childClasses.add("cobra.model.comp.RtHvCluster")
    meta.childClasses.add("cobra.model.comp.HvClusterRule")
    meta.childClasses.add("cobra.model.comp.RtHvClusterDefToHvCluster")
    meta.childClasses.add("cobra.model.comp.VmGroup")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHvClusterDefToHvCluster", "rthvClusterDefToHvCluster"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHvCluster", "rthvCluster-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvGroup", "hvgroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.VmGroup", "vmgroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvClusterRule", "rule-"))
    ...
    prop = PropMeta("str", "drs", "drs", 52115, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "oid", "oid", 52125, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "proactiveHa", "proactiveHa", 52116, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("proactiveHa", prop)
