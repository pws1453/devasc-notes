...
# ##################################################
class L3ExtAttachPortTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.L3ExtAttachPortTask")

    meta.moClassName = "compL3ExtAttachPortTask"
    meta.rnFormat = "compL3ExtAttachPortTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.comp.L3ExtAttachPortContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.L3ExtAttachPortContext", "compL3ExtAttachPort"))
    ...
    prop = PropMeta("str", "id", "id", 54064, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("resolveL3ExtVirtualLIfP", "resolvel3extvirtuallifp", 3558)
