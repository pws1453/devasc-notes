...
# ##################################################
class HostStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.comp.HostStatsHist", "host")
    ...
    meta.moClassName = "compHostStatsHist"


    meta.moClassName = "compHostStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats"
    ...
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.comp.HostStatsHist1h")
    ...
    prop = PropMeta("str", "cpuUsageAvg", "cpuUsageAvg", 7567, PropCategory.IMPLICIT_AVG)
    prop.label = "CPU usage average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cpuUsageAvg", prop)

    prop = PropMeta("str", "cpuUsageMax", "cpuUsageMax", 7566, PropCategory.IMPLICIT_MAX)
    prop.label = "CPU usage maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cpuUsageMax", prop)

    prop = PropMeta("str", "cpuUsageMin", "cpuUsageMin", 7565, PropCategory.IMPLICIT_MIN)
    prop.label = "CPU usage minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cpuUsageMin", prop)

    prop = PropMeta("str", "cpuUsageSpct", "cpuUsageSpct", 7568, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "CPU usage suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cpuUsageSpct", prop)

    prop = PropMeta("str", "cpuUsageThr", "cpuUsageThr", 7569, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "cpuUsageTr", "cpuUsageTr", 7570, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "memUsageAvg", "memUsageAvg", 7582, PropCategory.IMPLICIT_AVG)
    prop.label = "memory usage average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("memUsageAvg", prop)

    prop = PropMeta("str", "memUsageMax", "memUsageMax", 7581, PropCategory.IMPLICIT_MAX)
    prop.label = "memory usage maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("memUsageMax", prop)

    prop = PropMeta("str", "memUsageMin", "memUsageMin", 7580, PropCategory.IMPLICIT_MIN)
    prop.label = "memory usage minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("memUsageMin", prop)

    prop = PropMeta("str", "memUsageSpct", "memUsageSpct", 7583, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "memory usage suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("memUsageSpct", prop)

    prop = PropMeta("str", "memUsageThr", "memUsageThr", 7584, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "memUsageTr", "memUsageTr", 7585, PropCategory.IMPLICIT_TREND)
