...
# ##################################################
class TrnsmtdPktsHist1d(Mo):
    """
    A class that represents historical statistics for transmitted packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdPktsHist1d", "transmitted packets")
    ...
    meta.moClassName = "compTrnsmtdPktsHist1d"
    meta.rnFormat = "HDcompTrnsmtdPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical transmitted packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 5965, PropCategory.REGULAR)
