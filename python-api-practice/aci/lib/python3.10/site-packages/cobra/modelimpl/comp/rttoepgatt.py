...
class RtToEPgAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtToEPgAtt", "cobra.model.hvs.Rule")

    meta.moClassName = "compRtToEPgAtt"
    meta.rnFormat = "rtToEPgAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24274, PropCategory.REGULAR)
