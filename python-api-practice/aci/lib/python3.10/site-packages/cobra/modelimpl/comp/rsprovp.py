...
class RsProvP(Mo):
    """
    A source relation to the VMM provider profile. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.comp.RsProvP", "cobra.model.vmm.ProvP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsProvP"
    meta.rnFormat = "rsprovP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11781, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2135
    prop.defaultValueStr = "vmmProvP"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmProvP", None, 2135)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11780, PropCategory.REGULAR)
