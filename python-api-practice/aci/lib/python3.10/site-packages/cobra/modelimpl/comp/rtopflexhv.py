...
class RtOpflexHv(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtOpflexHv", "cobra.model.fv.VNode")

    meta.moClassName = "compRtOpflexHv"
    meta.rnFormat = "rtopflexHv"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21522, PropCategory.REGULAR)
