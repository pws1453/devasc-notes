...
# ##################################################
class HostStats5min(Mo):
    """
    A class that represents the most current statistics for host in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStats5min", "host")
    ...
    meta.moClassName = "compHostStats5min"
    meta.rnFormat = "CDcompHostStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host stats in 5 minute"
