...
# ##################################################
class LastEventInfoList(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.LastEventInfoList")

    meta.moClassName = "compLastEventInfoList"
    meta.rnFormat = "lastEventInfoList"
    meta.category = MoCategory.REGULAR
    meta.label = "Last Event Set Info"
    ...
    prop = PropMeta("str", "lastEventCollectorIdList", "lastEventCollectorIdList", 54011, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastEventCollectorIdList", prop)

    prop = PropMeta("str", "lastEventIdList", "lastEventIdList", 54010, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastEventIdList", prop)

    prop = PropMeta("str", "lastEventTSList", "lastEventTSList", 54009, PropCategory.REGULAR)
    prop.label = "Status"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastEventTSList", prop)
    ...
    prop = PropMeta("str", "listSize", "listSize", 54012, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("listSize", prop)
