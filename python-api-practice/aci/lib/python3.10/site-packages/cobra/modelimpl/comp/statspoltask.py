...
# ##################################################
class StatsPolTask(Mo):
    """
    A task for the controller statistics policy. This object is generated and used internally by the system.

    """

    meta = ClassMeta("cobra.model.comp.StatsPolTask")

    meta.moClassName = "compStatsPolTask"
    meta.rnFormat = "compStatsPolTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5760, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateStatsPol", "updatestatspol", 144)
