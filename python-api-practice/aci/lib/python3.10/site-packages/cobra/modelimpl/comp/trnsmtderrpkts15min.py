...
# ##################################################
class TrnsmtdErrPkts15min(Mo):
    """
    A class that represents the most current statistics for transmitted error packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPkts15min", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPkts15min"
    meta.rnFormat = "CDcompTrnsmtdErrPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted error packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDcompTrnsmtdErrPkts15min', False),
    ]
