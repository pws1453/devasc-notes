...
class RcvdPktsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.comp.RcvdPktsHist1year", "received packets")
    ...
    meta.moClassName = "compRcvdPktsHist1year"
    meta.rnFormat = "HDcompRcvdPkts1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 5945, PropCategory.REGULAR)
