...
class RsDlPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsDlPol", "cobra.model.hvs.ExtPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsDlPol"
    meta.rnFormat = "rsdlPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11769, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11768, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "updateTs", "updateTs", 35518, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
