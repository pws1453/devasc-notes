...
class PvlanCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.PvlanCont")

    meta.moClassName = "compPvlanCont"
    meta.rnFormat = "pvlancont"
    ...
    meta.childClasses.add("cobra.model.comp.PvlanEntry")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.PvlanEntry", "pri-"))
    ...
    prop = PropMeta("str", "descr", "descr", 23446, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23539, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "remoteErrMsg", "remoteErrMsg", 25845, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
