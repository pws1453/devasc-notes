...
# ##################################################
class PNic(Mo):
    meta = ClassMeta("cobra.model.comp.PNic")

    meta.isAbstract = True
    meta.moClassName = "compPNic"


    meta.moClassName = "compPNic"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of a Physical Interface"
    ...
    prop = PropMeta("str", "type", "type", 969, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
