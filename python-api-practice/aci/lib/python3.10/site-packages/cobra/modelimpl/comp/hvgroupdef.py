...
class HvGroupDef(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.HvGroupDef")

    meta.moClassName = "compHvGroupDef"
    meta.rnFormat = "hvgroup-[%(name)s]"
    ...
    meta.childClasses.add("cobra.model.comp.RsHvGroupDefToHv")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsHvGroupDefToHv", "rshvGroupDefToHv-"))
    ...
    prop = PropMeta("str", "name", "name", 52129, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
