...
# ##################################################
class RsHvGroupDefToHv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsHvGroupDefToHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsHvGroupDefToHv"
    meta.rnFormat = "rshvGroupDefToHv-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.comp.HvGroupDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rshvGroupDefToHv-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 52139, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 52138, PropCategory.REGULAR)
