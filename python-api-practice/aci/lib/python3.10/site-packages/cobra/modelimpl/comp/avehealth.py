...
class AveHealth(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.AveHealth")

    meta.moClassName = "compAveHealth"
    meta.rnFormat = "aveHealth"
    meta.category = MoCategory.REGULAR
    meta.label = "AVE Health Info"
    ...
    meta.childClasses.add("cobra.model.comp.AveHealthInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.AveHealthInst", "aveHealthInst-"))
    ...
    prop = PropMeta("str", "operIssues", "operIssues", 45570, PropCategory.REGULAR)
