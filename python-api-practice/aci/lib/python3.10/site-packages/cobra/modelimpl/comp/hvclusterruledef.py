...
# ##################################################
class HvClusterRuleDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvClusterRuleDef")

    meta.moClassName = "compHvClusterRuleDef"
    ...
    prop = PropMeta("str", "antiAffinity", "antiAffinity", 52114, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "hvGroup", "hvGroup", 52112, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "mandatory", "mandatory", 52113, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "name", "name", 52127, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vmGroup", "vmGroup", 52111, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
