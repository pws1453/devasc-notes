...
# ##################################################
class RsContGrpDepl(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsContGrpDepl", "cobra.model.comp.Deployment")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsContGrpDepl"
    meta.rnFormat = "rscontGrpDepl"
    ...
    meta.parentClasses.add("cobra.model.comp.ContGrp")
    ...
    prop = PropMeta("str", "tCl", "tCl", 36365, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10840
    prop.defaultValueStr = "compDeployment"
    prop._addConstant("compDeployment", None, 10840)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 36364, PropCategory.REGULAR)
