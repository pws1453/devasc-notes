...
# ##################################################
class HostStatsHist5min(Mo):
    """
    A class that represents historical statistics for host in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comp.HostStatsHist5min", "host")
    ...
    meta.moClassName = "compHostStatsHist5min"
    meta.rnFormat = "HDcompHostStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 5916, PropCategory.REGULAR)
