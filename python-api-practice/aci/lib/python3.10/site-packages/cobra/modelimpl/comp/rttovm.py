...
class RtToVm(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtToVm", "cobra.model.fv.Ep")

    meta.moClassName = "compRtToVm"
    meta.rnFormat = "rtfvToVm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27657, PropCategory.REGULAR)
