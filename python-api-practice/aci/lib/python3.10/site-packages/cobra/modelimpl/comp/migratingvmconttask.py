...
# ##################################################
class MigratingVmContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.MigratingVmContTask")

    meta.moClassName = "compMigratingVmContTask"
    meta.rnFormat = "compMigratingVmContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 53002, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VerifyMigratingVms", "verifymigratingvms", 3523)
