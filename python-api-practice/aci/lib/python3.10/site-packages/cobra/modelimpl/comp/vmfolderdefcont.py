...
# ##################################################
class VmFolderDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.VmFolderDefCont")

    meta.moClassName = "compVmFolderDefCont"
    meta.rnFormat = "vmfolderdefcont"
    ...
    meta.childClasses.add("cobra.model.comp.FolderDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.FolderDef", "folderdef-"))
    ...
    prop = PropMeta("str", "descr", "descr", 54426, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "issues", "issues", 54423, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
