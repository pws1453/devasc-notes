...
# ##################################################
class RsCtrlrPTask(Mo):
    """
    An internal task to send policy from one process to another. This object is generated and used only by internal process.

    """

    meta = ClassMeta("cobra.model.comp.RsCtrlrPTask")

    meta.moClassName = "compRsCtrlrPTask"
    meta.rnFormat = "compRsCtrlrPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5672, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpPDUpd", "eppdupd", 556)
