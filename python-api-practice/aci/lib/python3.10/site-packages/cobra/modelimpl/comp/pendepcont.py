...
class PendEpCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.PendEpCont")

    meta.moClassName = "compPendEpCont"
    meta.rnFormat = "pendEpCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Pending Ep Container"
    ...
    meta.childClasses.add("cobra.model.comp.PendDpVerify")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.comp.PendResEpCont")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.PendResEpCont", "pendResEpCont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.PendDpVerify", "pendDpVerify"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34210, PropCategory.REGULAR)
