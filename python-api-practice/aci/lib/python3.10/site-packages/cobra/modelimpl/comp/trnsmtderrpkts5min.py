...
# ##################################################
class TrnsmtdErrPkts5min(Mo):
    """
    A class that represents the most current statistics for transmitted error packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comp.TrnsmtdErrPkts5min", "transmitted error packets")
    ...
    meta.moClassName = "compTrnsmtdErrPkts5min"
    meta.rnFormat = "CDcompTrnsmtdErrPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted error packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcompTrnsmtdErrPkts5min', False),
    ]
