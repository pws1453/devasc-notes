...
class TechSupP(Mo):
    ...
    meta = ClassMeta("cobra.model.dbgexp.TechSupP")

    meta.moClassName = "dbgexpTechSupP"
    meta.rnFormat = "tsexp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TechSupport Export Policy"
    ...
    meta.childClasses.add("cobra.model.dbgexp.RtResTechSupP")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.dbgexp.RsTSScheduler")
    ...
    meta.childClasses.add("cobra.model.dbgexp.RtNodeTechSupP")
    meta.childClasses.add("cobra.model.dbgexp.RtApplTechSupP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtNodeTechSupP", "rtfabricNodeTechSupP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtApplTechSupP", "rtfabricApplTechSupP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtResTechSupP", "rtfabricResTechSupP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RsTSScheduler", "rsTSScheduler"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37783, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "compression", "compression", 4687, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39922, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "feature", "feature", 4688, PropCategory.REGULAR)
    prop.label = "Policy Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 512
    prop.defaultValueStr = "system"
    prop._addConstant("bootmgr", "bootmgr", 4)
    prop._addConstant("debugger", "debbuger", 16)
    prop._addConstant("faults-events", "eventmgr", 8)
    prop._addConstant("idmgr", "id-manager", 32)
    prop._addConstant("policy", "policy", 1)
    prop._addConstant("services", "services", 256)
    prop._addConstant("stats", "observer", 128)
    prop._addConstant("system", "system-info", 512)
    prop._addConstant("topology", "topomgr", 64)
    prop._addConstant("vmm", "vmm", 2)
    meta.props.add("feature", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14619, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6128, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
