...
class RsData(Mo):
    """
    A source relation to the tech support data to be collected.

    """

    meta = SourceRelationMeta("cobra.model.dbgexp.RsData", "cobra.model.dbgexp.TechSupDataCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "dbgexpRsData"
    meta.rnFormat = "rsdata"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Techsupport Data Collection Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37780, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39919, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14616, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12956, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4212
    prop.defaultValueStr = "dbgexpTechSupDataCont"
    prop._addConstant("dbgexpTechSupDataCont", None, 4212)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12955, PropCategory.REGULAR)
