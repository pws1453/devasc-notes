...
# ##################################################
class TechSupPTask(Mo):
    """
    A tech support policy task. This is a utility that creates a summary report containing configuration information, logs and diagnostic data that will help TAC in troubleshooting and resolving a technical issue.

    """

    meta = ClassMeta("cobra.model.dbgexp.TechSupPTask")

    meta.moClassName = "dbgexpTechSupPTask"
    meta.rnFormat = "dbgexpTechSupPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5677, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("deleteTechSupIfcTrackers", "deletetechsupifctrackers", 461)
