...
class RsTsSrc(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgexp.RsTsSrc", "cobra.model.top.System")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgexpRsTsSrc"
    meta.rnFormat = "rstsSrc-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Techsupport Source Node"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37786, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39925, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "srcId", "srcId", 12967, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 12968, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12966, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12965, PropCategory.REGULAR)
