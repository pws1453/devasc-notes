...
class CoreStatus(Mo):
    ...
    meta = ClassMeta("cobra.model.dbgexp.CoreStatus")

    meta.moClassName = "dbgexpCoreStatus"
    meta.rnFormat = "corenode-%(nodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Core Export Status"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37790, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "exportTechSupFileUri", "exportTechSupFileUri", 4704, PropCategory.REGULAR)
    prop.label = "Download Location (TechSupport)"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("exportTechSupFileUri", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39929, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6126, PropCategory.REGULAR)
    prop.label = "Node ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
