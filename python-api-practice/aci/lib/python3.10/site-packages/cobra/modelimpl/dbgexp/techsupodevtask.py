...
# ##################################################
class TechSupODevTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.dbgexp.TechSupODevTask")

    meta.moClassName = "dbgexpTechSupODevTask"
    meta.rnFormat = "dbgexpTechSupODevTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 22563, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("deleteODevIfcTrackers", "deleteodevifctrackers", 1959)
