...
# ##################################################
class RtResTechSupP(Mo):
    """
    A target relation to the tech support policy.

    """

    meta = TargetRelationMeta("cobra.model.dbgexp.RtResTechSupP", "cobra.model.fabric.Inst")

    meta.moClassName = "dbgexpRtResTechSupP"
    meta.rnFormat = "rtfabricResTechSupP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11756, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11755, PropCategory.REGULAR)
