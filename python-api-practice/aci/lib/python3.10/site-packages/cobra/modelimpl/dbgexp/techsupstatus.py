...
# ##################################################
class TechSupStatus(Mo):
    """
    Status of techsupport data export

    """

    meta = ClassMeta("cobra.model.dbgexp.TechSupStatus")

    meta.moClassName = "dbgexpTechSupStatus"
    meta.rnFormat = "tsnode-%(nodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TechSupport Export Status"
    ...
    meta.superClasses.add("cobra.model.dbgexp.NodeStatus")

    meta.rnPrefixes = [
        ('tsnode-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37789, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dbSize", "dbSize", 23298, PropCategory.REGULAR)
    prop.label = "Database file size"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("dbSize", prop)
    ...
    prop = PropMeta("str", "exportDbUri", "exportDbUri", 20421, PropCategory.REGULAR)
    prop.label = "Download Location for database"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("exportDbUri", prop)
    ...
    prop = PropMeta("str", "exportLogsUri", "exportLogsUri", 20420, PropCategory.REGULAR)
    prop.label = "Download Location for logs"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("exportLogsUri", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39928, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "logsSize", "logsSize", 23297, PropCategory.REGULAR)
    prop.label = "Logs file size"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("logsSize", prop)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6129, PropCategory.REGULAR)
    prop.label = "Node ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
