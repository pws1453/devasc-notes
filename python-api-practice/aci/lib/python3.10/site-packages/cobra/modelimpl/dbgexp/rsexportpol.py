...
# ##################################################
class RsExportPol(Mo):
    """
    A source relation to the data export policy.

    """

    meta = SourceRelationMeta("cobra.model.dbgexp.RsExportPol", "cobra.model.dbgexp.ExportP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "dbgexpRsExportPol"
    meta.rnFormat = "rsexportPol-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.dbgexp.DbgrCont")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12972, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12971, PropCategory.REGULAR)
