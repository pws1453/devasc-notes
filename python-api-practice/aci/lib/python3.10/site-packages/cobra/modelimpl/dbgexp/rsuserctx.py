...
class RsUserCtx(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgexp.RsUserCtx", "cobra.model.l3.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgexpRsUserCtx"
    meta.rnFormat = "rsUserCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Relation to L3 Context Export Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37781, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39920, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14617, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12952, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3750
    prop.defaultValueStr = "l3Ctx"
    prop._addConstant("l3Ctx", None, 3750)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12951, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15169, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
