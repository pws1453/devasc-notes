...
# ##################################################
class RsExportDest(Mo):
    """
    A source relation to the remote destination path parameters for the data export.

    """

    meta = SourceRelationMeta("cobra.model.dbgexp.RsExportDest", "cobra.model.file.RemotePath")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgexpRsExportDest"
    meta.rnFormat = "rsexportDest"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Export Destination Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37779, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39918, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14615, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12959, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12958, PropCategory.REGULAR)
