...
# ##################################################
class TechSupOnDTask(Mo):
    """
    A task for a utility that creates a summary report containing configuration information, logs, and diagnostic data. The summary report is intended to assist TAC with troubleshooting and resolving technical issues.

    """

    meta = ClassMeta("cobra.model.dbgexp.TechSupOnDTask")

    meta.moClassName = "dbgexpTechSupOnDTask"
    meta.rnFormat = "dbgexpTechSupOnDTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5676, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("deleteOnDIfcTrackers", "deleteondifctrackers", 462)
