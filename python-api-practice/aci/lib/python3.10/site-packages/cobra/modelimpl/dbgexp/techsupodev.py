...
# ##################################################
class TechSupODev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.dbgexp.TechSupODev")

    meta.moClassName = "dbgexpTechSupODev"
    meta.rnFormat = "tsodev-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TechSupport Export Policy for ODev"
    ...
    meta.childClasses.add("cobra.model.dbgexp.RsTsODev")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RsTsODev", "rstsODev-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38350, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "compression", "compression", 22561, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40489, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22574, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 22567, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
