...
class CoreP(Mo):
    ...
    meta = ClassMeta("cobra.model.dbgexp.CoreP")

    meta.moClassName = "dbgexpCoreP"
    meta.rnFormat = "coreexp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Core Export Policy"
    ...
    meta.childClasses.add("cobra.model.dbgexp.RtApplCoreP")
    ...
    meta.childClasses.add("cobra.model.dbgexp.RtResCoreP")
    meta.childClasses.add("cobra.model.dbgexp.RtNodeCoreP")
    meta.childClasses.add("cobra.model.dbgexp.RtExportPRel")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtApplCoreP", "rtfabricApplCoreP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtNodeCoreP", "rtfabricNodeCoreP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtResCoreP", "rtfabricResCoreP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtExportPRel", "rtpolExportPRel-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37782, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "category", "category", 20458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "collectType", "collectType", 4686, PropCategory.REGULAR)
    prop.label = "File(s) to Collect and Export"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "coreOnly"
    prop._addConstant("coreOnly", "core-only", 2)
    prop._addConstant("techSup", "core-and-techsupport", 1)
    meta.props.add("collectType", prop)

    prop = PropMeta("str", "compression", "compression", 4685, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "endTime", "endTime", 20460, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39921, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14618, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6125, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "startTime", "startTime", 20459, PropCategory.REGULAR)
