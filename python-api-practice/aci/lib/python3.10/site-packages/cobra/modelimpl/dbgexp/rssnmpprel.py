...
class RsSnmpPRel(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgexp.RsSnmpPRel", "cobra.model.snmp.Pol")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "dbgexpRsSnmpPRel"
    meta.rnFormat = "rssnmpPRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18087, PropCategory.REGULAR)
