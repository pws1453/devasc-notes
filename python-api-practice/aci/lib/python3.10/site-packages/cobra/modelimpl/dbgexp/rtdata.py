...
class RtData(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.dbgexp.RtData", "cobra.model.dbgexp.ExportP")

    meta.moClassName = "dbgexpRtData"
    meta.rnFormat = "rtdata"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12957, PropCategory.REGULAR)
