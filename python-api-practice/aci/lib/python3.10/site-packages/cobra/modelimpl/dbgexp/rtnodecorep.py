...
# ##################################################
class RtNodeCoreP(Mo):
    """
    A target relation to the core policy.

    """

    meta = TargetRelationMeta("cobra.model.dbgexp.RtNodeCoreP", "cobra.model.fabric.ANodePGrp")

    meta.moClassName = "dbgexpRtNodeCoreP"
    meta.rnFormat = "rtfabricNodeCoreP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11572, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11571, PropCategory.REGULAR)
