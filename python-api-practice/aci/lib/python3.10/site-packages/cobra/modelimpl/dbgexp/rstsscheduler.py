...
# ##################################################
class RsTSScheduler(Mo):
    """
    A source relation to the scheduler policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.dbgexp.RsTSScheduler", "cobra.model.trig.SchedP")
    meta.targetNameProps["name"] = "tnTrigSchedPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "dbgexpRsTSScheduler"
    meta.rnFormat = "rsTSScheduler"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Techsupport Scheduler Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37784, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39923, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14620, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12963, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTrigSchedPName", "tnTrigSchedPName", 12962, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
