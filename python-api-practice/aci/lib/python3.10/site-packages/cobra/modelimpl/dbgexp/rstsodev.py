...
class RsTsODev(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgexp.RsTsODev", "cobra.model.opflex.ODev")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgexpRsTsODev"
    meta.rnFormat = "rstsODev-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to ODev"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38351, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40490, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 22570, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1105
    prop.defaultValueStr = "opflexODev"
    prop._addConstant("opflexODev", None, 1105)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22569, PropCategory.REGULAR)
