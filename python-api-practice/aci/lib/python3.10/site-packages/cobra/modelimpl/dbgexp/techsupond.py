...
class TechSupOnD(Mo):
    """
    The on-demand tech support policy creates an archive containing configuration information, logs and diagnostic data that will help TAC with troubleshooting and resolving a technical issue.

    """

    meta = ClassMeta("cobra.model.dbgexp.TechSupOnD")

    meta.moClassName = "dbgexpTechSupOnD"
    meta.rnFormat = "tsod-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TechSupport Export on Demand"
    ...
    meta.childClasses.add("cobra.model.dbgexp.RtApplTechSupOnDemand")
    meta.childClasses.add("cobra.model.dbgexp.RsTsSrc")
    meta.childClasses.add("cobra.model.dbgexp.RtApplTechSupOnD")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtApplTechSupOnDemand", "rtfabricApplTechSupOnDemand-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtApplTechSupOnD", "rtfabricApplTechSupOnD-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37785, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "compression", "compression", 22562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39924, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14621, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6127, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
