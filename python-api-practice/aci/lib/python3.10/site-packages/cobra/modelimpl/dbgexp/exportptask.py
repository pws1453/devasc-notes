...
# ##################################################
class ExportPTask(Mo):
    """
    Contains the data export policy task.

    """

    meta = ClassMeta("cobra.model.dbgexp.ExportPTask")

    meta.moClassName = "dbgexpExportPTask"
    meta.rnFormat = "dbgexpExportPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5675, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("cleanupTechSupCloud", "cleanuptechsupcloud", 3513)
    prop._addConstant("none", "none", 0)
    prop._addConstant("resetExportStatus", "resetexportstatus", 2061)
    prop._addConstant("sendNodeList", "sendnodelist", 460)
    prop._addConstant("trigTechSupCloud", "trigtechsupcloud", 3512)
