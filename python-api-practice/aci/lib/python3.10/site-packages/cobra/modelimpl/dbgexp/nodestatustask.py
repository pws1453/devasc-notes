...
# ##################################################
class NodeStatusTask(Mo):
    """
    Node status task

    """

    meta = ClassMeta("cobra.model.dbgexp.NodeStatusTask")

    meta.moClassName = "dbgexpNodeStatusTask"
    meta.rnFormat = "dbgexpNodeStatusTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5653, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportIFCStatus", "reportifcstatus", 24)
    prop._addConstant("ReportNodeStatus", "reportnodestatus", 37)
    prop._addConstant("none", "none", 0)
    prop._addConstant("removeFile", "removefile", 25)
