...
class RtResCoreP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.dbgexp.RtResCoreP", "cobra.model.fabric.Inst")

    meta.moClassName = "dbgexpRtResCoreP"
    meta.rnFormat = "rtfabricResCoreP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11715, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11714, PropCategory.REGULAR)
