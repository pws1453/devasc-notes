...
class RsCtx2Leaf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.coop.RsCtx2Leaf", "cobra.model.coop.LeafRec")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "coopRsCtx2Leaf"
    meta.rnFormat = "rsctx2Leaf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Context Leaf Attachment"
    ...
    meta.parentClasses.add("cobra.model.coop.CtxRec")
    ...
    prop = PropMeta("str", "lastPub", "lastPub", 12655, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "pubId", "pubId", 12656, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12654, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12653, PropCategory.REGULAR)
