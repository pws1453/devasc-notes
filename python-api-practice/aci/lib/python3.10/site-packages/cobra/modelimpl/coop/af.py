...
# ##################################################
class Af(Mo):
    meta = ClassMeta("cobra.model.coop.Af")

    meta.isAbstract = True
    meta.moClassName = "coopAf"
    ...
    meta.concreteSubClasses.add("cobra.model.coop.DomAf")
    ...
    prop = PropMeta("str", "type", "type", 44945, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
