...
class RsBD2Dom(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.coop.RsBD2Dom", "cobra.model.coop.Dom")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "coopRsBD2Dom"
    meta.rnFormat = "rsBD2Dom-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Bridge Domain to VRF Host-Route Leak"
    ...
    meta.parentClasses.add("cobra.model.coop.BD")
    ...
    prop = PropMeta("str", "tCl", "tCl", 43450, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2575
    prop.defaultValueStr = "coopDom"
    prop._addConstant("coopDom", None, 2575)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43449, PropCategory.REGULAR)
