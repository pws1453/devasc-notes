...
# ##################################################
class RtResCoopPol(Mo):
    """
    A target relation to the COOP group policy information.

    """

    meta = TargetRelationMeta("cobra.model.coop.RtResCoopPol", "cobra.model.fabric.Inst")

    meta.moClassName = "coopRtResCoopPol"
    meta.rnFormat = "rtresCoopPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11711, PropCategory.REGULAR)
