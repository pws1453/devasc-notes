...
# ##################################################
class RtDTEp2Leaf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.coop.RtDTEp2Leaf", "cobra.model.coop.DTEp")

    meta.moClassName = "coopRtDTEp2Leaf"
    meta.rnFormat = "rtDTEp2Leaf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20721, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6934
    prop.defaultValueStr = "coopDTEp"
    prop._addConstant("coopDTEp", None, 6934)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20720, PropCategory.REGULAR)
