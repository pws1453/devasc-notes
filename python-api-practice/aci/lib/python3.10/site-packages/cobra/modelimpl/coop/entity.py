...
class Entity(Mo):
    """
    The COOP control plane entity information.

    """

    meta = ClassMeta("cobra.model.coop.Entity")

    meta.moClassName = "coopEntity"
    meta.rnFormat = "coop"
    meta.category = MoCategory.REGULAR
    meta.label = "COOP Entity"
    ...
    meta.childClasses.add("cobra.model.coop.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.coop.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14446, PropCategory.REGULAR)
