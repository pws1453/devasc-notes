...
# ##################################################
class RsMrtr2Leaf(Mo):
    """
    A source relation to the COOP leaf records.

    """

    meta = SourceRelationMeta("cobra.model.coop.RsMrtr2Leaf", "cobra.model.coop.LeafRec")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "coopRsMrtr2Leaf"
    meta.rnFormat = "rsmrtr2Leaf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Multicast Router Leaf Attachment"
    ...
    meta.parentClasses.add("cobra.model.coop.MrtrRec")
    ...
    prop = PropMeta("str", "lastPub", "lastPub", 12649, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "pubId", "pubId", 12650, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12648, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12647, PropCategory.REGULAR)
