...
# ##################################################
class FabMcGrpRec(Mo):
    meta = ClassMeta("cobra.model.coop.FabMcGrpRec")

    meta.isAbstract = True
    meta.moClassName = "coopFabMcGrpRec"
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.coop.RsFabMcgrp2Leaf", "rsfabMcgrp2Leaf-"))
    ...
    prop = PropMeta("str", "vnid", "vnid", 36924, PropCategory.REGULAR)
    prop.label = "VNID"
    prop.isImplicit = True
    prop.isAdmin = True
