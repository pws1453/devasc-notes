...
class IpAddr(Mo):
    """
    The IP entries in the static endpoint.

    """

    meta = ClassMeta("cobra.model.coop.IpAddr")

    meta.moClassName = "coopIpAddr"
    ...
    meta.parentClasses.add("cobra.model.coop.Ep")
    ...
    prop = PropMeta("str", "addr", "addr", 2470, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
