...
class Rep(Mo):
    """
    The COOP repository. The user can only change the associated policy.

    """

    meta = ClassMeta("cobra.model.coop.Rep")

    meta.moClassName = "coopRep"
    meta.rnFormat = "rep-%(type)s"
    ...
    prop = PropMeta("str", "type", "type", 804, PropCategory.REGULAR)
    prop.label = "Repository Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
