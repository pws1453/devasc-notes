...
# ##################################################
class RsFabMcgrp2Leaf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.coop.RsFabMcgrp2Leaf", "cobra.model.coop.LeafRec")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "coopRsFabMcgrp2Leaf"
    meta.rnFormat = "rsfabMcgrp2Leaf-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.coop.FabMcGrpv4Rec")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsfabMcgrp2Leaf-', True),
    ]
    ...
    prop = PropMeta("str", "lastPub", "lastPub", 36926, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "pubId", "pubId", 36927, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "remoteTs", "remoteTs", 36928, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 36930, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 36929, PropCategory.REGULAR)
