...
class DTEp(Mo):
    ...
    meta = ClassMeta("cobra.model.coop.DTEp")

    meta.moClassName = "coopDTEp"
    meta.rnFormat = "coop-[%(id)s]"
    ...
    meta.childClasses.add("cobra.model.coop.RsDTEp2Leaf")

    meta.childNamesAndRnPrefix.append(("cobra.model.coop.RsDTEp2Leaf", "rsDTEp2Leaf-"))

    meta.parentClasses.add("cobra.model.coop.TepDb")
    ...
    prop = PropMeta("str", "attachmentType", "attachmentType", 34405, PropCategory.REGULAR)
    prop.label = "AttachmentType"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "local"
    prop._addConstant("ipn", "ipn", 1)
    prop._addConstant("local", "local", 0)
    prop._addConstant("wan", "wan", 2)
    ...
    prop = PropMeta("str", "id", "id", 20707, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "location", "location", 34404, PropCategory.REGULAR)
    prop.label = "Location"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "local"
