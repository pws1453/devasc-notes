...
class Inst(Mo):
    """
    The per-COOP instance information. There is only one instance of this object present in the system.

    """

    meta = ClassMeta("cobra.model.coop.Inst")

    meta.moClassName = "coopInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "COOP Instance"
    ...
    meta.childClasses.add("cobra.model.coop.AuthP")
    meta.childClasses.add("cobra.model.coop.BD")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.coop.Dom")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.coop.AuthP", "auth"))
    meta.childNamesAndRnPrefix.append(("cobra.model.coop.Dom", "dom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.coop.BD", "bd-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14447, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "role", "role", 2528, PropCategory.REGULAR)
    prop.label = "Role"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "citizen"
    prop._addConstant("citizen", "citizen", 1)
    prop._addConstant("oracle", "oracle", 2)
