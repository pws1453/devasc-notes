...
class DomAf(Mo):
    ...
    meta = ClassMeta("cobra.model.coop.DomAf")

    meta.moClassName = "coopDomAf"
    ...
    meta.childClasses.add("cobra.model.coop.ProxyAddr")

    meta.childNamesAndRnPrefix.append(("cobra.model.coop.ProxyAddr", "forwarderAddr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.coop.RibLeakP", "ribleak"))

    meta.parentClasses.add("cobra.model.coop.Dom")

    meta.superClasses.add("cobra.model.coop.Af")
    ...
    prop = PropMeta("str", "type", "type", 44946, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
