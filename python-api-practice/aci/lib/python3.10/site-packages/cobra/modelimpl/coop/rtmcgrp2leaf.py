...
# ##################################################
class RtMcgrp2Leaf(Mo):
    """
    A target relation to the COOP leaf records.

    """

    meta = TargetRelationMeta("cobra.model.coop.RtMcgrp2Leaf", "cobra.model.coop.McGrpRec")

    meta.moClassName = "coopRtMcgrp2Leaf"
    meta.rnFormat = "rtmcgrp2Leaf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12664, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2593
    prop.defaultValueStr = "coopMcGrpRec"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12663, PropCategory.REGULAR)
