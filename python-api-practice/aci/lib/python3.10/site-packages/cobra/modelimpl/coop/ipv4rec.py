...
class Ipv4Rec(Mo):
    """
    The IPv4 entries in an endpoint record.

    """

    meta = ClassMeta("cobra.model.coop.Ipv4Rec")

    meta.moClassName = "coopIpv4Rec"
    meta.rnFormat = "epip4-%(addr)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv4 Record"
    ...
    meta.superClasses.add("cobra.model.coop.IpRec")
    ...
    prop = PropMeta("str", "addr", "addr", 2494, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "synthFlags", "synthFlags", 2493, PropCategory.REGULAR)
    prop.label = "Synthetic Flags"
    prop.isOper = True
    ...
    prop = PropMeta("str", "synthIp", "synthIp", 2491, PropCategory.REGULAR)
    prop.label = "Synthetic IP"
    prop.isOper = True
    meta.props.add("synthIp", prop)

    prop = PropMeta("str", "synthVrf", "synthVrf", 2492, PropCategory.REGULAR)
