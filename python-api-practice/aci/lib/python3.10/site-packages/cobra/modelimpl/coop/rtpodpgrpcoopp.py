...
# ##################################################
class RtPodPGrpCoopP(Mo):
    """
    A target relation to the COOP group policy.

    """

    meta = TargetRelationMeta("cobra.model.coop.RtPodPGrpCoopP", "cobra.model.fabric.PodPGrp")

    meta.moClassName = "coopRtPodPGrpCoopP"
    meta.rnFormat = "rtfabricPodPGrpCoopP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11552, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11551, PropCategory.REGULAR)
