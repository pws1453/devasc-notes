...
# ##################################################
class ConCitizenAdj(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.coop.ConCitizenAdj")

    meta.moClassName = "coopConCitizenAdj"
    meta.rnFormat = "concz-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Connected Citizen Adjacency"
    ...
    prop = PropMeta("str", "addr", "addr", 53213, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
