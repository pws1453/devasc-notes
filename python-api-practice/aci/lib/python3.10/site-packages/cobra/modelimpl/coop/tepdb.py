...
class TepDb(Mo):
    ...
    meta = ClassMeta("cobra.model.coop.TepDb")

    meta.moClassName = "coopTepDb"
    meta.rnFormat = "dbtep"
    ...
    meta.childClasses.add("cobra.model.coop.DTEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.coop.DTEp", "coop-"))
