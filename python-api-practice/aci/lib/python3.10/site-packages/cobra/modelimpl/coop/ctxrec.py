...
class CtxRec(Mo):
    ...
    meta = ClassMeta("cobra.model.coop.CtxRec")

    meta.moClassName = "coopCtxRec"
    meta.rnFormat = "ctx-%(vnid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Context Record"
    ...
    meta.childClasses.add("cobra.model.coop.RsCtx2Leaf")

    meta.childNamesAndRnPrefix.append(("cobra.model.coop.RsCtx2Leaf", "rsctx2Leaf-"))
    ...
    prop = PropMeta("str", "ctxName", "ctxName", 28337, PropCategory.REGULAR)
    prop.label = "VRF Name"
    prop.isOper = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "flags", "flags", 2516, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    prop._addConstant("dampen", "dampen", 1)
    ...
    prop = PropMeta("str", "vnid", "vnid", 2512, PropCategory.REGULAR)
    prop.label = "VNID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, vnid, markDirty=True, **creationProps):
        namingVals = [vnid]
