...
class IpOnlyRec(Mo):
    ...
    meta = ClassMeta("cobra.model.coop.IpOnlyRec")

    meta.moClassName = "coopIpOnlyRec"
    meta.rnFormat = "vrf-%(vrfVnid)s-ip-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Only Endpoint Record"
    ...
    meta.childClasses.add("cobra.model.coop.RtHBucket2IpOnlyRec")

    meta.childNamesAndRnPrefix.append(("cobra.model.coop.RtHBucket2IpOnlyRec", "rthBucket2IpOnlyRec"))
    ...
    prop = PropMeta("str", "addr", "addr", 16974, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "vrfVnid", "vrfVnid", 17446, PropCategory.REGULAR)
    prop.label = "VRF VNID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "vrfVnid"))
    meta.namingProps.append(getattr(meta.props, "addr"))
    getattr(meta.props, "addr").needDelimiter = True

    def __init__(self, parentMoOrDn, vrfVnid, addr, markDirty=True, **creationProps):
        namingVals = [vrfVnid, addr]
