...
# ##################################################
class RsDTEp2Leaf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.coop.RsDTEp2Leaf", "cobra.model.coop.LeafRec")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "coopRsDTEp2Leaf"
    meta.rnFormat = "rsDTEp2Leaf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DTEp Leaf Attachment"
    ...
    meta.parentClasses.add("cobra.model.coop.DTEp")
    ...
    prop = PropMeta("str", "lastPub", "lastPub", 20716, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "pubId", "pubId", 20717, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 20719, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20718, PropCategory.REGULAR)
