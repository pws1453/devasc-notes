...
# ##################################################
class RsMcgrp2Leaf(Mo):
    """
    A source relation to the COOP leaf records.

    """

    meta = SourceRelationMeta("cobra.model.coop.RsMcgrp2Leaf", "cobra.model.coop.LeafRec")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "coopRsMcgrp2Leaf"
    meta.rnFormat = "rsmcgrp2Leaf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Multicast Group Leaf Attachment"
    ...
    meta.parentClasses.add("cobra.model.coop.McGrpv6Rec")
    meta.parentClasses.add("cobra.model.coop.McGrpv4Rec")
    ...
    prop = PropMeta("str", "lastPub", "lastPub", 12661, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "pubId", "pubId", 12662, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "remoteTs", "remoteTs", 27695, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12660, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2578
    prop.defaultValueStr = "coopLeafRec"
    prop._addConstant("coopLeafRec", None, 2578)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12659, PropCategory.REGULAR)
