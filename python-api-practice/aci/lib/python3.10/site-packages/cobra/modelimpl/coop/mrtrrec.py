...
class MrtrRec(Mo):
    ...
    meta = ClassMeta("cobra.model.coop.MrtrRec")

    meta.moClassName = "coopMrtrRec"
    meta.rnFormat = "mrtr-%(vnid)s"
    ...
    meta.childClasses.add("cobra.model.coop.RsMrtr2Leaf")

    meta.childNamesAndRnPrefix.append(("cobra.model.coop.RsMrtr2Leaf", "rsmrtr2Leaf-"))
    ...
    prop = PropMeta("str", "flags", "flags", 2476, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    ...
    prop = PropMeta("str", "vnid", "vnid", 2472, PropCategory.REGULAR)
    prop.label = "VNID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
