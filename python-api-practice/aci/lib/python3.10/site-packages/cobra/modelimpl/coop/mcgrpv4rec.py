...
class McGrpv4Rec(Mo):
    """
    The IPv4 multicast group records.

    """

    meta = ClassMeta("cobra.model.coop.McGrpv4Rec")

    meta.moClassName = "coopMcGrpv4Rec"
    meta.rnFormat = "mgv4-%(version)s-mgv4-%(srcIp)s-mgv4-%(mcGrpIp)s-mgv4-%(vnid)s"
    ...
    meta.childClasses.add("cobra.model.coop.RsMcgrp2Leaf")

    meta.childNamesAndRnPrefix.append(("cobra.model.coop.RsMcgrp2Leaf", "rsmcgrp2Leaf-"))
    ...
    meta.superClasses.add("cobra.model.coop.McGrpv4RecBase")
    meta.superClasses.add("cobra.model.coop.Rec")
    meta.superClasses.add("cobra.model.nw.Item")
    meta.superClasses.add("cobra.model.nw.GEp")
    meta.superClasses.add("cobra.model.coop.McGrpRec")
    ...
    prop = PropMeta("str", "flags", "flags", 2518, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    ...
    prop = PropMeta("str", "mcGrpIp", "mcGrpIp", 2524, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 2523, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "version", "version", 2522, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vnid", "vnid", 5998, PropCategory.REGULAR)
    prop.label = "VNID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, version, srcIp, mcGrpIp, vnid, markDirty=True, **creationProps):
        namingVals = [version, srcIp, mcGrpIp, vnid]
