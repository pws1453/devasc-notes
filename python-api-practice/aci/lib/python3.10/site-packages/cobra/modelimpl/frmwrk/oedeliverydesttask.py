...
# ##################################################
class OEDeliveryDestTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.frmwrk.OEDeliveryDestTask")

    meta.moClassName = "frmwrkOEDeliveryDestTask"
    meta.rnFormat = "frmwrkOEDeliveryDestTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16355, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendMonitoringMessage", "sendmonitoringmessage", 1422)
