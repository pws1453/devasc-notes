...
# ##################################################
class ReliableDeliveryResp(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.frmwrk.ReliableDeliveryResp")

    meta.moClassName = "frmwrkReliableDeliveryResp"
    meta.rnFormat = "resp-[%(deliveryDn)s]"
    ...
    prop = PropMeta("str", "deliveryDn", "deliveryDn", 15993, PropCategory.REGULAR)
