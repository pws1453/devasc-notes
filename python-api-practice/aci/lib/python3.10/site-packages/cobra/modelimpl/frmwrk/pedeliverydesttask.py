...
# ##################################################
class PEDeliveryDestTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.frmwrk.PEDeliveryDestTask")

    meta.moClassName = "frmwrkPEDeliveryDestTask"
    meta.rnFormat = "frmwrkPEDeliveryDestTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15974, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendMonitoringMessage", "sendmonitoringmessage", 1359)
