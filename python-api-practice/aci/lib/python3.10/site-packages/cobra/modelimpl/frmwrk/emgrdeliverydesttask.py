...
# ##################################################
class EMgrDeliveryDestTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.frmwrk.EMgrDeliveryDestTask")

    meta.moClassName = "frmwrkEMgrDeliveryDestTask"
    meta.rnFormat = "frmwrkEMgrDeliveryDestTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('frmwrkEMgrDeliveryDestTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 15973, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendMonitoringMessage", "sendmonitoringmessage", 1358)
