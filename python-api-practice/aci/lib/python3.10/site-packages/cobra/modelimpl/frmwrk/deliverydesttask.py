...
# ##################################################
class DeliveryDestTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.frmwrk.DeliveryDestTask")

    meta.moClassName = "frmwrkDeliveryDestTask"
    meta.rnFormat = "frmwrkDeliveryDestTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15972, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendMonitoringMessage", "sendmonitoringmessage", 1357)
