...
# ##################################################
class LatencyAvg2Hist1w(Mo):
    """
    A class that represents historical statistics for delay(average mode-2) in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg2Hist1w", "delay(average mode-2)")
    ...
    meta.moClassName = "latencyLatencyAvg2Hist1w"
    meta.rnFormat = "HDlatencyLatencyAvg21w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-2) stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 29000, PropCategory.REGULAR)
