...
# ##################################################
class LatencyAvg1Hist15min(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist15min", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist15min"
    meta.rnFormat = "HDlatencyLatencyAvg115min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.latency.LatencyAvg1Hist")

    meta.rnPrefixes = [
        ('HDlatencyLatencyAvg115min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 28987, PropCategory.REGULAR)
