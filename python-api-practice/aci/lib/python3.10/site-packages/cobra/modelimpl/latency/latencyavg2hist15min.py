...
# ##################################################
class LatencyAvg2Hist15min(Mo):
    """
    A class that represents historical statistics for delay(average mode-2) in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg2Hist15min", "delay(average mode-2)")
    ...
    meta.moClassName = "latencyLatencyAvg2Hist15min"
    meta.rnFormat = "HDlatencyLatencyAvg215min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-2) stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyAvg215min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 28995, PropCategory.REGULAR)
