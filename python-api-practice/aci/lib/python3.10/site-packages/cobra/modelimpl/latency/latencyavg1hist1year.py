...
# ##################################################
class LatencyAvg1Hist1year(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist1year", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist1year"
    meta.rnFormat = "HDlatencyLatencyAvg11year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyAvg11year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 28993, PropCategory.REGULAR)
