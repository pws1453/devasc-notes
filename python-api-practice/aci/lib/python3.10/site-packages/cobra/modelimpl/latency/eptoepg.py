...
class EpToEpg(Mo):
    """
     Ep to Epg latency, On-demand, Entry 

    """

    meta = ClassMeta("cobra.model.latency.EpToEpg")

    meta.moClassName = "latencyEpToEpg"
    meta.rnFormat = "lEpToEpg-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ep to Epg latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28862, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28956, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28957, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 28861, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28958, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28955, PropCategory.REGULAR)
