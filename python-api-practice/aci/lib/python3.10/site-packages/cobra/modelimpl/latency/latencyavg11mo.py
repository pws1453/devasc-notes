...
# ##################################################
class LatencyAvg11mo(Mo):
    """
    A class that represents the most current statistics for delay(average mode-1) in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg11mo", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg11mo"
    meta.rnFormat = "CDlatencyLatencyAvg11mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(average mode-1) stats in 1 month"
