...
# ##################################################
class LatencyHist1Hist1year(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-1) in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist1Hist1year", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist1Hist1year"
    meta.rnFormat = "HDlatencyLatencyHist11year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-1) stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist11year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29009, PropCategory.REGULAR)
