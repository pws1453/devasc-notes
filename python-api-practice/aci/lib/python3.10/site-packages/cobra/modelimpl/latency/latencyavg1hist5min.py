...
# ##################################################
class LatencyAvg1Hist5min(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist5min", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist5min"
    meta.rnFormat = "HDlatencyLatencyAvg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 28994, PropCategory.REGULAR)
