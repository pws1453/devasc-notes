...
# ##################################################
class LatencyHist1Hist1qtr(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-1) in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist1Hist1qtr", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist1Hist1qtr"
    meta.rnFormat = "HDlatencyLatencyHist11qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-1) stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist11qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29007, PropCategory.REGULAR)
