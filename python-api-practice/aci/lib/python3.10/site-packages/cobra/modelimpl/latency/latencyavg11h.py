...
# ##################################################
class LatencyAvg11h(Mo):
    """
    A class that represents the most current statistics for delay(average mode-1) in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg11h", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg11h"
    meta.rnFormat = "CDlatencyLatencyAvg11h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(average mode-1) stats in 1 hour"
