...
# ##################################################
class LatencyHist11d(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist11d", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist11d"
    meta.rnFormat = "CDlatencyLatencyHist11d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 1 day"
