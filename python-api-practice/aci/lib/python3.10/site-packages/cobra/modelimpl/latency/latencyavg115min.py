...
# ##################################################
class LatencyAvg115min(Mo):
    """
    A class that represents the most current statistics for delay(average mode-1) in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg115min", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg115min"
    meta.rnFormat = "CDlatencyLatencyAvg115min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(average mode-1) stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDlatencyLatencyAvg115min', False),
    ]
