...
# ##################################################
class LatencyHist2Hist15min(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-2) in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist2Hist15min", "delay(histogram mode-2)")
    ...
    meta.moClassName = "latencyLatencyHist2Hist15min"
    meta.rnFormat = "HDlatencyLatencyHist215min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-2) stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist215min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29011, PropCategory.REGULAR)
