...
# ##################################################
class LatencyHist11mo(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist11mo", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist11mo"
    meta.rnFormat = "CDlatencyLatencyHist11mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDlatencyLatencyHist11mo', False),
    ]
