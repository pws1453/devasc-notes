...
# ##################################################
class LatencyAvg2Hist1year(Mo):
    """
    A class that represents historical statistics for delay(average mode-2) in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg2Hist1year", "delay(average mode-2)")
    ...
    meta.moClassName = "latencyLatencyAvg2Hist1year"
    meta.rnFormat = "HDlatencyLatencyAvg21year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-2) stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyAvg21year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29001, PropCategory.REGULAR)
