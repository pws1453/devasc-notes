...
# ##################################################
class LatencyHist2Hist1w(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-2) in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist2Hist1w", "delay(histogram mode-2)")
    ...
    meta.moClassName = "latencyLatencyHist2Hist1w"
    meta.rnFormat = "HDlatencyLatencyHist21w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-2) stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 29016, PropCategory.REGULAR)
