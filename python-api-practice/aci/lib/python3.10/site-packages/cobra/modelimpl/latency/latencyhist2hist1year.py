...
# ##################################################
class LatencyHist2Hist1year(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-2) in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist2Hist1year", "delay(histogram mode-2)")
    ...
    meta.moClassName = "latencyLatencyHist2Hist1year"
    meta.rnFormat = "HDlatencyLatencyHist21year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-2) stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist21year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29017, PropCategory.REGULAR)
