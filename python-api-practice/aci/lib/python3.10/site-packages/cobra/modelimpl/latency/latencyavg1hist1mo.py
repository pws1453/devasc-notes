...
# ##################################################
class LatencyAvg1Hist1mo(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist1mo", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist1mo"
    meta.rnFormat = "HDlatencyLatencyAvg11mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 28990, PropCategory.REGULAR)
