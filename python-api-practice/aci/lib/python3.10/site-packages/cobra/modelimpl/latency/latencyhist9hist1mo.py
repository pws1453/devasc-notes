...
# ##################################################
class LatencyHist9Hist1mo(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-9) in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist9Hist1mo", "delay(histogram mode-9)")
    ...
    meta.moClassName = "latencyLatencyHist9Hist1mo"
    meta.rnFormat = "HDlatencyLatencyHist91mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-9) stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 29070, PropCategory.REGULAR)
