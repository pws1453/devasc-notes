...
# ##################################################
class LatencyHist15min(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist15min", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist15min"
    meta.rnFormat = "CDlatencyLatencyHist15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDlatencyLatencyHist15min', False),
    ]
