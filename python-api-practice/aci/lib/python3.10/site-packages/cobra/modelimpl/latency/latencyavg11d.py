...
# ##################################################
class LatencyAvg11d(Mo):
    """
    A class that represents the most current statistics for delay(average mode-1) in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg11d", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg11d"
    meta.rnFormat = "CDlatencyLatencyAvg11d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(average mode-1) stats in 1 day"
