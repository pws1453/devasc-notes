...
# ##################################################
class LatencyHist9Hist15min(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-9) in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist9Hist15min", "delay(histogram mode-9)")
    ...
    meta.moClassName = "latencyLatencyHist9Hist15min"
    meta.rnFormat = "HDlatencyLatencyHist915min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-9) stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist915min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29067, PropCategory.REGULAR)
