...
# ##################################################
class LatencyHist2Hist1mo(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-2) in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist2Hist1mo", "delay(histogram mode-2)")
    ...
    meta.moClassName = "latencyLatencyHist2Hist1mo"
    meta.rnFormat = "HDlatencyLatencyHist21mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-2) stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 29014, PropCategory.REGULAR)
