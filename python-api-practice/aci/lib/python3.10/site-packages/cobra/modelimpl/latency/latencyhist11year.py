...
# ##################################################
class LatencyHist11year(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist11year", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist11year"
    meta.rnFormat = "CDlatencyLatencyHist11year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDlatencyLatencyHist11year', False),
    ]
