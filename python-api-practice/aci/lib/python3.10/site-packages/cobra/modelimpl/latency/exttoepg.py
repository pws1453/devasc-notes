...
class ExtToEpg(Mo):
    ...
    meta = ClassMeta("cobra.model.latency.ExtToEpg")

    meta.moClassName = "latencyExtToEpg"
    meta.rnFormat = "lExtToEpg-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ip to EPG latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 33256, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 33262, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 33263, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 33255, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 33264, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 33261, PropCategory.REGULAR)
