...
# ##################################################
class LatencyHist1Hist1h(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-1) in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist1Hist1h", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist1Hist1h"
    meta.rnFormat = "HDlatencyLatencyHist11h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-1) stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 29005, PropCategory.REGULAR)
