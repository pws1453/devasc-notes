...
class EpToEp(Mo):
    """
     Ep to EP latency, On-demand, Entry 

    """

    meta = ClassMeta("cobra.model.latency.EpToEp")

    meta.moClassName = "latencyEpToEp"
    meta.rnFormat = "lEpToEp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ep to Ep latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28852, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28952, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28953, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 28851, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28954, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28951, PropCategory.REGULAR)
