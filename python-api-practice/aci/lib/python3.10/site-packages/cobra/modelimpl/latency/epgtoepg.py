...
class EpgToEpg(Mo):
    """
     Epg to EPg latency, On-demand, Entry 

    """

    meta = ClassMeta("cobra.model.latency.EpgToEpg")

    meta.moClassName = "latencyEpgToEpg"
    meta.rnFormat = "lEpgToEpg-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Epg to Epg latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28870, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28968, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28969, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 28869, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28970, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28967, PropCategory.REGULAR)
