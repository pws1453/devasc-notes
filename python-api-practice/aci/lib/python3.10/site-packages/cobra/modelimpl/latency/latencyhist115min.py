...
# ##################################################
class LatencyHist115min(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist115min", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist115min"
    meta.rnFormat = "CDlatencyLatencyHist115min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.latency.LatencyHist1")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDlatencyLatencyHist115min', False),
    ]
