...
# ##################################################
class LatencyHist1Hist1w(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-1) in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist1Hist1w", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist1Hist1w"
    meta.rnFormat = "HDlatencyLatencyHist11w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-1) stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 29008, PropCategory.REGULAR)
