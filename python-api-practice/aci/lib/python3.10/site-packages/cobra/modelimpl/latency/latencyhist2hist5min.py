...
# ##################################################
class LatencyHist2Hist5min(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-2) in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist2Hist5min", "delay(histogram mode-2)")
    ...
    meta.moClassName = "latencyLatencyHist2Hist5min"
    meta.rnFormat = "HDlatencyLatencyHist25min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-2) stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist25min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29018, PropCategory.REGULAR)
