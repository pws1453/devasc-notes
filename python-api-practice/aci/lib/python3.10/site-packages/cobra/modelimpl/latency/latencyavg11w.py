...
# ##################################################
class LatencyAvg11w(Mo):
    """
    A class that represents the most current statistics for delay(average mode-1) in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg11w", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg11w"
    meta.rnFormat = "CDlatencyLatencyAvg11w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(average mode-1) stats in 1 week"
