...
class EpgToEp(Mo):
    """
     Epg to Ep latency, On-demand, Entry 

    """

    meta = ClassMeta("cobra.model.latency.EpgToEp")

    meta.moClassName = "latencyEpgToEp"
    meta.rnFormat = "lEpgToEp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Epg to Ep latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28864, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28965, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 28863, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28966, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28963, PropCategory.REGULAR)
