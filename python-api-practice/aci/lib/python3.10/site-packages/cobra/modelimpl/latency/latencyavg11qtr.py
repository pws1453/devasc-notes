...
# ##################################################
class LatencyAvg11qtr(Mo):
    """
    A class that represents the most current statistics for delay(average mode-1) in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg11qtr", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg11qtr"
    meta.rnFormat = "CDlatencyLatencyAvg11qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(average mode-1) stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDlatencyLatencyAvg11qtr', False),
    ]
