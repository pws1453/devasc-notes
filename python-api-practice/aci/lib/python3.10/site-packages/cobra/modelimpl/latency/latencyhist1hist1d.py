...
# ##################################################
class LatencyHist1Hist1d(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-1) in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist1Hist1d", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist1Hist1d"
    meta.rnFormat = "HDlatencyLatencyHist11d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-1) stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 29004, PropCategory.REGULAR)
