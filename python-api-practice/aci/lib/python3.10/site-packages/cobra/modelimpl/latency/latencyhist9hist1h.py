...
# ##################################################
class LatencyHist9Hist1h(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-9) in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist9Hist1h", "delay(histogram mode-9)")
    ...
    meta.moClassName = "latencyLatencyHist9Hist1h"
    meta.rnFormat = "HDlatencyLatencyHist91h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-9) stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 29069, PropCategory.REGULAR)
