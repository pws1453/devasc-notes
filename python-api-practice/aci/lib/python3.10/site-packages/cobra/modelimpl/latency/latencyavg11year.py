...
# ##################################################
class LatencyAvg11year(Mo):
    """
    A class that represents the most current statistics for delay(average mode-1) in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg11year", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg11year"
    meta.rnFormat = "CDlatencyLatencyAvg11year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(average mode-1) stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDlatencyLatencyAvg11year', False),
    ]
