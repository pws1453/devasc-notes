...
# ##################################################
class LatencyAvg2Hist1qtr(Mo):
    """
    A class that represents historical statistics for delay(average mode-2) in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg2Hist1qtr", "delay(average mode-2)")
    ...
    meta.moClassName = "latencyLatencyAvg2Hist1qtr"
    meta.rnFormat = "HDlatencyLatencyAvg21qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-2) stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 28999, PropCategory.REGULAR)
