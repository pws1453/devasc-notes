...
# ##################################################
class LatencyAvg1Hist1w(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist1w", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist1w"
    meta.rnFormat = "HDlatencyLatencyAvg11w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 28992, PropCategory.REGULAR)
