...
# ##################################################
class LatencyHist9Hist1year(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-9) in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist9Hist1year", "delay(histogram mode-9)")
    ...
    meta.moClassName = "latencyLatencyHist9Hist1year"
    meta.rnFormat = "HDlatencyLatencyHist91year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-9) stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist91year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29073, PropCategory.REGULAR)
