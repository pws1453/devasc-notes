...
# ##################################################
class LatencyHist11qtr(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist11qtr", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist11qtr"
    meta.rnFormat = "CDlatencyLatencyHist11qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDlatencyLatencyHist11qtr', False),
    ]
