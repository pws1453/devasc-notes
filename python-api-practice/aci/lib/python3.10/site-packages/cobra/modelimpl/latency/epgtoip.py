...
class EpgToIp(Mo):
    """
     EPG to IP latency, On-demand, Entry 

    """

    meta = ClassMeta("cobra.model.latency.EpgToIp")

    meta.moClassName = "latencyEpgToIp"
    meta.rnFormat = "lEpgToIp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EPG to External IP latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28866, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28972, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28973, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 28865, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28974, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28971, PropCategory.REGULAR)
