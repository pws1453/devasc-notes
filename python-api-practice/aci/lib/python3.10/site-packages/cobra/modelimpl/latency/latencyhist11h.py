...
# ##################################################
class LatencyHist11h(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist11h", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist11h"
    meta.rnFormat = "CDlatencyLatencyHist11h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 1 hour"
