...
# ##################################################
class LatencyAvg2Hist1d(Mo):
    """
    A class that represents historical statistics for delay(average mode-2) in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg2Hist1d", "delay(average mode-2)")
    ...
    meta.moClassName = "latencyLatencyAvg2Hist1d"
    meta.rnFormat = "HDlatencyLatencyAvg21d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-2) stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 28996, PropCategory.REGULAR)
