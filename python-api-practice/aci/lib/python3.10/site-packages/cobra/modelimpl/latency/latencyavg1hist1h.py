...
# ##################################################
class LatencyAvg1Hist1h(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist1h", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist1h"
    meta.rnFormat = "HDlatencyLatencyAvg11h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 28989, PropCategory.REGULAR)
