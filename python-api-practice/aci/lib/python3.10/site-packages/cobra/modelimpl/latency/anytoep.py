...
class AnyToEp(Mo):
    ...
    meta = ClassMeta("cobra.model.latency.AnyToEp")

    meta.moClassName = "latencyAnyToEp"
    meta.rnFormat = "lAnyToEp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Epg to any latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28860, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28944, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28945, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28946, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28943, PropCategory.REGULAR)
