...
# ##################################################
class LatencyAvg1Hist1d(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist1d", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist1d"
    meta.rnFormat = "HDlatencyLatencyAvg11d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 28988, PropCategory.REGULAR)
