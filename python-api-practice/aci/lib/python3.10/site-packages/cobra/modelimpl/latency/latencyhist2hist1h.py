...
# ##################################################
class LatencyHist2Hist1h(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-2) in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist2Hist1h", "delay(histogram mode-2)")
    ...
    meta.moClassName = "latencyLatencyHist2Hist1h"
    meta.rnFormat = "HDlatencyLatencyHist21h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-2) stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 29013, PropCategory.REGULAR)
