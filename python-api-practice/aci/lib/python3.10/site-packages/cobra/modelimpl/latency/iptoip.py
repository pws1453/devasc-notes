...
class IpToIp(Mo):
    """
     IP to EP latency, On-demand, Entry 

    """

    meta = ClassMeta("cobra.model.latency.IpToIp")

    meta.moClassName = "latencyIpToIp"
    meta.rnFormat = "lIpToIp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IP to IP latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28858, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28984, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28985, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 28857, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28986, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28983, PropCategory.REGULAR)
