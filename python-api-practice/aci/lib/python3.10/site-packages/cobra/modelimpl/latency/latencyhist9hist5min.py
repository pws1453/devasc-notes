...
# ##################################################
class LatencyHist9Hist5min(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-9) in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist9Hist5min", "delay(histogram mode-9)")
    ...
    meta.moClassName = "latencyLatencyHist9Hist5min"
    meta.rnFormat = "HDlatencyLatencyHist95min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-9) stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist95min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29074, PropCategory.REGULAR)
