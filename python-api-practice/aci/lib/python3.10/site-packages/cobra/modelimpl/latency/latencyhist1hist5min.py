...
# ##################################################
class LatencyHist1Hist5min(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-1) in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist1Hist5min", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist1Hist5min"
    meta.rnFormat = "HDlatencyLatencyHist15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-1) stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29010, PropCategory.REGULAR)
