...
class ExtToEp(Mo):
    ...
    meta = ClassMeta("cobra.model.latency.ExtToEp")

    meta.moClassName = "latencyExtToEp"
    meta.rnFormat = "lExtToep-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IP to EP latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 33254, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 33258, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 33259, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 33253, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 33260, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 33257, PropCategory.REGULAR)
