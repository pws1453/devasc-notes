...
# ##################################################
class LatencyHist11w(Mo):
    """
    A class that represents the most current statistics for delay(histogram mode-1) in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist11w", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist11w"
    meta.rnFormat = "CDlatencyLatencyHist11w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current delay(histogram mode-1) stats in 1 week"
