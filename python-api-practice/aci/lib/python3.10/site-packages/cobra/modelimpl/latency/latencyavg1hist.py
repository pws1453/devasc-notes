...
# ##################################################
class LatencyAvg1Hist(Mo):
    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist"


    meta.moClassName = "latencyLatencyAvg1Hist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats"
    ...
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist1w")
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist15min")
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist1year")
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist5min")
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist1qtr")
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist1d")
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist1h")
    meta.concreteSubClasses.add("cobra.model.latency.LatencyAvg1Hist1mo")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "avgDelayAvg", "avgDelayAvg", 29094, PropCategory.IMPLICIT_AVG)
    prop.label = "average delay average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgDelayAvg", prop)

    prop = PropMeta("str", "avgDelayCum", "avgDelayCum", 29090, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "average delay cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgDelayCum", prop)

    prop = PropMeta("str", "avgDelayMax", "avgDelayMax", 29093, PropCategory.IMPLICIT_MAX)
    prop.label = "average delay maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgDelayMax", prop)

    prop = PropMeta("str", "avgDelayMin", "avgDelayMin", 29092, PropCategory.IMPLICIT_MIN)
    prop.label = "average delay minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgDelayMin", prop)

    prop = PropMeta("str", "avgDelayPer", "avgDelayPer", 29091, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "average delay periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgDelayPer", prop)

    prop = PropMeta("str", "avgDelayRate", "avgDelayRate", 29098, PropCategory.IMPLICIT_RATE)
    prop.label = "average delay rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgDelayRate", prop)

    prop = PropMeta("str", "avgDelaySpct", "avgDelaySpct", 29095, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "average delay suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgDelaySpct", prop)

    prop = PropMeta("str", "avgDelayThr", "avgDelayThr", 29096, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "avgDelayTr", "avgDelayTr", 29097, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "cumAverageAvg", "cumAverageAvg", 29115, PropCategory.IMPLICIT_AVG)
    prop.label = "cumulative average delay average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cumAverageAvg", prop)

    prop = PropMeta("str", "cumAverageCum", "cumAverageCum", 29111, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "cumulative average delay cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cumAverageCum", prop)

    prop = PropMeta("str", "cumAverageMax", "cumAverageMax", 29114, PropCategory.IMPLICIT_MAX)
    prop.label = "cumulative average delay maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cumAverageMax", prop)

    prop = PropMeta("str", "cumAverageMin", "cumAverageMin", 29113, PropCategory.IMPLICIT_MIN)
    prop.label = "cumulative average delay minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cumAverageMin", prop)

    prop = PropMeta("str", "cumAveragePer", "cumAveragePer", 29112, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "cumulative average delay periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cumAveragePer", prop)

    prop = PropMeta("str", "cumAverageRate", "cumAverageRate", 29119, PropCategory.IMPLICIT_RATE)
    prop.label = "cumulative average delay rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cumAverageRate", prop)

    prop = PropMeta("str", "cumAverageSpct", "cumAverageSpct", 29116, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "cumulative average delay suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("cumAverageSpct", prop)

    prop = PropMeta("str", "cumAverageThr", "cumAverageThr", 29117, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "cumAverageTr", "cumAverageTr", 29118, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "maxDelayAvg", "maxDelayAvg", 29136, PropCategory.IMPLICIT_AVG)
    prop.label = "maximum delay average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelayAvg", prop)

    prop = PropMeta("str", "maxDelayCum", "maxDelayCum", 29132, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "maximum delay cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelayCum", prop)

    prop = PropMeta("str", "maxDelayMax", "maxDelayMax", 29135, PropCategory.IMPLICIT_MAX)
    prop.label = "maximum delay maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelayMax", prop)

    prop = PropMeta("str", "maxDelayMin", "maxDelayMin", 29134, PropCategory.IMPLICIT_MIN)
    prop.label = "maximum delay minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelayMin", prop)

    prop = PropMeta("str", "maxDelayPer", "maxDelayPer", 29133, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "maximum delay periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelayPer", prop)

    prop = PropMeta("str", "maxDelayRate", "maxDelayRate", 29140, PropCategory.IMPLICIT_RATE)
    prop.label = "maximum delay rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelayRate", prop)

    prop = PropMeta("str", "maxDelaySpct", "maxDelaySpct", 29137, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "maximum delay suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelaySpct", prop)

    prop = PropMeta("str", "maxDelayThr", "maxDelayThr", 29138, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "maxDelayTr", "maxDelayTr", 29139, PropCategory.IMPLICIT_TREND)
    prop.label = "maximum delay trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("maxDelayTr", prop)

    prop = PropMeta("str", "pktCountAvg", "pktCountAvg", 29157, PropCategory.IMPLICIT_AVG)
    prop.label = "packet count average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktCountAvg", prop)

    prop = PropMeta("str", "pktCountCum", "pktCountCum", 29153, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "packet count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktCountCum", prop)

    prop = PropMeta("str", "pktCountMax", "pktCountMax", 29156, PropCategory.IMPLICIT_MAX)
    prop.label = "packet count maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktCountMax", prop)

    prop = PropMeta("str", "pktCountMin", "pktCountMin", 29155, PropCategory.IMPLICIT_MIN)
    prop.label = "packet count minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktCountMin", prop)

    prop = PropMeta("str", "pktCountPer", "pktCountPer", 29154, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "packet count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktCountPer", prop)

    prop = PropMeta("str", "pktCountRate", "pktCountRate", 29161, PropCategory.IMPLICIT_RATE)
    prop.label = "packet count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktCountRate", prop)

    prop = PropMeta("str", "pktCountSpct", "pktCountSpct", 29158, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "packet count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktCountSpct", prop)

    prop = PropMeta("str", "pktCountThr", "pktCountThr", 29159, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktCountTr", "pktCountTr", 29160, PropCategory.IMPLICIT_TREND)
