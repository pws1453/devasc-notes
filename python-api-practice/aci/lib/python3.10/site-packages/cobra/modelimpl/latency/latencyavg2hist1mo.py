...
# ##################################################
class LatencyAvg2Hist1mo(Mo):
    """
    A class that represents historical statistics for delay(average mode-2) in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg2Hist1mo", "delay(average mode-2)")
    ...
    meta.moClassName = "latencyLatencyAvg2Hist1mo"
    meta.rnFormat = "HDlatencyLatencyAvg21mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-2) stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 28998, PropCategory.REGULAR)
