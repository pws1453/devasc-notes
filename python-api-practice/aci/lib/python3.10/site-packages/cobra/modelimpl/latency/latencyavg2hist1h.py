...
# ##################################################
class LatencyAvg2Hist1h(Mo):
    """
    A class that represents historical statistics for delay(average mode-2) in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg2Hist1h", "delay(average mode-2)")
    ...
    meta.moClassName = "latencyLatencyAvg2Hist1h"
    meta.rnFormat = "HDlatencyLatencyAvg21h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-2) stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 28997, PropCategory.REGULAR)
