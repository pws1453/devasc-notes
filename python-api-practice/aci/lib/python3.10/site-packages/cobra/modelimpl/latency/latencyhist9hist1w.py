...
# ##################################################
class LatencyHist9Hist1w(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-9) in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist9Hist1w", "delay(histogram mode-9)")
    ...
    meta.moClassName = "latencyLatencyHist9Hist1w"
    meta.rnFormat = "HDlatencyLatencyHist91w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-9) stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 29072, PropCategory.REGULAR)
