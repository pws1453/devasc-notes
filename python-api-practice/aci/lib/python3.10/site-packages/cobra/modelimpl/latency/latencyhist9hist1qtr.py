...
# ##################################################
class LatencyHist9Hist1qtr(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-9) in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist9Hist1qtr", "delay(histogram mode-9)")
    ...
    meta.moClassName = "latencyLatencyHist9Hist1qtr"
    meta.rnFormat = "HDlatencyLatencyHist91qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-9) stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist91qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29071, PropCategory.REGULAR)
