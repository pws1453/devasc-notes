...
class EpToIp(Mo):
    """
     Ep to Ip latency, On-demand, Entry 

    """

    meta = ClassMeta("cobra.model.latency.EpToIp")

    meta.moClassName = "latencyEpToIp"
    meta.rnFormat = "lEpToIp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ep to Ip latency Entry Stats"
    ...
    prop = PropMeta("str", "dst", "dst", 28854, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28960, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28961, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 28853, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28962, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28959, PropCategory.REGULAR)
