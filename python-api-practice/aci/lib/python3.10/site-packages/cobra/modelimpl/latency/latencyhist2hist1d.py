...
# ##################################################
class LatencyHist2Hist1d(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-2) in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist2Hist1d", "delay(histogram mode-2)")
    ...
    meta.moClassName = "latencyLatencyHist2Hist1d"
    meta.rnFormat = "HDlatencyLatencyHist21d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-2) stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 29012, PropCategory.REGULAR)
