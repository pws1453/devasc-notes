...
# ##################################################
class LatencyHist1Hist15min(Mo):
    """
    A class that represents historical statistics for delay(histogram mode-1) in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyHist1Hist15min", "delay(histogram mode-1)")
    ...
    meta.moClassName = "latencyLatencyHist1Hist15min"
    meta.rnFormat = "HDlatencyLatencyHist115min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(histogram mode-1) stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDlatencyLatencyHist115min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 29003, PropCategory.REGULAR)
