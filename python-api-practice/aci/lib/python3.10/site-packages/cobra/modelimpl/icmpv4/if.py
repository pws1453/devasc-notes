...
class If(Mo):
    """
    Internet Control Message Protocol (ICMPv4) information that is operated at the interface level.

    """

    meta = ClassMeta("cobra.model.icmpv4.If")

    meta.moClassName = "icmpv4If"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ICMPv4 Interface"
    ...
    meta.parentClasses.add("cobra.model.icmpv4.Dom")
    ...
    meta.superClasses.add("cobra.model.icmp.If")
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 2432, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = "redirect,port-unreachable"
    prop.defaultValueStr = "redirect,port-unreachable"
    prop._addConstant("port-unreachable", "send-icmp-port-unreachable-messages", 1)
    prop._addConstant("redirect", "send-icmp-redirect-messages", 256)
    prop._addConstant("unreachable", "send-icmp-unreachable-messages", 2)
    ...
    prop = PropMeta("str", "id", "id", 6598, PropCategory.REGULAR)
