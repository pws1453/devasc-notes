...
class Inst(Mo):
    """
    Per Internet Control Message Protocol (ICMPv4) instance information. There is only one instance of icmpv4 currently running in the system.

    """

    meta = ClassMeta("cobra.model.icmpv4.Inst")

    meta.moClassName = "icmpv4Inst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "ICMPv4 Instance"
    ...
    meta.childClasses.add("cobra.model.icmpv4.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.icmpv4.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.icmpv4.Entity")
