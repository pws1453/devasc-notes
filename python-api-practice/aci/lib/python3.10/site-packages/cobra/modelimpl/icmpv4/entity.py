...
class Entity(Mo):
    """
    Internet Control Message Protocol (ICMPv4) control plane entity information.

    """

    meta = ClassMeta("cobra.model.icmpv4.Entity")

    meta.moClassName = "icmpv4Entity"
    meta.rnFormat = "icmpv4"
    meta.category = MoCategory.REGULAR
    meta.label = "ICMPv4 Entity"
    ...
    meta.childClasses.add("cobra.model.icmpv4.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.icmpv4.Inst", "inst"))

    meta.parentClasses.add("cobra.model.top.System")

    meta.superClasses.add("cobra.model.nw.Conn")
    meta.superClasses.add("cobra.model.nw.CpEntity")
    meta.superClasses.add("cobra.model.icmp.Entity")
