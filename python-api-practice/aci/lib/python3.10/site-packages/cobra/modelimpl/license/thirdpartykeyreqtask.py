...
# ##################################################
class ThirdPartyKeyReqTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.license.ThirdPartyKeyReqTask")

    meta.moClassName = "licenseThirdPartyKeyReqTask"
    meta.rnFormat = "licenseThirdPartyKeyReqTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('licenseThirdPartyKeyReqTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 44942, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("send3rdPartyKeyReqToLM", "send3rdpartykeyreqtolm", 3246)
