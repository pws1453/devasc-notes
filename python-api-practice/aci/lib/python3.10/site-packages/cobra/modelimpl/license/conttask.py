...
class ContTask(Mo):
    ...
    meta = ClassMeta("cobra.model.license.ContTask")

    meta.moClassName = "licenseContTask"
    meta.rnFormat = "licenseContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 37143, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendToPD", "sendtopd", 3022)
