...
# ##################################################
class ConsumedEPsInstDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.license.ConsumedEPsInstDef")

    meta.moClassName = "licenseConsumedEPsInstDef"
    meta.rnFormat = "eps-%(consumerId)s"
    ...
    prop = PropMeta("str", "consumerId", "consumerId", 53055, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop.isNaming = True
    prop.range = [(1, 512)]
    meta.props.add("consumerId", prop)
    ...
    prop = PropMeta("str", "licenseCount", "licenseCount", 53057, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("licenseCount", prop)

    prop = PropMeta("str", "licenseType", "licenseType", 53056, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4
    ...
    meta.namingProps.append(getattr(meta.props, "consumerId"))

    def __init__(self, parentMoOrDn, consumerId, markDirty=True, **creationProps):
        namingVals = [consumerId]
