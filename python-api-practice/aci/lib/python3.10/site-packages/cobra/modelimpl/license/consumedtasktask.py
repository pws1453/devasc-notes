...
# ##################################################
class ConsumedTaskTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.license.ConsumedTaskTask")

    meta.moClassName = "licenseConsumedTaskTask"
    meta.rnFormat = "licenseConsumedTaskTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 36921, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("LicenseConsumeUpdate", "licenseconsumeupdate", 2997)
