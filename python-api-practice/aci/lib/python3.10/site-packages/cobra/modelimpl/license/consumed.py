...
class Consumed(Mo):
    ...
    meta = ClassMeta("cobra.model.license.Consumed")

    meta.moClassName = "licenseConsumed"
    meta.rnFormat = "consumed-%(licenseType)s"
    ...
    meta.childClasses.add("cobra.model.license.ConsumedInst")
    meta.childClasses.add("cobra.model.license.ConsumedEPsInst")
    meta.childClasses.add("cobra.model.license.ConsumedAppInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.license.ConsumedInst", "inst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.license.ConsumedEPsInst", "eps-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.license.ConsumedAppInst", "app-"))
    ...
    prop = PropMeta("str", "licenseType", "licenseType", 36874, PropCategory.REGULAR)
