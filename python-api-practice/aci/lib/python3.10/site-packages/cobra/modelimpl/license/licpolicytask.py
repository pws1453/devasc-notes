...
# ##################################################
class LicPolicyTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.license.LicPolicyTask")

    meta.moClassName = "licenseLicPolicyTask"
    meta.rnFormat = "licenseLicPolicyTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 37247, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendToLM", "sendtolm", 3034)
