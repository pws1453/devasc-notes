...
# ##################################################
class L3RemoteUsagePerHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist1mo", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist1mo"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36405, PropCategory.REGULAR)
