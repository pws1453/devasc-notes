...
# ##################################################
class L3v4Usage32Per15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Per15min", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Per15min"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Per15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries usage percentage stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.L3v4Usage32Per")

    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Per15min', False),
    ]
