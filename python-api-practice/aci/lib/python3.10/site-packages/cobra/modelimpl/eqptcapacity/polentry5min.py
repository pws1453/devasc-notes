...
# ##################################################
class PolEntry5min(Mo):
    """
    A class that represents the most current statistics for  Policy entry in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntry5min", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntry5min"
    meta.rnFormat = "CDeqptcapacityPolEntry5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Policy entry stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityPolEntry5min', False),
    ]
