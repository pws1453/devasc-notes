...
# ##################################################
class PolEntry15min(Mo):
    """
    A class that represents the most current statistics for  Policy entry in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntry15min", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntry15min"
    meta.rnFormat = "CDeqptcapacityPolEntry15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Policy entry stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityPolEntry15min', False),
    ]
