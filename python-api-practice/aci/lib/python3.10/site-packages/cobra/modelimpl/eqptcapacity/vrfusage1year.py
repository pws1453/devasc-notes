...
# ##################################################
class VrfUsage1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsage1year", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsage1year"
    meta.rnFormat = "CDeqptcapacityVrfUsage1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current VRF usage count stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVrfUsage1year', False),
    ]
