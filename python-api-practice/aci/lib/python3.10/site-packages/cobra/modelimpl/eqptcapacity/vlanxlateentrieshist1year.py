...
# ##################################################
class VlanXlateEntriesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist1year", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist1year"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20940, PropCategory.REGULAR)
