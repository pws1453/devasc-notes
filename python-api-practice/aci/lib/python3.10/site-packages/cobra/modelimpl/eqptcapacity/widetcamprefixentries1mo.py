...
# ##################################################
class WideTcamPrefixEntries1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntries1mo", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntries1mo"
    meta.rnFormat = "CDeqptcapacityWideTcamPrefixEntries1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Wide Tcam Prefix IPv6 entries stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityWideTcamPrefixEntries1mo', False),
    ]
