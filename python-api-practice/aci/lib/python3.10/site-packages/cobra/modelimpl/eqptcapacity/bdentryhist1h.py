...
# ##################################################
class BDEntryHist1h(Mo):
    """
    A class that represents historical statistics for bridge domain entry in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntryHist1h", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntryHist1h"
    meta.rnFormat = "HDeqptcapacityBDEntry1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical bridge domain entry stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6344, PropCategory.REGULAR)
