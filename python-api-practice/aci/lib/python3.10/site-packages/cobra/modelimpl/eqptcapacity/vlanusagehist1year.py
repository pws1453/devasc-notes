...
# ##################################################
class VlanUsageHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsageHist1year", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsageHist1year"
    meta.rnFormat = "HDeqptcapacityVlanUsage1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan entries usage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanUsage1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19997, PropCategory.REGULAR)
