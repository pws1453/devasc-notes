...
# ##################################################
class VrfUsageHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist1d", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist1d"
    meta.rnFormat = "HDeqptcapacityVrfUsage1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47476, PropCategory.REGULAR)
