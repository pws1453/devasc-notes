...
# ##################################################
class VlanXlateEntries5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntries5min", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntries5min"
    meta.rnFormat = "CDeqptcapacityVlanXlateEntries5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan Xlate entries stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanXlateEntries5min', False),
    ]
