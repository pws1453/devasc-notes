...
# ##################################################
class L3v6Usage128Hist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Hist15min", "Layer3 v6 128 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Hist15min"
    meta.rnFormat = "HDeqptcapacityL3v6Usage12815min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage count stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage12815min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43952, PropCategory.REGULAR)
