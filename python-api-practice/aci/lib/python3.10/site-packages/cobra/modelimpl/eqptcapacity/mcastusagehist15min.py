...
# ##################################################
class McastUsageHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsageHist15min", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsageHist15min"
    meta.rnFormat = "HDeqptcapacityMcastUsage15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Multicast entries usage stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityMcastUsage15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19967, PropCategory.REGULAR)
