...
# ##################################################
class L3UsageCapHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCapHist1qtr", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCapHist1qtr"
    meta.rnFormat = "HDeqptcapacityL3UsageCap1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries max capacity stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsageCap1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20471, PropCategory.REGULAR)
