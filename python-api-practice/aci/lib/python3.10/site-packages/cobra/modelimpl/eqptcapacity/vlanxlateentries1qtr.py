...
# ##################################################
class VlanXlateEntries1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntries1qtr", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntries1qtr"
    meta.rnFormat = "CDeqptcapacityVlanXlateEntries1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan Xlate entries stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanXlateEntries1qtr', False),
    ]
