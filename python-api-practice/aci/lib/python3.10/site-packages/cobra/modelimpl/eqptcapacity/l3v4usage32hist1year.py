...
# ##################################################
class L3v4Usage32Hist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Hist1year", "Layer3 v4 32 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Hist1year"
    meta.rnFormat = "HDeqptcapacityL3v4Usage321year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage count stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage321year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43934, PropCategory.REGULAR)
