...
# ##################################################
class L3v4Usage32Cap1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Cap1qtr", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Cap1qtr"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Cap1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries max capacity stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Cap1qtr', False),
    ]
