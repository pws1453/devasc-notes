...
# ##################################################
class L3UsageCapHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCapHist15min", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCapHist15min"
    meta.rnFormat = "HDeqptcapacityL3UsageCap15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries max capacity stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsageCap15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20467, PropCategory.REGULAR)
