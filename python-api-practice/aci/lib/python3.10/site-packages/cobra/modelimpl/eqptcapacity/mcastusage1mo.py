...
# ##################################################
class McastUsage1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage1mo", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsage1mo"
    meta.rnFormat = "CDeqptcapacityMcastUsage1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage1mo', False),
    ]
