...
# ##################################################
class L3TotalUsageCap1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCap1d", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCap1d"
    meta.rnFormat = "CDeqptcapacityL3TotalUsageCap1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 total entries max capacity stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3TotalUsageCap1d', False),
    ]
