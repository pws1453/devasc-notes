...
# ##################################################
class VrfUsageHist(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist"


    meta.moClassName = "eqptcapacityVrfUsageHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VrfUsageHist1year")
    ...
    prop = PropMeta("str", "totalAvg", "totalAvg", 47646, PropCategory.IMPLICIT_AVG)
    prop.label = "Total VRF entries average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalAvg", prop)

    prop = PropMeta("str", "totalCapAvg", "totalCapAvg", 47625, PropCategory.IMPLICIT_AVG)
    prop.label = "VRF entries capacity average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapAvg", prop)

    prop = PropMeta("str", "totalCapCum", "totalCapCum", 47621, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "VRF entries capacity cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapCum", prop)

    prop = PropMeta("str", "totalCapMax", "totalCapMax", 47624, PropCategory.IMPLICIT_MAX)
    prop.label = "VRF entries capacity maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMax", prop)

    prop = PropMeta("str", "totalCapMin", "totalCapMin", 47623, PropCategory.IMPLICIT_MIN)
    prop.label = "VRF entries capacity minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMin", prop)

    prop = PropMeta("str", "totalCapPer", "totalCapPer", 47622, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "VRF entries capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapPer", prop)

    prop = PropMeta("str", "totalCapRate", "totalCapRate", 47629, PropCategory.IMPLICIT_RATE)
    prop.label = "VRF entries capacity rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapRate", prop)

    prop = PropMeta("str", "totalCapSpct", "totalCapSpct", 47626, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "VRF entries capacity suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapSpct", prop)

    prop = PropMeta("str", "totalCapThr", "totalCapThr", 47627, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalCapTr", "totalCapTr", 47628, PropCategory.IMPLICIT_TREND)
    prop.label = "VRF entries capacity trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapTr", prop)

    prop = PropMeta("str", "totalCum", "totalCum", 47642, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total VRF entries cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCum", prop)

    prop = PropMeta("str", "totalMax", "totalMax", 47645, PropCategory.IMPLICIT_MAX)
    prop.label = "Total VRF entries maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMax", prop)

    prop = PropMeta("str", "totalMin", "totalMin", 47644, PropCategory.IMPLICIT_MIN)
    prop.label = "Total VRF entries minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMin", prop)

    prop = PropMeta("str", "totalPer", "totalPer", 47643, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total VRF entries periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalPer", prop)

    prop = PropMeta("str", "totalRate", "totalRate", 47650, PropCategory.IMPLICIT_RATE)
    prop.label = "Total VRF entries rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalRate", prop)

    prop = PropMeta("str", "totalSpct", "totalSpct", 47647, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total VRF entries suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalSpct", prop)

    prop = PropMeta("str", "totalThr", "totalThr", 47648, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalTr", "totalTr", 47649, PropCategory.IMPLICIT_TREND)
