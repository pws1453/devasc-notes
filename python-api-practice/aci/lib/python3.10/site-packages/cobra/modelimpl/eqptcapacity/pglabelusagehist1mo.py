...
# ##################################################
class PGLabelUsageHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist1mo", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist1mo"
    meta.rnFormat = "HDeqptcapacityPGLabelUsage1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPGLabelUsage1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 44393, PropCategory.REGULAR)
