...
# ##################################################
class VlanXlateEntries1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntries1w", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntries1w"
    meta.rnFormat = "CDeqptcapacityVlanXlateEntries1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan Xlate entries stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanXlateEntries1w', False),
    ]
