...
# ##################################################
class BdUsage1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage1qtr", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage1qtr"
    meta.rnFormat = "CDeqptcapacityBdUsage1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityBdUsage1qtr', False),
    ]
