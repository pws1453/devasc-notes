...
# ##################################################
class L3UsageCapHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCapHist1h", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCapHist1h"
    meta.rnFormat = "HDeqptcapacityL3UsageCap1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries max capacity stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsageCap1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20469, PropCategory.REGULAR)
