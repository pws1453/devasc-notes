...
# ##################################################
class WideTcamPrefixEntries1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntries1h", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntries1h"
    meta.rnFormat = "CDeqptcapacityWideTcamPrefixEntries1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Wide Tcam Prefix IPv6 entries stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityWideTcamPrefixEntries1h', False),
    ]
