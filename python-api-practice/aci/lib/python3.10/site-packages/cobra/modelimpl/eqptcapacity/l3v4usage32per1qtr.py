...
# ##################################################
class L3v4Usage32Per1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Per1qtr", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Per1qtr"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Per1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries usage percentage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Per1qtr', False),
    ]
