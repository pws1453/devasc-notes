...
# ##################################################
class L3TotalUsageCap5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCap5min", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCap5min"
    meta.rnFormat = "CDeqptcapacityL3TotalUsageCap5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 total entries max capacity stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3TotalUsageCap5min', False),
    ]
