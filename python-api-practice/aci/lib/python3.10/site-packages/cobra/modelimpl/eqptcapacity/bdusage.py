...
# ##################################################
class BdUsage(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage"


    meta.moClassName = "eqptcapacityBdUsage"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage1qtr")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsage15min")
    ...
    prop = PropMeta("str", "totalAvg", "totalAvg", 47510, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Bridge domain entries average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalAvg", prop)

    prop = PropMeta("str", "totalBase", "totalBase", 47505, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Total Bridge domain entries baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalBase", prop)

    prop = PropMeta("str", "totalCapAvg", "totalCapAvg", 47489, PropCategory.IMPLICIT_AVG)
    prop.label = "Bridge domain entries capacity average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapAvg", prop)

    prop = PropMeta("str", "totalCapBase", "totalCapBase", 47484, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Bridge domain entries capacity baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapBase", prop)

    prop = PropMeta("str", "totalCapCum", "totalCapCum", 47485, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Bridge domain entries capacity cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapCum", prop)

    prop = PropMeta("str", "totalCapLast", "totalCapLast", 47483, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Bridge domain entries capacity current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapLast", prop)

    prop = PropMeta("str", "totalCapMax", "totalCapMax", 47488, PropCategory.IMPLICIT_MAX)
    prop.label = "Bridge domain entries capacity maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMax", prop)

    prop = PropMeta("str", "totalCapMin", "totalCapMin", 47487, PropCategory.IMPLICIT_MIN)
    prop.label = "Bridge domain entries capacity minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMin", prop)

    prop = PropMeta("str", "totalCapPer", "totalCapPer", 47486, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Bridge domain entries capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapPer", prop)

    prop = PropMeta("str", "totalCapRate", "totalCapRate", 47494, PropCategory.IMPLICIT_RATE)
    prop.label = "Bridge domain entries capacity rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapRate", prop)

    prop = PropMeta("str", "totalCapSpct", "totalCapSpct", 47490, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Bridge domain entries capacity suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapSpct", prop)

    prop = PropMeta("str", "totalCapThr", "totalCapThr", 47491, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalCapTr", "totalCapTr", 47493, PropCategory.IMPLICIT_TREND)
    prop.label = "Bridge domain entries capacity trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapTr", prop)

    prop = PropMeta("str", "totalCapTrBase", "totalCapTrBase", 47492, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Bridge domain entries capacity trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapTrBase", prop)

    prop = PropMeta("str", "totalCum", "totalCum", 47506, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total Bridge domain entries cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCum", prop)

    prop = PropMeta("str", "totalLast", "totalLast", 47504, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Total Bridge domain entries current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalLast", prop)

    prop = PropMeta("str", "totalMax", "totalMax", 47509, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Bridge domain entries maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMax", prop)

    prop = PropMeta("str", "totalMin", "totalMin", 47508, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Bridge domain entries minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMin", prop)

    prop = PropMeta("str", "totalPer", "totalPer", 47507, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total Bridge domain entries periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalPer", prop)

    prop = PropMeta("str", "totalRate", "totalRate", 47515, PropCategory.IMPLICIT_RATE)
    prop.label = "Total Bridge domain entries rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalRate", prop)

    prop = PropMeta("str", "totalSpct", "totalSpct", 47511, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Bridge domain entries suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalSpct", prop)

    prop = PropMeta("str", "totalThr", "totalThr", 47512, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalTr", "totalTr", 47514, PropCategory.IMPLICIT_TREND)
    prop.label = "Total Bridge domain entries trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalTr", prop)

    prop = PropMeta("str", "totalTrBase", "totalTrBase", 47513, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Total Bridge domain entries trend baseline"
    prop.isOper = True
    prop.isStats = True
