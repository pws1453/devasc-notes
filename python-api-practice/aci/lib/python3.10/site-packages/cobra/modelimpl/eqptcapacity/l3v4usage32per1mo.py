...
# ##################################################
class L3v4Usage32Per1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Per1mo", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Per1mo"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Per1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries usage percentage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Per1mo', False),
    ]
