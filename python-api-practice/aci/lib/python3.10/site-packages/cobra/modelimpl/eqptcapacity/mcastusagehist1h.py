...
# ##################################################
class McastUsageHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsageHist1h", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsageHist1h"
    meta.rnFormat = "HDeqptcapacityMcastUsage1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Multicast entries usage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityMcastUsage1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19969, PropCategory.REGULAR)
