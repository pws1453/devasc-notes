...
# ##################################################
class L3RemoteUsagePerHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist15min", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist15min"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist")

    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36402, PropCategory.REGULAR)
