...
# ##################################################
class L3v4Usage32CapHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist5min", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist5min"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43927, PropCategory.REGULAR)
