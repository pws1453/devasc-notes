...
# ##################################################
class EpgUsageHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist1year", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist1year"
    meta.rnFormat = "HDeqptcapacityEpgUsage1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityEpgUsage1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47465, PropCategory.REGULAR)
