...
# ##################################################
class VrfUsageHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist1year", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist1year"
    meta.rnFormat = "HDeqptcapacityVrfUsage1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVrfUsage1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47481, PropCategory.REGULAR)
