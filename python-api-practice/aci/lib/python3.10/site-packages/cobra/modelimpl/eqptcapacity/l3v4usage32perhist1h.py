...
# ##################################################
class L3v4Usage32PerHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist1h", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist1h"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43938, PropCategory.REGULAR)
