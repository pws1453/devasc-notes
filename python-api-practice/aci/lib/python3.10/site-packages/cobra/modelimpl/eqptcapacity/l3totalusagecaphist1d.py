...
# ##################################################
class L3TotalUsageCapHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCapHist1d", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCapHist1d"
    meta.rnFormat = "HDeqptcapacityL3TotalUsageCap1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 total entries max capacity stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3TotalUsageCap1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36411, PropCategory.REGULAR)
