...
# ##################################################
class L3v4Usage32Cap1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Cap1h", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Cap1h"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Cap1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries max capacity stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Cap1h', False),
    ]
