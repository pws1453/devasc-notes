...
# ##################################################
class L3v4Usage32Hist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Hist1d", "Layer3 v4 32 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Hist1d"
    meta.rnFormat = "HDeqptcapacityL3v4Usage321d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage count stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage321d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43929, PropCategory.REGULAR)
