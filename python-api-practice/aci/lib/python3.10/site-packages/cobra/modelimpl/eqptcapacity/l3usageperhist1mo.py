...
# ##################################################
class L3UsagePerHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsagePerHist1mo", "Layer3 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3UsagePerHist1mo"
    meta.rnFormat = "HDeqptcapacityL3UsagePer1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries usage percentage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsagePer1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 27167, PropCategory.REGULAR)
