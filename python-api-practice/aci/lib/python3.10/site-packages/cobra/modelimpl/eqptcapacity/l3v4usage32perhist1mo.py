...
# ##################################################
class L3v4Usage32PerHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist1mo", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist1mo"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43939, PropCategory.REGULAR)
