...
# ##################################################
class VrfUsage15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsage15min", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsage15min"
    meta.rnFormat = "CDeqptcapacityVrfUsage15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current VRF usage count stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVrfUsage15min', False),
    ]
