...
# ##################################################
class EpgUsageHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist1qtr", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist1qtr"
    meta.rnFormat = "HDeqptcapacityEpgUsage1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityEpgUsage1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47463, PropCategory.REGULAR)
