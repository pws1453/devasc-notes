...
# ##################################################
class PGLabelUsageHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist5min", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist5min"
    meta.rnFormat = "HDeqptcapacityPGLabelUsage5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPGLabelUsage5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 44397, PropCategory.REGULAR)
