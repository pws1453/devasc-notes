...
# ##################################################
class McastUsage1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage1h", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsage1h"
    meta.rnFormat = "CDeqptcapacityMcastUsage1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage1h', False),
    ]
