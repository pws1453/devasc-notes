...
# ##################################################
class VrfUsageHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist1qtr", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist1qtr"
    meta.rnFormat = "HDeqptcapacityVrfUsage1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVrfUsage1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47479, PropCategory.REGULAR)
