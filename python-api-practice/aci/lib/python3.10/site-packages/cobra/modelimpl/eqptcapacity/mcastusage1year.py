...
# ##################################################
class McastUsage1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage1year", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsage1year"
    meta.rnFormat = "CDeqptcapacityMcastUsage1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage1year', False),
    ]
