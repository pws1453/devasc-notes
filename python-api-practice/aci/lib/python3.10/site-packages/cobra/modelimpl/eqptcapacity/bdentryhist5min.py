...
# ##################################################
class BDEntryHist5min(Mo):
    """
    A class that represents historical statistics for bridge domain entry in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntryHist5min", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntryHist5min"
    meta.rnFormat = "HDeqptcapacityBDEntry5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical bridge domain entry stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityBDEntry5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6349, PropCategory.REGULAR)
