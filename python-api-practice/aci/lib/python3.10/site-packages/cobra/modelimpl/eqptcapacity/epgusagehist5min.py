...
# ##################################################
class EpgUsageHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist5min", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist5min"
    meta.rnFormat = "HDeqptcapacityEpgUsage5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityEpgUsage5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47466, PropCategory.REGULAR)
