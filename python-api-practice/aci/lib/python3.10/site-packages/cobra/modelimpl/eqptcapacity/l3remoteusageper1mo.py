...
# ##################################################
class L3RemoteUsagePer1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePer1mo", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePer1mo"
    meta.rnFormat = "CDeqptcapacityL3RemoteUsagePer1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 remote entries usage percentage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3RemoteUsagePer1mo', False),
    ]
