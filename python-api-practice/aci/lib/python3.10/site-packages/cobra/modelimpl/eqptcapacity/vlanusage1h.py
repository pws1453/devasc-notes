...
# ##################################################
class VlanUsage1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage1h", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage1h"
    meta.rnFormat = "CDeqptcapacityVlanUsage1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage1h', False),
    ]
