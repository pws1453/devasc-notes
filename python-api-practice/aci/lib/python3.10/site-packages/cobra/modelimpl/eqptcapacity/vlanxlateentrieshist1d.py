...
# ##################################################
class VlanXlateEntriesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist1d", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist1d"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20935, PropCategory.REGULAR)
