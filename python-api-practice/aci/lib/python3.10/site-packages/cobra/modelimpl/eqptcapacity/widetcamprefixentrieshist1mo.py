...
# ##################################################
class WideTcamPrefixEntriesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1mo", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist1mo"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35433, PropCategory.REGULAR)
