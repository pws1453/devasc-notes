...
# ##################################################
class L3v4Usage32CapHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist1qtr", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist1qtr"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43924, PropCategory.REGULAR)
