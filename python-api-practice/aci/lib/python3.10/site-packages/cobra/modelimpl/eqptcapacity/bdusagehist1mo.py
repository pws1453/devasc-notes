...
# ##################################################
class BdUsageHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist1mo", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist1mo"
    meta.rnFormat = "HDeqptcapacityBdUsage1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 47454, PropCategory.REGULAR)
