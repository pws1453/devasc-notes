...
# ##################################################
class L3UsagePerHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsagePerHist5min", "Layer3 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3UsagePerHist5min"
    meta.rnFormat = "HDeqptcapacityL3UsagePer5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries usage percentage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsagePer5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 27171, PropCategory.REGULAR)
