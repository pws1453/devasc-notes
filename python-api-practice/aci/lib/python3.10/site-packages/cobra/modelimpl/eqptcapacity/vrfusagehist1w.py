...
# ##################################################
class VrfUsageHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist1w", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist1w"
    meta.rnFormat = "HDeqptcapacityVrfUsage1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47480, PropCategory.REGULAR)
