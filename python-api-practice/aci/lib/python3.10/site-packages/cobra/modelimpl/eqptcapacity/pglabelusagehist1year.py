...
# ##################################################
class PGLabelUsageHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist1year", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist1year"
    meta.rnFormat = "HDeqptcapacityPGLabelUsage1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPGLabelUsage1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 44396, PropCategory.REGULAR)
