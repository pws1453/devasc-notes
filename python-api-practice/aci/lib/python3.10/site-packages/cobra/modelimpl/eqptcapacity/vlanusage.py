...
# ##################################################
class VlanUsage(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage"


    meta.moClassName = "eqptcapacityVlanUsage"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage1qtr")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.VlanUsage15min")
    ...
    prop = PropMeta("str", "totalAvg", "totalAvg", 20104, PropCategory.IMPLICIT_AVG)
    prop.label = "Total vlan entries average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalAvg", prop)

    prop = PropMeta("str", "totalBase", "totalBase", 20099, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Total vlan entries baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalBase", prop)

    prop = PropMeta("str", "totalCapAvg", "totalCapAvg", 20586, PropCategory.IMPLICIT_AVG)
    prop.label = "Vlan entries capacity average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapAvg", prop)

    prop = PropMeta("str", "totalCapBase", "totalCapBase", 20581, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Vlan entries capacity baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapBase", prop)

    prop = PropMeta("str", "totalCapCum", "totalCapCum", 20582, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Vlan entries capacity cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapCum", prop)

    prop = PropMeta("str", "totalCapLast", "totalCapLast", 20580, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Vlan entries capacity current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapLast", prop)

    prop = PropMeta("str", "totalCapMax", "totalCapMax", 20585, PropCategory.IMPLICIT_MAX)
    prop.label = "Vlan entries capacity maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMax", prop)

    prop = PropMeta("str", "totalCapMin", "totalCapMin", 20584, PropCategory.IMPLICIT_MIN)
    prop.label = "Vlan entries capacity minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMin", prop)

    prop = PropMeta("str", "totalCapPer", "totalCapPer", 20583, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Vlan entries capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapPer", prop)

    prop = PropMeta("str", "totalCapRate", "totalCapRate", 20591, PropCategory.IMPLICIT_RATE)
    prop.label = "Vlan entries capacity rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapRate", prop)

    prop = PropMeta("str", "totalCapSpct", "totalCapSpct", 20587, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Vlan entries capacity suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapSpct", prop)

    prop = PropMeta("str", "totalCapThr", "totalCapThr", 20588, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalCapTr", "totalCapTr", 20590, PropCategory.IMPLICIT_TREND)
    prop.label = "Vlan entries capacity trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapTr", prop)

    prop = PropMeta("str", "totalCapTrBase", "totalCapTrBase", 20589, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Vlan entries capacity trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapTrBase", prop)

    prop = PropMeta("str", "totalCum", "totalCum", 20100, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total vlan entries cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCum", prop)

    prop = PropMeta("str", "totalLast", "totalLast", 20098, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Total vlan entries current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalLast", prop)

    prop = PropMeta("str", "totalMax", "totalMax", 20103, PropCategory.IMPLICIT_MAX)
    prop.label = "Total vlan entries maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMax", prop)

    prop = PropMeta("str", "totalMin", "totalMin", 20102, PropCategory.IMPLICIT_MIN)
    prop.label = "Total vlan entries minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMin", prop)

    prop = PropMeta("str", "totalPer", "totalPer", 20101, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total vlan entries periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalPer", prop)

    prop = PropMeta("str", "totalRate", "totalRate", 20109, PropCategory.IMPLICIT_RATE)
    prop.label = "Total vlan entries rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalRate", prop)

    prop = PropMeta("str", "totalSpct", "totalSpct", 20105, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total vlan entries suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalSpct", prop)

    prop = PropMeta("str", "totalThr", "totalThr", 20106, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalTr", "totalTr", 20108, PropCategory.IMPLICIT_TREND)
    prop.label = "Total vlan entries trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalTr", prop)

    prop = PropMeta("str", "totalTrBase", "totalTrBase", 20107, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Total vlan entries trend baseline"
    prop.isOper = True
    prop.isStats = True
