...
# ##################################################
class L3v6Usage128Per1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Per1qtr", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Per1qtr"
    meta.rnFormat = "CDeqptcapacityL3v6Usage128Per1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v6 128 entries usage percentage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v6Usage128Per1qtr', False),
    ]
