...
# ##################################################
class L3UsagePerHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsagePerHist15min", "Layer3 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3UsagePerHist15min"
    meta.rnFormat = "HDeqptcapacityL3UsagePer15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries usage percentage stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsagePer15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 27164, PropCategory.REGULAR)
