...
# ##################################################
class BdUsage15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage15min", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage15min"
    meta.rnFormat = "CDeqptcapacityBdUsage15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.BdUsage")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDeqptcapacityBdUsage15min', False),
    ]
