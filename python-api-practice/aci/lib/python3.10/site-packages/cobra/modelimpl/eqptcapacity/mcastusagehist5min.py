...
# ##################################################
class McastUsageHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsageHist5min", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsageHist5min"
    meta.rnFormat = "HDeqptcapacityMcastUsage5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Multicast entries usage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityMcastUsage5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19974, PropCategory.REGULAR)
