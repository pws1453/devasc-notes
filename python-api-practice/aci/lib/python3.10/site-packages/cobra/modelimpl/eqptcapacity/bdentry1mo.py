...
class BDEntry1mo(Mo):
    """
    A class that represents the most current statistics for bridge domain entry in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntry1mo", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntry1mo"
    meta.rnFormat = "CDeqptcapacityBDEntry1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current bridge domain entry stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityBDEntry1mo', False),
    ]
