...
# ##################################################
class PolEntryHist1year(Mo):
    """
    A class that represents historical statistics for  Policy entry in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntryHist1year", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntryHist1year"
    meta.rnFormat = "HDeqptcapacityPolEntry1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Policy entry stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPolEntry1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6380, PropCategory.REGULAR)
