...
# ##################################################
class WideTcamPrefixEntriesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1d", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist1d"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35431, PropCategory.REGULAR)
