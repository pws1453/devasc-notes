...
# ##################################################
class VlanUsageHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsageHist1qtr", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsageHist1qtr"
    meta.rnFormat = "HDeqptcapacityVlanUsage1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan entries usage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanUsage1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19995, PropCategory.REGULAR)
