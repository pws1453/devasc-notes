...
# ##################################################
class EpgUsage1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage1mo", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage1mo"
    meta.rnFormat = "CDeqptcapacityEpgUsage1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityEpgUsage1mo', False),
    ]
