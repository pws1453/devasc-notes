...
# ##################################################
class L2RemoteUsage1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsage1h", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsage1h"
    meta.rnFormat = "CDeqptcapacityL2RemoteUsage1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer2 remote entries usage count stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL2RemoteUsage1h', False),
    ]
