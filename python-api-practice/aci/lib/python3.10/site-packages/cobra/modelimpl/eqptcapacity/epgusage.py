...
# ##################################################
class EpgUsage(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage"


    meta.moClassName = "eqptcapacityEpgUsage"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage1qtr")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsage1d")
