...
# ##################################################
class WideTcamPrefixEntries1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntries1w", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntries1w"
    meta.rnFormat = "CDeqptcapacityWideTcamPrefixEntries1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Wide Tcam Prefix IPv6 entries stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityWideTcamPrefixEntries1w', False),
    ]
