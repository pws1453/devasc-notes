...
# ##################################################
class McastUsageHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsageHist1mo", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsageHist1mo"
    meta.rnFormat = "HDeqptcapacityMcastUsage1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Multicast entries usage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityMcastUsage1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19970, PropCategory.REGULAR)
