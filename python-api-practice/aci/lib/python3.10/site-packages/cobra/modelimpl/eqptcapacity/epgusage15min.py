...
# ##################################################
class EpgUsage15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage15min", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage15min"
    meta.rnFormat = "CDeqptcapacityEpgUsage15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityEpgUsage15min', False),
    ]
