...
# ##################################################
class McastUsageHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsageHist1qtr", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsageHist1qtr"
    meta.rnFormat = "HDeqptcapacityMcastUsage1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Multicast entries usage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityMcastUsage1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19971, PropCategory.REGULAR)
