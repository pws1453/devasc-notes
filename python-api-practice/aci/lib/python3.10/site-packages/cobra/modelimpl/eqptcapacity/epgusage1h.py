...
class EpgUsage1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage1h", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage1h"
    meta.rnFormat = "CDeqptcapacityEpgUsage1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityEpgUsage1h', False),
    ]
