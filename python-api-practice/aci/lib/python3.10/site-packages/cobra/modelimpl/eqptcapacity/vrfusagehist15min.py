...
# ##################################################
class VrfUsageHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist15min", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist15min"
    meta.rnFormat = "HDeqptcapacityVrfUsage15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.VrfUsageHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDeqptcapacityVrfUsage15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47475, PropCategory.REGULAR)
