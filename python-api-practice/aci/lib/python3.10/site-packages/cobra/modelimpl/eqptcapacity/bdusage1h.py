...
class BdUsage1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage1h", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage1h"
    meta.rnFormat = "CDeqptcapacityBdUsage1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats in 1 hour"
