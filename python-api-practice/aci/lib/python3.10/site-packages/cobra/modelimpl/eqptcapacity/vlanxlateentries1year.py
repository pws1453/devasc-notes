...
# ##################################################
class VlanXlateEntries1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntries1year", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntries1year"
    meta.rnFormat = "CDeqptcapacityVlanXlateEntries1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan Xlate entries stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanXlateEntries1year', False),
    ]
