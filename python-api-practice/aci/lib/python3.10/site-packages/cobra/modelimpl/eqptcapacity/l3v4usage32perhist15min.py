...
# ##################################################
class L3v4Usage32PerHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist15min", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist15min"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.L3v4Usage32PerHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43936, PropCategory.REGULAR)
