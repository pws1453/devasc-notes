...
# ##################################################
class L3v4Usage32PerHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist1qtr", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist1qtr"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43940, PropCategory.REGULAR)
