...
# ##################################################
class WideTcamPrefixEntriesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1qtr", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist1qtr"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35434, PropCategory.REGULAR)
