...
# ##################################################
class EpgUsage1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage1year", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage1year"
    meta.rnFormat = "CDeqptcapacityEpgUsage1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityEpgUsage1year', False),
    ]
