...
# ##################################################
class VlanXlateEntriesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist5min", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist5min"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20941, PropCategory.REGULAR)
