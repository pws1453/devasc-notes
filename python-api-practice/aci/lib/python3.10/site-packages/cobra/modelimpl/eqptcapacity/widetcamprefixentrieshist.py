...
# ##################################################
class WideTcamPrefixEntriesHist(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist"


    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1qtr")
    ...
    prop = PropMeta("str", "extNormalizedTr", "extNormalizedTr", 35452, PropCategory.IMPLICIT_TREND)
    prop.label = "External Subnet v6 /84 to /127 prefix entries usage trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("extNormalizedTr", prop)

    prop = PropMeta("str", "fabNormalizedAvg", "fabNormalizedAvg", 35464, PropCategory.IMPLICIT_AVG)
    prop.label = "v6 /84 to /127 prefix entries usage average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fabNormalizedAvg", prop)

    prop = PropMeta("str", "fabNormalizedMax", "fabNormalizedMax", 35463, PropCategory.IMPLICIT_MAX)
    prop.label = "v6 /84 to /127 prefix entries usage maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fabNormalizedMax", prop)

    prop = PropMeta("str", "fabNormalizedMin", "fabNormalizedMin", 35462, PropCategory.IMPLICIT_MIN)
    prop.label = "v6 /84 to /127 prefix entries usage minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fabNormalizedMin", prop)

    prop = PropMeta("str", "fabNormalizedSpct", "fabNormalizedSpct", 35465, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "v6 /84 to /127 prefix entries usage suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fabNormalizedSpct", prop)

    prop = PropMeta("str", "fabNormalizedThr", "fabNormalizedThr", 35466, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fabNormalizedTr", "fabNormalizedTr", 35467, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "normalizedAvg", "normalizedAvg", 35479, PropCategory.IMPLICIT_AVG)
    prop.label = "Deprecated.. average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedAvg", prop)

    prop = PropMeta("str", "normalizedMax", "normalizedMax", 35478, PropCategory.IMPLICIT_MAX)
    prop.label = "Deprecated.. maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedMax", prop)

    prop = PropMeta("str", "normalizedMin", "normalizedMin", 35477, PropCategory.IMPLICIT_MIN)
    prop.label = "Deprecated.. minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedMin", prop)

    prop = PropMeta("str", "normalizedSpct", "normalizedSpct", 35480, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Deprecated.. suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedSpct", prop)

    prop = PropMeta("str", "normalizedThr", "normalizedThr", 35481, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "normalizedTr", "normalizedTr", 35482, PropCategory.IMPLICIT_TREND)
