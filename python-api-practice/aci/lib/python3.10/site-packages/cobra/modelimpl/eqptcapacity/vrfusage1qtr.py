...
# ##################################################
class VrfUsage1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsage1qtr", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsage1qtr"
    meta.rnFormat = "CDeqptcapacityVrfUsage1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current VRF usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVrfUsage1qtr', False),
    ]
