...
# ##################################################
class EpgUsageHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist1h", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist1h"
    meta.rnFormat = "HDeqptcapacityEpgUsage1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47461, PropCategory.REGULAR)
