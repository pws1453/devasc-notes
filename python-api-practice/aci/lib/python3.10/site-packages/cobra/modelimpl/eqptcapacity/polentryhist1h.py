...
# ##################################################
class PolEntryHist1h(Mo):
    """
    A class that represents historical statistics for  Policy entry in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntryHist1h", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntryHist1h"
    meta.rnFormat = "HDeqptcapacityPolEntry1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Policy entry stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6376, PropCategory.REGULAR)
