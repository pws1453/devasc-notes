...
# ##################################################
class L3v4Usage32Per5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Per5min", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Per5min"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Per5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries usage percentage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Per5min', False),
    ]
