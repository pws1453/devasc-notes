...
# ##################################################
class VlanUsage1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage1year", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage1year"
    meta.rnFormat = "CDeqptcapacityVlanUsage1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage1year', False),
    ]
