...
class EpgUsage1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage1d", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage1d"
    meta.rnFormat = "CDeqptcapacityEpgUsage1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityEpgUsage1d', False),
    ]
