...
# ##################################################
class L3v4Usage32Cap5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Cap5min", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Cap5min"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Cap5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries max capacity stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Cap5min', False),
    ]
