...
# ##################################################
class L3TotalUsageCapHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCapHist1w", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCapHist1w"
    meta.rnFormat = "HDeqptcapacityL3TotalUsageCap1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 total entries max capacity stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3TotalUsageCap1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36415, PropCategory.REGULAR)
