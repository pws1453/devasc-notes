...
# ##################################################
class L3v4Usage32CapHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist1d", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist1d"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43921, PropCategory.REGULAR)
