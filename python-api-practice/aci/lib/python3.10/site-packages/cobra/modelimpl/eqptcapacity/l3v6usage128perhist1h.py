...
# ##################################################
class L3v6Usage128PerHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist1h", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist1h"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43962, PropCategory.REGULAR)
