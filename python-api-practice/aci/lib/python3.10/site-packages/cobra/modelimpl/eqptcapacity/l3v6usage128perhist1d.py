...
# ##################################################
class L3v6Usage128PerHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist1d", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist1d"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43961, PropCategory.REGULAR)
