...
# ##################################################
class WideTcamPrefixEntries5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntries5min", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntries5min"
    meta.rnFormat = "CDeqptcapacityWideTcamPrefixEntries5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Wide Tcam Prefix IPv6 entries stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityWideTcamPrefixEntries5min', False),
    ]
