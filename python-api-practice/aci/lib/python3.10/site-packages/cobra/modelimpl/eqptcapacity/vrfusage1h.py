...
class VrfUsage1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsage1h", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsage1h"
    meta.rnFormat = "CDeqptcapacityVrfUsage1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current VRF usage count stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVrfUsage1h', False),
    ]
