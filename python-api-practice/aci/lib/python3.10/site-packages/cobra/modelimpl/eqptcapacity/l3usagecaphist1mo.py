...
# ##################################################
class L3UsageCapHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCapHist1mo", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCapHist1mo"
    meta.rnFormat = "HDeqptcapacityL3UsageCap1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries max capacity stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsageCap1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20470, PropCategory.REGULAR)
