...
# ##################################################
class L3UsageCap1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCap1d", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCap1d"
    meta.rnFormat = "CDeqptcapacityL3UsageCap1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 entries max capacity stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3UsageCap1d', False),
    ]
