...
# ##################################################
class L2RemoteUsage1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsage1d", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsage1d"
    meta.rnFormat = "CDeqptcapacityL2RemoteUsage1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer2 remote entries usage count stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL2RemoteUsage1d', False),
    ]
