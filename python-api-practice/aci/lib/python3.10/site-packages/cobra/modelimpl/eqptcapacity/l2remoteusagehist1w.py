...
# ##################################################
class L2RemoteUsageHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist1w", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist1w"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36375, PropCategory.REGULAR)
