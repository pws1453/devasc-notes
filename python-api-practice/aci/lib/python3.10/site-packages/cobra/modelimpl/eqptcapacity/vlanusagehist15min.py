...
# ##################################################
class VlanUsageHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsageHist15min", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsageHist15min"
    meta.rnFormat = "HDeqptcapacityVlanUsage15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan entries usage stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanUsage15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19991, PropCategory.REGULAR)
