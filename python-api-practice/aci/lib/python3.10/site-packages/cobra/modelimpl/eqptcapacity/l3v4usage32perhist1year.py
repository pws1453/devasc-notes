...
# ##################################################
class L3v4Usage32PerHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist1year", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist1year"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43942, PropCategory.REGULAR)
