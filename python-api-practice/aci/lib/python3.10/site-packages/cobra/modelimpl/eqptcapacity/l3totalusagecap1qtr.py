...
# ##################################################
class L3TotalUsageCap1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCap1qtr", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCap1qtr"
    meta.rnFormat = "CDeqptcapacityL3TotalUsageCap1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 total entries max capacity stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3TotalUsageCap1qtr', False),
    ]
