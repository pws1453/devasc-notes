...
# ##################################################
class VrfUsage5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsage5min", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsage5min"
    meta.rnFormat = "CDeqptcapacityVrfUsage5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current VRF usage count stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVrfUsage5min', False),
    ]
