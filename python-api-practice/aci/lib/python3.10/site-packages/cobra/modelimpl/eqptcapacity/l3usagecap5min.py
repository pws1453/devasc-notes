...
# ##################################################
class L3UsageCap5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCap5min", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCap5min"
    meta.rnFormat = "CDeqptcapacityL3UsageCap5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 entries max capacity stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3UsageCap5min', False),
    ]
