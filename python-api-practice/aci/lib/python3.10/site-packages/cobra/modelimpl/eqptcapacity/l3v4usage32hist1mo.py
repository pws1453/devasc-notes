...
# ##################################################
class L3v4Usage32Hist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Hist1mo", "Layer3 v4 32 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Hist1mo"
    meta.rnFormat = "HDeqptcapacityL3v4Usage321mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage count stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage321mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43931, PropCategory.REGULAR)
