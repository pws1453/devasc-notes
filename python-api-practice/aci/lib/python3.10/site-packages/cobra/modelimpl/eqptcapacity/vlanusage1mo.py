...
# ##################################################
class VlanUsage1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage1mo", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage1mo"
    meta.rnFormat = "CDeqptcapacityVlanUsage1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage1mo', False),
    ]
