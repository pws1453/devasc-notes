...
# ##################################################
class L3RemoteUsagePer1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePer1qtr", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePer1qtr"
    meta.rnFormat = "CDeqptcapacityL3RemoteUsagePer1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 remote entries usage percentage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3RemoteUsagePer1qtr', False),
    ]
