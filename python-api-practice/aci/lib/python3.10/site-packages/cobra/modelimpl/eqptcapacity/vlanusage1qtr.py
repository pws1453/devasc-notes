...
# ##################################################
class VlanUsage1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage1qtr", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage1qtr"
    meta.rnFormat = "CDeqptcapacityVlanUsage1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage1qtr', False),
    ]
