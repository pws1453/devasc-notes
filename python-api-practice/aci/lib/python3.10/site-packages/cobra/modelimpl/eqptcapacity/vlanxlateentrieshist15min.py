...
# ##################################################
class VlanXlateEntriesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist15min", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist15min"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.VlanXlateEntriesHist")

    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20934, PropCategory.REGULAR)
