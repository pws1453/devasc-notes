...
# ##################################################
class L3v4Usage32CapHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist1year", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist1year"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43926, PropCategory.REGULAR)
