...
# ##################################################
class L2RemoteUsageHist(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist"


    meta.moClassName = "eqptcapacityL2RemoteUsageHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist1qtr")
    ...
    prop = PropMeta("str", "remoteEpAvg", "remoteEpAvg", 36471, PropCategory.IMPLICIT_AVG)
    prop.label = "Remote L2 Endpoints average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpAvg", prop)

    prop = PropMeta("str", "remoteEpCapAvg", "remoteEpCapAvg", 36450, PropCategory.IMPLICIT_AVG)
    prop.label = "Remote L2 Endpoints capacity average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpCapAvg", prop)

    prop = PropMeta("str", "remoteEpCapMax", "remoteEpCapMax", 36449, PropCategory.IMPLICIT_MAX)
    prop.label = "Remote L2 Endpoints capacity maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpCapMax", prop)

    prop = PropMeta("str", "remoteEpCapMin", "remoteEpCapMin", 36448, PropCategory.IMPLICIT_MIN)
    prop.label = "Remote L2 Endpoints capacity minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpCapMin", prop)

    prop = PropMeta("str", "remoteEpCapSpct", "remoteEpCapSpct", 36451, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Remote L2 Endpoints capacity suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpCapSpct", prop)

    prop = PropMeta("str", "remoteEpCapThr", "remoteEpCapThr", 36452, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "remoteEpCapTr", "remoteEpCapTr", 36453, PropCategory.IMPLICIT_TREND)
    prop.label = "Remote L2 Endpoints capacity trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpCapTr", prop)

    prop = PropMeta("str", "remoteEpMax", "remoteEpMax", 36470, PropCategory.IMPLICIT_MAX)
    prop.label = "Remote L2 Endpoints maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpMax", prop)

    prop = PropMeta("str", "remoteEpMin", "remoteEpMin", 36469, PropCategory.IMPLICIT_MIN)
    prop.label = "Remote L2 Endpoints minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpMin", prop)

    prop = PropMeta("str", "remoteEpSpct", "remoteEpSpct", 36472, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Remote L2 Endpoints suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpSpct", prop)

    prop = PropMeta("str", "remoteEpThr", "remoteEpThr", 36473, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "remoteEpTr", "remoteEpTr", 36474, PropCategory.IMPLICIT_TREND)
    prop.label = "Remote L2 Endpoints trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteEpTr", prop)

    prop = PropMeta("str", "remoteNormalizedAvg", "remoteNormalizedAvg", 36487, PropCategory.IMPLICIT_AVG)
    prop.label = "Remote L2 entries usage average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteNormalizedAvg", prop)

    prop = PropMeta("str", "remoteNormalizedMax", "remoteNormalizedMax", 36486, PropCategory.IMPLICIT_MAX)
    prop.label = "Remote L2 entries usage maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteNormalizedMax", prop)

    prop = PropMeta("str", "remoteNormalizedMin", "remoteNormalizedMin", 36485, PropCategory.IMPLICIT_MIN)
    prop.label = "Remote L2 entries usage minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteNormalizedMin", prop)

    prop = PropMeta("str", "remoteNormalizedSpct", "remoteNormalizedSpct", 36488, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Remote L2 entries usage suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("remoteNormalizedSpct", prop)

    prop = PropMeta("str", "remoteNormalizedThr", "remoteNormalizedThr", 36489, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "remoteNormalizedTr", "remoteNormalizedTr", 36490, PropCategory.IMPLICIT_TREND)
