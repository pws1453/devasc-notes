...
# ##################################################
class L3UsageCapHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCapHist1d", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCapHist1d"
    meta.rnFormat = "HDeqptcapacityL3UsageCap1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries max capacity stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsageCap1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20468, PropCategory.REGULAR)
