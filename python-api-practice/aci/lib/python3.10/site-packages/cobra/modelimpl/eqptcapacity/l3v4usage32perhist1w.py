...
# ##################################################
class L3v4Usage32PerHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist1w", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist1w"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43941, PropCategory.REGULAR)
