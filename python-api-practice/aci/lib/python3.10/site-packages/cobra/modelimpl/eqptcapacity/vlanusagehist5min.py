...
# ##################################################
class VlanUsageHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsageHist5min", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsageHist5min"
    meta.rnFormat = "HDeqptcapacityVlanUsage5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan entries usage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanUsage5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19998, PropCategory.REGULAR)
