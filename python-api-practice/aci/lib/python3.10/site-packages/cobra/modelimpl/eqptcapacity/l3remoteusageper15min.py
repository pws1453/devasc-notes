...
# ##################################################
class L3RemoteUsagePer15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePer15min", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePer15min"
    meta.rnFormat = "CDeqptcapacityL3RemoteUsagePer15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 remote entries usage percentage stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3RemoteUsagePer15min', False),
    ]
