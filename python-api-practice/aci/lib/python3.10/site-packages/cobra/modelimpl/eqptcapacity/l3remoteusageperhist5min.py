...
# ##################################################
class L3RemoteUsagePerHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist5min", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist5min"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36409, PropCategory.REGULAR)
