...
# ##################################################
class L3v6Usage128Hist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Hist1mo", "Layer3 v6 128 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Hist1mo"
    meta.rnFormat = "HDeqptcapacityL3v6Usage1281mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage count stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage1281mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43955, PropCategory.REGULAR)
