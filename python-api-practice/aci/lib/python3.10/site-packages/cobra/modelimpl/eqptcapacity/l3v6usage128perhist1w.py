...
# ##################################################
class L3v6Usage128PerHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist1w", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist1w"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43965, PropCategory.REGULAR)
