...
# ##################################################
class L3TotalUsageCap15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCap15min", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCap15min"
    meta.rnFormat = "CDeqptcapacityL3TotalUsageCap15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 total entries max capacity stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3TotalUsageCap15min', False),
    ]
