...
# ##################################################
class WideTcamPrefixEntries1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntries1d", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntries1d"
    meta.rnFormat = "CDeqptcapacityWideTcamPrefixEntries1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Wide Tcam Prefix IPv6 entries stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityWideTcamPrefixEntries1d', False),
    ]
