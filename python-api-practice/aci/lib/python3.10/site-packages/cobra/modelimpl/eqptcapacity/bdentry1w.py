...
class BDEntry1w(Mo):
    """
    A class that represents the most current statistics for bridge domain entry in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntry1w", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntry1w"
    meta.rnFormat = "CDeqptcapacityBDEntry1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current bridge domain entry stats in 1 week"
