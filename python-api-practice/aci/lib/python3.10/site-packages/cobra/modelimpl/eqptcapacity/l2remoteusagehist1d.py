...
# ##################################################
class L2RemoteUsageHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist1d", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist1d"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36371, PropCategory.REGULAR)
