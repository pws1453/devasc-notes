...
# ##################################################
class McastUsageHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsageHist1w", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsageHist1w"
    meta.rnFormat = "HDeqptcapacityMcastUsage1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Multicast entries usage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityMcastUsage1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19972, PropCategory.REGULAR)
