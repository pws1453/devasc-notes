...
# ##################################################
class BdUsageHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist1h", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist1h"
    meta.rnFormat = "HDeqptcapacityBdUsage1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47453, PropCategory.REGULAR)
