...
# ##################################################
class L3UsageCapHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCapHist5min", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCapHist5min"
    meta.rnFormat = "HDeqptcapacityL3UsageCap5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries max capacity stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsageCap5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20474, PropCategory.REGULAR)
