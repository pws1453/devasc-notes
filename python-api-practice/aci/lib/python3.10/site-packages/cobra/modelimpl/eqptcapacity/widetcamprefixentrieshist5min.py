...
# ##################################################
class WideTcamPrefixEntriesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist5min", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist5min"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35437, PropCategory.REGULAR)
