...
# ##################################################
class PGLabelUsageHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist15min", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist15min"
    meta.rnFormat = "HDeqptcapacityPGLabelUsage15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPGLabelUsage15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 44390, PropCategory.REGULAR)
