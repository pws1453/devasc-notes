...
# ##################################################
class PGLabelUsageHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist1h", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist1h"
    meta.rnFormat = "HDeqptcapacityPGLabelUsage1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPGLabelUsage1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 44392, PropCategory.REGULAR)
