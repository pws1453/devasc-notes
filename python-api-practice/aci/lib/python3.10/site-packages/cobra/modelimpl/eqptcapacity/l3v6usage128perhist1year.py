...
# ##################################################
class L3v6Usage128PerHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist1year", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist1year"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43966, PropCategory.REGULAR)
