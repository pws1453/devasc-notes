...
# ##################################################
class L3UsagePerHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsagePerHist1w", "Layer3 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3UsagePerHist1w"
    meta.rnFormat = "HDeqptcapacityL3UsagePer1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries usage percentage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsagePer1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 27169, PropCategory.REGULAR)
