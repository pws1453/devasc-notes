...
# ##################################################
class L3UsageCap1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCap1h", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCap1h"
    meta.rnFormat = "CDeqptcapacityL3UsageCap1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 entries max capacity stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3UsageCap1h', False),
    ]
