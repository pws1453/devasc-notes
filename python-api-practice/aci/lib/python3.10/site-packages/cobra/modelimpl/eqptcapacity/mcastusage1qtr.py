...
# ##################################################
class McastUsage1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage1qtr", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsage1qtr"
    meta.rnFormat = "CDeqptcapacityMcastUsage1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage1qtr', False),
    ]
