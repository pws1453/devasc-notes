...
# ##################################################
class L3TotalUsageCapHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCapHist1qtr", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCapHist1qtr"
    meta.rnFormat = "HDeqptcapacityL3TotalUsageCap1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 total entries max capacity stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3TotalUsageCap1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36414, PropCategory.REGULAR)
