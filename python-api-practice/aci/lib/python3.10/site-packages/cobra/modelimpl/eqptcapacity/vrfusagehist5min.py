...
# ##################################################
class VrfUsageHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist5min", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist5min"
    meta.rnFormat = "HDeqptcapacityVrfUsage5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVrfUsage5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47482, PropCategory.REGULAR)
