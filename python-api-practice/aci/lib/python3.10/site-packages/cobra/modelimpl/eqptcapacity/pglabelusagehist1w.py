...
# ##################################################
class PGLabelUsageHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist1w", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist1w"
    meta.rnFormat = "HDeqptcapacityPGLabelUsage1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPGLabelUsage1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 44395, PropCategory.REGULAR)
