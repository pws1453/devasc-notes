...
# ##################################################
class L2RemoteUsageHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist5min", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist5min"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36377, PropCategory.REGULAR)
