...
# ##################################################
class EpgUsageHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist15min", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist15min"
    meta.rnFormat = "HDeqptcapacityEpgUsage15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.EpgUsageHist")

    meta.rnPrefixes = [
        ('HDeqptcapacityEpgUsage15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47459, PropCategory.REGULAR)
