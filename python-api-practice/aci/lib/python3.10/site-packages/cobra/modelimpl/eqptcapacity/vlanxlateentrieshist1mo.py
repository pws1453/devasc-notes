...
# ##################################################
class VlanXlateEntriesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist1mo", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist1mo"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20937, PropCategory.REGULAR)
