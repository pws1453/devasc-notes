...
# ##################################################
class L3v4Usage32CapHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist1h", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist1h"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43922, PropCategory.REGULAR)
