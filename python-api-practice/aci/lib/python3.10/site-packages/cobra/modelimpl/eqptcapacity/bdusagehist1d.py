...
# ##################################################
class BdUsageHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist1d", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist1d"
    meta.rnFormat = "HDeqptcapacityBdUsage1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47452, PropCategory.REGULAR)
