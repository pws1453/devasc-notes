...
# ##################################################
class L2RemoteUsageHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist1qtr", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist1qtr"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36374, PropCategory.REGULAR)
