...
# ##################################################
class WideTcamPrefixEntriesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1w", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist1w"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35435, PropCategory.REGULAR)
