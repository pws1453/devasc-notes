...
# ##################################################
class VrfUsage1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsage1mo", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsage1mo"
    meta.rnFormat = "CDeqptcapacityVrfUsage1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current VRF usage count stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVrfUsage1mo', False),
    ]
