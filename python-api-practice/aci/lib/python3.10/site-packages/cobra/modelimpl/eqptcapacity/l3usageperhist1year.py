...
# ##################################################
class L3UsagePerHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsagePerHist1year", "Layer3 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3UsagePerHist1year"
    meta.rnFormat = "HDeqptcapacityL3UsagePer1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries usage percentage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsagePer1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 27170, PropCategory.REGULAR)
