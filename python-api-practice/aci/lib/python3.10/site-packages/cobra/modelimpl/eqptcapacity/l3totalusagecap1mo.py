...
# ##################################################
class L3TotalUsageCap1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCap1mo", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCap1mo"
    meta.rnFormat = "CDeqptcapacityL3TotalUsageCap1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 total entries max capacity stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3TotalUsageCap1mo', False),
    ]
