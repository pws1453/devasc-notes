...
# ##################################################
class L3v6Usage128Hist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Hist1w", "Layer3 v6 128 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Hist1w"
    meta.rnFormat = "HDeqptcapacityL3v6Usage1281w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage count stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage1281w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43957, PropCategory.REGULAR)
