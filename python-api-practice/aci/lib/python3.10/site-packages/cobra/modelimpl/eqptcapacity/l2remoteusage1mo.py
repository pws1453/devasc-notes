...
# ##################################################
class L2RemoteUsage1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsage1mo", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsage1mo"
    meta.rnFormat = "CDeqptcapacityL2RemoteUsage1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer2 remote entries usage count stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL2RemoteUsage1mo', False),
    ]
