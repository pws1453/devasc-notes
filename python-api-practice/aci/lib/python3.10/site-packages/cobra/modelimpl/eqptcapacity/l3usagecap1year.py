...
# ##################################################
class L3UsageCap1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCap1year", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCap1year"
    meta.rnFormat = "CDeqptcapacityL3UsageCap1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 entries max capacity stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3UsageCap1year', False),
    ]
