...
# ##################################################
class PolEntry1mo(Mo):
    """
    A class that represents the most current statistics for  Policy entry in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntry1mo", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntry1mo"
    meta.rnFormat = "CDeqptcapacityPolEntry1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Policy entry stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityPolEntry1mo', False),
    ]
