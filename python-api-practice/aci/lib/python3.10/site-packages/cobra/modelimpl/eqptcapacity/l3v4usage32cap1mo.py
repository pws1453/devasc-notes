...
# ##################################################
class L3v4Usage32Cap1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Cap1mo", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Cap1mo"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Cap1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries max capacity stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Cap1mo', False),
    ]
