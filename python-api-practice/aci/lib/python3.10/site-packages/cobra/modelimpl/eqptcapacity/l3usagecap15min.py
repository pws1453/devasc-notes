...
# ##################################################
class L3UsageCap15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCap15min", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCap15min"
    meta.rnFormat = "CDeqptcapacityL3UsageCap15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 entries max capacity stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3UsageCap15min', False),
    ]
