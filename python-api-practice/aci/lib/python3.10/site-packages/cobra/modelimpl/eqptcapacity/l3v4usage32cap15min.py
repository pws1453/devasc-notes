...
# ##################################################
class L3v4Usage32Cap15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Cap15min", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Cap15min"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Cap15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries max capacity stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.L3v4Usage32Cap")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Cap15min', False),
    ]
