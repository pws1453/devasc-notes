...
# ##################################################
class VlanXlateEntries1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntries1h", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntries1h"
    meta.rnFormat = "CDeqptcapacityVlanXlateEntries1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan Xlate entries stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanXlateEntries1h', False),
    ]
