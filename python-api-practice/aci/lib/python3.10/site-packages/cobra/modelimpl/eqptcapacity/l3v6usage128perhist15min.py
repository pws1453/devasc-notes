...
# ##################################################
class L3v6Usage128PerHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist15min", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist15min"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.L3v6Usage128PerHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43960, PropCategory.REGULAR)
