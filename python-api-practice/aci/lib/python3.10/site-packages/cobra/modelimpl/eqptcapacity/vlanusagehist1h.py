...
# ##################################################
class VlanUsageHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsageHist1h", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsageHist1h"
    meta.rnFormat = "HDeqptcapacityVlanUsage1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan entries usage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanUsage1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19993, PropCategory.REGULAR)
