...
# ##################################################
class EpgUsage5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage5min", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage5min"
    meta.rnFormat = "CDeqptcapacityEpgUsage5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityEpgUsage5min', False),
    ]
