...
# ##################################################
class L3v4Usage32CapHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist15min", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist15min"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.L3v4Usage32CapHist")

    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43920, PropCategory.REGULAR)
