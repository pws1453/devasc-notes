...
class BDEntry1d(Mo):
    """
    A class that represents the most current statistics for bridge domain entry in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntry1d", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntry1d"
    meta.rnFormat = "CDeqptcapacityBDEntry1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current bridge domain entry stats in 1 day"
