...
# ##################################################
class VlanUsage5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage5min", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage5min"
    meta.rnFormat = "CDeqptcapacityVlanUsage5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage5min', False),
    ]
