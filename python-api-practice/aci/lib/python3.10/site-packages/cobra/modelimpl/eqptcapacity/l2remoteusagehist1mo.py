...
# ##################################################
class L2RemoteUsageHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist1mo", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist1mo"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36373, PropCategory.REGULAR)
