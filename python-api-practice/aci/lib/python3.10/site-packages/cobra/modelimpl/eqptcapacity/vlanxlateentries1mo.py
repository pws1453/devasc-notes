...
# ##################################################
class VlanXlateEntries1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntries1mo", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntries1mo"
    meta.rnFormat = "CDeqptcapacityVlanXlateEntries1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan Xlate entries stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanXlateEntries1mo', False),
    ]
