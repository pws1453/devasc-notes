...
# ##################################################
class L3UsageCap1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCap1qtr", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCap1qtr"
    meta.rnFormat = "CDeqptcapacityL3UsageCap1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 entries max capacity stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3UsageCap1qtr', False),
    ]
