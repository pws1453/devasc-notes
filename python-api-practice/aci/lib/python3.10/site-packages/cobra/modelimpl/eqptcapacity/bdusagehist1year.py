...
# ##################################################
class BdUsageHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist1year", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist1year"
    meta.rnFormat = "HDeqptcapacityBdUsage1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityBdUsage1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47457, PropCategory.REGULAR)
