...
# ##################################################
class PolEntryHist1d(Mo):
    """
    A class that represents historical statistics for  Policy entry in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntryHist1d", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntryHist1d"
    meta.rnFormat = "HDeqptcapacityPolEntry1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Policy entry stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6375, PropCategory.REGULAR)
