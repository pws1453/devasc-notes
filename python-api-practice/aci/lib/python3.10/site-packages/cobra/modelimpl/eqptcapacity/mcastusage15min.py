...
# ##################################################
class McastUsage15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage15min", "Multicast entries usage")
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "localEpCapBase"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "localEpBase"
    ...
    meta.moClassName = "eqptcapacityMcastUsage15min"
    meta.rnFormat = "CDeqptcapacityMcastUsage15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.McastUsage")

    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage15min', False),
    ]
    ...
    prop = PropMeta("str", "localEpAvg", "localEpAvg", 20047, PropCategory.IMPLICIT_AVG)
    prop.label = "Local Multicast Endpoints average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpAvg", prop)

    prop = PropMeta("str", "localEpBase", "localEpBase", 20042, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Local Multicast Endpoints baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpBase", prop)

    prop = PropMeta("str", "localEpCapAvg", "localEpCapAvg", 20544, PropCategory.IMPLICIT_AVG)
    prop.label = "Local Multicast Endpoints capacity average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapAvg", prop)

    prop = PropMeta("str", "localEpCapBase", "localEpCapBase", 20539, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Local Multicast Endpoints capacity baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapBase", prop)

    prop = PropMeta("str", "localEpCapCum", "localEpCapCum", 20540, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Local Multicast Endpoints capacity cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapCum", prop)

    prop = PropMeta("str", "localEpCapLast", "localEpCapLast", 20538, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Local Multicast Endpoints capacity current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapLast", prop)

    prop = PropMeta("str", "localEpCapMax", "localEpCapMax", 20543, PropCategory.IMPLICIT_MAX)
    prop.label = "Local Multicast Endpoints capacity maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapMax", prop)

    prop = PropMeta("str", "localEpCapMin", "localEpCapMin", 20542, PropCategory.IMPLICIT_MIN)
    prop.label = "Local Multicast Endpoints capacity minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapMin", prop)

    prop = PropMeta("str", "localEpCapPer", "localEpCapPer", 20541, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Local Multicast Endpoints capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapPer", prop)

    prop = PropMeta("str", "localEpCapRate", "localEpCapRate", 20549, PropCategory.IMPLICIT_RATE)
    prop.label = "Local Multicast Endpoints capacity rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapRate", prop)

    prop = PropMeta("str", "localEpCapSpct", "localEpCapSpct", 20545, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Local Multicast Endpoints capacity suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapSpct", prop)

    prop = PropMeta("str", "localEpCapThr", "localEpCapThr", 20546, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "localEpCapTr", "localEpCapTr", 20548, PropCategory.IMPLICIT_TREND)
    prop.label = "Local Multicast Endpoints capacity trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapTr", prop)

    prop = PropMeta("str", "localEpCapTrBase", "localEpCapTrBase", 20547, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Local Multicast Endpoints capacity trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCapTrBase", prop)

    prop = PropMeta("str", "localEpCum", "localEpCum", 20043, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Local Multicast Endpoints cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpCum", prop)

    prop = PropMeta("str", "localEpLast", "localEpLast", 20041, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Local Multicast Endpoints current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpLast", prop)

    prop = PropMeta("str", "localEpMax", "localEpMax", 20046, PropCategory.IMPLICIT_MAX)
    prop.label = "Local Multicast Endpoints maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpMax", prop)

    prop = PropMeta("str", "localEpMin", "localEpMin", 20045, PropCategory.IMPLICIT_MIN)
    prop.label = "Local Multicast Endpoints minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpMin", prop)

    prop = PropMeta("str", "localEpPer", "localEpPer", 20044, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Local Multicast Endpoints periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpPer", prop)

    prop = PropMeta("str", "localEpRate", "localEpRate", 20052, PropCategory.IMPLICIT_RATE)
    prop.label = "Local Multicast Endpoints rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpRate", prop)

    prop = PropMeta("str", "localEpSpct", "localEpSpct", 20048, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Local Multicast Endpoints suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpSpct", prop)

    prop = PropMeta("str", "localEpThr", "localEpThr", 20049, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "localEpTr", "localEpTr", 20051, PropCategory.IMPLICIT_TREND)
    prop.label = "Local Multicast Endpoints trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("localEpTr", prop)

    prop = PropMeta("str", "localEpTrBase", "localEpTrBase", 20050, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Local Multicast Endpoints trend baseline"
    prop.isOper = True
    prop.isStats = True
    ...
    prop = PropMeta("str", "normalizedAvg", "normalizedAvg", 27221, PropCategory.IMPLICIT_AVG)
    prop.label = "Local Multicast entries usage average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedAvg", prop)

    prop = PropMeta("str", "normalizedLast", "normalizedLast", 27218, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Local Multicast entries usage current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedLast", prop)

    prop = PropMeta("str", "normalizedMax", "normalizedMax", 27220, PropCategory.IMPLICIT_MAX)
    prop.label = "Local Multicast entries usage maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedMax", prop)

    prop = PropMeta("str", "normalizedMin", "normalizedMin", 27219, PropCategory.IMPLICIT_MIN)
    prop.label = "Local Multicast entries usage minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedMin", prop)

    prop = PropMeta("str", "normalizedSpct", "normalizedSpct", 27222, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Local Multicast entries usage suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedSpct", prop)

    prop = PropMeta("str", "normalizedThr", "normalizedThr", 27224, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "normalizedTr", "normalizedTr", 27226, PropCategory.IMPLICIT_TREND)
    prop.label = "Local Multicast entries usage trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedTr", prop)

    prop = PropMeta("str", "normalizedTrBase", "normalizedTrBase", 27225, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Local Multicast entries usage trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedTrBase", prop)

    prop = PropMeta("str", "normalizedTtl", "normalizedTtl", 27223, PropCategory.IMPLICIT_TOTAL)
    prop.label = "Local Multicast entries usage total sum"
    prop.isOper = True
    prop.isStats = True
