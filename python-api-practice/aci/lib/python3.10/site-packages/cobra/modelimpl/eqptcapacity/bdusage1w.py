...
class BdUsage1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage1w", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage1w"
    meta.rnFormat = "CDeqptcapacityBdUsage1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats in 1 week"
