...
# ##################################################
class L3RemoteUsagePerHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist1w", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist1w"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36407, PropCategory.REGULAR)
