...
# ##################################################
class EpgUsageHist(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist"


    meta.moClassName = "eqptcapacityEpgUsageHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.EpgUsageHist1qtr")
    ...
    prop = PropMeta("str", "totalAvg", "totalAvg", 47562, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Endpoint groups average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalAvg", prop)

    prop = PropMeta("str", "totalCapAvg", "totalCapAvg", 47541, PropCategory.IMPLICIT_AVG)
    prop.label = "Endpoint groups capacity average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapAvg", prop)

    prop = PropMeta("str", "totalCapCum", "totalCapCum", 47537, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Endpoint groups capacity cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapCum", prop)

    prop = PropMeta("str", "totalCapMax", "totalCapMax", 47540, PropCategory.IMPLICIT_MAX)
    prop.label = "Endpoint groups capacity maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMax", prop)

    prop = PropMeta("str", "totalCapMin", "totalCapMin", 47539, PropCategory.IMPLICIT_MIN)
    prop.label = "Endpoint groups capacity minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapMin", prop)

    prop = PropMeta("str", "totalCapPer", "totalCapPer", 47538, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Endpoint groups capacity periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapPer", prop)

    prop = PropMeta("str", "totalCapRate", "totalCapRate", 47545, PropCategory.IMPLICIT_RATE)
    prop.label = "Endpoint groups capacity rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapRate", prop)

    prop = PropMeta("str", "totalCapSpct", "totalCapSpct", 47542, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Endpoint groups capacity suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapSpct", prop)

    prop = PropMeta("str", "totalCapThr", "totalCapThr", 47543, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalCapTr", "totalCapTr", 47544, PropCategory.IMPLICIT_TREND)
    prop.label = "Endpoint groups capacity trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCapTr", prop)

    prop = PropMeta("str", "totalCum", "totalCum", 47558, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total Endpoint groups cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalCum", prop)

    prop = PropMeta("str", "totalMax", "totalMax", 47561, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Endpoint groups maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMax", prop)

    prop = PropMeta("str", "totalMin", "totalMin", 47560, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Endpoint groups minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMin", prop)

    prop = PropMeta("str", "totalPer", "totalPer", 47559, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total Endpoint groups periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalPer", prop)

    prop = PropMeta("str", "totalRate", "totalRate", 47566, PropCategory.IMPLICIT_RATE)
    prop.label = "Total Endpoint groups rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalRate", prop)

    prop = PropMeta("str", "totalSpct", "totalSpct", 47563, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Endpoint groups suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalSpct", prop)

    prop = PropMeta("str", "totalThr", "totalThr", 47564, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalTr", "totalTr", 47565, PropCategory.IMPLICIT_TREND)
