...
# ##################################################
class L2RemoteUsageHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist1h", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist1h"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36372, PropCategory.REGULAR)
