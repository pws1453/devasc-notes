...
# ##################################################
class L3UsageCap1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCap1mo", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCap1mo"
    meta.rnFormat = "CDeqptcapacityL3UsageCap1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 entries max capacity stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3UsageCap1mo', False),
    ]
