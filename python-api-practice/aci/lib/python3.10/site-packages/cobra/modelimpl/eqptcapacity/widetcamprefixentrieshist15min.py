...
# ##################################################
class WideTcamPrefixEntriesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist15min", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist15min"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35430, PropCategory.REGULAR)
