...
# ##################################################
class BDEntryHist15min(Mo):
    """
    A class that represents historical statistics for bridge domain entry in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntryHist15min", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntryHist15min"
    meta.rnFormat = "HDeqptcapacityBDEntry15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical bridge domain entry stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityBDEntry15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6342, PropCategory.REGULAR)
