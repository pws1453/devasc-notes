...
# ##################################################
class L3TotalUsageCapHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCapHist5min", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCapHist5min"
    meta.rnFormat = "HDeqptcapacityL3TotalUsageCap5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 total entries max capacity stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3TotalUsageCap5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36417, PropCategory.REGULAR)
