...
# ##################################################
class PolEntryHist1w(Mo):
    """
    A class that represents historical statistics for  Policy entry in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntryHist1w", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntryHist1w"
    meta.rnFormat = "HDeqptcapacityPolEntry1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Policy entry stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6379, PropCategory.REGULAR)
