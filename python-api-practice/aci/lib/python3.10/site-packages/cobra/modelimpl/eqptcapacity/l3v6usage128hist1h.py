...
# ##################################################
class L3v6Usage128Hist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Hist1h", "Layer3 v6 128 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Hist1h"
    meta.rnFormat = "HDeqptcapacityL3v6Usage1281h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage count stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage1281h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43954, PropCategory.REGULAR)
