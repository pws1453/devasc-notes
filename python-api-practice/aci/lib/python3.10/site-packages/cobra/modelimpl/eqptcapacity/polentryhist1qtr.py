...
# ##################################################
class PolEntryHist1qtr(Mo):
    """
    A class that represents historical statistics for  Policy entry in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntryHist1qtr", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntryHist1qtr"
    meta.rnFormat = "HDeqptcapacityPolEntry1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Policy entry stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPolEntry1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6378, PropCategory.REGULAR)
