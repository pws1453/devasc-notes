...
# ##################################################
class VlanXlateEntriesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist1w", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist1w"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20939, PropCategory.REGULAR)
