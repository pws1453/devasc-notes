...
# ##################################################
class BdUsageHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist1qtr", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist1qtr"
    meta.rnFormat = "HDeqptcapacityBdUsage1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityBdUsage1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47455, PropCategory.REGULAR)
