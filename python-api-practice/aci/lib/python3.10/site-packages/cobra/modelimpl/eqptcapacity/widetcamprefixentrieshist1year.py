...
# ##################################################
class WideTcamPrefixEntriesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1year", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist1year"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35436, PropCategory.REGULAR)
