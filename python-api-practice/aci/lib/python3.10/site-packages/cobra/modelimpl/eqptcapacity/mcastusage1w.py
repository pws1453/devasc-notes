...
# ##################################################
class McastUsage1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage1w", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsage1w"
    meta.rnFormat = "CDeqptcapacityMcastUsage1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage1w', False),
    ]
