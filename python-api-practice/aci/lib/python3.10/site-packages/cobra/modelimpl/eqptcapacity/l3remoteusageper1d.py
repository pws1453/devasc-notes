...
# ##################################################
class L3RemoteUsagePer1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePer1d", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePer1d"
    meta.rnFormat = "CDeqptcapacityL3RemoteUsagePer1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 remote entries usage percentage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3RemoteUsagePer1d', False),
    ]
