...
# ##################################################
class BdUsageHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist1w", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist1w"
    meta.rnFormat = "HDeqptcapacityBdUsage1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47456, PropCategory.REGULAR)
