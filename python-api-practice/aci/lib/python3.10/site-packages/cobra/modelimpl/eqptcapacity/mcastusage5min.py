...
# ##################################################
class McastUsage5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage5min", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsage5min"
    meta.rnFormat = "CDeqptcapacityMcastUsage5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage5min', False),
    ]
