...
# ##################################################
class L3v4Usage32Per1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Per1h", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Per1h"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Per1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries usage percentage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Per1h', False),
    ]
