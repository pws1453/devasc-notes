...
# ##################################################
class BDEntryHist1w(Mo):
    """
    A class that represents historical statistics for bridge domain entry in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntryHist1w", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntryHist1w"
    meta.rnFormat = "HDeqptcapacityBDEntry1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical bridge domain entry stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6347, PropCategory.REGULAR)
