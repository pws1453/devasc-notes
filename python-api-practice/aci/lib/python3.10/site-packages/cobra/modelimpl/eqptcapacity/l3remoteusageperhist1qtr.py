...
# ##################################################
class L3RemoteUsagePerHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist1qtr", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist1qtr"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36406, PropCategory.REGULAR)
