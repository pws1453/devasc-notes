...
# ##################################################
class WideTcamPrefixEntries1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntries1qtr", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntries1qtr"
    meta.rnFormat = "CDeqptcapacityWideTcamPrefixEntries1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Wide Tcam Prefix IPv6 entries stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityWideTcamPrefixEntries1qtr', False),
    ]
