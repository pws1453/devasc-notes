...
class PolEntry1d(Mo):
    """
    A class that represents the most current statistics for  Policy entry in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntry1d", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntry1d"
    meta.rnFormat = "CDeqptcapacityPolEntry1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Policy entry stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityPolEntry1d', False),
    ]
