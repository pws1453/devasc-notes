...
# ##################################################
class BdUsage5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage5min", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage5min"
    meta.rnFormat = "CDeqptcapacityBdUsage5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityBdUsage5min', False),
    ]
