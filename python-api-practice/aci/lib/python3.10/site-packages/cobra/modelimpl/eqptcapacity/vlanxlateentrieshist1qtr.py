...
# ##################################################
class VlanXlateEntriesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist1qtr", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist1qtr"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20938, PropCategory.REGULAR)
