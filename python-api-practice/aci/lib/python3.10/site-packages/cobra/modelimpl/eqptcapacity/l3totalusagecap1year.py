...
# ##################################################
class L3TotalUsageCap1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCap1year", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCap1year"
    meta.rnFormat = "CDeqptcapacityL3TotalUsageCap1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 total entries max capacity stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3TotalUsageCap1year', False),
    ]
