...
# ##################################################
class BDEntryHist1mo(Mo):
    """
    A class that represents historical statistics for bridge domain entry in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntryHist1mo", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntryHist1mo"
    meta.rnFormat = "HDeqptcapacityBDEntry1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical bridge domain entry stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6345, PropCategory.REGULAR)
