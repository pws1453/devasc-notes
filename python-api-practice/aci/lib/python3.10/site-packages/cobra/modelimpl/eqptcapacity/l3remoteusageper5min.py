...
# ##################################################
class L3RemoteUsagePer5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePer5min", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePer5min"
    meta.rnFormat = "CDeqptcapacityL3RemoteUsagePer5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 remote entries usage percentage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3RemoteUsagePer5min', False),
    ]
