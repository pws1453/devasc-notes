...
# ##################################################
class EpgUsageHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist1d", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist1d"
    meta.rnFormat = "HDeqptcapacityEpgUsage1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 47460, PropCategory.REGULAR)
