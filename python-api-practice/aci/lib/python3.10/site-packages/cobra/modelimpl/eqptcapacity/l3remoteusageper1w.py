...
# ##################################################
class L3RemoteUsagePer1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePer1w", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePer1w"
    meta.rnFormat = "CDeqptcapacityL3RemoteUsagePer1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 remote entries usage percentage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3RemoteUsagePer1w', False),
    ]
