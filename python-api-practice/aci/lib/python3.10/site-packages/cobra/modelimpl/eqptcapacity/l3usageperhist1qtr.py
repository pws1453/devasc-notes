...
# ##################################################
class L3UsagePerHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsagePerHist1qtr", "Layer3 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3UsagePerHist1qtr"
    meta.rnFormat = "HDeqptcapacityL3UsagePer1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries usage percentage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsagePer1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 27168, PropCategory.REGULAR)
