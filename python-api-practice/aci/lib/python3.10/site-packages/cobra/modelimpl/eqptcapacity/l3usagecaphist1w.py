...
# ##################################################
class L3UsageCapHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsageCapHist1w", "Layer3 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3UsageCapHist1w"
    meta.rnFormat = "HDeqptcapacityL3UsageCap1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries max capacity stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsageCap1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20472, PropCategory.REGULAR)
