...
# ##################################################
class WideTcamPrefixEntriesHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntriesHist1h", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntriesHist1h"
    meta.rnFormat = "HDeqptcapacityWideTcamPrefixEntries1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Wide Tcam Prefix IPv6 entries stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityWideTcamPrefixEntries1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 35432, PropCategory.REGULAR)
