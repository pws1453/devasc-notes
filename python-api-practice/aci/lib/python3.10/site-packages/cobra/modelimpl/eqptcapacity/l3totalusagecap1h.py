...
# ##################################################
class L3TotalUsageCap1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCap1h", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCap1h"
    meta.rnFormat = "CDeqptcapacityL3TotalUsageCap1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 total entries max capacity stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3TotalUsageCap1h', False),
    ]
