...
# ##################################################
class L3TotalUsageCapHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCapHist15min", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCapHist15min"
    meta.rnFormat = "HDeqptcapacityL3TotalUsageCap15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 total entries max capacity stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3TotalUsageCap15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36410, PropCategory.REGULAR)
