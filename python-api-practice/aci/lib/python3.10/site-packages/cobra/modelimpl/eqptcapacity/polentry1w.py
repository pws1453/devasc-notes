...
class PolEntry1w(Mo):
    """
    A class that represents the most current statistics for  Policy entry in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntry1w", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntry1w"
    meta.rnFormat = "CDeqptcapacityPolEntry1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Policy entry stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityPolEntry1w', False),
    ]
