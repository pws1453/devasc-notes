...
# ##################################################
class L2RemoteUsage15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsage15min", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsage15min"
    meta.rnFormat = "CDeqptcapacityL2RemoteUsage15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer2 remote entries usage count stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL2RemoteUsage15min', False),
    ]
