...
# ##################################################
class L2RemoteUsage1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsage1w", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsage1w"
    meta.rnFormat = "CDeqptcapacityL2RemoteUsage1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer2 remote entries usage count stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL2RemoteUsage1w', False),
    ]
