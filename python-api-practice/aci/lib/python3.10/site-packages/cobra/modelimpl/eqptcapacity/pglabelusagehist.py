...
# ##################################################
class PGLabelUsageHist(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist"


    meta.moClassName = "eqptcapacityPGLabelUsageHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.PGLabelUsageHist1d")
