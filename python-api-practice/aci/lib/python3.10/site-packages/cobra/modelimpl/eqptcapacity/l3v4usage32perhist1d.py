...
# ##################################################
class L3v4Usage32PerHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist1d", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist1d"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43937, PropCategory.REGULAR)
