...
# ##################################################
class VlanUsage15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage15min", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage15min"
    meta.rnFormat = "CDeqptcapacityVlanUsage15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.VlanUsage")
    meta.superClasses.add("cobra.model.stats.Curr")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage15min', False),
    ]
