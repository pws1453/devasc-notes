...
# ##################################################
class L3v4Usage32Per1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Per1year", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Per1year"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Per1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries usage percentage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Per1year', False),
    ]
