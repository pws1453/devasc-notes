...
# ##################################################
class BDEntryHist1year(Mo):
    """
    A class that represents historical statistics for bridge domain entry in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntryHist1year", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntryHist1year"
    meta.rnFormat = "HDeqptcapacityBDEntry1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical bridge domain entry stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityBDEntry1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6348, PropCategory.REGULAR)
