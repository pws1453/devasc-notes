...
# ##################################################
class L3v6Usage128Hist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Hist1d", "Layer3 v6 128 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Hist1d"
    meta.rnFormat = "HDeqptcapacityL3v6Usage1281d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage count stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage1281d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43953, PropCategory.REGULAR)
