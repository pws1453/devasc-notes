...
class EpgUsage1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsage1w", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsage1w"
    meta.rnFormat = "CDeqptcapacityEpgUsage1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Endpoint groups usage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityEpgUsage1w', False),
    ]
