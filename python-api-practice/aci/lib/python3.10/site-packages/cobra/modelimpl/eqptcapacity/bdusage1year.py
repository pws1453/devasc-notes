...
# ##################################################
class BdUsage1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage1year", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage1year"
    meta.rnFormat = "CDeqptcapacityBdUsage1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityBdUsage1year', False),
    ]
