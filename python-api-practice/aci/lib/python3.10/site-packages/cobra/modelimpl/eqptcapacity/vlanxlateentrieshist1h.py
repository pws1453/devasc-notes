...
# ##################################################
class VlanXlateEntriesHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntriesHist1h", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntriesHist1h"
    meta.rnFormat = "HDeqptcapacityVlanXlateEntries1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan Xlate entries stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanXlateEntries1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 20936, PropCategory.REGULAR)
