...
# ##################################################
class L3RemoteUsagePerHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist1h", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist1h"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36404, PropCategory.REGULAR)
