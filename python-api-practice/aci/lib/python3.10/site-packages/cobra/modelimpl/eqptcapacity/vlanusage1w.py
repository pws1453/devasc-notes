...
# ##################################################
class VlanUsage1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage1w", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage1w"
    meta.rnFormat = "CDeqptcapacityVlanUsage1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage1w', False),
    ]
