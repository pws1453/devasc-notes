...
# ##################################################
class L3v4Usage32CapHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist1w", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist1w"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43925, PropCategory.REGULAR)
