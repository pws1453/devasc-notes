...
class PolEntry1h(Mo):
    """
    A class that represents the most current statistics for  Policy entry in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntry1h", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntry1h"
    meta.rnFormat = "CDeqptcapacityPolEntry1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Policy entry stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityPolEntry1h', False),
    ]
