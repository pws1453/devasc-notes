...
# ##################################################
class L3RemoteUsagePer1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePer1h", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePer1h"
    meta.rnFormat = "CDeqptcapacityL3RemoteUsagePer1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 remote entries usage percentage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3RemoteUsagePer1h', False),
    ]
