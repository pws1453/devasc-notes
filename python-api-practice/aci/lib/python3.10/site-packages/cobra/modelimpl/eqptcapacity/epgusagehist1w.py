...
# ##################################################
class EpgUsageHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist1w", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist1w"
    meta.rnFormat = "HDeqptcapacityEpgUsage1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 47464, PropCategory.REGULAR)
