...
# ##################################################
class L2RemoteUsage1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsage1qtr", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsage1qtr"
    meta.rnFormat = "CDeqptcapacityL2RemoteUsage1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer2 remote entries usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL2RemoteUsage1qtr', False),
    ]
