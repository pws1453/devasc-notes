...
# ##################################################
class L3v6Usage128Per5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Per5min", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Per5min"
    meta.rnFormat = "CDeqptcapacityL3v6Usage128Per5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v6 128 entries usage percentage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v6Usage128Per5min', False),
    ]
