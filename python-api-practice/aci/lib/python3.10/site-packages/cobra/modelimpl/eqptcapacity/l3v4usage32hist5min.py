...
# ##################################################
class L3v4Usage32Hist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Hist5min", "Layer3 v4 32 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Hist5min"
    meta.rnFormat = "HDeqptcapacityL3v4Usage325min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage count stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage325min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43935, PropCategory.REGULAR)
