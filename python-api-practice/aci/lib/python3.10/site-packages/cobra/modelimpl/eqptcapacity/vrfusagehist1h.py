...
# ##################################################
class VrfUsageHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist1h", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist1h"
    meta.rnFormat = "HDeqptcapacityVrfUsage1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 47477, PropCategory.REGULAR)
