...
# ##################################################
class L3RemoteUsagePerHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist1year", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist1year"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36408, PropCategory.REGULAR)
