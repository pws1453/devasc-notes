...
# ##################################################
class McastUsage1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsage1d", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsage1d"
    meta.rnFormat = "CDeqptcapacityMcastUsage1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Multicast entries usage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityMcastUsage1d', False),
    ]
