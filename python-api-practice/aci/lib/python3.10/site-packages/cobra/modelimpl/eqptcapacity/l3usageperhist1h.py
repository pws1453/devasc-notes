...
# ##################################################
class L3UsagePerHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3UsagePerHist1h", "Layer3 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3UsagePerHist1h"
    meta.rnFormat = "HDeqptcapacityL3UsagePer1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 entries usage percentage stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3UsagePer1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 27166, PropCategory.REGULAR)
