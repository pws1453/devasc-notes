...
# ##################################################
class BdUsageHist(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist"


    meta.moClassName = "eqptcapacityBdUsageHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist1h")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.BdUsageHist1qtr")
