...
# ##################################################
class L3RemoteUsagePerHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist1d", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist1d"
    meta.rnFormat = "HDeqptcapacityL3RemoteUsagePer1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3RemoteUsagePer1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36403, PropCategory.REGULAR)
