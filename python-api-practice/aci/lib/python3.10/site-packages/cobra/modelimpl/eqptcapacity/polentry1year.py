...
# ##################################################
class PolEntry1year(Mo):
    """
    A class that represents the most current statistics for  Policy entry in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntry1year", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntry1year"
    meta.rnFormat = "CDeqptcapacityPolEntry1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Policy entry stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityPolEntry1year', False),
    ]
