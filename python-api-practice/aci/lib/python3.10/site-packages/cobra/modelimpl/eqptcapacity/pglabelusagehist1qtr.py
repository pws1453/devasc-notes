...
# ##################################################
class PGLabelUsageHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PGLabelUsageHist1qtr", "PG Label entries usage")
    ...
    meta.moClassName = "eqptcapacityPGLabelUsageHist1qtr"
    meta.rnFormat = "HDeqptcapacityPGLabelUsage1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical PG Label entries usage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPGLabelUsage1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 44394, PropCategory.REGULAR)
