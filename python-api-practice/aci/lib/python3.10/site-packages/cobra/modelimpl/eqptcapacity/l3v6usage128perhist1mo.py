...
# ##################################################
class L3v6Usage128PerHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist1mo", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist1mo"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43963, PropCategory.REGULAR)
