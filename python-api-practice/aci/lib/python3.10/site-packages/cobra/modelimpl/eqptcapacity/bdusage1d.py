...
class BdUsage1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsage1d", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsage1d"
    meta.rnFormat = "CDeqptcapacityBdUsage1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Bridge domain usage count stats in 1 day"
