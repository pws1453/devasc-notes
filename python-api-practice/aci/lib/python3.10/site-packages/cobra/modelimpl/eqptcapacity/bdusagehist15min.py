...
# ##################################################
class BdUsageHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BdUsageHist15min", "Bridge domain usage count")
    ...
    meta.moClassName = "eqptcapacityBdUsageHist15min"
    meta.rnFormat = "HDeqptcapacityBdUsage15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Bridge domain usage count stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityBdUsage15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47451, PropCategory.REGULAR)
