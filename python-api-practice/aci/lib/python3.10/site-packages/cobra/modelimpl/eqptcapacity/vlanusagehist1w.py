...
# ##################################################
class VlanUsageHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsageHist1w", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsageHist1w"
    meta.rnFormat = "HDeqptcapacityVlanUsage1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan entries usage stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanUsage1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19996, PropCategory.REGULAR)
