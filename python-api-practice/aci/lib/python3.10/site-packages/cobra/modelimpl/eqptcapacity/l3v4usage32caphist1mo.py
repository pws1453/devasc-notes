...
# ##################################################
class L3v4Usage32CapHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32CapHist1mo", "Layer3 v4 32 entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32CapHist1mo"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Cap1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries max capacity stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Cap1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43923, PropCategory.REGULAR)
