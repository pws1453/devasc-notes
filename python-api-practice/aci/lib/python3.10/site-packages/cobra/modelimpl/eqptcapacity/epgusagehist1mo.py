...
# ##################################################
class EpgUsageHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.EpgUsageHist1mo", "Endpoint groups usage")
    ...
    meta.moClassName = "eqptcapacityEpgUsageHist1mo"
    meta.rnFormat = "HDeqptcapacityEpgUsage1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Endpoint groups usage stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityEpgUsage1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47462, PropCategory.REGULAR)
