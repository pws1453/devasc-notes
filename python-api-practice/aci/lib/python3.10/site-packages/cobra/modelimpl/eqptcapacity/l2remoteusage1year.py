...
# ##################################################
class L2RemoteUsage1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsage1year", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsage1year"
    meta.rnFormat = "CDeqptcapacityL2RemoteUsage1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer2 remote entries usage count stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL2RemoteUsage1year', False),
    ]
