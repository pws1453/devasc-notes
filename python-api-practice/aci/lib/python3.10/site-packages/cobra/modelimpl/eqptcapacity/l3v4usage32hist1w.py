...
# ##################################################
class L3v4Usage32Hist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Hist1w", "Layer3 v4 32 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Hist1w"
    meta.rnFormat = "HDeqptcapacityL3v4Usage321w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage count stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage321w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43933, PropCategory.REGULAR)
