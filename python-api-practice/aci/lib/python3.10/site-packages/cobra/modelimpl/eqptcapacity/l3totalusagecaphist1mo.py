...
# ##################################################
class L3TotalUsageCapHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCapHist1mo", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCapHist1mo"
    meta.rnFormat = "HDeqptcapacityL3TotalUsageCap1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 total entries max capacity stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3TotalUsageCap1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36413, PropCategory.REGULAR)
