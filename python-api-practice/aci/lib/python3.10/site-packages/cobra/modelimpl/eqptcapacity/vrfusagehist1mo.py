...
# ##################################################
class VrfUsageHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsageHist1mo", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsageHist1mo"
    meta.rnFormat = "HDeqptcapacityVrfUsage1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical VRF usage count stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVrfUsage1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47478, PropCategory.REGULAR)
