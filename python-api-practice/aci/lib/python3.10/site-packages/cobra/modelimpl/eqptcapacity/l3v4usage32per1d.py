...
# ##################################################
class L3v4Usage32Per1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Per1d", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Per1d"
    meta.rnFormat = "CDeqptcapacityL3v4Usage32Per1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Layer3 v4 32 entries usage percentage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityL3v4Usage32Per1d', False),
    ]
