...
# ##################################################
class L3v4Usage32Hist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Hist1h", "Layer3 v4 32 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Hist1h"
    meta.rnFormat = "HDeqptcapacityL3v4Usage321h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage count stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage321h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43930, PropCategory.REGULAR)
