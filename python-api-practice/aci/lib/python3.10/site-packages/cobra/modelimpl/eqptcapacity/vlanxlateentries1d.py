...
# ##################################################
class VlanXlateEntries1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanXlateEntries1d", "Vlan Xlate entries")
    ...
    meta.moClassName = "eqptcapacityVlanXlateEntries1d"
    meta.rnFormat = "CDeqptcapacityVlanXlateEntries1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan Xlate entries stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanXlateEntries1d', False),
    ]
