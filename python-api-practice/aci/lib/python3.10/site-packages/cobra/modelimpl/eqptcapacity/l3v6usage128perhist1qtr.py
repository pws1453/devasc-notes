...
# ##################################################
class L3v6Usage128PerHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist1qtr", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist1qtr"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43964, PropCategory.REGULAR)
