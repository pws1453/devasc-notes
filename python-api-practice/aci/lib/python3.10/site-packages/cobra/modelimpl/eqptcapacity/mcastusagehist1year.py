...
# ##################################################
class McastUsageHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.McastUsageHist1year", "Multicast entries usage")
    ...
    meta.moClassName = "eqptcapacityMcastUsageHist1year"
    meta.rnFormat = "HDeqptcapacityMcastUsage1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Multicast entries usage stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityMcastUsage1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19973, PropCategory.REGULAR)
