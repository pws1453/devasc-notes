...
# ##################################################
class L3v4Usage32PerHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32PerHist5min", "Layer3 v4 32 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32PerHist5min"
    meta.rnFormat = "HDeqptcapacityL3v4Usage32Per5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage percentage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage32Per5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43943, PropCategory.REGULAR)
