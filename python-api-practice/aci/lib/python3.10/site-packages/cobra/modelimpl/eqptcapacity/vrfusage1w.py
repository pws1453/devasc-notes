...
class VrfUsage1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqptcapacity.VrfUsage1w", "VRF usage count")
    ...
    meta.moClassName = "eqptcapacityVrfUsage1w"
    meta.rnFormat = "CDeqptcapacityVrfUsage1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current VRF usage count stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVrfUsage1w', False),
    ]
