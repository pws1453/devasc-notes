...
# ##################################################
class L3v4Usage32Hist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v4Usage32Hist1qtr", "Layer3 v4 32 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v4Usage32Hist1qtr"
    meta.rnFormat = "HDeqptcapacityL3v4Usage321qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v4 32 entries usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v4Usage321qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43932, PropCategory.REGULAR)
