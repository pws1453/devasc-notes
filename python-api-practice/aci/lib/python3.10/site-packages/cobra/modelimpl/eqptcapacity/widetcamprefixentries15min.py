...
# ##################################################
class WideTcamPrefixEntries15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.WideTcamPrefixEntries15min", "Wide Tcam Prefix IPv6 entries")
    ...
    meta.moClassName = "eqptcapacityWideTcamPrefixEntries15min"
    meta.rnFormat = "CDeqptcapacityWideTcamPrefixEntries15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Wide Tcam Prefix IPv6 entries stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityWideTcamPrefixEntries15min', False),
    ]
