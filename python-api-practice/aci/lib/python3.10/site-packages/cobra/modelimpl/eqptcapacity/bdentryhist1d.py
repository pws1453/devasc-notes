...
# ##################################################
class BDEntryHist1d(Mo):
    """
    A class that represents historical statistics for bridge domain entry in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.BDEntryHist1d", "bridge domain entry")
    ...
    meta.moClassName = "eqptcapacityBDEntryHist1d"
    meta.rnFormat = "HDeqptcapacityBDEntry1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical bridge domain entry stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6343, PropCategory.REGULAR)
