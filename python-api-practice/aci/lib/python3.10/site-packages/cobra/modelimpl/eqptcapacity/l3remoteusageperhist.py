...
# ##################################################
class L3RemoteUsagePerHist(Mo):
    meta = StatsClassMeta("cobra.model.eqptcapacity.L3RemoteUsagePerHist", "Layer3 remote entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist"


    meta.moClassName = "eqptcapacityL3RemoteUsagePerHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 remote entries usage percentage stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist15min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist1year")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist1d")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist1w")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist5min")
    meta.concreteSubClasses.add("cobra.model.eqptcapacity.L3RemoteUsagePerHist1h")
    ...
    prop = PropMeta("str", "normalizedRemotev4Avg", "normalizedRemotev4Avg", 36643, PropCategory.IMPLICIT_AVG)
    prop.label = "Remote v4 L3 entries usage percentage average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev4Avg", prop)

    prop = PropMeta("str", "normalizedRemotev4Max", "normalizedRemotev4Max", 36642, PropCategory.IMPLICIT_MAX)
    prop.label = "Remote v4 L3 entries usage percentage maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev4Max", prop)

    prop = PropMeta("str", "normalizedRemotev4Min", "normalizedRemotev4Min", 36641, PropCategory.IMPLICIT_MIN)
    prop.label = "Remote v4 L3 entries usage percentage minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev4Min", prop)

    prop = PropMeta("str", "normalizedRemotev4Spct", "normalizedRemotev4Spct", 36644, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Remote v4 L3 entries usage percentage suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev4Spct", prop)

    prop = PropMeta("str", "normalizedRemotev4Thr", "normalizedRemotev4Thr", 36645, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "normalizedRemotev4Tr", "normalizedRemotev4Tr", 36646, PropCategory.IMPLICIT_TREND)
    prop.label = "Remote v4 L3 entries usage percentage trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev4Tr", prop)

    prop = PropMeta("str", "normalizedRemotev6Avg", "normalizedRemotev6Avg", 36658, PropCategory.IMPLICIT_AVG)
    prop.label = "Remote v6 L3 entries usage percentage average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev6Avg", prop)

    prop = PropMeta("str", "normalizedRemotev6Max", "normalizedRemotev6Max", 36657, PropCategory.IMPLICIT_MAX)
    prop.label = "Remote v6 L3 entries usage percentage maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev6Max", prop)

    prop = PropMeta("str", "normalizedRemotev6Min", "normalizedRemotev6Min", 36656, PropCategory.IMPLICIT_MIN)
    prop.label = "Remote v6 L3 entries usage percentage minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev6Min", prop)

    prop = PropMeta("str", "normalizedRemotev6Spct", "normalizedRemotev6Spct", 36659, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Remote v6 L3 entries usage percentage suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("normalizedRemotev6Spct", prop)

    prop = PropMeta("str", "normalizedRemotev6Thr", "normalizedRemotev6Thr", 36660, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "normalizedRemotev6Tr", "normalizedRemotev6Tr", 36661, PropCategory.IMPLICIT_TREND)
