...
# ##################################################
class L3v6Usage128PerHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128PerHist5min", "Layer3 v6 128 entries usage percentage")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128PerHist5min"
    meta.rnFormat = "HDeqptcapacityL3v6Usage128Per5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage percentage stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage128Per5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43967, PropCategory.REGULAR)
