...
# ##################################################
class PolEntryHist1mo(Mo):
    """
    A class that represents historical statistics for  Policy entry in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.PolEntryHist1mo", "Policy entry")
    ...
    meta.moClassName = "eqptcapacityPolEntryHist1mo"
    meta.rnFormat = "HDeqptcapacityPolEntry1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Policy entry stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityPolEntry1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6377, PropCategory.REGULAR)
