...
# ##################################################
class VlanUsage1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsage1d", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsage1d"
    meta.rnFormat = "CDeqptcapacityVlanUsage1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Vlan entries usage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDeqptcapacityVlanUsage1d', False),
    ]
