...
# ##################################################
class L2RemoteUsageHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist15min", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist15min"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqptcapacity.L2RemoteUsageHist")

    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36370, PropCategory.REGULAR)
