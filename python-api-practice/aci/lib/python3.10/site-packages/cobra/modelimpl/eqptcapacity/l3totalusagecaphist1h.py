...
# ##################################################
class L3TotalUsageCapHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3TotalUsageCapHist1h", "Layer3 total entries max capacity")
    ...
    meta.moClassName = "eqptcapacityL3TotalUsageCapHist1h"
    meta.rnFormat = "HDeqptcapacityL3TotalUsageCap1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 total entries max capacity stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3TotalUsageCap1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36412, PropCategory.REGULAR)
