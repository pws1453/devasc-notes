...
# ##################################################
class VlanUsageHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.VlanUsageHist1d", "Vlan entries usage")
    ...
    meta.moClassName = "eqptcapacityVlanUsageHist1d"
    meta.rnFormat = "HDeqptcapacityVlanUsage1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Vlan entries usage stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityVlanUsage1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19992, PropCategory.REGULAR)
