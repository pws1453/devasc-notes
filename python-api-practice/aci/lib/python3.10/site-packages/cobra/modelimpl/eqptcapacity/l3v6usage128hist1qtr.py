...
# ##################################################
class L3v6Usage128Hist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L3v6Usage128Hist1qtr", "Layer3 v6 128 entries usage count")
    ...
    meta.moClassName = "eqptcapacityL3v6Usage128Hist1qtr"
    meta.rnFormat = "HDeqptcapacityL3v6Usage1281qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer3 v6 128 entries usage count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL3v6Usage1281qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 43956, PropCategory.REGULAR)
