...
class RsToInbEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.telemetry.RsToInbEpg", "cobra.model.mgmt.InB")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToInbEpg"
    meta.rnFormat = "rsToInbEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Inband Management to be used"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38800, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40939, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 35710, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 35709, PropCategory.REGULAR)
