...
# ##################################################
class RsServerToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsServerToCtx", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "telemetryRsServerToCtx"
    meta.rnFormat = "rsserverToCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Ctx behind which the server policy resides"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38797, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40936, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 35697, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 35696, PropCategory.REGULAR)
