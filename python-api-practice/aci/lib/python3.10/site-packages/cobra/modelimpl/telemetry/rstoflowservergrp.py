...
# ##################################################
class RsToFlowServerGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToFlowServerGrp", "cobra.model.telemetry.FlowServerGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "telemetryRsToFlowServerGrp"
    meta.rnFormat = "rstoFlowServerGrp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Flow Server Group"
    ...
    meta.rnPrefixes = [
        ('rstoFlowServerGrp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38827, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40966, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36958, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 36952, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11749
    prop.defaultValueStr = "telemetryFlowServerGrp"
    prop._addConstant("telemetryFlowServerGrp", None, 11749)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 36951, PropCategory.REGULAR)
