...
# ##################################################
class LogServerPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.LogServerPTask")

    meta.moClassName = "telemetryLogServerPTask"
    meta.rnFormat = "telemetryLogServerPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 47670, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("configureFileBeat", "configurefilebeat", 3310)
