...
# ##################################################
class SubnetFltGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.SubnetFltGrp")

    meta.moClassName = "telemetrySubnetFltGrp"
    meta.rnFormat = "sfltgrp"
    ...
    meta.childClasses.add("cobra.model.telemetry.SubnetFilter")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.telemetry.SubnetFilter", "subflt-"))
    ...
    meta.superClasses.add("cobra.model.telemetry.AFltGrp")

    meta.rnPrefixes = [
        ('sfltgrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38847, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40986, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
