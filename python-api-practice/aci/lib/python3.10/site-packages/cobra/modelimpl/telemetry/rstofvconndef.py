...
# ##################################################
class RsToFvConnDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToFvConnDef", "cobra.model.fv.ConnDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToFvConnDef"
    meta.rnFormat = "rstoFvConnDef"
    ...
    meta.parentClasses.add("cobra.model.telemetry.CollectorServer")
    ...
    prop = PropMeta("str", "tCl", "tCl", 41076, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 41075, PropCategory.REGULAR)
