...
# ##################################################
class RsToInbandEpP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToInbandEpP", "cobra.model.fv.InBEpP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToInbandEpP"
    meta.rnFormat = "rstoInbandEpP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55264, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55263, PropCategory.REGULAR)
