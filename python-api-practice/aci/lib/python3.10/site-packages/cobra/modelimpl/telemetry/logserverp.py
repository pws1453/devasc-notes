...
class LogServerP(Mo):
    ...
    meta = ClassMeta("cobra.model.telemetry.LogServerP")

    meta.moClassName = "telemetryLogServerP"
    meta.rnFormat = "logserverp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Log Server Info For Streaming logs"
    ...
    meta.childClasses.add("cobra.model.telemetry.RtToRemoteLogServer")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.telemetry.RsServerToCtx")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.telemetry.RtToRemoteLogServer", "rttoRemoteLogServer"))
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 41011, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38793, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40932, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 35617, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
