...
# ##################################################
class RsToInbandEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToInbandEpg", "cobra.model.mgmt.InB")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToInbandEpg"
    meta.rnFormat = "rstoInbandEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Inband Management through which traffic is sent"
    ...
    prop = PropMeta("str", "annotation", "annotation", 41084, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 41085, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 41070, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 41069, PropCategory.REGULAR)
