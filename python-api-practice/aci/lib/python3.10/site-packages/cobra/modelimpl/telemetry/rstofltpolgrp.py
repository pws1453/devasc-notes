...
# ##################################################
class RsToFltPolGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.telemetry.RsToFltPolGrp", "cobra.model.telemetry.FlowServerP")
    meta.targetNameProps["name"] = "tnTelemetryFlowServerPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "telemetryRsToFltPolGrp"
    meta.rnFormat = "rstoFltPolGrp-%(tnTelemetryFlowServerPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to telemetry analytics filter Policy Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38829, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40968, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36960, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 36956, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11754
    prop.defaultValueStr = "telemetryFlowServerP"
    ...
    prop = PropMeta("str", "tnTelemetryFlowServerPName", "tnTelemetryFlowServerPName", 36955, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTelemetryFlowServerPName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnTelemetryFlowServerPName"))
    ...
    def __init__(self, parentMoOrDn, tnTelemetryFlowServerPName, markDirty=True, **creationProps):
        namingVals = [tnTelemetryFlowServerPName]
