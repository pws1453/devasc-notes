...
# ##################################################
class MatchedSelector(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.MatchedSelector")

    meta.moClassName = "telemetryMatchedSelector"
    meta.rnFormat = "matchedSel-[%(selectorDn)s]"
    ...
    prop = PropMeta("str", "selectorDn", "selectorDn", 39343, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
