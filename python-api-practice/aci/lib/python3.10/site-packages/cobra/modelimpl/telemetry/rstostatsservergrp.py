...
# ##################################################
class RsToStatsServerGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToStatsServerGrp", "cobra.model.telemetry.StatsServerGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "telemetryRsToStatsServerGrp"
    meta.rnFormat = "rstoStatsServerGrp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Stats Group"
    ...
    meta.rnPrefixes = [
        ('rstoStatsServerGrp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38810, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40949, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36793, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 36787, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11699
    prop.defaultValueStr = "telemetryStatsServerGrp"
    prop._addConstant("telemetryStatsServerGrp", None, 11699)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 36786, PropCategory.REGULAR)
