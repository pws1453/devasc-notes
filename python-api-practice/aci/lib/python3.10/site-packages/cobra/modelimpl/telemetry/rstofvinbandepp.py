...
# ##################################################
class RsToFvInbandEpp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToFvInbandEpp", "cobra.model.fv.InBEpP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToFvInbandEpp"
    meta.rnFormat = "rstoFvInbandEpp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55330, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55329, PropCategory.REGULAR)
