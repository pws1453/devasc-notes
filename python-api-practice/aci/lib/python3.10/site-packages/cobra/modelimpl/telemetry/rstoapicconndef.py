...
# ##################################################
class RsToApicConnDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToApicConnDef", "cobra.model.fv.ConnDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToApicConnDef"
    meta.rnFormat = "rsToApicConnDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Association to inband IP of APIC"
    ...
    meta.parentClasses.add("cobra.model.telemetry.StNode")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsToApicConnDef', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 35713, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1922
    prop.defaultValueStr = "fvConnDef"
    prop._addConstant("fvConnDef", None, 1922)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35712, PropCategory.REGULAR)
