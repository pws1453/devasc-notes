...
# ##################################################
class AServerP(Mo):
    meta = ClassMeta("cobra.model.telemetry.AServerP")

    meta.isAbstract = True
    meta.moClassName = "telemetryAServerP"
    ...
    meta.concreteSubClasses.add("cobra.model.telemetry.Server")
    meta.concreteSubClasses.add("cobra.model.telemetry.LogServerP")
    meta.concreteSubClasses.add("cobra.model.telemetry.StatsServerP")
