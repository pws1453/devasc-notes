...
class RsToL3Dom(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.telemetry.RsToL3Dom", "cobra.model.l3.Dom")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToL3Dom"
    meta.rnFormat = "rstoL3Dom"
    ...
    meta.parentClasses.add("cobra.model.telemetry.ServerCtx")
    ...
    prop = PropMeta("str", "tCl", "tCl", 55333, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55332, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 55335, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
