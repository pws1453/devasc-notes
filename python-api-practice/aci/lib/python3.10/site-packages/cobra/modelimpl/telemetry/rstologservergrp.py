...
# ##################################################
class RsToLogServerGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToLogServerGrp", "cobra.model.telemetry.LogServerGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "telemetryRsToLogServerGrp"
    meta.rnFormat = "rstoLogServerGrp-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoLogServerGrp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40944, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35768, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35761, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11393
    prop.defaultValueStr = "telemetryLogServerGrp"
    prop._addConstant("telemetryLogServerGrp", None, 11393)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35760, PropCategory.REGULAR)
