...
# ##################################################
class RsToInbCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToInbCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToInbCtxDef"
    meta.rnFormat = "rsToInbCtxDef"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38801, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40940, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35719, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35716, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 35715, PropCategory.REGULAR)
