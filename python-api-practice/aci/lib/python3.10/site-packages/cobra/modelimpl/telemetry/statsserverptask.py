...
# ##################################################
class StatsServerPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.StatsServerPTask")

    meta.moClassName = "telemetryStatsServerPTask"
    meta.rnFormat = "telemetryStatsServerPTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('telemetryStatsServerPTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 35660, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("pushStatsServerPolToEm", "pushstatsserverpoltoem", 3093)
    prop._addConstant("pushStatsServerPolToTm", "pushstatsserverpoltotm", 3339)
    prop._addConstant("sendTelemetryPol", "sendtelemetrypol", 2954)
