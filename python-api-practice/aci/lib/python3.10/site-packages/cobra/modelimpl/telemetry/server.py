...
class Server(Mo):
    ...
    meta = ClassMeta("cobra.model.telemetry.Server")

    meta.moClassName = "telemetryServer"
    meta.rnFormat = "server-%(ip)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Config Server Info For Telemetry Server"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38767, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40906, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 34464, PropCategory.REGULAR)
    prop.label = "Server IP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
