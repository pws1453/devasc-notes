...
# ##################################################
class RsToRemoteLogServer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.telemetry.RsToRemoteLogServer", "cobra.model.telemetry.LogServerP")
    meta.targetNameProps["name"] = "tnTelemetryLogServerPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "telemetryRsToRemoteLogServer"
    meta.rnFormat = "rstoRemoteLogServer-%(tnTelemetryLogServerPName)s"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteLogServer-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38807, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40946, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35770, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35765, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11346
    prop.defaultValueStr = "telemetryLogServerP"
    ...
    prop = PropMeta("str", "tnTelemetryLogServerPName", "tnTelemetryLogServerPName", 35764, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTelemetryLogServerPName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnTelemetryLogServerPName"))
    ...
    def __init__(self, parentMoOrDn, tnTelemetryLogServerPName, markDirty=True, **creationProps):
        namingVals = [tnTelemetryLogServerPName]
