...
# ##################################################
class RsToRemoteStatsServer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.telemetry.RsToRemoteStatsServer", "cobra.model.telemetry.StatsServerP")
    meta.targetNameProps["name"] = "tnTelemetryStatsServerPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "telemetryRsToRemoteStatsServer"
    meta.rnFormat = "rstoRemoteStatsServer-%(tnTelemetryStatsServerPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Pol Group"
    ...
    meta.superClasses.add("cobra.model.telemetry.ARemoteServer")
    meta.superClasses.add("cobra.model.pol.NToRef")

    meta.rnPrefixes = [
        ('rstoRemoteStatsServer-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38812, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40951, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36795, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 36791, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11347
    prop.defaultValueStr = "telemetryStatsServerP"
    ...
    prop = PropMeta("str", "tnTelemetryStatsServerPName", "tnTelemetryStatsServerPName", 36790, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTelemetryStatsServerPName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnTelemetryStatsServerPName"))
    ...
    def __init__(self, parentMoOrDn, tnTelemetryStatsServerPName, markDirty=True, **creationProps):
        namingVals = [tnTelemetryStatsServerPName]
