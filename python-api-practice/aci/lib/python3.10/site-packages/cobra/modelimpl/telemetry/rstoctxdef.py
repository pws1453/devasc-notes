...
class RsToCtxDef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.telemetry.RsToCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToCtxDef"
    meta.rnFormat = "rstoCtxDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Association to inband ctxdef"
    ...
    prop = PropMeta("str", "annotation", "annotation", 41086, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 41087, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 41079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 41073, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 41072, PropCategory.REGULAR)
