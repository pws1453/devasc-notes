...
# ##################################################
class SubnetFilter(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.SubnetFilter")

    meta.moClassName = "telemetrySubnetFilter"
    meta.rnFormat = "subflt-[%(subnetIp)s]"
    ...
    meta.superClasses.add("cobra.model.telemetry.AFilter")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38848, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40987, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "subnetIp", "subnetIp", 37202, PropCategory.REGULAR)
    prop.label = "Subnet IP address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("subnetIp", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "subnetIp"))
    getattr(meta.props, "subnetIp").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, subnetIp, markDirty=True, **creationProps):
        namingVals = [subnetIp]
