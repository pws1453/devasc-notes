...
# ##################################################
class RsToFvCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.telemetry.RsToFvCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "telemetryRsToFvCtxDef"
    meta.rnFormat = "rstoFvCtxDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55327, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55326, PropCategory.REGULAR)
