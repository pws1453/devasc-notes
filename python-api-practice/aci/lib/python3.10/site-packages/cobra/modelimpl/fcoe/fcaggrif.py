...
class FcAggrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.fcoe.FcAggrIf")

    meta.moClassName = "fcoeFcAggrIf"
    meta.rnFormat = "fcaggrif-[%(id)s]"
    ...
    meta.childClasses.add("cobra.model.fcoe.FcAggrLogin")

    meta.childNamesAndRnPrefix.append(("cobra.model.fcoe.FcAggrLogin", "fcid-"))
    ...
    prop = PropMeta("str", "id", "id", 45461, PropCategory.REGULAR)
