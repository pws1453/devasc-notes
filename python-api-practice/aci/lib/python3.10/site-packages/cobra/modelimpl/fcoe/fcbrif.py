...
class FcBrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.fcoe.FcBrIf")

    meta.moClassName = "fcoeFcBrIf"
    meta.rnFormat = "fcbr-[%(id)s]"
    ...
    meta.childClasses.add("cobra.model.fcoe.FcBrLogin")

    meta.childNamesAndRnPrefix.append(("cobra.model.fcoe.FcBrLogin", "fcid-"))
    ...
    prop = PropMeta("str", "id", "id", 45463, PropCategory.REGULAR)
