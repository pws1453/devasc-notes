...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.fcoe.Entity")

    meta.moClassName = "fcoeEntity"
    meta.rnFormat = "fcoe"
    meta.category = MoCategory.REGULAR
    meta.label = "FCOE Manager Entity"
    ...
    meta.childClasses.add("cobra.model.fcoe.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fcoe.Inst", "inst"))
