...
class CktEp(Mo):
    ...
    meta = ClassMeta("cobra.model.vxlan.CktEp")

    meta.moClassName = "vxlanCktEp"
    meta.rnFormat = "vxlan-[%(encap)s]"
    ...
    meta.childClasses.add("cobra.model.vxlan.RsVxlanEppAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vxlan.RsVxlanEppAtt", "rsvxlanEppAtt"))
    ...
    prop = PropMeta("str", "encap", "encap", 7401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mcastEncap", "mcastEncap", 3541, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14540, PropCategory.REGULAR)
