...
# ##################################################
class RsVxlanEppAtt(Mo):
    """
    A source relation to an abstract representation of a resolvable endpoint profile.

    """

    meta = SourceRelationMeta("cobra.model.vxlan.RsVxlanEppAtt", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vxlanRsVxlanEppAtt"
    meta.rnFormat = "rsvxlanEppAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Epp Attachement"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15077, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12707, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12706, PropCategory.REGULAR)
