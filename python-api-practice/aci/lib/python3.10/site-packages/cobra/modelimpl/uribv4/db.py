...
class Db(Mo):
    """
    An IPv4 unicast route information base database.

    """

    meta = ClassMeta("cobra.model.uribv4.Db")

    meta.moClassName = "uribv4Db"
    ...
    meta.childClasses.add("cobra.model.uribv4.Route")

    meta.childNamesAndRnPrefix.append(("cobra.model.uribv4.Route", "rt-"))

    meta.parentClasses.add("cobra.model.uribv4.Dom")
    ...
    prop = PropMeta("str", "type", "type", 7287, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
