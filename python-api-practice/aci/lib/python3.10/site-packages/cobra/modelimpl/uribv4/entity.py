...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.uribv4.Entity")

    meta.moClassName = "uribv4Entity"
    meta.rnFormat = "uribv4"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv4 Unicast Routing Information Base Entity"
    ...
    meta.childClasses.add("cobra.model.uribv4.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.uribv4.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.top.System")

    meta.superClasses.add("cobra.model.rib.Entity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14571, PropCategory.REGULAR)
