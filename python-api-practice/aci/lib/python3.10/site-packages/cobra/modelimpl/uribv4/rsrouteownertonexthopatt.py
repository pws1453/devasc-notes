...
# ##################################################
class RsRouteOwnerToNexthopAtt(Mo):
    """
    A source relation to a URIB next hop database record.

    """

    meta = SourceRelationMeta("cobra.model.uribv4.RsRouteOwnerToNexthopAtt", "cobra.model.uribv4.Nexthop")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "uribv4RsRouteOwnerToNexthopAtt"
    meta.rnFormat = "rsrouteOwnerToNexthopAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12831, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3782
    prop.defaultValueStr = "uribv4Nexthop"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("uribv4Nexthop", None, 3782)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12830, PropCategory.REGULAR)
