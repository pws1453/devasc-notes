...
class IfHCIn(Mo):
    ...
    meta = ClassMeta("cobra.model.rmon.IfHCIn")

    meta.moClassName = "rmonIfHCIn"
    meta.rnFormat = "dbgIfHCIn"
    meta.category = MoCategory.REGULAR
    meta.label = "Interface HC Input Counters"
    ...
    prop = PropMeta("str", "broadcastPkts", "broadcastPkts", 4219, PropCategory.DEBUG_STATS)
    ...
    prop = PropMeta("str", "multicastPkts", "multicastPkts", 4218, PropCategory.DEBUG_STATS)
    prop.label = "Multicast Packets"
    prop.isOper = True
    meta.props.add("multicastPkts", prop)

    prop = PropMeta("str", "octets", "octets", 4216, PropCategory.DEBUG_STATS)
    prop.label = "Octets"
    prop.isOper = True
    ...
    prop = PropMeta("str", "ucastPkts", "ucastPkts", 4217, PropCategory.DEBUG_STATS)
