...
# ##################################################
class EgrCounters(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rmon.EgrCounters")

    meta.moClassName = "rmonEgrCounters"
    meta.rnFormat = "dbgEgrCounters"
    meta.category = MoCategory.REGULAR
    meta.label = "Egress Counters"
    ...
    meta.rnPrefixes = [
        ('dbgEgrCounters', False),
    ]

    prop = PropMeta("str", "bufferdroppkts", "bufferdroppkts", 53885, PropCategory.DEBUG_STATS)
    ...
    prop = PropMeta("str", "totaldroppkts", "totaldroppkts", 39358, PropCategory.DEBUG_STATS)
