...
# ##################################################
class IngrCounters(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rmon.IngrCounters")

    meta.moClassName = "rmonIngrCounters"
    meta.rnFormat = "dbgIngrCounters"
    meta.category = MoCategory.REGULAR
    meta.label = "Ingress Counters"
    ...
    meta.rnPrefixes = [
        ('dbgIngrCounters', False),
    ]

    prop = PropMeta("str", "bufferdroppkts", "bufferdroppkts", 55244, PropCategory.DEBUG_STATS)
    prop.label = "Buffer drop packets"
    prop.isOper = True
    meta.props.add("bufferdroppkts", prop)
    ...
    prop = PropMeta("str", "totaldroppkts", "totaldroppkts", 39357, PropCategory.DEBUG_STATS)
    prop.label = "Total drop packets"
    prop.isOper = True
    meta.props.add("totaldroppkts", prop)
