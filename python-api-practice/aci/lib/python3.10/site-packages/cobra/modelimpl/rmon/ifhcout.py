...
class IfHCOut(Mo):
    """
    The interface high capacity output statistics.

    """

    meta = ClassMeta("cobra.model.rmon.IfHCOut")

    meta.moClassName = "rmonIfHCOut"
    meta.rnFormat = "dbgIfHCOut"
    meta.category = MoCategory.REGULAR
    meta.label = "Interface HC Output Counters"
    ...
    prop = PropMeta("str", "broadcastPckts", "broadcastPckts", 4223, PropCategory.DEBUG_STATS)
    prop.label = "Broadcast Packets"
    prop.isOper = True
    meta.props.add("broadcastPckts", prop)

    prop = PropMeta("str", "broadcastPkts", "broadcastPkts", 4224, PropCategory.DEBUG_STATS)
    prop.label = "Broadcast Packets"
    prop.isOper = True
    ...
    prop = PropMeta("str", "multicastPkts", "multicastPkts", 4222, PropCategory.DEBUG_STATS)
    prop.label = "Multicast Packets"
    prop.isOper = True
    meta.props.add("multicastPkts", prop)

    prop = PropMeta("str", "octets", "octets", 4220, PropCategory.DEBUG_STATS)
    prop.label = "Octets"
    prop.isOper = True
    ...
    prop = PropMeta("str", "ucastPkts", "ucastPkts", 4221, PropCategory.DEBUG_STATS)
