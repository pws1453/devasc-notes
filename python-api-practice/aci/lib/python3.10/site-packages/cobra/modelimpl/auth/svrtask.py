...
class SvrTask(Mo):
    ...
    meta = ClassMeta("cobra.model.auth.SvrTask")

    meta.moClassName = "authSvrTask"
    meta.rnFormat = "authSvrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 43747, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Config", "config", 3171)
