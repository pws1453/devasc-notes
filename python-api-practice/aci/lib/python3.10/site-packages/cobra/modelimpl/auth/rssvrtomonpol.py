...
# ##################################################
class RsSvrToMonPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.auth.RsSvrToMonPol", "cobra.model.mon.InfraPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "authRsSvrToMonPol"
    meta.rnFormat = "rssvrToMonPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43906, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43907, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43875, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43843, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43842, PropCategory.REGULAR)
