...
class SvrGroup(Mo):
    ...
    meta = ClassMeta("cobra.model.auth.SvrGroup")

    meta.moClassName = "authSvrGroup"
    meta.rnFormat = "authsvrgrp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Auth Server Group"
    ...
    meta.childClasses.add("cobra.model.auth.Svr")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.auth.Svr", "authsvr-"))
    ...
    meta.superClasses.add("cobra.model.auth.ASvrGroup")

    meta.rnPrefixes = [
        ('authsvrgrp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43900, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "delimiter", "delimiter", 43708, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43901, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mode", "mode", 43707, PropCategory.REGULAR)
    prop.label = "Mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "AD"
    prop._addConstant("AD", "active-directory", 1)
    prop._addConstant("unknown", "unknown", 0)
    meta.props.add("mode", prop)

    prop = PropMeta("str", "monPolDn", "monPolDn", 43873, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 43762, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "txId", "txId", 43709, PropCategory.REGULAR)
    prop.label = "Transaction"
    prop.isImplicit = True
    prop.isAdmin = True
