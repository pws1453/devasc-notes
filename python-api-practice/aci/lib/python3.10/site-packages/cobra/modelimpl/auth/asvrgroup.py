...
# ##################################################
class ASvrGroup(Mo):
    meta = ClassMeta("cobra.model.auth.ASvrGroup")

    meta.isAbstract = True
    meta.moClassName = "authASvrGroup"


    meta.moClassName = "authASvrGroup"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Auth Server Group"
    ...
    meta.concreteSubClasses.add("cobra.model.auth.SvrGroup")
    ...
    prop = PropMeta("str", "name", "name", 43699, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
