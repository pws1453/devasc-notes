...
class UsrAccP(Mo):
    ...
    meta = ClassMeta("cobra.model.auth.UsrAccP")

    meta.moClassName = "authUsrAccP"
    meta.rnFormat = "usracc"
    meta.category = MoCategory.REGULAR
    meta.label = "Server credential"
    ...
    meta.superClasses.add("cobra.model.auth.BaseUsrAccP")

    meta.rnPrefixes = [
        ('usracc', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43898, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43899, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keyRingDn", "keyRingDn", 43706, PropCategory.REGULAR)
    prop.label = "Keyring DN"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("keyRingDn", prop)
