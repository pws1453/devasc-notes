...
# ##################################################
class RsSvrToMgmtEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.auth.RsSvrToMgmtEPg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "authRsSvrToMgmtEPg"
    meta.rnFormat = "rssvrToMgmtEPg"
    ...
    meta.rnPrefixes = [
        ('rssvrToMgmtEPg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43904, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43905, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 43839, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43838, PropCategory.REGULAR)
