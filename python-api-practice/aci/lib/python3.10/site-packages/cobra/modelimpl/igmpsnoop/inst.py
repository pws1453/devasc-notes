...
class Inst(Mo):
    """
    Holds per IGMP instance information. There is only one instance of IGMP running in the system today.

    """

    meta = ClassMeta("cobra.model.igmpsnoop.Inst")

    meta.moClassName = "igmpsnoopInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Snooping Instance"
    ...
    meta.childClasses.add("cobra.model.igmpsnoop.Dom")
    meta.childClasses.add("cobra.model.igmpsnoop.InstStats")

    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.InstStats", "inststats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14480, PropCategory.REGULAR)
