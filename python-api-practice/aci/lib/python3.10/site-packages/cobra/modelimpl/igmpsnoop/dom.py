...
class Dom(Mo):
    ...
    meta = ClassMeta("cobra.model.igmpsnoop.Dom")

    meta.moClassName = "igmpsnoopDom"
    meta.rnFormat = "dom-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Snooping Domain"
    ...
    meta.childClasses.add("cobra.model.igmpsnoop.StRtrIf")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.igmpsnoop.RtrIf")
    meta.childClasses.add("cobra.model.igmpsnoop.DomStats")
    meta.childClasses.add("cobra.model.igmpsnoop.QuerierSt")
    meta.childClasses.add("cobra.model.igmpsnoop.Db")
    meta.childClasses.add("cobra.model.igmpsnoop.CktEp")
    meta.childClasses.add("cobra.model.igmpsnoop.QuerierP")

    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.QuerierSt", "querierst"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.StRtrIf", "strtrif-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.DomStats", "domstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.QuerierP", "querierp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.RtrIf", "rtrif-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.CktEp", "cktep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.Db", "db-"))
    ...
    prop = PropMeta("str", "encap", "encap", 2956, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "flags", "flags", 2958, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    prop.defaultValue = "v12r-supr,v3r-supr,eht,llg-supr"
    prop.defaultValueStr = "v12r-supr,v3r-supr,eht,llg-supr"
    prop._addConstant("eht", "end-host-tracking", 4)
    prop._addConstant("llg-supr", "link-local-groups-suppression", 8)
    prop._addConstant("v12r-supr", "v1/v2-report-suppression", 1)
    prop._addConstant("v3r-supr", "v3-report-suppression", 2)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14477, PropCategory.REGULAR)
