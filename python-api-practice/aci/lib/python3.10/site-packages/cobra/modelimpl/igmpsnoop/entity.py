...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.igmpsnoop.Entity")

    meta.moClassName = "igmpsnoopEntity"
    meta.rnFormat = "igmpsnoop"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Snooping Entity"
    ...
    meta.childClasses.add("cobra.model.igmpsnoop.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmpsnoop.Inst", "inst"))

    meta.parentClasses.add("cobra.model.top.System")

    meta.superClasses.add("cobra.model.nw.Conn")
    meta.superClasses.add("cobra.model.ipmcsnoop.Entity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14479, PropCategory.REGULAR)
