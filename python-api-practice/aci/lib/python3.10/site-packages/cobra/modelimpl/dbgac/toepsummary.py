...
# ##################################################
class ToEpSummary(Mo):
    """
    The atomic counter destination endpoint summary.

    """

    meta = ClassMeta("cobra.model.dbgac.ToEpSummary")

    meta.moClassName = "dbgacToEpSummary"
    meta.rnFormat = "dstep-[%(epDn)s]"
    ...
    meta.superClasses.add("cobra.model.dbgac.EpSummary")
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 21208, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "epDn", "epDn", 6123, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "ipAddr", "ipAddr", 4554, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 4555, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
