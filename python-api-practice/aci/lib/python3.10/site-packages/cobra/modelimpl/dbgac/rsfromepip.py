...
class RsFromEpIp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsFromEpIp", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromEpIp"
    meta.rnFormat = "rsfromEpIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Source Ep Relation for Atomic Counter Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38104, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40243, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15841, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15813, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15812, PropCategory.REGULAR)
