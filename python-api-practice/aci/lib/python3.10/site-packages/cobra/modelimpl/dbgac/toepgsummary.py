...
# ##################################################
class ToEpgSummary(Mo):
    """
    The atomic counter destination endpoint group summary.

    """

    meta = ClassMeta("cobra.model.dbgac.ToEpgSummary")

    meta.moClassName = "dbgacToEpgSummary"
    meta.rnFormat = "dstepg-[%(epgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of Destination EPG Mo"
    ...
    meta.superClasses.add("cobra.model.dbgac.EpgSummary")
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 6124, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14592, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 4557, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
