...
# ##################################################
class RsFromLDevForIpToEpg(Mo):
    """
    A source relation to the service device cluster.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsFromLDevForIpToEpg", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromLDevForIpToEpg"
    meta.rnFormat = "rsfromLDevForIpToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Source LDev Relation for Ip to Epg Atomic Counter Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14600, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12897, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12896, PropCategory.REGULAR)
