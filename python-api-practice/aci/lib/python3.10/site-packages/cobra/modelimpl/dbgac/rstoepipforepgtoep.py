...
# ##################################################
class RsToEpIpForEpgToEp(Mo):
    """
    A source relation to the IP address of an endpoint. 

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToEpIpForEpgToEp", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEpIpForEpgToEp"
    meta.rnFormat = "rstoEpIpForEpgToEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination Ep Relation for Epg to Ep Atomic Counter Policy"
    ...
    meta.rnPrefixes = [
        ('rstoEpIpForEpgToEp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40242, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15840, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15809, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15808, PropCategory.REGULAR)
