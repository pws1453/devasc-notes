...
# ##################################################
class RsToEpgForEpgToEpg(Mo):
    """
    A source relation to the set of requirements for an application-level endpoint group instance.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToEpgForEpgToEpg", "cobra.model.fv.AEPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEpgForEpgToEpg"
    meta.rnFormat = "rstoEpgForEpgToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination EPG Relation for Epg to Epg Atomic Counter Policy"
    ...
    meta.rnPrefixes = [
        ('rstoEpgForEpgToEpg-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37764, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39903, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14596, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12886, PropCategory.REGULAR)
