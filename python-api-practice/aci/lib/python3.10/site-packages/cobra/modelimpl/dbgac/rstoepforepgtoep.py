...
# ##################################################
class RsToEpForEpgToEp(Mo):
    """
    A source relation to the client endpoint attaching to the network.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToEpForEpgToEp", "cobra.model.fv.CEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEpForEpgToEp"
    meta.rnFormat = "rstoEpForEpgToEp-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoEpForEpgToEp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37770, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39909, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14604, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12910, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12909, PropCategory.REGULAR)
