...
# ##################################################
class FilterSummary(Mo):
    """
    The filter summary.

    """

    meta = ClassMeta("cobra.model.dbgac.FilterSummary")

    meta.moClassName = "dbgacFilterSummary"
    meta.rnFormat = "filtsumm-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of AC Filter"
    ...
    prop = PropMeta("str", "name", "name", 6118, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
