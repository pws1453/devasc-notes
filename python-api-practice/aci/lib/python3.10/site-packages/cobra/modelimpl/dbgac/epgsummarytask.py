...
# ##################################################
class EpgSummaryTask(Mo):
    """
    The endpoint group summary task.

    """

    meta = ClassMeta("cobra.model.dbgac.EpgSummaryTask")

    meta.moClassName = "dbgacEpgSummaryTask"
    meta.rnFormat = "dbgacEpgSummaryTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5674, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportODACDef", "reportodacdef", 637)
