...
# ##################################################
class FromEpgSummary(Mo):
    """
    From endpoint group summary.

    """

    meta = ClassMeta("cobra.model.dbgac.FromEpgSummary")

    meta.moClassName = "dbgacFromEpgSummary"
    meta.rnFormat = "srcepg-[%(epgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of Source EPG Mo"
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 6120, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14591, PropCategory.REGULAR)
