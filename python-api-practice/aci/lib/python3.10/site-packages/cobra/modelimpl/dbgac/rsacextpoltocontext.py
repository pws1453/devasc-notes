...
# ##################################################
class RsAcExtPolToContext(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsAcExtPolToContext", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgacRsAcExtPolToContext"
    meta.rnFormat = "rsacExtPolToContext"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Context Name"
    ...
    meta.rnPrefixes = [
        ('rsacExtPolToContext', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38408, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40547, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23324, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23321, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23320, PropCategory.REGULAR)
