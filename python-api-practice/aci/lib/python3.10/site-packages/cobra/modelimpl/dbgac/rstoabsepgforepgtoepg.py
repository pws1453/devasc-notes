...
# ##################################################
class RsToAbsEpgForEpgToEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToAbsEpgForEpgToEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToAbsEpgForEpgToEpg"
    meta.rnFormat = "rstoAbsEpgForEpgToEpg-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoAbsEpgForEpgToEpg-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38775, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40914, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35381, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35378, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 35377, PropCategory.REGULAR)
