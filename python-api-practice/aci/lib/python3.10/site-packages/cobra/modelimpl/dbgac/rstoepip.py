...
class RsToEpIp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsToEpIp", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEpIp"
    meta.rnFormat = "rstoEpIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination Ep Relation for Atomic Counter Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40244, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15842, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15817, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15816, PropCategory.REGULAR)
