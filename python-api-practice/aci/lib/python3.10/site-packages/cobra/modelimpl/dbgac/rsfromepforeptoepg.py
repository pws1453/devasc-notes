...
# ##################################################
class RsFromEpForEpToEpg(Mo):
    """
    A source relation to the client endpoint attaching to the network.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsFromEpForEpToEpg", "cobra.model.fv.CEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromEpForEpToEpg"
    meta.rnFormat = "rsfromEpForEpToEpg-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsfromEpForEpToEpg-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37768, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39907, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14602, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12901, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12900, PropCategory.REGULAR)
