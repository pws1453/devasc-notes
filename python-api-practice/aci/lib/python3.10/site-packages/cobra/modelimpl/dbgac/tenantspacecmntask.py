...
# ##################################################
class TenantSpaceCmnTask(Mo):
    """
    The tenant space common task.

    """

    meta = ClassMeta("cobra.model.dbgac.TenantSpaceCmnTask")

    meta.moClassName = "dbgacTenantSpaceCmnTask"
    meta.rnFormat = "dbgacTenantSpaceCmnTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15628, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AcSendDbgProfile", "acsenddbgprofile", 1306)
