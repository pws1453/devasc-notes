...
class RsToEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsToEpg", "cobra.model.fv.AEPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEpg"
    meta.rnFormat = "rstoEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination EPG Relation for Atomic Counter Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37762, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39901, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14594, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12881, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12880, PropCategory.REGULAR)
