...
class IpToIp(Mo):
    ...
    meta = ClassMeta("cobra.model.dbgac.IpToIp")

    meta.moClassName = "dbgacIpToIp"
    meta.rnFormat = "acIpToIp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ext IP Address to Ext IP Address Atomic Counter Policy"
    ...
    meta.childClasses.add("cobra.model.dbgac.RsContext")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgac.RsContext", "rscontext"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38394, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstIp", "dstIp", 23086, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40533, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23109, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 23095, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 23085, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
