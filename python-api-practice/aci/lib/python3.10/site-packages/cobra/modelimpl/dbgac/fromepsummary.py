...
class FromEpSummary(Mo):
    """
    From endpoint summary.

    """

    meta = ClassMeta("cobra.model.dbgac.FromEpSummary")

    meta.moClassName = "dbgacFromEpSummary"
    ...
    prop = PropMeta("str", "epDn", "epDn", 6119, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
