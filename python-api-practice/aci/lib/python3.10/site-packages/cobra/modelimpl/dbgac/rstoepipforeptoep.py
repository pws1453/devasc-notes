...
# ##################################################
class RsToEpIpForEpToEp(Mo):
    """
    A source relation to the IP address of an endpoint.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToEpIpForEpToEp", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEpIpForEpToEp"
    meta.rnFormat = "rstoEpIpForEpToEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination Ep Relation for End-Point to End-Point Atomic Counter Policy"
    ...
    meta.rnPrefixes = [
        ('rstoEpIpForEpToEp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38106, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40245, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15843, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15821, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15820, PropCategory.REGULAR)
