...
class RsToEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsToEp", "cobra.model.fv.CEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEp"
    meta.rnFormat = "rstoEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37772, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39911, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14606, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12928, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12927, PropCategory.REGULAR)
