...
class RsToAbsEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsToAbsEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToAbsEpg"
    meta.rnFormat = "rstoAbsEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination L3Out EPG Relation for Atomic Counter Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38222, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40361, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18652, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18639, PropCategory.REGULAR)
