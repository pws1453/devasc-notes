...
# ##################################################
class RsFromLDevForExtToEp(Mo):
    """
    A source relation to the service device cluster.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsFromLDevForExtToEp", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromLDevForExtToEp"
    meta.rnFormat = "rsfromLDevForExtToEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Source LDev Relation for Ext. IP to End-Point Address Atomic Counter Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14614, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12948, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4872
    prop.defaultValueStr = "vnsALDev"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12947, PropCategory.REGULAR)
