...
# ##################################################
class RsToLDevForEpgToIp(Mo):
    """
    A source relation to the service device cluster.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToLDevForEpgToIp", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToLDevForEpgToIp"
    meta.rnFormat = "rstoLDevForEpgToIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination LDev Relation for Epg to Ip Atomic Counter Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14598, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12893, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12892, PropCategory.REGULAR)
