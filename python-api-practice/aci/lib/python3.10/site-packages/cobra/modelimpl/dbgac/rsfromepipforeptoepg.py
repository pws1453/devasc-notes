...
# ##################################################
class RsFromEpIpForEpToEpg(Mo):
    """
    A source relation to the IP address of an endpoint.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsFromEpIpForEpToEpg", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromEpIpForEpToEpg"
    meta.rnFormat = "rsfromEpIpForEpToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Source Ep Relation for Ep to Epg Atomic Counter Policy"
    ...
    meta.rnPrefixes = [
        ('rsfromEpIpForEpToEpg-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38102, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40241, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15839, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15804, PropCategory.REGULAR)
