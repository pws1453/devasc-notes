...
# ##################################################
class RsFromAbsEpg(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsFromAbsEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromAbsEpg"
    meta.rnFormat = "rsfromAbsEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Source L3Out EPG Relation for Atomic Counter Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38221, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40360, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18651, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18636, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18635, PropCategory.REGULAR)
