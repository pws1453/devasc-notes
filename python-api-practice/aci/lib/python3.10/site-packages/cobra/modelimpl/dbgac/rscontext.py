...
class RsContext(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsContext", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgacRsContext"
    meta.rnFormat = "rscontext"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40534, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23110, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23104, PropCategory.REGULAR)
