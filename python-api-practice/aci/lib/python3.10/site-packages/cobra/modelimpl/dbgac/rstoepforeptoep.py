...
# ##################################################
class RsToEpForEpToEp(Mo):
    """
    A source relation to the client endpoint attaching to the network.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToEpForEpToEp", "cobra.model.fv.CEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEpForEpToEp"
    meta.rnFormat = "rstoEpForEpToEp-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoEpForEpToEp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37776, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39915, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14610, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12936, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12935, PropCategory.REGULAR)
