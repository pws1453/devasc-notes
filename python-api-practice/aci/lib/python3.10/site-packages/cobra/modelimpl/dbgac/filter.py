...
class Filter(Mo):
    ...
    meta = ClassMeta("cobra.model.dbgac.Filter")

    meta.moClassName = "dbgacFilter"
    meta.rnFormat = "filt-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counter Filter"
    ...
    meta.superClasses.add("cobra.model.dbgac.AFilter")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37760, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstPort", "dstPort", 4560, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39899, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 6117, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prot", "prot", 4558, PropCategory.REGULAR)
    prop.label = "Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    ...
    prop = PropMeta("str", "srcPort", "srcPort", 4559, PropCategory.REGULAR)
