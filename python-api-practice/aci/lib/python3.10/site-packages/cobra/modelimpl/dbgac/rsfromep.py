...
class RsFromEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsFromEp", "cobra.model.fv.CEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromEp"
    meta.rnFormat = "rsfromEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37771, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39910, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14605, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12919, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12918, PropCategory.REGULAR)
