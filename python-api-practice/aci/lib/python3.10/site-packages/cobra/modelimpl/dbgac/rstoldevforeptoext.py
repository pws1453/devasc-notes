...
# ##################################################
class RsToLDevForEpToExt(Mo):
    """
    A source relation to the service device cluster.

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToLDevForEpToExt", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToLDevForEpToExt"
    meta.rnFormat = "rstoLDevForEpToExt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination LDev Relation for End-Point to Ext. IP Address Atomic Counter Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12944, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12943, PropCategory.REGULAR)
