...
class ProvLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.vsvc.ProvLbl")

    meta.moClassName = "vsvcProvLbl"
    meta.rnFormat = "prov-%(type)s-%(name)s"
    ...
    meta.superClasses.add("cobra.model.vsvc.AProvLbl")
    meta.superClasses.add("cobra.model.pol.ConsElem")
    meta.superClasses.add("cobra.model.pol.ProvLbl")
    ...
    prop = PropMeta("str", "name", "name", 7400, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 907, PropCategory.REGULAR)
