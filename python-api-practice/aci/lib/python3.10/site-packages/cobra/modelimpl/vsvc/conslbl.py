...
class ConsLbl(Mo):
    """
    A service consumer label.

    """

    meta = ClassMeta("cobra.model.vsvc.ConsLbl")

    meta.moClassName = "vsvcConsLbl"
    meta.rnFormat = "cons-%(type)s-%(name)s"
    ...
    meta.superClasses.add("cobra.model.vsvc.AConsLbl")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.pol.ConsLbl")
    ...
    prop = PropMeta("str", "name", "name", 7399, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 908, PropCategory.REGULAR)
    prop.label = "Service Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    def __init__(self, parentMoOrDn, type, name, markDirty=True, **creationProps):
        namingVals = [type, name]
