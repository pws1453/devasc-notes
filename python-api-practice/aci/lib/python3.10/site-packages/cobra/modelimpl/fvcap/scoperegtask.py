...
# ##################################################
class ScopeRegTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fvcap.ScopeRegTask")

    meta.moClassName = "fvcapScopeRegTask"
    meta.rnFormat = "fvcapScopeRegTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21358, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateScopeLimits", "updatescopelimits", 1870)
