...
# ##################################################
class RsPluginToVipP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ap.RsPluginToVipP", "cobra.model.telemetry.VipP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "apRsPluginToVipP"
    meta.rnFormat = "rsPluginToVipP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VipP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 35737, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11368
    prop.defaultValueStr = "telemetryVipP"
    prop._addConstant("telemetryVipP", None, 11368)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35736, PropCategory.REGULAR)
