...
# ##################################################
class RsClusterPolicy(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.ap.RsClusterPolicy", "cobra.model.infra.ClusterPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "apRsClusterPolicy"
    meta.rnFormat = "rsClusterPolicy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28238, PropCategory.REGULAR)
