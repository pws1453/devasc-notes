...
# ##################################################
class RsPluginToFabricSelfCAEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ap.RsPluginToFabricSelfCAEp", "cobra.model.pki.FabricSelfCAEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "apRsPluginToFabricSelfCAEp"
    meta.rnFormat = "rsPluginToFabricSelfCAEp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to FabricSelfCAEp"
    ...
    meta.rnPrefixes = [
        ('rsPluginToFabricSelfCAEp', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 55672, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55671, PropCategory.REGULAR)
