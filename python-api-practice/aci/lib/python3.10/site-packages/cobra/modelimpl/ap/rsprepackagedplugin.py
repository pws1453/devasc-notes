...
# ##################################################
class RsPrepackagedPlugin(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ap.RsPrepackagedPlugin", "cobra.model.firmware.Firmware")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "apRsPrepackagedPlugin"
    meta.rnFormat = "rsprepackagedPlugin-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Def MO to each pre-packaged app"
    ...
    meta.rnPrefixes = [
        ('rsprepackagedPlugin-', True),
    ]

    prop = PropMeta("str", "appCtxRoot", "appCtxRoot", 59185, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 59187, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 59186, PropCategory.REGULAR)
