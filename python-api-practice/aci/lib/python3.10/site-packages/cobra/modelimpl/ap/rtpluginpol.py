...
# ##################################################
class RtPluginPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.ap.RtPluginPol", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "apRtPluginPol"
    meta.rnFormat = "rtpolPluginPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 30175, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30174, PropCategory.REGULAR)
