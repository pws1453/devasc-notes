...
# ##################################################
class RsPrepackagedClusterPolicy(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ap.RsPrepackagedClusterPolicy", "cobra.model.infra.ClusterPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "apRsPrepackagedClusterPolicy"
    meta.rnFormat = "rsPrepackagedClusterPolicy"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to ClusterPol"
    ...
    meta.rnPrefixes = [
        ('rsPrepackagedClusterPolicy', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 60807, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 60806, PropCategory.REGULAR)
