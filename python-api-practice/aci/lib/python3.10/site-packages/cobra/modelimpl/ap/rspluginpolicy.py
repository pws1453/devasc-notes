...
# ##################################################
class RsPluginPolicy(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ap.RsPluginPolicy", "cobra.model.ap.PluginPolicy")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "apRsPluginPolicy"
    meta.rnFormat = "rsPluginPolicy"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to PluginPolicy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54624, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16088
    prop.defaultValueStr = "apPluginPolicy"
    prop._addConstant("apPluginPolicy", None, 16088)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54623, PropCategory.REGULAR)
