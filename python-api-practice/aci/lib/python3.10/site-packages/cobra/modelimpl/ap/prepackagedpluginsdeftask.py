...
# ##################################################
class PrepackagedPluginsDefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ap.PrepackagedPluginsDefTask")

    meta.moClassName = "apPrepackagedPluginsDefTask"
    meta.rnFormat = "apPrepackagedPluginsDefTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('apPrepackagedPluginsDefTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 59184, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("installPrepackagedPlugins", "installprepackagedplugins", 3861)
    prop._addConstant("none", "none", 0)
    prop._addConstant("removePrepackagedFirmwares", "removeprepackagedfirmwares", 3863)
    prop._addConstant("removePrepackagedPlugins", "removeprepackagedplugins", 3862)
