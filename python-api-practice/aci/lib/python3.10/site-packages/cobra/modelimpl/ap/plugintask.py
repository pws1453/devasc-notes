...
class PluginTask(Mo):
    ...
    meta = ClassMeta("cobra.model.ap.PluginTask")

    meta.moClassName = "apPluginTask"
    meta.rnFormat = "apPluginTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 28494, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("appWebtoken", "appwebtoken", 2587)
    prop._addConstant("dockerImageRef", "dockerimageref", 2607)
    prop._addConstant("genCertsCompleted", "gencertscompleted", 3666)
    prop._addConstant("generateCerts", "generatecerts", 3665)
    prop._addConstant("none", "none", 0)
    prop._addConstant("pluginCertUpdate", "plugincertupdate", 3945)
    prop._addConstant("pluginInstallation", "plugininstallation", 3823)
    prop._addConstant("pluginUpgrade", "pluginupgrade", 3824)
    prop._addConstant("preGenCerts", "pregencerts", 3664)
    prop._addConstant("preRemovePlugin", "preremoveplugin", 3943)
    prop._addConstant("removeAppliance", "removeappliance", 3590)
    prop._addConstant("removePlugin", "removeplugin", 3713)
