...
# ##################################################
class RsPrepackagedPluginsDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ap.RsPrepackagedPluginsDef", "cobra.model.ap.PrepackagedPlugins")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "apRsPrepackagedPluginsDef"
    meta.rnFormat = "rsprepackagedPluginsDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Def MO to apPrepackagedPlugins"
    ...
    prop = PropMeta("str", "tCl", "tCl", 59190, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16779
    prop.defaultValueStr = "apPrepackagedPlugins"
    prop._addConstant("apPrepackagedPlugins", None, 16779)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 59189, PropCategory.REGULAR)
