...
class Catalog(Mo):
    ...
    meta = ClassMeta("cobra.model.configprofile.Catalog")

    meta.moClassName = "configprofileCatalog"
    meta.rnFormat = "configProfile"
    meta.category = MoCategory.REGULAR
    meta.label = "Config Profile Catalog"
    ...
    meta.childClasses.add("cobra.model.configprofile.Entity")

    meta.childNamesAndRnPrefix.append(("cobra.model.configprofile.Entity", "cfgent-"))
