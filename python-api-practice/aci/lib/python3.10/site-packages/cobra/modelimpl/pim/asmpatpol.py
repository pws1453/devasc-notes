...
class ASMPatPol(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.ASMPatPol")

    meta.moClassName = "pimASMPatPol"
    meta.rnFormat = "asmpat"
    meta.category = MoCategory.REGULAR
    meta.label = "Any Source Multicast Pattern Policy"
    ...
    meta.childClasses.add("cobra.model.pim.SharedRangePol")
    meta.childClasses.add("cobra.model.pim.SGRangeExpPol")
    meta.childClasses.add("cobra.model.pim.RegTrPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.SharedRangePol", "sharedrange"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.SGRangeExpPol", "sgrangeexp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.RegTrPol", "regtr"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.pim.CtxP")
    meta.parentClasses.add("cobra.model.pim.IPV6CtxP")

    meta.superClasses.add("cobra.model.rtdmc.APatPol")
    meta.superClasses.add("cobra.model.rtdmc.AASMPatPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38462, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 24907, PropCategory.REGULAR)
    prop.label = "Control knobs"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("pre-build-spt", "pre-build-spt", 1)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40601, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25251, PropCategory.REGULAR)
