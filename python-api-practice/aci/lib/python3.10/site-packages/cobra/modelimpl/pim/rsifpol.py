...
class RsIfPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pim.RsIfPol", "cobra.model.pim.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pimRsIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38447, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40586, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25012, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 24988, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25811, PropCategory.REGULAR)
