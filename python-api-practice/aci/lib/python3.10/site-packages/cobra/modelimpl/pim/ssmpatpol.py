...
class SSMPatPol(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.SSMPatPol")

    meta.moClassName = "pimSSMPatPol"
    meta.rnFormat = "ssmpat"
    meta.category = MoCategory.REGULAR
    meta.label = "Source Specific Multicast Pattern Policy"
    ...
    meta.childClasses.add("cobra.model.pim.SSMRangePol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.SSMRangePol", "ssmrange"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.ASSMPatPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38465, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40604, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25257, PropCategory.REGULAR)
