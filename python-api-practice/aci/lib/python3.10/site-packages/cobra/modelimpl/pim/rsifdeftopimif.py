...
# ##################################################
class RsIfDefToPimIf(Mo):
    """
    Relationship to the PIM interfaces

    """

    meta = SourceRelationMeta("cobra.model.pim.RsIfDefToPimIf", "cobra.model.pim.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pimRsIfDefToPimIf"
    meta.rnFormat = "rsIfDefToPimIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24992, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8409
    prop.defaultValueStr = "pimIf"
    prop._addConstant("pimIf", None, 8409)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24991, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 25019, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
