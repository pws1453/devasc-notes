...
class RsRP2Grange(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pim.RsRP2Grange", "cobra.model.pim.RPGrange")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "pimRsRP2Grange"
    ...
    meta.parentClasses.add("cobra.model.pim.RPInfo")
    ...
    prop = PropMeta("str", "tCl", "tCl", 26437, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8405
    prop.defaultValueStr = "pimRPGrange"
    prop._addConstant("pimRPGrange", None, 8405)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26436, PropCategory.REGULAR)
