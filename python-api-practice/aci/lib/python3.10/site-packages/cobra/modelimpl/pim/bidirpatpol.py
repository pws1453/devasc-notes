...
# ##################################################
class BidirPatPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.BidirPatPol")

    meta.moClassName = "pimBidirPatPol"
    meta.rnFormat = "bidirpat"
    meta.category = MoCategory.REGULAR
    meta.label = "Bidirectional Multicast Pattern Policy"
