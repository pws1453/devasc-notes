...
# ##################################################
class FabricRPPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.FabricRPPol")

    meta.moClassName = "pimFabricRPPol"
    meta.rnFormat = "fabricrp"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric RP PIM Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43468, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43469, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43466, PropCategory.REGULAR)
