...
# ##################################################
class RPGrpRangeDef(Mo):
    """
    Specifies if RP multicast group range definition.

    """

    meta = ClassMeta("cobra.model.pim.RPGrpRangeDef")

    meta.moClassName = "pimRPGrpRangeDef"
    meta.rnFormat = "rpgrprangedef"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM RP Group Range Policy Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25246, PropCategory.REGULAR)
