...
# ##################################################
class RPGrpRangePol(Mo):
    """
    Specifies if RP multicast group range policy.

    """

    meta = ClassMeta("cobra.model.pim.RPGrpRangePol")

    meta.moClassName = "pimRPGrpRangePol"
    meta.rnFormat = "rpgrprange"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM RP Group Range Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.ARPGrpRangePol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38459, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40598, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25245, PropCategory.REGULAR)
