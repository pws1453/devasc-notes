...
# ##################################################
class SSMRangePol(Mo):
    """
    Source-specific group range policy

    """

    meta = ClassMeta("cobra.model.pim.SSMRangePol")

    meta.moClassName = "pimSSMRangePol"
    meta.rnFormat = "ssmrange"
    meta.category = MoCategory.REGULAR
    meta.label = "SSM group range Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.ASSMRangePol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38466, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40605, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25259, PropCategory.REGULAR)
