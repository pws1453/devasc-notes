...
# ##################################################
class StaticRPPol(Mo):
    """
    Static RP PIM policy

    """

    meta = ClassMeta("cobra.model.pim.StaticRPPol")

    meta.moClassName = "pimStaticRPPol"
    meta.rnFormat = "staticrp"
    meta.category = MoCategory.REGULAR
    meta.label = "Static RP PIM Policy"
    ...
    meta.childClasses.add("cobra.model.pim.StaticRPEntryPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.StaticRPEntryPol", "staticrpent-"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.AStaticRPPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38455, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40594, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25235, PropCategory.REGULAR)
