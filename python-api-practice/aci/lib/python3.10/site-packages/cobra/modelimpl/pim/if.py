...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.If")

    meta.moClassName = "pimIf"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Interface"
    ...
    meta.childClasses.add("cobra.model.pim.AdjEp")
    meta.childClasses.add("cobra.model.pim.HelloTrP")
    meta.childClasses.add("cobra.model.pim.IfStats")
    meta.childClasses.add("cobra.model.pim.Db")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")
    meta.childClasses.add("cobra.model.pim.RtIfDefToPimIf")
    meta.childClasses.add("cobra.model.pim.TrafficStats")
    meta.childClasses.add("cobra.model.pim.JPTrP")

    meta.childNamesAndRnPrefix.append(("cobra.model.pim.RtIfDefToPimIf", "rtifDefToPimIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.IfStats", "ifstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.TrafficStats", "trstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.HelloTrP", "hello"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.AdjEp", "adj-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.Db", "db-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.JPTrP", "jp"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.AIf")
    ...
    prop = PropMeta("str", "id", "id", 24775, PropCategory.REGULAR)
