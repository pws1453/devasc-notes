...
# ##################################################
class MAFilterDef(Mo):
    """
    PIM MA filter definition.

    """

    meta = ClassMeta("cobra.model.pim.MAFilterDef")

    meta.moClassName = "pimMAFilterDef"
    meta.rnFormat = "mafltdef"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM MA Filter Policy Definition"
    ...
    meta.superClasses.add("cobra.model.rtdmc.AMAFilter")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25240, PropCategory.REGULAR)
