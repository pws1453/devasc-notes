...
class RPInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.RPInfo")

    meta.moClassName = "pimRPInfo"
    ...
    meta.childClasses.add("cobra.model.pim.RsRP2Grange")

    meta.childNamesAndRnPrefix.append(("cobra.model.pim.RsRP2Grange", "rsRP2Grange-"))
    ...
    prop = PropMeta("str", "addr", "addr", 24780, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bsrAddr", "bsrAddr", 52097, PropCategory.REGULAR)
