...
class Entity(Mo):
    """
    PIM control plane entity information.

    """

    meta = ClassMeta("cobra.model.pim.Entity")

    meta.moClassName = "pimEntity"
    meta.rnFormat = "pim"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Entity"
    ...
    meta.childClasses.add("cobra.model.pim.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.Inst", "inst"))

    meta.parentClasses.add("cobra.model.top.System")

    meta.superClasses.add("cobra.model.nw.Conn")
    meta.superClasses.add("cobra.model.nw.CpEntity")
    meta.superClasses.add("cobra.model.rtdmc.AEntity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26404, PropCategory.REGULAR)
