...
class RegTrDef(Mo):
    """
    PIM register traffic policy definition

    """

    meta = ClassMeta("cobra.model.pim.RegTrDef")

    meta.moClassName = "pimRegTrDef"
    meta.rnFormat = "regtrdef"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Register Traffic Policy Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25248, PropCategory.REGULAR)
