...
# ##################################################
class RsIfDefToPim6If(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pim.RsIfDefToPim6If", "cobra.model.pim6.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pimRsIfDefToPim6If"
    meta.rnFormat = "rsIfDefToPim6If"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "PIM6 Interface"
    ...
    prop = PropMeta("str", "tCl", "tCl", 47430, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13644
    prop.defaultValueStr = "pim6If"
    prop._addConstant("pim6If", None, 13644)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 47429, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 47448, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
