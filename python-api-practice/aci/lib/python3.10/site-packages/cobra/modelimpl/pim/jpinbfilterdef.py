...
# ##################################################
class JPInbFilterDef(Mo):
    """
    Interface-level inbound join/prune filter definition.

    """

    meta = ClassMeta("cobra.model.pim.JPInbFilterDef")

    meta.moClassName = "pimJPInbFilterDef"
    meta.rnFormat = "jpinbfilterdef"
    meta.category = MoCategory.REGULAR
    meta.label = "JP Inbound Filter Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25262, PropCategory.REGULAR)
