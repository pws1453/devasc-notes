...
# ##################################################
class RtMldsnoopAccessGroupFilterRMap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.pim.RtMldsnoopAccessGroupFilterRMap", "cobra.model.mld.SnoopAccessGroup")

    meta.moClassName = "pimRtMldsnoopAccessGroupFilterRMap"
    meta.rnFormat = "rtmldMldsnoopAccessGroupFilterRMap-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtmldMldsnoopAccessGroupFilterRMap-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 53264, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15602
    prop.defaultValueStr = "mldSnoopAccessGroup"
    prop._addConstant("mldSnoopAccessGroup", None, 15602)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 53263, PropCategory.REGULAR)
