...
# ##################################################
class BSRFilterDef(Mo):
    """
    The PIM Bootstrap Router (BSR) filter definition.

    """

    meta = ClassMeta("cobra.model.pim.BSRFilterDef")

    meta.moClassName = "pimBSRFilterDef"
    meta.rnFormat = "bsfltdef"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM BS Filter Policy Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25242, PropCategory.REGULAR)
