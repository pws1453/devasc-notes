...
class AutoRPPol(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.AutoRPPol")

    meta.moClassName = "pimAutoRPPol"
    meta.rnFormat = "autorp"
    meta.category = MoCategory.REGULAR
    meta.label = "Auto RP PIM Policy"
    ...
    meta.childClasses.add("cobra.model.pim.MAFilterPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.MAFilterPol", "mafilter"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.ARPPol")
    meta.superClasses.add("cobra.model.rtdmc.AAutoRPPol")

    meta.rnPrefixes = [
        ('autorp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38453, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 24897, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40592, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25231, PropCategory.REGULAR)
