...
class RsV6IfPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pim.RsV6IfPol", "cobra.model.pim.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pimRsV6IfPol"
    meta.rnFormat = "rsV6IfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 47667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47668, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 47660, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8508
    prop.defaultValueStr = "pimIfPol"
    prop._addConstant("pimIfPol", None, 8508)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 47659, PropCategory.REGULAR)
