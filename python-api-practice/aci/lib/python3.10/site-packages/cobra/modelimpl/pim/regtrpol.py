...
class RegTrPol(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.RegTrPol")

    meta.moClassName = "pimRegTrPol"
    meta.rnFormat = "regtr"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Register Traffic Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.ARegTrPol")

    meta.rnPrefixes = [
        ('regtr', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38460, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40599, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "maxRate", "maxRate", 24904, PropCategory.REGULAR)
    prop.label = "Max Rate"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25247, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 25213, PropCategory.REGULAR)
