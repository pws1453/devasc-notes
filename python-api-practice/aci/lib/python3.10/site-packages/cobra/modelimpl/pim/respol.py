...
class ResPol(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.ResPol")

    meta.moClassName = "pimResPol"
    meta.rnFormat = "res"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Resource Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.AResPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38461, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40600, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "max", "max", 24905, PropCategory.REGULAR)
    prop.label = "Max Entries"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25249, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rsvd", "rsvd", 24906, PropCategory.REGULAR)
