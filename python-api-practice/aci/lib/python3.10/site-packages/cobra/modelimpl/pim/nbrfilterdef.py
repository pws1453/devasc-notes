...
# ##################################################
class NbrFilterDef(Mo):
    """
    Interface-level neighbor filter definition.

    """

    meta = ClassMeta("cobra.model.pim.NbrFilterDef")

    meta.moClassName = "pimNbrFilterDef"
    meta.rnFormat = "nbrfilterdef"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25264, PropCategory.REGULAR)
