...
class BSRPPol(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.BSRPPol")

    meta.moClassName = "pimBSRPPol"
    meta.rnFormat = "bsrp"
    meta.category = MoCategory.REGULAR
    meta.label = "Bootstrap RP PIM Policy"
    ...
    meta.childClasses.add("cobra.model.pim.BSRFilterPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.BSRFilterPol", "bsfilter"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.ABSRPPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38454, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 24899, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40593, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25233, PropCategory.REGULAR)
