...
# ##################################################
class RouteMapEntry(Mo):
    """
    PIM route map entry

    """

    meta = ClassMeta("cobra.model.pim.RouteMapEntry")

    meta.moClassName = "pimRouteMapEntry"
    meta.rnFormat = "rtmapentry-%(order)s"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Route Map Entry"
    ...
    meta.superClasses.add("cobra.model.rtdmc.ARtMapEntry")

    meta.rnPrefixes = [
        ('rtmapentry-', True),
    ]

    prop = PropMeta("str", "action", "action", 25211, PropCategory.REGULAR)
    prop.label = "Action"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "annotation", "annotation", 38469, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40608, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "grp", "grp", 25210, PropCategory.REGULAR)
    prop.label = "Destination Filter"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "order", "order", 25217, PropCategory.REGULAR)
    prop.label = "Order"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "rp", "rp", 25891, PropCategory.REGULAR)
    prop.label = "RP IP address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("rp", prop)

    prop = PropMeta("str", "src", "src", 25209, PropCategory.REGULAR)
    prop.label = "Source Filter"
    prop.isConfig = True
    prop.isAdmin = True
