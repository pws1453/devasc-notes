...
# ##################################################
class InterVRFPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.InterVRFPol")

    meta.moClassName = "pimInterVRFPol"
    meta.rnFormat = "intervrf"
    meta.category = MoCategory.REGULAR
    meta.label = "Inter Vrf PIM Policy"
    ...
    meta.childClasses.add("cobra.model.pim.InterVRFEntryPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.InterVRFEntryPol", "intervrfent-"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.AInterVRFPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 42752, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42753, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42746, PropCategory.REGULAR)
