...
class Route(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.Route")

    meta.moClassName = "pimRoute"
    meta.rnFormat = "src-[%(src)s]-grp-[%(grp)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Route"
    ...
    meta.childClasses.add("cobra.model.pim.Oif")

    meta.childNamesAndRnPrefix.append(("cobra.model.pim.Oif", "oif-"))
    ...
    prop = PropMeta("str", "grp", "grp", 24781, PropCategory.REGULAR)
    prop.label = "Group"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "rpAddrRoute", "rpAddrRoute", 52172, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 24782, PropCategory.REGULAR)
    prop.label = "Source"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
