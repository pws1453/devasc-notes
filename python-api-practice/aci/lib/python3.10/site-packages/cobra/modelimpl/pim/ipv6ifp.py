...
class IPV6IfP(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.IPV6IfP")

    meta.moClassName = "pimIPV6IfP"
    meta.rnFormat = "pimipv6ifp"
    ...
    meta.childClasses.add("cobra.model.pim.RsV6IfPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.RsV6IfPol", "rsV6IfPol"))
    ...
    meta.superClasses.add("cobra.model.pim.AIfP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 47440, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47441, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mcastAllow", "mcastAllow", 25214, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47437, PropCategory.REGULAR)
