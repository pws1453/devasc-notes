...
# ##################################################
class JPOutbFilterDef(Mo):
    """
    Interface-level outbound join/prune filter definition.

    """

    meta = ClassMeta("cobra.model.pim.JPOutbFilterDef")

    meta.moClassName = "pimJPOutbFilterDef"
    meta.rnFormat = "jpoutbfilterdef"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25263, PropCategory.REGULAR)
