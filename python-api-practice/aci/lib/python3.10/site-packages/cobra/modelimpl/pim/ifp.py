...
class IfP(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.IfP")

    meta.moClassName = "pimIfP"
    meta.rnFormat = "pimifp"
    ...
    meta.childClasses.add("cobra.model.pim.RsIfPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.RsIfPol", "rsIfPol"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38446, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40585, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25011, PropCategory.REGULAR)
