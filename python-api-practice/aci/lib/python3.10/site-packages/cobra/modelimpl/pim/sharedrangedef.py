...
# ##################################################
class SharedRangeDef(Mo):
    """
    Shared tree definition

    """

    meta = ClassMeta("cobra.model.pim.SharedRangeDef")

    meta.moClassName = "pimSharedRangeDef"
    meta.rnFormat = "sharedrangedef"
    meta.category = MoCategory.REGULAR
    meta.label = "Shared tree Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25256, PropCategory.REGULAR)
