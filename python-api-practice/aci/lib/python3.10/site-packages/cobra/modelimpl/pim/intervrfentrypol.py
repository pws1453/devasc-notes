...
# ##################################################
class InterVRFEntryPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.InterVRFEntryPol")

    meta.moClassName = "pimInterVRFEntryPol"
    meta.rnFormat = "intervrfent-[%(srcVrfDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Inter VRF Entry Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.AInterVRFEntry")
    ...
    prop = PropMeta("str", "annotation", "annotation", 42754, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 42734, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42755, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42748, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcVrfDn", "srcVrfDn", 44623, PropCategory.REGULAR)
    prop.label = "DN of the src Vrf"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("srcVrfDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "srcVrfDn"))
    getattr(meta.props, "srcVrfDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, srcVrfDn, markDirty=True, **creationProps):
        namingVals = [srcVrfDn]
