...
# ##################################################
class SharedRangePol(Mo):
    """
    Shared tree group range policy

    """

    meta = ClassMeta("cobra.model.pim.SharedRangePol")

    meta.moClassName = "pimSharedRangePol"
    meta.rnFormat = "sharedrange"
    meta.category = MoCategory.REGULAR
    meta.label = "Shared tree Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.ASharedRangePol")

    meta.rnPrefixes = [
        ('sharedrange', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38464, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40603, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25255, PropCategory.REGULAR)
