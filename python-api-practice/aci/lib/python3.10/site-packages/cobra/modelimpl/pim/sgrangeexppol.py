...
# ##################################################
class SGRangeExpPol(Mo):
    """
    The (S,G) range expiry policy.

    """

    meta = ClassMeta("cobra.model.pim.SGRangeExpPol")

    meta.moClassName = "pimSGRangeExpPol"
    meta.rnFormat = "sgrangeexp"
    meta.category = MoCategory.REGULAR
    meta.label = "(S,G) expiry Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.ASGRangeExpPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38463, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40602, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25253, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sgExpItvl", "sgExpItvl", 24908, PropCategory.REGULAR)
    prop.label = "Expity interval"
    prop.isConfig = True
    prop.isAdmin = True
