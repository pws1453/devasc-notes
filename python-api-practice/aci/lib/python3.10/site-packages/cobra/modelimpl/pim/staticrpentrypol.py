...
# ##################################################
class StaticRPEntryPol(Mo):
    """
    Static RP entry policy

    """

    meta = ClassMeta("cobra.model.pim.StaticRPEntryPol")

    meta.moClassName = "pimStaticRPEntryPol"
    meta.rnFormat = "staticrpent-[%(rpIp)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Static RP Entry Policy"
    ...
    meta.childClasses.add("cobra.model.pim.RPGrpRangePol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.RPGrpRangePol", "rpgrprange"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.AStaticRPEntry")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38456, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 26139, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ok"
    prop._addConstant("missing-rp-group-range", "missing-rp-group-range-configuration.", 1)
    prop._addConstant("ok", "ok", 0)
    prop._addConstant("pim-not-supported-on-ext-svi", "pim-is-not-supported-on-external-svi-interfaces", 4)
    prop._addConstant("src-only-route-map-allowed", "source-only-route-map-configuration-allowed.", 2)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40595, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25237, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rpIp", "rpIp", 24986, PropCategory.REGULAR)
    prop.label = "Static RP address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("rpIp", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "rpIp"))
    getattr(meta.props, "rpIp").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, rpIp, markDirty=True, **creationProps):
        namingVals = [rpIp]
