...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.Inst")

    meta.moClassName = "pimInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM Instance"
    ...
    meta.childClasses.add("cobra.model.pim.Overload")
    meta.childClasses.add("cobra.model.pim.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.pim.Overload", "overload"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26405, PropCategory.REGULAR)
