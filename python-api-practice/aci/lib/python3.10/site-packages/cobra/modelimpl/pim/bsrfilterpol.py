...
# ##################################################
class BSRFilterPol(Mo):
    """
    The PIM Bootstrap Router (BSR) filter policy.

    """

    meta = ClassMeta("cobra.model.pim.BSRFilterPol")

    meta.moClassName = "pimBSRFilterPol"
    meta.rnFormat = "bsfilter"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM BS Filter Policy"
    ...
    meta.superClasses.add("cobra.model.rtdmc.ABSRFilter")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 26254, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40597, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25241, PropCategory.REGULAR)
