...
# ##################################################
class SSMRangeDef(Mo):
    """
    Source-specific group range definition

    """

    meta = ClassMeta("cobra.model.pim.SSMRangeDef")

    meta.moClassName = "pimSSMRangeDef"
    meta.rnFormat = "ssmrangedef"
    meta.category = MoCategory.REGULAR
    meta.label = "SSM group range Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25260, PropCategory.REGULAR)
