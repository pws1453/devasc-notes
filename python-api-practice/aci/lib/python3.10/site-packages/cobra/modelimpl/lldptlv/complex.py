...
class Complex(Mo):
    """
    A complex type, length, value (TLV).

    """

    meta = ClassMeta("cobra.model.lldptlv.Complex")

    meta.moClassName = "lldptlvComplex"
    ...
    prop = PropMeta("str", "code", "code", 6879, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "id", "id", 6880, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
