...
# ##################################################
class ListenerRuleOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ListenerRuleOper")

    meta.moClassName = "hcloudListenerRuleOper"
    meta.rnFormat = "listenruleoper"
