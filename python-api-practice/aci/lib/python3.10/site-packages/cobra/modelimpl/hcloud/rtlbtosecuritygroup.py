...
# ##################################################
class RtLBToSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtLBToSecurityGroup", "cobra.model.hcloud.NativeLB")

    meta.moClassName = "hcloudRtLBToSecurityGroup"
    meta.rnFormat = "rtlBToSecurityGroup"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51938, PropCategory.REGULAR)
