...
# ##################################################
class RtToProvAcct(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtToProvAcct", "cobra.model.hcloud.Account")

    meta.moClassName = "hcloudRtToProvAcct"
    meta.rnFormat = "rttoProvAcct-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55770, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55769, PropCategory.REGULAR)
