...
class Racl(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Racl")

    meta.moClassName = "hcloudRacl"
    meta.rnFormat = "racl-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "routerAcl"
    ...
    meta.childClasses.add("cobra.model.hcloud.RaclRule")
    meta.childClasses.add("cobra.model.hcloud.RtSubnetToRacl")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSubnetToRacl", "rtsubnetToRacl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RaclRule", "raclrule-"))
    ...
    prop = PropMeta("str", "name", "name", 50753, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
