...
# ##################################################
class RsNextHopToIgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsNextHopToIgw", "cobra.model.hcloud.Igw")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsNextHopToIgw"
    meta.rnFormat = "rsnextHopToIgw"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Route Table Entries with Igw as NH"
    ...
    meta.rnPrefixes = [
        ('rsnextHopToIgw', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51620, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51621, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51302, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14920
    prop.defaultValueStr = "hcloudIgw"
    prop._addConstant("hcloudIgw", None, 14920)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51301, PropCategory.REGULAR)
