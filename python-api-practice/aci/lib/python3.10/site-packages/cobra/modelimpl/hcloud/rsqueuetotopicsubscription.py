...
# ##################################################
class RsQueueToTopicSubscription(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsQueueToTopicSubscription", "cobra.model.hcloud.Topic")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hcloudRsQueueToTopicSubscription"
    meta.rnFormat = "rsqueueToTopicSubscription-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Message queue to topic subscription"
    ...
    meta.rnPrefixes = [
        ('rsqueueToTopicSubscription-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51636, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51637, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51325, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14925
    prop.defaultValueStr = "hcloudTopic"
    prop._addConstant("hcloudTopic", None, 14925)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51324, PropCategory.REGULAR)
