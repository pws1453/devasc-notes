...
# ##################################################
class EndpointData(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.EndpointData")

    meta.moClassName = "hcloudEndpointData"
    meta.rnFormat = "ep-[%(endpointDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Endpoint data"
    ...
    prop = PropMeta("str", "endpointDn", "endpointDn", 55656, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "endpointDn"))
    getattr(meta.props, "endpointDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, endpointDn, markDirty=True, **creationProps):
        namingVals = [endpointDn]
