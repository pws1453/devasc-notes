...
# ##################################################
class RsVpnConnToCgwOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.RsVpnConnToCgwOper")

    meta.moClassName = "hcloudRsVpnConnToCgwOper"
    meta.rnFormat = "rvpntocgwoper"
    ...
    prop = PropMeta("str", "preSharedKey", "preSharedKey", 55629, PropCategory.REGULAR)
