...
# ##################################################
class RtInterSite(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtInterSite", "cobra.model.hcloud.SecurityGroup")

    meta.moClassName = "hcloudRtInterSite"
    meta.rnFormat = "rtinterSite-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51349, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51348, PropCategory.REGULAR)
