...
# ##################################################
class ObserverUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ObserverUpdateTask")

    meta.moClassName = "hcloudObserverUpdateTask"
    meta.rnFormat = "hcloudObserverUpdateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 50541, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SyncStats", "syncstats", 3343)
