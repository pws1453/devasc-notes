...
# ##################################################
class RsEpToSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsEpToSecurityGroup", "cobra.model.hcloud.SecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsEpToSecurityGroup"
    meta.rnFormat = "rsepToSecurityGroup-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsepToSecurityGroup-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51628, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51629, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51317, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51316, PropCategory.REGULAR)
