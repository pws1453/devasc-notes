...
# ##################################################
class ScaleSetNicGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ScaleSetNicGroup")

    meta.moClassName = "hcloudScaleSetNicGroup"
    meta.rnFormat = "ssnicgroup-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "None"
    meta.writeAccessMask = 0x1002601
    ...
    meta.childClasses.add("cobra.model.hcloud.RtEpToScaleSetNicGroup")
    ...
    meta.childClasses.add("cobra.model.hcloud.RsNicGroupToScaleSet")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtEpToScaleSetNicGroup", "rtepToScaleSetNicGroup-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsNicGroupToScaleSet", "rsnicGroupToScaleSet"))
    ...
    prop = PropMeta("str", "name", "name", 55701, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
