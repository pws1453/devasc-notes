...
# ##################################################
class ZoneMappingOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ZoneMappingOper")

    meta.moClassName = "hcloudZoneMappingOper"
    meta.rnFormat = "zonemap-[%(name)s]"
    ...
    prop = PropMeta("str", "awsZone", "awsZone", 52151, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("awsZone", prop)
    ...
    prop = PropMeta("str", "name", "name", 52156, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
