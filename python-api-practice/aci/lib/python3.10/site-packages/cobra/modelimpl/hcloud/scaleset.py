...
class ScaleSet(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.ScaleSet")

    meta.moClassName = "hcloudScaleSet"
    meta.rnFormat = "scaleset-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "vm instance scale set"
    ...
    meta.childClasses.add("cobra.model.hcloud.RtNicGroupToScaleSet")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.hcloud.RtInstToScaleSet")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtNicGroupToScaleSet", "rtnicGroupToScaleSet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtInstToScaleSet", "rtinstToScaleSet-"))
    ...
    prop = PropMeta("str", "name", "name", 55700, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
