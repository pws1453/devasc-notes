...
# ##################################################
class ProvMaxEpSecGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ProvMaxEpSecGrp")

    meta.moClassName = "hcloudProvMaxEpSecGrp"
    meta.rnFormat = "respol-[%(polKey)s]"
    ...
    prop = PropMeta("str", "maxValue", "maxValue", 55734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "polKey", "polKey", 55735, PropCategory.REGULAR)
