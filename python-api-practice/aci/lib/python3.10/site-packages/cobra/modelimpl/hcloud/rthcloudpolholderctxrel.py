...
# ##################################################
class RtHcloudPolHolderCtxRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtHcloudPolHolderCtxRel", "cobra.model.hcloud.HcloudPolHolder")

    meta.moClassName = "hcloudRtHcloudPolHolderCtxRel"
    meta.rnFormat = "rthcloudPolHolderCtxRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53901, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53900, PropCategory.REGULAR)
