...
class LogGrpPol(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.LogGrpPol")

    meta.moClassName = "hcloudLogGrpPol"
    meta.rnFormat = "loggrp-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Log Group Policy"
    ...
    meta.childClasses.add("cobra.model.hcloud.RtFlowToLogGrp")
    meta.childClasses.add("cobra.model.hcloud.RtSubnetFlowToLogGrp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSubnetFlowToLogGrp", "rtsubnetFlowToLogGrp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtFlowToLogGrp", "rtflowToLogGrp-"))
    ...
    meta.superClasses.add("cobra.model.hcloud.ALogGrpPol")
    ...
    prop = PropMeta("str", "name", "name", 50751, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "retention", "retention", 50340, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5
