...
# ##################################################
class RtVpnConnToCgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtVpnConnToCgw", "cobra.model.hcloud.Vgw")

    meta.moClassName = "hcloudRtVpnConnToCgw"
    meta.rnFormat = "rtvpnConnToCgw"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51361, PropCategory.REGULAR)
