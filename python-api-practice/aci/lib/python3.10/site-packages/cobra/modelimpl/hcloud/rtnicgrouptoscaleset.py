...
# ##################################################
class RtNicGroupToScaleSet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtNicGroupToScaleSet", "cobra.model.hcloud.ScaleSetNicGroup")

    meta.moClassName = "hcloudRtNicGroupToScaleSet"
    meta.rnFormat = "rtnicGroupToScaleSet-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55713, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55712, PropCategory.REGULAR)
