...
# ##################################################
class RsHcloudCtxCloudCtxProfileDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudCtxCloudCtxProfileDef", "cobra.model.cloud.CtxProfileDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudCtxCloudCtxProfileDef"
    meta.rnFormat = "rsHcloudCtxCloudCtxProfileDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "cloudCtxProfileDef to with this hcloudCtx relates"
    ...
    meta.rnPrefixes = [
        ('rsHcloudCtxCloudCtxProfileDef', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51614, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51615, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51288, PropCategory.REGULAR)
