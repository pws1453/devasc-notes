...
# ##################################################
class RsFlowToLogGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsFlowToLogGrp", "cobra.model.hcloud.LogGrpPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsFlowToLogGrp"
    meta.rnFormat = "rsflowToLogGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Flow to Log Group"
    ...
    meta.rnPrefixes = [
        ('rsflowToLogGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51641, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51331, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51330, PropCategory.REGULAR)
