...
class Tag(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Tag")

    meta.moClassName = "hcloudTag"
    meta.rnFormat = "hTagKey-%(key)s"
    ...
    prop = PropMeta("str", "key", "key", 50390, PropCategory.REGULAR)
    prop.label = "Key"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 50391, PropCategory.REGULAR)
    prop.label = "Key"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 128)]
