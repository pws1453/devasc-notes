...
# ##################################################
class RtTgToSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtTgToSecurityGroup", "cobra.model.hcloud.TargetGroup")

    meta.moClassName = "hcloudRtTgToSecurityGroup"
    meta.rnFormat = "rttgToSecurityGroup-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Native Listener Target pool"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51953, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51952, PropCategory.REGULAR)
