...
# ##################################################
class RtEpToSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtEpToSecurityGroup", "cobra.model.hcloud.AEndPoint")

    meta.moClassName = "hcloudRtEpToSecurityGroup"
    meta.rnFormat = "rtepToSecurityGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51319, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14911
    prop.defaultValueStr = "hcloudAEndPoint"
    ...
    prop = PropMeta("str", "tDn", "tDn", 51318, PropCategory.REGULAR)
