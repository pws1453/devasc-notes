...
# ##################################################
class RsTopicToCsr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsTopicToCsr", "cobra.model.hcloud.Csr")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hcloudRsTopicToCsr"
    meta.rnFormat = "rstopicToCsr-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "SNS that is assocaited with the CSR to post notifications"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51639, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51328, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14909
    prop.defaultValueStr = "hcloudCsr"
    prop._addConstant("hcloudCsr", None, 14909)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51327, PropCategory.REGULAR)
