...
class MsgQ(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.MsgQ")

    meta.moClassName = "hcloudMsgQ"
    meta.rnFormat = "msgQ-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud provider message queue"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsQueueToTopicSubscription")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsQueueToTopicSubscription", "rsqueueToTopicSubscription-"))
    ...
    prop = PropMeta("str", "name", "name", 50752, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "queueURL", "queueURL", 50333, PropCategory.REGULAR)
    prop.label = "Cloud provider URL for the queue"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("queueURL", prop)
