...
# ##################################################
class RtActionToTargetGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtActionToTargetGroup", "cobra.model.hcloud.AAction")

    meta.moClassName = "hcloudRtActionToTargetGroup"
    meta.rnFormat = "rtactionToTargetGroup-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Native Service Listener Action"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51946, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15210
    prop.defaultValueStr = "hcloudAAction"
    prop._addConstant("hcloudAAction", None, 15210)
    prop._addConstant("hcloudRuleAction", None, 15213)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51945, PropCategory.REGULAR)
