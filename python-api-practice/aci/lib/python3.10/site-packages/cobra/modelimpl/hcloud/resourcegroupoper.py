...
# ##################################################
class ResourceGroupOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ResourceGroupOper")

    meta.moClassName = "hcloudResourceGroupOper"
    meta.rnFormat = "rgoper-%(tenantName)s"
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 54947, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
