...
# ##################################################
class FilterEntryData(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.FilterEntryData")

    meta.moClassName = "hcloudFilterEntryData"
    meta.rnFormat = "fe-[%(filterEntryDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Filter Entry data"
    ...
    prop = PropMeta("str", "filterEntryDn", "filterEntryDn", 55657, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("filterEntryDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "filterEntryDn"))
    getattr(meta.props, "filterEntryDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, filterEntryDn, markDirty=True, **creationProps):
        namingVals = [filterEntryDn]
