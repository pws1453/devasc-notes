...
# ##################################################
class AvUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.AvUpdateTask")

    meta.moClassName = "hcloudAvUpdateTask"
    meta.rnFormat = "hcloudAvUpdateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 52747, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AvPoller", "avpoller", 3504)
