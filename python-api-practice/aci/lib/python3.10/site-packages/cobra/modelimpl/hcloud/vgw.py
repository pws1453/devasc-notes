...
class Vgw(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Vgw")

    meta.moClassName = "hcloudVgw"
    meta.rnFormat = "vgw"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsVpnConnToCgw")
    meta.childClasses.add("cobra.model.hcloud.VgwOper")
    meta.childClasses.add("cobra.model.hcloud.RtNextHopToVgw")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsVpnConnToCgw", "rsvpnConnToCgw-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtNextHopToVgw", "rtnextHopToVgw-"))
    ...
    prop = PropMeta("str", "asn", "asn", 50397, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "connectionType", "connectionType", 50398, PropCategory.REGULAR)
    prop.label = "Type of VGW Connection"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
