...
class IpOper(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.IpOper")

    meta.moClassName = "hcloudIpOper"
    meta.rnFormat = "operip-[%(name)s]"
    ...
    prop = PropMeta("str", "ipv4Addr", "ipv4Addr", 54945, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 54972, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
