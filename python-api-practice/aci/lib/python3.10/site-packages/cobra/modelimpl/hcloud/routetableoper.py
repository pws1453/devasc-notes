...
# ##################################################
class RouteTableOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.RouteTableOper")

    meta.moClassName = "hcloudRouteTableOper"
    meta.rnFormat = "routetableoper"
