...
class RouteTable(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.RouteTable")

    meta.moClassName = "hcloudRouteTable"
    meta.rnFormat = "routetable-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Subnet's Routing Table"
    ...
    meta.childClasses.add("cobra.model.hcloud.RtSubnetToRouteTable")
    meta.childClasses.add("cobra.model.hcloud.RouteTableEntry")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSubnetToRouteTable", "rtsubnetToRouteTable-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RouteTableOper", "routetableoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RouteTableEntry", "rtentry-"))
    ...
    prop = PropMeta("str", "name", "name", 50755, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
