...
# ##################################################
class RtNextHopToVgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtNextHopToVgw", "cobra.model.hcloud.RouteTableEntry")

    meta.moClassName = "hcloudRtNextHopToVgw"
    meta.rnFormat = "rtnextHopToVgw-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51312, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51311, PropCategory.REGULAR)
