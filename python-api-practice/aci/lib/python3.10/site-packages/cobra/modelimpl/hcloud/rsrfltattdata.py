...
# ##################################################
class RsRFltAttData(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.RsRFltAttData")

    meta.moClassName = "hcloudRsRFltAttData"
    meta.rnFormat = "rsrfltatt-[%(rsRFltAttDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "RsRFltAtt Data"
    ...
    prop = PropMeta("str", "rsRFltAttDn", "rsRFltAttDn", 54187, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("rsRFltAttDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "rsRFltAttDn"))
    getattr(meta.props, "rsRFltAttDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, rsRFltAttDn, markDirty=True, **creationProps):
        namingVals = [rsRFltAttDn]
