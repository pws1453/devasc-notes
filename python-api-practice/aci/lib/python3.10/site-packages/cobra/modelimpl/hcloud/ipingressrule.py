...
# ##################################################
class IpIngressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.IpIngressRule")

    meta.moClassName = "hcloudIpIngressRule"
    meta.rnFormat = "ipingress-%(protocol)s-%(fromPort)s-%(toPort)s-%(icmpv4Type)s-%(icmpv6Type)s-%(icmpCode)s-[%(source)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ipingress"
    ...
    prop = PropMeta("str", "fromPort", "fromPort", 52907, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpCode", "icmpCode", 52908, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpv4Type", "icmpv4Type", 52909, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpv6Type", "icmpv6Type", 52910, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "protocol", "protocol", 52912, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "source", "source", 52886, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "toPort", "toPort", 52911, PropCategory.REGULAR)
