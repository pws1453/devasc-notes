...
class InfraRes(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.InfraRes")

    meta.moClassName = "hcloudInfraRes"
    meta.rnFormat = "infraRes-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud provider infrastructure resources"
    ...
    meta.childClasses.add("cobra.model.hcloud.Topic")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.hcloud.StorageBucket")
    meta.childClasses.add("cobra.model.hcloud.ConfigRecorder")
    meta.childClasses.add("cobra.model.hcloud.MsgQ")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.hcloud.CloudWatchRule")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.hcloud.CloudTrail")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.StorageBucket", "storageBucket-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CloudTrail", "cloudTrail-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ConfigRecorder", "cfgRcrdr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CloudWatchRule", "cweRule-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.Topic", "topic-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.MsgQ", "msgQ-"))
    ...
    prop = PropMeta("str", "name", "name", 50749, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
