...
# ##################################################
class VnetStatsPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.VnetStatsPol")

    meta.moClassName = "hcloudVnetStatsPol"
    meta.rnFormat = "vnetstatsp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "hCloud Azure Stats Collection Object"
    ...
    prop = PropMeta("str", "enableStats", "enableStats", 55655, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 55660, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
