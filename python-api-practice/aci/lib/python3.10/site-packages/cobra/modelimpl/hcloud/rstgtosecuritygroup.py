...
# ##################################################
class RsTgToSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsTgToSecurityGroup", "cobra.model.hcloud.SecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsTgToSecurityGroup"
    meta.rnFormat = "rstgToSecurityGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "tg-to-securitygroup"
    ...
    meta.rnPrefixes = [
        ('rstgToSecurityGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 52011, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52012, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51951, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51950, PropCategory.REGULAR)
