...
# ##################################################
class EventsUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.EventsUpdateTask")

    meta.moClassName = "hcloudEventsUpdateTask"
    meta.rnFormat = "hcloudEventsUpdateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 50540, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SyncFaults", "syncfaults", 3368)
