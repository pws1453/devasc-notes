...
# ##################################################
class TargetGroupOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.TargetGroupOper")

    meta.moClassName = "hcloudTargetGroupOper"
    meta.rnFormat = "targetgroupoper"
