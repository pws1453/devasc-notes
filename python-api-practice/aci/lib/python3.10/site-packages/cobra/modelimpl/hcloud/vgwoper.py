...
class VgwOper(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.VgwOper")

    meta.moClassName = "hcloudVgwOper"
    meta.rnFormat = "vgwoper"
    ...
    prop = PropMeta("str", "bgpPeerIp", "bgpPeerIp", 54946, PropCategory.REGULAR)
    prop.label = "None"
