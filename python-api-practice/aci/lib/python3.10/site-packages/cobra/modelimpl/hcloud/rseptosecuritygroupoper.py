...
# ##################################################
class RsEpToSecurityGroupOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.RsEpToSecurityGroupOper")

    meta.moClassName = "hcloudRsEpToSecurityGroupOper"
    meta.rnFormat = "epsgoper"
