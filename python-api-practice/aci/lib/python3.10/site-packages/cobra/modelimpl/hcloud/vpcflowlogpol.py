...
# ##################################################
class VpcFlowLogPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.VpcFlowLogPol")

    meta.moClassName = "hcloudVpcFlowLogPol"
    meta.rnFormat = "vpcflp-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "VPC Flow Log Policy"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsFlowToLogGrp")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsFlowToLogGrp", "rsflowToLogGrp"))
    ...
    prop = PropMeta("str", "name", "name", 50761, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
