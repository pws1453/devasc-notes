...
# ##################################################
class RsNetworkInterfaceToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsNetworkInterfaceToSubnet", "cobra.model.hcloud.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsNetworkInterfaceToSubnet"
    meta.rnFormat = "rsnetworkInterfaceToSubnet"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nwif-to-subnet"
    ...
    meta.rnPrefixes = [
        ('rsnetworkInterfaceToSubnet', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51630, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51631, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51321, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14890
    prop.defaultValueStr = "hcloudSubnet"
    prop._addConstant("hcloudSubnet", None, 14890)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51320, PropCategory.REGULAR)
