...
# ##################################################
class AzureInventoryTaskError(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.AzureInventoryTaskError")

    meta.moClassName = "hcloudAzureInventoryTaskError"
    meta.rnFormat = "invtaskerr-[%(delegateDn)s]"
    ...
    prop = PropMeta("str", "delegateDn", "delegateDn", 56108, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "delegateDn"))
    getattr(meta.props, "delegateDn").needDelimiter = True

    def __init__(self, parentMoOrDn, delegateDn, markDirty=True, **creationProps):
        namingVals = [delegateDn]
