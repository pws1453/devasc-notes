...
# ##################################################
class RuleCondition(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.RuleCondition")

    meta.moClassName = "hcloudRuleCondition"
    meta.rnFormat = "condition-%(conditionType)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Native Service Listener Condition Rule"
    ...
    prop = PropMeta("str", "conditionType", "conditionType", 51849, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop.isNaming = True
    prop.defaultValue = 0
    prop.defaultValueStr = "host"
    prop._addConstant("host", "host", 0)
    prop._addConstant("path", "path", 1)
    meta.props.add("conditionType", prop)

    prop = PropMeta("str", "conditionVal", "conditionVal", 51850, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("conditionVal", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "conditionType"))
    ...
    def __init__(self, parentMoOrDn, conditionType, markDirty=True, **creationProps):
        namingVals = [conditionType]
