...
# ##################################################
class TechSupOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.TechSupOper")

    meta.moClassName = "hcloudTechSupOper"
    meta.rnFormat = "ts"
    meta.category = MoCategory.REGULAR
    meta.label = "Status of CSR Techsupport collection"
    ...
    meta.superClasses.add("cobra.model.hcloud.RouterStateOper")
    ...
    prop = PropMeta("str", "collectState", "collectState", 52764, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("collectState", prop)
    ...
    prop = PropMeta("str", "name", "name", 53077, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "operState", "operState", 53357, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "operStateQual", "operStateQual", 53359, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "routerPDn", "routerPDn", 53997, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("routerPDn", prop)

    prop = PropMeta("str", "stateReason", "stateReason", 53358, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "not-applicable"
    prop._addConstant("administrative-down", "interface-down", 4)
    prop._addConstant("not-applicable", "n/a", 0)
    prop._addConstant("protocol-down", "protocol-down", 2)
    prop._addConstant("up", "interface-up", 1)
    ...
    prop = PropMeta("str", "trigTime", "trigTime", 53078, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
