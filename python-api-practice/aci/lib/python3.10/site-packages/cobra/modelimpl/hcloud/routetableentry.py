...
class RouteTableEntry(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.RouteTableEntry")

    meta.moClassName = "hcloudRouteTableEntry"
    meta.rnFormat = "rtentry-[%(destinationAddress)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Routing Table Entry"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsNextHopToVgw")
    meta.childClasses.add("cobra.model.hcloud.RsNextHopToNwIf")
    meta.childClasses.add("cobra.model.hcloud.RouteTableEntryOper")
    meta.childClasses.add("cobra.model.hcloud.RsNextHopToIgw")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsNextHopToNwIf", "rsnextHopToNwIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsNextHopToVgw", "rsnextHopToVgw"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsNextHopToIgw", "rsnextHopToIgw"))
    ...
    prop = PropMeta("str", "destinationAddress", "destinationAddress", 50300, PropCategory.REGULAR)
    prop.label = "Next Hop For Destination"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("destinationAddress", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "destinationAddress"))
    getattr(meta.props, "destinationAddress").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, destinationAddress, markDirty=True, **creationProps):
        namingVals = [destinationAddress]
