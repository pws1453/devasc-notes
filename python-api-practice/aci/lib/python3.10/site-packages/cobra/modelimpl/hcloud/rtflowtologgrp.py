...
# ##################################################
class RtFlowToLogGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtFlowToLogGrp", "cobra.model.hcloud.VpcFlowLogPol")

    meta.moClassName = "hcloudRtFlowToLogGrp"
    meta.rnFormat = "rtflowToLogGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51333, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14936
    prop.defaultValueStr = "hcloudVpcFlowLogPol"
    prop._addConstant("hcloudVpcFlowLogPol", None, 14936)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51332, PropCategory.REGULAR)
