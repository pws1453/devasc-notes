...
# ##################################################
class ConfigTaskError(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ConfigTaskError")

    meta.moClassName = "hcloudConfigTaskError"
    meta.rnFormat = "cfgtaskerr-[%(objectDn)s]"
    ...
    prop = PropMeta("str", "objectDn", "objectDn", 54119, PropCategory.REGULAR)
    prop.label = "DN of object that caused the error"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    def __init__(self, parentMoOrDn, objectDn, markDirty=True, **creationProps):
        namingVals = [objectDn]
