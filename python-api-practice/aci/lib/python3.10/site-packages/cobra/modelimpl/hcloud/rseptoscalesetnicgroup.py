...
# ##################################################
class RsEpToScaleSetNicGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsEpToScaleSetNicGroup", "cobra.model.hcloud.ScaleSetNicGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsEpToScaleSetNicGroup"
    meta.rnFormat = "rsepToScaleSetNicGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ep-to-scalesetnicgroup"
    ...
    meta.rnPrefixes = [
        ('rsepToScaleSetNicGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55716, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55717, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55707, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16363
    prop.defaultValueStr = "hcloudScaleSetNicGroup"
    prop._addConstant("hcloudScaleSetNicGroup", None, 16363)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55706, PropCategory.REGULAR)
