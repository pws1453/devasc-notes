...
# ##################################################
class RsTgToEndPoint(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsTgToEndPoint", "cobra.model.hcloud.EndPoint")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsTgToEndPoint"
    meta.rnFormat = "rstgToEndPoint-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "tg-to-endpoint"
    ...
    meta.childClasses.add("cobra.model.hcloud.TargetPort")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.TargetPort", "targetPort-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 52009, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52010, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51948, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14914
    prop.defaultValueStr = "hcloudEndPoint"
    prop._addConstant("hcloudEndPoint", None, 14914)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51947, PropCategory.REGULAR)
