...
# ##################################################
class RsHcloudPolHolderCtxRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderCtxRel", "cobra.model.hcloud.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderCtxRel"
    meta.rnFormat = "rshcloudPolHolderCtxRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53899, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53898, PropCategory.REGULAR)
