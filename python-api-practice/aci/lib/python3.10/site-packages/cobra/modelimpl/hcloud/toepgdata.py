...
class ToEPgData(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.ToEPgData")

    meta.moClassName = "hcloudToEPgData"
    meta.rnFormat = "toepgdata-[%(toEPgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ToEpg data from a contract"
    ...
    prop = PropMeta("str", "toEPgDn", "toEPgDn", 53277, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, toEPgDn, markDirty=True, **creationProps):
        namingVals = [toEPgDn]
