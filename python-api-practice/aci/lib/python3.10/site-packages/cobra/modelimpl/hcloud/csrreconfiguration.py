...
# ##################################################
class CsrReconfiguration(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CsrReconfiguration")

    meta.moClassName = "hcloudCsrReconfiguration"
    meta.rnFormat = "csrreconf"
    meta.category = MoCategory.REGULAR
    meta.label = "Csr Reconfiguration information"
    ...
    prop = PropMeta("str", "csrDn", "csrDn", 50313, PropCategory.REGULAR)
    prop.label = "CSR DN for which reconfiguration in progress"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("csrDn", prop)
