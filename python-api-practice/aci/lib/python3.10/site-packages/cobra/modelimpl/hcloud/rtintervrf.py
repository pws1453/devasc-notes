...
class RtInterVrf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hcloud.RtInterVrf", "cobra.model.hcloud.ASecurityGroup")

    meta.moClassName = "hcloudRtInterVrf"
    meta.rnFormat = "rtinterVrf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51341, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51340, PropCategory.REGULAR)
