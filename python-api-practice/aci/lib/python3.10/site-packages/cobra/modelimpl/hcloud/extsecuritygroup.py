...
# ##################################################
class ExtSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ExtSecurityGroup")

    meta.moClassName = "hcloudExtSecurityGroup"
    meta.rnFormat = "extsgroup-[%(epgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ExtsecGroup"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsSecurityGroup")
    meta.childClasses.add("cobra.model.hcloud.RsInterVrf")
    meta.childClasses.add("cobra.model.hcloud.RtInterSite")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.hcloud.ExtEPSelector")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsSecurityGroup", "rsSecurityGroup"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ExtEPSelector", "extepselector-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtInterSite", "rtinterSite-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsInterVrf", "rsinterVrf-"))
    ...
    meta.superClasses.add("cobra.model.hcloud.ASecurityGroup")
    ...
    prop = PropMeta("str", "description", "description", 50362, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 52030, PropCategory.REGULAR)
    prop.label = "Mapping between a security group and the fvEPg"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "routeReachability", "routeReachability", 50365, PropCategory.REGULAR)
    prop.label = "Route reachability for this EPG"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "inter-site"
    prop._addConstant("inter-site", "routes-reachable-via-intersite-app-epg", 1)
    prop._addConstant("inter-site-ext", "routes-reachable-via-intersite-external-epg", 3)
    prop._addConstant("internet", "routes-reachable-via-internet", 2)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("routeReachability", prop)
    ...
    prop = PropMeta("str", "tags", "tags", 50363, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("tags", prop)

    prop = PropMeta("str", "type", "type", 50364, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "non-default"
    prop._addConstant("default-csr", "default-security-group-for-csr", 1)
    prop._addConstant("default-ep", "default-security-group-for-eps", 0)
    prop._addConstant("non-default", "non-default-security-group", 2)
