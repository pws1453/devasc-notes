...
# ##################################################
class RsActionToTargetGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsActionToTargetGroup", "cobra.model.hcloud.TargetGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsActionToTargetGroup"
    meta.rnFormat = "rsactionToTargetGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "action-to-tg"
    ...
    meta.rnPrefixes = [
        ('rsactionToTargetGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 52007, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52008, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51944, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15215
    prop.defaultValueStr = "hcloudTargetGroup"
    prop._addConstant("hcloudTargetGroup", None, 15215)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51943, PropCategory.REGULAR)
