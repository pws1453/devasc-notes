...
# ##################################################
class RsInstToScaleSet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsInstToScaleSet", "cobra.model.hcloud.ScaleSet")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsInstToScaleSet"
    meta.rnFormat = "rsinstToScaleSet"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "inst-to-scaleset"
    ...
    meta.rnPrefixes = [
        ('rsinstToScaleSet', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55714, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55715, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55703, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16360
    prop.defaultValueStr = "hcloudScaleSet"
    prop._addConstant("hcloudScaleSet", None, 16360)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55702, PropCategory.REGULAR)
