...
# ##################################################
class RsNextHopToVgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsNextHopToVgw", "cobra.model.hcloud.Vgw")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsNextHopToVgw"
    meta.rnFormat = "rsnextHopToVgw"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Route Table Entries with Vgw as NH"
    ...
    meta.rnPrefixes = [
        ('rsnextHopToVgw', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51622, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51623, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51310, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14983
    prop.defaultValueStr = "hcloudVgw"
    prop._addConstant("hcloudVgw", None, 14983)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51309, PropCategory.REGULAR)
