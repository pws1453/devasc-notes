...
# ##################################################
class CertificateOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CertificateOper")

    meta.moClassName = "hcloudCertificateOper"
    meta.rnFormat = "certificateoper"
