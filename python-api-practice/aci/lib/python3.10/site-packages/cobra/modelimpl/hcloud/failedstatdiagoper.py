...
# ##################################################
class FailedStatDiagOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.FailedStatDiagOper")

    meta.moClassName = "hcloudFailedStatDiagOper"
    meta.rnFormat = "diagoper-[%(resourceID)s]"
    ...
    prop = PropMeta("str", "hubName", "hubName", 55834, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("hubName", prop)
    ...
    prop = PropMeta("str", "operNodeType", "operNodeType", 55832, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "Unknown"
    prop._addConstant("AppGateway", "azure-appgateway", 3)
    prop._addConstant("NetworkInterface", "networkinterface", 1)
    prop._addConstant("ScaleSet", "scaleset", 2)
    prop._addConstant("Unknown", "unknown", 0)
    meta.props.add("operNodeType", prop)
    ...
    prop = PropMeta("str", "operType", "operType", 55831, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "Unknown"
    prop._addConstant("ClearDiagSetting", "cleardiagsetting", 2)
    prop._addConstant("ConfigureDiagSetting", "configurediagsetting", 1)
    prop._addConstant("Unknown", "unknown", 0)
    meta.props.add("operType", prop)

    prop = PropMeta("str", "region", "region", 55835, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "resourceID", "resourceID", 55833, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "resourceID"))
    getattr(meta.props, "resourceID").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, resourceID, markDirty=True, **creationProps):
        namingVals = [resourceID]
