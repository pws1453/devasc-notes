...
# ##################################################
class RtNetworkInterfaceToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtNetworkInterfaceToSubnet", "cobra.model.hcloud.NetworkInterface")

    meta.moClassName = "hcloudRtNetworkInterfaceToSubnet"
    meta.rnFormat = "rtnetworkInterfaceToSubnet-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtnetworkInterfaceToSubnet-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51323, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51322, PropCategory.REGULAR)
