...
class RaclRule(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.RaclRule")

    meta.moClassName = "hcloudRaclRule"
    meta.rnFormat = "raclrule-%(ruleno)s"
    meta.category = MoCategory.REGULAR
    meta.label = "routerAclRule"
    ...
    prop = PropMeta("str", "action", "action", 50360, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "egress", "egress", 50357, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("egress", prop)

    prop = PropMeta("str", "ipCidr", "ipCidr", 50356, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("ipCidr", prop)
    ...
    prop = PropMeta("str", "portRange", "portRange", 50358, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("portRange", prop)

    prop = PropMeta("str", "priority", "priority", 50361, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "protocol", "protocol", 50359, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "ruleno", "ruleno", 50355, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "ruleno"))
    ...
    def __init__(self, parentMoOrDn, ruleno, markDirty=True, **creationProps):
        namingVals = [ruleno]
