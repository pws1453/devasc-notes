...
class TgStats(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.TgStats")

    meta.moClassName = "hcloudTgStats"
    meta.rnFormat = "tgstats"
    ...
    meta.superClasses.add("cobra.model.hcloud.ATgStats")

    meta.rnPrefixes = [
        ('tgstats', False),
    ]

    prop = PropMeta("str", "HealthyHostCount", "HealthyHostCount", 52386, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("HealthyHostCount", prop)

    prop = PropMeta("str", "RequestCountPerTarget", "RequestCountPerTarget", 52387, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("RequestCountPerTarget", prop)

    prop = PropMeta("str", "TargetConnectionErrorCount", "TargetConnectionErrorCount", 52388, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("TargetConnectionErrorCount", prop)

    prop = PropMeta("str", "TargetResponseTime", "TargetResponseTime", 52389, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("TargetResponseTime", prop)

    prop = PropMeta("str", "TargetTLSNegotiationErrorCount", "TargetTLSNegotiationErrorCount", 52390, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("TargetTLSNegotiationErrorCount", prop)

    prop = PropMeta("str", "UnHealthyHostCount", "UnHealthyHostCount", 52391, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("UnHealthyHostCount", prop)

    prop = PropMeta("str", "annotation", "annotation", 52706, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52707, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "logicalDn", "logicalDn", 52385, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
