...
# ##################################################
class RsHcloudPolHolderRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderRel", "cobra.model.hcloud.Account")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderRel"
    meta.rnFormat = "rshcloudPolHolderRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51285, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14883
    prop.defaultValueStr = "hcloudAccount"
    prop._addConstant("hcloudAccount", None, 14883)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51284, PropCategory.REGULAR)
