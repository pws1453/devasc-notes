...
# ##################################################
class ListenerCertificateOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ListenerCertificateOper")

    meta.moClassName = "hcloudListenerCertificateOper"
    meta.rnFormat = "listencertoper"
