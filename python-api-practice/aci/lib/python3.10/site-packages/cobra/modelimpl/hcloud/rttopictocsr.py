...
# ##################################################
class RtTopicToCsr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtTopicToCsr", "cobra.model.hcloud.Topic")

    meta.moClassName = "hcloudRtTopicToCsr"
    meta.rnFormat = "rttopicToCsr"
    ...
    meta.readAccessMask = 0x708421002101
    ...
    prop = PropMeta("str", "tCl", "tCl", 51329, PropCategory.REGULAR)
