...
# ##################################################
class RsSubnetFlowToLogGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsSubnetFlowToLogGrp", "cobra.model.hcloud.LogGrpPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsSubnetFlowToLogGrp"
    meta.rnFormat = "rssubnetFlowToLogGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Subnet Flow to Log Group"
    ...
    meta.rnPrefixes = [
        ('rssubnetFlowToLogGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51642, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51643, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51335, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14935
    prop.defaultValueStr = "hcloudLogGrpPol"
    prop._addConstant("hcloudLogGrpPol", None, 14935)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51334, PropCategory.REGULAR)
