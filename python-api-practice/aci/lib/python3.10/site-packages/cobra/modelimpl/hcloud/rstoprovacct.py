...
# ##################################################
class RsToProvAcct(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsToProvAcct", "cobra.model.hcloud.ProvAccount")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsToProvAcct"
    meta.rnFormat = "rstoProvAcct"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to provider account"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55772, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55773, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55768, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16386
    prop.defaultValueStr = "hcloudProvAccount"
    prop._addConstant("hcloudProvAccount", None, 16386)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55767, PropCategory.REGULAR)
