...
# ##################################################
class CtxPeeringOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CtxPeeringOper")

    meta.moClassName = "hcloudCtxPeeringOper"
    meta.rnFormat = "ctxpeeringoper-[%(acceptorDn)s]"
    ...
    prop = PropMeta("str", "acceptorCloudProviderId", "acceptorCloudProviderId", 50354, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("acceptorCloudProviderId", prop)

    prop = PropMeta("str", "acceptorDn", "acceptorDn", 50353, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("acceptorDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "acceptorDn"))
    getattr(meta.props, "acceptorDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, acceptorDn, markDirty=True, **creationProps):
        namingVals = [acceptorDn]
