...
class RtListenerToCert(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hcloud.RtListenerToCert", "cobra.model.hcloud.Listener")

    meta.moClassName = "hcloudRtListenerToCert"
    meta.rnFormat = "rtlistenerToCert-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52677, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15207
    prop.defaultValueStr = "hcloudListener"
    prop._addConstant("hcloudListener", None, 15207)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52676, PropCategory.REGULAR)
