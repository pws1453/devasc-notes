...
# ##################################################
class StorageBucket(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.StorageBucket")

    meta.moClassName = "hcloudStorageBucket"
    meta.rnFormat = "storageBucket-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud provider storage service bucket"
    ...
    prop = PropMeta("str", "name", "name", 50757, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
