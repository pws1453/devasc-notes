...
# ##################################################
class RtQueueToTopicSubscription(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtQueueToTopicSubscription", "cobra.model.hcloud.MsgQ")

    meta.moClassName = "hcloudRtQueueToTopicSubscription"
    meta.rnFormat = "rtqueueToTopicSubscription"
    ...
    meta.rnPrefixes = [
        ('rtqueueToTopicSubscription', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51326, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14922
    prop.defaultValueStr = "hcloudMsgQ"
