...
# ##################################################
class RtInstToScaleSet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtInstToScaleSet", "cobra.model.hcloud.Instance")

    meta.moClassName = "hcloudRtInstToScaleSet"
    meta.rnFormat = "rtinstToScaleSet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "vm instance"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55705, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55704, PropCategory.REGULAR)
