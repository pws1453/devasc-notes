...
class TechSup(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.TechSup")

    meta.moClassName = "hcloudTechSup"
    meta.rnFormat = "ts-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Techsupport policy for Cloud Resources"
    ...
    prop = PropMeta("str", "name", "name", 52796, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "trigState", "trigState", 52763, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("trigState", prop)

    prop = PropMeta("str", "trigTime", "trigTime", 53075, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
