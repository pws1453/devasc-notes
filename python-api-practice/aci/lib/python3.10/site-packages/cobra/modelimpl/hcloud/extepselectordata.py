...
# ##################################################
class ExtEPSelectorData(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ExtEPSelectorData")

    meta.moClassName = "hcloudExtEPSelectorData"
    meta.rnFormat = "extepsel-[%(selectorDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ExtEPSelector Data"
    ...
    prop = PropMeta("str", "selectorDn", "selectorDn", 54186, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
