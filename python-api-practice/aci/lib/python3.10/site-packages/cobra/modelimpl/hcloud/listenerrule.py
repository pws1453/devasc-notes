...
class ListenerRule(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.ListenerRule")

    meta.moClassName = "hcloudListenerRule"
    meta.rnFormat = "rule-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Native Service Listener Rule"
    ...
    meta.childClasses.add("cobra.model.hcloud.RuleCondition")
    ...
    meta.childClasses.add("cobra.model.hcloud.RuleAction")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RuleCondition", "condition-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RuleAction", "action-"))
    ...
    prop = PropMeta("str", "default", "default", 52034, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 51894, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "priority", "priority", 51848, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
