...
# ##################################################
class InstanceOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.InstanceOper")

    meta.moClassName = "hcloudInstanceOper"
    meta.rnFormat = "instoper"
    ...
    prop = PropMeta("str", "instanceState", "instanceState", 52893, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("instanceState", prop)

    prop = PropMeta("str", "instanceStatus", "instanceStatus", 50352, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("impaired", "impaired", 1)
    prop._addConstant("initializing", "initializing", 2)
    prop._addConstant("insufficient-data", "insufficient-data", 3)
    prop._addConstant("not-applicable", "not-applicable", 0)
    prop._addConstant("ok", "ok", 4)
    meta.props.add("instanceStatus", prop)

    prop = PropMeta("str", "instanceType", "instanceType", 52746, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("instanceType", prop)
    ...
    prop = PropMeta("str", "routerPDn", "routerPDn", 53048, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
