...
# ##################################################
class SubnetFlowLogPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SubnetFlowLogPol")

    meta.moClassName = "hcloudSubnetFlowLogPol"
    meta.rnFormat = "subnetflp-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Subnet Flow Log Policy"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsSubnetFlowToLogGrp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsSubnetFlowToLogGrp", "rssubnetFlowToLogGrp"))
    ...
    meta.superClasses.add("cobra.model.hcloud.AFlowLogPol")
    ...
    prop = PropMeta("str", "logDestination", "logDestination", 50343, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 50758, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "trafficType", "trafficType", 50341, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
