...
# ##################################################
class EndPointOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.EndPointOper")

    meta.moClassName = "hcloudEndPointOper"
    meta.rnFormat = "epoper"
    ...
    meta.childClasses.add("cobra.model.hcloud.IpV4Addr")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.IpV4Addr", "v4addr-"))
    ...
    prop = PropMeta("str", "addrOperState", "addrOperState", 57021, PropCategory.REGULAR)
    prop.label = "None"
    ...
    meta.props.add("addrOperState", prop)

    prop = PropMeta("str", "attachmentId", "attachmentId", 50348, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("attachmentId", prop)
    ...
    prop = PropMeta("str", "eIpAllocationId", "eIpAllocationId", 50350, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("eIpAllocationId", prop)

    prop = PropMeta("str", "elasticIpAssociationId", "elasticIpAssociationId", 50349, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("elasticIpAssociationId", prop)

    prop = PropMeta("str", "epType", "epType", 50351, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ec2Inst"
    prop._addConstant("awsAlb", "network-interface-that-is-attached-to-an-aws-alb", 2)
    prop._addConstant("csr", "network-interface-that-is-attached-to-a-csr", 1)
    prop._addConstant("ec2Inst", "network-interface-that-is-attached-to-a-customer-ec2-instance", 0)
    prop._addConstant("scaleset-vm", "network-interface-that-is-attached-to-an-azure-scaleset-vm", 4)
    prop._addConstant("vm", "network-interface-that-is-attached-to-an-azure-vm", 3)
    meta.props.add("epType", prop)
    ...
    prop = PropMeta("str", "privateIpv4Addr", "privateIpv4Addr", 50345, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("privateIpv4Addr", prop)

    prop = PropMeta("str", "privateIpv6Addr", "privateIpv6Addr", 50347, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("privateIpv6Addr", prop)

    prop = PropMeta("str", "publicIpv4Addr", "publicIpv4Addr", 50344, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("publicIpv4Addr", prop)

    prop = PropMeta("str", "publicIpv6Addr", "publicIpv6Addr", 50346, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("publicIpv6Addr", prop)
