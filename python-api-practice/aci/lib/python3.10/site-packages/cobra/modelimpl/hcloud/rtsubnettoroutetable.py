...
# ##################################################
class RtSubnetToRouteTable(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtSubnetToRouteTable", "cobra.model.hcloud.Subnet")

    meta.moClassName = "hcloudRtSubnetToRouteTable"
    meta.rnFormat = "rtsubnetToRouteTable-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51300, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51299, PropCategory.REGULAR)
