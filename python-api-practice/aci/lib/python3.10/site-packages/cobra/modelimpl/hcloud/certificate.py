...
# ##################################################
class Certificate(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.Certificate")

    meta.moClassName = "hcloudCertificate"
    meta.rnFormat = "cert-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Native Service Listener Certificate"
    ...
    meta.childClasses.add("cobra.model.hcloud.RtListenerToCert")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtListenerToCert", "rtlistenerToCert-"))
    ...
    prop = PropMeta("str", "body", "body", 51869, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("body", prop)

    prop = PropMeta("str", "chain", "chain", 51870, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("chain", prop)
    ...
    prop = PropMeta("str", "name", "name", 51891, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "privateKey", "privateKey", 51868, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("privateKey", prop)
