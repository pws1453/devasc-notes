...
class IpV4Addr(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.IpV4Addr")

    meta.moClassName = "hcloudIpV4Addr"
    meta.rnFormat = "v4addr-%(addr)s"
    ...
    prop = PropMeta("str", "addr", "addr", 50322, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 51632, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51633, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "primary", "primary", 50324, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "private", "private", 50323, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
