...
class Cidr(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Cidr")

    meta.moClassName = "hcloudCidr"
    meta.rnFormat = "cidr-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Ctx's CIDR"
    ...
    meta.childClasses.add("cobra.model.hcloud.Subnet")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.Subnet", "subnet-"))
    ...
    meta.superClasses.add("cobra.model.hcloud.ACidr")

    meta.rnPrefixes = [
        ('cidr-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 50295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "primary", "primary", 50296, PropCategory.REGULAR)
