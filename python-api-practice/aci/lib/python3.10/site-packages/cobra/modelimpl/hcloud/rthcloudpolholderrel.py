...
# ##################################################
class RtHcloudPolHolderRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtHcloudPolHolderRel", "cobra.model.hcloud.HcloudPolHolder")

    meta.moClassName = "hcloudRtHcloudPolHolderRel"
    meta.rnFormat = "rthcloudPolHolderRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51287, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51286, PropCategory.REGULAR)
