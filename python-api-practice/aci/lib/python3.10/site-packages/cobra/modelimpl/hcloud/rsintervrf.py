...
class RsInterVrf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hcloud.RsInterVrf", "cobra.model.hcloud.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsInterVrf"
    meta.rnFormat = "rsinterVrf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "InterVRF relation"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51646, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51647, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51339, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14886
    prop.defaultValueStr = "hcloudCtx"
    prop._addConstant("hcloudCtx", None, 14886)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51338, PropCategory.REGULAR)
