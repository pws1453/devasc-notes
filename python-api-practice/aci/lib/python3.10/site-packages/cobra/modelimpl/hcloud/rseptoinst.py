...
class RsEpToInst(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hcloud.RsEpToInst", "cobra.model.hcloud.Instance")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsEpToInst"
    meta.rnFormat = "rsepToInst"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ep-to-inst"
    ...
    prop = PropMeta("str", "annotation", "annotation", 53088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 53089, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 53085, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14906
    prop.defaultValueStr = "hcloudInstance"
    prop._addConstant("hcloudInstance", None, 14906)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 53084, PropCategory.REGULAR)
