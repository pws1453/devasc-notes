...
# ##################################################
class RsLBToSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsLBToSecurityGroup", "cobra.model.hcloud.SecurityGroup")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hcloudRsLBToSecurityGroup"
    meta.rnFormat = "rslBToSecurityGroup-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "lb-to-securitygroup"
    ...
    meta.rnPrefixes = [
        ('rslBToSecurityGroup-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 52005, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52006, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51937, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14970
    prop.defaultValueStr = "hcloudSecurityGroup"
    prop._addConstant("hcloudSecurityGroup", None, 14970)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51936, PropCategory.REGULAR)
