...
# ##################################################
class RsSubnetToRouteTable(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsSubnetToRouteTable", "cobra.model.hcloud.RouteTable")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsSubnetToRouteTable"
    meta.rnFormat = "rssubnetToRouteTable"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Subnet Attachment to RouteTable"
    ...
    meta.rnPrefixes = [
        ('rssubnetToRouteTable', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51618, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 51296, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51619, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51298, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14895
    prop.defaultValueStr = "hcloudRouteTable"
    prop._addConstant("hcloudRouteTable", None, 14895)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51297, PropCategory.REGULAR)
