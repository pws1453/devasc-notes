...
# ##################################################
class RtSubnetFlowToLogGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtSubnetFlowToLogGrp", "cobra.model.hcloud.SubnetFlowLogPol")

    meta.moClassName = "hcloudRtSubnetFlowToLogGrp"
    meta.rnFormat = "rtsubnetFlowToLogGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51337, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14939
    prop.defaultValueStr = "hcloudSubnetFlowLogPol"
    prop._addConstant("hcloudSubnetFlowLogPol", None, 14939)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51336, PropCategory.REGULAR)
