...
# ##################################################
class RtSubnetToRacl(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtSubnetToRacl", "cobra.model.hcloud.Subnet")

    meta.moClassName = "hcloudRtSubnetToRacl"
    meta.rnFormat = "rtsubnetToRacl-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51294, PropCategory.REGULAR)
