...
# ##################################################
class RsSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsSecurityGroup", "cobra.model.cloud.EpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsSecurityGroup"
    meta.rnFormat = "rsSecurityGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Mapping between a security group and the cloudEpP"
    ...
    meta.rnPrefixes = [
        ('rsSecurityGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51644, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51645, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51343, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14617
    prop.defaultValueStr = "cloudEpP"
    prop._addConstant("cloudEpP", None, 14617)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51342, PropCategory.REGULAR)
