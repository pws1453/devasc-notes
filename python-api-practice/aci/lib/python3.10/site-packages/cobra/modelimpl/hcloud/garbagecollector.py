...
# ##################################################
class GarbageCollector(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.GarbageCollector")

    meta.moClassName = "hcloudGarbageCollector"
    meta.rnFormat = "startgc"
    ...
    prop = PropMeta("str", "startGarbageCollector", "startGarbageCollector", 53882, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
