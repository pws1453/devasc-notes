...
# ##################################################
class RtLBToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtLBToSubnet", "cobra.model.hcloud.NativeLB")

    meta.moClassName = "hcloudRtLBToSubnet"
    meta.rnFormat = "rtlBToSubnet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Native Service LB"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51942, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15202
    prop.defaultValueStr = "hcloudNativeLB"
    prop._addConstant("hcloudNativeLB", None, 15202)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51941, PropCategory.REGULAR)
