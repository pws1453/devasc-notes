...
# ##################################################
class ACidr(Mo):
    meta = ClassMeta("cobra.model.hcloud.ACidr")

    meta.isAbstract = True
    meta.moClassName = "hcloudACidr"


    meta.moClassName = "hcloudACidr"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Cloud Ctx's CIDR"
    ...
    prop = PropMeta("str", "addr", "addr", 53074, PropCategory.REGULAR)
