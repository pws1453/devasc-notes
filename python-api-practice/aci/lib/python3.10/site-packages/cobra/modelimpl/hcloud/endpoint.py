...
class EndPoint(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.EndPoint")

    meta.moClassName = "hcloudEndPoint"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsEpToScaleSetNicGroup")
    meta.childClasses.add("cobra.model.hcloud.RsEpToInst")
    meta.childClasses.add("cobra.model.hcloud.Tag")
    meta.childClasses.add("cobra.model.hcloud.EndPointOper")
    meta.childClasses.add("cobra.model.hcloud.RtTgToEndPoint")
    meta.childClasses.add("cobra.model.hcloud.IpV4Addr")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.hcloud.RsEpToSecurityGroup")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsEpToScaleSetNicGroup", "rsepToScaleSetNicGroup"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsEpToSecurityGroup", "rsepToSecurityGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtTgToEndPoint", "rttgToEndPoint-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsEpToInst", "rsepToInst"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsEpToSecurityGroupOper", "epsgoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.Tag", "hTagKey-"))
    ...
    meta.superClasses.add("cobra.model.hcloud.AEndPoint")
    ...
    prop = PropMeta("str", "name", "name", 50746, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "primaryIpV4Addr", "primaryIpV4Addr", 51837, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("primaryIpV4Addr", prop)
    ...
    prop = PropMeta("str", "runEPSelector", "runEPSelector", 55698, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("runEPSelector", prop)
