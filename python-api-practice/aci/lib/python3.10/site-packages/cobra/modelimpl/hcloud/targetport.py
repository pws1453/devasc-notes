...
class TargetPort(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.TargetPort")

    meta.moClassName = "hcloudTargetPort"
    meta.rnFormat = "targetPort-%(port)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Target Application Port"
    ...
    prop = PropMeta("str", "annotation", "annotation", 52013, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "endPointDN", "endPointDN", 54015, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("endPointDN", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52014, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ipAddress", "ipAddress", 54014, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "port", "port", 51867, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, port, markDirty=True, **creationProps):
        namingVals = [port]
