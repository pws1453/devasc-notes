...
class RsLBToSubnet(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hcloud.RsLBToSubnet", "cobra.model.hcloud.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsLBToSubnet"
    meta.rnFormat = "rslBToSubnet-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 52003, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52004, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51940, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51939, PropCategory.REGULAR)
