...
# ##################################################
class RsInterSite(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsInterSite", "cobra.model.hcloud.ExtSecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsInterSite"
    meta.rnFormat = "rsinterSite-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "InterSite relation"
    ...
    meta.childClasses.add("cobra.model.hcloud.ToEPgData")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ToEPgData", "toepgdata-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51648, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51649, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51347, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14973
    prop.defaultValueStr = "hcloudExtSecurityGroup"
    prop._addConstant("hcloudExtSecurityGroup", None, 14973)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51346, PropCategory.REGULAR)
