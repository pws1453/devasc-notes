...
# ##################################################
class RtNextHopToIgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtNextHopToIgw", "cobra.model.hcloud.RouteTableEntry")

    meta.moClassName = "hcloudRtNextHopToIgw"
    meta.rnFormat = "rtnextHopToIgw-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51304, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51303, PropCategory.REGULAR)
