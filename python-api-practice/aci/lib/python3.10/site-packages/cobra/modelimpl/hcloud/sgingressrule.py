...
# ##################################################
class SgIngressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SgIngressRule")

    meta.moClassName = "hcloudSgIngressRule"
    meta.rnFormat = "sgingress-%(protocol)s-%(fromPort)s-%(toPort)s-%(icmpv4Type)s-%(icmpv6Type)s-%(icmpCode)s-[%(source)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "sgingress"
    ...
    prop = PropMeta("str", "fromPort", "fromPort", 52919, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpCode", "icmpCode", 52920, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpv4Type", "icmpv4Type", 52921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpv6Type", "icmpv6Type", 52922, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "protocol", "protocol", 52924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "source", "source", 52888, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("source", prop)
    ...
    prop = PropMeta("str", "toPort", "toPort", 52923, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "source"))
    getattr(meta.props, "source").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, protocol, fromPort, toPort, icmpv4Type, icmpv6Type, icmpCode, source, markDirty=True, **creationProps):
        namingVals = [protocol, fromPort, toPort, icmpv4Type, icmpv6Type, icmpCode, source]
