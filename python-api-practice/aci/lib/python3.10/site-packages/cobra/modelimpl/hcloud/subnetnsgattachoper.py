...
# ##################################################
class SubnetNsgAttachOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SubnetNsgAttachOper")

    meta.moClassName = "hcloudSubnetNsgAttachOper"
    meta.rnFormat = "nsgattachoper"
