...
# ##################################################
class ListenerRulePriorityOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ListenerRulePriorityOper")

    meta.moClassName = "hcloudListenerRulePriorityOper"
    meta.rnFormat = "listenruleprioper"
