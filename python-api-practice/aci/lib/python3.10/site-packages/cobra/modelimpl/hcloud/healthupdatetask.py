...
# ##################################################
class HealthUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.HealthUpdateTask")

    meta.moClassName = "hcloudHealthUpdateTask"
    meta.rnFormat = "hcloudHealthUpdateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 53998, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SyncHealth", "synchealth", 3555)
