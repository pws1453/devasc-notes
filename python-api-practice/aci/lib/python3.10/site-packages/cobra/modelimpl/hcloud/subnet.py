...
class Subnet(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Subnet")

    meta.moClassName = "hcloudSubnet"
    meta.rnFormat = "subnet-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "subnet"
    meta.writeAccessMask = 0x1002001
    meta.readAccessMask = 0x1002701
    ...
    meta.childClasses.add("cobra.model.hcloud.RsSubnetToRouteTable")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.hcloud.RtNetworkInterfaceToSubnet")
    meta.childClasses.add("cobra.model.hcloud.RsSubnetToRacl")
    meta.childClasses.add("cobra.model.hcloud.SubnetNsgAttachOper")
    meta.childClasses.add("cobra.model.hcloud.SGRuleGroupOper")
    meta.childClasses.add("cobra.model.hcloud.EndPoint")
    meta.childClasses.add("cobra.model.hcloud.SubnetOper")
    meta.childClasses.add("cobra.model.hcloud.SubnetFlowLogPol")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.hcloud.ScaleSetNicGroup")
    meta.childClasses.add("cobra.model.hcloud.RtLBToSubnet")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtNetworkInterfaceToSubnet", "rtnetworkInterfaceToSubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsSubnetToRouteTable", "rssubnetToRouteTable"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsSubnetToRacl", "rssubnetToRacl"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SubnetNsgAttachOper", "nsgattachoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtLBToSubnet", "rtlBToSubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ScaleSetNicGroup", "ssnicgroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SubnetOper", "subnetoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SubnetFlowLogPol", "subnetflp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SGRuleGroupOper", "operrules"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.EndPoint", "ep-"))
    ...
    prop = PropMeta("str", "addr", "addr", 50299, PropCategory.REGULAR)
    prop.label = "Cloud CIDR's Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "usage", "usage", 50297, PropCategory.REGULAR)
    prop.label = "Subnet's usage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "user"
    prop._addConstant("gateway", "gateway", 4)
    prop._addConstant("infra-router", "infra-router", 2)
    prop._addConstant("user", "user", 1)
    meta.props.add("usage", prop)

    prop = PropMeta("str", "zone", "zone", 50298, PropCategory.REGULAR)
    prop.label = "Availability Zone of the Subnet"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("zone", prop)
