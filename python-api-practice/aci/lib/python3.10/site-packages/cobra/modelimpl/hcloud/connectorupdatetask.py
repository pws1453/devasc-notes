...
# ##################################################
class ConnectorUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ConnectorUpdateTask")

    meta.moClassName = "hcloudConnectorUpdateTask"
    meta.rnFormat = "hcloudConnectorUpdateTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('hcloudConnectorUpdateTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 50538, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SyncCloudOper", "synccloudoper", 3350)
