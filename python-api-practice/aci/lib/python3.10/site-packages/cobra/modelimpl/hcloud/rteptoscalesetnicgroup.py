...
# ##################################################
class RtEpToScaleSetNicGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtEpToScaleSetNicGroup", "cobra.model.hcloud.EndPoint")

    meta.moClassName = "hcloudRtEpToScaleSetNicGroup"
    meta.rnFormat = "rtepToScaleSetNicGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55709, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55708, PropCategory.REGULAR)
