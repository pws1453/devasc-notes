...
class CloudTrail(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.CloudTrail")

    meta.moClassName = "hcloudCloudTrail"
    meta.rnFormat = "cloudTrail-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Trail service to record user initiated config requests"
    ...
    prop = PropMeta("str", "name", "name", 50740, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
