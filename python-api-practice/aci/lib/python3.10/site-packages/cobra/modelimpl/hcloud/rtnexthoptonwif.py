...
# ##################################################
class RtNextHopToNwIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtNextHopToNwIf", "cobra.model.hcloud.RouteTableEntry")

    meta.moClassName = "hcloudRtNextHopToNwIf"
    meta.rnFormat = "rtnextHopToNwIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51308, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14896
    prop.defaultValueStr = "hcloudRouteTableEntry"
    prop._addConstant("hcloudRouteTableEntry", None, 14896)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51307, PropCategory.REGULAR)
