...
# ##################################################
class SgIngressRuleOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SgIngressRuleOper")

    meta.moClassName = "hcloudSgIngressRuleOper"
    meta.rnFormat = "sgingressoper"
    meta.category = MoCategory.REGULAR
    meta.label = "asgruleoper"
    ...
    meta.superClasses.add("cobra.model.hcloud.ASgRuleOper")
    ...
    prop = PropMeta("str", "priority", "priority", 55791, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
