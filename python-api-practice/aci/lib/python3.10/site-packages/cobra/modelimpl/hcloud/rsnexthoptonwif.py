...
# ##################################################
class RsNextHopToNwIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsNextHopToNwIf", "cobra.model.hcloud.NetworkInterface")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsNextHopToNwIf"
    meta.rnFormat = "rsnextHopToNwIf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Route Table Entries with NwIf as NH"
    ...
    meta.rnPrefixes = [
        ('rsnextHopToNwIf-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51624, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51625, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51306, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14915
    prop.defaultValueStr = "hcloudNetworkInterface"
    prop._addConstant("hcloudNetworkInterface", None, 14915)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51305, PropCategory.REGULAR)
