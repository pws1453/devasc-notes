...
# ##################################################
class CloudWatchRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CloudWatchRule")

    meta.moClassName = "hcloudCloudWatchRule"
    meta.rnFormat = "cweRule-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud watch rule to monitor events"
    ...
    prop = PropMeta("str", "name", "name", 50741, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
