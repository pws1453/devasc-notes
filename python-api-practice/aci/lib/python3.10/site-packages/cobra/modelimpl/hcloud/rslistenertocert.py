...
class RsListenerToCert(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hcloud.RsListenerToCert", "cobra.model.hcloud.Certificate")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsListenerToCert"
    ...
    prop = PropMeta("str", "annotation", "annotation", 52702, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "defaultCert", "defaultCert", 52673, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52703, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 52675, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15222
    prop.defaultValueStr = "hcloudCertificate"
    prop._addConstant("hcloudCertificate", None, 15222)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52674, PropCategory.REGULAR)
