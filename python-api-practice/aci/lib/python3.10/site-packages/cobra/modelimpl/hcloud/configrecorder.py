...
# ##################################################
class ConfigRecorder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ConfigRecorder")

    meta.moClassName = "hcloudConfigRecorder"
    meta.rnFormat = "cfgRcrdr-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Config service for reporting configuration changes"
    ...
    prop = PropMeta("str", "name", "name", 50742, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
