...
# ##################################################
class RsSubnetToRacl(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsSubnetToRacl", "cobra.model.hcloud.Racl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsSubnetToRacl"
    meta.rnFormat = "rssubnetToRacl"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "subnet-to-racl"
    ...
    meta.rnPrefixes = [
        ('rssubnetToRacl', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51616, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51617, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51293, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14963
    prop.defaultValueStr = "hcloudRacl"
    prop._addConstant("hcloudRacl", None, 14963)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51292, PropCategory.REGULAR)
