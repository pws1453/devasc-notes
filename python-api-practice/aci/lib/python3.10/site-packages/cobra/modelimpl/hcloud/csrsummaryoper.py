...
# ##################################################
class CsrSummaryOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CsrSummaryOper")

    meta.moClassName = "hcloudCsrSummaryOper"
    meta.rnFormat = "oper"
    ...
    prop = PropMeta("str", "accntStatus", "accntStatus", 54003, PropCategory.REGULAR)
    prop.label = "reflects the AccountOper status"
    ...
    meta.props.add("accntStatus", prop)
    ...
    prop = PropMeta("str", "csrStatus", "csrStatus", 54008, PropCategory.REGULAR)
    prop.label = "reflects the CsrOper status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("csrStatus", prop)

    prop = PropMeta("str", "ctxStatus", "ctxStatus", 54006, PropCategory.REGULAR)
    prop.label = "reflects the CtxOper status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    ...
    prop = PropMeta("str", "regionStatus", "regionStatus", 54007, PropCategory.REGULAR)
    prop.label = "reflects the RegionOper status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("regionStatus", prop)
    ...
    prop = PropMeta("str", "sshStatus", "sshStatus", 57361, PropCategory.REGULAR)
    prop.label = "reflects the SSH connectivity status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("sshStatus", prop)
    ...
    prop = PropMeta("str", "subnetStatus", "subnetStatus", 54005, PropCategory.REGULAR)
    prop.label = "reflects the SubnetOper status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("subnetStatus", prop)
