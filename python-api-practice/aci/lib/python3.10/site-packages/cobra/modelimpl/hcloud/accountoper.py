...
# ##################################################
class AccountOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.AccountOper")

    meta.moClassName = "hcloudAccountOper"
    meta.rnFormat = "acctoper"
    ...
    prop = PropMeta("str", "accountSetupDone", "accountSetupDone", 52060, PropCategory.REGULAR)
    prop.label = "None"
    ...
    meta.props.add("accountSetupDone", prop)

    prop = PropMeta("str", "cftURL", "cftURL", 55965, PropCategory.REGULAR)
    prop.label = "Role template URL for trusted tenants"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("cftURL", prop)
    ...
    prop = PropMeta("str", "isMasterAccountInOrg", "isMasterAccountInOrg", 52164, PropCategory.REGULAR)
    prop.label = "Is Master Account in Organization"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isMasterAccountInOrg", prop)
