...
class Listener(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Listener")

    meta.moClassName = "hcloudListener"
    meta.rnFormat = "listener-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Native Service Listener"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsListenerToCert")
    meta.childClasses.add("cobra.model.hcloud.ListenerRule")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsListenerToCert", "rslistenerToCert-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ListenerOper", "listeneroper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ListenerRule", "rule-"))
    ...
    prop = PropMeta("str", "name", "name", 51893, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "port", "port", 51846, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("port", prop)

    prop = PropMeta("str", "protocol", "protocol", 51845, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "secPolicy", "secPolicy", 51847, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
