...
class ResourceMap(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.ResourceMap")

    meta.moClassName = "hcloudResourceMap"
    meta.rnFormat = "resourcemap-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "resourcemap"
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 50284, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 50754, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
