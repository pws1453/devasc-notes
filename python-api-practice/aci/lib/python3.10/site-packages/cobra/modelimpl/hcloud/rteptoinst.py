...
class RtEpToInst(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hcloud.RtEpToInst", "cobra.model.hcloud.EndPoint")

    meta.moClassName = "hcloudRtEpToInst"
    meta.rnFormat = "rtepToInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53086, PropCategory.REGULAR)
