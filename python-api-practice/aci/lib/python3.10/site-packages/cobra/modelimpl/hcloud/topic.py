...
class Topic(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Topic")

    meta.moClassName = "hcloudTopic"
    meta.rnFormat = "topic-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud provider Notification service Topic"
    ...
    meta.childClasses.add("cobra.model.hcloud.RtQueueToTopicSubscription")
    meta.childClasses.add("cobra.model.hcloud.RsTopicToCsr")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtQueueToTopicSubscription", "rtqueueToTopicSubscription"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsTopicToCsr", "rstopicToCsr-"))
    ...
    prop = PropMeta("str", "name", "name", 50759, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "topicARN", "topicARN", 50334, PropCategory.REGULAR)
