...
# ##################################################
class RsHcloudPolHolderProvRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderProvRel", "cobra.model.hcloud.Prov")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderProvRel"
    meta.rnFormat = "rshcloudPolHolderProvRel"
    ...
    meta.rnPrefixes = [
        ('rshcloudPolHolderProvRel', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 55764, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16377
    prop.defaultValueStr = "hcloudProv"
    prop._addConstant("hcloudProv", None, 16377)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55763, PropCategory.REGULAR)
