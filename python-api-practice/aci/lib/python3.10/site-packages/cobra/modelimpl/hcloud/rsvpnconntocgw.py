...
# ##################################################
class RsVpnConnToCgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsVpnConnToCgw", "cobra.model.hcloud.Cgw")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hcloudRsVpnConnToCgw"
    meta.rnFormat = "rsvpnConnToCgw-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "VPN Connection from VGW to CGW"
    ...
    meta.childClasses.add("cobra.model.hcloud.AwsVpnTunnelInfo")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsVpnConnToCgwOper", "rvpntocgwoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.AwsVpnTunnelInfo", "tunnelinfo-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51654, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 51354, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "connectionType", "connectionType", 51355, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ipsec"
    prop._addConstant("ipsec", "ipsec", 0)
    meta.props.add("connectionType", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51655, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "hCloudName", "hCloudName", 51356, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("hCloudName", prop)
    ...
    prop = PropMeta("str", "operState", "operState", 51357, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "stateReason", "stateReason", 51358, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51360, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14986
    prop.defaultValueStr = "hcloudCgw"
    prop._addConstant("hcloudCgw", None, 14986)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51359, PropCategory.REGULAR)
