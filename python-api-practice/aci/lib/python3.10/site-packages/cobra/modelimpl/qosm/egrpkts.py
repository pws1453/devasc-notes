...
# ##################################################
class EgrPkts(Mo):
    meta = StatsClassMeta("cobra.model.qosm.EgrPkts", "egress packets")
    ...
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts1d")
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts5min")
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts1year")
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts1qtr")
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts1mo")
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts1h")
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts1w")
    meta.concreteSubClasses.add("cobra.model.qosm.EgrPkts15min")
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 10891, PropCategory.IMPLICIT_AVG)
    prop.label = "egress drop packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropBase", "dropBase", 10886, PropCategory.IMPLICIT_BASELINE)
    prop.label = "egress drop packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBase", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 10887, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropLast", "dropLast", 10885, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "egress drop packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropLast", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 10890, PropCategory.IMPLICIT_MAX)
    prop.label = "egress drop packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 10889, PropCategory.IMPLICIT_MIN)
    prop.label = "egress drop packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 10888, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 10896, PropCategory.IMPLICIT_RATE)
    prop.label = "egress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 10892, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 10893, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 10895, PropCategory.IMPLICIT_TREND)
    prop.label = "egress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 10894, PropCategory.IMPLICIT_TREND_BASE)
