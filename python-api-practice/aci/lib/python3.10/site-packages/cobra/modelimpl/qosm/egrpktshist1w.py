...
class EgrPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist1w", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist1w"
    meta.rnFormat = "HDqosmEgrPkts1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7095, PropCategory.REGULAR)
