...
class IngrPkts5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPkts5min", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPkts5min"
    meta.rnFormat = "CDqosmIngrPkts5min"
