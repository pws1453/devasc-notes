...
class Entity(Mo):
    """
    A policy container for QoS related entity information.

    """

    meta = ClassMeta("cobra.model.qosm.Entity")

    meta.moClassName = "qosmEntity"
    meta.rnFormat = "qosm"
    meta.category = MoCategory.REGULAR
    meta.label = "QoS Entity"
    ...
    meta.childClasses.add("cobra.model.qosp.DscpRule")
    meta.childClasses.add("cobra.model.qosm.Class")
    meta.childClasses.add("cobra.model.qosp.Class")
    meta.childClasses.add("cobra.model.qosm.If")
    meta.childClasses.add("cobra.model.qosp.InfraDscpMap")
    meta.childClasses.add("cobra.model.qosp.Dot1pRule")
    meta.childClasses.add("cobra.model.qosp.IpRule")

    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.InfraDscpMap", "infradscpmap"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.Class", "classp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosm.Class", "class-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.Dot1pRule", "dot1p-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.DscpRule", "dscp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosm.If", "if-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.IpRule", "ip-"))
    ...
    prop = PropMeta("str", "EtrapAgeTimer", "EtrapAgeTimer", 42303, PropCategory.REGULAR)
    prop.label = "E-trap flow age out timer"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("EtrapAgeTimer", prop)

    prop = PropMeta("str", "EtrapBwThresh", "EtrapBwThresh", 42304, PropCategory.REGULAR)
    prop.label = "Track activeness of elephant flow"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("EtrapBwThresh", prop)

    prop = PropMeta("str", "EtrapByteCt", "EtrapByteCt", 42302, PropCategory.REGULAR)
    prop.label = "E-trap elephant flow identifier"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("EtrapByteCt", prop)

    prop = PropMeta("str", "EtrapSt", "EtrapSt", 42301, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "FabricFlushInterval", "FabricFlushInterval", 45450, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "FabricFlushSt", "FabricFlushSt", 45449, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 22209, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14409, PropCategory.REGULAR)
