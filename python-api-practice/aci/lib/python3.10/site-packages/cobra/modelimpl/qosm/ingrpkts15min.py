...
class IngrPkts15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPkts15min", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPkts15min"
    meta.rnFormat = "CDqosmIngrPkts15min"
    ...
    meta.superClasses.add("cobra.model.qosm.IngrPkts")

    meta.rnPrefixes = [
        ('CDqosmIngrPkts15min', False),
    ]
