...
class EgrPktsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist1year", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist1year"
    meta.rnFormat = "HDqosmEgrPkts1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7096, PropCategory.REGULAR)
