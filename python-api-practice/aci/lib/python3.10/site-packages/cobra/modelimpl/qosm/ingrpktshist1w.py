...
class IngrPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPktsHist1w", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPktsHist1w"
    meta.rnFormat = "HDqosmIngrPkts1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7103, PropCategory.REGULAR)
