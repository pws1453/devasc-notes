...
class IngrPktsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPktsHist1year", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPktsHist1year"
    meta.rnFormat = "HDqosmIngrPkts1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7104, PropCategory.REGULAR)
