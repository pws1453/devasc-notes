...
class EgrPktsHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist1d", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist1d"
    meta.rnFormat = "HDqosmEgrPkts1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7091, PropCategory.REGULAR)
