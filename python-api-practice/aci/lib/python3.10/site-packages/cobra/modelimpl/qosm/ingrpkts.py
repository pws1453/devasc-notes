...
# ##################################################
class IngrPkts(Mo):
    meta = StatsClassMeta("cobra.model.qosm.IngrPkts", "ingress packets")
    ...
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts1year")
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts1h")
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts1qtr")
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts1d")
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts15min")
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts5min")
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts1mo")
    meta.concreteSubClasses.add("cobra.model.qosm.IngrPkts1w")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "admitAvg", "admitAvg", 10918, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress admit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitAvg", prop)

    prop = PropMeta("str", "admitBase", "admitBase", 10913, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress admit packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitBase", prop)

    prop = PropMeta("str", "admitCum", "admitCum", 10914, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress admit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitCum", prop)

    prop = PropMeta("str", "admitLast", "admitLast", 10912, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress admit packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitLast", prop)

    prop = PropMeta("str", "admitMax", "admitMax", 10917, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress admit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMax", prop)

    prop = PropMeta("str", "admitMin", "admitMin", 10916, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress admit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMin", prop)

    prop = PropMeta("str", "admitPer", "admitPer", 10915, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress admit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitPer", prop)

    prop = PropMeta("str", "admitRate", "admitRate", 10923, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress admit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitRate", prop)

    prop = PropMeta("str", "admitSpct", "admitSpct", 10919, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress admit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitSpct", prop)

    prop = PropMeta("str", "admitThr", "admitThr", 10920, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "admitTr", "admitTr", 10922, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress admit packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitTr", prop)

    prop = PropMeta("str", "admitTrBase", "admitTrBase", 10921, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "ingress admit packets trend baseline"
    prop.isOper = True
    prop.isStats = True
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 10945, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress drop packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropBase", "dropBase", 10940, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress drop packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBase", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 10941, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropLast", "dropLast", 10939, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress drop packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropLast", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 10944, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress drop packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 10943, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress drop packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 10942, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 10950, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 10946, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 10947, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 10949, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 10948, PropCategory.IMPLICIT_TREND_BASE)
