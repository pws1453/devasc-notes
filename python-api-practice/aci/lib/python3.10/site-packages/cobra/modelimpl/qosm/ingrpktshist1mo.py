...
class IngrPktsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPktsHist1mo", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPktsHist1mo"
    meta.rnFormat = "HDqosmIngrPkts1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7101, PropCategory.REGULAR)
