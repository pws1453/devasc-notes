...
class EgrPktsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist15min", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist15min"
    meta.rnFormat = "HDqosmEgrPkts15min-%(index)s"
    ...
    meta.superClasses.add("cobra.model.qosm.EgrPktsHist")

    meta.rnPrefixes = [
        ('HDqosmEgrPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 7090, PropCategory.REGULAR)
