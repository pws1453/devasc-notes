...
class EgrPktsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist1h", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist1h"
    meta.rnFormat = "HDqosmEgrPkts1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7092, PropCategory.REGULAR)
