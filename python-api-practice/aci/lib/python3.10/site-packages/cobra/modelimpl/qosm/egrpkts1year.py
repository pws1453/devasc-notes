...
class EgrPkts1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPkts1year", "egress packets")
    ...
    meta.moClassName = "qosmEgrPkts1year"
    meta.rnFormat = "CDqosmEgrPkts1year"
