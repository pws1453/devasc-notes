...
class EgrPkts15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPkts15min", "egress packets")
    ...
    meta.moClassName = "qosmEgrPkts15min"
    meta.rnFormat = "CDqosmEgrPkts15min"
    ...
    meta.superClasses.add("cobra.model.qosm.EgrPkts")

    meta.rnPrefixes = [
        ('CDqosmEgrPkts15min', False),
    ]
