...
class IngrPkts1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPkts1year", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPkts1year"
    meta.rnFormat = "CDqosmIngrPkts1year"
