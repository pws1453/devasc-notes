...
class EgrPktsHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist1qtr", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist1qtr"
    meta.rnFormat = "HDqosmEgrPkts1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7094, PropCategory.REGULAR)
