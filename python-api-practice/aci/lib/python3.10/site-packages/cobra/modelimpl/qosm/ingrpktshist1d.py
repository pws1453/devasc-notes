...
class IngrPktsHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPktsHist1d", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPktsHist1d"
    meta.rnFormat = "HDqosmIngrPkts1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7099, PropCategory.REGULAR)
