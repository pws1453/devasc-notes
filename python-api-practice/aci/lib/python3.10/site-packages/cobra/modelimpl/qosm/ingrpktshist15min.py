...
class IngrPktsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPktsHist15min", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPktsHist15min"
    meta.rnFormat = "HDqosmIngrPkts15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7098, PropCategory.REGULAR)
