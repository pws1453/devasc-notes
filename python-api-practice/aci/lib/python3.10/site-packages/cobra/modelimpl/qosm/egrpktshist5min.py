...
class EgrPktsHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist5min", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist5min"
    meta.rnFormat = "HDqosmEgrPkts5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7097, PropCategory.REGULAR)
