...
class IngrPkts1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPkts1qtr", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPkts1qtr"
    meta.rnFormat = "CDqosmIngrPkts1qtr"
