...
class IngrPktsHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPktsHist5min", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPktsHist5min"
    meta.rnFormat = "HDqosmIngrPkts5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7105, PropCategory.REGULAR)
