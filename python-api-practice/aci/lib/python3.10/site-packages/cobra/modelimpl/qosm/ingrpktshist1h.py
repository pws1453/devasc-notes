...
class IngrPktsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPktsHist1h", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPktsHist1h"
    meta.rnFormat = "HDqosmIngrPkts1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7100, PropCategory.REGULAR)
