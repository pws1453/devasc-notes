...
class IngrPkts1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.IngrPkts1mo", "ingress packets")
    ...
    meta.moClassName = "qosmIngrPkts1mo"
    meta.rnFormat = "CDqosmIngrPkts1mo"
