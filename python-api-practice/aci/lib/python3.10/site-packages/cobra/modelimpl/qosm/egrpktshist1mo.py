...
class EgrPktsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.qosm.EgrPktsHist1mo", "egress packets")
    ...
    meta.moClassName = "qosmEgrPktsHist1mo"
    meta.rnFormat = "HDqosmEgrPkts1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 7093, PropCategory.REGULAR)
