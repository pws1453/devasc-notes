...
# ##################################################
class WebConnAg1year(Mo):
    """
    A class that represents the most current aggregated statistics for web connections in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAg1year", "web connections")
    ...
    meta.moClassName = "commWebConnAg1year"
    meta.rnFormat = "CDcommWebConnAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web connections stats in 1 year"
