...
# ##################################################
class WebConnStates1mo(Mo):
    """
    A class that represents the most current statistics for web connections state in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStates1mo", "web connections state")
    ...
    meta.moClassName = "commWebConnStates1mo"
    meta.rnFormat = "CDcommWebConnStates1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current web connections state stats in 1 month"
