...
# ##################################################
class WebConnAg1mo(Mo):
    """
    A class that represents the most current aggregated statistics for web connections in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAg1mo", "web connections")
    ...
    meta.moClassName = "commWebConnAg1mo"
    meta.rnFormat = "CDcommWebConnAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web connections stats in 1 month"
