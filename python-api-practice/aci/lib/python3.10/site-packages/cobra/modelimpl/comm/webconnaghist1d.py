...
# ##################################################
class WebConnAgHist1d(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist1d", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist1d"
    meta.rnFormat = "HDcommWebConnAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 19351, PropCategory.REGULAR)
