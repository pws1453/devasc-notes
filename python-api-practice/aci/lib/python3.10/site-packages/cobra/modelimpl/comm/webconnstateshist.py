...
# ##################################################
class WebConnStatesHist(Mo):
    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist"


    meta.moClassName = "commWebConnStatesHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats"
    ...
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist1h")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist15min")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist1mo")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist1d")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist5min")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist1year")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist1w")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnStatesHist1qtr")
    ...
    prop = PropMeta("str", "readAvg", "readAvg", 19621, PropCategory.IMPLICIT_AVG)
    prop.label = "current reading connections average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("readAvg", prop)

    prop = PropMeta("str", "readMax", "readMax", 19620, PropCategory.IMPLICIT_MAX)
    prop.label = "current reading connections maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("readMax", prop)

    prop = PropMeta("str", "readMin", "readMin", 19619, PropCategory.IMPLICIT_MIN)
    prop.label = "current reading connections minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("readMin", prop)

    prop = PropMeta("str", "readSpct", "readSpct", 19622, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "current reading connections suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("readSpct", prop)

    prop = PropMeta("str", "readThr", "readThr", 19623, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "readTr", "readTr", 19624, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "waitAvg", "waitAvg", 19651, PropCategory.IMPLICIT_AVG)
    prop.label = "current waiting connections average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("waitAvg", prop)

    prop = PropMeta("str", "waitMax", "waitMax", 19650, PropCategory.IMPLICIT_MAX)
    prop.label = "current waiting connections maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("waitMax", prop)

    prop = PropMeta("str", "waitMin", "waitMin", 19649, PropCategory.IMPLICIT_MIN)
    prop.label = "current waiting connections minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("waitMin", prop)

    prop = PropMeta("str", "waitSpct", "waitSpct", 19652, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "current waiting connections suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("waitSpct", prop)

    prop = PropMeta("str", "waitThr", "waitThr", 19653, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "waitTr", "waitTr", 19654, PropCategory.IMPLICIT_TREND)
    prop.label = "current waiting connections trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("waitTr", prop)

    prop = PropMeta("str", "writeAvg", "writeAvg", 19681, PropCategory.IMPLICIT_AVG)
    prop.label = "current writing connections average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("writeAvg", prop)

    prop = PropMeta("str", "writeMax", "writeMax", 19680, PropCategory.IMPLICIT_MAX)
    prop.label = "current writing connections maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("writeMax", prop)

    prop = PropMeta("str", "writeMin", "writeMin", 19679, PropCategory.IMPLICIT_MIN)
    prop.label = "current writing connections minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("writeMin", prop)

    prop = PropMeta("str", "writeSpct", "writeSpct", 19682, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "current writing connections suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("writeSpct", prop)

    prop = PropMeta("str", "writeThr", "writeThr", 19683, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "writeTr", "writeTr", 19684, PropCategory.IMPLICIT_TREND)
