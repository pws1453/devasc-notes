...
# ##################################################
class WebConnStatesHist5min(Mo):
    """
    A class that represents historical statistics for web connections state in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist5min", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist5min"
    meta.rnFormat = "HDcommWebConnStates5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 19405, PropCategory.REGULAR)
