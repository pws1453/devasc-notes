...
class WebReqAg1d(Mo):
    """
    A class that represents the most current aggregated statistics for web requests in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqAg1d", "web requests")
    ...
    meta.moClassName = "commWebReqAg1d"
    meta.rnFormat = "CDcommWebReqAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web requests stats in 1 day"
