...
class WebReqAg1h(Mo):
    """
    A class that represents the most current aggregated statistics for web requests in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqAg1h", "web requests")
    ...
    meta.moClassName = "commWebReqAg1h"
    meta.rnFormat = "CDcommWebReqAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web requests stats in 1 hour"
