...
# ##################################################
class WebConnStatesHist1d(Mo):
    """
    A class that represents historical statistics for web connections state in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist1d", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist1d"
    meta.rnFormat = "HDcommWebConnStates1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 19399, PropCategory.REGULAR)
