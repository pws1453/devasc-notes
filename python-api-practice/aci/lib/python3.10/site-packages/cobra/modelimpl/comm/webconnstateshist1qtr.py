...
# ##################################################
class WebConnStatesHist1qtr(Mo):
    """
    A class that represents historical statistics for web connections state in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist1qtr", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist1qtr"
    meta.rnFormat = "HDcommWebConnStates1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 19402, PropCategory.REGULAR)
