...
# ##################################################
class WebConnStates5min(Mo):
    """
    A class that represents the most current statistics for web connections state in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStates5min", "web connections state")
    ...
    meta.moClassName = "commWebConnStates5min"
    meta.rnFormat = "CDcommWebConnStates5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current web connections state stats in 5 minute"
