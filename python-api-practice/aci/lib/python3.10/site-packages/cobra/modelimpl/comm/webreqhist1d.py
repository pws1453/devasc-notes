...
# ##################################################
class WebReqHist1d(Mo):
    """
    A class that represents historical statistics for web requests in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqHist1d", "web requests")
    ...
    meta.moClassName = "commWebReqHist1d"
    meta.rnFormat = "HDcommWebReq1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web requests stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 19439, PropCategory.REGULAR)
