...
# ##################################################
class WebReqAg1qtr(Mo):
    """
    A class that represents the most current aggregated statistics for web requests in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqAg1qtr", "web requests")
    ...
    meta.moClassName = "commWebReqAg1qtr"
    meta.rnFormat = "CDcommWebReqAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web requests stats in 1 quarter"
