...
# ##################################################
class WebConnStates1w(Mo):
    """
    A class that represents the most current statistics for web connections state in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStates1w", "web connections state")
    ...
    meta.moClassName = "commWebConnStates1w"
    meta.rnFormat = "CDcommWebConnStates1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current web connections state stats in 1 week"
