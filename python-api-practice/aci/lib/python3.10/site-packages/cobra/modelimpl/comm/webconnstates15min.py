...
# ##################################################
class WebConnStates15min(Mo):
    """
    A class that represents the most current statistics for web connections state in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStates15min", "web connections state")
    ...
    meta.moClassName = "commWebConnStates15min"
    meta.rnFormat = "CDcommWebConnStates15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current web connections state stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDcommWebConnStates15min', False),
    ]
