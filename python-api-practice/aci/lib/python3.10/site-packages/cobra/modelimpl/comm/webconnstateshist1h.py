...
# ##################################################
class WebConnStatesHist1h(Mo):
    """
    A class that represents historical statistics for web connections state in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist1h", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist1h"
    meta.rnFormat = "HDcommWebConnStates1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 19400, PropCategory.REGULAR)
