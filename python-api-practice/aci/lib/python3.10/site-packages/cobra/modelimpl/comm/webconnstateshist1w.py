...
# ##################################################
class WebConnStatesHist1w(Mo):
    """
    A class that represents historical statistics for web connections state in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist1w", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist1w"
    meta.rnFormat = "HDcommWebConnStates1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 19403, PropCategory.REGULAR)
