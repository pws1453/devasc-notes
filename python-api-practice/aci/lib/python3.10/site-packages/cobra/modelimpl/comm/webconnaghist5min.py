...
# ##################################################
class WebConnAgHist5min(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist5min", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist5min"
    meta.rnFormat = "HDcommWebConnAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 19357, PropCategory.REGULAR)
