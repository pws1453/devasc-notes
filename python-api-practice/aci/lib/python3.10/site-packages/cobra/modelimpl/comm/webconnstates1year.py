...
# ##################################################
class WebConnStates1year(Mo):
    """
    A class that represents the most current statistics for web connections state in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStates1year", "web connections state")
    ...
    meta.moClassName = "commWebConnStates1year"
    meta.rnFormat = "CDcommWebConnStates1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current web connections state stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcommWebConnStates1year', False),
    ]
