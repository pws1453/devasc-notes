...
# ##################################################
class WebConnAgHist1qtr(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist1qtr", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist1qtr"
    meta.rnFormat = "HDcommWebConnAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 19354, PropCategory.REGULAR)
