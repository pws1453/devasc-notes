...
# ##################################################
class WebConnStatesHist1mo(Mo):
    """
    A class that represents historical statistics for web connections state in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist1mo", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist1mo"
    meta.rnFormat = "HDcommWebConnStates1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 19401, PropCategory.REGULAR)
