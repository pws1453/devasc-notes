...
class RsKeyRing(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.comm.RsKeyRing", "cobra.model.pki.KeyRing")
    meta.targetNameProps["name"] = "tnPkiKeyRingName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "commRsKeyRing"
    meta.rnFormat = "rsKeyRing"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38117, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40256, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16229, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16226, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnPkiKeyRingName", "tnPkiKeyRingName", 16225, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnPkiKeyRingName", prop)
