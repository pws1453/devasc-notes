...
# ##################################################
class RsWebCommDefault(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comm.RsWebCommDefault", "cobra.model.comm.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "commRsWebCommDefault"
    meta.rnFormat = "rswebCommDefault"
    ...
    meta.parentClasses.add("cobra.model.comm.WebPolCont")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rswebCommDefault', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 20745, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20744, PropCategory.REGULAR)
