...
# ##################################################
class WebConnAgHist1year(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist1year", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist1year"
    meta.rnFormat = "HDcommWebConnAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 19356, PropCategory.REGULAR)
