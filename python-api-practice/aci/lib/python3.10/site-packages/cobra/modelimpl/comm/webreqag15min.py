...
# ##################################################
class WebReqAg15min(Mo):
    """
    A class that represents the most current aggregated statistics for web requests in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqAg15min", "web requests")
    ...
    meta.moClassName = "commWebReqAg15min"
    meta.rnFormat = "CDcommWebReqAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web requests stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.comm.WebReqAg")

    meta.rnPrefixes = [
        ('CDcommWebReqAg15min', False),
    ]
