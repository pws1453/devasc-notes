...
# ##################################################
class WebConnStatesHist15min(Mo):
    """
    A class that represents historical statistics for web connections state in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist15min", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist15min"
    meta.rnFormat = "HDcommWebConnStates15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.comm.WebConnStatesHist")

    meta.rnPrefixes = [
        ('HDcommWebConnStates15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19398, PropCategory.REGULAR)
