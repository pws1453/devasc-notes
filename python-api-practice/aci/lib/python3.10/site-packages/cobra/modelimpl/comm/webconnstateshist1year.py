...
# ##################################################
class WebConnStatesHist1year(Mo):
    """
    A class that represents historical statistics for web connections state in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStatesHist1year", "web connections state")
    ...
    meta.moClassName = "commWebConnStatesHist1year"
    meta.rnFormat = "HDcommWebConnStates1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web connections state stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 19404, PropCategory.REGULAR)
