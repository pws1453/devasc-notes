...
# ##################################################
class WebConnAgHist(Mo):
    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist"


    meta.moClassName = "commWebConnAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats"
    ...
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist1d")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist15min")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist1year")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist1h")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist1w")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist5min")
    meta.concreteSubClasses.add("cobra.model.comm.WebConnAgHist1qtr")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "acceptedCum", "acceptedCum", 19519, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "total accepted connections cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("acceptedCum", prop)

    prop = PropMeta("str", "acceptedPer", "acceptedPer", 19520, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "total accepted connections periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("acceptedPer", prop)

    prop = PropMeta("str", "acceptedRate", "acceptedRate", 19524, PropCategory.IMPLICIT_RATE)
    prop.label = "total accepted connections rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("acceptedRate", prop)

    prop = PropMeta("str", "acceptedSpct", "acceptedSpct", 19521, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "total accepted connections suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("acceptedSpct", prop)

    prop = PropMeta("str", "acceptedThr", "acceptedThr", 19522, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "acceptedTr", "acceptedTr", 19523, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "handledCum", "handledCum", 19604, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "total handled connections cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("handledCum", prop)

    prop = PropMeta("str", "handledPer", "handledPer", 19605, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "total handled connections periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("handledPer", prop)

    prop = PropMeta("str", "handledRate", "handledRate", 19609, PropCategory.IMPLICIT_RATE)
    prop.label = "total handled connections rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("handledRate", prop)

    prop = PropMeta("str", "handledSpct", "handledSpct", 19606, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "total handled connections suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("handledSpct", prop)

    prop = PropMeta("str", "handledThr", "handledThr", 19607, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "handledTr", "handledTr", 19608, PropCategory.IMPLICIT_TREND)
