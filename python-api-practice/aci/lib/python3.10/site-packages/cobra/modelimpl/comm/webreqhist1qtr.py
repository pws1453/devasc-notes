...
# ##################################################
class WebReqHist1qtr(Mo):
    """
    A class that represents historical statistics for web requests in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqHist1qtr", "web requests")
    ...
    meta.moClassName = "commWebReqHist1qtr"
    meta.rnFormat = "HDcommWebReq1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web requests stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 19442, PropCategory.REGULAR)
