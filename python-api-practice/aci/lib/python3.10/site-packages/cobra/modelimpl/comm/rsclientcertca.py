...
# ##################################################
class RsClientCertCA(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comm.RsClientCertCA", "cobra.model.pki.TP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "commRsClientCertCA"
    meta.rnFormat = "rsclientCertCA"
    ...
    meta.rnPrefixes = [
        ('rsclientCertCA', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 42750, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42751, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42745, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 42742, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 50066, PropCategory.REGULAR)
