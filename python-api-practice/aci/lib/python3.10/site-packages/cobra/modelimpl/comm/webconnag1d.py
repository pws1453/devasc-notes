...
# ##################################################
class WebConnAg1d(Mo):
    """
    A class that represents the most current aggregated statistics for web connections in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAg1d", "web connections")
    ...
    meta.moClassName = "commWebConnAg1d"
    meta.rnFormat = "CDcommWebConnAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web connections stats in 1 day"
