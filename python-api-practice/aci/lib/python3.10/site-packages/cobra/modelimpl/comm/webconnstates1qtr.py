...
# ##################################################
class WebConnStates1qtr(Mo):
    """
    A class that represents the most current statistics for web connections state in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStates1qtr", "web connections state")
    ...
    meta.moClassName = "commWebConnStates1qtr"
    meta.rnFormat = "CDcommWebConnStates1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current web connections state stats in 1 quarter"
