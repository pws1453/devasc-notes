...
class RtPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comm.RtPol", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "commRtPol"
    meta.rnFormat = "rtaaaPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12002, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12001, PropCategory.REGULAR)
