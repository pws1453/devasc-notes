...
# ##################################################
class WebConnStates1d(Mo):
    """
    A class that represents the most current statistics for web connections state in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnStates1d", "web connections state")
    ...
    meta.moClassName = "commWebConnStates1d"
    meta.rnFormat = "CDcommWebConnStates1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current web connections state stats in 1 day"
