...
# ##################################################
class WebReqHist1mo(Mo):
    """
    A class that represents historical statistics for web requests in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqHist1mo", "web requests")
    ...
    meta.moClassName = "commWebReqHist1mo"
    meta.rnFormat = "HDcommWebReq1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web requests stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 19441, PropCategory.REGULAR)
