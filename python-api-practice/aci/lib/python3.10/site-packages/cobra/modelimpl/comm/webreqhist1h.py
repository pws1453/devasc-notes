...
# ##################################################
class WebReqHist1h(Mo):
    """
    A class that represents historical statistics for web requests in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqHist1h", "web requests")
    ...
    meta.moClassName = "commWebReqHist1h"
    meta.rnFormat = "HDcommWebReq1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web requests stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 19440, PropCategory.REGULAR)
