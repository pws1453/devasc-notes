...
# ##################################################
class WebReqAg1mo(Mo):
    """
    A class that represents the most current aggregated statistics for web requests in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqAg1mo", "web requests")
    ...
    meta.moClassName = "commWebReqAg1mo"
    meta.rnFormat = "CDcommWebReqAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web requests stats in 1 month"
