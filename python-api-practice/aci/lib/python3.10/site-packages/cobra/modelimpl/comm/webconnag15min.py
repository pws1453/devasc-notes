...
# ##################################################
class WebConnAg15min(Mo):
    """
    A class that represents the most current aggregated statistics for web connections in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAg15min", "web connections")
    ...
    meta.moClassName = "commWebConnAg15min"
    meta.rnFormat = "CDcommWebConnAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web connections stats in 15 minute"
