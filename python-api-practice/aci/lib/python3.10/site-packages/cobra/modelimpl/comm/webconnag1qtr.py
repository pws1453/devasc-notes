...
# ##################################################
class WebConnAg1qtr(Mo):
    """
    A class that represents the most current aggregated statistics for web connections in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAg1qtr", "web connections")
    ...
    meta.moClassName = "commWebConnAg1qtr"
    meta.rnFormat = "CDcommWebConnAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web connections stats in 1 quarter"
