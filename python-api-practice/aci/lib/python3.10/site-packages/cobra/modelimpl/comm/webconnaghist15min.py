...
# ##################################################
class WebConnAgHist15min(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist15min", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist15min"
    meta.rnFormat = "HDcommWebConnAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.comm.WebConnAgHist")

    meta.rnPrefixes = [
        ('HDcommWebConnAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19350, PropCategory.REGULAR)
