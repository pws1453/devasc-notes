...
class SshInst(Mo):
    ...
    meta = ClassMeta("cobra.model.comm.SshInst")

    meta.moClassName = "commSshInst"
    meta.rnFormat = "sshinst"
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 28513, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38602, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40741, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 28511, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "port", "port", 28512, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
