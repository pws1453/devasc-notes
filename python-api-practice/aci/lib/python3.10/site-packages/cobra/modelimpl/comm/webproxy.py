...
class WebProxy(Mo):
    ...
    meta = ClassMeta("cobra.model.comm.WebProxy")

    meta.moClassName = "commWebProxy"
    meta.rnFormat = "wp-%(nodeId)s"
    ...
    prop = PropMeta("str", "ipAddress", "ipAddress", 1291, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 1290, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
