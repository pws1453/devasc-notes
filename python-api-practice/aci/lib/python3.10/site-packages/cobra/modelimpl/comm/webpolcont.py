...
class WebPolCont(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comm.RsWebCommPolRel", "rswebCommPolRel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comm.RsWebCommDefault", "rswebCommDefault"))
