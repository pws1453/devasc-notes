...
# ##################################################
class WebConnAgHist1w(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist1w", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist1w"
    meta.rnFormat = "HDcommWebConnAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 19355, PropCategory.REGULAR)
