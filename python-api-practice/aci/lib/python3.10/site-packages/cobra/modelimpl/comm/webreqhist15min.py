...
# ##################################################
class WebReqHist15min(Mo):
    """
    A class that represents historical statistics for web requests in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqHist15min", "web requests")
    ...
    meta.moClassName = "commWebReqHist15min"
    meta.rnFormat = "HDcommWebReq15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web requests stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 19438, PropCategory.REGULAR)
