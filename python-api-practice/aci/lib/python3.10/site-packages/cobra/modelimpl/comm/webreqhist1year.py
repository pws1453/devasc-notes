...
# ##################################################
class WebReqHist1year(Mo):
    """
    A class that represents historical statistics for web requests in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqHist1year", "web requests")
    ...
    meta.moClassName = "commWebReqHist1year"
    meta.rnFormat = "HDcommWebReq1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web requests stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 19444, PropCategory.REGULAR)
