...
class Http(Mo):
    ...
    meta = ClassMeta("cobra.model.comm.Http")

    meta.moClassName = "commHttp"
    meta.rnFormat = "http"
    meta.category = MoCategory.REGULAR
    meta.label = "HTTP Service"
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 1294, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37531, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cliOnlyMode", "cliOnlyMode", 47671, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39670, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19755, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 1292, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "http"
    ...
    prop = PropMeta("str", "port", "port", 1293, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 80
    prop.defaultValueStr = "80"
    ...
    prop = PropMeta("str", "redirectSt", "redirectSt", 1295, PropCategory.REGULAR)
    prop.label = "Redirect State"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "disabled"
    prop._addConstant("disabled", "disabled", 2)
    prop._addConstant("enabled", "enabled", 1)
    meta.props.add("redirectSt", prop)
    ...
    prop = PropMeta("str", "visoreAccess", "visoreAccess", 35416, PropCategory.REGULAR)
