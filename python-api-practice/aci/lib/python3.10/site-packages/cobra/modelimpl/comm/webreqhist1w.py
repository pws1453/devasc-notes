...
# ##################################################
class WebReqHist1w(Mo):
    """
    A class that represents historical statistics for web requests in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqHist1w", "web requests")
    ...
    meta.moClassName = "commWebReqHist1w"
    meta.rnFormat = "HDcommWebReq1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical web requests stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 19443, PropCategory.REGULAR)
