...
# ##################################################
class RsWebCommPolRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comm.RsWebCommPolRel", "cobra.model.comm.Pol")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "commRsWebCommPolRel"
    meta.rnFormat = "rswebCommPolRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20620, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20619, PropCategory.REGULAR)
