...
# ##################################################
class WebReqAg1year(Mo):
    """
    A class that represents the most current aggregated statistics for web requests in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebReqAg1year", "web requests")
    ...
    meta.moClassName = "commWebReqAg1year"
    meta.rnFormat = "CDcommWebReqAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated web requests stats in 1 year"
