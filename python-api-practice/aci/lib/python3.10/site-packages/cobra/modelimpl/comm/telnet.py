...
class Telnet(Mo):
    ...
    meta = ClassMeta("cobra.model.comm.Telnet")

    meta.moClassName = "commTelnet"
    meta.rnFormat = "telnet"
    meta.category = MoCategory.REGULAR
    meta.label = "Telnet Service"
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 1303, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37533, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39672, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 1301, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "port", "port", 1302, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
