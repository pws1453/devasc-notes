...
# ##################################################
class WebConnAgHist1mo(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist1mo", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist1mo"
    meta.rnFormat = "HDcommWebConnAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 19353, PropCategory.REGULAR)
