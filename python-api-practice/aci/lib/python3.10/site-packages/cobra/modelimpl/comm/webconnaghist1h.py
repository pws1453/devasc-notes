...
# ##################################################
class WebConnAgHist1h(Mo):
    """
    A class that represents historical aggregated statistics for web connections in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.comm.WebConnAgHist1h", "web connections")
    ...
    meta.moClassName = "commWebConnAgHist1h"
    meta.rnFormat = "HDcommWebConnAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated web connections stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 19352, PropCategory.REGULAR)
