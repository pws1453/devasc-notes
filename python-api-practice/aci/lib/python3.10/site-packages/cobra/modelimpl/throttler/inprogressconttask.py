...
# ##################################################
class InProgressContTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.throttler.InProgressContTask")

    meta.moClassName = "throttlerInProgressContTask"
    meta.rnFormat = "throttlerInProgressContTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('throttlerInProgressContTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 23248, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePM", "updatepm", 2059)
