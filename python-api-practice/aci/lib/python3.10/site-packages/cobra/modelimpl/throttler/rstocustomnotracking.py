...
# ##################################################
class RsToCustomNoTracking(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.throttler.RsToCustomNoTracking", "cobra.model.throttler.SubCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "throttlerRsToCustomNoTracking"
    meta.rnFormat = "rstoCustomNoTracking"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22085, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7480
    prop.defaultValueStr = "throttlerSubCont"
    prop._addConstant("throttlerSubCont", None, 7480)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22084, PropCategory.REGULAR)
