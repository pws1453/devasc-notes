...
# ##################################################
class RsIntersiteLbIfToOutRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsIntersiteLbIfToOutRef", "cobra.model.l3ext.OutRef")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l3RsIntersiteLbIfToOutRef"
    meta.rnFormat = "rsintersiteLbIfToOutRef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Intersite LoopBack"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 34296, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 34294, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5331
    prop.defaultValueStr = "l3extOutRef"
    prop._addConstant("l3extOutRef", None, 5331)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34293, PropCategory.REGULAR)
