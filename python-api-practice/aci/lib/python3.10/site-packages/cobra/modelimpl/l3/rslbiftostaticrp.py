...
# ##################################################
class RsLbIfToStaticRP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsLbIfToStaticRP", "cobra.model.pim.StaticRP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l3RsLbIfToStaticRP"
    meta.rnFormat = "rslbIfToStaticRP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 43470, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 43464, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8411
    prop.defaultValueStr = "pimStaticRP"
    prop._addConstant("pimStaticRP", None, 8411)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43463, PropCategory.REGULAR)
