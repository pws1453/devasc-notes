...
class RsIpEppAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l3.RsIpEppAtt", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3RsIpEppAtt"
    meta.rnFormat = "rsipEppAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20977, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20976, PropCategory.REGULAR)
