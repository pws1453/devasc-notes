...
# ##################################################
class RsL3dscpRuleAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsL3dscpRuleAtt", "cobra.model.qosp.DscpRule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3RsL3dscpRuleAtt"
    meta.rnFormat = "rsl3dscpRuleAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DSCP Rule Attachment"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45740, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operStQual", "operStQual", 42198, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "operState", "operState", 42199, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 42208, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("parentSKey", prop)

    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 42210, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("l3:RsL3dscpRuleAttforceResolve_failed_flag", None, 4)
    prop._addConstant("l3:RsL3dscpRuleAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("l3:RsL3dscpRuleAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("l3:RsL3dscpRuleAttmonPolDn_failed_flag", None, 128)
    prop._addConstant("l3:RsL3dscpRuleAttparentSKey_failed_flag", None, 1024)
    prop._addConstant("l3:RsL3dscpRuleAttrType_failed_flag", None, 8)
    prop._addConstant("l3:RsL3dscpRuleAttstateQual_failed_flag", None, 32)
    prop._addConstant("l3:RsL3dscpRuleAttstate_failed_flag", None, 16)
    prop._addConstant("l3:RsL3dscpRuleAtttCl_failed_flag", None, 1)
    prop._addConstant("l3:RsL3dscpRuleAtttDn_failed_flag", None, 2)
    prop._addConstant("l3:RsL3dscpRuleAtttType_failed_flag", None, 64)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 42212, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 42211, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 42201, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2500
    prop.defaultValueStr = "qospDscpRule"
    prop._addConstant("qospDscpRule", None, 2500)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 42200, PropCategory.REGULAR)
