...
# ##################################################
class RsLbIfToLocale(Mo):
    """
    A loopback created for the router ID. This relation is un-enforced because the code tries to access the real-time monitoring tool.

    """

    meta = SourceRelationMeta("cobra.model.l3.RsLbIfToLocale", "cobra.model.fv.Locale")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l3RsLbIfToLocale"
    meta.rnFormat = "rslbIfToLocale-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Router Id"
    ...
    meta.childClasses.add("cobra.model.l3.Cons")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3.Cons", "l3cons-"))
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15165, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12837, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12836, PropCategory.REGULAR)
