...
class FwdCtx(Mo):
    ...
    meta = ClassMeta("cobra.model.l3.FwdCtx")

    meta.moClassName = "l3FwdCtx"
    meta.rnFormat = "fwdctx"
    meta.category = MoCategory.REGULAR
    meta.label = "Forwarding Context"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17654, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 17652, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 17653, PropCategory.REGULAR)
    prop.label = "Operational State Qualifier"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ok"
    prop._addConstant("ok", "ok", 0)
    prop._addConstant("uneq-ext-rmac", "unequal-router-mac-on-external-l3-interfaces", 1)
