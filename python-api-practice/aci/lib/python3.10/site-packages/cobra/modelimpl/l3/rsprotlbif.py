...
class RsProtLbIf(Mo):
    """
    A loopback created for protection groups.

    """

    meta = SourceRelationMeta("cobra.model.l3.RsProtLbIf", "cobra.model.fabric.AProtGEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3RsProtLbIf"
    meta.rnFormat = "rsprotLbIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Protection Group"
    ...
    prop = PropMeta("str", "mode", "mode", 12841, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15167, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12840, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 979
    prop.defaultValueStr = "fabricAProtGEp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12839, PropCategory.REGULAR)
