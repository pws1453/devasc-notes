...
class RsPhysRtdConf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l3.RsPhysRtdConf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "l3RsPhysRtdConf"
    meta.rnFormat = "rsphysRtdConf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Physical Routed Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15152, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12821, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12820, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15151, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
