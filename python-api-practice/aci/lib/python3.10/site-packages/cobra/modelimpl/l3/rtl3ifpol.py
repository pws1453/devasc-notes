...
class RtL3IfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.l3.RtL3IfPol", "cobra.model.fabric.APortPGrp")

    meta.moClassName = "l3RtL3IfPol"
    meta.rnFormat = "rtfabricL3IfPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x2000000001
    meta.readAccessMask = 0x42000000001
    ...
    prop = PropMeta("str", "tCl", "tCl", 33461, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33460, PropCategory.REGULAR)
