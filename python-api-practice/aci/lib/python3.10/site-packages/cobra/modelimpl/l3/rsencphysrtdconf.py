...
# ##################################################
class RsEncPhysRtdConf(Mo):
    """
    A source relation to an abstraction of Ethernet interface properties that are common between Ethernet physical interfaces and aggregated interfaces. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l3.RsEncPhysRtdConf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3RsEncPhysRtdConf"
    meta.rnFormat = "rsencPhysRtdConf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Parent If"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15156, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12824, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12823, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15155, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
