...
# ##################################################
class RsL3dot1pRuleAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsL3dot1pRuleAtt", "cobra.model.qosp.Dot1pRule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3RsL3dot1pRuleAtt"
    meta.rnFormat = "rsl3dot1pRuleAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Dot1p Rule Attachment"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45741, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operStQual", "operStQual", 42192, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "operState", "operState", 42193, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 42206, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("parentSKey", prop)

    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 42213, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("l3:RsL3dot1pRuleAttforceResolve_failed_flag", None, 4)
    prop._addConstant("l3:RsL3dot1pRuleAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("l3:RsL3dot1pRuleAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("l3:RsL3dot1pRuleAttmonPolDn_failed_flag", None, 128)
    prop._addConstant("l3:RsL3dot1pRuleAttparentSKey_failed_flag", None, 1024)
    prop._addConstant("l3:RsL3dot1pRuleAttrType_failed_flag", None, 8)
    prop._addConstant("l3:RsL3dot1pRuleAttstateQual_failed_flag", None, 32)
    prop._addConstant("l3:RsL3dot1pRuleAttstate_failed_flag", None, 16)
    prop._addConstant("l3:RsL3dot1pRuleAtttCl_failed_flag", None, 1)
    prop._addConstant("l3:RsL3dot1pRuleAtttDn_failed_flag", None, 2)
    prop._addConstant("l3:RsL3dot1pRuleAtttType_failed_flag", None, 64)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 42215, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 42214, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 42195, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2501
    prop.defaultValueStr = "qospDot1pRule"
    prop._addConstant("qospDot1pRule", None, 2501)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 42194, PropCategory.REGULAR)
