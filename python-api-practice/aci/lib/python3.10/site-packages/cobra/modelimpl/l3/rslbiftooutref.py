...
# ##################################################
class RsLbIfToOutRef(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.l3.RsLbIfToOutRef", "cobra.model.l3ext.OutRef")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l3RsLbIfToOutRef"
    meta.rnFormat = "rslbIfToOutRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15749, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 15747, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15746, PropCategory.REGULAR)
