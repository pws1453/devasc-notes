...
# ##################################################
class RtSrcToL3OutAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3.RtSrcToL3OutAtt", "cobra.model.oam.Exec")

    meta.moClassName = "l3RtSrcToL3OutAtt"
    meta.rnFormat = "rtoamSrcToL3OutAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Exec"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x420004100001
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 43557, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 43500, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2319
    prop.defaultValueStr = "oamExec"
    ...
    prop = PropMeta("str", "tDn", "tDn", 43499, PropCategory.REGULAR)
