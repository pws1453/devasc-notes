...
# ##################################################
class CtxSubstitute(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3.CtxSubstitute")

    meta.moClassName = "l3CtxSubstitute"
    meta.rnFormat = "ctxsubstitute-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Context"
    meta.writeAccessMask = 0x400000000001
    meta.readAccessMask = 0x708401002003
    ...
    prop = PropMeta("str", "encap", "encap", 21425, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mgmtPcTag", "mgmtPcTag", 21413, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21475, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcEnfPref", "pcEnfPref", 21410, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 21412, PropCategory.REGULAR)
    prop.label = "PC Tag"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("any", "any", 0)
    ...
    prop = PropMeta("str", "type", "type", 21411, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
