...
class RsL3If(Mo):
    """
    The source of the sub-interface/l3-interface.

    """

    meta = SourceRelationMeta("cobra.model.l3.RsL3If", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l3RsL3If"
    meta.rnFormat = "rsl3If-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L3 Interface Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15149, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12818, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12817, PropCategory.REGULAR)
