...
# ##################################################
class RsToLocalCtxSubstitute(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsToLocalCtxSubstitute", "cobra.model.l3.LocalCtxSubstitute")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3RsToLocalCtxSubstitute"
    meta.rnFormat = "rsToLocalCtxSubstitute"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27497, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9273
    prop.defaultValueStr = "l3LocalCtxSubstitute"
    prop._addConstant("l3LocalCtxSubstitute", None, 9273)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27496, PropCategory.REGULAR)
