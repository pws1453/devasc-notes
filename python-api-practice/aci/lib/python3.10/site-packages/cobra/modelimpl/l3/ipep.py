...
class IpEp(Mo):
    ...
    meta = ClassMeta("cobra.model.l3.IpEp")

    meta.moClassName = "l3IpEp"
    meta.rnFormat = "ip-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Desired IP Endpoint"
    ...
    prop = PropMeta("str", "addr", "addr", 19772, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 19774, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "suppress-learn"
    prop._addConstant("suppress-learn", "suppress-learning", 1)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 19773, PropCategory.REGULAR)
