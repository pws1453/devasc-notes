...
# ##################################################
class RsLSubjToDomainRef(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.action.RsLSubjToDomainRef", "cobra.model.aaa.DomainRef")
    meta.targetNameProps["name"] = "tnAaaDomainRefName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "actionRsLSubjToDomainRef"
    meta.rnFormat = "rsLSubjToDomainRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LSubj To AAA Domain Ref"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16382, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnAaaDomainRefName", "tnAaaDomainRefName", 16381, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
