...
class MacEp(Mo):
    ...
    meta = ClassMeta("cobra.model.epm.MacEp")

    meta.moClassName = "epmMacEp"
    meta.rnFormat = "mac-%(addr)s"
    ...
    meta.childClasses.add("cobra.model.epm.RsMacEpToIpEpAtt")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.epm.RsMacEpToIpEpAtt", "rsmacEpToIpEpAtt-"))
    ...
    prop = PropMeta("str", "addr", "addr", 1976, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
