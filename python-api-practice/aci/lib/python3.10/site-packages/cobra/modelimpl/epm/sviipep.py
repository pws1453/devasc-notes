...
class SviIpEp(Mo):
    ...
    meta = ClassMeta("cobra.model.epm.SviIpEp")

    meta.moClassName = "epmSviIpEp"
    meta.rnFormat = "sviIpEp-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 35740, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35744, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSpec", "operSpec", 35741, PropCategory.REGULAR)
    prop.label = "OperSpecifier"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("operSpec", prop)
