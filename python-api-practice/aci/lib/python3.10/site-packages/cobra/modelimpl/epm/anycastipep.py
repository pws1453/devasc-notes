...
# ##################################################
class AnycastIpEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.epm.AnycastIpEp")

    meta.moClassName = "epmAnycastIpEp"
    meta.rnFormat = "AnycastIpEp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Anycast fault IP Endpoint"
    ...
    prop = PropMeta("str", "addr", "addr", 39347, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 39352, PropCategory.REGULAR)
