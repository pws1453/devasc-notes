...
class IpEp(Mo):
    ...
    meta = ClassMeta("cobra.model.epm.IpEp")

    meta.moClassName = "epmIpEp"
    ...
    meta.childClasses.add("cobra.model.epm.RtMacEpToIpEpAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.epm.RtMacEpToIpEpAtt", "rtmacEpToIpEpAtt"))
    ...
    prop = PropMeta("str", "addr", "addr", 1975, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
