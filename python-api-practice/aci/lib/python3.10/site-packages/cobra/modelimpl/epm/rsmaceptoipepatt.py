...
# ##################################################
class RsMacEpToIpEpAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.epm.RsMacEpToIpEpAtt", "cobra.model.epm.IpEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "epmRsMacEpToIpEpAtt"
    meta.rnFormat = "rsmacEpToIpEpAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12580, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2265
    prop.defaultValueStr = "epmIpEp"
    prop._addConstant("epmIpEp", None, 2265)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12579, PropCategory.REGULAR)
