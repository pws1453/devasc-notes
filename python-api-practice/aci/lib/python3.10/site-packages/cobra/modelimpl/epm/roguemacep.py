...
class RogueMacEp(Mo):
    ...
    meta = ClassMeta("cobra.model.epm.RogueMacEp")

    meta.moClassName = "epmRogueMacEp"
    meta.rnFormat = "rogueMacEP-%(addr)s"
    meta.category = MoCategory.REGULAR
    meta.label = "MAC Endpoint"
    ...
    meta.superClasses.add("cobra.model.epm.EpRec")
    meta.superClasses.add("cobra.model.epm.Rec")
    ...
    prop = PropMeta("str", "addr", "addr", 37022, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "createTs", "createTs", 1974, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "flags", "flags", 1973, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ifId", "ifId", 1972, PropCategory.REGULAR)
    prop.label = "Path"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37042, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 21174, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prevIfInfo", "prevIfInfo", 54695, PropCategory.REGULAR)
    prop.label = "PreviousInterfaceInfo"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("prevIfInfo", prop)
