...
class RogueIpEp(Mo):
    ...
    meta = ClassMeta("cobra.model.epm.RogueIpEp")

    meta.moClassName = "epmRogueIpEp"
    meta.rnFormat = "rogueIpEp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Endpoint"
    ...
    prop = PropMeta("str", "addr", "addr", 35739, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37040, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prevIfInfo", "prevIfInfo", 54694, PropCategory.REGULAR)
