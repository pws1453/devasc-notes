...
class Entity(Mo):
    """
    Holds entity information for the atomic counters control plane.

    """

    meta = ClassMeta("cobra.model.ac.Entity")

    meta.moClassName = "acEntity"
    meta.rnFormat = "ac"
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counters Entity"
    ...
    meta.childClasses.add("cobra.model.ac.RuleIp")
    meta.childClasses.add("cobra.model.ac.LatencyPtpModeDef")
    meta.childClasses.add("cobra.model.ac.RuleArp")
    meta.childClasses.add("cobra.model.ac.LatencyInst")
    meta.childClasses.add("cobra.model.ac.RuleMac")

    meta.childNamesAndRnPrefix.append(("cobra.model.ac.LatencyPtpModeDef", "latencyptpmodedef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ac.LatencyInst", "latencyinst"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ac.RuleArp", "ruleArp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ac.RuleMac", "ruleMac-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ac.RuleIp", "ruleIp-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18593, PropCategory.REGULAR)
