...
class RuleArp(Mo):
    ...
    meta = ClassMeta("cobra.model.ac.RuleArp")

    meta.moClassName = "acRuleArp"
    meta.rnFormat = "ruleArp-%(ruleId)s"
    ...
    prop = PropMeta("str", "opc", "opc", 2241, PropCategory.REGULAR)
    prop.label = "Opcode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ruleId", "ruleId", 5780, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "senderIp", "senderIp", 2243, PropCategory.REGULAR)
    prop.label = "Sender IP"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("senderIp", prop)

    prop = PropMeta("str", "senderMac", "senderMac", 2242, PropCategory.REGULAR)
    prop.label = "Sender MAC"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("dont-care", "wildcard-mac", 0)
    meta.props.add("senderMac", prop)
    ...
    prop = PropMeta("str", "targetIp", "targetIp", 2245, PropCategory.REGULAR)
    prop.label = "Target IP"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("targetIp", prop)

    prop = PropMeta("str", "targetMac", "targetMac", 2244, PropCategory.REGULAR)
    prop.label = "Target MAC"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("dont-care", "wildcard-mac", 0)
    meta.props.add("targetMac", prop)
