...
class RsRtDstAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.rtmap.RsRtDstAtt", "cobra.model.rtpfx.Rule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "rtmapRsRtDstAtt"
    meta.rnFormat = "rsrtDstAtt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.rtmap.MatchRtDst")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12806, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15141, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
