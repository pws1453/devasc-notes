...
class RsRtNhAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.rtmap.RsRtNhAtt", "cobra.model.rtpfx.Rule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "rtmapRsRtNhAtt"
    meta.rnFormat = "rsrtNhAtt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.rtmap.MatchRtNh")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12809, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12808, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15143, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
