...
class RsRtSrcAtt(Mo):
    """
    A source relation to the route control rule for prefix lists.

    """

    meta = SourceRelationMeta("cobra.model.rtmap.RsRtSrcAtt", "cobra.model.rtpfx.Rule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "rtmapRsRtSrcAtt"
    meta.rnFormat = "rsrtSrcAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Prefix List Attachment"
    ...
    meta.parentClasses.add("cobra.model.rtmap.MatchRtSrc")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12812, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3367
    prop.defaultValueStr = "rtpfxRule"
    prop._addConstant("rtpfxRule", None, 3367)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12811, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15145, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
