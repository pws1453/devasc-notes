...
# ##################################################
class RsExtCommAtt(Mo):
    """
    A source relation to the route control rule for extended community lists.

    """

    meta = SourceRelationMeta("cobra.model.rtmap.RsExtCommAtt", "cobra.model.rtextcom.Rule")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "rtmapRsExtCommAtt"
    meta.rnFormat = "rsextCommAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Extended Community Attachment"
    ...
    meta.parentClasses.add("cobra.model.rtmap.MatchExtComm")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12803, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3588
    prop.defaultValueStr = "rtextcomRule"
    prop._addConstant("rtextcomRule", None, 3588)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12802, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15139, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
