...
class Continue(Mo):
    ...
    meta = ClassMeta("cobra.model.rtmap.Continue")

    meta.moClassName = "rtmapContinue"
    meta.rnFormat = "cont"
    meta.category = MoCategory.REGULAR
    meta.label = "Continue Seq"
    ...
    prop = PropMeta("str", "order", "order", 62602, PropCategory.REGULAR)
    prop.label = "Order"
    prop.isImplicit = True
    prop.isAdmin = True
