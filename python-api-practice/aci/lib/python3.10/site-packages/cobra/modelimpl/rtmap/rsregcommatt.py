...
# ##################################################
class RsRegCommAtt(Mo):
    """
    A source relation to the route control rule for regular community lists.

    """

    meta = SourceRelationMeta("cobra.model.rtmap.RsRegCommAtt", "cobra.model.rtregcom.Rule")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "rtmapRsRegCommAtt"
    meta.rnFormat = "rsregCommAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Regular Community Attachment"
    ...
    meta.parentClasses.add("cobra.model.rtmap.MatchRegComm")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12800, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3373
    prop.defaultValueStr = "rtregcomRule"
    prop._addConstant("rtregcomRule", None, 3373)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12799, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15137, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
