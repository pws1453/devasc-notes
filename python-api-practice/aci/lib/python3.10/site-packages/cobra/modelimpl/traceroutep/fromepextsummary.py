...
# ##################################################
class FromEpExtSummary(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.traceroutep.FromEpExtSummary")

    meta.moClassName = "traceroutepFromEpExtSummary"
    meta.rnFormat = "srcepext-[%(epDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of Source EP Mo"
    ...
    meta.superClasses.add("cobra.model.traceroutep.TrEpSummary")
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 23562, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdDn", prop)

    prop = PropMeta("str", "bdSeg", "bdSeg", 23561, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "encap", "encap", 23557, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "epDn", "epDn", 26128, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("epDn", prop)

    prop = PropMeta("str", "ipAddr", "ipAddr", 23559, PropCategory.REGULAR)
    prop.label = "IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipAddr", prop)

    prop = PropMeta("str", "ipSubnet", "ipSubnet", 23563, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 23560, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "epDn"))
    getattr(meta.props, "epDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, epDn, markDirty=True, **creationProps):
        namingVals = [epDn]
