...
# ##################################################
class TrExtSummary(Mo):
    meta = ClassMeta("cobra.model.traceroutep.TrExtSummary")

    meta.isAbstract = True
    meta.moClassName = "traceroutepTrExtSummary"


    meta.moClassName = "traceroutepTrExtSummary"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of TrExt Mo"
    ...
    meta.concreteSubClasses.add("cobra.model.traceroutep.FromExtEpSummary")
    meta.concreteSubClasses.add("cobra.model.traceroutep.FromExtExtSummary")
    ...
    prop = PropMeta("str", "l3extOutDn", "l3extOutDn", 43489, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
