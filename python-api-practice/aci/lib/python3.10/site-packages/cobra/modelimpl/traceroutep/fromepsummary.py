...
# ##################################################
class FromEpSummary(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.traceroutep.FromEpSummary")

    meta.moClassName = "traceroutepFromEpSummary"
    meta.rnFormat = "srcep-[%(epDn)s]"
    ...
    prop = PropMeta("str", "epDn", "epDn", 23564, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
