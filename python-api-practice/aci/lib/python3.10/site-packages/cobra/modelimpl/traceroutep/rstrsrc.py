...
class RsTrSrc(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrSrc", "cobra.model.top.System")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "traceroutepRsTrSrc"
    meta.rnFormat = "rstrSrc-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Source Node"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37824, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39963, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "srcId", "srcId", 13082, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    meta.props.add("srcId", prop)

    prop = PropMeta("str", "srcIp", "srcIp", 13083, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 13081, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13080, PropCategory.REGULAR)
