...
class TrEpNode(Mo):
    ...
    meta = ClassMeta("cobra.model.traceroutep.TrEpNode")

    meta.moClassName = "traceroutepTrEpNode"
    meta.rnFormat = "trEpNode-%(epNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Traceroute Endpoint Node Info"
    ...
    meta.parentClasses.add("cobra.model.traceroutep.FromEpExtSummary")
    meta.parentClasses.add("cobra.model.traceroutep.ToEpSummary")
    ...
    meta.parentClasses.add("cobra.model.traceroutep.FromEpSummary")
    meta.parentClasses.add("cobra.model.traceroutep.FromExtExtSummary")
    ...
    meta.parentClasses.add("cobra.model.traceroutep.ToExtEpSummary")
    meta.parentClasses.add("cobra.model.traceroutep.FromExtEpSummary")
    ...
    prop = PropMeta("str", "adminState", "adminState", 18568, PropCategory.REGULAR)
    prop.label = "State of the deployment"
    ...
    prop = PropMeta("str", "epNodeId", "epNodeId", 18567, PropCategory.REGULAR)
    prop.label = "EP Node ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.props.add("epNodeId", prop)

    prop = PropMeta("str", "fabricPathEpDn", "fabricPathEpDn", 19081, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("fabricPathEpDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "epNodeId"))
    ...
    def __init__(self, parentMoOrDn, epNodeId, markDirty=True, **creationProps):
        namingVals = [epNodeId]
