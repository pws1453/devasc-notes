...
class RsTrDst(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37825, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstId", "dstId", 13076, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    meta.props.add("dstId", prop)

    prop = PropMeta("str", "dstIp", "dstIp", 13077, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("dstIp", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39964, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13075, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13074, PropCategory.REGULAR)
