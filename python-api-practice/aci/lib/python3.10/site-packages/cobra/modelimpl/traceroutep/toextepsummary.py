...
# ##################################################
class ToExtEpSummary(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.traceroutep.ToExtEpSummary")

    meta.moClassName = "traceroutepToExtEpSummary"
    meta.rnFormat = "dstextep-[%(epDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of Destination EP Mo"
    ...
    prop = PropMeta("str", "epDn", "epDn", 43494, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
