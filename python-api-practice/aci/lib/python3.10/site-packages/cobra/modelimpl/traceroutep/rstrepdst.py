...
class RsTrEpDst(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrEpDst", "cobra.model.fv.CEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "traceroutepRsTrEpDst"
    meta.rnFormat = "rstrEpDst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37822, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 21209, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdDn", prop)

    prop = PropMeta("str", "bdSeg", "bdSeg", 15571, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "encap", "encap", 25181, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39961, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ipAddr", "ipAddr", 13054, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipAddr", prop)

    prop = PropMeta("str", "ipSubnet", "ipSubnet", 19897, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 13055, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13053, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2033
    prop.defaultValueStr = "fvCEp"
    prop._addConstant("fvCEp", None, 2033)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13052, PropCategory.REGULAR)
