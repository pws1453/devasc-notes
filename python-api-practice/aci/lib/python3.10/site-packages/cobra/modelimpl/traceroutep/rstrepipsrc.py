...
# ##################################################
class RsTrEpIpSrc(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrEpIpSrc", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "traceroutepRsTrEpIpSrc"
    meta.rnFormat = "rstrEpIpSrc-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Source End Point"
    ...
    meta.childClasses.add("cobra.model.traceroutep.TrEpNode")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.traceroutep.TrEpNode", "trEpNode-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38107, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 21211, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdDn", prop)

    prop = PropMeta("str", "bdSeg", "bdSeg", 15833, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdSeg", prop)
    ...
    prop = PropMeta("str", "encap", "encap", 16279, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40246, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fabricPathEpDn", "fabricPathEpDn", 16280, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ipAddr", "ipAddr", 15834, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipAddr", prop)

    prop = PropMeta("str", "ipSubnet", "ipSubnet", 19899, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipSubnet", prop)
    ...
    prop = PropMeta("str", "mac", "mac", 15835, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15844, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "nodeId", "nodeId", 15836, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 15832, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5205
    prop.defaultValueStr = "fvIp"
    prop._addConstant("fvIp", None, 5205)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15831, PropCategory.REGULAR)
