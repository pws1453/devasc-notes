...
# ##################################################
class RsTrExtEpSrcToFvIfConn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrExtEpSrcToFvIfConn", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "traceroutepRsTrExtEpSrcToFvIfConn"
    meta.rnFormat = "rstrExtEpSrcToFvIfConn"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43510, PropCategory.REGULAR)
