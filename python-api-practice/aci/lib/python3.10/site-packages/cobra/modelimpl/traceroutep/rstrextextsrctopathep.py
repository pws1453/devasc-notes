...
# ##################################################
class RsTrExtExtSrcToPathEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrExtExtSrcToPathEp", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "traceroutepRsTrExtExtSrcToPathEp"
    meta.rnFormat = "rstrExtExtSrcToPathEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Traceroute Source to Path Endpoint"
    ...
    meta.rnPrefixes = [
        ('rstrExtExtSrcToPathEp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43554, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43555, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 43529, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43528, PropCategory.REGULAR)
