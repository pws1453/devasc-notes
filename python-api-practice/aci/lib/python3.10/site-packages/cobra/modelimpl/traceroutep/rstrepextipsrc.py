...
# ##################################################
class RsTrEpExtIpSrc(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrEpExtIpSrc", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "traceroutepRsTrEpExtIpSrc"
    meta.rnFormat = "rstrEpExtIpSrc"
    ...
    meta.rnPrefixes = [
        ('rstrEpExtIpSrc', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38226, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdSeg", "bdSeg", 19065, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "encap", "encap", 19066, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40365, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fabricPathEpDn", "fabricPathEpDn", 19067, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ipAddr", "ipAddr", 19068, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 19069, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19076, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "nodeId", "nodeId", 19070, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 19072, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19071, PropCategory.REGULAR)
