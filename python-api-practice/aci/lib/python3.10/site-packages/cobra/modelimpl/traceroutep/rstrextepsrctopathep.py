...
# ##################################################
class RsTrExtEpSrcToPathEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrExtEpSrcToPathEp", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "traceroutepRsTrExtEpSrcToPathEp"
    meta.rnFormat = "rstrExtEpSrcToPathEp-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstrExtEpSrcToPathEp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43548, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43549, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 43515, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43514, PropCategory.REGULAR)
