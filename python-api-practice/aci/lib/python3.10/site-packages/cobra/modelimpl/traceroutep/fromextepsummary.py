...
# ##################################################
class FromExtEpSummary(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.traceroutep.FromExtEpSummary")

    meta.moClassName = "traceroutepFromExtEpSummary"
    meta.rnFormat = "srcextep-[%(l3extOutDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of Source Ext Mo for ExtEp"
    ...
    prop = PropMeta("str", "l3extOutDn", "l3extOutDn", 43492, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
