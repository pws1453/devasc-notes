...
# ##################################################
class RsTrExtExtl3extOutSrc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrExtExtl3extOutSrc", "cobra.model.l3ext.Out")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "traceroutepRsTrExtExtl3extOutSrc"
    meta.rnFormat = "rstrExtExtl3extOutSrc"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Traceroute Source to l3extOut"
    ...
    meta.rnPrefixes = [
        ('rstrExtExtl3extOutSrc', False),
    ]

    prop = PropMeta("str", "addr", "addr", 43532, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 43552, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 43533, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43553, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "owner", "owner", 43534, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 43536, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1770
    prop.defaultValueStr = "l3extOut"
    prop._addConstant("l3extOut", None, 1770)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43535, PropCategory.REGULAR)
