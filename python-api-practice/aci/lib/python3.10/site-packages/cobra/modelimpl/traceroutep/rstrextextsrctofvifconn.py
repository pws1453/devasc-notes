...
# ##################################################
class RsTrExtExtSrcToFvIfConn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrExtExtSrcToFvIfConn", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "traceroutepRsTrExtExtSrcToFvIfConn"
    meta.rnFormat = "rstrExtExtSrcToFvIfConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Traceroute Source to  external L3 interface"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43525, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43524, PropCategory.REGULAR)
