...
# ##################################################
class FromExtExtSummary(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.traceroutep.FromExtExtSummary")

    meta.moClassName = "traceroutepFromExtExtSummary"
    meta.rnFormat = "srcextext-[%(l3extOutDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of Source Ext Mo for ExtExt"
    ...
    meta.superClasses.add("cobra.model.traceroutep.TrExtSummary")
    ...
    prop = PropMeta("str", "addr", "addr", 43490, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "encap", "encap", 43491, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "l3extOutDn", "l3extOutDn", 43493, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("l3extOutDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "l3extOutDn"))
    getattr(meta.props, "l3extOutDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, l3extOutDn, markDirty=True, **creationProps):
        namingVals = [l3extOutDn]
