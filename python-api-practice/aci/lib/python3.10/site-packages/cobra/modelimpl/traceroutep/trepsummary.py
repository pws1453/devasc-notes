...
# ##################################################
class TrEpSummary(Mo):
    meta = ClassMeta("cobra.model.traceroutep.TrEpSummary")

    meta.isAbstract = True
    meta.moClassName = "traceroutepTrEpSummary"


    meta.moClassName = "traceroutepTrEpSummary"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Summary of TrEP Mo"
    ...
    meta.concreteSubClasses.add("cobra.model.traceroutep.FromEpExtSummary")
    meta.concreteSubClasses.add("cobra.model.traceroutep.FromEpSummary")
    meta.concreteSubClasses.add("cobra.model.traceroutep.ToEpSummary")
    meta.concreteSubClasses.add("cobra.model.traceroutep.ToExtEpSummary")
    ...
    prop = PropMeta("str", "epDn", "epDn", 23558, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
