...
# ##################################################
class RsTrEpIpDst(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrEpIpDst", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "traceroutepRsTrEpIpDst"
    meta.rnFormat = "rstrEpIpDst-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Relation to Destination End Point"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38108, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 21210, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdDn", prop)

    prop = PropMeta("str", "bdSeg", "bdSeg", 15826, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "encap", "encap", 25182, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40247, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ipAddr", "ipAddr", 15827, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipAddr", prop)

    prop = PropMeta("str", "ipSubnet", "ipSubnet", 19898, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 15828, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15845, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15825, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15824, PropCategory.REGULAR)
