...
# ##################################################
class RsTrExtEpl3extOutSrc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrExtEpl3extOutSrc", "cobra.model.l3ext.Out")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "traceroutepRsTrExtEpl3extOutSrc"
    meta.rnFormat = "rstrExtEpl3extOutSrc-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstrExtEpl3extOutSrc-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 43518, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 43546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 43519, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43547, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "owner", "owner", 43520, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 43522, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43521, PropCategory.REGULAR)
