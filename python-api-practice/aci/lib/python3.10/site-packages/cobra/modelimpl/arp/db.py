...
class Db(Mo):
    """
    The ARP database. This contains all information owned by the ARP process, such as dynamic adjacency and arp statistics.

    """

    meta = ClassMeta("cobra.model.arp.Db")

    meta.moClassName = "arpDb"
    ...
    meta.childClasses.add("cobra.model.arp.AdjEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.arp.AdjEp", "adj-"))
    ...
    prop = PropMeta("str", "type", "type", 2431, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ip", "ip-database", 1)
