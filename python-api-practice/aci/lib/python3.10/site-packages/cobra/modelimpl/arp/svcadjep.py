...
class SvcAdjEp(Mo):
    ...
    meta = ClassMeta("cobra.model.arp.SvcAdjEp")

    meta.moClassName = "arpSvcAdjEp"
    meta.rnFormat = "svcadj-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ARP Service Adjacency"
    ...
    meta.childClasses.add("cobra.model.svcredir.EpPRedirPolCons")
    meta.childClasses.add("cobra.model.arp.Sla")

    meta.childNamesAndRnPrefix.append(("cobra.model.svcredir.EpPRedirPolCons", "epPRedirPolCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.arp.Sla", "sladn-"))

    meta.parentClasses.add("cobra.model.arp.CktEp")
    meta.parentClasses.add("cobra.model.arp.BD")
    ...
    prop = PropMeta("str", "ip", "ip", 20777, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "operSt", "operSt", 20774, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 20775, PropCategory.REGULAR)
