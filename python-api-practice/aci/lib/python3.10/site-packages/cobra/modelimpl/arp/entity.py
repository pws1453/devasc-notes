...
class Entity(Mo):
    """
    Represents ARP control plane entity information.

    """

    meta = ClassMeta("cobra.model.arp.Entity")

    meta.moClassName = "arpEntity"
    meta.rnFormat = "arp"
    meta.category = MoCategory.REGULAR
    meta.label = "ARP Entity"
    ...
    meta.childClasses.add("cobra.model.arp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.arp.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14432, PropCategory.REGULAR)
