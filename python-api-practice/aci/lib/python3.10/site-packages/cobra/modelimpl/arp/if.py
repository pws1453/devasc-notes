...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.arp.If")

    meta.moClassName = "arpIf"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ARP Interface"
    ...
    meta.childClasses.add("cobra.model.arp.IfStatsMisc")
    meta.childClasses.add("cobra.model.arp.StAdjEp")
    meta.childClasses.add("cobra.model.arp.IfStatsTx")
    meta.childClasses.add("cobra.model.arp.IfStatsAdj")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")
    meta.childClasses.add("cobra.model.arp.IfStatsRx")

    meta.childNamesAndRnPrefix.append(("cobra.model.arp.IfStatsMisc", "ifstatsmisc"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.arp.IfStatsAdj", "ifstatsadj"))
    meta.childNamesAndRnPrefix.append(("cobra.model.arp.IfStatsTx", "ifstatstx"))
    meta.childNamesAndRnPrefix.append(("cobra.model.arp.IfStatsRx", "ifstatsrx"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.arp.StAdjEp", "sadj-"))
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 45446, PropCategory.REGULAR)
    prop.label = "Interface controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("garp-adj-enable", "enable-garp-based-adjacency-create", 1)
    ...
    prop = PropMeta("str", "id", "id", 5871, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14431, PropCategory.REGULAR)
