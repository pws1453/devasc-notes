...
class RtArpIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.arp.RtArpIfPol", "cobra.model.l3ext.LIfP")

    meta.moClassName = "arpRtArpIfPol"
    meta.rnFormat = "rtl3extArpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52104, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 52103, PropCategory.REGULAR)
