...
class InstStats(Mo):
    """
     This objects hold per Instance statistics operational information. This is a singleton within Instance 

    """

    meta = ClassMeta("cobra.model.mldsnoop.InstStats")

    meta.moClassName = "mldsnoopInstStats"
