...
class StRtrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.mldsnoop.StRtrIf")

    meta.moClassName = "mldsnoopStRtrIf"
    meta.rnFormat = "strtrif-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "MLD Static Router Interface"
    meta.writeAccessMask = 0xc00c030060001
    meta.readAccessMask = 0xc00c030060001
    ...
    meta.superClasses.add("cobra.model.ipmcsnoop.If")
    ...
    meta.superClasses.add("cobra.model.ipmcsnoop.StRtrIf")
    ...
    prop = PropMeta("str", "encap", "encap", 16903, PropCategory.REGULAR)
    prop.label = "Encapsulation"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "id", "id", 17470, PropCategory.REGULAR)
