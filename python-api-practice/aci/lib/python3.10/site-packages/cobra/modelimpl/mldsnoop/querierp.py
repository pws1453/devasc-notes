...
class QuerierP(Mo):
    ...
    meta = ClassMeta("cobra.model.mldsnoop.QuerierP")

    meta.moClassName = "mldsnoopQuerierP"
    meta.rnFormat = "querierp"
    meta.category = MoCategory.REGULAR
    meta.label = "Querier Policy"
    ...
    prop = PropMeta("str", "ver", "ver", 16976, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
