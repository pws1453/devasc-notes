...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.mldsnoop.Entity")

    meta.moClassName = "mldsnoopEntity"
    meta.rnFormat = "mldsnoop"
    meta.category = MoCategory.REGULAR
    meta.label = "MLD Snooping Entity"
    ...
    meta.childClasses.add("cobra.model.mldsnoop.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mldsnoop.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47382, PropCategory.REGULAR)
