...
class Inst(Mo):
    """
     This objects hold per mld instance information. There is only one instance of mld running in the system today 

    """

    meta = ClassMeta("cobra.model.mldsnoop.Inst")

    meta.moClassName = "mldsnoopInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "MLD Snooping Instance"
    ...
    meta.childClasses.add("cobra.model.mldsnoop.Dom")
    meta.childClasses.add("cobra.model.mldsnoop.InstStats")

    meta.childNamesAndRnPrefix.append(("cobra.model.mldsnoop.InstStats", "inststats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mldsnoop.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.mldsnoop.Entity")

    meta.superClasses.add("cobra.model.nw.Conn")
    meta.superClasses.add("cobra.model.l3.ProtInst")
    meta.superClasses.add("cobra.model.ipmcsnoop.Inst")
    ...
    prop = PropMeta("str", "allRtrMcastEncap", "allRtrMcastEncap", 16943, PropCategory.REGULAR)
    prop.label = "All Router Multicast Encapsulation"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("allRtrMcastEncap", prop)
    ...
    prop = PropMeta("str", "flags", "flags", 16944, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    prop._addConstant("fabric-learn-disabled", "fabric-learning-disabled", 2)
    prop._addConstant("local-learn-disabled", "local-learning-disabled", 1)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47383, PropCategory.REGULAR)
