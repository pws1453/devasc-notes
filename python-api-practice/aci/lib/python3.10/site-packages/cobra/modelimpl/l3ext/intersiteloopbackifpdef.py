...
# ##################################################
class IntersiteLoopBackIfPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.IntersiteLoopBackIfPDef")

    meta.moClassName = "l3extIntersiteLoopBackIfPDef"
    meta.rnFormat = "sitelbpdef-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 34292, PropCategory.REGULAR)
