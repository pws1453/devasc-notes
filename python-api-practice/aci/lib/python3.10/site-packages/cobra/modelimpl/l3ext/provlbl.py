...
class ProvLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.ProvLbl")

    meta.moClassName = "l3extProvLbl"
    meta.rnFormat = "provlbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Connectivity Provider Label"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38318, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40457, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 21429, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
