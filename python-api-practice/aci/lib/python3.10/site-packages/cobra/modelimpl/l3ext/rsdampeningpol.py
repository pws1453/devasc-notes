...
# ##################################################
class RsDampeningPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsDampeningPol", "cobra.model.rtctrl.Profile")
    meta.targetNameProps["name"] = "tnRtctrlProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsDampeningPol"
    meta.rnFormat = "rsdampeningPol-[%(tnRtctrlProfileName)s]-%(af)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L3 Out Dampening Policy"
    ...
    prop = PropMeta("str", "af", "af", 23585, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 38416, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40555, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23588, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnRtctrlProfileName", "tnRtctrlProfileName", 23586, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, tnRtctrlProfileName, af, markDirty=True, **creationProps):
        namingVals = [tnRtctrlProfileName, af]
