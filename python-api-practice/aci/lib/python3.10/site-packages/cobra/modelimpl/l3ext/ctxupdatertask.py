...
# ##################################################
class CtxUpdaterTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.CtxUpdaterTask")

    meta.moClassName = "l3extCtxUpdaterTask"
    meta.rnFormat = "l3extCtxUpdaterTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 22216, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CtxEncapAllocatorUpd", "ctxencapallocatorupd", 1941)
