...
# ##################################################
class RtOutDefContToOutTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.RtOutDefContToOutTask")

    meta.moClassName = "l3extRtOutDefContToOutTask"
    meta.rnFormat = "l3extRtOutDefContToOutTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('l3extRtOutDefContToOutTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 33066, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RoutePeering", "routepeering", 2723)
