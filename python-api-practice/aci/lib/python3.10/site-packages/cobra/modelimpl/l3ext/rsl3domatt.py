...
class RsL3DomAtt(Mo):
    """
    A source relation to the outside domain advertising these prefixes and relationship to the L2 domain for external SWI.

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsL3DomAtt", "cobra.model.extnw.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsL3DomAtt"
    meta.rnFormat = "rsl3DomAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Domain Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37607, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39746, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14209, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12097, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12096, PropCategory.REGULAR)
