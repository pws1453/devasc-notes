...
# ##################################################
class RtInfraOutExp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtInfraOutExp", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "l3extRtInfraOutExp"
    meta.rnFormat = "rtinfraOutExp"
    ...
    meta.parentClasses.add("cobra.model.l3ext.InfraOutExp")
    ...
    prop = PropMeta("str", "tCl", "tCl", 21447, PropCategory.REGULAR)
