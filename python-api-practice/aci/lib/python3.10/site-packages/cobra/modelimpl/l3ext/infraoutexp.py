...
# ##################################################
class InfraOutExp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.InfraOutExp")

    meta.moClassName = "l3extInfraOutExp"
    meta.rnFormat = "infraoutexp-[%(instPDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Infra Outside policy Export"
    ...
    meta.childClasses.add("cobra.model.l3ext.RtInfraOutExp")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtInfraOutExp", "rtinfraOutExp"))
    ...
    prop = PropMeta("str", "instPDn", "instPDn", 21389, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("instPDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "instPDn"))
    getattr(meta.props, "instPDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, instPDn, markDirty=True, **creationProps):
        namingVals = [instPDn]
