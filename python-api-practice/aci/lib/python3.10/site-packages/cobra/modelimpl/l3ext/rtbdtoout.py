...
class RtBDToOut(Mo):
    """
    A target relation to the policy controlling layer 3 connectivity to outside.

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtBDToOut", "cobra.model.fv.ABDPol")

    meta.moClassName = "l3extRtBDToOut"
    meta.rnFormat = "rtfvBDToOut-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12167, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12166, PropCategory.REGULAR)
