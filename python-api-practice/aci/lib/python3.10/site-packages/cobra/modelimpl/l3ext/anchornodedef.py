...
# ##################################################
class AnchorNodeDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.AnchorNodeDef")

    meta.moClassName = "l3extAnchorNodeDef"
    meta.rnFormat = "anchornodedef"
    meta.category = MoCategory.REGULAR
    meta.label = "Anchor Node Def Mo"
