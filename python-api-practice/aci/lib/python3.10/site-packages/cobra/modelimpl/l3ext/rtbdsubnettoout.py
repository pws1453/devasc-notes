...
# ##################################################
class RtBDSubnetToOut(Mo):
    """
    A target relation to the layer 3 routed outside.

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtBDSubnetToOut", "cobra.model.fv.Subnet")

    meta.moClassName = "l3extRtBDSubnetToOut"
    meta.rnFormat = "rtfvBDSubnetToOut-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Subnet"
    meta.writeAccessMask = 0x1000001
    meta.readAccessMask = 0x6000008021041701
    ...
    prop = PropMeta("str", "tCl", "tCl", 12146, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12145, PropCategory.REGULAR)
