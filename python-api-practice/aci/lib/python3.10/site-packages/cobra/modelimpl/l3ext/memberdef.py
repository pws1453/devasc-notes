...
class MemberDef(Mo):
    """
    The member definition. The member is used for providing per node IP address configuration. This is used internally.

    """

    meta = ClassMeta("cobra.model.l3ext.MemberDef")

    meta.moClassName = "l3extMemberDef"
    meta.rnFormat = "mem-%(side)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Member Node Configuration Definition"
    ...
    prop = PropMeta("str", "side", "side", 6865, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
