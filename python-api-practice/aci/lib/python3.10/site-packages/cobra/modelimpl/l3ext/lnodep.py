...
class LNodeP(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.LNodeP")

    meta.moClassName = "l3extLNodeP"
    meta.rnFormat = "lnodep-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Node Profile"
    ...
    meta.childClasses.add("cobra.model.l3ext.RsNodeL3OutAtt")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.bgp.ProtP")
    ...
    meta.childClasses.add("cobra.model.l3ext.LIfP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.bgp.InfraPeerP")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsNodeL3OutAtt", "rsnodeL3OutAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.ProtP", "protp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasInst", "alias"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.LIfP", "lifp-"))
    ...
    meta.superClasses.add("cobra.model.l3ext.ALNodeP")
    meta.superClasses.add("cobra.model.pol.Lbl")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.extnw.ALNodeP")

    meta.rnPrefixes = [
        ('lnodep-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37610, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 23342, PropCategory.REGULAR)
    prop.label = "Node Path Misconfiguration"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39749, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14213, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6862, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 1627, PropCategory.REGULAR)
