...
class RsEctx(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsEctx", "cobra.model.fv.Ctx")
    meta.targetNameProps["name"] = "tnFvCtxName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsEctx"
    meta.rnFormat = "rsectx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37606, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39745, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14208, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvCtxName", "tnFvCtxName", 12092, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
