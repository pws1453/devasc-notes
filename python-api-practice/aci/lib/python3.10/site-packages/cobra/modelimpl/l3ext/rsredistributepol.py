...
# ##################################################
class RsRedistributePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsRedistributePol", "cobra.model.rtctrl.Profile")
    meta.targetNameProps["name"] = "tnRtctrlProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsRedistributePol"
    meta.rnFormat = "rsredistributePol-[%(tnRtctrlProfileName)s]-%(src)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Context Policy for OSPF, EIGRP or Static Routes Redistribution"
    ...
    meta.rnPrefixes = [
        ('rsredistributePol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 54517, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54518, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54515, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 54509, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("static", "static", 0)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnRtctrlProfileName", "tnRtctrlProfileName", 54510, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, tnRtctrlProfileName, src, markDirty=True, **creationProps):
        namingVals = [tnRtctrlProfileName, src]
