...
class RsNdIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsNdIfPol", "cobra.model.nd.IfPol")
    meta.targetNameProps["name"] = "tnNdIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsNdIfPol"
    meta.rnFormat = "rsNdIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38187, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40326, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18202, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18195, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNdIfPolName", "tnNdIfPolName", 18194, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
