...
class RsBgpAsP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l3ext.RsBgpAsP", "cobra.model.bgp.AsP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsBgpAsP"
    meta.rnFormat = "rsbgpAsP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18656, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 637
    prop.defaultValueStr = "bgpAsP"
    prop._addConstant("bgpAsP", None, 637)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18655, PropCategory.REGULAR)
