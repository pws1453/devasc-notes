...
class ConsLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.ConsLbl")

    meta.moClassName = "l3extConsLbl"
    meta.rnFormat = "conslbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Connectivity Consumer Label"
    ...
    meta.childClasses.add("cobra.model.l3ext.RsProvLblDef")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsProvLblDef", "rsprovLblDef-"))
    ...
    meta.superClasses.add("cobra.model.l3ext.AConsLbl")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38317, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40456, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 21426, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "owner", "owner", 22580, PropCategory.REGULAR)
    prop.label = "Represents the Provider Label ownership"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
