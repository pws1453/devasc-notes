...
# ##################################################
class ConfigOutDef(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.l3ext.ConfigOutDef")

    meta.moClassName = "l3extConfigOutDef"
    meta.rnFormat = "configOutDef"
    meta.category = MoCategory.REGULAR
    meta.label = "Anchor to Trigger Logic to Update OutDef"
