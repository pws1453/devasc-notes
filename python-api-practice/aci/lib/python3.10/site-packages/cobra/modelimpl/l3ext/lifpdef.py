...
class LIfPDef(Mo):
    """
    The interface identifiers attached to the node profile.

    """

    meta = ClassMeta("cobra.model.l3ext.LIfPDef")

    meta.moClassName = "l3extLIfPDef"
    meta.rnFormat = "lifp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Interface Profile"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x21000081
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsPathDefL3OutAtt", "rspathDefL3OutAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.VirtualLIfPDef", "vlifpdef-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14216, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6861, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
