...
class Ip(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.Ip")

    meta.moClassName = "l3extIp"
    meta.rnFormat = "addr-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Secondary IP address"
    ...
    meta.childClasses.add("cobra.model.dhcp.RelayGwExtIp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.RelayGwExtIp", "relayGwExtIp"))
    ...
    meta.superClasses.add("cobra.model.l3ext.AIp")

    meta.rnPrefixes = [
        ('addr-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 18126, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38176, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40315, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ipv6Dad", "ipv6Dad", 42724, PropCategory.REGULAR)
    prop.label = "IPv6 DAD"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26778, PropCategory.REGULAR)
