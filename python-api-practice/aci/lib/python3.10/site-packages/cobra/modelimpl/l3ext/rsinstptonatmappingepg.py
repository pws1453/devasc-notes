...
# ##################################################
class RsInstPToNatMappingEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsInstPToNatMappingEPg", "cobra.model.fv.AEPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsInstPToNatMappingEPg"
    meta.rnFormat = "rsInstPToNatMappingEPg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to NAT Mapping EPg"
    ...
    meta.rnPrefixes = [
        ('rsInstPToNatMappingEPg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38339, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40478, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27723, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22150, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22149, PropCategory.REGULAR)
