...
class LNodePDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.LNodePDef")

    meta.moClassName = "l3extLNodePDef"
    ...
    meta.childClasses.add("cobra.model.bgp.ProtDef")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.bgp.InfraPeerDef")
    meta.childClasses.add("cobra.model.l3ext.LIfPDef")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.l3ext.RsNodeDefL3OutAtt")
    meta.childClasses.add("cobra.model.bgp.PeerDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsNodeDefL3OutAtt", "rsnodeDefL3OutAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.ProtDef", "protp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.LIfPDef", "lifp-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14214, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6863, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
