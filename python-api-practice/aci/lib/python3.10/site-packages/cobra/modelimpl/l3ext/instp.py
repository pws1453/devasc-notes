...
class InstP(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.InstP")

    meta.moClassName = "l3extInstP"
    meta.rnFormat = "instP-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Network Instance Profile"
    meta.writeAccessMask = 0x1000001
    meta.readAccessMask = 0x608239400106c713
    ...
    meta.childClasses.add("cobra.model.l3ext.RsL3InstPToDomP")
    ...
    meta.childClasses.add("cobra.model.l3ext.RsInstPToNatMappingEPg")
    meta.childClasses.add("cobra.model.fv.RtVConnToEpgEp")
    meta.childClasses.add("cobra.model.fv.RsConsIf")
    meta.childClasses.add("cobra.model.l3ext.RtFromRPToL3OutInstP")
    ...
    meta.childClasses.add("cobra.model.l3ext.RsInstPToProfile")
    meta.childClasses.add("cobra.model.l2.IngrBytesAgHist1mo")
    meta.childClasses.add("cobra.model.l3ext.ConfigOutDef")
    ...
    meta.childClasses.add("cobra.model.l3ext.Subnet")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtFromRPToL3OutInstP", "rtorchsFromRPToL3OutInstP-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsInstPToNatMappingEPg", "rsInstPToNatMappingEPg"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsInstPToProfile", "rsinstPToProfile-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsL3InstPToDomP", "rsl3InstPToDomP"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ConfigOutDef", "configOutDef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.Subnet", "extsubnet-"))
    ...
    meta.superClasses.add("cobra.model.extnw.EPg")

    meta.rnPrefixes = [
        ('instP-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37608, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39747, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mcast", "mcast", 24915, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14210, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6859, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 1624, PropCategory.REGULAR)
    prop.label = "EPg Level Dscp"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
