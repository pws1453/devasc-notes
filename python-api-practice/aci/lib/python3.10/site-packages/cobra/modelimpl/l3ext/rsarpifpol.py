...
class RsArpIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsArpIfPol", "cobra.model.arp.IfPol")
    meta.targetNameProps["name"] = "tnArpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsArpIfPol"
    meta.rnFormat = "rsArpIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ARP Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 52106, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 52102, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15245
    prop.defaultValueStr = "arpIfPol"
    ...
    prop = PropMeta("str", "tnArpIfPolName", "tnArpIfPolName", 52101, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnArpIfPolName", prop)
