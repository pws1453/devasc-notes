...
class InfraNodeP(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.InfraNodeP")

    meta.moClassName = "l3extInfraNodeP"
    meta.rnFormat = "infranodep"
    meta.category = MoCategory.REGULAR
    meta.label = "Infra Logical Node Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38319, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40458, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fabricExtCtrlPeering", "fabricExtCtrlPeering", 21392, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fabricExtIntersiteCtrlPeering", "fabricExtIntersiteCtrlPeering", 29959, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26852, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "spineRole", "spineRole", 29960, PropCategory.REGULAR)
