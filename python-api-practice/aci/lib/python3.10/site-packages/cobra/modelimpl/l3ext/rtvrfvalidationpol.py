...
# ##################################################
class RtVrfValidationPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtVrfValidationPol", "cobra.model.fv.Ctx")

    meta.moClassName = "l3extRtVrfValidationPol"
    meta.rnFormat = "rtfvVrfValidationPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 35754, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 35753, PropCategory.REGULAR)
