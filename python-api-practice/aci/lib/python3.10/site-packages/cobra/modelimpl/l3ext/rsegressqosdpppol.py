...
# ##################################################
class RsEgressQosDppPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsEgressQosDppPol", "cobra.model.qos.DppPol")
    meta.targetNameProps["name"] = "tnQosDppPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsEgressQosDppPol"
    meta.rnFormat = "rsegressQosDppPol"
    ...
    meta.rnPrefixes = [
        ('rsegressQosDppPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40540, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23213, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23177, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosDppPolName", "tnQosDppPolName", 23176, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
