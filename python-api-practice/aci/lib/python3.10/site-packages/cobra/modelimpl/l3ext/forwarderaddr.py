...
class ForwarderAddr(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.ForwarderAddr")

    meta.moClassName = "l3extForwarderAddr"
    meta.rnFormat = "forwarderaddr-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Forwarding IP address"
    ...
    prop = PropMeta("str", "addr", "addr", 54504, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 54519, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54520, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54516, PropCategory.REGULAR)
