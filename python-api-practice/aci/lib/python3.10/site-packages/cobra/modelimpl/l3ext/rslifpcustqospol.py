...
# ##################################################
class RsLIfPCustQosPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsLIfPCustQosPol", "cobra.model.qos.CustomPol")
    meta.targetNameProps["name"] = "tnQosCustomPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsLIfPCustQosPol"
    meta.rnFormat = "rslIfPCustQosPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Custom QOS Policy"
    meta.writeAccessMask = 0x1000281
    meta.readAccessMask = 0x1000281
    ...
    meta.rnPrefixes = [
        ('rslIfPCustQosPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 42468, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42469, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42464, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 42461, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 128
    prop.defaultValueStr = "qosCustomPol"
    ...
    prop = PropMeta("str", "tnQosCustomPolName", "tnQosCustomPolName", 42460, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnQosCustomPolName", prop)
