...
class IpDef(Mo):
    """
    The definition of a secondary IP address policy.

    """

    meta = ClassMeta("cobra.model.l3ext.IpDef")

    meta.moClassName = "l3extIpDef"
    meta.rnFormat = "addr-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Secondary IP address definition"
    ...
    meta.childClasses.add("cobra.model.l3ext.RtAddrToIpDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtAddrToIpDef", "rtaddrToIpDef"))
    ...
    meta.parentClasses.add("cobra.model.l3ext.MemberDef")
    ...
    prop = PropMeta("str", "addr", "addr", 18127, PropCategory.REGULAR)
