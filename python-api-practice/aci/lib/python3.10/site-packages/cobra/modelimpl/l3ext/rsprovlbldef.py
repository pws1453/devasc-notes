...
# ##################################################
class RsProvLblDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsProvLblDef", "cobra.model.l3ext.ProvLblDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsProvLblDef"
    meta.rnFormat = "rsprovLblDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21460, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21459, PropCategory.REGULAR)
