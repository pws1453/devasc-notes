...
# ##################################################
class FloatingNodeDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.FloatingNodeDef")

    meta.moClassName = "l3extFloatingNodeDef"
    meta.rnFormat = "floatingnodedef"
    meta.category = MoCategory.REGULAR
    meta.label = "Floating Node Def Mo"
