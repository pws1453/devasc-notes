...
# ##################################################
class RtSrcToL3extOut(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtSrcToL3extOut", "cobra.model.span.ASrc")

    meta.moClassName = "l3extRtSrcToL3extOut"
    meta.rnFormat = "rtspanSrcToL3extOut-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 37074, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 37073, PropCategory.REGULAR)
