...
# ##################################################
class RtLIfCtxToOutDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtLIfCtxToOutDef", "cobra.model.vns.LIfCtx")

    meta.moClassName = "l3extRtLIfCtxToOutDef"
    meta.rnFormat = "rtvnsLIfCtxToOutDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33070, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33069, PropCategory.REGULAR)
