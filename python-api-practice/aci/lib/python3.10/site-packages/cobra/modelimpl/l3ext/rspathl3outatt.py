...
class RsPathL3OutAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l3ext.RsPathL3OutAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsPathL3OutAtt"
    meta.rnFormat = "rspathL3OutAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Leaf Port"
    meta.writeAccessMask = 0x1000001
    meta.readAccessMask = 0x8021020001
    ...
    meta.childClasses.add("cobra.model.l3ext.Ip")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.l3ext.ForwarderAddr")
    meta.childClasses.add("cobra.model.l3ext.Member")
    meta.childClasses.add("cobra.model.ptp.RtdEpgCfg")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.span.SpanCont")
    meta.childClasses.add("cobra.model.span.SrcGrpDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ForwarderAddr", "forwarderaddr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ptp.RtdEpgCfg", "ptpRtdEpgCfg"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.InfraPeerP", "infraPeerP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.SrcGrpDef", "srcgrpdef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.Ip", "addr-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.span.SpanCont", "span"))
    ...
    prop = PropMeta("str", "addr", "addr", 12116, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 37613, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "autostate", "autostate", 34178, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 61152, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "descr", "descr", 19107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "encap", "encap", 12117, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "encapScope", "encapScope", 22483, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39752, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ifInstT", "ifInstT", 12118, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ipv6Dad", "ipv6Dad", 42725, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "llAddr", "llAddr", 17509, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("llAddr", prop)

    prop = PropMeta("str", "mac", "mac", 12119, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mode", "mode", 21248, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17667, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "mtu", "mtu", 12120, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(576, 9216)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12114, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 12121, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
