...
# ##################################################
class VirtualLIfPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.VirtualLIfPDef")

    meta.moClassName = "l3extVirtualLIfPDef"
    meta.rnFormat = "vlifpdef-[%(nodeDn)s]-[%(encap)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 54052, PropCategory.REGULAR)
    prop.label = "External L3 Interface IP Address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 54103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "autostate", "autostate", 54059, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bcastP", "bcastP", 54050, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "descr", "descr", 54055, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 54048, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encapScope", "encapScope", 54058, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extEncap", "extEncap", 54049, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("extEncap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54104, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ifInstT", "ifInstT", 54047, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ipv6Dad", "ipv6Dad", 54060, PropCategory.REGULAR)
    prop.label = "IPv6 DAD"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "llAddr", "llAddr", 54054, PropCategory.REGULAR)
    prop.label = "IPv6 Link Local Address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("llAddr", prop)

    prop = PropMeta("str", "mac", "mac", 54051, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 54057, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54094, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "mtu", "mtu", 54056, PropCategory.REGULAR)
    prop.label = "MTU Size"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(576, 9216)]
    ...
    prop = PropMeta("str", "nodeDn", "nodeDn", 54061, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 54053, PropCategory.REGULAR)
