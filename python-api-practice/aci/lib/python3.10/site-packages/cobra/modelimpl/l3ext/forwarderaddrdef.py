...
# ##################################################
class ForwarderAddrDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.ForwarderAddrDef")

    meta.moClassName = "l3extForwarderAddrDef"
    meta.rnFormat = "forwarderaddr-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Forwarding IP address definition"
    ...
    prop = PropMeta("str", "addr", "addr", 54505, PropCategory.REGULAR)
