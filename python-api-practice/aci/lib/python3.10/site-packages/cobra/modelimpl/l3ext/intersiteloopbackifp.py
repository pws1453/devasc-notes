...
# ##################################################
class IntersiteLoopBackIfP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.IntersiteLoopBackIfP")

    meta.moClassName = "l3extIntersiteLoopBackIfP"
    meta.rnFormat = "sitelbp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Intersite Loop Back Interface Profile"
    ...
    prop = PropMeta("str", "addr", "addr", 34291, PropCategory.REGULAR)
    prop.label = "Intersite Loop Back Interface Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 38752, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40891, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34474, PropCategory.REGULAR)
