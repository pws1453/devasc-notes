...
# ##################################################
class RouteTagDef(Mo):
    """
    Definition of Route Tag Policy

    """

    meta = ClassMeta("cobra.model.l3ext.RouteTagDef")

    meta.moClassName = "l3extRouteTagDef"
    meta.rnFormat = "rttag"
    meta.category = MoCategory.REGULAR
    meta.label = "Definition of Route Tag  Policy"
