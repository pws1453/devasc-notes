...
# ##################################################
class AFabricExtRoutingP(Mo):
    meta = ClassMeta("cobra.model.l3ext.AFabricExtRoutingP")

    meta.isAbstract = True
    meta.moClassName = "l3extAFabricExtRoutingP"


    meta.moClassName = "l3extAFabricExtRoutingP"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Fabric External Routing Profile"
