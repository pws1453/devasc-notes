...
class RsNodeL3OutAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l3ext.RsNodeL3OutAtt", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsNodeL3OutAtt"
    meta.rnFormat = "rsnodeL3OutAtt-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.l3ext.InfraNodeP")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.ip.RouteP")
    ...
    meta.childClasses.add("cobra.model.l3ext.LoopBackIfP")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.l3ext.IntersiteLoopBackIfP")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.InfraNodeP", "infranodep"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.IntersiteLoopBackIfP", "sitelbp-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.LoopBackIfP", "lbp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Inst", "tag-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ip.RouteP", "rt-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37611, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 38852, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39750, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30312, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rtrId", "rtrId", 12106, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("rtrId", prop)

    prop = PropMeta("str", "rtrIdLoopBack", "rtrIdLoopBack", 19765, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = True
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("rtrIdLoopBack", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12104, PropCategory.REGULAR)
