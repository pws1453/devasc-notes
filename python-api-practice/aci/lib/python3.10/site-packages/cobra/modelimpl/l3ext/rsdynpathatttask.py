...
# ##################################################
class RsDynPathAttTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.RsDynPathAttTask")

    meta.moClassName = "l3extRsDynPathAttTask"
    meta.rnFormat = "l3extRsDynPathAttTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 54063, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpPDUpd", "eppdupd", 3561)
