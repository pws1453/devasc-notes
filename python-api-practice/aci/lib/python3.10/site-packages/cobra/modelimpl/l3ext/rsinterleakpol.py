...
# ##################################################
class RsInterleakPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsInterleakPol", "cobra.model.rtctrl.Profile")
    meta.targetNameProps["name"] = "tnRtctrlProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsInterleakPol"
    meta.rnFormat = "rsinterleakPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Context Interleak Policy"
    ...
    meta.rnPrefixes = [
        ('rsinterleakPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38414, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40553, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23556, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23555, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnRtctrlProfileName", "tnRtctrlProfileName", 23554, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
