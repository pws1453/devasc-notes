...
class LoopBackIfP(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.LoopBackIfP")

    meta.moClassName = "l3extLoopBackIfP"
    meta.rnFormat = "lbp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Loop Back Interface Profile"
    ...
    prop = PropMeta("str", "addr", "addr", 17823, PropCategory.REGULAR)
    prop.label = "Loop Back Interface Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 38162, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40301, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26764, PropCategory.REGULAR)
