...
class Subnet(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.Subnet")

    meta.moClassName = "l3extSubnet"
    ...
    meta.childClasses.add("cobra.model.l3ext.RsSubnetToRtSumm")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsSubnetToRtSumm", "rsSubnetToRtSumm"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37616, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39755, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 6867, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14218, PropCategory.REGULAR)
