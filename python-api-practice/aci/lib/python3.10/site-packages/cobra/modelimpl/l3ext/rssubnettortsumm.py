...
# ##################################################
class RsSubnetToRtSumm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsSubnetToRtSumm", "cobra.model.rtsum.ARtSummPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsSubnetToRtSumm"
    meta.rnFormat = "rsSubnetToRtSumm"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Route Summarization policy"
    ...
    meta.rnPrefixes = [
        ('rsSubnetToRtSumm', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38415, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40554, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23579, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23572, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7685
    prop.defaultValueStr = "rtsumARtSummPol"
    ...
    prop = PropMeta("str", "tDn", "tDn", 23571, PropCategory.REGULAR)
