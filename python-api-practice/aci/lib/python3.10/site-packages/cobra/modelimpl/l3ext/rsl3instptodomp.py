...
# ##################################################
class RsL3InstPToDomP(Mo):
    """
    A source relation to the fabric infrastructure policy domain profile.

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsL3InstPToDomP", "cobra.model.extnw.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsL3InstPToDomP"
    meta.rnFormat = "rsl3InstPToDomP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12100, PropCategory.REGULAR)
