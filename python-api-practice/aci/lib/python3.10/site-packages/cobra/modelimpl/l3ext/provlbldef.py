...
class ProvLblDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.ProvLblDef")

    meta.moClassName = "l3extProvLblDef"
    meta.rnFormat = "provlbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Connectivity Provider Label Definition"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x1020601
    ...
    meta.childClasses.add("cobra.model.l3ext.RtProvLblDef")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.l3ext.RtPrToL3extProvLblDef")
    meta.childClasses.add("cobra.model.fv.L3extOutLblDepl")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtPrToL3extProvLblDef", "rtpolPrToL3extProvLblDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.L3extOutLblDepl", "l3extOutLblDepl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtProvLblDef", "rtprovLblDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.fv.RtdEpP")
    meta.parentClasses.add("cobra.model.l3ext.ProvLblDefCont")
    ...
    meta.superClasses.add("cobra.model.l3ext.AProvLbl")
    ...
    prop = PropMeta("str", "name", "name", 21430, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
