...
class RtVLIfP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.l3ext.RtVLIfP", "cobra.model.vns.CIf")

    meta.moClassName = "l3extRtVLIfP"
    meta.rnFormat = "rtvnsVLIfP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54072, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54071, PropCategory.REGULAR)
