...
class CtxUpdater(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.CtxUpdater")

    meta.moClassName = "l3extCtxUpdater"
    meta.rnFormat = "ctx-[%(ctxDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Update Context"
    ...
    meta.childClasses.add("cobra.model.l3ext.RequestedBy")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RequestedBy", "requestedBy-"))
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 22215, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22218, PropCategory.REGULAR)
