...
class OutTask(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.OutTask")

    meta.moClassName = "l3extOutTask"
    meta.rnFormat = "l3extOutTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 54062, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateL3ExtInstP", "updatel3extinstp", 3562)
