...
# ##################################################
class GlobalCtxName(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.GlobalCtxName")

    meta.moClassName = "l3extGlobalCtxName"
    meta.rnFormat = "globalctxname"
    meta.category = MoCategory.REGULAR
    meta.label = "Global VRF Name"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38353, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40492, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 34350, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
