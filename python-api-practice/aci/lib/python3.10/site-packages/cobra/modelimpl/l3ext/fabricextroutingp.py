...
# ##################################################
class FabricExtRoutingP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.FabricExtRoutingP")

    meta.moClassName = "l3extFabricExtRoutingP"
    meta.rnFormat = "fabricExtRoutingP-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric External Routing Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38320, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40459, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21473, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 21427, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
