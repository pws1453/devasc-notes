...
class ConsLblDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.ConsLblDef")

    meta.moClassName = "l3extConsLblDef"
    meta.rnFormat = "conslbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Connectivity Consumer Label Definition"
    ...
    prop = PropMeta("str", "name", "name", 22582, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
