...
# ##################################################
class CtxExtEncapAllocator(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.CtxExtEncapAllocator")

    meta.moClassName = "l3extCtxExtEncapAllocator"
    meta.rnFormat = "encap-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Context Ext Encap"
    ...
    meta.childClasses.add("cobra.model.l3ext.EncapRequestor")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.EncapRequestor", "requestor-"))
    ...
    prop = PropMeta("str", "encap", "encap", 22217, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
