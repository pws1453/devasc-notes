...
class Member(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.Member")

    meta.moClassName = "l3extMember"
    meta.rnFormat = "mem-%(side)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Member Node Configuration"
    ...
    meta.superClasses.add("cobra.model.l3ext.AMember")

    meta.rnPrefixes = [
        ('mem-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 1632, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 37614, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39753, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ipv6Dad", "ipv6Dad", 42723, PropCategory.REGULAR)
    prop.label = "IPv6 DAD"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "llAddr", "llAddr", 16875, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26586, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "side", "side", 6864, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("A", "member-a", 1)
    prop._addConstant("B", "member-b", 2)
    meta.props.add("side", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "side"))
    ...
    def __init__(self, parentMoOrDn, side, markDirty=True, **creationProps):
        namingVals = [side]
