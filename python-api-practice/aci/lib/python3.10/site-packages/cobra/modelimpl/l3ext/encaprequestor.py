...
# ##################################################
class EncapRequestor(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.EncapRequestor")

    meta.moClassName = "l3extEncapRequestor"
    meta.rnFormat = "requestor-[%(requestorDn)s]"
    ...
    meta.parentClasses.add("cobra.model.l3ext.CtxExtEncapAllocator")
    ...
    prop = PropMeta("str", "requestorDn", "requestorDn", 22214, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
