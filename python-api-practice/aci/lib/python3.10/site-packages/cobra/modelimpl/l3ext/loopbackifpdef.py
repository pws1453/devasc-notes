...
class LoopBackIfPDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.LoopBackIfPDef")

    meta.moClassName = "l3extLoopBackIfPDef"
    meta.rnFormat = "lbpdef-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 19044, PropCategory.REGULAR)
