...
# ##################################################
class RsInstPToProfile(Mo):
    """
    A source relation to a route control profile.

    """

    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsInstPToProfile", "cobra.model.rtctrl.Profile")
    meta.targetNameProps["name"] = "tnRtctrlProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsInstPToProfile"
    meta.rnFormat = "rsinstPToProfile-[%(tnRtctrlProfileName)s]-%(direction)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Route Control Profile"
    ...
    meta.rnPrefixes = [
        ('rsinstPToProfile-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38158, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "direction", "direction", 17681, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40297, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17689, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17683, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnRtctrlProfileName", "tnRtctrlProfileName", 17682, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
