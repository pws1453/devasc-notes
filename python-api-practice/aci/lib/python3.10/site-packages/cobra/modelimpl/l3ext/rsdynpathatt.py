...
# ##################################################
class RsDynPathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsDynPathAtt", "cobra.model.infra.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsDynPathAtt"
    meta.rnFormat = "rsdynPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "VMM Path Attributes"
    ...
    meta.childClasses.add("cobra.model.l3ext.VirtualLIfPLagPolAtt")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.VirtualLIfPLagPolAtt", "vlifplagpolatt"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 54101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54102, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "floatingAddr", "floatingAddr", 54077, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("floatingAddr", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54078, PropCategory.REGULAR)
