...
# ##################################################
class RsOutDefContToOut(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsOutDefContToOut", "cobra.model.l3ext.Out")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsOutDefContToOut"
    meta.rnFormat = "rsoutDefContToOut-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from l3ext:OutDef container to l3ext:Out"
    meta.writeAccessMask = 0x1000001
    meta.readAccessMask = 0x6000000021000781
    ...
    prop = PropMeta("str", "tCl", "tCl", 33072, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33071, PropCategory.REGULAR)
