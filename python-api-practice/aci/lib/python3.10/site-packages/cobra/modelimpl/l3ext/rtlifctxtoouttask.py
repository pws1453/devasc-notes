...
# ##################################################
class RtLIfCtxToOutTask(Mo):
    """
    A target relation to an external output.

    """

    meta = ClassMeta("cobra.model.l3ext.RtLIfCtxToOutTask")

    meta.moClassName = "l3extRtLIfCtxToOutTask"
    meta.rnFormat = "l3extRtLIfCtxToOutTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 17842, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RoutePeering", "routepeering", 1538)
