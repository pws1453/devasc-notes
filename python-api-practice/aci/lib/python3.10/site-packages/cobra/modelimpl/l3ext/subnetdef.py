...
class SubnetDef(Mo):
    """
    An internal object that represents subnets defined under an L3 outside.

    """

    meta = ClassMeta("cobra.model.l3ext.SubnetDef")

    meta.moClassName = "l3extSubnetDef"
    meta.rnFormat = "extsubnet-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of External Network Instance"
    ...
    meta.childClasses.add("cobra.model.l3ext.RsSubnetToProfile")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.bgp.RtSummPolDef")
    meta.childClasses.add("cobra.model.ospf.RtSummPolDef")
    meta.childClasses.add("cobra.model.eigrp.RtSummPolDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsSubnetToProfile", "rssubnetToProfile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.RtSummPolDef", "eigrprtsumm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RtSummPolDef", "ospfrtsumm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtSummPolDef", "bgprtsum-"))
    ...
    meta.superClasses.add("cobra.model.extnw.AInstPSubnet")
    meta.superClasses.add("cobra.model.pol.Comp")
    meta.superClasses.add("cobra.model.l3ext.AInstPSubnet")
    ...
    prop = PropMeta("str", "aggregate", "aggregate", 19878, PropCategory.REGULAR)
    prop.label = "Aggregate Routes for Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("export-rtctrl", "aggregate-export", 2)
    prop._addConstant("import-rtctrl", "aggregate-import", 1)
    prop._addConstant("shared-rtctrl", "aggregate-shared", 4)
    ...
    prop = PropMeta("str", "ip", "ip", 6868, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14219, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scope", "scope", 17570, PropCategory.REGULAR)
    prop.label = "Scope of the External Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 4
    prop.defaultValueStr = "import-security"
    prop._addConstant("export-rtctrl", "export-route-control-subnet", 2)
    prop._addConstant("import-rtctrl", "import-route-control-subnet", 1)
    prop._addConstant("import-security", "external-subnets-for-the-external-epg", 4)
    prop._addConstant("shared-rtctrl", "shared-route-control-subnet", 16)
    prop._addConstant("shared-security", "shared-security-import-subnet", 8)
