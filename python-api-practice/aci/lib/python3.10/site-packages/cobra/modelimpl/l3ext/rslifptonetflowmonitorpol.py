...
# ##################################################
class RsLIfPToNetflowMonitorPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.l3ext.RsLIfPToNetflowMonitorPol", "cobra.model.netflow.MonitorPol")
    meta.targetNameProps["name"] = "tnNetflowMonitorPolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsLIfPToNetflowMonitorPol"
    meta.rnFormat = "rslIfPToNetflowMonitorPol-[%(tnNetflowMonitorPolName)s]-%(fltType)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Netflow Monitor Pol"
    ...
    meta.rnPrefixes = [
        ('rslIfPToNetflowMonitorPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40690, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fltType", "fltType", 27822, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27344, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNetflowMonitorPolName", "tnNetflowMonitorPolName", 27343, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
