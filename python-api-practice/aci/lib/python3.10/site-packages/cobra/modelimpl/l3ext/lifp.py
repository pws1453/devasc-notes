...
class LIfP(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.LIfP")

    meta.moClassName = "l3extLIfP"
    meta.rnFormat = "lifp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Interface Profile"
    meta.writeAccessMask = 0x1000001
    meta.readAccessMask = 0x8021040001
    ...
    meta.childClasses.add("cobra.model.dhcp.Lbl")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.eigrp.IfP")
    meta.childClasses.add("cobra.model.l3ext.VirtualLIfP")
    meta.childClasses.add("cobra.model.pim.IPV6IfP")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.l3ext.RsLIfPToNetflowMonitorPol")
    meta.childClasses.add("cobra.model.l3ext.RsPathL3OutAtt")
    meta.childClasses.add("cobra.model.l3ext.RsEgressQosDppPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.hsrp.IfP")
    meta.childClasses.add("cobra.model.igmp.IfP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.bfd.IfP")
    meta.childClasses.add("cobra.model.l3ext.RsIngressQosDppPol")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.l3ext.RsLIfPCustQosPol")
    meta.childClasses.add("cobra.model.l3ext.RsArpIfPol")
    meta.childClasses.add("cobra.model.pim.IfP")
    meta.childClasses.add("cobra.model.l3ext.RsNdIfPol")
    meta.childClasses.add("cobra.model.ospf.IfP")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsLIfPToNetflowMonitorPol", "rslIfPToNetflowMonitorPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsIngressQosDppPol", "rsingressQosDppPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsEgressQosDppPol", "rsegressQosDppPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsLIfPCustQosPol", "rslIfPCustQosPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsPathL3OutAtt", "rspathL3OutAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.IPV6IfP", "pimipv6ifp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsArpIfPol", "rsArpIfPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsNdIfPol", "rsNdIfPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.Lbl", "dhcplbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.IfP", "eigrpIfP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hsrp.IfP", "hsrpIfP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.IfP", "igmpIfP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.ExtMngdInst", "extmngd"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.IfP", "ospfIfP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.VirtualLIfP", "vlifp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.IfP", "bfdIfP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.IfP", "pimifp"))
    ...
    meta.superClasses.add("cobra.model.l3ext.AIfP")
    meta.superClasses.add("cobra.model.pol.ConsElem")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Lbl")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.extnw.ALIfP")

    meta.rnPrefixes = [
        ('lifp-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 1629, PropCategory.REGULAR)
    prop.label = "L3 Interface Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 37612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 1628, PropCategory.REGULAR)
    prop.label = "External Interface Encap"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39751, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14215, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6860, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 42449, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 1630, PropCategory.REGULAR)
