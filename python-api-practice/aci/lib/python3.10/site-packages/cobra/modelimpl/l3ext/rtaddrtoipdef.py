...
# ##################################################
class RtAddrToIpDef(Mo):
    """
    A target relation to a secondary IP address policy definition.

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtAddrToIpDef", "cobra.model.ip.Addr")

    meta.moClassName = "l3extRtAddrToIpDef"
    meta.rnFormat = "rtaddrToIpDef"
    ...
    meta.parentClasses.add("cobra.model.l3ext.IpDef")
    ...
    prop = PropMeta("str", "tCl", "tCl", 18130, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3799
    prop.defaultValueStr = "ipAddr"
