...
# ##################################################
class RsOutToBDPublicSubnetHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsOutToBDPublicSubnetHolder", "cobra.model.fv.BDPublicSubnetHolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsOutToBDPublicSubnetHolder"
    meta.rnFormat = "rsoutToBDPublicSubnetHolder-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to BDHolder from L3 out"
    ...
    meta.superClasses.add("cobra.model.pol.AObjToPolReln")

    meta.rnPrefixes = [
        ('rsoutToBDPublicSubnetHolder-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 20289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20288, PropCategory.REGULAR)
