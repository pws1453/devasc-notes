...
# ##################################################
class RsVSwitchEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsVSwitchEnhancedLagPol", "cobra.model.lacp.EnhancedLagPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsVSwitchEnhancedLagPol"
    meta.rnFormat = "rsvSwitchEnhancedLagPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Enhanced LACP Lag Policy"
    ...
    meta.rnPrefixes = [
        ('rsvSwitchEnhancedLagPol-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55892, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55893, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55889, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55885, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55884, PropCategory.REGULAR)
