...
class InstPDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.InstPDef")

    meta.moClassName = "l3extInstPDef"
    meta.rnFormat = "instPdef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Network Instance Profile Def"
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 17822, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17852, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 17843, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
