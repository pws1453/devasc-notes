...
# ##################################################
class RtEventCtrlrRetP(Mo):
    """
    A target relation to the controller event record retention policy.

    """

    meta = TargetRelationMeta("cobra.model.event.RtEventCtrlrRetP", "cobra.model.fault.RelnHolder")

    meta.moClassName = "eventRtEventCtrlrRetP"
    meta.rnFormat = "rtfaultEventCtrlrRetP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13417, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13416, PropCategory.REGULAR)
