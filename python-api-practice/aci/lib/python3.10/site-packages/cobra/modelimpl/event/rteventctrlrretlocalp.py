...
# ##################################################
class RtEventCtrlrRetLocalP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.event.RtEventCtrlrRetLocalP", "cobra.model.fault.RelnHolder")

    meta.moClassName = "eventRtEventCtrlrRetLocalP"
    meta.rnFormat = "rtfaultEventCtrlrRetLocalP-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfaultEventCtrlrRetLocalP-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 28352, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28351, PropCategory.REGULAR)
