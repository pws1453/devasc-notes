...
class RepDef(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.RepDef")

    meta.moClassName = "igmpRepDef"
    meta.rnFormat = "igmprepdef"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25974, PropCategory.REGULAR)
