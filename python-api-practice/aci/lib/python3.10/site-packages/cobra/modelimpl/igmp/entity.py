...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.Entity")

    meta.moClassName = "igmpEntity"
    meta.rnFormat = "igmp"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Entity"
    ...
    meta.childClasses.add("cobra.model.igmp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.Inst", "inst"))
    ...
    meta.superClasses.add("cobra.model.ipmc.AEntity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26353, PropCategory.REGULAR)
