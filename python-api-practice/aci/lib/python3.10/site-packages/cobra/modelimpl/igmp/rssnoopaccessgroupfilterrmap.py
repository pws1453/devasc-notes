...
# ##################################################
class RsSnoopAccessGroupFilterRMap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.igmp.RsSnoopAccessGroupFilterRMap", "cobra.model.pim.RouteMapPol")
    meta.targetNameProps["name"] = "tnPimRouteMapPolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "igmpRsSnoopAccessGroupFilterRMap"
    meta.rnFormat = "rssnoopAccessGroupFilterRMap-%(tnPimRouteMapPolName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Profile that specify what to accept using                              a pimRouteMapPol"
    meta.writeAccessMask = 0x20601
    ...
    meta.rnPrefixes = [
        ('rssnoopAccessGroupFilterRMap-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38556, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40695, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27438, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27433, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8713
    prop.defaultValueStr = "pimRouteMapPol"
    ...
    prop = PropMeta("str", "tnPimRouteMapPolName", "tnPimRouteMapPolName", 27432, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnPimRouteMapPolName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnPimRouteMapPolName"))
    ...
    def __init__(self, parentMoOrDn, tnPimRouteMapPolName, markDirty=True, **creationProps):
        namingVals = [tnPimRouteMapPolName]
