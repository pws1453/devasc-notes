...
class CtxP(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.CtxP")

    meta.moClassName = "igmpCtxP"
    meta.rnFormat = "igmpctxp"
    meta.category = MoCategory.REGULAR
    meta.label = "Context level IGMP Policy"
    ...
    meta.childClasses.add("cobra.model.igmp.SSMXlateP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.SSMXlateP", "ssmxlate-"))
    ...
    meta.superClasses.add("cobra.model.ipmc.ACtxPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38491, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40630, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
