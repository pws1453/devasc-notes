...
class RsIfPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.igmp.RsIfPol", "cobra.model.igmp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "igmpRsIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38487, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40626, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25823, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25813, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8799
    prop.defaultValueStr = "igmpIfPol"
    prop._addConstant("igmpIfPol", None, 8799)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25963, PropCategory.REGULAR)
