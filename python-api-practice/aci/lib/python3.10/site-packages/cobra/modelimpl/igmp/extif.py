...
class ExtIf(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.ExtIf")

    meta.moClassName = "igmpExtIf"
    meta.rnFormat = "extif-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP External Interface"
    ...
    meta.parentClasses.add("cobra.model.igmp.ExtDom")
    ...
    prop = PropMeta("str", "flags", "flags", 25498, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    prop._addConstant("mcast", "multicast-enabled", 1)
    meta.props.add("flags", prop)

    prop = PropMeta("str", "id", "id", 20710, PropCategory.REGULAR)
