...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.Inst")

    meta.moClassName = "igmpInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Instance"
    ...
    meta.childClasses.add("cobra.model.igmp.Dom")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.igmp.ExtDom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.ExtDom", "extdom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.igmp.Entity")

    meta.superClasses.add("cobra.model.nw.Conn")
    meta.superClasses.add("cobra.model.ipmc.AInst")
    ...
    prop = PropMeta("str", "bootupDelay", "bootupDelay", 24581, PropCategory.REGULAR)
    prop.label = "Bootup Route Add Delay"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    prop.defaultValueStr = "0"
    meta.props.add("bootupDelay", prop)
    ...
    prop = PropMeta("str", "instCtrl", "instCtrl", 24580, PropCategory.REGULAR)
    prop.label = "Inst Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("any-query-dest", "allow-any-dest-ip-for-query", 4)
    prop._addConstant("flush-on-restart", "flush-routes-on-restart", 1)
    prop._addConstant("rtr-alert", "enforce-router-alert", 2)
    meta.props.add("instCtrl", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26354, PropCategory.REGULAR)
