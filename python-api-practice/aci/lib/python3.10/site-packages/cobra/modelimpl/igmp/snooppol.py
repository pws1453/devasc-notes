...
class SnoopPol(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.SnoopPol")

    meta.moClassName = "igmpSnoopPol"
    meta.rnFormat = "snPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Snoop Policy"
    meta.writeAccessMask = 0x20001
    meta.readAccessMask = 0x21001
    ...
    meta.childClasses.add("cobra.model.igmp.RtIgmpsn")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.RtIgmpsn", "rtfvIgmpsn-"))
    ...
    meta.superClasses.add("cobra.model.igmp.ASnoopPol")
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 24381, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 1506, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39701, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "lastMbrIntvl", "lastMbrIntvl", 1509, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6605, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "queryIntvl", "queryIntvl", 1507, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rspIntvl", "rspIntvl", 1508, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "startQueryCnt", "startQueryCnt", 1511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "startQueryIntvl", "startQueryIntvl", 1510, PropCategory.REGULAR)
