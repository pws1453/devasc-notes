...
# ##################################################
class RsIfDefToIgmpIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.igmp.RsIfDefToIgmpIf", "cobra.model.igmp.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "igmpRsIfDefToIgmpIf"
    meta.rnFormat = "rsIfDefToIgmpIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25817, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8390
    prop.defaultValueStr = "igmpIf"
    prop._addConstant("igmpIf", None, 8390)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25816, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 25835, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
