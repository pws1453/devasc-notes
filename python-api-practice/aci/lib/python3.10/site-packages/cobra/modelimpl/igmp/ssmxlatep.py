...
class SSMXlateP(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.SSMXlateP")

    meta.moClassName = "igmpSSMXlateP"
    meta.rnFormat = "ssmxlate-[%(grpPfx)s]-[%(srcAddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Context level SSM Translate Policy"
    ...
    meta.superClasses.add("cobra.model.ipmc.ASSMXlateP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38492, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40631, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "grpPfx", "grpPfx", 25560, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("grpPfx", prop)
    ...
    prop = PropMeta("str", "srcAddr", "srcAddr", 25559, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "grpPfx"))
    getattr(meta.props, "grpPfx").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, grpPfx, srcAddr, markDirty=True, **creationProps):
        namingVals = [grpPfx, srcAddr]
