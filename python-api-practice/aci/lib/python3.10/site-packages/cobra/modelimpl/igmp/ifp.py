...
class IfP(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.IfP")

    meta.moClassName = "igmpIfP"
    meta.rnFormat = "igmpIfP"
    ...
    meta.childClasses.add("cobra.model.igmp.RsIfPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.RsIfPol", "rsIfPol"))
    ...
    meta.superClasses.add("cobra.model.igmp.AIfP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38486, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40625, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25822, PropCategory.REGULAR)
