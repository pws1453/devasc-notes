...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.If")

    meta.moClassName = "igmpIf"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Interface"
    ...
    meta.childClasses.add("cobra.model.igmp.RepP")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.igmp.RtIfDefToIgmpIf")
    meta.childClasses.add("cobra.model.igmp.StRepP")
    meta.childClasses.add("cobra.model.igmp.QuerierP")
    meta.childClasses.add("cobra.model.igmp.ResP")
    meta.childClasses.add("cobra.model.igmp.IfStats")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.RtIfDefToIgmpIf", "rtifDefToIgmpIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.StRepP", "streppol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.QuerierP", "querierp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.IfStats", "IfStats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.RepP", "reppol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.ResP", "limit"))
    ...
    prop = PropMeta("str", "id", "id", 24754, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26357, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "netId", "netId", 26295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "role", "role", 26296, PropCategory.REGULAR)
    prop.label = "Role"
    prop.isImplicit = True
    prop.isAdmin = True
