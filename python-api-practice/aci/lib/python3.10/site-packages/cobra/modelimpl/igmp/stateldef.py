...
class StateLDef(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.StateLDef")

    meta.moClassName = "igmpStateLDef"
    meta.rnFormat = "igmpstateLDef"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25975, PropCategory.REGULAR)
