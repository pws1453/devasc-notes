...
class IfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.igmp.IfPol")

    meta.moClassName = "igmpIfPol"
    meta.rnFormat = "igmpIfPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Interface Policy"
    ...
    meta.childClasses.add("cobra.model.igmp.StRepPol")
    meta.childClasses.add("cobra.model.igmp.RepPol")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.igmp.RtIfPol")
    meta.childClasses.add("cobra.model.igmp.StateLPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.StRepPol", "igmpstrepPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.StateLPol", "igmpstateLPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.RepPol", "igmprepPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.RtIfPol", "rtifPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38485, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40624, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25966, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 25556, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
