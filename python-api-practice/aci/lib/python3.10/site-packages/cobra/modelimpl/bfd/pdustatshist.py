...
class PduStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist"


    meta.moClassName = "bfdPduStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStatsHist1h")
