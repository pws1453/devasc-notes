...
# ##################################################
class RtSpineBfdIpv4InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.bfd.RtSpineBfdIpv4InstPol", "cobra.model.infra.SpineAccNodePGrp")

    meta.moClassName = "bfdRtSpineBfdIpv4InstPol"
    meta.rnFormat = "rtinfraSpineBfdIpv4InstPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtinfraSpineBfdIpv4InstPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 34370, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34369, PropCategory.REGULAR)
