...
class PduStats1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStats1mo", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats1mo"
    meta.rnFormat = "CDbfdPduStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats in 1 month"
