...
class PduStatsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist1year", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist1year"
    meta.rnFormat = "HDbfdPduStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 49647, PropCategory.REGULAR)
