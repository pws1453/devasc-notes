...
class PduStats1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStats1h", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats1h"
    meta.rnFormat = "CDbfdPduStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats in 1 hour"
