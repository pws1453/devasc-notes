...
# ##################################################
class RtBfdIpv6InstPol(Mo):
    """
     Relationship to BFD Ipv6 Instance Policy 

    """

    meta = TargetRelationMeta("cobra.model.bfd.RtBfdIpv6InstPol", "cobra.model.infra.AccNodePGrp")

    meta.moClassName = "bfdRtBfdIpv6InstPol"
    meta.rnFormat = "rtinfraBfdIpv6InstPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22839, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22838, PropCategory.REGULAR)
