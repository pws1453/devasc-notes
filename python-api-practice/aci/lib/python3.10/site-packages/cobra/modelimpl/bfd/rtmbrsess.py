...
class RtMbrSess(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.bfd.RtMbrSess", "cobra.model.bfd.Sess")

    meta.moClassName = "bfdRtMbrSess"
    meta.rnFormat = "rtmbrSess"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17532, PropCategory.REGULAR)
