...
class PduStats1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStats1year", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats1year"
    meta.rnFormat = "CDbfdPduStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats in 1 year"
