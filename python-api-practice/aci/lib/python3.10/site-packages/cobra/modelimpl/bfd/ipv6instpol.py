...
# ##################################################
class Ipv6InstPol(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.bfd.Ipv6InstPol")

    meta.moClassName = "bfdIpv6InstPol"
    meta.rnFormat = "bfdIpv6Inst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "BFD Global Ipv6 Policy"
    ...
    meta.childClasses.add("cobra.model.bfd.RtToBfdIpv6InstPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.bfd.RtSpineBfdIpv6InstPol")
    meta.childClasses.add("cobra.model.bfd.RtSysBfdIpv6PolCons")
    meta.childClasses.add("cobra.model.bfd.RtBfdIpv6InstPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RtSpineBfdIpv6InstPol", "rtinfraSpineBfdIpv6InstPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RtBfdIpv6InstPol", "rtinfraBfdIpv6InstPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RtSysBfdIpv6PolCons", "rtsysBfdIpv6PolCons"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RtToBfdIpv6InstPol", "rttoBfdIpv6InstPol"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38363, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40502, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 22785, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
