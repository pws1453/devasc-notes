...
class RtIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.bfd.RtIfPol", "cobra.model.bfd.IfP")

    meta.moClassName = "bfdRtIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24333, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8228
    prop.defaultValueStr = "bfdIfP"
    prop._addConstant("bfdIfP", None, 8228)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24332, PropCategory.REGULAR)
