...
class PduStatsHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist1d", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist1d"
    meta.rnFormat = "HDbfdPduStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 49642, PropCategory.REGULAR)
