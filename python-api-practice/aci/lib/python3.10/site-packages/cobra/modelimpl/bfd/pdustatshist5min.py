...
class PduStatsHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist5min", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist5min"
    meta.rnFormat = "HDbfdPduStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 49648, PropCategory.REGULAR)
