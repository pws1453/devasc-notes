...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.Inst")

    meta.moClassName = "bfdInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "BFD Instance"
    ...
    meta.childClasses.add("cobra.model.bfd.InstAf")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.bfd.Sess")
    meta.childClasses.add("cobra.model.bfd.If")
    meta.childClasses.add("cobra.model.bfd.InstHaCtx")

    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.Sess", "session-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.InstAf", "af-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.If", "if-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.InstHaCtx", "aux"))
    ...
    prop = PropMeta("str", "echoIf", "echoIf", 17063, PropCategory.REGULAR)
    prop.label = "Echo Interface"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("echoIf", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17540, PropCategory.REGULAR)
