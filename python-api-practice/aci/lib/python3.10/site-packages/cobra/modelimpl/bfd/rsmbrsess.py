...
class RsMbrSess(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.bfd.RsMbrSess", "cobra.model.bfd.Sess")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "bfdRsMbrSess"
    meta.rnFormat = "rsmbrSess-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Port-Channel Member Sessions"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17531, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5767
    prop.defaultValueStr = "bfdSess"
    prop._addConstant("bfdSess", None, 5767)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17530, PropCategory.REGULAR)
