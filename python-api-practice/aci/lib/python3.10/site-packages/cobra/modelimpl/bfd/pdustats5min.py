...
class PduStats5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStats5min", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats5min"
    meta.rnFormat = "CDbfdPduStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats in 5 minute"
