...
class PduStatsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist15min", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist15min"
    meta.rnFormat = "HDbfdPduStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 49641, PropCategory.REGULAR)
