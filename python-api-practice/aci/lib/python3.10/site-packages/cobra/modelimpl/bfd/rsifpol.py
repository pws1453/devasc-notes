...
class RsIfPol(Mo):
    """
     Relationship to the BFD interface policy 

    """

    meta = NamedSourceRelationMeta("cobra.model.bfd.RsIfPol", "cobra.model.bfd.IfPol")
    meta.targetNameProps["name"] = "tnBfdIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "bfdRsIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38426, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40565, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24335, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 24331, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8227
    prop.defaultValueStr = "bfdIfPol"
    ...
    prop = PropMeta("str", "tnBfdIfPolName", "tnBfdIfPolName", 24330, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBfdIfPolName", prop)
