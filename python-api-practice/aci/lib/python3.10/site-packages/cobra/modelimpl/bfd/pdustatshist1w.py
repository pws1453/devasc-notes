...
class PduStatsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist1w", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist1w"
    meta.rnFormat = "HDbfdPduStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 49646, PropCategory.REGULAR)
