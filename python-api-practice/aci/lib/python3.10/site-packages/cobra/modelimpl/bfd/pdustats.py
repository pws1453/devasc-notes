...
# ##################################################
class PduStats(Mo):
    meta = StatsClassMeta("cobra.model.bfd.PduStats", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats"


    meta.moClassName = "bfdPduStats"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats1qtr")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats1h")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats1year")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats1d")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats1mo")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats15min")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats1w")
    meta.concreteSubClasses.add("cobra.model.bfd.PduStats5min")
