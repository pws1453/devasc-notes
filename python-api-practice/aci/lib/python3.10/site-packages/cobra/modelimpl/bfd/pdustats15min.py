...
class PduStats15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStats15min", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats15min"
    meta.rnFormat = "CDbfdPduStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats in 15 minute"
