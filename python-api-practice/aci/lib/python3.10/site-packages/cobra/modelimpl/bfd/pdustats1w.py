...
class PduStats1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStats1w", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats1w"
    meta.rnFormat = "CDbfdPduStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats in 1 week"
