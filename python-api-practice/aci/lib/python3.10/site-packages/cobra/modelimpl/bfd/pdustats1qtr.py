...
class PduStats1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStats1qtr", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStats1qtr"
    meta.rnFormat = "CDbfdPduStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BFD Session Stats stats in 1 quarter"
