...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.Entity")

    meta.moClassName = "bfdEntity"
    meta.rnFormat = "bfd"
    meta.category = MoCategory.REGULAR
    meta.label = "BFD Entity"
    ...
    meta.childClasses.add("cobra.model.bfd.Inst")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17539, PropCategory.REGULAR)
