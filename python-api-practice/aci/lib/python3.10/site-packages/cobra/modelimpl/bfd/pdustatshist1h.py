...
class PduStatsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist1h", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist1h"
    meta.rnFormat = "HDbfdPduStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 49643, PropCategory.REGULAR)
