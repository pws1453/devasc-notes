...
class PduStatsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.bfd.PduStatsHist1mo", "BFD Session Stats")
    ...
    meta.moClassName = "bfdPduStatsHist1mo"
    meta.rnFormat = "HDbfdPduStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BFD Session Stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 49644, PropCategory.REGULAR)
