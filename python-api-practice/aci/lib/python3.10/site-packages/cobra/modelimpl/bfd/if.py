...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.If")

    meta.moClassName = "bfdIf"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BFD Interface"
    ...
    meta.childClasses.add("cobra.model.bfd.IfAf")

    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.IfAf", "af-"))
    ...
    prop = PropMeta("str", "id", "id", 17443, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24878, PropCategory.REGULAR)
