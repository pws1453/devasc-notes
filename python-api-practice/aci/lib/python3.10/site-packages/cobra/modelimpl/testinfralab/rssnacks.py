...
class RsSnacks(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.testinfralab.RsSnacks", "cobra.model.testinfralab.SnackP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "testinfralabRsSnacks"
    meta.rnFormat = "rssnacks-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37852, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39991, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13098, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4258
    prop.defaultValueStr = "testinfralabSnackP"
    prop._addConstant("testinfralabSnackP", None, 4258)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13097, PropCategory.REGULAR)
