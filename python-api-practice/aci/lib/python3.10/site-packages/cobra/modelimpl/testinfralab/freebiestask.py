...
# ##################################################
class FreebiesTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.testinfralab.FreebiesTask")

    meta.moClassName = "testinfralabFreebiesTask"
    meta.rnFormat = "testinfralabFreebiesTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5725, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportFreebies", "reportfreebies", 689)
