...
class FcPhysIf(Mo):
    ...
    meta = ClassMeta("cobra.model.fcpm.FcPhysIf")

    meta.moClassName = "fcpmFcPhysIf"
    meta.rnFormat = "fcphys"
    meta.category = MoCategory.REGULAR
    meta.label = "Physical Interface Runtime State (fcpm)"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47655, PropCategory.REGULAR)
