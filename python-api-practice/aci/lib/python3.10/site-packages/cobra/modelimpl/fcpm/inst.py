...
class Inst(Mo):
    """
     This class shall store the global configuration for a running FcPM instance. We have single FcPM in a system 

    """

    meta = ClassMeta("cobra.model.fcpm.Inst")

    meta.moClassName = "fcpmInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Fibre Channel Port Manager Instance"
    ...
    meta.parentClasses.add("cobra.model.fcpm.Entity")
    ...
    prop = PropMeta("str", "edTov", "edTov", 24706, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "raTov", "raTov", 24707, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "switchWWN", "switchWWN", 24705, PropCategory.REGULAR)
    prop.label = "Switch WWN"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("switchWWN", prop)
