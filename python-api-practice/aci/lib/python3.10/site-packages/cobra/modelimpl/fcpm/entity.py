...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.fcpm.Entity")

    meta.moClassName = "fcpmEntity"
    meta.rnFormat = "fcpm"
    meta.category = MoCategory.REGULAR
    meta.label = "Fibre channel Port Manager Entity"
    ...
    meta.childClasses.add("cobra.model.fcpm.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fcpm.Inst", "inst"))
