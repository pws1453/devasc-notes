...
class FcAggrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.fcpm.FcAggrIf")

    meta.moClassName = "fcpmFcAggrIf"
    meta.rnFormat = "fcaggrif"
    ...
    meta.superClasses.add("cobra.model.fcpm.If")

    meta.rnPrefixes = [
        ('fcaggrif', False),
    ]

    prop = PropMeta("str", "accessVlan", "accessVlan", 38949, PropCategory.REGULAR)
    prop.label = "Access Vlan"
    prop.isOper = True
    meta.props.add("accessVlan", prop)

    prop = PropMeta("str", "activeMbrs", "activeMbrs", 38965, PropCategory.REGULAR)
    prop.label = "List of Active Members"
    prop.isOper = True
    meta.props.add("activeMbrs", prop)

    prop = PropMeta("str", "allowedVlans", "allowedVlans", 38958, PropCategory.REGULAR)
    prop.label = "Allowed Vlans"
    prop.isOper = True
    meta.props.add("allowedVlans", prop)

    prop = PropMeta("str", "allowedVsanBmp", "allowedVsanBmp", 47341, PropCategory.REGULAR)
    prop.label = "Allowed Vsan Bitmap"
    prop.isOper = True
    meta.props.add("allowedVsanBmp", prop)

    prop = PropMeta("str", "bundleIndex", "bundleIndex", 38961, PropCategory.REGULAR)
    prop.label = "Bundle Index"
    prop.isOper = True
    meta.props.add("bundleIndex", prop)

    prop = PropMeta("str", "cfgAccessVlan", "cfgAccessVlan", 38952, PropCategory.REGULAR)
    prop.label = "Port Config Access Vlan"
    prop.isOper = True
    meta.props.add("cfgAccessVlan", prop)

    prop = PropMeta("str", "cfgNativeVlan", "cfgNativeVlan", 38951, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 38956, PropCategory.REGULAR)
    prop.label = "Port Encap"
    prop.isOper = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "errDisTimerRunning", "errDisTimerRunning", 38962, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "errVlans", "errVlans", 38960, PropCategory.REGULAR)
    prop.label = "Errored Vlans"
    prop.isOper = True
    meta.props.add("errVlans", prop)

    prop = PropMeta("str", "intfT", "intfT", 38963, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "iod", "iod", 38957, PropCategory.REGULAR)
    prop.label = "Iod"
    prop.isOper = True
    meta.props.add("iod", prop)

    prop = PropMeta("str", "lastLinkStChg", "lastLinkStChg", 47652, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47654, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "nativeVlan", "nativeVlan", 38950, PropCategory.REGULAR)
    prop.label = "Port Native Vlan"
    prop.isOper = True
    meta.props.add("nativeVlan", prop)

    prop = PropMeta("str", "numActivePorts", "numActivePorts", 38964, PropCategory.REGULAR)
    prop.label = "Number of Active Por"
    prop.isOper = True
    meta.props.add("numActivePorts", prop)

    prop = PropMeta("str", "numMbrUp", "numMbrUp", 38966, PropCategory.REGULAR)
    prop.label = "Number of Up Members"
    prop.isOper = True
    meta.props.add("numMbrUp", prop)

    prop = PropMeta("str", "operErrDisQual", "operErrDisQual", 38946, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operMode", "operMode", 38948, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operPortVsan", "operPortVsan", 47337, PropCategory.REGULAR)
    prop.label = "Operational Port vsan"
    prop.isOper = True
    prop.range = [(1, 4094)]
    meta.props.add("operPortVsan", prop)

    prop = PropMeta("str", "operSpeed", "operSpeed", 38947, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 38943, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 38944, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQualCode", "operStQualCode", 38945, PropCategory.REGULAR)
    prop.label = "Operational State Qualifier Code"
    prop.isOper = True
    meta.props.add("operStQualCode", prop)

    prop = PropMeta("str", "operTrkingMode", "operTrkingMode", 47338, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operVlans", "operVlans", 38959, PropCategory.REGULAR)
    prop.label = "Operational Vlans"
    prop.isOper = True
    meta.props.add("operVlans", prop)

    prop = PropMeta("str", "osSum", "osSum", 38942, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "primaryVlan", "primaryVlan", 38953, PropCategory.REGULAR)
    prop.label = "Port Primary-vlan"
    prop.isOper = True
    meta.props.add("primaryVlan", prop)

    prop = PropMeta("str", "resetCtr", "resetCtr", 38955, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "trunkIsolatedVsanBmp", "trunkIsolatedVsanBmp", 47340, PropCategory.REGULAR)
    prop.label = "Isolated Trunking Vsans Bitmap"
    prop.isOper = True
    meta.props.add("trunkIsolatedVsanBmp", prop)

    prop = PropMeta("str", "trunkPortUpVsanBmp", "trunkPortUpVsanBmp", 47339, PropCategory.REGULAR)
    prop.label = "Trunk Port Up Vsan Bitmap"
    prop.isOper = True
    meta.props.add("trunkPortUpVsanBmp", prop)

    prop = PropMeta("str", "vdcId", "vdcId", 38954, PropCategory.REGULAR)
    prop.label = "Vdc Id"
    prop.isOper = True
    prop.range = [(1, 4096)]
