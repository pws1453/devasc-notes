...
# ##################################################
class RsToNodeIdentP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pres.RsToNodeIdentP", "cobra.model.fabric.NodeIdentP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "presRsToNodeIdentP"
    meta.rnFormat = "rstoNodeIdentP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Node Member"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27070, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27069, PropCategory.REGULAR)
