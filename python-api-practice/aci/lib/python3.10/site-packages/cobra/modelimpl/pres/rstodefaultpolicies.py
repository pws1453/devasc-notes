...
# ##################################################
class RsToDefaultPolicies(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pres.RsToDefaultPolicies", "cobra.model.pres.Registry")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "presRsToDefaultPolicies"
    meta.rnFormat = "rstoDefaultPolicies"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25879, PropCategory.REGULAR)
