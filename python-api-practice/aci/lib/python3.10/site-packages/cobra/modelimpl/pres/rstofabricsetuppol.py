...
# ##################################################
class RsToFabricSetupPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pres.RsToFabricSetupPol", "cobra.model.fabric.SetupPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "presRsToFabricSetupPol"
    meta.rnFormat = "rstoFabricSetupPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Setup Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24011, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7234
    prop.defaultValueStr = "fabricSetupPol"
    prop._addConstant("fabricSetupPol", None, 7234)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24010, PropCategory.REGULAR)
