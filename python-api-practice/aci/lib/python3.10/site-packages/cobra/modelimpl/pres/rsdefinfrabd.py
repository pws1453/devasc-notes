...
# ##################################################
class RsDefInfraBd(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.pres.RsDefInfraBd", "cobra.model.fv.BD")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "presRsDefInfraBd"
    meta.rnFormat = "rsdefInfraBd"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17856, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17855, PropCategory.REGULAR)
