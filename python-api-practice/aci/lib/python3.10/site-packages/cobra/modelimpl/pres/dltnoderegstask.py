...
# ##################################################
class DltNodeRegsTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pres.DltNodeRegsTask")

    meta.moClassName = "presDltNodeRegsTask"
    meta.rnFormat = "presDltNodeRegsTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 20407, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("NotifyShard", "notifyshard", 1773)
