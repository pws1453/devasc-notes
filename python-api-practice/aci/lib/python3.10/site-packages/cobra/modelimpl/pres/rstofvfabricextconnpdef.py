...
# ##################################################
class RsToFvFabricExtConnPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pres.RsToFvFabricExtConnPDef", "cobra.model.fv.FabricExtConnPDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "presRsToFvFabricExtConnPDef"
    meta.rnFormat = "rstoFvFabricExtConnPDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Multipod Profile Definition"
    ...
    meta.parentClasses.add("cobra.model.pres.SubsDfltPolicy")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rstoFvFabricExtConnPDef', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27155, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27154, PropCategory.REGULAR)
