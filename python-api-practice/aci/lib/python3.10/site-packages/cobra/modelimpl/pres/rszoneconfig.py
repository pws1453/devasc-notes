...
# ##################################################
class RsZoneConfig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pres.RsZoneConfig", "cobra.model.infrazone.ZoneCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "presRsZoneConfig"
    meta.rnFormat = "rszoneConfig"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22829, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7738
    prop.defaultValueStr = "infrazoneZoneCont"
    prop._addConstant("infrazoneZoneCont", None, 7738)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22828, PropCategory.REGULAR)
