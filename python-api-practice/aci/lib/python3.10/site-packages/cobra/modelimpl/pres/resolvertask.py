...
class ResolverTask(Mo):
    ...
    meta = ClassMeta("cobra.model.pres.ResolverTask")

    meta.moClassName = "presResolverTask"
    meta.rnFormat = "presResolverTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5701, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ResolverRepl", "resolverrepl", 632)
