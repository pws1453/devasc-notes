...
# ##################################################
class RsPresRegdPodCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pres.RsPresRegdPodCont", "cobra.model.pres.RegdPodCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "presRsPresRegdPodCont"
    meta.rnFormat = "rspresRegdPodCont"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Registered Pod Container"
    ...
    meta.childClasses.add("cobra.model.pres.PodEvntLsn")

    meta.childNamesAndRnPrefix.append(("cobra.model.pres.PodEvntLsn", "list-"))

    meta.parentClasses.add("cobra.model.pres.RelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rspresRegdPodCont', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 20395, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6876
    prop.defaultValueStr = "presRegdPodCont"
    prop._addConstant("presRegdPodCont", None, 6876)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20394, PropCategory.REGULAR)
