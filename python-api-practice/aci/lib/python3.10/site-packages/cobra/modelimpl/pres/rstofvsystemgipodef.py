...
# ##################################################
class RsToFvSystemGIPoDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pres.RsToFvSystemGIPoDef", "cobra.model.fv.SystemGIPoDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "presRsToFvSystemGIPoDef"
    meta.rnFormat = "rstoFvSystemGIPoDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "System GIPo Definition"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24003, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8147
    prop.defaultValueStr = "fvSystemGIPoDef"
    prop._addConstant("fvSystemGIPoDef", None, 8147)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24002, PropCategory.REGULAR)
