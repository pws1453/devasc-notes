...
# ##################################################
class RsPresClass(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = SourceRelationMeta("cobra.model.pres.RsPresClass", "cobra.model.pres.Class")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "presRsPresClass"
    meta.rnFormat = "rspresClass-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.pres.Listener")

    meta.childNamesAndRnPrefix.append(("cobra.model.pres.Listener", "list-"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 12868, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3967
    prop.defaultValueStr = "presClass"
    prop._addConstant("presClass", None, 3967)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12867, PropCategory.REGULAR)
