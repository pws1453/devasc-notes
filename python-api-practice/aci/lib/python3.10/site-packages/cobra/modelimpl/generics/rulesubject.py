...
# ##################################################
class RuleSubject(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.generics.RuleSubject")

    meta.moClassName = "genericsRuleSubject"
    meta.rnFormat = "rulesubject-[%(subjectKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Rule Subject"
    ...
    prop = PropMeta("str", "changeSet", "changeSet", 50497, PropCategory.REGULAR)
    prop.label = "Change Set"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("changeSet", prop)
    ...
    prop = PropMeta("str", "nodeTag", "nodeTag", 50496, PropCategory.REGULAR)
    prop.label = "Node Tag"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("nodeTag", prop)
    ...
    prop = PropMeta("str", "subjectKey", "subjectKey", 50495, PropCategory.REGULAR)
    prop.label = "Key"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("subjectKey", prop)

    meta.namingProps.append(getattr(meta.props, "subjectKey"))
    getattr(meta.props, "subjectKey").needDelimiter = True

    def __init__(self, parentMoOrDn, subjectKey, markDirty=True, **creationProps):
        namingVals = [subjectKey]
