...
class Src(Mo):
    ...
    meta = ClassMeta("cobra.model.tacacs.Src")

    meta.moClassName = "tacacsSrc"
    meta.rnFormat = "tacacssrc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TACACS Source"
    ...
    meta.childClasses.add("cobra.model.tacacs.RsDestGroup")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tacacs.RsDestGroup", "rsdestGroup"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 41121, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 41122, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "incl", "incl", 41106, PropCategory.REGULAR)
    prop.label = "Include Action"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = "audit,session"
    prop.defaultValueStr = "audit,session"
    ...
    prop = PropMeta("str", "minSev", "minSev", 41107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 41117, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 41105, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "tacacs"
    prop.defaultValueStr = "tacacs"
