...
class TacacsDest(Mo):
    ...
    meta = ClassMeta("cobra.model.tacacs.TacacsDest")

    meta.moClassName = "tacacsTacacsDest"
    meta.rnFormat = "tacacsdest-%(host)s-port-%(port)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TACACS Destination"
    ...
    prop = PropMeta("str", "annotation", "annotation", 41125, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "authProtocol", "authProtocol", 41110, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 41126, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "host", "host", 41112, PropCategory.REGULAR)
    prop.label = "Host"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "key", "key", 41109, PropCategory.REGULAR)
    prop.label = "Key"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 41119, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "port", "port", 41108, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
