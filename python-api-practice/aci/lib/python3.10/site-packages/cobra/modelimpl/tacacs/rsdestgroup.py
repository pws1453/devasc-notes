...
class RsDestGroup(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.tacacs.RsDestGroup", "cobra.model.tacacs.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "tacacsRsDestGroup"
    meta.rnFormat = "rsdestGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "TACACS Destination Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 41123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 41124, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 41118, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 41114, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11992
    prop.defaultValueStr = "tacacsGroup"
    prop._addConstant("tacacsGroup", None, 11992)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 41113, PropCategory.REGULAR)
