...
# ##################################################
class McastIfDefCont(Mo):
    """
     Interface Policy Container

    """

    meta = ClassMeta("cobra.model.rtdmc.McastIfDefCont")

    meta.moClassName = "rtdmcMcastIfDefCont"
    meta.rnFormat = "mcastifdefcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Multicast Interface Profile Container"
    ...
    meta.childClasses.add("cobra.model.pim.IfDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.IfDef", "pimifdef"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.AIfPolCont")
    meta.superClasses.add("cobra.model.fabric.ProtoIfPol")

    meta.rnPrefixes = [
        ('mcastifdefcont', False),
    ]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25971, PropCategory.REGULAR)
