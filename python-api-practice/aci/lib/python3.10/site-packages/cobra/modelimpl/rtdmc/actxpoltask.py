...
# ##################################################
class ACtxPolTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtdmc.ACtxPolTask")

    meta.moClassName = "rtdmcACtxPolTask"
    meta.rnFormat = "rtdmcACtxPolTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 47412, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("releaseMcastGipoAddr", "releasemcastgipoaddr", 3305)
    prop._addConstant("requestMcastGipoAddr", "requestmcastgipoaddr", 3304)
