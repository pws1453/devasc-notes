...
# ##################################################
class AInterVRFEntry(Mo):
    meta = ClassMeta("cobra.model.rtdmc.AInterVRFEntry")

    meta.isAbstract = True
    meta.moClassName = "rtdmcAInterVRFEntry"


    meta.moClassName = "rtdmcAInterVRFEntry"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Multicast Inter VRF Entry"
    ...
    prop = PropMeta("str", "srcVrfDn", "srcVrfDn", 44620, PropCategory.REGULAR)
