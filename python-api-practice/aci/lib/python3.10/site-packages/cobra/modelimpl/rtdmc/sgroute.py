...
# ##################################################
class SGRoute(Mo):
    meta = ClassMeta("cobra.model.rtdmc.SGRoute")

    meta.isAbstract = True
    meta.moClassName = "rtdmcSGRoute"
    ...
    prop = PropMeta("str", "grp", "grp", 24532, PropCategory.REGULAR)
    prop.label = "Group"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "src", "src", 24531, PropCategory.REGULAR)
    prop.label = "Source"
    prop.isImplicit = True
    prop.isAdmin = True
