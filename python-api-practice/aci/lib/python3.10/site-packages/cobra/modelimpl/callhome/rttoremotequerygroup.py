...
# ##################################################
class RtToRemoteQueryGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.callhome.RtToRemoteQueryGroup", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "callhomeRtToRemoteQueryGroup"
    meta.rnFormat = "rtfvToRemoteQueryGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23247, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23246, PropCategory.REGULAR)
