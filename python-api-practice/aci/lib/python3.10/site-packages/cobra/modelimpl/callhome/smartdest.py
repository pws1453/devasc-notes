...
class SmartDest(Mo):
    ...
    meta = ClassMeta("cobra.model.callhome.SmartDest")

    meta.moClassName = "callhomeSmartDest"
    meta.rnFormat = "smartdest-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Smart Callhome Destination"
    ...
    meta.superClasses.add("cobra.model.callhome.ADest")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38835, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40974, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36989, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 36970, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
