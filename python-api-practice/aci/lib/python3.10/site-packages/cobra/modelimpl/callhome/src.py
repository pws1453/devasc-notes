...
class Src(Mo):
    ...
    meta = ClassMeta("cobra.model.callhome.Src")

    meta.moClassName = "callhomeSrc"
    meta.rnFormat = "chsrc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Callhome Source"
    ...
    meta.childClasses.add("cobra.model.callhome.RsDestGroup")
    meta.childClasses.add("cobra.model.callhome.RsQueryGroupRel")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RsQueryGroupRel", "rsqueryGroupRel"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RsDestGroup", "rsdestGroup"))
    ...
    meta.superClasses.add("cobra.model.callhome.ASrc")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37571, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39710, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "incl", "incl", 1534, PropCategory.REGULAR)
    prop.label = "Include Action"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "faults"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14173, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 5896, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "urgency", "urgency", 1561, PropCategory.REGULAR)
    prop.label = "Message Severity"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "alert"
    prop._addConstant("alert", "alerts", 1)
    prop._addConstant("critical", "critical", 2)
    prop._addConstant("debug", "debugging", 7)
    prop._addConstant("emergency", "emergencies", 0)
    prop._addConstant("error", "errors", 3)
    prop._addConstant("info", "information", 6)
    prop._addConstant("notice", "notifications", 5)
    prop._addConstant("warning", "warnings", 4)
    meta.props.add("urgency", prop)
