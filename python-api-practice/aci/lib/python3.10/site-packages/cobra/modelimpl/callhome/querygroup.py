...
class QueryGroup(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RtToRemoteQueryGroupRefEvent", "rtfaultToRemoteQueryGroupRefEvent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RtToRemoteQueryGroup", "rtfvToRemoteQueryGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RtQueryGroupRel", "rtqueryGroupRel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.Query", "chquery-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37581, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39720, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
