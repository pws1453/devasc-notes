...
# ##################################################
class RsQueryGroupRel(Mo):
    """
    A source relation to a call home query group.

    """

    meta = SourceRelationMeta("cobra.model.callhome.RsQueryGroupRel", "cobra.model.callhome.QueryGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "callhomeRsQueryGroupRel"
    meta.rnFormat = "rsqueryGroupRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Callhome Querygroup"
    ...
    meta.rnPrefixes = [
        ('rsqueryGroupRel', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37573, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39712, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14175, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12031, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1709
    prop.defaultValueStr = "callhomeQueryGroup"
    prop._addConstant("callhomeQueryGroup", None, 1709)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12030, PropCategory.REGULAR)
