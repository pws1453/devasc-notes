...
class Prof(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.SmtpServer", "smtp"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37570, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39709, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "transport", "transport", 1551, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
