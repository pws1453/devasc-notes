...
class RsDestGroupRel(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.callhome.RsDestGroupRel", "cobra.model.callhome.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "callhomeRsDestGroupRel"
    meta.rnFormat = "rsdestGroupRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Callhome Destination Group"
    ...
    meta.rnPrefixes = [
        ('rsdestGroupRel', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37579, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39718, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14181, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12038, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1700
    prop.defaultValueStr = "callhomeGroup"
    prop._addConstant("callhomeGroup", None, 1700)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12037, PropCategory.REGULAR)
