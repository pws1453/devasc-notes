...
# ##################################################
class RtToRemoteQueryGroupRefEvent(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.callhome.RtToRemoteQueryGroupRefEvent", "cobra.model.fault.RelnHolder")

    meta.moClassName = "callhomeRtToRemoteQueryGroupRefEvent"
    meta.rnFormat = "rtfaultToRemoteQueryGroupRefEvent-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfaultToRemoteQueryGroupRefEvent-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23674, PropCategory.REGULAR)
