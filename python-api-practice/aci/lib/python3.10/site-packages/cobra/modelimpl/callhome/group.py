...
class Group(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RtDestGroupRel", "rtdestGroupRel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RtDestGroup", "rtdestGroup-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37575, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39714, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
