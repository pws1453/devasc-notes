...
# ##################################################
class RsSmartdestGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.callhome.RsSmartdestGroup", "cobra.model.callhome.SmartGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "callhomeRsSmartdestGroup"
    meta.rnFormat = "rssmartdestGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to CallHome Destination Smart Group"
    ...
    meta.rnPrefixes = [
        ('rssmartdestGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38834, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40973, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36988, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 36984, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11772
    prop.defaultValueStr = "callhomeSmartGroup"
    prop._addConstant("callhomeSmartGroup", None, 11772)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 36983, PropCategory.REGULAR)
