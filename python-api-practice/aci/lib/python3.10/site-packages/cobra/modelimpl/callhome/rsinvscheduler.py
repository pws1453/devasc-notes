...
# ##################################################
class RsInvScheduler(Mo):
    """
    A source relation to the scheduler policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.callhome.RsInvScheduler", "cobra.model.trig.SchedP")
    meta.targetNameProps["name"] = "tnTrigSchedPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "callhomeRsInvScheduler"
    meta.rnFormat = "rsInvScheduler"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Callhome Inventory Scheduler"
    ...
    meta.rnPrefixes = [
        ('rsInvScheduler', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37578, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39717, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14180, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12035, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTrigSchedPName", "tnTrigSchedPName", 12034, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
