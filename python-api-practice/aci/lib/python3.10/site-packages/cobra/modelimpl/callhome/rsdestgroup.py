...
class RsDestGroup(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.callhome.RsDestGroup", "cobra.model.callhome.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "callhomeRsDestGroup"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37572, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39711, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14174, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12027, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12026, PropCategory.REGULAR)
