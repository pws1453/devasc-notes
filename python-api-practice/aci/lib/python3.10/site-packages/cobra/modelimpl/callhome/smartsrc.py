...
class SmartSrc(Mo):
    ...
    meta = ClassMeta("cobra.model.callhome.SmartSrc")

    meta.moClassName = "callhomeSmartSrc"
    meta.rnFormat = "smartchsrc"
    meta.category = MoCategory.REGULAR
    meta.label = "Smart Callhome Source"
    ...
    meta.childClasses.add("cobra.model.callhome.RsSmartdestGroup")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.mon.MonObjDn")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.callhome.SmartCallhomeFault")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.callhome.RsQueryGroupRel")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.RsSmartdestGroup", "rssmartdestGroup"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.callhome.SmartCallhomeFault", "code-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38833, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40972, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "incl", "incl", 43404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36987, PropCategory.REGULAR)
