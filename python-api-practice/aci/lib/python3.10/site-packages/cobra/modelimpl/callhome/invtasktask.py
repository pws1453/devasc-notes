...
# ##################################################
class InvTaskTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.callhome.InvTaskTask")

    meta.moClassName = "callhomeInvTaskTask"
    meta.rnFormat = "callhomeInvTaskTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16514, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendInventory", "sendinventory", 1459)
