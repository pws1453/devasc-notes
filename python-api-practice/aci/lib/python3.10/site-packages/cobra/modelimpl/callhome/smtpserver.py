...
class SmtpServer(Mo):
    ...
    meta = ClassMeta("cobra.model.callhome.SmtpServer")

    meta.moClassName = "callhomeSmtpServer"
    meta.rnFormat = "smtp"
    meta.category = MoCategory.REGULAR
    meta.label = "SMTP Server for Callhome"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37576, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39715, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14178, PropCategory.REGULAR)
