...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.draw.Inst")

    meta.moClassName = "drawInst"
    meta.rnFormat = "item-[%(oDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Graph Node"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38019, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40158, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "info", "info", 5240, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("info", prop)
    ...
    prop = PropMeta("str", "oDn", "oDn", 5241, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
