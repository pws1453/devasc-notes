...
class Cont(Mo):
    ...
    meta = ClassMeta("cobra.model.draw.Cont")

    meta.moClassName = "drawCont"
    meta.rnFormat = "cont"
    meta.category = MoCategory.REGULAR
    meta.label = "Graph Node Container"
    ...
    meta.childClasses.add("cobra.model.draw.Inst")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.draw.Inst", "item-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38020, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40159, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
