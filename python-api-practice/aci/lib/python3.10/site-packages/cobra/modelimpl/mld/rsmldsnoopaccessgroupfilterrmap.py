...
# ##################################################
class RsMldsnoopAccessGroupFilterRMap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.mld.RsMldsnoopAccessGroupFilterRMap", "cobra.model.pim.RouteMapPol")
    meta.targetNameProps["name"] = "tnPimRouteMapPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mldRsMldsnoopAccessGroupFilterRMap"
    meta.rnFormat = "rsmldsnoopAccessGroupFilterRMap"
    ...
    meta.rnPrefixes = [
        ('rsmldsnoopAccessGroupFilterRMap', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 53271, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 53272, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53266, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 53262, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnPimRouteMapPolName", "tnPimRouteMapPolName", 53261, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
