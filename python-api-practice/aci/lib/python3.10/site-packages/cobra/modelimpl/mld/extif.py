...
class ExtIf(Mo):
    ...
    meta = ClassMeta("cobra.model.mld.ExtIf")

    meta.moClassName = "mldExtIf"
    meta.rnFormat = "extif-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "MLD External Interface"
    ...
    meta.parentClasses.add("cobra.model.mld.ExtDom")
    ...
    prop = PropMeta("str", "flags", "flags", 55507, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    prop._addConstant("mcast", "multicast-enabled", 1)
    meta.props.add("flags", prop)

    prop = PropMeta("str", "id", "id", 55526, PropCategory.REGULAR)
