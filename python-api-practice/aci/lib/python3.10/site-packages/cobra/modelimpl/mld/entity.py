...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.mld.Entity")

    meta.moClassName = "mldEntity"
    meta.rnFormat = "mld"
    meta.category = MoCategory.REGULAR
    meta.label = "mld Entity"
    ...
    meta.childClasses.add("cobra.model.mld.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.mld.Inst", "inst"))
