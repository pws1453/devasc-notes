...
class Db(Mo):
    ...
    meta = ClassMeta("cobra.model.mld.Db")

    meta.moClassName = "mldDb"
    meta.rnFormat = "db-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "MLD Database"
    ...
    meta.childClasses.add("cobra.model.mld.Route")

    meta.childNamesAndRnPrefix.append(("cobra.model.mld.Route", "src-"))
    ...
    prop = PropMeta("str", "type", "type", 55504, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("route", "mld-route-database", 1)
