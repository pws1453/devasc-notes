...
class PhysIf(Mo):
    ...
    meta = ClassMeta("cobra.model.cnw.PhysIf")

    meta.moClassName = "cnwPhysIf"
    meta.rnFormat = "cphys-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Controller Physical Interface"
    ...
    meta.childClasses.add("cobra.model.cnw.RtActiveIf")
    ...
    meta.childClasses.add("cobra.model.cnw.RtMbrIfs")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cnw.RtActiveIf", "rtactiveIf"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cnw.RtMbrIfs", "rtmbrIfs"))
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37341, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deviceId", "deviceId", 61951, PropCategory.REGULAR)
    prop.label = "PCI Device ID"
    prop.isOper = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39480, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 5904, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 659, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vendorId", "vendorId", 61950, PropCategory.REGULAR)
    prop.label = "PCI Vendor ID"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("vendorId", prop)

    prop = PropMeta("str", "wiringIssues", "wiringIssues", 660, PropCategory.REGULAR)
