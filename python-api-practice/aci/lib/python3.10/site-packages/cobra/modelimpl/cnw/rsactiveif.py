...
class RsActiveIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.cnw.RsActiveIf", "cobra.model.cnw.PhysIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "cnwRsActiveIf"
    meta.rnFormat = "rsactiveIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Active Interface"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15018, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 11330, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11329, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15017, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
