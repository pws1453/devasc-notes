...
class RsMbrIfs(Mo):
    """
    A source relation to the physical interface assigned to the node cluster.

    """

    meta = SourceRelationMeta("cobra.model.cnw.RsMbrIfs", "cobra.model.cnw.PhysIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "cnwRsMbrIfs"
    meta.rnFormat = "rsmbrIfs-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Member Iinterfaces"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15022, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 11333, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 401
    prop.defaultValueStr = "cnwPhysIf"
    prop._addConstant("cnwPhysIf", None, 401)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11332, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15021, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
