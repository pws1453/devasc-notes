...
# ##################################################
class RxPktsHist1qtr(Mo):
    """
    A class that represents historical statistics for  Rx  Packet counters in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPktsHist1qtr", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist1qtr"
    meta.rnFormat = "HDvnsRxPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 7378, PropCategory.REGULAR)
