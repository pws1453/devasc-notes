...
# ##################################################
class RsConnToCtxTermInst(Mo):
    """
    A source relation to a terminal. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnToCtxTermInst", "cobra.model.vns.ATerm")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnToCtxTermInst"
    meta.rnFormat = "rsConnToCtxTermInst"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Connector Instance to a Terminal Node"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14878, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13631, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13630, PropCategory.REGULAR)
