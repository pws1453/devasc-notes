...
class AbsGrpCfg(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.AbsGrpCfg")

    meta.moClassName = "vnsAbsGrpCfg"
    meta.rnFormat = "absGrpCfg"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Group Shared Config"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37965, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40104, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14811, PropCategory.REGULAR)
