...
class RtGraphAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtGraphAtt", "cobra.model.vz.BrCP")

    meta.moClassName = "vnsRtGraphAtt"
    meta.rnFormat = "rtvzGraphAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11809, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11808, PropCategory.REGULAR)
