...
# ##################################################
class RxPkts15min(Mo):
    """
    A class that represents the most current statistics for  Rx  Packet counters in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPkts15min", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPkts15min"
    meta.rnFormat = "CDvnsRxPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Rx Packet counters stats in 15 minute"
