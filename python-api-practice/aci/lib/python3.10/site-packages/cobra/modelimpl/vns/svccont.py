...
class SvcCont(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.SvcCont")

    meta.moClassName = "vnsSvcCont"
    meta.rnFormat = "svcCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Service Container"
    meta.writeAccessMask = 0x2000000000000001
    meta.readAccessMask = 0x2000000000000005
    ...
    meta.childClasses.add("cobra.model.vns.SvcEPgPol")
    meta.childClasses.add("cobra.model.vns.InstPol")
    meta.childClasses.add("cobra.model.vns.RedirectHealthGroup")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.vns.BackupPol")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.vns.SvcRedirectPol")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RedirectHealthGroup", "redirectHealthGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SvcRedirectPol", "svcRedirectPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SvcEPgPol", "svcEPgPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.BackupPol", "backupPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.InstPol", "instPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38265, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40404, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30313, PropCategory.REGULAR)
