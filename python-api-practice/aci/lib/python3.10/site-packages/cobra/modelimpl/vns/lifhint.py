...
class LIfHint(Mo):
    """
    Contains hints for the logical interface that must be picked for a specific connector of a graph that belongs to the selected device cluster. The device cluster is selected based on device cluster hint.

    """

    meta = ClassMeta("cobra.model.vns.LIfHint")

    meta.moClassName = "vnsLIfHint"
    meta.rnFormat = "lIfHint"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Interface Hint"
    ...
    prop = PropMeta("str", "connNameOrLbl", "connNameOrLbl", 5024, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16121, PropCategory.REGULAR)
