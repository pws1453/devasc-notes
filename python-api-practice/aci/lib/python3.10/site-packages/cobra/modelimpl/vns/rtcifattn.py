...
class RtCIfAttN(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtCIfAttN", "cobra.model.vns.ALIf")

    meta.moClassName = "vnsRtCIfAttN"
    meta.rnFormat = "rtcIfAttN-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22032, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22031, PropCategory.REGULAR)
