...
# ##################################################
class RsLIfCtxToOutDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToOutDef", "cobra.model.l3ext.OutDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToOutDef"
    meta.rnFormat = "rsLIfCtxToOutDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to l3ext:OutDef"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33076, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33068, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5986
    prop.defaultValueStr = "l3extOutDef"
    prop._addConstant("l3extOutDef", None, 5986)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33067, PropCategory.REGULAR)
