...
class RtVnsmdev(Mo):
    """
    A target relation to definitions of the metadata for a service device type. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtVnsmdev", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "vnsRtVnsmdev"
    meta.rnFormat = "rtpolVnsmdev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13490, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13489, PropCategory.REGULAR)
