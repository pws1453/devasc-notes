...
# ##################################################
class RsSEPpInfoAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsSEPpInfoAtt", "cobra.model.vns.SDEPpInfo")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsSEPpInfoAtt"
    meta.rnFormat = "rsSEPpInfoAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17769, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5958
    prop.defaultValueStr = "vnsSDEPpInfo"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsSDEPpInfo", None, 5958)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17768, PropCategory.REGULAR)
