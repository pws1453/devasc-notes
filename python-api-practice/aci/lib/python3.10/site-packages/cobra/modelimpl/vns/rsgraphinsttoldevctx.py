...
# ##################################################
class RsGraphInstToLDevCtx(Mo):
    """
    A source relation to a device cluster. This MO is managed internally and should not be modified by the user.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsGraphInstToLDevCtx", "cobra.model.vns.LDevCtx")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsGraphInstToLDevCtx"
    meta.rnFormat = "rsGraphInstToLDevCtx"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13603, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13602, PropCategory.REGULAR)
