...
# ##################################################
class RsALDevToPhysDomP(Mo):
    """
    A source relation to a physical domain profile.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsALDevToPhysDomP", "cobra.model.phys.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsALDevToPhysDomP"
    meta.rnFormat = "rsALDevToPhysDomP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from L4-L7 Devices to a Vlan Namespace Instance Profile"
    ...
    meta.rnPrefixes = [
        ('rsALDevToPhysDomP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37997, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40136, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14898, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13683, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1809
    prop.defaultValueStr = "physDomP"
    prop._addConstant("physDomP", None, 1809)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13682, PropCategory.REGULAR)
