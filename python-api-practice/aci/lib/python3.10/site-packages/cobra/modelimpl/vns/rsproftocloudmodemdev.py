...
# ##################################################
class RsProfToCloudModeMDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsProfToCloudModeMDev", "cobra.model.vns.MDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsProfToCloudModeMDev"
    meta.rnFormat = "rsProfToCloudModeMDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to CloudMode MDev."
    ...
    meta.rnPrefixes = [
        ('rsProfToCloudModeMDev', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38813, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40952, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36804, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 36801, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 36800, PropCategory.REGULAR)
