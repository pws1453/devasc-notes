...
class AbsDevCfg(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.AbsDevCfg")

    meta.moClassName = "vnsAbsDevCfg"
    meta.rnFormat = "absDevCfg"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Device Shared Config"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40103, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14810, PropCategory.REGULAR)
