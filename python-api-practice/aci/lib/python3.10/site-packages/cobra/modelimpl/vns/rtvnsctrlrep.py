...
# ##################################################
class RtVnsCtrlrEp(Mo):
    """
    A target relation to the controller appliance IP address and connectivity information. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtVnsCtrlrEp", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "vnsRtVnsCtrlrEp"
    meta.rnFormat = "rtpolVnsCtrlrEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15603, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15602, PropCategory.REGULAR)
