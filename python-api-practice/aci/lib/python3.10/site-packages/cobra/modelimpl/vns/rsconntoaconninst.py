...
# ##################################################
class RsConnToAConnInst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnToAConnInst", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnToAConnInst"
    meta.rnFormat = "rsConnToAConnInst"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Connector Instance to a function/Terminal connector"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20741, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20737, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20736, PropCategory.REGULAR)
