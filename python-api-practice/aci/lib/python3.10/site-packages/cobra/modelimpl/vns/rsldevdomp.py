...
class RsLDevDomP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsLDevDomP", "cobra.model.infra.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsLDevDomP"
    meta.rnFormat = "rsLDevDomP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23308, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23307, PropCategory.REGULAR)
