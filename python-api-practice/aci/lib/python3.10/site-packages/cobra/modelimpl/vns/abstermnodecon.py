...
# ##################################################
class AbsTermNodeCon(Mo):
    """
    An abstract terminal node connected to a contract consumer.

    """

    meta = ClassMeta("cobra.model.vns.AbsTermNodeCon")

    meta.moClassName = "vnsAbsTermNodeCon"
    meta.rnFormat = "AbsTermNodeCon-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Consumer Terminal Node"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38082, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40221, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15297, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 15241, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
