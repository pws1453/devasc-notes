...
# ##################################################
class RsConnToFlt(Mo):
    """
    A source relation to a filter. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnToFlt", "cobra.model.vz.AFilterable")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnToFlt"
    meta.rnFormat = "rsConnToFlt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Function Connector to a Filter Object"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37974, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40113, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14824, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13545, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1314
    prop.defaultValueStr = "vzAFilterable"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13544, PropCategory.REGULAR)
