...
class AddrInst(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.AddrInst")

    meta.moClassName = "vnsAddrInst"
    meta.rnFormat = "CtrlrAddrInst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Address Pool"
    meta.writeAccessMask = 0x2601
    meta.readAccessMask = 0x4000000000002601
    ...
    meta.childClasses.add("cobra.model.vns.RtMgmtAddr")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtMgmtAddr", "rtmgmtAddr"))
    ...
    prop = PropMeta("str", "addr", "addr", 16169, PropCategory.REGULAR)
    prop.label = "IP Address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 38115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40254, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 16170, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 16174, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
