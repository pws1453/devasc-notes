...
# ##################################################
class RtAbsGraphRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtAbsGraphRef", "cobra.model.orchs.SvcRsrcPool")

    meta.moClassName = "vnsRtAbsGraphRef"
    meta.rnFormat = "rtorchsAbsGraphRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34621, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34620, PropCategory.REGULAR)
