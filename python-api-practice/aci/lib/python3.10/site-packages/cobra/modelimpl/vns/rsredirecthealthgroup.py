...
# ##################################################
class RsRedirectHealthGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsRedirectHealthGroup", "cobra.model.vns.RedirectHealthGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsRedirectHealthGroup"
    meta.rnFormat = "rsRedirectHealthGroup"
    ...
    meta.rnPrefixes = [
        ('rsRedirectHealthGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38743, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40882, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34191, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34185, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34184, PropCategory.REGULAR)
