...
# ##################################################
class RsTermToAny(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsTermToAny", "cobra.model.vz.Any")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsTermToAny"
    meta.rnFormat = "rstermToAny-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Terminal Node to Any"
    ...
    prop = PropMeta("str", "anyDn", "anyDn", 16843, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "ctxDefDn", "ctxDefDn", 16844, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ctxDefDn", prop)

    prop = PropMeta("str", "ctxPcTag", "ctxPcTag", 16845, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxSeg", "ctxSeg", 16846, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16848, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16847, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "txId", "txId", 34331, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
