...
# ##################################################
class RedirectDest(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.RedirectDest")

    meta.moClassName = "vnsRedirectDest"
    meta.rnFormat = "RedirectDest_ip-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Destination of redirected traffic"
    ...
    meta.childClasses.add("cobra.model.vns.RsRedirectHealthGroup")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsRedirectHealthGroup", "rsRedirectHealthGroup"))
    ...
    meta.rnPrefixes = [
        ('RedirectDest_ip-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38267, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "destName", "destName", 41094, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40406, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 20989, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ip2", "ip2", 34330, PropCategory.REGULAR)
    prop.label = "Second IP Address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("ip2", prop)
    ...
    prop = PropMeta("str", "mac", "mac", 20990, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26835, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "podId", "podId", 34175, PropCategory.REGULAR)
    prop.label = "Pod Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
