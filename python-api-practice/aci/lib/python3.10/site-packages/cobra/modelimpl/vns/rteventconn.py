...
# ##################################################
class RtEventConn(Mo):
    """
    A target relation to a connector. Note that this relation is an internal object

    """

    meta = TargetRelationMeta("cobra.model.vns.RtEventConn", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "vnsRtEventConn"
    meta.rnFormat = "rteventConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13657, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13656, PropCategory.REGULAR)
