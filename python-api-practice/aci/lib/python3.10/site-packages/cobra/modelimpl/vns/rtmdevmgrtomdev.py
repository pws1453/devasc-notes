...
# ##################################################
class RtMDevMgrToMDev(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vns.RtMDevMgrToMDev", "cobra.model.vns.MDevMgr")

    meta.moClassName = "vnsRtMDevMgrToMDev"
    meta.rnFormat = "rtmDevMgrToMDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18370, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18369, PropCategory.REGULAR)
