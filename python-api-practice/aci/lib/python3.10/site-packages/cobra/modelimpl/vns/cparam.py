...
class CParam(Mo):
    """
    A concrete configuration parameter.

    """

    meta = ClassMeta("cobra.model.vns.CParam")

    meta.moClassName = "vnsCParam"
    meta.rnFormat = "cParam-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete Parameter"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14892, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7320, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 5169, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
