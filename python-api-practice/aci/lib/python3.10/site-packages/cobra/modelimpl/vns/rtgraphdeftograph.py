...
# ##################################################
class RtGraphDefToGraph(Mo):
    """
    A target relation to graph.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtGraphDefToGraph", "cobra.model.vz.GraphDef")

    meta.moClassName = "vnsRtGraphDefToGraph"
    meta.rnFormat = "rtvzGraphDefToGraph-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11937, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1405
    prop.defaultValueStr = "vzGraphDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzGraphDef", None, 1405)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11936, PropCategory.REGULAR)
