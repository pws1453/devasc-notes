...
# ##################################################
class RsALDevToVxlanInstP(Mo):
    """
    A source relation to the VxLAN namespace policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsALDevToVxlanInstP", "cobra.model.fvns.VxlanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsALDevToVxlanInstP"
    meta.rnFormat = "rsALDevToVxlanInstP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from L4-L7 Devices to a Vxlan Namespace Instance Profile"
    ...
    meta.rnPrefixes = [
        ('rsALDevToVxlanInstP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37998, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40137, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14899, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13691, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4561
    prop.defaultValueStr = "fvnsVxlanInstP"
    prop._addConstant("fvnsVxlanInstP", None, 4561)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13690, PropCategory.REGULAR)
