...
# ##################################################
class RtSubjGraphAtt(Mo):
    """
    A target relation to an input terminal node. Note that this relation is an internal object

    """

    meta = TargetRelationMeta("cobra.model.vns.RtSubjGraphAtt", "cobra.model.vz.Subj")

    meta.moClassName = "vnsRtSubjGraphAtt"
    meta.rnFormat = "rtvzSubjGraphAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11836, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11835, PropCategory.REGULAR)
