...
# ##################################################
class TermConnInst(Mo):
    """
    A connector instance.

    """

    meta = ClassMeta("cobra.model.vns.TermConnInst")

    meta.moClassName = "vnsTermConnInst"
    meta.rnFormat = "TConnInst"
    ...
    meta.superClasses.add("cobra.model.vns.ATermConn")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14880, PropCategory.REGULAR)
