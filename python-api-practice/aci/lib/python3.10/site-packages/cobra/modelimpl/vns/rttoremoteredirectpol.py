...
# ##################################################
class RtToRemoteRedirectPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToRemoteRedirectPol", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "vnsRtToRemoteRedirectPol"
    meta.rnFormat = "rtfvToRemoteRedirectPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27688, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27687, PropCategory.REGULAR)
