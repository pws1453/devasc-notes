...
class EPpInfo(Mo):
    """
    Internal object to store encap info (vlan ID) for an endpoint.

    """

    meta = ClassMeta("cobra.model.vns.EPpInfo")

    meta.moClassName = "vnsEPpInfo"
    meta.rnFormat = "G-%(graphRn)s-N-%(nodeRn)s-C-%(connRn)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Service VDev EPP Information"
    meta.writeAccessMask = 0x6000000000000001
    meta.readAccessMask = 0x608279440106f713
    ...
    meta.childClasses.add("cobra.model.vns.SvcVipUpdate")
    ...
    meta.childClasses.add("cobra.model.vns.RtEPpInfoAtt")
    ...
    meta.childClasses.add("cobra.model.vns.RsEPpInfoToBD")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SvcVipUpdate", "svcvipupdate-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtEPpInfoAtt", "rtePpInfoAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsEPpInfoToBD", "rsEPpInfoToBD"))
    ...
    meta.superClasses.add("cobra.model.vns.AEPpInfo")
    ...
    prop = PropMeta("str", "connRn", "connRn", 5033, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "encap", "encap", 5036, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "encapNs", "encapNs", 17790, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("encapNs", prop)

    prop = PropMeta("str", "eppdDn", "eppdDn", 15709, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("eppdDn", prop)
    ...
    prop = PropMeta("str", "fabEncap", "fabEncap", 5037, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "graphRn", "graphRn", 5032, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.range = [(1, 512)]
    meta.props.add("graphRn", prop)

    prop = PropMeta("str", "isCopy", "isCopy", 26301, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14833, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeRn", "nodeRn", 5034, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "shareEncap", "shareEncap", 20399, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    meta.namingProps.append(getattr(meta.props, "graphRn"))
    meta.namingProps.append(getattr(meta.props, "nodeRn"))
    meta.namingProps.append(getattr(meta.props, "connRn"))
    ...
    def __init__(self, parentMoOrDn, graphRn, nodeRn, connRn, markDirty=True, **creationProps):
        namingVals = [graphRn, nodeRn, connRn]
