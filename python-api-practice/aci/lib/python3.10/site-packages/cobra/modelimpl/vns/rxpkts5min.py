...
class RxPkts5min(Mo):
    """
    A class that represents the most current statistics for  Rx  Packet counters in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPkts5min", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPkts5min"
    meta.rnFormat = "CDvnsRxPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Rx Packet counters stats in 5 minute"
