...
# ##################################################
class RsLDevCtxToLDev(Mo):
    """
    A service device cluster of a proxy object for a logical device cluster in the tenant.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLDevCtxToLDev", "cobra.model.vns.ALDevIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLDevCtxToLDev"
    meta.rnFormat = "rsLDevCtxToLDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a LDev Context to an LDev"
    ...
    meta.rnPrefixes = [
        ('rsLDevCtxToLDev', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37972, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40111, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14820, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13533, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4868
    prop.defaultValueStr = "vnsALDevIf"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13532, PropCategory.REGULAR)
