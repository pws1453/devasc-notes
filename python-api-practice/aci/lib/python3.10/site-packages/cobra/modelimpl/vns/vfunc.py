...
class VFunc(Mo):
    """
    A virtual function is a single function on a service device such as a firewall, a load balancer, or an SSL offloading device.

    """

    meta = ClassMeta("cobra.model.vns.VFunc")

    meta.moClassName = "vnsVFunc"
    meta.rnFormat = "vFunc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Service Function"
    ...
    meta.childClasses.add("cobra.model.vns.VConn")
    meta.childClasses.add("cobra.model.health.NodeInst")
    meta.childClasses.add("cobra.model.vns.RsFunction")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsFunction", "rsfunction"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CfgRoot", "cfgRoot-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.VConn", "vConn-"))
    ...
    prop = PropMeta("str", "key", "key", 5194, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14910, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7395, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
