...
# ##################################################
class RsAbsCopyConnection(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsAbsCopyConnection", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "vnsRsAbsCopyConnection"
    meta.rnFormat = "rsabsCopyConnection-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Service Graph Connection to CopyConnector"
    ...
    meta.rnPrefixes = [
        ('rsabsCopyConnection-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40544, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23287, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23286, PropCategory.REGULAR)
