...
class RsVLIfP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsVLIfP", "cobra.model.l3ext.VirtualLIfP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsVLIfP"
    meta.rnFormat = "rsVLIfP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Concrete Interface to the floating SVI interface"
    ...
    prop = PropMeta("str", "annotation", "annotation", 54105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54106, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54096, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54070, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54069, PropCategory.REGULAR)
