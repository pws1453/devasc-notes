...
# ##################################################
class SvcPkgSource(Mo):
    """
    The services device package installer support for the CLI.

    """

    meta = ClassMeta("cobra.model.vns.SvcPkgSource")

    meta.moClassName = "vnsSvcPkgSource"
    meta.rnFormat = "svc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Service Device Pkg. Installer"
    ...
    prop = PropMeta("str", "downloadStatus", "downloadStatus", 5062, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("downloadStatus", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14842, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7383, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "webtoken", "webtoken", 5061, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.isPassword = True
    meta.props.add("webtoken", prop)
