...
class RsLDevAtt(Mo):
    """
    A source relation to a service device cluster.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLDevAtt", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLDevAtt"
    meta.rnFormat = "rslDevAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13718, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13717, PropCategory.REGULAR)
