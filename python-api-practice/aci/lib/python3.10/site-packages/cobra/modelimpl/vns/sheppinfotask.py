...
# ##################################################
class SHEPpInfoTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.SHEPpInfoTask")

    meta.moClassName = "vnsSHEPpInfoTask"
    meta.rnFormat = "vnsSHEPpInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 18478, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpPDUpdSH", "eppdupdsh", 1666)
    prop._addConstant("ValidateEncap", "validateencap", 1697)
