...
# ##################################################
class RtTermInstMeta(Mo):
    """
    A target relation to an abstract terminal node. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtTermInstMeta", "cobra.model.vns.TermNodeInst")

    meta.moClassName = "vnsRtTermInstMeta"
    meta.rnFormat = "rttermInstMeta-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13607, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4804
    prop.defaultValueStr = "vnsTermNodeInst"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsTermNodeInst", None, 4804)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16210, PropCategory.REGULAR)
