...
class RxPkts1mo(Mo):
    """
    A class that represents the most current statistics for  Rx  Packet counters in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPkts1mo", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPkts1mo"
    meta.rnFormat = "CDvnsRxPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Rx Packet counters stats in 1 month"
