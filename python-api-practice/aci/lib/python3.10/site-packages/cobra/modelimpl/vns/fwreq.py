...
class FWReq(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.FWReq")

    meta.moClassName = "vnsFWReq"
    meta.rnFormat = "FW_C-%(ctrct)s-G-%(graph)s-F-%(node)s-N-%(acl)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Normalized Firewall parameters"
    meta.writeAccessMask = 0x200000000000001
    meta.readAccessMask = 0x200000000000001
    ...
    prop = PropMeta("str", "ace", "ace", 23069, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "allowAce"
    prop.defaultValueStr = "allowAce"
    meta.props.add("ace", prop)

    prop = PropMeta("str", "acl", "acl", 23068, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "allowAcl"
    prop.defaultValueStr = "allowAcl"
    meta.props.add("acl", prop)

    prop = PropMeta("str", "annotation", "annotation", 38343, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cons", "cons", 22242, PropCategory.REGULAR)
    prop.label = "consumer"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("cons", prop)

    prop = PropMeta("str", "ctrct", "ctrct", 22247, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "dFromPort", "dFromPort", 22424, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dToPort", "dToPort", 22425, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dType", "dType", 23070, PropCategory.REGULAR)
    prop.label = "acl destination type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "epg"
    prop._addConstant("epg", "epg", 0)
    prop._addConstant("host", "host", 1)
    prop._addConstant("net", "net", 2)
    ...
    prop = PropMeta("str", "destIp", "destIp", 23071, PropCategory.REGULAR)
    prop.label = "host/network ip address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extIntf", "extIntf", 27144, PropCategory.REGULAR)
    prop.label = "external interface name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    ...
    meta.props.add("extIntf", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40482, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "graph", "graph", 22248, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "intIntf", "intIntf", 27642, PropCategory.REGULAR)
    prop.label = "internal interface name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    ...
    prop = PropMeta("str", "node", "node", 22246, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nwObjName", "nwObjName", 23072, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "allowNw"
    prop.defaultValueStr = "allowNw"
    meta.props.add("nwObjName", prop)

    prop = PropMeta("str", "prot", "prot", 22244, PropCategory.REGULAR)
    prop.label = "Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    ...
    prop = PropMeta("str", "prov", "prov", 22243, PropCategory.REGULAR)
    prop.label = "provider"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.namingProps.append(getattr(meta.props, "acl"))
    ...
    def __init__(self, parentMoOrDn, ctrct, graph, node, acl, markDirty=True, **creationProps):
        namingVals = [ctrct, graph, node, acl]
