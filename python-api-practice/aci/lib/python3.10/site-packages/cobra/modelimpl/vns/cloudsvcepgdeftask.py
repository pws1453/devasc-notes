...
# ##################################################
class CloudSvcEPgDefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.CloudSvcEPgDefTask")

    meta.moClassName = "vnsCloudSvcEPgDefTask"
    meta.rnFormat = "vnsCloudSvcEPgDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 51873, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CloudEpP", "cloudepp", 3444)
