...
# ##################################################
class RsDevMgrToMDevMgr(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsDevMgrToMDevMgr", "cobra.model.vns.MDevMgr")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsDevMgrToMDevMgr"
    meta.rnFormat = "rsdevMgrToMDevMgr"
    ...
    meta.rnPrefixes = [
        ('rsdevMgrToMDevMgr', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38207, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40346, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18390, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6164
    prop.defaultValueStr = "vnsMDevMgr"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsMDevMgr", None, 6164)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18389, PropCategory.REGULAR)
