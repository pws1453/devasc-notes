...
# ##################################################
class TermNodeInst(Mo):
    """
    A terminal node instance.

    """

    meta = ClassMeta("cobra.model.vns.TermNodeInst")

    meta.moClassName = "vnsTermNodeInst"
    meta.rnFormat = "TermNodeInst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Input Node Instance"
    ...
    meta.childClasses.add("cobra.model.vns.RsTermInstMeta")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vns.TermConnInst")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsTermInstMeta", "rsTermInstMeta"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.TermConnInst", "TConnInst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14870, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7384, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
