...
# ##################################################
class RsLIfCtxToLIf(Mo):
    """
    A source relation to the logical interface of a device cluster.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToLIf", "cobra.model.vns.ALDevLIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToLIf"
    meta.rnFormat = "rsLIfCtxToLIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to LIf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37970, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40109, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14818, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13529, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4890
    prop.defaultValueStr = "vnsALDevLIf"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13528, PropCategory.REGULAR)
