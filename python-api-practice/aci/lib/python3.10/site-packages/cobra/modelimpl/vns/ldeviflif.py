...
class LDevIfLIf(Mo):
    """
    A proxy object in tenant that points to the logical interface of a device.

    """

    meta = ClassMeta("cobra.model.vns.LDevIfLIf")

    meta.moClassName = "vnsLDevIfLIf"
    meta.rnFormat = "lDevIfLIf-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Interface"
    meta.writeAccessMask = 0x5000000000000001
    meta.readAccessMask = 0x7000000000000001
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14903, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7345, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
