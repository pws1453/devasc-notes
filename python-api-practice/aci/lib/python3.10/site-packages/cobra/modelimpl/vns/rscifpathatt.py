...
# ##################################################
class RsCIfPathAtt(Mo):
    """
    A source relation to a path endpoint. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsCIfPathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCIfPathAtt"
    meta.rnFormat = "rsCIfPathAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Concrete Interface to the Physical Port on the ILeaf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38011, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40150, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13756, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13755, PropCategory.REGULAR)
