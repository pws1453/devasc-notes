...
# ##################################################
class RsDevMgrEpg(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsDevMgrEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsDevMgrEpg"
    meta.rnFormat = "rsdevMgrEpg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38206, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdmac", "bdmac", 18382, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "bdseg", "bdseg", 18383, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40345, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "seg", "seg", 18384, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 18386, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18385, PropCategory.REGULAR)
