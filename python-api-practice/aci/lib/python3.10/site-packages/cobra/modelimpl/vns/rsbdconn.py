...
class RsBdConn(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsBdConn", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsBdConn"
    meta.rnFormat = "rsbdConn"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13651, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13650, PropCategory.REGULAR)
