...
# ##################################################
class RsNodeToAbsFuncProf(Mo):
    """
    A source relation to an abstract function profile. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsNodeToAbsFuncProf", "cobra.model.vns.AbsFuncProf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsNodeToAbsFuncProf"
    meta.rnFormat = "rsNodeToAbsFuncProf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from an Function Node to an Service Graph Function Profile"
    ...
    meta.rnPrefixes = [
        ('rsNodeToAbsFuncProf', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37955, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40094, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14801, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13503, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13502, PropCategory.REGULAR)
