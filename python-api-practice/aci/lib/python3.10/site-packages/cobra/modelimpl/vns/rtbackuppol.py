...
# ##################################################
class RtBackupPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtBackupPol", "cobra.model.vns.SvcRedirectPol")

    meta.moClassName = "vnsRtBackupPol"
    meta.rnFormat = "rtbackupPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54415, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54414, PropCategory.REGULAR)
