...
# ##################################################
class RtFromLDevForExtToEp(Mo):
    """
    A target relation to a service device cluster. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtFromLDevForExtToEp", "cobra.model.dbgac.ExtToEp")

    meta.moClassName = "vnsRtFromLDevForExtToEp"
    meta.rnFormat = "rtdbgacFromLDevForExtToEp-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtdbgacFromLDevForExtToEp-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12950, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4101
    prop.defaultValueStr = "dbgacExtToEp"
    prop._addConstant("dbgacExtToEp", None, 4101)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12949, PropCategory.REGULAR)
