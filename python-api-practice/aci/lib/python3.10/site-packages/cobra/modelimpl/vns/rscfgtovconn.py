...
# ##################################################
class RsCfgToVConn(Mo):
    """
    A source relation to a virtual connector. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.vns.RsCfgToVConn", "cobra.model.vns.VConn")
    meta.targetNameProps["name"] = "tnVnsVConnName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCfgToVConn"
    meta.rnFormat = "rsCfgToVConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Abstract Configuration to a Virtual Connector"
    ...
    prop = PropMeta("str", "attType", "attType", 13667, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14890, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13666, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4906
    prop.defaultValueStr = "vnsVConn"
    ...
    prop = PropMeta("str", "tnVnsVConnName", "tnVnsVConnName", 13665, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVnsVConnName", prop)
