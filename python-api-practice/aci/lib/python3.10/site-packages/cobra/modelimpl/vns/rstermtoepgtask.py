...
# ##################################################
class RsTermToEPgTask(Mo):
    """
    A source relation representing the connection from a graph input/output terminal to an endpoint group.

    """

    meta = ClassMeta("cobra.model.vns.RsTermToEPgTask")

    meta.moClassName = "vnsRsTermToEPgTask"
    meta.rnFormat = "vnsRsTermToEPgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5735, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SvcFltUpd", "svcfltupd", 835)
