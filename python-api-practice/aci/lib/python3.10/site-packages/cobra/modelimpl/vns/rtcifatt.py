...
class RtCIfAtt(Mo):
    """
    A target relation to a set of concrete interfaces from the device in the cluster. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtCIfAtt", "cobra.model.vns.ALIf")

    meta.moClassName = "vnsRtCIfAtt"
    meta.rnFormat = "rtcIfAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13709, PropCategory.REGULAR)
