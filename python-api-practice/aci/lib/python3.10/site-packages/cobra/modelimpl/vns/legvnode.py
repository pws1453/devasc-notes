...
class LegVNode(Mo):
    """
    A classic mode or legacy virtual node.

    """

    meta = ClassMeta("cobra.model.vns.LegVNode")

    meta.moClassName = "vnsLegVNode"
    meta.rnFormat = "LegVNode-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.EPgDef")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.vns.BDDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EPgDef", "EPgDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.BDDef", "BDDef-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14871, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7350, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
