...
class RxPkts1w(Mo):
    """
    A class that represents the most current statistics for  Rx  Packet counters in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPkts1w", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPkts1w"
    meta.rnFormat = "CDvnsRxPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Rx Packet counters stats in 1 week"
