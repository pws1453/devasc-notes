...
# ##################################################
class RtBDDefToConn(Mo):
    """
    A target relation to a connector. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtBDDefToConn", "cobra.model.vns.BDDef")

    meta.moClassName = "vnsRtBDDefToConn"
    meta.rnFormat = "rtBDDefToConn"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13625, PropCategory.REGULAR)
