...
class DevInt(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.DevInt")

    meta.moClassName = "vnsDevInt"
    meta.rnFormat = "devInt-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Device Interface"
    ...
    meta.parentClasses.add("cobra.model.vns.DevProf")
    meta.parentClasses.add("cobra.model.vns.DevSlot")
    ...
    prop = PropMeta("str", "mgmtOnly", "mgmtOnly", 17638, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 17639, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
