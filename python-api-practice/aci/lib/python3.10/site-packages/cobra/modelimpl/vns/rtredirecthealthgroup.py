...
# ##################################################
class RtRedirectHealthGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtRedirectHealthGroup", "cobra.model.vns.RedirectDest")

    meta.moClassName = "vnsRtRedirectHealthGroup"
    meta.rnFormat = "rtredirectHealthGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34187, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7083
    prop.defaultValueStr = "vnsRedirectDest"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsRedirectDest", None, 7083)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34186, PropCategory.REGULAR)
