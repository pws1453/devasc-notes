...
# ##################################################
class RsLIfCtxToSvcEPgPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToSvcEPgPol", "cobra.model.vns.SvcEPgPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToSvcEPgPol"
    meta.rnFormat = "rsLIfCtxToSvcEPgPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to Service EPg Profile"
    ...
    meta.rnPrefixes = [
        ('rsLIfCtxToSvcEPgPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44819, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44820, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44817, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 44814, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12989
    prop.defaultValueStr = "vnsSvcEPgPol"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsSvcEPgPol", None, 12989)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 44813, PropCategory.REGULAR)
