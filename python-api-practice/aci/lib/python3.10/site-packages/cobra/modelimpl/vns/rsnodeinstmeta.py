...
# ##################################################
class RsNodeInstMeta(Mo):
    """
    A source relation to an abstract node that represents a service node such as server load balancer (SLB) or firewall (FW). Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsNodeInstMeta", "cobra.model.vns.AbsNode")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsNodeInstMeta"
    meta.rnFormat = "rsNodeInstMeta"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13589, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4629
    prop.defaultValueStr = "vnsAbsNode"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsAbsNode", None, 4629)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13588, PropCategory.REGULAR)
