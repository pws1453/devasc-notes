...
# ##################################################
class RsCDevOperInfoToCDev(Mo):
    """
    A source relation to an individual service device that is part of an L4-L7 device cluster. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsCDevOperInfoToCDev", "cobra.model.vns.CDev")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsCDevOperInfoToCDev"
    meta.rnFormat = "rsCDevOperInfoToCDev"
    ...
    meta.parentClasses.add("cobra.model.vns.CDevOperInfo")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsCDevOperInfoToCDev', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 13753, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13752, PropCategory.REGULAR)
