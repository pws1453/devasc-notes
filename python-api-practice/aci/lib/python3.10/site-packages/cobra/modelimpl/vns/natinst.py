...
class NatInst(Mo):
    """
    The NATed IP of a service node.

    """

    meta = ClassMeta("cobra.model.vns.NatInst")

    meta.moClassName = "vnsNatInst"
    meta.rnFormat = "ip-[%(ip)s]-ctx-%(seg)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Translated Address of Service Node"
    ...
    meta.childClasses.add("cobra.model.vns.EpInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EpInst", "ep-"))
    ...
    prop = PropMeta("str", "ip", "ip", 5220, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mappedHost", "mappedHost", 5221, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "seg", "seg", 5222, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "seg"))
    ...
    def __init__(self, parentMoOrDn, ip, seg, markDirty=True, **creationProps):
        namingVals = [ip, seg]
