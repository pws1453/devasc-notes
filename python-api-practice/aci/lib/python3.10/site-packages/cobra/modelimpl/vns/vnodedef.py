...
class VNodeDef(Mo):
    """
    The virtual node definition. This object is used internally.

    """

    meta = ClassMeta("cobra.model.vns.VNodeDef")

    meta.moClassName = "vnsVNodeDef"
    meta.rnFormat = "VNodeDef-%(name)s"
    ...
    meta.childClasses.add("cobra.model.sts.FabOutRevDef")
    meta.childClasses.add("cobra.model.sts.ExtInDef")
    meta.childClasses.add("cobra.model.sts.FabInDef")
    meta.childClasses.add("cobra.model.sts.FabInRevDef")
    meta.childClasses.add("cobra.model.sts.ExtOutDef")
    meta.childClasses.add("cobra.model.sts.FabOutDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.FabOutRevDef", "faboutrevdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.FabInRevDef", "fabinrevdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.ExtOutDef", "extoutdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.FabOutDef", "faboutdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.ExtInDef", "extindef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.FabInDef", "fabindef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.vns.NodeInstDef")

    meta.superClasses.add("cobra.model.vns.AVNode")
    ...
    prop = PropMeta("str", "name", "name", 7396, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
