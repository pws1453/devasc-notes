...
# ##################################################
class RtChassisToMChassis(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vns.RtChassisToMChassis", "cobra.model.vns.Chassis")

    meta.moClassName = "vnsRtChassisToMChassis"
    meta.rnFormat = "rtchassisToMChassis-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18381, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18380, PropCategory.REGULAR)
