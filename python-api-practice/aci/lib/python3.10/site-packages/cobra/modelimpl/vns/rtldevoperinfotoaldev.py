...
# ##################################################
class RtLDevOperInfoToALDev(Mo):
    """
    A target relation to a service device cluster.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLDevOperInfoToALDev", "cobra.model.vns.LDevOperInfo")

    meta.moClassName = "vnsRtLDevOperInfoToALDev"
    meta.rnFormat = "rtLDevOperInfoToALDev"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13716, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4895
    prop.defaultValueStr = "vnsLDevOperInfo"
