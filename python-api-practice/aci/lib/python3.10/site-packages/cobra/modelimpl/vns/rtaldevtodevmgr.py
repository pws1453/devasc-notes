...
# ##################################################
class RtALDevToDevMgr(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vns.RtALDevToDevMgr", "cobra.model.vns.ALDev")

    meta.moClassName = "vnsRtALDevToDevMgr"
    meta.rnFormat = "rtaLDevToDevMgr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18358, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18357, PropCategory.REGULAR)
