...
# ##################################################
class RsAbsFuncProf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsAbsFuncProf", "cobra.model.vns.AbsFuncProf")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsAbsFuncProf"
    meta.rnFormat = "rsabsFuncProf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19863, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19862, PropCategory.REGULAR)
