...
# ##################################################
class RsALDevToVlanInstP(Mo):
    """
    A source relation to the policy definition for ID ranges used for VLAN encapsulation.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsALDevToVlanInstP", "cobra.model.fvns.VlanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsALDevToVlanInstP"
    meta.rnFormat = "rsALDevToVlanInstP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13687, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13686, PropCategory.REGULAR)
