...
# ##################################################
class RtLIfCtxToSvcRedirectPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLIfCtxToSvcRedirectPol", "cobra.model.vns.LIfCtx")

    meta.moClassName = "vnsRtLIfCtxToSvcRedirectPol"
    meta.rnFormat = "rtLIfCtxToSvcRedirectPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21008, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21007, PropCategory.REGULAR)
