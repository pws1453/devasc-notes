...
class LIf(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.LIf")

    meta.moClassName = "vnsLIf"
    meta.rnFormat = "lIf-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Interface"
    ...
    meta.childClasses.add("cobra.model.vns.RtEPgDefToLIf")
    meta.childClasses.add("cobra.model.vns.RtBDDefToLIf")
    meta.childClasses.add("cobra.model.vns.RsMetaIf")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.vns.RtConnToLIfInst")
    meta.childClasses.add("cobra.model.vns.RtLIfCtxToLIf")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.vns.RsCIfAtt")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.vns.RsCIfAttN")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtConnToLIfInst", "rtconnToLIfInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtEPgDefToLIf", "rtEPgDefToLIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtLIfCtxToLIf", "rtLIfCtxToLIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtBDDefToLIf", "rtBDDefToLIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsCIfAttN", "rscIfAttN-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsCIfAtt", "rscIfAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsMetaIf", "rsmetaIf"))
    ...
    meta.superClasses.add("cobra.model.vns.ALIf")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.vns.ALDevLIf")

    meta.rnPrefixes = [
        ('lIf-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38002, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5182, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5183, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "encap", "encap", 21207, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40141, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14904, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7348, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
