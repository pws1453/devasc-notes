...
# ##################################################
class RsLIfCtxToSvcRedirectPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToSvcRedirectPol", "cobra.model.vns.SvcRedirectPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToSvcRedirectPol"
    meta.rnFormat = "rsLIfCtxToSvcRedirectPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to Service Redirect Policy"
    ...
    meta.rnPrefixes = [
        ('rsLIfCtxToSvcRedirectPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38264, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40403, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21009, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21006, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21005, PropCategory.REGULAR)
