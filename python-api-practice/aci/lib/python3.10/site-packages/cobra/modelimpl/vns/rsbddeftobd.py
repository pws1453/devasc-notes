...
# ##################################################
class RsBDDefToBD(Mo):
    """
    A source relation to the bridge domain policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsBDDefToBD", "cobra.model.fv.ABDPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsBDDefToBD"
    meta.rnFormat = "rsBDDefToBD"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13620, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13619, PropCategory.REGULAR)
