...
class LDevInst(Mo):
    """
    The local state in the object that reuses encaps across graphs with the same subnet. This is an internal object.

    """

    meta = ClassMeta("cobra.model.vns.LDevInst")

    meta.moClassName = "vnsLDevInst"
    meta.rnFormat = "LDevInst-[%(priKey)s]-ctx-%(ctxName)s"
    meta.category = MoCategory.REGULAR
    meta.label = "LDev Instance"
    meta.writeAccessMask = 0x6000000000000001
    meta.readAccessMask = 0x6000400401003701
    ...
    meta.childClasses.add("cobra.model.vns.REPpInfo")
    meta.childClasses.add("cobra.model.vns.DevCtxLblInfo")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vns.SHEPpInfo")
    meta.childClasses.add("cobra.model.vns.EPpInfo")
    meta.childClasses.add("cobra.model.vns.NodeInstIdCntnr")
    meta.childClasses.add("cobra.model.vns.RLDevInstCons")
    meta.childClasses.add("cobra.model.vns.RtrIdInfo")
    meta.childClasses.add("cobra.model.vns.RsRLdevInst")
    meta.childClasses.add("cobra.model.vns.RtLDevInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.NodeInstIdCntnr", "NodeInstIdCntnr"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.DevCtxLblInfo", "DevCtxLblInfo-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsRLdevInst", "rsrLdevInst"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtLDevInst", "rtLDevInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RLDevInstCons", "rldevinst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtrIdInfo", "rtrIdInfo"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SHEPpInfo", "epgDn-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.REPpInfo", "bd-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EPpInfo", "G-"))
    ...
    prop = PropMeta("str", "ctxName", "ctxName", 5118, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "id", "id", 31098, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14859, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "priKey", "priKey", 5117, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "priKey"))
    getattr(meta.props, "priKey").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "ctxName"))
    ...
    def __init__(self, parentMoOrDn, priKey, ctxName, markDirty=True, **creationProps):
        namingVals = [priKey, ctxName]
