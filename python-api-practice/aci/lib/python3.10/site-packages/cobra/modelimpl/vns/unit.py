...
class Unit(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.Unit")

    meta.moClassName = "vnsUnit"
    meta.rnFormat = "unit-%(id)s"
    ...
    meta.parentClasses.add("cobra.model.vns.UnitHolder")
    ...
    prop = PropMeta("str", "id", "id", 16173, PropCategory.REGULAR)
