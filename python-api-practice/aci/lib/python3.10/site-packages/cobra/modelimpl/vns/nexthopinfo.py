...
# ##################################################
class NextHopInfo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.NextHopInfo")

    meta.moClassName = "vnsNextHopInfo"
    meta.rnFormat = "pbrDn-[%(pbrDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "NextHop Info"
    ...
    prop = PropMeta("str", "bDSeg", "bDSeg", 53338, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "configInfo", "configInfo", 54489, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("configInfo", prop)

    prop = PropMeta("str", "configIssues", "configIssues", 54488, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 54487, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 53340, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ctxDn", prop)

    prop = PropMeta("str", "ctxSeg", "ctxSeg", 53339, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53349, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "nextHopDn", "nextHopDn", 53337, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("nextHopDn", prop)

    prop = PropMeta("str", "pbrDn", "pbrDn", 53336, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("pbrDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "pbrDn"))
    getattr(meta.props, "pbrDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, pbrDn, markDirty=True, **creationProps):
        namingVals = [pbrDn]
