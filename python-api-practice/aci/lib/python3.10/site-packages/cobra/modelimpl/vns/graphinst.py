...
class GraphInst(Mo):
    """
    The instance of a service graph. All instance objects are implicit.

    """

    meta = ClassMeta("cobra.model.vns.GraphInst")

    meta.moClassName = "vnsGraphInst"
    meta.rnFormat = "GraphInst_C-[%(ctrctDn)s]-G-[%(graphDn)s]-S-[%(scopeDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Service Graph Instance"
    ...
    meta.childClasses.add("cobra.model.vns.RsLDevInst")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vns.RsGraphInstanceMeta")
    meta.childClasses.add("cobra.model.vns.GraphIdCntnr")
    meta.childClasses.add("cobra.model.vns.NodeInst")
    meta.childClasses.add("cobra.model.vns.SLDevInstCons")
    meta.childClasses.add("cobra.model.vns.NodeInstDef")
    meta.childClasses.add("cobra.model.vns.ConnectionInst")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.vns.TermNodeInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsGraphInstanceMeta", "rsGraphInstanceMeta"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConnectionInst", "ConnectionInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.GraphIdCntnr", "GraphIdCntnr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.TermNodeInst", "TermNodeInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.NodeInstDef", "NodeInstDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsLDevInst", "rsLDevInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SLDevInstCons", "sldevinst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.NodeInst", "NodeInst-"))
    ...
    prop = PropMeta("str", "absGraphAnnotation", "absGraphAnnotation", 41095, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("absGraphAnnotation", prop)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5112, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5113, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ctrctDn", "ctrctDn", 5109, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("ctrctDn", prop)
    ...
    prop = PropMeta("str", "graphDn", "graphDn", 5110, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("graphDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14855, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "reqEPgClassIds", "reqEPgClassIds", 5107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("reqEPgClassIds", prop)

    prop = PropMeta("str", "reqEPgVlans", "reqEPgVlans", 5105, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("reqEPgVlans", prop)

    prop = PropMeta("str", "reqExtInEncs", "reqExtInEncs", 5097, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("reqExtInEncs", prop)

    prop = PropMeta("str", "reqExtOutEncs", "reqExtOutEncs", 5099, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("reqExtOutEncs", prop)

    prop = PropMeta("str", "reqFabInEncs", "reqFabInEncs", 5101, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("reqFabInEncs", prop)

    prop = PropMeta("str", "reqRevFabInEncs", "reqRevFabInEncs", 5103, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("reqRevFabInEncs", prop)
    ...
    prop = PropMeta("str", "scopeDn", "scopeDn", 5111, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 51786, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "usedEPgClassIds", "usedEPgClassIds", 5108, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("usedEPgClassIds", prop)

    prop = PropMeta("str", "usedEPgVlans", "usedEPgVlans", 5106, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("usedEPgVlans", prop)

    prop = PropMeta("str", "usedExtInEncs", "usedExtInEncs", 5098, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("usedExtInEncs", prop)

    prop = PropMeta("str", "usedExtOutEncs", "usedExtOutEncs", 5100, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("usedExtOutEncs", prop)

    prop = PropMeta("str", "usedFabInEncs", "usedFabInEncs", 5102, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("usedFabInEncs", prop)

    prop = PropMeta("str", "usedRevFabInEncs", "usedRevFabInEncs", 5104, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("usedRevFabInEncs", prop)

    meta.namingProps.append(getattr(meta.props, "ctrctDn"))
    getattr(meta.props, "ctrctDn").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "graphDn"))
    getattr(meta.props, "graphDn").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "scopeDn"))
    getattr(meta.props, "scopeDn").needDelimiter = True

    meta.deploymentCategory = DeploymentCategory("service-graph", "Service Graph")
    # Deployment Meta
    ...
    def __init__(self, parentMoOrDn, ctrctDn, graphDn, scopeDn, markDirty=True, **creationProps):
        namingVals = [ctrctDn, graphDn, scopeDn]
