...
class RsTarget(Mo):
    """
    A source relation to meta folder information. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsTarget", "cobra.model.vns.MFolder")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsTarget"
    meta.rnFormat = "rstarget"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L4-L7 Services Target Meta Folder"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13565, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13564, PropCategory.REGULAR)
