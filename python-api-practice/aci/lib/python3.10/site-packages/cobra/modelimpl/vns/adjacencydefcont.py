...
# ##################################################
class AdjacencyDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.AdjacencyDefCont")

    meta.moClassName = "vnsAdjacencyDefCont"
    meta.rnFormat = "adjCont-[%(svcRedirectPolDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Adjacency Definition Container"
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 24344, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "direction", "direction", 24345, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "graphDn", "graphDn", 53341, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("graphDn", prop)

    prop = PropMeta("str", "isMultisiteGraphRedir", "isMultisiteGraphRedir", 37246, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("isMultisiteGraphRedir", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24376, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "seg", "seg", 24343, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "svcRedirectPolDn", "svcRedirectPolDn", 24342, PropCategory.REGULAR)
    prop.label = "vnsSvcRedirectPol Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("svcRedirectPolDn", prop)

    prop = PropMeta("str", "trafficDir", "trafficDir", 53342, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("trafficDir", prop)

    meta.namingProps.append(getattr(meta.props, "svcRedirectPolDn"))
    getattr(meta.props, "svcRedirectPolDn").needDelimiter = True

    def __init__(self, parentMoOrDn, svcRedirectPolDn, markDirty=True, **creationProps):
        namingVals = [svcRedirectPolDn]
