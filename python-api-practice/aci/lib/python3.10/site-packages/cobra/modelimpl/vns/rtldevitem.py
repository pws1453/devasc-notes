...
class RtLDevItem(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtLDevItem", "cobra.model.orchs.LdevCont")

    meta.moClassName = "vnsRtLDevItem"
    meta.rnFormat = "rtorchsLDevItem-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28673, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9573
    prop.defaultValueStr = "orchsLdevCont"
    prop._addConstant("orchsLdevCont", None, 9573)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28672, PropCategory.REGULAR)
