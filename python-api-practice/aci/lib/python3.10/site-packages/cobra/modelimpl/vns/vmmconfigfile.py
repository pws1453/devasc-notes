...
# ##################################################
class VmmConfigFile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.VmmConfigFile")

    meta.moClassName = "vnsVmmConfigFile"
    meta.rnFormat = "vmmConfigFile-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VM Instantiation file"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x2000020000000005
    ...
    meta.childClasses.add("cobra.model.vns.RtInstPolToVmmConfigFile")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtInstPolToVmmConfigFile", "rtinstPolToVmmConfigFile-"))
    ...
    prop = PropMeta("str", "fileName", "fileName", 42633, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "filePath", "filePath", 42637, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("filePath", prop)
    ...
    prop = PropMeta("str", "model", "model", 42635, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42706, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 43430, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vendor", "vendor", 42634, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "version", "version", 42636, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
