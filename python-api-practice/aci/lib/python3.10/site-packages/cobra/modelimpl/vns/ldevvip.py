...
class LDevVip(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.LDevVip")

    meta.moClassName = "vnsLDevVip"
    meta.rnFormat = "lDevVip-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Devices"
    ...
    meta.childClasses.add("cobra.model.vns.RtAllocLDev")
    ...
    meta.childClasses.add("cobra.model.vns.Chkr")
    ...
    meta.childClasses.add("cobra.model.vns.Chkr2")
    meta.childClasses.add("cobra.model.vns.DevFolder")
    meta.childClasses.add("cobra.model.vns.RsLDevVipToInstPol")
    ...
    meta.childClasses.add("cobra.model.vns.RtLDevItem")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsLDevVipToInstPol", "rslDevVipToInstPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtAllocLDev", "rtorchsAllocLDev-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtLDevItem", "rtorchsLDevItem-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.Chkr2", "chkr2"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.Chkr", "chkr"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38004, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "devState", "devState", 44808, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40143, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isDynamic", "isDynamic", 42638, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14906, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7347, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
