...
# ##################################################
class RtBDDefToLIf(Mo):
    """
    A target relation to the logical interface associated with a set of concrete interfaces from the L4-L7 device cluster.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtBDDefToLIf", "cobra.model.vns.BDDef")

    meta.moClassName = "vnsRtBDDefToLIf"
    meta.rnFormat = "rtBDDefToLIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13629, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4821
    prop.defaultValueStr = "vnsBDDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsBDDef", None, 4821)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13628, PropCategory.REGULAR)
