...
class NATPATReq(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.NATPATReq")

    meta.moClassName = "vnsNATPATReq"
    meta.rnFormat = "FW_NAT_C-%(ctrct)s-G-%(graph)s-F-%(node)s-NAT-%(natRule)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Normalized Firewall NAT static port translation parameters"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38572, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrct", "ctrct", 27930, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40711, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "graph", "graph", 27931, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mappedIp", "mappedIp", 27910, PropCategory.REGULAR)
    prop.label = "Mapped IP address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("mappedIp", prop)

    prop = PropMeta("str", "mappedPort", "mappedPort", 27908, PropCategory.REGULAR)
    prop.label = "Mapped Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    ...
    meta.props.add("mappedPort", prop)
    ...
    prop = PropMeta("str", "natRule", "natRule", 27900, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "node", "node", 27929, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "realIp", "realIp", 27909, PropCategory.REGULAR)
    prop.label = "Real IP address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("realIp", prop)

    prop = PropMeta("str", "realPort", "realPort", 27907, PropCategory.REGULAR)
    prop.label = "Real Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "service", "service", 27906, PropCategory.REGULAR)
    prop.label = "NAT service type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    ...
    prop = PropMeta("str", "version", "version", 35490, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
