...
# ##################################################
class RsALDevToDevMgr(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.vns.RsALDevToDevMgr", "cobra.model.vns.DevMgr")
    meta.targetNameProps["name"] = "tnVnsDevMgrName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsALDevToDevMgr"
    meta.rnFormat = "rsaLDevToDevMgr"
    ...
    meta.rnPrefixes = [
        ('rsaLDevToDevMgr', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38201, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40340, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18356, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6174
    prop.defaultValueStr = "vnsDevMgr"
    ...
    prop = PropMeta("str", "tnVnsDevMgrName", "tnVnsDevMgrName", 18355, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVnsDevMgrName", prop)
