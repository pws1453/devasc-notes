...
# ##################################################
class RtInTermGraphAtt(Mo):
    """
    A target relation to an output terminal node.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtInTermGraphAtt", "cobra.model.vz.InTerm")

    meta.moClassName = "vnsRtInTermGraphAtt"
    meta.rnFormat = "rtvzInTermGraphAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11850, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1331
    prop.defaultValueStr = "vzInTerm"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzInTerm", None, 1331)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11849, PropCategory.REGULAR)
