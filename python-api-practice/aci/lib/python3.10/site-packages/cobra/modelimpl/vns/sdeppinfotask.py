...
# ##################################################
class SDEPpInfoTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.SDEPpInfoTask")

    meta.moClassName = "vnsSDEPpInfoTask"
    meta.rnFormat = "vnsSDEPpInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 17760, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EPpInfoS", "eppinfos", 1518)
    prop._addConstant("EpPDUpdS", "eppdupds", 1517)
