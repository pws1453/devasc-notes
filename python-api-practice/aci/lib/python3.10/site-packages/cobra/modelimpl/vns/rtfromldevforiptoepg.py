...
# ##################################################
class RtFromLDevForIpToEpg(Mo):
    """
    A target relation to a service device cluster. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtFromLDevForIpToEpg", "cobra.model.dbgac.IpToEpg")

    meta.moClassName = "vnsRtFromLDevForIpToEpg"
    meta.rnFormat = "rtdbgacFromLDevForIpToEpg-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x400000000000c001
    ...
    meta.rnPrefixes = [
        ('rtdbgacFromLDevForIpToEpg-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12899, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4078
    prop.defaultValueStr = "dbgacIpToEpg"
    prop._addConstant("dbgacIpToEpg", None, 4078)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12898, PropCategory.REGULAR)
