...
# ##################################################
class RtConnToCtxTerm(Mo):
    """
    A target relation to a terminal. This is an internal object that is only required when VRF split is intended.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtConnToCtxTerm", "cobra.model.vns.AFuncConn")

    meta.moClassName = "vnsRtConnToCtxTerm"
    meta.rnFormat = "rtconnToCtxTerm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13542, PropCategory.REGULAR)
