...
# ##################################################
class RsFolderInstToMFolder(Mo):
    """
    A source relation to an MFolder path.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsFolderInstToMFolder", "cobra.model.vns.MFolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsFolderInstToMFolder"
    meta.rnFormat = "rsfolderInstToMFolder-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L4-L7 Services Meta Folder"
    ...
    meta.rnPrefixes = [
        ('rsfolderInstToMFolder-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37989, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40128, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14865, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13600, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4736
    prop.defaultValueStr = "vnsMFolder"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsMFolder", None, 4736)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13599, PropCategory.REGULAR)
