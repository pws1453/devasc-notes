...
# ##################################################
class RsEPgDefToConn(Mo):
    """
    A source relation to a connector.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsEPgDefToConn", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsEPgDefToConn"
    meta.rnFormat = "rsEPgDefToConn"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13609, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13608, PropCategory.REGULAR)
