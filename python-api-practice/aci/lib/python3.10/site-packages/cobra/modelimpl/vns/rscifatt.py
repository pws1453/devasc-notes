...
class RsCIfAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsCIfAtt", "cobra.model.vns.CIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "vnsRsCIfAtt"
    meta.rnFormat = "rscIfAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38001, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40140, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14902, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13708, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13707, PropCategory.REGULAR)
