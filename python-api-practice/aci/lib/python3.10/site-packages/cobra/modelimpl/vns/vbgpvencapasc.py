...
# ##################################################
class VBgpVEncapAsc(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.VBgpVEncapAsc")

    meta.moClassName = "vnsVBgpVEncapAsc"
    meta.rnFormat = "vBgpVEncaAsc"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Connector Configuration"
    ...
    meta.superClasses.add("cobra.model.vns.AVRoutingVEncapAsc")
    ...
    prop = PropMeta("str", "addressFamily", "addressFamily", 18282, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20443, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "mtu", "mtu", 20369, PropCategory.REGULAR)
    prop.label = "MTU Size"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(576, 9216)]
