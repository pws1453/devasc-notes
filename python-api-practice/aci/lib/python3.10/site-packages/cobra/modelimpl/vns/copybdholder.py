...
# ##################################################
class CopyBdHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.CopyBdHolder")

    meta.moClassName = "vnsCopyBdHolder"
    meta.rnFormat = "copybdholder-[%(bdDn)s]"
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 26299, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "seg", "seg", 26300, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
