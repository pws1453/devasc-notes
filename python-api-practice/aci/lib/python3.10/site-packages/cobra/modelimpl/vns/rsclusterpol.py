...
# ##################################################
class RsClusterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.vns.RsClusterPol", "cobra.model.infra.ClusterPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsClusterPol"
    meta.rnFormat = "rsClusterPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20604, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20601, PropCategory.REGULAR)
