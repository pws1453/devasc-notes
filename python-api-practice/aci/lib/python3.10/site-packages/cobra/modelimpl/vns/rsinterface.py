...
# ##################################################
class RsInterface(Mo):
    """
    A source relation to an interface label. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsInterface", "cobra.model.vns.MIfLbl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsInterface"
    meta.rnFormat = "rsinterface"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L4-L7 Service Connector Interface Label"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37985, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40124, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13569, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4743
    prop.defaultValueStr = "vnsMIfLbl"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsMIfLbl", None, 4743)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13568, PropCategory.REGULAR)
