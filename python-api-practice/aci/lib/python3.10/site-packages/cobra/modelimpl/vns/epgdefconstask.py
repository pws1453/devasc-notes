...
# ##################################################
class EPgDefConsTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.EPgDefConsTask")

    meta.moClassName = "vnsEPgDefConsTask"
    meta.rnFormat = "vnsEPgDefConsTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 18477, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateSHS", "updateshs", 1668)
