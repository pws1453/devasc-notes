...
class RxPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.vns.RxPktsHist1w", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist1w"
    meta.rnFormat = "HDvnsRxPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 7379, PropCategory.REGULAR)
