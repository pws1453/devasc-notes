...
# ##################################################
class RsConnToAConn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnToAConn", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnToAConn"
    meta.rnFormat = "rsConnToAConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Function Connector to either peer function connector or terminal node connector"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38247, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40386, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20740, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20733, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20732, PropCategory.REGULAR)
