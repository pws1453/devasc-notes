...
# ##################################################
class REPpInfoTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.REPpInfoTask")

    meta.moClassName = "vnsREPpInfoTask"
    meta.rnFormat = "vnsREPpInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 17759, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AllocateEncap", "allocateencap", 1519)
    prop._addConstant("UpdateRoutes", "updateroutes", 2273)
