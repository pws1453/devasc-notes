...
# ##################################################
class RtConnector(Mo):
    """
    A target relation to the meta-connector. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtConnector", "cobra.model.vns.AMItem")

    meta.moClassName = "vnsRtConnector"
    meta.rnFormat = "rtconnector-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstract Configuration Item. can be either MFolder, MParam or MRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13563, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4733
    prop.defaultValueStr = "vnsAMItem"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13562, PropCategory.REGULAR)
