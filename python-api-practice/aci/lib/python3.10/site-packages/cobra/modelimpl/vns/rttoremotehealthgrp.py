...
# ##################################################
class RtToRemoteHealthGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToRemoteHealthGrp", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "vnsRtToRemoteHealthGrp"
    meta.rnFormat = "rtfvToRemoteHealthGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55781, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55780, PropCategory.REGULAR)
