...
class CCredSecret(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.CCredSecret")

    meta.moClassName = "vnsCCredSecret"
    meta.rnFormat = "cCredSecret"
    meta.category = MoCategory.REGULAR
    meta.label = "Secret Credentials"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38008, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40147, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 7314, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "value", "value", 5206, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
