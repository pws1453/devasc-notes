...
class MgmtLIf(Mo):
    """
    A representation of the management interface of logical service node cluster.

    """

    meta = ClassMeta("cobra.model.vns.MgmtLIf")

    meta.moClassName = "vnsMgmtLIf"
    meta.rnFormat = "mgmtLIf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38003, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40142, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14905, PropCategory.REGULAR)
