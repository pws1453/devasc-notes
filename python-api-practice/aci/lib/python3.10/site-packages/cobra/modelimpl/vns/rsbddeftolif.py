...
class RsBDDefToLIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsBDDefToLIf", "cobra.model.vns.LIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsBDDefToLIf"
    meta.rnFormat = "rsBDDefToLIf"
    ...
    meta.parentClasses.add("cobra.model.vns.BDDef")
    ...
    prop = PropMeta("str", "tCl", "tCl", 13627, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13626, PropCategory.REGULAR)
