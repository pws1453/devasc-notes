...
class CtrlrEp(Mo):
    """
    The controller appliance IP address and connectivity information.

    """

    meta = ClassMeta("cobra.model.vns.CtrlrEp")

    meta.moClassName = "vnsCtrlrEp"
    meta.rnFormat = "ctrlrEp-%(appliance)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ctrlr Appliance Address"
    meta.writeAccessMask = 0x4000000000000601
    meta.readAccessMask = 0x4000000000000601
    ...
    meta.childClasses.add("cobra.model.vns.RtVnsCtrlrEp")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtVnsCtrlrEp", "rtpolVnsCtrlrEp-"))
    ...
    prop = PropMeta("str", "appliance", "appliance", 5214, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "bdmac", "bdmac", 5218, PropCategory.REGULAR)
    prop.label = "MAC Address"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 280487012409856
    prop.defaultValueStr = "00:22:BD:F8:19:FF"
    meta.props.add("bdmac", prop)

    prop = PropMeta("str", "bdseg", "bdseg", 5219, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 16320, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 16321, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 5215, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mappedHost", "mappedHost", 5216, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15615, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "seg", "seg", 5217, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    def __init__(self, parentMoOrDn, appliance, markDirty=True, **creationProps):
        namingVals = [appliance]
