...
# ##################################################
class SLDevInstCons(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.SLDevInstCons")

    meta.moClassName = "vnsSLDevInstCons"
    meta.rnFormat = "sldevinst-[%(priKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Shared LdevInst consumer"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17778, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "priKey", "priKey", 17754, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
