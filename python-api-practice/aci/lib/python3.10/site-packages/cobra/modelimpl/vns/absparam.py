...
class AbsParam(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.AbsParam")

    meta.moClassName = "vnsAbsParam"
    meta.rnFormat = "absParam-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Parameter"
    ...
    meta.superClasses.add("cobra.model.vns.AParam")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37957, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "auxInfo", "auxInfo", 36345, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5010, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5011, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40096, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mandImp", "mandImp", 16621, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    prop.defaultValueStr = "notset"
    prop._addConstant("false", "false", 0)
    prop._addConstant("notset", "notset", 3)
    prop._addConstant("true", "true", 1)
    meta.props.add("mandImp", prop)

    prop = PropMeta("str", "mandatory", "mandatory", 5007, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14803, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7309, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "srcMapping", "srcMapping", 34429, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "srcRef", "srcRef", 34428, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "uniqKey", "uniqKey", 35420, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("uniqKey", prop)

    prop = PropMeta("str", "validation", "validation", 5009, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "value", "value", 5008, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
