...
# ##################################################
class AbsTermNodeProv(Mo):
    """
    An abstract terminal node connected to contract provider.

    """

    meta = ClassMeta("cobra.model.vns.AbsTermNodeProv")

    meta.moClassName = "vnsAbsTermNodeProv"
    meta.rnFormat = "AbsTermNodeProv-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Provider Terminal Node"
    ...
    meta.childClasses.add("cobra.model.vns.RtTermInstMeta")
    meta.childClasses.add("cobra.model.vns.AbsTermConn")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.vns.InTerm")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.vns.OutTerm")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtTermInstMeta", "rttermInstMeta-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AbsTermConn", "AbsTConn"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.ExtMngdInst", "extmngd"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.OutTerm", "outtmnl"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.InTerm", "intmnl"))
    ...
    meta.superClasses.add("cobra.model.vns.AbsTermNode")
    meta.superClasses.add("cobra.model.vns.ANode")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.vns.ATermNode")

    meta.rnPrefixes = [
        ('AbsTermNodeProv-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5019, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5020, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40222, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15298, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 15242, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
