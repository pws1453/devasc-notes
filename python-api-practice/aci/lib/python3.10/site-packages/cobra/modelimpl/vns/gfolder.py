...
class GFolder(Mo):
    """
    A graph instance folder.

    """

    meta = ClassMeta("cobra.model.vns.GFolder")

    meta.moClassName = "vnsGFolder"
    meta.rnFormat = "gFolder-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.RsFolderInstAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsFolderInstAtt", "rsfolderInstAtt"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14861, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7338, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
