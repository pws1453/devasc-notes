...
# ##################################################
class SLDevInstTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.SLDevInstTask")

    meta.moClassName = "vnsSLDevInstTask"
    meta.rnFormat = "vnsSLDevInstTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 17762, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RemoveVDev", "removevdev", 1522)
