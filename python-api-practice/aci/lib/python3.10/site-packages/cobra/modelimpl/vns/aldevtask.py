...
class ALDevTask(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.ALDevTask")

    meta.moClassName = "vnsALDevTask"
    meta.rnFormat = "vnsALDevTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 42688, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("MgmtEpPDUpd", "mgmteppdupd", 3129)
