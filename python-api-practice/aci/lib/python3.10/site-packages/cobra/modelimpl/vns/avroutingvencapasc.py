...
# ##################################################
class AVRoutingVEncapAsc(Mo):
    meta = ClassMeta("cobra.model.vns.AVRoutingVEncapAsc")

    meta.isAbstract = True
    meta.moClassName = "vnsAVRoutingVEncapAsc"


    meta.moClassName = "vnsAVRoutingVEncapAsc"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Routing Connector Configuration"
    ...
    meta.concreteSubClasses.add("cobra.model.vns.VOspfVEncapAsc")
    meta.concreteSubClasses.add("cobra.model.vns.VBgpVEncapAsc")
