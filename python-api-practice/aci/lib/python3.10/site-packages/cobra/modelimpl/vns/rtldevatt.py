...
class RtLDevAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtLDevAtt", "cobra.model.vns.VDev")

    meta.moClassName = "vnsRtLDevAtt"
    meta.rnFormat = "rtlDevAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13720, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13719, PropCategory.REGULAR)
