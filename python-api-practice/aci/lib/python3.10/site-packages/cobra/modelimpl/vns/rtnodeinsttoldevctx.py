...
# ##################################################
class RtNodeInstToLDevCtx(Mo):
    """
    A target relation to a device cluster context points to the device cluster used to pick a specific device based on contract, subject, and function label or names.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtNodeInstToLDevCtx", "cobra.model.vns.NodeInst")

    meta.moClassName = "vnsRtNodeInstToLDevCtx"
    meta.rnFormat = "rtnodeInstToLDevCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Node Instance"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13594, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4780
    prop.defaultValueStr = "vnsNodeInst"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsNodeInst", None, 4780)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13593, PropCategory.REGULAR)
