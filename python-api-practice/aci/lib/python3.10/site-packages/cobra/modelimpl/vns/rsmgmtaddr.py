...
class RsMgmtAddr(Mo):
    """
    A source relation to an address block. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsMgmtAddr", "cobra.model.vns.AddrInst")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsMgmtAddr"
    meta.rnFormat = "rsmgmtAddr"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Management Policy for Ctrl EPs to IP Address Range"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38013, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40152, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14920, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13760, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5507
    prop.defaultValueStr = "vnsAddrInst"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsAddrInst", None, 5507)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13759, PropCategory.REGULAR)
