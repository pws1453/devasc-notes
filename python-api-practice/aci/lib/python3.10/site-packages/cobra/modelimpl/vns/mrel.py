...
class MRel(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.MRel")

    meta.moClassName = "vnsMRel"
    meta.rnFormat = "mRel-%(key)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Meta Relation"
    ...
    meta.childClasses.add("cobra.model.vns.RsTarget")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsTarget", "rstarget"))
    ...
    prop = PropMeta("str", "cardinality", "cardinality", 15479, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "key", "key", 7361, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mandatory", "mandatory", 5060, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14840, PropCategory.REGULAR)
