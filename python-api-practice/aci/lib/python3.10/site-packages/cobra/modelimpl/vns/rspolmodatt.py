...
# ##################################################
class RsPolModAtt(Mo):
    """
    A source relation to a bridge domain policy modifier that can override the desired state of the bridge domain.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsPolModAtt", "cobra.model.fv.PolMod")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsPolModAtt"
    meta.rnFormat = "rsPolModAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13643, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1869
    prop.defaultValueStr = "fvPolMod"
    prop._addConstant("fvPolMod", None, 1869)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13642, PropCategory.REGULAR)
