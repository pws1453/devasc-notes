...
# ##################################################
class DevItem(Mo):
    meta = ClassMeta("cobra.model.vns.DevItem")

    meta.isAbstract = True
    meta.moClassName = "vnsDevItem"
    ...
    meta.concreteSubClasses.add("cobra.model.vns.DevFolder")
    meta.concreteSubClasses.add("cobra.model.vns.DevParam")
    ...
    prop = PropMeta("str", "key", "key", 5229, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 5228, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
