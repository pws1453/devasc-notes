...
# ##################################################
class LDevCtxTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.LDevCtxTask")

    meta.moClassName = "vnsLDevCtxTask"
    meta.rnFormat = "vnsLDevCtxTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16260, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReRenderGraph", "rerendergraph", 1412)
