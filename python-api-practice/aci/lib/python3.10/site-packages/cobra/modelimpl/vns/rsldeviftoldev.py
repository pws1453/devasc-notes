...
# ##################################################
class RsLdevIfToLDev(Mo):
    """
    A source relation to a service device cluster. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLdevIfToLDev", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLdevIfToLDev"
    meta.rnFormat = "rsldevIfToLDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LDev Interface to an LDev"
    meta.writeAccessMask = 0x5000000000000001
    meta.readAccessMask = 0x5000000000000001
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14895, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13674, PropCategory.REGULAR)
