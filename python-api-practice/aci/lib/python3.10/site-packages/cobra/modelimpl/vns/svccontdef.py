...
class SvcContDef(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.SvcContDef")

    meta.moClassName = "vnsSvcContDef"
    meta.rnFormat = "svcContDef"
    ...
    meta.childClasses.add("cobra.model.vns.EpPRedirPol")
    meta.childClasses.add("cobra.model.vns.EPgDefRedirPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EPgDefRedirPol", "epgDefRedirPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EpPRedirPol", "redirPol-"))
