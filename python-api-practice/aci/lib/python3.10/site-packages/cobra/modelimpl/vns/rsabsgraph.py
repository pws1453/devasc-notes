...
class RsAbsGraph(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsAbsGraph", "cobra.model.vns.AbsGraph")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsAbsGraph"
    meta.rnFormat = "rsabsGraph-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21985, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21984, PropCategory.REGULAR)
