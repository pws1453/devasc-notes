...
# ##################################################
class RtNodeInstMeta(Mo):
    """
    A target relation to an abstract node representing a service node. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtNodeInstMeta", "cobra.model.vns.NodeInst")

    meta.moClassName = "vnsRtNodeInstMeta"
    meta.rnFormat = "rtNodeInstMeta"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13590, PropCategory.REGULAR)
