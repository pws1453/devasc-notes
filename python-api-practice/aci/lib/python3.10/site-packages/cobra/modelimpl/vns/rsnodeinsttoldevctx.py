...
# ##################################################
class RsNodeInstToLDevCtx(Mo):
    """
    The device cluster context points to the device cluster used to pick a specific device based on contract, subject, and function label or names. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsNodeInstToLDevCtx", "cobra.model.vns.LDevCtx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsNodeInstToLDevCtx"
    meta.rnFormat = "rsNodeInstToLDevCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Node Instance to a Logical Device Context"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14857, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13592, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4666
    prop.defaultValueStr = "vnsLDevCtx"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsLDevCtx", None, 4666)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13591, PropCategory.REGULAR)
