...
# ##################################################
class RsSvcMgmtEpg(Mo):
    """
    A source relation to a set of endpoints. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsSvcMgmtEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsSvcMgmtEpg"
    meta.rnFormat = "rssvcMgmtEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Management End Point Group"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13704, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13703, PropCategory.REGULAR)
