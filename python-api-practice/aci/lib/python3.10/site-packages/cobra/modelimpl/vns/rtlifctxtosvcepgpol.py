...
# ##################################################
class RtLIfCtxToSvcEPgPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLIfCtxToSvcEPgPol", "cobra.model.vns.LIfCtx")

    meta.moClassName = "vnsRtLIfCtxToSvcEPgPol"
    meta.rnFormat = "rtLIfCtxToSvcEPgPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44816, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44815, PropCategory.REGULAR)
