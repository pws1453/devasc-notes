...
class Cons(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.Cons")

    meta.moClassName = "vnsCons"
    ...
    meta.childClasses.add("cobra.model.vns.RtSEPpInfo")
    meta.childClasses.add("cobra.model.vns.RtRLdevInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtRLdevInst", "rtrLdevInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtSEPpInfo", "rtsEPpInfo-"))

    meta.parentClasses.add("cobra.model.vns.CopyBdHolder")
    ...
    prop = PropMeta("str", "consDn", "consDn", 17752, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
