...
# ##################################################
class RsDevFolderToMFolder(Mo):
    """
    A source relation to an MFolder path.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsDevFolderToMFolder", "cobra.model.vns.MFolder")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "vnsRsDevFolderToMFolder"
    meta.rnFormat = "rsdevFolderToMFolder-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsdevFolderToMFolder-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38015, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40154, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14923, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13763, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13762, PropCategory.REGULAR)
