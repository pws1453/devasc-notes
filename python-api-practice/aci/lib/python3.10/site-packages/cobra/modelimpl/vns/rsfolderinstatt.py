...
# ##################################################
class RsFolderInstAtt(Mo):
    """
    A source relation to a folder instance configured by the administrator. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsFolderInstAtt", "cobra.model.vns.FolderInst")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsFolderInstAtt"
    meta.rnFormat = "rsfolderInstAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13596, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13595, PropCategory.REGULAR)
