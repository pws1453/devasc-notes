...
# ##################################################
class RtAbsConnectionConns(Mo):
    """
    A target relation to a connector. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtAbsConnectionConns", "cobra.model.vns.AbsConnection")

    meta.moClassName = "vnsRtAbsConnectionConns"
    meta.rnFormat = "rtAbsConnectionConns"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13558, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4689
    prop.defaultValueStr = "vnsAbsConnection"
