...
class InTerm(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.InTerm")

    meta.moClassName = "vnsInTerm"
    meta.rnFormat = "intmnl"
    meta.category = MoCategory.REGULAR
    meta.label = "In Terminal"
    ...
    meta.childClasses.add("cobra.model.vns.RsTermToAny")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.vns.RtConnToCtxTermInst")
    meta.childClasses.add("cobra.model.vns.RsTermToEPg")
    meta.childClasses.add("cobra.model.vns.RtScopeToTerm")
    meta.childClasses.add("cobra.model.vns.RtDefaultScopeToTerm")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vns.RtFiltGraphAtt")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.vns.RtConnToCtxTerm")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtConnToCtxTermInst", "rtconnToCtxTermInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtDefaultScopeToTerm", "rtdefaultScopeToTerm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtFiltGraphAtt", "rtvzFiltGraphAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtConnToCtxTerm", "rtconnToCtxTerm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtScopeToTerm", "rtscopeToTerm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsTermToAny", "rstermToAny-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsTermToEPg", "rstermToEPg-"))
    ...
    meta.superClasses.add("cobra.model.vns.ATerm")

    meta.rnPrefixes = [
        ('intmnl', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37967, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5017, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5018, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40106, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14814, PropCategory.REGULAR)
