...
class RtrIdInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.RtrIdInfo")

    meta.moClassName = "vnsRtrIdInfo"
    meta.rnFormat = "rtrIdInfo"
    meta.category = MoCategory.REGULAR
    meta.label = "Service VDev Router Id Information"
    ...
    prop = PropMeta("str", "mode", "mode", 19869, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("pool", "pool", 2)
    prop._addConstant("user", "user", 1)
    meta.props.add("mode", prop)

    prop = PropMeta("str", "monPolDn", "monPolDn", 19876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rtrId", "rtrId", 19868, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
