...
# ##################################################
class RtMConnAttInst(Mo):
    """
    A target relation to a connector between logical functions. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtMConnAttInst", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "vnsRtMConnAttInst"
    meta.rnFormat = "rtMConnAttInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15634, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15633, PropCategory.REGULAR)
