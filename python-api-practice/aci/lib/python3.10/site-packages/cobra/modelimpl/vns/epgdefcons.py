...
class EPgDefCons(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.EPgDefCons")

    meta.moClassName = "vnsEPgDefCons"
    meta.rnFormat = "epgdefcons-[%(consDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "EPG Definition Consumer"
    ...
    prop = PropMeta("str", "consDn", "consDn", 17753, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18480, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sharedSvc", "sharedSvc", 26307, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
