...
# ##################################################
class RtNodeToMFunc(Mo):
    """
    A target relation to the metadata for a single function on a device. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtNodeToMFunc", "cobra.model.vns.AbsNode")

    meta.moClassName = "vnsRtNodeToMFunc"
    meta.rnFormat = "rtnodeToMFunc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13509, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13508, PropCategory.REGULAR)
