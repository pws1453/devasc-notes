...
class RsCIfAttN(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsCIfAttN", "cobra.model.vns.CIf")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsCIfAttN"
    meta.rnFormat = "rscIfAttN-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to a Set of Concrete Interfaces from the Device in the Cluster"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38336, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40475, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22033, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22030, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4931
    prop.defaultValueStr = "vnsCIf"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsCIf", None, 4931)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22029, PropCategory.REGULAR)
