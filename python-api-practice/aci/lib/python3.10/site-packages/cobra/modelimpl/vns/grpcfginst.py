...
class GrpCfgInst(Mo):
    """
    A per function group shared configuration.

    """

    meta = ClassMeta("cobra.model.vns.GrpCfgInst")

    meta.moClassName = "vnsGrpCfgInst"
    meta.rnFormat = "grpCfgInst"
    meta.category = MoCategory.REGULAR
    meta.label = "Per Function Group Shared Cfg"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14868, PropCategory.REGULAR)
