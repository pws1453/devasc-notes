...
# ##################################################
class RtNodeToAbsFuncProf(Mo):
    """
    A target relation to an abstract function profile.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtNodeToAbsFuncProf", "cobra.model.vns.AbsNode")

    meta.moClassName = "vnsRtNodeToAbsFuncProf"
    meta.rnFormat = "rtnodeToAbsFuncProf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13505, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13504, PropCategory.REGULAR)
