...
# ##################################################
class AbsFuncProfNormalized(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.AbsFuncProfNormalized")

    meta.moClassName = "vnsAbsFuncProfNormalized"
    meta.rnFormat = "absFuncProfNormalized-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Normalized Function Profile"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34439, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 34438, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
