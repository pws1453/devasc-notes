...
# ##################################################
class RsIPSLAMonitoringPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsIPSLAMonitoringPol", "cobra.model.fv.IPSLAMonitoringPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsIPSLAMonitoringPol"
    meta.rnFormat = "rsIPSLAMonitoringPol"
    ...
    meta.rnPrefixes = [
        ('rsIPSLAMonitoringPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38741, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40880, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34189, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 34181, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34180, PropCategory.REGULAR)
