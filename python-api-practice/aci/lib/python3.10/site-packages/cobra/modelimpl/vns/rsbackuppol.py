...
# ##################################################
class RsBackupPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsBackupPol", "cobra.model.vns.BackupPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsBackupPol"
    meta.rnFormat = "rsBackupPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 54420, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54421, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54417, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54413, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54412, PropCategory.REGULAR)
