...
class Chkr(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.Chkr")

    meta.moClassName = "vnsChkr"
    meta.rnFormat = "chkr"
    meta.category = MoCategory.REGULAR
    meta.label = "checker for dev folder/params"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38243, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40382, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "state", "state", 20461, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
