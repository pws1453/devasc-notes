...
class RtAbsGraph(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtAbsGraph", "cobra.model.vns.SvcRelnHolder")

    meta.moClassName = "vnsRtAbsGraph"
    meta.rnFormat = "rtabsGraph-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21987, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21986, PropCategory.REGULAR)
