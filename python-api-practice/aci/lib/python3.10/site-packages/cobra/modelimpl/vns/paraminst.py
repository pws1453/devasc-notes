...
class ParamInst(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.ParamInst")

    meta.moClassName = "vnsParamInst"
    meta.rnFormat = "ParamInst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 param instance"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37987, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40126, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14863, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7364, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
