...
# ##################################################
class L1L2RedirectDest(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.L1L2RedirectDest")

    meta.moClassName = "vnsL1L2RedirectDest"
    meta.rnFormat = "L1L2RedirectDest-%(destName)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Destination of L1/L2 redirected traffic"
    ...
    meta.childClasses.add("cobra.model.vns.RsToCIf")
    meta.childClasses.add("cobra.model.vns.RsL1L2RedirectHealthGroup")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsL1L2RedirectHealthGroup", "rsL1L2RedirectHealthGroup"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsToCIf", "rstoCIf"))
    ...
    meta.rnPrefixes = [
        ('L1L2RedirectDest-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 42530, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "destName", "destName", 42523, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42531, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 42521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mac", "mac", 42522, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42528, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "destName"))
    ...
    def __init__(self, parentMoOrDn, destName, markDirty=True, **creationProps):
        namingVals = [destName]
