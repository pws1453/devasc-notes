...
# ##################################################
class RtMChassisToMDev(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vns.RtMChassisToMDev", "cobra.model.vns.MChassis")

    meta.moClassName = "vnsRtMChassisToMDev"
    meta.rnFormat = "rtmChassisToMDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18366, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18365, PropCategory.REGULAR)
