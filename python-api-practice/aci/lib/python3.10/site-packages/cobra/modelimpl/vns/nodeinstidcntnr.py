...
# ##################################################
class NodeInstIdCntnr(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.NodeInstIdCntnr")

    meta.moClassName = "vnsNodeInstIdCntnr"
    meta.rnFormat = "NodeInstIdCntnr"
    meta.category = MoCategory.REGULAR
    meta.label = "Container for NodeInst Ids"
    ...
    meta.childClasses.add("cobra.model.vns.NodeInstCons")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.NodeInstCons", "NodeInstCons-"))
    ...
    prop = PropMeta("str", "encap", "encap", 20397, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
