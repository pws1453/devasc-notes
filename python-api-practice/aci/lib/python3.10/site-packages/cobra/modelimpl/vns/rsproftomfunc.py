...
class RsProfToMFunc(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsProfToMFunc", "cobra.model.vns.MFunc")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsProfToMFunc"
    meta.rnFormat = "rsProfToMFunc"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L4-L7 Services Function Profile Meta Func."
    ...
    prop = PropMeta("str", "annotation", "annotation", 37963, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40102, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14809, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13514, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13513, PropCategory.REGULAR)
