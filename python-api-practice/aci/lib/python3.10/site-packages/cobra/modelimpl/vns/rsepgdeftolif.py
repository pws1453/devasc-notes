...
# ##################################################
class RsEPgDefToLIf(Mo):
    """
    A source relation to a logical interface.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsEPgDefToLIf", "cobra.model.vns.LIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsEPgDefToLIf"
    meta.rnFormat = "rsEPgDefToLIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13611, PropCategory.REGULAR)
