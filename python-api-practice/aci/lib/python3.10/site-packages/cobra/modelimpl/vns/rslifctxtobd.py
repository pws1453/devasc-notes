...
# ##################################################
class RsLIfCtxToBD(Mo):
    """
    A source relation to a private layer 2 bridge domain (BD).

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToBD", "cobra.model.fv.BD")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToBD"
    meta.rnFormat = "rsLIfCtxToBD"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38114, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40253, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16122, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16112, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16111, PropCategory.REGULAR)
