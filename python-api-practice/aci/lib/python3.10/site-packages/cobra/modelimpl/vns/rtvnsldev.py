...
class RtVnsldev(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtVnsldev", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "vnsRtVnsldev"
    meta.rnFormat = "rtpolVnsldev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13480, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13479, PropCategory.REGULAR)
