...
# ##################################################
class RsVConnToEpgSubnet(Mo):
    """
    A source relation to a set of endpoints. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsVConnToEpgSubnet", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsVConnToEpgSubnet"
    meta.rnFormat = "rsvConnToEpgSubnet-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.vns.VEpg")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsvConnToEpgSubnet-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 13734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13733, PropCategory.REGULAR)
