...
class DevIssues(Mo):
    """
    An object that represents any failures encountered when configuring a service node.

    """

    meta = ClassMeta("cobra.model.vns.DevIssues")

    meta.moClassName = "vnsDevIssues"
    meta.rnFormat = "devIssues"
    meta.category = MoCategory.REGULAR
    meta.label = "Device Issues"
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5233, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
