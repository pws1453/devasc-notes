...
# ##################################################
class HealthDestTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.HealthDestTask")

    meta.moClassName = "vnsHealthDestTask"
    meta.rnFormat = "vnsHealthDestTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 42631, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("GetCtxSeg", "getctxseg", 3120)
