...
# ##################################################
class RtAbsCopyConnection(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtAbsCopyConnection", "cobra.model.vns.AbsConnection")

    meta.moClassName = "vnsRtAbsCopyConnection"
    meta.rnFormat = "rtAbsCopyConnection"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23288, PropCategory.REGULAR)
