...
# ##################################################
class GraphIdCntnr(Mo):
    """
    Contains an ID consumer for the IDs needed by the graph.

    """

    meta = ClassMeta("cobra.model.vns.GraphIdCntnr")

    meta.moClassName = "vnsGraphIdCntnr"
    meta.rnFormat = "GraphIdCntnr-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Container for Graph Ids"
    ...
    prop = PropMeta("str", "id", "id", 31097, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 7341, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
