...
class RsCDevAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsCDevAtt", "cobra.model.vns.CDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCDevAtt"
    meta.rnFormat = "rsCDevAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13671, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13670, PropCategory.REGULAR)
