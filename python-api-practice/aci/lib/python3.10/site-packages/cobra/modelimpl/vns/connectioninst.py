...
# ##################################################
class ConnectionInst(Mo):
    """
    A connection instance.

    """

    meta = ClassMeta("cobra.model.vns.ConnectionInst")

    meta.moClassName = "vnsConnectionInst"
    meta.rnFormat = "ConnectionInst-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.RsConnectionInstConns")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsConnectionInstConns", "rsconnectionInstConns-"))
    ...
    meta.superClasses.add("cobra.model.vns.AConnection")

    meta.rnPrefixes = [
        ('ConnectionInst-', True),
    ]

    prop = PropMeta("str", "adjType", "adjType", 15742, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "L2"
    prop._addConstant("L2", "l2", 0)
    prop._addConstant("L3", "l3", 1)
    meta.props.add("adjType", prop)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5030, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5031, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "connDir", "connDir", 21034, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "provider"
    prop._addConstant("consumer", "consumer", 0)
    prop._addConstant("provider", "provider", 1)
    prop._addConstant("unknown", "unknown", 1)
    meta.props.add("connDir", prop)

    prop = PropMeta("str", "connType", "connType", 16108, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    meta.props.add("connType", prop)

    prop = PropMeta("str", "ctxDn", "ctxDn", 5133, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "directConnect", "directConnect", 27114, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("directConnect", prop)
    ...
    prop = PropMeta("str", "isExternal", "isExternal", 5134, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isExternal", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14881, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7326, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "unicastRoute", "unicastRoute", 5029, PropCategory.REGULAR)
