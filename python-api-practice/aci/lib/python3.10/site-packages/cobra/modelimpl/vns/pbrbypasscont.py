...
# ##################################################
class PbrByPassCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.PbrByPassCont")

    meta.moClassName = "vnsPbrByPassCont"
    meta.rnFormat = "bypassCont"
    meta.category = MoCategory.REGULAR
    meta.label = "PBR ByPass Container"
    ...
    meta.childClasses.add("cobra.model.vns.ByPassChain")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ByPassChain", "graph-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53347, PropCategory.REGULAR)
