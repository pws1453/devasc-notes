...
class MDevMgr(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.MDevMgr")

    meta.moClassName = "vnsMDevMgr"
    meta.rnFormat = "mDevMgr-%(vendor)s-%(model)s-%(version)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Device Manager type"
    ...
    meta.childClasses.add("cobra.model.vns.RsMDevMgrToMDev")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.vns.RtMDevMgr")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vns.RtDevMgrToMDevMgr")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtDevMgrToMDevMgr", "rtdevMgrToMDevMgr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsMDevMgrToMDev", "rsmDevMgrToMDev"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtMDevMgr", "rtmDevMgr-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38199, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 22586, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 22587, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40338, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "model", "model", 18344, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18397, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vendor", "vendor", 18343, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "version", "version", 18345, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
