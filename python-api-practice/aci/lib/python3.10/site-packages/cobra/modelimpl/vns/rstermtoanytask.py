...
# ##################################################
class RsTermToAnyTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.RsTermToAnyTask")

    meta.moClassName = "vnsRsTermToAnyTask"
    meta.rnFormat = "vnsRsTermToAnyTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16842, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SvcFltUpd", "svcfltupd", 1481)
