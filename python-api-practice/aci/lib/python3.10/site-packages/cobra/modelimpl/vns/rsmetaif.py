...
class RsMetaIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsMetaIf", "cobra.model.vns.MIfLbl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsMetaIf"
    meta.rnFormat = "rsmetaIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Logical Interface to an Interface Label"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38000, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40139, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isConAndProv", "isConAndProv", 24090, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isConAndProv", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14901, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13710, PropCategory.REGULAR)
