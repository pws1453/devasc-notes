...
class CRel(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.CRel")

    meta.moClassName = "vnsCRel"
    meta.rnFormat = "cRel-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14893, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7321, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "targetDn", "targetDn", 5170, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
