...
# ##################################################
class RtProfToCloudModeMDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtProfToCloudModeMDev", "cobra.model.vns.AbsFuncProf")

    meta.moClassName = "vnsRtProfToCloudModeMDev"
    meta.rnFormat = "rtprofToCloudModeMDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 36803, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 36802, PropCategory.REGULAR)
