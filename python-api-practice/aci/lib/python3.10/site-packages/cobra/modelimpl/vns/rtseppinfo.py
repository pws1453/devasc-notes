...
class RtSEPpInfo(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtSEPpInfo", "cobra.model.vns.REPpInfo")

    meta.moClassName = "vnsRtSEPpInfo"
    meta.rnFormat = "rtsEPpInfo-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17775, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17774, PropCategory.REGULAR)
