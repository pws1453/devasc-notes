...
class RtFunction(Mo):
    """
    A target relation to the metadata for a single function on a device. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtFunction", "cobra.model.vns.VFunc")

    meta.moClassName = "vnsRtFunction"
    meta.rnFormat = "rtfunction-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13724, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4903
    prop.defaultValueStr = "vnsVFunc"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsVFunc", None, 4903)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13723, PropCategory.REGULAR)
