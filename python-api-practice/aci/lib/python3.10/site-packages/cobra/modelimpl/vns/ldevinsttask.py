...
# ##################################################
class LDevInstTask(Mo):
    """
    An internal object to track the execution state of a task on the logical device instance that holds reusable encap information across service graphs.

    """

    meta = ClassMeta("cobra.model.vns.LDevInstTask")

    meta.moClassName = "vnsLDevInstTask"
    meta.rnFormat = "vnsLDevInstTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5733, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AllocateVDevId", "allocatevdevid", 1520)
    prop._addConstant("VDevUpdGraphInst", "vdevupdgraphinst", 840)
