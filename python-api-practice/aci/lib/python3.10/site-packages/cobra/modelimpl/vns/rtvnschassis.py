...
# ##################################################
class RtVnschassis(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtVnschassis", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "vnsRtVnschassis"
    meta.rnFormat = "rtpolVnschassis-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23135, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23134, PropCategory.REGULAR)
