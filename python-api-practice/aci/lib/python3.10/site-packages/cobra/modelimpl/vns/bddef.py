...
class BDDef(Mo):
    """
    A bridge domain definition for tracking allocated bridge domains. This is an internally used object.

    """

    meta = ClassMeta("cobra.model.vns.BDDef")

    meta.moClassName = "vnsBDDef"
    meta.rnFormat = "BDDef-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.RsBDDefToConn")
    meta.childClasses.add("cobra.model.vns.RsBDDefToBD")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.vns.RsBDDefToLIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsBDDefToConn", "rsBDDefToConn"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsBDDefToLIf", "rsBDDefToLIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsBDDefToBD", "rsBDDefToBD"))
    ...
    prop = PropMeta("str", "name", "name", 16208, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
