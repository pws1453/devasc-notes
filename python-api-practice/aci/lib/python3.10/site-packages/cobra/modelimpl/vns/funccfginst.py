...
# ##################################################
class FuncCfgInst(Mo):
    """
    A per function configuration instance.

    """

    meta = ClassMeta("cobra.model.vns.FuncCfgInst")

    meta.moClassName = "vnsFuncCfgInst"
    meta.rnFormat = "funcCfgInst"
    meta.category = MoCategory.REGULAR
    meta.label = "Per Func Cfg"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14869, PropCategory.REGULAR)
