...
class DevProf(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.DevProf")

    meta.moClassName = "vnsDevProf"
    meta.rnFormat = "devProf-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Device Profile"
    ...
    meta.childClasses.add("cobra.model.vns.DevInt")
    meta.childClasses.add("cobra.model.vns.DevSlot")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.DevSlot", "devSlot-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.DevInt", "devInt-"))
    ...
    prop = PropMeta("str", "context", "context", 17637, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "dispLabel", "dispLabel", 17787, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 17640, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "pcPrefix", "pcPrefix", 17786, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("pcPrefix", prop)
    ...
    prop = PropMeta("str", "type", "type", 17636, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
