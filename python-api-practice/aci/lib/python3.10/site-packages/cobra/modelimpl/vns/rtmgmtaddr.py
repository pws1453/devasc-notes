...
class RtMgmtAddr(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtMgmtAddr", "cobra.model.vns.CtrlrMgmtPol")

    meta.moClassName = "vnsRtMgmtAddr"
    meta.rnFormat = "rtmgmtAddr"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16175, PropCategory.REGULAR)
