...
class EPgDefTask(Mo):
    """
    An internal object to track a task on the object that tracks allocated endpoint groups.

    """

    meta = ClassMeta("cobra.model.vns.EPgDefTask")

    meta.moClassName = "vnsEPgDefTask"
    meta.rnFormat = "vnsEPgDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5728, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("LegacyEpP", "legacyepp", 1396)
    prop._addConstant("SvcQosUpd", "svcqosupd", 3116)
