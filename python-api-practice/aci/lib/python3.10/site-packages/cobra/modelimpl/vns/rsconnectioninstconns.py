...
# ##################################################
class RsConnectionInstConns(Mo):
    """
    A source relation to a connector. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnectionInstConns", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "vnsRsConnectionInstConns"
    meta.rnFormat = "rsconnectionInstConns-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13659, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13658, PropCategory.REGULAR)
