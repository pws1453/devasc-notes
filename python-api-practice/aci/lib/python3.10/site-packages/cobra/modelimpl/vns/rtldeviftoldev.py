...
# ##################################################
class RtLdevIfToLDev(Mo):
    """
    A target relation to a service device cluster.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLdevIfToLDev", "cobra.model.vns.LDevIf")

    meta.moClassName = "vnsRtLdevIfToLDev"
    meta.rnFormat = "rtldevIfToLDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13677, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4869
    prop.defaultValueStr = "vnsLDevIf"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsLDevIf", None, 4869)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13676, PropCategory.REGULAR)
