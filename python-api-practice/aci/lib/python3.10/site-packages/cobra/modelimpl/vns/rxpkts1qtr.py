...
class RxPkts1qtr(Mo):
    """
    A class that represents the most current statistics for  Rx  Packet counters in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPkts1qtr", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPkts1qtr"
    meta.rnFormat = "CDvnsRxPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Rx Packet counters stats in 1 quarter"
