...
class RtLDevInst(Mo):
    """
    A target relation to the object that ties a contract, graph and device.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLDevInst", "cobra.model.vns.GraphInst")

    meta.moClassName = "vnsRtLDevInst"
    meta.rnFormat = "rtLDevInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13586, PropCategory.REGULAR)
