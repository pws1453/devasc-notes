...
# ##################################################
class RsMChassisToMDev(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsMChassisToMDev", "cobra.model.vns.MDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsMChassisToMDev"
    meta.rnFormat = "rsmChassisToMDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L4-L7 Service Device Type"
    ...
    meta.rnPrefixes = [
        ('rsmChassisToMDev', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38198, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40337, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18396, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18364, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18363, PropCategory.REGULAR)
