...
# ##################################################
class RsConnToLIfInst(Mo):
    """
    A source relation to the logical interface associated with a set of concrete interfaces from the L4-L7 device cluster. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnToLIfInst", "cobra.model.vns.LIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnToLIfInst"
    meta.rnFormat = "rsConnToLIfInst"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Connector Instance to a Logical Interface"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13639, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4892
    prop.defaultValueStr = "vnsLIf"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsLIf", None, 4892)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13638, PropCategory.REGULAR)
