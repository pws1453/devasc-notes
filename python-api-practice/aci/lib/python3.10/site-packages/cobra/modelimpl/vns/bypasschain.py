...
# ##################################################
class ByPassChain(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.ByPassChain")

    meta.moClassName = "vnsByPassChain"
    meta.rnFormat = "graph-[%(graphDn)s]-dir-%(direction)s"
    meta.category = MoCategory.REGULAR
    meta.label = "ByPass Chain"
    ...
    meta.childClasses.add("cobra.model.vns.NextHopInfo")
    meta.childClasses.add("cobra.model.vns.GraphInstCons")
    meta.childClasses.add("cobra.model.vns.RtToRemoteByPassChain")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtToRemoteByPassChain", "rtfvToRemoteByPassChain-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.GraphInstCons", "graphInstDn-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.NextHopInfo", "pbrDn-"))
    ...
    prop = PropMeta("str", "direction", "direction", 53335, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "graphDn", "graphDn", 53334, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53348, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, graphDn, direction, markDirty=True, **creationProps):
        namingVals = [graphDn, direction]
