...
# ##################################################
class NodeInstDef(Mo):
    """
    An instance of the service node. This is an internal object.

    """

    meta = ClassMeta("cobra.model.vns.NodeInstDef")

    meta.moClassName = "vnsNodeInstDef"
    meta.rnFormat = "NodeInstDef-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.VNodeDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.VNodeDef", "VNodeDef-"))
    ...
    meta.superClasses.add("cobra.model.vns.ANodeInst")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14858, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7363, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
