...
class RtCDevAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtCDevAtt", "cobra.model.vns.CFolder")

    meta.moClassName = "vnsRtCDevAtt"
    meta.rnFormat = "rtCDevAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Concrete Folder"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13673, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4863
    prop.defaultValueStr = "vnsCFolder"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsCFolder", None, 4863)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13672, PropCategory.REGULAR)
