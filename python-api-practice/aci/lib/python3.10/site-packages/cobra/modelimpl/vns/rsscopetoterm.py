...
# ##################################################
class RsScopeToTerm(Mo):
    """
    A source relation to contract terminal node for parameter resolution. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsScopeToTerm", "cobra.model.vns.ATerm")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsScopeToTerm"
    meta.rnFormat = "rsscopeToTerm"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Abstract Folder Contract Terminal"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37956, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40095, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14802, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13511, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4652
    prop.defaultValueStr = "vnsATerm"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13510, PropCategory.REGULAR)
