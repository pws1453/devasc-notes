...
# ##################################################
class GraphInstCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.GraphInstCons")

    meta.moClassName = "vnsGraphInstCons"
    meta.rnFormat = "graphInstDn-[%(graphInstDn)s]"
    ...
    prop = PropMeta("str", "graphInstDn", "graphInstDn", 54490, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
