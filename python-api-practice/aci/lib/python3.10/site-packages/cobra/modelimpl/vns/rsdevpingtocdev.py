...
# ##################################################
class RsDevPingToCDev(Mo):
    """
    This property is managed internally and should not be modified by the user.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsDevPingToCDev", "cobra.model.vns.CDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsDevPingToCDev"
    meta.rnFormat = "rsdevPingToCDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Device Ping Object to a Concrete Service Device"
    ...
    meta.rnPrefixes = [
        ('rsdevPingToCDev', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38018, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40157, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14926, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13766, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4924
    prop.defaultValueStr = "vnsCDev"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsCDev", None, 4924)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13765, PropCategory.REGULAR)
