...
# ##################################################
class RtToRemoteByPassChain(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToRemoteByPassChain", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "vnsRtToRemoteByPassChain"
    meta.rnFormat = "rtfvToRemoteByPassChain-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53346, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53345, PropCategory.REGULAR)
