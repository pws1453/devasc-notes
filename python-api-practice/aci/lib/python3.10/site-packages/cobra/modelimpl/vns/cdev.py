...
class CDev(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.CDev")

    meta.moClassName = "vnsCDev"
    meta.rnFormat = "cDev-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete Device"
    ...
    meta.childClasses.add("cobra.model.vns.CCredSecret")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vns.CIf")
    meta.childClasses.add("cobra.model.vns.RtCDevAtt")
    meta.childClasses.add("cobra.model.vns.RsCDevToVm")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.vns.DevParam")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.vns.RtDevPingToCDev")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.vns.CMgmt")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.vns.DevFolder")
    ...
    meta.childClasses.add("cobra.model.vns.CCred")
    meta.childClasses.add("cobra.model.vns.DevIssues")
    meta.childClasses.add("cobra.model.vns.RtCDevOperInfoToCDev")
    meta.childClasses.add("cobra.model.vns.RsCDevToCtrlrP")
    meta.childClasses.add("cobra.model.vns.RsCDevTemplateToAddrInst")
    meta.childClasses.add("cobra.model.vns.HAPortGroup")
    meta.childClasses.add("cobra.model.vns.RsCDevToChassis")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsCDevTemplateToAddrInst", "rscDevTemplateToAddrInst"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtCDevOperInfoToCDev", "rtCDevOperInfoToCDev"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtDevPingToCDev", "rtdevPingToCDev-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsCDevToChassis", "rscDevToChassis"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsCDevToCtrlrP", "rscDevToCtrlrP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CCredSecret", "cCredSecret"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsCDevToVm", "rscDevToVm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.NodeInst", "nodehealth-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.HAPortGroup", "haPortGroup"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtCDevAtt", "rtCDevAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.DevFolder", "devFolder-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.DevParam", "devParam-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.DevIssues", "devIssues"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CMgmt", "cMgmt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasInst", "alias"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CCred", "cCred"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CIf", "cIf-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38006, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cloneCount", "cloneCount", 44830, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "0"
    meta.props.add("cloneCount", prop)

    prop = PropMeta("str", "configInfo", "configInfo", 15521, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("configInfo", prop)

    prop = PropMeta("str", "configIssues", "configIssues", 5200, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5201, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "devCtxLbl", "devCtxLbl", 5204, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("devCtxLbl", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40145, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "host", "host", 44809, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "isCloneOperation", "isCloneOperation", 44832, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("isCloneOperation", prop)

    prop = PropMeta("str", "isDynamic", "isDynamic", 42640, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isDynamic", prop)

    prop = PropMeta("str", "isTemplate", "isTemplate", 44831, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isTemplate", prop)

    prop = PropMeta("str", "isUpdate", "isUpdate", 49446, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14915, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7315, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "policyChangeCount", "policyChangeCount", 44553, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "0"
    meta.props.add("policyChangeCount", prop)
    ...
    prop = PropMeta("str", "state", "state", 42641, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "vcenterName", "vcenterName", 5202, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("vcenterName", prop)

    prop = PropMeta("str", "vmName", "vmName", 5203, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("vmName", prop)

    prop = PropMeta("str", "vmOp", "vmOp", 42639, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "deploying"
    prop._addConstant("created", "created", 1)
    prop._addConstant("deleted", "deleted", 8)
    prop._addConstant("deploying", "deploying", 0)
    prop._addConstant("monitor", "monitor", 4)
    prop._addConstant("policyupdate", "policyupdate", 6)
    prop._addConstant("policyupgrade", "policyupgrade", 5)
    prop._addConstant("poweroff", "poweroff", 3)
    prop._addConstant("poweron", "poweron", 2)
    prop._addConstant("redeploying", "redeploying", 7)
    meta.props.add("vmOp", prop)
