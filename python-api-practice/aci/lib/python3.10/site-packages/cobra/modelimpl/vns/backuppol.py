...
class BackupPol(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.BackupPol")

    meta.moClassName = "vnsBackupPol"
    meta.rnFormat = "backupPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "PBR Backup Policy"
    ...
    meta.childClasses.add("cobra.model.vns.L1L2RedirectDest")
    ...
    meta.childClasses.add("cobra.model.vns.RtBackupPol")
    meta.childClasses.add("cobra.model.vns.RedirectDest")
    meta.childClasses.add("cobra.model.vns.RtToRemoteBackupPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtToRemoteBackupPol", "rtfvToRemoteBackupPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.L1L2RedirectDest", "L1L2RedirectDest-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RedirectDest", "RedirectDest_ip-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtBackupPol", "rtbackupPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 54418, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54419, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54416, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 54410, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
