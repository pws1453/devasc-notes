...
# ##################################################
class RsCloudSvcEPgDefToSvcEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsCloudSvcEPgDefToSvcEPg", "cobra.model.cloud.ISvcEPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCloudSvcEPgDefToSvcEPg"
    meta.rnFormat = "rsCloudSvcEPgDefToSvcEPg"
    ...
    meta.rnPrefixes = [
        ('rsCloudSvcEPgDefToSvcEPg', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51912, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15164
    prop.defaultValueStr = "cloudISvcEPg"
    prop._addConstant("cloudISvcEPg", None, 15164)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51911, PropCategory.REGULAR)
