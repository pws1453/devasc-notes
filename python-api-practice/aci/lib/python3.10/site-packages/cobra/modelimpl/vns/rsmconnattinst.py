...
# ##################################################
class RsMConnAttInst(Mo):
    """
    A source relation to a connector between logical functions. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsMConnAttInst", "cobra.model.vns.MConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsMConnAttInst"
    meta.rnFormat = "rsMConnAttInst"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15635, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15632, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15631, PropCategory.REGULAR)
