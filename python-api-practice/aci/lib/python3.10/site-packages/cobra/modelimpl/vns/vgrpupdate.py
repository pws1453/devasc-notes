...
class VGrpUpdate(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.VGrpUpdate")

    meta.moClassName = "vnsVGrpUpdate"
    meta.rnFormat = "vGrpUpd-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tDn", "tDn", 18034, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
