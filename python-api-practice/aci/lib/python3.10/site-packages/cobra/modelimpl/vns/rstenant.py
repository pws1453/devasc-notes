...
class RsTenant(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsTenant", "cobra.model.fv.Tenant")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsTenant"
    meta.rnFormat = "rstenant-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation To Tenant"
    ...
    meta.childClasses.add("cobra.model.vns.RelnCons")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RelnCons", "relnCons-"))

    meta.parentClasses.add("cobra.model.vns.RelnHolder")
    ...
    prop = PropMeta("str", "tCl", "tCl", 18190, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18189, PropCategory.REGULAR)
