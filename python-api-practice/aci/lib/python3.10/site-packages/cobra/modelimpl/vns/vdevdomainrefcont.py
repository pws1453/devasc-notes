...
# ##################################################
class VDevDomainRefCont(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.VDevDomainRefCont")

    meta.moClassName = "vnsVDevDomainRefCont"
    meta.rnFormat = "vDevDomainRefCont"
    ...
    meta.childClasses.add("cobra.model.vns.RsVDevDomainRefContToDomainRef")
    meta.childClasses.add("cobra.model.res.Consumer")
    meta.childClasses.add("cobra.model.health.NodeInst")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsVDevDomainRefContToDomainRef", "rsVDevDomainRefContToDomainRef"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18097, PropCategory.REGULAR)
