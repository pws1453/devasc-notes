...
# ##################################################
class VDevOperInfo(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.VDevOperInfo")

    meta.moClassName = "vnsVDevOperInfo"
    meta.rnFormat = "operInfo"
    ...
    prop = PropMeta("str", "hlthResp", "hlthResp", 16055, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("hlthResp", prop)

    prop = PropMeta("str", "lastCounterCheckTime", "lastCounterCheckTime", 21973, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastCounterCheckTime", prop)

    prop = PropMeta("str", "lastHealthCheckTime", "lastHealthCheckTime", 21972, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastHealthCheckTime", prop)

    prop = PropMeta("str", "lastTransitionTime", "lastTransitionTime", 16628, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "modResp", "modResp", 16054, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("audit", "audit", 3)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16057, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operState", "operState", 16056, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
