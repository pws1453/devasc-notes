...
# ##################################################
class RsVConnToEpgEp(Mo):
    """
    A source relation to a set of endpoints. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsVConnToEpgEp", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsVConnToEpgEp"
    meta.rnFormat = "rsvConnToEpgEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13730, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13729, PropCategory.REGULAR)
