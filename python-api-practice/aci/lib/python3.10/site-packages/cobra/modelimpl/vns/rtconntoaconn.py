...
# ##################################################
class RtConnToAConn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtConnToAConn", "cobra.model.vns.AFuncConn")

    meta.moClassName = "vnsRtConnToAConn"
    meta.rnFormat = "rtconnToAConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20734, PropCategory.REGULAR)
