...
class RsMChassis(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsMChassis", "cobra.model.vns.MChassis")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsMChassis"
    meta.rnFormat = "rsmChassis-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23097, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23096, PropCategory.REGULAR)
