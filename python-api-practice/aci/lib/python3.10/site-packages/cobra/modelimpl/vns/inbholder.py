...
class InBHolder(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.InBHolder")

    meta.moClassName = "vnsInBHolder"
    meta.rnFormat = "InBHolder"
    meta.category = MoCategory.REGULAR
    meta.label = "Inband epp holder"
    ...
    meta.childClasses.add("cobra.model.vns.InBEpPInfo")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.InBEpPInfo", "epg-"))
