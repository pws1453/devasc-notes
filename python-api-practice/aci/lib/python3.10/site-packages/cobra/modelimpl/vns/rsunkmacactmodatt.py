...
# ##################################################
class RsUnkMacActModAtt(Mo):
    """
    A source relation to the policy modifying the bridge domain flood settings. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsUnkMacActModAtt", "cobra.model.fv.UnkMacUcastActMod")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsUnkMacActModAtt"
    meta.rnFormat = "rsUnkMacActModAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "BD Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13647, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1870
    prop.defaultValueStr = "fvUnkMacUcastActMod"
    prop._addConstant("fvUnkMacUcastActMod", None, 1870)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13646, PropCategory.REGULAR)
