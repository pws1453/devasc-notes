...
# ##################################################
class ScriptRTInfoTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.ScriptRTInfoTask")

    meta.moClassName = "vnsScriptRTInfoTask"
    meta.rnFormat = "vnsScriptRTInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15942, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateScriptRTInfo", "updatescriptrtinfo", 1355)
