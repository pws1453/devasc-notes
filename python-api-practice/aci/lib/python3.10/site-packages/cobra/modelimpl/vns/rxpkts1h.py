...
class RxPkts1h(Mo):
    """
    A class that represents the most current statistics for  Rx  Packet counters in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPkts1h", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPkts1h"
    meta.rnFormat = "CDvnsRxPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Rx Packet counters stats in 1 hour"
