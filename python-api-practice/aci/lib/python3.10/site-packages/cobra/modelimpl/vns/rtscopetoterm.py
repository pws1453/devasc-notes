...
# ##################################################
class RtScopeToTerm(Mo):
    """
    A target relation to a terminal. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtScopeToTerm", "cobra.model.vns.AFolder")

    meta.moClassName = "vnsRtScopeToTerm"
    meta.rnFormat = "rtscopeToTerm"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13512, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4634
    prop.defaultValueStr = "vnsAFolder"
