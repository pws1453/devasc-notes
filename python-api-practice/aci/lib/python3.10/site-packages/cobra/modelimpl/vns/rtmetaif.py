...
class RtMetaIf(Mo):
    """
    A target relation to an interface label.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtMetaIf", "cobra.model.vns.ALIf")

    meta.moClassName = "vnsRtMetaIf"
    meta.rnFormat = "rtmetaIf-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.vns.MIfLbl")
    ...
    prop = PropMeta("str", "tCl", "tCl", 13713, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4885
    prop.defaultValueStr = "vnsALIf"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13712, PropCategory.REGULAR)
