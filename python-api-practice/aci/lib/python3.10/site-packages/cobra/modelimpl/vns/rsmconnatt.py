...
class RsMConnAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsMConnAtt", "cobra.model.vns.MConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsMConnAtt"
    meta.rnFormat = "rsMConnAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Function Connector to a Meta Connector from Package"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37973, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40112, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14823, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13553, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13552, PropCategory.REGULAR)
