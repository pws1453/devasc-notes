...
# ##################################################
class RsNodeToLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsNodeToLDev", "cobra.model.vns.ALDevIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsNodeToLDev"
    meta.rnFormat = "rsNodeToLDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a AbsNode to an LDev"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38248, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40387, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20850, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20847, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20846, PropCategory.REGULAR)
