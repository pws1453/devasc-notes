...
# ##################################################
class RxPktsHist15min(Mo):
    """
    A class that represents historical statistics for  Rx  Packet counters in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPktsHist15min", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist15min"
    meta.rnFormat = "HDvnsRxPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.vns.RxPktsHist")

    meta.rnPrefixes = [
        ('HDvnsRxPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 7374, PropCategory.REGULAR)
