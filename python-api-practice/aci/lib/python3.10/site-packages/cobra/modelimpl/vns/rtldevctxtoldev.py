...
# ##################################################
class RtLDevCtxToLDev(Mo):
    """
    A target relation to a device cluster.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLDevCtxToLDev", "cobra.model.vns.LDevCtx")

    meta.moClassName = "vnsRtLDevCtxToLDev"
    meta.rnFormat = "rtLDevCtxToLDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13535, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13534, PropCategory.REGULAR)
