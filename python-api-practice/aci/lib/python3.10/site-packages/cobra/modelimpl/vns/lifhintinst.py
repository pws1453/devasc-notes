...
# ##################################################
class LIfHintInst(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.LIfHintInst")

    meta.moClassName = "vnsLIfHintInst"
    meta.rnFormat = "lIfHintInst"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Interface Hint Instance"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16344, PropCategory.REGULAR)
