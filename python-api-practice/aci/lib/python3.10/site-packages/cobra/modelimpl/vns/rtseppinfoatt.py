...
# ##################################################
class RtSEPpInfoAtt(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vns.RtSEPpInfoAtt", "cobra.model.vns.EPgDef")

    meta.moClassName = "vnsRtSEPpInfoAtt"
    meta.rnFormat = "rtSEPpInfoAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17771, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17770, PropCategory.REGULAR)
