...
class AbsCfgRel(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.AbsCfgRel")

    meta.moClassName = "vnsAbsCfgRel"
    meta.rnFormat = "absRel-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Relation"
    ...
    meta.superClasses.add("cobra.model.vns.ACCfgRel")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37959, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5012, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5013, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40098, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14805, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7301, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
