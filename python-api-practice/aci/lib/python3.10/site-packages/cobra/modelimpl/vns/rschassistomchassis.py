...
# ##################################################
class RsChassisToMChassis(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsChassisToMChassis", "cobra.model.vns.MChassis")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsChassisToMChassis"
    meta.rnFormat = "rschassisToMChassis"
    ...
    meta.rnPrefixes = [
        ('rschassisToMChassis', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38204, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40343, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18379, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6161
    prop.defaultValueStr = "vnsMChassis"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsMChassis", None, 6161)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18378, PropCategory.REGULAR)
