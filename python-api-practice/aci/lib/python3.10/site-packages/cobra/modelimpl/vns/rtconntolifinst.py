...
# ##################################################
class RtConnToLIfInst(Mo):
    """
    A target relation to a logical interface associated with a set of concrete interfaces from the L4-L7 device cluster. Note that this relation is an internal object

    """

    meta = TargetRelationMeta("cobra.model.vns.RtConnToLIfInst", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "vnsRtConnToLIfInst"
    meta.rnFormat = "rtconnToLIfInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13640, PropCategory.REGULAR)
