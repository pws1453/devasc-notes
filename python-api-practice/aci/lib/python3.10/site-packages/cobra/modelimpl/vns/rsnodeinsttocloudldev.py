...
# ##################################################
class RsNodeInstToCloudLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsNodeInstToCloudLDev", "cobra.model.cloud.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsNodeInstToCloudLDev"
    meta.rnFormat = "rsNodeInstToCloudLDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Node Instance to a cloud Logical Device"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51955, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51904, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51903, PropCategory.REGULAR)
