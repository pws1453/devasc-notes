...
class DevCfgInst(Mo):
    """
    GraphInst contains a copy of the per logical device shared configuration.

    """

    meta = ClassMeta("cobra.model.vns.DevCfgInst")

    meta.moClassName = "vnsDevCfgInst"
    meta.rnFormat = "devCfgInst"
    ...
    meta.childClasses.add("cobra.model.vns.RsGraphInstToLDevCtx")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsGraphInstToLDevCtx", "rsGraphInstToLDevCtx"))
    ...
    meta.superClasses.add("cobra.model.vns.CfgDef")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14867, PropCategory.REGULAR)
