...
class EpInst(Mo):
    """
    The endpoint that shares the IP and segment of the node instance.

    """

    meta = ClassMeta("cobra.model.vns.EpInst")

    meta.moClassName = "vnsEpInst"
    meta.rnFormat = "ep-[%(epDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "End Points that Shares the Ip and Segment"
    ...
    meta.parentClasses.add("cobra.model.vns.NatInst")
    ...
    prop = PropMeta("str", "epDn", "epDn", 5223, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
