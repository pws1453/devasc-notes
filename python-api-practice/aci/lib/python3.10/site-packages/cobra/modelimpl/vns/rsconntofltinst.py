...
# ##################################################
class RsConnToFltInst(Mo):
    """
    A source relation to a filter. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnToFltInst", "cobra.model.vz.AFilterable")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnToFltInst"
    meta.rnFormat = "rsConnToFltInst"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Connector Instance to a White List Filter"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14877, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13635, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13634, PropCategory.REGULAR)
