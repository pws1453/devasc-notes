...
class OutTerm(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.OutTerm")

    meta.moClassName = "vnsOutTerm"
    meta.rnFormat = "outtmnl"
    meta.category = MoCategory.REGULAR
    meta.label = "Out Terminal"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37968, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14815, PropCategory.REGULAR)
