...
class GParam(Mo):
    """
    NodeInst contains a copy of the abstract parameter from the abstract graph.

    """

    meta = ClassMeta("cobra.model.vns.GParam")

    meta.moClassName = "vnsGParam"
    meta.rnFormat = "gParam-%(name)s"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14860, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7339, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
