...
class DevMgr(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.DevMgr")

    meta.moClassName = "vnsDevMgr"
    meta.rnFormat = "devMgr-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Device Manager"
    ...
    meta.childClasses.add("cobra.model.vns.RsDevMgrToMDevMgr")
    meta.childClasses.add("cobra.model.vns.RsDevEpg")
    meta.childClasses.add("cobra.model.vns.CMgmts")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vns.RsDevMgrEpg")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.vns.RtALDevToDevMgr")
    meta.childClasses.add("cobra.model.vns.CCred")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsDevMgrToMDevMgr", "rsdevMgrToMDevMgr"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtALDevToDevMgr", "rtaLDevToDevMgr-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsDevMgrEpg", "rsdevMgrEpg"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38205, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 22590, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 22591, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40344, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mgmtType", "mgmtType", 18348, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18403, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 18347, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
