...
# ##################################################
class RtEPpInfoAtt(Mo):
    """
    A target relation to endpoint profile information. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtEPpInfoAtt", "cobra.model.vns.EPgDef")

    meta.moClassName = "vnsRtEPpInfoAtt"
    meta.rnFormat = "rtePpInfoAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "EPgDef"
    meta.writeAccessMask = 0x6000000000000001
    meta.readAccessMask = 0x600071040106f713
    ...
    prop = PropMeta("str", "tCl", "tCl", 13618, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13617, PropCategory.REGULAR)
