...
class RtMDev(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtMDev", "cobra.model.vns.SvcRelnHolder")

    meta.moClassName = "vnsRtMDev"
    meta.rnFormat = "rtmDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19080, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19079, PropCategory.REGULAR)
