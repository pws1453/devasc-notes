...
# ##################################################
class RsLDevOperInfoToALDev(Mo):
    """
    A source relation to the logical device. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLDevOperInfoToALDev", "cobra.model.vns.ALDev")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsLDevOperInfoToALDev"
    meta.rnFormat = "rsLDevOperInfoToALDev"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13715, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13714, PropCategory.REGULAR)
