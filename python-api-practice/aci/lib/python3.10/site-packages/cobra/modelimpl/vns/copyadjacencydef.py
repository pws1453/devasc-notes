...
# ##################################################
class CopyAdjacencyDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.CopyAdjacencyDef")

    meta.moClassName = "vnsCopyAdjacencyDef"
    meta.rnFormat = "bd-[%(bdDn)s]-node-%(nodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Destination of copy traffic"
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 23281, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 23283, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "direction", "direction", 23284, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 23280, PropCategory.REGULAR)
    prop.label = "Node ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "seg", "seg", 23282, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    def __init__(self, parentMoOrDn, bdDn, nodeId, markDirty=True, **creationProps):
        namingVals = [bdDn, nodeId]
