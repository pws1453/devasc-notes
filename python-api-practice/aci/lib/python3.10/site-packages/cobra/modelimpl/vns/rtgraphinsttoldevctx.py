...
class RtGraphInstToLDevCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtGraphInstToLDevCtx", "cobra.model.vns.DevCfgInst")

    meta.moClassName = "vnsRtGraphInstToLDevCtx"
    meta.rnFormat = "rtGraphInstToLDevCtx"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Per LDev Shared Cfg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13604, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4799
    prop.defaultValueStr = "vnsDevCfgInst"
