...
# ##################################################
class RtProfToMFunc(Mo):
    """
    A target relation to the metadata for a single function on a device.  Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtProfToMFunc", "cobra.model.vns.AbsFuncProf")

    meta.moClassName = "vnsRtProfToMFunc"
    meta.rnFormat = "rtprofToMFunc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13516, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13515, PropCategory.REGULAR)
