...
# ##################################################
class RsCDevToCtrlrP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsCDevToCtrlrP", "cobra.model.vmm.CtrlrP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCDevToCtrlrP"
    meta.rnFormat = "rscDevToCtrlrP"
    ...
    meta.rnPrefixes = [
        ('rscDevToCtrlrP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38242, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40381, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20448, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20445, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20444, PropCategory.REGULAR)
