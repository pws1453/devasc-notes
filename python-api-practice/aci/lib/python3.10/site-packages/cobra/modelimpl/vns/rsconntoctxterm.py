...
# ##################################################
class RsConnToCtxTerm(Mo):
    """
    A source relation to a terminal. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnToCtxTerm", "cobra.model.vns.ATerm")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnToCtxTerm"
    meta.rnFormat = "rsConnToCtxTerm"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Function Connector to Terminal Node"
    ...
    meta.rnPrefixes = [
        ('rsConnToCtxTerm', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37975, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40114, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14825, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13541, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13540, PropCategory.REGULAR)
