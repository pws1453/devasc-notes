...
class HealthDest(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.HealthDest")

    meta.moClassName = "vnsHealthDest"
    meta.rnFormat = "health_dest-[%(ip)s]-ctxDn-[%(ctxDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Health Destination"
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 42629, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxSeg", "ctxSeg", 42630, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ip", "ip", 42627, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ip2", "ip2", 42628, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42632, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, ip, ctxDn, markDirty=True, **creationProps):
        namingVals = [ip, ctxDn]
