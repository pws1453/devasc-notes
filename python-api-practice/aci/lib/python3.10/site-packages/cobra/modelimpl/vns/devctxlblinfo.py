...
# ##################################################
class DevCtxLblInfo(Mo):
    """
    An implicitly created object for storing configuration information to concrete device association.

    """

    meta = ClassMeta("cobra.model.vns.DevCtxLblInfo")

    meta.moClassName = "vnsDevCtxLblInfo"
    meta.rnFormat = "DevCtxLblInfo-%(devCtxLbl)s"
    ...
    prop = PropMeta("str", "cDevDn", "cDevDn", 5119, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "devCtxLbl", "devCtxLbl", 5120, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.namingProps.append(getattr(meta.props, "devCtxLbl"))
    ...
    def __init__(self, parentMoOrDn, devCtxLbl, markDirty=True, **creationProps):
        namingVals = [devCtxLbl]
