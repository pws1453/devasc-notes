...
# ##################################################
class CopyConnector(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.CopyConnector")

    meta.moClassName = "vnsCopyConnector"
    meta.rnFormat = "copyconnector"
    meta.category = MoCategory.REGULAR
    meta.label = "Copy Connector"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38406, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40545, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23294, PropCategory.REGULAR)
