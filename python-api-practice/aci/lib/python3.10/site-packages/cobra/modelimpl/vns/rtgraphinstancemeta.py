...
# ##################################################
class RtGraphInstanceMeta(Mo):
    """
    A target relation to an abstract graph is made of up of abstract nodes. Abstract nodes are comprised of service nodes, such as a service node balancer (SLB) or firewall (FW), abstract term nodes (the nodes that are connected to EPGs), and connections. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtGraphInstanceMeta", "cobra.model.vns.GraphInst")

    meta.moClassName = "vnsRtGraphInstanceMeta"
    meta.rnFormat = "rtgraphInstanceMeta-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13583, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4771
    prop.defaultValueStr = "vnsGraphInst"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsGraphInst", None, 4771)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13582, PropCategory.REGULAR)
