...
# ##################################################
class MscGraphXlateCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.MscGraphXlateCont")

    meta.moClassName = "vnsMscGraphXlateCont"
    meta.rnFormat = "mscGraphXlateCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Msc graph internal EPgs pc tag translation container"
    ...
    meta.childClasses.add("cobra.model.vns.EpgDefXlate")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EpgDefXlate", "epgDefXlate-"))
    ...
    meta.rnPrefixes = [
        ('mscGraphXlateCont', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38850, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40989, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37263, PropCategory.REGULAR)
