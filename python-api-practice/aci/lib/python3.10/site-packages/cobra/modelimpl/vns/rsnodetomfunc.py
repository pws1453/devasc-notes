...
# ##################################################
class RsNodeToMFunc(Mo):
    """
    A source relation to the metadata for a single function on a device. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsNodeToMFunc", "cobra.model.vns.MFunc")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsNodeToMFunc"
    meta.rnFormat = "rsNodeToMFunc"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from an Function Node to Meta Function from the Package"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37954, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40093, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14800, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13507, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4753
    prop.defaultValueStr = "vnsMFunc"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsMFunc", None, 4753)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13506, PropCategory.REGULAR)
