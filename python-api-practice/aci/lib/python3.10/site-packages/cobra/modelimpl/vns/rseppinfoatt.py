...
# ##################################################
class RsEPpInfoAtt(Mo):
    """
    A source relation to an internal object that stores the encap (vlan/vxlan) information of an endpoint.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsEPpInfoAtt", "cobra.model.vns.EPpInfo")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsEPpInfoAtt"
    meta.rnFormat = "rsePpInfoAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13616, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4694
    prop.defaultValueStr = "vnsEPpInfo"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsEPpInfo", None, 4694)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13615, PropCategory.REGULAR)
