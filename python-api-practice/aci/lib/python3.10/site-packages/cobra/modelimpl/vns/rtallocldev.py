...
# ##################################################
class RtAllocLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtAllocLDev", "cobra.model.orchs.SvcAlloc")

    meta.moClassName = "vnsRtAllocLDev"
    meta.rnFormat = "rtorchsAllocLDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28677, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28676, PropCategory.REGULAR)
