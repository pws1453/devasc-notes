...
# ##################################################
class RtAbsFuncProf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtAbsFuncProf", "cobra.model.vns.SvcRelnHolder")

    meta.moClassName = "vnsRtAbsFuncProf"
    meta.rnFormat = "rtabsFuncProf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19865, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19864, PropCategory.REGULAR)
