...
# ##################################################
class EPgSubnetCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.EPgSubnetCont")

    meta.moClassName = "vnsEPgSubnetCont"
    meta.rnFormat = "epgcont-[%(epgDn)s]"
    ...
    meta.parentClasses.add("cobra.model.vns.BDHolder")
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 25946, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
