...
# ##################################################
class RsLDevCtxToRtrCfg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.vns.RsLDevCtxToRtrCfg", "cobra.model.vns.RtrCfg")
    meta.targetNameProps["name"] = "tnVnsRtrCfgName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLDevCtxToRtrCfg"
    meta.rnFormat = "rsLDevCtxToRtrCfg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to RtrCfg"
    ...
    meta.rnPrefixes = [
        ('rsLDevCtxToRtrCfg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38234, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40373, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19875, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 19872, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6648
    prop.defaultValueStr = "vnsRtrCfg"
    ...
    prop = PropMeta("str", "tnVnsRtrCfgName", "tnVnsRtrCfgName", 19871, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVnsRtrCfgName", prop)
