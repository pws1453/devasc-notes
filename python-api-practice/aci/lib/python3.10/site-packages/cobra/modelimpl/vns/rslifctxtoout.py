...
# ##################################################
class RsLIfCtxToOut(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToOut", "cobra.model.l3ext.Out")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToOut"
    meta.rnFormat = "rsLIfCtxToOut"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to l3ext:Out"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38163, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40302, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17848, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18110, PropCategory.REGULAR)
