...
# ##################################################
class RsALDevToDomP(Mo):
    """
    A source relation to the VMM domain profile.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsALDevToDomP", "cobra.model.vmm.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsALDevToDomP"
    meta.rnFormat = "rsALDevToDomP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from L4-L7 Devices to a Vmm Domain"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37996, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40135, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14897, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "switchingMode", "switchingMode", 37153, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13679, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2136
    prop.defaultValueStr = "vmmDomP"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmDomP", None, 2136)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13678, PropCategory.REGULAR)
