...
# ##################################################
class RsNodeToCloudLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsNodeToCloudLDev", "cobra.model.cloud.ALDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsNodeToCloudLDev"
    meta.rnFormat = "rsNodeToCloudLDev"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a AbsNode to an CloudLDev"
    ...
    meta.rnPrefixes = [
        ('rsNodeToCloudLDev', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51973, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51974, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51954, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51900, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15154
    prop.defaultValueStr = "cloudALDev"
    prop._addConstant("cloudALDev", None, 15154)
    prop._addConstant("cloudLB", None, 15157)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51899, PropCategory.REGULAR)
