...
# ##################################################
class RtToLDevForEpgToIp(Mo):
    """
    A target relation to a service device cluster. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToLDevForEpgToIp", "cobra.model.dbgac.EpgToIp")

    meta.moClassName = "vnsRtToLDevForEpgToIp"
    meta.rnFormat = "rtdbgacToLDevForEpgToIp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12895, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4075
    prop.defaultValueStr = "dbgacEpgToIp"
    prop._addConstant("dbgacEpgToIp", None, 4075)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12894, PropCategory.REGULAR)
