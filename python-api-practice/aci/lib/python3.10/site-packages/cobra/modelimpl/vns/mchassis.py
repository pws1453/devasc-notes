...
class MChassis(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.MChassis")

    meta.moClassName = "vnsMChassis"
    meta.rnFormat = "mChassis-%(vendor)s-%(model)s-%(version)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Chassis type"
    meta.writeAccessMask = 0x100000000001
    meta.readAccessMask = 0x4000100000000001
    ...
    meta.childClasses.add("cobra.model.vns.RtMChassis")
    meta.childClasses.add("cobra.model.vns.RsMChassisToMDev")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.vns.RtChassisToMChassis")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtChassisToMChassis", "rtchassisToMChassis-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsMChassisToMDev", "rsmChassisToMDev"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtMChassis", "rtmChassis-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38197, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 22584, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 22585, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40336, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "model", "model", 18341, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vendor", "vendor", 18340, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "version", "version", 18342, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
