...
# ##################################################
class RsScriptHandlerStateToDomainRef(Mo):
    """
    A source relation to a reference of the domain that the parent object belongs.

    """

    meta = NamedSourceRelationMeta("cobra.model.vns.RsScriptHandlerStateToDomainRef", "cobra.model.aaa.DomainRef")
    meta.targetNameProps["name"] = "tnAaaDomainRefName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsScriptHandlerStateToDomainRef"
    meta.rnFormat = "rsScriptHandlerStateToDomainRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from VDev To AAA Domain Ref"
    ...
    meta.rnPrefixes = [
        ('rsScriptHandlerStateToDomainRef', False),
    ]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15730, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15727, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnAaaDomainRefName", "tnAaaDomainRefName", 15726, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
