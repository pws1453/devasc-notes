...
# ##################################################
class RtDefaultScopeToTerm(Mo):
    """
    A target relation to a terminal. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtDefaultScopeToTerm", "cobra.model.vns.AFuncNode")

    meta.moClassName = "vnsRtDefaultScopeToTerm"
    meta.rnFormat = "rtdefaultScopeToTerm"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13501, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4626
    prop.defaultValueStr = "vnsAFuncNode"
