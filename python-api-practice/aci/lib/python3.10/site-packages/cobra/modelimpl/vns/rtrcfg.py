...
class RtrCfg(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.RtrCfg")

    meta.moClassName = "vnsRtrCfg"
    meta.rnFormat = "rtrCfg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Router configuration"
    ...
    meta.childClasses.add("cobra.model.vns.RtLDevCtxToRtrCfg")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtLDevCtxToRtrCfg", "rtLDevCtxToRtrCfg-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38233, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40372, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 19870, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "rtrId", "rtrId", 19866, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
