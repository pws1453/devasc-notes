...
# ##################################################
class CtrlrMgmtPol(Mo):
    """
    The management policy for the controller appliance IP address.

    """

    meta = ClassMeta("cobra.model.vns.CtrlrMgmtPol")

    meta.moClassName = "vnsCtrlrMgmtPol"
    meta.rnFormat = "mgmtPolicy-[%(ctxDn)s]"
    ...
    meta.childClasses.add("cobra.model.vns.RsMgmtAddr")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vns.RsClusterPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsClusterPol", "rsClusterPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsMgmtAddr", "rsmgmtAddr"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38012, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 15589, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ok"
    prop._addConstant("arp-flood-enabled", "arp-flood-is-enabled-on-the-management-end-point-group", 4)
    prop._addConstant("invalid-ctx", "ctx-dn-mismatch", 1)
    prop._addConstant("missing-ctx", "ctx-does-not-exist", 2)
    prop._addConstant("ok", "ok", 0)
    meta.props.add("configIssues", prop)

    prop = PropMeta("str", "configured", "configured", 15590, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 15588, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40151, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14919, PropCategory.REGULAR)
