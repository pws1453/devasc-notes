...
# ##################################################
class RsChassisEpg(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsChassisEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsChassisEpg"
    meta.rnFormat = "rschassisEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Device Cluster to an EPG"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38203, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdmac", "bdmac", 18371, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "bdseg", "bdseg", 18372, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40342, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "seg", "seg", 18373, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 18375, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18374, PropCategory.REGULAR)
