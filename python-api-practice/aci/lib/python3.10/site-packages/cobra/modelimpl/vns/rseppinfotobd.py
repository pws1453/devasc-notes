...
# ##################################################
class RsEPpInfoToBD(Mo):
    """
    A source relation to the abstract representation of a bridge domain policy.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsEPpInfoToBD", "cobra.model.fv.ABDPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsEPpInfoToBD"
    meta.rnFormat = "rsEPpInfoToBD"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16116, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16115, PropCategory.REGULAR)
