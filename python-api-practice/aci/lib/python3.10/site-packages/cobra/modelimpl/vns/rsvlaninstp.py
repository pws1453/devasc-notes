...
# ##################################################
class RsVlanInstP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsVlanInstP", "cobra.model.fvns.VlanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsVlanInstP"
    meta.rnFormat = "rsvlanInstP-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.vns.SvcRelnCons")
    meta.childClasses.add("cobra.model.vns.EncapBlkDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SvcRelnCons", "svcRelnConsumer-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EncapBlkDef", "from-"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 21543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21542, PropCategory.REGULAR)
