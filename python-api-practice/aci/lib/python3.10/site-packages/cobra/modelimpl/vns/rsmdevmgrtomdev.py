...
# ##################################################
class RsMDevMgrToMDev(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsMDevMgrToMDev", "cobra.model.vns.MDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsMDevMgrToMDev"
    meta.rnFormat = "rsmDevMgrToMDev"
    ...
    meta.rnPrefixes = [
        ('rsmDevMgrToMDev', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38200, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40339, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18398, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18368, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18367, PropCategory.REGULAR)
