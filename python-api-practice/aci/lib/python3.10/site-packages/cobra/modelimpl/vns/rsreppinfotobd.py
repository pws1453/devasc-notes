...
# ##################################################
class RsREPpInfoToBD(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsREPpInfoToBD", "cobra.model.fv.ABDPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsREPpInfoToBD"
    meta.rnFormat = "rsREPpInfoToBD"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43559, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43558, PropCategory.REGULAR)
