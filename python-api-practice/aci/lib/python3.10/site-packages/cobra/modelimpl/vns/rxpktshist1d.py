...
# ##################################################
class RxPktsHist1d(Mo):
    """
    A class that represents historical statistics for  Rx  Packet counters in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPktsHist1d", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist1d"
    meta.rnFormat = "HDvnsRxPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 7375, PropCategory.REGULAR)
