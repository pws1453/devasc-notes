...
# ##################################################
class RtToFuncProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToFuncProfile", "cobra.model.orchs.FuncProfileCont")

    meta.moClassName = "vnsRtToFuncProfile"
    meta.rnFormat = "rtorchsToFuncProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34632, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11078
    prop.defaultValueStr = "orchsFuncProfileCont"
    prop._addConstant("orchsFuncProfileCont", None, 11078)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34631, PropCategory.REGULAR)
