...
# ##################################################
class RsBDDefToConn(Mo):
    """
    A source relation to a connector. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsBDDefToConn", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsBDDefToConn"
    meta.rnFormat = "rsBDDefToConn"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13624, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13623, PropCategory.REGULAR)
