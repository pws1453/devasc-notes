...
# ##################################################
class RsLIfCtxToCustQosPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.vns.RsLIfCtxToCustQosPol", "cobra.model.qos.CustomPol")
    meta.targetNameProps["name"] = "tnQosCustomPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToCustQosPol"
    meta.rnFormat = "rsLIfCtxToCustQosPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to QosPolicy"
    ...
    meta.rnPrefixes = [
        ('rsLIfCtxToCustQosPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 42499, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42500, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42498, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 42495, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosCustomPolName", "tnQosCustomPolName", 42494, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
