...
class Chassis(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.Chassis")

    meta.moClassName = "vnsChassis"
    meta.rnFormat = "chassis-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.RtVnschassis")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.vns.CCredSecret")
    meta.childClasses.add("cobra.model.vns.RsChassisToMChassis")
    meta.childClasses.add("cobra.model.vns.RsDevEpg")
    meta.childClasses.add("cobra.model.vns.CMgmts")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vns.ConfIssue")
    meta.childClasses.add("cobra.model.vns.RtCDevToChassis")
    meta.childClasses.add("cobra.model.vns.CCred")
    meta.childClasses.add("cobra.model.vns.RsChassisEpg")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsChassisToMChassis", "rschassisToMChassis"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtVnschassis", "rtpolVnschassis-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtCDevToChassis", "rtcDevToChassis-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsChassisEpg", "rschassisEpg"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CMgmts", "cMgmts-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38202, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 22588, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 22589, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40341, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mgmtType", "mgmtType", 18346, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18400, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 18351, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
