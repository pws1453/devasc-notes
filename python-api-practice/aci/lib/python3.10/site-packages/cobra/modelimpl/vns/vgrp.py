...
class VGrp(Mo):
    """
    A grouping of virtual functions in a single graph allows virtual functions on a service device to be combined without traffic egressing from the device.

    """

    meta = ClassMeta("cobra.model.vns.VGrp")

    meta.moClassName = "vnsVGrp"
    meta.rnFormat = "vGrp-[%(priKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Function Group"
    ...
    prop = PropMeta("str", "id", "id", 5192, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("id", prop)

    prop = PropMeta("str", "key", "key", 5193, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14909, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "priKey", "priKey", 5191, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
