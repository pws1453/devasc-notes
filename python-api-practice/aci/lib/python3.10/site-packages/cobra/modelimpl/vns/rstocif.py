...
class RsToCIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsToCIf", "cobra.model.vns.CIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsToCIf"
    meta.rnFormat = "rstoCIf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 45716, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45717, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45713, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 45711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45710, PropCategory.REGULAR)
