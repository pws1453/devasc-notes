...
class RsFunction(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsFunction", "cobra.model.vns.MFunc")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsFunction"
    meta.rnFormat = "rsfunction"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L4-L7 Service Function"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13722, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13721, PropCategory.REGULAR)
