...
# ##################################################
class RtToLDevForEpToExt(Mo):
    """
    A target relation to a service device cluster. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToLDevForEpToExt", "cobra.model.dbgac.EpToExt")

    meta.moClassName = "vnsRtToLDevForEpToExt"
    meta.rnFormat = "rtdbgacToLDevForEpToExt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12946, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4098
    prop.defaultValueStr = "dbgacEpToExt"
    prop._addConstant("dbgacEpToExt", None, 4098)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12945, PropCategory.REGULAR)
