...
# ##################################################
class RxPktsHist(Mo):
    meta = StatsClassMeta("cobra.model.vns.RxPktsHist", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist"


    meta.moClassName = "vnsRxPktsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats"
    ...
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist5min")
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist1w")
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist15min")
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist1d")
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist1year")
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist1h")
    meta.concreteSubClasses.add("cobra.model.vns.RxPktsHist1mo")
    ...
    prop = PropMeta("str", "rxdropsAvg", "rxdropsAvg", 11036, PropCategory.IMPLICIT_AVG)
    prop.label = "Rx Dropped average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsAvg", prop)

    prop = PropMeta("str", "rxdropsCum", "rxdropsCum", 11032, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Rx Dropped cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsCum", prop)

    prop = PropMeta("str", "rxdropsMax", "rxdropsMax", 11035, PropCategory.IMPLICIT_MAX)
    prop.label = "Rx Dropped maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsMax", prop)

    prop = PropMeta("str", "rxdropsMin", "rxdropsMin", 11034, PropCategory.IMPLICIT_MIN)
    prop.label = "Rx Dropped minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsMin", prop)

    prop = PropMeta("str", "rxdropsPer", "rxdropsPer", 11033, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Rx Dropped periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsPer", prop)

    prop = PropMeta("str", "rxdropsRate", "rxdropsRate", 11040, PropCategory.IMPLICIT_RATE)
    prop.label = "Rx Dropped rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsRate", prop)

    prop = PropMeta("str", "rxdropsSpct", "rxdropsSpct", 11037, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Rx Dropped suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsSpct", prop)

    prop = PropMeta("str", "rxdropsThr", "rxdropsThr", 11038, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxdropsTr", "rxdropsTr", 11039, PropCategory.IMPLICIT_TREND)
    prop.label = "Rx Dropped trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxdropsTr", prop)

    prop = PropMeta("str", "rxerrorsAvg", "rxerrorsAvg", 11063, PropCategory.IMPLICIT_AVG)
    prop.label = "Rx Errors average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsAvg", prop)

    prop = PropMeta("str", "rxerrorsCum", "rxerrorsCum", 11059, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Rx Errors cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsCum", prop)

    prop = PropMeta("str", "rxerrorsMax", "rxerrorsMax", 11062, PropCategory.IMPLICIT_MAX)
    prop.label = "Rx Errors maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsMax", prop)

    prop = PropMeta("str", "rxerrorsMin", "rxerrorsMin", 11061, PropCategory.IMPLICIT_MIN)
    prop.label = "Rx Errors minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsMin", prop)

    prop = PropMeta("str", "rxerrorsPer", "rxerrorsPer", 11060, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Rx Errors periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsPer", prop)

    prop = PropMeta("str", "rxerrorsRate", "rxerrorsRate", 11067, PropCategory.IMPLICIT_RATE)
    prop.label = "Rx Errors rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsRate", prop)

    prop = PropMeta("str", "rxerrorsSpct", "rxerrorsSpct", 11064, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Rx Errors suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsSpct", prop)

    prop = PropMeta("str", "rxerrorsThr", "rxerrorsThr", 11065, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxerrorsTr", "rxerrorsTr", 11066, PropCategory.IMPLICIT_TREND)
    prop.label = "Rx Errors trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxerrorsTr", prop)

    prop = PropMeta("str", "rxpacketsAvg", "rxpacketsAvg", 11090, PropCategory.IMPLICIT_AVG)
    prop.label = "Rx average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxpacketsAvg", prop)

    prop = PropMeta("str", "rxpacketsCum", "rxpacketsCum", 11086, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Rx cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxpacketsCum", prop)

    prop = PropMeta("str", "rxpacketsMax", "rxpacketsMax", 11089, PropCategory.IMPLICIT_MAX)
    prop.label = "Rx maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxpacketsMax", prop)

    prop = PropMeta("str", "rxpacketsMin", "rxpacketsMin", 11088, PropCategory.IMPLICIT_MIN)
    prop.label = "Rx minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxpacketsMin", prop)

    prop = PropMeta("str", "rxpacketsPer", "rxpacketsPer", 11087, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Rx periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxpacketsPer", prop)

    prop = PropMeta("str", "rxpacketsRate", "rxpacketsRate", 11094, PropCategory.IMPLICIT_RATE)
    prop.label = "Rx rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxpacketsRate", prop)

    prop = PropMeta("str", "rxpacketsSpct", "rxpacketsSpct", 11091, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Rx suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxpacketsSpct", prop)

    prop = PropMeta("str", "rxpacketsThr", "rxpacketsThr", 11092, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxpacketsTr", "rxpacketsTr", 11093, PropCategory.IMPLICIT_TREND)
    prop.label = "Rx trend"
    prop.isOper = True
    prop.isStats = True
