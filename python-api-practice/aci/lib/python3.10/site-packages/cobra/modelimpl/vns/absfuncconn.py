...
# ##################################################
class AbsFuncConn(Mo):
    """
    An abstract function node connector is used to map a service graph interface with the device interface.

    """

    meta = ClassMeta("cobra.model.vns.AbsFuncConn")

    meta.moClassName = "vnsAbsFuncConn"
    meta.rnFormat = "AbsFConn-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.RsMConnAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsMConnAtt", "rsMConnAtt"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37976, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40115, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14827, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7304, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
