...
class CMgmts(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.CMgmts")

    meta.moClassName = "vnsCMgmts"
    meta.rnFormat = "cMgmts-[%(host)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38263, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40402, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "host", "host", 20983, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mappedHost", "mappedHost", 22490, PropCategory.REGULAR)
    prop.label = "IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "port", "port", 22489, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    getattr(meta.props, "host").needDelimiter = True
