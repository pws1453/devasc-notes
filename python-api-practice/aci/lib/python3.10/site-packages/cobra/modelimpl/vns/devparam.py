...
class DevParam(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.DevParam")

    meta.moClassName = "vnsDevParam"
    meta.rnFormat = "devParam-%(name)s-key-%(key)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Device Configuration"
    ...
    meta.superClasses.add("cobra.model.vns.DevItem")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38016, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5230, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5231, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40155, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "key", "key", 7332, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14924, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7331, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 5232, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    def __init__(self, parentMoOrDn, name, key, markDirty=True, **creationProps):
        namingVals = [name, key]
