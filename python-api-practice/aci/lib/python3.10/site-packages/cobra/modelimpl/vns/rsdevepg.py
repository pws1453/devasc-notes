...
class RsDevEpg(Mo):
    """
    A source relation for storing management endpoint group related information. This object indicates that the device belongs to the management endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsDevEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsDevEpg"
    meta.rnFormat = "rsdevEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a L4-L7 Devices to an EPG"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdmac", "bdmac", 15629, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "bdseg", "bdseg", 15630, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40138, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14900, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "seg", "seg", 13696, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 13695, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13694, PropCategory.REGULAR)
