...
# ##################################################
class RtEPgDefToLIf(Mo):
    """
    A target relation to the logical interface associated with a set of concrete interfaces from the L4-L7 device cluster. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtEPgDefToLIf", "cobra.model.vns.EPgDef")

    meta.moClassName = "vnsRtEPgDefToLIf"
    meta.rnFormat = "rtEPgDefToLIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13614, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4812
    prop.defaultValueStr = "vnsEPgDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsEPgDef", None, 4812)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13613, PropCategory.REGULAR)
