...
class SDEPpInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.SDEPpInfo")

    meta.moClassName = "vnsSDEPpInfo"
    meta.rnFormat = "ldev-[%(priKey)s]-ctx-[%(ctxDn)s]-bd-[%(bdDn)s]"
    ...
    meta.childClasses.add("cobra.model.vns.RtSEPpInfoAtt")
    ...
    meta.childClasses.add("cobra.model.vns.Cons")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtSEPpInfoAtt", "rtSEPpInfoAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.Cons", "cons-"))
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 17748, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "confIssues", "confIssues", 17749, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("encap", "encap", 1)
    prop._addConstant("fabencap", "fabencap", 2)
    prop._addConstant("pctag", "pctag", 4)
    meta.props.add("confIssues", prop)
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 17747, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "encap", "encap", 21046, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "fabEncap", "fabEncap", 21047, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17776, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "priKey", "priKey", 17746, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, priKey, ctxDn, bdDn, markDirty=True, **creationProps):
        namingVals = [priKey, ctxDn, bdDn]
