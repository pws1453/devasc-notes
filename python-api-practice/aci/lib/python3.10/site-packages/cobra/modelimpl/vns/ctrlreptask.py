...
# ##################################################
class CtrlrEpTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.CtrlrEpTask")

    meta.moClassName = "vnsCtrlrEpTask"
    meta.rnFormat = "vnsCtrlrEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16516, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("NatCreate", "natcreate", 1455)
    prop._addConstant("none", "none", 0)
    prop._addConstant("updateVTap", "updatevtap", 2766)
