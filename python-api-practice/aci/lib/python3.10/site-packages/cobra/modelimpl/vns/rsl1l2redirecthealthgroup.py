...
# ##################################################
class RsL1L2RedirectHealthGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsL1L2RedirectHealthGroup", "cobra.model.vns.RedirectHealthGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsL1L2RedirectHealthGroup"
    meta.rnFormat = "rsL1L2RedirectHealthGroup"
    ...
    meta.rnPrefixes = [
        ('rsL1L2RedirectHealthGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 42532, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42533, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42529, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 42525, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10954
    prop.defaultValueStr = "vnsRedirectHealthGroup"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsRedirectHealthGroup", None, 10954)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 42524, PropCategory.REGULAR)
