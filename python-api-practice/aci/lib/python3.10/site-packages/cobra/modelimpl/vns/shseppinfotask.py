...
# ##################################################
class SHSEPpInfoTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.SHSEPpInfoTask")

    meta.moClassName = "vnsSHSEPpInfoTask"
    meta.rnFormat = "vnsSHSEPpInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 18479, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpPDUpdSHS", "eppdupdshs", 1667)
