...
class Prefix(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.Prefix")

    meta.moClassName = "vnsPrefix"
    meta.rnFormat = "prefix-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Routing Prefix representation"
    ...
    meta.parentClasses.add("cobra.model.vns.VOspfNetworks")
    meta.parentClasses.add("cobra.model.vns.VBgpNetworks")
    ...
    prop = PropMeta("str", "ip", "ip", 17833, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
