...
class RtVnsldevctx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtVnsldevctx", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "vnsRtVnsldevctx"
    meta.rnFormat = "rtpolVnsldevctx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13484, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13483, PropCategory.REGULAR)
