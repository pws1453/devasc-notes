...
# ##################################################
class Assertion(Mo):
    meta = ClassMeta("cobra.model.vns.Assertion")

    meta.isAbstract = True
    meta.moClassName = "vnsAssertion"


    meta.moClassName = "vnsAssertion"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Assertion"
    ...
    meta.concreteSubClasses.add("cobra.model.vns.Range")
    meta.concreteSubClasses.add("cobra.model.vns.Composite")
    meta.concreteSubClasses.add("cobra.model.vns.Comparison")
    ...
    prop = PropMeta("str", "name", "name", 5084, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
