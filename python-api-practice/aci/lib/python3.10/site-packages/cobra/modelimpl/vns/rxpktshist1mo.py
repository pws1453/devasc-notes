...
# ##################################################
class RxPktsHist1mo(Mo):
    """
    A class that represents historical statistics for  Rx  Packet counters in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPktsHist1mo", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist1mo"
    meta.rnFormat = "HDvnsRxPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 7377, PropCategory.REGULAR)
