...
class SHEPpInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.SHEPpInfo")

    meta.moClassName = "vnsSHEPpInfo"
    meta.rnFormat = "epgDn-[%(shEpgDn)s]"
    ...
    meta.childClasses.add("cobra.model.vns.EPgDefCons")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.EPgDefCons", "epgdefcons-"))
    ...
    prop = PropMeta("str", "encap", "encap", 21050, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "encapSt", "encapSt", 18670, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("none", "none", 0)
    prop._addConstant("validating", "validating", 1)
    prop._addConstant("validation-failed", "validation-failed", 3)
    meta.props.add("encapSt", prop)

    prop = PropMeta("str", "epgName", "epgName", 18215, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "fabEncap", "fabEncap", 21051, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18226, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "outName", "outName", 18214, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("outName", prop)
    ...
    prop = PropMeta("str", "shEpgDn", "shEpgDn", 18216, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("shEpgDn", prop)
    ...
    prop = PropMeta("str", "vlanNsDn", "vlanNsDn", 18671, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("vlanNsDn", prop)

    meta.namingProps.append(getattr(meta.props, "shEpgDn"))
    getattr(meta.props, "shEpgDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, shEpgDn, markDirty=True, **creationProps):
        namingVals = [shEpgDn]
