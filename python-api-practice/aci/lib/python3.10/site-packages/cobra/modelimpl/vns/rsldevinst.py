...
class RsLDevInst(Mo):
    """
    A source relation to a logical device instance that holds reusable encap information across service graphs.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLDevInst", "cobra.model.vns.LDevInst")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsLDevInst"
    meta.rnFormat = "rsLDevInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15516, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13585, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4786
    prop.defaultValueStr = "vnsLDevInst"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsLDevInst", None, 4786)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13584, PropCategory.REGULAR)
