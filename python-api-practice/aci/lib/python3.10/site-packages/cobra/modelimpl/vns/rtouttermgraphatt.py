...
# ##################################################
class RtOutTermGraphAtt(Mo):
    """
    A target relation to an input terminal node. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtOutTermGraphAtt", "cobra.model.vz.OutTerm")

    meta.moClassName = "vnsRtOutTermGraphAtt"
    meta.rnFormat = "rtvzOutTermGraphAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11855, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1334
    prop.defaultValueStr = "vzOutTerm"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzOutTerm", None, 1334)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11854, PropCategory.REGULAR)
