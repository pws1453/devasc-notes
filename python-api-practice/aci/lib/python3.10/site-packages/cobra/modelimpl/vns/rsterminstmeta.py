...
# ##################################################
class RsTermInstMeta(Mo):
    """
    A source relation to an abstract terminal node. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsTermInstMeta", "cobra.model.vns.AbsTermNode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsTermInstMeta"
    meta.rnFormat = "rsTermInstMeta"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13606, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4658
    prop.defaultValueStr = "vnsAbsTermNode"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13605, PropCategory.REGULAR)
