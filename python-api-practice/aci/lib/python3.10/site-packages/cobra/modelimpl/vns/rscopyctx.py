...
class RsCopyCtx(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsCopyCtx", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCopyCtx"
    meta.rnFormat = "rscopyCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to global copy ctx"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23290, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23289, PropCategory.REGULAR)
