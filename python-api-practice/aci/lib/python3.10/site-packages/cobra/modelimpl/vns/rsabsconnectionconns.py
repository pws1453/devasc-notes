...
# ##################################################
class RsAbsConnectionConns(Mo):
    """
    A source relation to a connector. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsAbsConnectionConns", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "vnsRsAbsConnectionConns"
    meta.rnFormat = "rsabsConnectionConns-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Service Graph Connection to Service Graph Connectors"
    ...
    meta.rnPrefixes = [
        ('rsabsConnectionConns-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37979, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40118, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14830, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13557, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13556, PropCategory.REGULAR)
