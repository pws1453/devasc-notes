...
# ##################################################
class RsGraphInstanceMeta(Mo):
    """
    A source relation to an abstract graph. A graph instance is related to a meta graph.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsGraphInstanceMeta", "cobra.model.vns.AbsGraph")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsGraphInstanceMeta"
    meta.rnFormat = "rsGraphInstanceMeta"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13581, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13580, PropCategory.REGULAR)
