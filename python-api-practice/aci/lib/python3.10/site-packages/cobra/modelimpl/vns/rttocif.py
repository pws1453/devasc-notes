...
class RtToCIf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtToCIf", "cobra.model.vns.L1L2RedirectDest")

    meta.moClassName = "vnsRtToCIf"
    meta.rnFormat = "rttoCIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45712, PropCategory.REGULAR)
