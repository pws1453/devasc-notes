...
class AbsFolder(Mo):
    """
    A folder added to an abstract graph. An abstract graph folder can contain an abstract graph folder (AbsFolder) and abstract node parameters (AbsParam), which are analogous to an MFolder and MParam. An abstract graph folder can be contained under abstract device configuration (AbsDevCfg), abstract group configuration (AbsGrpCfg), or abstract function configuration (AbsFuncCfg).

    """

    meta = ClassMeta("cobra.model.vns.AbsFolder")

    meta.moClassName = "vnsAbsFolder"
    meta.rnFormat = "absFolder-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Folder"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37958, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "auxInfo", "auxInfo", 36961, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("auxInfo", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40097, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14804, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7303, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nameRule", "nameRule", 35658, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("nameRule", prop)

    prop = PropMeta("str", "profileBehaviorShared", "profileBehaviorShared", 20614, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("profileBehaviorShared", prop)
    ...
    prop = PropMeta("str", "srcRef", "srcRef", 35421, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("srcRef", prop)
