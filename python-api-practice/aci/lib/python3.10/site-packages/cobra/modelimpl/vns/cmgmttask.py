...
class CMgmtTask(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.CMgmtTask")

    meta.moClassName = "vnsCMgmtTask"
    meta.rnFormat = "vnsCMgmtTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16515, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("NatCreate", "natcreate", 1456)
