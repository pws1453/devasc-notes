...
# ##################################################
class RxPktsHist5min(Mo):
    """
    A class that represents historical statistics for  Rx  Packet counters in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPktsHist5min", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist5min"
    meta.rnFormat = "HDvnsRxPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 7381, PropCategory.REGULAR)
