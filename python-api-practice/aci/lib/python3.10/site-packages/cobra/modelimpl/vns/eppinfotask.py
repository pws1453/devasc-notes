...
# ##################################################
class EPpInfoTask(Mo):
    """
    An internal object to rack a task on the container that holds endpoint profile objects.

    """

    meta = ClassMeta("cobra.model.vns.EPpInfoTask")

    meta.moClassName = "vnsEPpInfoTask"
    meta.rnFormat = "vnsEPpInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5731, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EPpInfo", "eppinfo", 837)
    prop._addConstant("EpPDUpd", "eppdupd", 1331)
    prop._addConstant("UpdateRoutes", "updateroutes", 2255)
