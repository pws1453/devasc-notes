...
# ##################################################
class RxPktsHist1year(Mo):
    """
    A class that represents historical statistics for  Rx  Packet counters in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPktsHist1year", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist1year"
    meta.rnFormat = "HDvnsRxPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 7380, PropCategory.REGULAR)
