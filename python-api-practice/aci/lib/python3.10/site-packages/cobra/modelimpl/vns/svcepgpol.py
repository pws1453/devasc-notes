...
class SvcEPgPol(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.SvcEPgPol")

    meta.moClassName = "vnsSvcEPgPol"
    meta.rnFormat = "svcEPgPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Service EPg Policy"
    ...
    meta.childClasses.add("cobra.model.vns.RtLIfCtxToSvcEPgPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtLIfCtxToSvcEPgPol", "rtLIfCtxToSvcEPgPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 44821, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44822, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44818, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 44812, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prefGrMemb", "prefGrMemb", 44811, PropCategory.REGULAR)
