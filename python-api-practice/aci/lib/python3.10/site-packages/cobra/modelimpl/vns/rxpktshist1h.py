...
# ##################################################
class RxPktsHist1h(Mo):
    """
    A class that represents historical statistics for  Rx  Packet counters in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPktsHist1h", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPktsHist1h"
    meta.rnFormat = "HDvnsRxPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Rx Packet counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 7376, PropCategory.REGULAR)
