...
class VGrpPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.VGrpPTask")

    meta.moClassName = "vnsVGrpPTask"
    meta.rnFormat = "vnsVGrpPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 27028, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReTrigVDevUpd", "retrigvdevupd", 2422)
