...
# ##################################################
class RtLIfCtxToLIf(Mo):
    """
    A target relation to the logical interface of a device cluster.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLIfCtxToLIf", "cobra.model.vns.LIfCtx")

    meta.moClassName = "vnsRtLIfCtxToLIf"
    meta.rnFormat = "rtLIfCtxToLIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13531, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13530, PropCategory.REGULAR)
