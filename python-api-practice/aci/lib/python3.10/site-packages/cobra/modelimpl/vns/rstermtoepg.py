...
# ##################################################
class RsTermToEPg(Mo):
    """
    A source relation to a set of endpoints. Note that this relation is an internal object

    """

    meta = SourceRelationMeta("cobra.model.vns.RsTermToEPg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsTermToEPg"
    meta.rnFormat = "rstermToEPg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Terminal Node to an EPG"
    ...
    meta.childClasses.add("cobra.model.vns.FltInst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.FltInst", "fltInst-"))
    ...
    prop = PropMeta("str", "EPgPcTag", "EPgPcTag", 13523, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("any", "any", 0)
    meta.props.add("EPgPcTag", prop)

    prop = PropMeta("str", "bDDefDn", "bDDefDn", 13524, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "deployed", "deployed", 30290, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ePgDn", "ePgDn", 13525, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14813, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13522, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "txId", "txId", 34332, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
