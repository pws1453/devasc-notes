...
# ##################################################
class NodeInstCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.NodeInstCons")

    meta.moClassName = "vnsNodeInstCons"
    meta.rnFormat = "NodeInstCons-[%(consDn)s]"
    ...
    meta.parentClasses.add("cobra.model.vns.NodeInstIdCntnr")
    ...
    prop = PropMeta("str", "consDn", "consDn", 20398, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
