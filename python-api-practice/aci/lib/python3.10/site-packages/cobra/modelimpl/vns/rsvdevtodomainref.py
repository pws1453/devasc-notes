...
# ##################################################
class RsVDevToDomainRef(Mo):
    """
    A source relation to the AAA domain reference.

    """

    meta = NamedSourceRelationMeta("cobra.model.vns.RsVDevToDomainRef", "cobra.model.aaa.DomainRef")
    meta.targetNameProps["name"] = "tnAaaDomainRefName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsVDevToDomainRef"
    meta.rnFormat = "rsVDevToDomainRef"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15647, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15644, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnAaaDomainRefName", "tnAaaDomainRefName", 15643, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
