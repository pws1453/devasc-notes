...
# ##################################################
class RsCDevTemplateToAddrInst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsCDevTemplateToAddrInst", "cobra.model.fvns.AddrInst")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCDevTemplateToAddrInst"
    meta.rnFormat = "rscDevTemplateToAddrInst"
    ...
    meta.rnPrefixes = [
        ('rscDevTemplateToAddrInst', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44854, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44855, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 44844, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44843, PropCategory.REGULAR)
