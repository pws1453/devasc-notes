...
class RsMDev(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsMDev", "cobra.model.vns.MDev")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsMDev"
    meta.rnFormat = "rsmDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19078, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19077, PropCategory.REGULAR)
