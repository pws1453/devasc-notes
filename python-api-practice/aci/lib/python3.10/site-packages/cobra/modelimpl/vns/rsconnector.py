...
# ##################################################
class RsConnector(Mo):
    """
    A source relation to a connector between logical functions. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsConnector", "cobra.model.vns.MConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsConnector"
    meta.rnFormat = "rsconnector"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L4-L7 Service Configuration Meta Connector"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37982, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "attType", "attType", 13561, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40121, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14837, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13560, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4756
    prop.defaultValueStr = "vnsMConn"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsMConn", None, 4756)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13559, PropCategory.REGULAR)
