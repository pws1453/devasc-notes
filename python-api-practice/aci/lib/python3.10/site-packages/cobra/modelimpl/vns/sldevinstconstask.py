...
# ##################################################
class SLDevInstConsTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.vns.SLDevInstConsTask")

    meta.moClassName = "vnsSLDevInstConsTask"
    meta.rnFormat = "vnsSLDevInstConsTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 17761, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RemoveVGrp", "removevgrp", 1521)
