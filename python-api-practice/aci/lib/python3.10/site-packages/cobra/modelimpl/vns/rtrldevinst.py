...
# ##################################################
class RtRLdevInst(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vns.RtRLdevInst", "cobra.model.vns.LDevInst")

    meta.moClassName = "vnsRtRLdevInst"
    meta.rnFormat = "rtrLdevInst-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.vns.Cons")
    ...
    prop = PropMeta("str", "tCl", "tCl", 17767, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17766, PropCategory.REGULAR)
