...
# ##################################################
class RsLIfCtxToInstP(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToInstP", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToInstP"
    meta.rnFormat = "rsLIfCtxToInstP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to fvEPg or subclass"
    ...
    meta.rnPrefixes = [
        ('rsLIfCtxToInstP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38174, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40313, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18111, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "redistribute", "redistribute", 18610, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = "ospf,bgp"
    prop.defaultValueStr = "ospf,bgp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18107, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18106, PropCategory.REGULAR)
