...
# ##################################################
class RtToRemoteBackupPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToRemoteBackupPol", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "vnsRtToRemoteBackupPol"
    meta.rnFormat = "rtfvToRemoteBackupPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55777, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55776, PropCategory.REGULAR)
