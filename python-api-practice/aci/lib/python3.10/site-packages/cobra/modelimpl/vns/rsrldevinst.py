...
# ##################################################
class RsRLdevInst(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.vns.RsRLdevInst", "cobra.model.vns.Cons")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsRLdevInst"
    meta.rnFormat = "rsrLdevInst"
    ...
    prop = PropMeta("str", "id", "id", 17763, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 17765, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5962
    prop.defaultValueStr = "vnsCons"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsCons", None, 5962)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17764, PropCategory.REGULAR)
