...
class RtBdConn(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.vns.RtBdConn", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "vnsRtBdConn"
    meta.rnFormat = "rtbdConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13653, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13652, PropCategory.REGULAR)
