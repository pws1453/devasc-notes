...
# ##################################################
class RtCfgToConn(Mo):
    """
    A target relation to a connector. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtCfgToConn", "cobra.model.vns.ACCfg")

    meta.moClassName = "vnsRtCfgToConn"
    meta.rnFormat = "rtcfgToConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13664, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15309, PropCategory.REGULAR)
