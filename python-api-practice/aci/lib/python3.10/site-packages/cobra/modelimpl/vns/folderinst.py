...
class FolderInst(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.FolderInst")

    meta.moClassName = "vnsFolderInst"
    meta.rnFormat = "FI_C-%(ctrctNameOrLbl)s-G-%(graphNameOrLbl)s-F-%(nodeNameOrLbl)s-N-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 folder instance"
    ...
    meta.childClasses.add("cobra.model.vns.RtFolderInstAtt")
    meta.childClasses.add("cobra.model.vns.RsScopeToTerm")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vns.RsCfgToConn")
    meta.childClasses.add("cobra.model.vns.RsFolderInstToMFolder")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsFolderInstToMFolder", "rsfolderInstToMFolder-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtFolderInstAtt", "rtfolderInstAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsScopeToTerm", "rsscopeToTerm"))
    ...
    meta.superClasses.add("cobra.model.vns.AFolder")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37988, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5002, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5003, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ctrctNameOrLbl", "ctrctNameOrLbl", 5123, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("ctrctNameOrLbl", prop)

    prop = PropMeta("str", "devCtxLbl", "devCtxLbl", 5004, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40127, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "graphNameOrLbl", "graphNameOrLbl", 5124, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = "any"
    prop.defaultValueStr = "any"
    meta.props.add("graphNameOrLbl", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14864, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7336, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nodeNameOrLbl", "nodeNameOrLbl", 5125, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = "any"
    prop.defaultValueStr = "any"
    meta.props.add("nodeNameOrLbl", prop)
    ...
    prop = PropMeta("str", "scopedBy", "scopedBy", 5001, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 4
    prop.defaultValueStr = "epg"
    prop._addConstant("ap", "ap", 2)
    prop._addConstant("bd", "bd", 3)
    prop._addConstant("epg", "epg", 4)
    prop._addConstant("none", "none", 0)
    prop._addConstant("tenant", "tenant", 1)
    meta.props.add("scopedBy", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "ctrctNameOrLbl"))
    meta.namingProps.append(getattr(meta.props, "graphNameOrLbl"))
    meta.namingProps.append(getattr(meta.props, "nodeNameOrLbl"))
    ...
    def __init__(self, parentMoOrDn, ctrctNameOrLbl, graphNameOrLbl, nodeNameOrLbl, name, markDirty=True, **creationProps):
        namingVals = [ctrctNameOrLbl, graphNameOrLbl, nodeNameOrLbl, name]
