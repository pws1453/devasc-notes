...
# ##################################################
class RtConnectionInstConns(Mo):
    """
    A target relation to a connector. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtConnectionInstConns", "cobra.model.vns.ConnectionInst")

    meta.moClassName = "vnsRtConnectionInstConns"
    meta.rnFormat = "rtConnectionInstConns"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13660, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4846
    prop.defaultValueStr = "vnsConnectionInst"
