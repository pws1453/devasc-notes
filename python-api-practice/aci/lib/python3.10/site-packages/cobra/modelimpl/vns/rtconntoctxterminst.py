...
# ##################################################
class RtConnToCtxTermInst(Mo):
    """
    A target relation to a terminal. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtConnToCtxTermInst", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "vnsRtConnToCtxTermInst"
    meta.rnFormat = "rtconnToCtxTermInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13633, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13632, PropCategory.REGULAR)
