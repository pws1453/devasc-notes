...
# ##################################################
class RtEPgDefToConn(Mo):
    """
    A target relation to a connector. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtEPgDefToConn", "cobra.model.vns.EPgDef")

    meta.moClassName = "vnsRtEPgDefToConn"
    meta.rnFormat = "rtEPgDefToConn"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13610, PropCategory.REGULAR)
