...
# ##################################################
class RtFolderInstAtt(Mo):
    """
    A target relation to a folder instance configured by the administrator. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtFolderInstAtt", "cobra.model.vns.GFolder")

    meta.moClassName = "vnsRtFolderInstAtt"
    meta.rnFormat = "rtfolderInstAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13598, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4789
    prop.defaultValueStr = "vnsGFolder"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsGFolder", None, 4789)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13597, PropCategory.REGULAR)
