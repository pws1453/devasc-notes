...
class LDevIf(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.LDevIf")

    meta.moClassName = "vnsLDevIf"
    meta.rnFormat = "lDevIf-[%(ldev)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Device Consumer"
    ...
    meta.childClasses.add("cobra.model.vns.LDevIfLIf")
    ...
    meta.childClasses.add("cobra.model.vns.RsLdevIfToLDev")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsLdevIfToLDev", "rsldevIfToLDev"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.LDevIfLIf", "lDevIfLIf-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37994, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 5173, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 5174, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "description", "description", 5172, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40133, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ldev", "ldev", 5171, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14894, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "ldev"))
    getattr(meta.props, "ldev").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, ldev, markDirty=True, **creationProps):
        namingVals = [ldev]
