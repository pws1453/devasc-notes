...
class InBEpPInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.InBEpPInfo")

    meta.moClassName = "vnsInBEpPInfo"
    meta.rnFormat = "epg-[%(epg)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Inband EpP"
    ...
    meta.parentClasses.add("cobra.model.vns.InBHolder")

    meta.rnPrefixes = [
        ('epg-', True),
    ]

    prop = PropMeta("str", "bd", "bd", 16257, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "ctx", "ctx", 16258, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "epg", "epg", 16256, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    getattr(meta.props, "epg").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, epg, markDirty=True, **creationProps):
        namingVals = [epg]
