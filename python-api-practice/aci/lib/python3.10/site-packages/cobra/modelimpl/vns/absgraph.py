...
class AbsGraph(Mo):
    """
    The abstract graph is made up of abstract nodes and used to define the traffic flow through a service function such as load balancing, SSL offload, and firewall. Abstract nodes are comprised of service nodes such as a service node balancer (SLB) or firewall (FW), abstract term nodes (the nodes that are connected to endpoint groups), and connections.

    """

    meta = ClassMeta("cobra.model.vns.AbsGraph")

    meta.moClassName = "vnsAbsGraph"
    meta.rnFormat = "AbsGraph-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Service Graph Template"
    meta.writeAccessMask = 0x2000000000000001
    meta.readAccessMask = 0x6000000000000101
    ...
    meta.childClasses.add("cobra.model.vns.RtAbsGraph")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vns.RtInTermGraphAtt")
    meta.childClasses.add("cobra.model.vns.AbsNode")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vns.RtGraphDefToGraph")
    meta.childClasses.add("cobra.model.vns.RtGraphInstanceMeta")
    ...
    meta.childClasses.add("cobra.model.vns.RtAbsGraphRef")
    meta.childClasses.add("cobra.model.vns.RtOutTermGraphAtt")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.vns.AbsConnection")
    meta.childClasses.add("cobra.model.vns.AbsTermNodeProv")
    meta.childClasses.add("cobra.model.vns.RtGraphAtt")
    meta.childClasses.add("cobra.model.vns.AbsTermNodeCon")
    meta.childClasses.add("cobra.model.vns.RtSubjGraphAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtGraphDefToGraph", "rtvzGraphDefToGraph-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtGraphInstanceMeta", "rtgraphInstanceMeta-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtOutTermGraphAtt", "rtvzOutTermGraphAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtInTermGraphAtt", "rtvzInTermGraphAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtAbsGraphRef", "rtorchsAbsGraphRef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtSubjGraphAtt", "rtvzSubjGraphAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AbsTermNodeProv", "AbsTermNodeProv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AbsTermNodeCon", "AbsTermNodeCon-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AbsConnection", "AbsConnection-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ConfIssue", "vnsConfIssue-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtGraphAtt", "rtvzGraphAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtAbsGraph", "rtabsGraph-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AbsNode", "AbsNode-"))
    ...
    meta.superClasses.add("cobra.model.vns.AGraph")

    meta.rnPrefixes = [
        ('AbsGraph-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37951, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configInfo", "configInfo", 15863, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("configInfo", prop)

    prop = PropMeta("str", "configIssues", "configIssues", 4995, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "configSt", "configSt", 4996, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40090, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "filterBetweenNodes", "filterBetweenNodes", 56068, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "allow-all"
    prop._addConstant("allow-all", "allow-all", 0)
    prop._addConstant("filters-from-contract", "filters-from-contract", 1)
    meta.props.add("filterBetweenNodes", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14797, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7307, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 51785, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "legacy"
    prop._addConstant("cloud", "cloud", 1)
    prop._addConstant("legacy", "legacy", 0)
    meta.props.add("type", prop)

    prop = PropMeta("str", "uiTemplateType", "uiTemplateType", 17743, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 8
    prop.defaultValueStr = "UNSPECIFIED"
    prop._addConstant("ONE_NODE_ADC_ONE_ARM", "one_node_adc_one_arm", 2)
    prop._addConstant("ONE_NODE_ADC_ONE_ARM_L3EXT", "one_node_adc_one_arm_l3ext", 11)
    prop._addConstant("ONE_NODE_ADC_TWO_ARM", "one_node_adc_two_arm", 3)
    prop._addConstant("ONE_NODE_FW_ROUTED", "one_node_fw_routed", 1)
    prop._addConstant("ONE_NODE_FW_TRANS", "one_node_fw_trans", 0)
    prop._addConstant("TWO_NODE_FW_ROUTED_ADC_ONE_ARM", "two_node_fw_routed_adc_one_arm", 5)
    prop._addConstant("TWO_NODE_FW_ROUTED_ADC_ONE_ARM_L3EXT", "two_node_fw_routed_adc_one_arm_l3ext", 22)
    prop._addConstant("TWO_NODE_FW_ROUTED_ADC_TWO_ARM", "two_node_fw_routed_adc_two_arm", 7)
    prop._addConstant("TWO_NODE_FW_TRANS_ADC_ONE_ARM", "two_node_fw_trans_adc_one_arm", 4)
    prop._addConstant("TWO_NODE_FW_TRANS_ADC_ONE_ARM_L3EXT", "two_node_fw_trans_adc_one_arm_l3ext", 21)
    prop._addConstant("TWO_NODE_FW_TRANS_ADC_TWO_ARM", "two_node_fw_trans_adc_two_arm", 6)
    prop._addConstant("UNSPECIFIED", "unspecified", 8)
    meta.props.add("uiTemplateType", prop)
