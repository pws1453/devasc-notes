...
# ##################################################
class RsLDevVipToInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLDevVipToInstPol", "cobra.model.vns.InstPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLDevVipToInstPol"
    meta.rnFormat = "rslDevVipToInstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Service Instance Policy"
    ...
    meta.rnPrefixes = [
        ('rslDevVipToInstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 42716, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42717, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42707, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 42696, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12359
    prop.defaultValueStr = "vnsInstPol"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsInstPol", None, 12359)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 42695, PropCategory.REGULAR)
