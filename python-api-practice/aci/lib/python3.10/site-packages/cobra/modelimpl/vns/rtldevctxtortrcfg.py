...
# ##################################################
class RtLDevCtxToRtrCfg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLDevCtxToRtrCfg", "cobra.model.vns.LDevCtx")

    meta.moClassName = "vnsRtLDevCtxToRtrCfg"
    meta.rnFormat = "rtLDevCtxToRtrCfg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19874, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19873, PropCategory.REGULAR)
