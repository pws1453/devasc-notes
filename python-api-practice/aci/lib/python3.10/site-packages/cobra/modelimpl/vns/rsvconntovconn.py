...
# ##################################################
class RsVConnToVConn(Mo):
    """
    A source relation to a virtual connector. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsVConnToVConn", "cobra.model.vns.VConn")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsVConnToVConn"
    meta.rnFormat = "rsvConnToVConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13738, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13737, PropCategory.REGULAR)
