...
# ##################################################
class RsNodeToCloudLDevTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.RsNodeToCloudLDevTask")

    meta.moClassName = "vnsRsNodeToCloudLDevTask"
    meta.rnFormat = "vnsRsNodeToCloudLDevTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 52395, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdSvcPolicyToLDev", "updsvcpolicytoldev", 3499)
