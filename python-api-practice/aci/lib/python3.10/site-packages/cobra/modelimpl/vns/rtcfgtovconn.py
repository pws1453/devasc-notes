...
# ##################################################
class RtCfgToVConn(Mo):
    """
    A target relation to a virtual connector. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vns.RtCfgToVConn", "cobra.model.vns.ACCfg")

    meta.moClassName = "vnsRtCfgToVConn"
    meta.rnFormat = "rtcfgToVConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13669, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4858
    prop.defaultValueStr = "vnsACCfg"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13668, PropCategory.REGULAR)
