...
# ##################################################
class RtFiltGraphAtt(Mo):
    """
    A target relation to an input terminal node. Note that this relation is an internal object. 

    """

    meta = TargetRelationMeta("cobra.model.vns.RtFiltGraphAtt", "cobra.model.vz.AFilterable")

    meta.moClassName = "vnsRtFiltGraphAtt"
    meta.rnFormat = "rtvzFiltGraphAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11827, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11826, PropCategory.REGULAR)
