...
class DevSlot(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.DevSlot")

    meta.moClassName = "vnsDevSlot"
    meta.rnFormat = "devSlot-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Device Slot"
    ...
    prop = PropMeta("str", "name", "name", 17641, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
