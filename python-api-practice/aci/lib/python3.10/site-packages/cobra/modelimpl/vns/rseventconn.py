...
# ##################################################
class RsEventConn(Mo):
    """
    A source relation to a connector. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsEventConn", "cobra.model.vns.AConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsEventConn"
    meta.rnFormat = "rseventConn"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13655, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13654, PropCategory.REGULAR)
