...
# ##################################################
class AMgmt(Mo):
    meta = ClassMeta("cobra.model.vns.AMgmt")

    meta.isAbstract = True
    meta.moClassName = "vnsAMgmt"
    ...
    meta.concreteSubClasses.add("cobra.model.vns.CMgmt")
    meta.concreteSubClasses.add("cobra.model.vns.CMgmts")
