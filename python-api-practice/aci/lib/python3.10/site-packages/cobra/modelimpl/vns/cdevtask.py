...
class CDevTask(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.CDevTask")

    meta.moClassName = "vnsCDevTask"
    meta.rnFormat = "vnsCDevTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23131, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateInfo", "updateinfo", 2032)
    prop._addConstant("UpdateInstPol", "updateinstpol", 3130)
