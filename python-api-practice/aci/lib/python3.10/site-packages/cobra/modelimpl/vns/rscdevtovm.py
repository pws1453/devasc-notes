...
class RsCDevToVm(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsCDevToVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "vnsRsCDevToVm"
    meta.rnFormat = "rscDevToVm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 42700, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 42699, PropCategory.REGULAR)
