...
class RsMDevMgr(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsMDevMgr", "cobra.model.vns.MDevMgr")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsMDevMgr"
    meta.rnFormat = "rsmDevMgr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23100, PropCategory.REGULAR)
