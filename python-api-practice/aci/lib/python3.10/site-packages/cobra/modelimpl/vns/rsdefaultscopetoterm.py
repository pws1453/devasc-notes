...
# ##################################################
class RsDefaultScopeToTerm(Mo):
    """
    A source relation to a terminal. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.vns.RsDefaultScopeToTerm", "cobra.model.vns.ATerm")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vnsRsDefaultScopeToTerm"
    meta.rnFormat = "rsdefaultScopeToTerm"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Function Node to a Terminal Node"
    ...
    meta.rnPrefixes = [
        ('rsdefaultScopeToTerm', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37952, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40091, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14798, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13500, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13499, PropCategory.REGULAR)
