...
# ##################################################
class LDevOperInfoTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.LDevOperInfoTask")

    meta.moClassName = "vnsLDevOperInfoTask"
    meta.rnFormat = "vnsLDevOperInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44810, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateState", "updatestate", 3234)
