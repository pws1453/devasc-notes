...
# ##################################################
class RLDevInstCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.RLDevInstCons")

    meta.moClassName = "vnsRLDevInstCons"
    meta.rnFormat = "rldevinst-[%(consDn)s]"
    ...
    prop = PropMeta("str", "consDn", "consDn", 20438, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
