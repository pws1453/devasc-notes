...
# ##################################################
class RtNodeToLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtNodeToLDev", "cobra.model.vns.AbsNode")

    meta.moClassName = "vnsRtNodeToLDev"
    meta.rnFormat = "rtnodeToLDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20849, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20848, PropCategory.REGULAR)
