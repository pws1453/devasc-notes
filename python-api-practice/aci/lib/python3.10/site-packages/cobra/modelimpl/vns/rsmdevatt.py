...
class RsMDevAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsMDevAtt", "cobra.model.vns.MDev")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsMDevAtt"
    meta.rnFormat = "rsmDevAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a Service L4-L7 Devices to Meta Device Information"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37995, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40134, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14896, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13700, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13699, PropCategory.REGULAR)
