...
# ##################################################
class SvcVipUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.SvcVipUpdateTask")

    meta.moClassName = "vnsSvcVipUpdateTask"
    meta.rnFormat = "vnsSvcVipUpdateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 20171, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateCtxDefWithSvcVipDef", "updatectxdefwithsvcvipdef", 1737)
