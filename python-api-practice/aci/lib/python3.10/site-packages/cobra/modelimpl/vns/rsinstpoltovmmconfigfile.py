...
# ##################################################
class RsInstPolToVmmConfigFile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsInstPolToVmmConfigFile", "cobra.model.vns.VmmConfigFile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsInstPolToVmmConfigFile"
    meta.rnFormat = "rsinstPolToVmmConfigFile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Vmm configuration file"
    meta.writeAccessMask = 0x2000000000000005
    ...
    meta.rnPrefixes = [
        ('rsinstPolToVmmConfigFile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 42720, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42721, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42709, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 42703, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12354
    prop.defaultValueStr = "vnsVmmConfigFile"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsVmmConfigFile", None, 12354)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 42702, PropCategory.REGULAR)
