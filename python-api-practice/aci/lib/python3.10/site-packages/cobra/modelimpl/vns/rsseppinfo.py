...
class RsSEPpInfo(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsSEPpInfo", "cobra.model.vns.Cons")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsSEPpInfo"
    meta.rnFormat = "rssEPpInfo"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17773, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17772, PropCategory.REGULAR)
