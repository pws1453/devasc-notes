...
# ##################################################
class EpgDefXlate(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.EpgDefXlate")

    meta.moClassName = "vnsEpgDefXlate"
    meta.rnFormat = "epgDefXlate-[%(epgDefDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "EpgDefXlate"
    meta.writeAccessMask = 0x2000000000000001
    meta.readAccessMask = 0x2000000000000101
    ...
    prop = PropMeta("str", "annotation", "annotation", 38851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "epgDefDn", "epgDefDn", 37243, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40990, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37264, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 37244, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
