...
class Composite(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.Composite")

    meta.moClassName = "vnsComposite"
    meta.rnFormat = "comp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Composite Assertion"
    ...
    meta.superClasses.add("cobra.model.vns.CAssertion")
    ...
    prop = PropMeta("str", "comp", "comp", 5090, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "and"
    prop._addConstant("and", "and", 1)
    prop._addConstant("none", "none", 0)
    prop._addConstant("one", "one", 3)
    prop._addConstant("or", "or", 2)
    meta.props.add("comp", prop)

    prop = PropMeta("str", "dispLabel", "dispLabel", 26245, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 7325, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
