...
class UnitHolder(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.UnitHolder")

    meta.moClassName = "vnsUnitHolder"
    meta.rnFormat = "UnitHolder-%(ns)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Id holder"
    ...
    meta.childClasses.add("cobra.model.vns.Unit")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.Unit", "unit-"))
    ...
    prop = PropMeta("str", "lastId", "lastId", 16172, PropCategory.REGULAR)
    prop.label = "Last used id"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastId", prop)
    ...
    prop = PropMeta("str", "ns", "ns", 16171, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, ns, markDirty=True, **creationProps):
        namingVals = [ns]
