...
class RxPkts1d(Mo):
    """
    A class that represents the most current statistics for  Rx  Packet counters in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.vns.RxPkts1d", "Rx Packet counters")
    ...
    meta.moClassName = "vnsRxPkts1d"
    meta.rnFormat = "CDvnsRxPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Rx Packet counters stats in 1 day"
