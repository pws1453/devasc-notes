...
# ##################################################
class RtCDevToChassis(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.vns.RtCDevToChassis", "cobra.model.vns.CDev")

    meta.moClassName = "vnsRtCDevToChassis"
    meta.rnFormat = "rtcDevToChassis-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18362, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18361, PropCategory.REGULAR)
