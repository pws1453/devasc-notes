...
# ##################################################
class DelegateTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.dlgt.DelegateTask")

    meta.moClassName = "dlgtDelegateTask"
    meta.rnFormat = "dlgtDelegateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21214, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ExcutePostponed", "excutepostponed", 1851)
