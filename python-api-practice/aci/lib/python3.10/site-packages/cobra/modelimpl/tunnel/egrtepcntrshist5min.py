...
# ##################################################
class EgrTepCntrsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist5min", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist5min"
    meta.rnFormat = "HDtunnelEgrTepCntrs5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 45944, PropCategory.REGULAR)
