...
# ##################################################
class EgrTepCntrsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist1qtr", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist1qtr"
    meta.rnFormat = "HDtunnelEgrTepCntrs1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 45941, PropCategory.REGULAR)
