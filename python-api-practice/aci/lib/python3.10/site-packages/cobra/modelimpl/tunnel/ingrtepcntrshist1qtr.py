...
# ##################################################
class IngrTepCntrsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist1qtr", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist1qtr"
    meta.rnFormat = "HDtunnelIngrTepCntrs1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 45949, PropCategory.REGULAR)
