...
# ##################################################
class IngrTepCntrsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist1mo", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist1mo"
    meta.rnFormat = "HDtunnelIngrTepCntrs1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 45948, PropCategory.REGULAR)
