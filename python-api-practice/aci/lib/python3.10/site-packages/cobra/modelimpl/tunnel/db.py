...
class Db(Mo):
    ...
    meta = ClassMeta("cobra.model.tunnel.Db")

    meta.moClassName = "tunnelDb"
    meta.rnFormat = "db-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Tunnel Database"
    ...
    prop = PropMeta("str", "type", "type", 20690, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.defaultValue = 1
    prop.defaultValueStr = "dep"
    prop._addConstant("dep", "discovered-endpoint-database", 1)
