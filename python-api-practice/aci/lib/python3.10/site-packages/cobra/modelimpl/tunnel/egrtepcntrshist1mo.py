...
# ##################################################
class EgrTepCntrsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist1mo", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist1mo"
    meta.rnFormat = "HDtunnelEgrTepCntrs1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 45940, PropCategory.REGULAR)
