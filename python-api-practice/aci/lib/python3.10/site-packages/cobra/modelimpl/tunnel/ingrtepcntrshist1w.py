...
# ##################################################
class IngrTepCntrsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist1w", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist1w"
    meta.rnFormat = "HDtunnelIngrTepCntrs1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 45950, PropCategory.REGULAR)
