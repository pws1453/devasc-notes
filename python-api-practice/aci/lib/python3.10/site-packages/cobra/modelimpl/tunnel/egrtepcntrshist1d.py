...
# ##################################################
class EgrTepCntrsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist1d", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist1d"
    meta.rnFormat = "HDtunnelEgrTepCntrs1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 45938, PropCategory.REGULAR)
