...
# ##################################################
class EgrTepCntrsHist(Mo):
    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist"


    meta.moClassName = "tunnelEgrTepCntrsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats"
    ...
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist1h")
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist5min")
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist1d")
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist1year")
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist1w")
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist15min")
    meta.concreteSubClasses.add("cobra.model.tunnel.EgrTepCntrsHist1mo")
