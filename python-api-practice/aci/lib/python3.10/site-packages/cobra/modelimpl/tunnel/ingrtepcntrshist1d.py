...
# ##################################################
class IngrTepCntrsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist1d", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist1d"
    meta.rnFormat = "HDtunnelIngrTepCntrs1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 45946, PropCategory.REGULAR)
