...
# ##################################################
class RsTunnelToLooseNode(Mo):
    """
    A source relation to an external connected node (i.e. blade switch).  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.tunnel.RsTunnelToLooseNode", "cobra.model.leqpt.LooseNode")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "tunnelRsTunnelToLooseNode"
    meta.rnFormat = "rstunnelToLooseNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15135, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12796, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12795, PropCategory.REGULAR)
