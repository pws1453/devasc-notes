...
# ##################################################
class EgrTepCntrsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist1year", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist1year"
    meta.rnFormat = "HDtunnelEgrTepCntrs1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 45943, PropCategory.REGULAR)
