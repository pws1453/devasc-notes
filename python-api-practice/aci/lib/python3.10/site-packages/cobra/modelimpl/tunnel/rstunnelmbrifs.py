...
# ##################################################
class RsTunnelMbrIfs(Mo):
    """
    A source relation to a layer 1 physical Ethernet interface.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.tunnel.RsTunnelMbrIfs", "cobra.model.l1.PhysIf")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "tunnelRsTunnelMbrIfs"
    meta.rnFormat = "rstunnelMbrIfs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15132, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12792, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12791, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15131, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
