...
# ##################################################
class EgrTepCntrsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist1w", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist1w"
    meta.rnFormat = "HDtunnelEgrTepCntrs1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 45942, PropCategory.REGULAR)
