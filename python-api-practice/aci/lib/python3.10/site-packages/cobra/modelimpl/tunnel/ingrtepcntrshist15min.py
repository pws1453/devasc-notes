...
# ##################################################
class IngrTepCntrsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist15min", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist15min"
    meta.rnFormat = "HDtunnelIngrTepCntrs15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.tunnel.IngrTepCntrsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDtunnelIngrTepCntrs15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45945, PropCategory.REGULAR)
