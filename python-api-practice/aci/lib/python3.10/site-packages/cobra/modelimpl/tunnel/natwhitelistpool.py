...
# ##################################################
class NatWhitelistPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.tunnel.NatWhitelistPool")

    meta.moClassName = "tunnelNatWhitelistPool"
    meta.rnFormat = "natwl-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Prefix to skip APICs Routable NAT"
    ...
    prop = PropMeta("str", "addr", "addr", 53870, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
