...
# ##################################################
class EgrTepCntrsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsHist1h", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsHist1h"
    meta.rnFormat = "HDtunnelEgrTepCntrs1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress TEP Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 45939, PropCategory.REGULAR)
