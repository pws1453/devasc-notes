...
# ##################################################
class IngrTepCntrsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist1h", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist1h"
    meta.rnFormat = "HDtunnelIngrTepCntrs1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 45947, PropCategory.REGULAR)
