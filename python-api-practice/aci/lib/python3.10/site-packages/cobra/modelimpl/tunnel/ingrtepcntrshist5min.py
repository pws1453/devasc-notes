...
# ##################################################
class IngrTepCntrsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist5min", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist5min"
    meta.rnFormat = "HDtunnelIngrTepCntrs5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 45952, PropCategory.REGULAR)
