...
# ##################################################
class IngrTepCntrsHist(Mo):
    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist"


    meta.moClassName = "tunnelIngrTepCntrsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats"
    ...
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist1d")
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist1year")
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist1mo")
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist1h")
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist5min")
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist1w")
    meta.concreteSubClasses.add("cobra.model.tunnel.IngrTepCntrsHist15min")
    ...
    prop = PropMeta("str", "dropBytesAvg", "dropBytesAvg", 47237, PropCategory.IMPLICIT_AVG)
    prop.label = "Drop Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesAvg", prop)

    prop = PropMeta("str", "dropBytesCum", "dropBytesCum", 47233, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Drop Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesCum", prop)

    prop = PropMeta("str", "dropBytesMax", "dropBytesMax", 47236, PropCategory.IMPLICIT_MAX)
    prop.label = "Drop Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesMax", prop)

    prop = PropMeta("str", "dropBytesMin", "dropBytesMin", 47235, PropCategory.IMPLICIT_MIN)
    prop.label = "Drop Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesMin", prop)

    prop = PropMeta("str", "dropBytesPer", "dropBytesPer", 47234, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Drop Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesPer", prop)

    prop = PropMeta("str", "dropBytesRate", "dropBytesRate", 47241, PropCategory.IMPLICIT_RATE)
    prop.label = "Drop Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRate", prop)

    prop = PropMeta("str", "dropBytesSpct", "dropBytesSpct", 47238, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Drop Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesSpct", prop)

    prop = PropMeta("str", "dropBytesThr", "dropBytesThr", 47239, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropBytesTr", "dropBytesTr", 47240, PropCategory.IMPLICIT_TREND)
    prop.label = "Drop Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesTr", prop)

    prop = PropMeta("str", "dropPktsAvg", "dropPktsAvg", 47258, PropCategory.IMPLICIT_AVG)
    prop.label = "Drop Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsAvg", prop)

    prop = PropMeta("str", "dropPktsCum", "dropPktsCum", 47254, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Drop Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsCum", prop)

    prop = PropMeta("str", "dropPktsMax", "dropPktsMax", 47257, PropCategory.IMPLICIT_MAX)
    prop.label = "Drop Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsMax", prop)

    prop = PropMeta("str", "dropPktsMin", "dropPktsMin", 47256, PropCategory.IMPLICIT_MIN)
    prop.label = "Drop Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsMin", prop)

    prop = PropMeta("str", "dropPktsPer", "dropPktsPer", 47255, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Drop Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsPer", prop)

    prop = PropMeta("str", "dropPktsRate", "dropPktsRate", 47262, PropCategory.IMPLICIT_RATE)
    prop.label = "Drop Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsRate", prop)

    prop = PropMeta("str", "dropPktsSpct", "dropPktsSpct", 47259, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Drop Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsSpct", prop)

    prop = PropMeta("str", "dropPktsThr", "dropPktsThr", 47260, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropPktsTr", "dropPktsTr", 47261, PropCategory.IMPLICIT_TREND)
    prop.label = "Drop Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsTr", prop)

    prop = PropMeta("str", "fwdBytesAvg", "fwdBytesAvg", 47279, PropCategory.IMPLICIT_AVG)
    prop.label = "Forwarded Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesAvg", prop)

    prop = PropMeta("str", "fwdBytesCum", "fwdBytesCum", 47275, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Forwarded Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesCum", prop)

    prop = PropMeta("str", "fwdBytesMax", "fwdBytesMax", 47278, PropCategory.IMPLICIT_MAX)
    prop.label = "Forwarded Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesMax", prop)

    prop = PropMeta("str", "fwdBytesMin", "fwdBytesMin", 47277, PropCategory.IMPLICIT_MIN)
    prop.label = "Forwarded Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesMin", prop)

    prop = PropMeta("str", "fwdBytesPer", "fwdBytesPer", 47276, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Forwarded Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesPer", prop)

    prop = PropMeta("str", "fwdBytesRate", "fwdBytesRate", 47283, PropCategory.IMPLICIT_RATE)
    prop.label = "Forwarded Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesRate", prop)

    prop = PropMeta("str", "fwdBytesSpct", "fwdBytesSpct", 47280, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Forwarded Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesSpct", prop)

    prop = PropMeta("str", "fwdBytesThr", "fwdBytesThr", 47281, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fwdBytesTr", "fwdBytesTr", 47282, PropCategory.IMPLICIT_TREND)
    prop.label = "Forwarded Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesTr", prop)

    prop = PropMeta("str", "fwdPktsAvg", "fwdPktsAvg", 47300, PropCategory.IMPLICIT_AVG)
    prop.label = "Forwarded Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsAvg", prop)

    prop = PropMeta("str", "fwdPktsCum", "fwdPktsCum", 47296, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Forwarded Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsCum", prop)

    prop = PropMeta("str", "fwdPktsMax", "fwdPktsMax", 47299, PropCategory.IMPLICIT_MAX)
    prop.label = "Forwarded Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsMax", prop)

    prop = PropMeta("str", "fwdPktsMin", "fwdPktsMin", 47298, PropCategory.IMPLICIT_MIN)
    prop.label = "Forwarded Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsMin", prop)

    prop = PropMeta("str", "fwdPktsPer", "fwdPktsPer", 47297, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Forwarded Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsPer", prop)

    prop = PropMeta("str", "fwdPktsRate", "fwdPktsRate", 47304, PropCategory.IMPLICIT_RATE)
    prop.label = "Forwarded Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsRate", prop)

    prop = PropMeta("str", "fwdPktsSpct", "fwdPktsSpct", 47301, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Forwarded Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsSpct", prop)

    prop = PropMeta("str", "fwdPktsThr", "fwdPktsThr", 47302, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fwdPktsTr", "fwdPktsTr", 47303, PropCategory.IMPLICIT_TREND)
