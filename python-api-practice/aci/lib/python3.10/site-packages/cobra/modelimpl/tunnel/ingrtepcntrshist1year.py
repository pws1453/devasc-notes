...
# ##################################################
class IngrTepCntrsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsHist1year", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsHist1year"
    meta.rnFormat = "HDtunnelIngrTepCntrs1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress TEP Counters stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDtunnelIngrTepCntrs1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45951, PropCategory.REGULAR)
