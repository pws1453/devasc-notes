...
# ##################################################
class RelTaskContTask(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = ClassMeta("cobra.model.reln.RelTaskContTask")

    meta.moClassName = "relnRelTaskContTask"
    meta.rnFormat = "relnRelTaskContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5637, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReleaseTnCommon", "releasetncommon", 10)
    prop._addConstant("Resolve", "resolve", 7)
    prop._addConstant("ResolveTnCommon", "resolvetncommon", 9)
    prop._addConstant("none", "none", 0)
    prop._addConstant("relnRelease", "relnrelease", 15)
    prop._addConstant("relnResolve", "relnresolve", 14)
    prop._addConstant("relnTargetCreate", "relntargetcreate", 17)
    prop._addConstant("relnTargetDelete", "relntargetdelete", 18)
