...
# ##################################################
class RelnResolveRespArgs(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = ClassMeta("cobra.model.reln.RelnResolveRespArgs")

    meta.moClassName = "relnRelnResolveRespArgs"
    meta.rnFormat = "rresp-[%(resolverDn)s]"
    ...
    prop = PropMeta("str", "found", "found", 184, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "resolverDn", "resolverDn", 183, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
