...
class TcPolCons(Mo):
    ...
    meta = ClassMeta("cobra.model.reln.TcPolCons")

    meta.moClassName = "relnTcPolCons"
    meta.rnFormat = "tccons-[%(resolverDn)s]"
    ...
    meta.parentClasses.add("cobra.model.reln.TcPol")
    ...
    prop = PropMeta("str", "resolverDn", "resolverDn", 18259, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
