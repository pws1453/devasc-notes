...
class RelnInst(Mo):
    ...
    meta = ClassMeta("cobra.model.reln.RelnInst")

    meta.moClassName = "relnRelnInst"
    meta.rnFormat = "rinst-[%(resolverDn)s]"
    ...
    prop = PropMeta("str", "resolverDn", "resolverDn", 145, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
