...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.uribv6.Entity")

    meta.moClassName = "uribv6Entity"
    meta.rnFormat = "uribv6"
    meta.category = MoCategory.REGULAR
    meta.label = "Unicast Routing Information Base Entity"
    ...
    meta.childClasses.add("cobra.model.uribv6.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.uribv6.Dom", "dom-"))
