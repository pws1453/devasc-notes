...
# ##################################################
class RsEppEigrpCtxDefaultPol(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.eigrp.RsEppEigrpCtxDefaultPol", "cobra.model.eigrp.CtxAfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "eigrpRsEppEigrpCtxDefaultPol"
    meta.rnFormat = "rseppEigrpCtxDefaultPol"
    ...
    meta.parentClasses.add("cobra.model.eigrp.ExtDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rseppEigrpCtxDefaultPol', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 18673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18672, PropCategory.REGULAR)
