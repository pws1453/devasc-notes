...
class If(Mo):
    """
    An EIGRP configured interface combines the benefits of distance vector protocols with the features of link-state protocols.

    """

    meta = ClassMeta("cobra.model.eigrp.If")

    meta.moClassName = "eigrpIf"
    ...
    meta.childClasses.add("cobra.model.eigrp.RtIfDefToEigrpIf")
    meta.childClasses.add("cobra.model.eigrp.IfAf")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.RtIfDefToEigrpIf", "rtifDefToEigrpIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.IfAf", "af-"))
    ...
    prop = PropMeta("str", "id", "id", 17449, PropCategory.REGULAR)
