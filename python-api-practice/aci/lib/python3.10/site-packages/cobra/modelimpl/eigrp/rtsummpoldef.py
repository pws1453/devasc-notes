...
class RtSummPolDef(Mo):
    ...
    meta = ClassMeta("cobra.model.eigrp.RtSummPolDef")

    meta.moClassName = "eigrpRtSummPolDef"
    meta.rnFormat = "eigrprtsumm-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EIGRP route summarization internal policy"
    ...
    prop = PropMeta("str", "name", "name", 22789, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
