...
class AuthIfPDef(Mo):
    ...
    meta = ClassMeta("cobra.model.eigrp.AuthIfPDef")

    meta.moClassName = "eigrpAuthIfPDef"
    meta.rnFormat = "eigrpAuthIfPDef"
    ...
    prop = PropMeta("str", "KeyChainPolDefDn", "KeyChainPolDefDn", 49900, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("KeyChainPolDefDn", prop)
