...
class Entity(Mo):
    """
    The EIGRP control plane entity information.

    """

    meta = ClassMeta("cobra.model.eigrp.Entity")

    meta.moClassName = "eigrpEntity"
    meta.rnFormat = "eigrp"
    meta.category = MoCategory.REGULAR
    meta.label = "EIGRP Entity"
    ...
    meta.childClasses.add("cobra.model.eigrp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.Inst", "inst-"))
