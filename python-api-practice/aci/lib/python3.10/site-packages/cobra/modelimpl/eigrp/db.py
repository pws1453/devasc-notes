...
class Db(Mo):
    ...
    meta = ClassMeta("cobra.model.eigrp.Db")

    meta.moClassName = "eigrpDb"
    meta.rnFormat = "db-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EIGRP Database"
    ...
    meta.childClasses.add("cobra.model.eigrp.Route")

    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.Route", "rt-"))
    ...
    prop = PropMeta("str", "type", "type", 17412, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
