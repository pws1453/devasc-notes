...
# ##################################################
class RtEppEigrpIfPol(Mo):
    """
    A target relation to the EIGRP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.eigrp.RtEppEigrpIfPol", "cobra.model.fv.RtdEpP")

    meta.moClassName = "eigrpRtEppEigrpIfPol"
    meta.rnFormat = "rtfvEppEigrpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17998, PropCategory.REGULAR)
