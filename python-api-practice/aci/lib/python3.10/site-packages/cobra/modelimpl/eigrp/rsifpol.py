...
class RsIfPol(Mo):
    """
    A source relation to the EIGRP interface policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.eigrp.RsIfPol", "cobra.model.eigrp.IfPol")
    meta.targetNameProps["name"] = "tnEigrpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "eigrpRsIfPol"
    meta.rnFormat = "rsIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38171, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40310, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18015, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18007, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6042
    prop.defaultValueStr = "eigrpIfPol"
    ...
    prop = PropMeta("str", "tnEigrpIfPolName", "tnEigrpIfPolName", 18006, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnEigrpIfPolName", prop)
