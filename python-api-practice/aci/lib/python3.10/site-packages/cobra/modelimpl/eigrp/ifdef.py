...
class IfDef(Mo):
    """
    The EIGRP interface definition.

    """

    meta = ClassMeta("cobra.model.eigrp.IfDef")

    meta.moClassName = "eigrpIfDef"
    meta.rnFormat = "eigrpIfP"
    ...
    meta.childClasses.add("cobra.model.eigrp.RsIfDefToEigrpIf")
    meta.childClasses.add("cobra.model.eigrp.SummDef")
    meta.childClasses.add("cobra.model.eigrp.AuthIfPDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.RsIfDefToEigrpIf", "rsIfDefToEigrpIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.AuthIfPDef", "eigrpAuthIfPDef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.SummDef", "summ-"))
    ...
    meta.superClasses.add("cobra.model.eigrp.AIfP")
    ...
    prop = PropMeta("str", "bw", "bw", 23656, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 17980, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "delay", "delay", 23657, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "delayUnit", "delayUnit", 23658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "helloIntvl", "helloIntvl", 17981, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "holdIntvl", "holdIntvl", 17982, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 17983, PropCategory.REGULAR)
