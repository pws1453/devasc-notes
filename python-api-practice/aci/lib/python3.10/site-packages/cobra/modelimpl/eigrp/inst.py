...
class Inst(Mo):
    """
    The EIGRP instance information.

    """

    meta = ClassMeta("cobra.model.eigrp.Inst")

    meta.moClassName = "eigrpInst"
    meta.rnFormat = "inst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EIGRP Instance"
    ...
    meta.childClasses.add("cobra.model.eigrp.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.eigrp.Entity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18506, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 17451, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
