...
class RtSum(Mo):
    ...
    meta = ClassMeta("cobra.model.eigrp.RtSum")

    meta.moClassName = "eigrpRtSum"
    ...
    prop = PropMeta("str", "addr", "addr", 22492, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tag", "tag", 22491, PropCategory.REGULAR)
