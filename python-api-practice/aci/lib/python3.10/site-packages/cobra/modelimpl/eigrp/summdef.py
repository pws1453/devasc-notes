...
class SummDef(Mo):
    """
    The EIGRP summary route definition.

    """

    meta = ClassMeta("cobra.model.eigrp.SummDef")

    meta.moClassName = "eigrpSummDef"
    ...
    prop = PropMeta("str", "addr", "addr", 17988, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
