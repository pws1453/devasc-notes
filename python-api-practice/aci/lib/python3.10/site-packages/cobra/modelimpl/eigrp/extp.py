...
class ExtP(Mo):
    ...
    meta = ClassMeta("cobra.model.eigrp.ExtP")

    meta.moClassName = "eigrpExtP"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38172, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40311, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
