...
# ##################################################
class RsIfDefToEigrpIf(Mo):
    """
    A source relation to EIGRP interfaces.

    """

    meta = SourceRelationMeta("cobra.model.eigrp.RsIfDefToEigrpIf", "cobra.model.eigrp.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "eigrpRsIfDefToEigrpIf"
    meta.rnFormat = "rsIfDefToEigrpIf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EIGRP Interface"
    ...
    meta.parentClasses.add("cobra.model.eigrp.IfDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsIfDefToEigrpIf', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 18011, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5854
    prop.defaultValueStr = "eigrpIf"
    prop._addConstant("eigrpIf", None, 5854)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18010, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 18017, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
