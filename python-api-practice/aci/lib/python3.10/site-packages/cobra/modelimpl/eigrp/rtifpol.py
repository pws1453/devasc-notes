...
class RtIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.eigrp.RtIfPol", "cobra.model.eigrp.IfP")

    meta.moClassName = "eigrpRtIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18009, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6044
    prop.defaultValueStr = "eigrpIfP"
    prop._addConstant("eigrpIfP", None, 6044)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18008, PropCategory.REGULAR)
