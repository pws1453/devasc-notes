...
class CtxAfDef(Mo):
    """
    The context-level EIGRP address family definition.

    """

    meta = ClassMeta("cobra.model.eigrp.CtxAfDef")

    meta.moClassName = "eigrpCtxAfDef"
    meta.rnFormat = "eigrpCtxP-%(af)s"
    ...
    meta.childClasses.add("cobra.model.eigrp.StubDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.StubDef", "stub"))
    ...
    prop = PropMeta("str", "af", "af", 17975, PropCategory.REGULAR)
