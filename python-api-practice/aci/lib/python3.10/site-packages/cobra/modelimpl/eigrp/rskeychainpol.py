...
# ##################################################
class RsKeyChainPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.eigrp.RsKeyChainPol", "cobra.model.fv.KeyChainPol")
    meta.targetNameProps["name"] = "tnFvKeyChainPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "eigrpRsKeyChainPol"
    meta.rnFormat = "rsKeyChainPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "KeyChain Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 49926, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49927, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 49917, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14328
    prop.defaultValueStr = "fvKeyChainPol"
    ...
    prop = PropMeta("str", "tnFvKeyChainPolName", "tnFvKeyChainPolName", 49916, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFvKeyChainPolName", prop)
