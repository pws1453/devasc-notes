...
class RtSummPol(Mo):
    ...
    meta = ClassMeta("cobra.model.eigrp.RtSummPol")

    meta.moClassName = "eigrpRtSummPol"
    meta.rnFormat = "eigrprtsumm-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EIGRP route summarization policy"
    ...
    meta.superClasses.add("cobra.model.eigrp.ARtSummPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38364, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40503, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 22788, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
