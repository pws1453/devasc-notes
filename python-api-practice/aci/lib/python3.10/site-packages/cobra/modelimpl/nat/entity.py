...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.nat.Entity")

    meta.moClassName = "natEntity"
    meta.rnFormat = "nat"
    meta.category = MoCategory.REGULAR
    meta.label = "NAT Entity"
    ...
    meta.childClasses.add("cobra.model.nat.Entry")

    meta.childNamesAndRnPrefix.append(("cobra.model.nat.Entry", "entry-"))
