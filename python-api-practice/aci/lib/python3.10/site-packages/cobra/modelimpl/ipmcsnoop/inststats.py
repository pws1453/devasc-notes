...
# ##################################################
class InstStats(Mo):
    meta = ClassMeta("cobra.model.ipmcsnoop.InstStats")

    meta.isAbstract = True
    meta.moClassName = "ipmcsnoopInstStats"
    ...
    meta.concreteSubClasses.add("cobra.model.mldsnoop.InstStats")
    meta.concreteSubClasses.add("cobra.model.igmpsnoop.InstStats")
