...
# ##################################################
class Dom(Mo):
    meta = ClassMeta("cobra.model.ipmcsnoop.Dom")

    meta.isAbstract = True
    meta.moClassName = "ipmcsnoopDom"


    meta.moClassName = "ipmcsnoopDom"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "IP Multicast Snooping Domain"
    ...
    prop = PropMeta("str", "encap", "encap", 16881, PropCategory.REGULAR)
    prop.label = "L2 Domain Fabric Encap"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "flags", "flags", 16883, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
