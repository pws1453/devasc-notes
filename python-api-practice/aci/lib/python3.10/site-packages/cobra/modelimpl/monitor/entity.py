...
class Entity(Mo):
    """
    Span manager control plane entity information.

    """

    meta = ClassMeta("cobra.model.monitor.Entity")

    meta.moClassName = "monitorEntity"
    meta.rnFormat = "monitor"
    ...
    meta.childClasses.add("cobra.model.monitor.Session")
    meta.childClasses.add("cobra.model.monitor.Db")

    meta.childNamesAndRnPrefix.append(("cobra.model.monitor.Session", "session-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.monitor.Db", "db-"))
