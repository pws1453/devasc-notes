...
# ##################################################
class AcPbDataA(Mo):
    meta = ClassMeta("cobra.model.dbg.AcPbDataA")

    meta.isAbstract = True
    meta.moClassName = "dbgAcPbDataA"


    meta.moClassName = "dbgAcPbDataA"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Class for Atomic Counter Probe Data"
    ...
    meta.concreteSubClasses.add("cobra.model.dbg.DVPCPath")
    meta.concreteSubClasses.add("cobra.model.dbg.AcLinkS2T")
    meta.concreteSubClasses.add("cobra.model.dbg.AcPath")
    meta.concreteSubClasses.add("cobra.model.dbg.SVPCPath")
    meta.concreteSubClasses.add("cobra.model.dbg.ACPbPathStats")
    meta.concreteSubClasses.add("cobra.model.dbg.SDVPCPath")
