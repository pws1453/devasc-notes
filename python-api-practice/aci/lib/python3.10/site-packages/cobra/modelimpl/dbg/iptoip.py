...
class IpToIp(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.IpToIp")

    meta.moClassName = "dbgIpToIp"
    meta.rnFormat = "ipToIp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 23088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 23090, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 23091, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 23092, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 23087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 23093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 23089, PropCategory.REGULAR)
