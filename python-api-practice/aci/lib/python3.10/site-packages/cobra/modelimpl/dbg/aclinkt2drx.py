...
# ##################################################
class AcLinkT2DRx(Mo):
    """
    Atomic Counter Link T2DRx.

    """

    meta = ClassMeta("cobra.model.dbg.AcLinkT2DRx")

    meta.moClassName = "dbgAcLinkT2DRx"
    meta.rnFormat = "linkT2DRx-%(srcSlotId)s-%(srcPortId)s-to-%(dstSlotId)s-%(dstPortId)s"
    ...
    prop = PropMeta("str", "dstPortId", "dstPortId", 6021, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstSlotId", "dstSlotId", 6024, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPortId", "srcPortId", 6022, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcSlotId", "srcSlotId", 6023, PropCategory.REGULAR)
