...
# ##################################################
class AcLinkT2DTx(Mo):
    """
    The atomic counter link T2DTx.

    """

    meta = ClassMeta("cobra.model.dbg.AcLinkT2DTx")

    meta.moClassName = "dbgAcLinkT2DTx"
    meta.rnFormat = "linkT2DTx-%(srcSlotId)s-%(srcPortId)s-to-%(dstSlotId)s-%(dstPortId)s"
    ...
    prop = PropMeta("str", "dstPortId", "dstPortId", 6025, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstSlotId", "dstSlotId", 6028, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPortId", "srcPortId", 6026, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcSlotId", "srcSlotId", 6027, PropCategory.REGULAR)
