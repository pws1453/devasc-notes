...
# ##################################################
class RsTenantToDomainRef(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.dbg.RsTenantToDomainRef", "cobra.model.aaa.DomainRef")
    meta.targetNameProps["name"] = "tnAaaDomainRefName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgRsTenantToDomainRef"
    meta.rnFormat = "rsTenantToDomainRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Tenant To AAA Domain Ref"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16353, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16350, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnAaaDomainRefName", "tnAaaDomainRefName", 16349, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
