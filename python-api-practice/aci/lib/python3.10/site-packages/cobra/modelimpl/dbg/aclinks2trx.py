...
# ##################################################
class AcLinkS2TRx(Mo):
    """
    The atomic counter link S2TRx.

    """

    meta = ClassMeta("cobra.model.dbg.AcLinkS2TRx")

    meta.moClassName = "dbgAcLinkS2TRx"
    meta.rnFormat = "linkS2TRx-%(srcSlotId)s-%(srcPortId)s-to-%(dstSlotId)s-%(dstPortId)s"
    ...
    meta.parentClasses.add("cobra.model.dbg.AcTrailRx")
    ...
    prop = PropMeta("str", "dstPortId", "dstPortId", 6013, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstSlotId", "dstSlotId", 6016, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPortId", "srcPortId", 6014, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcSlotId", "srcSlotId", 6015, PropCategory.REGULAR)
