...
class DVPCPathTx(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.DVPCPathTx")

    meta.moClassName = "dbgDVPCPathTx"
    meta.rnFormat = "dvpcpathTx-%(srcNodeId)s-to-%(dstNodeId)s-%(dstNodeId2)s"
    meta.category = MoCategory.REGULAR
    meta.label = "On-Going Path Atomic Counter Transmit Stats"
    ...
    meta.childClasses.add("cobra.model.dbg.AcTrailTx")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcTrailTx", "trailTx-"))
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 16012, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstNodeId2", "dstNodeId2", 16010, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 16011, PropCategory.REGULAR)
