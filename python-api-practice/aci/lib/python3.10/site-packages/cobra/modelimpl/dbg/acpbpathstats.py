...
# ##################################################
class ACPbPathStats(Mo):
    """
    The atomic counter probe path statistics.

    """

    meta = ClassMeta("cobra.model.dbg.ACPbPathStats")

    meta.moClassName = "dbgACPbPathStats"
    meta.rnFormat = "pstats-s-%(srcNodeId)s-d-%(dstNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "On Demand Fabric Atomic Counter"
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 6010, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 6011, PropCategory.REGULAR)
