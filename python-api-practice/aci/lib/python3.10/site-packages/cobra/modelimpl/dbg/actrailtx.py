...
class AcTrailTx(Mo):
    """
    The atomic counter trail Tx.

    """

    meta = ClassMeta("cobra.model.dbg.AcTrailTx")

    meta.moClassName = "dbgAcTrailTx"
    meta.rnFormat = "trailTx-%(transitNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "On-Going Trail Atomic Counter Transmit Stats"
    ...
    meta.childClasses.add("cobra.model.dbg.AcLinkS2TTx")
    meta.childClasses.add("cobra.model.dbg.AcLinkT2DTx")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcLinkS2TTx", "linkS2TTx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcLinkT2DTx", "linkT2DTx-"))

    meta.parentClasses.add("cobra.model.dbg.AcPathTx")
    meta.parentClasses.add("cobra.model.dbg.SVPCPathTx")
    meta.parentClasses.add("cobra.model.dbg.DVPCPathTx")
    ...
    prop = PropMeta("str", "transitNodeId", "transitNodeId", 4575, PropCategory.REGULAR)
    prop.label = "Transit Node Id for the Trail"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("transitNodeId", prop)

    meta.namingProps.append(getattr(meta.props, "transitNodeId"))

    def __init__(self, parentMoOrDn, transitNodeId, markDirty=True, **creationProps):
        namingVals = [transitNodeId]
