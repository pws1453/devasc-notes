...
class RtAcTrail(Mo):
    """
    A target relation to the atomic counter link.

    """

    meta = TargetRelationMeta("cobra.model.dbg.RtAcTrail", "cobra.model.fabric.Trail")

    meta.moClassName = "dbgRtAcTrail"
    meta.rnFormat = "rtacTrail"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11340, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 486
    prop.defaultValueStr = "fabricTrail"
