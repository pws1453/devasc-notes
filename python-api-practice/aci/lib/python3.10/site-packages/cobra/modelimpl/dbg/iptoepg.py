...
class IpToEpg(Mo):
    """
    IP to endpoint atomic counter, On-demand, Entry.

    """

    meta = ClassMeta("cobra.model.dbg.IpToEpg")

    meta.moClassName = "dbgIpToEpg"
    meta.rnFormat = "IpoEpg-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4514, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6099, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6100, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4513, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6102, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6098, PropCategory.REGULAR)
