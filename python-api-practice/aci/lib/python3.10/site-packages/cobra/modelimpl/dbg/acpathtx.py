...
class AcPathTx(Mo):
    """
    Used for per-link and per-path per-link.

    """

    meta = ClassMeta("cobra.model.dbg.AcPathTx")

    meta.moClassName = "dbgAcPathTx"
    meta.rnFormat = "pathTx-%(srcNodeId)s-to-%(dstNodeId)s"
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 6034, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 6033, PropCategory.REGULAR)
