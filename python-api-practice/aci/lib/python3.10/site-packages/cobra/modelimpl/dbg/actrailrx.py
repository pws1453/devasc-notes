...
class AcTrailRx(Mo):
    """
    The atomic counter trail Rx.

    """

    meta = ClassMeta("cobra.model.dbg.AcTrailRx")

    meta.moClassName = "dbgAcTrailRx"
    meta.rnFormat = "trailRx-%(transitNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "On-Going Trail Atomic Counter Receive Stats"
    ...
    meta.childClasses.add("cobra.model.dbg.AcLinkS2TRx")
    meta.childClasses.add("cobra.model.dbg.AcLinkT2DRx")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcLinkS2TRx", "linkS2TRx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcLinkT2DRx", "linkT2DRx-"))

    meta.parentClasses.add("cobra.model.dbg.SVPCPathRx")
    meta.parentClasses.add("cobra.model.dbg.DVPCPathRx")
    meta.parentClasses.add("cobra.model.dbg.AcPathRx")
    ...
    prop = PropMeta("str", "transitNodeId", "transitNodeId", 4576, PropCategory.REGULAR)
