...
class DVPCPath(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.DVPCPath")

    meta.moClassName = "dbgDVPCPath"
    meta.rnFormat = "dvpcpath-%(srcNodeId)s-to-%(dstNodeId)s-%(dstNodeId2)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counter for a Path from a single node to a VPC pair"
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 16006, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstNodeId2", "dstNodeId2", 16004, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16036, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 16005, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, srcNodeId, dstNodeId, dstNodeId2, markDirty=True, **creationProps):
        namingVals = [srcNodeId, dstNodeId, dstNodeId2]
