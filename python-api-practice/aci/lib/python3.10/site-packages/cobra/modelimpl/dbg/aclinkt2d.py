...
class AcLinkT2D(Mo):
    """
    S2L: Transit spine to destination leaf node of the trail.

    """

    meta = ClassMeta("cobra.model.dbg.AcLinkT2D")

    meta.moClassName = "dbgAcLinkT2D"
    meta.rnFormat = "trnstP-%(trnstP)s-dstP-%(dstP)s"
    ...
    meta.childClasses.add("cobra.model.dbg.RtAcLinkT2D")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.RtAcLinkT2D", "rtacLinkT2D"))
    ...
    prop = PropMeta("str", "dstP", "dstP", 4669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "trnstP", "trnstP", 4668, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "dstP"))

    def __init__(self, parentMoOrDn, trnstP, dstP, markDirty=True, **creationProps):
        namingVals = [trnstP, dstP]
