...
# ##################################################
class RtResOngoingAcMode(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.dbg.RtResOngoingAcMode", "cobra.model.fabric.Inst")

    meta.moClassName = "dbgRtResOngoingAcMode"
    meta.rnFormat = "rtresOngoingAcMode"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16576, PropCategory.REGULAR)
