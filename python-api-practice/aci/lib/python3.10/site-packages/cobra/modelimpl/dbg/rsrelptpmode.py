...
# ##################################################
class RsRelPtpMode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.dbg.RsRelPtpMode", "cobra.model.latency.PtpMode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgRsRelPtpMode"
    meta.rnFormat = "rsrelPtpMode"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation between dbg container and ptp mode"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34358, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34357, PropCategory.REGULAR)
