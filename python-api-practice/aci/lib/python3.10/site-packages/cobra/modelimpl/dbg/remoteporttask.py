...
# ##################################################
class RemotePortTask(Mo):
    """
    The remote port task.

    """

    meta = ClassMeta("cobra.model.dbg.RemotePortTask")

    meta.moClassName = "dbgRemotePortTask"
    meta.rnFormat = "dbgRemotePortTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5659, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateRemotePortToDbgrelem", "updateremoteporttodbgrelem", 667)
