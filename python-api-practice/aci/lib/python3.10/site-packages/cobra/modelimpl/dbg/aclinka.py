...
# ##################################################
class AcLinkA(Mo):
    meta = ClassMeta("cobra.model.dbg.AcLinkA")

    meta.isAbstract = True
    meta.moClassName = "dbgAcLinkA"


    meta.moClassName = "dbgAcLinkA"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "On-Going Link Atomic Counter Stats"
    ...
    prop = PropMeta("str", "dstPortId", "dstPortId", 4580, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstSlotId", "dstSlotId", 4579, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPortId", "srcPortId", 4578, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcSlotId", "srcSlotId", 4577, PropCategory.REGULAR)
