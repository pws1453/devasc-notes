...
class RsOgAcMode(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbg.RsOgAcMode", "cobra.model.dbg.OngoingAcMode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgRsOgAcMode"
    meta.rnFormat = "rsOgAcMode"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17874, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17873, PropCategory.REGULAR)
