...
class EpgToIp(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.EpgToIp")

    meta.moClassName = "dbgEpgToIp"
    meta.rnFormat = "epgToIp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4512, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6080, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6081, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6082, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6078, PropCategory.REGULAR)
