...
class EpToIp(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.EpToIp")

    meta.moClassName = "dbgEpToIp"
    meta.rnFormat = "epToIp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4502, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6061, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6062, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6063, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4501, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6064, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6060, PropCategory.REGULAR)
