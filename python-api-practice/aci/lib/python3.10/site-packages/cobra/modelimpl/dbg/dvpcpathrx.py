...
class DVPCPathRx(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.DVPCPathRx")

    meta.moClassName = "dbgDVPCPathRx"
    meta.rnFormat = "dvpcpathRx-%(srcNodeId)s-to-%(dstNodeId)s-%(dstNodeId2)s"
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 16009, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstNodeId2", "dstNodeId2", 16007, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 16008, PropCategory.REGULAR)
