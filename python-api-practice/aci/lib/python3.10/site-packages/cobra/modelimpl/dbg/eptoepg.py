...
class EpToEpg(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.EpToEpg")

    meta.moClassName = "dbgEpToEpg"
    meta.rnFormat = "epToEpg-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4508, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6055, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6056, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6057, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4507, PropCategory.REGULAR)
    prop.label = "Source EP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6058, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6054, PropCategory.REGULAR)
