...
class IpToEp(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.IpToEp")

    meta.moClassName = "dbgIpToEp"
    meta.rnFormat = "IpToep-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4504, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6094, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6095, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4503, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6096, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6092, PropCategory.REGULAR)
