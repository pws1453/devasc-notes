...
class EpgToEpg(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.EpgToEpg")

    meta.moClassName = "dbgEpgToEpg"
    meta.rnFormat = "epgToEpg-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    meta.superClasses.add("cobra.model.dbg.AcOdE")
    ...
    prop = PropMeta("str", "dst", "dst", 4516, PropCategory.REGULAR)
    prop.label = "Destination EPG Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6073, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6074, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6075, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4515, PropCategory.REGULAR)
    prop.label = "Source EPG Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6076, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6072, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, tenantName, ruleName, type, localNodeId, src, dst, filtEnt, markDirty=True, **creationProps):
        namingVals = [tenantName, ruleName, type, localNodeId, src, dst, filtEnt]
