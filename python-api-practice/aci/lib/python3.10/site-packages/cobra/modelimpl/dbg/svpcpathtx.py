...
class SVPCPathTx(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.SVPCPathTx")

    meta.moClassName = "dbgSVPCPathTx"
    meta.rnFormat = "svpcpathTx-%(srcNodeId)s-%(srcNodeId2)s-to-%(dstNodeId)s"
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 16033, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 16032, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId2", "srcNodeId2", 16031, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, srcNodeId, srcNodeId2, dstNodeId, markDirty=True, **creationProps):
        namingVals = [srcNodeId, srcNodeId2, dstNodeId]
