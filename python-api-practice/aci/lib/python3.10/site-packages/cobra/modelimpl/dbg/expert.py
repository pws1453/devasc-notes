...
class Expert(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.Expert")

    meta.moClassName = "dbgExpert"
    meta.rnFormat = "expert-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6085, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6086, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6084, PropCategory.REGULAR)
