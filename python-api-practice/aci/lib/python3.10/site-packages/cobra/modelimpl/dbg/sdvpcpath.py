...
class SDVPCPath(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.SDVPCPath")

    meta.moClassName = "dbgSDVPCPath"
    meta.rnFormat = "sdvpcpath-%(srcNodeId)s-%(srcNodeId2)s-to-%(dstNodeId)s-%(dstNodeId2)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counter for a Path from a VPC pair to a VPC pair"
    ...
    meta.childClasses.add("cobra.model.dbg.SVPCPathRx")
    meta.childClasses.add("cobra.model.dbg.AcPathRx")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.dbg.AcPathTx")
    meta.childClasses.add("cobra.model.dbg.DVPCPathRx")
    meta.childClasses.add("cobra.model.dbg.SVPCPathTx")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.dbg.DVPCPathTx")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.dbg.AcTrail")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.SVPCPathRx", "svpcpathRx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.DVPCPathRx", "dvpcpathRx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.SVPCPathTx", "svpcpathTx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.DVPCPathTx", "dvpcpathTx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcPathRx", "pathRx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcPathTx", "pathTx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcTrail", "trnst-"))

    meta.parentClasses.add("cobra.model.dbg.AC")

    meta.superClasses.add("cobra.model.dbg.AcPbDataA")
    meta.superClasses.add("cobra.model.dbg.AcPathA")
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 16016, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstNodeId2", "dstNodeId2", 16013, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16034, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 16015, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId2", "srcNodeId2", 16014, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "srcNodeId2"))
    meta.namingProps.append(getattr(meta.props, "dstNodeId"))
    meta.namingProps.append(getattr(meta.props, "dstNodeId2"))

    def __init__(self, parentMoOrDn, srcNodeId, srcNodeId2, dstNodeId, dstNodeId2, markDirty=True, **creationProps):
        namingVals = [srcNodeId, srcNodeId2, dstNodeId, dstNodeId2]
