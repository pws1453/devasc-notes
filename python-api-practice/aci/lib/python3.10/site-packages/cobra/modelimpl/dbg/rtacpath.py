...
class RtAcPath(Mo):
    """
    A target relation to the atomic counter path.

    """

    meta = TargetRelationMeta("cobra.model.dbg.RtAcPath", "cobra.model.fabric.Path")

    meta.moClassName = "dbgRtAcPath"
    meta.rnFormat = "rtacPath"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Fabric Path"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11337, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 483
    prop.defaultValueStr = "fabricPath"
