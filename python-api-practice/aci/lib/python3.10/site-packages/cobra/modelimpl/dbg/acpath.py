...
class AcPath(Mo):
    """
    The atomic counter path.

    """

    meta = ClassMeta("cobra.model.dbg.AcPath")

    meta.moClassName = "dbgAcPath"
    meta.rnFormat = "path-%(srcNodeId)s-to-%(dstNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counter for a Path"
    ...
    meta.childClasses.add("cobra.model.dbg.RtAcPath")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.RtAcPath", "rtacPath"))
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 6030, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15552, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 6029, PropCategory.REGULAR)
