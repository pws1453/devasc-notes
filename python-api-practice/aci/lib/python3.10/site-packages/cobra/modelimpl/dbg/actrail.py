...
class AcTrail(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.AcTrail")

    meta.moClassName = "dbgAcTrail"
    meta.rnFormat = "trnst-%(trnstNodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Atomic Counter for a Trail"
    ...
    meta.childClasses.add("cobra.model.dbg.AcLinkS2T")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.dbg.AcLinkT2D")
    meta.childClasses.add("cobra.model.dbg.RtAcTrail")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.RtAcTrail", "rtacTrail"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcLinkT2D", "trnstP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbg.AcLinkS2T", "srcP-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15553, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "trnstNodeId", "trnstNodeId", 6035, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "trnstNodeId"))

    def __init__(self, parentMoOrDn, trnstNodeId, markDirty=True, **creationProps):
        namingVals = [trnstNodeId]
