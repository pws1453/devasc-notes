...
# ##################################################
class RsLatencyOgMode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.dbg.RsLatencyOgMode", "cobra.model.latency.OngoingMode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgRsLatencyOgMode"
    meta.rnFormat = "rsLatencyOgMode"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation between dbg container and ongoing latency mode"
    ...
    meta.parentClasses.add("cobra.model.dbg.RelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsLatencyOgMode', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 33150, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9816
    prop.defaultValueStr = "latencyOngoingMode"
    prop._addConstant("latencyOngoingMode", None, 9816)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33149, PropCategory.REGULAR)
