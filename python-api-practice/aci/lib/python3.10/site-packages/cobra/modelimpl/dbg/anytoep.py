...
class AnyToEp(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.AnyToEp")

    meta.moClassName = "dbgAnyToEp"
    meta.rnFormat = "AnyToEp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4506, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6037, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6038, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6039, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6040, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6036, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, tenantName, ruleName, type, localNodeId, dst, filtEnt, markDirty=True, **creationProps):
        namingVals = [tenantName, ruleName, type, localNodeId, dst, filtEnt]
