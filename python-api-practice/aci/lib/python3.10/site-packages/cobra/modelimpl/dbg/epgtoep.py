...
class EpgToEp(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.EpgToEp")

    meta.moClassName = "dbgEpgToEp"
    meta.rnFormat = "epgToEp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4510, PropCategory.REGULAR)
    prop.label = "Destination EP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6067, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6068, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6069, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4509, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6070, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6066, PropCategory.REGULAR)
