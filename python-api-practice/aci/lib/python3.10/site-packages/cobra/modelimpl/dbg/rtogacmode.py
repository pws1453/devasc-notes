...
class RtOgAcMode(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.dbg.RtOgAcMode", "cobra.model.dbg.RelnHolder")

    meta.moClassName = "dbgRtOgAcMode"
    meta.rnFormat = "rtogAcMode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17875, PropCategory.REGULAR)
