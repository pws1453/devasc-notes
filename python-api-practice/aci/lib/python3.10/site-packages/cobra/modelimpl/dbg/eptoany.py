...
class EpToAny(Mo):
    """
    Endpoint to any atomic counter, On-demand, Entry.

    """

    meta = ClassMeta("cobra.model.dbg.EpToAny")

    meta.moClassName = "dbgEpToAny"
    meta.rnFormat = "epToAny-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-e-%(filtEnt)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ep to any Atomic Counter Entry Stats"
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6043, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6044, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6045, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4505, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6046, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6042, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, tenantName, ruleName, type, localNodeId, src, filtEnt, markDirty=True, **creationProps):
        namingVals = [tenantName, ruleName, type, localNodeId, src, filtEnt]
