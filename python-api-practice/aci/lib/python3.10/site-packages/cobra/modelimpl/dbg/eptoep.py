...
class EpToEp(Mo):
    """
    Endpoint to endpoint atomic counter, On-demand, Entry.

    """

    meta = ClassMeta("cobra.model.dbg.EpToEp")

    meta.moClassName = "dbgEpToEp"
    meta.rnFormat = "epToEp-tn-%(tenantName)s-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-s-[%(src)s]-d-[%(dst)s]-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "dst", "dst", 4500, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6050, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6051, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "src", "src", 4499, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 6052, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6048, PropCategory.REGULAR)
