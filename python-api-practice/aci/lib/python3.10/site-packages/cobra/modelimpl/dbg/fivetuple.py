...
class FiveTuple(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.FiveTuple")

    meta.moClassName = "dbgFiveTuple"
    meta.rnFormat = "fiveTuple-r-%(ruleName)s-%(type)s-l-%(localNodeId)s-e-%(filtEnt)s"
    ...
    prop = PropMeta("str", "filtEnt", "filtEnt", 6089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 6090, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 6091, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 6088, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, ruleName, type, localNodeId, filtEnt, markDirty=True, **creationProps):
        namingVals = [ruleName, type, localNodeId, filtEnt]
