...
class SVPCPathRx(Mo):
    ...
    meta = ClassMeta("cobra.model.dbg.SVPCPathRx")

    meta.moClassName = "dbgSVPCPathRx"
    meta.rnFormat = "svpcpathRx-%(srcNodeId)s-%(srcNodeId2)s-to-%(dstNodeId)s"
    ...
    prop = PropMeta("str", "dstNodeId", "dstNodeId", 16030, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId", "srcNodeId", 16029, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcNodeId2", "srcNodeId2", 16028, PropCategory.REGULAR)
