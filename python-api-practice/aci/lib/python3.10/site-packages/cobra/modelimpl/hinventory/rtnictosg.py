...
class RtNicToSG(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hinventory.RtNicToSG", "cobra.model.hinventory.NetworkInterface")

    meta.moClassName = "hinventoryRtNicToSG"
    meta.rnFormat = "rtnicToSG-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51398, PropCategory.REGULAR)
