...
# ##################################################
class ApplicationSecurityGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.ApplicationSecurityGroup")

    meta.moClassName = "hinventoryApplicationSecurityGroup"
    meta.rnFormat = "asg-%(cloudProviderId)s"
    ...
    meta.childClasses.add("cobra.model.hinventory.RtNicToAsg")
    meta.childClasses.add("cobra.model.hinventory.RsAsgToRegion")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsAsgToRegion", "rsasgToRegion"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RtNicToAsg", "rtnicToAsg-"))
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 54973, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "location", "location", 54957, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("location", prop)
