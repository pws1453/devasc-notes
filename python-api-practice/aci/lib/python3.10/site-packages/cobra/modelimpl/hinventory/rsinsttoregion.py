...
# ##################################################
class RsInstToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsInstToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsInstToRegion"
    meta.rnFormat = "rsinstToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "inst-to-reg"
    ...
    meta.rnPrefixes = [
        ('rsinstToRegion', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55130, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55131, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55004, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55003, PropCategory.REGULAR)
