...
# ##################################################
class RsNexthopIgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsNexthopIgw", "cobra.model.hinventory.InternetGateway")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsNexthopIgw"
    meta.rnFormat = "rsNexthopIgw"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nh-to-igw"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51678, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51679, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51421, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15039
    prop.defaultValueStr = "hinventoryInternetGateway"
    prop._addConstant("hinventoryInternetGateway", None, 15039)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51420, PropCategory.REGULAR)
