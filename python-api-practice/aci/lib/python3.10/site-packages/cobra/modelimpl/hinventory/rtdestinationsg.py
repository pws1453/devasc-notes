...
# ##################################################
class RtDestinationSG(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtDestinationSG", "cobra.model.hinventory.EgressRule")

    meta.moClassName = "hinventoryRtDestinationSG"
    meta.rnFormat = "rtdestinationSG-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51391, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15029
    prop.defaultValueStr = "hinventoryEgressRule"
    prop._addConstant("hinventoryEgressRule", None, 15029)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51390, PropCategory.REGULAR)
