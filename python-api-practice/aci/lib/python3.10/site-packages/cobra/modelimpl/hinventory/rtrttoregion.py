...
# ##################################################
class RtRtToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtRtToRegion", "cobra.model.hinventory.RouteTable")

    meta.moClassName = "hinventoryRtRtToRegion"
    meta.rnFormat = "rtrtToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55040, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15051
    prop.defaultValueStr = "hinventoryRouteTable"
    prop._addConstant("hinventoryRouteTable", None, 15051)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55039, PropCategory.REGULAR)
