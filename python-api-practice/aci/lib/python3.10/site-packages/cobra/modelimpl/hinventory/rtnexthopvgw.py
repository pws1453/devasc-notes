...
# ##################################################
class RtNexthopVgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtNexthopVgw", "cobra.model.hinventory.RouteTableEntry")

    meta.moClassName = "hinventoryRtNexthopVgw"
    meta.rnFormat = "rtnexthopVgw-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51431, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51430, PropCategory.REGULAR)
