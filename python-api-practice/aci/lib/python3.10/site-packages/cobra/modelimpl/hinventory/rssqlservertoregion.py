...
# ##################################################
class RsSqlServerToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsSqlServerToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsSqlServerToRegion"
    meta.rnFormat = "rsSqlServerToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "sqlserver-to-reg"
    ...
    meta.rnPrefixes = [
        ('rsSqlServerToRegion', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55170, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55171, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55092, PropCategory.REGULAR)
