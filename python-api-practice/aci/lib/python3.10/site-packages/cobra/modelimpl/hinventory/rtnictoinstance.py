...
# ##################################################
class RtNicToInstance(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtNicToInstance", "cobra.model.hinventory.NetworkInterface")

    meta.moClassName = "hinventoryRtNicToInstance"
    meta.rnFormat = "rtnicToInstance-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51394, PropCategory.REGULAR)
