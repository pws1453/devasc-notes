...
# ##################################################
class RtAsgToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtAsgToRegion", "cobra.model.hinventory.ApplicationSecurityGroup")

    meta.moClassName = "hinventoryRtAsgToRegion"
    meta.rnFormat = "rtasgToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55067, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55066, PropCategory.REGULAR)
