...
# ##################################################
class RtConnToVgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtConnToVgw", "cobra.model.hinventory.VpnConnection")

    meta.moClassName = "hinventoryRtConnToVgw"
    meta.rnFormat = "rtconnToVgw-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51415, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51414, PropCategory.REGULAR)
