...
# ##################################################
class RtNicToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtNicToSubnet", "cobra.model.hinventory.NetworkInterface")

    meta.moClassName = "hinventoryRtNicToSubnet"
    meta.rnFormat = "rtnicToSubnet-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55021, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55020, PropCategory.REGULAR)
