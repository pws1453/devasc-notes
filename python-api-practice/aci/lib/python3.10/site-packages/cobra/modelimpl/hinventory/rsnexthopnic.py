...
# ##################################################
class RsNexthopNic(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsNexthopNic", "cobra.model.hinventory.NetworkInterface")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsNexthopNic"
    meta.rnFormat = "rsNexthopNic"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nh-to-nic"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51682, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51683, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51425, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15034
    prop.defaultValueStr = "hinventoryNetworkInterface"
    prop._addConstant("hinventoryNetworkInterface", None, 15034)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51424, PropCategory.REGULAR)
