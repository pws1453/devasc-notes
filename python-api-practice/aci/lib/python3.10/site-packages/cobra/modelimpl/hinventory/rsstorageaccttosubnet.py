...
# ##################################################
class RsStorageAcctToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsStorageAcctToSubnet", "cobra.model.hinventory.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsStorageAcctToSubnet"
    meta.rnFormat = "rsstorageAcctToSubnet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "storageacct-to-subnet"
    ...
    meta.rnPrefixes = [
        ('rsstorageAcctToSubnet-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55164, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55165, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55089, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15032
    prop.defaultValueStr = "hinventorySubnet"
    prop._addConstant("hinventorySubnet", None, 15032)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55088, PropCategory.REGULAR)
