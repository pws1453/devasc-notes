...
# ##################################################
class RtLbToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtLbToRegion", "cobra.model.hinventory.LoadBalancer")

    meta.moClassName = "hinventoryRtLbToRegion"
    meta.rnFormat = "rtlbToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55047, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15061
    prop.defaultValueStr = "hinventoryLoadBalancer"
    prop._addConstant("hinventoryLoadBalancer", None, 15061)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55046, PropCategory.REGULAR)
