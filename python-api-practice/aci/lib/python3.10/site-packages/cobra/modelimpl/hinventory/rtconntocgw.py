...
# ##################################################
class RtConnToCgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtConnToCgw", "cobra.model.hinventory.VpnConnection")

    meta.moClassName = "hinventoryRtConnToCgw"
    meta.rnFormat = "rtconnToCgw-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51411, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51410, PropCategory.REGULAR)
