...
# ##################################################
class RsStorageAcctToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsStorageAcctToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsStorageAcctToRegion"
    meta.rnFormat = "rsStorageAcctToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "storageacct-to-reg"
    ...
    meta.rnPrefixes = [
        ('rsStorageAcctToRegion', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55166, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55167, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55085, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15023
    prop.defaultValueStr = "hinventoryRegion"
    prop._addConstant("hinventoryRegion", None, 15023)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55084, PropCategory.REGULAR)
