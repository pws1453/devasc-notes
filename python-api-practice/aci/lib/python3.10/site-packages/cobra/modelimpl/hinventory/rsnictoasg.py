...
class RsNicToAsg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hinventory.RsNicToAsg", "cobra.model.hinventory.ApplicationSecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsNicToAsg"
    meta.rnFormat = "rsnicToAsg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nic-to-asg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55142, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55143, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55008, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16141
    prop.defaultValueStr = "hinventoryApplicationSecurityGroup"
    prop._addConstant("hinventoryApplicationSecurityGroup", None, 16141)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55007, PropCategory.REGULAR)
