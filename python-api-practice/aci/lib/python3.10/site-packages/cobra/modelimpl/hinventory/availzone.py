...
class AvailZone(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.AvailZone")

    meta.moClassName = "hinventoryAvailZone"
    meta.rnFormat = "az-[%(name)s]"
    ...
    prop = PropMeta("str", "name", "name", 52157, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "state", "state", 52155, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "available"
    prop._addConstant("available", "available", 0)
    prop._addConstant("impaired", "impaired", 2)
    prop._addConstant("information", "information", 1)
    prop._addConstant("unavailable", "unavailable", 3)
