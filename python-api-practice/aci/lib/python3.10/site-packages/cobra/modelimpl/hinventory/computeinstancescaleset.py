...
# ##################################################
class ComputeInstanceScaleSet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.ComputeInstanceScaleSet")

    meta.moClassName = "hinventoryComputeInstanceScaleSet"
    meta.rnFormat = "instss-[%(name)s]"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsInstSetToRegion")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsInstSetToRegion", "rsInstSetToRegion"))
    ...
    prop = PropMeta("str", "State", "State", 54958, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "name", "name", 54974, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
