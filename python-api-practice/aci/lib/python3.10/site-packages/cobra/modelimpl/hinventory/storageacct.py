...
# ##################################################
class StorageAcct(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.StorageAcct")

    meta.moClassName = "hinventoryStorageAcct"
    meta.rnFormat = "storageacct-[%(name)s]"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsStorageAcctToSubnet")
    meta.childClasses.add("cobra.model.hinventory.Tag")
    meta.childClasses.add("cobra.model.hinventory.StaleResource")
    meta.childClasses.add("cobra.model.hinventory.RsStorageAcctToRegion")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsStorageAcctToSubnet", "rsstorageAcctToSubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsStorageAcctToRegion", "rsStorageAcctToRegion"))
    ...
    prop = PropMeta("str", "ipRules", "ipRules", 54960, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("ipRules", prop)
    ...
    prop = PropMeta("str", "name", "name", 54978, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
