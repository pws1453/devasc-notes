...
class Inventory(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.Inventory")

    meta.moClassName = "hinventoryInventory"
    meta.rnFormat = "inventory"
    ...
    meta.childClasses.add("cobra.model.hinventory.Provider")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.Provider", "provider-"))
