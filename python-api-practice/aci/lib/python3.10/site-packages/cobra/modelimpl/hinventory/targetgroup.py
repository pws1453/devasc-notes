...
# ##################################################
class TargetGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.TargetGroup")

    meta.moClassName = "hinventoryTargetGroup"
    meta.rnFormat = "tg-[%(name)s]"
    ...
    prop = PropMeta("str", "arn", "arn", 50481, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "name", "name", 50781, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
