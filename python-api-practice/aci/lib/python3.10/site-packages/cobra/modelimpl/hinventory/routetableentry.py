...
# ##################################################
class RouteTableEntry(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.RouteTableEntry")

    meta.moClassName = "hinventoryRouteTableEntry"
    meta.rnFormat = "rtentry-[%(DestAddress)s]-%(NextHop)s"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsNexthopIgw")
    meta.childClasses.add("cobra.model.hinventory.RsNexthopVgw")
    meta.childClasses.add("cobra.model.hinventory.RsNexthopNic")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsNexthopIgw", "rsNexthopIgw"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsNexthopVgw", "rsNexthopVgw"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsNexthopNic", "rsNexthopNic"))
    ...
    prop = PropMeta("str", "DestAddress", "DestAddress", 50479, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("DestAddress", prop)

    prop = PropMeta("str", "NextHop", "NextHop", 52239, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "DestAddress"))
    getattr(meta.props, "DestAddress").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "NextHop"))

    def __init__(self, parentMoOrDn, DestAddress, NextHop, markDirty=True, **creationProps):
        namingVals = [DestAddress, NextHop]
