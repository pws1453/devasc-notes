...
class RtRtToSub(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hinventory.RtRtToSub", "cobra.model.hinventory.RouteTable")

    meta.moClassName = "hinventoryRtRtToSub"
    meta.rnFormat = "rtRtToSub"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51419, PropCategory.REGULAR)
