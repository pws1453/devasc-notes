...
class SqlServer(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.SqlServer")

    meta.moClassName = "hinventorySqlServer"
    meta.rnFormat = "sqlserver-[%(name)s]"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsSqlServerToSubnet")
    meta.childClasses.add("cobra.model.hinventory.Tag")
    meta.childClasses.add("cobra.model.hinventory.StaleResource")
    meta.childClasses.add("cobra.model.hinventory.SqlDb")
    meta.childClasses.add("cobra.model.hinventory.RsSqlServerToRegion")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsSqlServerToSubnet", "rssqlServerToSubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsSqlServerToRegion", "rsSqlServerToRegion"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.SqlDb", "sqldb-"))
    ...
    prop = PropMeta("str", "name", "name", 54977, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
