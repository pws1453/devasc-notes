...
# ##################################################
class RtInstToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtInstToRegion", "cobra.model.hinventory.ComputeInstance")

    meta.moClassName = "hinventoryRtInstToRegion"
    meta.rnFormat = "rtinstToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55006, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55005, PropCategory.REGULAR)
