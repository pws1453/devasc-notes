...
# ##################################################
class RtNexthopNic(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtNexthopNic", "cobra.model.hinventory.RouteTableEntry")

    meta.moClassName = "hinventoryRtNexthopNic"
    meta.rnFormat = "rtnexthopNic-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51427, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51426, PropCategory.REGULAR)
