...
# ##################################################
class RtConnToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtConnToRegion", "cobra.model.hinventory.VpnConnection")

    meta.moClassName = "hinventoryRtConnToRegion"
    meta.rnFormat = "rtconnToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55036, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15046
    prop.defaultValueStr = "hinventoryVpnConnection"
    prop._addConstant("hinventoryVpnConnection", None, 15046)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55035, PropCategory.REGULAR)
