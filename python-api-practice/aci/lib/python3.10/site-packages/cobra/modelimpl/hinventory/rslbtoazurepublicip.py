...
# ##################################################
class RsLbToAzurePublicIP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsLbToAzurePublicIP", "cobra.model.hinventory.AzurePublicIP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hinventoryRsLbToAzurePublicIP"
    meta.rnFormat = "rslbToAzurePublicIP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "lb-to-pubip"
    ...
    meta.rnPrefixes = [
        ('rslbToAzurePublicIP-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56723, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56724, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 56717, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 56716, PropCategory.REGULAR)
