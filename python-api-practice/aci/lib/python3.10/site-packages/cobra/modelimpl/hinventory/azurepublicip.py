...
# ##################################################
class AzurePublicIP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.AzurePublicIP")

    meta.moClassName = "hinventoryAzurePublicIP"
    meta.rnFormat = "publicip-%(cloudProviderId)s"
    ...
    meta.childClasses.add("cobra.model.hinventory.RtVgwToAzurePublicIP")
    meta.childClasses.add("cobra.model.hinventory.RtLbToAzurePublicIP")
    meta.childClasses.add("cobra.model.hinventory.StaleResource")
    meta.childClasses.add("cobra.model.hinventory.RtNicToAzurePublicIP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RtVgwToAzurePublicIP", "rtVgwToAzurePublicIP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RtNicToAzurePublicIP", "rtNicToAzurePublicIP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RtLbToAzurePublicIP", "rtLbToAzurePublicIP"))
    ...
    prop = PropMeta("str", "Address", "Address", 56708, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("Address", prop)

    prop = PropMeta("str", "State", "State", 56707, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 56709, PropCategory.REGULAR)
