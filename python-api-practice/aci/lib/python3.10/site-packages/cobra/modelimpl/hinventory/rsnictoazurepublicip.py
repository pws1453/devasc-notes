...
# ##################################################
class RsNicToAzurePublicIP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsNicToAzurePublicIP", "cobra.model.hinventory.AzurePublicIP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hinventoryRsNicToAzurePublicIP"
    meta.rnFormat = "rsnicToAzurePublicIP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nic-to-pubip"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x600c001
    ...
    meta.rnPrefixes = [
        ('rsnicToAzurePublicIP-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56719, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56720, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 56711, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16643
    prop.defaultValueStr = "hinventoryAzurePublicIP"
    prop._addConstant("hinventoryAzurePublicIP", None, 16643)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56710, PropCategory.REGULAR)
