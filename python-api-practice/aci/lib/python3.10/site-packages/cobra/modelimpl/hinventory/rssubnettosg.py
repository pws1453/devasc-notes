...
# ##################################################
class RsSubnetToSG(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsSubnetToSG", "cobra.model.hinventory.SecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsSubnetToSG"
    meta.rnFormat = "rsSubnetToSG"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "sub-to-sg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55796, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55797, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55793, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55792, PropCategory.REGULAR)
