...
# ##################################################
class RsVgwToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsVgwToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsVgwToRegion"
    meta.rnFormat = "rsVgwToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "vgw-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55148, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55149, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55026, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55025, PropCategory.REGULAR)
