...
class Listener(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.Listener")

    meta.moClassName = "hinventoryListener"
    meta.rnFormat = "listener-%(port)s"
    ...
    prop = PropMeta("str", "arn", "arn", 55557, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "port", "port", 55558, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "protocol", "protocol", 55559, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
