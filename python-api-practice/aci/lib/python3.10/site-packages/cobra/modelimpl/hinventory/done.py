...
class Done(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.Done")

    meta.moClassName = "hinventoryDone"
    meta.rnFormat = "invdone"
    ...
    prop = PropMeta("str", "invAccountDN", "invAccountDN", 52154, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("invAccountDN", prop)
