...
# ##################################################
class RtCtxToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtCtxToRegion", "cobra.model.hinventory.Ctx")

    meta.moClassName = "hinventoryRtCtxToRegion"
    meta.rnFormat = "rtctxToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54995, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54994, PropCategory.REGULAR)
