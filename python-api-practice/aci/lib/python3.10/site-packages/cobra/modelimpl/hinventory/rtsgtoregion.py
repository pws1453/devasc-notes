...
# ##################################################
class RtSGToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtSGToRegion", "cobra.model.hinventory.SecurityGroup")

    meta.moClassName = "hinventoryRtSGToRegion"
    meta.rnFormat = "rtSGToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54998, PropCategory.REGULAR)
