...
class RsRtToSub(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hinventory.RsRtToSub", "cobra.model.hinventory.Subnet")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hinventoryRsRtToSub"
    meta.rnFormat = "rsrtToSub-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "rt-to-sub"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51676, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 51416, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51677, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51418, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51417, PropCategory.REGULAR)
