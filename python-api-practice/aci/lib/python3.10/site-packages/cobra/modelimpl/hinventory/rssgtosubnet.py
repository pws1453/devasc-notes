...
# ##################################################
class RsSGToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsSGToSubnet", "cobra.model.hinventory.Subnet")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hinventoryRsSGToSubnet"
    meta.rnFormat = "rsSGToSubnet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "sg-to-subnet"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55124, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55125, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55001, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55000, PropCategory.REGULAR)
