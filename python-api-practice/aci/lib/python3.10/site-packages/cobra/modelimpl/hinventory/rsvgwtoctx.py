...
class RsVgwToCtx(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hinventory.RsVgwToCtx", "cobra.model.hinventory.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsVgwToCtx"
    meta.rnFormat = "rsvgwToCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "vgw-to-ctx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51670, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51671, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51405, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15024
    prop.defaultValueStr = "hinventoryCtx"
    prop._addConstant("hinventoryCtx", None, 15024)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51404, PropCategory.REGULAR)
