...
# ##################################################
class RsSGToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsSGToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsSGToRegion"
    meta.rnFormat = "rsSGToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "sg-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55126, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55127, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 54997, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54996, PropCategory.REGULAR)
