...
# ##################################################
class ComputeInstance(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.ComputeInstance")

    meta.moClassName = "hinventoryComputeInstance"
    meta.rnFormat = "inst-%(cloudProviderId)s"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsInstToRegion")
    meta.childClasses.add("cobra.model.hinventory.Tag")
    meta.childClasses.add("cobra.model.hinventory.RtNicToInstance")
    meta.childClasses.add("cobra.model.hinventory.StaleResource")
    meta.childClasses.add("cobra.model.hinventory.NetworkInterface")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RtNicToInstance", "rtnicToInstance-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsInstToRegion", "rsinstToRegion"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.NetworkInterface", "nic-"))
    ...
    prop = PropMeta("str", "LaunchTime", "LaunchTime", 53286, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("LaunchTime", prop)

    prop = PropMeta("str", "PowerState", "PowerState", 55537, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("PowerState", prop)

    prop = PropMeta("str", "Size", "Size", 55631, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "State", "State", 53285, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 50767, PropCategory.REGULAR)
