...
class PrivateIP(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.PrivateIP")

    meta.moClassName = "hinventoryPrivateIP"
    meta.rnFormat = "private-[%(Address)s]"
    ...
    prop = PropMeta("str", "Address", "Address", 53291, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "Primary", "Primary", 53290, PropCategory.REGULAR)
    prop.label = "None"
