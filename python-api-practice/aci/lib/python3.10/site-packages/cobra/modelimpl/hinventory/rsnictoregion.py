...
# ##################################################
class RsNicToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsNicToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsNicToRegion"
    meta.rnFormat = "rsNicToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nic-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55144, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55145, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55015, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55014, PropCategory.REGULAR)
