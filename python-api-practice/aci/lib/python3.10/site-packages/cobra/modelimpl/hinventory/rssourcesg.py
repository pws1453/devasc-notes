...
class RsSourceSG(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hinventory.RsSourceSG", "cobra.model.hinventory.SecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsSourceSG"
    meta.rnFormat = "rssourceSG-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51660, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51661, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51384, PropCategory.REGULAR)
