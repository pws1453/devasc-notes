...
# ##################################################
class IngressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.IngressRule")

    meta.moClassName = "hinventoryIngressRule"
    meta.rnFormat = "ingress-%(Protocol)s-%(FromPort)s-%(ToPort)s-[%(Source)s]"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsSourceSG")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsSourceSG", "rssourceSG-"))
    ...
    prop = PropMeta("str", "FromPort", "FromPort", 50470, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "Protocol", "Protocol", 50469, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "Source", "Source", 52237, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "ToPort", "ToPort", 50471, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "priority", "priority", 54955, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    def __init__(self, parentMoOrDn, Protocol, FromPort, ToPort, Source, markDirty=True, **creationProps):
        namingVals = [Protocol, FromPort, ToPort, Source]
