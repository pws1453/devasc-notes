...
class RtVgwToCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hinventory.RtVgwToCtx", "cobra.model.hinventory.VpnGateway")

    meta.moClassName = "hinventoryRtVgwToCtx"
    meta.rnFormat = "rtvgwToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51406, PropCategory.REGULAR)
