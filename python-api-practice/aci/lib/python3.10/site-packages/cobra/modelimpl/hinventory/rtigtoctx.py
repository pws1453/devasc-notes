...
class RtIGToCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hinventory.RtIGToCtx", "cobra.model.hinventory.InternetGateway")

    meta.moClassName = "hinventoryRtIGToCtx"
    meta.rnFormat = "rtIGToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51402, PropCategory.REGULAR)
