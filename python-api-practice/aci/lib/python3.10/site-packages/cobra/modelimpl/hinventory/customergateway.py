...
# ##################################################
class CustomerGateway(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.CustomerGateway")

    meta.moClassName = "hinventoryCustomerGateway"
    meta.rnFormat = "cgw-%(cloudProviderId)s"
    ...
    meta.childClasses.add("cobra.model.hinventory.RtConnToCgw")
    meta.childClasses.add("cobra.model.hinventory.StaleResource")
    meta.childClasses.add("cobra.model.hinventory.RsCgwToRegion")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsCgwToRegion", "rsCgwToRegion"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RtConnToCgw", "rtconnToCgw-"))
    ...
    prop = PropMeta("str", "BgpAsn", "BgpAsn", 53297, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "IpAddress", "IpAddress", 53298, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("IpAddress", prop)

    prop = PropMeta("str", "State", "State", 53295, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "VpnType", "VpnType", 53296, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 50769, PropCategory.REGULAR)
