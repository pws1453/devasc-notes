...
class RtLbToSubnet(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hinventory.RtLbToSubnet", "cobra.model.hinventory.LoadBalancer")

    meta.moClassName = "hinventoryRtLbToSubnet"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55051, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55050, PropCategory.REGULAR)
