...
class Provider(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.Provider")

    meta.moClassName = "hinventoryProvider"
    meta.rnFormat = "provider-[%(name)s]"
    ...
    meta.childClasses.add("cobra.model.hinventory.Account")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.Account", "account-"))
    ...
    prop = PropMeta("str", "name", "name", 50775, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
