...
# ##################################################
class RsLbToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsLbToSubnet", "cobra.model.hinventory.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsLbToSubnet"
    meta.rnFormat = "rslbToSubnet"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "lb-to-subnet"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55162, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55163, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55048, PropCategory.REGULAR)
