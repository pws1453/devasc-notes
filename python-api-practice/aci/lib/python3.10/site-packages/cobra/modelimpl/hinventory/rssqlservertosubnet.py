...
# ##################################################
class RsSqlServerToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsSqlServerToSubnet", "cobra.model.hinventory.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsSqlServerToSubnet"
    meta.rnFormat = "rssqlServerToSubnet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "sqlserver-to-subnet"
    ...
    meta.rnPrefixes = [
        ('rssqlServerToSubnet-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55168, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55169, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55097, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55096, PropCategory.REGULAR)
