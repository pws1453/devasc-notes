...
class PublicIP(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.PublicIP")

    meta.moClassName = "hinventoryPublicIP"
    meta.rnFormat = "public-[%(Address)s]"
    ...
    prop = PropMeta("str", "Address", "Address", 53289, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
