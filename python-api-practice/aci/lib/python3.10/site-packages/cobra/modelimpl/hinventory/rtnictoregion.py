...
# ##################################################
class RtNicToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtNicToRegion", "cobra.model.hinventory.NetworkInterface")

    meta.moClassName = "hinventoryRtNicToRegion"
    meta.rnFormat = "rtnicToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55017, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55016, PropCategory.REGULAR)
