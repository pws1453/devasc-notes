...
# ##################################################
class RtCgwToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtCgwToRegion", "cobra.model.hinventory.CustomerGateway")

    meta.moClassName = "hinventoryRtCgwToRegion"
    meta.rnFormat = "rtcgwToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55032, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55031, PropCategory.REGULAR)
