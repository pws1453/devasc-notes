...
class RsIGToCtx(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hinventory.RsIGToCtx", "cobra.model.hinventory.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsIGToCtx"
    meta.rnFormat = "rsIGToCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ig-to-ctx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51668, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51669, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51400, PropCategory.REGULAR)
