...
# ##################################################
class RsConnToCgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsConnToCgw", "cobra.model.hinventory.CustomerGateway")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsConnToCgw"
    meta.rnFormat = "rsConnToCgw"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "conn-to-cgw"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51672, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51673, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51409, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15045
    prop.defaultValueStr = "hinventoryCustomerGateway"
    prop._addConstant("hinventoryCustomerGateway", None, 15045)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51408, PropCategory.REGULAR)
