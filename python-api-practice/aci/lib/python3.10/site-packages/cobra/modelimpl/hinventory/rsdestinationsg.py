...
# ##################################################
class RsDestinationSG(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsDestinationSG", "cobra.model.hinventory.SecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsDestinationSG"
    meta.rnFormat = "rsdestinationSG-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsdestinationSG-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51662, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51663, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51389, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15025
    prop.defaultValueStr = "hinventorySecurityGroup"
    prop._addConstant("hinventorySecurityGroup", None, 15025)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51388, PropCategory.REGULAR)
