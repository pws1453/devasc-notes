...
# ##################################################
class RsNicToInstance(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsNicToInstance", "cobra.model.hinventory.ComputeInstance")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsNicToInstance"
    meta.rnFormat = "rsNicToInstance"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nic-to-inst"
    ...
    meta.rnPrefixes = [
        ('rsNicToInstance', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51664, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51665, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51393, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15033
    prop.defaultValueStr = "hinventoryComputeInstance"
    prop._addConstant("hinventoryComputeInstance", None, 15033)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51392, PropCategory.REGULAR)
