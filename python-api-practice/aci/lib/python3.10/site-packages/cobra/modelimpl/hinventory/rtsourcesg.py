...
class RtSourceSG(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hinventory.RtSourceSG", "cobra.model.hinventory.IngressRule")

    meta.moClassName = "hinventoryRtSourceSG"
    meta.rnFormat = "rtsourceSG-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51387, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15026
    prop.defaultValueStr = "hinventoryIngressRule"
    prop._addConstant("hinventoryIngressRule", None, 15026)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51386, PropCategory.REGULAR)
