...
# ##################################################
class RsAsgToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsAsgToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsAsgToRegion"
    meta.rnFormat = "rsasgToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "asg-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55128, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55129, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55065, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55064, PropCategory.REGULAR)
