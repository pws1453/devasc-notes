...
# ##################################################
class RsResGrpToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsResGrpToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsResGrpToRegion"
    meta.rnFormat = "rsResGrpToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "resgrp-to-reg"
    ...
    meta.rnPrefixes = [
        ('rsResGrpToRegion', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55120, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55121, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55061, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55060, PropCategory.REGULAR)
