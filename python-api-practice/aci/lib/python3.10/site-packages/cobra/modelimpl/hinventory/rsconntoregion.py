...
# ##################################################
class RsConnToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsConnToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsConnToRegion"
    meta.rnFormat = "rsConnToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "conn-to-reg"
    ...
    meta.rnPrefixes = [
        ('rsConnToRegion', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55155, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55034, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55033, PropCategory.REGULAR)
