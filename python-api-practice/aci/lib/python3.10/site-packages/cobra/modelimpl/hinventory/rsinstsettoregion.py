...
# ##################################################
class RsInstSetToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsInstSetToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsInstSetToRegion"
    meta.rnFormat = "rsInstSetToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "instset-to-reg"
    ...
    meta.rnPrefixes = [
        ('rsInstSetToRegion', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55138, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55139, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55073, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55072, PropCategory.REGULAR)
