...
# ##################################################
class VpnConnection(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.VpnConnection")

    meta.moClassName = "hinventoryVpnConnection"
    meta.rnFormat = "conn-%(cloudProviderId)s"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsConnToCgw")
    meta.childClasses.add("cobra.model.hinventory.StaleResource")
    meta.childClasses.add("cobra.model.hinventory.RsConnToVgw")
    meta.childClasses.add("cobra.model.hinventory.RsConnToRegion")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsConnToRegion", "rsConnToRegion"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsConnToCgw", "rsConnToCgw"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsConnToVgw", "rsConnToVgw"))
    ...
    prop = PropMeta("str", "State", "State", 53299, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "VpnType", "VpnType", 53300, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 50782, PropCategory.REGULAR)
