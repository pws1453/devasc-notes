...
# ##################################################
class RsNexthopVgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsNexthopVgw", "cobra.model.hinventory.VpnGateway")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsNexthopVgw"
    meta.rnFormat = "rsNexthopVgw"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nh-to-vgw"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51680, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51681, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51429, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15042
    prop.defaultValueStr = "hinventoryVpnGateway"
    prop._addConstant("hinventoryVpnGateway", None, 15042)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51428, PropCategory.REGULAR)
