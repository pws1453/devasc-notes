...
# ##################################################
class RsConnToVgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsConnToVgw", "cobra.model.hinventory.VpnGateway")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsConnToVgw"
    meta.rnFormat = "rsConnToVgw"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "conn-to-vgw"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51674, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51675, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51413, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51412, PropCategory.REGULAR)
