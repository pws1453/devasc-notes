...
class CtxCidr(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.CtxCidr")

    meta.moClassName = "hinventoryCtxCidr"
    meta.rnFormat = "ctxcidr-[%(CIDR)s]"
    ...
    prop = PropMeta("str", "CIDR", "CIDR", 53281, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("CIDR", prop)

    prop = PropMeta("str", "Primary", "Primary", 53282, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "State", "State", 53283, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    meta.namingProps.append(getattr(meta.props, "CIDR"))
    getattr(meta.props, "CIDR").needDelimiter = True

    def __init__(self, parentMoOrDn, CIDR, markDirty=True, **creationProps):
        namingVals = [CIDR]
