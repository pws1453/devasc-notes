...
class SqlDb(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.SqlDb")

    meta.moClassName = "hinventorySqlDb"
    meta.rnFormat = "sqldb-[%(name)s]"
    ...
    prop = PropMeta("str", "name", "name", 54976, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
