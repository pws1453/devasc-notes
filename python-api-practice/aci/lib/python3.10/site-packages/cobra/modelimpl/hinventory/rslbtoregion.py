...
# ##################################################
class RsLbToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsLbToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsLbToRegion"
    meta.rnFormat = "rslbToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "lb-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55158, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55159, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55045, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55044, PropCategory.REGULAR)
