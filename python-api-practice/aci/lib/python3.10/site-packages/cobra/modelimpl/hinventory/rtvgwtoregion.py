...
# ##################################################
class RtVgwToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtVgwToRegion", "cobra.model.hinventory.VpnGateway")

    meta.moClassName = "hinventoryRtVgwToRegion"
    meta.rnFormat = "rtvgwToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55028, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55027, PropCategory.REGULAR)
