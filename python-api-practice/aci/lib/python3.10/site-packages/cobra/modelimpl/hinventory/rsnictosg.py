...
class RsNicToSG(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hinventory.RsNicToSG", "cobra.model.hinventory.SecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hinventoryRsNicToSG"
    meta.rnFormat = "rsnicToSG-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nic-to-sg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51667, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51397, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51396, PropCategory.REGULAR)
