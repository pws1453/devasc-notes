...
# ##################################################
class RtSubnetToSG(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtSubnetToSG", "cobra.model.hinventory.Subnet")

    meta.moClassName = "hinventoryRtSubnetToSG"
    meta.rnFormat = "rtsubnetToSG-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55795, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55794, PropCategory.REGULAR)
