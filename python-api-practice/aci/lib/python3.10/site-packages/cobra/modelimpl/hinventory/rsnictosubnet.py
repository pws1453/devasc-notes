...
# ##################################################
class RsNicToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsNicToSubnet", "cobra.model.hinventory.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsNicToSubnet"
    meta.rnFormat = "rsNicToSubnet"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nic-to-subnet"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55140, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55141, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55019, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55018, PropCategory.REGULAR)
