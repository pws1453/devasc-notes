...
# ##################################################
class InternetGateway(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.InternetGateway")

    meta.moClassName = "hinventoryInternetGateway"
    meta.rnFormat = "igw-%(cloudProviderId)s"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsIGToCtx")
    meta.childClasses.add("cobra.model.hinventory.StaleResource")
    meta.childClasses.add("cobra.model.hinventory.RtNexthopIgw")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RtNexthopIgw", "rtnexthopIgw-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsIGToCtx", "rsIGToCtx-"))
    ...
    prop = PropMeta("str", "cloudProviderId", "cloudProviderId", 50772, PropCategory.REGULAR)
