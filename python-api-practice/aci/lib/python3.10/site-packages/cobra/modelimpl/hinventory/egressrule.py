...
class EgressRule(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.EgressRule")

    meta.moClassName = "hinventoryEgressRule"
    meta.rnFormat = "egress-%(Protocol)s-%(FromPort)s-%(ToPort)s-[%(Destination)s]"
    ...
    meta.childClasses.add("cobra.model.hinventory.RsDestinationSG")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsDestinationSG", "rsdestinationSG-"))
    ...
    prop = PropMeta("str", "Destination", "Destination", 52238, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "FromPort", "FromPort", 50475, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "Protocol", "Protocol", 50474, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "ToPort", "ToPort", 50476, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "priority", "priority", 54956, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    def __init__(self, parentMoOrDn, Protocol, FromPort, ToPort, Destination, markDirty=True, **creationProps):
        namingVals = [Protocol, FromPort, ToPort, Destination]
