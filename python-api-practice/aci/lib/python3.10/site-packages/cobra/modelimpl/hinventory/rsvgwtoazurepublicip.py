...
# ##################################################
class RsVgwToAzurePublicIP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsVgwToAzurePublicIP", "cobra.model.hinventory.AzurePublicIP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hinventoryRsVgwToAzurePublicIP"
    meta.rnFormat = "rsvgwToAzurePublicIP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "vgw-to-pubip"
    ...
    meta.rnPrefixes = [
        ('rsvgwToAzurePublicIP-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56721, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56722, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 56714, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 56713, PropCategory.REGULAR)
