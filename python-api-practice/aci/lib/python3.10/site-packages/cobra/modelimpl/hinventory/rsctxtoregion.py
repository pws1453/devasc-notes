...
# ##################################################
class RsCtxToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsCtxToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsCtxToRegion"
    meta.rnFormat = "rsCtxToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ctx-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55122, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55123, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 54993, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54992, PropCategory.REGULAR)
