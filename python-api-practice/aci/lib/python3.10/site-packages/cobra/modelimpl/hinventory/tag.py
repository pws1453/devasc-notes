...
class Tag(Mo):
    ...
    meta = ClassMeta("cobra.model.hinventory.Tag")

    meta.moClassName = "hinventoryTag"
    ...
    prop = PropMeta("str", "key", "key", 54961, PropCategory.REGULAR)
    prop.label = "Key"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 54962, PropCategory.REGULAR)
    prop.label = "Key"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 128)]
