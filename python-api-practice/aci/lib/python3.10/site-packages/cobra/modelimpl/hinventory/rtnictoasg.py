...
class RtNicToAsg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hinventory.RtNicToAsg", "cobra.model.hinventory.NetworkInterface")

    meta.moClassName = "hinventoryRtNicToAsg"
    meta.rnFormat = "rtnicToAsg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55010, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55009, PropCategory.REGULAR)
