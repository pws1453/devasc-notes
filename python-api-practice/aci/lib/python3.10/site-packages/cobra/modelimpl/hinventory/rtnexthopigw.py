...
# ##################################################
class RtNexthopIgw(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtNexthopIgw", "cobra.model.hinventory.RouteTableEntry")

    meta.moClassName = "hinventoryRtNexthopIgw"
    meta.rnFormat = "rtnexthopIgw-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51423, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15054
    prop.defaultValueStr = "hinventoryRouteTableEntry"
    prop._addConstant("hinventoryRouteTableEntry", None, 15054)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51422, PropCategory.REGULAR)
