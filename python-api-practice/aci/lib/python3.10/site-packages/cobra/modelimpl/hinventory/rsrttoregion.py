...
# ##################################################
class RsRtToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsRtToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsRtToRegion"
    meta.rnFormat = "rsRtToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "rt-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55156, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55157, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55038, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55037, PropCategory.REGULAR)
