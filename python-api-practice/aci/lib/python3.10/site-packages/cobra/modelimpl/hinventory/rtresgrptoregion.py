...
# ##################################################
class RtResGrpToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hinventory.RtResGrpToRegion", "cobra.model.hinventory.ResourceGrp")

    meta.moClassName = "hinventoryRtResGrpToRegion"
    meta.rnFormat = "rtresGrpToRegion-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55063, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16132
    prop.defaultValueStr = "hinventoryResourceGrp"
    prop._addConstant("hinventoryResourceGrp", None, 16132)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55062, PropCategory.REGULAR)
