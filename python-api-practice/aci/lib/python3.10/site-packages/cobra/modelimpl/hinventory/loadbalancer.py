...
# ##################################################
class LoadBalancer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hinventory.LoadBalancer")

    meta.moClassName = "hinventoryLoadBalancer"
    meta.rnFormat = "lb-[%(name)s]"
    ...
    meta.childClasses.add("cobra.model.hinventory.Listener")
    meta.childClasses.add("cobra.model.hinventory.PrivateIP")
    meta.childClasses.add("cobra.model.hinventory.RsLbToRegion")
    meta.childClasses.add("cobra.model.hinventory.RsLbToAzurePublicIP")
    meta.childClasses.add("cobra.model.hinventory.RsLbToSubnet")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsLbToAzurePublicIP", "rslbToAzurePublicIP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsLbToRegion", "rslbToRegion"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.RsLbToSubnet", "rslbToSubnet"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hinventory.Listener", "listener-"))
    ...
    prop = PropMeta("str", "State", "State", 55538, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "arn", "arn", 50480, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("arn", prop)
    ...
    prop = PropMeta("str", "dnsName", "dnsName", 56696, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("dnsName", prop)
    ...
    prop = PropMeta("str", "name", "name", 50773, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
