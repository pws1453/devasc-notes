...
# ##################################################
class RsCgwToRegion(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hinventory.RsCgwToRegion", "cobra.model.hinventory.Region")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hinventoryRsCgwToRegion"
    meta.rnFormat = "rsCgwToRegion"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "cgw-to-reg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55152, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55153, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55030, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55029, PropCategory.REGULAR)
