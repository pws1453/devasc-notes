...
# ##################################################
class TreeCalcNodeStatsHist5min(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist5min", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist5min"
    meta.rnFormat = "HDisisTreeCalcNodeStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6718, PropCategory.REGULAR)
