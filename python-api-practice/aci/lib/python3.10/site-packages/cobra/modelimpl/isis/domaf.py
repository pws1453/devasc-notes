...
class DomAf(Mo):
    """
    Per address family IS-IS VRF information.

    """

    meta = ClassMeta("cobra.model.isis.DomAf")

    meta.moClassName = "isisDomAf"
    ...
    meta.superClasses.add("cobra.model.isis.Af")
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 3163, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("adj-check", "adjacency-check", 1)
    ...
    prop = PropMeta("str", "type", "type", 6693, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("v4", "ipv4-address-family", 1)
    prop._addConstant("v6", "ipv6-address-family", 2)
