...
# ##################################################
class FtagTreeStatsHist1h(Mo):
    """
    A class that represents historical statistics for FTAG in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist1h", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist1h"
    meta.rnFormat = "HDisisFtagTreeStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6699, PropCategory.REGULAR)
