...
# ##################################################
class IsisCsnpStats1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats1h", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats1h"
    meta.rnFormat = "CDisisIsisCsnpStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats in 1 hour"
