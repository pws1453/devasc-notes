...
# ##################################################
class FtagTreeStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist"


    meta.moClassName = "isisFtagTreeStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats"
    ...
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.isis.FtagTreeStatsHist1year")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "avgAvgPenaltyAvg", "avgAvgPenaltyAvg", 9438, PropCategory.IMPLICIT_AVG)
    prop.label = "average average penalty average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltyAvg", prop)

    prop = PropMeta("str", "avgAvgPenaltyCum", "avgAvgPenaltyCum", 9434, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "average average penalty cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltyCum", prop)

    prop = PropMeta("str", "avgAvgPenaltyMax", "avgAvgPenaltyMax", 9437, PropCategory.IMPLICIT_MAX)
    prop.label = "average average penalty maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltyMax", prop)

    prop = PropMeta("str", "avgAvgPenaltyMin", "avgAvgPenaltyMin", 9436, PropCategory.IMPLICIT_MIN)
    prop.label = "average average penalty minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltyMin", prop)

    prop = PropMeta("str", "avgAvgPenaltyPer", "avgAvgPenaltyPer", 9435, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "average average penalty periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltyPer", prop)

    prop = PropMeta("str", "avgAvgPenaltyRate", "avgAvgPenaltyRate", 9442, PropCategory.IMPLICIT_RATE)
    prop.label = "average average penalty rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltyRate", prop)

    prop = PropMeta("str", "avgAvgPenaltySpct", "avgAvgPenaltySpct", 9439, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "average average penalty suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltySpct", prop)

    prop = PropMeta("str", "avgAvgPenaltyThr", "avgAvgPenaltyThr", 9440, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "avgAvgPenaltyTr", "avgAvgPenaltyTr", 9441, PropCategory.IMPLICIT_TREND)
    prop.label = "average average penalty trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgAvgPenaltyTr", prop)

    prop = PropMeta("str", "avgMaxPenaltyAvg", "avgMaxPenaltyAvg", 9465, PropCategory.IMPLICIT_AVG)
    prop.label = "average maximum penalty average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgMaxPenaltyAvg", prop)

    prop = PropMeta("str", "avgMaxPenaltyCum", "avgMaxPenaltyCum", 9461, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "average maximum penalty cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgMaxPenaltyCum", prop)

    prop = PropMeta("str", "avgMaxPenaltyMax", "avgMaxPenaltyMax", 9464, PropCategory.IMPLICIT_MAX)
    prop.label = "average maximum penalty maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgMaxPenaltyMax", prop)

    prop = PropMeta("str", "avgMaxPenaltyMin", "avgMaxPenaltyMin", 9463, PropCategory.IMPLICIT_MIN)
    prop.label = "average maximum penalty minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgMaxPenaltyMin", prop)

    prop = PropMeta("str", "avgMaxPenaltyPer", "avgMaxPenaltyPer", 9462, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "average maximum penalty periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgMaxPenaltyPer", prop)

    prop = PropMeta("str", "avgMaxPenaltyRate", "avgMaxPenaltyRate", 9469, PropCategory.IMPLICIT_RATE)
    prop.label = "average maximum penalty rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgMaxPenaltyRate", prop)

    prop = PropMeta("str", "avgMaxPenaltySpct", "avgMaxPenaltySpct", 9466, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "average maximum penalty suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("avgMaxPenaltySpct", prop)

    prop = PropMeta("str", "avgMaxPenaltyThr", "avgMaxPenaltyThr", 9467, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "avgMaxPenaltyTr", "avgMaxPenaltyTr", 9468, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "curAvgPenaltyAvg", "curAvgPenaltyAvg", 9492, PropCategory.IMPLICIT_AVG)
    prop.label = "current average penalty average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltyAvg", prop)

    prop = PropMeta("str", "curAvgPenaltyCum", "curAvgPenaltyCum", 9488, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "current average penalty cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltyCum", prop)

    prop = PropMeta("str", "curAvgPenaltyMax", "curAvgPenaltyMax", 9491, PropCategory.IMPLICIT_MAX)
    prop.label = "current average penalty maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltyMax", prop)

    prop = PropMeta("str", "curAvgPenaltyMin", "curAvgPenaltyMin", 9490, PropCategory.IMPLICIT_MIN)
    prop.label = "current average penalty minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltyMin", prop)

    prop = PropMeta("str", "curAvgPenaltyPer", "curAvgPenaltyPer", 9489, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "current average penalty periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltyPer", prop)

    prop = PropMeta("str", "curAvgPenaltyRate", "curAvgPenaltyRate", 9496, PropCategory.IMPLICIT_RATE)
    prop.label = "current average penalty rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltyRate", prop)

    prop = PropMeta("str", "curAvgPenaltySpct", "curAvgPenaltySpct", 9493, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "current average penalty suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltySpct", prop)

    prop = PropMeta("str", "curAvgPenaltyThr", "curAvgPenaltyThr", 9494, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "curAvgPenaltyTr", "curAvgPenaltyTr", 9495, PropCategory.IMPLICIT_TREND)
    prop.label = "current average penalty trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curAvgPenaltyTr", prop)

    prop = PropMeta("str", "curMaxPenaltyAvg", "curMaxPenaltyAvg", 9519, PropCategory.IMPLICIT_AVG)
    prop.label = "current maximum penalty average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curMaxPenaltyAvg", prop)

    prop = PropMeta("str", "curMaxPenaltyCum", "curMaxPenaltyCum", 9515, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "current maximum penalty cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curMaxPenaltyCum", prop)

    prop = PropMeta("str", "curMaxPenaltyMax", "curMaxPenaltyMax", 9518, PropCategory.IMPLICIT_MAX)
    prop.label = "current maximum penalty maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curMaxPenaltyMax", prop)

    prop = PropMeta("str", "curMaxPenaltyMin", "curMaxPenaltyMin", 9517, PropCategory.IMPLICIT_MIN)
    prop.label = "current maximum penalty minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curMaxPenaltyMin", prop)

    prop = PropMeta("str", "curMaxPenaltyPer", "curMaxPenaltyPer", 9516, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "current maximum penalty periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curMaxPenaltyPer", prop)

    prop = PropMeta("str", "curMaxPenaltyRate", "curMaxPenaltyRate", 9523, PropCategory.IMPLICIT_RATE)
    prop.label = "current maximum penalty rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curMaxPenaltyRate", prop)

    prop = PropMeta("str", "curMaxPenaltySpct", "curMaxPenaltySpct", 9520, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "current maximum penalty suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("curMaxPenaltySpct", prop)

    prop = PropMeta("str", "curMaxPenaltyThr", "curMaxPenaltyThr", 9521, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "curMaxPenaltyTr", "curMaxPenaltyTr", 9522, PropCategory.IMPLICIT_TREND)
