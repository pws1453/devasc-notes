...
# ##################################################
class IsisPsnpStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist1mo", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist1mo"
    meta.rnFormat = "HDisisIsisPsnpStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 45852, PropCategory.REGULAR)
