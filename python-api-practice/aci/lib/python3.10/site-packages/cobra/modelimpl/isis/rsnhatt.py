...
class RsNhAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.isis.RsNhAtt", "cobra.model.isis.Nexthop")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "isisRsNhAtt"
    meta.rnFormat = "rsnhAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "IS-IS Nexthop Attachment"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37757, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39896, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14492, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12672, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2849
    prop.defaultValueStr = "isisNexthop"
    prop._addConstant("isisNexthop", None, 2849)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12671, PropCategory.REGULAR)
