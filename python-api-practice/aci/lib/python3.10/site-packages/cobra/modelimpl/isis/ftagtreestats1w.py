...
# ##################################################
class FtagTreeStats1w(Mo):
    """
    A class that represents the most current statistics for FTAG in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStats1w", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStats1w"
    meta.rnFormat = "CDisisFtagTreeStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG stats in 1 week"
