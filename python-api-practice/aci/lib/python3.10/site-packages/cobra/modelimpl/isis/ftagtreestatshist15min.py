...
# ##################################################
class FtagTreeStatsHist15min(Mo):
    """
    A class that represents historical statistics for FTAG in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist15min", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist15min"
    meta.rnFormat = "HDisisFtagTreeStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.isis.FtagTreeStatsHist")

    meta.rnPrefixes = [
        ('HDisisFtagTreeStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6697, PropCategory.REGULAR)
