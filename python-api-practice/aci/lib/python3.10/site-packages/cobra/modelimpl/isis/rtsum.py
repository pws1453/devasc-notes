...
class RtSum(Mo):
    """
    This object holds summarization address. Any address that maps to this prefix will be summarized through this address

    """

    meta = ClassMeta("cobra.model.isis.RtSum")

    meta.moClassName = "isisRtSum"
    ...
    prop = PropMeta("str", "addr", "addr", 15240, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
