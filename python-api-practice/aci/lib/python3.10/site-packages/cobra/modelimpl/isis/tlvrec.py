...
class TlvRec(Mo):
    """
    The generic Type Length Value (TLV) record.

    """

    meta = ClassMeta("cobra.model.isis.TlvRec")

    meta.moClassName = "isisTlvRec"
    meta.rnFormat = "tlvRec-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Generic TLV Record"
    ...
    prop = PropMeta("str", "len", "len", 3252, PropCategory.REGULAR)
    prop.label = "Length"
    prop.isOper = True
    ...
    prop = PropMeta("str", "type", "type", 3251, PropCategory.REGULAR)
    prop.label = "TLV"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 3253, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isOper = True
    prop.range = [(0, 512)]
