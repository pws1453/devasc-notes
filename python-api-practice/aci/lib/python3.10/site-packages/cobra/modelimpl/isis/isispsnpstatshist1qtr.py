...
# ##################################################
class IsisPsnpStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist1qtr", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist1qtr"
    meta.rnFormat = "HDisisIsisPsnpStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 45853, PropCategory.REGULAR)
