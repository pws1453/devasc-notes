...
# ##################################################
class IsisCsnpStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist1year", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist1year"
    meta.rnFormat = "HDisisIsisCsnpStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 45815, PropCategory.REGULAR)
