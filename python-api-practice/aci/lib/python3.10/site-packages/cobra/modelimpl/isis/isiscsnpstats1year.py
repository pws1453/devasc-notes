...
# ##################################################
class IsisCsnpStats1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats1year", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats1year"
    meta.rnFormat = "CDisisIsisCsnpStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDisisIsisCsnpStats1year', False),
    ]
