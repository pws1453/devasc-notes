...
# ##################################################
class TreeCalcNodeStats1h(Mo):
    """
    A class that represents the most current statistics for FTAG global node in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStats1h", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStats1h"
    meta.rnFormat = "CDisisTreeCalcNodeStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global node stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcNodeStats1h', False),
    ]
