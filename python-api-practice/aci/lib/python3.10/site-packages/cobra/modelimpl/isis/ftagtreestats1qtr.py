...
# ##################################################
class FtagTreeStats1qtr(Mo):
    """
    A class that represents the most current statistics for FTAG in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStats1qtr", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStats1qtr"
    meta.rnFormat = "CDisisFtagTreeStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG stats in 1 quarter"
