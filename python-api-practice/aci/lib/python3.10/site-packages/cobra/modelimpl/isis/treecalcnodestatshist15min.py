...
# ##################################################
class TreeCalcNodeStatsHist15min(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist15min", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist15min"
    meta.rnFormat = "HDisisTreeCalcNodeStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.isis.TreeCalcNodeStatsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6711, PropCategory.REGULAR)
