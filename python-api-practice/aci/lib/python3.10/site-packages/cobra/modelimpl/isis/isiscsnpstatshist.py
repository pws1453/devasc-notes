...
# ##################################################
class IsisCsnpStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist"


    meta.moClassName = "isisIsisCsnpStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStatsHist1year")
    ...
    prop = PropMeta("str", "csnpPktsRxAvg", "csnpPktsRxAvg", 46124, PropCategory.IMPLICIT_AVG)
    prop.label = "CSNP Packets Recevied average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxAvg", prop)

    prop = PropMeta("str", "csnpPktsRxCum", "csnpPktsRxCum", 46120, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "CSNP Packets Recevied cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxCum", prop)

    prop = PropMeta("str", "csnpPktsRxMax", "csnpPktsRxMax", 46123, PropCategory.IMPLICIT_MAX)
    prop.label = "CSNP Packets Recevied maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxMax", prop)

    prop = PropMeta("str", "csnpPktsRxMin", "csnpPktsRxMin", 46122, PropCategory.IMPLICIT_MIN)
    prop.label = "CSNP Packets Recevied minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxMin", prop)

    prop = PropMeta("str", "csnpPktsRxPer", "csnpPktsRxPer", 46121, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "CSNP Packets Recevied periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxPer", prop)

    prop = PropMeta("str", "csnpPktsRxRate", "csnpPktsRxRate", 46128, PropCategory.IMPLICIT_RATE)
    prop.label = "CSNP Packets Recevied rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxRate", prop)

    prop = PropMeta("str", "csnpPktsRxSpct", "csnpPktsRxSpct", 46125, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "CSNP Packets Recevied suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxSpct", prop)

    prop = PropMeta("str", "csnpPktsRxThr", "csnpPktsRxThr", 46126, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "csnpPktsRxTr", "csnpPktsRxTr", 46127, PropCategory.IMPLICIT_TREND)
    prop.label = "CSNP Packets Recevied trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsRxTr", prop)

    prop = PropMeta("str", "csnpPktsTxAvg", "csnpPktsTxAvg", 46145, PropCategory.IMPLICIT_AVG)
    prop.label = "CSNP Packets Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsTxAvg", prop)

    prop = PropMeta("str", "csnpPktsTxCum", "csnpPktsTxCum", 46141, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "CSNP Packets Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsTxCum", prop)

    prop = PropMeta("str", "csnpPktsTxMax", "csnpPktsTxMax", 46144, PropCategory.IMPLICIT_MAX)
    prop.label = "CSNP Packets Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsTxMax", prop)

    prop = PropMeta("str", "csnpPktsTxMin", "csnpPktsTxMin", 46143, PropCategory.IMPLICIT_MIN)
    prop.label = "CSNP Packets Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsTxMin", prop)

    prop = PropMeta("str", "csnpPktsTxPer", "csnpPktsTxPer", 46142, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "CSNP Packets Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsTxPer", prop)

    prop = PropMeta("str", "csnpPktsTxRate", "csnpPktsTxRate", 46149, PropCategory.IMPLICIT_RATE)
    prop.label = "CSNP Packets Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsTxRate", prop)

    prop = PropMeta("str", "csnpPktsTxSpct", "csnpPktsTxSpct", 46146, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "CSNP Packets Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("csnpPktsTxSpct", prop)

    prop = PropMeta("str", "csnpPktsTxThr", "csnpPktsTxThr", 46147, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "csnpPktsTxTr", "csnpPktsTxTr", 46148, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "fastCsnpPktsRxAvg", "fastCsnpPktsRxAvg", 46166, PropCategory.IMPLICIT_AVG)
    prop.label = "Fast CSNP Packets Recevied average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fastCsnpPktsRxAvg", prop)

    prop = PropMeta("str", "fastCsnpPktsRxCum", "fastCsnpPktsRxCum", 46162, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Fast CSNP Packets Recevied cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fastCsnpPktsRxCum", prop)

    prop = PropMeta("str", "fastCsnpPktsRxMax", "fastCsnpPktsRxMax", 46165, PropCategory.IMPLICIT_MAX)
    prop.label = "Fast CSNP Packets Recevied maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fastCsnpPktsRxMax", prop)

    prop = PropMeta("str", "fastCsnpPktsRxMin", "fastCsnpPktsRxMin", 46164, PropCategory.IMPLICIT_MIN)
    prop.label = "Fast CSNP Packets Recevied minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fastCsnpPktsRxMin", prop)

    prop = PropMeta("str", "fastCsnpPktsRxPer", "fastCsnpPktsRxPer", 46163, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Fast CSNP Packets Recevied periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fastCsnpPktsRxPer", prop)

    prop = PropMeta("str", "fastCsnpPktsRxRate", "fastCsnpPktsRxRate", 46170, PropCategory.IMPLICIT_RATE)
    prop.label = "Fast CSNP Packets Recevied rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fastCsnpPktsRxRate", prop)

    prop = PropMeta("str", "fastCsnpPktsRxSpct", "fastCsnpPktsRxSpct", 46167, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Fast CSNP Packets Recevied suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fastCsnpPktsRxSpct", prop)

    prop = PropMeta("str", "fastCsnpPktsRxThr", "fastCsnpPktsRxThr", 46168, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fastCsnpPktsRxTr", "fastCsnpPktsRxTr", 46169, PropCategory.IMPLICIT_TREND)
