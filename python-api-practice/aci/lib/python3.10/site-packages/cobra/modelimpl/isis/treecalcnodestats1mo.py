...
# ##################################################
class TreeCalcNodeStats1mo(Mo):
    """
    A class that represents the most current statistics for FTAG global node in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStats1mo", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStats1mo"
    meta.rnFormat = "CDisisTreeCalcNodeStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global node stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcNodeStats1mo', False),
    ]
