...
# ##################################################
class IsisCsnpStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist15min", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist15min"
    meta.rnFormat = "HDisisIsisCsnpStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.isis.IsisCsnpStatsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDisisIsisCsnpStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 45809, PropCategory.REGULAR)
