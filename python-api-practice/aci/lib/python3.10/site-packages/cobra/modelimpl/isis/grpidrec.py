...
class GrpIdRec(Mo):
    """
    The multicast groups identifier record.

    """

    meta = ClassMeta("cobra.model.isis.GrpIdRec")

    meta.moClassName = "isisGrpIdRec"
    meta.rnFormat = "grp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Group IP Record"
    ...
    meta.parentClasses.add("cobra.model.isis.NodeRec")
    ...
    prop = PropMeta("str", "addr", "addr", 3114, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
