...
class Nexthop(Mo):
    ...
    meta = ClassMeta("cobra.model.isis.Nexthop")

    meta.moClassName = "isisNexthop"
    meta.rnFormat = "nh-[%(nhIf)s]-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IS-IS Nexthop"
    ...
    meta.childClasses.add("cobra.model.isis.RtNhAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.isis.RtNhAtt", "rtnhAtt-"))
    ...
    prop = PropMeta("str", "addr", "addr", 3215, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "if", "if", 3213, PropCategory.REGULAR)
    prop.label = "Interface (IOD Internal)"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "nhIf", "nhIf", 3214, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, nhIf, addr, markDirty=True, **creationProps):
        namingVals = [nhIf, addr]
