...
# ##################################################
class TreeCalcNodeStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist"


    meta.moClassName = "isisTreeCalcNodeStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats"
    ...
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.isis.TreeCalcNodeStatsHist5min")
    ...
    prop = PropMeta("str", "leafCountAvg", "leafCountAvg", 9546, PropCategory.IMPLICIT_AVG)
    prop.label = "leaf count average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("leafCountAvg", prop)

    prop = PropMeta("str", "leafCountCum", "leafCountCum", 9542, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "leaf count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("leafCountCum", prop)

    prop = PropMeta("str", "leafCountMax", "leafCountMax", 9545, PropCategory.IMPLICIT_MAX)
    prop.label = "leaf count maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("leafCountMax", prop)

    prop = PropMeta("str", "leafCountMin", "leafCountMin", 9544, PropCategory.IMPLICIT_MIN)
    prop.label = "leaf count minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("leafCountMin", prop)

    prop = PropMeta("str", "leafCountPer", "leafCountPer", 9543, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "leaf count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("leafCountPer", prop)

    prop = PropMeta("str", "leafCountRate", "leafCountRate", 9550, PropCategory.IMPLICIT_RATE)
    prop.label = "leaf count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("leafCountRate", prop)

    prop = PropMeta("str", "leafCountSpct", "leafCountSpct", 9547, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "leaf count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("leafCountSpct", prop)

    prop = PropMeta("str", "leafCountThr", "leafCountThr", 9548, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "leafCountTr", "leafCountTr", 9549, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "spineCountAvg", "spineCountAvg", 9573, PropCategory.IMPLICIT_AVG)
    prop.label = "spine count average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("spineCountAvg", prop)

    prop = PropMeta("str", "spineCountCum", "spineCountCum", 9569, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "spine count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("spineCountCum", prop)

    prop = PropMeta("str", "spineCountMax", "spineCountMax", 9572, PropCategory.IMPLICIT_MAX)
    prop.label = "spine count maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("spineCountMax", prop)

    prop = PropMeta("str", "spineCountMin", "spineCountMin", 9571, PropCategory.IMPLICIT_MIN)
    prop.label = "spine count minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("spineCountMin", prop)

    prop = PropMeta("str", "spineCountPer", "spineCountPer", 9570, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "spine count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("spineCountPer", prop)

    prop = PropMeta("str", "spineCountRate", "spineCountRate", 9577, PropCategory.IMPLICIT_RATE)
    prop.label = "spine count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("spineCountRate", prop)

    prop = PropMeta("str", "spineCountSpct", "spineCountSpct", 9574, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "spine count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("spineCountSpct", prop)

    prop = PropMeta("str", "spineCountThr", "spineCountThr", 9575, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "spineCountTr", "spineCountTr", 9576, PropCategory.IMPLICIT_TREND)
