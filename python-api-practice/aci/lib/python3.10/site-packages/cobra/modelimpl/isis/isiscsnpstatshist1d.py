...
# ##################################################
class IsisCsnpStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist1d", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist1d"
    meta.rnFormat = "HDisisIsisCsnpStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 45810, PropCategory.REGULAR)
