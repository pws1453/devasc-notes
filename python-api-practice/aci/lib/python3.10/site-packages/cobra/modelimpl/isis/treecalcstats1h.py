...
# ##################################################
class TreeCalcStats1h(Mo):
    """
    A class that represents the most current statistics for FTAG global in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStats1h", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStats1h"
    meta.rnFormat = "CDisisTreeCalcStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global stats in 1 hour"
