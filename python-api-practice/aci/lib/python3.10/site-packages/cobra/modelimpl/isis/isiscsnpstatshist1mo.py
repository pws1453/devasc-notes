...
# ##################################################
class IsisCsnpStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist1mo", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist1mo"
    meta.rnFormat = "HDisisIsisCsnpStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 45812, PropCategory.REGULAR)
