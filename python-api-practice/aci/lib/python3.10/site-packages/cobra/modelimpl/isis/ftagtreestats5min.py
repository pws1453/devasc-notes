...
# ##################################################
class FtagTreeStats5min(Mo):
    """
    A class that represents the most current statistics for FTAG in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStats5min", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStats5min"
    meta.rnFormat = "CDisisFtagTreeStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG stats in 5 minute"
