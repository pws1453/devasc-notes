...
# ##################################################
class IsisCsnpStats15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats15min", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats15min"
    meta.rnFormat = "CDisisIsisCsnpStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDisisIsisCsnpStats15min', False),
    ]
