...
# ##################################################
class TreeCalcNodeStatsHist1h(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist1h", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist1h"
    meta.rnFormat = "HDisisTreeCalcNodeStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6713, PropCategory.REGULAR)
