...
# ##################################################
class IsisCsnpStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist1h", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist1h"
    meta.rnFormat = "HDisisIsisCsnpStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 45811, PropCategory.REGULAR)
