...
class ExtIf(Mo):
    ...
    meta = ClassMeta("cobra.model.isis.ExtIf")

    meta.moClassName = "isisExtIf"
    meta.rnFormat = "extif-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IS-IS Interface"
    ...
    prop = PropMeta("str", "fabricId", "fabricId", 20656, PropCategory.REGULAR)
    prop.label = "Destination Fabric ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "flags", "flags", 30379, PropCategory.REGULAR)
    prop.label = "flags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("trans-cap", "translation-capable", 1)
    meta.props.add("flags", prop)

    prop = PropMeta("str", "id", "id", 20711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 32891, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "netId", "netId", 20657, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "role", "role", 20658, PropCategory.REGULAR)
    prop.label = "Role"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "native-mcast"
    prop._addConstant("he-repl", "head-end-replication", 2)
    prop._addConstant("ingr-he-repl", "ingress-head-end-replication", 3)
    prop._addConstant("native-mcast", "inter-fabric", 0)
    prop._addConstant("remote-ileaf", "remote-ileaf", 1)
    ...
    prop = PropMeta("str", "transCapError", "transCapError", 32711, PropCategory.REGULAR)
    prop.label = "Translation Capability Error"
    prop.isOper = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("transCapError", prop)
