...
# ##################################################
class TreeCalcStatsHist1year(Mo):
    """
    A class that represents historical statistics for FTAG global in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStatsHist1year", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStatsHist1year"
    meta.rnFormat = "HDisisTreeCalcStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6725, PropCategory.REGULAR)
