...
# ##################################################
class TreeCalcNodeStatsHist1mo(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist1mo", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist1mo"
    meta.rnFormat = "HDisisTreeCalcNodeStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6714, PropCategory.REGULAR)
