...
# ##################################################
class IsisCsnpStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist1w", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist1w"
    meta.rnFormat = "HDisisIsisCsnpStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 45814, PropCategory.REGULAR)
