...
# ##################################################
class IsisPsnpStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist"


    meta.moClassName = "isisIsisPsnpStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.isis.IsisPsnpStatsHist1year")
