...
# ##################################################
class TreeCalcNodeStats1qtr(Mo):
    """
    A class that represents the most current statistics for FTAG global node in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStats1qtr", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStats1qtr"
    meta.rnFormat = "CDisisTreeCalcNodeStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global node stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcNodeStats1qtr', False),
    ]
