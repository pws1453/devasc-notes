...
# ##################################################
class TreeCalcStatsHist1h(Mo):
    """
    A class that represents historical statistics for FTAG global in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStatsHist1h", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStatsHist1h"
    meta.rnFormat = "HDisisTreeCalcStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6721, PropCategory.REGULAR)
