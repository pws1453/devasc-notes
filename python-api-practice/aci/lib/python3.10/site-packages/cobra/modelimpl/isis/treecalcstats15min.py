...
# ##################################################
class TreeCalcStats15min(Mo):
    """
    A class that represents the most current statistics for FTAG global in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStats15min", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStats15min"
    meta.rnFormat = "CDisisTreeCalcStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcStats15min', False),
    ]
