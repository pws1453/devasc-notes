...
# ##################################################
class IsisCsnpStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist1qtr", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist1qtr"
    meta.rnFormat = "HDisisIsisCsnpStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 45813, PropCategory.REGULAR)
