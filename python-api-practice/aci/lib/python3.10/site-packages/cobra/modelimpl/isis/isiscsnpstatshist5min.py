...
# ##################################################
class IsisCsnpStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStatsHist5min", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStatsHist5min"
    meta.rnFormat = "HDisisIsisCsnpStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS CSNP Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 45816, PropCategory.REGULAR)
