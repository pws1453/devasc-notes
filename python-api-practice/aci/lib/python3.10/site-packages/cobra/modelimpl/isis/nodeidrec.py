...
class NodeIdRec(Mo):
    """
    The fabric nodes active for this multicast group element.

    """

    meta = ClassMeta("cobra.model.isis.NodeIdRec")

    meta.moClassName = "isisNodeIdRec"
    meta.rnFormat = "node-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Node ID Record"
    ...
    prop = PropMeta("str", "addr", "addr", 3220, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
