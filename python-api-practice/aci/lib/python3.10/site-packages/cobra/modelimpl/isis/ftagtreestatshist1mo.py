...
# ##################################################
class FtagTreeStatsHist1mo(Mo):
    """
    A class that represents historical statistics for FTAG in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist1mo", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist1mo"
    meta.rnFormat = "HDisisFtagTreeStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6700, PropCategory.REGULAR)
