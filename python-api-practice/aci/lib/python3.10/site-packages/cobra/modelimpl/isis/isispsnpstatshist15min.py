...
# ##################################################
class IsisPsnpStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist15min", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist15min"
    meta.rnFormat = "HDisisIsisPsnpStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 45849, PropCategory.REGULAR)
