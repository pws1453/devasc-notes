...
# ##################################################
class IsisCsnpStats1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats1w", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats1w"
    meta.rnFormat = "CDisisIsisCsnpStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats in 1 week"
