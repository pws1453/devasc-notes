...
# ##################################################
class FtagTreeStatsHist1qtr(Mo):
    """
    A class that represents historical statistics for FTAG in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist1qtr", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist1qtr"
    meta.rnFormat = "HDisisFtagTreeStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6701, PropCategory.REGULAR)
