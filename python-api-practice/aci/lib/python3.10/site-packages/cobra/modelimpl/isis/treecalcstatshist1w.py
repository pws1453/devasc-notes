...
# ##################################################
class TreeCalcStatsHist1w(Mo):
    """
    A class that represents historical statistics for FTAG global in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStatsHist1w", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStatsHist1w"
    meta.rnFormat = "HDisisTreeCalcStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6724, PropCategory.REGULAR)
