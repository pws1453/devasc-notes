...
# ##################################################
class IsisPsnpStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist1w", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist1w"
    meta.rnFormat = "HDisisIsisPsnpStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 45854, PropCategory.REGULAR)
