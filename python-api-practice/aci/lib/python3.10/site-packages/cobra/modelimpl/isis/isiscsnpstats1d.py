...
# ##################################################
class IsisCsnpStats1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats1d", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats1d"
    meta.rnFormat = "CDisisIsisCsnpStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats in 1 day"
