...
# ##################################################
class TreeCalcStatsHist1d(Mo):
    """
    A class that represents historical statistics for FTAG global in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStatsHist1d", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStatsHist1d"
    meta.rnFormat = "HDisisTreeCalcStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6720, PropCategory.REGULAR)
