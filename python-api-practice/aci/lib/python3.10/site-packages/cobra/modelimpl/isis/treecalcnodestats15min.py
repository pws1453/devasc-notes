...
# ##################################################
class TreeCalcNodeStats15min(Mo):
    """
    A class that represents the most current statistics for FTAG global node in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStats15min", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStats15min"
    meta.rnFormat = "CDisisTreeCalcNodeStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global node stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcNodeStats15min', False),
    ]
