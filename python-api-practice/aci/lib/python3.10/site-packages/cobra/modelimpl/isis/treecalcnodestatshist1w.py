...
# ##################################################
class TreeCalcNodeStatsHist1w(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist1w", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist1w"
    meta.rnFormat = "HDisisTreeCalcNodeStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6716, PropCategory.REGULAR)
