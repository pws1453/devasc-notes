...
# ##################################################
class TreeCalcStatsHist1qtr(Mo):
    """
    A class that represents historical statistics for FTAG global in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStatsHist1qtr", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStatsHist1qtr"
    meta.rnFormat = "HDisisTreeCalcStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6723, PropCategory.REGULAR)
