...
# ##################################################
class TreeCalcStats1year(Mo):
    """
    A class that represents the most current statistics for FTAG global in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStats1year", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStats1year"
    meta.rnFormat = "CDisisTreeCalcStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcStats1year', False),
    ]
