...
# ##################################################
class TreeCalcStatsHist5min(Mo):
    """
    A class that represents historical statistics for FTAG global in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStatsHist5min", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStatsHist5min"
    meta.rnFormat = "HDisisTreeCalcStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6726, PropCategory.REGULAR)
