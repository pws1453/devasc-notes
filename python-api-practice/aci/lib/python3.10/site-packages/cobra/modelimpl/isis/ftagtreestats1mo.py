...
# ##################################################
class FtagTreeStats1mo(Mo):
    """
    A class that represents the most current statistics for FTAG in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStats1mo", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStats1mo"
    meta.rnFormat = "CDisisFtagTreeStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG stats in 1 month"
