...
# ##################################################
class FtagTreeStats15min(Mo):
    """
    A class that represents the most current statistics for FTAG in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStats15min", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStats15min"
    meta.rnFormat = "CDisisFtagTreeStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDisisFtagTreeStats15min', False),
    ]
