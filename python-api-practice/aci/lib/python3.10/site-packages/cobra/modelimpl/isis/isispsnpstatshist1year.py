...
# ##################################################
class IsisPsnpStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist1year", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist1year"
    meta.rnFormat = "HDisisIsisPsnpStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 45855, PropCategory.REGULAR)
