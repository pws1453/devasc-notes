...
class IpRec(Mo):
    """
    The IP Prefix record.

    """

    meta = ClassMeta("cobra.model.isis.IpRec")

    meta.moClassName = "isisIpRec"
    meta.rnFormat = "iprec-[%(pfx)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Prefix Record"
    ...
    meta.parentClasses.add("cobra.model.isis.LspRec")
    ...
    prop = PropMeta("str", "metric", "metric", 3255, PropCategory.REGULAR)
    prop.label = "Metric"
    prop.isOper = True
    prop.range = [(1, 63)]
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "pfx", "pfx", 3254, PropCategory.REGULAR)
    prop.label = "Prefix"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "udBit", "udBit", 3256, PropCategory.REGULAR)
    prop.label = "Up/down Bit"
    prop.isOper = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("udBit", prop)
