...
# ##################################################
class TreeCalcNodeStatsHist1qtr(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist1qtr", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist1qtr"
    meta.rnFormat = "HDisisTreeCalcNodeStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6715, PropCategory.REGULAR)
