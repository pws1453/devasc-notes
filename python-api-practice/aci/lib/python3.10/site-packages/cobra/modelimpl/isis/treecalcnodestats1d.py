...
# ##################################################
class TreeCalcNodeStats1d(Mo):
    """
    A class that represents the most current statistics for FTAG global node in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStats1d", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStats1d"
    meta.rnFormat = "CDisisTreeCalcNodeStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global node stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcNodeStats1d', False),
    ]
