...
# ##################################################
class TreeCalcNodeStats1year(Mo):
    """
    A class that represents the most current statistics for FTAG global node in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStats1year", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStats1year"
    meta.rnFormat = "CDisisTreeCalcNodeStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global node stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcNodeStats1year', False),
    ]
