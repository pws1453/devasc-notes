...
# ##################################################
class TreeCalcNodeStatsHist1year(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist1year", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist1year"
    meta.rnFormat = "HDisisTreeCalcNodeStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6717, PropCategory.REGULAR)
