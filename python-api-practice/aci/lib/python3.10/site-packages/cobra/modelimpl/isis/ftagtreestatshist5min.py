...
# ##################################################
class FtagTreeStatsHist5min(Mo):
    """
    A class that represents historical statistics for FTAG in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist5min", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist5min"
    meta.rnFormat = "HDisisFtagTreeStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6704, PropCategory.REGULAR)
