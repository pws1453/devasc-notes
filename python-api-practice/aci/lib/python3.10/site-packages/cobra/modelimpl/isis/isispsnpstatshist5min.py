...
# ##################################################
class IsisPsnpStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist5min", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist5min"
    meta.rnFormat = "HDisisIsisPsnpStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 45856, PropCategory.REGULAR)
