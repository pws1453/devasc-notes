...
# ##################################################
class TreeCalcStats1qtr(Mo):
    """
    A class that represents the most current statistics for FTAG global in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStats1qtr", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStats1qtr"
    meta.rnFormat = "CDisisTreeCalcStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global stats in 1 quarter"
