...
# ##################################################
class TreeCalcStats1d(Mo):
    """
    A class that represents the most current statistics for FTAG global in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStats1d", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStats1d"
    meta.rnFormat = "CDisisTreeCalcStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global stats in 1 day"
