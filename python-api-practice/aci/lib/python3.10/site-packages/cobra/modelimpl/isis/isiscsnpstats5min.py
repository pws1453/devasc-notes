...
# ##################################################
class IsisCsnpStats5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats5min", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats5min"
    meta.rnFormat = "CDisisIsisCsnpStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats in 5 minute"
