...
# ##################################################
class FtagTreeStats1d(Mo):
    """
    A class that represents the most current statistics for FTAG in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStats1d", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStats1d"
    meta.rnFormat = "CDisisFtagTreeStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG stats in 1 day"
