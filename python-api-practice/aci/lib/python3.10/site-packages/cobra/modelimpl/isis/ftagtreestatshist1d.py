...
# ##################################################
class FtagTreeStatsHist1d(Mo):
    """
    A class that represents historical statistics for FTAG in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist1d", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist1d"
    meta.rnFormat = "HDisisFtagTreeStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6698, PropCategory.REGULAR)
