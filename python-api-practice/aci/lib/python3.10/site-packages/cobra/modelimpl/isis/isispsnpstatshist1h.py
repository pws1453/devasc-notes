...
# ##################################################
class IsisPsnpStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisPsnpStatsHist1h", "ISIS PSNP Packets")
    ...
    meta.moClassName = "isisIsisPsnpStatsHist1h"
    meta.rnFormat = "HDisisIsisPsnpStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ISIS PSNP Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 45851, PropCategory.REGULAR)
