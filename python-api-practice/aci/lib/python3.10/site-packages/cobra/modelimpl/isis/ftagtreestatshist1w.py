...
# ##################################################
class FtagTreeStatsHist1w(Mo):
    """
    A class that represents historical statistics for FTAG in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStatsHist1w", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStatsHist1w"
    meta.rnFormat = "HDisisFtagTreeStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6702, PropCategory.REGULAR)
