...
# ##################################################
class TreeCalcNodeStatsHist1d(Mo):
    """
    A class that represents historical statistics for FTAG global node in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStatsHist1d", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStatsHist1d"
    meta.rnFormat = "HDisisTreeCalcNodeStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global node stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDisisTreeCalcNodeStats1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6712, PropCategory.REGULAR)
