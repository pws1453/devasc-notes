...
class Entity(Mo):
    """
    IS-IS control plane entity information.

    """

    meta = ClassMeta("cobra.model.isis.Entity")

    meta.moClassName = "isisEntity"
    meta.rnFormat = "isis"
    meta.category = MoCategory.REGULAR
    meta.label = "IS-IS Entity"
    ...
    meta.childClasses.add("cobra.model.isis.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.isis.Inst", "inst-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14495, PropCategory.REGULAR)
