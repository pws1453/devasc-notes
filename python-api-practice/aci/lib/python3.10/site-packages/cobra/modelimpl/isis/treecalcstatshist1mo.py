...
# ##################################################
class TreeCalcStatsHist1mo(Mo):
    """
    A class that represents historical statistics for FTAG global in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStatsHist1mo", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStatsHist1mo"
    meta.rnFormat = "HDisisTreeCalcStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FTAG global stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6722, PropCategory.REGULAR)
