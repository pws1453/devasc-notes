...
# ##################################################
class IsisCsnpStats(Mo):
    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats"


    meta.moClassName = "isisIsisCsnpStats"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats1h")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats5min")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats1mo")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats1d")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats1year")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats15min")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats1qtr")
    meta.concreteSubClasses.add("cobra.model.isis.IsisCsnpStats1w")
