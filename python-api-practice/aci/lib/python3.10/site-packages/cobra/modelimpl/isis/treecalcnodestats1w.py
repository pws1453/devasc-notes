...
# ##################################################
class TreeCalcNodeStats1w(Mo):
    """
    A class that represents the most current statistics for FTAG global node in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcNodeStats1w", "FTAG global node")
    ...
    meta.moClassName = "isisTreeCalcNodeStats1w"
    meta.rnFormat = "CDisisTreeCalcNodeStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global node stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDisisTreeCalcNodeStats1w', False),
    ]
