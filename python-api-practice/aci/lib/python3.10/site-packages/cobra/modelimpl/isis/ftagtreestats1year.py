...
# ##################################################
class FtagTreeStats1year(Mo):
    """
    A class that represents the most current statistics for FTAG in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.FtagTreeStats1year", "FTAG")
    ...
    meta.moClassName = "isisFtagTreeStats1year"
    meta.rnFormat = "CDisisFtagTreeStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDisisFtagTreeStats1year', False),
    ]
