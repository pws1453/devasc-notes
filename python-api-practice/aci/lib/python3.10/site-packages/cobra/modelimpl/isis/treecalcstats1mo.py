...
# ##################################################
class TreeCalcStats1mo(Mo):
    """
    A class that represents the most current statistics for FTAG global in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.isis.TreeCalcStats1mo", "FTAG global")
    ...
    meta.moClassName = "isisTreeCalcStats1mo"
    meta.rnFormat = "CDisisTreeCalcStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FTAG global stats in 1 month"
