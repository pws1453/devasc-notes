...
class RsToNveIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hcl3.RsToNveIf", "cobra.model.hcnve.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcl3RsToNveIf"
    meta.rnFormat = "rstoNveIf"
    ...
    meta.childClasses.add("cobra.model.hcl3.NveIfOper")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.NveIfOper", "oper"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 51281, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14988
    prop.defaultValueStr = "hcnveIf"
    prop._addConstant("hcnveIf", None, 14988)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51280, PropCategory.REGULAR)
