...
# ##################################################
class RtBgpPeerTolbRoutedIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcl3.RtBgpPeerTolbRoutedIf", "cobra.model.hcbgp.Peer")

    meta.moClassName = "hcl3RtBgpPeerTolbRoutedIf"
    meta.rnFormat = "rthcbgpBgpPeerTolbRoutedIf-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rthcbgpBgpPeerTolbRoutedIf-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51268, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14824
    prop.defaultValueStr = "hcbgpPeer"
    prop._addConstant("hcbgpPeer", None, 14824)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56281, PropCategory.REGULAR)
