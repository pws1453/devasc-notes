...
# ##################################################
class RtLoopbackIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcl3.RtLoopbackIf", "cobra.model.hcospf.Dom")

    meta.moClassName = "hcl3RtLoopbackIf"
    meta.rnFormat = "rtloopbackIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51368, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14995
    prop.defaultValueStr = "hcospfDom"
