...
class Vrf(Mo):
    ...
    meta = ClassMeta("cobra.model.hcl3.Vrf")

    meta.moClassName = "hcl3Vrf"
    meta.rnFormat = "vrf-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "VRF"
    meta.writeAccessMask = 0x408021002001
    meta.readAccessMask = 0x708021002001
    ...
    meta.childClasses.add("cobra.model.hcl2.Bd")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.hcl3.RoutedIf")
    meta.childClasses.add("cobra.model.hcl3.VrfOper")
    meta.childClasses.add("cobra.model.hcl3.RsToNveIf")
    meta.childClasses.add("cobra.model.hcl3.LoopbackRoutedIf")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.LoopbackRoutedIf", "loopbackroutedif-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.RsToNveIf", "rstoNveIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.RoutedIf", "routed-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.VrfOper", "oper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl2.Bd", "bd-"))

    meta.parentClasses.add("cobra.model.hcloud.Csr")

    meta.superClasses.add("cobra.model.hcl3.AVrf")

    meta.rnPrefixes = [
        ('vrf-', True),
    ]

    prop = PropMeta("str", "bgpRd", "bgpRd", 50274, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 50276, PropCategory.REGULAR)
    prop.label = "Encapsulation"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "encapType", "encapType", 50275, PropCategory.REGULAR)
    prop.label = "Encapsulation Type: VLan/VxLAN"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unknown"
    prop._addConstant("unknown", "unknown", 0)
    prop._addConstant("vlan", "vxlan", 2)
    prop._addConstant("vxlan", "ivxlan", 1)
    meta.props.add("encapType", prop)
    ...
    prop = PropMeta("str", "name", "name", 50738, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 51834, PropCategory.REGULAR)
    prop.label = "VRF Type: Shadow or Regular"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
