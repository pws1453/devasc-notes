...
# ##################################################
class LoopbackRoutedIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcl3.LoopbackRoutedIf")

    meta.moClassName = "hcl3LoopbackRoutedIf"
    meta.rnFormat = "loopbackroutedif-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Loopback if"
    ...
    meta.childClasses.add("cobra.model.hcl3.RtSourceLoopbackRoutedIf")
    meta.childClasses.add("cobra.model.hcl3.RtLoopbackIf")
    meta.childClasses.add("cobra.model.hcl3.LoopbackRoutedIfOper")
    meta.childClasses.add("cobra.model.hcl3.RtBgpPeerTolbRoutedIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.RtSourceLoopbackRoutedIf", "rthcnveSourceLoopbackRoutedIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.RtBgpPeerTolbRoutedIf", "rthcbgpBgpPeerTolbRoutedIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.RtLoopbackIf", "rtloopbackIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.LoopbackRoutedIfOper", "oper"))

    meta.parentClasses.add("cobra.model.hcl3.Vrf")

    meta.superClasses.add("cobra.model.hcl3.ALoopbackRoutedIf")

    meta.rnPrefixes = [
        ('loopbackroutedif-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 50736, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 50270, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 50269, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 50271, PropCategory.REGULAR)
    prop.label = "Type of Loopback"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "dptep"
    prop._addConstant("cptep", "control-plane-tep", 1)
    prop._addConstant("dptep", "data-plane-tep", 2)
