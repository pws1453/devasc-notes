...
# ##################################################
class RtSourceLoopbackRoutedIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcl3.RtSourceLoopbackRoutedIf", "cobra.model.hcnve.If")

    meta.moClassName = "hcl3RtSourceLoopbackRoutedIf"
    meta.rnFormat = "rthcnveSourceLoopbackRoutedIf-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rthcnveSourceLoopbackRoutedIf-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51365, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51364, PropCategory.REGULAR)
