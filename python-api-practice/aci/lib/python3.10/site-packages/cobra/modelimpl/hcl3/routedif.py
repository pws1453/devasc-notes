...
class RoutedIf(Mo):
    ...
    meta = ClassMeta("cobra.model.hcl3.RoutedIf")

    meta.moClassName = "hcl3RoutedIf"
    meta.rnFormat = "routed-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Routed Interface"
    meta.writeAccessMask = 0x408021002001
    meta.readAccessMask = 0x8408021042001
    ...
    meta.childClasses.add("cobra.model.hcl3.RsPhysRoutedAtt")
    meta.childClasses.add("cobra.model.hcl3.RtBgpPeerTohcl3RoutedIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.RtBgpPeerTohcl3RoutedIf", "rtbgpPeerTohcl3RoutedIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcl3.RsPhysRoutedAtt", "rsphysRoutedAtt"))
    ...
    prop = PropMeta("str", "id", "id", 50737, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
