...
# ##################################################
class RsPhysRoutedAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcl3.RsPhysRoutedAtt", "cobra.model.hcl1.GigEthIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hcl3RsPhysRoutedAtt"
    meta.rnFormat = "rsphysRoutedAtt"
    ...
    meta.parentClasses.add("cobra.model.hcl3.RoutedIf")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsphysRoutedAtt', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51278, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14856
    prop.defaultValueStr = "hcl1GigEthIf"
    prop._addConstant("hcl1GigEthIf", None, 14856)
    prop._addConstant("hcl1PhysicalIf", None, 14857)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51277, PropCategory.REGULAR)
