...
class NveIfOper(Mo):
    ...
    meta = ClassMeta("cobra.model.hcl3.NveIfOper")

    meta.moClassName = "hcl3NveIfOper"
    meta.rnFormat = "oper"
    meta.category = MoCategory.REGULAR
    meta.label = "Layer 3 Nve Configuration Oper Mo"
    ...
    meta.parentClasses.add("cobra.model.hcl3.RsToNveIf")
