...
class Ctrlr(Mo):
    ...
    meta = ClassMeta("cobra.model.svccore.Ctrlr")

    meta.moClassName = "svccoreCtrlr"
    meta.rnFormat = "ctrlr-%(ctrlrId)s-svc-%(svcName)s-ts-%(createTime)s"
    meta.category = MoCategory.REGULAR
    meta.label = "History of metadata for a core generated at Ctrlr"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37814, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "createTime", "createTime", 7222, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrlrId", "ctrlrId", 4728, PropCategory.REGULAR)
    prop.label = "Ctrlr ID where the Core File was Created"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39953, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15556, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "svcName", "svcName", 7221, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "ctrlrId"))
    meta.namingProps.append(getattr(meta.props, "svcName"))
    meta.namingProps.append(getattr(meta.props, "createTime"))

    def __init__(self, parentMoOrDn, ctrlrId, svcName, createTime, markDirty=True, **creationProps):
        namingVals = [ctrlrId, svcName, createTime]
