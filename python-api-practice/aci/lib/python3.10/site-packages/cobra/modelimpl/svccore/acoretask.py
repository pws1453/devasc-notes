...
class ACoreTask(Mo):
    """
    An abstraction of a core task.

    """

    meta = ClassMeta("cobra.model.svccore.ACoreTask")

    meta.moClassName = "svccoreACoreTask"
    meta.rnFormat = "svccoreACoreTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5654, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendCoreInfo", "sendcoreinfo", 26)
