...
class NodeTask(Mo):
    ...
    meta = ClassMeta("cobra.model.svccore.NodeTask")

    meta.moClassName = "svccoreNodeTask"
    meta.rnFormat = "svccoreNodeTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5655, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SendCoreInfo", "sendcoreinfo", 38)
