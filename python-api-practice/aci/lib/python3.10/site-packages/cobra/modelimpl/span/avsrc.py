...
# ##################################################
class AVSrc(Mo):
    meta = ClassMeta("cobra.model.span.AVSrc")

    meta.isAbstract = True
    meta.moClassName = "spanAVSrc"
    ...
    meta.concreteSubClasses.add("cobra.model.span.VSrcDef")
    meta.concreteSubClasses.add("cobra.model.span.VSrc")
