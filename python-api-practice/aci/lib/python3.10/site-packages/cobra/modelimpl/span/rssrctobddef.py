...
# ##################################################
class RsSrcToBDDef(Mo):
    """
    A source relation to a private Layer 2 network context that belongs to a specific tenant or context, or is shared.

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToBDDef", "cobra.model.fv.BDDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToBDDef"
    meta.rnFormat = "rssrcToBDDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Source to BDDef Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12998, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12997, PropCategory.REGULAR)
