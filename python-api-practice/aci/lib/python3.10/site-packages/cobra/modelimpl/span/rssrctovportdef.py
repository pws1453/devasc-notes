...
# ##################################################
class RsSrcToVPortDef(Mo):
    """
     Relation to port 

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToVPortDef", "cobra.model.span.CEpDefRef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "spanRsSrcToVPortDef"
    meta.rnFormat = "rssrcToVPortDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to Port"
    ...
    meta.rnPrefixes = [
        ('rssrcToVPortDef-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38127, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40266, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16422, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16416, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5618
    prop.defaultValueStr = "spanCEpDefRef"
    prop._addConstant("spanCEpDefRef", None, 5618)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16415, PropCategory.REGULAR)
