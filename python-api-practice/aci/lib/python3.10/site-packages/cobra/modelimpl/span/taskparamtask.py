...
# ##################################################
class TaskParamTask(Mo):
    """
    The parameter task.

    """

    meta = ClassMeta("cobra.model.span.TaskParamTask")

    meta.moClassName = "spanTaskParamTask"
    meta.rnFormat = "spanTaskParamTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5703, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateSpanSrcGrpDef", "updatespansrcgrpdef", 635)
