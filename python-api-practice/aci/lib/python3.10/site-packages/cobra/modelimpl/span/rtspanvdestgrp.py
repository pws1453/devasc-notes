...
# ##################################################
class RtSpanVDestGrp(Mo):
    """
    A target relation to the VSPAN destination group.

    """

    meta = TargetRelationMeta("cobra.model.span.RtSpanVDestGrp", "cobra.model.infra.AccGrp")

    meta.moClassName = "spanRtSpanVDestGrp"
    meta.rnFormat = "rtinfraSpanVDestGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13236, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13235, PropCategory.REGULAR)
