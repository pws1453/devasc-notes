...
# ##################################################
class RsDestToVPortDef(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.span.RsDestToVPortDef", "cobra.model.span.CEpDefRef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "spanRsDestToVPortDef"
    meta.rnFormat = "rsdestToVPortDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VSPAN Destination Vport"
    ...
    meta.rnPrefixes = [
        ('rsdestToVPortDef-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38128, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40267, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16423, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16420, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16419, PropCategory.REGULAR)
