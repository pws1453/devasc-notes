...
class RetrySrc(Mo):
    """
    The retry source information.

    """

    meta = ClassMeta("cobra.model.span.RetrySrc")

    meta.moClassName = "spanRetrySrc"
    meta.rnFormat = "src-[%(srcDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "SPAN Retry Src Item"
    ...
    meta.childClasses.add("cobra.model.span.RetryTarget")

    meta.childNamesAndRnPrefix.append(("cobra.model.span.RetryTarget", "tgt-"))

    meta.parentClasses.add("cobra.model.span.RetryCont")
    ...
    prop = PropMeta("str", "srcDn", "srcDn", 15851, PropCategory.REGULAR)
    prop.label = "RetrySrc Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.namingProps.append(getattr(meta.props, "srcDn"))
    getattr(meta.props, "srcDn").needDelimiter = True

    def __init__(self, parentMoOrDn, srcDn, markDirty=True, **creationProps):
        namingVals = [srcDn]
