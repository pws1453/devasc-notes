...
class SrcTask(Mo):
    """
    A task to send SPAN and related information across shards.

    """

    meta = ClassMeta("cobra.model.span.SrcTask")

    meta.moClassName = "spanSrcTask"
    meta.rnFormat = "spanSrcTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5702, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportSpanSrcDef", "reportspansrcdef", 634)
