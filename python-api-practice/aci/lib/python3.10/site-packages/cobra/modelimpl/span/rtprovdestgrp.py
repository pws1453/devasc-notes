...
# ##################################################
class RtProvDestGrp(Mo):
    """
    A target relation to the SPAN destination group.

    """

    meta = TargetRelationMeta("cobra.model.span.RtProvDestGrp", "cobra.model.span.SpanProv")

    meta.moClassName = "spanRtProvDestGrp"
    meta.rnFormat = "rtprovDestGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13036, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4170
    prop.defaultValueStr = "spanSpanProv"
    prop._addConstant("spanSpanProv", None, 4170)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13035, PropCategory.REGULAR)
