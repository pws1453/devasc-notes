...
class SpanLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.span.SpanLbl")

    meta.moClassName = "spanSpanLbl"
    meta.rnFormat = "spanlbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SPAN Source-destination Group Match Label"
    ...
    meta.childClasses.add("cobra.model.span.VSpanProv")
    meta.childClasses.add("cobra.model.span.SpanProv")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.VSpanProv", "vspanprov-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.SpanProv", "spanprov-"))
    ...
    meta.superClasses.add("cobra.model.span.ASpanLbl")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37797, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39936, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14634, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7169, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
