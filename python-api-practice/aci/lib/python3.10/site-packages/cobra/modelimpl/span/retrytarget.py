...
# ##################################################
class RetryTarget(Mo):
    """
    The retry target information.

    """

    meta = ClassMeta("cobra.model.span.RetryTarget")

    meta.moClassName = "spanRetryTarget"
    meta.rnFormat = "tgt-[%(targetDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "SPAN Retry Target Item"
    ...
    meta.parentClasses.add("cobra.model.span.RetrySrc")
    ...
    prop = PropMeta("str", "targetDn", "targetDn", 15852, PropCategory.REGULAR)
    prop.label = "RetryTarget Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
