...
class TaskParam(Mo):
    """
    The SPAN source to EPG task information.

    """

    meta = ClassMeta("cobra.model.span.TaskParam")

    meta.moClassName = "spanTaskParam"
    meta.rnFormat = "cont-[%(EpgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Relation to SPAN Src EPG Container"
    ...
    prop = PropMeta("str", "EpgDn", "EpgDn", 4719, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14646, PropCategory.REGULAR)
