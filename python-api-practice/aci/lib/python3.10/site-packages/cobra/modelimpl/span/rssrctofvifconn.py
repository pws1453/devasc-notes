...
# ##################################################
class RsSrcToFvIfConn(Mo):
    """
     Relation to fvIfConn

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToFvIfConn", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToFvIfConn"
    meta.rnFormat = "rssrcToFvIfConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to external L3 interface"
    ...
    prop = PropMeta("str", "encap", "encap", 45650, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "l3extOutDn", "l3extOutDn", 45651, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 45652, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("nodeId", prop)

    prop = PropMeta("str", "pathName", "pathName", 45653, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 37076, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1949
    prop.defaultValueStr = "fvIfConn"
    prop._addConstant("fvIfConn", None, 1949)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 37075, PropCategory.REGULAR)
