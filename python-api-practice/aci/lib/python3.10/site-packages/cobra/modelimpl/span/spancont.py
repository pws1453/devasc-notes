...
class SpanCont(Mo):
    """
    Source Group Definition objects that are created under fv:EpP.

    """

    meta = ClassMeta("cobra.model.span.SpanCont")

    meta.moClassName = "spanSpanCont"
    meta.rnFormat = "span"
    meta.category = MoCategory.REGULAR
    meta.label = "SPAN Container"
