...
# ##################################################
class RtProvToVDestGrp(Mo):
    """
    A target relation to the VSPAN destination group.

    """

    meta = TargetRelationMeta("cobra.model.span.RtProvToVDestGrp", "cobra.model.span.VSpanProv")

    meta.moClassName = "spanRtProvToVDestGrp"
    meta.rnFormat = "rtprovToVDestGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13051, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4194
    prop.defaultValueStr = "spanVSpanProv"
    prop._addConstant("spanVSpanProv", None, 4194)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13050, PropCategory.REGULAR)
