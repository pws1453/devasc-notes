...
# ##################################################
class RsSrcToNode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "spanRsSrcToNode"
    meta.rnFormat = "rssrcToNode-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to Node"
    ...
    prop = PropMeta("str", "annotation", "annotation", 47389, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47390, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 47378, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 47377, PropCategory.REGULAR)
