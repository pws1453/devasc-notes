...
# ##################################################
class RsSrcToL3extOut(Mo):
    """
     Relation to l3extOut 

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToL3extOut", "cobra.model.l3ext.Out")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToL3extOut"
    meta.rnFormat = "rssrcToL3extOut"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to l3extOut"
    ...
    meta.rnPrefixes = [
        ('rssrcToL3extOut', False),
    ]

    prop = PropMeta("str", "addr", "addr", 37068, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 38843, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 37069, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40982, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "owner", "owner", 37070, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 37072, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 37071, PropCategory.REGULAR)
