...
# ##################################################
class RsProvToVDestGrp(Mo):
    """
    A source relation to the name of the group used to match VSPAN sources with VSPAN destination(s).

    """

    meta = NamedSourceRelationMeta("cobra.model.span.RsProvToVDestGrp", "cobra.model.span.VDestGrp")
    meta.targetNameProps["name"] = "tnSpanVDestGrpName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsProvToVDestGrp"
    meta.rnFormat = "rsprovToVDestGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VSPAN VDestination Provider to Group"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14660, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnSpanVDestGrpName", "tnSpanVDestGrpName", 13048, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
