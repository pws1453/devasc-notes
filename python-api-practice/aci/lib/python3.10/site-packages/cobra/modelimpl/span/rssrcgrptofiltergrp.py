...
# ##################################################
class RsSrcGrpToFilterGrp(Mo):
    """
    Relation to Filter Group

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcGrpToFilterGrp", "cobra.model.span.FilterGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcGrpToFilterGrp"
    meta.rnFormat = "rssrcGrpToFilterGrp"
    ...
    meta.rnPrefixes = [
        ('rssrcGrpToFilterGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 45777, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45778, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 45770, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45769, PropCategory.REGULAR)
