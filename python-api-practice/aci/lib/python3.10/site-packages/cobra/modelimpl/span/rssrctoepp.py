...
class RsSrcToEpP(Mo):
    """
     Relation to EpP created implicitly when srcToEpg is created under infra:Infra heirarchy 

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToEpP", "cobra.model.fv.EpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToEpP"
    meta.rnFormat = "rssrcToEpP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to End Point Profile"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14630, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13010, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1936
    prop.defaultValueStr = "fvEpP"
    prop._addConstant("fvEpP", None, 1936)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13009, PropCategory.REGULAR)
