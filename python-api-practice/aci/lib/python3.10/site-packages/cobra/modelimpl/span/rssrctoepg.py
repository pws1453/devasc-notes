...
class RsSrcToEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.span.RsSrcToEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToEpg"
    meta.rnFormat = "rssrcToEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to EPG"
    ...
    meta.childClasses.add("cobra.model.span.TaskParam")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.span.TaskParam", "cont-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37793, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39932, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14628, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "owner", "owner", 20748, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 12980, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12979, PropCategory.REGULAR)
