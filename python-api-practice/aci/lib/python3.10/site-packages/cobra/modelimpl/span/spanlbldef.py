...
class SpanLblDef(Mo):
    """
    The SPAN label definition.

    """

    meta = ClassMeta("cobra.model.span.SpanLblDef")

    meta.moClassName = "spanSpanLblDef"
    meta.rnFormat = "spanlbldef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SPAN Label Def."
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14635, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7170, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
