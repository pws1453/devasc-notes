...
class RsSrcToCtx(Mo):
    """
    A source relation to the private Layer 3 network context that belongs to a specific tenant or is shared.

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToCtx", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToCtx"
    meta.rnFormat = "rssrcToCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to Ctx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37796, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39935, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13002, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13001, PropCategory.REGULAR)
