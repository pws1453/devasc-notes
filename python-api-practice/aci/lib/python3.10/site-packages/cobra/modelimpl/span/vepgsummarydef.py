...
# ##################################################
class VEpgSummaryDef(Mo):
    """
    The VSPAN EpgSummaryDef is used for VERSPAN definitions.

    """

    meta = ClassMeta("cobra.model.span.VEpgSummaryDef")

    meta.moClassName = "spanVEpgSummaryDef"
    meta.rnFormat = "vepgsummarydef"
    meta.category = MoCategory.REGULAR
    meta.label = "Copy of  VSPAN Epg Summary Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14658, PropCategory.REGULAR)
