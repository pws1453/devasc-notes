...
# ##################################################
class RsSpanSrcToL2CktEpAtt(Mo):
    """
    A source relation to the abstraction of a circuit endpoint.

    """

    meta = SourceRelationMeta("cobra.model.span.RsSpanSrcToL2CktEpAtt", "cobra.model.l2.CktEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSpanSrcToL2CktEpAtt"
    meta.rnFormat = "rsspanSrcToL2CktEpAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Span Circuit Endpoint"
    ...
    prop = PropMeta("str", "id", "id", 12618, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14400, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 12619, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 12620, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "spanCfgFailedBmp", "spanCfgFailedBmp", 15176, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:RsSpanSrcToL2CktEpAttforceResolve_failed_flag", None, 4)
    prop._addConstant("span:RsSpanSrcToL2CktEpAttid_failed_flag", None, 128)
    prop._addConstant("span:RsSpanSrcToL2CktEpAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("span:RsSpanSrcToL2CktEpAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("span:RsSpanSrcToL2CktEpAttmonPolDn_failed_flag", None, 256)
    prop._addConstant("span:RsSpanSrcToL2CktEpAttrType_failed_flag", None, 8)
    prop._addConstant("span:RsSpanSrcToL2CktEpAttstateQual_failed_flag", None, 32)
    prop._addConstant("span:RsSpanSrcToL2CktEpAttstate_failed_flag", None, 16)
    prop._addConstant("span:RsSpanSrcToL2CktEpAtttCl_failed_flag", None, 1)
    prop._addConstant("span:RsSpanSrcToL2CktEpAtttDn_failed_flag", None, 2)
    prop._addConstant("span:RsSpanSrcToL2CktEpAtttSKey_failed_flag", None, 16384)
    prop._addConstant("span:RsSpanSrcToL2CktEpAtttType_failed_flag", None, 64)
    meta.props.add("spanCfgFailedBmp", prop)

    prop = PropMeta("str", "spanCfgFailedTs", "spanCfgFailedTs", 15178, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("spanCfgFailedTs", prop)

    prop = PropMeta("str", "spanCfgState", "spanCfgState", 15177, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12617, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3422
    prop.defaultValueStr = "l2CktEp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12616, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15043, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
