...
class RsDestEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.span.RsDestEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsDestEpg"
    meta.rnFormat = "rsdestEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Destination EPG"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37799, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dscp", "dscp", 13015, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39938, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "finalIp", "finalIp", 21192, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("finalIp", prop)

    prop = PropMeta("str", "flowId", "flowId", 13016, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 1023)]
    ...
    prop = PropMeta("str", "ip", "ip", 13017, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mode", "mode", 13018, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14637, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "mtu", "mtu", 13019, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(64, 9216)]
    ...
    prop = PropMeta("str", "srcIpPrefix", "srcIpPrefix", 13020, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 13014, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13013, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ttl", "ttl", 13021, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    ...
    prop = PropMeta("str", "ver", "ver", 13022, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "verEnforced", "verEnforced", 24093, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
