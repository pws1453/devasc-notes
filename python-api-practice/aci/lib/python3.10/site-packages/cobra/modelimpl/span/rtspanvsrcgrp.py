...
# ##################################################
class RtSpanVSrcGrp(Mo):
    """
    A target relation to the VSPAN source group.

    """

    meta = TargetRelationMeta("cobra.model.span.RtSpanVSrcGrp", "cobra.model.infra.AccGrp")

    meta.moClassName = "spanRtSpanVSrcGrp"
    meta.rnFormat = "rtinfraSpanVSrcGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13240, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13239, PropCategory.REGULAR)
