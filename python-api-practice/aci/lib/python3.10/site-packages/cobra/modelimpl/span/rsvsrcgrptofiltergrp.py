...
# ##################################################
class RsVSrcGrpToFilterGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.span.RsVSrcGrpToFilterGrp", "cobra.model.span.FilterGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsVSrcGrpToFilterGrp"
    meta.rnFormat = "rsvSrcGrpToFilterGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from VSPAN Source Grp to span FilterGrp"
    ...
    meta.rnPrefixes = [
        ('rsvSrcGrpToFilterGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55642, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55637, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13213
    prop.defaultValueStr = "spanFilterGrp"
    prop._addConstant("spanFilterGrp", None, 13213)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55636, PropCategory.REGULAR)
