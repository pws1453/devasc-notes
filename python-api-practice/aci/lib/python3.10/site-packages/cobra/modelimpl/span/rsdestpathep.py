...
# ##################################################
class RsDestPathEp(Mo):
    """
    A source relation to an abstraction of a path endpoint.

    """

    meta = SourceRelationMeta("cobra.model.span.RsDestPathEp", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "spanRsDestPathEp"
    meta.rnFormat = "rsdestPathEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Destination Path"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37800, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39939, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14640, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "mtu", "mtu", 27871, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(64, 9216)]
    ...
    prop = PropMeta("str", "noLocalPort", "noLocalPort", 13027, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("noLocalPort", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13026, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13025, PropCategory.REGULAR)
