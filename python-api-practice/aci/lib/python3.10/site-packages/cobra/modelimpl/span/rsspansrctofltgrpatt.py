...
# ##################################################
class RsSpanSrcToFltGrpAtt(Mo):
    """
    .

    """

    meta = SourceRelationMeta("cobra.model.span.RsSpanSrcToFltGrpAtt", "cobra.model.span.FltGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSpanSrcToFltGrpAtt"
    meta.rnFormat = "rsspanSrcToFltGrpAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Source to Filter Group Attachment"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45728, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 47345, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 47346, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "spanCfgFailedBmp", "spanCfgFailedBmp", 47350, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:RsSpanSrcToFltGrpAttforceResolve_failed_flag", None, 4)
    prop._addConstant("span:RsSpanSrcToFltGrpAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("span:RsSpanSrcToFltGrpAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("span:RsSpanSrcToFltGrpAttmonPolDn_failed_flag", None, 128)
    prop._addConstant("span:RsSpanSrcToFltGrpAttrType_failed_flag", None, 8)
    prop._addConstant("span:RsSpanSrcToFltGrpAttstateQual_failed_flag", None, 32)
    prop._addConstant("span:RsSpanSrcToFltGrpAttstate_failed_flag", None, 16)
    prop._addConstant("span:RsSpanSrcToFltGrpAtttCl_failed_flag", None, 1)
    prop._addConstant("span:RsSpanSrcToFltGrpAtttDn_failed_flag", None, 2)
    prop._addConstant("span:RsSpanSrcToFltGrpAtttSKey_failed_flag", None, 8192)
    prop._addConstant("span:RsSpanSrcToFltGrpAtttType_failed_flag", None, 64)
    meta.props.add("spanCfgFailedBmp", prop)

    prop = PropMeta("str", "spanCfgFailedTs", "spanCfgFailedTs", 47352, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("spanCfgFailedTs", prop)

    prop = PropMeta("str", "spanCfgState", "spanCfgState", 47351, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 45725, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13146
    prop.defaultValueStr = "spanFltGrp"
    prop._addConstant("spanFltGrp", None, 13146)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45724, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 45731, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
