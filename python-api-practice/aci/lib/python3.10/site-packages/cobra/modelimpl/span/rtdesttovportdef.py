...
# ##################################################
class RtDestToVPortDef(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.span.RtDestToVPortDef", "cobra.model.span.AVDest")

    meta.moClassName = "spanRtDestToVPortDef"
    meta.rnFormat = "rtdestToVPortDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16421, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16545, PropCategory.REGULAR)
