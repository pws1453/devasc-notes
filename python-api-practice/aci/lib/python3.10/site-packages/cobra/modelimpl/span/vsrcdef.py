...
class VSrcDef(Mo):
    ...
    meta = ClassMeta("cobra.model.span.VSrcDef")

    meta.moClassName = "spanVSrcDef"
    meta.rnFormat = "vsrcdef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract VSPAN Source Definition"
    ...
    meta.childClasses.add("cobra.model.span.RsVsrcToEpg")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.span.RsVsrcToEpg", "rsvsrcToEpg"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37804, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "epgID", "epgID", 4720, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39943, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14649, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7182, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
