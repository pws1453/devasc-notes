...
# ##################################################
class RsSrcToCtxDef(Mo):
    """
     Relation to CtxDef 

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToCtxDef"
    meta.rnFormat = "rssrcToCtxDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Source to CtxDef Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16552, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13006, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13005, PropCategory.REGULAR)
