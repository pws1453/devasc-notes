...
class RsSrcToBD(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.span.RsSrcToBD", "cobra.model.fv.BD")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToBD"
    meta.rnFormat = "rssrcToBD"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Source to Bridge Domain"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37795, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39934, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12994, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12993, PropCategory.REGULAR)
