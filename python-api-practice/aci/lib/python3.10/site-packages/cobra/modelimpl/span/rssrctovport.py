...
# ##################################################
class RsSrcToVPort(Mo):
    """
    A source relation to an endpoint.

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToVPort", "cobra.model.fv.Ep")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "spanRsSrcToVPort"
    meta.rnFormat = "rssrcToVPort-[%(tDn)s]"
    ...
    meta.superClasses.add("cobra.model.span.AToCEp")

    meta.rnPrefixes = [
        ('rssrcToVPort-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37802, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39941, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14647, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13038, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13037, PropCategory.REGULAR)
