...
class CEpDefRef(Mo):
    ...
    meta = ClassMeta("cobra.model.span.CEpDefRef")

    meta.moClassName = "spanCEpDefRef"
    meta.rnFormat = "CEpDR-%(name)s"
    ...
    meta.childClasses.add("cobra.model.span.RtDestToVPortDef")
    meta.childClasses.add("cobra.model.span.RtSrcToVPortDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.span.RtDestToVPortDef", "rtdestToVPortDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.RtSrcToVPortDef", "rtsrcToVPortDef-"))
    ...
    meta.parentClasses.add("cobra.model.span.CEpDefCont")
    ...
    prop = PropMeta("str", "name", "name", 16522, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
