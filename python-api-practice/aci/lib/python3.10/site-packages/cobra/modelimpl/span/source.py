...
class Source(Mo):
    ...
    meta.childClasses.add("cobra.model.span.RsSpanSrcToL2CktEpAtt")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.span.RsSpanSrcToL3OutAtt")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.span.RsSpanSrcToL2CktEpAtt", "rsspanSrcToL2CktEpAtt"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.span.RsSpanSrcToL3OutAtt", "rsspanSrcToL3OutAtt"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14399, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7168, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
