...
class Acct(Mo):
    """
    The SPAN global accounting information.

    """

    meta = ClassMeta("cobra.model.span.Acct")

    meta.moClassName = "spanAcct"
    meta.rnFormat = "acct"
    meta.category = MoCategory.REGULAR
    meta.label = "SPAN Accounting"
    ...
    prop = PropMeta("str", "fltGrpId", "fltGrpId", 45767, PropCategory.REGULAR)
    prop.label = "ID of the Filter Group"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("fltGrpId", prop)

    prop = PropMeta("str", "fstate", "fstate", 20961, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("run-out-of-sessions", "run-out-of-sessions", 1)
    meta.props.add("fstate", prop)

    prop = PropMeta("str", "fstateMap", "fstateMap", 20962, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14645, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sessionId", "sessionId", 15580, PropCategory.REGULAR)
    prop.label = "ID of Session"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("sessionId", prop)

    prop = PropMeta("str", "sessionNum", "sessionNum", 4718, PropCategory.REGULAR)
    prop.label = "Number of Sessions"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("sessionNum", prop)

    prop = PropMeta("str", "sourceId", "sourceId", 15581, PropCategory.REGULAR)
    prop.label = "ID of Source"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("sourceId", prop)
