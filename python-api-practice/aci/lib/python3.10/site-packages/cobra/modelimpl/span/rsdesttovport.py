...
# ##################################################
class RsDestToVPort(Mo):
    """
    A source relation to an endpoint.

    """

    meta = SourceRelationMeta("cobra.model.span.RsDestToVPort", "cobra.model.fv.Ep")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "spanRsDestToVPort"
    meta.rnFormat = "rsdestToVPort-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37810, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39949, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14655, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13046, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13045, PropCategory.REGULAR)
