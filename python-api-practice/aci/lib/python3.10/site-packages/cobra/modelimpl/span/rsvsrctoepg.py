...
# ##################################################
class RsVsrcToEpg(Mo):
    """
    A source relation to a set of endpoints.

    """

    meta = SourceRelationMeta("cobra.model.span.RsVsrcToEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsVsrcToEpg"
    meta.rnFormat = "rsvsrcToEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VSPAN Source to Epg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39944, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13042, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13041, PropCategory.REGULAR)
