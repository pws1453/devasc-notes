...
# ##################################################
class RsSrcToFilterGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.span.RsSrcToFilterGrp", "cobra.model.span.FilterGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSrcToFilterGrp"
    meta.rnFormat = "rssrcToFilterGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Filter Group"
    ...
    meta.rnPrefixes = [
        ('rssrcToFilterGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 45779, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45780, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 45774, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45773, PropCategory.REGULAR)
