...
class RetryCont(Mo):
    """
    Span retry information.

    """

    meta = ClassMeta("cobra.model.span.RetryCont")

    meta.moClassName = "spanRetryCont"
    meta.rnFormat = "retry"
    meta.category = MoCategory.REGULAR
    meta.label = "SPAN Retry Container"
    ...
    meta.childClasses.add("cobra.model.span.RetrySrc")

    meta.childNamesAndRnPrefix.append(("cobra.model.span.RetrySrc", "src-"))
