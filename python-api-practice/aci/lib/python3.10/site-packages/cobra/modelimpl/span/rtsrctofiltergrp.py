...
# ##################################################
class RtSrcToFilterGrp(Mo):
    """
    Relation to Filter Group

    """

    meta = TargetRelationMeta("cobra.model.span.RtSrcToFilterGrp", "cobra.model.span.ASrc")

    meta.moClassName = "spanRtSrcToFilterGrp"
    meta.rnFormat = "rtsrcToFilterGrp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstract SPAN Source"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45776, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4134
    prop.defaultValueStr = "spanASrc"
    ...
    prop = PropMeta("str", "tDn", "tDn", 45775, PropCategory.REGULAR)
