...
# ##################################################
class VEpgSummary(Mo):
    """
    The VEpg summary.

    """

    meta = ClassMeta("cobra.model.span.VEpgSummary")

    meta.moClassName = "spanVEpgSummary"
    meta.rnFormat = "vepgsummary"
    meta.category = MoCategory.REGULAR
    meta.label = "VSPAN Destination EPG Summary"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40240, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18424, PropCategory.REGULAR)
