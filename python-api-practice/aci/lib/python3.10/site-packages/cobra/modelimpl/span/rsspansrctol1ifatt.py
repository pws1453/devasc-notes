...
# ##################################################
class RsSpanSrcToL1IfAtt(Mo):
    """
    A source relation to an abstraction for a Layer 1 interface in the system.

    """

    meta = SourceRelationMeta("cobra.model.span.RsSpanSrcToL1IfAtt", "cobra.model.l1.If")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "spanRsSpanSrcToL1IfAtt"
    meta.rnFormat = "rsspanSrcToL1IfAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L1 Interface Attachment"
    ...
    prop = PropMeta("str", "id", "id", 12611, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14398, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 12612, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 12613, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "spanCfgFailedBmp", "spanCfgFailedBmp", 15173, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:RsSpanSrcToL1IfAttforceResolve_failed_flag", None, 4)
    prop._addConstant("span:RsSpanSrcToL1IfAttid_failed_flag", None, 128)
    prop._addConstant("span:RsSpanSrcToL1IfAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("span:RsSpanSrcToL1IfAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("span:RsSpanSrcToL1IfAttmonPolDn_failed_flag", None, 256)
    prop._addConstant("span:RsSpanSrcToL1IfAttrType_failed_flag", None, 8)
    prop._addConstant("span:RsSpanSrcToL1IfAttstateQual_failed_flag", None, 32)
    prop._addConstant("span:RsSpanSrcToL1IfAttstate_failed_flag", None, 16)
    prop._addConstant("span:RsSpanSrcToL1IfAtttCl_failed_flag", None, 1)
    prop._addConstant("span:RsSpanSrcToL1IfAtttDn_failed_flag", None, 2)
    prop._addConstant("span:RsSpanSrcToL1IfAtttSKey_failed_flag", None, 16384)
    prop._addConstant("span:RsSpanSrcToL1IfAtttType_failed_flag", None, 64)
    meta.props.add("spanCfgFailedBmp", prop)

    prop = PropMeta("str", "spanCfgFailedTs", "spanCfgFailedTs", 15175, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("spanCfgFailedTs", prop)

    prop = PropMeta("str", "spanCfgState", "spanCfgState", 15174, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12610, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3613
    prop.defaultValueStr = "l1If"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12609, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15041, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("tSKey", prop)
