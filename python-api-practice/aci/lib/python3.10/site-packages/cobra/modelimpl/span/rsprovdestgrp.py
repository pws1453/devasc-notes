...
# ##################################################
class RsProvDestGrp(Mo):
    """
    A source relation to the SPAN destination group.

    """

    meta = NamedSourceRelationMeta("cobra.model.span.RsProvDestGrp", "cobra.model.span.DestGrp")
    meta.targetNameProps["name"] = "tnSpanDestGrpName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsProvDestGrp"
    meta.rnFormat = "rsProvDestGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SPAN Destination Provider Group"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14644, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13034, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4158
    prop.defaultValueStr = "spanDestGrp"
    ...
    prop = PropMeta("str", "tnSpanDestGrpName", "tnSpanDestGrpName", 13033, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnSpanDestGrpName", prop)
