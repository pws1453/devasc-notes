...
# ##################################################
class RsSessionToDomainRef(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.span.RsSessionToDomainRef", "cobra.model.aaa.DomainRef")
    meta.targetNameProps["name"] = "tnAaaDomainRefName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSessionToDomainRef"
    meta.rnFormat = "rsSessionToDomainRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Session To AAA Domain Ref"
    ...
    meta.rnPrefixes = [
        ('rsSessionToDomainRef', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38137, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40276, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16583, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "parentSKey", "parentSKey", 16584, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 16580, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnAaaDomainRefName", "tnAaaDomainRefName", 16579, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
