...
class Dest(Mo):
    """
    The SPAN destination is where network traffic is sent for analysis by a network analyzer. A SPAN destination can be local or remote (ERSPAN). When you create a traffic monitoring session, you must select a SPAN source and a SPAN destination. The type of session (Tenant, Access, or Fabric) determines the allowed types of SPAN sources and destinations. The destination can be either a port or an endpoint group. If the destination is a port, it should not be one that has been configured for other purposes.

    """

    meta = ClassMeta("cobra.model.span.Dest")

    meta.moClassName = "spanDest"
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.span.VEpgSummary", "vepgsummary"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.EpgSummary", "epgsummary"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37801, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39940, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("local-dest-connected-apic", "local-destination-is-connected-to-apic", 9)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14641, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7165, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
