...
class RtHpp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hostprot.RtHpp", "cobra.model.opflex.IDEp")

    meta.moClassName = "hostprotRtHpp"
    meta.rnFormat = "rthpp"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Inband Discovered Endpoint"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43416, PropCategory.REGULAR)
