...
class RemoteIp(Mo):
    ...
    meta = ClassMeta("cobra.model.hostprot.RemoteIp")

    meta.moClassName = "hostprotRemoteIp"
    ...
    prop = PropMeta("str", "addr", "addr", 29974, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38634, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40773, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 29990, PropCategory.REGULAR)
