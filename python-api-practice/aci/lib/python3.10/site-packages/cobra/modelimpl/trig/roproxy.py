...
class RoProxy(Mo):
    ...
    meta = ClassMeta("cobra.model.trig.RoProxy")

    meta.moClassName = "trigRoProxy"
    meta.rnFormat = "roproxy-[%(policyDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Proxy object for triggering admin executable policies"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43424, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43425, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43423, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "policyDn", "policyDn", 43420, PropCategory.REGULAR)
    prop.label = "DN of the triggerable policy"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.namingProps.append(getattr(meta.props, "policyDn"))
    getattr(meta.props, "policyDn").needDelimiter = True

    def __init__(self, parentMoOrDn, policyDn, markDirty=True, **creationProps):
        namingVals = [policyDn]
