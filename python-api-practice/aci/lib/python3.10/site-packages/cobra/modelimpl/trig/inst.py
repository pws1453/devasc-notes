...
# ##################################################
class Inst(Mo):
    meta = ClassMeta("cobra.model.trig.Inst")

    meta.isAbstract = True
    meta.moClassName = "trigInst"
    ...
    meta.concreteSubClasses.add("cobra.model.trig.Meta")
    meta.concreteSubClasses.add("cobra.model.trig.Sched")
