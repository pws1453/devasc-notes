...
# ##################################################
class RsExportEncryptionKey(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pki.RsExportEncryptionKey", "cobra.model.pki.ExportEncryptionKey")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pkiRsExportEncryptionKey"
    meta.rnFormat = "rsexportEncryptionKey"
    ...
    meta.parentClasses.add("cobra.model.pki.ExportEncryptionKeyRelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsexportEncryptionKey', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 21507, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7286
    prop.defaultValueStr = "pkiExportEncryptionKey"
    prop._addConstant("pkiExportEncryptionKey", None, 7286)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21506, PropCategory.REGULAR)
