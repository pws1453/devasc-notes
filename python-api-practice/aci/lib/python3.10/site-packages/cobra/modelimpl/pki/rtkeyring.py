...
class RtKeyRing(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.pki.RtKeyRing", "cobra.model.comm.Https")

    meta.moClassName = "pkiRtKeyRing"
    meta.rnFormat = "rtcommKeyRing-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16228, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16227, PropCategory.REGULAR)
