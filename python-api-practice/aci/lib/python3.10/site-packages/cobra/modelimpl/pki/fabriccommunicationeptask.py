...
# ##################################################
class FabricCommunicationEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pki.FabricCommunicationEpTask")

    meta.moClassName = "pkiFabricCommunicationEpTask"
    meta.rnFormat = "pkiFabricCommunicationEpTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('pkiFabricCommunicationEpTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 33355, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PushStrictModeState", "pushstrictmodestate", 2781)
