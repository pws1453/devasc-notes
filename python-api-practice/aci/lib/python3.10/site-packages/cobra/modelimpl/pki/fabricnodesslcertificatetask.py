...
# ##################################################
class FabricNodeSSLCertificateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pki.FabricNodeSSLCertificateTask")

    meta.moClassName = "pkiFabricNodeSSLCertificateTask"
    meta.rnFormat = "pkiFabricNodeSSLCertificateTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('pkiFabricNodeSSLCertificateTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 22526, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PushIFMSSLCerts", "pushifmsslcerts", 1954)
    prop._addConstant("PushIFMSSLCertsFromAD", "pushifmsslcertsfromad", 1953)
