...
# ##################################################
class RtClientCertCA(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.pki.RtClientCertCA", "cobra.model.comm.Https")

    meta.moClassName = "pkiRtClientCertCA"
    meta.rnFormat = "rtcommClientCertCA-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 42744, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1578
    prop.defaultValueStr = "commHttps"
    prop._addConstant("commHttps", None, 1578)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 42743, PropCategory.REGULAR)
