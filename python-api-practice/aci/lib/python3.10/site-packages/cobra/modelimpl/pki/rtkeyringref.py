...
# ##################################################
class RtKeyringRef(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.pki.RtKeyringRef", "cobra.model.aaa.KeyringRelnHolder")

    meta.moClassName = "pkiRtKeyringRef"
    meta.rnFormat = "rtaaaKeyringRef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Keyring Relation Holder"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16341, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5556
    prop.defaultValueStr = "aaaKeyringRelnHolder"
    prop._addConstant("aaaKeyringRelnHolder", None, 5556)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16340, PropCategory.REGULAR)
