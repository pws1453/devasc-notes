...
# ##################################################
class RtSvrKeyRing(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.pki.RtSvrKeyRing", "cobra.model.adepg.ASvr")

    meta.moClassName = "pkiRtSvrKeyRing"
    meta.rnFormat = "rtadepgSvrKeyRing-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43821, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43820, PropCategory.REGULAR)
