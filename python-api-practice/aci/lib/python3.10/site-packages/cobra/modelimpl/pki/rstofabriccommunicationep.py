...
# ##################################################
class RsToFabricCommunicationEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pki.RsToFabricCommunicationEp", "cobra.model.pki.FabricCommunicationEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "pkiRsToFabricCommunicationEp"
    meta.rnFormat = "rstoFabricCommunicationEp"
    ...
    meta.rnPrefixes = [
        ('rstoFabricCommunicationEp', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 22630, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22629, PropCategory.REGULAR)
