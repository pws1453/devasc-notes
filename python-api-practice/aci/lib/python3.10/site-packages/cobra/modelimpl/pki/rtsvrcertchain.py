...
# ##################################################
class RtSvrCertChain(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.pki.RtSvrCertChain", "cobra.model.adepg.ASvr")

    meta.moClassName = "pkiRtSvrCertChain"
    meta.rnFormat = "rtadepgSvrCertChain-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstract auth server"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43817, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12623
    prop.defaultValueStr = "adepgASvr"
    prop._addConstant("adepgASvr", None, 12623)
    prop._addConstant("adepgSvr", None, 12628)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43816, PropCategory.REGULAR)
