...
# ##################################################
class RtListenerToCert(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.pki.RtListenerToCert", "cobra.model.cloud.Listener")

    meta.moClassName = "pkiRtListenerToCert"
    meta.rnFormat = "rtcloudListenerToCert-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Cloud Load Balancer Listener"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52663, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15167
    prop.defaultValueStr = "cloudListener"
    prop._addConstant("cloudListener", None, 15167)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52662, PropCategory.REGULAR)
