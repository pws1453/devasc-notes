...
# ##################################################
class Inst(Mo):
    meta = ClassMeta("cobra.model.fsm.Inst")

    meta.isAbstract = True
    meta.moClassName = "fsmInst"
    ...
    prop = PropMeta("str", "currStage", "currStage", 62, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 44, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "prevStage", "prevStage", 63, PropCategory.REGULAR)
