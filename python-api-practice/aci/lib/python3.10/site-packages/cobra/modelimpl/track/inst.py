...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.track.Inst")

    meta.moClassName = "trackInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "OTM Instance"
    ...
    meta.childClasses.add("cobra.model.fv.IdTracker")
    meta.childClasses.add("cobra.model.track.Object")

    meta.childNamesAndRnPrefix.append(("cobra.model.track.Object", "object-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IdTracker", "obj-"))

    meta.parentClasses.add("cobra.model.track.Entity")
