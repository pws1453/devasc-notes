...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.vsanmgr.Entity")

    meta.moClassName = "vsanmgrEntity"
    meta.rnFormat = "vsanmgr"
    meta.category = MoCategory.REGULAR
    meta.label = "Vsan Manager Entity"
    ...
    meta.childClasses.add("cobra.model.vsanmgr.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vsanmgr.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27082, PropCategory.REGULAR)
