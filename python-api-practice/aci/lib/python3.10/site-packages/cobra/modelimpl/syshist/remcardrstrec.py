...
# ##################################################
class RemCardRstRec(Mo):
    """
    The remote card reset record.

    """

    meta = ClassMeta("cobra.model.syshist.RemCardRstRec")

    meta.moClassName = "syshistRemCardRstRec"
    meta.rnFormat = "remrstrec-%(ts)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Remote Card Reset Record"
    ...
    prop = PropMeta("str", "ts", "ts", 7251, PropCategory.REGULAR)
