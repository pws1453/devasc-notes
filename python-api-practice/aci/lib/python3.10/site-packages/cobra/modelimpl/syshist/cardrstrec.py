...
class CardRstRec(Mo):
    """
    The card reset record.

    """

    meta = ClassMeta("cobra.model.syshist.CardRstRec")

    meta.moClassName = "syshistCardRstRec"
    meta.rnFormat = "rstrec-%(ts)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Card Reset Record"
    ...
    meta.superClasses.add("cobra.model.syshist.RstRec")
    ...
    prop = PropMeta("str", "ts", "ts", 7249, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "ts"))
    ...
    def __init__(self, parentMoOrDn, ts, markDirty=True, **creationProps):
        namingVals = [ts]
