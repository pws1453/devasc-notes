...
# ##################################################
class ExtChCardRstRec(Mo):
    """
    The extended chassis card reset record.

    """

    meta = ClassMeta("cobra.model.syshist.ExtChCardRstRec")

    meta.moClassName = "syshistExtChCardRstRec"
    meta.rnFormat = "rstrec-%(ts)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Extended Chassis Card Reset Record"
    ...
    prop = PropMeta("str", "ts", "ts", 7250, PropCategory.REGULAR)
