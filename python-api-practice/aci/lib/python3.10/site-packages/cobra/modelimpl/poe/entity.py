...
class Entity(Mo):
    """
     Holds Power over Ethernet control plane entity information 

    """

    meta = ClassMeta("cobra.model.poe.Entity")

    meta.moClassName = "poeEntity"
    meta.rnFormat = "poe"
    meta.category = MoCategory.REGULAR
    meta.label = "PoE Entity"
    ...
    meta.childClasses.add("cobra.model.poe.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.poe.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42506, PropCategory.REGULAR)
