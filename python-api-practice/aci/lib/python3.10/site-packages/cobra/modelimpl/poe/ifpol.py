...
class IfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.poe.IfPol")

    meta.moClassName = "poeIfPol"
    meta.rnFormat = "poeIfP-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "POE Interface Policy"
    ...
    meta.childClasses.add("cobra.model.poe.RsPoeEpg")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.poe.RtPoeIfPolCons")
    meta.childClasses.add("cobra.model.poe.RtPoeIfPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.poe.RtPoeIfPolCons", "rtl1PoeIfPolCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.poe.RtPoeIfPol", "rtinfraPoeIfPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.poe.RsPoeEpg", "rspoeEpg"))
    ...
    meta.superClasses.add("cobra.model.poe.AIfPol")
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 50097, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "consumption", "consumption", 34066, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40873, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "max", "max", 34065, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 34064, PropCategory.REGULAR)
    prop.label = "Power Mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34086, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 34069, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "poeEpg", "poeEpg", 42452, PropCategory.REGULAR)
    prop.label = "End Point Group dn"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("poeEpg", prop)

    prop = PropMeta("str", "poeVoiceVlan", "poeVoiceVlan", 42451, PropCategory.REGULAR)
    prop.label = "PoE Vlan"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("poeVoiceVlan", prop)

    prop = PropMeta("str", "policeAct", "policeAct", 34068, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prioHigh", "prioHigh", 34067, PropCategory.REGULAR)
