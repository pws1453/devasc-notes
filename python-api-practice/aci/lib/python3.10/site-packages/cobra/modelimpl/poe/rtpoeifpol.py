...
class RtPoeIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.poe.RtPoeIfPol", "cobra.model.infra.AccPortGrp")

    meta.moClassName = "poeRtPoeIfPol"
    meta.rnFormat = "rtinfraPoeIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34085, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34084, PropCategory.REGULAR)
