...
class RsPoeEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.poe.RsPoeEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "poeRsPoeEpg"
    meta.rnFormat = "rspoeEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "PoE EPg"
    meta.writeAccessMask = 0x2100000000601
    meta.readAccessMask = 0x2100000000601
    ...
    prop = PropMeta("str", "annotation", "annotation", 44916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44917, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44912, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 44905, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44904, PropCategory.REGULAR)
