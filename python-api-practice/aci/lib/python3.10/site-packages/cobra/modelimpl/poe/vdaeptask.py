...
class VDAEpTask(Mo):
    ...
    meta = ClassMeta("cobra.model.poe.VDAEpTask")

    meta.moClassName = "poeVDAEpTask"
    meta.rnFormat = "poeVDAEpTask-%(id)s"
    meta.category = MoCategory.TASK
    meta.label = "None"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x2000008000001
    ...
    prop = PropMeta("str", "id", "id", 42505, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PoeEpAttachOrDetach", "poeepattachordetach", 3111)
