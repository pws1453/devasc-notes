...
class Nic(Mo):
    ...
    meta = ClassMeta("cobra.model.poe.Nic")

    meta.moClassName = "poeNic"
    meta.rnFormat = "poenic-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "poe Nic Class"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42465, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 42459, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vlanType", "vlanType", 42450, PropCategory.REGULAR)
    prop.label = "VlanType"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
