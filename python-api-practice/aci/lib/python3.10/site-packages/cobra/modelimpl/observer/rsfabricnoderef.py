...
# ##################################################
class RsFabricNodeRef(Mo):
    """
    A source relation to the root node for the APIC.

    """

    meta = SourceRelationMeta("cobra.model.observer.RsFabricNodeRef", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "observerRsFabricNodeRef"
    meta.rnFormat = "rsfabricNodeRef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11292, PropCategory.REGULAR)
