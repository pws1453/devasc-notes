...
# ##################################################
class RsVsanLabelAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vsan.RsVsanLabelAtt", "cobra.model.nw.LabelEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vsanRsVsanLabelAtt"
    meta.rnFormat = "rsvsanLabelAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Vsan Label Attachment Interface"
    ...
    meta.superClasses.add("cobra.model.vsan.ARsVsanPathAtt")
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39212, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4094)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 39124, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11879
    prop.defaultValueStr = "nwLabelEp"
    prop._addConstant("nwLabelEp", None, 11879)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 39123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 39211, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "type", "type", 38872, PropCategory.REGULAR)
    prop.label = "native type to represent port vsan"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("untagged", "untagged", 2)
