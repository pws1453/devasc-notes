...
class InstP(Mo):
    ...
    meta = ClassMeta("cobra.model.l2ext.InstP")

    meta.moClassName = "l2extInstP"
    meta.rnFormat = "instP-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Network Instance Profile"
    meta.writeAccessMask = 0x800001
    meta.readAccessMask = 0x608279440186f713
    ...
    meta.childClasses.add("cobra.model.l2ext.RsL2InstPToDomP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.RsL2InstPToDomP", "rsl2InstPToDomP"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37601, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39740, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14202, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6837, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "pcEnfPref", "pcEnfPref", 23075, PropCategory.REGULAR)
