...
class LIfPDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l2ext.LIfPDef")

    meta.moClassName = "l2extLIfPDef"
    meta.rnFormat = "lifp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Interface Profile Definition"
    ...
    meta.childClasses.add("cobra.model.l2ext.RsPathDefL2OutAtt")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.RsPathDefL2OutAtt", "rspathDefL2OutAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.l2ext.DomDef")
    meta.parentClasses.add("cobra.model.l2ext.LNodePDef")
    ...
    prop = PropMeta("str", "name", "name", 6839, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
