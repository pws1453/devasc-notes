...
class LNodeP(Mo):
    ...
    meta = ClassMeta("cobra.model.l2ext.LNodeP")

    meta.moClassName = "l2extLNodeP"
    ...
    meta.childClasses.add("cobra.model.l2ext.LIfP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.LIfP", "lifp-"))
    ...
    meta.superClasses.add("cobra.model.l2ext.ALNodeP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37602, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39741, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14203, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6840, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
