...
class RsL2DomAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l2ext.RsL2DomAtt", "cobra.model.l2ext.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2extRsL2DomAtt"
    meta.rnFormat = "rsl2DomAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Domain Profile"
    meta.writeAccessMask = 0x800001
    meta.readAccessMask = 0x820601
    ...
    prop = PropMeta("str", "annotation", "annotation", 37598, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39737, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14198, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12071, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1744
    prop.defaultValueStr = "l2extDomP"
    prop._addConstant("l2extDomP", None, 1744)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12070, PropCategory.REGULAR)
