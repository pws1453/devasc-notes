...
# ##################################################
class RsPathL2OutAtt(Mo):
    """
    The path endpoint.

    """

    meta = SourceRelationMeta("cobra.model.l2ext.RsPathL2OutAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l2extRsPathL2OutAtt"
    meta.rnFormat = "rspathL2OutAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37604, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 19106, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39743, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12078, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 12080, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
