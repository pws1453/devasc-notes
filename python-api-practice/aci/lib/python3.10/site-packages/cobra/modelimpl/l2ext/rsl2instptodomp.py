...
# ##################################################
class RsL2InstPToDomP(Mo):
    """
    A source relation to the external bridged domain profile.

    """

    meta = SourceRelationMeta("cobra.model.l2ext.RsL2InstPToDomP", "cobra.model.l2ext.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2extRsL2InstPToDomP"
    meta.rnFormat = "rsl2InstPToDomP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12075, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12074, PropCategory.REGULAR)
