...
# ##################################################
class RsPathDefL2OutAtt(Mo):
    """
    The object used to create a static association with a leaf host port. The existence of this object implies that the corresponding set of policies will be resolved into the node pointed to by the relationship.

    """

    meta = SourceRelationMeta("cobra.model.l2ext.RsPathDefL2OutAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l2extRsPathDefL2OutAtt"
    meta.rnFormat = "rspathDefL2OutAtt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.l2ext.LIfPDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rspathDefL2OutAtt-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12084, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 12085, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
