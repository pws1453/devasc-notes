...
class LNodePDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l2ext.LNodePDef")

    meta.moClassName = "l2extLNodePDef"
    meta.rnFormat = "lnodep-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Logical Node Profile Definition"
    ...
    meta.childClasses.add("cobra.model.l2ext.LIfPDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.LIfPDef", "lifp-"))
    ...
    prop = PropMeta("str", "encap", "encap", 15486, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 6841, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
