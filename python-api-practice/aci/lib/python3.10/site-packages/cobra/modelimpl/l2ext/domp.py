...
class DomP(Mo):
    ...
    meta = ClassMeta("cobra.model.l2ext.DomP")

    meta.moClassName = "l2extDomP"
    meta.rnFormat = "l2dom-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L2 Domain Profile"
    meta.writeAccessMask = 0x800001
    meta.readAccessMask = 0x80384001800603
    ...
    meta.childClasses.add("cobra.model.l2ext.RtL2InstPToDomP")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.l2ext.RtL2DomAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.RtL2InstPToDomP", "rtl2InstPToDomP-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.RtL2DomAtt", "rtl2DomAtt-"))
    ...
    meta.superClasses.add("cobra.model.l2ext.ADomP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37600, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39739, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14200, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6836, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
