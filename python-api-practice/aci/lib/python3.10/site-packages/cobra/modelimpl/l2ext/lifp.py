...
class LIfP(Mo):
    """
    The logical interface profile defines a common configuration that can be applied to one or more interfaces.

    """

    meta = ClassMeta("cobra.model.l2ext.LIfP")

    meta.moClassName = "l2extLIfP"
    ...
    meta.childClasses.add("cobra.model.l2ext.RsPathL2OutAtt")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.l2ext.RsPathL2OutAtt", "rspathL2OutAtt-"))
    ...
    meta.superClasses.add("cobra.model.l2ext.AIfP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37603, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39742, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14205, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6838, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
