...
class RsEBd(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.l2ext.RsEBd", "cobra.model.fv.BD")
    meta.targetNameProps["name"] = "tnFvBDName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2extRsEBd"
    meta.rnFormat = "rseBd"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Bridge Domain"
    meta.writeAccessMask = 0x800001
    meta.readAccessMask = 0x800001
    ...
    meta.childClasses.add("cobra.model.fv.SubnetBDDefCont")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.SubnetBDDefCont", "subnetBddefDn-"))
    ...
    meta.superClasses.add("cobra.model.fv.AToBD")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37599, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 12067, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39738, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14199, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12066, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1887
    prop.defaultValueStr = "fvBD"
    ...
    prop = PropMeta("str", "tnFvBDName", "tnFvBDName", 12065, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.-]+']
    meta.props.add("tnFvBDName", prop)
