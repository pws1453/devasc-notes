...
# ##################################################
class RtQosDppIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtQosDppIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "qosRtQosDppIfPol"
    meta.rnFormat = "rtinfraQosDppIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22972, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22971, PropCategory.REGULAR)
