...
# ##################################################
class DscpClassDef(Mo):
    """
    The definition class to be attached to the endpoint profile. Note that this is an internal object.

    """

    meta = ClassMeta("cobra.model.qos.DscpClassDef")

    meta.moClassName = "qosDscpClassDef"
    meta.rnFormat = "dcsp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DSCP Class to Priority Mapping Policy Definition"
    ...
    meta.childClasses.add("cobra.model.qos.RsDefToDscpClass")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RsDefToDscpClass", "rsDefToDscpClass"))
    ...
    prop = PropMeta("str", "from", "from", 272, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 63)]
    ...
    prop = PropMeta("str", "name", "name", 7088, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "to", "to", 273, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 63)]
