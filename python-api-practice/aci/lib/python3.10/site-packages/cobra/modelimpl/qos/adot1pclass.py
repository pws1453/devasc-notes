...
# ##################################################
class ADot1PClass(Mo):
    meta = ClassMeta("cobra.model.qos.ADot1PClass")

    meta.isAbstract = True
    meta.moClassName = "qosADot1PClass"


    meta.moClassName = "qosADot1PClass"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Dot1P Class to Priority Mapping Policy"
    ...
    meta.concreteSubClasses.add("cobra.model.qos.Dot1PClassDef")
    meta.concreteSubClasses.add("cobra.model.qos.Dot1PClass")
