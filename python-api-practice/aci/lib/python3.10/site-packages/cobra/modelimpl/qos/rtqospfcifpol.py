...
# ##################################################
class RtQosPfcIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtQosPfcIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "qosRtQosPfcIfPol"
    meta.rnFormat = "rtinfraQosPfcIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25365, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25364, PropCategory.REGULAR)
