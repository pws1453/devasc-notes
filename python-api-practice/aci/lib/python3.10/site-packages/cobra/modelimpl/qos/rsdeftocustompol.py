...
# ##################################################
class RsDefToCustomPol(Mo):
    """
    A source relation to a custom QoS policy that enables different levels of service to be assigned to network traffic, including specifications for the Differentiated Services Code Point (DSCP) value(s), and the 802.1p Dot1p priority. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.qos.RsDefToCustomPol", "cobra.model.qos.CustomPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "qosRsDefToCustomPol"
    meta.rnFormat = "rsDefToCustomPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11251, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11250, PropCategory.REGULAR)
