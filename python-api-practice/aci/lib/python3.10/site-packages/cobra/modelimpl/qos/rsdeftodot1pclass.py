...
# ##################################################
class RsDefToDot1PClass(Mo):
    """
    A source relation to the class for dot1p to priority map. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.qos.RsDefToDot1PClass", "cobra.model.qos.Dot1PClass")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "qosRsDefToDot1PClass"
    meta.rnFormat = "rsDefToDot1PClass"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Dot1P Class to Priority Mapping Policy"
    ...
    meta.parentClasses.add("cobra.model.qos.Dot1PClassDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsDefToDot1PClass', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11257, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 150
    prop.defaultValueStr = "qosDot1PClass"
    prop._addConstant("qosDot1PClass", None, 150)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11256, PropCategory.REGULAR)
