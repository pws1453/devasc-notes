...
# ##################################################
class RtQosSdIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtQosSdIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "qosRtQosSdIfPol"
    meta.rnFormat = "rtinfraQosSdIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25810, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25809, PropCategory.REGULAR)
