...
class DscpClass(Mo):
    ...
    meta = ClassMeta("cobra.model.qos.DscpClass")

    meta.moClassName = "qosDscpClass"
    meta.rnFormat = "dcsp-%(from)s-%(to)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DSCP Class to Priority Mapping Policy"
    ...
    meta.childClasses.add("cobra.model.qos.RtDefToDscpClass")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtDefToDscpClass", "rtDefToDscpClass"))
    ...
    meta.superClasses.add("cobra.model.qos.ADscpClass")
    meta.superClasses.add("cobra.model.qos.Classification")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37283, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39422, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "from", "from", 7087, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 274, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "target", "target", 271, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "targetCos", "targetCos", 26215, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 8)]
    ...
    meta.props.add("targetCos", prop)

    prop = PropMeta("str", "to", "to", 7086, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
