...
# ##################################################
class RsDefToDscpClass(Mo):
    """
    A source relation to the class for DSCP to priority map.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.qos.RsDefToDscpClass", "cobra.model.qos.DscpClass")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "qosRsDefToDscpClass"
    meta.rnFormat = "rsDefToDscpClass"
    ...
    meta.parentClasses.add("cobra.model.qos.DscpClassDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsDefToDscpClass', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11254, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 146
    prop.defaultValueStr = "qosDscpClass"
    prop._addConstant("qosDscpClass", None, 146)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11253, PropCategory.REGULAR)
