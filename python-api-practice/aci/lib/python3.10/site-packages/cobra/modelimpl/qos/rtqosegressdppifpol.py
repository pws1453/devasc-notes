...
# ##################################################
class RtQosEgressDppIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtQosEgressDppIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "qosRtQosEgressDppIfPol"
    meta.rnFormat = "rtinfraQosEgressDppIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23207, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23206, PropCategory.REGULAR)
