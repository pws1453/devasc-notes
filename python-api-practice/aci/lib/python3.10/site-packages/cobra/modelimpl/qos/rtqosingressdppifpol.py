...
# ##################################################
class RtQosIngressDppIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtQosIngressDppIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "qosRtQosIngressDppIfPol"
    meta.rnFormat = "rtinfraQosIngressDppIfPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtinfraQosIngressDppIfPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23211, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23210, PropCategory.REGULAR)
