...
# ##################################################
class RtQosLlfcIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtQosLlfcIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "qosRtQosLlfcIfPol"
    meta.rnFormat = "rtinfraQosLlfcIfPol-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x100300000000001
    ...
    prop = PropMeta("str", "tCl", "tCl", 62407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62406, PropCategory.REGULAR)
