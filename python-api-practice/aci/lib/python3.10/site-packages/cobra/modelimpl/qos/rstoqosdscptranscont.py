...
# ##################################################
class RsToQosDscpTransCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.qos.RsToQosDscpTransCont", "cobra.model.qos.DscpTransCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "qosRsToQosDscpTransCont"
    meta.rnFormat = "rstoQosDscpTransCont"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22199, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7522
    prop.defaultValueStr = "qosDscpTransCont"
    prop._addConstant("qosDscpTransCont", None, 7522)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22198, PropCategory.REGULAR)
