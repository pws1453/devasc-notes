...
# ##################################################
class DscpTransPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.DscpTransPol")

    meta.moClassName = "qosDscpTransPol"
    meta.rnFormat = "dscptranspol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DSCP class-cos translation policy for L3 traffic to other pods/sites"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38342, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40481, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 22197, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
