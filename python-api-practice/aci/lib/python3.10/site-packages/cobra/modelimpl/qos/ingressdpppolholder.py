...
# ##################################################
class IngressDppPolHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.IngressDppPolHolder")

    meta.moClassName = "qosIngressDppPolHolder"
    meta.rnFormat = "iqosdpppolh"
    ...
    meta.superClasses.add("cobra.model.qos.ADppPolHolder")
