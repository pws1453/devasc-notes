...
# ##################################################
class RtCustQosPol(Mo):
    """
    A target relation to a custom QoS policy that enables different levels of service to be assigned to network traffic, including specifications for the Differentiated Services Code Point (DSCP) value(s), and the 802.1p Dot1p priority. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.qos.RtCustQosPol", "cobra.model.fv.EPg")

    meta.moClassName = "qosRtCustQosPol"
    meta.rnFormat = "rtfvCustQosPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "End Point Group"
    meta.writeAccessMask = 0x81
    meta.readAccessMask = 0x1000681
    ...
    prop = PropMeta("str", "tCl", "tCl", 12224, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12223, PropCategory.REGULAR)
