...
# ##################################################
class RtToRemoteQosDppPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtToRemoteQosDppPolDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "qosRtToRemoteQosDppPolDef"
    meta.rnFormat = "rtfvToRemoteQosDppPolDef-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.qos.DppPolDef")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtfvToRemoteQosDppPolDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 22827, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22826, PropCategory.REGULAR)
