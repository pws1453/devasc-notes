...
# ##################################################
class Dot1PClassDef(Mo):
    """
    The definition class to be attached to the endpoint profile. Note that this is an internal object.

    """

    meta = ClassMeta("cobra.model.qos.Dot1PClassDef")

    meta.moClassName = "qosDot1PClassDef"
    meta.rnFormat = "dot1P-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Dot1P Class to Priority Mapping Policy Definition"
    ...
    meta.childClasses.add("cobra.model.qos.RsDefToDot1PClass")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RsDefToDot1PClass", "rsDefToDot1PClass"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.qos.CustomPolDef")

    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Comp")
    meta.superClasses.add("cobra.model.qos.ADot1PClass")
    ...
    prop = PropMeta("str", "from", "from", 275, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 8)]
    ...
    prop = PropMeta("str", "name", "name", 7085, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 277, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "to", "to", 276, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 8)]
