...
class Entity(Mo):
    """
    The satellite manager entity information.

    """

    meta = ClassMeta("cobra.model.satm.Entity")

    meta.moClassName = "satmEntity"
    meta.rnFormat = "satm"
    meta.category = MoCategory.REGULAR
    meta.label = "Satellite Manager Entity"
    ...
    meta.childClasses.add("cobra.model.satm.DExtCh")
    meta.childClasses.add("cobra.model.satm.FabP")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.satm.DExtCh", "dextch-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.satm.FabP", "fabp-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16070, PropCategory.REGULAR)
