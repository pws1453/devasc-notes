...
class Dropped15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.analytics.Dropped15min", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped15min"
    meta.rnFormat = "CDanalyticsDropped15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats in 15 minute"
