...
class Dropped1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.analytics.Dropped1qtr", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped1qtr"
    meta.rnFormat = "CDanalyticsDropped1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats in 1 quarter"
