...
# ##################################################
class ExportHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.ExportHist1d", "Netflow Export Counters")
    ...
    meta.moClassName = "analyticsExportHist1d"
    meta.rnFormat = "HDanalyticsExport1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Export Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 28081, PropCategory.REGULAR)
