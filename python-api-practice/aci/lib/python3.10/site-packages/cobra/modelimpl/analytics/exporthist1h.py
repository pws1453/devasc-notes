...
# ##################################################
class ExportHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.ExportHist1h", "Netflow Export Counters")
    ...
    meta.moClassName = "analyticsExportHist1h"
    meta.rnFormat = "HDanalyticsExport1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Export Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 28082, PropCategory.REGULAR)
