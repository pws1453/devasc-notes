...
class CfgSrv(Mo):
    ...
    meta = ClassMeta("cobra.model.analytics.CfgSrv")

    meta.moClassName = "analyticsCfgSrv"
    meta.rnFormat = "cfgsrv-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Config Server Info For Analytics Cluster"
    ...
    meta.childClasses.add("cobra.model.analytics.RtNodeCfgSrv")
    meta.childClasses.add("cobra.model.analytics.RsSrvCtxDef")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.analytics.RtNodeCfgSrv", "rtfabricNodeCfgSrv-"))
    ...
    meta.superClasses.add("cobra.model.analytics.ACfgSrv")

    meta.rnPrefixes = [
        ('cfgsrv-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38421, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40560, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 26449, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
