...
# ##################################################
class ExportHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.ExportHist5min", "Netflow Export Counters")
    ...
    meta.moClassName = "analyticsExportHist5min"
    meta.rnFormat = "HDanalyticsExport5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Export Counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 28087, PropCategory.REGULAR)
