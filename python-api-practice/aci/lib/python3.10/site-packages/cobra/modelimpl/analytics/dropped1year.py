...
class Dropped1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.analytics.Dropped1year", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped1year"
    meta.rnFormat = "CDanalyticsDropped1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats in 1 year"
