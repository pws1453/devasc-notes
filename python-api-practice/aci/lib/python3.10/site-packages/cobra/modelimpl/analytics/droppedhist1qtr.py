...
# ##################################################
class DroppedHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.DroppedHist1qtr", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist1qtr"
    meta.rnFormat = "HDanalyticsDropped1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 28076, PropCategory.REGULAR)
