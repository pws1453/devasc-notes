...
class Dropped1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.analytics.Dropped1w", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped1w"
    meta.rnFormat = "CDanalyticsDropped1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats in 1 week"
