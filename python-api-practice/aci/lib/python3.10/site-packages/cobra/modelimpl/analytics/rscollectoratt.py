...
# ##################################################
class RsCollectorAtt(Mo):
    """
     Relation to collector 

    """

    meta = SourceRelationMeta("cobra.model.analytics.RsCollectorAtt", "cobra.model.analytics.Collector")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "analyticsRsCollectorAtt"
    meta.rnFormat = "rscollectorAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Reference to Collector"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38517, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40656, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26203, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "nfmCfgFailedBmp", "nfmCfgFailedBmp", 28608, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("analytics:RsCollectorAttannotation_failed_flag", None, 128)
    prop._addConstant("analytics:RsCollectorAttextMngdBy_failed_flag", None, 256)
    prop._addConstant("analytics:RsCollectorAttforceResolve_failed_flag", None, 4)
    prop._addConstant("analytics:RsCollectorAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("analytics:RsCollectorAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("analytics:RsCollectorAttmonPolDn_failed_flag", None, 512)
    prop._addConstant("analytics:RsCollectorAttrType_failed_flag", None, 8)
    prop._addConstant("analytics:RsCollectorAttstateQual_failed_flag", None, 32)
    prop._addConstant("analytics:RsCollectorAttstate_failed_flag", None, 16)
    prop._addConstant("analytics:RsCollectorAtttCl_failed_flag", None, 1)
    prop._addConstant("analytics:RsCollectorAtttDn_failed_flag", None, 2)
    prop._addConstant("analytics:RsCollectorAtttType_failed_flag", None, 64)
    prop._addConstant("analytics:RsCollectorAttuid_failed_flag", None, 4611686018427387904)
    meta.props.add("nfmCfgFailedBmp", prop)

    prop = PropMeta("str", "nfmCfgFailedTs", "nfmCfgFailedTs", 28610, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("nfmCfgFailedTs", prop)

    prop = PropMeta("str", "nfmCfgState", "nfmCfgState", 28609, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("nfmCfgState", prop)

    prop = PropMeta("str", "operSt", "operSt", 28606, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 28607, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 26193, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9021
    prop.defaultValueStr = "analyticsCollector"
    prop._addConstant("analyticsCollector", None, 9021)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26192, PropCategory.REGULAR)
