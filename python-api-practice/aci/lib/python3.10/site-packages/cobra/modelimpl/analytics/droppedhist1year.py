...
# ##################################################
class DroppedHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.DroppedHist1year", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist1year"
    meta.rnFormat = "HDanalyticsDropped1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 28078, PropCategory.REGULAR)
