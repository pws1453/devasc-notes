...
# ##################################################
class ExportHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.ExportHist1qtr", "Netflow Export Counters")
    ...
    meta.moClassName = "analyticsExportHist1qtr"
    meta.rnFormat = "HDanalyticsExport1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Export Counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 28084, PropCategory.REGULAR)
