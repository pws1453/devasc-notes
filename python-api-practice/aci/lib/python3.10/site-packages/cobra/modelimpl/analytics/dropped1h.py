...
class Dropped1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.analytics.Dropped1h", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped1h"
    meta.rnFormat = "CDanalyticsDropped1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats in 1 hour"
