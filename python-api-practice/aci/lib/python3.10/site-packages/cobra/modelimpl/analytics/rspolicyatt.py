...
# ##################################################
class RsPolicyAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.analytics.RsPolicyAtt", "cobra.model.analytics.Policy")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "analyticsRsPolicyAtt"
    meta.rnFormat = "rspolicyAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Reference to policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38597, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40736, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28451, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9526
    prop.defaultValueStr = "analyticsPolicy"
    prop._addConstant("analyticsPolicy", None, 9526)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28450, PropCategory.REGULAR)
