...
# ##################################################
class DroppedHist(Mo):
    meta = StatsClassMeta("cobra.model.analytics.DroppedHist", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist"


    meta.moClassName = "analyticsDroppedHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats"
    ...
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist1d")
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist15min")
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist5min")
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist1h")
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist1mo")
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist1w")
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist1year")
    meta.concreteSubClasses.add("cobra.model.analytics.DroppedHist1qtr")
    ...
    prop = PropMeta("str", "noRouteToHostAvg", "noRouteToHostAvg", 28104, PropCategory.IMPLICIT_AVG)
    prop.label = "Dropped Packets - No Route To Host average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostAvg", prop)

    prop = PropMeta("str", "noRouteToHostCum", "noRouteToHostCum", 28100, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Dropped Packets - No Route To Host cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostCum", prop)

    prop = PropMeta("str", "noRouteToHostMax", "noRouteToHostMax", 28103, PropCategory.IMPLICIT_MAX)
    prop.label = "Dropped Packets - No Route To Host maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostMax", prop)

    prop = PropMeta("str", "noRouteToHostMin", "noRouteToHostMin", 28102, PropCategory.IMPLICIT_MIN)
    prop.label = "Dropped Packets - No Route To Host minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostMin", prop)

    prop = PropMeta("str", "noRouteToHostPer", "noRouteToHostPer", 28101, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Dropped Packets - No Route To Host periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostPer", prop)

    prop = PropMeta("str", "noRouteToHostRate", "noRouteToHostRate", 28108, PropCategory.IMPLICIT_RATE)
    prop.label = "Dropped Packets - No Route To Host rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostRate", prop)

    prop = PropMeta("str", "noRouteToHostSpct", "noRouteToHostSpct", 28105, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Dropped Packets - No Route To Host suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostSpct", prop)

    prop = PropMeta("str", "noRouteToHostThr", "noRouteToHostThr", 28106, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "noRouteToHostTr", "noRouteToHostTr", 28107, PropCategory.IMPLICIT_TREND)
    prop.label = "Dropped Packets - No Route To Host trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("noRouteToHostTr", prop)

    prop = PropMeta("str", "otherAvg", "otherAvg", 28125, PropCategory.IMPLICIT_AVG)
    prop.label = "Other Dropped Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherAvg", prop)

    prop = PropMeta("str", "otherCum", "otherCum", 28121, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Other Dropped Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherCum", prop)

    prop = PropMeta("str", "otherMax", "otherMax", 28124, PropCategory.IMPLICIT_MAX)
    prop.label = "Other Dropped Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherMax", prop)

    prop = PropMeta("str", "otherMin", "otherMin", 28123, PropCategory.IMPLICIT_MIN)
    prop.label = "Other Dropped Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherMin", prop)

    prop = PropMeta("str", "otherPer", "otherPer", 28122, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Other Dropped Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherPer", prop)

    prop = PropMeta("str", "otherRate", "otherRate", 28129, PropCategory.IMPLICIT_RATE)
    prop.label = "Other Dropped Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherRate", prop)

    prop = PropMeta("str", "otherSpct", "otherSpct", 28126, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Other Dropped Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherSpct", prop)

    prop = PropMeta("str", "otherThr", "otherThr", 28127, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "otherTr", "otherTr", 28128, PropCategory.IMPLICIT_TREND)
    prop.label = "Other Dropped Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("otherTr", prop)

    prop = PropMeta("str", "outputDropAvg", "outputDropAvg", 28146, PropCategory.IMPLICIT_AVG)
    prop.label = "Dropped Output Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("outputDropAvg", prop)

    prop = PropMeta("str", "outputDropCum", "outputDropCum", 28142, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Dropped Output Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("outputDropCum", prop)

    prop = PropMeta("str", "outputDropMax", "outputDropMax", 28145, PropCategory.IMPLICIT_MAX)
    prop.label = "Dropped Output Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("outputDropMax", prop)

    prop = PropMeta("str", "outputDropMin", "outputDropMin", 28144, PropCategory.IMPLICIT_MIN)
    prop.label = "Dropped Output Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("outputDropMin", prop)

    prop = PropMeta("str", "outputDropPer", "outputDropPer", 28143, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Dropped Output Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("outputDropPer", prop)

    prop = PropMeta("str", "outputDropRate", "outputDropRate", 28150, PropCategory.IMPLICIT_RATE)
    prop.label = "Dropped Output Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("outputDropRate", prop)

    prop = PropMeta("str", "outputDropSpct", "outputDropSpct", 28147, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Dropped Output Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("outputDropSpct", prop)

    prop = PropMeta("str", "outputDropThr", "outputDropThr", 28148, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "outputDropTr", "outputDropTr", 28149, PropCategory.IMPLICIT_TREND)
