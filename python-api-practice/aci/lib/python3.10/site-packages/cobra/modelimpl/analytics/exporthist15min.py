...
# ##################################################
class ExportHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.ExportHist15min", "Netflow Export Counters")
    ...
    meta.moClassName = "analyticsExportHist15min"
    meta.rnFormat = "HDanalyticsExport15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Export Counters stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 28080, PropCategory.REGULAR)
