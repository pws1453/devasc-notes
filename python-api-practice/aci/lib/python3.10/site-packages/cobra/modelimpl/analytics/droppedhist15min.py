...
# ##################################################
class DroppedHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.DroppedHist15min", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist15min"
    meta.rnFormat = "HDanalyticsDropped15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 28072, PropCategory.REGULAR)
