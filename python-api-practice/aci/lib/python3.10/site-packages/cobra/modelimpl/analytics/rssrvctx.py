...
class RsSrvCtx(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.analytics.RsSrvCtx", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "analyticsRsSrvCtx"
    meta.rnFormat = "rssrvCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Ctx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38419, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40558, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 24108, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24107, PropCategory.REGULAR)
