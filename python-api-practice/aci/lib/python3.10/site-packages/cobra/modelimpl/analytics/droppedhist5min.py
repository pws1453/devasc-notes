...
# ##################################################
class DroppedHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.DroppedHist5min", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist5min"
    meta.rnFormat = "HDanalyticsDropped5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 28079, PropCategory.REGULAR)
