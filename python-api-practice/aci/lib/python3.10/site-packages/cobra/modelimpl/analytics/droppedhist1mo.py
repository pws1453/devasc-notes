...
# ##################################################
class DroppedHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.DroppedHist1mo", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist1mo"
    meta.rnFormat = "HDanalyticsDropped1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 28075, PropCategory.REGULAR)
