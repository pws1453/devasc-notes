...
# ##################################################
class DroppedHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.DroppedHist1w", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist1w"
    meta.rnFormat = "HDanalyticsDropped1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 28077, PropCategory.REGULAR)
