...
# ##################################################
class RsSrvCtxDef(Mo):
    """
     Relation to CtxDef 

    """

    meta = SourceRelationMeta("cobra.model.analytics.RsSrvCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "analyticsRsSrvCtxDef"
    meta.rnFormat = "rssrvCtxDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24112, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24111, PropCategory.REGULAR)
