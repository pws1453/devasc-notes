...
class RsProfAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.analytics.RsProfAtt", "cobra.model.analytics.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "analyticsRsProfAtt"
    meta.rnFormat = "rsprofAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Reference to profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40660, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26205, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26189, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9027
    prop.defaultValueStr = "analyticsProfile"
    prop._addConstant("analyticsProfile", None, 9027)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26188, PropCategory.REGULAR)
