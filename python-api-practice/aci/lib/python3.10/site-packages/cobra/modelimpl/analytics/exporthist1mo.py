...
# ##################################################
class ExportHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.ExportHist1mo", "Netflow Export Counters")
    ...
    meta.moClassName = "analyticsExportHist1mo"
    meta.rnFormat = "HDanalyticsExport1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Export Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 28083, PropCategory.REGULAR)
