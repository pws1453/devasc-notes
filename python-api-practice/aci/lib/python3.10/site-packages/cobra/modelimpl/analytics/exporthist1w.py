...
# ##################################################
class ExportHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.ExportHist1w", "Netflow Export Counters")
    ...
    meta.moClassName = "analyticsExportHist1w"
    meta.rnFormat = "HDanalyticsExport1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Export Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 28085, PropCategory.REGULAR)
