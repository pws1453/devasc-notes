...
class Dropped1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.analytics.Dropped1d", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped1d"
    meta.rnFormat = "CDanalyticsDropped1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats in 1 day"
