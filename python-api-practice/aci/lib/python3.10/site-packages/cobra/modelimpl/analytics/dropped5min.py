...
class Dropped5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.analytics.Dropped5min", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped5min"
    meta.rnFormat = "CDanalyticsDropped5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats in 5 minute"
