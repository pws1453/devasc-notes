...
# ##################################################
class DroppedHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.analytics.DroppedHist1h", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDroppedHist1h"
    meta.rnFormat = "HDanalyticsDropped1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Netflow Drop Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 28074, PropCategory.REGULAR)
