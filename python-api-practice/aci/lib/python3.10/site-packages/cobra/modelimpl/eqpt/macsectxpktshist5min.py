...
# ##################################################
class MacsectxpktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist5min", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist5min"
    meta.rnFormat = "HDeqptMacsectxpkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 30776, PropCategory.REGULAR)
