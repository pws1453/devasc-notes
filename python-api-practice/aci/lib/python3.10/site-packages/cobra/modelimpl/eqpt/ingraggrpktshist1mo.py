...
# ##################################################
class IngrAggrPktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist1mo", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist1mo"
    meta.rnFormat = "HDeqptIngrAggrPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 25551, PropCategory.REGULAR)
