...
# ##################################################
class FanStatsHist5min(Mo):
    """
    A class that represents historical statistics for fan in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStatsHist5min", "fan")
    ...
    meta.moClassName = "eqptFanStatsHist5min"
    meta.rnFormat = "HDeqptFanStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical fan stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6244, PropCategory.REGULAR)
