...
class IngrUnkBytesHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist1w", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist1w"
    meta.rnFormat = "HDeqptIngrUnkBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6290, PropCategory.REGULAR)
