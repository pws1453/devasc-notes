...
class IngrTotalHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotalHist1h", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotalHist1h"
    meta.rnFormat = "HDeqptIngrTotal1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6279, PropCategory.REGULAR)
