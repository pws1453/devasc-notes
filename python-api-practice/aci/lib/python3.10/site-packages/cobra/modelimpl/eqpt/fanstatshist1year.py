...
# ##################################################
class FanStatsHist1year(Mo):
    """
    A class that represents historical statistics for fan in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStatsHist1year", "fan")
    ...
    meta.moClassName = "eqptFanStatsHist1year"
    meta.rnFormat = "HDeqptFanStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical fan stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6243, PropCategory.REGULAR)
