...
# ##################################################
class BvmacsecrxpktsHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist"


    meta.moClassName = "eqptBvmacsecrxpktsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist1qtr")
    ...
    prop = PropMeta("str", "decryptedPacktesAvg", "decryptedPacktesAvg", 42570, PropCategory.IMPLICIT_AVG)
    prop.label = "BV Macsec Decrypted packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesAvg", prop)

    prop = PropMeta("str", "decryptedPacktesCum", "decryptedPacktesCum", 42566, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "BV Macsec Decrypted packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesCum", prop)

    prop = PropMeta("str", "decryptedPacktesMax", "decryptedPacktesMax", 42569, PropCategory.IMPLICIT_MAX)
    prop.label = "BV Macsec Decrypted packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesMax", prop)

    prop = PropMeta("str", "decryptedPacktesMin", "decryptedPacktesMin", 42568, PropCategory.IMPLICIT_MIN)
    prop.label = "BV Macsec Decrypted packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesMin", prop)

    prop = PropMeta("str", "decryptedPacktesPer", "decryptedPacktesPer", 42567, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "BV Macsec Decrypted packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesPer", prop)

    prop = PropMeta("str", "decryptedPacktesRate", "decryptedPacktesRate", 42574, PropCategory.IMPLICIT_RATE)
    prop.label = "BV Macsec Decrypted packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesRate", prop)

    prop = PropMeta("str", "decryptedPacktesRateAvg", "decryptedPacktesRateAvg", 42586, PropCategory.IMPLICIT_AVG)
    prop.label = "BV Macsec Decrypted packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesRateAvg", prop)

    prop = PropMeta("str", "decryptedPacktesRateMax", "decryptedPacktesRateMax", 42585, PropCategory.IMPLICIT_MAX)
    prop.label = "BV Macsec Decrypted packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesRateMax", prop)

    prop = PropMeta("str", "decryptedPacktesRateMin", "decryptedPacktesRateMin", 42584, PropCategory.IMPLICIT_MIN)
    prop.label = "BV Macsec Decrypted packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesRateMin", prop)

    prop = PropMeta("str", "decryptedPacktesRateSpct", "decryptedPacktesRateSpct", 42587, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BV Macsec Decrypted packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesRateSpct", prop)

    prop = PropMeta("str", "decryptedPacktesRateThr", "decryptedPacktesRateThr", 42588, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "decryptedPacktesRateTr", "decryptedPacktesRateTr", 42589, PropCategory.IMPLICIT_TREND)
    prop.label = "BV Macsec Decrypted packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesRateTr", prop)

    prop = PropMeta("str", "decryptedPacktesSpct", "decryptedPacktesSpct", 42571, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "BV Macsec Decrypted packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("decryptedPacktesSpct", prop)

    prop = PropMeta("str", "decryptedPacktesThr", "decryptedPacktesThr", 42572, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "decryptedPacktesTr", "decryptedPacktesTr", 42573, PropCategory.IMPLICIT_TREND)
