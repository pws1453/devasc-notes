...
# ##################################################
class FanStats15min(Mo):
    """
    A class that represents the most current statistics for fan in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStats15min", "fan")
    ...
    meta.moClassName = "eqptFanStats15min"
    meta.rnFormat = "CDeqptFanStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current fan stats in 15 minute"
