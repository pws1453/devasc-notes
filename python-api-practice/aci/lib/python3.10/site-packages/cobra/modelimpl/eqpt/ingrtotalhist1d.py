...
class IngrTotalHist1d(Mo):
    ...
    meta.moClassName = "eqptIngrTotalHist1d"
    meta.rnFormat = "HDeqptIngrTotal1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6278, PropCategory.REGULAR)
