...
# ##################################################
class BvmacsecrxpktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist15min", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist15min"
    meta.rnFormat = "HDeqptBvmacsecrxpkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.BvmacsecrxpktsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDeqptBvmacsecrxpkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42538, PropCategory.REGULAR)
