...
# ##################################################
class IngrDropPktsHist1year(Mo):
    """
    A class that represents historical statistics for  Ingress  Drop  Packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPktsHist1year", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPktsHist1year"
    meta.rnFormat = "HDeqptIngrDropPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Drop Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6267, PropCategory.REGULAR)
