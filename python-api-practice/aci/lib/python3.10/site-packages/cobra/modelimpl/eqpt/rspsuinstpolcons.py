...
# ##################################################
class RsPsuInstPolCons(Mo):
    """
    A source relation to a power redundancy policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.eqpt.RsPsuInstPolCons", "cobra.model.psu.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "eqptRsPsuInstPolCons"
    meta.rnFormat = "rspsuInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Policy Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12676, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 579
    prop.defaultValueStr = "psuInstPol"
    prop._addConstant("psuInstPol", None, 579)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12675, PropCategory.REGULAR)
