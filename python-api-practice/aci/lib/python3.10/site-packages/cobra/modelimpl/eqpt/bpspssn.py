...
class BpSpSSN(Mo):
    """
    The backplane SPROM second serial number.

    """

    meta = ClassMeta("cobra.model.eqpt.BpSpSSN")

    meta.moClassName = "eqptBpSpSSN"
    meta.rnFormat = "bpspssn"
    meta.category = MoCategory.REGULAR
    meta.label = "Backplane Serial Number"
    ...
    prop = PropMeta("str", "serNum", "serNum", 3383, PropCategory.REGULAR)
