...
# ##################################################
class RtSupCOdDiag(Mo):
    """
    A target relation to the supervisor card. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.eqpt.RtSupCOdDiag", "cobra.model.eqptdiagp.SupCTsOd")

    meta.moClassName = "eqptRtSupCOdDiag"
    meta.rnFormat = "rtsupCOdDiag"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "On-Demand Diag Policy Set for the Sup Card Type"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12562, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2236
    prop.defaultValueStr = "eqptdiagpSupCTsOd"
