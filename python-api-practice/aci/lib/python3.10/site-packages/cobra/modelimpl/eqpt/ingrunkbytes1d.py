...
class IngrUnkBytes1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytes1d", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytes1d"
    meta.rnFormat = "CDeqptIngrUnkBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Unknown Bytes stats in 1 day"
