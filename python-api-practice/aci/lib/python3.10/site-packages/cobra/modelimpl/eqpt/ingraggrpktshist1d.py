...
# ##################################################
class IngrAggrPktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist1d", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist1d"
    meta.rnFormat = "HDeqptIngrAggrPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 25549, PropCategory.REGULAR)
