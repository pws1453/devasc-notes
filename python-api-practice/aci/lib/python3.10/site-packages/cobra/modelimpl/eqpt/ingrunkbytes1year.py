...
class IngrUnkBytes1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytes1year", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytes1year"
    meta.rnFormat = "CDeqptIngrUnkBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Unknown Bytes stats in 1 year"
