...
# ##################################################
class IngrDropPktsHist1d(Mo):
    """
    A class that represents historical statistics for  Ingress  Drop  Packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPktsHist1d", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPktsHist1d"
    meta.rnFormat = "HDeqptIngrDropPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Drop Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6262, PropCategory.REGULAR)
