...
# ##################################################
class IngrDropPkts1w(Mo):
    """
    A class that represents the most current statistics for  Ingress  Drop  Packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts1w", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPkts1w"
    meta.rnFormat = "CDeqptIngrDropPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Drop Packets stats in 1 week"
