...
# ##################################################
class BvmacsecrxpktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist1year", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist1year"
    meta.rnFormat = "HDeqptBvmacsecrxpkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptBvmacsecrxpkts1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 42544, PropCategory.REGULAR)
