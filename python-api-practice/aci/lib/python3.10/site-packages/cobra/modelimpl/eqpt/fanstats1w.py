...
class FanStats1w(Mo):
    """
    A class that represents the most current statistics for fan in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStats1w", "fan")
    ...
    meta.moClassName = "eqptFanStats1w"
    meta.rnFormat = "CDeqptFanStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current fan stats in 1 week"
