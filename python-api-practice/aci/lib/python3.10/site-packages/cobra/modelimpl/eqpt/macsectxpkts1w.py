...
# ##################################################
class Macsectxpkts1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts1w", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts1w"
    meta.rnFormat = "CDeqptMacsectxpkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats in 1 week"
