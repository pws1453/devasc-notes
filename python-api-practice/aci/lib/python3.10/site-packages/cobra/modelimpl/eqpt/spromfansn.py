...
class SpromFanSN(Mo):
    """
    The fan SPROM serial number block.

    """

    meta = ClassMeta("cobra.model.eqpt.SpromFanSN")

    meta.moClassName = "eqptSpromFanSN"
    meta.rnFormat = "spfansn"
    meta.category = MoCategory.REGULAR
    meta.label = "Fan Serial Number"
    ...
    prop = PropMeta("str", "serNum", "serNum", 3391, PropCategory.REGULAR)
