...
# ##################################################
class FruPower1qtr(Mo):
    """
    A class that represents the most current statistics for FRU power in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPower1qtr", "FRU power")
    ...
    meta.moClassName = "eqptFruPower1qtr"
    meta.rnFormat = "CDeqptFruPower1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FRU power stats in 1 quarter"
