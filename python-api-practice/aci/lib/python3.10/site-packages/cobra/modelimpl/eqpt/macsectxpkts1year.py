...
# ##################################################
class Macsectxpkts1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts1year", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts1year"
    meta.rnFormat = "CDeqptMacsectxpkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats in 1 year"
