...
# ##################################################
class IngrStorm1mo(Mo):
    """
    A class that represents the most current statistics for  Ingress  Storm  Ctrl in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStorm1mo", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStorm1mo"
    meta.rnFormat = "CDeqptIngrStorm1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Storm Ctrl stats in 1 month"
