...
# ##################################################
class FruPower15min(Mo):
    """
    A class that represents the most current statistics for FRU power in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPower15min", "FRU power")
    ...
    meta.moClassName = "eqptFruPower15min"
    meta.rnFormat = "CDeqptFruPower15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FRU power stats in 15 minute"
