...
# ##################################################
class IngrUnkBytesHist15min(Mo):
    """
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist15min", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist15min"
    meta.rnFormat = "HDeqptIngrUnkBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrUnkBytesHist")

    meta.rnPrefixes = [
        ('HDeqptIngrUnkBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6285, PropCategory.REGULAR)
