...
# ##################################################
class IngrUnkBytesHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist"


    meta.moClassName = "eqptIngrUnkBytesHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrUnkBytesHist1h")
    ...
    prop = PropMeta("str", "unclassifiedAvg", "unclassifiedAvg", 8727, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Unclassfied Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedAvg", prop)

    prop = PropMeta("str", "unclassifiedCum", "unclassifiedCum", 8723, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Unclassfied Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedCum", prop)

    prop = PropMeta("str", "unclassifiedMax", "unclassifiedMax", 8726, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Unclassfied Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedMax", prop)

    prop = PropMeta("str", "unclassifiedMin", "unclassifiedMin", 8725, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Unclassfied Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedMin", prop)

    prop = PropMeta("str", "unclassifiedPer", "unclassifiedPer", 8724, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Unclassfied Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedPer", prop)

    prop = PropMeta("str", "unclassifiedRate", "unclassifiedRate", 8731, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Unclassfied Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedRate", prop)

    prop = PropMeta("str", "unclassifiedSpct", "unclassifiedSpct", 8728, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Unclassfied Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedSpct", prop)

    prop = PropMeta("str", "unclassifiedThr", "unclassifiedThr", 8729, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unclassifiedTr", "unclassifiedTr", 8730, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Unclassfied Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unclassifiedTr", prop)

    prop = PropMeta("str", "unicastAvg", "unicastAvg", 8754, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Unknown Unicast Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 8750, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Unknown Unicast Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 8753, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Unknown Unicast Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 8752, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Unknown Unicast Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 8751, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Unknown Unicast Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 8758, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Unknown Unicast Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 8755, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Unknown Unicast Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 8756, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 8757, PropCategory.IMPLICIT_TREND)
