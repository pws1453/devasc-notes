...
class EgrTotal1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotal1w", "Egress")
    ...
    meta.moClassName = "eqptEgrTotal1w"
    meta.rnFormat = "CDeqptEgrTotal1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Egress stats in 1 week"
