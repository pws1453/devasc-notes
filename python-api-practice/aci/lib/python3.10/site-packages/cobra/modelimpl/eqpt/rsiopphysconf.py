...
# ##################################################
class RsIoPPhysConf(Mo):
    """
    A source relation to an L1 Ethernet interface. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.eqpt.RsIoPPhysConf", "cobra.model.l1.PhysIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "eqptRsIoPPhysConf"
    meta.rnFormat = "rsioPPhysConf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Physical Interface Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12679, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12678, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15063, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
