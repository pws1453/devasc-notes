...
# ##################################################
class IngrAggrPktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist1h", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist1h"
    meta.rnFormat = "HDeqptIngrAggrPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 25550, PropCategory.REGULAR)
