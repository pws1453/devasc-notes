...
class IngrPktsHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist1qtr", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist1qtr"
    meta.rnFormat = "HDeqptIngrPkts1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6273, PropCategory.REGULAR)
