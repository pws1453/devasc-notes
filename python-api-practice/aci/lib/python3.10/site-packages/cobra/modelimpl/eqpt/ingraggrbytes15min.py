...
# ##################################################
class IngrAggrBytes15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytes15min", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytes15min"
    meta.rnFormat = "CDeqptIngrAggrBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrAggrBytes")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDeqptIngrAggrBytes15min', False),
    ]
