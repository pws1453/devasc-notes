...
# ##################################################
class Macsectxpkts(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts"


    meta.moClassName = "eqptMacsectxpkts"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.Macsectxpkts1qtr")
