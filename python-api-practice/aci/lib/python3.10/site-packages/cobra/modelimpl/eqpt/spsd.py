...
class SpSd(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.SpSd")

    meta.moClassName = "eqptSpSd"
    meta.rnFormat = "spsd-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Sprom Sensor Data"
    ...
    meta.parentClasses.add("cobra.model.eqpt.SpSensorBlk")
    ...
    prop = PropMeta("str", "id", "id", 6315, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "majTh", "majTh", 3379, PropCategory.REGULAR)
    prop.label = "Major Threshold"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("majTh", prop)
    ...
    prop = PropMeta("str", "minTh", "minTh", 3380, PropCategory.REGULAR)
    prop.label = "Minor Threshold"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("minTh", prop)
