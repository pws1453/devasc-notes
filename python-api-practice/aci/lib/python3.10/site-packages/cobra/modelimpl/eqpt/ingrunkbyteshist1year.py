...
# ##################################################
class IngrUnkBytesHist1year(Mo):
    """
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist1year", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist1year"
    meta.rnFormat = "HDeqptIngrUnkBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6291, PropCategory.REGULAR)
