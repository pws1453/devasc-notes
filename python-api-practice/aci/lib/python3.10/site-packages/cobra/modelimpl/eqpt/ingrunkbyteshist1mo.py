...
class IngrUnkBytesHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist1mo", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist1mo"
    meta.rnFormat = "HDeqptIngrUnkBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6288, PropCategory.REGULAR)
