...
# ##################################################
class IngrStorm1w(Mo):
    """
    A class that represents the most current statistics for  Ingress  Storm  Ctrl in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStorm1w", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStorm1w"
    meta.rnFormat = "CDeqptIngrStorm1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Storm Ctrl stats in 1 week"
