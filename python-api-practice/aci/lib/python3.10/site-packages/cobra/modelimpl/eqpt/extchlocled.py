...
# ##################################################
class ExtChLocLed(Mo):
    """
    A locator LED on extended chassis components.

    """

    meta = ClassMeta("cobra.model.eqpt.ExtChLocLed")

    meta.moClassName = "eqptExtChLocLed"
    meta.rnFormat = "locled-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Extended Chassis Locator LED"
    ...
    meta.superClasses.add("cobra.model.eqpt.ALocLed")
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 3499, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 6234, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
