...
class IngrTotalHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotalHist15min", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotalHist15min"
    meta.rnFormat = "HDeqptIngrTotal15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrTotalHist")

    meta.rnPrefixes = [
        ('HDeqptIngrTotal15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6277, PropCategory.REGULAR)
