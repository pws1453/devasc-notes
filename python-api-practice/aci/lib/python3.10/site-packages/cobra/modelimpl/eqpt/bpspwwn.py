...
class BpSpWWN(Mo):
    """
    The backplane SPROM WWN.

    """

    meta = ClassMeta("cobra.model.eqpt.BpSpWWN")

    meta.moClassName = "eqptBpSpWWN"
    meta.rnFormat = "bpspwwn"
    meta.category = MoCategory.REGULAR
    meta.label = "Backplane Sprom WWN"
    ...
    prop = PropMeta("str", "uBits", "uBits", 3381, PropCategory.REGULAR)
    prop.label = "Usage Bits"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("uBits", prop)
