...
class EgrTotal1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotal1qtr", "Egress")
    ...
    meta.moClassName = "eqptEgrTotal1qtr"
    meta.rnFormat = "CDeqptEgrTotal1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Egress stats in 1 quarter"
