...
# ##################################################
class IngrAggrPkts1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPkts1qtr", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPkts1qtr"
    meta.rnFormat = "CDeqptIngrAggrPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Packets stats in 1 quarter"
