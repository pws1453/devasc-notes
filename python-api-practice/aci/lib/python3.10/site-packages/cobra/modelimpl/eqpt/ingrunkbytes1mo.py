...
class IngrUnkBytes1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytes1mo", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytes1mo"
    meta.rnFormat = "CDeqptIngrUnkBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Unknown Bytes stats in 1 month"
