...
# ##################################################
class IngrCrcErrPkts1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts1d", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts1d"
    meta.rnFormat = "CDeqptIngrCrcErrPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats in 1 day"
