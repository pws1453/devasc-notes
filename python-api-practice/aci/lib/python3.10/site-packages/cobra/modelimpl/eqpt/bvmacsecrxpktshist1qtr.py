...
# ##################################################
class BvmacsecrxpktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist1qtr", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist1qtr"
    meta.rnFormat = "HDeqptBvmacsecrxpkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 42542, PropCategory.REGULAR)
