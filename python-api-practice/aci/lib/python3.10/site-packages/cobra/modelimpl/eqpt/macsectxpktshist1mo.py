...
# ##################################################
class MacsectxpktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist1mo", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist1mo"
    meta.rnFormat = "HDeqptMacsectxpkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 30772, PropCategory.REGULAR)
