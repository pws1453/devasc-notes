...
# ##################################################
class IngrDropPkts1d(Mo):
    """
    A class that represents the most current statistics for  Ingress  Drop  Packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts1d", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPkts1d"
    meta.rnFormat = "CDeqptIngrDropPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Drop Packets stats in 1 day"
