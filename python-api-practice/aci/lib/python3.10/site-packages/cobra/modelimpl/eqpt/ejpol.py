...
class EjPol(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.EjPol")

    meta.moClassName = "eqptEjPol"
    meta.rnFormat = "ejpol-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ejector Policy"
    ...
    prop = PropMeta("str", "autoSh", "autoSh", 3352, PropCategory.REGULAR)
    prop.label = "Auto Shutdown on Ejector Open"
    ...
    prop = PropMeta("str", "id", "id", 6227, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
