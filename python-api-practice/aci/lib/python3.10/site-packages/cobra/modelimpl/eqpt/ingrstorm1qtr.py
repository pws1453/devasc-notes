...
# ##################################################
class IngrStorm1qtr(Mo):
    """
    A class that represents the most current statistics for  Ingress  Storm  Ctrl in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStorm1qtr", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStorm1qtr"
    meta.rnFormat = "CDeqptIngrStorm1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Storm Ctrl stats in 1 quarter"
