...
class EgrTotalHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotalHist5min", "Egress")
    ...
    meta.moClassName = "eqptEgrTotalHist5min"
    meta.rnFormat = "HDeqptEgrTotal5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6226, PropCategory.REGULAR)
