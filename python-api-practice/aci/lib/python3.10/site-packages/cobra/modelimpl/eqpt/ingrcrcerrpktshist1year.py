...
# ##################################################
class IngrCrcErrPktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist1year", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist1year"
    meta.rnFormat = "HDeqptIngrCrcErrPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptIngrCrcErrPkts1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 56339, PropCategory.REGULAR)
