...
# ##################################################
class IngrDropPkts1qtr(Mo):
    """
    A class that represents the most current statistics for  Ingress  Drop  Packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts1qtr", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPkts1qtr"
    meta.rnFormat = "CDeqptIngrDropPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Drop Packets stats in 1 quarter"
