...
# ##################################################
class Macsectxpkts1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts1d", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts1d"
    meta.rnFormat = "CDeqptMacsectxpkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats in 1 day"
