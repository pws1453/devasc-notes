...
# ##################################################
class BvmacsecrxpktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist1d", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist1d"
    meta.rnFormat = "HDeqptBvmacsecrxpkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 42539, PropCategory.REGULAR)
