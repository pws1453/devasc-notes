...
class IngrUnkBytes15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytes15min", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytes15min"
    meta.rnFormat = "CDeqptIngrUnkBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Unknown Bytes stats in 15 minute"
