...
# ##################################################
class FruPowerHist1h(Mo):
    """
    A class that represents historical statistics for FRU power in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist1h", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist1h"
    meta.rnFormat = "HDeqptFruPower1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6247, PropCategory.REGULAR)
