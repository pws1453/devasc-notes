...
class IngrTotalHist1qtr(Mo):
    ...
    meta.moClassName = "eqptIngrTotalHist1qtr"
    meta.rnFormat = "HDeqptIngrTotal1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6281, PropCategory.REGULAR)
