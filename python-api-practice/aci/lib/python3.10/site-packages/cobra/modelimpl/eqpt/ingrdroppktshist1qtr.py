...
# ##################################################
class IngrDropPktsHist1qtr(Mo):
    """
    A class that represents historical statistics for  Ingress  Drop  Packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPktsHist1qtr", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPktsHist1qtr"
    meta.rnFormat = "HDeqptIngrDropPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Drop Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6265, PropCategory.REGULAR)
