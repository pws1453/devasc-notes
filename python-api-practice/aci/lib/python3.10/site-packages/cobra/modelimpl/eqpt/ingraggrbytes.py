...
# ##################################################
class IngrAggrBytes(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytes", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytes"


    meta.moClassName = "eqptIngrAggrBytes"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrAggrBytes1w")
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 25690, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Aggregated Drop Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropBase", "dropBase", 25685, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Ingress Aggregated Drop Bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBase", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 25686, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Aggregated Drop Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropLast", "dropLast", 25684, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Ingress Aggregated Drop Bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropLast", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 25689, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Aggregated Drop Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 25688, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Aggregated Drop Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 25687, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Aggregated Drop Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 25695, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Aggregated Drop Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropRateAvg", "dropRateAvg", 25708, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Aggregated Drop Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateAvg", prop)

    prop = PropMeta("str", "dropRateLast", "dropRateLast", 25705, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Ingress Aggregated Drop Bytes rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateLast", prop)

    prop = PropMeta("str", "dropRateMax", "dropRateMax", 25707, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Aggregated Drop Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateMax", prop)

    prop = PropMeta("str", "dropRateMin", "dropRateMin", 25706, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Aggregated Drop Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateMin", prop)

    prop = PropMeta("str", "dropRateSpct", "dropRateSpct", 25709, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Aggregated Drop Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateSpct", prop)

    prop = PropMeta("str", "dropRateThr", "dropRateThr", 25711, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropRateTr", "dropRateTr", 25713, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Aggregated Drop Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateTr", prop)

    prop = PropMeta("str", "dropRateTrBase", "dropRateTrBase", 25712, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Ingress Aggregated Drop Bytes rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateTrBase", prop)

    prop = PropMeta("str", "dropRateTtl", "dropRateTtl", 25710, PropCategory.IMPLICIT_TOTAL)
    prop.label = "Ingress Aggregated Drop Bytes rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRateTtl", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 25691, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Aggregated Drop Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 25692, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 25694, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Aggregated Drop Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 25693, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Ingress Aggregated Drop Bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTrBase", prop)

    prop = PropMeta("str", "forwardAvg", "forwardAvg", 25726, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Aggregated Forward Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardAvg", prop)

    prop = PropMeta("str", "forwardBase", "forwardBase", 25721, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Ingress Aggregated Forward Bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardBase", prop)

    prop = PropMeta("str", "forwardCum", "forwardCum", 25722, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Aggregated Forward Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardCum", prop)

    prop = PropMeta("str", "forwardLast", "forwardLast", 25720, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Ingress Aggregated Forward Bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardLast", prop)

    prop = PropMeta("str", "forwardMax", "forwardMax", 25725, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Aggregated Forward Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardMax", prop)

    prop = PropMeta("str", "forwardMin", "forwardMin", 25724, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Aggregated Forward Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardMin", prop)

    prop = PropMeta("str", "forwardPer", "forwardPer", 25723, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Aggregated Forward Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardPer", prop)

    prop = PropMeta("str", "forwardRate", "forwardRate", 25731, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Aggregated Forward Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRate", prop)

    prop = PropMeta("str", "forwardRateAvg", "forwardRateAvg", 25744, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Aggregated Forward Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateAvg", prop)

    prop = PropMeta("str", "forwardRateLast", "forwardRateLast", 25741, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Ingress Aggregated Forward Bytes rate current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateLast", prop)

    prop = PropMeta("str", "forwardRateMax", "forwardRateMax", 25743, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Aggregated Forward Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateMax", prop)

    prop = PropMeta("str", "forwardRateMin", "forwardRateMin", 25742, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Aggregated Forward Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateMin", prop)

    prop = PropMeta("str", "forwardRateSpct", "forwardRateSpct", 25745, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Aggregated Forward Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateSpct", prop)

    prop = PropMeta("str", "forwardRateThr", "forwardRateThr", 25747, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "forwardRateTr", "forwardRateTr", 25749, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Aggregated Forward Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateTr", prop)

    prop = PropMeta("str", "forwardRateTrBase", "forwardRateTrBase", 25748, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Ingress Aggregated Forward Bytes rate trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateTrBase", prop)

    prop = PropMeta("str", "forwardRateTtl", "forwardRateTtl", 25746, PropCategory.IMPLICIT_TOTAL)
    prop.label = "Ingress Aggregated Forward Bytes rate total sum"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardRateTtl", prop)

    prop = PropMeta("str", "forwardSpct", "forwardSpct", 25727, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Aggregated Forward Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardSpct", prop)

    prop = PropMeta("str", "forwardThr", "forwardThr", 25728, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "forwardTr", "forwardTr", 25730, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Aggregated Forward Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("forwardTr", prop)

    prop = PropMeta("str", "forwardTrBase", "forwardTrBase", 25729, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Ingress Aggregated Forward Bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
