...
class IngrPktsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist1year", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist1year"
    meta.rnFormat = "HDeqptIngrPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6275, PropCategory.REGULAR)
