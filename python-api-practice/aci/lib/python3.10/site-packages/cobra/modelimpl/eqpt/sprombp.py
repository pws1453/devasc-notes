...
class SpromBP(Mo):
    """
    A backplane SPROM unit block.

    """

    meta = ClassMeta("cobra.model.eqpt.SpromBP")

    meta.moClassName = "eqptSpromBP"
    meta.rnFormat = "spbp"
    meta.category = MoCategory.REGULAR
    meta.label = "Backplane Sprom"
    ...
    meta.childClasses.add("cobra.model.eqpt.BpSpSSN")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.eqpt.BpSpLic")
    meta.childClasses.add("cobra.model.eqpt.SpromBPBlk")
    meta.childClasses.add("cobra.model.eqpt.BpSpWWN")
    meta.childClasses.add("cobra.model.eqpt.SpCmnBlk")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.BpSpSSN", "bpspssn"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.BpSpLic", "bpsplic"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromBPBlk", "spbpblk"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.BpSpWWN", "bpspwwn"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpCmnBlk", "spcmn"))
    ...
    meta.superClasses.add("cobra.model.eqpt.Sprom")
    ...
    prop = PropMeta("str", "errRsn", "errRsn", 3438, PropCategory.REGULAR)
    prop.label = "Error Reason"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unknown"
    prop._addConstant("accessfail", "access-failure", 2)
    prop._addConstant("cksumfail", "checksum-failure", 1)
    prop._addConstant("none", "none", 3)
    prop._addConstant("unknown", "unknown", 0)
    meta.props.add("errRsn", prop)

    prop = PropMeta("str", "id", "id", 3437, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 100)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14518, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "numBlk", "numBlk", 3439, PropCategory.REGULAR)
    prop.label = "Number of Blocks"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("numBlk", prop)
