...
# ##################################################
class FruPowerHist1qtr(Mo):
    """
    A class that represents historical statistics for FRU power in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist1qtr", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist1qtr"
    meta.rnFormat = "HDeqptFruPower1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6249, PropCategory.REGULAR)
