...
# ##################################################
class IngrAggrBytesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytesHist1year", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytesHist1year"
    meta.rnFormat = "HDeqptIngrAggrBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 25546, PropCategory.REGULAR)
