...
class IngrUnkBytesHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist1d", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist1d"
    meta.rnFormat = "HDeqptIngrUnkBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6286, PropCategory.REGULAR)
