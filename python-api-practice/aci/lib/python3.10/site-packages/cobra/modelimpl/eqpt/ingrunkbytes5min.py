...
class IngrUnkBytes5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytes5min", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytes5min"
    meta.rnFormat = "CDeqptIngrUnkBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Unknown Bytes stats in 5 minute"
