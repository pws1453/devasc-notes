...
class EgrBytesHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist1qtr", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist1qtr"
    meta.rnFormat = "HDeqptEgrBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress Bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6199, PropCategory.REGULAR)
