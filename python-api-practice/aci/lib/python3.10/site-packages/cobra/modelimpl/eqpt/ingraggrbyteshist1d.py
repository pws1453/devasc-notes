...
# ##################################################
class IngrAggrBytesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytesHist1d", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytesHist1d"
    meta.rnFormat = "HDeqptIngrAggrBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 25541, PropCategory.REGULAR)
