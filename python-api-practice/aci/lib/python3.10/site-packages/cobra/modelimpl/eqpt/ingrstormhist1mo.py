...
# ##################################################
class IngrStormHist1mo(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist1mo", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist1mo"
    meta.rnFormat = "HDeqptIngrStorm1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 17693, PropCategory.REGULAR)
