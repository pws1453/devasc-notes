...
class IngrUnkBytesHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist1qtr", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist1qtr"
    meta.rnFormat = "HDeqptIngrUnkBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6289, PropCategory.REGULAR)
