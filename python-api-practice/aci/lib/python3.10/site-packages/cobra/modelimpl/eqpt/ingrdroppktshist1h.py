...
# ##################################################
class IngrDropPktsHist1h(Mo):
    """
    A class that represents historical statistics for  Ingress  Drop  Packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPktsHist1h", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPktsHist1h"
    meta.rnFormat = "HDeqptIngrDropPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Drop Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6263, PropCategory.REGULAR)
