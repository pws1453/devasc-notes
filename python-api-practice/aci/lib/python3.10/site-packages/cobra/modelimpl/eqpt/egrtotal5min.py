...
class EgrTotal5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotal5min", "Egress")
    ...
    meta.moClassName = "eqptEgrTotal5min"
    meta.rnFormat = "CDeqptEgrTotal5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Egress stats in 5 minute"
