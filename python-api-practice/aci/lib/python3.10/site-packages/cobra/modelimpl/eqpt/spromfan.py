...
class SpromFan(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.SpromFan")

    meta.moClassName = "eqptSpromFan"
    meta.rnFormat = "spfan"
    meta.category = MoCategory.REGULAR
    meta.label = "Fan Sprom"
    ...
    meta.childClasses.add("cobra.model.eqpt.SpromFanBlk")
    meta.childClasses.add("cobra.model.eqpt.SpCmnBlk")
    meta.childClasses.add("cobra.model.eqpt.SpromFanSN")

    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromFanBlk", "spfanblk"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromFanSN", "spfansn"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14516, PropCategory.REGULAR)
