...
# ##################################################
class IngrCrcErrPktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist1mo", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist1mo"
    meta.rnFormat = "HDeqptIngrCrcErrPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 56336, PropCategory.REGULAR)
