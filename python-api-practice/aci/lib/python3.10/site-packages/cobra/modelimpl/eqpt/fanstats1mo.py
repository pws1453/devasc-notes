...
# ##################################################
class FanStats1mo(Mo):
    """
    A class that represents the most current statistics for fan in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStats1mo", "fan")
    ...
    meta.moClassName = "eqptFanStats1mo"
    meta.rnFormat = "CDeqptFanStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current fan stats in 1 month"
