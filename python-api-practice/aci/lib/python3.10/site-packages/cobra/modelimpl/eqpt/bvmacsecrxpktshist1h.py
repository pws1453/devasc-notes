...
# ##################################################
class BvmacsecrxpktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist1h", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist1h"
    meta.rnFormat = "HDeqptBvmacsecrxpkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 42540, PropCategory.REGULAR)
