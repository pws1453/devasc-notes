...
# ##################################################
class IngrAggrBytesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytesHist15min", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytesHist15min"
    meta.rnFormat = "HDeqptIngrAggrBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Bytes stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 25540, PropCategory.REGULAR)
