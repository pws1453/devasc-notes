...
class IngrUnkBytes1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytes1w", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytes1w"
    meta.rnFormat = "CDeqptIngrUnkBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Unknown Bytes stats in 1 week"
