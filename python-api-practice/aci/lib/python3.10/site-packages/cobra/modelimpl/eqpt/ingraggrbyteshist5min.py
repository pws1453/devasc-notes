...
# ##################################################
class IngrAggrBytesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytesHist5min", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytesHist5min"
    meta.rnFormat = "HDeqptIngrAggrBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 25547, PropCategory.REGULAR)
