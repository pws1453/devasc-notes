...
# ##################################################
class IngrAggrPktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist1qtr", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist1qtr"
    meta.rnFormat = "HDeqptIngrAggrPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 25552, PropCategory.REGULAR)
