...
class SpPd(Mo):
    """
    The SPROM port data. The SPROM on the device contains detailed information about the hardware, including serial, part, and revision numbers.

    """

    meta = ClassMeta("cobra.model.eqpt.SpPd")

    meta.moClassName = "eqptSpPd"
    meta.rnFormat = "sppd"
    meta.category = MoCategory.REGULAR
    meta.label = "Sprom Port Data"
    ...
    meta.parentClasses.add("cobra.model.eqpt.SpromLcBlk")
    meta.parentClasses.add("cobra.model.eqpt.SpromSupBlk")
    ...
    prop = PropMeta("str", "numPts", "numPts", 3378, PropCategory.REGULAR)
    prop.label = "Number of Ports"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("numPts", prop)

    prop = PropMeta("str", "prtTy", "prtTy", 3377, PropCategory.REGULAR)
    prop.label = "Port Type"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("prtTy", prop)
