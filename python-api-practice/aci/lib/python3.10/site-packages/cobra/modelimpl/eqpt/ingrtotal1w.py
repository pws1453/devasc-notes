...
class IngrTotal1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotal1w", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotal1w"
    meta.rnFormat = "CDeqptIngrTotal1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress stats in 1 week"
