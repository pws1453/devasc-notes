...
# ##################################################
class IngrAggrPkts1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPkts1h", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPkts1h"
    meta.rnFormat = "CDeqptIngrAggrPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Packets stats in 1 hour"
