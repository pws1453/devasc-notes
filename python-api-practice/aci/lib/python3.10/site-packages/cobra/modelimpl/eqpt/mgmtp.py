...
class MgmtP(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.MgmtP")

    meta.moClassName = "eqptMgmtP"
    meta.rnFormat = "mgmt-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Management Port"
    ...
    prop = PropMeta("str", "id", "id", 6304, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
