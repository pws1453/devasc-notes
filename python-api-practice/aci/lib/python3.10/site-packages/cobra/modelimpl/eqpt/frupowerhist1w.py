...
# ##################################################
class FruPowerHist1w(Mo):
    """
    A class that represents historical statistics for FRU power in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist1w", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist1w"
    meta.rnFormat = "HDeqptFruPower1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6250, PropCategory.REGULAR)
