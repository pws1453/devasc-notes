...
# ##################################################
class IngrCrcErrPkts1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts1w", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts1w"
    meta.rnFormat = "CDeqptIngrCrcErrPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats in 1 week"
