...
# ##################################################
class FruPowerHist1year(Mo):
    """
    A class that represents historical statistics for FRU power in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist1year", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist1year"
    meta.rnFormat = "HDeqptFruPower1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6251, PropCategory.REGULAR)
