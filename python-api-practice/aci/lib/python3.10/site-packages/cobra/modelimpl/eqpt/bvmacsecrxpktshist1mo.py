...
# ##################################################
class BvmacsecrxpktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist1mo", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist1mo"
    meta.rnFormat = "HDeqptBvmacsecrxpkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 42541, PropCategory.REGULAR)
