...
# ##################################################
class FruPower1mo(Mo):
    """
    A class that represents the most current statistics for FRU power in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPower1mo", "FRU power")
    ...
    meta.moClassName = "eqptFruPower1mo"
    meta.rnFormat = "CDeqptFruPower1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FRU power stats in 1 month"
