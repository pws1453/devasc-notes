...
# ##################################################
class IngrAggrPktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist1year", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist1year"
    meta.rnFormat = "HDeqptIngrAggrPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 25554, PropCategory.REGULAR)
