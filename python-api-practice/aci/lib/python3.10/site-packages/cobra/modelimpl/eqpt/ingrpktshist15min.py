...
class IngrPktsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist15min", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist15min"
    meta.rnFormat = "HDeqptIngrPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrPktsHist")

    meta.rnPrefixes = [
        ('HDeqptIngrPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6269, PropCategory.REGULAR)
