...
class SupC(Mo):
    """
    The supervisor card, which contains the CPU running control plane.

    """

    meta = ClassMeta("cobra.model.eqpt.SupC")

    meta.moClassName = "eqptSupC"
    meta.rnFormat = "sup"
    meta.category = MoCategory.REGULAR
    meta.label = "Supervisor Module"
    ...
    meta.childClasses.add("cobra.model.eqpt.CpuP")
    ...
    meta.childClasses.add("cobra.model.eqpt.ConsP")
    ...
    meta.childClasses.add("cobra.model.eqpt.MgmtP")
    meta.childClasses.add("cobra.model.eqpt.RtSupCOdDiag")
    ...
    meta.childClasses.add("cobra.model.eqpt.SpromSup")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.RtSupCOdDiag", "rtsupCOdDiag"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.CpuP", "cpuport-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.ConsP", "console-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.MgmtP", "mgmt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromSup", "spsup"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 3328, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "supervisor"
