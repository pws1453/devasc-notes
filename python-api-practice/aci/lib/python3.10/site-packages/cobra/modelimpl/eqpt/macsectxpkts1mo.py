...
# ##################################################
class Macsectxpkts1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts1mo", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts1mo"
    meta.rnFormat = "CDeqptMacsectxpkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats in 1 month"
