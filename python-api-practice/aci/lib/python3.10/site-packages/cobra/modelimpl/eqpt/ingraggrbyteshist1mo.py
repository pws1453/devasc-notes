...
# ##################################################
class IngrAggrBytesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytesHist1mo", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytesHist1mo"
    meta.rnFormat = "HDeqptIngrAggrBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 25543, PropCategory.REGULAR)
