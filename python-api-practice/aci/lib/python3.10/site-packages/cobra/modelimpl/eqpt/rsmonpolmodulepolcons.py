...
# ##################################################
class RsMonPolModulePolCons(Mo):
    """
    A source relation to a monitoring policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.eqpt.RsMonPolModulePolCons", "cobra.model.mon.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "eqptRsMonPolModulePolCons"
    meta.rnFormat = "rsmonPolModulePolCons"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12682, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12681, PropCategory.REGULAR)
