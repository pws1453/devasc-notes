...
# ##################################################
class IngrStorm1year(Mo):
    """
    A class that represents the most current statistics for  Ingress  Storm  Ctrl in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStorm1year", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStorm1year"
    meta.rnFormat = "CDeqptIngrStorm1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Storm Ctrl stats in 1 year"
