...
class Nic(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.Nic")

    meta.moClassName = "eqptNic"
    meta.rnFormat = "nic-%(id)s"
    ...
    meta.childClasses.add("cobra.model.eqpt.ExtAP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.ExtAP", "eaport-"))
    ...
    prop = PropMeta("str", "id", "id", 6306, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13868, PropCategory.REGULAR)
