...
class EgrTotalHist1w(Mo):
    ...
    meta.moClassName = "eqptEgrTotalHist1w"
    meta.rnFormat = "HDeqptEgrTotal1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6224, PropCategory.REGULAR)
