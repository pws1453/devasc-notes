...
class EgrBytesHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist1h", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist1h"
    meta.rnFormat = "HDeqptEgrBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress Bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6197, PropCategory.REGULAR)
