...
# ##################################################
class IngrStormHist1w(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist1w", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist1w"
    meta.rnFormat = "HDeqptIngrStorm1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 17695, PropCategory.REGULAR)
