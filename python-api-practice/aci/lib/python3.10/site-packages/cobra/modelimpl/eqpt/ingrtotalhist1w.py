...
class IngrTotalHist1w(Mo):
    ...
    meta.moClassName = "eqptIngrTotalHist1w"
    meta.rnFormat = "HDeqptIngrTotal1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6282, PropCategory.REGULAR)
