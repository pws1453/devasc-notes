...
# ##################################################
class SpSensorBlk(Mo):
    """
    A SPROM sensor block.

    """

    meta = ClassMeta("cobra.model.eqpt.SpSensorBlk")

    meta.moClassName = "eqptSpSensorBlk"
    meta.rnFormat = "spsensorblk"
    meta.category = MoCategory.REGULAR
    meta.label = "Sprom Sensor Block"
