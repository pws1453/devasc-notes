...
class SpromSup(Mo):
    """
    The supervisor SPROM.

    """

    meta = ClassMeta("cobra.model.eqpt.SpromSup")

    meta.moClassName = "eqptSpromSup"
    meta.rnFormat = "spsup"
    meta.category = MoCategory.REGULAR
    meta.label = "Supervisor Sprom"
    ...
    meta.childClasses.add("cobra.model.eqpt.SpromSupBlk")
    meta.childClasses.add("cobra.model.eqpt.SpSensorBlk")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.eqpt.SpCmnBlk")
    meta.childClasses.add("cobra.model.eqpt.SpPd")

    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpSensorBlk", "spsensorblk"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromSupBlk", "spsupblk"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14519, PropCategory.REGULAR)
