...
# ##################################################
class FruPower1year(Mo):
    """
    A class that represents the most current statistics for FRU power in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPower1year", "FRU power")
    ...
    meta.moClassName = "eqptFruPower1year"
    meta.rnFormat = "CDeqptFruPower1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FRU power stats in 1 year"
