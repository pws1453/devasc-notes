...
class IngrTotal1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotal1mo", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotal1mo"
    meta.rnFormat = "CDeqptIngrTotal1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress stats in 1 month"
