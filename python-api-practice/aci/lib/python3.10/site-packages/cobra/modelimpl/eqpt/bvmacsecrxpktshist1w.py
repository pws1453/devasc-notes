...
# ##################################################
class BvmacsecrxpktsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist1w", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist1w"
    meta.rnFormat = "HDeqptBvmacsecrxpkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 42543, PropCategory.REGULAR)
