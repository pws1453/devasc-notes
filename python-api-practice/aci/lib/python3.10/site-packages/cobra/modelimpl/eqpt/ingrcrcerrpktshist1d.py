...
# ##################################################
class IngrCrcErrPktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist1d", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist1d"
    meta.rnFormat = "HDeqptIngrCrcErrPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 56334, PropCategory.REGULAR)
