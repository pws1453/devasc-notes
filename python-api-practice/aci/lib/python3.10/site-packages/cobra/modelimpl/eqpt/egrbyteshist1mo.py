...
class EgrBytesHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist1mo", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist1mo"
    meta.rnFormat = "HDeqptEgrBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress Bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6198, PropCategory.REGULAR)
