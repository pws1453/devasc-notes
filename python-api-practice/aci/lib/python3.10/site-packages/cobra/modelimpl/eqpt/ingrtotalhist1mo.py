...
class IngrTotalHist1mo(Mo):
    ...
    meta.moClassName = "eqptIngrTotalHist1mo"
    meta.rnFormat = "HDeqptIngrTotal1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6280, PropCategory.REGULAR)
