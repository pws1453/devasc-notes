...
# ##################################################
class IngrCrcErrPkts1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts1mo", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts1mo"
    meta.rnFormat = "CDeqptIngrCrcErrPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats in 1 month"
