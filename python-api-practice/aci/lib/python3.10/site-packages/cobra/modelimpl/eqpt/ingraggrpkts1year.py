...
# ##################################################
class IngrAggrPkts1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPkts1year", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPkts1year"
    meta.rnFormat = "CDeqptIngrAggrPkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Packets stats in 1 year"
