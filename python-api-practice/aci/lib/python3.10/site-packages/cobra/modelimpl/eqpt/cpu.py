...
class CPU(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.CPU")

    meta.moClassName = "eqptCPU"
    meta.rnFormat = "cpu-%(id)s"
    ...
    meta.childClasses.add("cobra.model.eqpt.Core")

    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.Core", "core-"))
    ...
    meta.superClasses.add("cobra.model.eqpt.ACPU")
    ...
    prop = PropMeta("str", "arch", "arch", 3489, PropCategory.REGULAR)
    prop.label = "Architecture"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("any", "any", 0)
    prop._addConstant("x86_32", "x86_32", 1)
    prop._addConstant("x86_64", "x86_64", 2)
    meta.props.add("arch", prop)
    ...
    prop = PropMeta("str", "cores", "cores", 3491, PropCategory.REGULAR)
    prop.label = "Cores"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("unspecified", "number-of-cores", 0)
    meta.props.add("cores", prop)

    prop = PropMeta("str", "coresEn", "coresEn", 3492, PropCategory.REGULAR)
    prop.label = "Cores Enabled"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("unspecified", "number-of-cores", 0)
    meta.props.add("coresEn", prop)
    ...
    prop = PropMeta("str", "id", "id", 6190, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "sock", "sock", 3488, PropCategory.REGULAR)
    prop.label = "Socket"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("unspecified", "socket", 0)
    meta.props.add("sock", prop)

    prop = PropMeta("str", "speed", "speed", 3490, PropCategory.REGULAR)
    prop.label = "Speed"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "thrds", "thrds", 3493, PropCategory.REGULAR)
    prop.label = "Threads"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("thrds", prop)
