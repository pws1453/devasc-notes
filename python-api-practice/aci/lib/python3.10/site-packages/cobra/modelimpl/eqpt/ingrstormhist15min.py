...
# ##################################################
class IngrStormHist15min(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist15min", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist15min"
    meta.rnFormat = "HDeqptIngrStorm15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrStormHist")

    meta.rnPrefixes = [
        ('HDeqptIngrStorm15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 17690, PropCategory.REGULAR)
