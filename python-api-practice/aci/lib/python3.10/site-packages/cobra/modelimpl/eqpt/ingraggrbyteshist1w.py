...
# ##################################################
class IngrAggrBytesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytesHist1w", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytesHist1w"
    meta.rnFormat = "HDeqptIngrAggrBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 25545, PropCategory.REGULAR)
