...
class ExtAP(Mo):
    """
    An external extension port for a controller.

    """

    meta = ClassMeta("cobra.model.eqpt.ExtAP")

    meta.moClassName = "eqptExtAP"
    meta.rnFormat = "eaport-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 6230, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "operSt", "operSt", 710, PropCategory.REGULAR)
