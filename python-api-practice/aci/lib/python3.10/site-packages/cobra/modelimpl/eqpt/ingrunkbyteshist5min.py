...
class IngrUnkBytesHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist5min", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist5min"
    meta.rnFormat = "HDeqptIngrUnkBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6292, PropCategory.REGULAR)
