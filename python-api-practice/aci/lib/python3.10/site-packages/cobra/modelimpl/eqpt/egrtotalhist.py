...
# ##################################################
class EgrTotalHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotalHist", "Egress")
    ...
    meta.moClassName = "eqptEgrTotalHist"


    meta.moClassName = "eqptEgrTotalHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrTotalHist1qtr")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 8139, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Egress Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 8135, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total Egress Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 8138, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Egress Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 8137, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Egress Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 8136, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total Egress Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 8143, PropCategory.IMPLICIT_RATE)
    prop.label = "Total Egress Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 8161, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Egress Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 8160, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Egress Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 8159, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Egress Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 8162, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Egress Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 8163, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 8164, PropCategory.IMPLICIT_TREND)
    prop.label = "Total Egress Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 8140, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Egress Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 8141, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 8142, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 8187, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Egress Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 8183, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total Egress Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 8186, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Egress Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 8185, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Egress Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 8184, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total Egress Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 8191, PropCategory.IMPLICIT_RATE)
    prop.label = "Total Egress Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 8209, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Egress Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 8208, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Egress Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 8207, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Egress Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 8210, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Egress Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 8211, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 8212, PropCategory.IMPLICIT_TREND)
    prop.label = "Total Egress Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 8188, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Egress Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 8189, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 8190, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "utilAvg", "utilAvg", 8230, PropCategory.IMPLICIT_AVG)
    prop.label = "Egress Link Utilization average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilAvg", prop)

    prop = PropMeta("str", "utilMax", "utilMax", 8229, PropCategory.IMPLICIT_MAX)
    prop.label = "Egress Link Utilization maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilMax", prop)

    prop = PropMeta("str", "utilMin", "utilMin", 8228, PropCategory.IMPLICIT_MIN)
    prop.label = "Egress Link Utilization minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilMin", prop)

    prop = PropMeta("str", "utilSpct", "utilSpct", 8231, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Egress Link Utilization suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilSpct", prop)

    prop = PropMeta("str", "utilThr", "utilThr", 8232, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "utilTr", "utilTr", 8233, PropCategory.IMPLICIT_TREND)
