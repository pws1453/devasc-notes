...
# ##################################################
class FanStatsHist1w(Mo):
    """
    A class that represents historical statistics for fan in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStatsHist1w", "fan")
    ...
    meta.moClassName = "eqptFanStatsHist1w"
    meta.rnFormat = "HDeqptFanStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical fan stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6242, PropCategory.REGULAR)
