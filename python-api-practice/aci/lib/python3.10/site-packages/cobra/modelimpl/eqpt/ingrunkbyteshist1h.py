...
class IngrUnkBytesHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytesHist1h", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytesHist1h"
    meta.rnFormat = "HDeqptIngrUnkBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Unknown Bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6287, PropCategory.REGULAR)
