...
# ##################################################
class IngrAggrPkts5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPkts5min", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPkts5min"
    meta.rnFormat = "CDeqptIngrAggrPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Packets stats in 5 minute"
