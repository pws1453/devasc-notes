...
class SpromPsu(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.SpromPsu")

    meta.moClassName = "eqptSpromPsu"
    meta.rnFormat = "sppsu"
    meta.category = MoCategory.REGULAR
    meta.label = "Power Supply Unit Sprom"
    ...
    meta.childClasses.add("cobra.model.eqpt.SpromPsuBlk")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.SpromPsuBlk", "sppsublk"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14517, PropCategory.REGULAR)
