...
class LPort(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.LPort")

    meta.moClassName = "eqptLPort"
    meta.rnFormat = "lport"
    ...
    meta.parentClasses.add("cobra.model.eqpt.EobcP")
    ...
    meta.parentClasses.add("cobra.model.eqpt.EpcP")
    meta.parentClasses.add("cobra.model.eqpt.FabP")
    meta.parentClasses.add("cobra.model.eqpt.FcP")
    meta.parentClasses.add("cobra.model.eqpt.ExtAP")
    meta.parentClasses.add("cobra.model.eqpt.MgmtP")
    meta.parentClasses.add("cobra.model.eqpt.ConsP")

    meta.superClasses.add("cobra.model.eqpt.ALPort")

    meta.rnPrefixes = [
        ('lport', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37758, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39897, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 3314, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isImplicit = True
    prop.isAdmin = True
