...
# ##################################################
class IngrCrcErrPkts5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts5min", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts5min"
    meta.rnFormat = "CDeqptIngrCrcErrPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptIngrCrcErrPkts5min', False),
    ]
