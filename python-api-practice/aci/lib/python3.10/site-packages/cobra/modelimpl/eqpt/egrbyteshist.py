...
# ##################################################
class EgrBytesHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist"


    meta.moClassName = "eqptEgrBytesHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress Bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.EgrBytesHist1h")
    ...
    prop = PropMeta("str", "floodAvg", "floodAvg", 7854, PropCategory.IMPLICIT_AVG)
    prop.label = "Egress Flood Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodAvg", prop)

    prop = PropMeta("str", "floodCum", "floodCum", 7850, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Egress Flood Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodCum", prop)

    prop = PropMeta("str", "floodMax", "floodMax", 7853, PropCategory.IMPLICIT_MAX)
    prop.label = "Egress Flood Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMax", prop)

    prop = PropMeta("str", "floodMin", "floodMin", 7852, PropCategory.IMPLICIT_MIN)
    prop.label = "Egress Flood Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMin", prop)

    prop = PropMeta("str", "floodPer", "floodPer", 7851, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Egress Flood Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPer", prop)

    prop = PropMeta("str", "floodRate", "floodRate", 7858, PropCategory.IMPLICIT_RATE)
    prop.label = "Egress Flood Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodRate", prop)

    prop = PropMeta("str", "floodSpct", "floodSpct", 7855, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Egress Flood Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodSpct", prop)

    prop = PropMeta("str", "floodThr", "floodThr", 7856, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodTr", "floodTr", 7857, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 7881, PropCategory.IMPLICIT_AVG)
    prop.label = "Egress Multicast Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 7877, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Egress Multicast Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 7880, PropCategory.IMPLICIT_MAX)
    prop.label = "Egress Multicast Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 7879, PropCategory.IMPLICIT_MIN)
    prop.label = "Egress Multicast Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 7878, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Egress Multicast Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 7885, PropCategory.IMPLICIT_RATE)
    prop.label = "Egress Multicast Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastRateAvg", "multicastRateAvg", 7903, PropCategory.IMPLICIT_AVG)
    prop.label = "Egress Multicast Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRateAvg", prop)

    prop = PropMeta("str", "multicastRateMax", "multicastRateMax", 7902, PropCategory.IMPLICIT_MAX)
    prop.label = "Egress Multicast Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRateMax", prop)

    prop = PropMeta("str", "multicastRateMin", "multicastRateMin", 7901, PropCategory.IMPLICIT_MIN)
    prop.label = "Egress Multicast Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRateMin", prop)

    prop = PropMeta("str", "multicastRateSpct", "multicastRateSpct", 7904, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Egress Multicast Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRateSpct", prop)

    prop = PropMeta("str", "multicastRateThr", "multicastRateThr", 7905, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastRateTr", "multicastRateTr", 7906, PropCategory.IMPLICIT_TREND)
    prop.label = "Egress Multicast Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRateTr", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 7882, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Egress Multicast Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 7883, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 7884, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 7929, PropCategory.IMPLICIT_AVG)
    prop.label = "Egress Unicast Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 7925, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Egress Unicast Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 7928, PropCategory.IMPLICIT_MAX)
    prop.label = "Egress Unicast Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 7927, PropCategory.IMPLICIT_MIN)
    prop.label = "Egress Unicast Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 7926, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Egress Unicast Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 7933, PropCategory.IMPLICIT_RATE)
    prop.label = "Egress Unicast Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastRateAvg", "unicastRateAvg", 7951, PropCategory.IMPLICIT_AVG)
    prop.label = "Egress Unicast Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRateAvg", prop)

    prop = PropMeta("str", "unicastRateMax", "unicastRateMax", 7950, PropCategory.IMPLICIT_MAX)
    prop.label = "Egress Unicast Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRateMax", prop)

    prop = PropMeta("str", "unicastRateMin", "unicastRateMin", 7949, PropCategory.IMPLICIT_MIN)
    prop.label = "Egress Unicast Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRateMin", prop)

    prop = PropMeta("str", "unicastRateSpct", "unicastRateSpct", 7952, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Egress Unicast Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRateSpct", prop)

    prop = PropMeta("str", "unicastRateThr", "unicastRateThr", 7953, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastRateTr", "unicastRateTr", 7954, PropCategory.IMPLICIT_TREND)
    prop.label = "Egress Unicast Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRateTr", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 7930, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Egress Unicast Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 7931, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 7932, PropCategory.IMPLICIT_TREND)
