...
# ##################################################
class FruPowerHist1mo(Mo):
    """
    A class that represents historical statistics for FRU power in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist1mo", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist1mo"
    meta.rnFormat = "HDeqptFruPower1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6248, PropCategory.REGULAR)
