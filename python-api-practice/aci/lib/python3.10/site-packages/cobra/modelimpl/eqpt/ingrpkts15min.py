...
class IngrPkts15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPkts15min", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPkts15min"
    meta.rnFormat = "CDeqptIngrPkts15min"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrPkts")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDeqptIngrPkts15min', False),
    ]
