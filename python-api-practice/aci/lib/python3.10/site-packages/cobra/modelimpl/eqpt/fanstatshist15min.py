...
# ##################################################
class FanStatsHist15min(Mo):
    """
    A class that represents historical statistics for fan in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStatsHist15min", "fan")
    ...
    meta.moClassName = "eqptFanStatsHist15min"
    meta.rnFormat = "HDeqptFanStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical fan stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 6237, PropCategory.REGULAR)
