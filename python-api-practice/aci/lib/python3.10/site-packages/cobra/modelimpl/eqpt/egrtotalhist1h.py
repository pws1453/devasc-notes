...
class EgrTotalHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotalHist1h", "Egress")
    ...
    meta.moClassName = "eqptEgrTotalHist1h"
    meta.rnFormat = "HDeqptEgrTotal1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6221, PropCategory.REGULAR)
