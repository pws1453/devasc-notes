...
# ##################################################
class IngrCrcErrPktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist5min", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist5min"
    meta.rnFormat = "HDeqptIngrCrcErrPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 56340, PropCategory.REGULAR)
