...
class EgrTotal1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotal1h", "Egress")
    ...
    meta.moClassName = "eqptEgrTotal1h"
    meta.rnFormat = "CDeqptEgrTotal1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Egress stats in 1 hour"
