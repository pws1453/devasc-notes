...
# ##################################################
class IngrCrcErrPktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist1h", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist1h"
    meta.rnFormat = "HDeqptIngrCrcErrPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 56335, PropCategory.REGULAR)
