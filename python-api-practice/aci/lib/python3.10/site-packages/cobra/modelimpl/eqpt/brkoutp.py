...
class BrkoutP(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.BrkoutP")

    meta.moClassName = "eqptBrkoutP"
    meta.rnFormat = "brkoutport-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Breakout Port"
    ...
    prop = PropMeta("str", "id", "id", 24748, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24849, PropCategory.REGULAR)
