...
class FruPower1h(Mo):
    """
    A class that represents the most current statistics for FRU power in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPower1h", "FRU power")
    ...
    meta.moClassName = "eqptFruPower1h"
    meta.rnFormat = "CDeqptFruPower1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FRU power stats in 1 hour"
