...
class IngrPktsHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist1d", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist1d"
    meta.rnFormat = "HDeqptIngrPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6270, PropCategory.REGULAR)
