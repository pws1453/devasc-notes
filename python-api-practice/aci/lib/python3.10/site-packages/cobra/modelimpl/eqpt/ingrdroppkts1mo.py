...
# ##################################################
class IngrDropPkts1mo(Mo):
    """
    A class that represents the most current statistics for  Ingress  Drop  Packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts1mo", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPkts1mo"
    meta.rnFormat = "CDeqptIngrDropPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Drop Packets stats in 1 month"
