...
# ##################################################
class IngrAggrPktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist5min", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist5min"
    meta.rnFormat = "HDeqptIngrAggrPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 25555, PropCategory.REGULAR)
