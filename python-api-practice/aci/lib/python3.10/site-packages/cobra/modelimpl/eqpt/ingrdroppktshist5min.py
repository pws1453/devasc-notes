...
# ##################################################
class IngrDropPktsHist5min(Mo):
    """
    A class that represents historical statistics for  Ingress  Drop  Packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPktsHist5min", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPktsHist5min"
    meta.rnFormat = "HDeqptIngrDropPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Drop Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6268, PropCategory.REGULAR)
