...
# ##################################################
class IngrStormHist1h(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist1h", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist1h"
    meta.rnFormat = "HDeqptIngrStorm1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 17692, PropCategory.REGULAR)
