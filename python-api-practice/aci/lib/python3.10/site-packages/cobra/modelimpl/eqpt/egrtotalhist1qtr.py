...
class EgrTotalHist1qtr(Mo):
    ...
    meta.moClassName = "eqptEgrTotalHist1qtr"
    meta.rnFormat = "HDeqptEgrTotal1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6223, PropCategory.REGULAR)
