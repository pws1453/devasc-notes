...
# ##################################################
class IngrAggrPktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist15min", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist15min"
    meta.rnFormat = "HDeqptIngrAggrPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrAggrPktsHist")

    meta.rnPrefixes = [
        ('HDeqptIngrAggrPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 25548, PropCategory.REGULAR)
