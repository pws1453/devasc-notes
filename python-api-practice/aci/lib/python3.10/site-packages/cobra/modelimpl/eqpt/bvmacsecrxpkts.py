...
# ##################################################
class Bvmacsecrxpkts(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.Bvmacsecrxpkts", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpkts"


    meta.moClassName = "eqptBvmacsecrxpkts"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BV Macsec Rx Pkts stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.Bvmacsecrxpkts5min")
