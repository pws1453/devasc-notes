...
class Asic(Mo):
    """
    The ASIC information container.

    """

    meta = ClassMeta("cobra.model.eqpt.Asic")

    meta.moClassName = "eqptAsic"
    meta.rnFormat = "asic-%(id)s"
    ...
    meta.childClasses.add("cobra.model.eqpt.FwdInst")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.FwdInst", "fwdinst-"))
    ...
    prop = PropMeta("str", "id", "id", 3507, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14534, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 3509, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 3508, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "northstar"
    prop._addConstant("alpine", "alpine", 2)
    prop._addConstant("bcm", "broadcom", 3)
    prop._addConstant("northstar", "northstar", 1)
