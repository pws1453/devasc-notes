...
# ##################################################
class IngrStorm1h(Mo):
    """
    A class that represents the most current statistics for  Ingress  Storm  Ctrl in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStorm1h", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStorm1h"
    meta.rnFormat = "CDeqptIngrStorm1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Storm Ctrl stats in 1 hour"
