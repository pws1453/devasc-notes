...
# ##################################################
class MacsectxpktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist1qtr", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist1qtr"
    meta.rnFormat = "HDeqptMacsectxpkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 30773, PropCategory.REGULAR)
