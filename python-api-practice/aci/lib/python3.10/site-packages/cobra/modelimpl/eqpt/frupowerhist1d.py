...
# ##################################################
class FruPowerHist1d(Mo):
    """
    A class that represents historical statistics for FRU power in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist1d", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist1d"
    meta.rnFormat = "HDeqptFruPower1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6246, PropCategory.REGULAR)
