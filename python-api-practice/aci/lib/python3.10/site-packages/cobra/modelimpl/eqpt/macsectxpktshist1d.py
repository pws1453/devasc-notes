...
# ##################################################
class MacsectxpktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist1d", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist1d"
    meta.rnFormat = "HDeqptMacsectxpkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 30770, PropCategory.REGULAR)
