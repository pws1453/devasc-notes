...
# ##################################################
class FruPowerHist15min(Mo):
    """
    A class that represents historical statistics for FRU power in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist15min", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist15min"
    meta.rnFormat = "HDeqptFruPower15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.FruPowerHist")

    meta.rnPrefixes = [
        ('HDeqptFruPower15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6245, PropCategory.REGULAR)
