...
# ##################################################
class IngrDropPkts15min(Mo):
    """
    A class that represents the most current statistics for  Ingress  Drop  Packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts15min", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPkts15min"
    meta.rnFormat = "CDeqptIngrDropPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Drop Packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.IngrDropPkts")

    meta.rnPrefixes = [
        ('CDeqptIngrDropPkts15min', False),
    ]
