...
# ##################################################
class IngrCrcErrPktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist15min", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist15min"
    meta.rnFormat = "HDeqptIngrCrcErrPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDeqptIngrCrcErrPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 56333, PropCategory.REGULAR)
