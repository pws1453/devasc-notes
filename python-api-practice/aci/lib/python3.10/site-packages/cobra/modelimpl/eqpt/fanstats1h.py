...
class FanStats1h(Mo):
    """
    A class that represents the most current statistics for fan in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStats1h", "fan")
    ...
    meta.moClassName = "eqptFanStats1h"
    meta.rnFormat = "CDeqptFanStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current fan stats in 1 hour"
