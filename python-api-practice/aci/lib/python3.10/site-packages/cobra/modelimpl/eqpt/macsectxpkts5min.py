...
# ##################################################
class Macsectxpkts5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts5min", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts5min"
    meta.rnFormat = "CDeqptMacsectxpkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats in 5 minute"
