...
class IngrUnkBytes1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrUnkBytes1qtr", "Ingress Unknown Bytes")
    ...
    meta.moClassName = "eqptIngrUnkBytes1qtr"
    meta.rnFormat = "CDeqptIngrUnkBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Unknown Bytes stats in 1 quarter"
