...
# ##################################################
class IngrAggrPkts1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPkts1w", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPkts1w"
    meta.rnFormat = "CDeqptIngrAggrPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Packets stats in 1 week"
