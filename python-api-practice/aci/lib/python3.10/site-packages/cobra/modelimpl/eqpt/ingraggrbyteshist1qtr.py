...
# ##################################################
class IngrAggrBytesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytesHist1qtr", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytesHist1qtr"
    meta.rnFormat = "HDeqptIngrAggrBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 25544, PropCategory.REGULAR)
