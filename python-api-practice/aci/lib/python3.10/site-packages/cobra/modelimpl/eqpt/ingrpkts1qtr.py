...
class IngrPkts1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPkts1qtr", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPkts1qtr"
    meta.rnFormat = "CDeqptIngrPkts1qtr"
