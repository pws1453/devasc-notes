...
# ##################################################
class MacsectxpktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist1h", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist1h"
    meta.rnFormat = "HDeqptMacsectxpkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 30771, PropCategory.REGULAR)
