...
# ##################################################
class FanStatsHist1qtr(Mo):
    """
    A class that represents historical statistics for fan in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStatsHist1qtr", "fan")
    ...
    meta.moClassName = "eqptFanStatsHist1qtr"
    meta.rnFormat = "HDeqptFanStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical fan stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6241, PropCategory.REGULAR)
