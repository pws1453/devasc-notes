...
class IngrPkts1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPkts1year", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPkts1year"
    meta.rnFormat = "CDeqptIngrPkts1year"
