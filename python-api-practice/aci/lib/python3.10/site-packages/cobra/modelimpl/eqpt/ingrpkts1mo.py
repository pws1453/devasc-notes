...
class IngrPkts1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPkts1mo", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPkts1mo"
    meta.rnFormat = "CDeqptIngrPkts1mo"
