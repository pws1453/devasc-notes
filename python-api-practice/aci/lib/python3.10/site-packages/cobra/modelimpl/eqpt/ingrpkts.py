...
# ##################################################
class IngrPkts(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrPkts", "Ingress Packets")
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPkts1h")
    ...
    prop = PropMeta("str", "floodAvg", "floodAvg", 8540, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Flood Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodAvg", prop)

    prop = PropMeta("str", "floodBase", "floodBase", 8535, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Ingress Flood Packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodBase", prop)

    prop = PropMeta("str", "floodCum", "floodCum", 8536, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Flood Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodCum", prop)

    prop = PropMeta("str", "floodLast", "floodLast", 8534, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Ingress Flood Packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodLast", prop)

    prop = PropMeta("str", "floodMax", "floodMax", 8539, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Flood Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMax", prop)

    prop = PropMeta("str", "floodMin", "floodMin", 8538, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Flood Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMin", prop)

    prop = PropMeta("str", "floodPer", "floodPer", 8537, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Flood Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPer", prop)

    prop = PropMeta("str", "floodRate", "floodRate", 8545, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Flood Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodRate", prop)

    prop = PropMeta("str", "floodSpct", "floodSpct", 8541, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Flood Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodSpct", prop)

    prop = PropMeta("str", "floodThr", "floodThr", 8542, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodTr", "floodTr", 8544, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Flood Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodTr", prop)

    prop = PropMeta("str", "floodTrBase", "floodTrBase", 8543, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 8567, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Multicast Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastBase", "multicastBase", 8562, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Ingress Multicast Packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastBase", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 8563, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Multicast Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastLast", "multicastLast", 8561, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Ingress Multicast Packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastLast", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 8566, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Multicast Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 8565, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Multicast Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 8564, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Multicast Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 8572, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Multicast Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 8568, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Multicast Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 8569, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 8571, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Multicast Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastTr", prop)

    prop = PropMeta("str", "multicastTrBase", "multicastTrBase", 8570, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 8594, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Unicast Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastBase", "unicastBase", 8589, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Ingress Unicast Packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastBase", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 8590, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Unicast Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastLast", "unicastLast", 8588, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Ingress Unicast Packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastLast", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 8593, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Unicast Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 8592, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Unicast Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 8591, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Unicast Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 8599, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Unicast Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 8595, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Unicast Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 8596, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 8598, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Unicast Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 8597, PropCategory.IMPLICIT_TREND_BASE)
