...
# ##################################################
class IngrStormHist5min(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist5min", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist5min"
    meta.rnFormat = "HDeqptIngrStorm5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 17697, PropCategory.REGULAR)
