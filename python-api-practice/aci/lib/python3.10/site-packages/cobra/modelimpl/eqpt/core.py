...
class Core(Mo):
    """
    An equipment core container.

    """

    meta = ClassMeta("cobra.model.eqpt.Core")

    meta.moClassName = "eqptCore"
    meta.rnFormat = "core-%(id)s"
    ...
    meta.parentClasses.add("cobra.model.eqpt.CPU")

    meta.superClasses.add("cobra.model.eqpt.Item")
    meta.superClasses.add("cobra.model.eqpt.ACore")
    ...
    prop = PropMeta("str", "id", "id", 6192, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
