...
# ##################################################
class FanStats1qtr(Mo):
    """
    A class that represents the most current statistics for fan in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStats1qtr", "fan")
    ...
    meta.moClassName = "eqptFanStats1qtr"
    meta.rnFormat = "CDeqptFanStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current fan stats in 1 quarter"
