...
# ##################################################
class IngrAggrPkts15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPkts15min", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPkts15min"
    meta.rnFormat = "CDeqptIngrAggrPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Packets stats in 15 minute"
