...
class Ejec(Mo):
    """
    The ejector information.

    """

    meta = ClassMeta("cobra.model.eqpt.Ejec")

    meta.moClassName = "eqptEjec"
    meta.rnFormat = "ej-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 3353, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "operSt", "operSt", 3354, PropCategory.REGULAR)
    prop.label = "Operational State"
    prop.isOper = True
    prop.defaultValue = 1
    prop.defaultValueStr = "closed"
    prop._addConstant("closed", "closed", 1)
    prop._addConstant("open", "open", 0)
