...
class Dimm(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.Dimm")

    meta.moClassName = "eqptDimm"
    meta.rnFormat = "dimm-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 6194, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "type", "type", 3342, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "dimm"
