...
# ##################################################
class FlashConfig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.eqpt.FlashConfig")

    meta.moClassName = "eqptFlashConfig"
    meta.rnFormat = "flashconfig"
    meta.category = MoCategory.REGULAR
    meta.label = "FlashConfig"
    ...
    prop = PropMeta("str", "annotation", "annotation", 53071, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deltape", "deltape", 53070, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 53072, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "gbb", "gbb", 53068, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "peCycles", "peCycles", 53067, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "readErr", "readErr", 53069, PropCategory.REGULAR)
