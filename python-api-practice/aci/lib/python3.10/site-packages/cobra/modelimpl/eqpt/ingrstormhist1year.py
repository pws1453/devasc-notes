...
# ##################################################
class IngrStormHist1year(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist1year", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist1year"
    meta.rnFormat = "HDeqptIngrStorm1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 17696, PropCategory.REGULAR)
