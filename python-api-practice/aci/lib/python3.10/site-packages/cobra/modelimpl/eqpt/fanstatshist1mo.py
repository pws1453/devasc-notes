...
# ##################################################
class FanStatsHist1mo(Mo):
    """
    A class that represents historical statistics for fan in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStatsHist1mo", "fan")
    ...
    meta.moClassName = "eqptFanStatsHist1mo"
    meta.rnFormat = "HDeqptFanStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical fan stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6240, PropCategory.REGULAR)
