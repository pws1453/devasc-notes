...
# ##################################################
class IngrCrcErrPkts(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts"


    meta.moClassName = "eqptIngrCrcErrPkts"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPkts15min")
