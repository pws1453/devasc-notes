...
# ##################################################
class IngrDropPktsHist15min(Mo):
    """
    A class that represents historical statistics for  Ingress  Drop  Packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPktsHist15min", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPktsHist15min"
    meta.rnFormat = "HDeqptIngrDropPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Drop Packets stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 6261, PropCategory.REGULAR)
