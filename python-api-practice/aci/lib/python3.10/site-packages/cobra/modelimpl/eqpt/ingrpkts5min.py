...
class IngrPkts5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPkts5min", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPkts5min"
    meta.rnFormat = "CDeqptIngrPkts5min"
