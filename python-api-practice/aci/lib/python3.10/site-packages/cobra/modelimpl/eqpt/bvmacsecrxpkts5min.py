...
# ##################################################
class Bvmacsecrxpkts5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Bvmacsecrxpkts5min", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpkts5min"
    meta.rnFormat = "CDeqptBvmacsecrxpkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BV Macsec Rx Pkts stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptBvmacsecrxpkts5min', False),
    ]
