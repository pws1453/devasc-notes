...
class EgrBytes1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytes1qtr", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytes1qtr"
    meta.rnFormat = "CDeqptEgrBytes1qtr"
