...
# ##################################################
class Bvmacsecrxpkts15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Bvmacsecrxpkts15min", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpkts15min"
    meta.rnFormat = "CDeqptBvmacsecrxpkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BV Macsec Rx Pkts stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptBvmacsecrxpkts15min', False),
    ]
