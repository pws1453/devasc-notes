...
class EgrBytes1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytes1year", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytes1year"
    meta.rnFormat = "CDeqptEgrBytes1year"
