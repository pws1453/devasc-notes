...
# ##################################################
class Macsectxpkts15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts15min", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts15min"
    meta.rnFormat = "CDeqptMacsectxpkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats in 15 minute"
