...
# ##################################################
class FanStatsHist1d(Mo):
    """
    A class that represents historical statistics for fan in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStatsHist1d", "fan")
    ...
    meta.moClassName = "eqptFanStatsHist1d"
    meta.rnFormat = "HDeqptFanStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical fan stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6238, PropCategory.REGULAR)
