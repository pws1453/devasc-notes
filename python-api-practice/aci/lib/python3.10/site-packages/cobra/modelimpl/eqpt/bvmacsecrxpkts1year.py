...
# ##################################################
class Bvmacsecrxpkts1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Bvmacsecrxpkts1year", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpkts1year"
    meta.rnFormat = "CDeqptBvmacsecrxpkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BV Macsec Rx Pkts stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptBvmacsecrxpkts1year', False),
    ]
