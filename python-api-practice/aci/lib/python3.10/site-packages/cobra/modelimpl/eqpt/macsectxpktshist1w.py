...
# ##################################################
class MacsectxpktsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist1w", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist1w"
    meta.rnFormat = "HDeqptMacsectxpkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 30774, PropCategory.REGULAR)
