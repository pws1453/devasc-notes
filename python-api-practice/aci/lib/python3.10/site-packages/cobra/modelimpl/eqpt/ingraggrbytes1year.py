...
# ##################################################
class IngrAggrBytes1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrBytes1year", "Ingress Aggregated Bytes")
    ...
    meta.moClassName = "eqptIngrAggrBytes1year"
    meta.rnFormat = "CDeqptIngrAggrBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDeqptIngrAggrBytes1year', False),
    ]
