...
# ##################################################
class IngrTotalHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotalHist", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotalHist"


    meta.moClassName = "eqptIngrTotalHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrTotalHist1mo")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 8631, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Ingress Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 8627, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total Ingress Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 8630, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Ingress Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 8629, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Ingress Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 8628, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total Ingress Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 8635, PropCategory.IMPLICIT_RATE)
    prop.label = "Total Ingress Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 8653, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Ingress Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 8652, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Ingress Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 8651, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Ingress Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 8654, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Ingress Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 8655, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 8656, PropCategory.IMPLICIT_TREND)
    prop.label = "Total Ingress Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 8632, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Ingress Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 8633, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 8634, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 8679, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Ingress Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 8675, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Total Ingress Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 8678, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Ingress Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 8677, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Ingress Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 8676, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Total Ingress Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 8683, PropCategory.IMPLICIT_RATE)
    prop.label = "Total Ingress Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsRateAvg", "pktsRateAvg", 15254, PropCategory.IMPLICIT_AVG)
    prop.label = "Total Ingress Packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateAvg", prop)

    prop = PropMeta("str", "pktsRateMax", "pktsRateMax", 15253, PropCategory.IMPLICIT_MAX)
    prop.label = "Total Ingress Packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMax", prop)

    prop = PropMeta("str", "pktsRateMin", "pktsRateMin", 15252, PropCategory.IMPLICIT_MIN)
    prop.label = "Total Ingress Packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateMin", prop)

    prop = PropMeta("str", "pktsRateSpct", "pktsRateSpct", 15255, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Ingress Packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateSpct", prop)

    prop = PropMeta("str", "pktsRateThr", "pktsRateThr", 15256, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 15257, PropCategory.IMPLICIT_TREND)
    prop.label = "Total Ingress Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 8680, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Total Ingress Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 8681, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 8682, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "utilAvg", "utilAvg", 8701, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Link Utilization average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilAvg", prop)

    prop = PropMeta("str", "utilMax", "utilMax", 8700, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Link Utilization maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilMax", prop)

    prop = PropMeta("str", "utilMin", "utilMin", 8699, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Link Utilization minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilMin", prop)

    prop = PropMeta("str", "utilSpct", "utilSpct", 8702, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Link Utilization suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("utilSpct", prop)

    prop = PropMeta("str", "utilThr", "utilThr", 8703, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "utilTr", "utilTr", 8704, PropCategory.IMPLICIT_TREND)
