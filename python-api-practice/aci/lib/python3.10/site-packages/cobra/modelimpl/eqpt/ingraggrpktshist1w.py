...
# ##################################################
class IngrAggrPktsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPktsHist1w", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPktsHist1w"
    meta.rnFormat = "HDeqptIngrAggrPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Aggregated Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 25553, PropCategory.REGULAR)
