...
# ##################################################
class BvmacsecrxpktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.BvmacsecrxpktsHist5min", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpktsHist5min"
    meta.rnFormat = "HDeqptBvmacsecrxpkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BV Macsec Rx Pkts stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 42545, PropCategory.REGULAR)
