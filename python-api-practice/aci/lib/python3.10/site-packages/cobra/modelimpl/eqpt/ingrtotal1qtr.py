...
class IngrTotal1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotal1qtr", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotal1qtr"
    meta.rnFormat = "CDeqptIngrTotal1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress stats in 1 quarter"
