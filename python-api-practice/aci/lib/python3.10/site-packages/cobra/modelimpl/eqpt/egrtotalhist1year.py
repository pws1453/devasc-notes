...
class EgrTotalHist1year(Mo):
    ...
    meta.moClassName = "eqptEgrTotalHist1year"
    meta.rnFormat = "HDeqptEgrTotal1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats in 1 year"
    ...
    meta.superClasses.add("cobra.model.eqpt.EgrTotalHist")

    meta.rnPrefixes = [
        ('HDeqptEgrTotal1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6225, PropCategory.REGULAR)
