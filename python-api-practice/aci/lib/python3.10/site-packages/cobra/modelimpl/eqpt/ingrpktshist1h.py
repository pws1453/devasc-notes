...
class IngrPktsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist1h", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist1h"
    meta.rnFormat = "HDeqptIngrPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6271, PropCategory.REGULAR)
