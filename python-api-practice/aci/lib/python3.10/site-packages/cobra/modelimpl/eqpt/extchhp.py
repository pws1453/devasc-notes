...
class ExtChHP(Mo):
    """
    The extension chassis port connected to hosts.

    """

    meta = ClassMeta("cobra.model.eqpt.ExtChHP")

    meta.moClassName = "eqptExtChHP"
    meta.rnFormat = "hostextport-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Extended Chassis Host Port"
    ...
    prop = PropMeta("str", "id", "id", 6233, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14509, PropCategory.REGULAR)
