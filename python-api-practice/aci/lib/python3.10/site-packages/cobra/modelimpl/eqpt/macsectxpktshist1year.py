...
# ##################################################
class MacsectxpktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist1year", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist1year"
    meta.rnFormat = "HDeqptMacsectxpkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 30775, PropCategory.REGULAR)
