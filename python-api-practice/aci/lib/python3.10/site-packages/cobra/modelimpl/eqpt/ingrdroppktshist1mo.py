...
# ##################################################
class IngrDropPktsHist1mo(Mo):
    """
    A class that represents historical statistics for  Ingress  Drop  Packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPktsHist1mo", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPktsHist1mo"
    meta.rnFormat = "HDeqptIngrDropPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Drop Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6264, PropCategory.REGULAR)
