...
class FcP(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.FcP")

    meta.moClassName = "eqptFcP"
    meta.rnFormat = "fc-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 39102, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 39184, PropCategory.REGULAR)
