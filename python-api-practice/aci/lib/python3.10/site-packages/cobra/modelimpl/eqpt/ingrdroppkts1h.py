...
# ##################################################
class IngrDropPkts1h(Mo):
    """
    A class that represents the most current statistics for  Ingress  Drop  Packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts1h", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPkts1h"
    meta.rnFormat = "CDeqptIngrDropPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Drop Packets stats in 1 hour"
