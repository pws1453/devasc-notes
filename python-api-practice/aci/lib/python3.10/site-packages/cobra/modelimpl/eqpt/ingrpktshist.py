...
# ##################################################
class IngrPktsHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist"


    meta.moClassName = "eqptIngrPktsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrPktsHist1w")
    ...
    prop = PropMeta("str", "floodAvg", "floodAvg", 8550, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Flood Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodAvg", prop)

    prop = PropMeta("str", "floodCum", "floodCum", 8546, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Flood Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodCum", prop)

    prop = PropMeta("str", "floodMax", "floodMax", 8549, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Flood Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMax", prop)

    prop = PropMeta("str", "floodMin", "floodMin", 8548, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Flood Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMin", prop)

    prop = PropMeta("str", "floodPer", "floodPer", 8547, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Flood Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPer", prop)

    prop = PropMeta("str", "floodRate", "floodRate", 8554, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Flood Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodRate", prop)

    prop = PropMeta("str", "floodSpct", "floodSpct", 8551, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Flood Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodSpct", prop)

    prop = PropMeta("str", "floodThr", "floodThr", 8552, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodTr", "floodTr", 8553, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 8577, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Multicast Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 8573, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Multicast Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 8576, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Multicast Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 8575, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Multicast Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 8574, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Multicast Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 8581, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Multicast Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 8578, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Multicast Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 8579, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 8580, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 8604, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Unicast Packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 8600, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Unicast Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 8603, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Unicast Packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 8602, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Unicast Packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 8601, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Unicast Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 8608, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Unicast Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 8605, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Unicast Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 8606, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 8607, PropCategory.IMPLICIT_TREND)
