...
# ##################################################
class IngrCrcErrPkts15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts15min", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts15min"
    meta.rnFormat = "CDeqptIngrCrcErrPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDeqptIngrCrcErrPkts15min', False),
    ]
