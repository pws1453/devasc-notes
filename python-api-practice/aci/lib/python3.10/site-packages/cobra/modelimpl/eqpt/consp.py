...
class ConsP(Mo):
    """
    An external (debug) console port.

    """

    meta = ClassMeta("cobra.model.eqpt.ConsP")

    meta.moClassName = "eqptConsP"
    meta.rnFormat = "console-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Console Port"
    ...
    prop = PropMeta("str", "id", "id", 6191, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
