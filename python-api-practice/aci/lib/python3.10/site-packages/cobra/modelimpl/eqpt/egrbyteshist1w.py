...
class EgrBytesHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist1w", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist1w"
    meta.rnFormat = "HDeqptEgrBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress Bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6200, PropCategory.REGULAR)
