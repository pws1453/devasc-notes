...
class EgrTotalHist1mo(Mo):
    ...
    meta.moClassName = "eqptEgrTotalHist1mo"
    meta.rnFormat = "HDeqptEgrTotal1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6222, PropCategory.REGULAR)
