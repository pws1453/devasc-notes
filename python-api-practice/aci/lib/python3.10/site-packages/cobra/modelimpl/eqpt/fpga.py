...
class Fpga(Mo):
    """
    A field-programmable gate array container.

    """

    meta = ClassMeta("cobra.model.eqpt.Fpga")

    meta.moClassName = "eqptFpga"
    meta.rnFormat = "fpga-%(id)s"
    ...
    meta.childClasses.add("cobra.model.firmware.CompRunning")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.firmware.CompRunning", "running"))
    ...
    prop = PropMeta("str", "id", "id", 3344, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17925, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 3346, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 3345, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "io"
    prop._addConstant("io", "io-fpga", 1)
    prop._addConstant("mi", "mi-fpga", 2)
