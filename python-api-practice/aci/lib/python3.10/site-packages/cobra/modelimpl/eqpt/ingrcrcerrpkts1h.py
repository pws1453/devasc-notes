...
# ##################################################
class IngrCrcErrPkts1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts1h", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts1h"
    meta.rnFormat = "CDeqptIngrCrcErrPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats in 1 hour"
