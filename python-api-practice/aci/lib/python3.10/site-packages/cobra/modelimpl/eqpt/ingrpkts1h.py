...
class IngrPkts1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPkts1h", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPkts1h"
    meta.rnFormat = "CDeqptIngrPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Packets stats in 1 hour"
