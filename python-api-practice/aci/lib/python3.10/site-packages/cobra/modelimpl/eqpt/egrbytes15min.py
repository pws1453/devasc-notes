...
class EgrBytes15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytes15min", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytes15min"
    meta.rnFormat = "CDeqptEgrBytes15min"
