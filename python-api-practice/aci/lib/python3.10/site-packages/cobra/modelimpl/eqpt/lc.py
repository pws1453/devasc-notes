...
class LC(Mo):
    """
    A line card (IO card) contains IO ports and stores various line card related state mac addresses assigned to this card, such as whether the card went online.

    """

    meta = ClassMeta("cobra.model.eqpt.LC")

    meta.moClassName = "eqptLC"
    meta.rnFormat = "lc"
    meta.category = MoCategory.REGULAR
    meta.label = "Line Module"
    ...
    meta.childClasses.add("cobra.model.eqpt.LeafP")
    ...
    meta.childClasses.add("cobra.model.eqpt.FcP")
    meta.childClasses.add("cobra.model.eqpt.Ejec")
    meta.childClasses.add("cobra.model.eqpt.EobcP")
    meta.childClasses.add("cobra.model.eqpt.Flash")
    meta.childClasses.add("cobra.model.eqpt.RtLcOdDiag")
    meta.childClasses.add("cobra.model.eqpt.FabP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.RtLcOdDiag", "rtlcOdDiag"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.LeafP", "leafport-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.FabP", "fabport-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.FcP", "fc-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.Ejec", "ej-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14512, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 3329, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "linecard"
