...
class FruPower1d(Mo):
    """
    A class that represents the most current statistics for FRU power in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPower1d", "FRU power")
    ...
    meta.moClassName = "eqptFruPower1d"
    meta.rnFormat = "CDeqptFruPower1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FRU power stats in 1 day"
