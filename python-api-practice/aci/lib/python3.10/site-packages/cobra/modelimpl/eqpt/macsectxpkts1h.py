...
# ##################################################
class Macsectxpkts1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Macsectxpkts1h", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpkts1h"
    meta.rnFormat = "CDeqptMacsectxpkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Macsec Tx Pkts stats in 1 hour"
