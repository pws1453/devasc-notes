...
class ExtChCard(Mo):
    """
    The module on an extension chassis. The extended chassis is an extension of the fabric.

    """

    meta = ClassMeta("cobra.model.eqpt.ExtChCard")

    meta.moClassName = "eqptExtChCard"
    meta.rnFormat = "extchc"
    meta.category = MoCategory.REGULAR
    meta.label = "Extended Chassis Module"
    ...
    meta.childClasses.add("cobra.model.eqpt.ExtChCPU")
    ...
    meta.childClasses.add("cobra.model.eqpt.ExtChHP")
    ...
    meta.childClasses.add("cobra.model.eqpt.ExtChFP")
    ...
    meta.childClasses.add("cobra.model.eqpt.RtExtChCardOdDiag")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.RtExtChCardOdDiag", "rtextChCardOdDiag"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.ExtChHP", "hostextport-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.ExtChFP", "leafextport-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.ExtChCPU", "extchcpu-"))
    ...
    prop = PropMeta("str", "cimcVersion", "cimcVersion", 56704, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "modModel", "modModel", 3335, PropCategory.REGULAR)
    prop.label = "Model"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("modModel", prop)

    prop = PropMeta("str", "modSerial", "modSerial", 3333, PropCategory.REGULAR)
    prop.label = "Serial Number"
    prop.isOper = True
    prop.range = [(0, 16)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("modSerial", prop)
    ...
    prop = PropMeta("str", "modVendor", "modVendor", 3334, PropCategory.REGULAR)
    prop.label = "Vendor"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("modVendor", prop)

    prop = PropMeta("str", "model", "model", 5609, PropCategory.REGULAR)
    prop.label = "Model"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14515, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "partNum", "partNum", 3336, PropCategory.REGULAR)
    prop.label = "Module Part Number"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("partNum", prop)
    ...
    prop = PropMeta("str", "rev", "rev", 5610, PropCategory.REGULAR)
    prop.label = "Revision"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "ser", "ser", 5611, PropCategory.REGULAR)
    prop.label = "Serial Number"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "type", "type", 3332, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5
    prop.defaultValueStr = "extchcard"
    ...
    prop = PropMeta("str", "vendor", "vendor", 5612, PropCategory.REGULAR)
    prop.label = "Vendor"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
