...
class EgrBytesHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist1year", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist1year"
    meta.rnFormat = "HDeqptEgrBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress Bytes stats in 1 year"
    ...
    meta.superClasses.add("cobra.model.eqpt.EgrBytesHist")

    meta.rnPrefixes = [
        ('HDeqptEgrBytes1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6201, PropCategory.REGULAR)
