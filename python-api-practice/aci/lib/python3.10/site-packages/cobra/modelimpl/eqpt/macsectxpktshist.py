...
# ##################################################
class MacsectxpktsHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist"


    meta.moClassName = "eqptMacsectxpktsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.MacsectxpktsHist1qtr")
    ...
    prop = PropMeta("str", "encryptedPacktesAvg", "encryptedPacktesAvg", 31009, PropCategory.IMPLICIT_AVG)
    prop.label = "Macsec Encrypted packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesAvg", prop)

    prop = PropMeta("str", "encryptedPacktesCum", "encryptedPacktesCum", 31005, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Macsec Encrypted packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesCum", prop)

    prop = PropMeta("str", "encryptedPacktesMax", "encryptedPacktesMax", 31008, PropCategory.IMPLICIT_MAX)
    prop.label = "Macsec Encrypted packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesMax", prop)

    prop = PropMeta("str", "encryptedPacktesMin", "encryptedPacktesMin", 31007, PropCategory.IMPLICIT_MIN)
    prop.label = "Macsec Encrypted packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesMin", prop)

    prop = PropMeta("str", "encryptedPacktesPer", "encryptedPacktesPer", 31006, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Macsec Encrypted packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesPer", prop)

    prop = PropMeta("str", "encryptedPacktesRate", "encryptedPacktesRate", 31013, PropCategory.IMPLICIT_RATE)
    prop.label = "Macsec Encrypted packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesRate", prop)

    prop = PropMeta("str", "encryptedPacktesRateAvg", "encryptedPacktesRateAvg", 31025, PropCategory.IMPLICIT_AVG)
    prop.label = "Macsec Encrypted packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesRateAvg", prop)

    prop = PropMeta("str", "encryptedPacktesRateMax", "encryptedPacktesRateMax", 31024, PropCategory.IMPLICIT_MAX)
    prop.label = "Macsec Encrypted packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesRateMax", prop)

    prop = PropMeta("str", "encryptedPacktesRateMin", "encryptedPacktesRateMin", 31023, PropCategory.IMPLICIT_MIN)
    prop.label = "Macsec Encrypted packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesRateMin", prop)

    prop = PropMeta("str", "encryptedPacktesRateSpct", "encryptedPacktesRateSpct", 31026, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Macsec Encrypted packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesRateSpct", prop)

    prop = PropMeta("str", "encryptedPacktesRateThr", "encryptedPacktesRateThr", 31027, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "encryptedPacktesRateTr", "encryptedPacktesRateTr", 31028, PropCategory.IMPLICIT_TREND)
    prop.label = "Macsec Encrypted packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesRateTr", prop)

    prop = PropMeta("str", "encryptedPacktesSpct", "encryptedPacktesSpct", 31010, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Macsec Encrypted packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("encryptedPacktesSpct", prop)

    prop = PropMeta("str", "encryptedPacktesThr", "encryptedPacktesThr", 31011, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "encryptedPacktesTr", "encryptedPacktesTr", 31012, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "protectedPacketsAvg", "protectedPacketsAvg", 31045, PropCategory.IMPLICIT_AVG)
    prop.label = "Macsec Protected packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsAvg", prop)

    prop = PropMeta("str", "protectedPacketsCum", "protectedPacketsCum", 31041, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Macsec Protected packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsCum", prop)

    prop = PropMeta("str", "protectedPacketsMax", "protectedPacketsMax", 31044, PropCategory.IMPLICIT_MAX)
    prop.label = "Macsec Protected packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsMax", prop)

    prop = PropMeta("str", "protectedPacketsMin", "protectedPacketsMin", 31043, PropCategory.IMPLICIT_MIN)
    prop.label = "Macsec Protected packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsMin", prop)

    prop = PropMeta("str", "protectedPacketsPer", "protectedPacketsPer", 31042, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Macsec Protected packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsPer", prop)

    prop = PropMeta("str", "protectedPacketsRate", "protectedPacketsRate", 31049, PropCategory.IMPLICIT_RATE)
    prop.label = "Macsec Protected packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsRate", prop)

    prop = PropMeta("str", "protectedPacketsRateAvg", "protectedPacketsRateAvg", 31061, PropCategory.IMPLICIT_AVG)
    prop.label = "Macsec Protected packets rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsRateAvg", prop)

    prop = PropMeta("str", "protectedPacketsRateMax", "protectedPacketsRateMax", 31060, PropCategory.IMPLICIT_MAX)
    prop.label = "Macsec Protected packets rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsRateMax", prop)

    prop = PropMeta("str", "protectedPacketsRateMin", "protectedPacketsRateMin", 31059, PropCategory.IMPLICIT_MIN)
    prop.label = "Macsec Protected packets rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsRateMin", prop)

    prop = PropMeta("str", "protectedPacketsRateSpct", "protectedPacketsRateSpct", 31062, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Macsec Protected packets rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsRateSpct", prop)

    prop = PropMeta("str", "protectedPacketsRateThr", "protectedPacketsRateThr", 31063, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "protectedPacketsRateTr", "protectedPacketsRateTr", 31064, PropCategory.IMPLICIT_TREND)
    prop.label = "Macsec Protected packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsRateTr", prop)

    prop = PropMeta("str", "protectedPacketsSpct", "protectedPacketsSpct", 31046, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Macsec Protected packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("protectedPacketsSpct", prop)

    prop = PropMeta("str", "protectedPacketsThr", "protectedPacketsThr", 31047, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "protectedPacketsTr", "protectedPacketsTr", 31048, PropCategory.IMPLICIT_TREND)
