...
# ##################################################
class IngrStormHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist"


    meta.moClassName = "eqptIngrStormHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist1d")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrStormHist1qtr")
    ...
    prop = PropMeta("str", "dropBytesAvg", "dropBytesAvg", 18056, PropCategory.IMPLICIT_AVG)
    prop.label = "Storm Ctrl Drop Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesAvg", prop)

    prop = PropMeta("str", "dropBytesCum", "dropBytesCum", 18052, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Storm Ctrl Drop Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesCum", prop)

    prop = PropMeta("str", "dropBytesMax", "dropBytesMax", 18055, PropCategory.IMPLICIT_MAX)
    prop.label = "Storm Ctrl Drop Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesMax", prop)

    prop = PropMeta("str", "dropBytesMin", "dropBytesMin", 18054, PropCategory.IMPLICIT_MIN)
    prop.label = "Storm Ctrl Drop Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesMin", prop)

    prop = PropMeta("str", "dropBytesPer", "dropBytesPer", 18053, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Storm Ctrl Drop Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesPer", prop)

    prop = PropMeta("str", "dropBytesRate", "dropBytesRate", 18060, PropCategory.IMPLICIT_RATE)
    prop.label = "Storm Ctrl Drop Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRate", prop)

    prop = PropMeta("str", "dropBytesRateAvg", "dropBytesRateAvg", 18072, PropCategory.IMPLICIT_AVG)
    prop.label = "Storm Ctrl Drop Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRateAvg", prop)

    prop = PropMeta("str", "dropBytesRateMax", "dropBytesRateMax", 18071, PropCategory.IMPLICIT_MAX)
    prop.label = "Storm Ctrl Drop Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRateMax", prop)

    prop = PropMeta("str", "dropBytesRateMin", "dropBytesRateMin", 18070, PropCategory.IMPLICIT_MIN)
    prop.label = "Storm Ctrl Drop Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRateMin", prop)

    prop = PropMeta("str", "dropBytesRateSpct", "dropBytesRateSpct", 18073, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Storm Ctrl Drop Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRateSpct", prop)

    prop = PropMeta("str", "dropBytesRateThr", "dropBytesRateThr", 18074, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropBytesRateTr", "dropBytesRateTr", 18075, PropCategory.IMPLICIT_TREND)
    prop.label = "Storm Ctrl Drop Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRateTr", prop)

    prop = PropMeta("str", "dropBytesSpct", "dropBytesSpct", 18057, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Storm Ctrl Drop Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesSpct", prop)

    prop = PropMeta("str", "dropBytesThr", "dropBytesThr", 18058, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropBytesTr", "dropBytesTr", 18059, PropCategory.IMPLICIT_TREND)
