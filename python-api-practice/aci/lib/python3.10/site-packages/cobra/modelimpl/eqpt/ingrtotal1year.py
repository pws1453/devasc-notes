...
class IngrTotal1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotal1year", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotal1year"
    meta.rnFormat = "CDeqptIngrTotal1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress stats in 1 year"
