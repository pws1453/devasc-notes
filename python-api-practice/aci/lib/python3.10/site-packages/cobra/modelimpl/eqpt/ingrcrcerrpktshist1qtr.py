...
# ##################################################
class IngrCrcErrPktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist1qtr", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist1qtr"
    meta.rnFormat = "HDeqptIngrCrcErrPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 56337, PropCategory.REGULAR)
