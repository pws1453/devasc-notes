...
# ##################################################
class IngrCrcErrPkts1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPkts1qtr", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPkts1qtr"
    meta.rnFormat = "CDeqptIngrCrcErrPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress CRC Error Packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDeqptIngrCrcErrPkts1qtr', False),
    ]
