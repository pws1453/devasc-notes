...
class FC(Mo):
    """
    The fabric card, which connects different IO cards and stores all fabric related information.

    """

    meta = ClassMeta("cobra.model.eqpt.FC")

    meta.moClassName = "eqptFC"
    meta.rnFormat = "fc"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric Module"
    ...
    meta.childClasses.add("cobra.model.eqpt.RtFcOdDiag")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqpt.RtFcOdDiag", "rtfcOdDiag"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14513, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 3330, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    prop.defaultValueStr = "fabriccard"
