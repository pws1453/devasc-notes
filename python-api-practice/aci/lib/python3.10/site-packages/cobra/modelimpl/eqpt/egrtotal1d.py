...
class EgrTotal1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotal1d", "Egress")
    ...
    meta.moClassName = "eqptEgrTotal1d"
    meta.rnFormat = "CDeqptEgrTotal1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Egress stats in 1 day"
