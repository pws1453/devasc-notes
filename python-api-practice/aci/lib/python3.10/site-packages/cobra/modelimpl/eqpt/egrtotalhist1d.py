...
class EgrTotalHist1d(Mo):
    ...
    meta.moClassName = "eqptEgrTotalHist1d"
    meta.rnFormat = "HDeqptEgrTotal1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6220, PropCategory.REGULAR)
