...
# ##################################################
class FanStats1year(Mo):
    """
    A class that represents the most current statistics for fan in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FanStats1year", "fan")
    ...
    meta.moClassName = "eqptFanStats1year"
    meta.rnFormat = "CDeqptFanStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current fan stats in 1 year"
