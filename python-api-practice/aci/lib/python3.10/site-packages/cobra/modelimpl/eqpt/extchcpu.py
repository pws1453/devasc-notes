...
class ExtChCPU(Mo):
    """
    The extended chassis CPU.

    """

    meta = ClassMeta("cobra.model.eqpt.ExtChCPU")

    meta.moClassName = "eqptExtChCPU"
    meta.rnFormat = "extchcpu-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Extended Chassis CPU"
    ...
    prop = PropMeta("str", "id", "id", 6231, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
