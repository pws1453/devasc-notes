...
class EgrBytes5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytes5min", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytes5min"
    meta.rnFormat = "CDeqptEgrBytes5min"
