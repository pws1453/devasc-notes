...
class IngrTotalHist1year(Mo):
    ...
    meta.moClassName = "eqptIngrTotalHist1year"
    meta.rnFormat = "HDeqptIngrTotal1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6283, PropCategory.REGULAR)
