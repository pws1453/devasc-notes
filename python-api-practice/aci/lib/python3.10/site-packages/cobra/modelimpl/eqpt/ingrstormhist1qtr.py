...
# ##################################################
class IngrStormHist1qtr(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist1qtr", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist1qtr"
    meta.rnFormat = "HDeqptIngrStorm1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 17694, PropCategory.REGULAR)
