...
class FruPower1w(Mo):
    """
    A class that represents the most current statistics for FRU power in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPower1w", "FRU power")
    ...
    meta.moClassName = "eqptFruPower1w"
    meta.rnFormat = "CDeqptFruPower1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current FRU power stats in 1 week"
