...
# ##################################################
class IngrAggrPkts1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrAggrPkts1d", "Ingress Aggregated Packets")
    ...
    meta.moClassName = "eqptIngrAggrPkts1d"
    meta.rnFormat = "CDeqptIngrAggrPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Aggregated Packets stats in 1 day"
