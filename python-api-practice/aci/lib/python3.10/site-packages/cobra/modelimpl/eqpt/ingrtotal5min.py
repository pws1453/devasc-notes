...
class IngrTotal5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotal5min", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotal5min"
    meta.rnFormat = "CDeqptIngrTotal5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress stats in 5 minute"
