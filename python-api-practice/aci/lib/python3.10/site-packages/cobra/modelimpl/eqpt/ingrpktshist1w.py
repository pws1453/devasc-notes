...
class IngrPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist1w", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist1w"
    meta.rnFormat = "HDeqptIngrPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6274, PropCategory.REGULAR)
