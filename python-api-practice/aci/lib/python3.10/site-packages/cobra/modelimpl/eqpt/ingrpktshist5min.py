...
class IngrPktsHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist5min", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist5min"
    meta.rnFormat = "HDeqptIngrPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6276, PropCategory.REGULAR)
