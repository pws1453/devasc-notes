...
class IngrPktsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrPktsHist1mo", "Ingress Packets")
    ...
    meta.moClassName = "eqptIngrPktsHist1mo"
    meta.rnFormat = "HDeqptIngrPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6272, PropCategory.REGULAR)
