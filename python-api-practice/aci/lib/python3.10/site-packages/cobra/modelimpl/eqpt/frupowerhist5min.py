...
# ##################################################
class FruPowerHist5min(Mo):
    """
    A class that represents historical statistics for FRU power in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.eqpt.FruPowerHist5min", "FRU power")
    ...
    meta.moClassName = "eqptFruPowerHist5min"
    meta.rnFormat = "HDeqptFruPower5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical FRU power stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6252, PropCategory.REGULAR)
