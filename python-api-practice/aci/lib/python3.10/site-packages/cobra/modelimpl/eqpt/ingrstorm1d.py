...
# ##################################################
class IngrStorm1d(Mo):
    """
    A class that represents the most current statistics for  Ingress  Storm  Ctrl in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStorm1d", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStorm1d"
    meta.rnFormat = "CDeqptIngrStorm1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Storm Ctrl stats in 1 day"
