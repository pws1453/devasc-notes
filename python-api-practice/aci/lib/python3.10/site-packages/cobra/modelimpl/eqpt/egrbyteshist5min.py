...
class EgrBytesHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrBytesHist5min", "Egress Bytes")
    ...
    meta.moClassName = "eqptEgrBytesHist5min"
    meta.rnFormat = "HDeqptEgrBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Egress Bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6202, PropCategory.REGULAR)
