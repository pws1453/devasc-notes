...
# ##################################################
class MacsectxpktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.MacsectxpktsHist15min", "Macsec Tx Pkts")
    ...
    meta.moClassName = "eqptMacsectxpktsHist15min"
    meta.rnFormat = "HDeqptMacsectxpkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Macsec Tx Pkts stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.eqpt.MacsectxpktsHist")

    meta.rnPrefixes = [
        ('HDeqptMacsectxpkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 30769, PropCategory.REGULAR)
