...
class IngrTotalHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotalHist5min", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotalHist5min"
    meta.rnFormat = "HDeqptIngrTotal5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6284, PropCategory.REGULAR)
