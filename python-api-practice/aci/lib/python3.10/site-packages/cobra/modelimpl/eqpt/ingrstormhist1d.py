...
# ##################################################
class IngrStormHist1d(Mo):
    """
    A class that represents historical statistics for  Ingress  Storm  Ctrl in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrStormHist1d", "Ingress Storm Ctrl")
    ...
    meta.moClassName = "eqptIngrStormHist1d"
    meta.rnFormat = "HDeqptIngrStorm1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Storm Ctrl stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 17691, PropCategory.REGULAR)
