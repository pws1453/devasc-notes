...
class EgrTotal1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.EgrTotal1mo", "Egress")
    ...
    meta.moClassName = "eqptEgrTotal1mo"
    meta.rnFormat = "CDeqptEgrTotal1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Egress stats in 1 month"
