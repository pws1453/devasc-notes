...
class IngrTotal1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotal1d", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotal1d"
    meta.rnFormat = "CDeqptIngrTotal1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress stats in 1 day"
