...
class IngrTotal15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.eqpt.IngrTotal15min", "Ingress")
    ...
    meta.moClassName = "eqptIngrTotal15min"
    meta.rnFormat = "CDeqptIngrTotal15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress stats in 15 minute"
