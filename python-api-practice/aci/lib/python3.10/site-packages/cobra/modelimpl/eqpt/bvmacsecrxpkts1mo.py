...
# ##################################################
class Bvmacsecrxpkts1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqpt.Bvmacsecrxpkts1mo", "BV Macsec Rx Pkts")
    ...
    meta.moClassName = "eqptBvmacsecrxpkts1mo"
    meta.rnFormat = "CDeqptBvmacsecrxpkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BV Macsec Rx Pkts stats in 1 month"
