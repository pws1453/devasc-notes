...
# ##################################################
class IngrCrcErrPktsHist(Mo):
    meta = StatsClassMeta("cobra.model.eqpt.IngrCrcErrPktsHist", "Ingress CRC Error Packets")
    ...
    meta.moClassName = "eqptIngrCrcErrPktsHist"


    meta.moClassName = "eqptIngrCrcErrPktsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress CRC Error Packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist1w")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist5min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist15min")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist1mo")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist1year")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist1h")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.eqpt.IngrCrcErrPktsHist1d")
