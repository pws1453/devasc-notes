...
class LocLed(Mo):
    """
    A locator LED on chassis components.

    """

    meta = ClassMeta("cobra.model.eqpt.LocLed")

    meta.moClassName = "eqptLocLed"
    meta.rnFormat = "locled-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Locator LED"
    ...
    prop = PropMeta("str", "id", "id", 6303, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
