...
class EobcP(Mo):
    """
    An internal Ethernet out-of-band channel port. Note that all card component management is done via this port.

    """

    meta = ClassMeta("cobra.model.eqpt.EobcP")

    meta.moClassName = "eqptEobcP"
    meta.rnFormat = "eobc-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Ethernet Out of Band Channel Port"
    ...
    meta.superClasses.add("cobra.model.eqpt.IntP")
    ...
    prop = PropMeta("str", "id", "id", 6228, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
