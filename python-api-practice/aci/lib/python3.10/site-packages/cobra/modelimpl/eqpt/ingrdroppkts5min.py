...
# ##################################################
class IngrDropPkts5min(Mo):
    """
    A class that represents the most current statistics for  Ingress  Drop  Packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.eqpt.IngrDropPkts5min", "Ingress Drop Packets")
    ...
    meta.moClassName = "eqptIngrDropPkts5min"
    meta.rnFormat = "CDeqptIngrDropPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Drop Packets stats in 5 minute"
