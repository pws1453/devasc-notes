...
# ##################################################
class RsNwsSyslogSrcToDestGroup(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.nws.RsNwsSyslogSrcToDestGroup", "cobra.model.syslog.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "nwsRsNwsSyslogSrcToDestGroup"
    meta.rnFormat = "rsnwsSyslogSrcToDestGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Syslog Destination Group"
    ...
    meta.rnPrefixes = [
        ('rsnwsSyslogSrcToDestGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38328, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40467, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21541, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "remoteDestCount", "remoteDestCount", 22042, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 21532, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21531, PropCategory.REGULAR)
