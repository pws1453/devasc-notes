...
# ##################################################
class RtVswitchOverrideFwPol(Mo):
    """
     Relationship to nws fw policy 

    """

    meta = TargetRelationMeta("cobra.model.nws.RtVswitchOverrideFwPol", "cobra.model.vmm.VSwitchPolicyCont")

    meta.moClassName = "nwsRtVswitchOverrideFwPol"
    meta.rnFormat = "rtvmmVswitchOverrideFwPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvmmVswitchOverrideFwPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23005, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23004, PropCategory.REGULAR)
