...
# ##################################################
class RtDefaultFwPol(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.nws.RtDefaultFwPol", "cobra.model.vmm.DomP")

    meta.moClassName = "nwsRtDefaultFwPol"
    meta.rnFormat = "rtvmmDefaultFwPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 19088, PropCategory.REGULAR)
