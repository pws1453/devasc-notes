...
# ##################################################
class RsNwsSyslogSrcDefToDestGroup(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.nws.RsNwsSyslogSrcDefToDestGroup", "cobra.model.syslog.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "nwsRsNwsSyslogSrcDefToDestGroup"
    meta.rnFormat = "rsnwsSyslogSrcDefToDestGroup"
    ...
    meta.parentClasses.add("cobra.model.nws.SyslogSrcDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsnwsSyslogSrcDefToDestGroup', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 21536, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21535, PropCategory.REGULAR)
