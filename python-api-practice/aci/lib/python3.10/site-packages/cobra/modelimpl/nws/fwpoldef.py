...
class FwPolDef(Mo):
    """
     read only copy of lacp policy 

    """

    meta = ClassMeta("cobra.model.nws.FwPolDef")

    meta.moClassName = "nwsFwPolDef"
    meta.rnFormat = "fwPD-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Firewall Policy"
    ...
    meta.childClasses.add("cobra.model.nws.SyslogSrcDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.nws.SyslogSrcDef", "slsrcd-"))
    ...
    prop = PropMeta("str", "name", "name", 19085, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
