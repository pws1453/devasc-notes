...
# ##################################################
class RtResNwsFwPol(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.nws.RtResNwsFwPol", "cobra.model.infra.Infra")

    meta.moClassName = "nwsRtResNwsFwPol"
    meta.rnFormat = "rtresNwsFwPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19100, PropCategory.REGULAR)
