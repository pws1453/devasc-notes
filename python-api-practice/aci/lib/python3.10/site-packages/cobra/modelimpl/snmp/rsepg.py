...
class RsEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.snmp.RsEpg", "cobra.model.fv.ATg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "snmpRsEpg"
    meta.rnFormat = "rsepg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37946, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40085, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13337, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13336, PropCategory.REGULAR)
