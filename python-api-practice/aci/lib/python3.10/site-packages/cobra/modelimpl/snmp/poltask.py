...
class PolTask(Mo):
    ...
    meta = ClassMeta("cobra.model.snmp.PolTask")

    meta.moClassName = "snmpPolTask"
    meta.rnFormat = "snmpPolTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 60821, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendCtrlrInstInfo", "sendctrlrinstinfo", 3932)
