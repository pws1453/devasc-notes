...
class RtDestGroup(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.snmp.RtDestGroup", "cobra.model.snmp.Src")

    meta.moClassName = "snmpRtDestGroup"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12025, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1688
    prop.defaultValueStr = "snmpSrc"
    prop._addConstant("snmpSrc", None, 1688)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12024, PropCategory.REGULAR)
