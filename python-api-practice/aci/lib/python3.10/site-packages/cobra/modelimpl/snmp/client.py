...
class Client(Mo):
    ...
    meta = ClassMeta("cobra.model.snmp.Client")

    meta.moClassName = "snmpClient"
    meta.rnFormat = "client-[%(addr)s]"
    ...
    meta.superClasses.add("cobra.model.snmp.AClientP")

    meta.rnPrefixes = [
        ('client-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 7152, PropCategory.REGULAR)
    prop.label = "Client Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16095, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 15482, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 15483, PropCategory.REGULAR)
