...
class RtSnmpGrp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.snmp.RtSnmpGrp", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "snmpRtSnmpGrp"
    meta.rnFormat = "rtpolSnmpGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 60832, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 60831, PropCategory.REGULAR)
