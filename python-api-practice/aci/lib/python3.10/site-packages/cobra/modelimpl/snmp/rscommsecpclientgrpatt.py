...
# ##################################################
class RsCommSecPClientGrpAtt(Mo):
    """
    Ignore, removed

    """

    meta = SourceRelationMeta("cobra.model.snmp.RsCommSecPClientGrpAtt", "cobra.model.snmp.CommSecP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "snmpRsCommSecPClientGrpAtt"
    meta.rnFormat = "rscommSecPClientGrpAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Community Security Policy Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12640, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2530
    prop.defaultValueStr = "snmpCommSecP"
    prop._addConstant("snmpCommSecP", None, 2530)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12639, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15055, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
