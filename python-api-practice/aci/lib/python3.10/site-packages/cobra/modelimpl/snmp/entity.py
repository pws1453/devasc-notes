...
class Entity(Mo):
    """
    SNMP control plane entity information.

    """

    meta = ClassMeta("cobra.model.snmp.Entity")

    meta.moClassName = "snmpEntity"
    meta.rnFormat = "snmp"
    meta.category = MoCategory.REGULAR
    meta.label = "SNMP Entity"
    ...
    meta.childClasses.add("cobra.model.snmp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.snmp.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15609, PropCategory.REGULAR)
