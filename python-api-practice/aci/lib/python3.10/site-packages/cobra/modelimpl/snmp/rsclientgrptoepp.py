...
# ##################################################
class RsClientGrpToEpp(Mo):
    """
    A source relation to an abstract representation of the resolvable endpoint profile.

    """

    meta = SourceRelationMeta("cobra.model.snmp.RsClientGrpToEpp", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "snmpRsClientGrpToEpp"
    meta.rnFormat = "rsclientGrpToEpp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SNMP Clien Group Reachability EPP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16074, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16073, PropCategory.REGULAR)
