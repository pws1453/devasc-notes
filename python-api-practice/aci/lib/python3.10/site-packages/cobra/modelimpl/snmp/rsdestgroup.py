...
# ##################################################
class RsDestGroup(Mo):
    """
    A source relation to an SNMP destination group. This group contains information needed to send traps or informs to a set of destinations. .

    """

    meta = SourceRelationMeta("cobra.model.snmp.RsDestGroup", "cobra.model.snmp.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "snmpRsDestGroup"
    meta.rnFormat = "rsdestGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "SNMP Destination Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37567, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39706, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14169, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12023, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1692
    prop.defaultValueStr = "snmpGroup"
    prop._addConstant("snmpGroup", None, 1692)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12022, PropCategory.REGULAR)
