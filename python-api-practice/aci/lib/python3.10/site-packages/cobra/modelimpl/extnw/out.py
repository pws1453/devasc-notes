...
# ##################################################
class Out(Mo):
    meta = ClassMeta("cobra.model.extnw.Out")

    meta.isAbstract = True
    meta.moClassName = "extnwOut"


    meta.moClassName = "extnwOut"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Outside Profile"
    ...
    prop = PropMeta("str", "targetDscp", "targetDscp", 16510, PropCategory.REGULAR)
    prop.label = "Out Level Dscp"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
