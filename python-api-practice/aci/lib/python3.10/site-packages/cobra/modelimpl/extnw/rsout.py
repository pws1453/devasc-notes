...
class RsOut(Mo):
    """
    A source relation to an abstraction of the port functions.

    """

    meta = SourceRelationMeta("cobra.model.extnw.RsOut", "cobra.model.infra.AccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "extnwRsOut"
    meta.rnFormat = "rsout-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access Group"
    ...
    meta.childClasses.add("cobra.model.infra.Node")

    meta.childNamesAndRnPrefix.append(("cobra.model.infra.Node", "node-"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 12089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12088, PropCategory.REGULAR)
