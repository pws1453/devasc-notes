...
# ##################################################
class SysMemHist5min(Mo):
    """
    A class that represents historical statistics for  System memory in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist5min", "System memory")
    ...
    meta.moClassName = "procSysMemHist5min"
    meta.rnFormat = "HDprocSysMem5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 7079, PropCategory.REGULAR)
