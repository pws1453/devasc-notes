...
# ##################################################
class SysMemHist15min(Mo):
    """
    A class that represents historical statistics for  System memory in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist15min", "System memory")
    ...
    meta.moClassName = "procSysMemHist15min"
    meta.rnFormat = "HDprocSysMem15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.proc.SysMemHist")

    meta.rnPrefixes = [
        ('HDprocSysMem15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 7072, PropCategory.REGULAR)
