...
class ProcMem1d(Mo):
    """
    A class that represents the most current statistics for  Process memory in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMem1d", "Process memory")
    ...
    meta.moClassName = "procProcMem1d"
    meta.rnFormat = "CDprocProcMem1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Process memory stats in 1 day"
