...
class MemHist1d(Mo):
    """
    A class that represents historical statistics for memory in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.MemHist1d", "memory")
    ...
    meta.moClassName = "procMemHist1d"
    meta.rnFormat = "HDprocMem1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical memory stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 7031, PropCategory.REGULAR)
