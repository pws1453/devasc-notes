...
# ##################################################
class MemHist1qtr(Mo):
    """
    A class that represents historical statistics for memory in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.MemHist1qtr", "memory")
    ...
    meta.moClassName = "procMemHist1qtr"
    meta.rnFormat = "HDprocMem1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical memory stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 7034, PropCategory.REGULAR)
