...
class SysMem5min(Mo):
    """
    A class that represents the most current statistics for  System memory in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMem5min", "System memory")
    ...
    meta.moClassName = "procSysMem5min"
    meta.rnFormat = "CDprocSysMem5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System memory stats in 5 minute"
