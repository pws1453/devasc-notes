...
class SysCPU1w(Mo):
    """
    A class that represents the most current statistics for  System cpu in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPU1w", "System cpu")
    ...
    meta.moClassName = "procSysCPU1w"
    meta.rnFormat = "CDprocSysCPU1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System cpu stats in 1 week"
