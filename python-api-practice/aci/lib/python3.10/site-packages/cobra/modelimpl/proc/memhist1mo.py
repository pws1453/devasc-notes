...
class MemHist1mo(Mo):
    """
    A class that represents historical statistics for memory in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.MemHist1mo", "memory")
    ...
    meta.moClassName = "procMemHist1mo"
    meta.rnFormat = "HDprocMem1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical memory stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 7033, PropCategory.REGULAR)
