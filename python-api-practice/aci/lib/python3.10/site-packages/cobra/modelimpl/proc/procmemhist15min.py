...
# ##################################################
class ProcMemHist15min(Mo):
    """
    A class that represents historical statistics for  Process memory in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMemHist15min", "Process memory")
    ...
    meta.moClassName = "procProcMemHist15min"
    meta.rnFormat = "HDprocProcMem15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Process memory stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 7046, PropCategory.REGULAR)
