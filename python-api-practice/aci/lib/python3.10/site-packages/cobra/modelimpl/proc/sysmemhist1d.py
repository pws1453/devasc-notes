...
# ##################################################
class SysMemHist1d(Mo):
    """
    A class that represents historical statistics for  System memory in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist1d", "System memory")
    ...
    meta.moClassName = "procSysMemHist1d"
    meta.rnFormat = "HDprocSysMem1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 7073, PropCategory.REGULAR)
