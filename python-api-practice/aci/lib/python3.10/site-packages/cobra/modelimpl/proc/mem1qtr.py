...
class Mem1qtr(Mo):
    """
    A class that represents the most current statistics for memory in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem1qtr", "memory")
    ...
    meta.moClassName = "procMem1qtr"
    meta.rnFormat = "CDprocMem1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 1 quarter"
