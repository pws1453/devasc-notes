...
class CPU1qtr(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU1qtr", "CPU utilization")
    ...
    meta.moClassName = "procCPU1qtr"
    meta.rnFormat = "CDprocCPU1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 1 quarter"
