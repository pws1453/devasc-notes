...
# ##################################################
class ApplicationCPU1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPU1qtr", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPU1qtr"
    meta.rnFormat = "CDprocApplicationCPU1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Application CPU utilization stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDprocApplicationCPU1qtr', False),
    ]
