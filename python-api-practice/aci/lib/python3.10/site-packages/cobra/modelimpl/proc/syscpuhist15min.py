...
# ##################################################
class SysCPUHist15min(Mo):
    """
    A class that represents historical statistics for  System cpu in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist15min", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist15min"
    meta.rnFormat = "HDprocSysCPU15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.proc.SysCPUHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDprocSysCPU15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 7056, PropCategory.REGULAR)
