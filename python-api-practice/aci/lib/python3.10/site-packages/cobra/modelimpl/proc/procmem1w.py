...
class ProcMem1w(Mo):
    """
    A class that represents the most current statistics for  Process memory in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMem1w", "Process memory")
    ...
    meta.moClassName = "procProcMem1w"
    meta.rnFormat = "CDprocProcMem1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Process memory stats in 1 week"
