...
# ##################################################
class SysMem1year(Mo):
    """
    A class that represents the most current statistics for  System memory in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMem1year", "System memory")
    ...
    meta.moClassName = "procSysMem1year"
    meta.rnFormat = "CDprocSysMem1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System memory stats in 1 year"
