...
# ##################################################
class CPUHist15min(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist15min", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist15min"
    meta.rnFormat = "HDprocCPU15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.proc.CPUHist")
    ...
    prop = PropMeta("str", "index", "index", 7021, PropCategory.REGULAR)
