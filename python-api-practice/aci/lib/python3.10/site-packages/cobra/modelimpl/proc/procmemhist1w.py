...
# ##################################################
class ProcMemHist1w(Mo):
    """
    A class that represents historical statistics for  Process memory in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMemHist1w", "Process memory")
    ...
    meta.moClassName = "procProcMemHist1w"
    meta.rnFormat = "HDprocProcMem1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Process memory stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 7051, PropCategory.REGULAR)
