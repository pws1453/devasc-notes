...
class Mem15min(Mo):
    """
    A class that represents the most current statistics for memory in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem15min", "memory")
    ...
    meta.moClassName = "procMem15min"
    meta.rnFormat = "CDprocMem15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.proc.Mem")

    meta.rnPrefixes = [
        ('CDprocMem15min', False),
    ]
