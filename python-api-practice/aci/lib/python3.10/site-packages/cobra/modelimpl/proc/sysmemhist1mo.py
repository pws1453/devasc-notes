...
# ##################################################
class SysMemHist1mo(Mo):
    """
    A class that represents historical statistics for  System memory in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist1mo", "System memory")
    ...
    meta.moClassName = "procSysMemHist1mo"
    meta.rnFormat = "HDprocSysMem1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 7075, PropCategory.REGULAR)
