...
class Mem5min(Mo):
    """
    A class that represents the most current statistics for memory in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem5min", "memory")
    ...
    meta.moClassName = "procMem5min"
    meta.rnFormat = "CDprocMem5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 5 minute"
