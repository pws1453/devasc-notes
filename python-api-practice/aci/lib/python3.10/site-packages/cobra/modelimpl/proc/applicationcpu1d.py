...
# ##################################################
class ApplicationCPU1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPU1d", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPU1d"
    meta.rnFormat = "CDprocApplicationCPU1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Application CPU utilization stats in 1 day"
