...
# ##################################################
class SysCPUHist1year(Mo):
    """
    A class that represents historical statistics for  System cpu in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist1year", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist1year"
    meta.rnFormat = "HDprocSysCPU1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 7062, PropCategory.REGULAR)
