...
# ##################################################
class ApplicationCPUHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPUHist1h", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPUHist1h"
    meta.rnFormat = "HDprocApplicationCPU1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Application CPU utilization stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 30328, PropCategory.REGULAR)
