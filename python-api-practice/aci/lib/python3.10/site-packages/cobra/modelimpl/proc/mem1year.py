...
class Mem1year(Mo):
    """
    A class that represents the most current statistics for memory in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem1year", "memory")
    ...
    meta.moClassName = "procMem1year"
    meta.rnFormat = "CDprocMem1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 1 year"
