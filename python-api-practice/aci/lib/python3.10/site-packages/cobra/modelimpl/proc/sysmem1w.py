...
class SysMem1w(Mo):
    """
    A class that represents the most current statistics for  System memory in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMem1w", "System memory")
    ...
    meta.moClassName = "procSysMem1w"
    meta.rnFormat = "CDprocSysMem1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System memory stats in 1 week"
