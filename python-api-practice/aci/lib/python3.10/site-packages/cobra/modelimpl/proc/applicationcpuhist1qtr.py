...
# ##################################################
class ApplicationCPUHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPUHist1qtr", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPUHist1qtr"
    meta.rnFormat = "HDprocApplicationCPU1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Application CPU utilization stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 30330, PropCategory.REGULAR)
