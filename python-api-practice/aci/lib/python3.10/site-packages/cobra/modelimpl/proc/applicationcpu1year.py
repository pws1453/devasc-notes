...
# ##################################################
class ApplicationCPU1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPU1year", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPU1year"
    meta.rnFormat = "CDprocApplicationCPU1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Application CPU utilization stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDprocApplicationCPU1year', False),
    ]
