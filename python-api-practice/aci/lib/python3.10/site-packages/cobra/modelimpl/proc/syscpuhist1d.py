...
# ##################################################
class SysCPUHist1d(Mo):
    """
    A class that represents historical statistics for  System cpu in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist1d", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist1d"
    meta.rnFormat = "HDprocSysCPU1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 7057, PropCategory.REGULAR)
