...
class SysMem1qtr(Mo):
    """
    A class that represents the most current statistics for  System memory in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMem1qtr", "System memory")
    ...
    meta.moClassName = "procSysMem1qtr"
    meta.rnFormat = "CDprocSysMem1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System memory stats in 1 quarter"
