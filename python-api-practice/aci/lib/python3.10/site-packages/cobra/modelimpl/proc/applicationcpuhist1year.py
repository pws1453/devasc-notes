...
# ##################################################
class ApplicationCPUHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPUHist1year", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPUHist1year"
    meta.rnFormat = "HDprocApplicationCPU1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Application CPU utilization stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDprocApplicationCPU1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 30332, PropCategory.REGULAR)
