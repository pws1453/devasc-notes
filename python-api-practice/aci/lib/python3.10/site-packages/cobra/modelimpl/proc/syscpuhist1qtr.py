...
# ##################################################
class SysCPUHist1qtr(Mo):
    """
    A class that represents historical statistics for  System cpu in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist1qtr", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist1qtr"
    meta.rnFormat = "HDprocSysCPU1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 7060, PropCategory.REGULAR)
