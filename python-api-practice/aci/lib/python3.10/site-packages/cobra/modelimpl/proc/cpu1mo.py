...
class CPU1mo(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU1mo", "CPU utilization")
    ...
    meta.moClassName = "procCPU1mo"
    meta.rnFormat = "CDprocCPU1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 1 month"
