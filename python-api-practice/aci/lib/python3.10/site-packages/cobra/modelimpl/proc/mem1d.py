...
class Mem1d(Mo):
    """
    A class that represents the most current statistics for memory in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem1d", "memory")
    ...
    meta.moClassName = "procMem1d"
    meta.rnFormat = "CDprocMem1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 1 day"
