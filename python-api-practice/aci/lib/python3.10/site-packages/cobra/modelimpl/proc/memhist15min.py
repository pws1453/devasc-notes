...
# ##################################################
class MemHist15min(Mo):
    """
    A class that represents historical statistics for memory in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.MemHist15min", "memory")
    ...
    meta.moClassName = "procMemHist15min"
    meta.rnFormat = "HDprocMem15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical memory stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 7030, PropCategory.REGULAR)
