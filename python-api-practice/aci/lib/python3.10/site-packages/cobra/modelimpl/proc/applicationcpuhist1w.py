...
# ##################################################
class ApplicationCPUHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPUHist1w", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPUHist1w"
    meta.rnFormat = "HDprocApplicationCPU1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Application CPU utilization stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 30331, PropCategory.REGULAR)
