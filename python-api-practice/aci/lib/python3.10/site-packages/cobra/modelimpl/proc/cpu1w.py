...
class CPU1w(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU1w", "CPU utilization")
    ...
    meta.moClassName = "procCPU1w"
    meta.rnFormat = "CDprocCPU1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 1 week"
