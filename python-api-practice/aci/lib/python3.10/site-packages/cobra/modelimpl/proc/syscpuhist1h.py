...
# ##################################################
class SysCPUHist1h(Mo):
    """
    A class that represents historical statistics for  System cpu in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist1h", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist1h"
    meta.rnFormat = "HDprocSysCPU1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 7058, PropCategory.REGULAR)
