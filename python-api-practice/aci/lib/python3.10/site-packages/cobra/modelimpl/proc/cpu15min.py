...
class CPU15min(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU15min", "CPU utilization")
    ...
    meta.moClassName = "procCPU15min"
    meta.rnFormat = "CDprocCPU15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.proc.CPU")

    meta.rnPrefixes = [
        ('CDprocCPU15min', False),
    ]
