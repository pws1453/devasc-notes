...
# ##################################################
class SysCPUHist5min(Mo):
    """
    A class that represents historical statistics for  System cpu in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist5min", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist5min"
    meta.rnFormat = "HDprocSysCPU5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 7063, PropCategory.REGULAR)
