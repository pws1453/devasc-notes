...
# ##################################################
class SysMemHist(Mo):
    meta = StatsClassMeta("cobra.model.proc.SysMemHist", "System memory")
    ...
    meta.moClassName = "procSysMemHist"


    meta.moClassName = "procSysMemHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats"
    ...
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist1h")
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist1d")
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist15min")
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist5min")
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist1mo")
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist1w")
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist1year")
    meta.concreteSubClasses.add("cobra.model.proc.SysMemHist1qtr")
    ...
    prop = PropMeta("str", "freeAvg", "freeAvg", 10833, PropCategory.IMPLICIT_AVG)
    prop.label = "free memory average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("freeAvg", prop)

    prop = PropMeta("str", "freeMax", "freeMax", 10832, PropCategory.IMPLICIT_MAX)
    prop.label = "free memory maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("freeMax", prop)

    prop = PropMeta("str", "freeMin", "freeMin", 10831, PropCategory.IMPLICIT_MIN)
    prop.label = "free memory minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("freeMin", prop)

    prop = PropMeta("str", "freeSpct", "freeSpct", 10834, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "free memory suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("freeSpct", prop)

    prop = PropMeta("str", "freeThr", "freeThr", 10835, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "freeTr", "freeTr", 10836, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "totalAvg", "totalAvg", 10854, PropCategory.IMPLICIT_AVG)
    prop.label = "total memory average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalAvg", prop)

    prop = PropMeta("str", "totalMax", "totalMax", 10853, PropCategory.IMPLICIT_MAX)
    prop.label = "total memory maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMax", prop)

    prop = PropMeta("str", "totalMin", "totalMin", 10852, PropCategory.IMPLICIT_MIN)
    prop.label = "total memory minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalMin", prop)

    prop = PropMeta("str", "totalSpct", "totalSpct", 10855, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "total memory suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalSpct", prop)

    prop = PropMeta("str", "totalThr", "totalThr", 10856, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "totalTr", "totalTr", 10857, PropCategory.IMPLICIT_TREND)
    prop.label = "total memory trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("totalTr", prop)

    prop = PropMeta("str", "usedAvg", "usedAvg", 10875, PropCategory.IMPLICIT_AVG)
    prop.label = "used memory average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("usedAvg", prop)

    prop = PropMeta("str", "usedMax", "usedMax", 10874, PropCategory.IMPLICIT_MAX)
    prop.label = "used memory maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("usedMax", prop)

    prop = PropMeta("str", "usedMin", "usedMin", 10873, PropCategory.IMPLICIT_MIN)
    prop.label = "used memory minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("usedMin", prop)

    prop = PropMeta("str", "usedSpct", "usedSpct", 10876, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "used memory suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("usedSpct", prop)

    prop = PropMeta("str", "usedThr", "usedThr", 10877, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "usedTr", "usedTr", 10878, PropCategory.IMPLICIT_TREND)
