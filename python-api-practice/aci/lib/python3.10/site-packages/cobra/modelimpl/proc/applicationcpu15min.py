...
# ##################################################
class ApplicationCPU15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPU15min", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPU15min"
    meta.rnFormat = "CDprocApplicationCPU15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Application CPU utilization stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDprocApplicationCPU15min', False),
    ]
