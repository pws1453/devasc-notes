...
class SysCPU1mo(Mo):
    """
    A class that represents the most current statistics for  System cpu in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPU1mo", "System cpu")
    ...
    meta.moClassName = "procSysCPU1mo"
    meta.rnFormat = "CDprocSysCPU1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System cpu stats in 1 month"
