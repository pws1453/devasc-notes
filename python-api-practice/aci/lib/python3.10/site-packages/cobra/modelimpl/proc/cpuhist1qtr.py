...
# ##################################################
class CPUHist1qtr(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist1qtr", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist1qtr"
    meta.rnFormat = "HDprocCPU1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 7025, PropCategory.REGULAR)
