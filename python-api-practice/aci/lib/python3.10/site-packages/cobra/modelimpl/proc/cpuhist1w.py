...
class CPUHist1w(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist1w", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist1w"
    meta.rnFormat = "HDprocCPU1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 7026, PropCategory.REGULAR)
