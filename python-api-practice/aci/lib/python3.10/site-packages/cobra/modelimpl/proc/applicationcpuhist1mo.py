...
# ##################################################
class ApplicationCPUHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPUHist1mo", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPUHist1mo"
    meta.rnFormat = "HDprocApplicationCPU1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Application CPU utilization stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 30329, PropCategory.REGULAR)
