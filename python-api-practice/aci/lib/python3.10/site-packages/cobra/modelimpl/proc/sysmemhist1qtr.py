...
# ##################################################
class SysMemHist1qtr(Mo):
    """
    A class that represents historical statistics for  System memory in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist1qtr", "System memory")
    ...
    meta.moClassName = "procSysMemHist1qtr"
    meta.rnFormat = "HDprocSysMem1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 7076, PropCategory.REGULAR)
