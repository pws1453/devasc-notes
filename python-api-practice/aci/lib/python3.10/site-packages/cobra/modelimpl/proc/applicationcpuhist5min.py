...
# ##################################################
class ApplicationCPUHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPUHist5min", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPUHist5min"
    meta.rnFormat = "HDprocApplicationCPU5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Application CPU utilization stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 30333, PropCategory.REGULAR)
