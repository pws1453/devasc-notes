...
# ##################################################
class SysMemHist1h(Mo):
    """
    A class that represents historical statistics for  System memory in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist1h", "System memory")
    ...
    meta.moClassName = "procSysMemHist1h"
    meta.rnFormat = "HDprocSysMem1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 7074, PropCategory.REGULAR)
