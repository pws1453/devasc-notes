...
class CPUHist1d(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist1d", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist1d"
    meta.rnFormat = "HDprocCPU1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 7022, PropCategory.REGULAR)
