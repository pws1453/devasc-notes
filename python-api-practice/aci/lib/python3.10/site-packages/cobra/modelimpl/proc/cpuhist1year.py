...
# ##################################################
class CPUHist1year(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist1year", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist1year"
    meta.rnFormat = "HDprocCPU1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 7027, PropCategory.REGULAR)
