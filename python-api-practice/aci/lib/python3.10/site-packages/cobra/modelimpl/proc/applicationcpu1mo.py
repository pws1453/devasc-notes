...
# ##################################################
class ApplicationCPU1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPU1mo", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPU1mo"
    meta.rnFormat = "CDprocApplicationCPU1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Application CPU utilization stats in 1 month"
