...
class Mem1h(Mo):
    """
    A class that represents the most current statistics for memory in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem1h", "memory")
    ...
    meta.moClassName = "procMem1h"
    meta.rnFormat = "CDprocMem1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 1 hour"
