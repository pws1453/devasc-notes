...
class CPU1h(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU1h", "CPU utilization")
    ...
    meta.moClassName = "procCPU1h"
    meta.rnFormat = "CDprocCPU1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 1 hour"
