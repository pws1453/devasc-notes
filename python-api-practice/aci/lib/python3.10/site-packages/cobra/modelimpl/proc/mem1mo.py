...
class Mem1mo(Mo):
    """
    A class that represents the most current statistics for memory in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem1mo", "memory")
    ...
    meta.moClassName = "procMem1mo"
    meta.rnFormat = "CDprocMem1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 1 month"
