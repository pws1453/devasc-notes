...
# ##################################################
class CPUHist5min(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist5min", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist5min"
    meta.rnFormat = "HDprocCPU5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 7028, PropCategory.REGULAR)
