...
class Mem1w(Mo):
    """
    A class that represents the most current statistics for memory in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.Mem1w", "memory")
    ...
    meta.moClassName = "procMem1w"
    meta.rnFormat = "CDprocMem1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current memory stats in 1 week"
