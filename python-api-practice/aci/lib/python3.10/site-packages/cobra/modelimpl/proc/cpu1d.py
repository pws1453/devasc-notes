...
class CPU1d(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU1d", "CPU utilization")
    ...
    meta.moClassName = "procCPU1d"
    meta.rnFormat = "CDprocCPU1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 1 day"
