...
# ##################################################
class SysCPU15min(Mo):
    """
    A class that represents the most current statistics for  System cpu in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPU15min", "System cpu")
    ...
    meta.moClassName = "procSysCPU15min"
    meta.rnFormat = "CDprocSysCPU15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System cpu stats in 15 minute"
