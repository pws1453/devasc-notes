...
# ##################################################
class SysMem15min(Mo):
    """
    A class that represents the most current statistics for  System memory in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMem15min", "System memory")
    ...
    meta.moClassName = "procSysMem15min"
    meta.rnFormat = "CDprocSysMem15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System memory stats in 15 minute"
