...
# ##################################################
class ProcMemHist1h(Mo):
    """
    A class that represents historical statistics for  Process memory in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMemHist1h", "Process memory")
    ...
    meta.moClassName = "procProcMemHist1h"
    meta.rnFormat = "HDprocProcMem1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Process memory stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 7048, PropCategory.REGULAR)
