...
class CPU1year(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU1year", "CPU utilization")
    ...
    meta.moClassName = "procCPU1year"
    meta.rnFormat = "CDprocCPU1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 1 year"
