...
# ##################################################
class ProcMemHist1mo(Mo):
    """
    A class that represents historical statistics for  Process memory in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMemHist1mo", "Process memory")
    ...
    meta.moClassName = "procProcMemHist1mo"
    meta.rnFormat = "HDprocProcMem1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Process memory stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 7049, PropCategory.REGULAR)
