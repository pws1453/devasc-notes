...
# ##################################################
class SysCPUHist1mo(Mo):
    """
    A class that represents historical statistics for  System cpu in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPUHist1mo", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist1mo"
    meta.rnFormat = "HDprocSysCPU1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 7059, PropCategory.REGULAR)
