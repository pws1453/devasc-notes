...
# ##################################################
class ProcMemHist1year(Mo):
    """
    A class that represents historical statistics for  Process memory in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMemHist1year", "Process memory")
    ...
    meta.moClassName = "procProcMemHist1year"
    meta.rnFormat = "HDprocProcMem1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Process memory stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 7052, PropCategory.REGULAR)
