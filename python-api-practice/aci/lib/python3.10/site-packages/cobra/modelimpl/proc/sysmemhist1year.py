...
# ##################################################
class SysMemHist1year(Mo):
    """
    A class that represents historical statistics for  System memory in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist1year", "System memory")
    ...
    meta.moClassName = "procSysMemHist1year"
    meta.rnFormat = "HDprocSysMem1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 7078, PropCategory.REGULAR)
