...
# ##################################################
class ApplicationCPU1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPU1w", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPU1w"
    meta.rnFormat = "CDprocApplicationCPU1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Application CPU utilization stats in 1 week"
