...
class MemHist1h(Mo):
    """
    A class that represents historical statistics for memory in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.MemHist1h", "memory")
    ...
    meta.moClassName = "procMemHist1h"
    meta.rnFormat = "HDprocMem1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical memory stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 7032, PropCategory.REGULAR)
