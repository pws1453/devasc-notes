...
# ##################################################
class SysCPU1year(Mo):
    """
    A class that represents the most current statistics for  System cpu in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPU1year", "System cpu")
    ...
    meta.moClassName = "procSysCPU1year"
    meta.rnFormat = "CDprocSysCPU1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System cpu stats in 1 year"
