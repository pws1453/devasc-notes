...
class SysMem1h(Mo):
    """
    A class that represents the most current statistics for  System memory in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMem1h", "System memory")
    ...
    meta.moClassName = "procSysMem1h"
    meta.rnFormat = "CDprocSysMem1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System memory stats in 1 hour"
