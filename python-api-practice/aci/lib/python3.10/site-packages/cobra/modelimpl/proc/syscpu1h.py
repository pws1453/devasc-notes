...
class SysCPU1h(Mo):
    """
    A class that represents the most current statistics for  System cpu in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPU1h", "System cpu")
    ...
    meta.moClassName = "procSysCPU1h"
    meta.rnFormat = "CDprocSysCPU1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System cpu stats in 1 hour"
