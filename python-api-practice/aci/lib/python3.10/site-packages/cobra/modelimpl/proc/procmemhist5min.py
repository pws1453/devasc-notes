...
# ##################################################
class ProcMemHist5min(Mo):
    """
    A class that represents historical statistics for  Process memory in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMemHist5min", "Process memory")
    ...
    meta.moClassName = "procProcMemHist5min"
    meta.rnFormat = "HDprocProcMem5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Process memory stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 7053, PropCategory.REGULAR)
