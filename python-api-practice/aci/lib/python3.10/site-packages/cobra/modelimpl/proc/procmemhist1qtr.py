...
# ##################################################
class ProcMemHist1qtr(Mo):
    """
    A class that represents historical statistics for  Process memory in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.ProcMemHist1qtr", "Process memory")
    ...
    meta.moClassName = "procProcMemHist1qtr"
    meta.rnFormat = "HDprocProcMem1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Process memory stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 7050, PropCategory.REGULAR)
