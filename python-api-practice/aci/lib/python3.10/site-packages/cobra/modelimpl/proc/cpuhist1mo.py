...
class CPUHist1mo(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist1mo", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist1mo"
    meta.rnFormat = "HDprocCPU1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 7024, PropCategory.REGULAR)
