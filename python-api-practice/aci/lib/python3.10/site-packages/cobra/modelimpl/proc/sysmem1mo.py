...
class SysMem1mo(Mo):
    """
    A class that represents the most current statistics for  System memory in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMem1mo", "System memory")
    ...
    meta.moClassName = "procSysMem1mo"
    meta.rnFormat = "CDprocSysMem1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System memory stats in 1 month"
