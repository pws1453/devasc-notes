...
# ##################################################
class MemHist1year(Mo):
    """
    A class that represents historical statistics for memory in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.MemHist1year", "memory")
    ...
    meta.moClassName = "procMemHist1year"
    meta.rnFormat = "HDprocMem1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical memory stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 7036, PropCategory.REGULAR)
