...
# ##################################################
class ApplicationCPU5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.proc.ApplicationCPU5min", "Application CPU utilization")
    ...
    meta.moClassName = "procApplicationCPU5min"
    meta.rnFormat = "CDprocApplicationCPU5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Application CPU utilization stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDprocApplicationCPU5min', False),
    ]
