...
class MemHist1w(Mo):
    """
    A class that represents historical statistics for memory in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.MemHist1w", "memory")
    ...
    meta.moClassName = "procMemHist1w"
    meta.rnFormat = "HDprocMem1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical memory stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 7035, PropCategory.REGULAR)
