...
class CPUHist1h(Mo):
    """
    A class that represents historical statistics for CPU utilization in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.proc.CPUHist1h", "CPU utilization")
    ...
    meta.moClassName = "procCPUHist1h"
    meta.rnFormat = "HDprocCPU1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical CPU utilization stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 7023, PropCategory.REGULAR)
