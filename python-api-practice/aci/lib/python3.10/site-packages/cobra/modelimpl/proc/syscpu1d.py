...
class SysCPU1d(Mo):
    """
    A class that represents the most current statistics for  System cpu in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.proc.SysCPU1d", "System cpu")
    ...
    meta.moClassName = "procSysCPU1d"
    meta.rnFormat = "CDprocSysCPU1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current System cpu stats in 1 day"
