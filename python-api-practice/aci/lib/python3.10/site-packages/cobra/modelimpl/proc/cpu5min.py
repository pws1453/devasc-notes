...
class CPU5min(Mo):
    """
    A class that represents the most current statistics for CPU utilization in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.proc.CPU5min", "CPU utilization")
    ...
    meta.moClassName = "procCPU5min"
    meta.rnFormat = "CDprocCPU5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current CPU utilization stats in 5 minute"
