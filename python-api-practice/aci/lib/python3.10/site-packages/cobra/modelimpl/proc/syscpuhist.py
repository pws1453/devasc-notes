...
# ##################################################
class SysCPUHist(Mo):
    meta = StatsClassMeta("cobra.model.proc.SysCPUHist", "System cpu")
    ...
    meta.moClassName = "procSysCPUHist"


    meta.moClassName = "procSysCPUHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System cpu stats"
    ...
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist15min")
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist1h")
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist1year")
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist1d")
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist1mo")
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist1w")
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist5min")
    meta.concreteSubClasses.add("cobra.model.proc.SysCPUHist1qtr")
    ...
    prop = PropMeta("str", "idleAverage1mAvg", "idleAverage1mAvg", 21909, PropCategory.IMPLICIT_AVG)
    prop.label = "1 minute idle CPU average average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleAverage1mAvg", prop)

    prop = PropMeta("str", "idleAverage1mMax", "idleAverage1mMax", 21908, PropCategory.IMPLICIT_MAX)
    prop.label = "1 minute idle CPU average maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleAverage1mMax", prop)

    prop = PropMeta("str", "idleAverage1mMin", "idleAverage1mMin", 21907, PropCategory.IMPLICIT_MIN)
    prop.label = "1 minute idle CPU average minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleAverage1mMin", prop)

    prop = PropMeta("str", "idleAverage1mSpct", "idleAverage1mSpct", 21910, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "1 minute idle CPU average suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleAverage1mSpct", prop)

    prop = PropMeta("str", "idleAverage1mThr", "idleAverage1mThr", 21911, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "idleAverage1mTr", "idleAverage1mTr", 21912, PropCategory.IMPLICIT_TREND)
    prop.label = "1 minute idle CPU average trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleAverage1mTr", prop)

    prop = PropMeta("str", "idleAvg", "idleAvg", 10665, PropCategory.IMPLICIT_AVG)
    prop.label = "idle CPU average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleAvg", prop)

    prop = PropMeta("str", "idleMax", "idleMax", 10664, PropCategory.IMPLICIT_MAX)
    prop.label = "idle CPU maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleMax", prop)

    prop = PropMeta("str", "idleMin", "idleMin", 10663, PropCategory.IMPLICIT_MIN)
    prop.label = "idle CPU minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleMin", prop)

    prop = PropMeta("str", "idleSpct", "idleSpct", 10666, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "idle CPU suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("idleSpct", prop)

    prop = PropMeta("str", "idleThr", "idleThr", 10667, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "idleTr", "idleTr", 10668, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "kernelAverage1mAvg", "kernelAverage1mAvg", 21924, PropCategory.IMPLICIT_AVG)
    prop.label = "1 minute kernel CPU average average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelAverage1mAvg", prop)

    prop = PropMeta("str", "kernelAverage1mMax", "kernelAverage1mMax", 21923, PropCategory.IMPLICIT_MAX)
    prop.label = "1 minute kernel CPU average maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelAverage1mMax", prop)

    prop = PropMeta("str", "kernelAverage1mMin", "kernelAverage1mMin", 21922, PropCategory.IMPLICIT_MIN)
    prop.label = "1 minute kernel CPU average minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelAverage1mMin", prop)

    prop = PropMeta("str", "kernelAverage1mSpct", "kernelAverage1mSpct", 21925, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "1 minute kernel CPU average suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelAverage1mSpct", prop)

    prop = PropMeta("str", "kernelAverage1mThr", "kernelAverage1mThr", 21926, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "kernelAverage1mTr", "kernelAverage1mTr", 21927, PropCategory.IMPLICIT_TREND)
    prop.label = "1 minute kernel CPU average trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelAverage1mTr", prop)

    prop = PropMeta("str", "kernelAvg", "kernelAvg", 10686, PropCategory.IMPLICIT_AVG)
    prop.label = "kernel CPU average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelAvg", prop)

    prop = PropMeta("str", "kernelMax", "kernelMax", 10685, PropCategory.IMPLICIT_MAX)
    prop.label = "kernel CPU maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelMax", prop)

    prop = PropMeta("str", "kernelMin", "kernelMin", 10684, PropCategory.IMPLICIT_MIN)
    prop.label = "kernel CPU minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelMin", prop)

    prop = PropMeta("str", "kernelSpct", "kernelSpct", 10687, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "kernel CPU suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("kernelSpct", prop)

    prop = PropMeta("str", "kernelThr", "kernelThr", 10688, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "kernelTr", "kernelTr", 10689, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "userAverage1mAvg", "userAverage1mAvg", 21939, PropCategory.IMPLICIT_AVG)
    prop.label = "1 minute user CPU average average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userAverage1mAvg", prop)

    prop = PropMeta("str", "userAverage1mMax", "userAverage1mMax", 21938, PropCategory.IMPLICIT_MAX)
    prop.label = "1 minute user CPU average maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userAverage1mMax", prop)

    prop = PropMeta("str", "userAverage1mMin", "userAverage1mMin", 21937, PropCategory.IMPLICIT_MIN)
    prop.label = "1 minute user CPU average minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userAverage1mMin", prop)

    prop = PropMeta("str", "userAverage1mSpct", "userAverage1mSpct", 21940, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "1 minute user CPU average suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userAverage1mSpct", prop)

    prop = PropMeta("str", "userAverage1mThr", "userAverage1mThr", 21941, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "userAverage1mTr", "userAverage1mTr", 21942, PropCategory.IMPLICIT_TREND)
    prop.label = "1 minute user CPU average trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userAverage1mTr", prop)

    prop = PropMeta("str", "userAvg", "userAvg", 10707, PropCategory.IMPLICIT_AVG)
    prop.label = "user CPU average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userAvg", prop)

    prop = PropMeta("str", "userMax", "userMax", 10706, PropCategory.IMPLICIT_MAX)
    prop.label = "user CPU maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userMax", prop)

    prop = PropMeta("str", "userMin", "userMin", 10705, PropCategory.IMPLICIT_MIN)
    prop.label = "user CPU minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userMin", prop)

    prop = PropMeta("str", "userSpct", "userSpct", 10708, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "user CPU suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("userSpct", prop)

    prop = PropMeta("str", "userThr", "userThr", 10709, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "userTr", "userTr", 10710, PropCategory.IMPLICIT_TREND)
