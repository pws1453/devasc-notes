...
# ##################################################
class SysMemHist1w(Mo):
    """
    A class that represents historical statistics for  System memory in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.proc.SysMemHist1w", "System memory")
    ...
    meta.moClassName = "procSysMemHist1w"
    meta.rnFormat = "HDprocSysMem1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical System memory stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 7077, PropCategory.REGULAR)
