...
class Nexthop(Mo):
    ...
    meta = ClassMeta("cobra.model.ipv4.Nexthop")

    meta.moClassName = "ipv4Nexthop"
    ...
    prop = PropMeta("str", "ipv4CfgFailedBmp", "ipv4CfgFailedBmp", 17734, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("ipv4:NexthopLogicalDn_failed_flag", None, 8)
    prop._addConstant("ipv4:Nexthopctrl_failed_flag", None, 64)
    prop._addConstant("ipv4:Nexthopdescr_failed_flag", None, 4)
    prop._addConstant("ipv4:NexthoplcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("ipv4:NexthopmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("ipv4:NexthopmonPolDn_failed_flag", None, 524288)
    prop._addConstant("ipv4:NexthopnameAlias_failed_flag", None, 2)
    prop._addConstant("ipv4:Nexthopname_failed_flag", None, 1)
    prop._addConstant("ipv4:NexthopnhAddr_failed_flag", None, 256)
    prop._addConstant("ipv4:NexthopnhIf_failed_flag", None, 512)
    prop._addConstant("ipv4:NexthopnhVrf_failed_flag", None, 1024)
    prop._addConstant("ipv4:Nexthoppref_failed_flag", None, 8192)
    prop._addConstant("ipv4:NexthoprwEncap_failed_flag", None, 16384)
    prop._addConstant("ipv4:NexthoptrackId_failed_flag", None, 32768)
    meta.props.add("ipv4CfgFailedBmp", prop)

    prop = PropMeta("str", "ipv4CfgFailedTs", "ipv4CfgFailedTs", 17736, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("ipv4CfgFailedTs", prop)

    prop = PropMeta("str", "ipv4CfgState", "ipv4CfgState", 17735, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14578, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhAddr", "nhAddr", 6680, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhIf", "nhIf", 6681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhVrf", "nhVrf", 6682, PropCategory.REGULAR)
