...
class Entity(Mo):
    """
    A container for IPV4 control plane entity information.

    """

    meta = ClassMeta("cobra.model.ipv4.Entity")

    meta.moClassName = "ipv4Entity"
    meta.rnFormat = "ipv4"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv4 Entity"
    ...
    meta.childClasses.add("cobra.model.ipv4.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ipv4.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14579, PropCategory.REGULAR)
