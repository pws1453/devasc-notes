...
class Inst(Mo):
    """
    A container for IPV4 instance information.

    """

    meta = ClassMeta("cobra.model.ipv4.Inst")

    meta.moClassName = "ipv4Inst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv4 Instance"
    ...
    meta.childClasses.add("cobra.model.ipv4.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ipv4.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14580, PropCategory.REGULAR)
