...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.Inst")

    meta.moClassName = "stsInst"
    meta.rnFormat = "inst"
    ...
    meta.childClasses.add("cobra.model.sts.Chain")
    meta.childClasses.add("cobra.model.sts.Node")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.Chain", "chain-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.Node", "node-"))

    meta.parentClasses.add("cobra.model.sts.Entity")
