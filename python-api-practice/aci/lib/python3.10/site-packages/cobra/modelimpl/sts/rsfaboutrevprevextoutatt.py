...
# ##################################################
class RsFabOutRevPrevExtOutAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.sts.RsFabOutRevPrevExtOutAtt", "cobra.model.sts.ExtOut")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "stsRsFabOutRevPrevExtOutAtt"
    meta.rnFormat = "rsfabOutRevPrevExtOutAtt"
    ...
    meta.parentClasses.add("cobra.model.sts.FabOutRev")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsfabOutRevPrevExtOutAtt', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12603, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2298
    prop.defaultValueStr = "stsExtOut"
    prop._addConstant("stsExtOut", None, 2298)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12602, PropCategory.REGULAR)
