...
# ##################################################
class RtFabOutRevPrevExtOutAtt(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.sts.RtFabOutRevPrevExtOutAtt", "cobra.model.sts.AFabOutRev")

    meta.moClassName = "stsRtFabOutRevPrevExtOutAtt"
    meta.rnFormat = "rtfabOutRevPrevExtOutAtt"
    ...
    meta.rnPrefixes = [
        ('rtfabOutRevPrevExtOutAtt', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12604, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2312
    prop.defaultValueStr = "stsAFabOutRev"
