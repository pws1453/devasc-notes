...
# ##################################################
class RsFabInExtInAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.sts.RsFabInExtInAtt", "cobra.model.sts.ExtIn")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "stsRsFabInExtInAtt"
    meta.rnFormat = "rsfabInExtInAtt"
    ...
    meta.parentClasses.add("cobra.model.sts.FabIn")
    meta.parentClasses.add("cobra.model.sts.FabInRevDef")
    meta.parentClasses.add("cobra.model.sts.FabInDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsfabInExtInAtt', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12583, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12582, PropCategory.REGULAR)
