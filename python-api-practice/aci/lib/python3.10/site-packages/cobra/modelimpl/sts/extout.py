...
class ExtOut(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.ExtOut")

    meta.moClassName = "stsExtOut"
    meta.rnFormat = "extout-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "External Output"
    ...
    meta.childClasses.add("cobra.model.sts.RtFabOutRevPrevExtOutAtt")
    meta.childClasses.add("cobra.model.sts.RtFabInRevExtOutAtt")
    meta.childClasses.add("cobra.model.sts.RsExtOutFabOutAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RtFabOutRevPrevExtOutAtt", "rtfabOutRevPrevExtOutAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RtFabInRevExtOutAtt", "rtfabInRevExtOutAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RsExtOutFabOutAtt", "rsextOutFabOutAtt-"))

    meta.parentClasses.add("cobra.model.sts.VNode")
    meta.parentClasses.add("cobra.model.vns.StsVNode")

    meta.superClasses.add("cobra.model.sts.ExtOutBase")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.sts.AExtOut")
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 15223, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "encap", "encap", 7211, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "ip", "ip", 1988, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "vrf", "vrf", 1986, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "vrfEncap", "vrfEncap", 1987, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
