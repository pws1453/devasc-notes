...
class FabOutRev(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.FabOutRev")

    meta.moClassName = "stsFabOutRev"
    meta.rnFormat = "faboutrev-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Reverse Fabric Output"
    ...
    meta.childClasses.add("cobra.model.sts.RsFabOutRevPrevExtOutAtt")
    meta.childClasses.add("cobra.model.sts.RtExtInFabOutRevAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RsFabOutRevPrevExtOutAtt", "rsfabOutRevPrevExtOutAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RtExtInFabOutRevAtt", "rtextInFabOutRevAtt"))
    ...
    meta.superClasses.add("cobra.model.sts.AFabOutRev")
    ...
    prop = PropMeta("str", "encap", "encap", 7219, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
