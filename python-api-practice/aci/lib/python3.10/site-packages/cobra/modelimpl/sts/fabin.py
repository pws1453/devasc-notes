...
class FabIn(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.FabIn")

    meta.moClassName = "stsFabIn"
    meta.rnFormat = "fabin-[%(encap)s]"
    ...
    meta.childClasses.add("cobra.model.sts.RsFabInExtInAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RsFabInExtInAtt", "rsfabInExtInAtt"))
    ...
    meta.superClasses.add("cobra.model.sts.AFabIn")
    meta.superClasses.add("cobra.model.sts.FabInBase")
    ...
    prop = PropMeta("str", "encap", "encap", 7213, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
