...
class FabOutDef(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.FabOutDef")

    meta.moClassName = "stsFabOutDef"
    meta.rnFormat = "faboutdef-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 7218, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
