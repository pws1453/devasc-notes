...
# ##################################################
class RsExtInFabOutRevAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.sts.RsExtInFabOutRevAtt", "cobra.model.sts.FabOutRev")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "stsRsExtInFabOutRevAtt"
    meta.rnFormat = "rsextInFabOutRevAtt"
    ...
    meta.parentClasses.add("cobra.model.sts.ExtInDef")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12590, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2315
    prop.defaultValueStr = "stsFabOutRev"
    prop._addConstant("stsFabOutRev", None, 2315)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12589, PropCategory.REGULAR)
