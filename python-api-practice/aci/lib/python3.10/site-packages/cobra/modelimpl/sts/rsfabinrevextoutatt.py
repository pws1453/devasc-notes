...
# ##################################################
class RsFabInRevExtOutAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.sts.RsFabInRevExtOutAtt", "cobra.model.sts.ExtOut")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "stsRsFabInRevExtOutAtt"
    meta.rnFormat = "rsfabInRevExtOutAtt"
    ...
    meta.parentClasses.add("cobra.model.sts.FabInRev")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsfabInRevExtOutAtt', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12586, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12585, PropCategory.REGULAR)
