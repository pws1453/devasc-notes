...
# ##################################################
class RtExtInFabOutRevAtt(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.sts.RtExtInFabOutRevAtt", "cobra.model.sts.AExtIn")

    meta.moClassName = "stsRtExtInFabOutRevAtt"
    meta.rnFormat = "rtextInFabOutRevAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12591, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2287
    prop.defaultValueStr = "stsAExtIn"
