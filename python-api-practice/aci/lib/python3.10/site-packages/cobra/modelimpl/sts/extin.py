...
class ExtIn(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.ExtIn")

    meta.moClassName = "stsExtIn"
    meta.rnFormat = "extin-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "External Input"
    ...
    meta.childClasses.add("cobra.model.sts.RtFabInExtInAtt")
    meta.childClasses.add("cobra.model.sts.RtFabOutNxtExtInAtt")
    meta.childClasses.add("cobra.model.sts.RsExtInFabOutRevAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RtFabOutNxtExtInAtt", "rtfabOutNxtExtInAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RsExtInFabOutRevAtt", "rsextInFabOutRevAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RtFabInExtInAtt", "rtfabInExtInAtt"))

    meta.parentClasses.add("cobra.model.sts.VNode")
    meta.parentClasses.add("cobra.model.vns.StsVNode")

    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.sts.AExtIn")
    meta.superClasses.add("cobra.model.sts.ExtInBase")
    ...
    prop = PropMeta("str", "encap", "encap", 7209, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "ip", "ip", 1982, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "vrf", "vrf", 1980, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "vrfEncap", "vrfEncap", 1981, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
