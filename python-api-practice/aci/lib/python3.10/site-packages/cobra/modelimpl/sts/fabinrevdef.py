...
# ##################################################
class FabInRevDef(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.sts.FabInRevDef")

    meta.moClassName = "stsFabInRevDef"
    meta.rnFormat = "fabinrevdef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Reverse Fabric Input"
    ...
    prop = PropMeta("str", "name", "name", 7216, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
