...
class Tap(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.Tap")

    meta.moClassName = "stsTap"
    meta.rnFormat = "tap-[%(port)s]-[%(encap)s]"
    ...
    prop = PropMeta("str", "encap", "encap", 2003, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "port", "port", 2002, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    getattr(meta.props, "port").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, port, encap, markDirty=True, **creationProps):
        namingVals = [port, encap]
