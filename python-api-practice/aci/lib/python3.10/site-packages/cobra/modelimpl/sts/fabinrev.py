...
class FabInRev(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.FabInRev")

    meta.moClassName = "stsFabInRev"
    meta.rnFormat = "fabinrev-[%(encap)s]"
    ...
    meta.childClasses.add("cobra.model.sts.RsFabInRevExtOutAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RsFabInRevExtOutAtt", "rsfabInRevExtOutAtt"))
    ...
    meta.superClasses.add("cobra.model.sts.AFabInRev")
    ...
    prop = PropMeta("str", "encap", "encap", 7215, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
