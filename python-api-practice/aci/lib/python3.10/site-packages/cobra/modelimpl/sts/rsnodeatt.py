...
class RsNodeAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.sts.RsNodeAtt", "cobra.model.sts.Node")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "stsRsNodeAtt"
    meta.rnFormat = "rsnodeAtt"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15037, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12596, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2300
    prop.defaultValueStr = "stsNode"
    prop._addConstant("stsNode", None, 2300)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12595, PropCategory.REGULAR)
