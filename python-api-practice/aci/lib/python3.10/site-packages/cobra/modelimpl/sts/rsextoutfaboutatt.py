...
# ##################################################
class RsExtOutFabOutAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.sts.RsExtOutFabOutAtt", "cobra.model.sts.FabOut")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "stsRsExtOutFabOutAtt"
    meta.rnFormat = "rsextOutFabOutAtt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.sts.ExtOutDef")
    meta.parentClasses.add("cobra.model.sts.ExtOut")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsextOutFabOutAtt-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12593, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2310
    prop.defaultValueStr = "stsFabOut"
    prop._addConstant("stsFabOut", None, 2310)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12592, PropCategory.REGULAR)
