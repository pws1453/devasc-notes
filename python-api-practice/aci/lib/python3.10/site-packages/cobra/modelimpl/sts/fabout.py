...
class FabOut(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.FabOut")

    meta.moClassName = "stsFabOut"
    meta.rnFormat = "fabout-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric Output"
    ...
    meta.childClasses.add("cobra.model.sts.Tap")
    meta.childClasses.add("cobra.model.sts.RtExtOutFabOutAtt")
    meta.childClasses.add("cobra.model.sts.RsFabOutNxtExtInAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RsFabOutNxtExtInAtt", "rsfabOutNxtExtInAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.RtExtOutFabOutAtt", "rtextOutFabOutAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sts.Tap", "tap-"))

    meta.parentClasses.add("cobra.model.sts.VNode")
    meta.parentClasses.add("cobra.model.vns.StsVNode")

    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.sts.AFabOut")
    meta.superClasses.add("cobra.model.sts.FabOutBase")
    meta.superClasses.add("cobra.model.sts.Path")
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 2006, PropCategory.REGULAR)
    prop.label = "Path Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("epg-reclassify", "epg-reclassification", 2)
    prop._addConstant("svc-rt", "service-routing", 256)
    prop._addConstant("terminal", "terminal-stage", 1)
    ...
    prop = PropMeta("str", "encap", "encap", 7217, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "id", "id", 2005, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ip", "ip", 2011, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "order", "order", 2008, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16)]
    ...
    prop = PropMeta("str", "sPcTag", "sPcTag", 2007, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "vrf", "vrf", 2009, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "vrfEncap", "vrfEncap", 2010, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
