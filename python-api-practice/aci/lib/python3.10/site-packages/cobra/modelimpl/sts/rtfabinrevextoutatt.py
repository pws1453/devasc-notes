...
# ##################################################
class RtFabInRevExtOutAtt(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.sts.RtFabInRevExtOutAtt", "cobra.model.sts.AFabInRev")

    meta.moClassName = "stsRtFabInRevExtOutAtt"
    meta.rnFormat = "rtfabInRevExtOutAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12588, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2281
    prop.defaultValueStr = "stsAFabInRev"
    prop._addConstant("stsAFabInRev", None, 2281)
    prop._addConstant("stsFabInRev", None, 2284)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12587, PropCategory.REGULAR)
