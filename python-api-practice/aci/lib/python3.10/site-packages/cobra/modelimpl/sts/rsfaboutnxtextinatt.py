...
# ##################################################
class RsFabOutNxtExtInAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.sts.RsFabOutNxtExtInAtt", "cobra.model.sts.ExtIn")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "stsRsFabOutNxtExtInAtt"
    meta.rnFormat = "rsfabOutNxtExtInAtt"
    ...
    meta.parentClasses.add("cobra.model.sts.FabOutDef")
    meta.parentClasses.add("cobra.model.sts.FabOutRevDef")
    meta.parentClasses.add("cobra.model.sts.FabOut")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsfabOutNxtExtInAtt', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12600, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2290
    prop.defaultValueStr = "stsExtIn"
    prop._addConstant("stsExtIn", None, 2290)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12599, PropCategory.REGULAR)
