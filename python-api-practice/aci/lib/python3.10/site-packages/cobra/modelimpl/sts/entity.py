...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.Entity")

    meta.moClassName = "stsEntity"
    meta.rnFormat = "sts"
    ...
    meta.childClasses.add("cobra.model.sts.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.sts.Inst", "inst"))
