...
# ##################################################
class RtExtOutFabOutAtt(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.sts.RtExtOutFabOutAtt", "cobra.model.sts.AExtOut")

    meta.moClassName = "stsRtExtOutFabOutAtt"
    meta.rnFormat = "rtextOutFabOutAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12594, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2295
    prop.defaultValueStr = "stsAExtOut"
