...
# ##################################################
class FabOutRevDef(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.sts.FabOutRevDef")

    meta.moClassName = "stsFabOutRevDef"
    meta.rnFormat = "faboutrevdef-%(name)s"
    ...
    meta.parentClasses.add("cobra.model.vns.VNodeDef")
    ...
    prop = PropMeta("str", "encap", "encap", 2004, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 7220, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
