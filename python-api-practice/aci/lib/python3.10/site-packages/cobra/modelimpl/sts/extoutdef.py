...
class ExtOutDef(Mo):
    ...
    meta = ClassMeta("cobra.model.sts.ExtOutDef")

    meta.moClassName = "stsExtOutDef"
    meta.rnFormat = "extoutdef-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 7212, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
