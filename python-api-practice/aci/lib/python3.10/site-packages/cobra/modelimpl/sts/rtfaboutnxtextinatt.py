...
# ##################################################
class RtFabOutNxtExtInAtt(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.sts.RtFabOutNxtExtInAtt", "cobra.model.sts.AFabOut")

    meta.moClassName = "stsRtFabOutNxtExtInAtt"
    meta.rnFormat = "rtfabOutNxtExtInAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12601, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2307
    prop.defaultValueStr = "stsAFabOut"
