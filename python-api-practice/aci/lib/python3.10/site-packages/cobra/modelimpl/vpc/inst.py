...
class Inst(Mo):
    """
    The vPC instance information. There is only one instance of vpc running in the system today.

    """

    meta = ClassMeta("cobra.model.vpc.Inst")

    meta.moClassName = "vpcInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "VPC Instance"
    ...
    meta.childClasses.add("cobra.model.vpc.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vpc.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14547, PropCategory.REGULAR)
