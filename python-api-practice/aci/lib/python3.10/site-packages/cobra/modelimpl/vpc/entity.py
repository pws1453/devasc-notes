...
class Entity(Mo):
    """
    The vPC control plane entity information.

    """

    meta = ClassMeta("cobra.model.vpc.Entity")

    meta.moClassName = "vpcEntity"
    meta.rnFormat = "vpc"
    meta.category = MoCategory.REGULAR
    meta.label = "VPC Entity"
    ...
    meta.childClasses.add("cobra.model.vpc.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vpc.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14546, PropCategory.REGULAR)
