...
class IfTask(Mo):
    """
    The information returned by or provided to the application or task.

    """

    meta = ClassMeta("cobra.model.vpc.IfTask")

    meta.moClassName = "vpcIfTask"
    meta.rnFormat = "vpcIfTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5671, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updatePathEp", "updatepathep", 1826)
    prop._addConstant("updateVpcProtLink", "updatevpcprotlink", 517)
