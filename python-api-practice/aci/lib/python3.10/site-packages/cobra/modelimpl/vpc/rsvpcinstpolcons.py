...
# ##################################################
class RsVpcInstPolCons(Mo):
    """
    A source relation to the node-level vPC domain policy.

    """

    meta = SourceRelationMeta("cobra.model.vpc.RsVpcInstPolCons", "cobra.model.vpc.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "vpcRsVpcInstPolCons"
    meta.rnFormat = "rsvpcInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Vpc Instance Policy Attachment"
    ...
    prop = PropMeta("str", "protGEp", "protGEp", 12744, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("protGEp", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12743, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12742, PropCategory.REGULAR)
