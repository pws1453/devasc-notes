...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.hcurib.Entity")

    meta.moClassName = "hcuribEntity"
    meta.rnFormat = "urib"
    meta.category = MoCategory.REGULAR
    meta.label = "Hybrid Cloud CSR URIB Entity"
    ...
    meta.childClasses.add("cobra.model.hcurib.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcurib.Inst", "inst"))
