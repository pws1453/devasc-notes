...
class Route(Mo):
    ...
    meta = ClassMeta("cobra.model.hcurib.Route")

    meta.moClassName = "hcuribRoute"
    meta.rnFormat = "route-[%(prefix)s]"
    ...
    meta.childClasses.add("cobra.model.hcurib.Nexthop")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcurib.Nexthop", "nh-"))

    meta.parentClasses.add("cobra.model.hcurib.RouteDb")

    meta.superClasses.add("cobra.model.hcurib.ARoute")
    ...
    prop = PropMeta("str", "prefix", "prefix", 55554, PropCategory.REGULAR)
    prop.label = "Route Prefix"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
