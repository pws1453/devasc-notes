...
class RouteDb(Mo):
    ...
    meta = ClassMeta("cobra.model.hcurib.RouteDb")

    meta.moClassName = "hcuribRouteDb"
    meta.rnFormat = "routeDb"
    meta.category = MoCategory.REGULAR
    meta.label = "Route Database"
    ...
    meta.childClasses.add("cobra.model.hcurib.Route")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcurib.Route", "route-"))

    meta.parentClasses.add("cobra.model.hcurib.Dom")
