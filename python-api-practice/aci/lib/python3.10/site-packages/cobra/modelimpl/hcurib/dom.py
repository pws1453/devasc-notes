...
class Dom(Mo):
    ...
    meta = ClassMeta("cobra.model.hcurib.Dom")

    meta.moClassName = "hcuribDom"
    ...
    meta.childClasses.add("cobra.model.hcurib.RouteDb")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcurib.RouteDb", "routeDb"))

    meta.parentClasses.add("cobra.model.hcurib.Inst")
    ...
    prop = PropMeta("str", "name", "name", 55550, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
