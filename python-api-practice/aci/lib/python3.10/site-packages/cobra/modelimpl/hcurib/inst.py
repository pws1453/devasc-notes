...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.hcurib.Inst")

    meta.moClassName = "hcuribInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Hybrid Cloud CSR URIB Instance"
    ...
    meta.childClasses.add("cobra.model.hcurib.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcurib.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.hcurib.Entity")
