...
# ##################################################
class SegAllocContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ident.SegAllocContTask")

    meta.moClassName = "identSegAllocContTask"
    meta.rnFormat = "identSegAllocContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23036, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BulkAllocSegments", "bulkallocsegments", 2024)
