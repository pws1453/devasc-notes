...
# ##################################################
class SegmentTask(Mo):
    """
    The identity segment task.

    """

    meta = ClassMeta("cobra.model.ident.SegmentTask")

    meta.moClassName = "identSegmentTask"
    meta.rnFormat = "identSegmentTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.ident.SegmentIpContext")
    meta.childClasses.add("cobra.model.ident.Segment64Context")
    meta.childClasses.add("cobra.model.ident.Segment16Context")
    meta.childClasses.add("cobra.model.ident.Segment32Context")

    meta.childNamesAndRnPrefix.append(("cobra.model.ident.SegmentIpContext", "identSegmentIp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ident.Segment64Context", "identSegment64"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ident.Segment16Context", "identSegment16"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ident.Segment32Context", "identSegment32"))
    ...
    prop = PropMeta("str", "id", "id", 5692, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateUni", "updateuni", 230)
    prop._addConstant("UsageAlert", "usagealert", 3075)
