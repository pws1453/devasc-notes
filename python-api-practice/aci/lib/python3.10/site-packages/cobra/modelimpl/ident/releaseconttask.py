...
# ##################################################
class ReleaseContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ident.ReleaseContTask")

    meta.moClassName = "identReleaseContTask"
    meta.rnFormat = "identReleaseContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21578, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReleaseIds", "releaseids", 1898)
