...
class SourceTask(Mo):
    """
    The identity source task.

    """

    meta = ClassMeta("cobra.model.ident.SourceTask")

    meta.moClassName = "identSourceTask"
    meta.rnFormat = "identSourceTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.ident.SourceContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.ident.SourceContext", "identSource"))
    ...
    prop = PropMeta("str", "id", "id", 5635, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Release", "release", 12)
