...
# ##################################################
class AllocContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ident.AllocContTask")

    meta.moClassName = "identAllocContTask"
    meta.rnFormat = "identAllocContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21577, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AllocateIds", "allocateids", 1897)
