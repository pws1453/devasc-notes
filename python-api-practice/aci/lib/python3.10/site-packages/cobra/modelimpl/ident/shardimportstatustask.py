...
# ##################################################
class ShardImportStatusTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ident.ShardImportStatusTask")

    meta.moClassName = "identShardImportStatusTask"
    meta.rnFormat = "identShardImportStatusTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('identShardImportStatusTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 23356, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("InformIdRecoveryDone", "informidrecoverydone", 2076)
    prop._addConstant("InformStartIdentAlloc", "informstartidentalloc", 2075)
    prop._addConstant("InformStartSegementAlloc", "informstartsegementalloc", 2074)
    prop._addConstant("InformStartSegementRelease", "informstartsegementrelease", 2073)
