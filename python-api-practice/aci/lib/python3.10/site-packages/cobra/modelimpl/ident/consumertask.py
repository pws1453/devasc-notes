...
class ConsumerTask(Mo):
    """
    The identity consumer task.

    """

    meta = ClassMeta("cobra.model.ident.ConsumerTask")

    meta.moClassName = "identConsumerTask"
    meta.rnFormat = "identConsumerTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5634, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Allocate", "allocate", 11)
