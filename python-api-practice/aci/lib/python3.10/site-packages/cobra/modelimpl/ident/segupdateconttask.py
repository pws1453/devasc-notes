...
# ##################################################
class SegUpdateContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ident.SegUpdateContTask")

    meta.moClassName = "identSegUpdateContTask"
    meta.rnFormat = "identSegUpdateContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 39386, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BulkUpdateSegments", "bulkupdatesegments", 3077)
