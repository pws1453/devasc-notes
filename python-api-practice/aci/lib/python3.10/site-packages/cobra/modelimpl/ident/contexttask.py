...
class ContextTask(Mo):
    """
    The identity context task.

    """

    meta = ClassMeta("cobra.model.ident.ContextTask")

    meta.moClassName = "identContextTask"
    meta.rnFormat = "identContextTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5657, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AllocateAck", "allocateack", 107)
