...
class SubjTask(Mo):
    ...
    meta = ClassMeta("cobra.model.ident.SubjTask")

    meta.moClassName = "identSubjTask"
    meta.rnFormat = "identSubjTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 27142, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SubjSync", "subjsync", 2442)
