...
# ##################################################
class SegReleaseContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ident.SegReleaseContTask")

    meta.moClassName = "identSegReleaseContTask"
    meta.rnFormat = "identSegReleaseContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23037, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BulkReleaseSegments", "bulkreleasesegments", 2023)
