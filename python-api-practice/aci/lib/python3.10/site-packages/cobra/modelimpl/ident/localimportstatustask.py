...
# ##################################################
class LocalImportStatusTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ident.LocalImportStatusTask")

    meta.moClassName = "identLocalImportStatusTask"
    meta.rnFormat = "identLocalImportStatusTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('identLocalImportStatusTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 23355, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportImportIdStatus", "reportimportidstatus", 2072)
