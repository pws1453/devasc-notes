...
# ##################################################
class ElementTask(Mo):
    """
    The identity element task.

    """

    meta = ClassMeta("cobra.model.ident.ElementTask")

    meta.moClassName = "identElementTask"
    meta.rnFormat = "identElementTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5658, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Unregister", "unregister", 108)
