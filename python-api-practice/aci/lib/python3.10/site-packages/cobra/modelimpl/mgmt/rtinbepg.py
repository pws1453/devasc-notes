...
class RtInbEpg(Mo):
    """
    A target relation to the in-band management endpoint group.

    """

    meta = TargetRelationMeta("cobra.model.mgmt.RtInbEpg", "cobra.model.mgmt.InBZone")

    meta.moClassName = "mgmtRtInbEpg"
    meta.rnFormat = "rtinbEpg"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "InB Managed Nodes Zone"
    meta.writeAccessMask = 0x4601
    meta.readAccessMask = 0x6000d10401047713
    ...
    prop = PropMeta("str", "tCl", "tCl", 12529, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2176
    prop.defaultValueStr = "mgmtInBZone"
