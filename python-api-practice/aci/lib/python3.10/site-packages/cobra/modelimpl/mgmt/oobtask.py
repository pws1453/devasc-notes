...
class OoBTask(Mo):
    """
    The out-of-bound task.

    """

    meta = ClassMeta("cobra.model.mgmt.OoBTask")

    meta.moClassName = "mgmtOoBTask"
    meta.rnFormat = "mgmtOoBTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5699, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("OobEpP", "oobepp", 627)
