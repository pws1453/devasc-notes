...
class InstPDef(Mo):
    """
    The instance profile definition.

    """

    meta = ClassMeta("cobra.model.mgmt.InstPDef")

    meta.moClassName = "mgmtInstPDef"
    ...
    meta.childClasses.add("cobra.model.mgmt.SubnetDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.SubnetDef", "subnet-"))
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 28692, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14350, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6928, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
