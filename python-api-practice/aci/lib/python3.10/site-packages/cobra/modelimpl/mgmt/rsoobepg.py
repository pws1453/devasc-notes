...
class RsOobEpg(Mo):
    """
    A source relation to an out-of-band management endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.mgmt.RsOobEpg", "cobra.model.mgmt.OoB")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "mgmtRsOobEpg"
    meta.rnFormat = "rsoobEpg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37688, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39827, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14342, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12525, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2191
    prop.defaultValueStr = "mgmtOoB"
    prop._addConstant("mgmtOoB", None, 2191)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12524, PropCategory.REGULAR)
