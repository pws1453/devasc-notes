...
class RsInB(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.mgmt.RsInB", "cobra.model.mgmt.InB")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mgmtRsInB"
    meta.rnFormat = "rsinB"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38357, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40496, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22677, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22676, PropCategory.REGULAR)
