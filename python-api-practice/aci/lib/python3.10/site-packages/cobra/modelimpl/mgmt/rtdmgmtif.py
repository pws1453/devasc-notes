...
class RtdMgmtIf(Mo):
    ...
    meta = ClassMeta("cobra.model.mgmt.RtdMgmtIf")

    meta.moClassName = "mgmtRtdMgmtIf"
    meta.rnFormat = "mgmt-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Routed Management Interface"
    meta.writeAccessMask = 0x400401002001
    meta.readAccessMask = 0x8428425162001
    ...
    meta.childClasses.add("cobra.model.mgmt.RsRtdMgmtConf")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.RsRtdMgmtConf", "rsrtdMgmtConf"))
    ...
    prop = PropMeta("str", "id", "id", 6934, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14572, PropCategory.REGULAR)
