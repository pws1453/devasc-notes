...
class Subnet(Mo):
    ...
    meta = ClassMeta("cobra.model.mgmt.Subnet")

    meta.moClassName = "mgmtSubnet"
    meta.rnFormat = "subnet-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "External Subnet"
    ...
    meta.superClasses.add("cobra.model.mgmt.AInstPSubnet")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37696, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39835, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 6935, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
