...
class RtToInbEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.mgmt.RtToInbEpg", "cobra.model.telemetry.VipP")

    meta.moClassName = "mgmtRtToInbEpg"
    meta.rnFormat = "rtToInbEpg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 35711, PropCategory.REGULAR)
