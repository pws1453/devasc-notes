...
class RsToNodeGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.mgmt.RsToNodeGrp", "cobra.model.mgmt.NodeGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "mgmtRsToNodeGrp"
    ...
    meta.readAccessMask = 0x980000000001
    ...
    prop = PropMeta("str", "annotation", "annotation", 38258, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40397, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20900, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2179
    prop.defaultValueStr = "mgmtNodeGrp"
    prop._addConstant("mgmtNodeGrp", None, 2179)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20899, PropCategory.REGULAR)
