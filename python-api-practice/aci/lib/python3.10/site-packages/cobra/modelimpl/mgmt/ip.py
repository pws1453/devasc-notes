...
class Ip(Mo):
    ...
    meta = ClassMeta("cobra.model.mgmt.Ip")

    meta.moClassName = "mgmtIp"
    meta.rnFormat = "mip-[%(addr)s]"
    ...
    meta.superClasses.add("cobra.model.mgmt.AIp")

    meta.rnPrefixes = [
        ('mip-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 23549, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38413, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40552, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "gw", "gw", 23548, PropCategory.REGULAR)
