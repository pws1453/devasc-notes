...
class OoB(Mo):
    """
    An out-of-band management endpoint group, which consists of switches (leaves/spines) and APICs that are part of the associated   out-of-band management zone. Each node in the group is assigned an IP address that is dynamically allocated from the address pool   associated with the corresponding out-of-band management zone. The allocated IP address is then configured on the out-of-band management   port of the corresponding node. Hosts that are part of regular endpoint groups cannot communicate with the nodes in the out-of-band   management endpoint group. Any host that is part of a special group known as the instance profile can communicate with the nodes   in an out-of-band management endpoint group using special out-of-band contracts. Regular contracts cannot be used with this endpoint group.

    """

    meta = ClassMeta("cobra.model.mgmt.OoB")

    meta.moClassName = "mgmtOoB"
    meta.rnFormat = "oob-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Out-Of-Band Management EPg"
    meta.writeAccessMask = 0x4601
    meta.readAccessMask = 0x910000004603
    ...
    meta.childClasses.add("cobra.model.mgmt.RsOoBProv")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.mgmt.RtOobEpg")
    meta.childClasses.add("cobra.model.mgmt.RsOoBStNode")
    meta.childClasses.add("cobra.model.mgmt.RsOoBCtx")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.fv.RtProfileToEpg")
    meta.childClasses.add("cobra.model.mgmt.RtOoB")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.RsOoBStNode", "rsooBStNode-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.RsOoBProv", "rsooBProv-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.RtOobEpg", "rtoobEpg"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.RsOoBCtx", "rsooBCtx"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.ExtMngdInst", "extmngd"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.RtOoB", "rtooB-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39837, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14352, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6933, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
