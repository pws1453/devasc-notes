...
class InstPTask(Mo):
    """
    The instance profile task.

    """

    meta = ClassMeta("cobra.model.mgmt.InstPTask")

    meta.moClassName = "mgmtInstPTask"
    meta.rnFormat = "mgmtInstPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15528, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("InstPEpP", "instpepp", 1285)
