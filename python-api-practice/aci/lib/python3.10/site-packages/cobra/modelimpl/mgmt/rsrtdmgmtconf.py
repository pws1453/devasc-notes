...
# ##################################################
class RsRtdMgmtConf(Mo):
    """
    A source relation to the management interface.

    """

    meta = SourceRelationMeta("cobra.model.mgmt.RsRtdMgmtConf", "cobra.model.mgmt.MgmtIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "mgmtRsRtdMgmtConf"
    meta.rnFormat = "rsrtdMgmtConf"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15162, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12834, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12833, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15161, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
