...
# ##################################################
class RsOoBStNode(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.mgmt.RsOoBStNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "mgmtRsOoBStNode"
    meta.rnFormat = "rsooBStNode-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Out-of-band Static Node"
    ...
    meta.childClasses.add("cobra.model.mgmt.Ip")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.Ip", "mip-"))
    ...
    prop = PropMeta("str", "addr", "addr", 16530, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 38133, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 52322, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40272, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "gw", "gw", 16531, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 16529, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16528, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "v6Addr", "v6Addr", 24086, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("v6Addr", prop)

    prop = PropMeta("str", "v6Gw", "v6Gw", 24087, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("v6Gw", prop)
