...
class CollectionContTask(Mo):
    ...
    meta = ClassMeta("cobra.model.mgmt.CollectionContTask")

    meta.moClassName = "mgmtCollectionContTask"
    meta.rnFormat = "mgmtCollectionContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5697, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BringConsInfoIntoCtrct", "bringconsinfointoctrct", 629)
    prop._addConstant("BringProvInfoIntoCtrct", "bringprovinfointoctrct", 628)
