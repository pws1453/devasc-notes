...
# ##################################################
class RsInBStNode(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.mgmt.RsInBStNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "mgmtRsInBStNode"
    meta.rnFormat = "rsinBStNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 16536, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 38134, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 52323, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40273, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "gw", "gw", 16537, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 16535, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16534, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "v6Addr", "v6Addr", 24088, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("v6Addr", prop)

    prop = PropMeta("str", "v6Gw", "v6Gw", 24089, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
