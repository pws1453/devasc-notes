...
# ##################################################
class OoBZoneTask(Mo):
    """
    The out-of-band zone task.

    """

    meta = ClassMeta("cobra.model.mgmt.OoBZoneTask")

    meta.moClassName = "mgmtOoBZoneTask"
    meta.rnFormat = "mgmtOoBZoneTask-%(id)s"
    meta.category = MoCategory.TASK
    meta.label = "None"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x800000000001
    ...
    prop = PropMeta("str", "id", "id", 5700, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BringNodeInfoToOoBMgmtEppShard", "bringnodeinfotooobmgmteppshard", 626)
