...
class RsOoB(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.mgmt.RsOoB", "cobra.model.mgmt.OoB")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mgmtRsOoB"
    meta.rnFormat = "rsooB"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38356, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40495, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22680, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22672, PropCategory.REGULAR)
