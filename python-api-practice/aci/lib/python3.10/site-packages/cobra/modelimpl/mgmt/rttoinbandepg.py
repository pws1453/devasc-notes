...
# ##################################################
class RtToInbandEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.mgmt.RtToInbandEpg", "cobra.model.telemetry.FlowCollectorP")

    meta.moClassName = "mgmtRtToInbandEpg"
    meta.rnFormat = "rttoInbandEpg"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Flow Collector Policy"
    meta.writeAccessMask = 0x4601
    meta.readAccessMask = 0x6002f1040106f713
    ...
    prop = PropMeta("str", "tCl", "tCl", 41071, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11976
    prop.defaultValueStr = "telemetryFlowCollectorP"
