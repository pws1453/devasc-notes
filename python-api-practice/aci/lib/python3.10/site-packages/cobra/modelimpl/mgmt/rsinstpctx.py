...
class RsInstPCtx(Mo):
    """
    A source relation to the private layer 3 network context.

    """

    meta = NamedSourceRelationMeta("cobra.model.mgmt.RsInstPCtx", "cobra.model.fv.Ctx")
    meta.targetNameProps["name"] = "tnFvCtxName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mgmtRsInstPCtx"
    meta.rnFormat = "rsinstPCtx"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16237, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16234, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvCtxName", "tnFvCtxName", 16233, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
