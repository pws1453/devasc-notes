...
class RsOoBProv(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.mgmt.RsOoBProv", "cobra.model.vz.OOBBrCP")
    meta.targetNameProps["name"] = "tnVzOOBBrCPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "mgmtRsOoBProv"
    meta.rnFormat = "rsooBProv-%(tnVzOOBBrCPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Out-Of-Band Contract"
    meta.writeAccessMask = 0x4601
    meta.readAccessMask = 0x4601
    ...
    meta.childClasses.add("cobra.model.mgmt.CollectionCont")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.CollectionCont", "mgmtcollectionDn-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37699, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39838, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14353, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 12543, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12542, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1305
    prop.defaultValueStr = "vzOOBBrCP"
    prop._addConstant("unspecified", "unspecified", 0)
    ...
    prop = PropMeta("str", "tnVzOOBBrCPName", "tnVzOOBBrCPName", 12541, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVzOOBBrCPName", prop)

    prop = PropMeta("str", "triggerSt", "triggerSt", 12544, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.namingProps.append(getattr(meta.props, "tnVzOOBBrCPName"))
    ...
    def __init__(self, parentMoOrDn, tnVzOOBBrCPName, markDirty=True, **creationProps):
        namingVals = [tnVzOOBBrCPName]
