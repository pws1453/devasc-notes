...
class RsOoBCtx(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.mgmt.RsOoBCtx", "cobra.model.fv.Ctx")
    meta.targetNameProps["name"] = "tnFvCtxName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mgmtRsOoBCtx"
    meta.rnFormat = "rsooBCtx"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16224, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16221, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvCtxName", "tnFvCtxName", 16220, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
