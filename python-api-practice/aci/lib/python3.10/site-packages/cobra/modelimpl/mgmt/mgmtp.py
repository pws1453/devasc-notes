...
class MgmtP(Mo):
    ...
    meta = ClassMeta("cobra.model.mgmt.MgmtP")

    meta.moClassName = "mgmtMgmtP"
    meta.rnFormat = "mgmtp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Management Profile"
    meta.writeAccessMask = 0x4201
    meta.readAccessMask = 0x6000400401007701
    ...
    meta.childClasses.add("cobra.model.mgmt.InB")
    meta.childClasses.add("cobra.model.mgmt.OoB")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.InB", "inb-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.OoB", "oob-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37697, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39836, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14351, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6930, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
