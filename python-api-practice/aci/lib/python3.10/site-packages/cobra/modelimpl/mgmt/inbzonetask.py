...
# ##################################################
class InBZoneTask(Mo):
    """
    The in-band zone task.

    """

    meta = ClassMeta("cobra.model.mgmt.InBZoneTask")

    meta.moClassName = "mgmtInBZoneTask"
    meta.rnFormat = "mgmtInBZoneTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5698, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BringNodeInfoToInBMgmtEppShard", "bringnodeinfotoinbmgmteppshard", 625)
