...
class RsMgmtBD(Mo):
    """
    A source relation to the management bridge domain.

    """

    meta = NamedSourceRelationMeta("cobra.model.mgmt.RsMgmtBD", "cobra.model.fv.BD")
    meta.targetNameProps["name"] = "tnFvBDName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mgmtRsMgmtBD"
    meta.rnFormat = "rsmgmtBD"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37701, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39840, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14355, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12548, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvBDName", "tnFvBDName", 12547, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
