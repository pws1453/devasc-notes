...
class ExtMgmtEntity(Mo):
    ...
    meta = ClassMeta("cobra.model.mgmt.ExtMgmtEntity")

    meta.moClassName = "mgmtExtMgmtEntity"
    meta.rnFormat = "extmgmt-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Entities"
    ...
    meta.childClasses.add("cobra.model.mgmt.InstP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.InstP", "instp-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37693, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39832, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14347, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6924, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
