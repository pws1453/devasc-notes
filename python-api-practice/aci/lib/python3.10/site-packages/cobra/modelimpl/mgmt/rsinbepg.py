...
class RsInbEpg(Mo):
    """
    A source relation to the in-band management endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.mgmt.RsInbEpg", "cobra.model.mgmt.InB")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "mgmtRsInbEpg"
    meta.rnFormat = "rsinbEpg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37690, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39829, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14344, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12528, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2194
    prop.defaultValueStr = "mgmtInB"
    prop._addConstant("mgmtInB", None, 2194)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12527, PropCategory.REGULAR)
