...
class IpDef(Mo):
    ...
    meta = ClassMeta("cobra.model.mgmt.IpDef")

    meta.moClassName = "mgmtIpDef"
    meta.rnFormat = "mipdef-[%(addr)s]"
    ...
    meta.parentClasses.add("cobra.model.mgmt.StNodeDef")
    ...
    prop = PropMeta("str", "addr", "addr", 23550, PropCategory.REGULAR)
