...
# ##################################################
class RtToSnInbEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.mgmt.RtToSnInbEpg", "cobra.model.aaa.ServiceNodeCluster")

    meta.moClassName = "mgmtRtToSnInbEpg"
    meta.rnFormat = "rttoSnInbEpg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55622, PropCategory.REGULAR)
