...
class RtOobEpg(Mo):
    """
    A target relation to the out-of-band management endpoint group.

    """

    meta = TargetRelationMeta("cobra.model.mgmt.RtOobEpg", "cobra.model.mgmt.OoBZone")

    meta.moClassName = "mgmtRtOobEpg"
    meta.rnFormat = "rtoobEpg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12526, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2173
    prop.defaultValueStr = "mgmtOoBZone"
