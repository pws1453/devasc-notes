...
class RsAddrInst(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.mgmt.RsAddrInst", "cobra.model.fvns.AddrInst")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mgmtRsAddrInst"
    meta.rnFormat = "rsaddrInst"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to IP Address Pool"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37686, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39825, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14340, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12520, PropCategory.REGULAR)
