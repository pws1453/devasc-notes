...
class RsGrp(Mo):
    """
    A source relation to the managed node group.

    """

    meta = SourceRelationMeta("cobra.model.mgmt.RsGrp", "cobra.model.mgmt.Grp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "mgmtRsGrp"
    meta.rnFormat = "rsgrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37692, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39831, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14346, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12531, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2169
    prop.defaultValueStr = "mgmtGrp"
    prop._addConstant("mgmtGrp", None, 2169)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12530, PropCategory.REGULAR)
