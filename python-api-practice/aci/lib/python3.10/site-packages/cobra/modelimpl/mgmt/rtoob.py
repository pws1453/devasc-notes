...
class RtOoB(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.mgmt.RtOoB", "cobra.model.mgmt.OoBZone")

    meta.moClassName = "mgmtRtOoB"
    meta.rnFormat = "rtooB-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22674, PropCategory.REGULAR)
