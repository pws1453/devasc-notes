...
class Entity(Mo):
    """
     Holds fabric routed multicast group manager entity information 

    """

    meta = ClassMeta("cobra.model.fabrgm.Entity")

    meta.moClassName = "fabrgmEntity"
    meta.rnFormat = "fabrgm"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric Group Manager Entity"
    ...
    meta.childClasses.add("cobra.model.fabrgm.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fabrgm.Inst", "inst"))
