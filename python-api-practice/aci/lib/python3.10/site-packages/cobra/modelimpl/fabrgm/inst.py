...
class Inst(Mo):
    """
     This objects hold per fabrgm instance information. There is only one instance of fabrgm running in the system today 

    """

    meta = ClassMeta("cobra.model.fabrgm.Inst")

    meta.moClassName = "fabrgmInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric Group Manager Instance"
    ...
    meta.childClasses.add("cobra.model.fabrgm.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fabrgm.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.fabrgm.Entity")
