...
# ##################################################
class InstLimitPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.statslimit.InstLimitPol")

    meta.moClassName = "statslimitInstLimitPol"
    meta.rnFormat = "limitpol"
    meta.category = MoCategory.REGULAR
    meta.label = "Stats Limit Pol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38814, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40953, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "instLimit", "instLimit", 36818, PropCategory.REGULAR)
    prop.label = "instance limit"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 514
    prop.defaultValueStr = "514"
    meta.props.add("instLimit", prop)
