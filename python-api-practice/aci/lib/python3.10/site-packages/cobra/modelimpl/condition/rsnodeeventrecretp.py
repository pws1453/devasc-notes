...
# ##################################################
class RsNodeEventRecRetP(Mo):
    """
    A source relation to the switch event retention policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.condition.RsNodeEventRecRetP", "cobra.model.event.SwRetP")
    meta.targetNameProps["name"] = "tnEventSwRetPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "conditionRsNodeEventRecRetP"
    meta.rnFormat = "rsnodeEventRecRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Event Record Retention Policy"
    ...
    meta.rnPrefixes = [
        ('rsnodeEventRecRetP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37591, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39730, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14191, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12054, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 225
    prop.defaultValueStr = "eventSwRetP"
    ...
    prop = PropMeta("str", "tnEventSwRetPName", "tnEventSwRetPName", 12053, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnEventSwRetPName", prop)
