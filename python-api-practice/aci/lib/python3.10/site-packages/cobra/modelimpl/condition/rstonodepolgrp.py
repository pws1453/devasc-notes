...
# ##################################################
class RsToNodePolGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.condition.RsToNodePolGrp", "cobra.model.condition.NodePolGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "conditionRsToNodePolGrp"
    meta.rnFormat = "rstoNodePolGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38256, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40395, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20896, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1724
    prop.defaultValueStr = "conditionNodePolGrp"
    prop._addConstant("conditionNodePolGrp", None, 1724)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20895, PropCategory.REGULAR)
