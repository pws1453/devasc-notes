...
# ##################################################
class RsNodeFaultRecRetP(Mo):
    """
    A source relation to the fault retention policy for switches.

    """

    meta = NamedSourceRelationMeta("cobra.model.condition.RsNodeFaultRecRetP", "cobra.model.fault.SwRetP")
    meta.targetNameProps["name"] = "tnFaultSwRetPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "conditionRsNodeFaultRecRetP"
    meta.rnFormat = "rsnodeFaultRecRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Fault Record Retention Policy"
    ...
    meta.rnPrefixes = [
        ('rsnodeFaultRecRetP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37590, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39729, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14190, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12058, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 238
    prop.defaultValueStr = "faultSwRetP"
    ...
    prop = PropMeta("str", "tnFaultSwRetPName", "tnFaultSwRetPName", 12057, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFaultSwRetPName", prop)
