...
# ##################################################
class RsNodeAaaRecRetP(Mo):
    """
    A source relation to the switch AAA audit log retention policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.condition.RsNodeAaaRecRetP", "cobra.model.aaa.SwRetP")
    meta.targetNameProps["name"] = "tnAaaSwRetPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "conditionRsNodeAaaRecRetP"
    meta.rnFormat = "rsnodeAaaRecRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Audit Record Retention Policy"
    ...
    meta.rnPrefixes = [
        ('rsnodeAaaRecRetP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37592, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39731, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14192, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12050, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1568
    prop.defaultValueStr = "aaaSwRetP"
    ...
    prop = PropMeta("str", "tnAaaSwRetPName", "tnAaaSwRetPName", 12049, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnAaaSwRetPName", prop)
