...
# ##################################################
class RsNodeHealthRecRetP(Mo):
    """
    A source relation to health record retention policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.condition.RsNodeHealthRecRetP", "cobra.model.health.SwRetP")
    meta.targetNameProps["name"] = "tnHealthSwRetPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "conditionRsNodeHealthRecRetP"
    meta.rnFormat = "rsnodeHealthRecRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Health Record Retention Policy"
    ...
    meta.rnPrefixes = [
        ('rsnodeHealthRecRetP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37593, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39732, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14193, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12062, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1642
    prop.defaultValueStr = "healthSwRetP"
    ...
    prop = PropMeta("str", "tnHealthSwRetPName", "tnHealthSwRetPName", 12061, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnHealthSwRetPName", prop)
