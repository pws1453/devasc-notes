...
# ##################################################
class ResolveCompleteRefTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.pcons.ResolveCompleteRefTask")

    meta.moClassName = "pconsResolveCompleteRefTask"
    meta.rnFormat = "pconsResolveCompleteRefTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('pconsResolveCompleteRefTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 16091, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("policyDeploymentDone", "policydeploymentdone", 1367)
