...
# ##################################################
class RsSubtreeClDep(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = SourceRelationMeta("cobra.model.pcons.RsSubtreeClDep", "cobra.model.pcons.SubtreeDepClass")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "pconsRsSubtreeClDep"
    meta.rnFormat = "rssubtreeClDep-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.pcons.DepClass")
    ...
    prop = PropMeta("str", "tCl", "tCl", 11268, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11267, PropCategory.REGULAR)
