...
# ##################################################
class LicenseCleanupTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pcons.LicenseCleanupTask")

    meta.moClassName = "pconsLicenseCleanupTask"
    meta.rnFormat = "pconsLicenseCleanupTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 54664, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CleanupSub", "cleanupsub", 3595)
