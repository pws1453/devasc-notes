...
class RefTask(Mo):
    ...
    meta = ClassMeta("cobra.model.pcons.RefTask")

    meta.moClassName = "pconsRefTask"
    meta.rnFormat = "pconsRefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5636, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PolUpdate", "polupdate", 13)
