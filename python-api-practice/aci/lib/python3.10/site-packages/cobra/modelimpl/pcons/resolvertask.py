...
# ##################################################
class ResolverTask(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = ClassMeta("cobra.model.pcons.ResolverTask")

    meta.moClassName = "pconsResolverTask"
    meta.rnFormat = "pconsResolverTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5670, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Resolve", "resolve", 45)
    prop._addConstant("ResolveAllPolicies", "resolveallpolicies", 1271)
    prop._addConstant("ResolveShardPolicy", "resolveshardpolicy", 3345)
