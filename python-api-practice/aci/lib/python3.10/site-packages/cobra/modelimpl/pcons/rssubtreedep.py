...
# ##################################################
class RsSubtreeDep(Mo):
    """
    This is generated and used only by internal processes.

    """

    meta = SourceRelationMeta("cobra.model.pcons.RsSubtreeDep", "cobra.model.pcons.APolDep")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "pconsRsSubtreeDep"
    meta.rnFormat = "rssubtreeDep-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11260, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 170
    prop.defaultValueStr = "pconsAPolDep"
    ...
    prop = PropMeta("str", "tDn", "tDn", 11259, PropCategory.REGULAR)
