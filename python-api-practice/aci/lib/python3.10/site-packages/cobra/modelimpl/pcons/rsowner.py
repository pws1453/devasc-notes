...
class RsOwner(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pcons.RsOwner", "cobra.model.pcons.PolOwner")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "pconsRsOwner"
    meta.rnFormat = "rsowner-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11272, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 171
    prop.defaultValueStr = "pconsPolOwner"
    prop._addConstant("pconsPolOwner", None, 171)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11271, PropCategory.REGULAR)
