...
# ##################################################
class VmmCleanupTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pcons.VmmCleanupTask")

    meta.moClassName = "pconsVmmCleanupTask"
    meta.rnFormat = "pconsVmmCleanupTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 32636, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CleanupSub", "cleanupsub", 2711)
