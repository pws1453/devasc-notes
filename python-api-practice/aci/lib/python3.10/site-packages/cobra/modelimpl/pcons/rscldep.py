...
class RsClDep(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.pcons.RsClDep", "cobra.model.pcons.APolDep")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "pconsRsClDep"
    meta.rnFormat = "rsclDep-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11264, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11263, PropCategory.REGULAR)
