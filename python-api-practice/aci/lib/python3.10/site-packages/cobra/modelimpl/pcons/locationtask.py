...
# ##################################################
class LocationTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pcons.LocationTask")

    meta.moClassName = "pconsLocationTask"
    meta.rnFormat = "pconsLocationTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21173, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("syncWithQuorum", "syncwithquorum", 1846)
