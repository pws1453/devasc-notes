...
# ##################################################
class ResolverContTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.pcons.ResolverContTask")

    meta.moClassName = "pconsResolverContTask"
    meta.rnFormat = "pconsResolverContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16090, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CheckBootStrap", "checkbootstrap", 1366)
    prop._addConstant("CheckBootStrapWorstCaseTask", "checkbootstrapworstcasetask", 1381)
