...
# ##################################################
class NlbStaticGroupDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ip.NlbStaticGroupDef")

    meta.moClassName = "ipNlbStaticGroupDef"
    meta.rnFormat = "mac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Nlb Static Membership configuration"
    ...
    prop = PropMeta("str", "mac", "mac", 49452, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
