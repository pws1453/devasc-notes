...
class RsConsRoot(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.ip.RsConsRoot", "cobra.model.cons.Root")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ipRsConsRoot"
    meta.rnFormat = "rsconsRoot"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Cons Root tree of ToEPgs/ToEPgAnys"
    ...
    meta.parentClasses.add("cobra.model.ip.Cons")
    ...
    prop = PropMeta("str", "tCl", "tCl", 45307, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10778
    prop.defaultValueStr = "consRoot"
    prop._addConstant("consRoot", None, 10778)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45306, PropCategory.REGULAR)
