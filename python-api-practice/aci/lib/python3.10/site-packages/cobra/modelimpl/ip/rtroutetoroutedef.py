...
# ##################################################
class RtRouteToRouteDef(Mo):
    """
    A target relation to the route definitions.

    """

    meta = TargetRelationMeta("cobra.model.ip.RtRouteToRouteDef", "cobra.model.ip.Route")

    meta.moClassName = "ipRtRouteToRouteDef"
    meta.rnFormat = "rtrouteToRouteDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12857, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3806
    prop.defaultValueStr = "ipRoute"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12856, PropCategory.REGULAR)
