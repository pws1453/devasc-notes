...
# ##################################################
class NexthopEpPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ip.NexthopEpPDef")

    meta.moClassName = "ipNexthopEpPDef"
    meta.rnFormat = "nexthop-[%(nhAddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Nexthop EpP Definition"
    ...
    prop = PropMeta("str", "nhAddr", "nhAddr", 33374, PropCategory.REGULAR)
