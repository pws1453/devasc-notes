...
# ##################################################
class RtNexthopToNexthopDef(Mo):
    """
    A target relation to the next hops for the static route.

    """

    meta = TargetRelationMeta("cobra.model.ip.RtNexthopToNexthopDef", "cobra.model.ip.Nexthop")

    meta.moClassName = "ipRtNexthopToNexthopDef"
    meta.rnFormat = "rtnexthopToNexthopDef"
    ...
    meta.parentClasses.add("cobra.model.ip.NexthopDef")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtnexthopToNexthopDef', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12860, PropCategory.REGULAR)
