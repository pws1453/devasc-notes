...
# ##################################################
class EpAnycastDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ip.EpAnycastDef")

    meta.moClassName = "ipEpAnycastDef"
    meta.rnFormat = "mac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Anycast Ep Definition"
    ...
    prop = PropMeta("str", "mac", "mac", 37067, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
