...
# ##################################################
class RsRouteToRouteDef(Mo):
    """
    A source relation to route definitions.

    """

    meta = SourceRelationMeta("cobra.model.ip.RsRouteToRouteDef", "cobra.model.ip.RouteDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "ipRsRouteToRouteDef"
    meta.rnFormat = "rsrouteToRouteDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12855, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12854, PropCategory.REGULAR)
