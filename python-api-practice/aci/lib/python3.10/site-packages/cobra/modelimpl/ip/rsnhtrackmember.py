...
# ##################################################
class RsNHTrackMember(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ip.RsNHTrackMember", "cobra.model.fv.TrackMember")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ipRsNHTrackMember"
    meta.rnFormat = "rsNHTrackMember"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Track Member Policy"
    ...
    meta.rnPrefixes = [
        ('rsNHTrackMember', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 47678, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47679, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47677, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 47674, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 47673, PropCategory.REGULAR)
