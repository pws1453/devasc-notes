...
class NexthopEpP(Mo):
    ...
    meta = ClassMeta("cobra.model.ip.NexthopEpP")

    meta.moClassName = "ipNexthopEpP"
    meta.rnFormat = "nh-[%(nhAddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Nexthop EpP Reachability"
    meta.writeAccessMask = 0x400401003001
    ...
    meta.superClasses.add("cobra.model.ip.ANexthopEpP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38705, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40844, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhAddr", "nhAddr", 33373, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 33372, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
