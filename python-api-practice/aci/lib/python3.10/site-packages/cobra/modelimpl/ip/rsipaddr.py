...
class RsIpAddr(Mo):
    """
    A source relation to the connectivity parameters for an interface.

    """

    meta = SourceRelationMeta("cobra.model.ip.RsIpAddr", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "ipRsIpAddr"
    meta.rnFormat = "rsipAddr-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "IF Policy Attachement"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12845, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12844, PropCategory.REGULAR)
