...
class NexthopDef(Mo):
    """
    The Nexthops for the static route.

    """

    meta = ClassMeta("cobra.model.ip.NexthopDef")

    meta.moClassName = "ipNexthopDef"
    meta.rnFormat = "nh-[%(nhAddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Nexthop IP Profile Definition"
    ...
    meta.childClasses.add("cobra.model.ip.RtNexthopToNexthopDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.ip.RtNexthopToNexthopDef", "rtnexthopToNexthopDef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.ip.RouteDef")
    ...
    prop = PropMeta("str", "LogicalDn", "LogicalDn", 52346, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhAddr", "nhAddr", 6673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "trackListDn", "trackListDn", 49422, PropCategory.REGULAR)
