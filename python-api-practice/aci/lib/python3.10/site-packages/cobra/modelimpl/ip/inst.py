...
# ##################################################
class Inst(Mo):
    meta = ClassMeta("cobra.model.ip.Inst")

    meta.isAbstract = True
    meta.moClassName = "ipInst"


    meta.moClassName = "ipInst"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "IP Instance"
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 4362, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("addr-overlap", "enable-address-overlap", 256)
