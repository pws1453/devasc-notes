...
# ##################################################
class RsAddrToIpDef(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.ip.RsAddrToIpDef", "cobra.model.l3ext.IpDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "ipRsAddrToIpDef"
    meta.rnFormat = "rsaddrToIpDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "IpDef attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18129, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6084
    prop.defaultValueStr = "l3extIpDef"
    prop._addConstant("l3extIpDef", None, 6084)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18128, PropCategory.REGULAR)
