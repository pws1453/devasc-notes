...
# ##################################################
class RsNexthopToNexthopDef(Mo):
    """
    A source relation to the next hops for the static route.

    """

    meta = SourceRelationMeta("cobra.model.ip.RsNexthopToNexthopDef", "cobra.model.ip.NexthopDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "ipRsNexthopToNexthopDef"
    meta.rnFormat = "rsnexthopToNexthopDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Nexthop Def Attachment"
    ...
    meta.parentClasses.add("cobra.model.ipv6.NexthopStub")
    meta.parentClasses.add("cobra.model.ipv4.NexthopStub")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsnexthopToNexthopDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12859, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4283
    prop.defaultValueStr = "ipNexthopDef"
    prop._addConstant("ipNexthopDef", None, 4283)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12858, PropCategory.REGULAR)
