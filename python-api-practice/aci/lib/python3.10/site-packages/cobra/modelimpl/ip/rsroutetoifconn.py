...
# ##################################################
class RsRouteToIfConn(Mo):
    """
    A source relation to the connectivity parameters for an interface.

    """

    meta = SourceRelationMeta("cobra.model.ip.RsRouteToIfConn", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "ipRsRouteToIfConn"
    meta.rnFormat = "rsrouteToIfConn-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Route if Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12850, PropCategory.REGULAR)
