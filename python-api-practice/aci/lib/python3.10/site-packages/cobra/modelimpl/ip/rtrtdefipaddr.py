...
# ##################################################
class RtRtDefIpAddr(Mo):
    """
    A target relation to the route definitions.

    """

    meta = TargetRelationMeta("cobra.model.ip.RtRtDefIpAddr", "cobra.model.ip.Addr")

    meta.moClassName = "ipRtRtDefIpAddr"
    meta.rnFormat = "rtrtDefIpAddr"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12849, PropCategory.REGULAR)
