...
# ##################################################
class RsNexthopRouteTrack(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ip.RsNexthopRouteTrack", "cobra.model.fv.TrackList")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ipRsNexthopRouteTrack"
    meta.rnFormat = "rsNexthopRouteTrack"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Tracking policy"
    ...
    meta.rnPrefixes = [
        ('rsNexthopRouteTrack', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 45718, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45719, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45715, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 45707, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13170
    prop.defaultValueStr = "fvTrackList"
    prop._addConstant("fvTrackList", None, 13170)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45706, PropCategory.REGULAR)
