...
# ##################################################
class RsNexthopToProtG(Mo):
    """
    A source relation to an abstraction of the VPC protection group.

    """

    meta = SourceRelationMeta("cobra.model.ip.RsNexthopToProtG", "cobra.model.fabric.AProtGEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "ipRsNexthopToProtG"
    meta.rnFormat = "rsnexthopToProtG-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Protection Group Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12862, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12861, PropCategory.REGULAR)
