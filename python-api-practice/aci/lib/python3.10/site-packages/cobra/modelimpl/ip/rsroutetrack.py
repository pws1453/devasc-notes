...
# ##################################################
class RsRouteTrack(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ip.RsRouteTrack", "cobra.model.fv.TrackList")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ipRsRouteTrack"
    meta.rnFormat = "rsRouteTrack"
    ...
    prop = PropMeta("str", "annotation", "annotation", 45687, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45688, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45670, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 45655, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45654, PropCategory.REGULAR)
