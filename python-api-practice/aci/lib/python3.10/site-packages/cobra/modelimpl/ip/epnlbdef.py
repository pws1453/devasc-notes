...
class EpNlbDef(Mo):
    ...
    meta = ClassMeta("cobra.model.ip.EpNlbDef")

    meta.moClassName = "ipEpNlbDef"
    meta.rnFormat = "nlbmac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Nlb Ep Definition"
    ...
    prop = PropMeta("str", "mac", "mac", 49453, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
