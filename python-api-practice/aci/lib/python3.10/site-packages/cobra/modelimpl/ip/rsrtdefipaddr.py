...
# ##################################################
class RsRtDefIpAddr(Mo):
    """
    A source relation to route definitions.

    """

    meta = SourceRelationMeta("cobra.model.ip.RsRtDefIpAddr", "cobra.model.ip.RouteDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "ipRsRtDefIpAddr"
    meta.rnFormat = "rsrtDefIpAddr-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Route Def Attachment"
    ...
    meta.parentClasses.add("cobra.model.ipv6.ForwarderAddr")
    meta.parentClasses.add("cobra.model.ipv6.LLaddr")
    meta.parentClasses.add("cobra.model.ipv4.ForwarderAddr")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12848, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4280
    prop.defaultValueStr = "ipRouteDef"
    prop._addConstant("ipRouteDef", None, 4280)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12847, PropCategory.REGULAR)
