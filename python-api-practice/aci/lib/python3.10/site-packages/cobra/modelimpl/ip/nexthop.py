...
# ##################################################
class Nexthop(Mo):
    meta = ClassMeta("cobra.model.ip.Nexthop")

    meta.isAbstract = True
    meta.moClassName = "ipNexthop"
    ...
    prop = PropMeta("str", "nhAddr", "nhAddr", 4356, PropCategory.REGULAR)
    prop.label = "Nexthop Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("nhAddr", prop)

    prop = PropMeta("str", "nhIf", "nhIf", 4355, PropCategory.REGULAR)
    prop.label = "Nexthop Interface"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("nhIf", prop)

    prop = PropMeta("str", "nhVrf", "nhVrf", 4357, PropCategory.REGULAR)
