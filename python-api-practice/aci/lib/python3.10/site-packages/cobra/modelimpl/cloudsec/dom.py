...
class Dom(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudsec.Dom")

    meta.moClassName = "cloudsecDom"
    meta.rnFormat = "dom-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloudsec Layer 3 Domain"
    ...
    meta.childClasses.add("cobra.model.cloudsec.If")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.If", "if-"))
    ...
    prop = PropMeta("str", "encap", "encap", 42178, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43458, PropCategory.REGULAR)
