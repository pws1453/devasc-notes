...
# ##################################################
class SiteTxKeySt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SiteTxKeySt")

    meta.moClassName = "cloudsecSiteTxKeySt"
    meta.rnFormat = "sitetxkeystatus"
    meta.category = MoCategory.REGULAR
    meta.label = "Aggregated TXSaKey status on Site"
    ...
    meta.rnPrefixes = [
        ('sitetxkeystatus', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44610, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44611, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keyControl", "keyControl", 45341, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44601, PropCategory.REGULAR)
