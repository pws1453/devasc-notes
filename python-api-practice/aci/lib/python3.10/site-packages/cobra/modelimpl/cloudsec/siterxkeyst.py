...
# ##################################################
class SiteRxKeySt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SiteRxKeySt")

    meta.moClassName = "cloudsecSiteRxKeySt"
    meta.rnFormat = "siterxkeystatus"
    meta.category = MoCategory.REGULAR
    meta.label = "Aggregated RXSaKey status on Site"
    ...
    meta.rnPrefixes = [
        ('siterxkeystatus', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44606, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44607, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keyControl", "keyControl", 45338, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44599, PropCategory.REGULAR)
