...
# ##################################################
class SiteTxKeyStTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SiteTxKeyStTask")

    meta.moClassName = "cloudsecSiteTxKeyStTask"
    meta.rnFormat = "cloudsecSiteTxKeyStTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44592, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateSiteTxKeySt", "updatesitetxkeyst", 3202)
