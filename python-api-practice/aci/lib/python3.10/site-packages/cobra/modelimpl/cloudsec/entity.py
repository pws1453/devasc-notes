...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudsec.Entity")

    meta.moClassName = "cloudsecEntity"
    meta.rnFormat = "cloudsec"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloudsec Entity"
    ...
    meta.childClasses.add("cobra.model.cloudsec.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43455, PropCategory.REGULAR)
