...
class ControlDef(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudsec.ControlDef")

    meta.moClassName = "cloudsecControlDef"
    meta.rnFormat = "cloudseccontroldef"
    meta.category = MoCategory.REGULAR
    meta.label = "Resolved Cloudsec Site Control"
    ...
    prop = PropMeta("str", "keyEncryptionKey", "keyEncryptionKey", 42729, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
