...
# ##################################################
class ASpKeySt(Mo):
    meta = ClassMeta("cobra.model.cloudsec.ASpKeySt")

    meta.isAbstract = True
    meta.moClassName = "cloudsecASpKeySt"


    meta.moClassName = "cloudsecASpKeySt"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Aggregated SaKey status on Spine"
    ...
    prop = PropMeta("str", "siteId", "siteId", 44621, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 1000)]
