...
# ##################################################
class FabricSpTxKeySt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.FabricSpTxKeySt")

    meta.moClassName = "cloudsecFabricSpTxKeySt"
    meta.rnFormat = "fabricspineTxkeystatus"
    ...
    meta.parentClasses.add("cobra.model.cloudsec.KeyStNodeCont")
    ...
    prop = PropMeta("str", "keyControl", "keyControl", 45340, PropCategory.REGULAR)
