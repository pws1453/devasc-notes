...
class SaTxKey(Mo):
    ...
    prop = PropMeta("str", "cloudsecCfgFailedBmp", "cloudsecCfgFailedBmp", 44658, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop._addConstant("cloudsec:SaTxKeylcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("cloudsec:SaTxKeymodTs_failed_flag", None, 2305843009213693952)
    ...
    prop = PropMeta("str", "cloudsecCfgFailedTs", "cloudsecCfgFailedTs", 44660, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("cloudsecCfgFailedTs", prop)

    prop = PropMeta("str", "cloudsecCfgState", "cloudsecCfgState", 44659, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
