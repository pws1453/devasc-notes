...
# ##################################################
class CapabilityLocal(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.CapabilityLocal")

    meta.moClassName = "cloudsecCapabilityLocal"
    meta.rnFormat = "cloudseccaplocal"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloudsec Local Site Capability exchanged with MSC"
    ...
    meta.superClasses.add("cobra.model.cloudsec.ACapability")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")

    meta.rnPrefixes = [
        ('cloudseccaplocal', False),
    ]

    prop = PropMeta("str", "capBm", "capBm", 44771, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("cloudsec-is-supported", "cloudsec-is-supported", 1)
    prop._addConstant("none", "none", 0)
    meta.props.add("capBm", prop)
    ...
    prop = PropMeta("str", "cloudsecStatus", "cloudsecStatus", 44770, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    meta.props.add("cloudsecStatus", prop)

    prop = PropMeta("str", "configIssues", "configIssues", 44947, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ok"
    prop._addConstant("missing-kek", "cloudsec-control-does-not-have-a-kek-configured.", 2)
    prop._addConstant("missing-psk", "cloudsec-interface-policy-does-not-have-any-psk-configured.-it-should-have-at-least-one-psk.", 1)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44948, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "version", "version", 44769, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
