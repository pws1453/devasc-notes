...
# ##################################################
class SaKeyStatusLocal(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SaKeyStatusLocal")

    meta.moClassName = "cloudsecSaKeyStatusLocal"
    meta.rnFormat = "sakeystatuslocal-%(siteId)s"
    ...
    prop = PropMeta("str", "keyControl", "keyControl", 45333, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "siteId", "siteId", 44594, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
