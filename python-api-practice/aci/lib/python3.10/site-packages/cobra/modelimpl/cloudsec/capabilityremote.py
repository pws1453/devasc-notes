...
# ##################################################
class CapabilityRemote(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.CapabilityRemote")

    meta.moClassName = "cloudsecCapabilityRemote"
    meta.rnFormat = "cloudseccapremote"
    ...
    meta.rnPrefixes = [
        ('cloudseccapremote', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44780, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "capBm", "capBm", 44774, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "cloudsecStatus", "cloudsecStatus", 44773, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44781, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "version", "version", 44772, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
