...
class SpTxKeySt(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudsec.SpTxKeySt")

    meta.moClassName = "cloudsecSpTxKeySt"
    meta.rnFormat = "spinetxkeystatus-%(siteId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Aggregated TXSaKey status on Spine"
    ...
    meta.rnPrefixes = [
        ('spinetxkeystatus-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44608, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44609, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keyControl", "keyControl", 45339, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44600, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "siteId", "siteId", 44596, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
