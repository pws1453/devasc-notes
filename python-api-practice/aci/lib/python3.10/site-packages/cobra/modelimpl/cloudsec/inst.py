...
class Inst(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.SpTxKeySt", "spinetxkeystatus-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.SpRxKeySt", "spinerxkeystatus-"))
