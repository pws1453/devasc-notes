...
# ##################################################
class SpRxKeyStTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SpRxKeyStTask")

    meta.moClassName = "cloudsecSpRxKeyStTask"
    meta.rnFormat = "cloudsecSpRxKeyStTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44589, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateSpRxKeySt", "updatesprxkeyst", 3203)
