...
class SaKeyUsage(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudsec.SaKeyUsage")

    meta.moClassName = "cloudsecSaKeyUsage"
    meta.rnFormat = "sakeyusage-%(siteId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloudsec Site SaKey Usage"
    ...
    prop = PropMeta("str", "AssocNum0", "AssocNum0", 44556, PropCategory.REGULAR)
    prop.label = "SaKey Usage"
    ...
    meta.props.add("AssocNum0", prop)

    prop = PropMeta("str", "AssocNum1", "AssocNum1", 44557, PropCategory.REGULAR)
    prop.label = "SaKey Usage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "siteId", "siteId", 44558, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
