...
# ##################################################
class SiteRxKeyStTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SiteRxKeyStTask")

    meta.moClassName = "cloudsecSiteRxKeyStTask"
    meta.rnFormat = "cloudsecSiteRxKeyStTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44591, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateSiteRxKeySt", "updatesiterxkeyst", 3201)
