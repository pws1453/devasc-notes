...
# ##################################################
class SaKeyPLocal(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SaKeyPLocal")

    meta.moClassName = "cloudsecSaKeyPLocal"
    meta.rnFormat = "sakeyplocal-%(siteId)s"
    ...
    meta.superClasses.add("cobra.model.cloudsec.ASaKeyPLocal")
    ...
    prop = PropMeta("str", "assocNum", "assocNum", 44567, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "cipher", "cipher", 44570, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encryptedSaKey", "encryptedSaKey", 44572, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "sci", "sci", 44569, PropCategory.REGULAR)
    prop.label = "Secure Channel Identifier"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("sci", prop)

    prop = PropMeta("str", "sequenceNumber", "sequenceNumber", 44568, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("sequenceNumber", prop)

    prop = PropMeta("str", "siteId", "siteId", 44593, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
