...
# ##################################################
class SaKeyStatusRemote(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SaKeyStatusRemote")

    meta.moClassName = "cloudsecSaKeyStatusRemote"
    meta.rnFormat = "sakeystatusremote"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloudsec Site Remote SaKey status exchanged with MSC"
    ...
    meta.rnPrefixes = [
        ('sakeystatusremote', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44614, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44615, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "prgmStatus", "prgmStatus", 44588, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
