...
# ##################################################
class FabricSpRxKeySt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.FabricSpRxKeySt")

    meta.moClassName = "cloudsecFabricSpRxKeySt"
    meta.rnFormat = "fabricspinerxkeystatus"
    ...
    prop = PropMeta("str", "keyControl", "keyControl", 45337, PropCategory.REGULAR)
