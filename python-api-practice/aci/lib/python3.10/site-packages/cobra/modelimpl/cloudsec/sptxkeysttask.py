...
# ##################################################
class SpTxKeyStTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SpTxKeyStTask")

    meta.moClassName = "cloudsecSpTxKeyStTask"
    meta.rnFormat = "cloudsecSpTxKeyStTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44590, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateSpTxKeySt", "updatesptxkeyst", 3204)
