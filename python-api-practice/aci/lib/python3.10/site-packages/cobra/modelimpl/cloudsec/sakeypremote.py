...
# ##################################################
class SaKeyPRemote(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudsec.SaKeyPRemote")

    meta.moClassName = "cloudsecSaKeyPRemote"
    meta.rnFormat = "sakeypremote"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloudsec Remote Site SaKey Profile exchanged with MSC"
    ...
    prop = PropMeta("str", "annotation", "annotation", 44612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "assocNum", "assocNum", 44573, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "encryptedSaKey", "encryptedSaKey", 44577, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("encryptedSaKey", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44613, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
