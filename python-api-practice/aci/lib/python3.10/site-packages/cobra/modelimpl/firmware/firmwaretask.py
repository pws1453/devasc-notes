...
# ##################################################
class FirmwareTask(Mo):
    """
    Information about the firmware task specification.

    """

    meta = ClassMeta("cobra.model.firmware.FirmwareTask")

    meta.moClassName = "firmwareFirmwareTask"
    meta.rnFormat = "firmwareFirmwareTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5646, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("LoadCatalog", "loadcatalog", 71)
    prop._addConstant("UpdateAnalyticsAgentFwP", "updateanalyticsagentfwp", 2556)
    prop._addConstant("addBasePackage", "addbasepackage", 3079)
    prop._addConstant("addFirmware", "addfirmware", 3023)
    prop._addConstant("addPlugin", "addplugin", 2546)
    prop._addConstant("apPluginFault", "appluginfault", 2655)
    prop._addConstant("autoloadCatalog", "autoloadcatalog", 1380)
    prop._addConstant("createConfigFileMo", "createconfigfilemo", 3143)
    prop._addConstant("installPlugin", "installplugin", 3297)
    prop._addConstant("none", "none", 0)
    prop._addConstant("preInstallPreRemovePlugin", "preinstallpreremoveplugin", 3589)
    prop._addConstant("preUpgradePlugin", "preupgradeplugin", 3469)
    prop._addConstant("upgradePlugin", "upgradeplugin", 3470)
