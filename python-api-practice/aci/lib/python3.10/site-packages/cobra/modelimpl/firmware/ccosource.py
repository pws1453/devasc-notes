...
class CcoSource(Mo):
    ...
    meta = ClassMeta("cobra.model.firmware.CcoSource")

    meta.moClassName = "firmwareCcoSource"
    meta.rnFormat = "ccosrc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cco Firmware Source"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37318, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39457, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13829, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6518, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
