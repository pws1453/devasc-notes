...
# ##################################################
class ExtChRunning(Mo):
    """
    Information about the extended chassis firmware.

    """

    meta = ClassMeta("cobra.model.firmware.ExtChRunning")

    meta.moClassName = "firmwareExtChRunning"
    meta.rnFormat = "running"
    meta.category = MoCategory.REGULAR
    meta.label = "Extended Chassis Running Status"
    ...
    prop = PropMeta("str", "loaderVer", "loaderVer", 3285, PropCategory.REGULAR)
    prop.label = "Loader Version"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("loaderVer", prop)
