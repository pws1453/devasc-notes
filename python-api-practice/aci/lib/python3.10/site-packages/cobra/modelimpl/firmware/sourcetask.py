...
class SourceTask(Mo):
    """
    Contains information about the firmware source task specification.

    """

    meta = ClassMeta("cobra.model.firmware.SourceTask")

    meta.moClassName = "firmwareSourceTask"
    meta.rnFormat = "firmwareSourceTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5652, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("populateRepo", "populaterepo", 34)
