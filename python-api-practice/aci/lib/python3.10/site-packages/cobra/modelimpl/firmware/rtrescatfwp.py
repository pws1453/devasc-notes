...
# ##################################################
class RtResCatFwP(Mo):
    """
    A relation to the catalog firmware policy version.

    """

    meta = TargetRelationMeta("cobra.model.firmware.RtResCatFwP", "cobra.model.fabric.Inst")

    meta.moClassName = "firmwareRtResCatFwP"
    meta.rnFormat = "rtresCatFwP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11708, PropCategory.REGULAR)
