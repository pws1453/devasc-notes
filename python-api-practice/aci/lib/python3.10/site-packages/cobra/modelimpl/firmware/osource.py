...
class OSource(Mo):
    ...
    meta = ClassMeta("cobra.model.firmware.OSource")

    meta.moClassName = "firmwareOSource"
    meta.rnFormat = "osrc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Firmware Download Task"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37319, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39458, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13830, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6523, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
