...
# ##################################################
class CompRunning(Mo):
    """
    Information about each equipment component firmware that is running.

    """

    meta = ClassMeta("cobra.model.firmware.CompRunning")

    meta.moClassName = "firmwareCompRunning"
    meta.rnFormat = "running"
    meta.category = MoCategory.REGULAR
    meta.label = "Equipment Component Running Status"
    ...
    prop = PropMeta("str", "expectedVer", "expectedVer", 17921, PropCategory.REGULAR)
    prop.label = "Expected Component Running Version"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17924, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 17922, PropCategory.REGULAR)
