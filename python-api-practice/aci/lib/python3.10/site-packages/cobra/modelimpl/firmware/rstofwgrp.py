...
class RsToFwGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.firmware.RsToFwGrp", "cobra.model.firmware.FwGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "firmwareRsToFwGrp"
    meta.rnFormat = "rstoFwGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38250, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40389, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20908, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20884, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 353
    prop.defaultValueStr = "firmwareFwGrp"
    prop._addConstant("firmwareFwGrp", None, 353)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20883, PropCategory.REGULAR)
