...
class RsFwgrpp(Mo):
    """
    A source relation to the firmware specification policy for a node.

    """

    meta = NamedSourceRelationMeta("cobra.model.firmware.RsFwgrpp", "cobra.model.firmware.FwP")
    meta.targetNameProps["name"] = "tnFirmwareFwPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "firmwareRsFwgrpp"
    meta.rnFormat = "rsfwgrpp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Firmware Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37323, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39462, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13833, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11297, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 363
    prop.defaultValueStr = "firmwareFwP"
    ...
    prop = PropMeta("str", "tnFirmwareFwPName", "tnFirmwareFwPName", 11296, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFirmwareFwPName", prop)
