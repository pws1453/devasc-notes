...
# ##################################################
class DownloadTask(Mo):
    """
    The task of the attempted download from a specified source.

    """

    meta = ClassMeta("cobra.model.firmware.DownloadTask")

    meta.moClassName = "firmwareDownloadTask"
    meta.rnFormat = "firmwareDownloadTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5651, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("populateDownload", "populatedownload", 35)
