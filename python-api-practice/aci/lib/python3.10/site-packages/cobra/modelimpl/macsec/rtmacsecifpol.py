...
# ##################################################
class RtMacsecIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.macsec.RtMacsecIfPol", "cobra.model.infra.AAccGrp")

    meta.moClassName = "macsecRtMacsecIfPol"
    meta.rnFormat = "rtinfraMacsecIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 30127, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30126, PropCategory.REGULAR)
