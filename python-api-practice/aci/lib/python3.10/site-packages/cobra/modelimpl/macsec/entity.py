...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.macsec.Entity")

    meta.moClassName = "macsecEntity"
    meta.rnFormat = "macsec"
    meta.category = MoCategory.REGULAR
    meta.label = "MACSEC Entity"
    ...
    meta.childClasses.add("cobra.model.macsec.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.macsec.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34267, PropCategory.REGULAR)
