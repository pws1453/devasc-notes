...
# ##################################################
class RtToParamPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.macsec.RtToParamPol", "cobra.model.macsec.AAIfPol")

    meta.moClassName = "macsecRtToParamPol"
    meta.rnFormat = "rttoParamPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 30135, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30134, PropCategory.REGULAR)
