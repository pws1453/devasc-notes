...
class FabIf(Mo):
    ...
    meta = ClassMeta("cobra.model.macsec.FabIf")

    meta.moClassName = "macsecFabIf"
    meta.rnFormat = "fabif-[%(id)s]"
    ...
    prop = PropMeta("str", "id", "id", 30289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34270, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nwIssues", "nwIssues", 35723, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ok"
    prop._addConstant("must-secure-config-error", "can-only-deploy-must-secure-mode-or-change-keychain-on-interface-already-set-to-should-secure-mode.", 1)
    ...
    prop = PropMeta("str", "policyDn", "policyDn", 35678, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
