...
class ParamPol(Mo):
    ...
    meta = ClassMeta("cobra.model.macsec.ParamPol")

    meta.moClassName = "macsecParamPol"
    meta.rnFormat = "paramp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "MACsec Access Parameters Policy"
    meta.writeAccessMask = 0x2102000000001
    meta.readAccessMask = 0x2102000000001
    ...
    meta.childClasses.add("cobra.model.macsec.RtToParamPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.macsec.RtToParamPol", "rttoParamPol-"))
    ...
    meta.superClasses.add("cobra.model.macsec.AAParamPol")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.macsec.AParamPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38702, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cipherSuite", "cipherSuite", 30247, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "confOffset", "confOffset", 30081, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40841, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keySvrPrio", "keySvrPrio", 30248, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33350, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 33337, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "replayWindow", "replayWindow", 30246, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sakExpiryTime", "sakExpiryTime", 33081, PropCategory.REGULAR)
    prop.label = "Secure Association Key Expiry Time (seconds)"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "secPolicy", "secPolicy", 30245, PropCategory.REGULAR)
