...
# ##################################################
class AKeyPol(Mo):
    meta = ClassMeta("cobra.model.macsec.AKeyPol")

    meta.isAbstract = True
    meta.moClassName = "macsecAKeyPol"
    ...
    meta.superClasses.add("cobra.model.macsec.AAKeyPol")
    ...
    prop = PropMeta("str", "endTime", "endTime", 30089, PropCategory.REGULAR)
    prop.label = "End Time"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "keyName", "keyName", 30087, PropCategory.REGULAR)
    prop.label = "Key Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-fA-F0-9]+']
    meta.props.add("keyName", prop)
    ...
    prop = PropMeta("str", "preSharedKey", "preSharedKey", 30086, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "startTime", "startTime", 30088, PropCategory.REGULAR)
