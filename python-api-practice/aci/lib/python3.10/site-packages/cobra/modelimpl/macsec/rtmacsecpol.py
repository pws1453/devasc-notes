...
# ##################################################
class RtMacsecPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.macsec.RtMacsecPol", "cobra.model.fabric.PodPGrp")

    meta.moClassName = "macsecRtMacsecPol"
    meta.rnFormat = "rtfabricMacsecPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Pod Policy Group"
    meta.writeAccessMask = 0x2002000000001
    meta.readAccessMask = 0x208e700000001
    ...
    prop = PropMeta("str", "tCl", "tCl", 30119, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30118, PropCategory.REGULAR)
