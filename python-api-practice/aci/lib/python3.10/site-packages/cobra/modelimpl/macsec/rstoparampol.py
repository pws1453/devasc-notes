...
# ##################################################
class RsToParamPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.macsec.RsToParamPol", "cobra.model.macsec.AAParamPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "macsecRsToParamPol"
    meta.rnFormat = "rsToParamPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Source to IfPol Relation"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38644, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40783, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30140, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30133, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9884
    prop.defaultValueStr = "macsecAAParamPol"
    ...
    prop = PropMeta("str", "tDn", "tDn", 30132, PropCategory.REGULAR)
