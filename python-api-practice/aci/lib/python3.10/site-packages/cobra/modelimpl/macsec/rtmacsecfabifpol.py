...
# ##################################################
class RtMacsecFabIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.macsec.RtMacsecFabIfPol", "cobra.model.fabric.APortPGrp")

    meta.moClassName = "macsecRtMacsecFabIfPol"
    meta.rnFormat = "rtfabricMacsecFabIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 30115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30114, PropCategory.REGULAR)
