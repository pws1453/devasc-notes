...
# ##################################################
class RsToKeyChainPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.macsec.RsToKeyChainPol", "cobra.model.macsec.AKeyChainPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "macsecRsToKeyChainPol"
    meta.rnFormat = "rsToKeyChainPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Source to KeyChain Relation"
    ...
    meta.rnPrefixes = [
        ('rsToKeyChainPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38645, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40784, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30141, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30129, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9890
    prop.defaultValueStr = "macsecAKeyChainPol"
    prop._addConstant("macsecAKeyChainPol", None, 9890)
    prop._addConstant("macsecKeyChainPol", None, 9891)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 30128, PropCategory.REGULAR)
