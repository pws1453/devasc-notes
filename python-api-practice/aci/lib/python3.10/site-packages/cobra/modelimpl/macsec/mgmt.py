...
class Mgmt(Mo):
    ...
    meta = ClassMeta("cobra.model.macsec.Mgmt")

    meta.moClassName = "macsecMgmt"
    meta.rnFormat = "mgmt"
    meta.category = MoCategory.REGULAR
    meta.label = "MACsec State Management"
    ...
    prop = PropMeta("str", "state", "state", 35676, PropCategory.REGULAR)
    prop.label = "Cleanup State"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
