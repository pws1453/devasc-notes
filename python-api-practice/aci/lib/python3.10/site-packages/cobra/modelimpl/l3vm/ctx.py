...
class Ctx(Mo):
    ...
    meta = ClassMeta("cobra.model.l3vm.Ctx")

    meta.moClassName = "l3vmCtx"
    meta.rnFormat = "ctx-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Vrf Entity"
    ...
    prop = PropMeta("str", "encap", "encap", 44485, PropCategory.REGULAR)
    prop.label = "Encapsulation"
    prop.isOper = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "id", "id", 44484, PropCategory.REGULAR)
    prop.label = "VRF ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "name", "name", 44486, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("name", prop)

    prop = PropMeta("str", "operStQual", "operStQual", 44488, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operState", "operState", 44487, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 44489, PropCategory.REGULAR)
    prop.label = "Context Type"
    prop.isOper = True
    prop.defaultValue = 3
