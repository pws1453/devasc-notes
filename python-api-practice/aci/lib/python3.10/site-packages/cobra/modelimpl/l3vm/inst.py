...
class Inst(Mo):
    """
    An internal object used by NX-OS processes to contain other runtime objects.

    """

    meta = ClassMeta("cobra.model.l3vm.Inst")

    meta.moClassName = "l3vmInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "L3VM Instance"
    ...
    meta.childClasses.add("cobra.model.l3vm.Tbl")
    meta.childClasses.add("cobra.model.l3vm.Ctx")
    meta.childClasses.add("cobra.model.l3.DomMbrIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3.DomMbrIf", "dommbr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3vm.Tbl", "tbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3vm.Ctx", "ctx-"))

    meta.parentClasses.add("cobra.model.l3vm.Entity")
    ...
    prop = PropMeta("str", "featureSet", "featureSet", 4244, PropCategory.REGULAR)
    prop.label = "Feature Set Bitmap"
    prop.isOper = True
    meta.props.add("featureSet", prop)
    ...
    prop = PropMeta("str", "tblAllocId", "tblAllocId", 4243, PropCategory.REGULAR)
    prop.label = "Allocated Table ID"
    prop.isOper = True
    meta.props.add("tblAllocId", prop)

    prop = PropMeta("str", "vrfAllocId", "vrfAllocId", 4242, PropCategory.REGULAR)
    prop.label = "Allocated VRF ID"
    prop.isOper = True
    meta.props.add("vrfAllocId", prop)
