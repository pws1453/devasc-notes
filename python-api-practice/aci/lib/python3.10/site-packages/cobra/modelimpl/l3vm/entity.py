...
class Entity(Mo):
    """
    A container for the L3VM entity information.

    """

    meta = ClassMeta("cobra.model.l3vm.Entity")

    meta.moClassName = "l3vmEntity"
    meta.rnFormat = "l3vm"
    meta.category = MoCategory.REGULAR
    meta.label = "L3VM Entity"
    ...
    meta.childClasses.add("cobra.model.l3vm.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3vm.Inst", "inst"))
