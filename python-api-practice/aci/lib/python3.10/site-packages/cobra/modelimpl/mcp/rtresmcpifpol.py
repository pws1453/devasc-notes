...
# ##################################################
class RtResMcpIfPol(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.mcp.RtResMcpIfPol", "cobra.model.infra.Infra")

    meta.moClassName = "mcpRtResMcpIfPol"
    meta.rnFormat = "rtresMcpIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17529, PropCategory.REGULAR)
