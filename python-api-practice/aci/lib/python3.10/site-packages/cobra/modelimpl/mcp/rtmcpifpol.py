...
class RtMcpIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.mcp.RtMcpIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "mcpRtMcpIfPol"
    meta.rnFormat = "rtinfraMcpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17522, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17521, PropCategory.REGULAR)
