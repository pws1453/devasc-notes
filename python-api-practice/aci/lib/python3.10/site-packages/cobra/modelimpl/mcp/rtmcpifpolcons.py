...
# ##################################################
class RtMcpIfPolCons(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.mcp.RtMcpIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "mcpRtMcpIfPolCons"
    meta.rnFormat = "rtl1McpIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17740, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17739, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 17742, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
