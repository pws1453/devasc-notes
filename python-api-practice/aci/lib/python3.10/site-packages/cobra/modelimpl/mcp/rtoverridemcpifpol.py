...
# ##################################################
class RtOverrideMcpIfPol(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.mcp.RtOverrideMcpIfPol", "cobra.model.infra.AttPolicyGroup")

    meta.moClassName = "mcpRtOverrideMcpIfPol"
    meta.rnFormat = "rtinfraOverrideMcpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17526, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17525, PropCategory.REGULAR)
