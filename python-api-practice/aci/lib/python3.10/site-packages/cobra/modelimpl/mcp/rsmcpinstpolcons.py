...
# ##################################################
class RsMcpInstPolCons(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.mcp.RsMcpInstPolCons", "cobra.model.mcp.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "mcpRsMcpInstPolCons"
    meta.rnFormat = "rsmcpInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Mcp Instance Policy Consumption"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17907, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17906, PropCategory.REGULAR)
