...
class Entity(Mo):
    """
    The MisCabling Protocol (MCP) entity information.

    """

    meta = ClassMeta("cobra.model.mcp.Entity")

    meta.moClassName = "mcpEntity"
    meta.rnFormat = "mcp"
    meta.category = MoCategory.REGULAR
    meta.label = "MCP Entity"
    ...
    meta.childClasses.add("cobra.model.mcp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mcp.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14440, PropCategory.REGULAR)
