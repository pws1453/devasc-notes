...
# ##################################################
class SnapshotMgrP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.config.SnapshotMgrP")

    meta.moClassName = "configSnapshotMgrP"
    meta.rnFormat = "snpmgr-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Configuration Snapshot Manager Policy"
    ...
    meta.childClasses.add("cobra.model.config.RtDbgrConfigSnapshotMgrP")
    meta.childClasses.add("cobra.model.config.RsRemotePath")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.config.RtDbgrConfigSnapshotMgrP", "rtpolDbgrConfigSnapshotMgrP-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38241, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40380, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fileName", "fileName", 20427, PropCategory.REGULAR)
    prop.label = "File Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "mode", "mode", 20428, PropCategory.REGULAR)
    prop.label = "Snapshot Manager Action"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "upload"
    prop._addConstant("download", "download", 1)
    prop._addConstant("upload", "upload", 0)
    meta.props.add("mode", prop)

    prop = PropMeta("str", "monPolDn", "monPolDn", 20436, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 20430, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
