...
# ##################################################
class ImportJobTrig(Mo):
    """
    The import job trigger.

    """

    meta = ClassMeta("cobra.model.config.ImportJobTrig")

    meta.moClassName = "configImportJobTrig"
    meta.rnFormat = "configimptrig-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 5992, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
