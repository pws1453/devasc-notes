...
# ##################################################
class ImportIdJobTrig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.config.ImportIdJobTrig")

    meta.moClassName = "configImportIdJobTrig"
    meta.rnFormat = "impidtrig-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 21580, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
