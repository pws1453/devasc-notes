...
# ##################################################
class RsExportScheduler(Mo):
    """
    A source relation to the scheduler policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.config.RsExportScheduler", "cobra.model.trig.SchedP")
    meta.targetNameProps["name"] = "tnTrigSchedPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "configRsExportScheduler"
    meta.rnFormat = "rsExportScheduler"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Export Scheduler"
    ...
    meta.rnPrefixes = [
        ('rsExportScheduler', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37300, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39439, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13804, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11279, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTrigSchedPName", "tnTrigSchedPName", 11278, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
