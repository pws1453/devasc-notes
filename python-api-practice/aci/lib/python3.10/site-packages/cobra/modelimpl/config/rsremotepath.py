...
# ##################################################
class RsRemotePath(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.config.RsRemotePath", "cobra.model.file.RemotePath")
    meta.targetNameProps["name"] = "tnFileRemotePathName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "configRsRemotePath"
    meta.rnFormat = "rsRemotePath"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Backup remote path"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38214, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40353, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18469, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1674
    prop.defaultValueStr = "fileRemotePath"
    ...
    prop = PropMeta("str", "tnFileRemotePathName", "tnFileRemotePathName", 18468, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFileRemotePathName", prop)
