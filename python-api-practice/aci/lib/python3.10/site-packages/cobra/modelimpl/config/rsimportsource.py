...
class RsImportSource(Mo):
    ...
    meta.rnPrefixes = [
        ('rsImportSource', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37304, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39443, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13807, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11282, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFileRemotePathName", "tnFileRemotePathName", 11281, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
