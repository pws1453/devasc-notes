...
class RollbackP(Mo):
    ...
    meta = ClassMeta("cobra.model.config.RollbackP")

    meta.moClassName = "configRollbackP"
    meta.rnFormat = "snprlb-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Configuration Snapshot Rollback Policy"
    ...
    meta.childClasses.add("cobra.model.config.RtDbgrConfigRollbackP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.config.RtDbgrConfigRollbackP", "rtpolDbgrConfigRollbackP-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38236, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40375, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mode", "mode", 20146, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20247, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 20175, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "preview", "preview", 20147, PropCategory.REGULAR)
    prop.label = "Preview mode, nothing is applied"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    ...
    prop = PropMeta("str", "snapshotOneDn", "snapshotOneDn", 20144, PropCategory.REGULAR)
    prop.label = "Snapshot one"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("snapshotOneDn", prop)

    prop = PropMeta("str", "snapshotTwoDn", "snapshotTwoDn", 20145, PropCategory.REGULAR)
    prop.label = "Snapshot two"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("snapshotTwoDn", prop)
