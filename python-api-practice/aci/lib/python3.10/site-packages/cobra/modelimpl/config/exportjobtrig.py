...
# ##################################################
class ExportJobTrig(Mo):
    """
    The export job trigger.

    """

    meta = ClassMeta("cobra.model.config.ExportJobTrig")

    meta.moClassName = "configExportJobTrig"
    meta.rnFormat = "configexptrig-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 5990, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
