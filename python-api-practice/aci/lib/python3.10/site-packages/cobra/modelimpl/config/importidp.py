...
class ImportIdP(Mo):
    ...
    meta = ClassMeta("cobra.model.config.ImportIdP")

    meta.moClassName = "configImportIdP"
    meta.rnFormat = "impid-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "ID Import Policy"
    ...
    meta.childClasses.add("cobra.model.config.RtDbgrConfigImportIdP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.config.RtDbgrConfigImportIdP", "rtpolDbgrConfigImportIdP-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38330, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40469, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fileName", "fileName", 21565, PropCategory.REGULAR)
    prop.label = "Id File to Import"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21586, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 21581, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
