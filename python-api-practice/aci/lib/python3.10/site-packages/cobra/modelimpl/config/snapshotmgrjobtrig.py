...
# ##################################################
class SnapshotMgrJobTrig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.config.SnapshotMgrJobTrig")

    meta.moClassName = "configSnapshotMgrJobTrig"
    meta.rnFormat = "snpmgrtrig-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 20429, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
