...
class SubJobTask(Mo):
    ...
    meta = ClassMeta("cobra.model.config.SubJobTask")

    meta.moClassName = "configSubJobTask"
    meta.rnFormat = "configSubJobTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 20169, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("applyPdConfigTree", "applypdconfigtree", 2417)
    prop._addConstant("applyTree", "applytree", 1733)
    prop._addConstant("fetchDhcpIds", "fetchdhcpids", 1947)
    prop._addConstant("fetchPdConfigTree", "fetchpdconfigtree", 2416)
    prop._addConstant("fetchTree", "fetchtree", 1732)
    prop._addConstant("importDhcpObjects", "importdhcpobjects", 1946)
    prop._addConstant("importIds", "importids", 1894)
    prop._addConstant("none", "none", 0)
    prop._addConstant("prepareRollback", "preparerollback", 1734)
    prop._addConstant("prepareRollbackPd", "preparerollbackpd", 2418)
