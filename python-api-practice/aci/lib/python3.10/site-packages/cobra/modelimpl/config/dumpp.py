...
class DumpP(Mo):
    ...
    meta = ClassMeta("cobra.model.config.DumpP")

    meta.moClassName = "configDumpP"
    meta.rnFormat = "configdump-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Configuration Export Policy from PD"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38754, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "details", "details", 34318, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40893, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34321, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 34320, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "operSt", "operSt", 34317, PropCategory.REGULAR)
