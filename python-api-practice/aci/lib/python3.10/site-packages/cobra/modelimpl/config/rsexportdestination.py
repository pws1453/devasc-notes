...
# ##################################################
class RsExportDestination(Mo):
    """
    A source relation to the remote destination path parameters.

    """

    meta = NamedSourceRelationMeta("cobra.model.config.RsExportDestination", "cobra.model.file.RemotePath")
    meta.targetNameProps["name"] = "tnFileRemotePathName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "configRsExportDestination"
    meta.rnFormat = "rsExportDestination"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Export Destination"
    ...
    meta.rnPrefixes = [
        ('rsExportDestination', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37301, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39440, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFileRemotePathName", "tnFileRemotePathName", 11275, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
