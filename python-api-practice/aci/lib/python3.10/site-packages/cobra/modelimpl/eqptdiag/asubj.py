...
# ##################################################
class ASubj(Mo):
    meta = ClassMeta("cobra.model.eqptdiag.ASubj")

    meta.isAbstract = True
    meta.moClassName = "eqptdiagASubj"
    ...
    meta.concreteSubClasses.add("cobra.model.eqptdiag.Subj")
    meta.concreteSubClasses.add("cobra.model.eqptdiag.OnDSubj")
    ...
    prop = PropMeta("str", "oDn", "oDn", 4074, PropCategory.REGULAR)
