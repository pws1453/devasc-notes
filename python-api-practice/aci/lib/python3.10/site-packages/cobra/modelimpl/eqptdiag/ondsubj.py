...
class OnDSubj(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiag.OnDSubj")

    meta.moClassName = "eqptdiagOnDSubj"
    meta.rnFormat = "subj-[%(oDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "On Demand Equipment Diag Subject"
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 3261, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14502, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oDn", "oDn", 6383, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 15618, PropCategory.REGULAR)
    prop.label = "Operational State"
    prop.isOper = True
    prop.defaultValue = 7
    prop.defaultValueStr = "not-tested"
