...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.unifiedports.Entity")

    meta.moClassName = "unifiedportsEntity"
    meta.rnFormat = "unifiedports"
    ...
    meta.childClasses.add("cobra.model.unifiedports.If")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.unifiedports.If", "if-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 39187, PropCategory.REGULAR)
