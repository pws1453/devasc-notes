...
# ##################################################
class UpdateDelegateHealthPayload(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.health.UpdateDelegateHealthPayload")

    meta.moClassName = "healthUpdateDelegateHealthPayload"
    meta.rnFormat = "udhp-[%(deliveryDn)s]"
    ...
    prop = PropMeta("str", "deliveryDn", "deliveryDn", 15994, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "isExisting", "isExisting", 15967, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 15970, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("nodeId", prop)

    prop = PropMeta("str", "observableDn", "observableDn", 15968, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("observableDn", prop)

    prop = PropMeta("str", "ownerSvcId", "ownerSvcId", 20270, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "podId", "podId", 15969, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    ...
    prop = PropMeta("str", "shardId", "shardId", 15971, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "termId", "termId", 20271, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "weight", "weight", 21293, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("undefined", "undefined", 4294967280)
