...
# ##################################################
class UpdateDelegateWeightPayload(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.health.UpdateDelegateWeightPayload")

    meta.moClassName = "healthUpdateDelegateWeightPayload"
    meta.rnFormat = "udwp-[%(deliveryDn)s]"
    ...
    prop = PropMeta("str", "deliveryDn", "deliveryDn", 16402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 16396, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("nodeId", prop)

    prop = PropMeta("str", "observableDn", "observableDn", 16394, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("observableDn", prop)

    prop = PropMeta("str", "ownerSvcId", "ownerSvcId", 20272, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "podId", "podId", 16395, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    ...
    prop = PropMeta("str", "shardId", "shardId", 16397, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "termId", "termId", 20273, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "weight", "weight", 16398, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
