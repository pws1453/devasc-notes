...
class LevelP(Mo):
    ...
    meta = ClassMeta("cobra.model.health.LevelP")

    meta.moClassName = "healthLevelP"
    meta.rnFormat = "lvl-%(high)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Health Score Level Policy"
    ...
    meta.childClasses.add("cobra.model.health.RtHealthLevelLocalP")
    meta.childClasses.add("cobra.model.health.RtHealthLevelP")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.health.RtHealthLevelLocalP", "rtfaultHealthLevelLocalP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.RtHealthLevelP", "rtfaultHealthLevelP-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "color", "color", 1420, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39690, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "high", "high", 1417, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "low", "low", 1418, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 100)]
    meta.props.add("low", prop)
    ...
    prop = PropMeta("str", "txtlabel", "txtlabel", 1419, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("txtlabel", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "high"))

    # Deployment Meta
    meta.deploymentQuery = True
    meta.deploymentType = "Policy"

    def __init__(self, parentMoOrDn, high, markDirty=True, **creationProps):
        namingVals = [high]
