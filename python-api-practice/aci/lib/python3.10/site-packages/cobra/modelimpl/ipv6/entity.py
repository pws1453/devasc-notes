...
class Entity(Mo):
    """
    The IPv6 entity information.

    """

    meta = ClassMeta("cobra.model.ipv6.Entity")

    meta.moClassName = "ipv6Entity"
    meta.rnFormat = "ipv6"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv6 Entity"
    ...
    meta.childClasses.add("cobra.model.ipv6.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ipv6.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14557, PropCategory.REGULAR)
