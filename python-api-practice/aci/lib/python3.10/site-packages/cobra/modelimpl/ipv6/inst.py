...
class Inst(Mo):
    """
    The IPv6 information. In the current implementation, only one instance of IPv6 is running in the system.

    """

    meta = ClassMeta("cobra.model.ipv6.Inst")

    meta.moClassName = "ipv6Inst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv6 Instance"
    ...
    meta.childClasses.add("cobra.model.ipv6.Dom")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ipv6.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14558, PropCategory.REGULAR)
