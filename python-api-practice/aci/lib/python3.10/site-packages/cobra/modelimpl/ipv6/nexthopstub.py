...
class NexthopStub(Mo):
    ...
    meta = ClassMeta("cobra.model.ipv6.NexthopStub")

    meta.moClassName = "ipv6NexthopStub"
    ...
    prop = PropMeta("str", "nhAddr", "nhAddr", 17456, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhIf", "nhIf", 17457, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhVrf", "nhVrf", 17458, PropCategory.REGULAR)
