...
class Nexthop(Mo):
    """
    The next hops for the static route.

    """

    meta = ClassMeta("cobra.model.ipv6.Nexthop")

    meta.moClassName = "ipv6Nexthop"
    meta.rnFormat = "nh-[%(nhIf)s]-addr-[%(nhAddr)s]-vrf-[%(nhVrf)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IPv6 Nexthop"
    ...
    prop = PropMeta("str", "ipv6CfgFailedBmp", "ipv6CfgFailedBmp", 18031, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("ipv6:NexthopLogicalDn_failed_flag", None, 8)
    prop._addConstant("ipv6:NexthopcachedRtCtrl_failed_flag", None, 16)
    prop._addConstant("ipv6:NexthopcontextId_failed_flag", None, 32)
    prop._addConstant("ipv6:Nexthopctrl_failed_flag", None, 64)
    prop._addConstant("ipv6:Nexthopdescr_failed_flag", None, 4)
    prop._addConstant("ipv6:NexthoplcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("ipv6:NexthopmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("ipv6:NexthopmonPolDn_failed_flag", None, 524288)
    prop._addConstant("ipv6:NexthopnameAlias_failed_flag", None, 2)
    prop._addConstant("ipv6:Nexthopname_failed_flag", None, 1)
    prop._addConstant("ipv6:NexthopnhAddr_failed_flag", None, 256)
    prop._addConstant("ipv6:NexthopnhIf_failed_flag", None, 512)
    prop._addConstant("ipv6:NexthopnhVrf_failed_flag", None, 1024)
    prop._addConstant("ipv6:Nexthoppref_failed_flag", None, 8192)
    prop._addConstant("ipv6:NexthoprwEncap_failed_flag", None, 16384)
    prop._addConstant("ipv6:NexthoptrackId_failed_flag", None, 32768)
    meta.props.add("ipv6CfgFailedBmp", prop)

    prop = PropMeta("str", "ipv6CfgFailedTs", "ipv6CfgFailedTs", 18033, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("ipv6CfgFailedTs", prop)

    prop = PropMeta("str", "ipv6CfgState", "ipv6CfgState", 18032, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14556, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhAddr", "nhAddr", 6687, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhIf", "nhIf", 6688, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nhVrf", "nhVrf", 6689, PropCategory.REGULAR)
