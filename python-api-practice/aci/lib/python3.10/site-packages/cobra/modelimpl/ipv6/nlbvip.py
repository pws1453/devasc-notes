...
class NlbVip(Mo):
    ...
    meta = ClassMeta("cobra.model.ipv6.NlbVip")

    meta.moClassName = "ipv6NlbVip"
    meta.rnFormat = "nlb-%(mode)s-mac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "NLB endpoint"
    ...
    meta.superClasses.add("cobra.model.ip.NlbVip")
    ...
    prop = PropMeta("str", "mac", "mac", 45609, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mfdmCfgFailedBmp", "mfdmCfgFailedBmp", 51782, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("ipv6:NlbVipfabEncapGrpIp_failed_flag", None, 32)
    prop._addConstant("ipv6:NlbVipfabEncap_failed_flag", None, 16)
    prop._addConstant("ipv6:NlbVipgroup_failed_flag", None, 64)
    prop._addConstant("ipv6:NlbViplcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("ipv6:NlbVipmac_failed_flag", None, 128)
    prop._addConstant("ipv6:NlbVipmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("ipv6:NlbVipmode_failed_flag", None, 256)
    prop._addConstant("ipv6:NlbVipmonPolDn_failed_flag", None, 16384)
    prop._addConstant("ipv6:NlbVipname_failed_flag", None, 1)
    prop._addConstant("ipv6:NlbVippcTag_failed_flag", None, 1024)
    meta.props.add("mfdmCfgFailedBmp", prop)

    prop = PropMeta("str", "mfdmCfgFailedTs", "mfdmCfgFailedTs", 51784, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("mfdmCfgFailedTs", prop)

    prop = PropMeta("str", "mfdmCfgState", "mfdmCfgState", 51783, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("mfdmCfgState", prop)
    ...
    prop = PropMeta("str", "mode", "mode", 45610, PropCategory.REGULAR)
    prop.label = "NLB mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51778, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "mode"))
    meta.namingProps.append(getattr(meta.props, "mac"))

    def __init__(self, parentMoOrDn, mode, mac, markDirty=True, **creationProps):
        namingVals = [mode, mac]
