...
# ##################################################
class RsDeployedFex(Mo):
    """
     Deployed Fex 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsDeployedFex", "cobra.model.planner.FexTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "plannerRsDeployedFex"
    meta.rnFormat = "rsdeployedFex-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Deployed Fexs"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38302, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "count", "count", 21271, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40441, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21273, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7183
    prop.defaultValueStr = "plannerFexTmpl"
    prop._addConstant("plannerFexTmpl", None, 7183)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21272, PropCategory.REGULAR)
