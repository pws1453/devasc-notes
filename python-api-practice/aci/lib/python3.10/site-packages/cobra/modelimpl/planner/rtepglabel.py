...
class RtEpgLabel(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.planner.RtEpgLabel", "cobra.model.planner.AEpg")

    meta.moClassName = "plannerRtEpgLabel"
    meta.rnFormat = "rtepgLabel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21313, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21312, PropCategory.REGULAR)
