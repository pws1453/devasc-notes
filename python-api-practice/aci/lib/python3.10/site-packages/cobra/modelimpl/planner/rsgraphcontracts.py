...
# ##################################################
class RsGraphContracts(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.planner.RsGraphContracts", "cobra.model.planner.ContractTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "plannerRsGraphContracts"
    meta.rnFormat = "rsgraphContracts-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsgraphContracts-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38290, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40429, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21161, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21119, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21118, PropCategory.REGULAR)
