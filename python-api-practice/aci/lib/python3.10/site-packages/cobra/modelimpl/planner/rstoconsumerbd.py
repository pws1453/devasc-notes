...
# ##################################################
class RsToConsumerBd(Mo):
    """
     Consumer side Bridge Domain (for goto-two-arm) 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsToConsumerBd", "cobra.model.planner.BdTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsToConsumerBd"
    meta.rnFormat = "rstoConsumerBd"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "To Consumer Bd"
    ...
    meta.rnPrefixes = [
        ('rstoConsumerBd', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38294, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40433, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21165, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21131, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7119
    prop.defaultValueStr = "plannerBdTmpl"
    prop._addConstant("plannerBdTmpl", None, 7119)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21233, PropCategory.REGULAR)
