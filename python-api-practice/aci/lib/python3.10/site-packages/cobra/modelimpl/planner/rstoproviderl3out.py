...
# ##################################################
class RsToProviderL3Out(Mo):
    """
     Provider side L3Out (for goto-two-arm) 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsToProviderL3Out", "cobra.model.planner.L3OutTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsToProviderL3Out"
    meta.rnFormat = "rstoProviderL3Out"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "To Provider L3Out"
    ...
    meta.rnPrefixes = [
        ('rstoProviderL3Out', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38297, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40436, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21168, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21143, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21236, PropCategory.REGULAR)
