...
class RsEpgLabel(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.planner.RsEpgLabel", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsEpgLabel"
    meta.rnFormat = "rsepgLabel"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38309, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40448, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21339, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21311, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7200
    prop.defaultValueStr = "plannerLabel"
    prop._addConstant("plannerLabel", None, 7200)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21310, PropCategory.REGULAR)
