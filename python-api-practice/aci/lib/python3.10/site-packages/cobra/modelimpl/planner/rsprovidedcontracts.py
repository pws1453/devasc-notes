...
# ##################################################
class RsProvidedContracts(Mo):
    """
     Contracts provided by this epg 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsProvidedContracts", "cobra.model.planner.ContractTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "plannerRsProvidedContracts"
    meta.rnFormat = "rsprovidedContracts-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Provided Contracts"
    ...
    meta.rnPrefixes = [
        ('rsprovidedContracts-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38280, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40419, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21151, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21099, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7117
    prop.defaultValueStr = "plannerContractTmpl"
    prop._addConstant("plannerContractTmpl", None, 7117)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21098, PropCategory.REGULAR)
