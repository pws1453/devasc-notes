...
class RsGraphBd(Mo):
    """
     Graph Bridge Domain (for goto-one-arm) 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsGraphBd", "cobra.model.planner.BdTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsGraphBd"
    meta.rnFormat = "rsgraphBd"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38292, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40431, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21163, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21231, PropCategory.REGULAR)
