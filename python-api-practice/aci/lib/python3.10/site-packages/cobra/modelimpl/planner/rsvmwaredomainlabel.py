...
# ##################################################
class RsVmwareDomainLabel(Mo):
    """
     Label for this domain 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsVmwareDomainLabel", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsVmwareDomainLabel"
    meta.rnFormat = "rsvmwareDomainLabel"
    ...
    meta.rnPrefixes = [
        ('rsvmwareDomainLabel', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38373, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40512, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22885, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22852, PropCategory.REGULAR)
