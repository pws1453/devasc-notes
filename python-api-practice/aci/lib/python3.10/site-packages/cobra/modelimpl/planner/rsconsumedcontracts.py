...
# ##################################################
class RsConsumedContracts(Mo):
    """
     Contracts consumed by this epg 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsConsumedContracts", "cobra.model.planner.ContractTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "plannerRsConsumedContracts"
    meta.rnFormat = "rsconsumedContracts-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Consumed Contracts"
    ...
    meta.rnPrefixes = [
        ('rsconsumedContracts-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38281, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40420, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21152, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21095, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21094, PropCategory.REGULAR)
