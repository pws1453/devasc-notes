...
class RsL3OutVrf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.planner.RsL3OutVrf", "cobra.model.planner.VrfTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsL3OutVrf"
    meta.rnFormat = "rsl3OutVrf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38285, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40424, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21111, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7118
    prop.defaultValueStr = "plannerVrfTmpl"
    prop._addConstant("plannerVrfTmpl", None, 7118)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21229, PropCategory.REGULAR)
