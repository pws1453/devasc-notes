...
# ##################################################
class RsGraphCluster(Mo):
    """
     L4L7 Cluster 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsGraphCluster", "cobra.model.planner.L4L7ClusterTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsGraphCluster"
    meta.rnFormat = "rsgraphCluster"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L4L7 Cluster"
    ...
    meta.rnPrefixes = [
        ('rsgraphCluster', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38335, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40474, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21994, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7139
    prop.defaultValueStr = "plannerL4L7ClusterTmpl"
    prop._addConstant("plannerL4L7ClusterTmpl", None, 7139)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21993, PropCategory.REGULAR)
