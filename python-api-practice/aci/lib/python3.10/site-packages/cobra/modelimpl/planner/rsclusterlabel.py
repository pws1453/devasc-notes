...
# ##################################################
class RsClusterLabel(Mo):
    """
     Label for this Cluster 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsClusterLabel", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsClusterLabel"
    meta.rnFormat = "rsclusterLabel"
    ...
    meta.rnPrefixes = [
        ('rsclusterLabel', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38334, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40473, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21998, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21990, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21989, PropCategory.REGULAR)
