...
class RsFexLabel(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.planner.RsFexLabel", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsFexLabel"
    meta.rnFormat = "rsfexLabel"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38307, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40446, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21337, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21331, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21330, PropCategory.REGULAR)
