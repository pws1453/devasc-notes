...
# ##################################################
class RsConnectedSpine(Mo):
    """
     Spine this leaf is connected to 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsConnectedSpine", "cobra.model.planner.SpineTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsConnectedSpine"
    meta.rnFormat = "rsconnectedSpine"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Connected Spine"
    ...
    meta.rnPrefixes = [
        ('rsconnectedSpine', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38325, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40464, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21492, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21489, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7283
    prop.defaultValueStr = "plannerSpineTmpl"
    prop._addConstant("plannerSpineTmpl", None, 7283)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21488, PropCategory.REGULAR)
