...
class LeafTmpl(Mo):
    ...
    meta = ClassMeta("cobra.model.planner.LeafTmpl")

    meta.moClassName = "plannerLeafTmpl"
    ...
    meta.childClasses.add("cobra.model.planner.RsConnectedSpine")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.planner.RsLeafLabels")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.planner.RtConnectedLeaf")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.planner.RsConnectedSpine", "rsconnectedSpine"))
    meta.childNamesAndRnPrefix.append(("cobra.model.planner.RtConnectedLeaf", "rtconnectedLeaf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.planner.RsLeafLabels", "rsleafLabels-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38300, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "count", "count", 21259, PropCategory.REGULAR)
    prop.label = "Count of leafs"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40439, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "model", "model", 21261, PropCategory.REGULAR)
    prop.label = "Model"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21334, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 21270, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
