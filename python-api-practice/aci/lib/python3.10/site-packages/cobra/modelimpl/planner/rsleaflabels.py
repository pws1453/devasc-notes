...
# ##################################################
class RsLeafLabels(Mo):
    """
     Lables assigned to leaf 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsLeafLabels", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "plannerRsLeafLabels"
    meta.rnFormat = "rsleafLabels-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38306, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40445, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21336, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21323, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21322, PropCategory.REGULAR)
