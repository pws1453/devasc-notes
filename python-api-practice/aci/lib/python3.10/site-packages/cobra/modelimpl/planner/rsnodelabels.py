...
# ##################################################
class RsNodeLabels(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.planner.RsNodeLabels", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "plannerRsNodeLabels"
    meta.rnFormat = "rsnodeLabels-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21319, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21318, PropCategory.REGULAR)
