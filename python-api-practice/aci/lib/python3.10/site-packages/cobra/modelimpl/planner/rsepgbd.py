...
class RsEpgBd(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.planner.RsEpgBd", "cobra.model.planner.BdTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsEpgBd"
    meta.rnFormat = "rsepgBd"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38283, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40422, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21227, PropCategory.REGULAR)
