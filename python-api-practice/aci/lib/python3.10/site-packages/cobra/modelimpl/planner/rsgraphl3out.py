...
# ##################################################
class RsGraphL3Out(Mo):
    """
     Graph L3Out (for goto-one-arm) 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsGraphL3Out", "cobra.model.planner.L3OutTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsGraphL3Out"
    meta.rnFormat = "rsgraphL3Out"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40432, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21164, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21127, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21232, PropCategory.REGULAR)
