...
class RsBdVrf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.planner.RsBdVrf", "cobra.model.planner.VrfTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsBdVrf"
    meta.rnFormat = "rsbdVrf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38279, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40418, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21150, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21091, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21226, PropCategory.REGULAR)
