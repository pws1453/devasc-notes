...
# ##################################################
class RsDeployedObject(Mo):
    """
     Deployed Object 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsDeployedObject", "cobra.model.planner.ATmpl")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "plannerRsDeployedObject"
    meta.rnFormat = "rsdeployedObject-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Deployed Objects"
    ...
    meta.rnPrefixes = [
        ('rsdeployedObject-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38299, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "count", "count", 21237, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40438, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "inst", "inst", 21238, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21245, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21240, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7291
    prop.defaultValueStr = "plannerATmpl"
    ...
    prop = PropMeta("str", "tDn", "tDn", 21239, PropCategory.REGULAR)
