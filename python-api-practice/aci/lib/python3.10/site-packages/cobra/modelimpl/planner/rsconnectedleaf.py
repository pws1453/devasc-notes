...
# ##################################################
class RsConnectedLeaf(Mo):
    """
     Leaf this fex is connected to 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsConnectedLeaf", "cobra.model.planner.LeafTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsConnectedLeaf"
    meta.rnFormat = "rsconnectedLeaf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Connected Leaf"
    ...
    meta.rnPrefixes = [
        ('rsconnectedLeaf', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38308, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40447, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21338, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21327, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7182
    prop.defaultValueStr = "plannerLeafTmpl"
    prop._addConstant("plannerLeafTmpl", None, 7182)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21326, PropCategory.REGULAR)
