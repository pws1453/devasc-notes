...
class RsL2OutBd(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.planner.RsL2OutBd", "cobra.model.planner.BdTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsL2OutBd"
    meta.rnFormat = "rsl2OutBd"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38287, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40426, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21159, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21230, PropCategory.REGULAR)
