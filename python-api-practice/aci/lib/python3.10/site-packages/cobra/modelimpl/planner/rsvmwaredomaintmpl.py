...
# ##################################################
class RsVmwareDomainTmpl(Mo):
    """
     Vmware Domain Template 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsVmwareDomainTmpl", "cobra.model.planner.VmwareDomainTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsVmwareDomainTmpl"
    meta.rnFormat = "rsvmwareDomainTmpl"
    ...
    meta.rnPrefixes = [
        ('rsvmwareDomainTmpl', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38378, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40517, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22889, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22861, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7742
    prop.defaultValueStr = "plannerVmwareDomainTmpl"
    prop._addConstant("plannerVmwareDomainTmpl", None, 7742)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22860, PropCategory.REGULAR)
