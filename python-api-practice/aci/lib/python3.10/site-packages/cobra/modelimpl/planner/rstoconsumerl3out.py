...
# ##################################################
class RsToConsumerL3Out(Mo):
    """
     Consumer side l3out (for goto-two-arm) 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsToConsumerL3Out", "cobra.model.planner.L3OutTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsToConsumerL3Out"
    meta.rnFormat = "rstoConsumerL3Out"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "To Consumer L3Out"
    ...
    meta.rnPrefixes = [
        ('rstoConsumerL3Out', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40434, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21166, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21135, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7133
    prop.defaultValueStr = "plannerL3OutTmpl"
    prop._addConstant("plannerL3OutTmpl", None, 7133)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21234, PropCategory.REGULAR)
