...
# ##################################################
class RsToProviderBd(Mo):
    """
     Provider side Bridge Domain (for goto-two-arm) 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsToProviderBd", "cobra.model.planner.BdTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsToProviderBd"
    meta.rnFormat = "rstoProviderBd"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "To Provider Bd"
    ...
    meta.rnPrefixes = [
        ('rstoProviderBd', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38296, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40435, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21167, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 21139, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21235, PropCategory.REGULAR)
