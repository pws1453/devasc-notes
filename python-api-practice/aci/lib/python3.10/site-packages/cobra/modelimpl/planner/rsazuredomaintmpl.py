...
# ##################################################
class RsAzureDomainTmpl(Mo):
    """
     Azure Domain Template 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsAzureDomainTmpl", "cobra.model.planner.AzureDomainTmpl")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsAzureDomainTmpl"
    meta.rnFormat = "rsazureDomainTmpl"
    ...
    meta.rnPrefixes = [
        ('rsazureDomainTmpl', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40519, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22891, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22865, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7745
    prop.defaultValueStr = "plannerAzureDomainTmpl"
    prop._addConstant("plannerAzureDomainTmpl", None, 7745)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22864, PropCategory.REGULAR)
