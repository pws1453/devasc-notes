...
class Options(Mo):
    ...
    meta = ClassMeta("cobra.model.planner.Options")

    meta.moClassName = "plannerOptions"
    meta.rnFormat = "options"
    meta.category = MoCategory.REGULAR
    meta.label = "Optimizer Options"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38298, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40437, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ignoreTopology", "ignoreTopology", 21483, PropCategory.REGULAR)
    prop.label = "Use ingress ACLs feature"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("ignoreTopology", prop)
    ...
    prop = PropMeta("str", "switchModel", "switchModel", 21216, PropCategory.REGULAR)
    prop.label = "Switch hardware model"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("switchModel", prop)
