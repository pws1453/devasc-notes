...
# ##################################################
class RsExistingTopoDeplPref(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.planner.RsExistingTopoDeplPref", "cobra.model.planner.ExistingTopoDeplPref")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "plannerRsExistingTopoDeplPref"
    meta.rnFormat = "rsexistingTopoDeplPref"
    ...
    meta.rnPrefixes = [
        ('rsexistingTopoDeplPref', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38721, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40860, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33575, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33573, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10784
    prop.defaultValueStr = "plannerExistingTopoDeplPref"
    prop._addConstant("plannerExistingTopoDeplPref", None, 10784)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33572, PropCategory.REGULAR)
