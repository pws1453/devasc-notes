...
# ##################################################
class RsAzureDomainLabel(Mo):
    """
     Label for this domain 

    """

    meta = SourceRelationMeta("cobra.model.planner.RsAzureDomainLabel", "cobra.model.planner.Label")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "plannerRsAzureDomainLabel"
    meta.rnFormat = "rsazureDomainLabel"
    ...
    meta.rnPrefixes = [
        ('rsazureDomainLabel', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38375, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40514, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22857, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22856, PropCategory.REGULAR)
