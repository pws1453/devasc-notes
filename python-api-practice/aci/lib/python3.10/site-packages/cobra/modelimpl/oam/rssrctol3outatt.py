...
# ##################################################
class RsSrcToL3OutAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.oam.RsSrcToL3OutAtt", "cobra.model.l3.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "oamRsSrcToL3OutAtt"
    meta.rnFormat = "rssrcToL3OutAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L3 out interface"
    ...
    meta.rnPrefixes = [
        ('rssrcToL3OutAtt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43540, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43541, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 43498, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3758
    prop.defaultValueStr = "l3If"
    ...
    prop = PropMeta("str", "tDn", "tDn", 43497, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 43556, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
