...
class RsSrcEncap(Mo):
    """
    A source relation to an 802.1q VLAN. This object indicates the VLAN an endpoint belongs to.

    """

    meta = SourceRelationMeta("cobra.model.oam.RsSrcEncap", "cobra.model.vlan.CktEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "oamRsSrcEncap"
    meta.rnFormat = "rssrcEncap"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Source Encapsulation Attachment"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37742, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39881, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15579, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12606, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3390
    prop.defaultValueStr = "vlanCktEp"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vlanCktEp", None, 3390)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12605, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15039, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
