...
# ##################################################
class RsEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hvs.RsEnhancedLagPol", "cobra.model.lacp.EnhancedLagPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsEnhancedLagPol"
    meta.rnFormat = "rsEnhancedLagPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Abstraction of Enhanced LACP Lag Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44372, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12857
    prop.defaultValueStr = "lacpEnhancedLagPolDef"
    prop._addConstant("lacpEnhancedLagPolDef", None, 12857)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 44371, PropCategory.REGULAR)
