...
class RsCompHv(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsCompHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "hvsRsCompHv"
    meta.rnFormat = "rscompHv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44750, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 44747, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44746, PropCategory.REGULAR)
