...
class PvlanCont(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.PvlanCont")

    meta.moClassName = "hvsPvlanCont"
    meta.rnFormat = "pvlan"
    ...
    meta.childClasses.add("cobra.model.hvs.PvlanEntry")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.PvlanEntry", "sec-"))
    ...
    prop = PropMeta("str", "descr", "descr", 23448, PropCategory.REGULAR)
