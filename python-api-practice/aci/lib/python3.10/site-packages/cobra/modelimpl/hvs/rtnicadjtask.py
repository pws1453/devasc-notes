...
# ##################################################
class RtNicAdjTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.hvs.RtNicAdjTask")

    meta.moClassName = "hvsRtNicAdjTask"
    meta.rnFormat = "hvsRtNicAdjTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5766, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("reportLooseNode", "reportloosenode", 189)
