...
class SecGrp(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.SecGrp")

    meta.moClassName = "hvsSecGrp"
    meta.rnFormat = "secgrp-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Security group"
    ...
    meta.childClasses.add("cobra.model.hvs.RsEpCPAtt")
    meta.childClasses.add("cobra.model.hvs.IpSet")
    meta.childClasses.add("cobra.model.hvs.MacSet")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RsEpCPAtt", "rsEpCPAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.MacSet", "macset-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.IpSet", "ipset-"))
    ...
    meta.superClasses.add("cobra.model.hvs.UsegContE")
    ...
    prop = PropMeta("str", "eppDn", "eppDn", 23398, PropCategory.REGULAR)
    prop.label = "EpP Dn"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23537, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 23467, PropCategory.REGULAR)
    prop.label = "Object id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "oname", "oname", 23395, PropCategory.REGULAR)
    prop.label = "Object name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("oname", prop)

    prop = PropMeta("str", "remoteOperIssues", "remoteOperIssues", 23397, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
