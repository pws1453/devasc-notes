...
class RsExtPol(Mo):
    """
    A source relation to the common policies for the interfaces on VMs.

    """

    meta = SourceRelationMeta("cobra.model.hvs.RsExtPol", "cobra.model.hvs.ExtPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsExtPol"
    meta.rnFormat = "rsExtPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11243, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11242, PropCategory.REGULAR)
