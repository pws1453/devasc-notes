...
class Rule(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.Rule")

    meta.moClassName = "hvsRule"
    meta.rnFormat = "rule-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "firewall rule"
    ...
    meta.childClasses.add("cobra.model.hvs.RsToEPgAtt")
    meta.childClasses.add("cobra.model.hvs.RsRule")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RsToEPgAtt", "rsToEPgAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RsRule", "rsrule-"))
    ...
    prop = PropMeta("str", "oid", "oid", 23466, PropCategory.REGULAR)
