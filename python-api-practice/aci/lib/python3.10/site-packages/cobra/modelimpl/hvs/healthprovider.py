...
# ##################################################
class HealthProvider(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hvs.HealthProvider")

    meta.moClassName = "hvsHealthProvider"
    meta.rnFormat = "healthp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Host Health Provider"
    ...
    meta.childClasses.add("cobra.model.hvs.RsCompHv")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.hvs.HvHealth")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RsCompHv", "rscompHv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.HvHealth", "hvhealth-"))
    ...
    prop = PropMeta("str", "description", "description", 44720, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44749, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 44742, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "uid", "uid", 44721, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
