...
class IpSetTask(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.IpSetTask")

    meta.moClassName = "hvsIpSetTask"
    meta.rnFormat = "hvsIpSetTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23456, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegIpSet", "addordelusegipset", 2089)
