...
class RtPvlan2(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hvs.RtPvlan2", "cobra.model.hvs.ExtPol")

    meta.moClassName = "hvsRtPvlan2"
    meta.rnFormat = "rtpvlan2-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26361, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26360, PropCategory.REGULAR)
