...
class RsLsNode(Mo):
    """
    A source relation to an externally connected node.

    """

    meta = SourceRelationMeta("cobra.model.hvs.RsLsNode", "cobra.model.fabric.LooseNode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsLsNode"
    meta.rnFormat = "rsLsNode"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Loose Node"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11247, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11246, PropCategory.REGULAR)
