...
class ExtPolTask(Mo):
    """
    The external policy task.

    """

    meta = ClassMeta("cobra.model.hvs.ExtPolTask")

    meta.moClassName = "hvsExtPolTask"
    meta.rnFormat = "hvsExtPolTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5764, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Update", "update", 141)
    prop._addConstant("none", "none", 0)
    prop._addConstant("setExtPolInfo", "setextpolinfo", 161)
