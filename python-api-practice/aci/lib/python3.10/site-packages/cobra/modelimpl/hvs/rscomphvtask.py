...
# ##################################################
class RsCompHvTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hvs.RsCompHvTask")

    meta.moClassName = "hvsRsCompHvTask"
    meta.rnFormat = "hvsRsCompHvTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44741, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("addHvToHealthProvider", "addhvtohealthprovider", 3229)
