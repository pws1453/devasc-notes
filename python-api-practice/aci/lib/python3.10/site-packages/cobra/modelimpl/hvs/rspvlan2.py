...
class RsPvlan2(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsPvlan2", "cobra.model.hvs.PvlanEntry")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsPvlan2"
    meta.rnFormat = "rsPvlan2"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26359, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26358, PropCategory.REGULAR)
