...
class RsRFltPAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsRFltPAtt", "cobra.model.comp.RFltP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hvsRsRFltPAtt"
    meta.rnFormat = "rsRFltPAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24275, PropCategory.REGULAR)
