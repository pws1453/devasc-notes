...
class MbrCont(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.MbrCont")

    meta.moClassName = "hvsMbrCont"
    meta.rnFormat = "mbrcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Controller Member MAC/IP Container"
    ...
    meta.childClasses.add("cobra.model.hvs.MbrMac")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.MbrMac", "mbrmac-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24290, PropCategory.REGULAR)
