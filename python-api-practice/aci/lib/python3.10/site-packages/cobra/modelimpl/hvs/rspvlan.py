...
class RsPvlan(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsPvlan", "cobra.model.hvs.PvlanEntry")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hvsRsPvlan"
    meta.rnFormat = "rsPvlan"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23475, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23474, PropCategory.REGULAR)
