...
class HvHealth(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.HvHealth")

    meta.moClassName = "hvsHvHealth"
    meta.rnFormat = "hvhealth-%(hostoid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Host Health Update"
    ...
    prop = PropMeta("str", "health", "health", 44725, PropCategory.REGULAR)
    prop.label = "Entity State"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "hostoid", "hostoid", 44722, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "remediation", "remediation", 44724, PropCategory.REGULAR)
    prop.label = "Description of the required step to resolve the issue"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "updateId", "updateId", 44723, PropCategory.REGULAR)
    prop.label = "Id of the health update"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("updateId", prop)

    meta.namingProps.append(getattr(meta.props, "hostoid"))

    def __init__(self, parentMoOrDn, hostoid, markDirty=True, **creationProps):
        namingVals = [hostoid]
