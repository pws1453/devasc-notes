...
class RsToEPgAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsToEPgAtt", "cobra.model.comp.ToEPg")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hvsRsToEPgAtt"
    meta.rnFormat = "rsToEPgAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to compToEPg"
    ...
    meta.parentClasses.add("cobra.model.hvs.Rule")
    ...
    prop = PropMeta("str", "tCl", "tCl", 24273, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7980
    prop.defaultValueStr = "compToEPg"
    prop._addConstant("compToEPg", None, 7980)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24272, PropCategory.REGULAR)
