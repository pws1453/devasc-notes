...
class Svc(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.Svc")

    meta.moClassName = "hvsSvc"
    meta.rnFormat = "svc-%(oid)s"
    ...
    meta.parentClasses.add("cobra.model.hvs.SvcGrp")
    ...
    prop = PropMeta("str", "oid", "oid", 23468, PropCategory.REGULAR)
