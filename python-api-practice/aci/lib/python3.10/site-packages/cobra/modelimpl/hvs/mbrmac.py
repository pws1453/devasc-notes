...
class MbrMac(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.MbrMac")

    meta.moClassName = "hvsMbrMac"
    meta.rnFormat = "mbrmac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Controller Member MAC"
    ...
    meta.superClasses.add("cobra.model.hvs.ContE")
    ...
    prop = PropMeta("str", "eppDn", "eppDn", 24252, PropCategory.REGULAR)
    prop.label = "EpP Dn"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 24250, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24291, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "remoteOperIssues", "remoteOperIssues", 23389, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "sgcnt", "sgcnt", 24251, PropCategory.REGULAR)
    prop.label = "Number of Security Groups Belong to"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("sgcnt", prop)
