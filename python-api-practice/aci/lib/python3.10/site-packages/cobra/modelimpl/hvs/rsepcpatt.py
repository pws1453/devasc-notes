...
class RsEpCPAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsEpCPAtt", "cobra.model.comp.EpCP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hvsRsEpCPAtt"
    meta.rnFormat = "rsEpCPAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to compEpCP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23522, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8212
    prop.defaultValueStr = "compEpCP"
    prop._addConstant("compEpCP", None, 8212)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23521, PropCategory.REGULAR)
