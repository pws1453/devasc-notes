...
class IpSet(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.IpSet")

    meta.moClassName = "hvsIpSet"
    meta.rnFormat = "ipset-%(oid)s"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23529, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 24265, PropCategory.REGULAR)
