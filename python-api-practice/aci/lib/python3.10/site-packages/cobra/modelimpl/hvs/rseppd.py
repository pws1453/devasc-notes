...
class RsEpPD(Mo):
    """
    A source relation to the abstraction for the endpoint group policy description.

    """

    meta = SourceRelationMeta("cobra.model.hvs.RsEpPD", "cobra.model.comp.EpPD")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsEpPD"
    meta.rnFormat = "rsEpPD"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11239, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11238, PropCategory.REGULAR)
