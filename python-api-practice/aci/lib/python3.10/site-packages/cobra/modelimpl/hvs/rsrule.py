...
class RsRule(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hvs.RsRule", "cobra.model.hvs.SvcGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hvsRsRule"
    meta.rnFormat = "rsrule-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to hvsSvcGrp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24269, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7967
    prop.defaultValueStr = "hvsSvcGrp"
    prop._addConstant("hvsSvcGrp", None, 7967)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24268, PropCategory.REGULAR)
