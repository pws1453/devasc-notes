...
class RtLNode(Mo):
    """
    A target relation to the logical node.

    """

    meta = TargetRelationMeta("cobra.model.hvs.RtLNode", "cobra.model.fv.VNode")

    meta.moClassName = "hvsRtLNode"
    meta.rnFormat = "rtfvLNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12432, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12431, PropCategory.REGULAR)
