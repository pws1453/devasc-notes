...
class MacSetTask(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.MacSetTask")

    meta.moClassName = "hvsMacSetTask"
    meta.rnFormat = "hvsMacSetTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23457, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelUsegMacSet", "addordelusegmacset", 2090)
