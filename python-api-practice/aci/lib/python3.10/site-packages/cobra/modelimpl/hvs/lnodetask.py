...
class LNodeTask(Mo):
    """
    The logical node task.

    """

    meta = ClassMeta("cobra.model.hvs.LNodeTask")

    meta.moClassName = "hvsLNodeTask"
    meta.rnFormat = "hvsLNodeTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5765, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AddorDelBlackHolePortGroup", "addordelblackholeportgroup", 1689)
    prop._addConstant("AddorDelOutsideCloudPortGroup", "addordeloutsidecloudportgroup", 3200)
    prop._addConstant("AddorDelUplinkPortGroup", "addordeluplinkportgroup", 151)
    prop._addConstant("AddorDelVtepPortGroup", "addordelvtepportgroup", 152)
