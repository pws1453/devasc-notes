...
class SvcGrp(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.SvcGrp")

    meta.moClassName = "hvsSvcGrp"
    meta.rnFormat = "svcgrp-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.hvs.Svc")
    meta.childClasses.add("cobra.model.hvs.RsRFltPAtt")
    meta.childClasses.add("cobra.model.hvs.RtRule")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RsRFltPAtt", "rsRFltPAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RtRule", "rtrule-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.Svc", "svc-"))
    ...
    prop = PropMeta("str", "oid", "oid", 23469, PropCategory.REGULAR)
