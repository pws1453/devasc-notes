...
class MbrMacTask(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.MbrMacTask")

    meta.moClassName = "hvsMbrMacTask"
    meta.rnFormat = "hvsMbrMacTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24264, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateUsegMbrMac", "updateusegmbrmac", 2137)
