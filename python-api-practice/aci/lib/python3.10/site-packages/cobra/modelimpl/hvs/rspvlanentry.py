...
# ##################################################
class RsPvlanEntry(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hvs.RsPvlanEntry", "cobra.model.comp.PvlanEntry")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "hvsRsPvlanEntry"
    meta.rnFormat = "rsPvlanEntry"
    ...
    meta.parentClasses.add("cobra.model.hvs.PvlanEntry")
    ...
    prop = PropMeta("str", "tCl", "tCl", 25161, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7978
    prop.defaultValueStr = "compPvlanEntry"
    prop._addConstant("compPvlanEntry", None, 7978)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25160, PropCategory.REGULAR)
