...
# ##################################################
class RsLsNodeToIf(Mo):
    """
    A source relation to an abstraction of Ethernet interface properties that are common between Ethernet physical interfaces and aggregated interfaces.

    """

    meta = SourceRelationMeta("cobra.model.leqpt.RsLsNodeToIf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "leqptRsLsNodeToIf"
    meta.rnFormat = "rslsNodeToIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12690, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12689, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15065, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
