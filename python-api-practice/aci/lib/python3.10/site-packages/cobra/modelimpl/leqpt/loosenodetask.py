...
# ##################################################
class LooseNodeTask(Mo):
    """
    An internal task object used by an unmanaged node.

    """

    meta = ClassMeta("cobra.model.leqpt.LooseNodeTask")

    meta.moClassName = "leqptLooseNodeTask"
    meta.rnFormat = "leqptLooseNodeTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5665, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("reportLooseNode", "reportloosenode", 228)
    prop._addConstant("reportPathGrp", "reportpathgrp", 1458)
