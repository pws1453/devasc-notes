...
# ##################################################
class RsLsNodeToIfTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.leqpt.RsLsNodeToIfTask")

    meta.moClassName = "leqptRsLsNodeToIfTask"
    meta.rnFormat = "leqptRsLsNodeToIfTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 49824, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportEncapsOnLooseNodePath", "reportencapsonloosenodepath", 3324)
