...
# ##################################################
class RsLsAttLink(Mo):
    """
    An internal relation for policy resolution.

    """

    meta = SourceRelationMeta("cobra.model.leqpt.RsLsAttLink", "cobra.model.fabric.LooseNode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "leqptRsLsAttLink"
    meta.rnFormat = "rsLsAttLink"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Unmanaged Fabric Node"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12686, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 498
    prop.defaultValueStr = "fabricLooseNode"
    prop._addConstant("fabricLooseNode", None, 498)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12685, PropCategory.REGULAR)
