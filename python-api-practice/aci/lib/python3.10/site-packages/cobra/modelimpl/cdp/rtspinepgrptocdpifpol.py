...
# ##################################################
class RtSpinePGrpToCdpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtSpinePGrpToCdpIfPol", "cobra.model.infra.SpineAccNodePGrp")

    meta.moClassName = "cdpRtSpinePGrpToCdpIfPol"
    meta.rnFormat = "rtinfraSpinePGrpToCdpIfPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtinfraSpinePGrpToCdpIfPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 54536, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54535, PropCategory.REGULAR)
