...
# ##################################################
class RtResCdpIfPol(Mo):
    """
    A target relation to the CDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtResCdpIfPol", "cobra.model.infra.Infra")

    meta.moClassName = "cdpRtResCdpIfPol"
    meta.rnFormat = "rtresCdpIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13287, PropCategory.REGULAR)
