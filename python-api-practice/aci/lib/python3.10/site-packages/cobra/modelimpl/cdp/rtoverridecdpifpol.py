...
# ##################################################
class RtOverrideCdpIfPol(Mo):
    """
    A target relation to the CDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtOverrideCdpIfPol", "cobra.model.infra.AttPolicyGroup")

    meta.moClassName = "cdpRtOverrideCdpIfPol"
    meta.rnFormat = "rtinfraOverrideCdpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13275, PropCategory.REGULAR)
