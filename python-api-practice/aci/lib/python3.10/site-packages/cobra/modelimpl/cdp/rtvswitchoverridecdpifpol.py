...
# ##################################################
class RtVswitchOverrideCdpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtVswitchOverrideCdpIfPol", "cobra.model.vmm.VSwitchPolicyCont")

    meta.moClassName = "cdpRtVswitchOverrideCdpIfPol"
    meta.rnFormat = "rtvmmVswitchOverrideCdpIfPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvmmVswitchOverrideCdpIfPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23001, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23000, PropCategory.REGULAR)
