...
class IfPolDef(Mo):
    """
    The read only copy of CDP interface policy.

    """

    meta = ClassMeta("cobra.model.cdp.IfPolDef")

    meta.moClassName = "cdpIfPolDef"
    meta.rnFormat = "cdpIfPD-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "CDP Policy"
    ...
    prop = PropMeta("str", "name", "name", 5899, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
