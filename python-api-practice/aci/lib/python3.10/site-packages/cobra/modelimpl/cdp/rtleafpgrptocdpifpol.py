...
# ##################################################
class RtLeafPGrpToCdpIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtLeafPGrpToCdpIfPol", "cobra.model.infra.AccNodePGrp")

    meta.moClassName = "cdpRtLeafPGrpToCdpIfPol"
    meta.rnFormat = "rtinfraLeafPGrpToCdpIfPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtinfraLeafPGrpToCdpIfPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 54528, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54527, PropCategory.REGULAR)
