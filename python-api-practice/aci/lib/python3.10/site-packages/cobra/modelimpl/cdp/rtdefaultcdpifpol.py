...
# ##################################################
class RtDefaultCdpIfPol(Mo):
    """
    A target relation to the CDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtDefaultCdpIfPol", "cobra.model.vmm.DomP")

    meta.moClassName = "cdpRtDefaultCdpIfPol"
    meta.rnFormat = "rtvmmDefaultCdpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12470, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12469, PropCategory.REGULAR)
