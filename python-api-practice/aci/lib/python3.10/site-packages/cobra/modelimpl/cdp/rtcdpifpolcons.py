...
# ##################################################
class RtCdpIfPolCons(Mo):
    """
    A target relation to a CDP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtCdpIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "cdpRtCdpIfPolCons"
    meta.rnFormat = "rtl1CdpIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12753, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12752, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15110, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
