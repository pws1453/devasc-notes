...
class RtCdpIfPol(Mo):
    """
    A target relation to physical interface configuration policy.

    """

    meta = TargetRelationMeta("cobra.model.cdp.RtCdpIfPol", "cobra.model.infra.AAccGrp")

    meta.moClassName = "cdpRtCdpIfPol"
    meta.rnFormat = "rtinfraCdpIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13216, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13215, PropCategory.REGULAR)
