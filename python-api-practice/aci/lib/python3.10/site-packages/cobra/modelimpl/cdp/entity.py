...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.cdp.Entity")

    meta.moClassName = "cdpEntity"
    meta.rnFormat = "cdp"
    meta.category = MoCategory.REGULAR
    meta.label = "CDP Entity"
    ...
    meta.childClasses.add("cobra.model.cdp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.cdp.Inst", "inst"))
