...
# ##################################################
class RtOverrideLacpPol(Mo):
    """
    A target relation to the LACP policy.

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtOverrideLacpPol", "cobra.model.infra.AttPolicyGroup")

    meta.moClassName = "lacpRtOverrideLacpPol"
    meta.rnFormat = "rtinfraOverrideLacpPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13280, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13279, PropCategory.REGULAR)
