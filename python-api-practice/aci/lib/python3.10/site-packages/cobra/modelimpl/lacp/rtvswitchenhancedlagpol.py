...
# ##################################################
class RtVSwitchEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtVSwitchEnhancedLagPol", "cobra.model.l3ext.VirtualLIfPLagPolAtt")

    meta.moClassName = "lacpRtVSwitchEnhancedLagPol"
    meta.rnFormat = "rtl3extVSwitchEnhancedLagPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtl3extVSwitchEnhancedLagPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 55887, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16424
    prop.defaultValueStr = "l3extVirtualLIfPLagPolAtt"
    prop._addConstant("l3extVirtualLIfPLagPolAtt", None, 16424)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55886, PropCategory.REGULAR)
