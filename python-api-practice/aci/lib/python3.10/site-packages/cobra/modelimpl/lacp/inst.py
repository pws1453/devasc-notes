...
class Inst(Mo):
    """
    The LACP instance information. Only one LACP instance is currently supported.

    """

    meta = ClassMeta("cobra.model.lacp.Inst")

    meta.moClassName = "lacpInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "LACP Instance"
    ...
    meta.childClasses.add("cobra.model.lacp.If")

    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.If", "if-"))

    meta.parentClasses.add("cobra.model.lacp.Entity")
    ...
    prop = PropMeta("str", "adminPrio", "adminPrio", 2271, PropCategory.REGULAR)
    prop.label = "Adminstrative Priority"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 32768
    prop.defaultValueStr = "32768"
    meta.props.add("adminPrio", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14429, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operPrio", "operPrio", 2272, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysMac", "sysMac", 2273, PropCategory.REGULAR)
