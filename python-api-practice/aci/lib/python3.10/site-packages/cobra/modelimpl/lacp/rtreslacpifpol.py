...
# ##################################################
class RtResLacpIfPol(Mo):
    """
    A target relation to the LACP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtResLacpIfPol", "cobra.model.infra.Infra")

    meta.moClassName = "lacpRtResLacpIfPol"
    meta.rnFormat = "rtresLacpIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13293, PropCategory.REGULAR)
