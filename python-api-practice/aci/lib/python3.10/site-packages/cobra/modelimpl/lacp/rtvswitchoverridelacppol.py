...
# ##################################################
class RtVswitchOverrideLacpPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtVswitchOverrideLacpPol", "cobra.model.vmm.VSwitchPolicyCont")

    meta.moClassName = "lacpRtVswitchOverrideLacpPol"
    meta.rnFormat = "rtvmmVswitchOverrideLacpPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvmmVswitchOverrideLacpPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23009, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23008, PropCategory.REGULAR)
