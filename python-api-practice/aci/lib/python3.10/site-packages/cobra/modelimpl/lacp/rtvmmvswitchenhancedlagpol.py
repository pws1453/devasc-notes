...
# ##################################################
class RtVmmVSwitchEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtVmmVSwitchEnhancedLagPol", "cobra.model.fv.AEPgLagPolAtt")

    meta.moClassName = "lacpRtVmmVSwitchEnhancedLagPol"
    meta.rnFormat = "rtfvVmmVSwitchEnhancedLagPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Application EPG Lag Policy"
    meta.writeAccessMask = 0x2000000000011
    meta.readAccessMask = 0x2000000000615
    ...
    meta.rnPrefixes = [
        ('rtfvVmmVSwitchEnhancedLagPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 44911, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13009
    prop.defaultValueStr = "fvAEPgLagPolAtt"
    prop._addConstant("fvAEPgLagPolAtt", None, 13009)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 44910, PropCategory.REGULAR)
