...
# ##################################################
class RtLacpPolCons(Mo):
    """
    A target relation to the LACP policy.

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtLacpPolCons", "cobra.model.pc.AggrIf")

    meta.moClassName = "lacpRtLacpPolCons"
    meta.rnFormat = "rtpcLacpPolCons-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Aggregated Interface"
    meta.writeAccessMask = 0x2100000000001
    meta.readAccessMask = 0x6100000000011
    ...
    prop = PropMeta("str", "tCl", "tCl", 12787, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12786, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15126, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
