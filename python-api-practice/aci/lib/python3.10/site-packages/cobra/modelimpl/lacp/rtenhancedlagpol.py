...
# ##################################################
class RtEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtEnhancedLagPol", "cobra.model.hvs.EnhancedLagPol")

    meta.moClassName = "lacpRtEnhancedLagPol"
    meta.rnFormat = "rthvsEnhancedLagPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44374, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12853
    prop.defaultValueStr = "hvsEnhancedLagPol"
    prop._addConstant("hvsEnhancedLagPol", None, 12853)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 44373, PropCategory.REGULAR)
