...
# ##################################################
class LagPolDefTask(Mo):
    """
    The LACP policy definition task.

    """

    meta = ClassMeta("cobra.model.lacp.LagPolDefTask")

    meta.moClassName = "lacpLagPolDefTask"
    meta.rnFormat = "lacpLagPolDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5767, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateLacp", "updatelacp", 142)
