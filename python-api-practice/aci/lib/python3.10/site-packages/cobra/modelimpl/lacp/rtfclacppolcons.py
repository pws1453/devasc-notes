...
# ##################################################
class RtFcLacpPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtFcLacpPolCons", "cobra.model.pc.FcAggrIf")

    meta.moClassName = "lacpRtFcLacpPolCons"
    meta.rnFormat = "rtpcFcLacpPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39173, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39172, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 39242, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
