...
# ##################################################
class RtLacpIfPol(Mo):
    """
    A target relation to the LACP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtLacpIfPol", "cobra.model.infra.AccBndlSubgrp")

    meta.moClassName = "lacpRtLacpIfPol"
    meta.rnFormat = "rtlacpIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13263, PropCategory.REGULAR)
