...
# ##################################################
class RtResLacpLagPol(Mo):
    """
    A target relation to the LACP policy.

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtResLacpLagPol", "cobra.model.infra.Infra")

    meta.moClassName = "lacpRtResLacpLagPol"
    meta.rnFormat = "rtresLacpLagPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13296, PropCategory.REGULAR)
