...
# ##################################################
class RtUsrAggrLagPolAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtUsrAggrLagPolAtt", "cobra.model.vmm.UsrAggr")

    meta.moClassName = "lacpRtUsrAggrLagPolAtt"
    meta.rnFormat = "rtvmmUsrAggrLagPolAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "User Configurable End Point Group Aggregator Definition"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53007, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9377
    prop.defaultValueStr = "vmmUsrAggr"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmUsrAggr", None, 9377)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 53006, PropCategory.REGULAR)
