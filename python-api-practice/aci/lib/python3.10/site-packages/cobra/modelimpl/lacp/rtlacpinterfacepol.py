...
# ##################################################
class RtLacpInterfacePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtLacpInterfacePol", "cobra.model.infra.AccBndlSubgrp")

    meta.moClassName = "lacpRtLacpInterfacePol"
    meta.rnFormat = "rtinfraLacpInterfacePol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22050, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22049, PropCategory.REGULAR)
