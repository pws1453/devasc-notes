...
class RtFcLagPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.lacp.RtFcLagPol", "cobra.model.infra.AFcAccBndlGrp")

    meta.moClassName = "lacpRtFcLagPol"
    meta.rnFormat = "rtfcLagPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39140, PropCategory.REGULAR)
