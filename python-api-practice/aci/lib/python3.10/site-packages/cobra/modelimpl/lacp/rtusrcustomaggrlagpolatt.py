...
# ##################################################
class RtUsrCustomAggrLagPolAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtUsrCustomAggrLagPolAtt", "cobra.model.vmm.UsrCustomAggr")

    meta.moClassName = "lacpRtUsrCustomAggrLagPolAtt"
    meta.rnFormat = "rtvmmUsrCustomAggrLagPolAtt-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x2000000000415
    ...
    meta.rnPrefixes = [
        ('rtvmmUsrCustomAggrLagPolAtt-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 56457, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10991
    prop.defaultValueStr = "vmmUsrCustomAggr"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmUsrCustomAggr", None, 10991)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56456, PropCategory.REGULAR)
