...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.lacp.Entity")

    meta.moClassName = "lacpEntity"
    meta.rnFormat = "lacp"
    meta.category = MoCategory.REGULAR
    meta.label = "LACP Entity"
    ...
    meta.childClasses.add("cobra.model.lacp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.Inst", "inst"))
