...
# ##################################################
class EnhancedLagPolDefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.lacp.EnhancedLagPolDefTask")

    meta.moClassName = "lacpEnhancedLagPolDefTask"
    meta.rnFormat = "lacpEnhancedLagPolDefTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('lacpEnhancedLagPolDefTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 44362, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateEnhancedLacp", "updateenhancedlacp", 3185)
