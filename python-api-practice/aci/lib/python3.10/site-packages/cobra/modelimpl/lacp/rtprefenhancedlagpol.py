...
# ##################################################
class RtPrefEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtPrefEnhancedLagPol", "cobra.model.vmm.DomP")

    meta.moClassName = "lacpRtPrefEnhancedLagPol"
    meta.rnFormat = "rtvmmPrefEnhancedLagPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44903, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44902, PropCategory.REGULAR)
