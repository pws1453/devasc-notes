...
# ##################################################
class RtDefaultLacpLagPol(Mo):
    """
    A target relation to the LACP policy.

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtDefaultLacpLagPol", "cobra.model.vmm.DomP")

    meta.moClassName = "lacpRtDefaultLacpLagPol"
    meta.rnFormat = "rtvmmDefaultLacpLagPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15526, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15525, PropCategory.REGULAR)
