...
# ##################################################
class RtLacpIfPolCons(Mo):
    """
    A target relation to the LACP interface policy.

    """

    meta = TargetRelationMeta("cobra.model.lacp.RtLacpIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "lacpRtLacpIfPolCons"
    meta.rnFormat = "rtl1LacpIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12761, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12760, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15114, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
