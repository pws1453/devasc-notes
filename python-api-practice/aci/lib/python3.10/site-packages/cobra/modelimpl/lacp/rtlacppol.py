...
class RtLacpPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.lacp.RtLacpPol", "cobra.model.infra.AAccBndlGrp")

    meta.moClassName = "lacpRtLacpPol"
    meta.rnFormat = "rtinfraLacpPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13248, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6101
    prop.defaultValueStr = "infraAAccBndlGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13247, PropCategory.REGULAR)
