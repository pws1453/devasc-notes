...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.lacp.If")

    meta.moClassName = "lacpIf"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "LACP Interface"
    ...
    meta.childClasses.add("cobra.model.lacp.AdjEp")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")
    meta.childClasses.add("cobra.model.lacp.IfStats")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.IfStats", "ifstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.AdjEp", "adj"))

    meta.parentClasses.add("cobra.model.lacp.Inst")
    ...
    prop = PropMeta("str", "activityFlags", "activityFlags", 2266, PropCategory.REGULAR)
    prop.label = "Activity Flags"
    prop.isOper = True
    prop._addConstant("active", "active", 1)
    prop._addConstant("aggregate", "aggregatable", 4)
    prop._addConstant("collect", "collecting", 16)
    prop._addConstant("defaulted", "defaulted", 64)
    prop._addConstant("distribute", "distributing", 32)
    prop._addConstant("expired", "expired", 128)
    prop._addConstant("short", "short-timeout", 2)
    prop._addConstant("sync", "in-sync", 8)
    meta.props.add("activityFlags", prop)
    ...
    prop = PropMeta("str", "id", "id", 6869, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "key", "key", 2270, PropCategory.REGULAR)
    prop.label = "Operational Key"
    prop.isOper = True
    prop.range = [(1, 65535)]
    meta.props.add("key", prop)

    prop = PropMeta("str", "lastActive", "lastActive", 2267, PropCategory.REGULAR)
    prop.label = "Last Active"
    prop.isOper = True
    meta.props.add("lastActive", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14427, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operPrio", "operPrio", 2269, PropCategory.REGULAR)
    prop.label = "Operational Priority"
    prop.isOper = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 32768
    prop.defaultValueStr = "32768"
    meta.props.add("operPrio", prop)

    prop = PropMeta("str", "port", "port", 2268, PropCategory.REGULAR)
    prop.label = "Port"
    prop.isOper = True
    prop.range = [(0, 65535)]
    meta.props.add("port", prop)

    prop = PropMeta("str", "prio", "prio", 2262, PropCategory.REGULAR)
    prop.label = "Priority"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop = PropMeta("str", "txRate", "txRate", 2263, PropCategory.REGULAR)
    prop.label = "Transmit Rate"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "normal"
    prop._addConstant("fast", "fast", 2)
