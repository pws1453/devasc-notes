...
# ##################################################
class RtFaultCtrlrRetP(Mo):
    """
    A target relation to controller fault record retention policy.

    """

    meta = TargetRelationMeta("cobra.model.fault.RtFaultCtrlrRetP", "cobra.model.fault.RelnHolder")

    meta.moClassName = "faultRtFaultCtrlrRetP"
    meta.rnFormat = "rtfaultCtrlrRetP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13432, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13431, PropCategory.REGULAR)
