...
# ##################################################
class RsEventCtrlrRetLocalP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsEventCtrlrRetLocalP", "cobra.model.event.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsEventCtrlrRetLocalP"
    meta.rnFormat = "rseventCtrlrRetLocalP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28350, PropCategory.REGULAR)
