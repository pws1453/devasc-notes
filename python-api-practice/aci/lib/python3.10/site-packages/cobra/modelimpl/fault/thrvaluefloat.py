...
# ##################################################
class ThrValueFloat(Mo):
    """
    The threshold value float.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueFloat")

    meta.moClassName = "faultThrValueFloat"
    meta.rnFormat = "thrValFloat-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38041, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40180, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6507, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5492, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5491, PropCategory.REGULAR)
