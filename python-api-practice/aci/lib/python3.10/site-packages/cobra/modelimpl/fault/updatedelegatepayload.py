...
# ##################################################
class UpdateDelegatePayload(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fault.UpdateDelegatePayload")

    meta.moClassName = "faultUpdateDelegatePayload"
    meta.rnFormat = "udp-[%(deliveryDn)s]"
    ...
    prop = PropMeta("str", "deliveryDn", "deliveryDn", 15979, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ownerSvcId", "ownerSvcId", 17944, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "shardId", "shardId", 15953, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "termId", "termId", 17945, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
