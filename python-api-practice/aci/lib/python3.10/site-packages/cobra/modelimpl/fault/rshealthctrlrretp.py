...
# ##################################################
class RsHealthCtrlrRetP(Mo):
    """
    A relation to the controller health score history record retention policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsHealthCtrlrRetP", "cobra.model.health.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsHealthCtrlrRetP"
    meta.rnFormat = "rshealthCtrlrRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Controller Health Record Retention Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16184, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1643
    prop.defaultValueStr = "healthCtrlrRetP"
