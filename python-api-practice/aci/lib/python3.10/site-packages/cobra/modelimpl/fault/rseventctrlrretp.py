...
# ##################################################
class RsEventCtrlrRetP(Mo):
    """
    A source relation to the controller event record retention policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsEventCtrlrRetP", "cobra.model.event.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsEventCtrlrRetP"
    meta.rnFormat = "rseventCtrlrRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Controller Event Record Retention Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16182, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 226
    prop.defaultValueStr = "eventCtrlrRetP"
