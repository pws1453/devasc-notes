...
# ##################################################
class RtFaultCtrlrRetLocalP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fault.RtFaultCtrlrRetLocalP", "cobra.model.fault.RelnHolder")

    meta.moClassName = "faultRtFaultCtrlrRetLocalP"
    meta.rnFormat = "rtfaultCtrlrRetLocalP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28355, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28354, PropCategory.REGULAR)
