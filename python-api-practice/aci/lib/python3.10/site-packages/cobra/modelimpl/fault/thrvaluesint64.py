...
# ##################################################
class ThrValueSint64(Mo):
    """
    The threshold value Service Interface Notification Statistics (SINT) 64.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueSint64")

    meta.moClassName = "faultThrValueSint64"
    meta.rnFormat = "thrValSint64-%(propId)s"
    ...
    meta.superClasses.add("cobra.model.fault.AThrValue")

    meta.rnPrefixes = [
        ('thrValSint64-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38040, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40179, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6511, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5490, PropCategory.REGULAR)
    prop.label = "Threshold value from policy."
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("thrValue", prop)
    ...
    prop = PropMeta("str", "value", "value", 5489, PropCategory.REGULAR)
    prop.label = "Value of the property."
    prop.isConfig = True
    prop.isAdmin = True
