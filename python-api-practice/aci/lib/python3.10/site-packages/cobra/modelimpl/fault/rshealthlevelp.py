...
# ##################################################
class RsHealthLevelP(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsHealthLevelP", "cobra.model.health.LevelP")
    meta.targetNameProps["high"] = "tnHealthLevelPHigh"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsHealthLevelP"
    meta.rnFormat = "rshealthLevelP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16270, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnHealthLevelPHigh", "tnHealthLevelPHigh", 16269, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 100)]
