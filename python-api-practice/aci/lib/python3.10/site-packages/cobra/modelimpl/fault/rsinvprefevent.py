...
# ##################################################
class RsInvPRefEvent(Mo):
    """
    A source relation to the call home inventory policy.

    """

    meta = SourceRelationMeta("cobra.model.fault.RsInvPRefEvent", "cobra.model.callhome.InvP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsInvPRefEvent"
    meta.rnFormat = "rsInvPRefEvent"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16178, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16177, PropCategory.REGULAR)
