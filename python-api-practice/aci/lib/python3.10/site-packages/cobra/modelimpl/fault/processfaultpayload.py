...
# ##################################################
class ProcessFaultPayload(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fault.ProcessFaultPayload")

    meta.moClassName = "faultProcessFaultPayload"
    meta.rnFormat = "pfp-[%(deliveryDn)s]"
    ...
    prop = PropMeta("str", "delegateDn", "delegateDn", 15951, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("delegateDn", prop)

    prop = PropMeta("str", "deliveryDn", "deliveryDn", 15978, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15952, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "shardId", "shardId", 15950, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
