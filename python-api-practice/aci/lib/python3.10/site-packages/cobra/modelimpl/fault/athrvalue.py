...
# ##################################################
class AThrValue(Mo):
    meta = ClassMeta("cobra.model.fault.AThrValue")

    meta.isAbstract = True
    meta.moClassName = "faultAThrValue"
    ...
    meta.parentClasses.add("cobra.model.fault.UpdateTcaFaultMaskPayload")

    meta.concreteSubClasses.add("cobra.model.fault.ThrValueFloat")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueSint64")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueUint32")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueSint16")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueSint32")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueDouble")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueUByte")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueSByte")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueTrigger")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueUint64")
    meta.concreteSubClasses.add("cobra.model.fault.ThrValueUint16")
    ...
    prop = PropMeta("str", "propId", "propId", 394, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
