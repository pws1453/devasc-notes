...
# ##################################################
class RsHealthFabricNode(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsHealthFabricNode", "cobra.model.fabric.Node")
    meta.targetNameProps["id"] = "tnFabricNodeId"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsHealthFabricNode"
    meta.rnFormat = "rshealthFabricNode"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16636, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricNodeId", "tnFabricNodeId", 16635, PropCategory.REGULAR)
    prop.label = "Id"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tnFabricNodeId", prop)
