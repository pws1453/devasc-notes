...
# ##################################################
class ThrValueUint32(Mo):
    """
    The threshold value uint 32.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueUint32")

    meta.moClassName = "faultThrValueUint32"
    meta.rnFormat = "thrValUint32-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38037, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40176, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6515, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5484, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5483, PropCategory.REGULAR)
