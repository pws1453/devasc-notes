...
# ##################################################
class RsMonToFvEppOobEvent(Mo):
    """
    A source relation for the out-of-band management endpoint profile for a fabric node management endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.fault.RsMonToFvEppOobEvent", "cobra.model.fv.OoBEpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsMonToFvEppOobEvent"
    meta.rnFormat = "rsmonToFvEppOobEvent"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16194, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16193, PropCategory.REGULAR)
