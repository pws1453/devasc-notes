...
# ##################################################
class RsHealthRetPolicy(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fault.RsHealthRetPolicy", "cobra.model.health.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsHealthRetPolicy"
    meta.rnFormat = "rshealthRetPolicy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34448, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34447, PropCategory.REGULAR)
