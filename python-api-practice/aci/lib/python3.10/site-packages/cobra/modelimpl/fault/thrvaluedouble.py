...
# ##################################################
class ThrValueDouble(Mo):
    """
    The threshold value double.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueDouble")

    meta.moClassName = "faultThrValueDouble"
    meta.rnFormat = "thrValDouble-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38039, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40178, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6506, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5488, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5487, PropCategory.REGULAR)
