...
# ##################################################
class RsMonPolRefEvent(Mo):
    """
    A source relation to the base monitoring policy model.

    """

    meta = SourceRelationMeta("cobra.model.fault.RsMonPolRefEvent", "cobra.model.mon.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsMonPolRefEvent"
    meta.rnFormat = "rsmonPolRefEvent"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16186, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16185, PropCategory.REGULAR)
