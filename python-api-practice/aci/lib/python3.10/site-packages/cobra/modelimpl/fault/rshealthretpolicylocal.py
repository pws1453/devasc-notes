...
# ##################################################
class RsHealthRetPolicyLocal(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fault.RsHealthRetPolicyLocal", "cobra.model.health.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsHealthRetPolicyLocal"
    meta.rnFormat = "rshealthRetPolicyLocal"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34452, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34451, PropCategory.REGULAR)
