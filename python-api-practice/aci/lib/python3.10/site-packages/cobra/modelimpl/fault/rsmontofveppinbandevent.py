...
# ##################################################
class RsMonToFvEppInbandEvent(Mo):
    """
    A source relation to the in-band management endpoint profile for a fabric node management endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.fault.RsMonToFvEppInbandEvent", "cobra.model.fv.InBEpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsMonToFvEppInbandEvent"
    meta.rnFormat = "rsmonToFvEppInbandEvent"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16190, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1941
    prop.defaultValueStr = "fvInBEpP"
    prop._addConstant("fvInBEpP", None, 1941)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16189, PropCategory.REGULAR)
