...
# ##################################################
class RsToRemoteMonGrpRefEvent(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fault.RsToRemoteMonGrpRefEvent", "cobra.model.mon.Group")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "faultRsToRemoteMonGrpRefEvent"
    meta.rnFormat = "rstoRemoteMonGrpRefEvent-[%(tDn)s]"
    ...
    meta.superClasses.add("cobra.model.fault.ARsToRemote")

    meta.rnPrefixes = [
        ('rstoRemoteMonGrpRefEvent-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23669, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1677
    prop.defaultValueStr = "monGroup"
    ...
    prop = PropMeta("str", "tDn", "tDn", 23668, PropCategory.REGULAR)
