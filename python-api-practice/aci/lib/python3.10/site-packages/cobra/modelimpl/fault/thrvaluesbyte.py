...
# ##################################################
class ThrValueSByte(Mo):
    """
    The threshold value Sbyte.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueSByte")

    meta.moClassName = "faultThrValueSByte"
    meta.rnFormat = "thrValSByte-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38036, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40175, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6508, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5482, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5481, PropCategory.REGULAR)
