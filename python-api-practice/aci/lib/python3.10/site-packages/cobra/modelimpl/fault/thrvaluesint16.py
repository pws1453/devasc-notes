...
# ##################################################
class ThrValueSint16(Mo):
    """
    The threshold value Service Interface Notification Statistics (SINT) 16.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueSint16")

    meta.moClassName = "faultThrValueSint16"
    meta.rnFormat = "thrValSint16-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38033, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40172, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6509, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5476, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5475, PropCategory.REGULAR)
