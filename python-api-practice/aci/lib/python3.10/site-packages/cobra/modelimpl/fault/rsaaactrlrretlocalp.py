...
# ##################################################
class RsAaaCtrlrRetLocalP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsAaaCtrlrRetLocalP", "cobra.model.aaa.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsAaaCtrlrRetLocalP"
    meta.rnFormat = "rsaaaCtrlrRetLocalP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28347, PropCategory.REGULAR)
