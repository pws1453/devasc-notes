...
# ##################################################
class RsToRemoteQueryGroupRefEvent(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fault.RsToRemoteQueryGroupRefEvent", "cobra.model.callhome.QueryGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "faultRsToRemoteQueryGroupRefEvent"
    meta.rnFormat = "rstoRemoteQueryGroupRefEvent-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteQueryGroupRefEvent-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23672, PropCategory.REGULAR)
