...
# ##################################################
class RsFaultCtrlrRetP(Mo):
    """
    A source relation to the controller fault record retention policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsFaultCtrlrRetP", "cobra.model.fault.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsFaultCtrlrRetP"
    meta.rnFormat = "rsfaultCtrlrRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Controller Fault Record Retention Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16183, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 239
    prop.defaultValueStr = "faultCtrlrRetP"
