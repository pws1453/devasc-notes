...
# ##################################################
class RsFaultCtrlrRetLocalP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsFaultCtrlrRetLocalP", "cobra.model.fault.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsFaultCtrlrRetLocalP"
    meta.rnFormat = "rsfaultCtrlrRetLocalP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28353, PropCategory.REGULAR)
