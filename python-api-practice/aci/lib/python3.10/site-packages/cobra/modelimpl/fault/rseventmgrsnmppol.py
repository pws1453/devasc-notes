...
# ##################################################
class RsEventMgrSnmpPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fault.RsEventMgrSnmpPol", "cobra.model.snmp.Pol")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "faultRsEventMgrSnmpPol"
    meta.rnFormat = "rseventMgrSnmpPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23337, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23336, PropCategory.REGULAR)
