...
# ##################################################
class RsAaaCtrlrRetP(Mo):
    """
    A source relation to the controller audit log retention policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsAaaCtrlrRetP", "cobra.model.aaa.CtrlrRetP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsAaaCtrlrRetP"
    meta.rnFormat = "rsaaaCtrlrRetP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Controller Audit Record Retention Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16181, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1569
    prop.defaultValueStr = "aaaCtrlrRetP"
