...
# ##################################################
class ThrValueUint16(Mo):
    """
    The threshold value Uint 16.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueUint16")

    meta.moClassName = "faultThrValueUint16"
    meta.rnFormat = "thrValUint16-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38035, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40174, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6514, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5480, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5479, PropCategory.REGULAR)
