...
# ##################################################
class ThrValueUint64(Mo):
    """
    The threshold value uint 64.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueUint64")

    meta.moClassName = "faultThrValueUint64"
    meta.rnFormat = "thrValUint64-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38042, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40181, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6516, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5494, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5493, PropCategory.REGULAR)
