...
# ##################################################
class RsMonPolLocalRefEvent(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fault.RsMonPolLocalRefEvent", "cobra.model.mon.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsMonPolLocalRefEvent"
    meta.rnFormat = "rsmonPolLocalRefEvent"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27715, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27714, PropCategory.REGULAR)
