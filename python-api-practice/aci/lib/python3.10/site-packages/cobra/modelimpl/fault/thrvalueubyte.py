...
# ##################################################
class ThrValueUByte(Mo):
    """
    The threshold value Ubyte.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueUByte")

    meta.moClassName = "faultThrValueUByte"
    meta.rnFormat = "thrValUByte-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38038, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40177, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6513, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5486, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5485, PropCategory.REGULAR)
