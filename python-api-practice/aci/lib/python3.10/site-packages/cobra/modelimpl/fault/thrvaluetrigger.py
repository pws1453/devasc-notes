...
# ##################################################
class ThrValueTrigger(Mo):
    """
    The threshold value trigger.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueTrigger")

    meta.moClassName = "faultThrValueTrigger"
    meta.rnFormat = "thrValTrigger-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38032, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40171, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6512, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5474, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5473, PropCategory.REGULAR)
