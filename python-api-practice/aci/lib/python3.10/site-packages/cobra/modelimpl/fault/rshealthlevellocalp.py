...
# ##################################################
class RsHealthLevelLocalP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fault.RsHealthLevelLocalP", "cobra.model.health.LevelP")
    meta.targetNameProps["high"] = "tnHealthLevelPHigh"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsHealthLevelLocalP"
    meta.rnFormat = "rshealthLevelLocalP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Health Level Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28357, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1625
    prop.defaultValueStr = "healthLevelP"
    ...
    prop = PropMeta("str", "tnHealthLevelPHigh", "tnHealthLevelPHigh", 28356, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 100)]
    meta.props.add("tnHealthLevelPHigh", prop)
