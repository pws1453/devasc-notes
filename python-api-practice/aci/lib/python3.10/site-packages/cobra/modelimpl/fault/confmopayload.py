...
# ##################################################
class ConfMoPayload(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fault.ConfMoPayload")

    meta.moClassName = "faultConfMoPayload"
    meta.rnFormat = "cmp-[%(deliveryDn)s]"
    ...
    prop = PropMeta("str", "deliveryDn", "deliveryDn", 15976, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "testApi", "testApi", 15954, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "0"
    meta.props.add("testApi", prop)
