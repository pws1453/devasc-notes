...
# ##################################################
class RsSynPolicyEvent(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fault.RsSynPolicyEvent", "cobra.model.synthetic.Policy")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsSynPolicyEvent"
    meta.rnFormat = "rssynPolicyEvent"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16198, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16197, PropCategory.REGULAR)
