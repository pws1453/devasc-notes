...
# ##################################################
class RsInvPLocalRefEvent(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fault.RsInvPLocalRefEvent", "cobra.model.callhome.InvP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "faultRsInvPLocalRefEvent"
    meta.rnFormat = "rsInvPLocalRefEvent"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28344, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28343, PropCategory.REGULAR)
