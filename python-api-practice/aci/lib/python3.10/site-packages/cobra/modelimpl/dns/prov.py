...
class Prov(Mo):
    ...
    meta = ClassMeta("cobra.model.dns.Prov")

    meta.moClassName = "dnsProv"
    ...
    prop = PropMeta("str", "addr", "addr", 6188, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37307, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39446, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
