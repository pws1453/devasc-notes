...
# ##################################################
class RsProfileToEpp(Mo):
    """
    A source relation to an abstract representation of the resolvable endpoint profile.

    """

    meta = SourceRelationMeta("cobra.model.dns.RsProfileToEpp", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dnsRsProfileToEpp"
    meta.rnFormat = "rsProfileToEpp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to the EpP through which DNS Providers are reachable."
    ...
    prop = PropMeta("str", "tCl", "tCl", 16127, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16126, PropCategory.REGULAR)
