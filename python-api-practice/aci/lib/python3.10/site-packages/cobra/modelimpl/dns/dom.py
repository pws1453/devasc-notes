...
class Dom(Mo):
    ...
    meta = ClassMeta("cobra.model.dns.Dom")

    meta.moClassName = "dnsDom"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37741, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39880, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 6182, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
