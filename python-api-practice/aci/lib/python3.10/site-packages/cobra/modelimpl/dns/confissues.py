...
class ConfIssues(Mo):
    ...
    meta = ClassMeta("cobra.model.dns.ConfIssues")

    meta.moClassName = "dnsConfIssues"
    meta.rnFormat = "dnsissues"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Profile Policy Configuration Issues"
    ...
    prop = PropMeta("str", "configQual", "configQual", 53877, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("provider-limit-exceeded", "provider-limit-exceeded", 1)
    ...
    prop = PropMeta("str", "debugMessage", "debugMessage", 53878, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53879, PropCategory.REGULAR)
