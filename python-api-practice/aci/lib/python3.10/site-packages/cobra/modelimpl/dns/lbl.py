...
class Lbl(Mo):
    """
    The network domain name label. Labels enable classifying which objects can and cannot communicate with one another. 

    """

    meta = ClassMeta("cobra.model.dns.Lbl")

    meta.moClassName = "dnsLbl"
    meta.rnFormat = "dnslbl-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Profile Label"
    ...
    meta.superClasses.add("cobra.model.dns.ALbl")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37309, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39448, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 6184, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
