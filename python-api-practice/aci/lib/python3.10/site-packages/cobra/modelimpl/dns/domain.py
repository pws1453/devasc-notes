...
class Domain(Mo):
    ...
    meta = ClassMeta("cobra.model.dns.Domain")

    meta.moClassName = "dnsDomain"
    ...
    meta.superClasses.add("cobra.model.dns.ADomain")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37308, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39447, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isDefault", "isDefault", 463, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 6183, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.regex = ['[a-zA-Z0-9.-]{1,255}']
