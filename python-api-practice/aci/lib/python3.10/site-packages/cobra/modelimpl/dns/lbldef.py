...
class LblDef(Mo):
    ...
    meta = ClassMeta("cobra.model.dns.LblDef")

    meta.moClassName = "dnsLblDef"
    ...
    meta.childClasses.add("cobra.model.dns.RsDnsProfile")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.dns.RsDnsProfile", "rsDnsProfile"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13811, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6185, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
