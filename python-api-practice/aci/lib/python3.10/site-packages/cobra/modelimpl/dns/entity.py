...
class Entity(Mo):
    """
    The DNS control plane entity information

    """

    meta = ClassMeta("cobra.model.dns.Entity")

    meta.moClassName = "dnsEntity"
    meta.rnFormat = "dns"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Entity"
    ...
    meta.childClasses.add("cobra.model.dns.Prof")

    meta.childNamesAndRnPrefix.append(("cobra.model.dns.Prof", "prof-"))
