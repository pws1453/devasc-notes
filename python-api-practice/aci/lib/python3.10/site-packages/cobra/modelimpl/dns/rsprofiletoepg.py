...
# ##################################################
class RsProfileToEpg(Mo):
    """
    A source relation to DNS server endpoint group

    """

    meta = SourceRelationMeta("cobra.model.dns.RsProfileToEpg", "cobra.model.fv.ATg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dnsRsProfileToEpg"
    meta.rnFormat = "rsProfileToEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to the EPg through which DNS server is reachable"
    ...
    meta.rnPrefixes = [
        ('rsProfileToEpg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37306, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39445, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 11285, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11284, PropCategory.REGULAR)
