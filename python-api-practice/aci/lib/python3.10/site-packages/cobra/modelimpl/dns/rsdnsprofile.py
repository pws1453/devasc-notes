...
# ##################################################
class RsDnsProfile(Mo):
    """
    A source relation to the DNS profile.

    """

    meta = SourceRelationMeta("cobra.model.dns.RsDnsProfile", "cobra.model.dns.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dnsRsDnsProfile"
    meta.rnFormat = "rsDnsProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DNS Policy"
    meta.writeAccessMask = 0x10000002001
    meta.readAccessMask = 0x10000002001
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13812, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11289, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 278
    prop.defaultValueStr = "dnsProfile"
    prop._addConstant("dnsProfile", None, 278)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11288, PropCategory.REGULAR)
