...
class Provider(Mo):
    ...
    meta = ClassMeta("cobra.model.dns.Provider")

    meta.moClassName = "dnsProvider"
    meta.rnFormat = "prov-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Provider"
    ...
    meta.parentClasses.add("cobra.model.dns.Prof")

    meta.superClasses.add("cobra.model.dns.AProv")
    ...
    prop = PropMeta("str", "addr", "addr", 6189, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37740, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39879, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "preferred", "preferred", 461, PropCategory.REGULAR)
    prop.label = "Prefered DNS Provider"
    prop.isConfig = True
    prop.isAdmin = True
