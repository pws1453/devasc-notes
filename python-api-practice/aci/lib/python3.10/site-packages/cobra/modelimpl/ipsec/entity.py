...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.ipsec.Entity")

    meta.moClassName = "ipsecEntity"
    meta.rnFormat = "ipsec"
    meta.category = MoCategory.REGULAR
    meta.label = "IPSec Entity"
    ...
    meta.childClasses.add("cobra.model.ipsec.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.ipsec.Inst", "inst"))
