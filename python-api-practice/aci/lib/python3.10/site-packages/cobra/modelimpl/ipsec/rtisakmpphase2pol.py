...
# ##################################################
class RtIsakmpPhase2Pol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.ipsec.RtIsakmpPhase2Pol", "cobra.model.cloud.IpSecTunnelIfP")

    meta.moClassName = "ipsecRtIsakmpPhase2Pol"
    meta.rnFormat = "rtcloudIsakmpPhase2Pol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51219, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51218, PropCategory.REGULAR)
