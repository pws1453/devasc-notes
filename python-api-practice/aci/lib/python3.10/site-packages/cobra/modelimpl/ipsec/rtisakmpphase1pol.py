...
# ##################################################
class RtIsakmpPhase1Pol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.ipsec.RtIsakmpPhase1Pol", "cobra.model.cloud.IpSecTunnelIfP")

    meta.moClassName = "ipsecRtIsakmpPhase1Pol"
    meta.rnFormat = "rtcloudIsakmpPhase1Pol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51215, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14434
    prop.defaultValueStr = "cloudIpSecTunnelIfP"
    prop._addConstant("cloudIpSecTunnelIfP", None, 14434)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51214, PropCategory.REGULAR)
