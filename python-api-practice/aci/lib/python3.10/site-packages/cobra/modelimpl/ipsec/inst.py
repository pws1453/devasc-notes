...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.ipsec.Inst")

    meta.moClassName = "ipsecInst"
    meta.rnFormat = "inst"
    ...
    meta.childClasses.add("cobra.model.ipsec.StSecAssoc")

    meta.childNamesAndRnPrefix.append(("cobra.model.ipsec.StSecAssoc", "sa-"))

    meta.parentClasses.add("cobra.model.ipsec.Entity")
