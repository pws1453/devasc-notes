...
# ##################################################
class RtPsuInstPol(Mo):
    """
    A target relation to the power redundancy policy.

    """

    meta = TargetRelationMeta("cobra.model.psu.RtPsuInstPol", "cobra.model.fabric.ANodePGrp")

    meta.moClassName = "psuRtPsuInstPol"
    meta.rnFormat = "rtfabricPsuInstPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11580, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11579, PropCategory.REGULAR)
