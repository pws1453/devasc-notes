...
class InstPol(Mo):
    ...
    meta.childClasses.add("cobra.model.psu.RtSysPsuInstPolCons")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.psu.RtSysPsuInstPolCons", "rtsysPsuInstPolCons"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37353, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39492, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
