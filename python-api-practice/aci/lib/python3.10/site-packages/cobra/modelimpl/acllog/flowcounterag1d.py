...
# ##################################################
class FlowCounterAg1d(Mo):
    """
    A class that represents the most current aggregated statistics for  Flow  Record  Counter in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAg1d", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAg1d"
    meta.rnFormat = "CDacllogFlowCounterAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Flow Record Counter stats in 1 day"
