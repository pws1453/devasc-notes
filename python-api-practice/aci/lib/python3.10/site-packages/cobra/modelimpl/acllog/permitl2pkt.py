...
# ##################################################
class PermitL2Pkt(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.acllog.PermitL2Pkt")

    meta.moClassName = "acllogPermitL2Pkt"
    meta.rnFormat = "permitl2pkt-%(recordId)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-time-%(timeStamp)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L2 Permit Pkt Record"
    ...
    meta.superClasses.add("cobra.model.acllog.PermitL2Record")
    ...
    prop = PropMeta("str", "dstMacAddr", "dstMacAddr", 25085, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25157, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "pktLen", "pktLen", 25044, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "recordId", "recordId", 27665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcMacAddr", "srcMacAddr", 25086, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "timeStamp", "timeStamp", 25045, PropCategory.REGULAR)
