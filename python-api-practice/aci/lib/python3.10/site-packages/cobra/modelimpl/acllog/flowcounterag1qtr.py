...
# ##################################################
class FlowCounterAg1qtr(Mo):
    """
    A class that represents the most current aggregated statistics for  Flow  Record  Counter in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAg1qtr", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAg1qtr"
    meta.rnFormat = "CDacllogFlowCounterAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Flow Record Counter stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDacllogFlowCounterAg1qtr', False),
    ]
