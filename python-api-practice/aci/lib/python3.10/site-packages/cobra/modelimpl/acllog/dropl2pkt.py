...
class DropL2Pkt(Mo):
    ...
    meta = ClassMeta("cobra.model.acllog.DropL2Pkt")

    meta.moClassName = "acllogDropL2Pkt"
    meta.rnFormat = "dropl2pkt-%(recordId)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-time-%(timeStamp)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L2 Drop Pkt Record"
    ...
    prop = PropMeta("str", "dstMacAddr", "dstMacAddr", 25052, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25158, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "pktLen", "pktLen", 25046, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "recordId", "recordId", 27666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcMacAddr", "srcMacAddr", 25053, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "timeStamp", "timeStamp", 25047, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vlan", "vlan", 25026, PropCategory.REGULAR)
    prop.label = "VLAN Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
