...
# ##################################################
class FlowCounterAgHist5min(Mo):
    """
    A class that represents historical aggregated statistics for  Flow  Record  Counter in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAgHist5min", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAgHist5min"
    meta.rnFormat = "HDacllogFlowCounterAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Flow Record Counter stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDacllogFlowCounterAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 25072, PropCategory.REGULAR)
