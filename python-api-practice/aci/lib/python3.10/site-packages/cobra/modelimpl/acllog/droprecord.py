...
# ##################################################
class DropRecord(Mo):
    meta = ClassMeta("cobra.model.acllog.DropRecord")

    meta.isAbstract = True
    meta.moClassName = "acllogDropRecord"
    ...
    meta.concreteSubClasses.add("cobra.model.acllog.DropL3Flow")
    meta.concreteSubClasses.add("cobra.model.acllog.DropL2Pkt")
    meta.concreteSubClasses.add("cobra.model.acllog.DropL2Flow")
    meta.concreteSubClasses.add("cobra.model.acllog.DropL3Pkt")
