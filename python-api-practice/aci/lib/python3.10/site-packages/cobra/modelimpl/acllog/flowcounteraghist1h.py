...
# ##################################################
class FlowCounterAgHist1h(Mo):
    """
    A class that represents historical aggregated statistics for  Flow  Record  Counter in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAgHist1h", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAgHist1h"
    meta.rnFormat = "HDacllogFlowCounterAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Flow Record Counter stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 25067, PropCategory.REGULAR)
