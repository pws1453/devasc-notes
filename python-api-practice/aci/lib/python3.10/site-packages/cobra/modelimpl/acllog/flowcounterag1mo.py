...
# ##################################################
class FlowCounterAg1mo(Mo):
    """
    A class that represents the most current aggregated statistics for  Flow  Record  Counter in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAg1mo", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAg1mo"
    meta.rnFormat = "CDacllogFlowCounterAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Flow Record Counter stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDacllogFlowCounterAg1mo', False),
    ]
