...
# ##################################################
class FlowCounterAgHist1mo(Mo):
    """
    A class that represents historical aggregated statistics for  Flow  Record  Counter in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAgHist1mo", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAgHist1mo"
    meta.rnFormat = "HDacllogFlowCounterAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Flow Record Counter stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 25068, PropCategory.REGULAR)
