...
# ##################################################
class FlowCounterAg1year(Mo):
    """
    A class that represents the most current aggregated statistics for  Flow  Record  Counter in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAg1year", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAg1year"
    meta.rnFormat = "CDacllogFlowCounterAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Flow Record Counter stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDacllogFlowCounterAg1year', False),
    ]
