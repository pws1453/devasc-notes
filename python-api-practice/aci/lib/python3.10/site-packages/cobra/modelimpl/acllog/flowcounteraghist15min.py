...
# ##################################################
class FlowCounterAgHist15min(Mo):
    """
    A class that represents historical aggregated statistics for  Flow  Record  Counter in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAgHist15min", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAgHist15min"
    meta.rnFormat = "HDacllogFlowCounterAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Flow Record Counter stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDacllogFlowCounterAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 25065, PropCategory.REGULAR)
