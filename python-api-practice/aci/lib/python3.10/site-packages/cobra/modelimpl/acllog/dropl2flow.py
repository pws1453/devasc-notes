...
class DropL2Flow(Mo):
    ...
    prop = PropMeta("str", "dstEpgName", "dstEpgName", 37083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstMacAddr", "dstMacAddr", 25048, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcEpgName", "srcEpgName", 37085, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcMacAddr", "srcMacAddr", 25050, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, srcPcTag, dstPcTag, srcEpgName, dstEpgName, srcMacAddr, dstMacAddr, srcIntf, vlan, markDirty=True, **creationProps):
        namingVals = [srcPcTag, dstPcTag, srcEpgName, dstEpgName, srcMacAddr, dstMacAddr, srcIntf, vlan]
