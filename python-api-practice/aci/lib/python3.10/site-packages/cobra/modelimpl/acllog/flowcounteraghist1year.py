...
# ##################################################
class FlowCounterAgHist1year(Mo):
    """
    A class that represents historical aggregated statistics for  Flow  Record  Counter in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAgHist1year", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAgHist1year"
    meta.rnFormat = "HDacllogFlowCounterAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Flow Record Counter stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDacllogFlowCounterAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 25071, PropCategory.REGULAR)
