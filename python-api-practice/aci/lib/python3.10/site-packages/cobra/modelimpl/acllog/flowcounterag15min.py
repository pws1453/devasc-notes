...
# ##################################################
class FlowCounterAg15min(Mo):
    """
    A class that represents the most current aggregated statistics for  Flow  Record  Counter in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAg15min", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAg15min"
    meta.rnFormat = "CDacllogFlowCounterAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Flow Record Counter stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.acllog.FlowCounterAg")

    meta.rnPrefixes = [
        ('CDacllogFlowCounterAg15min', False),
    ]
