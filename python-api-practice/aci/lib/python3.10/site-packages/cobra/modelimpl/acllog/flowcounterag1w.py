...
# ##################################################
class FlowCounterAg1w(Mo):
    """
    A class that represents the most current aggregated statistics for  Flow  Record  Counter in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAg1w", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAg1w"
    meta.rnFormat = "CDacllogFlowCounterAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Flow Record Counter stats in 1 week"
