...
class DropL3Flow(Mo):
    ...
    meta = ClassMeta("cobra.model.acllog.DropL3Flow")

    meta.moClassName = "acllogDropL3Flow"
    meta.rnFormat = "dropl3flow-spctag-%(srcPcTag)s-dpctag-%(dstPcTag)s-sepgname-%(srcEpgName)s-depgname-%(dstEpgName)s-sip-[%(srcIp)s]-dip-[%(dstIp)s]-proto-%(protocol)s-sport-%(srcPort)s-dport-%(dstPort)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-sintf-[%(srcIntf)s]-vrfencap-%(vrfEncap)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Flow L3 Drop Record"
    ...
    meta.superClasses.add("cobra.model.acllog.DropL3Record")
    ...
    prop = PropMeta("str", "dstEpgName", "dstEpgName", 37087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstIp", "dstIp", 25054, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstMacAddr", "dstMacAddr", 25055, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstPcTag", "dstPcTag", 37088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstPort", "dstPort", 25056, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25152, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "protocol", "protocol", 25057, PropCategory.REGULAR)
    prop.label = "Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "srcEpgName", "srcEpgName", 37089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIntf", "srcIntf", 25058, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 25059, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcMacAddr", "srcMacAddr", 25060, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPcTag", "srcPcTag", 37090, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPort", "srcPort", 25061, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vrfEncap", "vrfEncap", 25062, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "vrfEncap"))

    def __init__(self, parentMoOrDn, srcPcTag, dstPcTag, srcEpgName, dstEpgName, srcIp, dstIp, protocol, srcPort, dstPort, srcMacAddr, dstMacAddr, srcIntf, vrfEncap, markDirty=True, **creationProps):
        namingVals = [srcPcTag, dstPcTag, srcEpgName, dstEpgName, srcIp, dstIp, protocol, srcPort, dstPort, srcMacAddr, dstMacAddr, srcIntf, vrfEncap]
