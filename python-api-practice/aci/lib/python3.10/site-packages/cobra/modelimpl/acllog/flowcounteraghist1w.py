...
# ##################################################
class FlowCounterAgHist1w(Mo):
    """
    A class that represents historical aggregated statistics for  Flow  Record  Counter in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAgHist1w", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAgHist1w"
    meta.rnFormat = "HDacllogFlowCounterAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Flow Record Counter stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 25070, PropCategory.REGULAR)
