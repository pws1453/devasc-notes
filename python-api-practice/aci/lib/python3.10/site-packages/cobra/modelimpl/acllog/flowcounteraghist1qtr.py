...
# ##################################################
class FlowCounterAgHist1qtr(Mo):
    """
    A class that represents historical aggregated statistics for  Flow  Record  Counter in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.acllog.FlowCounterAgHist1qtr", "Flow Record Counter")
    ...
    meta.moClassName = "acllogFlowCounterAgHist1qtr"
    meta.rnFormat = "HDacllogFlowCounterAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Flow Record Counter stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDacllogFlowCounterAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 25069, PropCategory.REGULAR)
