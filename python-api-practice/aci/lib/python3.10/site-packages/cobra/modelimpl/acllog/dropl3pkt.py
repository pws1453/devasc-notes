...
class DropL3Pkt(Mo):
    ...
    meta = ClassMeta("cobra.model.acllog.DropL3Pkt")

    meta.moClassName = "acllogDropL3Pkt"
    meta.rnFormat = "dropl3pkt-%(recordId)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-time-%(timeStamp)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L3 Drop Pkt Record"
    ...
    prop = PropMeta("str", "dstIp", "dstIp", 25028, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstMacAddr", "dstMacAddr", 25063, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstPort", "dstPort", 25031, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25156, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "pktLen", "pktLen", 25042, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "protocol", "protocol", 25032, PropCategory.REGULAR)
    prop.label = "Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "recordId", "recordId", 27664, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 25027, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcMacAddr", "srcMacAddr", 25064, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPort", "srcPort", 25030, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "timeStamp", "timeStamp", 25043, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vrfEncap", "vrfEncap", 25029, PropCategory.REGULAR)
