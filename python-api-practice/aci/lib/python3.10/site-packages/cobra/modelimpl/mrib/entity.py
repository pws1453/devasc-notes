...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.mrib.Entity")

    meta.moClassName = "mribEntity"
    meta.rnFormat = "mrib"
    meta.category = MoCategory.REGULAR
    meta.label = "MRIB Entity"
    ...
    meta.childClasses.add("cobra.model.mrib.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.mrib.Inst", "inst"))
