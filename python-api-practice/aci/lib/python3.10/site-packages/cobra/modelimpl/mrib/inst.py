...
class Inst(Mo):
    """
     These objects hold per routed multicast instance information 

    """

    meta = ClassMeta("cobra.model.mrib.Inst")

    meta.moClassName = "mribInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "MRIB instance"
    ...
    meta.childClasses.add("cobra.model.mrib.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.mrib.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.mrib.Entity")
