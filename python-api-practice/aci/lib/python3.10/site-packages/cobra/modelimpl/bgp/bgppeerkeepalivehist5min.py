...
# ##################################################
class BgpPeerKeepAliveHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist5min", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist5min"
    meta.rnFormat = "HDbgpBgpPeerKeepAlive5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDbgpBgpPeerKeepAlive5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53395, PropCategory.REGULAR)
