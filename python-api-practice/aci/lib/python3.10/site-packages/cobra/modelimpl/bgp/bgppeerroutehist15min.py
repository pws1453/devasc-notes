...
# ##################################################
class BgpPeerRouteHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist15min", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist15min"
    meta.rnFormat = "HDbgpBgpPeerRoute15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.bgp.BgpPeerRouteHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDbgpBgpPeerRoute15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53412, PropCategory.REGULAR)
