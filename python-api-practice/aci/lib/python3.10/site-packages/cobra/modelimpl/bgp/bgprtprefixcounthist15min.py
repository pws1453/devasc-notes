...
# ##################################################
class BgpRtPrefixCountHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist15min", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist15min"
    meta.rnFormat = "HDbgpBgpRtPrefixCount15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDbgpBgpRtPrefixCount15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53420, PropCategory.REGULAR)
