...
# ##################################################
class PeerOpenHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist5min", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist5min"
    meta.rnFormat = "HDbgpPeerOpen5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47736, PropCategory.REGULAR)
