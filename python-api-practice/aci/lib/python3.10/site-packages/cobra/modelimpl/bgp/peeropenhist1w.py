...
# ##################################################
class PeerOpenHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist1w", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist1w"
    meta.rnFormat = "HDbgpPeerOpen1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47734, PropCategory.REGULAR)
