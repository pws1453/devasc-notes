...
class LocalAsnP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.LocalAsnP")

    meta.moClassName = "bgpLocalAsnP"
    meta.rnFormat = "localasn"
    meta.category = MoCategory.REGULAR
    meta.label = "Local Autonomous System Profile"
    ...
    meta.superClasses.add("cobra.model.bgp.ALocalAsnP")

    meta.rnPrefixes = [
        ('localasn', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38150, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "asnPropagate", "asnPropagate", 17562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40289, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "localAsn", "localAsn", 17561, PropCategory.REGULAR)
    prop.label = "Local ASN"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26749, PropCategory.REGULAR)
