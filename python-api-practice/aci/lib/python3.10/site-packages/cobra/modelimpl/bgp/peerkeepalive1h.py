...
# ##################################################
class PeerKeepAlive1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAlive1h", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAlive1h"
    meta.rnFormat = "CDbgpPeerKeepAlive1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BGP Peer Keepalive stats in 1 hour"
