...
class AsDef(Mo):
    """
    An internal object for the BGP autonomous system profile definition.

    """

    meta = ClassMeta("cobra.model.bgp.AsDef")

    meta.moClassName = "bgpAsDef"
    meta.rnFormat = "as"
    meta.category = MoCategory.REGULAR
    meta.label = "Autonomous System Profile Definition"
