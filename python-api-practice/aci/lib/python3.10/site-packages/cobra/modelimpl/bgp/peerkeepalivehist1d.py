...
# ##################################################
class PeerKeepAliveHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist1d", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist1d"
    meta.rnFormat = "HDbgpPeerKeepAlive1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47714, PropCategory.REGULAR)
