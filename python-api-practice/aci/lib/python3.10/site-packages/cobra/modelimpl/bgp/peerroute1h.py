...
# ##################################################
class PeerRoute1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRoute1h", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRoute1h"
    meta.rnFormat = "CDbgpPeerRoute1h"
