...
# ##################################################
class RtEppBgpCtxAfPol(Mo):
    """
    A target relation to the per-address family BGP context policy.

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtEppBgpCtxAfPol", "cobra.model.fv.RtdEpP")

    meta.moClassName = "bgpRtEppBgpCtxAfPol"
    meta.rnFormat = "rtfvEppBgpCtxAfPol-[%(tDn)s]-%(af)s"
    ...
    meta.rnPrefixes = [
        ('rtfvEppBgpCtxAfPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "af", "af", 17582, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 17584, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17583, PropCategory.REGULAR)
