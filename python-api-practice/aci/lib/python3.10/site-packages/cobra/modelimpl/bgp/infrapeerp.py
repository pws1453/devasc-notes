...
class InfraPeerP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.InfraPeerP")

    meta.moClassName = "bgpInfraPeerP"
    meta.rnFormat = "infraPeerP-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Infra Peer Connectivity Profile"
    ...
    prop = PropMeta("str", "addr", "addr", 21417, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38312, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 25165, PropCategory.REGULAR)
    prop.label = "Peer AF Controls"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = "send-com,send-ext-com"
    prop.defaultValueStr = "send-com,send-ext-com"
    ...
    prop = PropMeta("str", "dataPlaneAddr", "dataPlaneAddr", 56430, PropCategory.REGULAR)
    prop.label = "Data plane address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("dataPlaneAddr", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40451, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21469, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "peerT", "peerT", 21365, PropCategory.REGULAR)
    prop.label = "Peer Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "wan"
    prop._addConstant("intersite", "intersite-connectivity", 4)
    prop._addConstant("wan", "wan-connectivity", 1)
    meta.props.add("peerT", prop)
    ...
    prop = PropMeta("str", "remoteIntersiteRR", "remoteIntersiteRR", 29961, PropCategory.REGULAR)
    prop.label = "Intersite Route Reflector"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("remoteIntersiteRR", prop)
    ...
    prop = PropMeta("str", "srcIfT", "srcIfT", 55948, PropCategory.REGULAR)
    prop.label = "Source Interface Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "l3out-loopback"
    prop._addConstant("l3out-loopback", "l3out-loopback-as-source", 1)
    prop._addConstant("routable-loopback", "routable-loopback-as-source", 2)
    meta.props.add("srcIfT", prop)
    ...
    prop = PropMeta("str", "trustCtrl", "trustCtrl", 27966, PropCategory.REGULAR)
    prop.label = "Control Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "untrusted"
    prop._addConstant("trusted", "enable", 2)
    prop._addConstant("untrusted", "disable", 0)
    meta.props.add("trustCtrl", prop)
