...
# ##################################################
class BgpPeerRouteHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist1w", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist1w"
    meta.rnFormat = "HDbgpBgpPeerRoute1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 53417, PropCategory.REGULAR)
