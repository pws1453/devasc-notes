...
# ##################################################
class BgpPeerKeepAlive15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive15min", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive15min"
    meta.rnFormat = "CDbgpBgpPeerKeepAlive15min"
    ...
    meta.rnPrefixes = [
        ('CDbgpBgpPeerKeepAlive15min', False),
    ]
