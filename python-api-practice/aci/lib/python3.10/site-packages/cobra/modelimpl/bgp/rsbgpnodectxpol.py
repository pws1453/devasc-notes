...
# ##################################################
class RsBgpNodeCtxPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.bgp.RsBgpNodeCtxPol", "cobra.model.bgp.CtxPol")
    meta.targetNameProps["name"] = "tnBgpCtxPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "bgpRsBgpNodeCtxPol"
    meta.rnFormat = "rsbgpNodeCtxPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "BGP Context Policy Per Profile"
    ...
    meta.rnPrefixes = [
        ('rsbgpNodeCtxPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38606, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40745, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28620, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 28616, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 643
    prop.defaultValueStr = "bgpCtxPol"
    ...
    prop = PropMeta("str", "tnBgpCtxPolName", "tnBgpCtxPolName", 28615, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBgpCtxPolName", prop)
