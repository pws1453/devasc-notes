...
# ##################################################
class BgpPeerOpenHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist1d", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist1d"
    meta.rnFormat = "HDbgpBgpPeerOpen1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 53405, PropCategory.REGULAR)
