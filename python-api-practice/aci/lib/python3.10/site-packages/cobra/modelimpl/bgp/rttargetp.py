...
class RtTargetP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RtTargetP")

    meta.moClassName = "bgpRtTargetP"
    meta.rnFormat = "rtp-%(af)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Route Target Profile"
    ...
    meta.childClasses.add("cobra.model.bgp.RtTarget")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtTarget", "rt-"))
    ...
    prop = PropMeta("str", "af", "af", 21372, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38313, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40452, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
