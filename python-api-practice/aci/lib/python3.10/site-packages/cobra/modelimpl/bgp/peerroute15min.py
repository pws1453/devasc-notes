...
# ##################################################
class PeerRoute15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRoute15min", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRoute15min"
    meta.rnFormat = "CDbgpPeerRoute15min"
