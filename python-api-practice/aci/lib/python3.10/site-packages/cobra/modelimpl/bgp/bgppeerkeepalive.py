...
# ##################################################
class BgpPeerKeepAlive(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive15min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive1h")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive5min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAlive1mo")
