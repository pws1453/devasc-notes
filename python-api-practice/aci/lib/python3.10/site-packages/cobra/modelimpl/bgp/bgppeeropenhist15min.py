...
# ##################################################
class BgpPeerOpenHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist15min", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist15min"
    meta.rnFormat = "HDbgpBgpPeerOpen15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.bgp.BgpPeerOpenHist")

    meta.rnPrefixes = [
        ('HDbgpBgpPeerOpen15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53404, PropCategory.REGULAR)
