...
# ##################################################
class EVpnImetRoute(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.EVpnImetRoute")

    meta.moClassName = "bgpEVpnImetRoute"
    meta.rnFormat = "evpnimetrt-%(rd)s-eti-%(eti)s-ip-[%(pfx)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "EVPN Inclusive Multicast Ethernet Tag Route"
    ...
    prop = PropMeta("str", "eti", "eti", 20647, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pfx", "pfx", 20699, PropCategory.REGULAR)
    prop.label = "Prefix"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "rd", "rd", 20698, PropCategory.REGULAR)
