...
# ##################################################
class BgpPeerRoute(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRoute", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRoute"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute1h")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute15min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRoute5min")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "capabilityRcvdAvg", "capabilityRcvdAvg", 53728, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Capability Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdAvg", prop)

    prop = PropMeta("str", "capabilityRcvdBase", "capabilityRcvdBase", 53723, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Capability Messages Received baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdBase", prop)

    prop = PropMeta("str", "capabilityRcvdCum", "capabilityRcvdCum", 53724, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Capability Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdCum", prop)

    prop = PropMeta("str", "capabilityRcvdLast", "capabilityRcvdLast", 53722, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Capability Messages Received current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdLast", prop)

    prop = PropMeta("str", "capabilityRcvdMax", "capabilityRcvdMax", 53727, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Capability Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdMax", prop)

    prop = PropMeta("str", "capabilityRcvdMin", "capabilityRcvdMin", 53726, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Capability Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdMin", prop)

    prop = PropMeta("str", "capabilityRcvdPer", "capabilityRcvdPer", 53725, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Capability Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdPer", prop)

    prop = PropMeta("str", "capabilityRcvdRate", "capabilityRcvdRate", 53733, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Capability Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdRate", prop)

    prop = PropMeta("str", "capabilityRcvdSpct", "capabilityRcvdSpct", 53729, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Capability Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdSpct", prop)

    prop = PropMeta("str", "capabilityRcvdThr", "capabilityRcvdThr", 53730, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "capabilityRcvdTr", "capabilityRcvdTr", 53732, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Capability Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdTr", prop)

    prop = PropMeta("str", "capabilityRcvdTrBase", "capabilityRcvdTrBase", 53731, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Number of Capability Messages Received trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdTrBase", prop)

    prop = PropMeta("str", "capabilitySentAvg", "capabilitySentAvg", 53749, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Capability Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentAvg", prop)

    prop = PropMeta("str", "capabilitySentBase", "capabilitySentBase", 53744, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Capability Messages Sent baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentBase", prop)

    prop = PropMeta("str", "capabilitySentCum", "capabilitySentCum", 53745, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Capability Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentCum", prop)

    prop = PropMeta("str", "capabilitySentLast", "capabilitySentLast", 53743, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Capability Messages Sent current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentLast", prop)

    prop = PropMeta("str", "capabilitySentMax", "capabilitySentMax", 53748, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Capability Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentMax", prop)

    prop = PropMeta("str", "capabilitySentMin", "capabilitySentMin", 53747, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Capability Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentMin", prop)

    prop = PropMeta("str", "capabilitySentPer", "capabilitySentPer", 53746, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Capability Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentPer", prop)

    prop = PropMeta("str", "capabilitySentRate", "capabilitySentRate", 53754, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Capability Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentRate", prop)

    prop = PropMeta("str", "capabilitySentSpct", "capabilitySentSpct", 53750, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Capability Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentSpct", prop)

    prop = PropMeta("str", "capabilitySentThr", "capabilitySentThr", 53751, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "capabilitySentTr", "capabilitySentTr", 53753, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Capability Messages Sent trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentTr", prop)

    prop = PropMeta("str", "capabilitySentTrBase", "capabilitySentTrBase", 53752, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "routeRefreshRcvdAvg", "routeRefreshRcvdAvg", 53770, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Route Refresh Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdAvg", prop)

    prop = PropMeta("str", "routeRefreshRcvdBase", "routeRefreshRcvdBase", 53765, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Route Refresh Messages Received baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdBase", prop)

    prop = PropMeta("str", "routeRefreshRcvdCum", "routeRefreshRcvdCum", 53766, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Route Refresh Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdCum", prop)

    prop = PropMeta("str", "routeRefreshRcvdLast", "routeRefreshRcvdLast", 53764, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Route Refresh Messages Received current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdLast", prop)

    prop = PropMeta("str", "routeRefreshRcvdMax", "routeRefreshRcvdMax", 53769, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Route Refresh Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdMax", prop)

    prop = PropMeta("str", "routeRefreshRcvdMin", "routeRefreshRcvdMin", 53768, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Route Refresh Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdMin", prop)

    prop = PropMeta("str", "routeRefreshRcvdPer", "routeRefreshRcvdPer", 53767, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Route Refresh Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdPer", prop)

    prop = PropMeta("str", "routeRefreshRcvdRate", "routeRefreshRcvdRate", 53775, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Route Refresh Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdRate", prop)

    prop = PropMeta("str", "routeRefreshRcvdSpct", "routeRefreshRcvdSpct", 53771, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Route Refresh Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdSpct", prop)

    prop = PropMeta("str", "routeRefreshRcvdThr", "routeRefreshRcvdThr", 53772, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "routeRefreshRcvdTr", "routeRefreshRcvdTr", 53774, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Route Refresh Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdTr", prop)

    prop = PropMeta("str", "routeRefreshRcvdTrBase", "routeRefreshRcvdTrBase", 53773, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Number of Route Refresh Messages Received trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdTrBase", prop)

    prop = PropMeta("str", "routeRefreshSentAvg", "routeRefreshSentAvg", 53791, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Route Refresh Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentAvg", prop)

    prop = PropMeta("str", "routeRefreshSentBase", "routeRefreshSentBase", 53786, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Route Refresh Messages Sent baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentBase", prop)

    prop = PropMeta("str", "routeRefreshSentCum", "routeRefreshSentCum", 53787, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Route Refresh Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentCum", prop)

    prop = PropMeta("str", "routeRefreshSentLast", "routeRefreshSentLast", 53785, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Route Refresh Messages Sent current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentLast", prop)

    prop = PropMeta("str", "routeRefreshSentMax", "routeRefreshSentMax", 53790, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Route Refresh Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentMax", prop)

    prop = PropMeta("str", "routeRefreshSentMin", "routeRefreshSentMin", 53789, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Route Refresh Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentMin", prop)

    prop = PropMeta("str", "routeRefreshSentPer", "routeRefreshSentPer", 53788, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Route Refresh Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentPer", prop)

    prop = PropMeta("str", "routeRefreshSentRate", "routeRefreshSentRate", 53796, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Route Refresh Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentRate", prop)

    prop = PropMeta("str", "routeRefreshSentSpct", "routeRefreshSentSpct", 53792, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Route Refresh Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentSpct", prop)

    prop = PropMeta("str", "routeRefreshSentThr", "routeRefreshSentThr", 53793, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "routeRefreshSentTr", "routeRefreshSentTr", 53795, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Route Refresh Messages Sent trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentTr", prop)

    prop = PropMeta("str", "routeRefreshSentTrBase", "routeRefreshSentTrBase", 53794, PropCategory.IMPLICIT_TREND_BASE)
