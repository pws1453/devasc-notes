...
class RtCtrlDef(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RtCtrlDef")

    meta.moClassName = "bgpRtCtrlDef"
    meta.rnFormat = "rtCtrlDef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Bgp Route Control Policy Def"
    ...
    prop = PropMeta("str", "direction", "direction", 54495, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "name", "name", 54502, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
