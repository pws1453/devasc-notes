...
# ##################################################
class PeerKeepAlive(Mo):
    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAlive", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAlive"


    meta.moClassName = "bgpPeerKeepAlive"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BGP Peer Keepalive stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive1w")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive1d")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive1year")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive5min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive1h")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive15min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAlive1qtr")
    ...
    prop = PropMeta("str", "keepaliveRcvdAvg", "keepaliveRcvdAvg", 47987, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Keepalive Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdAvg", prop)

    prop = PropMeta("str", "keepaliveRcvdBase", "keepaliveRcvdBase", 47982, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Keepalive Messages Received baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdBase", prop)

    prop = PropMeta("str", "keepaliveRcvdCum", "keepaliveRcvdCum", 47983, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Keepalive Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdCum", prop)

    prop = PropMeta("str", "keepaliveRcvdLast", "keepaliveRcvdLast", 47981, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Keepalive Messages Received current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdLast", prop)

    prop = PropMeta("str", "keepaliveRcvdMax", "keepaliveRcvdMax", 47986, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Keepalive Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdMax", prop)

    prop = PropMeta("str", "keepaliveRcvdMin", "keepaliveRcvdMin", 47985, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Keepalive Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdMin", prop)

    prop = PropMeta("str", "keepaliveRcvdPer", "keepaliveRcvdPer", 47984, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Keepalive Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdPer", prop)

    prop = PropMeta("str", "keepaliveRcvdRate", "keepaliveRcvdRate", 47992, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Keepalive Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdRate", prop)

    prop = PropMeta("str", "keepaliveRcvdSpct", "keepaliveRcvdSpct", 47988, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Keepalive Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdSpct", prop)

    prop = PropMeta("str", "keepaliveRcvdThr", "keepaliveRcvdThr", 47989, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "keepaliveRcvdTr", "keepaliveRcvdTr", 47991, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Keepalive Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdTr", prop)

    prop = PropMeta("str", "keepaliveRcvdTrBase", "keepaliveRcvdTrBase", 47990, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Number of Keepalive Messages Received trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdTrBase", prop)

    prop = PropMeta("str", "keepaliveSentAvg", "keepaliveSentAvg", 48008, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Keepalive Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentAvg", prop)

    prop = PropMeta("str", "keepaliveSentBase", "keepaliveSentBase", 48003, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Keepalive Messages Sent baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentBase", prop)

    prop = PropMeta("str", "keepaliveSentCum", "keepaliveSentCum", 48004, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Keepalive Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentCum", prop)

    prop = PropMeta("str", "keepaliveSentLast", "keepaliveSentLast", 48002, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Keepalive Messages Sent current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentLast", prop)

    prop = PropMeta("str", "keepaliveSentMax", "keepaliveSentMax", 48007, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Keepalive Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentMax", prop)

    prop = PropMeta("str", "keepaliveSentMin", "keepaliveSentMin", 48006, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Keepalive Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentMin", prop)

    prop = PropMeta("str", "keepaliveSentPer", "keepaliveSentPer", 48005, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Keepalive Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentPer", prop)

    prop = PropMeta("str", "keepaliveSentRate", "keepaliveSentRate", 48013, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Keepalive Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentRate", prop)

    prop = PropMeta("str", "keepaliveSentSpct", "keepaliveSentSpct", 48009, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Keepalive Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentSpct", prop)

    prop = PropMeta("str", "keepaliveSentThr", "keepaliveSentThr", 48010, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "keepaliveSentTr", "keepaliveSentTr", 48012, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Keepalive Messages Sent trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentTr", prop)

    prop = PropMeta("str", "keepaliveSentTrBase", "keepaliveSentTrBase", 48011, PropCategory.IMPLICIT_TREND_BASE)
