...
# ##################################################
class RtBgpCtxPol(Mo):
    """
    A target relation to the BGP timers policy.

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtBgpCtxPol", "cobra.model.fv.Ctx")

    meta.moClassName = "bgpRtBgpCtxPol"
    meta.rnFormat = "rtfvBgpCtxPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12363, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12362, PropCategory.REGULAR)
