...
class CktEpEvi(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.CktEpEvi")

    meta.moClassName = "bgpCktEpEvi"
    meta.rnFormat = "cktepevi-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Circuit Endpoint Ethernet VPN Instance"
    ...
    prop = PropMeta("str", "encap", "encap", 20696, PropCategory.REGULAR)
