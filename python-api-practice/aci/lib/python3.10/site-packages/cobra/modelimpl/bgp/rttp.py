...
class RttP(Mo):
    """
    The route target policy.

    """

    meta = ClassMeta("cobra.model.bgp.RttP")

    meta.moClassName = "bgpRttP"
    meta.rnFormat = "rttp-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Route Target Policy"
    ...
    meta.childClasses.add("cobra.model.bgp.RtCtrlMapP")
    meta.childClasses.add("cobra.model.bgp.RttEntry")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtCtrlMapP", "rtctrlmap"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RttEntry", "ent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.bgp.DomAf")
    meta.parentClasses.add("cobra.model.bgp.EncapGroupEvi")
    meta.parentClasses.add("cobra.model.bgp.BDEvi")
    meta.parentClasses.add("cobra.model.bgp.CktEpEvi")
    meta.parentClasses.add("cobra.model.bgp.DomEvi")

    meta.superClasses.add("cobra.model.pol.Instr")
    meta.superClasses.add("cobra.model.bgp.ARtP")
    ...
    prop = PropMeta("str", "instantiationT", "instantiationT", 26472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 2538, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
