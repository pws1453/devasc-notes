...
# ##################################################
class PeerMsgHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.PeerMsgHist", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpPeerMsgHist"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerMsgHist1h")
    ...
    prop = PropMeta("str", "msgRcvdAvg", "msgRcvdAvg", 48039, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdAvg", prop)

    prop = PropMeta("str", "msgRcvdCum", "msgRcvdCum", 48035, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdCum", prop)

    prop = PropMeta("str", "msgRcvdMax", "msgRcvdMax", 48038, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdMax", prop)

    prop = PropMeta("str", "msgRcvdMin", "msgRcvdMin", 48037, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdMin", prop)

    prop = PropMeta("str", "msgRcvdPer", "msgRcvdPer", 48036, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdPer", prop)

    prop = PropMeta("str", "msgRcvdRate", "msgRcvdRate", 48043, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdRate", prop)

    prop = PropMeta("str", "msgRcvdSpct", "msgRcvdSpct", 48040, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdSpct", prop)

    prop = PropMeta("str", "msgRcvdThr", "msgRcvdThr", 48041, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "msgRcvdTr", "msgRcvdTr", 48042, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdTr", prop)

    prop = PropMeta("str", "msgSentAvg", "msgSentAvg", 48060, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentAvg", prop)

    prop = PropMeta("str", "msgSentCum", "msgSentCum", 48056, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentCum", prop)

    prop = PropMeta("str", "msgSentMax", "msgSentMax", 48059, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentMax", prop)

    prop = PropMeta("str", "msgSentMin", "msgSentMin", 48058, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentMin", prop)

    prop = PropMeta("str", "msgSentPer", "msgSentPer", 48057, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentPer", prop)

    prop = PropMeta("str", "msgSentRate", "msgSentRate", 48064, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentRate", prop)

    prop = PropMeta("str", "msgSentSpct", "msgSentSpct", 48061, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentSpct", prop)

    prop = PropMeta("str", "msgSentThr", "msgSentThr", 48062, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "notifSentTr", "notifSentTr", 48105, PropCategory.IMPLICIT_TREND)
