...
# ##################################################
class PeerKeepAlive15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAlive15min", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAlive15min"
    meta.rnFormat = "CDbgpPeerKeepAlive15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BGP Peer Keepalive stats in 15 minute"
