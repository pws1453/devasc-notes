...
# ##################################################
class PeerKeepAliveHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist1year", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist1year"
    meta.rnFormat = "HDbgpPeerKeepAlive1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47719, PropCategory.REGULAR)
