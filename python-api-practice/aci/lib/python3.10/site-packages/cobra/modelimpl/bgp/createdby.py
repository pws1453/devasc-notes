...
class CreatedBy(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.CreatedBy")

    meta.moClassName = "bgpCreatedBy"
    meta.rnFormat = "by-[%(peerPDn)s]-[%(rsNodeDn)s]"
    ...
    prop = PropMeta("str", "peerPDn", "peerPDn", 25184, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("peerPDn", prop)
    ...
    prop = PropMeta("str", "rsNodeDn", "rsNodeDn", 25185, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("rsNodeDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "peerPDn"))
    getattr(meta.props, "peerPDn").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "rsNodeDn"))
    getattr(meta.props, "rsNodeDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, peerPDn, rsNodeDn, markDirty=True, **creationProps):
        namingVals = [peerPDn, rsNodeDn]
