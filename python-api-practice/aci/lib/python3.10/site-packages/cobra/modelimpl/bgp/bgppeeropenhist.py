...
# ##################################################
class BgpPeerOpenHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist"


    meta.moClassName = "bgpBgpPeerOpenHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist1h")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpenHist1qtr")
    ...
    prop = PropMeta("str", "openRcvdAvg", "openRcvdAvg", 53654, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Open Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdAvg", prop)

    prop = PropMeta("str", "openRcvdCum", "openRcvdCum", 53650, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Open Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdCum", prop)

    prop = PropMeta("str", "openRcvdMax", "openRcvdMax", 53653, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Open Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdMax", prop)

    prop = PropMeta("str", "openRcvdMin", "openRcvdMin", 53652, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Open Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdMin", prop)

    prop = PropMeta("str", "openRcvdPer", "openRcvdPer", 53651, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Open Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdPer", prop)

    prop = PropMeta("str", "openRcvdRate", "openRcvdRate", 53658, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Open Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdRate", prop)

    prop = PropMeta("str", "openRcvdSpct", "openRcvdSpct", 53655, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Open Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdSpct", prop)

    prop = PropMeta("str", "openRcvdThr", "openRcvdThr", 53656, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "openRcvdTr", "openRcvdTr", 53657, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Open Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdTr", prop)

    prop = PropMeta("str", "openSentAvg", "openSentAvg", 53675, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Open Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentAvg", prop)

    prop = PropMeta("str", "openSentCum", "openSentCum", 53671, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Open Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentCum", prop)

    prop = PropMeta("str", "openSentMax", "openSentMax", 53674, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Open Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentMax", prop)

    prop = PropMeta("str", "openSentMin", "openSentMin", 53673, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Open Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentMin", prop)

    prop = PropMeta("str", "openSentPer", "openSentPer", 53672, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Open Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentPer", prop)

    prop = PropMeta("str", "openSentRate", "openSentRate", 53679, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Open Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentRate", prop)

    prop = PropMeta("str", "openSentSpct", "openSentSpct", 53676, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Open Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentSpct", prop)

    prop = PropMeta("str", "openSentThr", "openSentThr", 53677, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "openSentTr", "openSentTr", 53678, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "updateRcvdAvg", "updateRcvdAvg", 53696, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Update Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdAvg", prop)

    prop = PropMeta("str", "updateRcvdCum", "updateRcvdCum", 53692, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Update Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdCum", prop)

    prop = PropMeta("str", "updateRcvdMax", "updateRcvdMax", 53695, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Update Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdMax", prop)

    prop = PropMeta("str", "updateRcvdMin", "updateRcvdMin", 53694, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Update Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdMin", prop)

    prop = PropMeta("str", "updateRcvdPer", "updateRcvdPer", 53693, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Update Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdPer", prop)

    prop = PropMeta("str", "updateRcvdRate", "updateRcvdRate", 53700, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Update Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdRate", prop)

    prop = PropMeta("str", "updateRcvdSpct", "updateRcvdSpct", 53697, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Update Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdSpct", prop)

    prop = PropMeta("str", "updateRcvdThr", "updateRcvdThr", 53698, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "updateRcvdTr", "updateRcvdTr", 53699, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Update Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdTr", prop)

    prop = PropMeta("str", "updateSentAvg", "updateSentAvg", 53717, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Update Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentAvg", prop)

    prop = PropMeta("str", "updateSentCum", "updateSentCum", 53713, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Update Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentCum", prop)

    prop = PropMeta("str", "updateSentMax", "updateSentMax", 53716, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Update Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentMax", prop)

    prop = PropMeta("str", "updateSentMin", "updateSentMin", 53715, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Update Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentMin", prop)

    prop = PropMeta("str", "updateSentPer", "updateSentPer", 53714, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Update Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentPer", prop)

    prop = PropMeta("str", "updateSentRate", "updateSentRate", 53721, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Update Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentRate", prop)

    prop = PropMeta("str", "updateSentSpct", "updateSentSpct", 53718, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Update Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentSpct", prop)

    prop = PropMeta("str", "updateSentThr", "updateSentThr", 53719, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "updateSentTr", "updateSentTr", 53720, PropCategory.IMPLICIT_TREND)
