...
# ##################################################
class PeerRoute1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRoute1w", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRoute1w"
    meta.rnFormat = "CDbgpPeerRoute1w"
