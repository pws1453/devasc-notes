...
# ##################################################
class BgpPeerKeepAliveHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist15min", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist15min"
    meta.rnFormat = "HDbgpBgpPeerKeepAlive15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist")

    meta.rnPrefixes = [
        ('HDbgpBgpPeerKeepAlive15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53388, PropCategory.REGULAR)
