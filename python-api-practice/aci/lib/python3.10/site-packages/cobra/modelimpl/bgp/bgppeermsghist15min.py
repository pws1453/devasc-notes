...
# ##################################################
class BgpPeerMsgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerMsgHist15min", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpBgpPeerMsgHist15min"
    meta.rnFormat = "HDbgpBgpPeerMsg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Msg stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.bgp.BgpPeerMsgHist")

    meta.rnPrefixes = [
        ('HDbgpBgpPeerMsg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53396, PropCategory.REGULAR)
