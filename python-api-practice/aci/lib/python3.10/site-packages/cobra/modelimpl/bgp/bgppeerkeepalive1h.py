...
# ##################################################
class BgpPeerKeepAlive1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive1h", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive1h"
    meta.rnFormat = "CDbgpBgpPeerKeepAlive1h"
