...
# ##################################################
class RsPeerToProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.bgp.RsPeerToProfile", "cobra.model.rtctrl.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "bgpRsPeerToProfile"
    meta.rnFormat = "rspeerToProfile-[%(tDn)s]-%(direction)s"
    ...
    meta.rnPrefixes = [
        ('rspeerToProfile-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 54403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 54507, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "direction", "direction", 54396, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54404, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 54402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54398, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54508, PropCategory.REGULAR)
