...
# ##################################################
class PeerMsgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerMsgHist1year", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpPeerMsgHist1year"
    meta.rnFormat = "HDbgpPeerMsg1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47727, PropCategory.REGULAR)
