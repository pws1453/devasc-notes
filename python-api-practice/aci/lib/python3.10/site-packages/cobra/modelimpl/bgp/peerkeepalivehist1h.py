...
# ##################################################
class PeerKeepAliveHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist1h", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist1h"
    meta.rnFormat = "HDbgpPeerKeepAlive1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47715, PropCategory.REGULAR)
