...
# ##################################################
class BgpRtPrefixCountHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist1d", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist1d"
    meta.rnFormat = "HDbgpBgpRtPrefixCount1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 53421, PropCategory.REGULAR)
