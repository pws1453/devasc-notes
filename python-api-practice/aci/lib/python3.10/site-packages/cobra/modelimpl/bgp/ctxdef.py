...
class CtxDef(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.CtxDef")

    meta.moClassName = "bgpCtxDef"
    meta.rnFormat = "bgpCtxP"
    ...
    meta.parentClasses.add("cobra.model.l3ext.RtdCtxDef")
    ...
    meta.superClasses.add("cobra.model.bgp.ACtxPol")
    ...
    prop = PropMeta("str", "grCtrl", "grCtrl", 812, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "holdIntvl", "holdIntvl", 811, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "kaIntvl", "kaIntvl", 810, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxAsLimit", "maxAsLimit", 24380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "staleIntvl", "staleIntvl", 813, PropCategory.REGULAR)
