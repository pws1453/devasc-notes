...
# ##################################################
class BgpPeerMsgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerMsgHist1d", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpBgpPeerMsgHist1d"
    meta.rnFormat = "HDbgpBgpPeerMsg1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 53397, PropCategory.REGULAR)
