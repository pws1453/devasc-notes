...
# ##################################################
class BgpPeerKeepAliveHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist"


    meta.moClassName = "bgpBgpPeerKeepAliveHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerKeepAliveHist1h")
    ...
    prop = PropMeta("str", "keepaliveRcvdAvg", "keepaliveRcvdAvg", 53528, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Keepalive Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdAvg", prop)

    prop = PropMeta("str", "keepaliveRcvdCum", "keepaliveRcvdCum", 53524, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Keepalive Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdCum", prop)

    prop = PropMeta("str", "keepaliveRcvdMax", "keepaliveRcvdMax", 53527, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Keepalive Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdMax", prop)

    prop = PropMeta("str", "keepaliveRcvdMin", "keepaliveRcvdMin", 53526, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Keepalive Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdMin", prop)

    prop = PropMeta("str", "keepaliveRcvdPer", "keepaliveRcvdPer", 53525, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Keepalive Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdPer", prop)

    prop = PropMeta("str", "keepaliveRcvdRate", "keepaliveRcvdRate", 53532, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Keepalive Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdRate", prop)

    prop = PropMeta("str", "keepaliveRcvdSpct", "keepaliveRcvdSpct", 53529, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Keepalive Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdSpct", prop)

    prop = PropMeta("str", "keepaliveRcvdThr", "keepaliveRcvdThr", 53530, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "keepaliveRcvdTr", "keepaliveRcvdTr", 53531, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Keepalive Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdTr", prop)

    prop = PropMeta("str", "keepaliveSentAvg", "keepaliveSentAvg", 53549, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Keepalive Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentAvg", prop)

    prop = PropMeta("str", "keepaliveSentCum", "keepaliveSentCum", 53545, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Keepalive Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentCum", prop)

    prop = PropMeta("str", "keepaliveSentMax", "keepaliveSentMax", 53548, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Keepalive Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentMax", prop)

    prop = PropMeta("str", "keepaliveSentMin", "keepaliveSentMin", 53547, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Keepalive Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentMin", prop)

    prop = PropMeta("str", "keepaliveSentPer", "keepaliveSentPer", 53546, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Keepalive Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentPer", prop)

    prop = PropMeta("str", "keepaliveSentRate", "keepaliveSentRate", 53553, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Keepalive Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentRate", prop)

    prop = PropMeta("str", "keepaliveSentSpct", "keepaliveSentSpct", 53550, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Keepalive Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentSpct", prop)

    prop = PropMeta("str", "keepaliveSentThr", "keepaliveSentThr", 53551, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "keepaliveSentTr", "keepaliveSentTr", 53552, PropCategory.IMPLICIT_TREND)
