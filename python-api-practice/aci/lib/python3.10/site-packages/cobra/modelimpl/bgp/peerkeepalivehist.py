...
# ##################################################
class PeerKeepAliveHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist1h")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerKeepAliveHist1year")
    ...
    prop = PropMeta("str", "keepaliveRcvdAvg", "keepaliveRcvdAvg", 47997, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Keepalive Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdAvg", prop)

    prop = PropMeta("str", "keepaliveRcvdCum", "keepaliveRcvdCum", 47993, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Keepalive Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdCum", prop)

    prop = PropMeta("str", "keepaliveRcvdMax", "keepaliveRcvdMax", 47996, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Keepalive Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdMax", prop)

    prop = PropMeta("str", "keepaliveRcvdMin", "keepaliveRcvdMin", 47995, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Keepalive Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdMin", prop)

    prop = PropMeta("str", "keepaliveRcvdPer", "keepaliveRcvdPer", 47994, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Keepalive Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdPer", prop)

    prop = PropMeta("str", "keepaliveRcvdRate", "keepaliveRcvdRate", 48001, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Keepalive Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdRate", prop)

    prop = PropMeta("str", "keepaliveRcvdSpct", "keepaliveRcvdSpct", 47998, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Keepalive Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdSpct", prop)

    prop = PropMeta("str", "keepaliveRcvdThr", "keepaliveRcvdThr", 47999, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "keepaliveRcvdTr", "keepaliveRcvdTr", 48000, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Keepalive Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveRcvdTr", prop)

    prop = PropMeta("str", "keepaliveSentAvg", "keepaliveSentAvg", 48018, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Keepalive Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentAvg", prop)

    prop = PropMeta("str", "keepaliveSentCum", "keepaliveSentCum", 48014, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Keepalive Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentCum", prop)

    prop = PropMeta("str", "keepaliveSentMax", "keepaliveSentMax", 48017, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Keepalive Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentMax", prop)

    prop = PropMeta("str", "keepaliveSentMin", "keepaliveSentMin", 48016, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Keepalive Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentMin", prop)

    prop = PropMeta("str", "keepaliveSentPer", "keepaliveSentPer", 48015, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Keepalive Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentPer", prop)

    prop = PropMeta("str", "keepaliveSentRate", "keepaliveSentRate", 48022, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Keepalive Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentRate", prop)

    prop = PropMeta("str", "keepaliveSentSpct", "keepaliveSentSpct", 48019, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Keepalive Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("keepaliveSentSpct", prop)

    prop = PropMeta("str", "keepaliveSentThr", "keepaliveSentThr", 48020, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "keepaliveSentTr", "keepaliveSentTr", 48021, PropCategory.IMPLICIT_TREND)
