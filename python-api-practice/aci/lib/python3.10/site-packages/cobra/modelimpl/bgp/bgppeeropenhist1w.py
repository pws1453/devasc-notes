...
# ##################################################
class BgpPeerOpenHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist1w", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist1w"
    meta.rnFormat = "HDbgpBgpPeerOpen1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 53409, PropCategory.REGULAR)
