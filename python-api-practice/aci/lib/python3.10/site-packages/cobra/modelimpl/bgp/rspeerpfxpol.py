...
# ##################################################
class RsPeerPfxPol(Mo):
    """
    The source relation to the peer prefix policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.bgp.RsPeerPfxPol", "cobra.model.bgp.PeerPfxPol")
    meta.targetNameProps["name"] = "tnBgpPeerPfxPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "bgpRsPeerPfxPol"
    meta.rnFormat = "rspeerPfxPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Peer Prefix Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37382, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39521, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13906, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11383, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 646
    prop.defaultValueStr = "bgpPeerPfxPol"
    ...
    prop = PropMeta("str", "tnBgpPeerPfxPolName", "tnBgpPeerPfxPolName", 11382, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBgpPeerPfxPolName", prop)
