...
# ##################################################
class RtEppBgpCtxPol(Mo):
    """
    A target relation to the BGP timers policy.

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtEppBgpCtxPol", "cobra.model.fv.RtdEpP")

    meta.moClassName = "bgpRtEppBgpCtxPol"
    meta.rnFormat = "rtfvEppBgpCtxPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12254, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12253, PropCategory.REGULAR)
