...
# ##################################################
class PeerOpenHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist1year", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist1year"
    meta.rnFormat = "HDbgpPeerOpen1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47735, PropCategory.REGULAR)
