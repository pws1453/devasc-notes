...
# ##################################################
class PeerOpen5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpen5min", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpen5min"
    meta.rnFormat = "CDbgpPeerOpen5min"
