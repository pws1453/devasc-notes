...
# ##################################################
class BgpPeerRouteHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist1mo", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist1mo"
    meta.rnFormat = "HDbgpBgpPeerRoute1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 53415, PropCategory.REGULAR)
