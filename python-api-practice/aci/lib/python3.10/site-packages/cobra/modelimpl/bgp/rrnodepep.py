...
class RRNodePEp(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RRNodePEp")

    meta.moClassName = "bgpRRNodePEp"
    meta.rnFormat = "node-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Route Reflector Node Policy Ep"
    ...
    meta.childClasses.add("cobra.model.bgp.InvalidRREp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.InvalidRREp", "badselection"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37378, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39517, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 5885, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13901, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 806, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
