...
# ##################################################
class BgpRtPrefixCountHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist1qtr", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist1qtr"
    meta.rnFormat = "HDbgpBgpRtPrefixCount1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDbgpBgpRtPrefixCount1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53424, PropCategory.REGULAR)
