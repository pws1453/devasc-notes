...
# ##################################################
class LocalAsnDef(Mo):
    """
    The local autonomous system number (ASN) definition.

    """

    meta = ClassMeta("cobra.model.bgp.LocalAsnDef")

    meta.moClassName = "bgpLocalAsnDef"
    meta.rnFormat = "localasn"
    meta.category = MoCategory.REGULAR
    meta.label = "Local Autonomous System Profile Definition"
