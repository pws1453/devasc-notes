...
# ##################################################
class RtBestPathCtrlPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtBestPathCtrlPol", "cobra.model.bgp.ProtP")

    meta.moClassName = "bgpRtBestPathCtrlPol"
    meta.rnFormat = "rtbestPathCtrlPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55236, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9549
    prop.defaultValueStr = "bgpProtP"
    prop._addConstant("bgpProtP", None, 9549)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55235, PropCategory.REGULAR)
