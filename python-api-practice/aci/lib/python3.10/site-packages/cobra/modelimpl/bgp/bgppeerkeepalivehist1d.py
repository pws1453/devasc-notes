...
# ##################################################
class BgpPeerKeepAliveHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist1d", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist1d"
    meta.rnFormat = "HDbgpBgpPeerKeepAlive1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 53389, PropCategory.REGULAR)
