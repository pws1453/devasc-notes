...
# ##################################################
class PeerKeepAliveHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist5min", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist5min"
    meta.rnFormat = "HDbgpPeerKeepAlive5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47720, PropCategory.REGULAR)
