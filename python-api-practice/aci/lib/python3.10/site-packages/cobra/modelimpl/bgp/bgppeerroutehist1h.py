...
# ##################################################
class BgpPeerRouteHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist1h", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist1h"
    meta.rnFormat = "HDbgpBgpPeerRoute1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 53414, PropCategory.REGULAR)
