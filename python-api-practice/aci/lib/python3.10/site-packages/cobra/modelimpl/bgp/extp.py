...
class ExtP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.ExtP")

    meta.moClassName = "bgpExtP"
    meta.rnFormat = "bgpExtP"
    ...
    meta.superClasses.add("cobra.model.bgp.AExtP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37383, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39522, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26521, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 825, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "bgp"
