...
# ##################################################
class BgpPeerRouteHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist1d", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist1d"
    meta.rnFormat = "HDbgpBgpPeerRoute1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 53413, PropCategory.REGULAR)
