...
# ##################################################
class PeerOpenHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist1qtr", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist1qtr"
    meta.rnFormat = "HDbgpPeerOpen1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47733, PropCategory.REGULAR)
