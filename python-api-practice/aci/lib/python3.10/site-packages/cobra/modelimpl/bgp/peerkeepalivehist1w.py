...
# ##################################################
class PeerKeepAliveHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist1w", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist1w"
    meta.rnFormat = "HDbgpPeerKeepAlive1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47718, PropCategory.REGULAR)
