...
# ##################################################
class BgpPeerKeepAliveHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist1qtr", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist1qtr"
    meta.rnFormat = "HDbgpBgpPeerKeepAlive1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDbgpBgpPeerKeepAlive1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53392, PropCategory.REGULAR)
