...
# ##################################################
class BgpPeerRouteHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist1qtr", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist1qtr"
    meta.rnFormat = "HDbgpBgpPeerRoute1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 53416, PropCategory.REGULAR)
