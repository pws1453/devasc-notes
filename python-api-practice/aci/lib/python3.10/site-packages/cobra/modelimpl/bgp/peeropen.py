...
# ##################################################
class PeerOpen(Mo):
    meta = StatsClassMeta("cobra.model.bgp.PeerOpen", "BGP Peer Open")
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen5min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen1w")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen1year")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen1d")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen1h")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpen15min")
