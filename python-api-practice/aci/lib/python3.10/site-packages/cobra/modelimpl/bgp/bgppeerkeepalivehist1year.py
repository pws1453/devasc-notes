...
# ##################################################
class BgpPeerKeepAliveHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist1year", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist1year"
    meta.rnFormat = "HDbgpBgpPeerKeepAlive1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDbgpBgpPeerKeepAlive1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53394, PropCategory.REGULAR)
