...
# ##################################################
class PeerMsgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerMsgHist15min", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpPeerMsgHist15min"
    meta.rnFormat = "HDbgpPeerMsg15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47721, PropCategory.REGULAR)
