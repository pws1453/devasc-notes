...
class CtxAfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.CtxAfPol")

    meta.moClassName = "bgpCtxAfPol"
    meta.rnFormat = "bgpCtxAfP-%(name)s"
    ...
    meta.childClasses.add("cobra.model.bgp.RtEppBgpCtxAfPol")
    meta.childClasses.add("cobra.model.bgp.RtCtxToBgpCtxAfPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtCtxToBgpCtxAfPol", "rtfvCtxToBgpCtxAfPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtEppBgpCtxAfPol", "rtfvEppBgpCtxAfPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38151, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 27238, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("host-rt-leak", "host-rt-leak", 1)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40290, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "maxEcmp", "maxEcmp", 33266, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxEcmpIbgp", "maxEcmpIbgp", 33381, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 17574, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
