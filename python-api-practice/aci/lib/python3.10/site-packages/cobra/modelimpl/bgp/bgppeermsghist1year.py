...
# ##################################################
class BgpPeerMsgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerMsgHist1year", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpBgpPeerMsgHist1year"
    meta.rnFormat = "HDbgpBgpPeerMsg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Msg stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 53402, PropCategory.REGULAR)
