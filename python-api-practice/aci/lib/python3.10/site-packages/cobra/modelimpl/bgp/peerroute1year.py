...
# ##################################################
class PeerRoute1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRoute1year", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRoute1year"
    meta.rnFormat = "CDbgpPeerRoute1year"
