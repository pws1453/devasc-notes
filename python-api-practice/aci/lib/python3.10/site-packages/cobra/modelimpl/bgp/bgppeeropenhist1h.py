...
# ##################################################
class BgpPeerOpenHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist1h", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist1h"
    meta.rnFormat = "HDbgpBgpPeerOpen1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 53406, PropCategory.REGULAR)
