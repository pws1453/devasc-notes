...
# ##################################################
class PeerRoute5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRoute5min", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRoute5min"
    meta.rnFormat = "CDbgpPeerRoute5min"
