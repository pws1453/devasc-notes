...
# ##################################################
class BgpPeerOpenHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist1year", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist1year"
    meta.rnFormat = "HDbgpBgpPeerOpen1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 53410, PropCategory.REGULAR)
