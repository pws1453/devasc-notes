...
# ##################################################
class BgpPeerMsgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerMsgHist1mo", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpBgpPeerMsgHist1mo"
    meta.rnFormat = "HDbgpBgpPeerMsg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Msg stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 53399, PropCategory.REGULAR)
