...
# ##################################################
class RtCtrlPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.RtCtrlPolDef")

    meta.moClassName = "bgpRtCtrlPolDef"
    meta.rnFormat = "bgpRtctrlPolDef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Bgp Route Control Policies"
    ...
    prop = PropMeta("str", "direction", "direction", 54496, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "name", "name", 54503, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
