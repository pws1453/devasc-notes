...
# ##################################################
class PeerKeepAliveHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist1qtr", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist1qtr"
    meta.rnFormat = "HDbgpPeerKeepAlive1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47717, PropCategory.REGULAR)
