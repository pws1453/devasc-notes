...
# ##################################################
class BgpPeerOpenHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist1mo", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist1mo"
    meta.rnFormat = "HDbgpBgpPeerOpen1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 53407, PropCategory.REGULAR)
