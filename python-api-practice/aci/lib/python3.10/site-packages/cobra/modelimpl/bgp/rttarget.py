...
class RtTarget(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RtTarget")

    meta.moClassName = "bgpRtTarget"
    meta.rnFormat = "rt-[%(rt)s]-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Route Target"
    ...
    meta.superClasses.add("cobra.model.bgp.ARtTarget")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38314, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40453, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "rt", "rt", 21418, PropCategory.REGULAR)
    prop.label = "Route Target"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "targetAf", "targetAf", 21375, PropCategory.REGULAR)
    prop.label = "Route Target Target Address Family"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "l2vpn-evpn"
    prop._addConstant("l2vpn-evpn", "l2vpn-evpn-address-family", 1)
    meta.props.add("targetAf", prop)

    prop = PropMeta("str", "type", "type", 22487, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "rt"))
    getattr(meta.props, "rt").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, rt, type, markDirty=True, **creationProps):
        namingVals = [rt, type]
