...
# ##################################################
class BgpPeerOpenHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist1qtr", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist1qtr"
    meta.rnFormat = "HDbgpBgpPeerOpen1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 53408, PropCategory.REGULAR)
