...
class RRP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RRP")

    meta.moClassName = "bgpRRP"
    meta.rnFormat = "rr"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37377, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39516, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13900, PropCategory.REGULAR)
