...
# ##################################################
class RtBgpNodeCtxPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtBgpNodeCtxPol", "cobra.model.bgp.ProtP")

    meta.moClassName = "bgpRtBgpNodeCtxPol"
    meta.rnFormat = "rtbgpNodeCtxPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28618, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 28617, PropCategory.REGULAR)
