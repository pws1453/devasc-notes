...
# ##################################################
class EVpnPfxRoute(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.EVpnPfxRoute")

    meta.moClassName = "bgpEVpnPfxRoute"
    meta.rnFormat = "evpnpfxrt-%(rd)s-eti-%(eti)s-ip-[%(pfx)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "EVPN IP Prefix Route"
    ...
    meta.parentClasses.add("cobra.model.bgp.BDEvi")
    ...
    meta.superClasses.add("cobra.model.bgp.PfxRoute")
    ...
    prop = PropMeta("str", "esi", "esi", 20648, PropCategory.REGULAR)
    prop.label = "Ethernet Segment Identifier"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("esi", prop)

    prop = PropMeta("str", "eti", "eti", 20649, PropCategory.REGULAR)
    prop.label = "Ethernet Tag Identifier"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("eti", prop)

    prop = PropMeta("str", "gwip", "gwip", 20650, PropCategory.REGULAR)
    prop.label = "Gateway IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("gwip", prop)
    ...
    prop = PropMeta("str", "pfx", "pfx", 20703, PropCategory.REGULAR)
    prop.label = "Prefix"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "rd", "rd", 20702, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "rd"))
    meta.namingProps.append(getattr(meta.props, "eti"))
    meta.namingProps.append(getattr(meta.props, "pfx"))
    getattr(meta.props, "pfx").needDelimiter = True

    def __init__(self, parentMoOrDn, rd, eti, pfx, markDirty=True, **creationProps):
        namingVals = [rd, eti, pfx]
