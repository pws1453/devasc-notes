...
# ##################################################
class PeerRouteHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRouteHist5min", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRouteHist5min"
    meta.rnFormat = "HDbgpPeerRoute5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47744, PropCategory.REGULAR)
