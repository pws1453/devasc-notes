...
# ##################################################
class BgpPeerMsgHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpPeerMsgHist", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpBgpPeerMsgHist"


    meta.moClassName = "bgpBgpPeerMsgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Msg stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist1h")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerMsgHist1qtr")
    ...
    prop = PropMeta("str", "msgRcvdAvg", "msgRcvdAvg", 53570, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdAvg", prop)

    prop = PropMeta("str", "msgRcvdCum", "msgRcvdCum", 53566, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdCum", prop)

    prop = PropMeta("str", "msgRcvdMax", "msgRcvdMax", 53569, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdMax", prop)

    prop = PropMeta("str", "msgRcvdMin", "msgRcvdMin", 53568, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdMin", prop)

    prop = PropMeta("str", "msgRcvdPer", "msgRcvdPer", 53567, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdPer", prop)

    prop = PropMeta("str", "msgRcvdRate", "msgRcvdRate", 53574, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdRate", prop)

    prop = PropMeta("str", "msgRcvdSpct", "msgRcvdSpct", 53571, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdSpct", prop)

    prop = PropMeta("str", "msgRcvdThr", "msgRcvdThr", 53572, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "msgRcvdTr", "msgRcvdTr", 53573, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgRcvdTr", prop)

    prop = PropMeta("str", "msgSentAvg", "msgSentAvg", 53591, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentAvg", prop)

    prop = PropMeta("str", "msgSentCum", "msgSentCum", 53587, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentCum", prop)

    prop = PropMeta("str", "msgSentMax", "msgSentMax", 53590, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentMax", prop)

    prop = PropMeta("str", "msgSentMin", "msgSentMin", 53589, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentMin", prop)

    prop = PropMeta("str", "msgSentPer", "msgSentPer", 53588, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentPer", prop)

    prop = PropMeta("str", "msgSentRate", "msgSentRate", 53595, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentRate", prop)

    prop = PropMeta("str", "msgSentSpct", "msgSentSpct", 53592, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("msgSentSpct", prop)

    prop = PropMeta("str", "msgSentThr", "msgSentThr", 53593, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "notifSentTr", "notifSentTr", 53636, PropCategory.IMPLICIT_TREND)
