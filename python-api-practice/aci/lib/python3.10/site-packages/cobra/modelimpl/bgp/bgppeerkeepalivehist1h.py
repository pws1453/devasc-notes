...
# ##################################################
class BgpPeerKeepAliveHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist1h", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist1h"
    meta.rnFormat = "HDbgpBgpPeerKeepAlive1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 53390, PropCategory.REGULAR)
