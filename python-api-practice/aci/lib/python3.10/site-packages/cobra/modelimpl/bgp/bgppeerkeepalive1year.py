...
# ##################################################
class BgpPeerKeepAlive1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive1year", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive1year"
    meta.rnFormat = "CDbgpBgpPeerKeepAlive1year"
    ...
    meta.rnPrefixes = [
        ('CDbgpBgpPeerKeepAlive1year', False),
    ]
