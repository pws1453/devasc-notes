...
# ##################################################
class PeerKeepAlive1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAlive1mo", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAlive1mo"
    meta.rnFormat = "CDbgpPeerKeepAlive1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BGP Peer Keepalive stats in 1 month"
