...
class ExtRRP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.ExtRRP")

    meta.moClassName = "bgpExtRRP"
    meta.rnFormat = "extrr"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38311, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40450, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21468, PropCategory.REGULAR)
