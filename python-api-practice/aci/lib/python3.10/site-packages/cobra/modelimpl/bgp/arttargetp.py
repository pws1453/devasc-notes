...
# ##################################################
class ARtTargetP(Mo):
    meta = ClassMeta("cobra.model.bgp.ARtTargetP")

    meta.isAbstract = True
    meta.moClassName = "bgpARtTargetP"


    meta.moClassName = "bgpARtTargetP"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Route Target Profile"
    ...
    prop = PropMeta("str", "af", "af", 21371, PropCategory.REGULAR)
