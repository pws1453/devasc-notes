...
# ##################################################
class BgpRtPrefixCountHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist1w", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist1w"
    meta.rnFormat = "HDbgpBgpRtPrefixCount1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 53425, PropCategory.REGULAR)
