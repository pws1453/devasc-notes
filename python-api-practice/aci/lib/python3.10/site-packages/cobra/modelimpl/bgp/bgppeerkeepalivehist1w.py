...
# ##################################################
class BgpPeerKeepAliveHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAliveHist1w", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAliveHist1w"
    meta.rnFormat = "HDbgpBgpPeerKeepAlive1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Keepalive stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 53393, PropCategory.REGULAR)
