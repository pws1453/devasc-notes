...
# ##################################################
class InfraPeerDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.InfraPeerDef")

    meta.moClassName = "bgpInfraPeerDef"
    meta.rnFormat = "infraPeerP-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Infra Peer Connectivity Profile Definition"
    ...
    meta.childClasses.add("cobra.model.bgp.CreatedBy")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.CreatedBy", "by-"))
    ...
    meta.superClasses.add("cobra.model.bgp.APeerDef")
    ...
    prop = PropMeta("str", "addr", "addr", 21416, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dataPlaneAddr", "dataPlaneAddr", 56431, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21470, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "peerT", "peerT", 21370, PropCategory.REGULAR)
    ...
    prop._addConstant("intra-site", "intra-site-connectivity", 2)
    ...
    prop = PropMeta("str", "remoteIntersiteRR", "remoteIntersiteRR", 29962, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIfT", "srcIfT", 55949, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "trustCtrl", "trustCtrl", 27967, PropCategory.REGULAR)
