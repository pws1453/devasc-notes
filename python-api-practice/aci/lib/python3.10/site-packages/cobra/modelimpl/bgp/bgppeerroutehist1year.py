...
# ##################################################
class BgpPeerRouteHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist1year", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist1year"
    meta.rnFormat = "HDbgpBgpPeerRoute1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 53418, PropCategory.REGULAR)
