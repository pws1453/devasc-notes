...
class VpnCtrlP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.VpnCtrlP")

    meta.moClassName = "bgpVpnCtrlP"
    meta.rnFormat = "ctrl-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Virtual Private Network Control Policy"
    ...
    meta.childClasses.add("cobra.model.bgp.PfxLeakCtrlP")
    meta.childClasses.add("cobra.model.bgp.RtP")
    meta.childClasses.add("cobra.model.bgp.PfxLeakP")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.PfxLeakCtrlP", "pfxleakctrl"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.PfxLeakP", "pfxleak-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtP", "rtp-"))
    ...
    prop = PropMeta("str", "type", "type", 20706, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
