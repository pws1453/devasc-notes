...
# ##################################################
class BgpPeerOpen1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpen1year", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpen1year"
    meta.rnFormat = "CDbgpBgpPeerOpen1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BGP Peer Open stats in 1 year"
    ...
    meta.superClasses.add("cobra.model.bgp.BgpPeerOpen")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDbgpBgpPeerOpen1year', False),
    ]
