...
class RtSummPol(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RtSummPol")

    meta.moClassName = "bgpRtSummPol"
    meta.rnFormat = "bgprtsum-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP route summarization policy"
    ...
    meta.superClasses.add("cobra.model.bgp.ARtSummPol")

    meta.rnPrefixes = [
        ('bgprtsum-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38361, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "attrmap", "attrmap", 22732, PropCategory.REGULAR)
    prop.label = "Attribute Route-Map"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("attrmap", prop)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 22731, PropCategory.REGULAR)
    prop.label = "Summary control"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("as-set", "generate-as-set-information", 1)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40500, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 22786, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
