...
# ##################################################
class PeerOpenHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist1h", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist1h"
    meta.rnFormat = "HDbgpPeerOpen1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47731, PropCategory.REGULAR)
