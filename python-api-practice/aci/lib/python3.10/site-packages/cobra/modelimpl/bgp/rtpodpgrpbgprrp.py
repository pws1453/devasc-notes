...
# ##################################################
class RtPodPGrpBGPRRP(Mo):
    """
    A target relation to the BGP instance policy.

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtPodPGrpBGPRRP", "cobra.model.fabric.PodPGrp")

    meta.moClassName = "bgpRtPodPGrpBGPRRP"
    meta.rnFormat = "rtfabricPodPGrpBGPRRP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11548, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11547, PropCategory.REGULAR)
