...
# ##################################################
class BgpPeerRouteHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist5min", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist5min"
    meta.rnFormat = "HDbgpBgpPeerRoute5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 53419, PropCategory.REGULAR)
