...
# ##################################################
class PeerOpen1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpen1mo", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpen1mo"
    meta.rnFormat = "CDbgpPeerOpen1mo"
