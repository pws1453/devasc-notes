...
# ##################################################
class BgpPeerMsgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerMsgHist5min", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpBgpPeerMsgHist5min"
    meta.rnFormat = "HDbgpBgpPeerMsg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Msg stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 53403, PropCategory.REGULAR)
