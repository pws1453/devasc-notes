...
# ##################################################
class BgpPeerRoute15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRoute15min", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRoute15min"
    meta.rnFormat = "CDbgpBgpPeerRoute15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BGP Peer Route stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.bgp.BgpPeerRoute")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDbgpBgpPeerRoute15min', False),
    ]
