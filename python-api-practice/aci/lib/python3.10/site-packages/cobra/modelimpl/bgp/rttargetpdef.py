...
# ##################################################
class RtTargetPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.RtTargetPDef")

    meta.moClassName = "bgpRtTargetPDef"
    meta.rnFormat = "rtp-%(af)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Route Target Profile Definition"
    ...
    prop = PropMeta("str", "af", "af", 21419, PropCategory.REGULAR)
