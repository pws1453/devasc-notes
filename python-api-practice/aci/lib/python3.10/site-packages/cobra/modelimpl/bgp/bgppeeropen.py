...
# ##################################################
class BgpPeerOpen(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpen", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpen"


    meta.moClassName = "bgpBgpPeerOpen"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current BGP Peer Open stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen1h")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen5min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen15min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerOpen1qtr")
    ...
    prop = PropMeta("str", "openRcvdAvg", "openRcvdAvg", 53644, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Open Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdAvg", prop)

    prop = PropMeta("str", "openRcvdBase", "openRcvdBase", 53639, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Open Messages Received baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdBase", prop)

    prop = PropMeta("str", "openRcvdCum", "openRcvdCum", 53640, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Open Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdCum", prop)

    prop = PropMeta("str", "openRcvdLast", "openRcvdLast", 53638, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Open Messages Received current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdLast", prop)

    prop = PropMeta("str", "openRcvdMax", "openRcvdMax", 53643, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Open Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdMax", prop)

    prop = PropMeta("str", "openRcvdMin", "openRcvdMin", 53642, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Open Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdMin", prop)

    prop = PropMeta("str", "openRcvdPer", "openRcvdPer", 53641, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Open Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdPer", prop)

    prop = PropMeta("str", "openRcvdRate", "openRcvdRate", 53649, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Open Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdRate", prop)

    prop = PropMeta("str", "openRcvdSpct", "openRcvdSpct", 53645, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Open Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdSpct", prop)

    prop = PropMeta("str", "openRcvdThr", "openRcvdThr", 53646, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "openRcvdTr", "openRcvdTr", 53648, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Open Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdTr", prop)

    prop = PropMeta("str", "openRcvdTrBase", "openRcvdTrBase", 53647, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Number of Open Messages Received trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openRcvdTrBase", prop)

    prop = PropMeta("str", "openSentAvg", "openSentAvg", 53665, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Open Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentAvg", prop)

    prop = PropMeta("str", "openSentBase", "openSentBase", 53660, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Open Messages Sent baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentBase", prop)

    prop = PropMeta("str", "openSentCum", "openSentCum", 53661, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Open Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentCum", prop)

    prop = PropMeta("str", "openSentLast", "openSentLast", 53659, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Open Messages Sent current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentLast", prop)

    prop = PropMeta("str", "openSentMax", "openSentMax", 53664, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Open Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentMax", prop)

    prop = PropMeta("str", "openSentMin", "openSentMin", 53663, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Open Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentMin", prop)

    prop = PropMeta("str", "openSentPer", "openSentPer", 53662, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Open Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentPer", prop)

    prop = PropMeta("str", "openSentRate", "openSentRate", 53670, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Open Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentRate", prop)

    prop = PropMeta("str", "openSentSpct", "openSentSpct", 53666, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Open Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentSpct", prop)

    prop = PropMeta("str", "openSentThr", "openSentThr", 53667, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "openSentTr", "openSentTr", 53669, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Open Messages Sent trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("openSentTr", prop)

    prop = PropMeta("str", "openSentTrBase", "openSentTrBase", 53668, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "updateRcvdAvg", "updateRcvdAvg", 53686, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Update Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdAvg", prop)

    prop = PropMeta("str", "updateRcvdBase", "updateRcvdBase", 53681, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Update Messages Received baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdBase", prop)

    prop = PropMeta("str", "updateRcvdCum", "updateRcvdCum", 53682, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Update Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdCum", prop)

    prop = PropMeta("str", "updateRcvdLast", "updateRcvdLast", 53680, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Update Messages Received current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdLast", prop)

    prop = PropMeta("str", "updateRcvdMax", "updateRcvdMax", 53685, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Update Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdMax", prop)

    prop = PropMeta("str", "updateRcvdMin", "updateRcvdMin", 53684, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Update Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdMin", prop)

    prop = PropMeta("str", "updateRcvdPer", "updateRcvdPer", 53683, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Update Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdPer", prop)

    prop = PropMeta("str", "updateRcvdRate", "updateRcvdRate", 53691, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Update Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdRate", prop)

    prop = PropMeta("str", "updateRcvdSpct", "updateRcvdSpct", 53687, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Update Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdSpct", prop)

    prop = PropMeta("str", "updateRcvdThr", "updateRcvdThr", 53688, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "updateRcvdTr", "updateRcvdTr", 53690, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Update Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdTr", prop)

    prop = PropMeta("str", "updateRcvdTrBase", "updateRcvdTrBase", 53689, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Number of Update Messages Received trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateRcvdTrBase", prop)

    prop = PropMeta("str", "updateSentAvg", "updateSentAvg", 53707, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Update Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentAvg", prop)

    prop = PropMeta("str", "updateSentBase", "updateSentBase", 53702, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Number of Update Messages Sent baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentBase", prop)

    prop = PropMeta("str", "updateSentCum", "updateSentCum", 53703, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Update Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentCum", prop)

    prop = PropMeta("str", "updateSentLast", "updateSentLast", 53701, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Number of Update Messages Sent current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentLast", prop)

    prop = PropMeta("str", "updateSentMax", "updateSentMax", 53706, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Update Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentMax", prop)

    prop = PropMeta("str", "updateSentMin", "updateSentMin", 53705, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Update Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentMin", prop)

    prop = PropMeta("str", "updateSentPer", "updateSentPer", 53704, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Update Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentPer", prop)

    prop = PropMeta("str", "updateSentRate", "updateSentRate", 53712, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Update Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentRate", prop)

    prop = PropMeta("str", "updateSentSpct", "updateSentSpct", 53708, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Update Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentSpct", prop)

    prop = PropMeta("str", "updateSentThr", "updateSentThr", 53709, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "updateSentTr", "updateSentTr", 53711, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Update Messages Sent trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("updateSentTr", prop)

    prop = PropMeta("str", "updateSentTrBase", "updateSentTrBase", 53710, PropCategory.IMPLICIT_TREND_BASE)
