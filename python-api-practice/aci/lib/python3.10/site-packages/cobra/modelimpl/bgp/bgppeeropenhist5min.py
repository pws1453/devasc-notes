...
# ##################################################
class BgpPeerOpenHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerOpenHist5min", "BGP Peer Open")
    ...
    meta.moClassName = "bgpBgpPeerOpenHist5min"
    meta.rnFormat = "HDbgpBgpPeerOpen5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Open stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 53411, PropCategory.REGULAR)
