...
# ##################################################
class PeerKeepAliveHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerKeepAliveHist15min", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpPeerKeepAliveHist15min"
    meta.rnFormat = "HDbgpPeerKeepAlive15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47713, PropCategory.REGULAR)
