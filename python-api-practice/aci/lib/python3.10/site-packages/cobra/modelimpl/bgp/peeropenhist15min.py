...
# ##################################################
class PeerOpenHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist15min", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist15min"
    meta.rnFormat = "HDbgpPeerOpen15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47729, PropCategory.REGULAR)
