...
# ##################################################
class PeerRouteHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRouteHist15min", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRouteHist15min"
    meta.rnFormat = "HDbgpPeerRoute15min-%(index)s"
    ...
    meta.superClasses.add("cobra.model.bgp.PeerRouteHist")

    meta.rnPrefixes = [
        ('HDbgpPeerRoute15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 47737, PropCategory.REGULAR)
