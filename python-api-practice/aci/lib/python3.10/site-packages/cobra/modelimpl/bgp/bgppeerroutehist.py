...
# ##################################################
class BgpPeerRouteHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpPeerRouteHist", "BGP Peer Route")
    ...
    meta.moClassName = "bgpBgpPeerRouteHist"


    meta.moClassName = "bgpBgpPeerRouteHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Route stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist1h")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpPeerRouteHist15min")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "capabilityRcvdAvg", "capabilityRcvdAvg", 53738, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Capability Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdAvg", prop)

    prop = PropMeta("str", "capabilityRcvdCum", "capabilityRcvdCum", 53734, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Capability Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdCum", prop)

    prop = PropMeta("str", "capabilityRcvdMax", "capabilityRcvdMax", 53737, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Capability Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdMax", prop)

    prop = PropMeta("str", "capabilityRcvdMin", "capabilityRcvdMin", 53736, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Capability Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdMin", prop)

    prop = PropMeta("str", "capabilityRcvdPer", "capabilityRcvdPer", 53735, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Capability Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdPer", prop)

    prop = PropMeta("str", "capabilityRcvdRate", "capabilityRcvdRate", 53742, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Capability Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdRate", prop)

    prop = PropMeta("str", "capabilityRcvdSpct", "capabilityRcvdSpct", 53739, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Capability Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdSpct", prop)

    prop = PropMeta("str", "capabilityRcvdThr", "capabilityRcvdThr", 53740, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "capabilityRcvdTr", "capabilityRcvdTr", 53741, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Capability Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdTr", prop)

    prop = PropMeta("str", "capabilitySentAvg", "capabilitySentAvg", 53759, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Capability Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentAvg", prop)

    prop = PropMeta("str", "capabilitySentCum", "capabilitySentCum", 53755, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Capability Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentCum", prop)

    prop = PropMeta("str", "capabilitySentMax", "capabilitySentMax", 53758, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Capability Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentMax", prop)

    prop = PropMeta("str", "capabilitySentMin", "capabilitySentMin", 53757, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Capability Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentMin", prop)

    prop = PropMeta("str", "capabilitySentPer", "capabilitySentPer", 53756, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Capability Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentPer", prop)

    prop = PropMeta("str", "capabilitySentRate", "capabilitySentRate", 53763, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Capability Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentRate", prop)

    prop = PropMeta("str", "capabilitySentSpct", "capabilitySentSpct", 53760, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Capability Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentSpct", prop)

    prop = PropMeta("str", "capabilitySentThr", "capabilitySentThr", 53761, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "capabilitySentTr", "capabilitySentTr", 53762, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "routeRefreshRcvdAvg", "routeRefreshRcvdAvg", 53780, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Route Refresh Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdAvg", prop)

    prop = PropMeta("str", "routeRefreshRcvdCum", "routeRefreshRcvdCum", 53776, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Route Refresh Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdCum", prop)

    prop = PropMeta("str", "routeRefreshRcvdMax", "routeRefreshRcvdMax", 53779, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Route Refresh Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdMax", prop)

    prop = PropMeta("str", "routeRefreshRcvdMin", "routeRefreshRcvdMin", 53778, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Route Refresh Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdMin", prop)

    prop = PropMeta("str", "routeRefreshRcvdPer", "routeRefreshRcvdPer", 53777, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Route Refresh Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdPer", prop)

    prop = PropMeta("str", "routeRefreshRcvdRate", "routeRefreshRcvdRate", 53784, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Route Refresh Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdRate", prop)

    prop = PropMeta("str", "routeRefreshRcvdSpct", "routeRefreshRcvdSpct", 53781, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Route Refresh Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdSpct", prop)

    prop = PropMeta("str", "routeRefreshRcvdThr", "routeRefreshRcvdThr", 53782, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "routeRefreshRcvdTr", "routeRefreshRcvdTr", 53783, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Route Refresh Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdTr", prop)

    prop = PropMeta("str", "routeRefreshSentAvg", "routeRefreshSentAvg", 53801, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Route Refresh Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentAvg", prop)

    prop = PropMeta("str", "routeRefreshSentCum", "routeRefreshSentCum", 53797, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Route Refresh Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentCum", prop)

    prop = PropMeta("str", "routeRefreshSentMax", "routeRefreshSentMax", 53800, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Route Refresh Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentMax", prop)

    prop = PropMeta("str", "routeRefreshSentMin", "routeRefreshSentMin", 53799, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Route Refresh Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentMin", prop)

    prop = PropMeta("str", "routeRefreshSentPer", "routeRefreshSentPer", 53798, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Route Refresh Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentPer", prop)

    prop = PropMeta("str", "routeRefreshSentRate", "routeRefreshSentRate", 53805, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Route Refresh Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentRate", prop)

    prop = PropMeta("str", "routeRefreshSentSpct", "routeRefreshSentSpct", 53802, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Route Refresh Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentSpct", prop)

    prop = PropMeta("str", "routeRefreshSentThr", "routeRefreshSentThr", 53803, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "routeRefreshSentTr", "routeRefreshSentTr", 53804, PropCategory.IMPLICIT_TREND)
