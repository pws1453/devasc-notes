...
# ##################################################
class BgpPeerKeepAlive1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive1mo", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive1mo"
    meta.rnFormat = "CDbgpBgpPeerKeepAlive1mo"
    ...
    meta.rnPrefixes = [
        ('CDbgpBgpPeerKeepAlive1mo', False),
    ]
