...
# ##################################################
class BgpPeerMsgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerMsgHist1qtr", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpBgpPeerMsgHist1qtr"
    meta.rnFormat = "HDbgpBgpPeerMsg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Peer Msg stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 53400, PropCategory.REGULAR)
