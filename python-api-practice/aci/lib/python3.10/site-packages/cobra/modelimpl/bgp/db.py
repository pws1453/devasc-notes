...
class Db(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.Db")

    meta.moClassName = "bgpDb"
    meta.rnFormat = "db-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Database"
    ...
    meta.childClasses.add("cobra.model.bgp.DTEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.DTEp", "dtep-"))
    ...
    prop = PropMeta("str", "type", "type", 20653, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("dtep", "dynamic-tunnel-endpoint-database", 1)
