...
# ##################################################
class PeerOpenHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist1mo")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerOpenHist1h")
