...
# ##################################################
class BgpRtPrefixCountHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist5min", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist5min"
    meta.rnFormat = "HDbgpBgpRtPrefixCount5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDbgpBgpRtPrefixCount5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 53427, PropCategory.REGULAR)
