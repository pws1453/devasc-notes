...
# ##################################################
class ExtIntersiteRRP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.ExtIntersiteRRP")

    meta.moClassName = "bgpExtIntersiteRRP"
    meta.rnFormat = "extisrr"
    meta.category = MoCategory.REGULAR
    meta.label = "Route Reflector Profile"
    ...
    meta.superClasses.add("cobra.model.bgp.ARRP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38628, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40767, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 29965, PropCategory.REGULAR)
