...
# ##################################################
class BgpRtPrefixCountHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist1h", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist1h"
    meta.rnFormat = "HDbgpBgpRtPrefixCount1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 53422, PropCategory.REGULAR)
