...
# ##################################################
class PeerMsgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerMsgHist1qtr", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpPeerMsgHist1qtr"
    meta.rnFormat = "HDbgpPeerMsg1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47725, PropCategory.REGULAR)
