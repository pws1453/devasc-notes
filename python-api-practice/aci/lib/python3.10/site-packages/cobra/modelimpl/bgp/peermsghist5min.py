...
# ##################################################
class PeerMsgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerMsgHist5min", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpPeerMsgHist5min"
    meta.rnFormat = "HDbgpPeerMsg5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47728, PropCategory.REGULAR)
