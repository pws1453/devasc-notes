...
# ##################################################
class BgpPeerKeepAlive1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive1d", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive1d"
    meta.rnFormat = "CDbgpBgpPeerKeepAlive1d"
