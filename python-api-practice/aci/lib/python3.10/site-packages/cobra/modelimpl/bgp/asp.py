...
class AsP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.AsP")

    meta.moClassName = "bgpAsP"
    meta.rnFormat = "as"
    meta.category = MoCategory.REGULAR
    meta.label = "Autonomous System Profile"
    meta.writeAccessMask = 0x8000000001
    meta.readAccessMask = 0x8001000001
    ...
    meta.childClasses.add("cobra.model.bgp.RtBgpAsP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtBgpAsP", "rtl3extBgpAsP-"))
    ...
    meta.superClasses.add("cobra.model.bgp.AAsP")

    meta.rnPrefixes = [
        ('as', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37376, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "asn", "asn", 805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39515, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22423, PropCategory.REGULAR)
