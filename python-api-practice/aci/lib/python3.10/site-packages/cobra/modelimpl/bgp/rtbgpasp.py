...
class RtBgpAsP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.bgp.RtBgpAsP", "cobra.model.l3ext.OutDef")

    meta.moClassName = "bgpRtBgpAsP"
    meta.rnFormat = "rtl3extBgpAsP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "L3 Outside Def"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18657, PropCategory.REGULAR)
