...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.Entity")

    meta.moClassName = "bgpEntity"
    meta.rnFormat = "bgp"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Entity"
    ...
    meta.childClasses.add("cobra.model.bgp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14452, PropCategory.REGULAR)
