...
class PeerDef(Mo):
    """
    An internal object for the BGP peer connectivity definition.

    """

    meta = ClassMeta("cobra.model.bgp.PeerDef")

    meta.moClassName = "bgpPeerDef"
    meta.rnFormat = "peerP-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Peer Connectivity Profile Definition"
    ...
    meta.childClasses.add("cobra.model.bgp.RtCtrlDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RsPeerPfxPol", "rspeerPfxPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtCtrlDef", "rtCtrlDef-"))
    ...
    prop = PropMeta("str", "addr", "addr", 5882, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21466, PropCategory.REGULAR)
