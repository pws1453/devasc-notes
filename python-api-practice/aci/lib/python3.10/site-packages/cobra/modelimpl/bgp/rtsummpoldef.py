...
class RtSummPolDef(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RtSummPolDef")

    meta.moClassName = "bgpRtSummPolDef"
    meta.rnFormat = "bgprtsum-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP route summarization Internal policy"
    ...
    prop = PropMeta("str", "name", "name", 22787, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
