...
# ##################################################
class EncapEviBase(Mo):
    meta = ClassMeta("cobra.model.bgp.EncapEviBase")

    meta.isAbstract = True
    meta.moClassName = "bgpEncapEviBase"


    meta.moClassName = "bgpEncapEviBase"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Ethernet VPN Instance per Encap"
    ...
    prop = PropMeta("str", "encap", "encap", 20639, PropCategory.REGULAR)
