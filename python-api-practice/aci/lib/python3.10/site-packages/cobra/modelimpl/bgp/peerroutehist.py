...
# ##################################################
class PeerRouteHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.PeerRouteHist", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRouteHist"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist1h")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.PeerRouteHist1mo")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "capabilityRcvdAvg", "capabilityRcvdAvg", 48207, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Capability Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdAvg", prop)

    prop = PropMeta("str", "capabilityRcvdCum", "capabilityRcvdCum", 48203, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Capability Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdCum", prop)

    prop = PropMeta("str", "capabilityRcvdMax", "capabilityRcvdMax", 48206, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Capability Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdMax", prop)

    prop = PropMeta("str", "capabilityRcvdMin", "capabilityRcvdMin", 48205, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Capability Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdMin", prop)

    prop = PropMeta("str", "capabilityRcvdPer", "capabilityRcvdPer", 48204, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Capability Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdPer", prop)

    prop = PropMeta("str", "capabilityRcvdRate", "capabilityRcvdRate", 48211, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Capability Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdRate", prop)

    prop = PropMeta("str", "capabilityRcvdSpct", "capabilityRcvdSpct", 48208, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Capability Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdSpct", prop)

    prop = PropMeta("str", "capabilityRcvdThr", "capabilityRcvdThr", 48209, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "capabilityRcvdTr", "capabilityRcvdTr", 48210, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Capability Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilityRcvdTr", prop)

    prop = PropMeta("str", "capabilitySentAvg", "capabilitySentAvg", 48228, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Capability Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentAvg", prop)

    prop = PropMeta("str", "capabilitySentCum", "capabilitySentCum", 48224, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Capability Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentCum", prop)

    prop = PropMeta("str", "capabilitySentMax", "capabilitySentMax", 48227, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Capability Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentMax", prop)

    prop = PropMeta("str", "capabilitySentMin", "capabilitySentMin", 48226, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Capability Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentMin", prop)

    prop = PropMeta("str", "capabilitySentPer", "capabilitySentPer", 48225, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Capability Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentPer", prop)

    prop = PropMeta("str", "capabilitySentRate", "capabilitySentRate", 48232, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Capability Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentRate", prop)

    prop = PropMeta("str", "capabilitySentSpct", "capabilitySentSpct", 48229, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Capability Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("capabilitySentSpct", prop)

    prop = PropMeta("str", "capabilitySentThr", "capabilitySentThr", 48230, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "capabilitySentTr", "capabilitySentTr", 48231, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "routeRefreshRcvdAvg", "routeRefreshRcvdAvg", 48249, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Route Refresh Messages Received average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdAvg", prop)

    prop = PropMeta("str", "routeRefreshRcvdCum", "routeRefreshRcvdCum", 48245, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Route Refresh Messages Received cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdCum", prop)

    prop = PropMeta("str", "routeRefreshRcvdMax", "routeRefreshRcvdMax", 48248, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Route Refresh Messages Received maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdMax", prop)

    prop = PropMeta("str", "routeRefreshRcvdMin", "routeRefreshRcvdMin", 48247, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Route Refresh Messages Received minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdMin", prop)

    prop = PropMeta("str", "routeRefreshRcvdPer", "routeRefreshRcvdPer", 48246, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Route Refresh Messages Received periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdPer", prop)

    prop = PropMeta("str", "routeRefreshRcvdRate", "routeRefreshRcvdRate", 48253, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Route Refresh Messages Received rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdRate", prop)

    prop = PropMeta("str", "routeRefreshRcvdSpct", "routeRefreshRcvdSpct", 48250, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Route Refresh Messages Received suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdSpct", prop)

    prop = PropMeta("str", "routeRefreshRcvdThr", "routeRefreshRcvdThr", 48251, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "routeRefreshRcvdTr", "routeRefreshRcvdTr", 48252, PropCategory.IMPLICIT_TREND)
    prop.label = "Number of Route Refresh Messages Received trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshRcvdTr", prop)

    prop = PropMeta("str", "routeRefreshSentAvg", "routeRefreshSentAvg", 48270, PropCategory.IMPLICIT_AVG)
    prop.label = "Number of Route Refresh Messages Sent average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentAvg", prop)

    prop = PropMeta("str", "routeRefreshSentCum", "routeRefreshSentCum", 48266, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Number of Route Refresh Messages Sent cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentCum", prop)

    prop = PropMeta("str", "routeRefreshSentMax", "routeRefreshSentMax", 48269, PropCategory.IMPLICIT_MAX)
    prop.label = "Number of Route Refresh Messages Sent maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentMax", prop)

    prop = PropMeta("str", "routeRefreshSentMin", "routeRefreshSentMin", 48268, PropCategory.IMPLICIT_MIN)
    prop.label = "Number of Route Refresh Messages Sent minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentMin", prop)

    prop = PropMeta("str", "routeRefreshSentPer", "routeRefreshSentPer", 48267, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Number of Route Refresh Messages Sent periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentPer", prop)

    prop = PropMeta("str", "routeRefreshSentRate", "routeRefreshSentRate", 48274, PropCategory.IMPLICIT_RATE)
    prop.label = "Number of Route Refresh Messages Sent rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentRate", prop)

    prop = PropMeta("str", "routeRefreshSentSpct", "routeRefreshSentSpct", 48271, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Number of Route Refresh Messages Sent suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("routeRefreshSentSpct", prop)

    prop = PropMeta("str", "routeRefreshSentThr", "routeRefreshSentThr", 48272, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "routeRefreshSentTr", "routeRefreshSentTr", 48273, PropCategory.IMPLICIT_TREND)
