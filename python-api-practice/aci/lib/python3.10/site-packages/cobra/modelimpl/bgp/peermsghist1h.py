...
# ##################################################
class PeerMsgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerMsgHist1h", "BGP Peer Msg")
    ...
    meta.moClassName = "bgpPeerMsgHist1h"
    meta.rnFormat = "HDbgpPeerMsg1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47723, PropCategory.REGULAR)
