...
# ##################################################
class BgpPeerKeepAlive1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive1w", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive1w"
    meta.rnFormat = "CDbgpBgpPeerKeepAlive1w"
