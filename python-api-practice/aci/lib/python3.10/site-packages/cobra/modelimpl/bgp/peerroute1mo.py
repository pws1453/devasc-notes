...
# ##################################################
class PeerRoute1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRoute1mo", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRoute1mo"
    meta.rnFormat = "CDbgpPeerRoute1mo"
