...
# ##################################################
class RsBestPathCtrlPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.bgp.RsBestPathCtrlPol", "cobra.model.bgp.BestPathCtrlPol")
    meta.targetNameProps["name"] = "tnBgpBestPathCtrlPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "bgpRsBestPathCtrlPol"
    meta.rnFormat = "rsBestPathCtrlPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "AS Path policy"
    ...
    meta.rnPrefixes = [
        ('rsBestPathCtrlPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55238, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55239, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55237, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55234, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16209
    prop.defaultValueStr = "bgpBestPathCtrlPol"
    ...
    prop = PropMeta("str", "tnBgpBestPathCtrlPolName", "tnBgpBestPathCtrlPolName", 55233, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBgpBestPathCtrlPolName", prop)
