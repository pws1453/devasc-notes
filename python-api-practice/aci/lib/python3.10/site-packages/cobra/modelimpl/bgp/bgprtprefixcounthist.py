...
# ##################################################
class BgpRtPrefixCountHist(Mo):
    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist"


    meta.moClassName = "bgpBgpRtPrefixCountHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats"
    ...
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist1w")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist15min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist1year")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist1d")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist1qtr")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist5min")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist1h")
    meta.concreteSubClasses.add("cobra.model.bgp.BgpRtPrefixCountHist1mo")
