...
# ##################################################
class BestPathCtrlPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.BestPathCtrlPol")

    meta.moClassName = "bgpBestPathCtrlPol"
    meta.rnFormat = "bestpath-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Best Path Control policy"
    ...
    meta.childClasses.add("cobra.model.bgp.RtBestPathCtrlPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtBestPathCtrlPol", "rtbestPathCtrlPol-"))
    ...
    meta.superClasses.add("cobra.model.bgp.ABestPathCtrlPol")

    meta.rnPrefixes = [
        ('bestpath-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55240, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 55229, PropCategory.REGULAR)
    prop.label = "Best Path Control"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("asPathMultipathRelax", "relax-as-path-restriction-when-choosing-multipaths", 1)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55241, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 55231, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
