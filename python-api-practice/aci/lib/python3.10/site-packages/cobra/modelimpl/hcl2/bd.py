...
class Bd(Mo):
    ...
    meta = ClassMeta("cobra.model.hcl2.Bd")

    meta.moClassName = "hcl2Bd"
    meta.rnFormat = "bd-%(id)s"
    ...
    meta.childClasses.add("cobra.model.hcbdi.If")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcbdi.If", "bdi"))
    ...
    prop = PropMeta("str", "encap", "encap", 50264, PropCategory.REGULAR)
    prop.label = "Access Encapsulation"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "encapType", "encapType", 50263, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 50262, PropCategory.REGULAR)
    prop.label = "BD Id/Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
