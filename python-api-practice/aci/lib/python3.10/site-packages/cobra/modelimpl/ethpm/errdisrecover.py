...
# ##################################################
class ErrDisRecover(Mo):
    """
    The global configuration for error-disable recovery.

    """

    meta = ClassMeta("cobra.model.ethpm.ErrDisRecover")

    meta.moClassName = "ethpmErrDisRecover"
    meta.rnFormat = "errdisrecover"
    meta.category = MoCategory.REGULAR
    meta.label = "Error Disable Recovery Policy"
    ...
    meta.childClasses.add("cobra.model.ethpm.RsErrDisRecoverPolCons")
    meta.childClasses.add("cobra.model.ethpm.Event")

    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.RsErrDisRecoverPolCons", "rsErrDisRecoverPolCons"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.Event", "Event-"))
    ...
    prop = PropMeta("str", "errDisRecovIntvl", "errDisRecovIntvl", 18426, PropCategory.REGULAR)
