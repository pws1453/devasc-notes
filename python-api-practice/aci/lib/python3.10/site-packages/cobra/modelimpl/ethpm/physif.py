...
class PhysIf(Mo):
    ...
    meta = ClassMeta("cobra.model.ethpm.PhysIf")

    meta.moClassName = "ethpmPhysIf"
    meta.rnFormat = "phys"
    meta.category = MoCategory.REGULAR
    meta.label = "Physical Interface Runtime State (ethpm)"
    ...
    meta.childClasses.add("cobra.model.ethpm.FcotDD")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.ethpm.Fcot")
    meta.childClasses.add("cobra.model.ethpm.FcotX2")
    meta.childClasses.add("cobra.model.ethpm.DOMStats")
    meta.childClasses.add("cobra.model.ethpm.PortCap")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.ethpm.Fault")

    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.DOMStats", "domstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.PortCap", "portcap"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.FcotDD", "fcotdd"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.FcotX2", "fcotx2"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.Fault", "fault"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.Fcot", "fcot"))

    meta.parentClasses.add("cobra.model.l1.PhysIf")

    meta.superClasses.add("cobra.model.ethpm.If")
    ...
    prop = PropMeta("str", "hwResourceId", "hwResourceId", 26237, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14561, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operFecMode", "operFecMode", 25849, PropCategory.REGULAR)
    prop.label = "Operational FEC Mode"
    prop.isOper = True
    prop.defaultValue = 1
    ...
    meta.props.add("operFecMode", prop)
    ...
    prop = PropMeta("str", "operModeDetail", "operModeDetail", 33201, PropCategory.REGULAR)
    prop.label = "Detailed Operational Mode"
    prop.isOper = True
    prop.defaultValue = 2
    prop.defaultValueStr = "trunk"
    prop._addConstant("access", "access", 1)
    ...
    prop._addConstant("trunk-doubleEncapPort", "trunk-doubleencapport", 6)
    prop._addConstant("unknown", "unknown", 0)
    meta.props.add("operModeDetail", prop)
    ...
    prop._addConstant("channel-admin-down", "channel-admin-down", 4)
