...
# ##################################################
class RsErrDisRecoverPolCons(Mo):
    """
    A source relation to the error-disable recovery policy.

    """

    meta = SourceRelationMeta("cobra.model.ethpm.RsErrDisRecoverPolCons", "cobra.model.edr.ErrDisRecoverPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ethpmRsErrDisRecoverPolCons"
    meta.rnFormat = "rsErrDisRecoverPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ErrDisableRecovery Policy Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18222, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6123
    prop.defaultValueStr = "edrErrDisRecoverPol"
    prop._addConstant("edrErrDisRecoverPol", None, 6123)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18221, PropCategory.REGULAR)
