...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.ethpm.Entity")

    meta.moClassName = "ethpmEntity"
    meta.rnFormat = "ethpm"
    meta.category = MoCategory.REGULAR
    meta.label = "Ethernet Port Manager Entity"
    ...
    meta.childClasses.add("cobra.model.ethpm.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.ethpm.Inst", "inst"))
