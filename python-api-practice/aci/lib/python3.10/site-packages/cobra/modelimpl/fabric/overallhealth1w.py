...
# ##################################################
class OverallHealth1w(Mo):
    """
    A class that represents the most current statistics for overall fabric health in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.OverallHealth1w", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealth1w"
    meta.rnFormat = "CDfabricOverallHealth1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall fabric health stats in 1 week"
