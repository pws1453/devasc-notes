...
# ##################################################
class RsExtLeaves(Mo):
    """
    The leaf selector provides the node IDs to which the FEX will connect.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsExtLeaves", "cobra.model.fabric.LeafS")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsExtLeaves"
    meta.rnFormat = "rsextLeaves-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11468, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 824
    prop.defaultValueStr = "fabricLeafS"
    prop._addConstant("fabricLeafS", None, 824)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11467, PropCategory.REGULAR)
