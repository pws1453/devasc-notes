...
# ##################################################
class GroupRefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.GroupRefTask")

    meta.moClassName = "fabricGroupRefTask"
    meta.rnFormat = "fabricGroupRefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 49826, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("InformLeqptLooseNodeEdmNodeDn", "informleqptloosenodeedmnodedn", 3320)
