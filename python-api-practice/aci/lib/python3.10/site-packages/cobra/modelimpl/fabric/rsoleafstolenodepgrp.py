...
# ##################################################
class RsOLeafSToLeNodePGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsOLeafSToLeNodePGrp", "cobra.model.fabric.LeNodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsOLeafSToLeNodePGrp"
    meta.rnFormat = "rsOLeafSToLeNodePGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Leaf Node Policy Group"
    ...
    meta.rnPrefixes = [
        ('rsOLeafSToLeNodePGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38507, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40646, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26064, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26054, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 926
    prop.defaultValueStr = "fabricLeNodePGrp"
    prop._addConstant("fabricLeNodePGrp", None, 926)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26053, PropCategory.REGULAR)
