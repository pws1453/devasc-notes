...
# ##################################################
class RsNodeIdentPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsNodeIdentPol", "cobra.model.fabric.NodeIdentPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsNodeIdentPol"
    meta.rnFormat = "rsNodeIdentPol"
    ...
    meta.parentClasses.add("cobra.model.fabric.NodeIdentPolRelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsNodeIdentPol', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 22901, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22900, PropCategory.REGULAR)
