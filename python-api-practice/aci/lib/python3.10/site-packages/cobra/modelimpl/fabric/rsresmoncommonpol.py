...
# ##################################################
class RsResMonCommonPol(Mo):
    """
    A source relation to the monitoring policy model for the common semantic scope. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResMonCommonPol", "cobra.model.mon.CommonPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResMonCommonPol"
    meta.rnFormat = "rsresMonCommonPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Common Monitoring Policy Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13925, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11745, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 255
    prop.defaultValueStr = "monCommonPol"
