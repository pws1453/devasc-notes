...
# ##################################################
class RtSpPortPGrp(Mo):
    """
    A target relation to the base class for a spine port policy group.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtSpPortPGrp", "cobra.model.fabric.SFPortS")

    meta.moClassName = "fabricRtSpPortPGrp"
    meta.rnFormat = "rtspPortPGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11466, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 843
    prop.defaultValueStr = "fabricSFPortS"
    prop._addConstant("fabricSFPortS", None, 843)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11465, PropCategory.REGULAR)
