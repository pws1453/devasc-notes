...
# ##################################################
class RsTwampResponderPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsTwampResponderPol", "cobra.model.twamp.ResponderPol")
    meta.targetNameProps["name"] = "tnTwampResponderPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsTwampResponderPol"
    meta.rnFormat = "rstwampResponderPol"
    ...
    meta.rnPrefixes = [
        ('rstwampResponderPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38841, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40980, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37012, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 37003, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTwampResponderPolName", "tnTwampResponderPolName", 37002, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTwampResponderPolName", prop)
