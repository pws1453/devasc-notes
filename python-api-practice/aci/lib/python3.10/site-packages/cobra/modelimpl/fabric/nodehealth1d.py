...
# ##################################################
class NodeHealth1d(Mo):
    """
    A class that represents the most current statistics for node health in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth1d", "node health")
    ...
    meta.moClassName = "fabricNodeHealth1d"
    meta.rnFormat = "CDfabricNodeHealth1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 1 day"
