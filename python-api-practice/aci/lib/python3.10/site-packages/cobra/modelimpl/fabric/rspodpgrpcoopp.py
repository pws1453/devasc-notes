...
# ##################################################
class RsPodPGrpCoopP(Mo):
    """
    A source relation to the COOP (council of oracle protocol) group policy information.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsPodPGrpCoopP", "cobra.model.coop.Pol")
    meta.targetNameProps["name"] = "tnCoopPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsPodPGrpCoopP"
    meta.rnFormat = "rspodPGrpCoopP"
    ...
    meta.rnPrefixes = [
        ('rspodPGrpCoopP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37439, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39578, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13998, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11550, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 631
    prop.defaultValueStr = "coopPol"
    ...
    prop = PropMeta("str", "tnCoopPolName", "tnCoopPolName", 11549, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCoopPolName", prop)
