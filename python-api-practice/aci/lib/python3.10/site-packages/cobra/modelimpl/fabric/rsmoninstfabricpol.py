...
# ##################################################
class RsMonInstFabricPol(Mo):
    """
    A source relation to the monitoring policy model for the fabric semantic scope.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsMonInstFabricPol", "cobra.model.mon.FabricPol")
    meta.targetNameProps["name"] = "tnMonFabricPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsMonInstFabricPol"
    meta.rnFormat = "rsmonInstFabricPol"
    ...
    meta.rnPrefixes = [
        ('rsmonInstFabricPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37443, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39582, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14002, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11566, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonFabricPolName", "tnMonFabricPolName", 11565, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
