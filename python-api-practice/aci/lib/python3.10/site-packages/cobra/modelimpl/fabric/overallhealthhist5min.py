...
class OverallHealthHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.fabric.OverallHealthHist5min", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealthHist5min"
    meta.rnFormat = "HDfabricOverallHealth5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical overall fabric health stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDfabricOverallHealth5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6480, PropCategory.REGULAR)
