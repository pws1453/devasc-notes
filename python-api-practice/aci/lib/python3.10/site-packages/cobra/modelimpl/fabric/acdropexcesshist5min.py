...
# ##################################################
class AcDropExcessHist5min(Mo):
    """
    A class that represents historical statistics for drop packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.fabric.AcDropExcessHist5min", "drop packets")
    ...
    meta.moClassName = "fabricAcDropExcessHist5min"
    meta.rnFormat = "HDfabricAcDropExcess5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical drop packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6425, PropCategory.REGULAR)
