...
# ##################################################
class PathEpCleanupShardTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.PathEpCleanupShardTask")

    meta.moClassName = "fabricPathEpCleanupShardTask"
    meta.rnFormat = "fabricPathEpCleanupShardTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricPathEpCleanupShardTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 21268, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("cleanupPathEpForShard", "cleanuppathepforshard", 1857)
