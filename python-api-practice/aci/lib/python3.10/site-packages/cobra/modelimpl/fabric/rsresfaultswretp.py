...
# ##################################################
class RsResFaultSwRetP(Mo):
    """
    A source relation to the retention policy of the fault history records for switches. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResFaultSwRetP", "cobra.model.fault.SwRetP")
    meta.targetNameProps["name"] = "tnFaultSwRetPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResFaultSwRetP"
    meta.rnFormat = "rsresFaultSwRetP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13938, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11729, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFaultSwRetPName", "tnFaultSwRetPName", 11728, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
