...
# ##################################################
class RsApplCoreP(Mo):
    """
    A source relation to the core file report containing data about the system and the component at the time of the failure. 

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsApplCoreP", "cobra.model.dbgexp.CoreP")
    meta.targetNameProps["name"] = "tnDbgexpCorePName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsApplCoreP"
    meta.rnFormat = "rsapplCoreP"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37432, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39571, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13991, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11526, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4111
    prop.defaultValueStr = "dbgexpCoreP"
    ...
    prop = PropMeta("str", "tnDbgexpCorePName", "tnDbgexpCorePName", 11525, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnDbgexpCorePName", prop)
