...
class NodeInfoLM(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.NodeInfoLM")

    meta.moClassName = "fabricNodeInfoLM"
    meta.rnFormat = "nilm-%(id)s"
    ...
    prop = PropMeta("str", "fabricSt", "fabricSt", 49945, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 37013, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "inbMgmtAddr", "inbMgmtAddr", 37111, PropCategory.REGULAR)
    prop.label = "In-band Management IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("inbMgmtAddr", prop)

    prop = PropMeta("str", "isDeleted", "isDeleted", 37017, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "model", "model", 37110, PropCategory.REGULAR)
    prop.label = "Model"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 37015, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeType", "nodeType", 37109, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "oobMgmtAddr", "oobMgmtAddr", 37112, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "role", "role", 37108, PropCategory.REGULAR)
    prop.label = "Role"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "serial", "serial", 37014, PropCategory.REGULAR)
    prop.label = "Serial"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tepAddr", "tepAddr", 44951, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("tepAddr", prop)

    prop = PropMeta("str", "version", "version", 37016, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
