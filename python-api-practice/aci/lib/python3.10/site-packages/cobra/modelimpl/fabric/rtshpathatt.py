...
# ##################################################
class RtSHPathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtSHPathAtt", "cobra.model.infra.SHPathS")

    meta.moClassName = "fabricRtSHPathAtt"
    meta.rnFormat = "rtSHPathAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24365, PropCategory.REGULAR)
