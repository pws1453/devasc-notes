...
# ##################################################
class OverallHealth15min(Mo):
    """
    A class that represents the most current statistics for overall fabric health in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.fabric.OverallHealth15min", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealth15min"
    meta.rnFormat = "CDfabricOverallHealth15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall fabric health stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDfabricOverallHealth15min', False),
    ]
