...
# ##################################################
class RsCtrlrPolGroup(Mo):
    """
    A source relation to appliance policy group, which contains the info on which policies have to be deployed at pod level. Note that this relation is an internal object. 

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsCtrlrPolGroup", "cobra.model.fabric.CtrlrPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsCtrlrPolGroup"
    meta.rnFormat = "rsctrlrPolGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15604, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11472, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 894
    prop.defaultValueStr = "fabricCtrlrPGrp"
    prop._addConstant("fabricCtrlrPGrp", None, 894)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11471, PropCategory.REGULAR)
