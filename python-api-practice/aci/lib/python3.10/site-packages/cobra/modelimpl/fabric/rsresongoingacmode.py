...
# ##################################################
class RsResOngoingAcMode(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResOngoingAcMode", "cobra.model.dbg.OngoingAcMode")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResOngoingAcMode"
    meta.rnFormat = "rsresOngoingAcMode"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ongoing Atomic Counters Mode Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16577, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16575, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5632
    prop.defaultValueStr = "dbgOngoingAcMode"
