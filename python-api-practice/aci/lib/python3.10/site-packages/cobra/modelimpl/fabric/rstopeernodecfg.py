...
# ##################################################
class RsToPeerNodeCfg(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsToPeerNodeCfg", "cobra.model.infra.NodeCfg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsToPeerNodeCfg"
    meta.rnFormat = "rstoPeerNodeCfg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17939, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17938, PropCategory.REGULAR)
