...
# ##################################################
class RsRemoteStatsServer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsRemoteStatsServer", "cobra.model.telemetry.StatsServerP")
    meta.targetNameProps["name"] = "tnTelemetryStatsServerPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsRemoteStatsServer"
    meta.rnFormat = "rsremoteStatsServer-%(tnTelemetryStatsServerPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Remote Telemetry StatsServer"
    ...
    meta.rnPrefixes = [
        ('rsremoteStatsServer-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38791, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40930, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35634, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35629, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTelemetryStatsServerPName", "tnTelemetryStatsServerPName", 35628, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
