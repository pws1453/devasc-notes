...
class RtSetupPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtSetupPol", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "fabricRtSetupPol"
    meta.rnFormat = "rtpolSetupPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21454, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21453, PropCategory.REGULAR)
