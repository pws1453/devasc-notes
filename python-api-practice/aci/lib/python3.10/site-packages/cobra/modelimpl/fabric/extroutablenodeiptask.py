...
# ##################################################
class ExtRoutableNodeIpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.ExtRoutableNodeIpTask")

    meta.moClassName = "fabricExtRoutableNodeIpTask"
    meta.rnFormat = "fabricExtRoutableNodeIpTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricExtRoutableNodeIpTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 45414, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 3268)
