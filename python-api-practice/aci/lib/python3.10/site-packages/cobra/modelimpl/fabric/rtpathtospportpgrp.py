...
# ##################################################
class RtPathToSpPortPGrp(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtPathToSpPortPGrp", "cobra.model.fabric.SFPathS")

    meta.moClassName = "fabricRtPathToSpPortPGrp"
    meta.rnFormat = "rtpathToSpPortPGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18155, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6096
    prop.defaultValueStr = "fabricSFPathS"
    prop._addConstant("fabricSFPathS", None, 6096)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18154, PropCategory.REGULAR)
