...
# ##################################################
class AcDropExcessHist1w(Mo):
    """
    A class that represents historical statistics for drop packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.AcDropExcessHist1w", "drop packets")
    ...
    meta.moClassName = "fabricAcDropExcessHist1w"
    meta.rnFormat = "HDfabricAcDropExcess1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical drop packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6423, PropCategory.REGULAR)
