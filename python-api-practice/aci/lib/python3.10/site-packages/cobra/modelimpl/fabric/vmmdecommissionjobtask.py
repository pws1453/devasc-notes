...
# ##################################################
class VmmDecommissionJobTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.VmmDecommissionJobTask")

    meta.moClassName = "fabricVmmDecommissionJobTask"
    meta.rnFormat = "fabricVmmDecommissionJobTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricVmmDecommissionJobTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 36783, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VmmCleanup", "vmmcleanup", 2983)
