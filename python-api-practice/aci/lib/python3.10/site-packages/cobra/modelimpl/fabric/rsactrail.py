...
class RsAcTrail(Mo):
    """
    A source relation to the atomic counter for a trail. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsAcTrail", "cobra.model.dbg.AcTrail")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsAcTrail"
    meta.rnFormat = "rsacTrail"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Atomic Counter for the Trail"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11339, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4060
    prop.defaultValueStr = "dbgAcTrail"
    prop._addConstant("dbgAcTrail", None, 4060)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11338, PropCategory.REGULAR)
