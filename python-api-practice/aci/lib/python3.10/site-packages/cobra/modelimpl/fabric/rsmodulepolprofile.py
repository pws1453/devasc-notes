...
# ##################################################
class RsModulePolProfile(Mo):
    """
    A source relation to the template used for deploying card fabric configuration.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsModulePolProfile", "cobra.model.fabric.CardP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsModulePolProfile"
    meta.rnFormat = "rsmodulePolProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13973, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11482, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 884
    prop.defaultValueStr = "fabricCardP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 11481, PropCategory.REGULAR)
