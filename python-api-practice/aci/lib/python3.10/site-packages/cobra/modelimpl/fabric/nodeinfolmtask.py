...
# ##################################################
class NodeInfoLMTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.NodeInfoLMTask")

    meta.moClassName = "fabricNodeInfoLMTask"
    meta.rnFormat = "fabricNodeInfoLMTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 37031, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendToLM", "sendtolm", 3012)
