...
class RsResRsaEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsResRsaEp", "cobra.model.aaa.RsaEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResRsaEp"
    meta.rnFormat = "rsresRsaEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34237, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10967
    prop.defaultValueStr = "aaaRsaEp"
    prop._addConstant("aaaRsaEp", None, 10967)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34236, PropCategory.REGULAR)
