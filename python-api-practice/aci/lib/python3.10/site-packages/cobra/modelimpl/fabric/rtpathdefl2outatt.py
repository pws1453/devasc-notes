...
# ##################################################
class RtPathDefL2OutAtt(Mo):
    """
    A target relation to an abstraction of a path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtPathDefL2OutAtt", "cobra.model.l2ext.LIfPDef")

    meta.moClassName = "fabricRtPathDefL2OutAtt"
    meta.rnFormat = "rtl2extPathDefL2OutAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12087, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1756
    prop.defaultValueStr = "l2extLIfPDef"
    prop._addConstant("l2extLIfPDef", None, 1756)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12086, PropCategory.REGULAR)
