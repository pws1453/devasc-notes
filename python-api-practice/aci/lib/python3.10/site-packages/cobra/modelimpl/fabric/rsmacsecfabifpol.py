...
# ##################################################
class RsMacsecFabIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsMacsecFabIfPol", "cobra.model.macsec.FabIfPol")
    meta.targetNameProps["name"] = "tnMacsecFabIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsMacsecFabIfPol"
    meta.rnFormat = "rsmacsecFabIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "macsec Policy"
    ...
    meta.rnPrefixes = [
        ('rsmacsecFabIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40779, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30136, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30113, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9883
    prop.defaultValueStr = "macsecFabIfPol"
    ...
    prop = PropMeta("str", "tnMacsecFabIfPolName", "tnMacsecFabIfPolName", 30112, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMacsecFabIfPolName", prop)
