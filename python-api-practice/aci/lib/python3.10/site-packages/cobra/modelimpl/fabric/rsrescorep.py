...
class RsResCoreP(Mo):
    """
    A source relation to a core file report containing data about the system and the component at the time of the failure. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResCoreP", "cobra.model.dbgexp.CoreP")
    meta.targetNameProps["name"] = "tnDbgexpCorePName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResCoreP"
    meta.rnFormat = "rsresCoreP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13946, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11713, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDbgexpCorePName", "tnDbgexpCorePName", 11712, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
