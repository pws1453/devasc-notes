...
# ##################################################
class RsApplTechSupP(Mo):
    """
    A source relation to the tech support policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsApplTechSupP", "cobra.model.dbgexp.TechSupP")
    meta.targetNameProps["name"] = "tnDbgexpTechSupPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsApplTechSupP"
    meta.rnFormat = "rsapplTechSupP"
    ...
    meta.rnPrefixes = [
        ('rsapplTechSupP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37431, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39570, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13990, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11534, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDbgexpTechSupPName", "tnDbgexpTechSupPName", 11533, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
