...
# ##################################################
class RsDwdmFabIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsDwdmFabIfPol", "cobra.model.dwdm.FabIfPol")
    meta.targetNameProps["name"] = "tnDwdmFabIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsDwdmFabIfPol"
    meta.rnFormat = "rsdwdmFabIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DWDM fiber optics channel Policy"
    ...
    meta.rnPrefixes = [
        ('rsdwdmFabIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38787, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40926, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35585, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35573, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDwdmFabIfPolName", "tnDwdmFabIfPolName", 35572, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnDwdmFabIfPolName", prop)
