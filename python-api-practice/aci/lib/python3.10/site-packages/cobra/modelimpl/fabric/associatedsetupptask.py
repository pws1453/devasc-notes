...
# ##################################################
class AssociatedSetupPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.AssociatedSetupPTask")

    meta.moClassName = "fabricAssociatedSetupPTask"
    meta.rnFormat = "fabricAssociatedSetupPTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricAssociatedSetupPTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 45412, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 3270)
