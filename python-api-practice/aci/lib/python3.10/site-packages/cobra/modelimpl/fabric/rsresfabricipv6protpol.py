...
# ##################################################
class RsResFabricIPV6ProtPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResFabricIPV6ProtPol", "cobra.model.fabric.IPV6ProtPol")
    meta.targetNameProps["name"] = "tnFabricIPV6ProtPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResFabricIPV6ProtPol"
    meta.rnFormat = "rsresFabricIPV6ProtPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17536, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17505, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricIPV6ProtPolName", "tnFabricIPV6ProtPolName", 17504, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
