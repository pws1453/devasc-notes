...
# ##################################################
class RtResHIfPol(Mo):
    """
    A target relation to the host interface policy. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtResHIfPol", "cobra.model.infra.Infra")

    meta.moClassName = "fabricRtResHIfPol"
    meta.rnFormat = "rtresHIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13290, PropCategory.REGULAR)
