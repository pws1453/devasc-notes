...
# ##################################################
class RsResHealthPols(Mo):
    """
    A source relation to a fabric health policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResHealthPols", "cobra.model.health.PolCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResHealthPols"
    meta.rnFormat = "rsresHealthPols"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Container for Health Score Policy Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13942, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11731, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1650
    prop.defaultValueStr = "healthPolCont"
