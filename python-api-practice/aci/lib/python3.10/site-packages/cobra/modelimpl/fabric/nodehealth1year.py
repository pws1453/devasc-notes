...
# ##################################################
class NodeHealth1year(Mo):
    """
    A class that represents the most current statistics for node health in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth1year", "node health")
    ...
    meta.moClassName = "fabricNodeHealth1year"
    meta.rnFormat = "CDfabricNodeHealth1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 1 year"
