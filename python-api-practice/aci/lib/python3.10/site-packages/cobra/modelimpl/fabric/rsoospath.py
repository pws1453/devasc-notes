...
class RsOosPath(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsOosPath", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsOosPath"
    meta.rnFormat = "rsoosPath-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Out of Service Fabric Path"
    ...
    meta.childClasses.add("cobra.model.fabric.Locale")
    meta.childClasses.add("cobra.model.fabric.OosPathIssues")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.OosPathIssues", "pathissues"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.Locale", "node-"))
    ...
    meta.superClasses.add("cobra.model.fabric.AOOSReln")

    meta.rnPrefixes = [
        ('rsoosPath-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39524, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "lc", "lc", 11405, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "in-service"
    prop._addConstant("blacklist", "blacklist", 3)
    prop._addConstant("in-service", "in-service", 1)
    prop._addConstant("out-of-service", "out-of-service", 2)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15291, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11403, PropCategory.REGULAR)
