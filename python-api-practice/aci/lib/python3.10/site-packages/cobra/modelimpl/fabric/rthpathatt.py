...
class RtHPathAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtHPathAtt", "cobra.model.infra.HPathS")

    meta.moClassName = "fabricRtHPathAtt"
    meta.rnFormat = "rtHPathAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18161, PropCategory.REGULAR)
