...
class RtNodeCtrl(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtNodeCtrl", "cobra.model.fabric.ANodePGrp")

    meta.moClassName = "fabricRtNodeCtrl"
    meta.rnFormat = "rtnodeCtrl-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25954, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25953, PropCategory.REGULAR)
