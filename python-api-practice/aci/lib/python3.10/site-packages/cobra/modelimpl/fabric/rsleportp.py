...
class RsLePortP(Mo):
    """
    A source relation to the leaf fabric port profile.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsLePortP", "cobra.model.fabric.LePortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsLePortP"
    meta.rnFormat = "rslePortP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37420, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39559, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13979, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11510, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 888
    prop.defaultValueStr = "fabricLePortP"
    prop._addConstant("fabricLePortP", None, 888)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11509, PropCategory.REGULAR)
