...
# ##################################################
class RtFIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtFIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "fabricRtFIfPolCons"
    meta.rnFormat = "rtl1FIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 59724, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 59723, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 59732, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
