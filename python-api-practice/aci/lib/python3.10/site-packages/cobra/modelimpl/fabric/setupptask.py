...
class SetupPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.SetupPTask")

    meta.moClassName = "fabricSetupPTask"
    meta.rnFormat = "fabricSetupPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21415, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PodCleanup", "podcleanup", 2885)
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 1883)
