...
# ##################################################
class RtPathToLePortPGrp(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtPathToLePortPGrp", "cobra.model.fabric.LFPathS")

    meta.moClassName = "fabricRtPathToLePortPGrp"
    meta.rnFormat = "rtpathToLePortPGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18151, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6091
    prop.defaultValueStr = "fabricLFPathS"
    prop._addConstant("fabricLFPathS", None, 6091)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18150, PropCategory.REGULAR)
