...
# ##################################################
class NodeHealth1mo(Mo):
    """
    A class that represents the most current statistics for node health in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth1mo", "node health")
    ...
    meta.moClassName = "fabricNodeHealth1mo"
    meta.rnFormat = "CDfabricNodeHealth1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 1 month"
