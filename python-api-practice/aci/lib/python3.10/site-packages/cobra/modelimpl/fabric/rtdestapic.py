...
class RtDestApic(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtDestApic", "cobra.model.span.ADest")

    meta.moClassName = "fabricRtDestApic"
    meta.rnFormat = "rtdestApic"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18498, PropCategory.REGULAR)
