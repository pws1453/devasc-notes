...
# ##################################################
class RsResHealthSwRetP(Mo):
    """
    A source relation to the retention policy of the health score history records for switches. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResHealthSwRetP", "cobra.model.health.SwRetP")
    meta.targetNameProps["name"] = "tnHealthSwRetPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResHealthSwRetP"
    meta.rnFormat = "rsresHealthSwRetP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13941, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnHealthSwRetPName", "tnHealthSwRetPName", 11733, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
