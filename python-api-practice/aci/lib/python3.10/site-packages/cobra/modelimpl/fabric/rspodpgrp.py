...
class RsPodPGrp(Mo):
    """
    A source relation to the pod policy group specifying policies to the leaf nodes in the pod.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsPodPGrp", "cobra.model.fabric.PodPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsPodPGrp"
    meta.rnFormat = "rspodPGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39540, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13953, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11440, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 901
    prop.defaultValueStr = "fabricPodPGrp"
    prop._addConstant("fabricPodPGrp", None, 901)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11439, PropCategory.REGULAR)
