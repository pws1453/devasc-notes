...
class RsLeNodeP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsLeNodeP", "cobra.model.fabric.LeafP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsLeNodeP"
    meta.rnFormat = "rsleNodeP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Leaf Node Profile"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20911, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20872, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20871, PropCategory.REGULAR)
