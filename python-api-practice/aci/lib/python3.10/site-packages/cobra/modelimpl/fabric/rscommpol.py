...
class RsCommPol(Mo):
    """
    A source relation to the communication policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsCommPol", "cobra.model.comm.Pol")
    meta.targetNameProps["name"] = "tnCommPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsCommPol"
    meta.rnFormat = "rsCommPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37438, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39577, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13997, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11538, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1572
    prop.defaultValueStr = "commPol"
    ...
    prop = PropMeta("str", "tnCommPolName", "tnCommPolName", 11537, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCommPolName", prop)
