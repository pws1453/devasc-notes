...
# ##################################################
class RsNodeGroup(Mo):
    """
    A source relation to the node group.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsNodeGroup", "cobra.model.fabric.NodeGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsNodeGroup"
    meta.rnFormat = "rsnodeGroup-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.fabric.NodeGroupPolicy")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.NodeGroupPolicy", "policy-"))
    ...
    prop = PropMeta("str", "deplSt", "deplSt", 15593, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15616, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15592, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 808
    prop.defaultValueStr = "fabricNodeGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15591, PropCategory.REGULAR)
