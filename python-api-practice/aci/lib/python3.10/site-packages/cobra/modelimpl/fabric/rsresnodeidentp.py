...
# ##################################################
class RsResNodeIdentP(Mo):
    """
    A source relation to the node identity profile. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResNodeIdentP", "cobra.model.fabric.NodeIdentP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResNodeIdentP"
    meta.rnFormat = "rsresNodeIdentP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Node Member Profile"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11751, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 791
    prop.defaultValueStr = "fabricNodeIdentP"
    prop._addConstant("fabricNodeIdentP", None, 791)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11750, PropCategory.REGULAR)
