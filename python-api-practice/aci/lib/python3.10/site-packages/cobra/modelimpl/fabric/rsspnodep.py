...
class RsSpNodeP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsSpNodeP", "cobra.model.fabric.SpineP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsSpNodeP"
    meta.rnFormat = "rsspNodeP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine Node Profile"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20912, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20875, PropCategory.REGULAR)
