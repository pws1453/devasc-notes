...
# ##################################################
class PmPathEpCleanupTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.PmPathEpCleanupTask")

    meta.moClassName = "fabricPmPathEpCleanupTask"
    meta.rnFormat = "fabricPmPathEpCleanupTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricPmPathEpCleanupTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 21267, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("cleanupPathEp", "cleanuppathep", 1858)
