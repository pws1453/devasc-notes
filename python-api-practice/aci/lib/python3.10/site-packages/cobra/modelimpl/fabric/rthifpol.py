...
class RtHIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtHIfPol", "cobra.model.infra.AAccGrp")

    meta.moClassName = "fabricRtHIfPol"
    meta.rnFormat = "rtinfraHIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13220, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13219, PropCategory.REGULAR)
