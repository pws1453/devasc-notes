...
class RsNodeCoreP(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37442, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39581, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14001, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11570, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDbgexpCorePName", "tnDbgexpCorePName", 11569, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
