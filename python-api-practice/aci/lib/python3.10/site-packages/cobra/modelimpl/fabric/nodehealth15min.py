...
# ##################################################
class NodeHealth15min(Mo):
    """
    A class that represents the most current statistics for node health in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth15min", "node health")
    ...
    meta.moClassName = "fabricNodeHealth15min"
    meta.rnFormat = "CDfabricNodeHealth15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fabric.NodeHealth")

    meta.rnPrefixes = [
        ('CDfabricNodeHealth15min', False),
    ]
