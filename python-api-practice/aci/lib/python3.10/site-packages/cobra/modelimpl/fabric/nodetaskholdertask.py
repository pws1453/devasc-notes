...
# ##################################################
class NodeTaskHolderTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fabric.NodeTaskHolderTask")

    meta.moClassName = "fabricNodeTaskHolderTask"
    meta.rnFormat = "fabricNodeTaskHolderTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16360, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("subscribeToPM", "subscribetopm", 1424)
