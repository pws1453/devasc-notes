...
# ##################################################
class RsNodeCfgSrv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsNodeCfgSrv", "cobra.model.analytics.CfgSrv")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsNodeCfgSrv"
    meta.rnFormat = "rsnodeCfgSrv"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Analytics Config Server Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38418, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40557, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 24104, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8189
    prop.defaultValueStr = "analyticsCfgSrv"
    prop._addConstant("analyticsCfgSrv", None, 8189)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 24103, PropCategory.REGULAR)
