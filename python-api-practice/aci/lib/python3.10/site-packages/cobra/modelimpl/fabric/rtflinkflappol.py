...
# ##################################################
class RtFLinkFlapPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtFLinkFlapPol", "cobra.model.fabric.APortPGrp")

    meta.moClassName = "fabricRtFLinkFlapPol"
    meta.rnFormat = "rtfLinkFlapPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 61873, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 61872, PropCategory.REGULAR)
