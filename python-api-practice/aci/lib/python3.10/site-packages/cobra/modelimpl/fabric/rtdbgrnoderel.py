...
# ##################################################
class RtDbgrNodeRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtDbgrNodeRel", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "fabricRtDbgrNodeRel"
    meta.rnFormat = "rtpolDbgrNodeRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53063, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53062, PropCategory.REGULAR)
