...
# ##################################################
class RsCallhomeInvPol(Mo):
    """
    A source relation to the policy for periodically sending Call Home messages with system inventory information. 

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsCallhomeInvPol", "cobra.model.callhome.InvP")
    meta.targetNameProps["name"] = "tnCallhomeInvPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsCallhomeInvPol"
    meta.rnFormat = "rscallhomeInvPol"
    ...
    meta.rnPrefixes = [
        ('rscallhomeInvPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37445, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39584, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14004, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11562, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1702
    prop.defaultValueStr = "callhomeInvP"
    ...
    prop = PropMeta("str", "tnCallhomeInvPName", "tnCallhomeInvPName", 11561, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCallhomeInvPName", prop)
