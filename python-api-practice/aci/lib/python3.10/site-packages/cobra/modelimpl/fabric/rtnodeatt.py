...
class RtNodeAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtNodeAtt", "cobra.model.fv.AEPg")

    meta.moClassName = "fabricRtNodeAtt"
    meta.rnFormat = "rtfvNodeAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12343, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12342, PropCategory.REGULAR)
