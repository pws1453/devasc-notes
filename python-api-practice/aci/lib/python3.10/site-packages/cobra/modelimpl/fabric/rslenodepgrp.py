...
# ##################################################
class RsLeNodePGrp(Mo):
    """
    A source relation to the leaf node policy group.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsLeNodePGrp", "cobra.model.fabric.LeNodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsLeNodePGrp"
    meta.rnFormat = "rsleNodePGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39542, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13955, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11444, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11443, PropCategory.REGULAR)
