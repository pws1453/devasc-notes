...
# ##################################################
class RsPodPGrpBGPRRP(Mo):
    """
    A source relation to the instance-level BGP policy information.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsPodPGrpBGPRRP", "cobra.model.bgp.InstPol")
    meta.targetNameProps["name"] = "tnBgpInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsPodPGrpBGPRRP"
    meta.rnFormat = "rspodPGrpBGPRRP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "BGP Instance Policy"
    ...
    meta.rnPrefixes = [
        ('rspodPGrpBGPRRP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37436, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39575, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13995, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11546, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 635
    prop.defaultValueStr = "bgpInstPol"
    ...
    prop = PropMeta("str", "tnBgpInstPolName", "tnBgpInstPolName", 11545, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBgpInstPolName", prop)
