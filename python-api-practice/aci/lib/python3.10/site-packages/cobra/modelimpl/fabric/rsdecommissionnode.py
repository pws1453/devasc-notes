...
# ##################################################
class RsDecommissionNode(Mo):
    """
    The node for decommissioning a switch.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsDecommissionNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsDecommissionNode"
    meta.rnFormat = "rsdecommissionNode-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Decommission Node"
    ...
    meta.rnPrefixes = [
        ('rsdecommissionNode-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37386, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "debug", "debug", 33107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39525, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13908, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "removeFromController", "removeFromController", 15776, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("removeFromController", prop)

    prop = PropMeta("str", "retries", "retries", 11388, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "start", "start", 60941, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 11387, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11386, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "targetId", "targetId", 11389, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("targetId", prop)
