...
# ##################################################
class RtSrcToPathEp(Mo):
    """
    A target relation to an abstraction of a path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtSrcToPathEp", "cobra.model.span.ASrc")

    meta.moClassName = "fabricRtSrcToPathEp"
    meta.rnFormat = "rtspanSrcToPathEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12986, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12985, PropCategory.REGULAR)
