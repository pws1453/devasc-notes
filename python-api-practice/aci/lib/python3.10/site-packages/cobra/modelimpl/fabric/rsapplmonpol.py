...
# ##################################################
class RsApplMonPol(Mo):
    """
    A source relation to the monitoring policy model for the fabric semantic scope. 

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsApplMonPol", "cobra.model.mon.FabricPol")
    meta.targetNameProps["name"] = "tnMonFabricPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsApplMonPol"
    meta.rnFormat = "rsapplMonPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37433, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39572, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13992, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11530, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonFabricPolName", "tnMonFabricPolName", 11529, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
