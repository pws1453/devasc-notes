...
# ##################################################
class AcDropExcessHist1qtr(Mo):
    """
    A class that represents historical statistics for drop packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.AcDropExcessHist1qtr", "drop packets")
    ...
    meta.moClassName = "fabricAcDropExcessHist1qtr"
    meta.rnFormat = "HDfabricAcDropExcess1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical drop packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6422, PropCategory.REGULAR)
