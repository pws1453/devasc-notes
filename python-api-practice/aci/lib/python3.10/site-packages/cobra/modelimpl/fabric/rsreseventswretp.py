...
# ##################################################
class RsResEventSwRetP(Mo):
    """
    A source relation to the retention policy for all events on all switches to which the policy is applied. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResEventSwRetP", "cobra.model.event.SwRetP")
    meta.targetNameProps["name"] = "tnEventSwRetPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResEventSwRetP"
    meta.rnFormat = "rsresEventSwRetP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13939, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11717, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnEventSwRetPName", "tnEventSwRetPName", 11716, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
