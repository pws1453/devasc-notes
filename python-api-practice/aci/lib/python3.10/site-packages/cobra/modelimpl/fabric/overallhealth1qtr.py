...
# ##################################################
class OverallHealth1qtr(Mo):
    """
    A class that represents the most current statistics for overall fabric health in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.OverallHealth1qtr", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealth1qtr"
    meta.rnFormat = "CDfabricOverallHealth1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall fabric health stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDfabricOverallHealth1qtr', False),
    ]
