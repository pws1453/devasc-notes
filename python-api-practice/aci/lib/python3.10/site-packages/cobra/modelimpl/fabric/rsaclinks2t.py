...
# ##################################################
class RsAcLinkS2T(Mo):
    """
    A source relation to an atomic counter for a link.  Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsAcLinkS2T", "cobra.model.dbg.AcLinkS2T")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsAcLinkS2T"
    meta.rnFormat = "rsacLinkS2T-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Atomic Counter for the Link"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11342, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4061
    prop.defaultValueStr = "dbgAcLinkS2T"
    prop._addConstant("dbgAcLinkS2T", None, 4061)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11341, PropCategory.REGULAR)
