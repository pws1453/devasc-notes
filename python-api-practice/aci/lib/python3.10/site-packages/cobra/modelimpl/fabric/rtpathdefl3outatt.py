...
# ##################################################
class RtPathDefL3OutAtt(Mo):
    """
    A target relation to an abstraction of a path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtPathDefL3OutAtt", "cobra.model.l3ext.LIfPDef")

    meta.moClassName = "fabricRtPathDefL3OutAtt"
    meta.rnFormat = "rtl3extPathDefL3OutAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Logical Interface Profile"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x80001800003
    ...
    prop = PropMeta("str", "tCl", "tCl", 12135, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1792
    prop.defaultValueStr = "l3extLIfPDef"
    prop._addConstant("l3extLIfPDef", None, 1792)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12134, PropCategory.REGULAR)
