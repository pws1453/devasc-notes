...
# ##################################################
class NodeHealth1qtr(Mo):
    """
    A class that represents the most current statistics for node health in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth1qtr", "node health")
    ...
    meta.moClassName = "fabricNodeHealth1qtr"
    meta.rnFormat = "CDfabricNodeHealth1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 1 quarter"
