...
class RsNodePolGroup(Mo):
    """
    A source relation to the abstraction of node policy groups. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsNodePolGroup", "cobra.model.fabric.ANodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsNodePolGroup"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13972, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11487, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11486, PropCategory.REGULAR)
