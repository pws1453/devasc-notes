...
# ##################################################
class ProtGEpTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fabric.ProtGEpTask")

    meta.moClassName = "fabricProtGEpTask"
    meta.rnFormat = "fabricProtGEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16461, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VPcRegisterForNotification", "vpcregisterfornotification", 1452)
