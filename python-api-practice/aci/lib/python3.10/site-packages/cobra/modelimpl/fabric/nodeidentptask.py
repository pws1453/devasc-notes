...
# ##################################################
class NodeIdentPTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fabric.NodeIdentPTask")

    meta.moClassName = "fabricNodeIdentPTask"
    meta.rnFormat = "fabricNodeIdentPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15856, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("send", "send", 1352)
