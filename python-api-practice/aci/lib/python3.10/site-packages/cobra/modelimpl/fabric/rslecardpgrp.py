...
# ##################################################
class RsLeCardPGrp(Mo):
    """
    A source relation to the leaf card policy group.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsLeCardPGrp", "cobra.model.fabric.LeCardPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsLeCardPGrp"
    meta.rnFormat = "rsleCardPGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39546, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13959, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11452, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 930
    prop.defaultValueStr = "fabricLeCardPGrp"
    prop._addConstant("fabricLeCardPGrp", None, 930)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11451, PropCategory.REGULAR)
