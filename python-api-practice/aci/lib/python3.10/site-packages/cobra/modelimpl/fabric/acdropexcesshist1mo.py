...
# ##################################################
class AcDropExcessHist1mo(Mo):
    """
    A class that represents historical statistics for drop packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.AcDropExcessHist1mo", "drop packets")
    ...
    meta.moClassName = "fabricAcDropExcessHist1mo"
    meta.rnFormat = "HDfabricAcDropExcess1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical drop packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6421, PropCategory.REGULAR)
