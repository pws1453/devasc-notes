...
# ##################################################
class RtInBStNode(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtInBStNode", "cobra.model.mgmt.InB")

    meta.moClassName = "fabricRtInBStNode"
    meta.rnFormat = "rtmgmtInBStNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16539, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16538, PropCategory.REGULAR)
