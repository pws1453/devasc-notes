...
# ##################################################
class RsPodPolGroup(Mo):
    """
    A source relation to the pod policy group. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsPodPolGroup", "cobra.model.fabric.PodPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsPodPolGroup"
    meta.rnFormat = "rspodPolGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13971, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11492, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11491, PropCategory.REGULAR)
