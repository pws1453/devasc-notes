...
class RtFIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtFIfPol", "cobra.model.fabric.APortPGrp")

    meta.moClassName = "fabricRtFIfPol"
    meta.rnFormat = "rtfIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 59720, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 59719, PropCategory.REGULAR)
