...
# ##################################################
class RsApplTechSupOnD(Mo):
    """
    A source relation to the on-demand tech support policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsApplTechSupOnD", "cobra.model.dbgexp.TechSupOnD")
    meta.targetNameProps["name"] = "tnDbgexpTechSupOnDName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsApplTechSupOnD"
    meta.rnFormat = "rsapplTechSupOnD"
    ...
    meta.rnPrefixes = [
        ('rsapplTechSupOnD', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38085, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40224, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15328, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15325, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDbgexpTechSupOnDName", "tnDbgexpTechSupOnDName", 15324, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
