...
# ##################################################
class RsUsedNodeIp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsUsedNodeIp", "cobra.model.fabric.ExtRoutableNodeIp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsUsedNodeIp"
    meta.rnFormat = "rsusedNodeIp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45426, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13110
    prop.defaultValueStr = "fabricExtRoutableNodeIp"
    prop._addConstant("fabricExtRoutableNodeIp", None, 13110)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45425, PropCategory.REGULAR)
