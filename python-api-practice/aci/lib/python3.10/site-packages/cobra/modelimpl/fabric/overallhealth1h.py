...
# ##################################################
class OverallHealth1h(Mo):
    """
    A class that represents the most current statistics for overall fabric health in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.fabric.OverallHealth1h", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealth1h"
    meta.rnFormat = "CDfabricOverallHealth1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall fabric health stats in 1 hour"
