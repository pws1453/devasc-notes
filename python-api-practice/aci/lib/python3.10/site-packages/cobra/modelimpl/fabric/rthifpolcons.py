...
# ##################################################
class RtHIfPolCons(Mo):
    """
    A target relation to the host interface policy. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtHIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "fabricRtHIfPolCons"
    meta.rnFormat = "rtl1HIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12757, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12756, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15112, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
