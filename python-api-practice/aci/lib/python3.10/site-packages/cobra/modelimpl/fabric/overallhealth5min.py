...
# ##################################################
class OverallHealth5min(Mo):
    """
    A class that represents the most current statistics for overall fabric health in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.fabric.OverallHealth5min", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealth5min"
    meta.rnFormat = "CDfabricOverallHealth5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall fabric health stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDfabricOverallHealth5min', False),
    ]
