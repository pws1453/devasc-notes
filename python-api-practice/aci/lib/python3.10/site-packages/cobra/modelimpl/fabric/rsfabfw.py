...
class RsFabFw(Mo):
    """
    A source relation to the firmware versions in use by fabric. This is maintained on IFC to keep track of firmwares in use. All nodes resolve this relation via policy resolution.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsFabFw", "cobra.model.compat.Fw")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsFabFw"
    meta.rnFormat = "rsfabFw-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Running Firmware Version"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11702, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11701, PropCategory.REGULAR)
