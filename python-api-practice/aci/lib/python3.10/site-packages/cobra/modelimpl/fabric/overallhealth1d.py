...
# ##################################################
class OverallHealth1d(Mo):
    """
    A class that represents the most current statistics for overall fabric health in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.fabric.OverallHealth1d", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealth1d"
    meta.rnFormat = "CDfabricOverallHealth1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall fabric health stats in 1 day"
