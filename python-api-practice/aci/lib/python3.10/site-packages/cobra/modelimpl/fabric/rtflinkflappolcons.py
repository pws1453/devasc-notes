...
# ##################################################
class RtFLinkFlapPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtFLinkFlapPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "fabricRtFLinkFlapPolCons"
    meta.rnFormat = "rtl1FLinkFlapPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 61877, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 61876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 61885, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
