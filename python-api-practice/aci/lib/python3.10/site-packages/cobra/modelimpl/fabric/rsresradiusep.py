...
# ##################################################
class RsResRadiusEp(Mo):
    """
    A source relation to the global security management properties for RADIUS endpoints and RADIUS provider groups. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResRadiusEp", "cobra.model.aaa.RadiusEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResRadiusEp"
    meta.rnFormat = "rsresRadiusEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11424, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1596
    prop.defaultValueStr = "aaaRadiusEp"
    prop._addConstant("aaaRadiusEp", None, 1596)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11423, PropCategory.REGULAR)
