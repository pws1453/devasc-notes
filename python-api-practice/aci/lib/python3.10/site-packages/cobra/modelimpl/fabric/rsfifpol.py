...
class RsFIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fabric.RsFIfPol", "cobra.model.fabric.FIfPol")
    meta.targetNameProps["name"] = "tnFabricFIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsFIfPol"
    meta.rnFormat = "rsfIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Fabric Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 59729, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59730, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59726, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 59718, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricFIfPolName", "tnFabricFIfPolName", 59717, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricFIfPolName", prop)
