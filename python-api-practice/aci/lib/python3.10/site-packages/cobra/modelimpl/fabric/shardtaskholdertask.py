...
# ##################################################
class ShardTaskHolderTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fabric.ShardTaskHolderTask")

    meta.moClassName = "fabricShardTaskHolderTask"
    meta.rnFormat = "fabricShardTaskHolderTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricShardTaskHolderTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 15562, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("cleanupPodForShard", "cleanuppodforshard", 2892)
    prop._addConstant("none", "none", 0)
    prop._addConstant("sendToTM", "sendtotm", 1638)
    prop._addConstant("sendToVMM", "sendtovmm", 3472)
    prop._addConstant("unsubscribeFromPM", "unsubscribefrompm", 1288)
