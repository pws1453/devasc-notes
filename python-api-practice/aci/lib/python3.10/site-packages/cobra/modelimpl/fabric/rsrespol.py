...
class RsResPol(Mo):
    """
    A source relation to the communication policy. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResPol", "cobra.model.comm.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResPol"
    meta.rnFormat = "rsresPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11420, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11419, PropCategory.REGULAR)
