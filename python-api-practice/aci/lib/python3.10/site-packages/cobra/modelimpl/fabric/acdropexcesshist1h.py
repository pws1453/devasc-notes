...
# ##################################################
class AcDropExcessHist1h(Mo):
    """
    A class that represents historical statistics for drop packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.fabric.AcDropExcessHist1h", "drop packets")
    ...
    meta.moClassName = "fabricAcDropExcessHist1h"
    meta.rnFormat = "HDfabricAcDropExcess1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical drop packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6420, PropCategory.REGULAR)
