...
class RsResPkiEp(Mo):
    """
    A source relation to the Public Key Infrastructure (PKI) configuration. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResPkiEp", "cobra.model.pki.Ep")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResPkiEp"
    meta.rnFormat = "rsresPkiEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11416, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1478
    prop.defaultValueStr = "pkiEp"
    prop._addConstant("pkiEp", None, 1478)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11415, PropCategory.REGULAR)
