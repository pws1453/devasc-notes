...
# ##################################################
class RsNodeFlowServers(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsNodeFlowServers", "cobra.model.telemetry.FlowServers")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsNodeFlowServers"
    meta.rnFormat = "rsnodeFlowServers"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Telemetry Policy"
    ...
    meta.rnPrefixes = [
        ('rsnodeFlowServers', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38796, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40935, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35672, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11355
    prop.defaultValueStr = "telemetryFlowServers"
    prop._addConstant("telemetryFlowServers", None, 11355)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35671, PropCategory.REGULAR)
