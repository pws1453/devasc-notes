...
class RtPathAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fabric.RtPathAtt", "cobra.model.fv.AEPg")

    meta.moClassName = "fabricRtPathAtt"
    meta.rnFormat = "rtfvPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Application EPG"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x4080001821603
    ...
    prop = PropMeta("str", "tCl", "tCl", 12351, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12350, PropCategory.REGULAR)
