...
class RsResLbPol(Mo):
    """
    A source relation to the fabric load balance policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResLbPol", "cobra.model.lbp.Pol")
    meta.targetNameProps["name"] = "tnLbpPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResLbPol"
    meta.rnFormat = "rsresLbPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Load Balance Relation Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13917, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11740, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1808
    prop.defaultValueStr = "lbpPol"
    ...
    prop = PropMeta("str", "tnLbpPolName", "tnLbpPolName", 11739, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnLbpPolName", prop)
