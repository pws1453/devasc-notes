...
# ##################################################
class NodeHealth1w(Mo):
    """
    A class that represents the most current statistics for node health in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth1w", "node health")
    ...
    meta.moClassName = "fabricNodeHealth1w"
    meta.rnFormat = "CDfabricNodeHealth1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 1 week"
