...
class RsL3IfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fabric.RsL3IfPol", "cobra.model.l3.IfPol")
    meta.targetNameProps["name"] = "tnL3IfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsL3IfPol"
    meta.rnFormat = "rsl3IfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L3 Interface Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40850, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33466, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33459, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL3IfPolName", "tnL3IfPolName", 33458, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL3IfPolName", prop)
