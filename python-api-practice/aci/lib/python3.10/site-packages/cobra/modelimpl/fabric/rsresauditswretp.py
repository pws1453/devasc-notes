...
# ##################################################
class RsResAuditSwRetP(Mo):
    """
    A source relation to the switch AAA audit log retention policy. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResAuditSwRetP", "cobra.model.aaa.SwRetP")
    meta.targetNameProps["name"] = "tnAaaSwRetPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResAuditSwRetP"
    meta.rnFormat = "rsresAuditSwRetP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13940, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11705, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnAaaSwRetPName", "tnAaaSwRetPName", 11704, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
