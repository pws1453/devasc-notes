...
class RsSpPortP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsSpPortP", "cobra.model.fabric.SpPortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsSpPortP"
    meta.rnFormat = "rsspPortP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37423, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39562, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13982, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11518, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 889
    prop.defaultValueStr = "fabricSpPortP"
    prop._addConstant("fabricSpPortP", None, 889)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11517, PropCategory.REGULAR)
