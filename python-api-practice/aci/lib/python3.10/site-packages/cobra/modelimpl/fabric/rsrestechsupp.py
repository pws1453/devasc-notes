...
# ##################################################
class RsResTechSupP(Mo):
    """
    A source relation to a utility that creates a summary report containing configuration information, logs, and diagnostic data that will help TAC in troubleshooting and resolving a technical issue. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResTechSupP", "cobra.model.dbgexp.TechSupP")
    meta.targetNameProps["name"] = "tnDbgexpTechSupPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResTechSupP"
    meta.rnFormat = "rsresTechSupP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Tech Support Export Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13945, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11754, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDbgexpTechSupPName", "tnDbgexpTechSupPName", 11753, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
