...
# ##################################################
class RsUsedAnycastIp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsUsedAnycastIp", "cobra.model.fabric.ExtRoutableAnycastIp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsUsedAnycastIp"
    meta.rnFormat = "rsusedAnycastIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Anycast TEP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55954, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16439
    prop.defaultValueStr = "fabricExtRoutableAnycastIp"
    prop._addConstant("fabricExtRoutableAnycastIp", None, 16439)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55953, PropCategory.REGULAR)
