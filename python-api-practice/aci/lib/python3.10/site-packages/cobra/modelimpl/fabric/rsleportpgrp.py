...
# ##################################################
class RsLePortPGrp(Mo):
    """
    A source relation to the policy providing lag/singular function semantics to the ports.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsLePortPGrp", "cobra.model.fabric.LeAPortPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsLePortPGrp"
    meta.rnFormat = "rslePortPGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37411, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39550, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13963, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11460, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11459, PropCategory.REGULAR)
