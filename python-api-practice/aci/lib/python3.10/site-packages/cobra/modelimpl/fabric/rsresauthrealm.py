...
# ##################################################
class RsResAuthRealm(Mo):
    """
    This object is generated and used only by internal processes.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResAuthRealm", "cobra.model.aaa.AuthRealm")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResAuthRealm"
    meta.rnFormat = "rsresAuthRealm"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11408, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1594
    prop.defaultValueStr = "aaaAuthRealm"
    prop._addConstant("aaaAuthRealm", None, 1594)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11407, PropCategory.REGULAR)
