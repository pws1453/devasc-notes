...
# ##################################################
class RsTwampServerPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsTwampServerPol", "cobra.model.twamp.ServerPol")
    meta.targetNameProps["name"] = "tnTwampServerPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsTwampServerPol"
    meta.rnFormat = "rstwampServerPol"
    ...
    meta.rnPrefixes = [
        ('rstwampServerPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38840, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40979, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37011, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 37007, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTwampServerPolName", "tnTwampServerPolName", 37006, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTwampServerPolName", prop)
