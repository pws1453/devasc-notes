...
# ##################################################
class RsToFabricIPV6ProtPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsToFabricIPV6ProtPol", "cobra.model.fabric.IPV6ProtPol")
    meta.targetNameProps["name"] = "tnFabricIPV6ProtPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsToFabricIPV6ProtPol"
    meta.rnFormat = "rstoFabricIPV6ProtPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20415, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20409, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 978
    prop.defaultValueStr = "fabricIPV6ProtPol"
    ...
    prop = PropMeta("str", "tnFabricIPV6ProtPolName", "tnFabricIPV6ProtPolName", 20408, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricIPV6ProtPolName", prop)
