...
class OverallHealth1year(Mo):
    """
    A class that represents the most current statistics for overall fabric health in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.OverallHealth1year", "overall fabric health")
    ...
    meta.moClassName = "fabricOverallHealth1year"
    meta.rnFormat = "CDfabricOverallHealth1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall fabric health stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDfabricOverallHealth1year', False),
    ]
