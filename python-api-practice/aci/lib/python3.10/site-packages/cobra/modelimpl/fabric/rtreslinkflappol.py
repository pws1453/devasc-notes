...
# ##################################################
class RtResLinkFlapPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtResLinkFlapPol", "cobra.model.infra.Infra")

    meta.moClassName = "fabricRtResLinkFlapPol"
    meta.rnFormat = "rtresLinkFlapPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 57462, PropCategory.REGULAR)
