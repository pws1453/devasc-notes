...
# ##################################################
class RtStCEpToPathEp(Mo):
    """
    A target relation to an abstraction of a path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtStCEpToPathEp", "cobra.model.fv.StCEp")

    meta.moClassName = "fabricRtStCEpToPathEp"
    meta.rnFormat = "rtfvStCEpToPathEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12400, PropCategory.REGULAR)
