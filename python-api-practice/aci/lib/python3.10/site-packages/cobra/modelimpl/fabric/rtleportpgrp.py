...
# ##################################################
class RtLePortPGrp(Mo):
    """
    A target relation to the leaf port policy group.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtLePortPGrp", "cobra.model.fabric.LFPortS")

    meta.moClassName = "fabricRtLePortPGrp"
    meta.rnFormat = "rtlePortPGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11462, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 840
    prop.defaultValueStr = "fabricLFPortS"
    prop._addConstant("fabricLFPortS", None, 840)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11461, PropCategory.REGULAR)
