...
# ##################################################
class RtLinkFlapPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtLinkFlapPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "fabricRtLinkFlapPolCons"
    meta.rnFormat = "rtl1LinkFlapPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 57459, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 57458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 57475, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
