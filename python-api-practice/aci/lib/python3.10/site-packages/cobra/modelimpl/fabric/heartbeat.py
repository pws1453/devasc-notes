...
class Heartbeat(Mo):
    """
    An internal object that tracks heartbeats from the switch to the APIC. This should be implicit and cannot be modified by the user.

    """

    meta = ClassMeta("cobra.model.fabric.Heartbeat")

    meta.moClassName = "fabricHeartbeat"
    meta.rnFormat = "heartbeat"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric Node Heartbeat"
    ...
    prop = PropMeta("str", "lastHeartbeat", "lastHeartbeat", 15455, PropCategory.REGULAR)
    prop.label = "Last Heartbeat"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("lastHeartbeat", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15456, PropCategory.REGULAR)
