...
# ##################################################
class AcDropExcessHist15min(Mo):
    """
    A class that represents historical statistics for drop packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.fabric.AcDropExcessHist15min", "drop packets")
    ...
    meta.moClassName = "fabricAcDropExcessHist15min"
    meta.rnFormat = "HDfabricAcDropExcess15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical drop packets stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDfabricAcDropExcess15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6418, PropCategory.REGULAR)
