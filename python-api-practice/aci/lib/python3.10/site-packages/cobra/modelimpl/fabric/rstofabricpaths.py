...
# ##################################################
class RsToFabricPathS(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsToFabricPathS", "cobra.model.fabric.APathS")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsToFabricPathS"
    meta.rnFormat = "rstoFabricPathS-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Relation from Node to Interface Path Selector"
    ...
    meta.superClasses.add("cobra.model.fabric.NodeToPathOverridePolicy")
    meta.superClasses.add("cobra.model.reln.To")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rstoFabricPathS-', True),
    ]
    ...
    prop = PropMeta("str", "deplSt", "deplSt", 18176, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18185, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18178, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6090
    prop.defaultValueStr = "fabricAPathS"
    ...
    prop = PropMeta("str", "tDn", "tDn", 18177, PropCategory.REGULAR)
