...
# ##################################################
class RsPodPGrpIsisDomP(Mo):
    """
    A source relation to the domain policy for configuring ISIS domain specific properties.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsPodPGrpIsisDomP", "cobra.model.isis.DomPol")
    meta.targetNameProps["name"] = "tnIsisDomPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsPodPGrpIsisDomP"
    meta.rnFormat = "rspodPGrpIsisDomP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ISIS Domain Policy"
    ...
    meta.rnPrefixes = [
        ('rspodPGrpIsisDomP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37435, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39574, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13994, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11554, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4275
    prop.defaultValueStr = "isisDomPol"
    ...
    prop = PropMeta("str", "tnIsisDomPolName", "tnIsisDomPolName", 11553, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnIsisDomPolName", prop)
