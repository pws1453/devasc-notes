...
# ##################################################
class AcDropExcessHist1year(Mo):
    """
    A class that represents historical statistics for drop packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fabric.AcDropExcessHist1year", "drop packets")
    ...
    meta.moClassName = "fabricAcDropExcessHist1year"
    meta.rnFormat = "HDfabricAcDropExcess1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical drop packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDfabricAcDropExcess1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6424, PropCategory.REGULAR)
