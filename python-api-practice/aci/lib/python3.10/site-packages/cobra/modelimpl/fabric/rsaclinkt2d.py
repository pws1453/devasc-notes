...
# ##################################################
class RsAcLinkT2D(Mo):
    """
    A source relation to an atomic counter link.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsAcLinkT2D", "cobra.model.dbg.AcLinkT2D")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsAcLinkT2D"
    meta.rnFormat = "rsacLinkT2D-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11345, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4062
    prop.defaultValueStr = "dbgAcLinkT2D"
    prop._addConstant("dbgAcLinkT2D", None, 4062)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11344, PropCategory.REGULAR)
