...
# ##################################################
class RsResCoopPol(Mo):
    """
    A source relation to the COOP group policy information.  Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResCoopPol", "cobra.model.coop.Pol")
    meta.targetNameProps["name"] = "tnCoopPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResCoopPol"
    meta.rnFormat = "rsresCoopPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric COOP Group Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11710, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnCoopPolName", "tnCoopPolName", 11709, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
