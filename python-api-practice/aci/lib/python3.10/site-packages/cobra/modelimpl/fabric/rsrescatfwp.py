...
# ##################################################
class RsResCatFwP(Mo):
    """
    A source relation to the catalog firmware policy version.  Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResCatFwP", "cobra.model.firmware.CatFwP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResCatFwP"
    meta.rnFormat = "rsresCatFwP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Catalog Firmware Profile Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13922, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11707, PropCategory.REGULAR)
