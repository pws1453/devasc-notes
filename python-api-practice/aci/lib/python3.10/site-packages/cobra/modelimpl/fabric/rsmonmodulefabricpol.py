...
# ##################################################
class RsMonModuleFabricPol(Mo):
    """
    A source relation to the monitoring policy model for the fabric semantic scope.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsMonModuleFabricPol", "cobra.model.mon.FabricPol")
    meta.targetNameProps["name"] = "tnMonFabricPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsMonModuleFabricPol"
    meta.rnFormat = "rsmonModuleFabricPol"
    ...
    meta.superClasses.add("cobra.model.fabric.PolicyGrpToMonitoring")

    meta.rnPrefixes = [
        ('rsmonModuleFabricPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37448, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39587, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14007, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11582, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 249
    prop.defaultValueStr = "monFabricPol"
    ...
    prop = PropMeta("str", "tnMonFabricPolName", "tnMonFabricPolName", 11581, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMonFabricPolName", prop)
