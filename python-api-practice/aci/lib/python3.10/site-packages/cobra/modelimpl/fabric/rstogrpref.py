...
class RsToGrpRef(Mo):
    """
    A source relation to the group of ports in a leaf node connected to the same loose node.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsToGrpRef", "cobra.model.fabric.GroupRef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsToGrpRef"
    meta.rnFormat = "rstoGrpRef-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fabric.ProtLooseLink")
    meta.parentClasses.add("cobra.model.fabric.LooseLink")
    ...
    prop = PropMeta("str", "tCl", "tCl", 15652, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 501
    prop.defaultValueStr = "fabricGroupRef"
    prop._addConstant("fabricGroupRef", None, 501)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15651, PropCategory.REGULAR)
