...
class RsOosSlot(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsOosSlot", "cobra.model.eqpt.Slot")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsOosSlot"
    meta.rnFormat = "rsoosSlot-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Out of Service Slot"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38118, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40257, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "lc", "lc", 16331, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 16330, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3339
    prop.defaultValueStr = "eqptSlot"
    ...
    prop = PropMeta("str", "tDn", "tDn", 16329, PropCategory.REGULAR)
