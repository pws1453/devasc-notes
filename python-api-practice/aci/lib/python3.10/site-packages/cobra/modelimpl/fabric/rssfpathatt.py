...
# ##################################################
class RsSFPathAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsSFPathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsSFPathAtt"
    meta.rnFormat = "rssFPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine Fabric Path"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38181, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40320, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 18157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18156, PropCategory.REGULAR)
