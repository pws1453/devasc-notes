...
# ##################################################
class RtSrcToNode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtSrcToNode", "cobra.model.span.Src")

    meta.moClassName = "fabricRtSrcToNode"
    meta.rnFormat = "rtsrcToNode"
    ...
    prop = PropMeta("str", "tCl", "tCl", 47379, PropCategory.REGULAR)
