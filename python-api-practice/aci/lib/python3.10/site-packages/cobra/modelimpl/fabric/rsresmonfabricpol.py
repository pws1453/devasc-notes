...
# ##################################################
class RsResMonFabricPol(Mo):
    """
    A source relation to a fabric monitoring policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResMonFabricPol", "cobra.model.mon.FabricPol")
    meta.targetNameProps["name"] = "tnMonFabricPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResMonFabricPol"
    meta.rnFormat = "rsresMonFabricPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Monitoring Policy Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13923, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11748, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonFabricPolName", "tnMonFabricPolName", 11747, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
