...
# ##################################################
class RsUsedMcastIp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsUsedMcastIp", "cobra.model.fabric.ExtRoutableMcastIp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsUsedMcastIp"
    meta.rnFormat = "rsusedMcastIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MultiCast TEP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45423, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13112
    prop.defaultValueStr = "fabricExtRoutableMcastIp"
    prop._addConstant("fabricExtRoutableMcastIp", None, 13112)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45422, PropCategory.REGULAR)
