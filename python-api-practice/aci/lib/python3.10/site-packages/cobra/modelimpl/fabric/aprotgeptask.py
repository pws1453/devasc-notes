...
# ##################################################
class AProtGEpTask(Mo):
    """
    An internal task on VPC the protection group.

    """

    meta = ClassMeta("cobra.model.fabric.AProtGEpTask")

    meta.moClassName = "fabricAProtGEpTask"
    meta.rnFormat = "fabricAProtGEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5679, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ManageVIP", "managevip", 458)
    prop._addConstant("SpineProxyCreate", "spineproxycreate", 1462)
