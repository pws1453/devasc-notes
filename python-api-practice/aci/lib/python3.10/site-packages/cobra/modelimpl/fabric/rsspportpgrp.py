...
# ##################################################
class RsSpPortPGrp(Mo):
    """
    A source relation to the policy providing lag/singular function semantics to the ports.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsSpPortPGrp", "cobra.model.fabric.SpAPortPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsSpPortPGrp"
    meta.rnFormat = "rsspPortPGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37413, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39552, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13965, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11464, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11463, PropCategory.REGULAR)
