...
# ##################################################
class RsResFabricMACProtPol(Mo):
    """
    A source relation to the spine MAC protection policy. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResFabricMACProtPol", "cobra.model.fabric.MACProtPol")
    meta.targetNameProps["name"] = "tnFabricMACProtPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResFabricMACProtPol"
    meta.rnFormat = "rsresFabricMACProtPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine MAC Protection Group Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13919, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11723, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 976
    prop.defaultValueStr = "fabricMACProtPol"
    ...
    prop = PropMeta("str", "tnFabricMACProtPolName", "tnFabricMACProtPolName", 11722, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricMACProtPolName", prop)
