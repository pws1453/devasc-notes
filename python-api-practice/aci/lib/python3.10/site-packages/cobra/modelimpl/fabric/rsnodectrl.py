...
class RsNodeCtrl(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fabric.RsNodeCtrl", "cobra.model.fabric.NodeControl")
    meta.targetNameProps["name"] = "tnFabricNodeControlName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsNodeCtrl"
    meta.rnFormat = "rsnodeCtrl"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Digital Optical Monitoring Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38498, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40637, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25972, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 25952, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8937
    prop.defaultValueStr = "fabricNodeControl"
    ...
    prop = PropMeta("str", "tnFabricNodeControlName", "tnFabricNodeControlName", 27117, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricNodeControlName", prop)
