...
# ##################################################
class RsPathToSpPortPGrp(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsPathToSpPortPGrp", "cobra.model.fabric.SpAPortPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsPathToSpPortPGrp"
    meta.rnFormat = "rspathToSpPortPGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine Port Policy Group"
    ...
    meta.rnPrefixes = [
        ('rspathToSpPortPGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38182, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40321, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18169, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18153, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 962
    prop.defaultValueStr = "fabricSpAPortPGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 18152, PropCategory.REGULAR)
