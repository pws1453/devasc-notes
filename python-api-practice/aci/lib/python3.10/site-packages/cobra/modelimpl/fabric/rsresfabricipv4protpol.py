...
# ##################################################
class RsResFabricIPV4ProtPol(Mo):
    """
    A source relation to the spine IPV4 protection policy. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResFabricIPV4ProtPol", "cobra.model.fabric.IPV4ProtPol")
    meta.targetNameProps["name"] = "tnFabricIPV4ProtPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResFabricIPV4ProtPol"
    meta.rnFormat = "rsresFabricIPV4ProtPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine IPV4 Protection Group Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13920, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11720, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 977
    prop.defaultValueStr = "fabricIPV4ProtPol"
    ...
    prop = PropMeta("str", "tnFabricIPV4ProtPolName", "tnFabricIPV4ProtPolName", 11719, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricIPV4ProtPolName", prop)
