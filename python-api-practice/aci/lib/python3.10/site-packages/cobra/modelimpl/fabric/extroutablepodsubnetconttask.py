...
# ##################################################
class ExtRoutablePodSubnetContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.ExtRoutablePodSubnetContTask")

    meta.moClassName = "fabricExtRoutablePodSubnetContTask"
    meta.rnFormat = "fabricExtRoutablePodSubnetContTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricExtRoutablePodSubnetContTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 54437, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 3575)
