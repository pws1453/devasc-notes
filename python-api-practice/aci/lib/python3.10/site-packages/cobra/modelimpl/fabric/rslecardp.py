...
class RsLeCardP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsLeCardP", "cobra.model.fabric.LeCardP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsLeCardP"
    meta.rnFormat = "rsleCardP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37419, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39558, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13978, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11506, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 885
    prop.defaultValueStr = "fabricLeCardP"
    prop._addConstant("fabricLeCardP", None, 885)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11505, PropCategory.REGULAR)
