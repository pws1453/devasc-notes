...
# ##################################################
class RsResLdapEp(Mo):
    """
    A source relation to the global security management properties for LDAP endpoints and LDAP provider groups. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResLdapEp", "cobra.model.aaa.LdapEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResLdapEp"
    meta.rnFormat = "rsresLdapEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11412, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1597
    prop.defaultValueStr = "aaaLdapEp"
    prop._addConstant("aaaLdapEp", None, 1597)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11411, PropCategory.REGULAR)
