...
# ##################################################
class RsSpCardPGrp(Mo):
    """
    A source relation to the spine card policy group.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsSpCardPGrp", "cobra.model.fabric.SpCardPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsSpCardPGrp"
    meta.rnFormat = "rsspCardPGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37409, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39548, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13961, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11456, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 937
    prop.defaultValueStr = "fabricSpCardPGrp"
    prop._addConstant("fabricSpCardPGrp", None, 937)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11455, PropCategory.REGULAR)
