...
# ##################################################
class RsMonIfFabricPol(Mo):
    """
    A source relation to the monitoring policy model for the fabric semantic scope.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsMonIfFabricPol", "cobra.model.mon.FabricPol")
    meta.targetNameProps["name"] = "tnMonFabricPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsMonIfFabricPol"
    meta.rnFormat = "rsmonIfFabricPol"
    ...
    meta.rnPrefixes = [
        ('rsmonIfFabricPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37429, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39568, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13988, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11522, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonFabricPolName", "tnMonFabricPolName", 11521, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
