...
# ##################################################
class RtHealthFabricNode(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtHealthFabricNode", "cobra.model.fault.RelnHolder")

    meta.moClassName = "fabricRtHealthFabricNode"
    meta.rnFormat = "rtfaultHealthFabricNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16637, PropCategory.REGULAR)
