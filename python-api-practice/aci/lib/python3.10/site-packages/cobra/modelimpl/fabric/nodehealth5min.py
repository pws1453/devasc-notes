...
# ##################################################
class NodeHealth5min(Mo):
    """
    A class that represents the most current statistics for node health in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth5min", "node health")
    ...
    meta.moClassName = "fabricNodeHealth5min"
    meta.rnFormat = "CDfabricNodeHealth5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 5 minute"
