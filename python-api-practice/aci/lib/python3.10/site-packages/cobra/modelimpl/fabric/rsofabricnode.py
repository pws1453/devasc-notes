...
# ##################################################
class RsOFabricNode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsOFabricNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsOFabricNode"
    meta.rnFormat = "rsOFabricNode"
    ...
    meta.parentClasses.add("cobra.model.infra.OSpineS")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38503, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40642, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 26046, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26045, PropCategory.REGULAR)
