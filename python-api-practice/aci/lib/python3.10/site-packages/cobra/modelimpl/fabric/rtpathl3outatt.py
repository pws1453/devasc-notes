...
# ##################################################
class RtPathL3OutAtt(Mo):
    """
    A target relation to an abstraction of a path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtPathL3OutAtt", "cobra.model.l3ext.LIfP")

    meta.moClassName = "fabricRtPathL3OutAtt"
    meta.rnFormat = "rtl3extPathL3OutAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Logical Interface Profile"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x88021820003
    ...
    prop = PropMeta("str", "tCl", "tCl", 12123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12122, PropCategory.REGULAR)
