...
# ##################################################
class RsOSpineSToSpNodePGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsOSpineSToSpNodePGrp", "cobra.model.fabric.SpNodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsOSpineSToSpNodePGrp"
    meta.rnFormat = "rsOSpineSToSpNodePGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Spine Node Policy Group"
    ...
    meta.rnPrefixes = [
        ('rsOSpineSToSpNodePGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38505, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40644, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26062, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26050, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 925
    prop.defaultValueStr = "fabricSpNodePGrp"
    prop._addConstant("fabricSpNodePGrp", None, 925)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26049, PropCategory.REGULAR)
