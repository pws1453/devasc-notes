...
# ##################################################
class RtLinkFlapPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtLinkFlapPol", "cobra.model.infra.AAccGrp")

    meta.moClassName = "fabricRtLinkFlapPol"
    meta.rnFormat = "rtinfraLinkFlapPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 57466, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 57465, PropCategory.REGULAR)
