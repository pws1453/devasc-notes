...
# ##################################################
class RsResL2InstPol(Mo):
    """
    A source relation to the Layer 2 instance policy information. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResL2InstPol", "cobra.model.l2.InstPol")
    meta.targetNameProps["name"] = "tnL2InstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResL2InstPol"
    meta.rnFormat = "rsresL2InstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13943, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11737, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL2InstPolName", "tnL2InstPolName", 11736, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
