...
class RsSpCardP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsSpCardP", "cobra.model.fabric.SpCardP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsSpCardP"
    meta.rnFormat = "rsspCardP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37422, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39561, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13981, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11514, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 886
    prop.defaultValueStr = "fabricSpCardP"
    prop._addConstant("fabricSpCardP", None, 886)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11513, PropCategory.REGULAR)
