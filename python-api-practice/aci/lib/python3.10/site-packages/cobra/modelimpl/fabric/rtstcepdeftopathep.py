...
# ##################################################
class RtStCEpDefToPathEp(Mo):
    """
    A target relation to an abstraction of a path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtStCEpDefToPathEp", "cobra.model.fv.StCEpDef")

    meta.moClassName = "fabricRtStCEpDefToPathEp"
    meta.rnFormat = "rtfvStCEpDefToPathEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12404, PropCategory.REGULAR)
