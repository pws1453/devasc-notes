...
# ##################################################
class RsFLinkFlapPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsFLinkFlapPol", "cobra.model.fabric.FLinkFlapPol")
    meta.targetNameProps["name"] = "tnFabricFLinkFlapPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsFLinkFlapPol"
    meta.rnFormat = "rsfLinkFlapPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Fabric Link Flap Policy"
    ...
    meta.rnPrefixes = [
        ('rsfLinkFlapPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 61882, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61883, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 61871, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricFLinkFlapPolName", "tnFabricFLinkFlapPolName", 61870, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricFLinkFlapPolName", prop)
