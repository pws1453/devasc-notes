...
# ##################################################
class VpcResourceTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fabric.VpcResourceTask")

    meta.moClassName = "fabricVpcResourceTask"
    meta.rnFormat = "fabricVpcResourceTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 17903, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReleaseVIP", "releasevip", 1575)
