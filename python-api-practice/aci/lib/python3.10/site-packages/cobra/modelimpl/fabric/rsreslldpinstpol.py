...
# ##################################################
class RsResLldpInstPol(Mo):
    """
    A source relation to the node level LLDP policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResLldpInstPol", "cobra.model.lldp.InstPol")
    meta.targetNameProps["name"] = "tnLldpInstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResLldpInstPol"
    meta.rnFormat = "rsresLldpInstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11743, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnLldpInstPolName", "tnLldpInstPolName", 11742, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnLldpInstPolName", prop)
