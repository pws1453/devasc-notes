...
# ##################################################
class RsResFabricProtChainP(Mo):
    """
    A source relation to the node proxy IP profile. Note that this relation is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResFabricProtChainP", "cobra.model.fabric.ProtChainP")
    meta.targetNameProps["name"] = "tnFabricProtChainPName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResFabricProtChainP"
    meta.rnFormat = "rsresFabricProtChainP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Protection Chain Profile Relation"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11726, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 997
    prop.defaultValueStr = "fabricProtChainP"
    ...
    prop = PropMeta("str", "tnFabricProtChainPName", "tnFabricProtChainPName", 11725, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFabricProtChainPName", prop)
