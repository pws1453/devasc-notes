...
# ##################################################
class RsPathToLePortPGrp(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsPathToLePortPGrp", "cobra.model.fabric.LeAPortPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsPathToLePortPGrp"
    meta.rnFormat = "rspathToLePortPGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Leaf Port Policy Group"
    ...
    meta.rnPrefixes = [
        ('rspathToLePortPGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38179, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40318, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18167, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18149, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 963
    prop.defaultValueStr = "fabricLeAPortPGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 18148, PropCategory.REGULAR)
