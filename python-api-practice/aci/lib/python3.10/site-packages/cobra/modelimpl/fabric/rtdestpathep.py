...
# ##################################################
class RtDestPathEp(Mo):
    """
    A target relation to an abstraction of the path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtDestPathEp", "cobra.model.span.ADest")

    meta.moClassName = "fabricRtDestPathEp"
    meta.rnFormat = "rtspanDestPathEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "SPAN Destination"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x80001820603
    ...
    prop = PropMeta("str", "tCl", "tCl", 13029, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4159
    prop.defaultValueStr = "spanADest"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13028, PropCategory.REGULAR)
