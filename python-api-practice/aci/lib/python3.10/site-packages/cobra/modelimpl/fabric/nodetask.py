...
class NodeTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.NodeTask")

    meta.moClassName = "fabricNodeTask"
    meta.rnFormat = "fabricNodeTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5747, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("send", "send", 30)
