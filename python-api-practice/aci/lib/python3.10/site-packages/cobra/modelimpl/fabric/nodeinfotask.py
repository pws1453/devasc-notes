...
# ##################################################
class NodeInfoTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fabric.NodeInfoTask")

    meta.moClassName = "fabricNodeInfoTask"
    meta.rnFormat = "fabricNodeInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15561, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("send", "send", 1287)
