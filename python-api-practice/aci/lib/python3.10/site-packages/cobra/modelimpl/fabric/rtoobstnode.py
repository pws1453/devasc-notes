...
# ##################################################
class RtOoBStNode(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtOoBStNode", "cobra.model.mgmt.OoB")

    meta.moClassName = "fabricRtOoBStNode"
    meta.rnFormat = "rtmgmtOoBStNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16533, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16532, PropCategory.REGULAR)
