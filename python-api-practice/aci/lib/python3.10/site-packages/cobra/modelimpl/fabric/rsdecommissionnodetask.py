...
# ##################################################
class RsDecommissionNodeTask(Mo):
    """
    An internal task for managing node decommission.

    """

    meta = ClassMeta("cobra.model.fabric.RsDecommissionNodeTask")

    meta.moClassName = "fabricRsDecommissionNodeTask"
    meta.rnFormat = "fabricRsDecommissionNodeTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricRsDecommissionNodeTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 5682, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CleanupPolicy", "cleanuppolicy", 3946)
    prop._addConstant("PdCleanupNodePol", "pdcleanupnodepol", 2653)
    prop._addConstant("RemoveSwitch", "removeswitch", 357)
    prop._addConstant("TopoCleanup", "topocleanup", 358)
    prop._addConstant("UpdateCloudsec", "updatecloudsec", 3294)
