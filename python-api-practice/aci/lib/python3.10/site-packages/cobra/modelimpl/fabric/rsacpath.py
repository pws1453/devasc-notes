...
class RsAcPath(Mo):
    """
    A source relation to the atomic counter for a path. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsAcPath", "cobra.model.dbg.AcPath")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsAcPath"
    meta.rnFormat = "rsacPath"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Atomic Counter for the Path"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11336, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4058
    prop.defaultValueStr = "dbgAcPath"
    prop._addConstant("dbgAcPath", None, 4058)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11335, PropCategory.REGULAR)
