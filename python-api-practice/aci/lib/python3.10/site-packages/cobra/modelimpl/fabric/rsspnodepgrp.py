...
# ##################################################
class RsSpNodePGrp(Mo):
    """
    A source relation to the spine node policy group.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsSpNodePGrp", "cobra.model.fabric.SpNodePGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsSpNodePGrp"
    meta.rnFormat = "rsspNodePGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39544, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13957, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11448, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11447, PropCategory.REGULAR)
