...
class RsTimePol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fabric.RsTimePol", "cobra.model.datetime.Pol")
    meta.targetNameProps["name"] = "tnDatetimePolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsTimePol"
    meta.rnFormat = "rsTimePol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DateTime Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37437, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39576, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13996, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11542, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4525
    prop.defaultValueStr = "datetimePol"
    ...
    prop = PropMeta("str", "tnDatetimePolName", "tnDatetimePolName", 11541, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnDatetimePolName", prop)
