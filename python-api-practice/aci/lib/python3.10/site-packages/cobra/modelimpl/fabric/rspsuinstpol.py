...
# ##################################################
class RsPsuInstPol(Mo):
    """
    A source relation to the power redundancy policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsPsuInstPol", "cobra.model.psu.InstPol")
    meta.targetNameProps["name"] = "tnPsuInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsPsuInstPol"
    meta.rnFormat = "rspsuInstPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37444, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39583, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14003, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11578, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnPsuInstPolName", "tnPsuInstPolName", 11577, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnPsuInstPolName", prop)
