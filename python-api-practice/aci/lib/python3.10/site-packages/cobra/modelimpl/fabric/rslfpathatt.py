...
# ##################################################
class RsLFPathAtt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsLFPathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsLFPathAtt"
    meta.rnFormat = "rslFPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Leaf Fabric Path"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38178, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40317, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 18146, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18145, PropCategory.REGULAR)
