...
# ##################################################
class RsMacsecPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsMacsecPol", "cobra.model.macsec.FabIfPol")
    meta.targetNameProps["name"] = "tnMacsecFabIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsMacsecPol"
    meta.rnFormat = "rsmacsecPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40780, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30137, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30117, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMacsecFabIfPolName", "tnMacsecFabIfPolName", 30116, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
