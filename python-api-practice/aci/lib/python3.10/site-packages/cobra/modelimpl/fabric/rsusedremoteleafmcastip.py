...
# ##################################################
class RsUsedRemoteLeafMcastIp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsUsedRemoteLeafMcastIp", "cobra.model.fabric.ExtRoutableRemoteLeafMcastIp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsUsedRemoteLeafMcastIp"
    meta.rnFormat = "rsusedRemoteLeafMcastIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "RemoteLeaf Mcast TEP"
    ...
    meta.parentClasses.add("cobra.model.fabric.ExtRoutableSubnet")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsusedRemoteLeafMcastIp-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 52985, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15521
    prop.defaultValueStr = "fabricExtRoutableRemoteLeafMcastIp"
    prop._addConstant("fabricExtRoutableRemoteLeafMcastIp", None, 15521)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52984, PropCategory.REGULAR)
