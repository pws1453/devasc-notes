...
# ##################################################
class RsApplTechSupOnDemand(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsApplTechSupOnDemand", "cobra.model.dbgexp.TechSupOnD")
    meta.targetNameProps["name"] = "tnDbgexpTechSupOnDName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsApplTechSupOnDemand"
    meta.rnFormat = "rsapplTechSupOnDemand-%(tnDbgexpTechSupOnDName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Tech Support Policy for On-demand Collection"
    ...
    meta.rnPrefixes = [
        ('rsapplTechSupOnDemand-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 53980, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 53981, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53979, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 53976, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4115
    prop.defaultValueStr = "dbgexpTechSupOnD"
    ...
    prop = PropMeta("str", "tnDbgexpTechSupOnDName", "tnDbgexpTechSupOnDName", 53975, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnDbgexpTechSupOnDName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnDbgexpTechSupOnDName"))

    # Deployment Meta
    meta.deploymentQuery = True
    meta.deploymentType = "Ancestor"

    def __init__(self, parentMoOrDn, tnDbgexpTechSupOnDName, markDirty=True, **creationProps):
        namingVals = [tnDbgexpTechSupOnDName]
