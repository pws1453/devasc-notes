...
class RsResDuoEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fabric.RsResDuoEp", "cobra.model.aaa.DuoEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResDuoEp"
    meta.rnFormat = "rsresDuoEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55907, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16429
    prop.defaultValueStr = "aaaDuoEp"
    prop._addConstant("aaaDuoEp", None, 16429)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55906, PropCategory.REGULAR)
