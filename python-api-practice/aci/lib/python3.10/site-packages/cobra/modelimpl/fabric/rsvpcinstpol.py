...
# ##################################################
class RsVpcInstPol(Mo):
    """
    A source relation to the node-level vPC domain policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsVpcInstPol", "cobra.model.vpc.InstPol")
    meta.targetNameProps["name"] = "tnVpcInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsVpcInstPol"
    meta.rnFormat = "rsvpcInstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to VPC Domain Policy"
    meta.writeAccessMask = 0x100000001
    meta.readAccessMask = 0x100000001
    ...
    prop = PropMeta("str", "annotation", "annotation", 37454, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39593, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14035, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11698, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 693
    prop.defaultValueStr = "vpcInstPol"
    ...
    prop = PropMeta("str", "tnVpcInstPolName", "tnVpcInstPolName", 11697, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVpcInstPolName", prop)
