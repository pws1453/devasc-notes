...
# ##################################################
class RtFcPathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtFcPathAtt", "cobra.model.fv.AEPg")

    meta.moClassName = "fabricRtFcPathAtt"
    meta.rnFormat = "rtfvFcPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Application EPG"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x80001800603
    ...
    prop = PropMeta("str", "tCl", "tCl", 25337, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25336, PropCategory.REGULAR)
