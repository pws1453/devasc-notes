...
# ##################################################
class ExtSetupPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.ExtSetupPTask")

    meta.moClassName = "fabricExtSetupPTask"
    meta.rnFormat = "fabricExtSetupPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 45417, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 3271)
