...
# ##################################################
class RsCtrlrPGrp(Mo):
    """
    A source relation to policy group providing policies for appliance nodes in the pod. 

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsCtrlrPGrp", "cobra.model.fabric.CtrlrPGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsCtrlrPGrp"
    meta.rnFormat = "rsctrlrPGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39538, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13951, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11436, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11435, PropCategory.REGULAR)
