...
# ##################################################
class RsResPsuInstPol(Mo):
    """
    A source relation to the power redundancy policy. This object indicates which policy is associated with fabric.

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsResPsuInstPol", "cobra.model.psu.InstPol")
    meta.targetNameProps["name"] = "tnPsuInstPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fabricRsResPsuInstPol"
    meta.rnFormat = "rsresPsuInstPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15356, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15354, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnPsuInstPolName", "tnPsuInstPolName", 15353, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
