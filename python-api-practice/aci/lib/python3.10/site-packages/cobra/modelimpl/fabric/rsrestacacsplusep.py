...
# ##################################################
class RsResTacacsPlusEp(Mo):
    """
    A source relation to the global security management properties for TACACS+ endpoints and TACACS+ provider groups. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResTacacsPlusEp", "cobra.model.aaa.TacacsPlusEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResTacacsPlusEp"
    meta.rnFormat = "rsresTacacsPlusEp"
    ...
    meta.parentClasses.add("cobra.model.fabric.SecRelnHolder")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsresTacacsPlusEp', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11428, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1598
    prop.defaultValueStr = "aaaTacacsPlusEp"
    prop._addConstant("aaaTacacsPlusEp", None, 1598)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11427, PropCategory.REGULAR)
