...
# ##################################################
class NodePEpTask(Mo):
    """
    An internal task for node policy endpoints.

    """

    meta = ClassMeta("cobra.model.fabric.NodePEpTask")

    meta.moClassName = "fabricNodePEpTask"
    meta.rnFormat = "fabricNodePEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5681, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ManageProtectionChainIP", "manageprotectionchainip", 459)
