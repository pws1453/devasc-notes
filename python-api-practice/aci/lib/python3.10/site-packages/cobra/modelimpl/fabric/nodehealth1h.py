...
# ##################################################
class NodeHealth1h(Mo):
    """
    A class that represents the most current statistics for node health in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.fabric.NodeHealth1h", "node health")
    ...
    meta.moClassName = "fabricNodeHealth1h"
    meta.rnFormat = "CDfabricNodeHealth1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current node health stats in 1 hour"
