...
# ##################################################
class RsResUserEp(Mo):
    """
    This object is generated and used only by internal processes.

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsResUserEp", "cobra.model.aaa.UserEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsResUserEp"
    meta.rnFormat = "rsresUserEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11432, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11431, PropCategory.REGULAR)
