...
# ##################################################
class RtCIfPathAtt(Mo):
    """
    A target relation to an abstraction of a path endpoint. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fabric.RtCIfPathAtt", "cobra.model.vns.CIf")

    meta.moClassName = "fabricRtCIfPathAtt"
    meta.rnFormat = "rtvnsCIfPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Concrete Interface"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x4000080001820603
    ...
    prop = PropMeta("str", "tCl", "tCl", 13758, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13757, PropCategory.REGULAR)
