...
# ##################################################
class DecommissionJobTask(Mo):
    """
    An internal object for tracking decommission job tasks.

    """

    meta = ClassMeta("cobra.model.fabric.DecommissionJobTask")

    meta.moClassName = "fabricDecommissionJobTask"
    meta.rnFormat = "fabricDecommissionJobTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricDecommissionJobTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 5680, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PmCleanup", "pmcleanup", 359)
