...
class CtrlrTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.CtrlrTask")

    meta.moClassName = "fabricCtrlrTask"
    meta.rnFormat = "fabricCtrlrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 62706, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendSnmpInst", "sendsnmpinst", 4094)
