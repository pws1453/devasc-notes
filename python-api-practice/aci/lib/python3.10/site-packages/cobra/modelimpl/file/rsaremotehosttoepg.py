...
# ##################################################
class RsARemoteHostToEpg(Mo):
    """
    A source relation to the endpoint group through which the remote host is reachable.

    """

    meta = SourceRelationMeta("cobra.model.file.RsARemoteHostToEpg", "cobra.model.fv.ATg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fileRsARemoteHostToEpg"
    meta.rnFormat = "rsARemoteHostToEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachable Target Group"
    ...
    meta.rnPrefixes = [
        ('rsARemoteHostToEpg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37563, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39702, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12019, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1895
    prop.defaultValueStr = "fvATg"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12018, PropCategory.REGULAR)
