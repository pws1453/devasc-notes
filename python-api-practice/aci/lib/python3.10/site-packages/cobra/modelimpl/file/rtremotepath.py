...
# ##################################################
class RtRemotePath(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.file.RtRemotePath", "cobra.model.config.ABackupP")

    meta.moClassName = "fileRtRemotePath"
    meta.rnFormat = "rtconfigRemotePath-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Configuration Backup Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18471, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 257
    prop.defaultValueStr = "configABackupP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 18470, PropCategory.REGULAR)
