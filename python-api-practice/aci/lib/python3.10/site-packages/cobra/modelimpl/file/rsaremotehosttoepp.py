...
# ##################################################
class RsARemoteHostToEpp(Mo):
    """
    A source relation to the abstract representation of the resolvable endpoint profile.

    """

    meta = SourceRelationMeta("cobra.model.file.RsARemoteHostToEpp", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fileRsARemoteHostToEpp"
    meta.rnFormat = "rsARemoteHostToEpp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Remote Host  Reachability EPP"
    ...
    meta.rnPrefixes = [
        ('rsARemoteHostToEpp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38109, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40248, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15872, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15865, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1924
    prop.defaultValueStr = "fvAREpP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15864, PropCategory.REGULAR)
