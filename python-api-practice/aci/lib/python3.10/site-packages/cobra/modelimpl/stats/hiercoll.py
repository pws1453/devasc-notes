...
class HierColl(Mo):
    ...
    meta = ClassMeta("cobra.model.stats.HierColl")

    meta.moClassName = "statsHierColl"
    meta.rnFormat = "coll-%(granularity)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Hierarchical Statistics Collection Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37274, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39413, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "granularity", "granularity", 7187, PropCategory.REGULAR)
