...
class ThrDoubleP(Mo):
    """
    The concrete statistical threshold policy for a double data type.

    """

    meta = ClassMeta("cobra.model.stats.ThrDoubleP")

    meta.moClassName = "statsThrDoubleP"
    meta.rnFormat = "thrDouble-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38028, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "critHighReset", "critHighReset", 5399, PropCategory.REGULAR)
    prop.label = "Crit high crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critHighReset", prop)

    prop = PropMeta("str", "critHighSet", "critHighSet", 5398, PropCategory.REGULAR)
    prop.label = "Crit high crossing threshold promotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critHighSet", prop)

    prop = PropMeta("str", "critLowReset", "critLowReset", 5409, PropCategory.REGULAR)
    prop.label = "Crit low crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critLowReset", prop)

    prop = PropMeta("str", "critLowSet", "critLowSet", 5408, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40167, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "highRangeEnd", "highRangeEnd", 5391, PropCategory.REGULAR)
    prop.label = "End range for high crossing threshold values."
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("highRangeEnd", prop)

    prop = PropMeta("str", "highRangeStart", "highRangeStart", 5390, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "lowRangeEnd", "lowRangeEnd", 5401, PropCategory.REGULAR)
    prop.label = "End range for low crossing threshold values."
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("lowRangeEnd", prop)

    prop = PropMeta("str", "lowRangeStart", "lowRangeStart", 5400, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "normal", "normal", 5389, PropCategory.REGULAR)
    prop.label = "Threshold normal value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("normal", prop)

    prop = PropMeta("str", "propId", "propId", 7188, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "warnHighReset", "warnHighReset", 5393, PropCategory.REGULAR)
    prop.label = "Warn high crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnHighReset", prop)

    prop = PropMeta("str", "warnHighSet", "warnHighSet", 5392, PropCategory.REGULAR)
    prop.label = "Warn high crossing threshold promotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnHighSet", prop)

    prop = PropMeta("str", "warnLowReset", "warnLowReset", 5403, PropCategory.REGULAR)
    prop.label = "Warn low crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnLowReset", prop)

    prop = PropMeta("str", "warnLowSet", "warnLowSet", 5402, PropCategory.REGULAR)
