...
class ThrSint64P(Mo):
    """
    The concrete statistical threshold policy for a 64-bit signed integer data type.

    """

    meta = ClassMeta("cobra.model.stats.ThrSint64P")

    meta.moClassName = "statsThrSint64P"
    meta.rnFormat = "thrSint64-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38029, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "critHighReset", "critHighReset", 5420, PropCategory.REGULAR)
    prop.label = "Crit high crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critHighReset", prop)

    prop = PropMeta("str", "critHighSet", "critHighSet", 5419, PropCategory.REGULAR)
    prop.label = "Crit high crossing threshold promotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critHighSet", prop)

    prop = PropMeta("str", "critLowReset", "critLowReset", 5430, PropCategory.REGULAR)
    prop.label = "Crit low crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critLowReset", prop)

    prop = PropMeta("str", "critLowSet", "critLowSet", 5429, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40168, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "highRangeEnd", "highRangeEnd", 5412, PropCategory.REGULAR)
    prop.label = "End range for high crossing threshold values."
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("highRangeEnd", prop)

    prop = PropMeta("str", "highRangeStart", "highRangeStart", 5411, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "lowRangeEnd", "lowRangeEnd", 5422, PropCategory.REGULAR)
    prop.label = "End range for low crossing threshold values."
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("lowRangeEnd", prop)

    prop = PropMeta("str", "lowRangeStart", "lowRangeStart", 5421, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "normal", "normal", 5410, PropCategory.REGULAR)
    prop.label = "Threshold normal value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("normal", prop)

    prop = PropMeta("str", "propId", "propId", 7193, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "warnHighReset", "warnHighReset", 5414, PropCategory.REGULAR)
    prop.label = "Warn high crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnHighReset", prop)

    prop = PropMeta("str", "warnHighSet", "warnHighSet", 5413, PropCategory.REGULAR)
    prop.label = "Warn high crossing threshold promotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnHighSet", prop)

    prop = PropMeta("str", "warnLowReset", "warnLowReset", 5424, PropCategory.REGULAR)
    prop.label = "Warn low crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnLowReset", prop)

    prop = PropMeta("str", "warnLowSet", "warnLowSet", 5423, PropCategory.REGULAR)
