...
class ThrUByteP(Mo):
    """
    The concrete statistical threshold policy for an unsigned byte data type.

    """

    meta = ClassMeta("cobra.model.stats.ThrUByteP")

    meta.moClassName = "statsThrUByteP"
    meta.rnFormat = "thrUByte-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38027, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "critHighReset", "critHighReset", 5378, PropCategory.REGULAR)
    prop.label = "Crit high crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critHighReset", prop)

    prop = PropMeta("str", "critHighSet", "critHighSet", 5377, PropCategory.REGULAR)
    prop.label = "Crit high crossing threshold promotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critHighSet", prop)

    prop = PropMeta("str", "critLowReset", "critLowReset", 5388, PropCategory.REGULAR)
    prop.label = "Crit low crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("critLowReset", prop)

    prop = PropMeta("str", "critLowSet", "critLowSet", 5387, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40166, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "highRangeEnd", "highRangeEnd", 5370, PropCategory.REGULAR)
    prop.label = "End range for high crossing threshold values."
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("highRangeEnd", prop)

    prop = PropMeta("str", "highRangeStart", "highRangeStart", 5369, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "lowRangeEnd", "lowRangeEnd", 5380, PropCategory.REGULAR)
    prop.label = "End range for low crossing threshold values."
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("lowRangeEnd", prop)

    prop = PropMeta("str", "lowRangeStart", "lowRangeStart", 5379, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "normal", "normal", 5368, PropCategory.REGULAR)
    prop.label = "Threshold normal value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("normal", prop)

    prop = PropMeta("str", "propId", "propId", 7195, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "warnHighReset", "warnHighReset", 5372, PropCategory.REGULAR)
    prop.label = "Warn high crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnHighReset", prop)

    prop = PropMeta("str", "warnHighSet", "warnHighSet", 5371, PropCategory.REGULAR)
    prop.label = "Warn high crossing threshold promotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnHighSet", prop)

    prop = PropMeta("str", "warnLowReset", "warnLowReset", 5382, PropCategory.REGULAR)
    prop.label = "Warn low crossing threshold demotion value"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("warnLowReset", prop)

    prop = PropMeta("str", "warnLowSet", "warnLowSet", 5381, PropCategory.REGULAR)
