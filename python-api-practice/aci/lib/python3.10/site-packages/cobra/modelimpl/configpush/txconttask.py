...
class TxContTask(Mo):
    ...
    meta = ClassMeta("cobra.model.configpush.TxContTask")

    meta.moClassName = "configpushTxContTask"
    meta.rnFormat = "configpushTxContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33592, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PushToPm", "pushtopm", 2818)
