...
class RsNextTx(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.configpush.RsNextTx", "cobra.model.configpush.TxCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "configpushRsNextTx"
    meta.rnFormat = "rsnextTx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Next Transaction"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26377, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26376, PropCategory.REGULAR)
