...
# ##################################################
class TriggeredDeplModeTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.infrazone.TriggeredDeplModeTask")

    meta.moClassName = "infrazoneTriggeredDeplModeTask"
    meta.rnFormat = "infrazoneTriggeredDeplModeTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('infrazoneTriggeredDeplModeTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 22963, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("NotifyShard", "notifyshard", 2007)
