...
# ##################################################
class RsToNodeGrp(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.infrazone.RsToNodeGrp", "cobra.model.infrazone.NodeGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infrazoneRsToNodeGrp"
    meta.rnFormat = "rstoNodeGrp-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x4180000000001
    ...
    prop = PropMeta("str", "annotation", "annotation", 38371, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40510, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22883, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 22849, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7734
    prop.defaultValueStr = "infrazoneNodeGrp"
    prop._addConstant("infrazoneNodeGrp", None, 7734)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22848, PropCategory.REGULAR)
