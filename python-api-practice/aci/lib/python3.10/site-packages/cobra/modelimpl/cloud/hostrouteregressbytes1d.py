...
# ##################################################
class HostRouterEgressBytes1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes1d", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes1d"
    meta.rnFormat = "CDcloudHostRouterEgressBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes1d', False),
    ]
