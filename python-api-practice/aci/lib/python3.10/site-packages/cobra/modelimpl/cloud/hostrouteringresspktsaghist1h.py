...
# ##################################################
class HostRouterIngressPktsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist1h", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist1h"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54240, PropCategory.REGULAR)
