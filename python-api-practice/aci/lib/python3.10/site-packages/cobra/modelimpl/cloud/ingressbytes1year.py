...
# ##################################################
class IngressBytes1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytes1year", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes1year"
    meta.rnFormat = "CDcloudIngressBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudIngressBytes1year', False),
    ]
