...
# ##################################################
class HostRouterEgressPktsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist1mo", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist1mo"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54209, PropCategory.REGULAR)
