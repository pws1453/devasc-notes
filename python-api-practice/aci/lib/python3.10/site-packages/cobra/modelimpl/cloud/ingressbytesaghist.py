...
# ##################################################
class IngressBytesAgHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist"


    meta.moClassName = "cloudIngressBytesAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist15min")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist1h")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist1year")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist5min")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytesAgHist1d")
