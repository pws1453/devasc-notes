...
class VpnGwPol(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.VpnGwPol")

    meta.moClassName = "cloudVpnGwPol"
    meta.rnFormat = "vpngwpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud VPN GW Policy"
    ...
    meta.childClasses.add("cobra.model.cloud.RtToVpnGwPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtToVpnGwPol", "rttoVpnGwPol-"))
    ...
    meta.superClasses.add("cobra.model.cloud.AVpnGwPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 51510, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "asn", "asn", 55843, PropCategory.REGULAR)
    prop.label = "VPN GW Autonomous System Number"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51511, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50715, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vpnTransit", "vpnTransit", 50121, PropCategory.REGULAR)
    prop.label = "Does the VPN GW need to provide transit service"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("vpnTransit", prop)
