...
# ##################################################
class LBStatsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist1mo", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist1mo"
    meta.rnFormat = "HDcloudLBStatsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 52400, PropCategory.REGULAR)
