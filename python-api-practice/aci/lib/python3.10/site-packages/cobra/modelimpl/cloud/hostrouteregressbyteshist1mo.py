...
# ##################################################
class HostRouterEgressBytesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist1mo", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist1mo"
    meta.rnFormat = "HDcloudHostRouterEgressBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54201, PropCategory.REGULAR)
