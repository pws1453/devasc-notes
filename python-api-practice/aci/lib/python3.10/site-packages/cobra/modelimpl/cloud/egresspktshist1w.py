...
# ##################################################
class EgressPktsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist1w", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist1w"
    meta.rnFormat = "HDcloudEgressPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50651, PropCategory.REGULAR)
