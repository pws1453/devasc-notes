...
# ##################################################
class PoolHealthStatsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist5min", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist5min"
    meta.rnFormat = "HDcloudPoolHealthStatsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52422, PropCategory.REGULAR)
