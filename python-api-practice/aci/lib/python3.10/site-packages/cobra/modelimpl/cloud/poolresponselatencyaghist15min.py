...
# ##################################################
class PoolResponseLatencyAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist15min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist15min"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.PoolResponseLatencyAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52432, PropCategory.REGULAR)
