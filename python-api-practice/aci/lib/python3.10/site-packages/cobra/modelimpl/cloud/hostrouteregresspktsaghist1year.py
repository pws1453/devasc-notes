...
# ##################################################
class HostRouterEgressPktsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist1year", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist1year"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54212, PropCategory.REGULAR)
