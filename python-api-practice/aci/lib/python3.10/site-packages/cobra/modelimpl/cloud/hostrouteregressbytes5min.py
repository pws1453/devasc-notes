...
# ##################################################
class HostRouterEgressBytes5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes5min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes5min"
    meta.rnFormat = "CDcloudHostRouterEgressBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes5min', False),
    ]
