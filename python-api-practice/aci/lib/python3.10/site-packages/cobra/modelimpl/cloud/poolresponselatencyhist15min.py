...
# ##################################################
class PoolResponseLatencyHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist15min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist15min"
    meta.rnFormat = "HDcloudPoolResponseLatency15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.PoolResponseLatencyHist")

    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52440, PropCategory.REGULAR)
