...
# ##################################################
class PoolResponseLatencyAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg1d", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg1d"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg1d', False),
    ]
