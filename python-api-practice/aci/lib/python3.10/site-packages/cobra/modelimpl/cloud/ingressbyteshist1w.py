...
# ##################################################
class IngressBytesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesHist1w", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesHist1w"
    meta.rnFormat = "HDcloudIngressBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress bytess stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50677, PropCategory.REGULAR)
