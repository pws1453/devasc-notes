...
# ##################################################
class HostRouterIngressBytesAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAg1year", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAg1year"
    meta.rnFormat = "CDcloudHostRouterIngressBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router cloud ingress bytess stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytesAg1year', False),
    ]
