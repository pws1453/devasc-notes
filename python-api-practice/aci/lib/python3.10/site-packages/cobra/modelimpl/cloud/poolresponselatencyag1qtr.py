...
# ##################################################
class PoolResponseLatencyAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg1qtr", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg1qtr"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg1qtr', False),
    ]
