...
# ##################################################
class HostRouterEgressBytesAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist5min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist5min"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54197, PropCategory.REGULAR)
