...
# ##################################################
class HostRouterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.HostRouterPol")

    meta.moClassName = "cloudHostRouterPol"
    meta.rnFormat = "hostrouterpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Host Router Policy"
    ...
    meta.childClasses.add("cobra.model.cloud.RtToHostRouterPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtToHostRouterPol", "rttoHostRouterPol-"))
    ...
    meta.superClasses.add("cobra.model.cloud.AHostRouterPol")

    meta.rnPrefixes = [
        ('hostrouterpol-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51506, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51507, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50662, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "password", "password", 50114, PropCategory.REGULAR)
    prop.label = "Router Password"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "routerModel", "routerModel", 50109, PropCategory.REGULAR)
    prop.label = "Cloud Host Router Model"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "csr"
    prop._addConstant("csr", "cisco-csr-router", 0)
    meta.props.add("routerModel", prop)
    ...
    prop = PropMeta("str", "throughput", "throughput", 50111, PropCategory.REGULAR)
    prop.label = "Router Throughput"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 10
    prop.defaultValueStr = "10M"
    prop._addConstant("100M", "100mb-throughput", 100)
    prop._addConstant("10G", "10gb-throughput", 10000)
    prop._addConstant("10M", "10mb-throughput", 10)
    prop._addConstant("1G", "1gb-throughput", 1000)
    prop._addConstant("2.5G", "2.5gb-throughput", 2500)
    prop._addConstant("250M", "250mb-throughput", 250)
    prop._addConstant("500M", "500mb-throughput", 500)
    prop._addConstant("50M", "50mb-throughput", 50)
    prop._addConstant("5G", "5gb-throughput", 5000)
    prop._addConstant("7.5G", "7.5gb-throughput", 7500)
    meta.props.add("throughput", prop)

    prop = PropMeta("str", "token", "token", 50112, PropCategory.REGULAR)
    prop.label = "Router License Token"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("token", prop)
    ...
    prop = PropMeta("str", "username", "username", 50113, PropCategory.REGULAR)
    prop.label = "Router User Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
