...
# ##################################################
class IntNetworkP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.IntNetworkP")

    meta.moClassName = "cloudIntNetworkP"
    meta.rnFormat = "intnetworkp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Internal Network Policy"
    ...
    meta.superClasses.add("cobra.model.cloud.AIntNetworkP")

    meta.rnPrefixes = [
        ('intnetworkp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51502, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51503, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51465, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 50696, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
