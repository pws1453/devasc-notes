...
# ##################################################
class IngressBytes1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytes1d", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes1d"
    meta.rnFormat = "CDcloudIngressBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats in 1 day"
