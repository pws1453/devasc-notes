...
# ##################################################
class RsISvcEPgCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsISvcEPgCtx", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsISvcEPgCtx"
    meta.rnFormat = "rsISvcEPgCtx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 52872, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52873, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52867, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 52864, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 52863, PropCategory.REGULAR)
