...
# ##################################################
class HostRouterEgressBytesAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg1d", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg1d"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg1d', False),
    ]
