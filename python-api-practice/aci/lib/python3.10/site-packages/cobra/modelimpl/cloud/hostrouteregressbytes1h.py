...
# ##################################################
class HostRouterEgressBytes1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes1h", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes1h"
    meta.rnFormat = "CDcloudHostRouterEgressBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes1h', False),
    ]
