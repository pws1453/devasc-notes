...
# ##################################################
class HostRouterEgressPktsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist15min", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist15min"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterEgressPktsAgHist")

    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54206, PropCategory.REGULAR)
