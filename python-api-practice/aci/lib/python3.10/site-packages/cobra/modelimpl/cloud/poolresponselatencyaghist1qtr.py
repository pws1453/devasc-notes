...
# ##################################################
class PoolResponseLatencyAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist1qtr", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist1qtr"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52436, PropCategory.REGULAR)
