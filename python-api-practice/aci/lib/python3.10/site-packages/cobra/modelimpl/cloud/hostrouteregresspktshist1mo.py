...
# ##################################################
class HostRouterEgressPktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist1mo", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist1mo"
    meta.rnFormat = "HDcloudHostRouterEgressPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54217, PropCategory.REGULAR)
