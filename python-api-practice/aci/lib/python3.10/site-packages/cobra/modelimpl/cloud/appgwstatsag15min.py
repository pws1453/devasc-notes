...
# ##################################################
class AppGwStatsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg15min", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg15min"
    meta.rnFormat = "CDcloudAppGwStatsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudAppGwStatsAg15min', False),
    ]
