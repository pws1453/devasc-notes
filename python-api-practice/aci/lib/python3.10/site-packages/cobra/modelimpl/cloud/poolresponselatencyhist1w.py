...
# ##################################################
class PoolResponseLatencyHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist1w", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist1w"
    meta.rnFormat = "HDcloudPoolResponseLatency1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52445, PropCategory.REGULAR)
