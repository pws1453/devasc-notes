...
# ##################################################
class HostRouterIngressPktsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist1qtr", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist1qtr"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54242, PropCategory.REGULAR)
