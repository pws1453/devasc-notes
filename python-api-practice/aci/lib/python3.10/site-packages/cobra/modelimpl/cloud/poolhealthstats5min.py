...
# ##################################################
class PoolHealthStats5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats5min", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats5min"
    meta.rnFormat = "CDcloudPoolHealthStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats5min', False),
    ]
