...
class RtAD(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.cloud.RtAD", "cobra.model.cloud.Credentials")

    meta.moClassName = "cloudRtAD"
    meta.rnFormat = "rtAD-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55059, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55058, PropCategory.REGULAR)
