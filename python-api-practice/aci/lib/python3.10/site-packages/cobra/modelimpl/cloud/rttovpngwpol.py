...
# ##################################################
class RtToVpnGwPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtToVpnGwPol", "cobra.model.cloud.RouterP")

    meta.moClassName = "cloudRtToVpnGwPol"
    meta.rnFormat = "rttoVpnGwPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51211, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51210, PropCategory.REGULAR)
