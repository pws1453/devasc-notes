...
# ##################################################
class IngressBytesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesHist1d", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesHist1d"
    meta.rnFormat = "HDcloudIngressBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress bytess stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50673, PropCategory.REGULAR)
