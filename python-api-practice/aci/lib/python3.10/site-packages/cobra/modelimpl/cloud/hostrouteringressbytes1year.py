...
# ##################################################
class HostRouterIngressBytes1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytes1year", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytes1year"
    meta.rnFormat = "CDcloudHostRouterIngressBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router cloud ingress bytess stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytes1year', False),
    ]
