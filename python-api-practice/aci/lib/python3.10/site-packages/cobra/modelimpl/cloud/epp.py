...
class EpP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.EpP")

    meta.moClassName = "cloudEpP"
    meta.rnFormat = "cld-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud EPg Resolved"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x2000610021020783
    ...
    meta.childClasses.add("cobra.model.cloud.ExtEPSelectorDef")
    ...
    meta.childClasses.add("cobra.model.cloud.RtSecurityGroup")
    ...
    meta.childClasses.add("cobra.model.cloud.Bookeeping")
    ...
    meta.childClasses.add("cobra.model.cloud.EPSelectorDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtSecurityGroup", "rthcloudSecurityGroup-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.ExtEPSelectorDef", "extepselectordef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.EPSelectorDef", "epselectordef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.Bookeeping", "bookeep"))
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 50654, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51480, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "routeReachability", "routeReachability", 50149, PropCategory.REGULAR)
