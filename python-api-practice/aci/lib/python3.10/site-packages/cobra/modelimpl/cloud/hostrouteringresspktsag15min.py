...
# ##################################################
class HostRouterIngressPktsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg15min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg15min"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterIngressPktsAg")

    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg15min', False),
    ]
