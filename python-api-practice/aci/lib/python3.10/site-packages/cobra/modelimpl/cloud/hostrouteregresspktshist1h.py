...
# ##################################################
class HostRouterEgressPktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist1h", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist1h"
    meta.rnFormat = "HDcloudHostRouterEgressPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54216, PropCategory.REGULAR)
