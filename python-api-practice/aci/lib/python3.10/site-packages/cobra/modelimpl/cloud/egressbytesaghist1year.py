...
# ##################################################
class EgressBytesAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAgHist1year", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAgHist1year"
    meta.rnFormat = "HDcloudEgressBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudEgressBytesAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50628, PropCategory.REGULAR)
