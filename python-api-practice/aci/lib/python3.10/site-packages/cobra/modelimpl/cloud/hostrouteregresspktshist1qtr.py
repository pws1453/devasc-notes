...
# ##################################################
class HostRouterEgressPktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist1qtr", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist1qtr"
    meta.rnFormat = "HDcloudHostRouterEgressPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54218, PropCategory.REGULAR)
