...
# ##################################################
class IngressBytes15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytes15min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes15min"
    meta.rnFormat = "CDcloudIngressBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.IngressBytes")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDcloudIngressBytes15min', False),
    ]
