...
# ##################################################
class AppGwStatsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg1year", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg1year"
    meta.rnFormat = "CDcloudAppGwStatsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudAppGwStatsAg1year', False),
    ]
