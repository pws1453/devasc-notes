...
# ##################################################
class LBStatsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist1qtr", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist1qtr"
    meta.rnFormat = "HDcloudLBStatsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 52401, PropCategory.REGULAR)
