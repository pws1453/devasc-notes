...
# ##################################################
class IngressPktsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAgHist1h", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAgHist1h"
    meta.rnFormat = "HDcloudIngressPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50682, PropCategory.REGULAR)
