...
# ##################################################
class HostRouterEgressPktsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg1year", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg1year"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg1year', False),
    ]
