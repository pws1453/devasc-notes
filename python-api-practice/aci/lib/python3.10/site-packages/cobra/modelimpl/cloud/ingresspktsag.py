...
# ##################################################
class IngressPktsAg(Mo):
    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAg", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAg"


    meta.moClassName = "cloudIngressPktsAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg15min")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg1h")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg1d")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg1year")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg1w")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPktsAg5min")
