...
# ##################################################
class RsCloudCtxProfileDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsCloudCtxProfileDef", "cobra.model.cloud.CtxProfileDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "cloudRsCloudCtxProfileDef"
    meta.rnFormat = "rscloudCtxProfileDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EpP deployed in a CloudCtxProfileDef"
    ...
    meta.parentClasses.add("cobra.model.cloud.Bookeeping")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rscloudCtxProfileDef-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51554, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51555, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51241, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51240, PropCategory.REGULAR)
