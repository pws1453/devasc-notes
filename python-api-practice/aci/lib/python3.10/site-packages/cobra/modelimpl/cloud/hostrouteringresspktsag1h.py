...
# ##################################################
class HostRouterIngressPktsAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg1h", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg1h"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg1h', False),
    ]
