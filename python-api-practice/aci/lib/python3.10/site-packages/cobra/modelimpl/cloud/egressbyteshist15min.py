...
# ##################################################
class EgressBytesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist15min", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist15min"
    meta.rnFormat = "HDcloudEgressBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.EgressBytesHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDcloudEgressBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50630, PropCategory.REGULAR)
