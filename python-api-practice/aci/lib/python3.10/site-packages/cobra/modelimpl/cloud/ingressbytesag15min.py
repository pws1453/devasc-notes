...
# ##################################################
class IngressBytesAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAg15min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAg15min"
    meta.rnFormat = "CDcloudIngressBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress bytess stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.IngressBytesAg")

    meta.rnPrefixes = [
        ('CDcloudIngressBytesAg15min', False),
    ]
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 51085, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 51086, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 51091, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 51087, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 51088, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 51090, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 51089, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 51119, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 51120, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 51125, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 51121, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 51122, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 51124, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress unicast bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 51123, PropCategory.IMPLICIT_TREND_BASE)
