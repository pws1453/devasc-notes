...
# ##################################################
class IngressPktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist1h", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist1h"
    meta.rnFormat = "HDcloudIngressPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50690, PropCategory.REGULAR)
