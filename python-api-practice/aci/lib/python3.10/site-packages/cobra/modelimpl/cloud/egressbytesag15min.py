...
# ##################################################
class EgressBytesAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAg15min", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAg15min"
    meta.rnFormat = "CDcloudEgressBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.EgressBytesAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDcloudEgressBytesAg15min', False),
    ]
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 50949, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 50950, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 50955, PropCategory.IMPLICIT_RATE)
    prop.label = "egress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 50951, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 50952, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 50954, PropCategory.IMPLICIT_TREND)
    prop.label = "egress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 50953, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 50983, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 50984, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 50989, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 50985, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 50986, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 50988, PropCategory.IMPLICIT_TREND)
    prop.label = "egress unicast bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 50987, PropCategory.IMPLICIT_TREND_BASE)
