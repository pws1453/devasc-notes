...
# ##################################################
class EgressBytesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist1qtr", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist1qtr"
    meta.rnFormat = "HDcloudEgressBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 50634, PropCategory.REGULAR)
