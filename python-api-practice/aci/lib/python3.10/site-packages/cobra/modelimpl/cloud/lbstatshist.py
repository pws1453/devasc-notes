...
# ##################################################
class LBStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist"


    meta.moClassName = "cloudLBStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsHist5min")
