...
# ##################################################
class AppGwStatsAg(Mo):
    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg"


    meta.moClassName = "cloudAppGwStatsAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg1year")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg1d")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg1h")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg5min")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg15min")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAg1w")
