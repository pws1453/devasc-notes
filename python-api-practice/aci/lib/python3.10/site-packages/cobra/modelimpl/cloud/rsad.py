...
class RsAD(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.cloud.RsAD", "cobra.model.cloud.AD")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsAD"
    meta.rnFormat = "rsAD"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachment to billing account"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55114, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55115, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55104, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55057, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16116
    prop.defaultValueStr = "cloudAD"
    prop._addConstant("cloudAD", None, 16116)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55056, PropCategory.REGULAR)
