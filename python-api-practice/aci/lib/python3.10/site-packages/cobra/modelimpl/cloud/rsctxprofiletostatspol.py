...
# ##################################################
class RsCtxProfileToStatsPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsCtxProfileToStatsPol", "cobra.model.cloud.AzureStatsPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsCtxProfileToStatsPol"
    meta.rnFormat = "rsctxProfileToStatsPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachment to Stats pol"
    ...
    meta.rnPrefixes = [
        ('rsctxProfileToStatsPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55668, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55663, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16349
    prop.defaultValueStr = "cloudAzureStatsPol"
    prop._addConstant("cloudAzureStatsPol", None, 16349)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55662, PropCategory.REGULAR)
