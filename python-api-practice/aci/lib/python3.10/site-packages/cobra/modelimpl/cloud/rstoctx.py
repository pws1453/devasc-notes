...
class RsToCtx(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.cloud.RsToCtx", "cobra.model.fv.Ctx")
    meta.targetNameProps["name"] = "tnFvCtxName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsToCtx"
    meta.rnFormat = "rstoCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachment to fvCtx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51538, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51539, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51473, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51229, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvCtxName", "tnFvCtxName", 51228, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
