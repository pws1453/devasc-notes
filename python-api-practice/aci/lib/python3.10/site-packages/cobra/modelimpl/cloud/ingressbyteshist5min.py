...
# ##################################################
class IngressBytesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesHist5min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesHist5min"
    meta.rnFormat = "HDcloudIngressBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress bytess stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 50679, PropCategory.REGULAR)
