...
# ##################################################
class HostRouterEgressPktsAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg1qtr", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg1qtr"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg1qtr', False),
    ]
