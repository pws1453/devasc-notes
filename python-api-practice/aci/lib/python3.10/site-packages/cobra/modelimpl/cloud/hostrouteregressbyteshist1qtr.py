...
# ##################################################
class HostRouterEgressBytesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist1qtr", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist1qtr"
    meta.rnFormat = "HDcloudHostRouterEgressBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54202, PropCategory.REGULAR)
