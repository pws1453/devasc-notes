...
# ##################################################
class LBStats5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStats5min", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStats5min"
    meta.rnFormat = "CDcloudLBStats5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB front end stats stats in 5 minute"
