...
# ##################################################
class PoolHealthStatsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg1year", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg1year"
    meta.rnFormat = "CDcloudPoolHealthStatsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg1year', False),
    ]
