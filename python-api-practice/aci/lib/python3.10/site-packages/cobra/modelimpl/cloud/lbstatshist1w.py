...
# ##################################################
class LBStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist1w", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist1w"
    meta.rnFormat = "HDcloudLBStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 52410, PropCategory.REGULAR)
