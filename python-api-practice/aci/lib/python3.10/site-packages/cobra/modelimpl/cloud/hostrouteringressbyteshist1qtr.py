...
# ##################################################
class HostRouterIngressBytesHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist1qtr", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist1qtr"
    meta.rnFormat = "HDcloudHostRouterIngressBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54234, PropCategory.REGULAR)
