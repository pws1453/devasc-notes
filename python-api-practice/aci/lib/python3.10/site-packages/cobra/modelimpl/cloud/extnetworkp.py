...
# ##################################################
class ExtNetworkP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.ExtNetworkP")

    meta.moClassName = "cloudExtNetworkP"
    meta.rnFormat = "extnetworkp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Network Policy"
    ...
    meta.childClasses.add("cobra.model.cloud.OspfAreaP")
    meta.childClasses.add("cobra.model.cloud.VpnIfP")
    meta.childClasses.add("cobra.model.cloud.HostIfP")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.cloud.LoopbackIfP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.OspfAreaP", "ospfareap-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.HostIfP", "hostifp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.VpnIfP", "vpnifp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LoopbackIfP", "lbifp-"))
    ...
    meta.superClasses.add("cobra.model.cloud.AExtNetworkP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 51504, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51505, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51466, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 50658, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
