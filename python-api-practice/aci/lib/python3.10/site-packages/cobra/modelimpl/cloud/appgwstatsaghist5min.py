...
# ##################################################
class AppGwStatsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist5min", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist5min"
    meta.rnFormat = "HDcloudAppGwStatsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 55359, PropCategory.REGULAR)
