...
# ##################################################
class HostRouterIngressPktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist1h", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist1h"
    meta.rnFormat = "HDcloudHostRouterIngressPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54248, PropCategory.REGULAR)
