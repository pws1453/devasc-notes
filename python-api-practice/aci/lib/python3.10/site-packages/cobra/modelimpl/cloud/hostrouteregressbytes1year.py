...
# ##################################################
class HostRouterEgressBytes1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes1year", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes1year"
    meta.rnFormat = "CDcloudHostRouterEgressBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes1year', False),
    ]
