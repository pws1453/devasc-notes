...
# ##################################################
class HostRouterEgressPktsAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg1h", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg1h"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg1h', False),
    ]
