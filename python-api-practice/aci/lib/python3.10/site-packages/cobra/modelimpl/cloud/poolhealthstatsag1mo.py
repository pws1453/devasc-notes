...
# ##################################################
class PoolHealthStatsAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg1mo", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg1mo"
    meta.rnFormat = "CDcloudPoolHealthStatsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg1mo', False),
    ]
