...
# ##################################################
class EgressPktsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist1h", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist1h"
    meta.rnFormat = "HDcloudEgressPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50648, PropCategory.REGULAR)
