...
# ##################################################
class HostRouterEgressPkts1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts1h", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts1h"
    meta.rnFormat = "CDcloudHostRouterEgressPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPkts1h', False),
    ]
