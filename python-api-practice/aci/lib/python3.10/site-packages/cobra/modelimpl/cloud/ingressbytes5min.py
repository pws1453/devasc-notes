...
# ##################################################
class IngressBytes5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytes5min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes5min"
    meta.rnFormat = "CDcloudIngressBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats in 5 minute"
