...
# ##################################################
class HostRouterIngressPktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist5min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist5min"
    meta.rnFormat = "HDcloudHostRouterIngressPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54253, PropCategory.REGULAR)
