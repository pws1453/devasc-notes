...
# ##################################################
class HostRouterIngressPkts15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts15min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts15min"
    meta.rnFormat = "CDcloudHostRouterIngressPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterIngressPkts")

    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts15min', False),
    ]
