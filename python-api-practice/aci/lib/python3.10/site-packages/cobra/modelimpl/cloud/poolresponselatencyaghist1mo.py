...
# ##################################################
class PoolResponseLatencyAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist1mo", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist1mo"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52435, PropCategory.REGULAR)
