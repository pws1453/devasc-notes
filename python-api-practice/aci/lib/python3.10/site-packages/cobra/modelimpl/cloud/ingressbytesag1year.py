...
# ##################################################
class IngressBytesAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAg1year", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAg1year"
    meta.rnFormat = "CDcloudIngressBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress bytess stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudIngressBytesAg1year', False),
    ]
