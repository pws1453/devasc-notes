...
# ##################################################
class IngressPktsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAgHist1w", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAgHist1w"
    meta.rnFormat = "HDcloudIngressPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50685, PropCategory.REGULAR)
