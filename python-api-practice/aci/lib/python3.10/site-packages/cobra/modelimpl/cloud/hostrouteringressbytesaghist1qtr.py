...
# ##################################################
class HostRouterIngressBytesAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist1qtr", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist1qtr"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54226, PropCategory.REGULAR)
