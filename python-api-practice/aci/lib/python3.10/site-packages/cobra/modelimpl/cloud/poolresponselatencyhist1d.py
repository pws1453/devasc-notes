...
# ##################################################
class PoolResponseLatencyHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist1d", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist1d"
    meta.rnFormat = "HDcloudPoolResponseLatency1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52441, PropCategory.REGULAR)
