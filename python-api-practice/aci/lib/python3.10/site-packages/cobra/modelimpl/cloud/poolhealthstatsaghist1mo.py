...
# ##################################################
class PoolHealthStatsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist1mo", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist1mo"
    meta.rnFormat = "HDcloudPoolHealthStatsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52418, PropCategory.REGULAR)
