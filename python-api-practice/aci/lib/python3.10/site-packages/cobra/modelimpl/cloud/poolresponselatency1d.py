...
# ##################################################
class PoolResponseLatency1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency1d", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency1d"
    meta.rnFormat = "CDcloudPoolResponseLatency1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatency1d', False),
    ]
