...
class ISvcEPg(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.ISvcEPg")

    meta.moClassName = "cloudISvcEPg"
    meta.rnFormat = "lif-%(lifDn)s-ctx-[%(ctxDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "cloud implicit service EPg"
    ...
    meta.childClasses.add("cobra.model.cloud.RtCloudSvcEPgDefToSvcEPg")
    ...
    meta.childClasses.add("cobra.model.cloud.RsISvcEPgCtx")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtCloudSvcEPgDefToSvcEPg", "rtvnsCloudSvcEPgDefToSvcEPg-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsISvcEPgCtx", "rsISvcEPgCtx"))
    ...
    meta.superClasses.add("cobra.model.cloud.ASvcEPg")
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 51807, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "lifDn", "lifDn", 51808, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rsToCtxDn", "rsToCtxDn", 51806, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("rsToCtxDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "lifDn"))
    ...
    def __init__(self, parentMoOrDn, lifDn, ctxDn, markDirty=True, **creationProps):
        namingVals = [lifDn, ctxDn]
