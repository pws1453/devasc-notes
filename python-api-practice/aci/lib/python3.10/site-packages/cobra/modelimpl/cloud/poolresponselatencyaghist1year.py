...
# ##################################################
class PoolResponseLatencyAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist1year", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist1year"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52438, PropCategory.REGULAR)
