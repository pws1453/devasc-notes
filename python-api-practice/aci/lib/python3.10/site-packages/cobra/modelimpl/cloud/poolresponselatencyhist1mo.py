...
# ##################################################
class PoolResponseLatencyHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist1mo", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist1mo"
    meta.rnFormat = "HDcloudPoolResponseLatency1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52443, PropCategory.REGULAR)
