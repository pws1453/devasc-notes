...
# ##################################################
class EgressPkts15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPkts15min", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPkts15min"
    meta.rnFormat = "CDcloudEgressPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.EgressPkts")

    meta.rnPrefixes = [
        ('CDcloudEgressPkts15min', False),
    ]
