...
# ##################################################
class EgressPktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist1year", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist1year"
    meta.rnFormat = "HDcloudEgressPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 50652, PropCategory.REGULAR)
