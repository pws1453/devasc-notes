...
# ##################################################
class HostRouterIngressBytes1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytes1qtr", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytes1qtr"
    meta.rnFormat = "CDcloudHostRouterIngressBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router cloud ingress bytess stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytes1qtr', False),
    ]
