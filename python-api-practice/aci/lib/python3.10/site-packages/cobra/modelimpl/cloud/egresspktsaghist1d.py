...
# ##################################################
class EgressPktsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist1d", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist1d"
    meta.rnFormat = "HDcloudEgressPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50639, PropCategory.REGULAR)
