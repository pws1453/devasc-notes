...
# ##################################################
class HostRouterEgressPkts1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts1year", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts1year"
    meta.rnFormat = "CDcloudHostRouterEgressPkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPkts1year', False),
    ]
