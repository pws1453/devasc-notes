...
# ##################################################
class PoolHealthStatsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg5min", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg5min"
    meta.rnFormat = "CDcloudPoolHealthStatsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg5min', False),
    ]
