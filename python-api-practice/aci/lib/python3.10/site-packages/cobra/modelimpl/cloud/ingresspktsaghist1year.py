...
# ##################################################
class IngressPktsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAgHist1year", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAgHist1year"
    meta.rnFormat = "HDcloudIngressPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudIngressPktsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50686, PropCategory.REGULAR)
