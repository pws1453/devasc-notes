...
# ##################################################
class PoolHealthStatsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg15min", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg15min"
    meta.rnFormat = "CDcloudPoolHealthStatsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.PoolHealthStatsAg")

    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg15min', False),
    ]
