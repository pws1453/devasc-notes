...
# ##################################################
class HostRouterEgressPktsAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg1d", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg1d"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg1d', False),
    ]
