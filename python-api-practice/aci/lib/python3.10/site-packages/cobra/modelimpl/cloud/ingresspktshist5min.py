...
# ##################################################
class IngressPktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist5min", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist5min"
    meta.rnFormat = "HDcloudIngressPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 50695, PropCategory.REGULAR)
