...
# ##################################################
class HostRouterIngressBytesAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAg1qtr", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAg1qtr"
    meta.rnFormat = "CDcloudHostRouterIngressBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router cloud ingress bytess stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytesAg1qtr', False),
    ]
