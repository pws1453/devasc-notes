...
# ##################################################
class HostRouterEgressBytesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist15min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist15min"
    meta.rnFormat = "HDcloudHostRouterEgressBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterEgressBytesHist")

    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54198, PropCategory.REGULAR)
