...
# ##################################################
class PoolHealthStatsAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg1w", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg1w"
    meta.rnFormat = "CDcloudPoolHealthStatsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg1w', False),
    ]
