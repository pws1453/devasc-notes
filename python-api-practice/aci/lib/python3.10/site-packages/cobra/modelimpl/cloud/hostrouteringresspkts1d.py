...
# ##################################################
class HostRouterIngressPkts1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts1d", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts1d"
    meta.rnFormat = "CDcloudHostRouterIngressPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts1d', False),
    ]
