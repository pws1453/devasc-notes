...
# ##################################################
class IngressBytesAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAg1d", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAg1d"
    meta.rnFormat = "CDcloudIngressBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress bytess stats in 1 day"
