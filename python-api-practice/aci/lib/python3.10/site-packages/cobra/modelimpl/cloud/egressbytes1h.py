...
# ##################################################
class EgressBytes1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytes1h", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes1h"
    meta.rnFormat = "CDcloudEgressBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats in 1 hour"
