...
# ##################################################
class IngressPktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist1d", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist1d"
    meta.rnFormat = "HDcloudIngressPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50689, PropCategory.REGULAR)
