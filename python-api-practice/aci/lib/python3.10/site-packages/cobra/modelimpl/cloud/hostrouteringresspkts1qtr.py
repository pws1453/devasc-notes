...
# ##################################################
class HostRouterIngressPkts1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts1qtr", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts1qtr"
    meta.rnFormat = "CDcloudHostRouterIngressPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts1qtr', False),
    ]
