...
# ##################################################
class HostRouterIngressPktsAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg1mo", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg1mo"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg1mo', False),
    ]
