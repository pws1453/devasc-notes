...
# ##################################################
class IngressBytesAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist15min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist15min"
    meta.rnFormat = "HDcloudIngressBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.IngressBytesAgHist")

    meta.rnPrefixes = [
        ('HDcloudIngressBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 51092, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 51093, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 51097, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 51094, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 51095, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 51096, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "index", "index", 50664, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 51126, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 51127, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 51131, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 51128, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 51129, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 51130, PropCategory.IMPLICIT_TREND)
