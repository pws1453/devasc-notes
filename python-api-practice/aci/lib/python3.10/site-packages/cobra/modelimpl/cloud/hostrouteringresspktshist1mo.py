...
# ##################################################
class HostRouterIngressPktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist1mo", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist1mo"
    meta.rnFormat = "HDcloudHostRouterIngressPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54249, PropCategory.REGULAR)
