...
# ##################################################
class IpSecTunnelIfP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.IpSecTunnelIfP")

    meta.moClassName = "cloudIpSecTunnelIfP"
    meta.rnFormat = "ipsectunnelifp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IPSec specific L3TunnelIfP"
    ...
    meta.childClasses.add("cobra.model.cloud.RsIsakmpPhase1Pol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.cloud.RsIsakmpPhase2Pol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsIsakmpPhase1Pol", "rsisakmpPhase1Pol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsIsakmpPhase2Pol", "rsisakmpPhase2Pol-"))
    ...
    meta.superClasses.add("cobra.model.cloud.AIpSecTunnelIfP")

    meta.rnPrefixes = [
        ('ipsectunnelifp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51526, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51527, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51469, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 50698, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "preSharedKey", "preSharedKey", 50135, PropCategory.REGULAR)
    prop.label = "Pre Shared Key"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
