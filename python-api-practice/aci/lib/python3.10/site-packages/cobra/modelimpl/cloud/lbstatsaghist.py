...
# ##################################################
class LBStatsAgHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist"


    meta.moClassName = "cloudLBStatsAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist5min")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist15min")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist1d")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist1h")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist1year")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAgHist1qtr")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountCum", "HTTPCode_ELB_5XX_CountCum", 52485, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Native LB HTPP 5XX error count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountCum", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountPer", "HTTPCode_ELB_5XX_CountPer", 52486, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Native LB HTPP 5XX error count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountPer", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountRate", "HTTPCode_ELB_5XX_CountRate", 52490, PropCategory.IMPLICIT_RATE)
    prop.label = "Native LB HTPP 5XX error count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountRate", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountSpct", "HTTPCode_ELB_5XX_CountSpct", 52487, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Native LB HTPP 5XX error count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountSpct", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountThr", "HTTPCode_ELB_5XX_CountThr", 52488, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountTr", "HTTPCode_ELB_5XX_CountTr", 52489, PropCategory.IMPLICIT_TREND)
    prop.label = "Native LB HTPP 5XX error count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountTr", prop)

    prop = PropMeta("str", "RejectedConnectionCountCum", "RejectedConnectionCountCum", 52519, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Nantive LB rejected requests count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountCum", prop)

    prop = PropMeta("str", "RejectedConnectionCountPer", "RejectedConnectionCountPer", 52520, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Nantive LB rejected requests count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountPer", prop)

    prop = PropMeta("str", "RejectedConnectionCountRate", "RejectedConnectionCountRate", 52524, PropCategory.IMPLICIT_RATE)
    prop.label = "Nantive LB rejected requests count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountRate", prop)

    prop = PropMeta("str", "RejectedConnectionCountSpct", "RejectedConnectionCountSpct", 52521, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Nantive LB rejected requests count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountSpct", prop)

    prop = PropMeta("str", "RejectedConnectionCountThr", "RejectedConnectionCountThr", 52522, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "RejectedConnectionCountTr", "RejectedConnectionCountTr", 52523, PropCategory.IMPLICIT_TREND)
    prop.label = "Nantive LB rejected requests count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountTr", prop)

    prop = PropMeta("str", "RequestCountCum", "RequestCountCum", 52553, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Native LB requests count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountCum", prop)

    prop = PropMeta("str", "RequestCountPer", "RequestCountPer", 52554, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Native LB requests count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountPer", prop)

    prop = PropMeta("str", "RequestCountRate", "RequestCountRate", 52558, PropCategory.IMPLICIT_RATE)
    prop.label = "Native LB requests count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountRate", prop)

    prop = PropMeta("str", "RequestCountSpct", "RequestCountSpct", 52555, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Native LB requests count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountSpct", prop)

    prop = PropMeta("str", "RequestCountThr", "RequestCountThr", 52556, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "RequestCountTr", "RequestCountTr", 52557, PropCategory.IMPLICIT_TREND)
    prop.label = "Native LB requests count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountTr", prop)

    prop = PropMeta("str", "RuleEvaluationsCum", "RuleEvaluationsCum", 52954, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Native LB rules evaluated cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsCum", prop)

    prop = PropMeta("str", "RuleEvaluationsPer", "RuleEvaluationsPer", 52955, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Native LB rules evaluated periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsPer", prop)

    prop = PropMeta("str", "RuleEvaluationsRate", "RuleEvaluationsRate", 52959, PropCategory.IMPLICIT_RATE)
    prop.label = "Native LB rules evaluated rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsRate", prop)

    prop = PropMeta("str", "RuleEvaluationsSpct", "RuleEvaluationsSpct", 52956, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Native LB rules evaluated suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsSpct", prop)

    prop = PropMeta("str", "RuleEvaluationsThr", "RuleEvaluationsThr", 52957, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "RuleEvaluationsTr", "RuleEvaluationsTr", 52958, PropCategory.IMPLICIT_TREND)
