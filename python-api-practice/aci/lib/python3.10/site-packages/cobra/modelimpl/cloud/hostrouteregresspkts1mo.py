...
# ##################################################
class HostRouterEgressPkts1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts1mo", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts1mo"
    meta.rnFormat = "CDcloudHostRouterEgressPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPkts1mo', False),
    ]
