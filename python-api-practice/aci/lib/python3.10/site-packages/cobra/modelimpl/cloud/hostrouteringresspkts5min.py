...
# ##################################################
class HostRouterIngressPkts5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts5min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts5min"
    meta.rnFormat = "CDcloudHostRouterIngressPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts5min', False),
    ]
