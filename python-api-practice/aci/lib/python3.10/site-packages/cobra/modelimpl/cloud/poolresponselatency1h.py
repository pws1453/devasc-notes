...
# ##################################################
class PoolResponseLatency1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency1h", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency1h"
    meta.rnFormat = "CDcloudPoolResponseLatency1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatency1h', False),
    ]
