...
# ##################################################
class EgressBytesAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAg1year", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAg1year"
    meta.rnFormat = "CDcloudEgressBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudEgressBytesAg1year', False),
    ]
