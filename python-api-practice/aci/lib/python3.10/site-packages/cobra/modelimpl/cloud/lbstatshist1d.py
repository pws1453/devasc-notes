...
# ##################################################
class LBStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist1d", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist1d"
    meta.rnFormat = "HDcloudLBStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 52406, PropCategory.REGULAR)
