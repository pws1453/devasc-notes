...
# ##################################################
class PoolHealthStats1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats1qtr", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats1qtr"
    meta.rnFormat = "CDcloudPoolHealthStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats1qtr', False),
    ]
