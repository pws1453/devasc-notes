...
class Account(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.Account")

    meta.moClassName = "cloudAccount"
    meta.rnFormat = "act-[%(id)s]-vendor-%(vendor)s"
    ...
    meta.childClasses.add("cobra.model.cloud.RtCloudAccount")
    meta.childClasses.add("cobra.model.cloud.RsCredentials")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtCloudAccount", "rtfvCloudAccount-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsCredentials", "rscredentials"))
    ...
    prop = PropMeta("str", "accessType", "accessType", 54914, PropCategory.REGULAR)
    prop.label = "Account acccess type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "managed"
    prop._addConstant("credentials", "credentials", 1)
    prop._addConstant("managed", "managed", 0)
    meta.props.add("accessType", prop)

    prop = PropMeta("str", "annotation", "annotation", 55108, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55109, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 54913, PropCategory.REGULAR)
    prop.label = "Account id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vendor", "vendor", 54912, PropCategory.REGULAR)
    prop.label = "Account vendor"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    def __init__(self, parentMoOrDn, id, vendor, markDirty=True, **creationProps):
        namingVals = [id, vendor]
