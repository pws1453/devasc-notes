...
# ##################################################
class PoolResponseLatencyAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist1w", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist1w"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52437, PropCategory.REGULAR)
