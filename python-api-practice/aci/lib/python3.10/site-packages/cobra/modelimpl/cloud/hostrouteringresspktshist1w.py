...
# ##################################################
class HostRouterIngressPktsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist1w", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist1w"
    meta.rnFormat = "HDcloudHostRouterIngressPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54251, PropCategory.REGULAR)
