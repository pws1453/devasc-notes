...
class ExtEPg(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.ExtEPg")

    meta.moClassName = "cloudExtEPg"
    meta.rnFormat = "cloudextepg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "cloud External EPg"
    ...
    meta.childClasses.add("cobra.model.cloud.ExtEPSelector")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.ExtEPSelector", "extepselector-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51576, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51577, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51486, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 50657, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "routeReachability", "routeReachability", 50167, PropCategory.REGULAR)
