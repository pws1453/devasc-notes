...
# ##################################################
class LBStatsAg(Mo):
    meta = StatsClassMeta("cobra.model.cloud.LBStatsAg", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAg"


    meta.moClassName = "cloudLBStatsAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB front end stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg15min")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg1w")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg1year")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg1h")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg1d")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg5min")
    meta.concreteSubClasses.add("cobra.model.cloud.LBStatsAg1mo")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountCum", "HTTPCode_ELB_5XX_CountCum", 52478, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Native LB HTPP 5XX error count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountCum", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountPer", "HTTPCode_ELB_5XX_CountPer", 52479, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Native LB HTPP 5XX error count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountPer", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountRate", "HTTPCode_ELB_5XX_CountRate", 52484, PropCategory.IMPLICIT_RATE)
    prop.label = "Native LB HTPP 5XX error count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountRate", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountSpct", "HTTPCode_ELB_5XX_CountSpct", 52480, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Native LB HTPP 5XX error count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountSpct", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountThr", "HTTPCode_ELB_5XX_CountThr", 52481, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountTr", "HTTPCode_ELB_5XX_CountTr", 52483, PropCategory.IMPLICIT_TREND)
    prop.label = "Native LB HTPP 5XX error count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountTr", prop)

    prop = PropMeta("str", "HTTPCode_ELB_5XX_CountTrBase", "HTTPCode_ELB_5XX_CountTrBase", 52482, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Native LB HTPP 5XX error count trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HTTPCode_ELB_5XX_CountTrBase", prop)

    prop = PropMeta("str", "RejectedConnectionCountCum", "RejectedConnectionCountCum", 52512, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Nantive LB rejected requests count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountCum", prop)

    prop = PropMeta("str", "RejectedConnectionCountPer", "RejectedConnectionCountPer", 52513, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Nantive LB rejected requests count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountPer", prop)

    prop = PropMeta("str", "RejectedConnectionCountRate", "RejectedConnectionCountRate", 52518, PropCategory.IMPLICIT_RATE)
    prop.label = "Nantive LB rejected requests count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountRate", prop)

    prop = PropMeta("str", "RejectedConnectionCountSpct", "RejectedConnectionCountSpct", 52514, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Nantive LB rejected requests count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountSpct", prop)

    prop = PropMeta("str", "RejectedConnectionCountThr", "RejectedConnectionCountThr", 52515, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "RejectedConnectionCountTr", "RejectedConnectionCountTr", 52517, PropCategory.IMPLICIT_TREND)
    prop.label = "Nantive LB rejected requests count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountTr", prop)

    prop = PropMeta("str", "RejectedConnectionCountTrBase", "RejectedConnectionCountTrBase", 52516, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Nantive LB rejected requests count trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RejectedConnectionCountTrBase", prop)

    prop = PropMeta("str", "RequestCountCum", "RequestCountCum", 52546, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Native LB requests count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountCum", prop)

    prop = PropMeta("str", "RequestCountPer", "RequestCountPer", 52547, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Native LB requests count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountPer", prop)

    prop = PropMeta("str", "RequestCountRate", "RequestCountRate", 52552, PropCategory.IMPLICIT_RATE)
    prop.label = "Native LB requests count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountRate", prop)

    prop = PropMeta("str", "RequestCountSpct", "RequestCountSpct", 52548, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Native LB requests count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountSpct", prop)

    prop = PropMeta("str", "RequestCountThr", "RequestCountThr", 52549, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "RequestCountTr", "RequestCountTr", 52551, PropCategory.IMPLICIT_TREND)
    prop.label = "Native LB requests count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountTr", prop)

    prop = PropMeta("str", "RequestCountTrBase", "RequestCountTrBase", 52550, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Native LB requests count trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RequestCountTrBase", prop)

    prop = PropMeta("str", "RuleEvaluationsCum", "RuleEvaluationsCum", 52947, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Native LB rules evaluated cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsCum", prop)

    prop = PropMeta("str", "RuleEvaluationsPer", "RuleEvaluationsPer", 52948, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Native LB rules evaluated periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsPer", prop)

    prop = PropMeta("str", "RuleEvaluationsRate", "RuleEvaluationsRate", 52953, PropCategory.IMPLICIT_RATE)
    prop.label = "Native LB rules evaluated rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsRate", prop)

    prop = PropMeta("str", "RuleEvaluationsSpct", "RuleEvaluationsSpct", 52949, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Native LB rules evaluated suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsSpct", prop)

    prop = PropMeta("str", "RuleEvaluationsThr", "RuleEvaluationsThr", 52950, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "RuleEvaluationsTr", "RuleEvaluationsTr", 52952, PropCategory.IMPLICIT_TREND)
    prop.label = "Native LB rules evaluated trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("RuleEvaluationsTr", prop)

    prop = PropMeta("str", "RuleEvaluationsTrBase", "RuleEvaluationsTrBase", 52951, PropCategory.IMPLICIT_TREND_BASE)
