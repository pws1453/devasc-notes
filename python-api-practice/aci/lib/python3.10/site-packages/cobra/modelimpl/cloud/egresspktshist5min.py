...
# ##################################################
class EgressPktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist5min", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist5min"
    meta.rnFormat = "HDcloudEgressPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 50653, PropCategory.REGULAR)
