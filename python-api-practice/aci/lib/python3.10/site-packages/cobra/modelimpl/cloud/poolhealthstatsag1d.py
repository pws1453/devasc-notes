...
# ##################################################
class PoolHealthStatsAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg1d", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg1d"
    meta.rnFormat = "CDcloudPoolHealthStatsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg1d', False),
    ]
