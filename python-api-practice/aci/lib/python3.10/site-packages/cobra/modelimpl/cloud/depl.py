...
class Depl(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.Depl")

    meta.moClassName = "cloudDepl"
    meta.rnFormat = "cldDepl"
    meta.category = MoCategory.REGULAR
    meta.label = "Indicates which CPE will deploy this tenant cloudEPg"
    ...
    meta.childClasses.add("cobra.model.cloud.DeplBy")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.DeplBy", "by-"))
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 50151, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    ...
    prop = PropMeta("str", "podId", "podId", 50150, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
