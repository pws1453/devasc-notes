...
# ##################################################
class PoolHealthStats1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats1year", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats1year"
    meta.rnFormat = "CDcloudPoolHealthStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats1year', False),
    ]
