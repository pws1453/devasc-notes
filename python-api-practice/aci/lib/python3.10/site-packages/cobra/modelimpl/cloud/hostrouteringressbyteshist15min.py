...
# ##################################################
class HostRouterIngressBytesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist15min", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist15min"
    meta.rnFormat = "HDcloudHostRouterIngressBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterIngressBytesHist")

    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54230, PropCategory.REGULAR)
