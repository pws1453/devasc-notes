...
# ##################################################
class HostRouterIngressBytes1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytes1d", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytes1d"
    meta.rnFormat = "CDcloudHostRouterIngressBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router cloud ingress bytess stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytes1d', False),
    ]
