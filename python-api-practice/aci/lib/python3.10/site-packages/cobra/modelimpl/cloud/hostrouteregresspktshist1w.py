...
# ##################################################
class HostRouterEgressPktsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist1w", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist1w"
    meta.rnFormat = "HDcloudHostRouterEgressPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54219, PropCategory.REGULAR)
