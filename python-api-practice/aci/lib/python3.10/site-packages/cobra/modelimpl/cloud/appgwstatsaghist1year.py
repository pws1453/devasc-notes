...
# ##################################################
class AppGwStatsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist1year", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist1year"
    meta.rnFormat = "HDcloudAppGwStatsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 55358, PropCategory.REGULAR)
