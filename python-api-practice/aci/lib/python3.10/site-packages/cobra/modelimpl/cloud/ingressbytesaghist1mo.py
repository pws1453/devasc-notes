...
# ##################################################
class IngressBytesAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist1mo", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist1mo"
    meta.rnFormat = "HDcloudIngressBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50667, PropCategory.REGULAR)
