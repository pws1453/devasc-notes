...
# ##################################################
class LBStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist15min", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist15min"
    meta.rnFormat = "HDcloudLBStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 52405, PropCategory.REGULAR)
