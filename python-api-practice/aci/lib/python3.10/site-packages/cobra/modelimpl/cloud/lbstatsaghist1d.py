...
# ##################################################
class LBStatsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist1d", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist1d"
    meta.rnFormat = "HDcloudLBStatsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 52398, PropCategory.REGULAR)
