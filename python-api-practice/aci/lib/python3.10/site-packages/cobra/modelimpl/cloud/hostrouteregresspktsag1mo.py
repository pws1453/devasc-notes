...
# ##################################################
class HostRouterEgressPktsAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg1mo", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg1mo"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg1mo', False),
    ]
