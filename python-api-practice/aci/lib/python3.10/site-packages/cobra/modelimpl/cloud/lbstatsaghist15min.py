...
# ##################################################
class LBStatsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist15min", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist15min"
    meta.rnFormat = "HDcloudLBStatsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.LBStatsAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcloudLBStatsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52397, PropCategory.REGULAR)
