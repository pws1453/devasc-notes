...
# ##################################################
class HostRouterEgressBytesAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg15min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg15min"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterEgressBytesAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg15min', False),
    ]
