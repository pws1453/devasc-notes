...
# ##################################################
class EgressPktsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist1w", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist1w"
    meta.rnFormat = "HDcloudEgressPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50643, PropCategory.REGULAR)
