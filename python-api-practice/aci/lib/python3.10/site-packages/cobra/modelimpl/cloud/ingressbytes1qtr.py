...
# ##################################################
class IngressBytes1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytes1qtr", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes1qtr"
    meta.rnFormat = "CDcloudIngressBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats in 1 quarter"
