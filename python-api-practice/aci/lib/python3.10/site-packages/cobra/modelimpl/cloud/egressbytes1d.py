...
# ##################################################
class EgressBytes1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytes1d", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes1d"
    meta.rnFormat = "CDcloudEgressBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats in 1 day"
