...
# ##################################################
class HostRouterEgressBytesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist1d", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist1d"
    meta.rnFormat = "HDcloudHostRouterEgressBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54199, PropCategory.REGULAR)
