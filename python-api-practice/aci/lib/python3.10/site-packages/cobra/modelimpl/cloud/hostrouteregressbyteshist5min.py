...
# ##################################################
class HostRouterEgressBytesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist5min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist5min"
    meta.rnFormat = "HDcloudHostRouterEgressBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54205, PropCategory.REGULAR)
