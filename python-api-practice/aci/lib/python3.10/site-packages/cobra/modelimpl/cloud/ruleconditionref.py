...
# ##################################################
class RuleConditionRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.RuleConditionRef")

    meta.moClassName = "cloudRuleConditionRef"
    meta.rnFormat = "conditionref-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Load Balancer Listener Rule Condition Reference"
    ...
    prop = PropMeta("str", "type", "type", 52449, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
