...
# ##################################################
class IngressBytesAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist1h", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist1h"
    meta.rnFormat = "HDcloudIngressBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50666, PropCategory.REGULAR)
