...
class Counter(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.Counter")

    meta.moClassName = "cloudCounter"
    meta.rnFormat = "counter"
    meta.category = MoCategory.REGULAR
    meta.label = "Global Counter"
    ...
    prop = PropMeta("str", "nextId", "nextId", 52358, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("nextId", prop)
