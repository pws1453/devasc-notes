...
# ##################################################
class PoolResponseLatencyHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist5min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist5min"
    meta.rnFormat = "HDcloudPoolResponseLatency5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52447, PropCategory.REGULAR)
