...
# ##################################################
class PoolResponseLatencyHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist1year", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist1year"
    meta.rnFormat = "HDcloudPoolResponseLatency1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52446, PropCategory.REGULAR)
