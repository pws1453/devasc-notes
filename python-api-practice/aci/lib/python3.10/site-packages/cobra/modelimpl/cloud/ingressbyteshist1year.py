...
# ##################################################
class IngressBytesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesHist1year", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesHist1year"
    meta.rnFormat = "HDcloudIngressBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress bytess stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 50678, PropCategory.REGULAR)
