...
# ##################################################
class IngressBytes(Mo):
    meta = StatsClassMeta("cobra.model.cloud.IngressBytes", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes"


    meta.moClassName = "cloudIngressBytes"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes1year")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes1w")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes15min")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes1h")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes5min")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes1d")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressBytes1qtr")
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 51070, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress drop bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropBase", "dropBase", 51065, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress drop bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBase", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 51066, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropLast", "dropLast", 51064, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress drop bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropLast", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 51069, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress drop bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 51068, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress drop bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 51067, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 51075, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 51071, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 51072, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 51074, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 51073, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 51104, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress unicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastBase", "unicastBase", 51099, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress unicast bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastBase", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 51100, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastLast", "unicastLast", 51098, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress unicast bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastLast", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 51103, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress unicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 51102, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress unicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 51101, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 51109, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 51105, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 51106, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 51108, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress unicast bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 51107, PropCategory.IMPLICIT_TREND_BASE)
