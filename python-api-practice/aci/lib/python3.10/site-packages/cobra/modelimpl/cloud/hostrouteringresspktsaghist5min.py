...
# ##################################################
class HostRouterIngressPktsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist5min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist5min"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54245, PropCategory.REGULAR)
