...
# ##################################################
class ALDev(Mo):
    meta = ClassMeta("cobra.model.cloud.ALDev")

    meta.isAbstract = True
    meta.moClassName = "cloudALDev"


    meta.moClassName = "cloudALDev"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud L4-L7 Abstract Devices"
    ...
    prop = PropMeta("str", "name", "name", 51794, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
