...
class LBStats1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.cloud.LBStats1h", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStats1h"
    meta.rnFormat = "CDcloudLBStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB front end stats stats in 1 hour"
