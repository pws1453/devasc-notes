...
# ##################################################
class EgressBytes1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytes1qtr", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes1qtr"
    meta.rnFormat = "CDcloudEgressBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats in 1 quarter"
