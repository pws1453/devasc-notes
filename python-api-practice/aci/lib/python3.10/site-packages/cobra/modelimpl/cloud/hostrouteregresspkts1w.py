...
# ##################################################
class HostRouterEgressPkts1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts1w", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts1w"
    meta.rnFormat = "CDcloudHostRouterEgressPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPkts1w', False),
    ]
