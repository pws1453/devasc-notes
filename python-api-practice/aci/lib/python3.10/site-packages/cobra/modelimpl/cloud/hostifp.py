...
class HostIfP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.HostIfP")

    meta.moClassName = "cloudHostIfP"
    meta.rnFormat = "hostifp-%(nicId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Host Router Interface Profile"
    ...
    meta.childClasses.add("cobra.model.cloud.L3TunnelIfP")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.L3TunnelIfP", "l3tunnelifp-"))
    ...
    meta.superClasses.add("cobra.model.cloud.AHostIfP")

    meta.rnPrefixes = [
        ('hostifp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51512, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51513, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "logicalMoDn", "logicalMoDn", 52710, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51467, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nicId", "nicId", 50660, PropCategory.REGULAR)
    prop.label = "Cloud Host Router NIC Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("nicId", prop)
    ...
    prop = PropMeta("str", "usableForRemoteSiteTunnel", "usableForRemoteSiteTunnel", 52206, PropCategory.REGULAR)
    prop.label = "If true, this interface may be used for cloud to cloud tunnels"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("usableForRemoteSiteTunnel", prop)

    meta.namingProps.append(getattr(meta.props, "nicId"))
    ...
    def __init__(self, parentMoOrDn, nicId, markDirty=True, **creationProps):
        namingVals = [nicId]
