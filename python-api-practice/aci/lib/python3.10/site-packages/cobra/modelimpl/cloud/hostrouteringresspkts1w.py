...
# ##################################################
class HostRouterIngressPkts1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts1w", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts1w"
    meta.rnFormat = "CDcloudHostRouterIngressPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts1w', False),
    ]
