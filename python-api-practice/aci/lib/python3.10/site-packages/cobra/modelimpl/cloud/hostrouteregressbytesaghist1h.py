...
# ##################################################
class HostRouterEgressBytesAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist1h", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist1h"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54192, PropCategory.REGULAR)
