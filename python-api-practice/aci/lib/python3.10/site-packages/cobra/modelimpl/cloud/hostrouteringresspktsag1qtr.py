...
# ##################################################
class HostRouterIngressPktsAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg1qtr", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg1qtr"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg1qtr', False),
    ]
