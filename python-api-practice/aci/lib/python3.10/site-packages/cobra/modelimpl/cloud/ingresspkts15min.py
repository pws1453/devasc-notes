...
# ##################################################
class IngressPkts15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPkts15min", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPkts15min"
    meta.rnFormat = "CDcloudIngressPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.IngressPkts")

    meta.rnPrefixes = [
        ('CDcloudIngressPkts15min', False),
    ]
