...
# ##################################################
class PoolHealthStatsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist1h", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist1h"
    meta.rnFormat = "HDcloudPoolHealthStatsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52417, PropCategory.REGULAR)
