...
# ##################################################
class AppGwStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist5min", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist5min"
    meta.rnFormat = "HDcloudAppGwStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 55367, PropCategory.REGULAR)
