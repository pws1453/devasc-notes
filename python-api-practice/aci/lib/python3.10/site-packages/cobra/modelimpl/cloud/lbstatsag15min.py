...
# ##################################################
class LBStatsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAg15min", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAg15min"
    meta.rnFormat = "CDcloudLBStatsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB front end stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.LBStatsAg")

    meta.rnPrefixes = [
        ('CDcloudLBStatsAg15min', False),
    ]
