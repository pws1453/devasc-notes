...
# ##################################################
class HostRouterIngressBytesAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAg1d", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAg1d"
    meta.rnFormat = "CDcloudHostRouterIngressBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router cloud ingress bytess stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytesAg1d', False),
    ]
