...
# ##################################################
class EgressBytesAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAg1h", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAg1h"
    meta.rnFormat = "CDcloudEgressBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress bytes stats in 1 hour"
