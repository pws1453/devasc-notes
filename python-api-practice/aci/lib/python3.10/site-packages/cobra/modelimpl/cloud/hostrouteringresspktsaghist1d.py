...
# ##################################################
class HostRouterIngressPktsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist1d", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist1d"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54239, PropCategory.REGULAR)
