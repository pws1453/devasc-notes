...
class CDevDef(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.CDevDef")

    meta.moClassName = "cloudCDevDef"
    meta.rnFormat = "cdevdef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud CDev Resolved Data"
    ...
    meta.childClasses.add("cobra.model.cloud.CIfDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.CIfDef", "cifdef-"))
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 51801, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "devName", "devName", 51802, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "instanceCount", "instanceCount", 54930, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "isDualStack", "isDualStack", 51805, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isDualStack", prop)
    ...
    prop = PropMeta("str", "logicalMoDn", "logicalMoDn", 52874, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("logicalMoDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51962, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 51874, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "oid", "oid", 52348, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "regionDn", "regionDn", 52028, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "scheme", "scheme", 51804, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "size", "size", 54929, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "type", "type", 51803, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
