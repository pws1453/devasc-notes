...
# ##################################################
class LBStatsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist1year", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist1year"
    meta.rnFormat = "HDcloudLBStatsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 52403, PropCategory.REGULAR)
