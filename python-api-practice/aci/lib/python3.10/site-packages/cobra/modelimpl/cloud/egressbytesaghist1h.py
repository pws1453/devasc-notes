...
# ##################################################
class EgressBytesAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAgHist1h", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAgHist1h"
    meta.rnFormat = "HDcloudEgressBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50624, PropCategory.REGULAR)
