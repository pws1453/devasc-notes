...
# ##################################################
class Credentials(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.Credentials")

    meta.moClassName = "cloudCredentials"
    meta.rnFormat = "credentials-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Credential to manage the cloud resources"
    ...
    meta.childClasses.add("cobra.model.cloud.RtCredentials")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.cloud.RsAD")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtCredentials", "rtcredentials-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsAD", "rsAD"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 55112, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55113, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "httpProxy", "httpProxy", 54917, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "key", "key", 54916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "keyId", "keyId", 54915, PropCategory.REGULAR)
    prop.label = "Acces Key ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55103, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 54970, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
