...
# ##################################################
class EgressBytes(Mo):
    meta = StatsClassMeta("cobra.model.cloud.EgressBytes", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes"


    meta.moClassName = "cloudEgressBytes"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes15min")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes1w")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes1year")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes1d")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes5min")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytes1h")
