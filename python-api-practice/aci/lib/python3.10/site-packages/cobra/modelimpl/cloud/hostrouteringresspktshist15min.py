...
# ##################################################
class HostRouterIngressPktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist15min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist15min"
    meta.rnFormat = "HDcloudHostRouterIngressPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterIngressPktsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54246, PropCategory.REGULAR)
