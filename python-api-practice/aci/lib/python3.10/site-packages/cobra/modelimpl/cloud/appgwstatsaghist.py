...
# ##################################################
class AppGwStatsAgHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist"


    meta.moClassName = "cloudAppGwStatsAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist1d")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist1h")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist5min")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist15min")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsAgHist1year")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "CurrentConnectionsCum", "CurrentConnectionsCum", 55396, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure LB existing connections cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsCum", prop)

    prop = PropMeta("str", "CurrentConnectionsPer", "CurrentConnectionsPer", 55397, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure LB existing connections periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsPer", prop)

    prop = PropMeta("str", "CurrentConnectionsRate", "CurrentConnectionsRate", 55401, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure LB existing connections rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsRate", prop)

    prop = PropMeta("str", "CurrentConnectionsSpct", "CurrentConnectionsSpct", 55398, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure LB existing connections suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsSpct", prop)

    prop = PropMeta("str", "CurrentConnectionsThr", "CurrentConnectionsThr", 55399, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "CurrentConnectionsTr", "CurrentConnectionsTr", 55400, PropCategory.IMPLICIT_TREND)
    prop.label = "Azure LB existing connections trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsTr", prop)

    prop = PropMeta("str", "FailedRequestsCum", "FailedRequestsCum", 55430, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure LB Failed Requests cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsCum", prop)

    prop = PropMeta("str", "FailedRequestsPer", "FailedRequestsPer", 55431, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure LB Failed Requests periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsPer", prop)

    prop = PropMeta("str", "FailedRequestsRate", "FailedRequestsRate", 55435, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure LB Failed Requests rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsRate", prop)

    prop = PropMeta("str", "FailedRequestsSpct", "FailedRequestsSpct", 55432, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure LB Failed Requests suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsSpct", prop)

    prop = PropMeta("str", "FailedRequestsThr", "FailedRequestsThr", 55433, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "FailedRequestsTr", "FailedRequestsTr", 55434, PropCategory.IMPLICIT_TREND)
    prop.label = "Azure LB Failed Requests trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsTr", prop)

    prop = PropMeta("str", "ThroughputCum", "ThroughputCum", 55464, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure LB Total Throughput cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputCum", prop)

    prop = PropMeta("str", "ThroughputPer", "ThroughputPer", 55465, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure LB Total Throughput periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputPer", prop)

    prop = PropMeta("str", "ThroughputRate", "ThroughputRate", 55469, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure LB Total Throughput rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputRate", prop)

    prop = PropMeta("str", "ThroughputSpct", "ThroughputSpct", 55466, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure LB Total Throughput suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputSpct", prop)

    prop = PropMeta("str", "ThroughputThr", "ThroughputThr", 55467, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "ThroughputTr", "ThroughputTr", 55468, PropCategory.IMPLICIT_TREND)
    prop.label = "Azure LB Total Throughput trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputTr", prop)

    prop = PropMeta("str", "TotalRequestsCum", "TotalRequestsCum", 55498, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure Native LB requests count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsCum", prop)

    prop = PropMeta("str", "TotalRequestsPer", "TotalRequestsPer", 55499, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure Native LB requests count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsPer", prop)

    prop = PropMeta("str", "TotalRequestsRate", "TotalRequestsRate", 55503, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure Native LB requests count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsRate", prop)

    prop = PropMeta("str", "TotalRequestsSpct", "TotalRequestsSpct", 55500, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure Native LB requests count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsSpct", prop)

    prop = PropMeta("str", "TotalRequestsThr", "TotalRequestsThr", 55501, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "TotalRequestsTr", "TotalRequestsTr", 55502, PropCategory.IMPLICIT_TREND)
