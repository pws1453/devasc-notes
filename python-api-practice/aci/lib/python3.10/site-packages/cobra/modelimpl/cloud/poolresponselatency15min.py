...
# ##################################################
class PoolResponseLatency15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency15min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency15min"
    meta.rnFormat = "CDcloudPoolResponseLatency15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatency15min', False),
    ]
