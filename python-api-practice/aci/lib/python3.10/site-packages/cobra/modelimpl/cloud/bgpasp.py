...
class BgpAsP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.BgpAsP")

    meta.moClassName = "cloudBgpAsP"
    meta.rnFormat = "as"
    meta.category = MoCategory.REGULAR
    meta.label = "Autonomous System Profile"
    meta.writeAccessMask = 0x8c00000001
    meta.readAccessMask = 0x8c00000001
    ...
    meta.superClasses.add("cobra.model.cloud.ABgpAsP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 51492, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "asn", "asn", 50106, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51493, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51460, PropCategory.REGULAR)
