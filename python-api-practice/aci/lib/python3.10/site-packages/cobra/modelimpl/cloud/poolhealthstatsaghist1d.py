...
# ##################################################
class PoolHealthStatsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist1d", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist1d"
    meta.rnFormat = "HDcloudPoolHealthStatsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52416, PropCategory.REGULAR)
