...
# ##################################################
class RtCloudAccount(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtCloudAccount", "cobra.model.fv.Tenant")

    meta.moClassName = "cloudRtCloudAccount"
    meta.rnFormat = "rtfvCloudAccount-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55771, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54982, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54981, PropCategory.REGULAR)
