...
# ##################################################
class IngressPkts(Mo):
    meta = StatsClassMeta("cobra.model.cloud.IngressPkts", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPkts"


    meta.moClassName = "cloudIngressPkts"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts5min")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts1h")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts15min")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts1d")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts1year")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts1w")
    meta.concreteSubClasses.add("cobra.model.cloud.IngressPkts1qtr")
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 51138, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress drop packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropBase", "dropBase", 51133, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress drop packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBase", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 51134, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropLast", "dropLast", 51132, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress drop packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropLast", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 51137, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress drop packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 51136, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress drop packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 51135, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 51143, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 51139, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 51140, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 51142, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 51141, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 51172, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress unicast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastBase", "unicastBase", 51167, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress unicast packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastBase", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 51168, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastLast", "unicastLast", 51166, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress unicast packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastLast", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 51171, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress unicast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 51170, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress unicast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 51169, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 51177, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 51173, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 51174, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 51176, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress unicast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 51175, PropCategory.IMPLICIT_TREND_BASE)
