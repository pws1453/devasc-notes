...
# ##################################################
class PoolHealthStatsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist1qtr", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist1qtr"
    meta.rnFormat = "HDcloudPoolHealthStatsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52419, PropCategory.REGULAR)
