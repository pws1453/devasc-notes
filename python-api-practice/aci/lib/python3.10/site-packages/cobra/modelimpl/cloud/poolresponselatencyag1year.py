...
# ##################################################
class PoolResponseLatencyAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg1year", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg1year"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg1year', False),
    ]
