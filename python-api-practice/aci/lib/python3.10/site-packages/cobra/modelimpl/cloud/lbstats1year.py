...
# ##################################################
class LBStats1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStats1year", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStats1year"
    meta.rnFormat = "CDcloudLBStats1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB front end stats stats in 1 year"
