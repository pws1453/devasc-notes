...
# ##################################################
class PoolResponseLatency5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency5min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency5min"
    meta.rnFormat = "CDcloudPoolResponseLatency5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatency5min', False),
    ]
