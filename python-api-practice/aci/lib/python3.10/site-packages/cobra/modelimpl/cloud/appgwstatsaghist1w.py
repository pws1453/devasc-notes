...
# ##################################################
class AppGwStatsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist1w", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist1w"
    meta.rnFormat = "HDcloudAppGwStatsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 55357, PropCategory.REGULAR)
