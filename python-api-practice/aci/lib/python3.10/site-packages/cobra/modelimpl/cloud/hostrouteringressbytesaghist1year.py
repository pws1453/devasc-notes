...
# ##################################################
class HostRouterIngressBytesAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist1year", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist1year"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54228, PropCategory.REGULAR)
