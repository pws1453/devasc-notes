...
# ##################################################
class HostRouterEgressPktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist1year", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist1year"
    meta.rnFormat = "HDcloudHostRouterEgressPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54220, PropCategory.REGULAR)
