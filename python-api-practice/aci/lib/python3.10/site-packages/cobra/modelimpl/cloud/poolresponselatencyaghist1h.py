...
# ##################################################
class PoolResponseLatencyAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist1h", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist1h"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52434, PropCategory.REGULAR)
