...
# ##################################################
class EgressBytesAg(Mo):
    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAg", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAg"


    meta.moClassName = "cloudEgressBytesAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg1h")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg1d")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg5min")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg15min")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg1year")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesAg1w")
