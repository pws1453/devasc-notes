...
# ##################################################
class PoolHealthStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist1mo", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist1mo"
    meta.rnFormat = "HDcloudPoolHealthStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStats1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52426, PropCategory.REGULAR)
