...
# ##################################################
class EgressPktsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAg1year", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAg1year"
    meta.rnFormat = "CDcloudEgressPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudEgressPktsAg1year', False),
    ]
