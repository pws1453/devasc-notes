...
# ##################################################
class AzureStatsPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.AzureStatsPol")

    meta.moClassName = "cloudAzureStatsPol"
    meta.rnFormat = "azstatpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Azure Stats Collection Policy"
    ...
    meta.childClasses.add("cobra.model.cloud.RtCtxProfileToStatsPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtCtxProfileToStatsPol", "rtctxProfileToStatsPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 55669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "enableStats", "enableStats", 55653, PropCategory.REGULAR)
    prop.label = "StatsCollection on Azure"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("enableStats", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55670, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 55658, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
