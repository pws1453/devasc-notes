...
class LB(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.LB")

    meta.moClassName = "cloudLB"
    meta.rnFormat = "clb-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud L4-L7 Load Balancer"
    ...
    meta.childClasses.add("cobra.model.cloud.LBStatsHist1d")
    meta.childClasses.add("cobra.model.vns.RsSvcMgmtEpg")
    meta.childClasses.add("cobra.model.cloud.LBStats1w")
    meta.childClasses.add("cobra.model.vns.RtLDevCtxToLDev")
    meta.childClasses.add("cobra.model.cloud.LBStats5min")
    meta.childClasses.add("cobra.model.cloud.AppGwStats1qtr")
    meta.childClasses.add("cobra.model.cloud.LBStatsHist1year")
    meta.childClasses.add("cobra.model.cloud.LBStatsHist1h")
    meta.childClasses.add("cobra.model.cloud.LBStatsHist1qtr")
    meta.childClasses.add("cobra.model.cloud.LBStatsHist1w")
    meta.childClasses.add("cobra.model.cloud.LBStats1qtr")
    meta.childClasses.add("cobra.model.cloud.LBStatsHist5min")
    meta.childClasses.add("cobra.model.cloud.LBStats1year")
    meta.childClasses.add("cobra.model.cloud.LBStats1d")
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist1mo")
    meta.childClasses.add("cobra.model.cloud.LBStats1h")
    meta.childClasses.add("cobra.model.cloud.RtNodeInstToCloudLDev")
    ...
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist1year")
    ...
    meta.childClasses.add("cobra.model.cloud.AppGwStats5min")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist5min")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.cloud.LBStatsHist1mo")
    meta.childClasses.add("cobra.model.cloud.AbsNodeRef")
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist1qtr")
    ...
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist15min")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.vns.RtLDevAtt")
    meta.childClasses.add("cobra.model.cloud.SvcPolicy")
    meta.childClasses.add("cobra.model.cloud.RtNodeToCloudLDev")
    meta.childClasses.add("cobra.model.vns.MgmtLIf")
    meta.childClasses.add("cobra.model.cloud.LBStats1mo")
    ...
    meta.childClasses.add("cobra.model.cloud.RsLDevToCloudSubnet")
    meta.childClasses.add("cobra.model.cloud.LBStats15min")
    meta.childClasses.add("cobra.model.cloud.AppGwStats1h")
    meta.childClasses.add("cobra.model.cloud.AppGwStats1mo")
    meta.childClasses.add("cobra.model.vns.RsALDevToVxlanInstP")
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist1w")
    meta.childClasses.add("cobra.model.vns.RtNodeToLDev")
    meta.childClasses.add("cobra.model.cloud.AppGwStats1d")
    meta.childClasses.add("cobra.model.vns.RsALDevToDevMgr")
    meta.childClasses.add("cobra.model.vns.RtLdevIfToLDev")
    meta.childClasses.add("cobra.model.cloud.LBStatsHist15min")
    meta.childClasses.add("cobra.model.cloud.AppGwStats15min")
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist1h")
    meta.childClasses.add("cobra.model.vns.RsALDevToPhysDomP")
    meta.childClasses.add("cobra.model.cloud.AppGwStatsHist1d")
    meta.childClasses.add("cobra.model.cloud.AppGwStats1w")
    meta.childClasses.add("cobra.model.cloud.AppGwStats1year")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtNodeInstToCloudLDev", "rtvnsNodeInstToCloudLDev-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist1year", "HDcloudAppGwStats1year-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist15min", "HDcloudAppGwStats15min-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist5min", "HDcloudAppGwStats5min-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist1qtr", "HDcloudAppGwStats1qtr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats15min", "CDcloudAppGwStats15min"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats1year", "CDcloudAppGwStats1year"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtLDevOperInfoToALDev", "rtLDevOperInfoToALDev"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats1qtr", "CDcloudAppGwStats1qtr"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist1mo", "HDcloudAppGwStats1mo-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats5min", "CDcloudAppGwStats5min"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtNodeToCloudLDev", "rtvnsNodeToCloudLDev-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist1year", "HDcloudLBStats1year-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsLDevToCloudSubnet", "rsLDevToCloudSubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats1mo", "CDcloudAppGwStats1mo"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist1w", "HDcloudAppGwStats1w-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist15min", "HDcloudLBStats15min-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist1h", "HDcloudAppGwStats1h-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStatsHist1d", "HDcloudAppGwStats1d-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist1qtr", "HDcloudLBStats1qtr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist5min", "HDcloudLBStats5min-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats1year", "CDcloudLBStats1year"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsALDevToVlanInstP", "rsALDevToVlanInstP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats15min", "CDcloudLBStats15min"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats1h", "CDcloudAppGwStats1h"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsALDevToVxlanInstP", "rsALDevToVxlanInstP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats1d", "CDcloudAppGwStats1d"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AppGwStats1w", "CDcloudAppGwStats1w"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats5min", "CDcloudLBStats5min"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats1qtr", "CDcloudLBStats1qtr"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist1mo", "HDcloudLBStats1mo-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist1d", "HDcloudLBStats1d-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist1h", "HDcloudLBStats1h-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStatsHist1w", "HDcloudLBStats1w-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats1mo", "CDcloudLBStats1mo"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsALDevToPhysDomP", "rsALDevToPhysDomP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats1w", "CDcloudLBStats1w"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtLDevCtxToLDev", "rtLDevCtxToLDev-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats1d", "CDcloudLBStats1d"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LBStats1h", "CDcloudLBStats1h"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.AbsNodeRef", "noderef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsDevEpg", "rsdevEpg"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.SvcPolicy", "svcpol-"))
    ...
    meta.superClasses.add("cobra.model.vns.ALDev")
    meta.superClasses.add("cobra.model.vns.AL4L7ServiceFault")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.vns.ALDevIf")
    meta.superClasses.add("cobra.model.cloud.ALDev")

    meta.rnPrefixes = [
        ('clb-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51977, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "devtype", "devtype", 51795, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "CLOUD"
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51978, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "instanceCount", "instanceCount", 54928, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "2"
    meta.props.add("instanceCount", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51958, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 51878, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "scheme", "scheme", 51798, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "internet"
    prop._addConstant("internal", "internal", 1)
    prop._addConstant("internet", "internet", 0)
    meta.props.add("scheme", prop)

    prop = PropMeta("str", "size", "size", 54927, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "medium"
    prop._addConstant("large", "large", 2)
    prop._addConstant("medium", "medium", 1)
    prop._addConstant("small", "small", 0)
    ...
    prop = PropMeta("str", "svcType", "svcType", 51796, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 5
    prop.defaultValueStr = "NATIVELB"
    ...
    prop = PropMeta("str", "type", "type", 51797, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "application"
    prop._addConstant("application", "application", 0)
    prop._addConstant("network", "network", 1)
