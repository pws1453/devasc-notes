...
# ##################################################
class HostRouterEgressBytesHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist1h", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist1h"
    meta.rnFormat = "HDcloudHostRouterEgressBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54200, PropCategory.REGULAR)
