...
# ##################################################
class HostRouterEgressBytes1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes1mo", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes1mo"
    meta.rnFormat = "CDcloudHostRouterEgressBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes1mo', False),
    ]
