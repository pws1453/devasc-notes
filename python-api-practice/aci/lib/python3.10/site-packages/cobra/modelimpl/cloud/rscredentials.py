...
# ##################################################
class RsCredentials(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsCredentials", "cobra.model.cloud.Credentials")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsCredentials"
    meta.rnFormat = "rscredentials"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Credentials to use to manage the account"
    ...
    prop = PropMeta("str", "annotation", "annotation", 55110, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55111, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55102, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55053, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16113
    prop.defaultValueStr = "cloudCredentials"
    prop._addConstant("cloudCredentials", None, 16113)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55052, PropCategory.REGULAR)
