...
# ##################################################
class RsActionDefToPoolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsActionDefToPoolDef", "cobra.model.cloud.PoolDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsActionDefToPoolDef"
    meta.rnFormat = "rsActionDefToPoolDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from resolved Listener Rule Action to Pool"
    ...
    meta.rnPrefixes = [
        ('rsActionDefToPoolDef', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 52698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52699, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52693, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 52669, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15186
    prop.defaultValueStr = "cloudPoolDef"
    prop._addConstant("cloudPoolDef", None, 15186)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52668, PropCategory.REGULAR)
