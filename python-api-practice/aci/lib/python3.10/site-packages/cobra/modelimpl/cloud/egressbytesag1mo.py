...
# ##################################################
class EgressBytesAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAg1mo", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAg1mo"
    meta.rnFormat = "CDcloudEgressBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress bytes stats in 1 month"
