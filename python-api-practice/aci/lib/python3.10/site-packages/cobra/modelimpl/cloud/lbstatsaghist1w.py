...
# ##################################################
class LBStatsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist1w", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist1w"
    meta.rnFormat = "HDcloudLBStatsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 52402, PropCategory.REGULAR)
