...
# ##################################################
class LBStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist1mo", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist1mo"
    meta.rnFormat = "HDcloudLBStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 52408, PropCategory.REGULAR)
