...
# ##################################################
class IngressPktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist1qtr", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist1qtr"
    meta.rnFormat = "HDcloudIngressPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 50692, PropCategory.REGULAR)
