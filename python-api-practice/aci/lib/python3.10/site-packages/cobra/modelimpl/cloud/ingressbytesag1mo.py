...
# ##################################################
class IngressBytesAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAg1mo", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAg1mo"
    meta.rnFormat = "CDcloudIngressBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress bytess stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudIngressBytesAg1mo', False),
    ]
