...
# ##################################################
class HostRouterIngressBytesHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist1h", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist1h"
    meta.rnFormat = "HDcloudHostRouterIngressBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54232, PropCategory.REGULAR)
