...
# ##################################################
class EgressPktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist1mo", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist1mo"
    meta.rnFormat = "HDcloudEgressPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50649, PropCategory.REGULAR)
