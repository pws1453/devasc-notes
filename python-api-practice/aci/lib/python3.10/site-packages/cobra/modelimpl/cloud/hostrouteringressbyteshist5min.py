...
# ##################################################
class HostRouterIngressBytesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist5min", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist5min"
    meta.rnFormat = "HDcloudHostRouterIngressBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54237, PropCategory.REGULAR)
