...
# ##################################################
class RsListenerToCert(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsListenerToCert", "cobra.model.pki.KeyRing")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "cloudRsListenerToCert"
    meta.rnFormat = "rslistenerToCert-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Listener to Certificate"
    ...
    meta.rnPrefixes = [
        ('rslistenerToCert-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51985, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "certStore", "certStore", 51919, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "default"
    prop._addConstant("acm", "aws-acm", 2)
    prop._addConstant("default", "aws:acm", 0)
    prop._addConstant("iam", "aws-iam", 1)
    meta.props.add("certStore", prop)
    ...
    prop = PropMeta("str", "defaultCert", "defaultCert", 52661, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("defaultCert", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51986, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51968, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51921, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1482
    prop.defaultValueStr = "pkiKeyRing"
    prop._addConstant("pkiKeyRing", None, 1482)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51920, PropCategory.REGULAR)
