...
# ##################################################
class PoolHealthStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist"


    meta.moClassName = "cloudPoolHealthStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist1d")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsHist15min")
