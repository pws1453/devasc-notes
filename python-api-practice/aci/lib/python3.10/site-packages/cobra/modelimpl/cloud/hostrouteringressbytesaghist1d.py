...
# ##################################################
class HostRouterIngressBytesAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist1d", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist1d"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54223, PropCategory.REGULAR)
