...
# ##################################################
class PoolHealthStats1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats1d", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats1d"
    meta.rnFormat = "CDcloudPoolHealthStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats1d', False),
    ]
