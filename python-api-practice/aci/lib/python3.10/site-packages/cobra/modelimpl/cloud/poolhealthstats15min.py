...
# ##################################################
class PoolHealthStats15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats15min", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats15min"
    meta.rnFormat = "CDcloudPoolHealthStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.PoolHealthStats")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats15min', False),
    ]
