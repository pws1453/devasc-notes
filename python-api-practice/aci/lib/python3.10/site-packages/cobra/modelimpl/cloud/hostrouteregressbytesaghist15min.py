...
# ##################################################
class HostRouterEgressBytesAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist15min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist15min"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterEgressBytesAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54190, PropCategory.REGULAR)
