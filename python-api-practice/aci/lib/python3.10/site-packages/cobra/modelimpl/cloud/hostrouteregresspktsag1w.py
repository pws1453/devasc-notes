...
# ##################################################
class HostRouterEgressPktsAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg1w", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg1w"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg1w', False),
    ]
