...
# ##################################################
class HostRouterIngressBytesAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAg1w", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAg1w"
    meta.rnFormat = "CDcloudHostRouterIngressBytesAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router cloud ingress bytess stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytesAg1w', False),
    ]
