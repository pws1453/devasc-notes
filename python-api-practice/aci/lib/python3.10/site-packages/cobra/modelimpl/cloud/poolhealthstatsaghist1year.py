...
# ##################################################
class PoolHealthStatsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist1year", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist1year"
    meta.rnFormat = "HDcloudPoolHealthStatsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52421, PropCategory.REGULAR)
