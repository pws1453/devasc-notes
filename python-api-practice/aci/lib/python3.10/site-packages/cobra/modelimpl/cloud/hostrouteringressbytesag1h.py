...
# ##################################################
class HostRouterIngressBytesAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAg1h", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAg1h"
    meta.rnFormat = "CDcloudHostRouterIngressBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router cloud ingress bytess stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytesAg1h', False),
    ]
