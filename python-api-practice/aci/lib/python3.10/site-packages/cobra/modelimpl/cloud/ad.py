...
class AD(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.AD")

    meta.moClassName = "cloudAD"
    meta.rnFormat = "ad-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Active Directory"
    ...
    meta.childClasses.add("cobra.model.cloud.RtAD")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtAD", "rtAD-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 55116, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55117, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 54918, PropCategory.REGULAR)
    prop.label = "AD ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
