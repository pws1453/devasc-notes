...
class CIfDef(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.CIfDef")

    meta.moClassName = "cloudCIfDef"
    meta.rnFormat = "cifdef-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud CIf Resolved Data"
    meta.writeAccessMask = 0x4000000001002001
    ...
    prop = PropMeta("str", "ip", "ip", 51875, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
