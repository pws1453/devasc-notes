...
# ##################################################
class HostRouterIngressPktsAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg1d", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg1d"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg1d', False),
    ]
