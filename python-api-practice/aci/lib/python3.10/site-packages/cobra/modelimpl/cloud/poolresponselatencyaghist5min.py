...
# ##################################################
class PoolResponseLatencyAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist5min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist5min"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52439, PropCategory.REGULAR)
