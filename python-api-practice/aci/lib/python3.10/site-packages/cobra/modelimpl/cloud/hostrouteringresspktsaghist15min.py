...
# ##################################################
class HostRouterIngressPktsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist15min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist15min"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterIngressPktsAgHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54238, PropCategory.REGULAR)
