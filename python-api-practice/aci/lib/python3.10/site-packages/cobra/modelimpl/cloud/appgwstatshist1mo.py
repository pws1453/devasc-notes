...
# ##################################################
class AppGwStatsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist1mo", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist1mo"
    meta.rnFormat = "HDcloudAppGwStats1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 55363, PropCategory.REGULAR)
