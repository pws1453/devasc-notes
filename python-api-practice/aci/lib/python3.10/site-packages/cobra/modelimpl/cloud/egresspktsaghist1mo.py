...
# ##################################################
class EgressPktsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist1mo", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist1mo"
    meta.rnFormat = "HDcloudEgressPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50641, PropCategory.REGULAR)
