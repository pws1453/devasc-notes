...
# ##################################################
class RsCtxToFlowLog(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.cloud.RsCtxToFlowLog", "cobra.model.cloud.AwsFlowLogPol")
    meta.targetNameProps["name"] = "tnCloudAwsFlowLogPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsCtxToFlowLog"
    meta.rnFormat = "rsctxToFlowLog"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relationship to Flow Log Policy"
    ...
    meta.rnPrefixes = [
        ('rsctxToFlowLog', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51542, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51543, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51475, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51225, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14630
    prop.defaultValueStr = "cloudAwsFlowLogPol"
    ...
    prop = PropMeta("str", "tnCloudAwsFlowLogPolName", "tnCloudAwsFlowLogPolName", 51224, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCloudAwsFlowLogPolName", prop)
