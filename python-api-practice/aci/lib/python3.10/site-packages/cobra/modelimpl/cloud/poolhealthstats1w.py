...
# ##################################################
class PoolHealthStats1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats1w", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats1w"
    meta.rnFormat = "CDcloudPoolHealthStats1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats1w', False),
    ]
