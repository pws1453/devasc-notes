...
# ##################################################
class IngressBytesAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAg1h", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAg1h"
    meta.rnFormat = "CDcloudIngressBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress bytess stats in 1 hour"
