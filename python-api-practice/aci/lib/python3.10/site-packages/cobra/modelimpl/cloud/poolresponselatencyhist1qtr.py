...
# ##################################################
class PoolResponseLatencyHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist1qtr", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist1qtr"
    meta.rnFormat = "HDcloudPoolResponseLatency1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52444, PropCategory.REGULAR)
