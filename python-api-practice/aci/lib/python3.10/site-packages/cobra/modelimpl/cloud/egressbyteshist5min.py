...
# ##################################################
class EgressBytesHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist5min", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist5min"
    meta.rnFormat = "HDcloudEgressBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 50637, PropCategory.REGULAR)
