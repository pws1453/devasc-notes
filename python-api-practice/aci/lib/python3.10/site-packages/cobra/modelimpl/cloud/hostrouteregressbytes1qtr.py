...
# ##################################################
class HostRouterEgressBytes1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes1qtr", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes1qtr"
    meta.rnFormat = "CDcloudHostRouterEgressBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes1qtr', False),
    ]
