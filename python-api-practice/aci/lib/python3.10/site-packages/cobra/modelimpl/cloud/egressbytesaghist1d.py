...
# ##################################################
class EgressBytesAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAgHist1d", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAgHist1d"
    meta.rnFormat = "HDcloudEgressBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50623, PropCategory.REGULAR)
