...
# ##################################################
class HostRouterEgressPkts5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts5min", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts5min"
    meta.rnFormat = "CDcloudHostRouterEgressPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPkts5min', False),
    ]
