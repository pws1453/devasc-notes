...
# ##################################################
class HostRouterEgressPktsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist1w", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist1w"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54211, PropCategory.REGULAR)
