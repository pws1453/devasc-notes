...
# ##################################################
class EgressBytesAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAgHist1w", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAgHist1w"
    meta.rnFormat = "HDcloudEgressBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50627, PropCategory.REGULAR)
