...
# ##################################################
class AppGwStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist1w", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist1w"
    meta.rnFormat = "HDcloudAppGwStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 55365, PropCategory.REGULAR)
