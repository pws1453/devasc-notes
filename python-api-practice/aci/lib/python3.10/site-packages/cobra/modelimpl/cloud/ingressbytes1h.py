...
# ##################################################
class IngressBytes1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytes1h", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes1h"
    meta.rnFormat = "CDcloudIngressBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats in 1 hour"
