...
# ##################################################
class HostRouterEgressPkts(Mo):
    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts"


    meta.moClassName = "cloudHostRouterEgressPkts"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts15min")
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts1w")
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts1h")
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts1year")
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts5min")
    meta.concreteSubClasses.add("cobra.model.cloud.HostRouterEgressPkts1d")
