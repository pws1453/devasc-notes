...
# ##################################################
class AppGwStatsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist1h", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist1h"
    meta.rnFormat = "HDcloudAppGwStatsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 55354, PropCategory.REGULAR)
