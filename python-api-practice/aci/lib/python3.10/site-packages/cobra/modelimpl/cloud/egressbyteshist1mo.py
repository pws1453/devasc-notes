...
# ##################################################
class EgressBytesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist1mo", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist1mo"
    meta.rnFormat = "HDcloudEgressBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50633, PropCategory.REGULAR)
