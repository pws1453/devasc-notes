...
# ##################################################
class HostRouterIngressBytesAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist5min", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist5min"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54229, PropCategory.REGULAR)
