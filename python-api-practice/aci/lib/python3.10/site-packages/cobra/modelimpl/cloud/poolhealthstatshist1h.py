...
# ##################################################
class PoolHealthStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist1h", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist1h"
    meta.rnFormat = "HDcloudPoolHealthStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 52425, PropCategory.REGULAR)
