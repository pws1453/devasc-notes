...
# ##################################################
class HostRouterIngressPkts1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts1h", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts1h"
    meta.rnFormat = "CDcloudHostRouterIngressPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts1h', False),
    ]
