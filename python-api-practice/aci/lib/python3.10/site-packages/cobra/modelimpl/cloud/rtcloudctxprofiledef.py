...
# ##################################################
class RtCloudCtxProfileDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtCloudCtxProfileDef", "cobra.model.cloud.Bookeeping")

    meta.moClassName = "cloudRtCloudCtxProfileDef"
    meta.rnFormat = "rtcloudCtxProfileDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51243, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51242, PropCategory.REGULAR)
