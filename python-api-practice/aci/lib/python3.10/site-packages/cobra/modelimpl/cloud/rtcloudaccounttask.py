...
# ##################################################
class RtCloudAccountTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.RtCloudAccountTask")

    meta.moClassName = "cloudRtCloudAccountTask"
    meta.rnFormat = "cloudRtCloudAccountTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 55762, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendTnCons", "sendtncons", 3674)
