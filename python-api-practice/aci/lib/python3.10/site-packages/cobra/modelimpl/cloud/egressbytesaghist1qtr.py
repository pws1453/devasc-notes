...
# ##################################################
class EgressBytesAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAgHist1qtr", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAgHist1qtr"
    meta.rnFormat = "HDcloudEgressBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 50626, PropCategory.REGULAR)
