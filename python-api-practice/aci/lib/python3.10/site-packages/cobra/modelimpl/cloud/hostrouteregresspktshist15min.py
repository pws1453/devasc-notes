...
# ##################################################
class HostRouterEgressPktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist15min", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist15min"
    meta.rnFormat = "HDcloudHostRouterEgressPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterEgressPktsHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54214, PropCategory.REGULAR)
