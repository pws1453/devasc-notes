...
# ##################################################
class PoolHealthStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist15min", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist15min"
    meta.rnFormat = "HDcloudPoolHealthStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStats15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52423, PropCategory.REGULAR)
