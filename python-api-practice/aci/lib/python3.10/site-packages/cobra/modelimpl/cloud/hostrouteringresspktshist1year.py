...
# ##################################################
class HostRouterIngressPktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist1year", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist1year"
    meta.rnFormat = "HDcloudHostRouterIngressPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54252, PropCategory.REGULAR)
