...
# ##################################################
class IngressPktsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist1w", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist1w"
    meta.rnFormat = "HDcloudIngressPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50693, PropCategory.REGULAR)
