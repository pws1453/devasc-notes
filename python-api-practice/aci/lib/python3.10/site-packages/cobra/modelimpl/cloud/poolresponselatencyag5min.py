...
# ##################################################
class PoolResponseLatencyAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg5min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg5min"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg5min', False),
    ]
