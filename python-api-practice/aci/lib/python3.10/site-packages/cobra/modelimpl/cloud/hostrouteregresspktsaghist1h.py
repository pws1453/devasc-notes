...
# ##################################################
class HostRouterEgressPktsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist1h", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist1h"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54208, PropCategory.REGULAR)
