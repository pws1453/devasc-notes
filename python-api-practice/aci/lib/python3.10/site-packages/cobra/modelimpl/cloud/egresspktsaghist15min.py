...
# ##################################################
class EgressPktsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist15min", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist15min"
    meta.rnFormat = "HDcloudEgressPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.EgressPktsAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcloudEgressPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 51024, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 51025, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 51029, PropCategory.IMPLICIT_RATE)
    prop.label = "egress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 51026, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 51027, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 51028, PropCategory.IMPLICIT_TREND)
    prop.label = "egress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "index", "index", 50638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 51058, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 51059, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 51063, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 51060, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 51061, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 51062, PropCategory.IMPLICIT_TREND)
