...
# ##################################################
class EgressBytesAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAg1qtr", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAg1qtr"
    meta.rnFormat = "CDcloudEgressBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress bytes stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudEgressBytesAg1qtr', False),
    ]
