...
# ##################################################
class IngressPktsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAgHist1mo", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAgHist1mo"
    meta.rnFormat = "HDcloudIngressPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50683, PropCategory.REGULAR)
