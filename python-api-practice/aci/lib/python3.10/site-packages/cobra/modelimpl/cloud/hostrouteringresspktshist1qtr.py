...
# ##################################################
class HostRouterIngressPktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist1qtr", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist1qtr"
    meta.rnFormat = "HDcloudHostRouterIngressPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54250, PropCategory.REGULAR)
