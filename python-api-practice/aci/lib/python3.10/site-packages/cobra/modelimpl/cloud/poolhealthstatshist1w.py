...
# ##################################################
class PoolHealthStatsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist1w", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist1w"
    meta.rnFormat = "HDcloudPoolHealthStats1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 52428, PropCategory.REGULAR)
