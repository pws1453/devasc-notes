...
# ##################################################
class PoolHealthStatsAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg1h", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg1h"
    meta.rnFormat = "CDcloudPoolHealthStatsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg1h', False),
    ]
