...
# ##################################################
class PoolResponseLatencyAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg1h", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg1h"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg1h', False),
    ]
