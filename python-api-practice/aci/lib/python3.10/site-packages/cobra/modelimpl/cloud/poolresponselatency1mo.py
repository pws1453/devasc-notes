...
# ##################################################
class PoolResponseLatency1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency1mo", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency1mo"
    meta.rnFormat = "CDcloudPoolResponseLatency1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatency1mo', False),
    ]
