...
# ##################################################
class IngressPktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist15min", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist15min"
    meta.rnFormat = "HDcloudIngressPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.IngressPktsHist")

    meta.rnPrefixes = [
        ('HDcloudIngressPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50688, PropCategory.REGULAR)
