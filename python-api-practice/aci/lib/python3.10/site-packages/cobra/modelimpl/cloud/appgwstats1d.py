...
# ##################################################
class AppGwStats1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStats1d", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStats1d"
    meta.rnFormat = "CDcloudAppGwStats1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Azure ALB front end stats stats in 1 day"
