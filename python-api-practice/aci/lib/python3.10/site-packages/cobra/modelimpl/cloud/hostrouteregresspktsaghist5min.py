...
# ##################################################
class HostRouterEgressPktsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist5min", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist5min"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54213, PropCategory.REGULAR)
