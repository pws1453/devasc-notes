...
# ##################################################
class RtNodeToCloudLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtNodeToCloudLDev", "cobra.model.vns.AbsNode")

    meta.moClassName = "cloudRtNodeToCloudLDev"
    meta.rnFormat = "rtvnsNodeToCloudLDev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51902, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51901, PropCategory.REGULAR)
