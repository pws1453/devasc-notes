...
# ##################################################
class HostRouterEgressBytesAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg1w", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg1w"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg1w', False),
    ]
