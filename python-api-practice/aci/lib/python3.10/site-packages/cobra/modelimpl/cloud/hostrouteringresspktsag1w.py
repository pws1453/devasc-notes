...
# ##################################################
class HostRouterIngressPktsAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg1w", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg1w"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg1w', False),
    ]
