...
# ##################################################
class EgressPktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist1d", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist1d"
    meta.rnFormat = "HDcloudEgressPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50647, PropCategory.REGULAR)
