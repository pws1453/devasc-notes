...
class OspfIfP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.OspfIfP")

    meta.moClassName = "cloudOspfIfP"
    meta.rnFormat = "ospfifp-[%(area)s]-af-%(af)s"
    ...
    meta.superClasses.add("cobra.model.cloud.AOspfIfP")
    ...
    prop = PropMeta("str", "af", "af", 50706, PropCategory.REGULAR)
    prop.label = "OSPF Address Family"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 51532, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "area", "area", 50707, PropCategory.REGULAR)
    prop.label = "OSPF Area Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51533, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.namingProps.append(getattr(meta.props, "area"))
    getattr(meta.props, "area").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, area, af, markDirty=True, **creationProps):
        namingVals = [area, af]
