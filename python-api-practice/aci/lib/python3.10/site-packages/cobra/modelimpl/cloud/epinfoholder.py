...
# ##################################################
class EpInfoHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.EpInfoHolder")

    meta.moClassName = "cloudEpInfoHolder"
    meta.rnFormat = "ep-%(endpoint)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EndPoint Stats Holder"
    ...
    prop = PropMeta("str", "endpoint", "endpoint", 52047, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52071, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "endpoint"))
    ...
    def __init__(self, parentMoOrDn, endpoint, markDirty=True, **creationProps):
        namingVals = [endpoint]
