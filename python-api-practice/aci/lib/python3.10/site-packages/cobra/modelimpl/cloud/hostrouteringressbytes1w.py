...
# ##################################################
class HostRouterIngressBytes1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytes1w", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytes1w"
    meta.rnFormat = "CDcloudHostRouterIngressBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router cloud ingress bytess stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytes1w', False),
    ]
