...
# ##################################################
class HostRouterIngressBytes1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytes1mo", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytes1mo"
    meta.rnFormat = "CDcloudHostRouterIngressBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router cloud ingress bytess stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytes1mo', False),
    ]
