...
# ##################################################
class HostRouterEgressBytesAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist1mo", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist1mo"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54193, PropCategory.REGULAR)
