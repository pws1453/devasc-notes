...
# ##################################################
class PoolHealthStats1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats1h", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats1h"
    meta.rnFormat = "CDcloudPoolHealthStats1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats1h', False),
    ]
