...
# ##################################################
class EgressBytesAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAgHist1mo", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAgHist1mo"
    meta.rnFormat = "HDcloudEgressBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50625, PropCategory.REGULAR)
