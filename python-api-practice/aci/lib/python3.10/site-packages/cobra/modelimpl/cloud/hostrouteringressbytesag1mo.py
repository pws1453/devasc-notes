...
# ##################################################
class HostRouterIngressBytesAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAg1mo", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAg1mo"
    meta.rnFormat = "CDcloudHostRouterIngressBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router cloud ingress bytess stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytesAg1mo', False),
    ]
