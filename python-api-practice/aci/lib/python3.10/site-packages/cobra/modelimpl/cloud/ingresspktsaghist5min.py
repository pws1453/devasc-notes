...
# ##################################################
class IngressPktsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAgHist5min", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAgHist5min"
    meta.rnFormat = "HDcloudIngressPktsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 50687, PropCategory.REGULAR)
