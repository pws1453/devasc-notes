...
# ##################################################
class RsIsakmpPhase1Pol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.cloud.RsIsakmpPhase1Pol", "cobra.model.ipsec.IsakmpPhase1Pol")
    meta.targetNameProps["name"] = "tnIpsecIsakmpPhase1PolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "cloudRsIsakmpPhase1Pol"
    meta.rnFormat = "rsisakmpPhase1Pol-%(tnIpsecIsakmpPhase1PolName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ISAKMP Phase1 Policy"
    ...
    meta.rnPrefixes = [
        ('rsisakmpPhase1Pol-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51528, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51529, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51470, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51213, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15087
    prop.defaultValueStr = "ipsecIsakmpPhase1Pol"
    ...
    prop = PropMeta("str", "tnIpsecIsakmpPhase1PolName", "tnIpsecIsakmpPhase1PolName", 51212, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnIpsecIsakmpPhase1PolName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnIpsecIsakmpPhase1PolName"))
    ...
    def __init__(self, parentMoOrDn, tnIpsecIsakmpPhase1PolName, markDirty=True, **creationProps):
        namingVals = [tnIpsecIsakmpPhase1PolName]
