...
class RuleCondition(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.RuleCondition")

    meta.moClassName = "cloudRuleCondition"
    meta.rnFormat = "condition-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Load Balancer Listener Rule Condition"
    ...
    meta.superClasses.add("cobra.model.cloud.ARuleCondition")
    ...
    prop = PropMeta("str", "annotation", "annotation", 51995, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51996, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "type", "type", 51888, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 51816, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
