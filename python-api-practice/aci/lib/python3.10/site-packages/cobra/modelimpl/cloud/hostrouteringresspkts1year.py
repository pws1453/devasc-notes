...
# ##################################################
class HostRouterIngressPkts1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts1year", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts1year"
    meta.rnFormat = "CDcloudHostRouterIngressPkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts1year', False),
    ]
