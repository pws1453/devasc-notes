...
# ##################################################
class EgressBytes1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytes1year", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes1year"
    meta.rnFormat = "CDcloudEgressBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats in 1 year"
