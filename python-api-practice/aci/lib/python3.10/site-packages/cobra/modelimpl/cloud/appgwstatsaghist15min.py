...
# ##################################################
class AppGwStatsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist15min", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist15min"
    meta.rnFormat = "HDcloudAppGwStatsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.AppGwStatsAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDcloudAppGwStatsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 55352, PropCategory.REGULAR)
