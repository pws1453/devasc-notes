...
# ##################################################
class AppGwStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist1qtr", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist1qtr"
    meta.rnFormat = "HDcloudAppGwStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 55364, PropCategory.REGULAR)
