...
# ##################################################
class PoolHealthStatsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist15min", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist15min"
    meta.rnFormat = "HDcloudPoolHealthStatsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.PoolHealthStatsAgHist")

    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52415, PropCategory.REGULAR)
