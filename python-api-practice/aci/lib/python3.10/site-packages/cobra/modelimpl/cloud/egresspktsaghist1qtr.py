...
# ##################################################
class EgressPktsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist1qtr", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist1qtr"
    meta.rnFormat = "HDcloudEgressPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 50642, PropCategory.REGULAR)
