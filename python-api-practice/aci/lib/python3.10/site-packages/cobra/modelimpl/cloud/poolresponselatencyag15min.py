...
# ##################################################
class PoolResponseLatencyAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg15min", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg15min"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.PoolResponseLatencyAg")

    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg15min', False),
    ]
