...
# ##################################################
class HostRouterEgressBytesAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist1w", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist1w"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54195, PropCategory.REGULAR)
