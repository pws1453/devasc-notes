...
# ##################################################
class HostRouterIngressBytesAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist1h", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist1h"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54224, PropCategory.REGULAR)
