...
# ##################################################
class RtCtxToFlowLog(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtCtxToFlowLog", "cobra.model.cloud.CtxProfile")

    meta.moClassName = "cloudRtCtxToFlowLog"
    meta.rnFormat = "rtctxToFlowLog-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51227, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51226, PropCategory.REGULAR)
