...
# ##################################################
class EgressPktsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist15min", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist15min"
    meta.rnFormat = "HDcloudEgressPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.EgressPktsHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDcloudEgressPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50646, PropCategory.REGULAR)
