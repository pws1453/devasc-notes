...
# ##################################################
class HostRouterEgressBytesAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist1d", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist1d"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54191, PropCategory.REGULAR)
