...
class LDevDef(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.LDevDef")

    meta.moClassName = "cloudLDevDef"
    meta.rnFormat = "ldevdef-[%(lDevDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud LDev Resolved Data"
    meta.writeAccessMask = 0x4000000000000001
    meta.readAccessMask = 0x700000000000c701
    ...
    meta.childClasses.add("cobra.model.cloud.ISvcEPg")
    ...
    meta.childClasses.add("cobra.model.cloud.RtPullRemoteLDevDef")
    ...
    meta.childClasses.add("cobra.model.cloud.SvcPolicyDef")
    ...
    meta.childClasses.add("cobra.model.cloud.CDevDef")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.cloud.LIfDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtPullRemoteLDevDef", "rtresolutionPullRemoteLDevDef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.SvcPolicyDef", "svcpolicydef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.CDevDef", "cdevdef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.LIfDef", "lifdef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.ISvcEPg", "lif-"))
    ...
    prop = PropMeta("str", "lDevDn", "lDevDn", 51800, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("lDevDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51961, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "lDevDn"))
    getattr(meta.props, "lDevDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, lDevDn, markDirty=True, **creationProps):
        namingVals = [lDevDn]
