...
# ##################################################
class EgressBytes1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytes1mo", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes1mo"
    meta.rnFormat = "CDcloudEgressBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats in 1 month"
