...
class RsFvCtxDef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.cloud.RsFvCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "cloudRsFvCtxDef"
    meta.rnFormat = "rsfvCtxDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EpP related to fvCtxDef"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51556, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51557, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51245, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51244, PropCategory.REGULAR)
