...
# ##################################################
class IngressBytesAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist1year", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist1year"
    meta.rnFormat = "HDcloudIngressBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudIngressBytesAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50670, PropCategory.REGULAR)
