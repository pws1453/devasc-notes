...
# ##################################################
class AppGwStatsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg5min", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg5min"
    meta.rnFormat = "CDcloudAppGwStatsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats in 5 minute"
