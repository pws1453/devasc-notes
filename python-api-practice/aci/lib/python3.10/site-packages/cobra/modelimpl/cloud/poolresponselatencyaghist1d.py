...
# ##################################################
class PoolResponseLatencyAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAgHist1d", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAgHist1d"
    meta.rnFormat = "HDcloudPoolResponseLatencyAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool response latency stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatencyAg1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52433, PropCategory.REGULAR)
