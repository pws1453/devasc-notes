...
# ##################################################
class EgressBytesHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist"


    meta.moClassName = "cloudEgressBytesHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist15min")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist1year")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist1h")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist5min")
    meta.concreteSubClasses.add("cobra.model.cloud.EgressBytesHist1d")
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 50944, PropCategory.IMPLICIT_AVG)
    prop.label = "egress drop packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 50940, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 50943, PropCategory.IMPLICIT_MAX)
    prop.label = "egress drop packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 50942, PropCategory.IMPLICIT_MIN)
    prop.label = "egress drop packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 50941, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 50948, PropCategory.IMPLICIT_RATE)
    prop.label = "egress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 50945, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 50946, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 50947, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 50978, PropCategory.IMPLICIT_AVG)
    prop.label = "egress unicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 50974, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 50977, PropCategory.IMPLICIT_MAX)
    prop.label = "egress unicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 50976, PropCategory.IMPLICIT_MIN)
    prop.label = "egress unicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 50975, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 50982, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 50979, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 50980, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 50981, PropCategory.IMPLICIT_TREND)
