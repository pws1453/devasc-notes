...
# ##################################################
class HostRouterIngressBytesAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAg15min", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAg15min"
    meta.rnFormat = "CDcloudHostRouterIngressBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router cloud ingress bytess stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterIngressBytesAg")
    meta.superClasses.add("cobra.model.stats.Curr")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytesAg15min', False),
    ]
