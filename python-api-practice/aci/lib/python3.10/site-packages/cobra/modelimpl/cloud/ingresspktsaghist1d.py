...
# ##################################################
class IngressPktsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAgHist1d", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAgHist1d"
    meta.rnFormat = "HDcloudIngressPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50681, PropCategory.REGULAR)
