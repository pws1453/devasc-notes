...
# ##################################################
class EgressBytes15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytes15min", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes15min"
    meta.rnFormat = "CDcloudEgressBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats in 15 minute"
