...
# ##################################################
class PoolHealthStatsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist1w", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist1w"
    meta.rnFormat = "HDcloudPoolHealthStatsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStatsAg1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52420, PropCategory.REGULAR)
