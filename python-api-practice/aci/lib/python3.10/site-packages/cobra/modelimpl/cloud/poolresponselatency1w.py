...
# ##################################################
class PoolResponseLatency1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency1w", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency1w"
    meta.rnFormat = "CDcloudPoolResponseLatency1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatency1w', False),
    ]
