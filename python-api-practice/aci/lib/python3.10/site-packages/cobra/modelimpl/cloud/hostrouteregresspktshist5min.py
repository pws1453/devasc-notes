...
# ##################################################
class HostRouterEgressPktsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist5min", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist5min"
    meta.rnFormat = "HDcloudHostRouterEgressPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54221, PropCategory.REGULAR)
