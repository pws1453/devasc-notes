...
# ##################################################
class RtNodeInstToCloudLDev(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtNodeInstToCloudLDev", "cobra.model.vns.NodeInst")

    meta.moClassName = "cloudRtNodeInstToCloudLDev"
    meta.rnFormat = "rtvnsNodeInstToCloudLDev-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Node Instance"
    meta.writeAccessMask = 0x6000000000000001
    meta.readAccessMask = 0x600000000000c001
    ...
    prop = PropMeta("str", "tCl", "tCl", 51906, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51905, PropCategory.REGULAR)
