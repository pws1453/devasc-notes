...
# ##################################################
class IngressPktsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAg1year", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAg1year"
    meta.rnFormat = "CDcloudIngressPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudIngressPktsAg1year', False),
    ]
