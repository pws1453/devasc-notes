...
# ##################################################
class HostRouterEgressBytesAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist1year", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist1year"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54196, PropCategory.REGULAR)
