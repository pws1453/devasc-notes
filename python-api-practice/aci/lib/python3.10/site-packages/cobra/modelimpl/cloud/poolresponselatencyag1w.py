...
# ##################################################
class PoolResponseLatencyAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg1w", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg1w"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg1w', False),
    ]
