...
# ##################################################
class RsZoneAttach(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsZoneAttach", "cobra.model.cloud.Zone")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsZoneAttach"
    meta.rnFormat = "rszoneAttach"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachment to Cloud Zone"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51548, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51549, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51478, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51237, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14805
    prop.defaultValueStr = "cloudZone"
    prop._addConstant("cloudZone", None, 14805)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51236, PropCategory.REGULAR)
