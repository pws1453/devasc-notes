...
class Subnet(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.Subnet")

    meta.moClassName = "cloudSubnet"
    meta.rnFormat = "subnet-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Subnet"
    meta.writeAccessMask = 0x1002001
    meta.readAccessMask = 0x4000000001002001
    ...
    meta.childClasses.add("cobra.model.cloud.RsZoneAttach")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.cloud.RtLDevToCloudSubnet")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtLDevToCloudSubnet", "rtLDevToCloudSubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsZoneAttach", "rszoneAttach"))
    ...
    meta.superClasses.add("cobra.model.cloud.ASubnet")
    ...
    prop = PropMeta("str", "annotation", "annotation", 51546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51547, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 50713, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51477, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scope", "scope", 50143, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "usage", "usage", 50142, PropCategory.REGULAR)
