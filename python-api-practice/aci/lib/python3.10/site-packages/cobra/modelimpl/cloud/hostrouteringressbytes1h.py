...
# ##################################################
class HostRouterIngressBytes1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytes1h", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytes1h"
    meta.rnFormat = "CDcloudHostRouterIngressBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router cloud ingress bytess stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytes1h', False),
    ]
