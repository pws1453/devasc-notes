...
class Cidr(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.Cidr")

    meta.moClassName = "cloudCidr"
    meta.rnFormat = "cidr-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud CIDR Pool"
    ...
    meta.childClasses.add("cobra.model.cloud.Subnet")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.Subnet", "subnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.cloud.CtxProfile")

    meta.superClasses.add("cobra.model.cloud.ACidr")
    ...
    prop = PropMeta("str", "addr", "addr", 50551, PropCategory.REGULAR)
    prop.label = "Cloud Context's CIDR"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 51544, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51545, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51476, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "primary", "primary", 50141, PropCategory.REGULAR)
    prop.label = "Preferred as primary CIDR"
    prop.isConfig = True
    prop.isAdmin = True
