...
class CertStore(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.CertStore")

    meta.moClassName = "cloudCertStore"
    meta.rnFormat = "certstore"
    meta.category = MoCategory.REGULAR
    meta.label = "Certificate Store"
    ...
    meta.superClasses.add("cobra.model.cloud.ACertStore")

    meta.rnPrefixes = [
        ('certstore', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52000, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52687, PropCategory.REGULAR)
