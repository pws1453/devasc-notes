...
# ##################################################
class HostRouterIngressBytesAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist1w", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist1w"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54227, PropCategory.REGULAR)
