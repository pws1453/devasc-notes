...
# ##################################################
class HostRouterEgressPkts1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts1qtr", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts1qtr"
    meta.rnFormat = "CDcloudHostRouterEgressPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPkts1qtr', False),
    ]
