...
class RegionName(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.RegionName")

    meta.moClassName = "cloudRegionName"
    meta.rnFormat = "provider-%(provider)s-region-%(region)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Provider and Region Names"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51592, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51593, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "provider", "provider", 50175, PropCategory.REGULAR)
    prop.label = "Cloud Provider Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.props.add("provider", prop)

    prop = PropMeta("str", "region", "region", 50176, PropCategory.REGULAR)
    prop.label = "Cloud Region Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.namingProps.append(getattr(meta.props, "provider"))
    ...
    def __init__(self, parentMoOrDn, provider, region, markDirty=True, **creationProps):
        namingVals = [provider, region]
