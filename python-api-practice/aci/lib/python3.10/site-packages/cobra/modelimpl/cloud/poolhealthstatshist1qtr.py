...
# ##################################################
class PoolHealthStatsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist1qtr", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist1qtr"
    meta.rnFormat = "HDcloudPoolHealthStats1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStats1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52427, PropCategory.REGULAR)
