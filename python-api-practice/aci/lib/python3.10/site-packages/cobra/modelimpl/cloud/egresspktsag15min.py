...
# ##################################################
class EgressPktsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAg15min", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAg15min"
    meta.rnFormat = "CDcloudEgressPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.EgressPktsAg")

    meta.rnPrefixes = [
        ('CDcloudEgressPktsAg15min', False),
    ]
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 51017, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 51018, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 51023, PropCategory.IMPLICIT_RATE)
    prop.label = "egress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 51019, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 51020, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 51022, PropCategory.IMPLICIT_TREND)
    prop.label = "egress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 51021, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 51051, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 51052, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 51057, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 51053, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 51054, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 51056, PropCategory.IMPLICIT_TREND)
    prop.label = "egress unicast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 51055, PropCategory.IMPLICIT_TREND_BASE)
