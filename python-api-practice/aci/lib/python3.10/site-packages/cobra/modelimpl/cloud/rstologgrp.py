...
class RsToLogGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.cloud.RsToLogGrp", "cobra.model.cloud.AwsLogGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsToLogGrp"
    meta.rnFormat = "rstoLogGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relationship to Log Group"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51563, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51482, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51253, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14628
    prop.defaultValueStr = "cloudAwsLogGroup"
    prop._addConstant("cloudAwsLogGroup", None, 14628)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51252, PropCategory.REGULAR)
