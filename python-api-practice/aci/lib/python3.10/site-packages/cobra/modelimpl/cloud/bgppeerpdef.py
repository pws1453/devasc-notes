...
# ##################################################
class BgpPeerPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.BgpPeerPDef")

    meta.moClassName = "cloudBgpPeerPDef"
    meta.rnFormat = "bgppeerpd-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Peer Connectivity Profile Def"
    ...
    meta.parentClasses.add("cobra.model.cloud.L3IfPDef")
    ...
    prop = PropMeta("str", "addr", "addr", 50550, PropCategory.REGULAR)
