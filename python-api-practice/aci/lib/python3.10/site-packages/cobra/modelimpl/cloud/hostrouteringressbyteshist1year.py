...
# ##################################################
class HostRouterIngressBytesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist1year", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist1year"
    meta.rnFormat = "HDcloudHostRouterIngressBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54236, PropCategory.REGULAR)
