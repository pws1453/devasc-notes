...
# ##################################################
class HostRouterIngressPktsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist1w", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist1w"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54243, PropCategory.REGULAR)
