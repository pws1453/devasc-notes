...
# ##################################################
class IngressBytesAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAg1qtr", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAg1qtr"
    meta.rnFormat = "CDcloudIngressBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress bytess stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudIngressBytesAg1qtr', False),
    ]
