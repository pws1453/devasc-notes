...
# ##################################################
class PoolResponseLatencyHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyHist1h", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyHist1h"
    meta.rnFormat = "HDcloudPoolResponseLatency1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool response latency stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolResponseLatency1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52442, PropCategory.REGULAR)
