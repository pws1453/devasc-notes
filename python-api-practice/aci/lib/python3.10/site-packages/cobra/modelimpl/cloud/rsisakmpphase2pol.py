...
# ##################################################
class RsIsakmpPhase2Pol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.cloud.RsIsakmpPhase2Pol", "cobra.model.ipsec.IsakmpPhase2Pol")
    meta.targetNameProps["name"] = "tnIpsecIsakmpPhase2PolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "cloudRsIsakmpPhase2Pol"
    meta.rnFormat = "rsisakmpPhase2Pol-%(tnIpsecIsakmpPhase2PolName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ISAKMP Phase2 Policy"
    ...
    meta.rnPrefixes = [
        ('rsisakmpPhase2Pol-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51530, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51531, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51471, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51217, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15090
    prop.defaultValueStr = "ipsecIsakmpPhase2Pol"
    ...
    prop = PropMeta("str", "tnIpsecIsakmpPhase2PolName", "tnIpsecIsakmpPhase2PolName", 51216, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnIpsecIsakmpPhase2PolName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnIpsecIsakmpPhase2PolName"))
    ...
    def __init__(self, parentMoOrDn, tnIpsecIsakmpPhase2PolName, markDirty=True, **creationProps):
        namingVals = [tnIpsecIsakmpPhase2PolName]
