...
# ##################################################
class IngressBytesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesHist15min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesHist15min"
    meta.rnFormat = "HDcloudIngressBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress bytess stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 50672, PropCategory.REGULAR)
