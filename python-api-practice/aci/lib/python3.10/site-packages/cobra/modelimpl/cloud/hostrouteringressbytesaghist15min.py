...
# ##################################################
class HostRouterIngressBytesAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist15min", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist15min"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterIngressBytesAgHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54222, PropCategory.REGULAR)
