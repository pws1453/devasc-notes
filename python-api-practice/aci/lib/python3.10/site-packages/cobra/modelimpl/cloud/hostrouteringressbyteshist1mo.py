...
# ##################################################
class HostRouterIngressBytesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist1mo", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist1mo"
    meta.rnFormat = "HDcloudHostRouterIngressBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54233, PropCategory.REGULAR)
