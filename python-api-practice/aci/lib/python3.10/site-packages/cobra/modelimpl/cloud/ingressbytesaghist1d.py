...
# ##################################################
class IngressBytesAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist1d", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist1d"
    meta.rnFormat = "HDcloudIngressBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50665, PropCategory.REGULAR)
