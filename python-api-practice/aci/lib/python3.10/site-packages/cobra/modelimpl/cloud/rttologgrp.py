...
class RtToLogGrp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.cloud.RtToLogGrp", "cobra.model.cloud.AwsFlowLogPol")

    meta.moClassName = "cloudRtToLogGrp"
    meta.rnFormat = "rttoLogGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51255, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51254, PropCategory.REGULAR)
