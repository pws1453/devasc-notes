...
# ##################################################
class HostRouterEgressBytes15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes15min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes15min"
    meta.rnFormat = "CDcloudHostRouterEgressBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterEgressBytes")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes15min', False),
    ]
