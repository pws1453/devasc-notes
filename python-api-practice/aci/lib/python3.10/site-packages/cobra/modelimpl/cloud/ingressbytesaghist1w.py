...
# ##################################################
class IngressBytesAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist1w", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist1w"
    meta.rnFormat = "HDcloudIngressBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50669, PropCategory.REGULAR)
