...
# ##################################################
class HostRouterEgressBytesAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg1qtr", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg1qtr"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg1qtr', False),
    ]
