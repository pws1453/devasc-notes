...
# ##################################################
class HostRouterIngressPktsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg5min", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg5min"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg5min', False),
    ]
