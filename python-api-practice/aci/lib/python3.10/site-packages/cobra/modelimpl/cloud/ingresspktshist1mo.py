...
# ##################################################
class IngressPktsHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist1mo", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist1mo"
    meta.rnFormat = "HDcloudIngressPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50691, PropCategory.REGULAR)
