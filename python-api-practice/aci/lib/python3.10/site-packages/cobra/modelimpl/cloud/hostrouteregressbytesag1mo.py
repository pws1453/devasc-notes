...
# ##################################################
class HostRouterEgressBytesAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg1mo", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg1mo"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg1mo', False),
    ]
