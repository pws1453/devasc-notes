...
# ##################################################
class AppGwStatsHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist"


    meta.moClassName = "cloudAppGwStatsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist15min")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist1year")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist5min")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist1h")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStatsHist1d")
