...
# ##################################################
class EgressPktsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist1h", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist1h"
    meta.rnFormat = "HDcloudEgressPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50640, PropCategory.REGULAR)
