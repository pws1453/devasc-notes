...
# ##################################################
class PoolHealthStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist1year", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist1year"
    meta.rnFormat = "HDcloudPoolHealthStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudPoolHealthStats1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 52429, PropCategory.REGULAR)
