...
# ##################################################
class LBStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist1h", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist1h"
    meta.rnFormat = "HDcloudLBStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 52407, PropCategory.REGULAR)
