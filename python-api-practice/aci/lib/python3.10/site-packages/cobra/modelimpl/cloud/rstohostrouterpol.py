...
# ##################################################
class RsToHostRouterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.cloud.RsToHostRouterPol", "cobra.model.cloud.HostRouterPol")
    meta.targetNameProps["name"] = "tnCloudHostRouterPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsToHostRouterPol"
    meta.rnFormat = "rstoHostRouterPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachment to Host Router Pol"
    ...
    meta.rnPrefixes = [
        ('rstoHostRouterPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51500, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51501, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51464, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51205, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14411
    prop.defaultValueStr = "cloudHostRouterPol"
    ...
    prop = PropMeta("str", "tnCloudHostRouterPolName", "tnCloudHostRouterPolName", 51204, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCloudHostRouterPolName", prop)
