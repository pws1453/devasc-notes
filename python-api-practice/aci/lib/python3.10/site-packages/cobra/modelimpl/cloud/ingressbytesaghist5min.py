...
# ##################################################
class IngressBytesAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist5min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist5min"
    meta.rnFormat = "HDcloudIngressBytesAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDcloudIngressBytesAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50671, PropCategory.REGULAR)
