...
# ##################################################
class EgressBytesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist1year", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist1year"
    meta.rnFormat = "HDcloudEgressBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 50636, PropCategory.REGULAR)
