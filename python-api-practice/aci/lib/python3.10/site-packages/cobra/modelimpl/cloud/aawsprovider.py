...
# ##################################################
class AAwsProvider(Mo):
    meta = ClassMeta("cobra.model.cloud.AAwsProvider")

    meta.isAbstract = True
    meta.moClassName = "cloudAAwsProvider"


    meta.moClassName = "cloudAAwsProvider"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "cloud AWS Provider"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.AwsProvider")
    meta.concreteSubClasses.add("cobra.model.cloud.AwsProviderDef")
