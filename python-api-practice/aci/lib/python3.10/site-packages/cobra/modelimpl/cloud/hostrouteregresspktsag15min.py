...
# ##################################################
class HostRouterEgressPktsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg15min", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg15min"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.HostRouterEgressPktsAg")

    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg15min', False),
    ]
