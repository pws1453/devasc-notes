...
# ##################################################
class IngressPktsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAgHist1qtr", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAgHist1qtr"
    meta.rnFormat = "HDcloudIngressPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 50684, PropCategory.REGULAR)
