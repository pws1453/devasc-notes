...
# ##################################################
class IngressBytesHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesHist1mo", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesHist1mo"
    meta.rnFormat = "HDcloudIngressBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress bytess stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 50675, PropCategory.REGULAR)
