...
# ##################################################
class AppGwStatsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist1mo", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist1mo"
    meta.rnFormat = "HDcloudAppGwStatsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 55355, PropCategory.REGULAR)
