...
# ##################################################
class HostRouterEgressPktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsHist1d", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsHist1d"
    meta.rnFormat = "HDcloudHostRouterEgressPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPkts1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54215, PropCategory.REGULAR)
