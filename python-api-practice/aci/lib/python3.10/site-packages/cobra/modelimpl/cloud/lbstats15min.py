...
# ##################################################
class LBStats15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStats15min", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStats15min"
    meta.rnFormat = "CDcloudLBStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB front end stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.LBStats")

    meta.rnPrefixes = [
        ('CDcloudLBStats15min', False),
    ]
