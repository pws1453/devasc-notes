...
# ##################################################
class LBStatsHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist5min", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist5min"
    meta.rnFormat = "HDcloudLBStats5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 52412, PropCategory.REGULAR)
