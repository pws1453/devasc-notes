...
# ##################################################
class HostRouterEgressBytesAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg5min", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg5min"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg5min', False),
    ]
