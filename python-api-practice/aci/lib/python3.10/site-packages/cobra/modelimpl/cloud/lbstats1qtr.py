...
# ##################################################
class LBStats1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStats1qtr", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStats1qtr"
    meta.rnFormat = "CDcloudLBStats1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB front end stats stats in 1 quarter"
