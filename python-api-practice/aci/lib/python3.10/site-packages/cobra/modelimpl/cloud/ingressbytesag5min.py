...
# ##################################################
class IngressBytesAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAg5min", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAg5min"
    meta.rnFormat = "CDcloudIngressBytesAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress bytess stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudIngressBytesAg5min', False),
    ]
