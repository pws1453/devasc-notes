...
# ##################################################
class AppGwStatsHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist15min", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist15min"
    meta.rnFormat = "HDcloudAppGwStats15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 55360, PropCategory.REGULAR)
