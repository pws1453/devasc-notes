...
# ##################################################
class HostRouterIngressBytesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist1d", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist1d"
    meta.rnFormat = "HDcloudHostRouterIngressBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54231, PropCategory.REGULAR)
