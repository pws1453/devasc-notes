...
# ##################################################
class HostRouterIngressPktsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist1year", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist1year"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54244, PropCategory.REGULAR)
