...
class LIfDef(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.LIfDef")

    meta.moClassName = "cloudLIfDef"
    meta.rnFormat = "lifdef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud LIf Resolved Data"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51963, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 51879, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
