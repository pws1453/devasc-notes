...
# ##################################################
class AppGwStatsHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist1h", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist1h"
    meta.rnFormat = "HDcloudAppGwStats1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 55362, PropCategory.REGULAR)
