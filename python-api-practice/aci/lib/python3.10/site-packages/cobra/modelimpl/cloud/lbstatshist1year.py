...
# ##################################################
class LBStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsHist1year", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsHist1year"
    meta.rnFormat = "HDcloudLBStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB front end stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 52411, PropCategory.REGULAR)
