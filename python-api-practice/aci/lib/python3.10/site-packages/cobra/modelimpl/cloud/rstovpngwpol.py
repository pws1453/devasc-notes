...
# ##################################################
class RsToVpnGwPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.cloud.RsToVpnGwPol", "cobra.model.cloud.VpnGwPol")
    meta.targetNameProps["name"] = "tnCloudVpnGwPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsToVpnGwPol"
    meta.rnFormat = "rstoVpnGwPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attachment to VPN GW Pol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51496, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51497, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51462, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51209, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14415
    prop.defaultValueStr = "cloudVpnGwPol"
    ...
    prop = PropMeta("str", "tnCloudVpnGwPolName", "tnCloudVpnGwPolName", 51208, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnCloudVpnGwPolName", prop)
