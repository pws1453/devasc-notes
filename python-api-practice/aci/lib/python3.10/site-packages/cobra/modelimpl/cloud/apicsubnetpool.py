...
# ##################################################
class ApicSubnetPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.ApicSubnetPool")

    meta.moClassName = "cloudApicSubnetPool"
    meta.rnFormat = "apicsubnetpool-[%(subnet)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Apic Subnet Pool"
    ...
    meta.childClasses.add("cobra.model.cloud.ApicSubnet")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.ApicSubnet", "apicsubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))

    meta.parentClasses.add("cobra.model.fv.Tenant")

    meta.superClasses.add("cobra.model.cloud.AApicSubnetPool")

    meta.rnPrefixes = [
        ('apicsubnetpool-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 52870, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52871, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "subnet", "subnet", 52861, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
