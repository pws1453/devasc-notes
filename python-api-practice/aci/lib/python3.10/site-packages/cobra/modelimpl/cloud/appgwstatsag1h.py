...
# ##################################################
class AppGwStatsAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg1h", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg1h"
    meta.rnFormat = "CDcloudAppGwStatsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats in 1 hour"
