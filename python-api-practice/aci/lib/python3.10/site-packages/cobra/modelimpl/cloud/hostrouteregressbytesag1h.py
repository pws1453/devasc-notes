...
# ##################################################
class HostRouterEgressBytesAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg1h", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg1h"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg1h', False),
    ]
