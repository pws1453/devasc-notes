...
# ##################################################
class HostRouterIngressBytesAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesAgHist1mo", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesAgHist1mo"
    meta.rnFormat = "HDcloudHostRouterIngressBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router cloud ingress bytess stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytesAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54225, PropCategory.REGULAR)
