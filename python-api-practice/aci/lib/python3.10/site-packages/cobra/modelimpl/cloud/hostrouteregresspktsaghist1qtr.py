...
# ##################################################
class HostRouterEgressPktsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist1qtr", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist1qtr"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54210, PropCategory.REGULAR)
