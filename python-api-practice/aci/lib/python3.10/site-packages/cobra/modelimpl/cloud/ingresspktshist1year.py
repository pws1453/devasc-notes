...
# ##################################################
class IngressPktsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsHist1year", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsHist1year"
    meta.rnFormat = "HDcloudIngressPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 50694, PropCategory.REGULAR)
