...
# ##################################################
class HostRouterIngressPktsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAgHist1mo", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAgHist1mo"
    meta.rnFormat = "HDcloudHostRouterIngressPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router ingress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPktsAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54241, PropCategory.REGULAR)
