...
# ##################################################
class EgressPktsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist1year", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist1year"
    meta.rnFormat = "HDcloudEgressPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 50644, PropCategory.REGULAR)
