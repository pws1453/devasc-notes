...
# ##################################################
class HostRouterEgressBytesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist1w", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist1w"
    meta.rnFormat = "HDcloudHostRouterEgressBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54203, PropCategory.REGULAR)
