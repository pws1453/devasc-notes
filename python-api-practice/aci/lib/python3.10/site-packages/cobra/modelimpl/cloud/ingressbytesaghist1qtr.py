...
# ##################################################
class IngressBytesAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesAgHist1qtr", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesAgHist1qtr"
    meta.rnFormat = "HDcloudIngressBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud ingress bytess stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudIngressBytesAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 50668, PropCategory.REGULAR)
