...
# ##################################################
class PoolResponseLatency1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency1qtr", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency1qtr"
    meta.rnFormat = "CDcloudPoolResponseLatency1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatency1qtr', False),
    ]
