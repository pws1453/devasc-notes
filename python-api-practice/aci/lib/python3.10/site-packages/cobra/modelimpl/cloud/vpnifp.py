...
class VpnIfP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.VpnIfP")

    meta.moClassName = "cloudVpnIfP"
    meta.rnFormat = "vpnifp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud VGW VPN Interface Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51518, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51519, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50717, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
