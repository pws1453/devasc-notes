...
# ##################################################
class HostRouterEgressPkts1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPkts1d", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPkts1d"
    meta.rnFormat = "CDcloudHostRouterEgressPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPkts1d', False),
    ]
