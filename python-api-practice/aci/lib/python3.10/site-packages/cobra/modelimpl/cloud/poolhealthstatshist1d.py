...
# ##################################################
class PoolHealthStatsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsHist1d", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsHist1d"
    meta.rnFormat = "HDcloudPoolHealthStats1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ALB back end pool health stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 52424, PropCategory.REGULAR)
