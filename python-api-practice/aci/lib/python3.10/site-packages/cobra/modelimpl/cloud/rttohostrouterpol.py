...
# ##################################################
class RtToHostRouterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtToHostRouterPol", "cobra.model.cloud.RouterP")

    meta.moClassName = "cloudRtToHostRouterPol"
    meta.rnFormat = "rttoHostRouterPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51207, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14399
    prop.defaultValueStr = "cloudRouterP"
    prop._addConstant("cloudRouterP", None, 14399)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51206, PropCategory.REGULAR)
