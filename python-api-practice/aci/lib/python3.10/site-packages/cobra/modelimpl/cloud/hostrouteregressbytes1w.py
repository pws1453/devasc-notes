...
# ##################################################
class HostRouterEgressBytes1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytes1w", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytes1w"
    meta.rnFormat = "CDcloudHostRouterEgressBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router egress bytes stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytes1w', False),
    ]
