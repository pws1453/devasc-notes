...
# ##################################################
class PoolHealthStatsAgHist(Mo):
    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAgHist", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAgHist"


    meta.moClassName = "cloudPoolHealthStatsAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB back end pool health stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist1w")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist15min")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist1year")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist1d")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist5min")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolHealthStatsAgHist1h")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "HealthyHostCountCum", "HealthyHostCountCum", 52587, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Pool healthy hosts count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HealthyHostCountCum", prop)

    prop = PropMeta("str", "HealthyHostCountPer", "HealthyHostCountPer", 52588, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Pool healthy hosts count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HealthyHostCountPer", prop)

    prop = PropMeta("str", "HealthyHostCountRate", "HealthyHostCountRate", 52592, PropCategory.IMPLICIT_RATE)
    prop.label = "Pool healthy hosts count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HealthyHostCountRate", prop)

    prop = PropMeta("str", "HealthyHostCountSpct", "HealthyHostCountSpct", 52589, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Pool healthy hosts count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HealthyHostCountSpct", prop)

    prop = PropMeta("str", "HealthyHostCountThr", "HealthyHostCountThr", 52590, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "HealthyHostCountTr", "HealthyHostCountTr", 52591, PropCategory.IMPLICIT_TREND)
    prop.label = "Pool healthy hosts count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("HealthyHostCountTr", prop)

    prop = PropMeta("str", "UnHealthyHostCountCum", "UnHealthyHostCountCum", 52621, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Pool unhealthy hosts count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("UnHealthyHostCountCum", prop)

    prop = PropMeta("str", "UnHealthyHostCountPer", "UnHealthyHostCountPer", 52622, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Pool unhealthy hosts count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("UnHealthyHostCountPer", prop)

    prop = PropMeta("str", "UnHealthyHostCountRate", "UnHealthyHostCountRate", 52626, PropCategory.IMPLICIT_RATE)
    prop.label = "Pool unhealthy hosts count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("UnHealthyHostCountRate", prop)

    prop = PropMeta("str", "UnHealthyHostCountSpct", "UnHealthyHostCountSpct", 52623, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Pool unhealthy hosts count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("UnHealthyHostCountSpct", prop)

    prop = PropMeta("str", "UnHealthyHostCountThr", "UnHealthyHostCountThr", 52624, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "UnHealthyHostCountTr", "UnHealthyHostCountTr", 52625, PropCategory.IMPLICIT_TREND)
