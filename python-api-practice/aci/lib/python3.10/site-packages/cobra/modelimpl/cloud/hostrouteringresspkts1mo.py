...
# ##################################################
class HostRouterIngressPkts1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPkts1mo", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPkts1mo"
    meta.rnFormat = "CDcloudHostRouterIngressPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router ingress packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPkts1mo', False),
    ]
