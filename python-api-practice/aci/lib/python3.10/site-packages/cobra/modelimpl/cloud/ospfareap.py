...
class OspfAreaP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.OspfAreaP")

    meta.moClassName = "cloudOspfAreaP"
    meta.rnFormat = "ospfareap-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Area Policy"
    ...
    meta.superClasses.add("cobra.model.cloud.AOspfAreaP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 51534, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "areaType", "areaType", 50139, PropCategory.REGULAR)
    prop.label = "OSPF Area Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "nssa"
    prop._addConstant("nssa", "nssa", 0)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51535, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 50704, PropCategory.REGULAR)
    prop.label = "OSPF Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
