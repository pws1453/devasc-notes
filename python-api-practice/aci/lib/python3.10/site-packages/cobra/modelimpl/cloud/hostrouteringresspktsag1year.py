...
# ##################################################
class HostRouterIngressPktsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsAg1year", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsAg1year"
    meta.rnFormat = "CDcloudHostRouterIngressPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressPktsAg1year', False),
    ]
