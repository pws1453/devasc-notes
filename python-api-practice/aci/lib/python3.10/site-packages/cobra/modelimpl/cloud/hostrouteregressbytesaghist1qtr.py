...
# ##################################################
class HostRouterEgressBytesAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAgHist1qtr", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAgHist1qtr"
    meta.rnFormat = "HDcloudHostRouterEgressBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress bytes stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytesAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54194, PropCategory.REGULAR)
