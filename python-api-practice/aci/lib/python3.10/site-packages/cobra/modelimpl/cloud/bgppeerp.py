...
class BgpPeerP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.BgpPeerP")

    meta.moClassName = "cloudBgpPeerP"
    meta.rnFormat = "bgppeerp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Peer Connectivity Profile"
    meta.writeAccessMask = 0xc01002001
    ...
    meta.superClasses.add("cobra.model.cloud.ABgpPeerP")

    meta.rnPrefixes = [
        ('bgppeerp-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 50549, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "af", "af", 50101, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 51490, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "asn", "asn", 50103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 50102, PropCategory.REGULAR)
    prop.label = "Control"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("activate", "activate", 128)
    ...
    prop._addConstant("nh-unchanged", "next-hop-unchanged", 512)
    prop._addConstant("rr-client", "route-reflector-client", 4)
    prop._addConstant("send-com", "send-community", 1)
    prop._addConstant("send-ext-com", "send-extended-community", 2)
    prop._addConstant("soft-reconfig-inbound", "soft-reconfig-inbound", 256)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51491, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "password", "password", 50105, PropCategory.REGULAR)
    prop.label = "Password"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ttl", "ttl", 50104, PropCategory.REGULAR)
