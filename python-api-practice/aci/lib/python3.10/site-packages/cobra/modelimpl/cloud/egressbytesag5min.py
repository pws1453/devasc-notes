...
# ##################################################
class EgressBytesAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAg5min", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAg5min"
    meta.rnFormat = "CDcloudEgressBytesAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud egress bytes stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudEgressBytesAg5min', False),
    ]
