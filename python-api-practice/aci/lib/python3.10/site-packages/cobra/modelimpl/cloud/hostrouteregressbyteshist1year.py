...
# ##################################################
class HostRouterEgressBytesHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesHist1year", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesHist1year"
    meta.rnFormat = "HDcloudHostRouterEgressBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressBytes1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54204, PropCategory.REGULAR)
