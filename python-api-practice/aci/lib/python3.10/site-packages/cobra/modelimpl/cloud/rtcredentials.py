...
# ##################################################
class RtCredentials(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtCredentials", "cobra.model.cloud.Account")

    meta.moClassName = "cloudRtCredentials"
    meta.rnFormat = "rtcredentials-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55055, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55054, PropCategory.REGULAR)
