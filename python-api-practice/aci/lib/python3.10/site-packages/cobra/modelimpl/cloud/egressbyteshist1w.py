...
# ##################################################
class EgressBytesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist1w", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist1w"
    meta.rnFormat = "HDcloudEgressBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 50635, PropCategory.REGULAR)
