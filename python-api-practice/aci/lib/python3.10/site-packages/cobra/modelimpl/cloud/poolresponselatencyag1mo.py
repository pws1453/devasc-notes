...
# ##################################################
class PoolResponseLatencyAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatencyAg1mo", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatencyAg1mo"
    meta.rnFormat = "CDcloudPoolResponseLatencyAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool response latency stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolResponseLatencyAg1mo', False),
    ]
