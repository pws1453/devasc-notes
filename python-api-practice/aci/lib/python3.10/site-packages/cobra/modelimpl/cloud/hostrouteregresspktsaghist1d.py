...
# ##################################################
class HostRouterEgressPktsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAgHist1d", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAgHist1d"
    meta.rnFormat = "HDcloudHostRouterEgressPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated host router egress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterEgressPktsAg1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54207, PropCategory.REGULAR)
