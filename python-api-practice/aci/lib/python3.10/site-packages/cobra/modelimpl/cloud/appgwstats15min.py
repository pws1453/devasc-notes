...
# ##################################################
class AppGwStats15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStats15min", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStats15min"
    meta.rnFormat = "CDcloudAppGwStats15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Azure ALB front end stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.cloud.AppGwStats")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDcloudAppGwStats15min', False),
    ]
