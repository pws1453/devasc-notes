...
# ##################################################
class HostRouterEgressPktsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressPktsAg5min", "host router egress packets")
    ...
    meta.moClassName = "cloudHostRouterEgressPktsAg5min"
    meta.rnFormat = "CDcloudHostRouterEgressPktsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressPktsAg5min', False),
    ]
