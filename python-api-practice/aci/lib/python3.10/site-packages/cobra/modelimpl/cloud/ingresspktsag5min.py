...
# ##################################################
class IngressPktsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressPktsAg5min", "cloud ingress packets")
    ...
    meta.moClassName = "cloudIngressPktsAg5min"
    meta.rnFormat = "CDcloudIngressPktsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated cloud ingress packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudIngressPktsAg5min', False),
    ]
