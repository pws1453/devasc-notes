...
# ##################################################
class RtCtxProfileToStatsPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtCtxProfileToStatsPol", "cobra.model.cloud.CtxProfile")

    meta.moClassName = "cloudRtCtxProfileToStatsPol"
    meta.rnFormat = "rtctxProfileToStatsPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55664, PropCategory.REGULAR)
