...
# ##################################################
class HostRouterIngressPktsHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressPktsHist1d", "host router ingress packets")
    ...
    meta.moClassName = "cloudHostRouterIngressPktsHist1d"
    meta.rnFormat = "HDcloudHostRouterIngressPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router ingress packets stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressPkts1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54247, PropCategory.REGULAR)
