...
# ##################################################
class EgressPktsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsAgHist5min", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsAgHist5min"
    meta.rnFormat = "HDcloudEgressPktsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 50645, PropCategory.REGULAR)
