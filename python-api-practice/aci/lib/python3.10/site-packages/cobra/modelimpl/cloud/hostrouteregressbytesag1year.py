...
# ##################################################
class HostRouterEgressBytesAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterEgressBytesAg1year", "host router egress bytes")
    ...
    meta.moClassName = "cloudHostRouterEgressBytesAg1year"
    meta.rnFormat = "CDcloudHostRouterEgressBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated host router egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterEgressBytesAg1year', False),
    ]
