...
# ##################################################
class HostRouterIngressBytes5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytes5min", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytes5min"
    meta.rnFormat = "CDcloudHostRouterIngressBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current host router cloud ingress bytess stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDcloudHostRouterIngressBytes5min', False),
    ]
