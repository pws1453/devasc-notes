...
# ##################################################
class EgressBytes1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytes1w", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytes1w"
    meta.rnFormat = "CDcloudEgressBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud egress bytes stats in 1 week"
