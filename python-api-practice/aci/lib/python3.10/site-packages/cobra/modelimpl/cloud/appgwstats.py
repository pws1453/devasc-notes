...
# ##################################################
class AppGwStats(Mo):
    meta = StatsClassMeta("cobra.model.cloud.AppGwStats", "Azure ALB front end stats")

    counter = CounterMeta("CurrentConnections", CounterCategory.COUNTER, "count", "Azure LB existing connections")
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "CurrentConnectionsLast"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "CurrentConnectionsBase"
    ...
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "FailedRequestsLast"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "FailedRequestsBase"
    ...
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "ThroughputLast"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "ThroughputBase"
    ...
    counter._propRefs[PropCategory.IMPLICIT_LASTREADING] = "TotalRequestsLast"
    ...
    counter._propRefs[PropCategory.IMPLICIT_BASELINE] = "TotalRequestsBase"
    ...
    meta.moClassName = "cloudAppGwStats"


    meta.moClassName = "cloudAppGwStats"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Azure ALB front end stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats1h")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats5min")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats1d")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats1year")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats1w")
    meta.concreteSubClasses.add("cobra.model.cloud.AppGwStats15min")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "CurrentConnectionsAvg", "CurrentConnectionsAvg", 55374, PropCategory.IMPLICIT_AVG)
    prop.label = "Azure LB existing connections average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsAvg", prop)

    prop = PropMeta("str", "CurrentConnectionsBase", "CurrentConnectionsBase", 55369, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Azure LB existing connections baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsBase", prop)

    prop = PropMeta("str", "CurrentConnectionsCum", "CurrentConnectionsCum", 55370, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure LB existing connections cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsCum", prop)

    prop = PropMeta("str", "CurrentConnectionsLast", "CurrentConnectionsLast", 55368, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Azure LB existing connections current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsLast", prop)

    prop = PropMeta("str", "CurrentConnectionsMax", "CurrentConnectionsMax", 55373, PropCategory.IMPLICIT_MAX)
    prop.label = "Azure LB existing connections maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsMax", prop)

    prop = PropMeta("str", "CurrentConnectionsMin", "CurrentConnectionsMin", 55372, PropCategory.IMPLICIT_MIN)
    prop.label = "Azure LB existing connections minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsMin", prop)

    prop = PropMeta("str", "CurrentConnectionsPer", "CurrentConnectionsPer", 55371, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure LB existing connections periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsPer", prop)

    prop = PropMeta("str", "CurrentConnectionsRate", "CurrentConnectionsRate", 55379, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure LB existing connections rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsRate", prop)

    prop = PropMeta("str", "CurrentConnectionsSpct", "CurrentConnectionsSpct", 55375, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure LB existing connections suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsSpct", prop)

    prop = PropMeta("str", "CurrentConnectionsThr", "CurrentConnectionsThr", 55376, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "CurrentConnectionsTr", "CurrentConnectionsTr", 55378, PropCategory.IMPLICIT_TREND)
    prop.label = "Azure LB existing connections trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsTr", prop)

    prop = PropMeta("str", "CurrentConnectionsTrBase", "CurrentConnectionsTrBase", 55377, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Azure LB existing connections trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("CurrentConnectionsTrBase", prop)

    prop = PropMeta("str", "FailedRequestsAvg", "FailedRequestsAvg", 55408, PropCategory.IMPLICIT_AVG)
    prop.label = "Azure LB Failed Requests average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsAvg", prop)

    prop = PropMeta("str", "FailedRequestsBase", "FailedRequestsBase", 55403, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Azure LB Failed Requests baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsBase", prop)

    prop = PropMeta("str", "FailedRequestsCum", "FailedRequestsCum", 55404, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure LB Failed Requests cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsCum", prop)

    prop = PropMeta("str", "FailedRequestsLast", "FailedRequestsLast", 55402, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Azure LB Failed Requests current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsLast", prop)

    prop = PropMeta("str", "FailedRequestsMax", "FailedRequestsMax", 55407, PropCategory.IMPLICIT_MAX)
    prop.label = "Azure LB Failed Requests maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsMax", prop)

    prop = PropMeta("str", "FailedRequestsMin", "FailedRequestsMin", 55406, PropCategory.IMPLICIT_MIN)
    prop.label = "Azure LB Failed Requests minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsMin", prop)

    prop = PropMeta("str", "FailedRequestsPer", "FailedRequestsPer", 55405, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure LB Failed Requests periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsPer", prop)

    prop = PropMeta("str", "FailedRequestsRate", "FailedRequestsRate", 55413, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure LB Failed Requests rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsRate", prop)

    prop = PropMeta("str", "FailedRequestsSpct", "FailedRequestsSpct", 55409, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure LB Failed Requests suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsSpct", prop)

    prop = PropMeta("str", "FailedRequestsThr", "FailedRequestsThr", 55410, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "FailedRequestsTr", "FailedRequestsTr", 55412, PropCategory.IMPLICIT_TREND)
    prop.label = "Azure LB Failed Requests trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsTr", prop)

    prop = PropMeta("str", "FailedRequestsTrBase", "FailedRequestsTrBase", 55411, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Azure LB Failed Requests trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("FailedRequestsTrBase", prop)

    prop = PropMeta("str", "ThroughputAvg", "ThroughputAvg", 55442, PropCategory.IMPLICIT_AVG)
    prop.label = "Azure LB Total Throughput average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputAvg", prop)

    prop = PropMeta("str", "ThroughputBase", "ThroughputBase", 55437, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Azure LB Total Throughput baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputBase", prop)

    prop = PropMeta("str", "ThroughputCum", "ThroughputCum", 55438, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure LB Total Throughput cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputCum", prop)

    prop = PropMeta("str", "ThroughputLast", "ThroughputLast", 55436, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Azure LB Total Throughput current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputLast", prop)

    prop = PropMeta("str", "ThroughputMax", "ThroughputMax", 55441, PropCategory.IMPLICIT_MAX)
    prop.label = "Azure LB Total Throughput maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputMax", prop)

    prop = PropMeta("str", "ThroughputMin", "ThroughputMin", 55440, PropCategory.IMPLICIT_MIN)
    prop.label = "Azure LB Total Throughput minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputMin", prop)

    prop = PropMeta("str", "ThroughputPer", "ThroughputPer", 55439, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure LB Total Throughput periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputPer", prop)

    prop = PropMeta("str", "ThroughputRate", "ThroughputRate", 55447, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure LB Total Throughput rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputRate", prop)

    prop = PropMeta("str", "ThroughputSpct", "ThroughputSpct", 55443, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure LB Total Throughput suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputSpct", prop)

    prop = PropMeta("str", "ThroughputThr", "ThroughputThr", 55444, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "ThroughputTr", "ThroughputTr", 55446, PropCategory.IMPLICIT_TREND)
    prop.label = "Azure LB Total Throughput trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputTr", prop)

    prop = PropMeta("str", "ThroughputTrBase", "ThroughputTrBase", 55445, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Azure LB Total Throughput trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ThroughputTrBase", prop)

    prop = PropMeta("str", "TotalRequestsAvg", "TotalRequestsAvg", 55476, PropCategory.IMPLICIT_AVG)
    prop.label = "Azure Native LB requests count average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsAvg", prop)

    prop = PropMeta("str", "TotalRequestsBase", "TotalRequestsBase", 55471, PropCategory.IMPLICIT_BASELINE)
    prop.label = "Azure Native LB requests count baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsBase", prop)

    prop = PropMeta("str", "TotalRequestsCum", "TotalRequestsCum", 55472, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Azure Native LB requests count cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsCum", prop)

    prop = PropMeta("str", "TotalRequestsLast", "TotalRequestsLast", 55470, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Azure Native LB requests count current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsLast", prop)

    prop = PropMeta("str", "TotalRequestsMax", "TotalRequestsMax", 55475, PropCategory.IMPLICIT_MAX)
    prop.label = "Azure Native LB requests count maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsMax", prop)

    prop = PropMeta("str", "TotalRequestsMin", "TotalRequestsMin", 55474, PropCategory.IMPLICIT_MIN)
    prop.label = "Azure Native LB requests count minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsMin", prop)

    prop = PropMeta("str", "TotalRequestsPer", "TotalRequestsPer", 55473, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Azure Native LB requests count periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsPer", prop)

    prop = PropMeta("str", "TotalRequestsRate", "TotalRequestsRate", 55481, PropCategory.IMPLICIT_RATE)
    prop.label = "Azure Native LB requests count rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsRate", prop)

    prop = PropMeta("str", "TotalRequestsSpct", "TotalRequestsSpct", 55477, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Azure Native LB requests count suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsSpct", prop)

    prop = PropMeta("str", "TotalRequestsThr", "TotalRequestsThr", 55478, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "TotalRequestsTr", "TotalRequestsTr", 55480, PropCategory.IMPLICIT_TREND)
    prop.label = "Azure Native LB requests count trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("TotalRequestsTr", prop)

    prop = PropMeta("str", "TotalRequestsTrBase", "TotalRequestsTrBase", 55479, PropCategory.IMPLICIT_TREND_BASE)
