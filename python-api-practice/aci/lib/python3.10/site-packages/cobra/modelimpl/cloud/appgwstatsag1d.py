...
# ##################################################
class AppGwStatsAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg1d", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg1d"
    meta.rnFormat = "CDcloudAppGwStatsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats in 1 day"
