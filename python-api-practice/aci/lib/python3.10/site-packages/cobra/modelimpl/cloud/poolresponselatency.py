...
# ##################################################
class PoolResponseLatency(Mo):
    meta = StatsClassMeta("cobra.model.cloud.PoolResponseLatency", "ALB back end pool response latency")
    ...
    meta.moClassName = "cloudPoolResponseLatency"


    meta.moClassName = "cloudPoolResponseLatency"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool response latency stats"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency1qtr")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency5min")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency1w")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency1h")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency15min")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency1mo")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency1year")
    meta.concreteSubClasses.add("cobra.model.cloud.PoolResponseLatency1d")
