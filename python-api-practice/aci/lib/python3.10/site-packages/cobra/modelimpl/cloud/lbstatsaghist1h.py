...
# ##################################################
class LBStatsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist1h", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist1h"
    meta.rnFormat = "HDcloudLBStatsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 52399, PropCategory.REGULAR)
