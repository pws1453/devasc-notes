...
# ##################################################
class RsLDevToCloudSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsLDevToCloudSubnet", "cobra.model.cloud.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "cloudRsLDevToCloudSubnet"
    meta.rnFormat = "rsLDevToCloudSubnet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Cloud LDev to Cloud Subnet"
    ...
    meta.rnPrefixes = [
        ('rsLDevToCloudSubnet-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51975, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51976, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51957, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 51916, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14606
    prop.defaultValueStr = "cloudSubnet"
    prop._addConstant("cloudSubnet", None, 14606)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51915, PropCategory.REGULAR)
