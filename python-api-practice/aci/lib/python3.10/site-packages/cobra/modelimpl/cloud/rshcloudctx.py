...
# ##################################################
class RsHcloudCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsHcloudCtx", "cobra.model.hcloud.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "cloudRsHcloudCtx"
    meta.rnFormat = "rshcloudCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EpP under an hcloudCtx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51552, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51553, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51249, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51248, PropCategory.REGULAR)
