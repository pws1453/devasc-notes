...
class RouterP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.RouterP")

    meta.moClassName = "cloudRouterP"
    meta.rnFormat = "routerp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Router Profile"
    ...
    meta.childClasses.add("cobra.model.cloud.ExtNetworkP")
    meta.childClasses.add("cobra.model.cloud.RsToVpnGwPol")
    meta.childClasses.add("cobra.model.cloud.IntNetworkP")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.health.NodeInst")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.cloud.RsToHostRouterPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsToHostRouterPol", "rstoHostRouterPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.ExtNetworkP", "extnetworkp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RsToVpnGwPol", "rstoVpnGwPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.IntNetworkP", "intnetworkp-"))
    ...
    meta.superClasses.add("cobra.model.cloud.ARouterP")

    meta.rnPrefixes = [
        ('routerp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51494, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51495, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 51461, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "mss", "mss", 62447, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 50711, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "numInstances", "numInstances", 50108, PropCategory.REGULAR)
    prop.label = "Number of Host Router Instances in the Cluster"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("numInstances", prop)
    ...
    prop = PropMeta("str", "type", "type", 50107, PropCategory.REGULAR)
    prop.label = "Cloud Router Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "vpn-gw"
    prop._addConstant("host-router", "host-router", 1)
    prop._addConstant("vpn-gw", "vpn-gw", 0)
