...
# ##################################################
class AppGwStatsAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg1qtr", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg1qtr"
    meta.rnFormat = "CDcloudAppGwStatsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats in 1 quarter"
