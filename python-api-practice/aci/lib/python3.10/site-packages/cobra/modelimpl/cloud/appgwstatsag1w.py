...
# ##################################################
class AppGwStatsAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAg1w", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAg1w"
    meta.rnFormat = "CDcloudAppGwStatsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Azure ALB front end stats stats in 1 week"
