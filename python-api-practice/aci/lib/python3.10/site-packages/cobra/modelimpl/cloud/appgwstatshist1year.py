...
# ##################################################
class AppGwStatsHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsHist1year", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsHist1year"
    meta.rnFormat = "HDcloudAppGwStats1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Azure ALB front end stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 55366, PropCategory.REGULAR)
