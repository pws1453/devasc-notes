...
# ##################################################
class AppGwStatsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist1qtr", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist1qtr"
    meta.rnFormat = "HDcloudAppGwStatsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 55356, PropCategory.REGULAR)
