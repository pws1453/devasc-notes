...
# ##################################################
class EgressBytesHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist1d", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist1d"
    meta.rnFormat = "HDcloudEgressBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 50631, PropCategory.REGULAR)
