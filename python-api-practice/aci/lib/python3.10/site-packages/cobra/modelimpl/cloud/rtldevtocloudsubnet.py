...
# ##################################################
class RtLDevToCloudSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtLDevToCloudSubnet", "cobra.model.cloud.ALDev")

    meta.moClassName = "cloudRtLDevToCloudSubnet"
    meta.rnFormat = "rtLDevToCloudSubnet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Cloud L4-L7 Abstract Devices"
    meta.writeAccessMask = 0x1002001
    meta.readAccessMask = 0x6000000001002001
    ...
    prop = PropMeta("str", "tCl", "tCl", 51918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51917, PropCategory.REGULAR)
