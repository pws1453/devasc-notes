...
# ##################################################
class HostRouterIngressBytesHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.HostRouterIngressBytesHist1w", "host router cloud ingress bytess")
    ...
    meta.moClassName = "cloudHostRouterIngressBytesHist1w"
    meta.rnFormat = "HDcloudHostRouterIngressBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical host router cloud ingress bytess stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDcloudHostRouterIngressBytes1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 54235, PropCategory.REGULAR)
