...
# ##################################################
class PoolHealthStats1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStats1mo", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStats1mo"
    meta.rnFormat = "CDcloudPoolHealthStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ALB back end pool health stats stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStats1mo', False),
    ]
