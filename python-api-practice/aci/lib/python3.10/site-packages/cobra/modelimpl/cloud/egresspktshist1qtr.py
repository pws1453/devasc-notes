...
# ##################################################
class EgressPktsHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressPktsHist1qtr", "cloud egress packets")
    ...
    meta.moClassName = "cloudEgressPktsHist1qtr"
    meta.rnFormat = "HDcloudEgressPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 50650, PropCategory.REGULAR)
