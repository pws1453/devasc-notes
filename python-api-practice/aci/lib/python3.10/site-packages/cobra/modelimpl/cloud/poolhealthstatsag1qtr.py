...
# ##################################################
class PoolHealthStatsAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.PoolHealthStatsAg1qtr", "ALB back end pool health stats")
    ...
    meta.moClassName = "cloudPoolHealthStatsAg1qtr"
    meta.rnFormat = "CDcloudPoolHealthStatsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ALB back end pool health stats stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDcloudPoolHealthStatsAg1qtr', False),
    ]
