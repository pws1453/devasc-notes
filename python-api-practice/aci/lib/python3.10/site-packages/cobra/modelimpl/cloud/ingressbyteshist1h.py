...
# ##################################################
class IngressBytesHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytesHist1h", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytesHist1h"
    meta.rnFormat = "HDcloudIngressBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud ingress bytess stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50674, PropCategory.REGULAR)
