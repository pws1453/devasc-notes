...
class Entity(Mo):
    """
    A stub to categorize the runtime states of the interface manager module.

    """

    meta = ClassMeta("cobra.model.im.Entity")

    meta.moClassName = "imEntity"
    meta.rnFormat = "im"
    meta.category = MoCategory.REGULAR
    meta.label = "Interface Manager Entity"
    ...
    meta.childClasses.add("cobra.model.im.Inst")
    meta.childClasses.add("cobra.model.im.ForcedBrkoutInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.im.ForcedBrkoutInst", "forcedBrkoutInst"))
    meta.childNamesAndRnPrefix.append(("cobra.model.im.Inst", "inst"))
