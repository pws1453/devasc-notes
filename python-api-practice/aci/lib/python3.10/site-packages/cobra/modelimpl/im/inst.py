...
class Inst(Mo):
    """
    A container that stores the global runtime state of the interface manager module.

    """

    meta = ClassMeta("cobra.model.im.Inst")

    meta.moClassName = "imInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Interface Manager Instance"
    ...
    meta.childClasses.add("cobra.model.im.Capability")
    meta.childClasses.add("cobra.model.im.Module")

    meta.childNamesAndRnPrefix.append(("cobra.model.im.Module", "module-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.im.Capability", "cap-"))

    meta.parentClasses.add("cobra.model.im.Entity")
    ...
    prop = PropMeta("str", "numCaps", "numCaps", 4009, PropCategory.REGULAR)
    prop.label = "Number of Feature/software Capabilities"
    prop.isOper = True
    meta.props.add("numCaps", prop)
    ...
    prop = PropMeta("str", "vdcSt", "vdcSt", 4010, PropCategory.REGULAR)
    prop.label = "Default VDC State"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "not-created"
    prop._addConstant("cleanup", "cleanup", 2)
    prop._addConstant("created", "created", 1)
    prop._addConstant("not-created", "not-created", 0)
    meta.props.add("vdcSt", prop)
