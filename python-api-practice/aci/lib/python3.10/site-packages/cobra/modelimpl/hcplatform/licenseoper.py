...
# ##################################################
class LicenseOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcplatform.LicenseOper")

    meta.moClassName = "hcplatformLicenseOper"
    meta.rnFormat = "oper"
    meta.category = MoCategory.REGULAR
    meta.label = "License Oper Mo"
    ...
    prop = PropMeta("str", "licenseExp", "licenseExp", 53080, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("licenseExp", prop)
    ...
    prop = PropMeta("str", "throughput", "throughput", 53081, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
