...
class License(Mo):
    ...
    meta = ClassMeta("cobra.model.hcplatform.License")

    meta.moClassName = "hcplatformLicense"
    meta.rnFormat = "license"
    ...
    meta.childClasses.add("cobra.model.hcplatform.LicenseOper")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcplatform.LicenseOper", "oper"))
    ...
    prop = PropMeta("str", "token", "token", 50447, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
