...
class RtTunnIf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hctunn.RtTunnIf", "cobra.model.hcospf.Dom")

    meta.moClassName = "hctunnRtTunnIf"
    meta.rnFormat = "rttunnIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51371, PropCategory.REGULAR)
