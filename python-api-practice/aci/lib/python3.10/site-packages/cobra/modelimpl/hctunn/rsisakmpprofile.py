...
# ##################################################
class RsIsakmpProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hctunn.RsIsakmpProfile", "cobra.model.hcisakmp.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hctunnRsIsakmpProfile"
    meta.rnFormat = "rsisakmpProfile"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51377, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51376, PropCategory.REGULAR)
