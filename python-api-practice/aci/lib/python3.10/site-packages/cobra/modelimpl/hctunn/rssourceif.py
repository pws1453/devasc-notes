...
class RsSourceIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hctunn.RsSourceIf", "cobra.model.hcl1.PhysicalIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hctunnRsSourceIf"
    meta.rnFormat = "rssourceIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51381, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14857
    prop.defaultValueStr = "hcl1PhysicalIf"
    prop._addConstant("hcl1PhysicalIf", None, 14857)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51380, PropCategory.REGULAR)
