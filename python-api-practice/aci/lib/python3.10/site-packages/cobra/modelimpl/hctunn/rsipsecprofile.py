...
# ##################################################
class RsIpsecProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hctunn.RsIpsecProfile", "cobra.model.hcipsec.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hctunnRsIpsecProfile"
    meta.rnFormat = "rsipsecProfile"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51373, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51372, PropCategory.REGULAR)
