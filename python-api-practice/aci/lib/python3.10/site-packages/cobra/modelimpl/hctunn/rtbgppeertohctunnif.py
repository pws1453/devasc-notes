...
# ##################################################
class RtBgpPeerTohctunnIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hctunn.RtBgpPeerTohctunnIf", "cobra.model.hcbgp.Peer")

    meta.moClassName = "hctunnRtBgpPeerTohctunnIf"
    meta.rnFormat = "rtbgpPeerTohctunnIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51265, PropCategory.REGULAR)
