...
# ##################################################
class RsIkev2Profile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hctunn.RsIkev2Profile", "cobra.model.hcisakmp.Ikev2Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hctunnRsIkev2Profile"
    meta.rnFormat = "rsikev2Profile"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54989, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54988, PropCategory.REGULAR)
