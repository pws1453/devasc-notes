...
class PfxP(Mo):
    ...
    meta = ClassMeta("cobra.model.nd.PfxP")

    meta.moClassName = "ndPfxP"
    meta.rnFormat = "ndpfxP"
    ...
    meta.childClasses.add("cobra.model.nd.RsPfxPToNdPfxPol")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.nd.RsPfxPToNdPfxPol", "rsPfxPToNdPfxPol"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38788, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40927, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35586, PropCategory.REGULAR)
