...
class RaSubnet(Mo):
    ...
    meta = ClassMeta("cobra.model.nd.RaSubnet")

    meta.moClassName = "ndRaSubnet"
    meta.rnFormat = "RaSubnet-[%(ip)s]"
    ...
    meta.childClasses.add("cobra.model.nd.RsRaSubnetToNdPfxPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.nd.RsRaSubnetToNdPfxPol", "rsRaSubnetToNdPfxPol"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38219, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40358, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 18619, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18625, PropCategory.REGULAR)
