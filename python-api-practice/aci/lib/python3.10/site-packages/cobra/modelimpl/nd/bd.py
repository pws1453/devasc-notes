...
class BD(Mo):
    ...
    meta = ClassMeta("cobra.model.nd.BD")

    meta.moClassName = "ndBD"
    meta.rnFormat = "bd-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ND Bd Domain"
    ...
    meta.childClasses.add("cobra.model.nd.SvcAdjEp")
    meta.childClasses.add("cobra.model.nd.CktEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.nd.SvcAdjEp", "svcadj-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nd.CktEp", "cktep-"))
    ...
    prop = PropMeta("str", "encap", "encap", 27162, PropCategory.REGULAR)
