...
# ##################################################
class RsPfxPToNdPfxPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.nd.RsPfxPToNdPfxPol", "cobra.model.nd.PfxPol")
    meta.targetNameProps["name"] = "tnNdPfxPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ndRsPfxPToNdPfxPol"
    meta.rnFormat = "rsPfxPToNdPfxPol"
    ...
    meta.rnPrefixes = [
        ('rsPfxPToNdPfxPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38789, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40928, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35582, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNdPfxPolName", "tnNdPfxPolName", 35581, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
