...
class StAdjEp(Mo):
    """
    The static neighbor discovery adjacency definitions.

    """

    meta = ClassMeta("cobra.model.nd.StAdjEp")

    meta.moClassName = "ndStAdjEp"
    meta.rnFormat = "sadj-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ND Static Adjacency"
    ...
    meta.childClasses.add("cobra.model.nd.RtEpDefRefToStAdjEpV6")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.nd.RtEpDefRefToStAdjEpV6", "rtfvEpDefRefToStAdjEpV6-"))
    ...
    meta.superClasses.add("cobra.model.nd.AAdjEp")
    ...
    prop = PropMeta("str", "addr", "addr", 17472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37201, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 17074, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 17075, PropCategory.REGULAR)
