...
class Entity(Mo):
    """
    The neighbor discovery protocol entity information.

    """

    meta = ClassMeta("cobra.model.nd.Entity")

    meta.moClassName = "ndEntity"
    meta.rnFormat = "nd"
    meta.category = MoCategory.REGULAR
    meta.label = "Neighbor Discover Entity"
    ...
    meta.childClasses.add("cobra.model.nd.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nd.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14459, PropCategory.REGULAR)
