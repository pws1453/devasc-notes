...
class Inst(Mo):
    """
    The per neighbor discovery instance information. In the current implementation, only one instance of ND is running in the system.

    """

    meta = ClassMeta("cobra.model.nd.Inst")

    meta.moClassName = "ndInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Neighbor Discovery Instance"
    ...
    meta.childClasses.add("cobra.model.nd.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nd.Dom", "dom-"))
    ...
    prop = PropMeta("str", "agingIntvl", "agingIntvl", 2738, PropCategory.REGULAR)
    prop.label = "Aging Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(300, 65535)]
    prop.defaultValue = 1380
    prop.defaultValueStr = "1380"
    meta.props.add("agingIntvl", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14460, PropCategory.REGULAR)
