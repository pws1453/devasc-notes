...
# ##################################################
class RsRaSubnetToNdPfxPol(Mo):
    """
    A source relation to the neighbor discovery prefix policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.nd.RsRaSubnetToNdPfxPol", "cobra.model.nd.PfxPol")
    meta.targetNameProps["name"] = "tnNdPfxPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ndRsRaSubnetToNdPfxPol"
    meta.rnFormat = "rsRaSubnetToNdPfxPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ND Prefix Policy"
    ...
    meta.rnPrefixes = [
        ('rsRaSubnetToNdPfxPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38220, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40359, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18626, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18622, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5980
    prop.defaultValueStr = "ndPfxPol"
    ...
    prop = PropMeta("str", "tnNdPfxPolName", "tnNdPfxPolName", 18621, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnNdPfxPolName", prop)
