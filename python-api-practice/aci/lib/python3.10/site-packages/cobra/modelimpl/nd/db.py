...
class Db(Mo):
    """
    A neighbor discovery database.

    """

    meta = ClassMeta("cobra.model.nd.Db")

    meta.moClassName = "ndDb"
    ...
    meta.childClasses.add("cobra.model.nd.AdjEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.nd.AdjEp", "adj-"))
    ...
    prop = PropMeta("str", "type", "type", 17101, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
