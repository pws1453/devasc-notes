...
# ##################################################
class RaSubnetDef(Mo):
    """
    An external subnet.

    """

    meta = ClassMeta("cobra.model.nd.RaSubnetDef")

    meta.moClassName = "ndRaSubnetDef"
    meta.rnFormat = "RaSubnetDef-[%(ip)s]"
    ...
    prop = PropMeta("str", "ip", "ip", 18620, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
