...
class Inst(Mo):
    """
    A container for VLAN manager instance information.

    """

    meta = ClassMeta("cobra.model.vlanmgr.Inst")

    meta.moClassName = "vlanmgrInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Vlan Manager Instance"
    ...
    meta.childClasses.add("cobra.model.l2.DomMbrIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.l2.DomMbrIf", "dommbr-"))

    meta.parentClasses.add("cobra.model.vlanmgr.Entity")
    ...
    prop = PropMeta("str", "vdcId", "vdcId", 3572, PropCategory.REGULAR)
    prop.label = "VDC ID"
    prop.isOper = True
    prop.range = [(1, 4096)]
