...
class Entity(Mo):
    """
    A container for VLAN manager entity information.

    """

    meta = ClassMeta("cobra.model.vlanmgr.Entity")

    meta.moClassName = "vlanmgrEntity"
    meta.rnFormat = "vlanmgr"
    meta.category = MoCategory.REGULAR
    meta.label = "Vlan Manager Entity"
    ...
    meta.childClasses.add("cobra.model.vlanmgr.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.vlanmgr.Inst", "inst"))
