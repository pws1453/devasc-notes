...
class VxlanP(Mo):
    """
    The fabric VXLAN policy.

    """

    meta = ClassMeta("cobra.model.topoctrl.VxlanP")

    meta.moClassName = "topoctrlVxlanP"
    meta.rnFormat = "vxlanp"
    ...
    prop = PropMeta("str", "udpPort", "udpPort", 16494, PropCategory.REGULAR)
    prop.label = "Udp Port"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
