...
class ShardChP(Mo):
    """
    The shard chaining policy.

    """

    meta = ClassMeta("cobra.model.topoctrl.ShardChP")

    meta.moClassName = "topoctrlShardChP"
    meta.rnFormat = "shchp-%(af)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Shard Chain Policy"
    meta.writeAccessMask = 0x401000000001
    meta.readAccessMask = 0x401000000001
    ...
    prop = PropMeta("str", "af", "af", 2059, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "node", "node", 2060, PropCategory.REGULAR)
    prop.label = "Node"
    prop.isImplicit = True
    prop.isAdmin = True
