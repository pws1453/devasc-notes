...
# ##################################################
class RsEpLoopProtectPolCons(Mo):
    """
    The source relation to the loop protection policy.

    """

    meta = SourceRelationMeta("cobra.model.topoctrl.RsEpLoopProtectPolCons", "cobra.model.ep.LoopProtectP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "topoctrlRsEpLoopProtectPolCons"
    meta.rnFormat = "rsepLoopProtectPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "End Point Loop Protect Policy Attachment"
    ...
    meta.parentClasses.add("cobra.model.topoctrl.LoopProtectP")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsepLoopProtectPolCons', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 18120, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18119, PropCategory.REGULAR)
