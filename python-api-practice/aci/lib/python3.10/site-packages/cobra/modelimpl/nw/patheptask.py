...
class PathEpTask(Mo):
    """
    The path endpoint task.

    """

    meta = ClassMeta("cobra.model.nw.PathEpTask")

    meta.moClassName = "nwPathEpTask"
    meta.rnFormat = "nwPathEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5669, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updatePathEp", "updatepathep", 157)
