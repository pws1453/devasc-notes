...
# ##################################################
class RsLabelEpToAllowedEthIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.nw.RsLabelEpToAllowedEthIf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "nwRsLabelEpToAllowedEthIf"
    meta.rnFormat = "rslabelEpToAllowedEthIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39220, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 39146, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39145, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 39219, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
