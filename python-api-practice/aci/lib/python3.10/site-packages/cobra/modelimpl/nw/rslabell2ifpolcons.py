...
# ##################################################
class RsLabelL2IfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.nw.RsLabelL2IfPolCons", "cobra.model.l2.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "nwRsLabelL2IfPolCons"
    meta.rnFormat = "rslabelL2IfPolCons"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39227, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 39153, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39152, PropCategory.REGULAR)
