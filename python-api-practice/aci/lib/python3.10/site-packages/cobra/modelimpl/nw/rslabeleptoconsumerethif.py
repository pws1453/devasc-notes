...
# ##################################################
class RsLabelEpToConsumerEthIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.nw.RsLabelEpToConsumerEthIf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "nwRsLabelEpToConsumerEthIf"
    meta.rnFormat = "rslabelEpToConsumerEthIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39224, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 39150, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39149, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 39223, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
