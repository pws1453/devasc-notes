...
# ##################################################
class RsLabelToPathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.nw.RsLabelToPathAtt", "cobra.model.fv.APathAtt")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "nwRsLabelToPathAtt"
    meta.rnFormat = "rslabelToPathAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39229, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 39157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39156, PropCategory.REGULAR)
