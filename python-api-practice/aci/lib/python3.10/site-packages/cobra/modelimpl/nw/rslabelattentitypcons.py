...
# ##################################################
class RsLabelAttEntityPCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.nw.RsLabelAttEntityPCons", "cobra.model.infra.AttEntityP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "nwRsLabelAttEntityPCons"
    meta.rnFormat = "rslabelAttEntityPCons-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.nw.LabelEp")
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39217, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 39142, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39141, PropCategory.REGULAR)
