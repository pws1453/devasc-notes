...
# ##################################################
class RsNextScope(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.validator.RsNextScope", "cobra.model.validator.ScopeHop")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "validatorRsNextScope"
    meta.rnFormat = "rsnextScope"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "To Next Scope"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26467, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26466, PropCategory.REGULAR)
