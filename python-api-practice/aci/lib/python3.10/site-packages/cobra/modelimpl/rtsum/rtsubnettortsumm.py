...
# ##################################################
class RtSubnetToRtSumm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.rtsum.RtSubnetToRtSumm", "cobra.model.l3ext.Subnet")

    meta.moClassName = "rtsumRtSubnetToRtSumm"
    meta.rnFormat = "rtl3extSubnetToRtSumm-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.eigrp.RtSummPolDef")
    meta.parentClasses.add("cobra.model.bgp.RtSummPolDef")
    meta.parentClasses.add("cobra.model.ospf.RtSummPol")
    meta.parentClasses.add("cobra.model.ospf.RtSummPolDef")
    ...
    prop = PropMeta("str", "tCl", "tCl", 23574, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1801
    prop.defaultValueStr = "l3extSubnet"
    prop._addConstant("l3extSubnet", None, 1801)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23573, PropCategory.REGULAR)
