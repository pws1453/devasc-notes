...
class SyncInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.SyncInfo")

    meta.moClassName = "edmSyncInfo"
    meta.rnFormat = "syncinf"
    meta.category = MoCategory.REGULAR
    meta.label = "External Device Sync Info timestamps"
    ...
    prop = PropMeta("str", "apicObjUpdTS", "apicObjUpdTS", 43679, PropCategory.REGULAR)
    prop.label = "APIC Object Updated Timestamp"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "never"
    prop._addConstant("never", "never", 0)
    meta.props.add("apicObjUpdTS", prop)
    ...
    prop = PropMeta("str", "devMgrCfgApplyTS", "devMgrCfgApplyTS", 43678, PropCategory.REGULAR)
    prop.label = "Device Manager Config Apply Timestamp"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "never"
    prop._addConstant("never", "never", 0)
    meta.props.add("devMgrCfgApplyTS", prop)

    prop = PropMeta("str", "devMgrObjUpdTS", "devMgrObjUpdTS", 43677, PropCategory.REGULAR)
    prop.label = "Device Manager Object Updated Timestamp"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "never"
    prop._addConstant("never", "never", 0)
    meta.props.add("devMgrObjUpdTS", prop)
