...
class RsDomRef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.edm.RsDomRef", "cobra.model.infra.ADomP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "edmRsDomRef"
    meta.rnFormat = "rsdomRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43827, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43826, PropCategory.REGULAR)
