...
# ##################################################
class SDWanPrefixListContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SDWanPrefixListContTask")

    meta.moClassName = "edmSDWanPrefixListContTask"
    meta.rnFormat = "edmSDWanPrefixListContTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('edmSDWanPrefixListContTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 55583, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SyncSlaPrefix", "syncslaprefix", 3656)
