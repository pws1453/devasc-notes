...
# ##################################################
class NicProfToDomTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.NicProfToDomTask")

    meta.moClassName = "edmNicProfToDomTask"
    meta.rnFormat = "edmNicProfToDomTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 49823, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfigDomDef", "configdomdef", 3322)
