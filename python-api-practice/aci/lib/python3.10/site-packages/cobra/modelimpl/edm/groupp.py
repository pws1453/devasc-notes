...
# ##################################################
class GroupP(Mo):
    meta = ClassMeta("cobra.model.edm.GroupP")

    meta.isAbstract = True
    meta.moClassName = "edmGroupP"


    meta.moClassName = "edmGroupP"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Group Profile"
    ...
    prop = PropMeta("str", "name", "name", 43650, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
