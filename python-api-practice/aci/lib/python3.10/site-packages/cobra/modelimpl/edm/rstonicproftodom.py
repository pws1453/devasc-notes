...
# ##################################################
class RsToNicProfToDom(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.edm.RsToNicProfToDom", "cobra.model.edm.NicProfToDom")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "edmRsToNicProfToDom"
    meta.rnFormat = "rstoNicProfToDom-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Association between Managed NIC to a NIC Profile Domain Association"
    ...
    meta.rnPrefixes = [
        ('rstoNicProfToDom-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 49892, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49893, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49881, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 49865, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14288
    prop.defaultValueStr = "edmNicProfToDom"
    prop._addConstant("edmNicProfToDom", None, 14288)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49864, PropCategory.REGULAR)
