...
# ##################################################
class SDWanPrefixEntry(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SDWanPrefixEntry")

    meta.moClassName = "edmSDWanPrefixEntry"
    meta.rnFormat = "prefixEntry-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "SDWAN prefix Entry"
    ...
    prop = PropMeta("str", "addr", "addr", 55569, PropCategory.REGULAR)
    prop.label = "Prefix Info"
    prop.isConfig = True
    prop.isAdmin = True
