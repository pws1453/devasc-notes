...
class RsToSvrNic(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.edm.RsToSvrNic", "cobra.model.edm.ServerNic")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "edmRsToSvrNic"
    meta.rnFormat = "rstoSvrNic"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Association between ServerNic (UCSM inventory) and HpNic (VMM inventory)"
    ...
    prop = PropMeta("str", "annotation", "annotation", 49894, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49895, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49882, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 49869, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14289
    prop.defaultValueStr = "edmServerNic"
    prop._addConstant("edmServerNic", None, 14289)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49868, PropCategory.REGULAR)
