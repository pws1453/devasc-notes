...
# ##################################################
class RtCtrlrToDom(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.edm.RtCtrlrToDom", "cobra.model.edm.CompCtrlrProxy")

    meta.moClassName = "edmRtCtrlrToDom"
    meta.rnFormat = "rtctrlrToDom-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.edm.DomainEncap")
    ...
    prop = PropMeta("str", "tCl", "tCl", 49863, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14294
    prop.defaultValueStr = "edmCompCtrlrProxy"
    prop._addConstant("edmCompCtrlrProxy", None, 14294)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49862, PropCategory.REGULAR)
