...
class RtToEdm(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.edm.RtToEdm", "cobra.model.comp.EDMgrProxy")

    meta.moClassName = "edmRtToEdm"
    meta.rnFormat = "rtcompToEdm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49874, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14303
    prop.defaultValueStr = "compEDMgrProxy"
    prop._addConstant("compEDMgrProxy", None, 14303)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49873, PropCategory.REGULAR)
