...
# ##################################################
class RsNicNodeBinding(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.edm.RsNicNodeBinding", "cobra.model.edm.Node")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "edmRsNicNodeBinding"
    meta.rnFormat = "rsnicNodeBinding-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.edm.ServerNic")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsnicNodeBinding-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 49855, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14276
    prop.defaultValueStr = "edmNode"
    prop._addConstant("edmNode", None, 14276)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49854, PropCategory.REGULAR)
