...
# ##################################################
class SDWanSlaUpdPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SDWanSlaUpdPol")

    meta.moClassName = "edmSDWanSlaUpdPol"
    meta.rnFormat = "sdwanslaupdpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SDWan SLA Policy"
    ...
    meta.childClasses.add("cobra.model.edm.SDWanVrfListCont")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.SDWanVrfListCont", "vrflistcont"))
    ...
    prop = PropMeta("str", "dscp", "dscp", 55563, PropCategory.REGULAR)
    prop.label = "SLA DSCP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "jitter", "jitter", 55560, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "latency", "latency", 55562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "listId", "listId", 55564, PropCategory.REGULAR)
    prop.label = "SLA Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("listId", prop)

    prop = PropMeta("str", "loss", "loss", 55561, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55600, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 55587, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
