...
class RsEncapDef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.edm.RsEncapDef", "cobra.model.edm.EncapDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "edmRsEncapDef"
    meta.rnFormat = "rsencapDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to a Single Encap Definition"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43894, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43895, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43870, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43835, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12660
    prop.defaultValueStr = "edmEncapDef"
    prop._addConstant("edmEncapDef", None, 12660)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43834, PropCategory.REGULAR)
