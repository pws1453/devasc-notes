...
# ##################################################
class RemoteCDPPort(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.RemoteCDPPort")

    meta.moClassName = "edmRemoteCDPPort"
    meta.rnFormat = "cdpAdj-%(sysName)s-%(platId)s-%(portId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Device CDP RemotePath"
    ...
    meta.parentClasses.add("cobra.model.edm.LeafInterfacePathEp")
    ...
    prop = PropMeta("str", "addr", "addr", 49794, PropCategory.REGULAR)
    prop.label = "Address"
    ...
    prop = PropMeta("str", "devId", "devId", 49785, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fabricPathDn", "fabricPathDn", 49793, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "index", "index", 49784, PropCategory.REGULAR)
    prop.label = "Index"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mtu", "mtu", 49789, PropCategory.REGULAR)
    prop.label = "MTU"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "nativeVlan", "nativeVlan", 49788, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "platId", "platId", 49787, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portId", "portId", 49786, PropCategory.REGULAR)
    prop.label = "Port ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "sysLoc", "sysLoc", 49791, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysName", "sysName", 49790, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysObjIdV", "sysObjIdV", 49792, PropCategory.REGULAR)
    prop.label = "System OID Value"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("sysObjIdV", prop)

    meta.namingProps.append(getattr(meta.props, "sysName"))
    meta.namingProps.append(getattr(meta.props, "platId"))
    meta.namingProps.append(getattr(meta.props, "portId"))
    ...
    def __init__(self, parentMoOrDn, sysName, platId, portId, markDirty=True, **creationProps):
        namingVals = [sysName, platId, portId]
