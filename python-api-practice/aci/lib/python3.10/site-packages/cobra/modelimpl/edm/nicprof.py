...
class NicProf(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.NicProf")

    meta.moClassName = "edmNicProf"
    meta.rnFormat = "nicprof-[%(externalId)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "External Device Manager NIC Profile"
    ...
    meta.childClasses.add("cobra.model.edm.RtNicProf")
    meta.childClasses.add("cobra.model.edm.RsExtDevDomP")
    meta.childClasses.add("cobra.model.edm.NicProfToDom")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.edm.RsEncapDef")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.tag.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RsExtDevDomP", "rsextDevDomP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RsEncapDef", "rsencapDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RtNicProf", "rtnicProf"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.NicProfToDom", "npd-"))
    ...
    meta.superClasses.add("cobra.model.edm.ANicProf")
    ...
    prop = PropMeta("str", "externFound", "externFound", 43686, PropCategory.REGULAR)
    prop.label = "Externally Found NIC Profile"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "externalId", "externalId", 43763, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "faultDKey", "faultDKey", 43684, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43869, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 43683, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "operMtu", "operMtu", 52327, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "userConfigured", "userConfigured", 43685, PropCategory.REGULAR)
    prop.label = "User Configured NIC Profile"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
