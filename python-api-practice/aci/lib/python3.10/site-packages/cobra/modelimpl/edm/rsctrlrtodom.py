...
# ##################################################
class RsCtrlrToDom(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.edm.RsCtrlrToDom", "cobra.model.edm.DomainEncap")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "edmRsCtrlrToDom"
    meta.rnFormat = "rsctrlrToDom"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Association between proxy Ctrlr and domain"
    ...
    prop = PropMeta("str", "annotation", "annotation", 49890, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49891, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 49861, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12653
    prop.defaultValueStr = "edmDomainEncap"
    prop._addConstant("edmDomainEncap", None, 12653)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49860, PropCategory.REGULAR)
