...
class RtNicProf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.edm.RtNicProf", "cobra.model.edm.ServerNic")

    meta.moClassName = "edmRtNicProf"
    meta.rnFormat = "rtnicProf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49859, PropCategory.REGULAR)
