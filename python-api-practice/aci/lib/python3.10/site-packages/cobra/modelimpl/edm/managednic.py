...
class ManagedNic(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.ManagedNic")

    meta.moClassName = "edmManagedNic"
    meta.rnFormat = "hpnic-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "proxy for compHpNic MO"
    ...
    meta.childClasses.add("cobra.model.edm.RsToSvrNic")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.edm.RsToNicProfToDom")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RsToNicProfToDom", "rstoNicProfToDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RsToSvrNic", "rstoSvrNic"))
    ...
    prop = PropMeta("str", "hostId", "hostId", 52329, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("hostId", prop)
    ...
    prop = PropMeta("str", "mac", "mac", 49806, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nicKey", "nicKey", 49807, PropCategory.REGULAR)
    prop.label = "HpNic Dn"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("nicKey", prop)
