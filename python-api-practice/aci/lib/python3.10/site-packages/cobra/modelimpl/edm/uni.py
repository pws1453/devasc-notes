...
class Uni(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.Uni")

    meta.moClassName = "edmUni"
    meta.rnFormat = "edm"
    meta.category = MoCategory.REGULAR
    meta.label = "Universe"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x2002000000003
    ...
    meta.childClasses.add("cobra.model.edm.Mgr")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.Mgr", "Mgr-"))

    meta.parentClasses.add("cobra.model.top.Root")

    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.edm.Entity")
    meta.superClasses.add("cobra.model.edm.ContE")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43864, PropCategory.REGULAR)
