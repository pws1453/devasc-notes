...
# ##################################################
class SDWanVpnEntry(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SDWanVpnEntry")

    meta.moClassName = "edmSDWanVpnEntry"
    meta.rnFormat = "vpnEntry-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SDWAN VPN Entry read from remote"
    ...
    prop = PropMeta("str", "listId", "listId", 55566, PropCategory.REGULAR)
    prop.label = "VRF name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 55588, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vpnId", "vpnId", 55565, PropCategory.REGULAR)
    prop.label = "Mapped VPN Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
