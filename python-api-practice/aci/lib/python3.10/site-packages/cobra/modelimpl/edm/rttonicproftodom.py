...
# ##################################################
class RtToNicProfToDom(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.edm.RtToNicProfToDom", "cobra.model.edm.ManagedNic")

    meta.moClassName = "edmRtToNicProfToDom"
    meta.rnFormat = "rttoNicProfToDom-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49867, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14297
    prop.defaultValueStr = "edmManagedNic"
    prop._addConstant("edmManagedNic", None, 14297)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49866, PropCategory.REGULAR)
