...
class RsMbrIfs(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.edm.RsMbrIfs", "cobra.model.edm.PhysIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "edmRsMbrIfs"
    meta.rnFormat = "rsmbrIfs-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Physical Interface on Remote Node"
    ...
    meta.parentClasses.add("cobra.model.edm.AggrIf")
    ...
    prop = PropMeta("str", "tCl", "tCl", 49852, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14281
    prop.defaultValueStr = "edmPhysIf"
    prop._addConstant("edmPhysIf", None, 14281)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49851, PropCategory.REGULAR)
