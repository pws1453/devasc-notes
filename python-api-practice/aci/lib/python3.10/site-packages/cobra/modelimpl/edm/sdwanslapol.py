...
class SDWanSlaPol(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.SDWanSlaPol")

    meta.moClassName = "edmSDWanSlaPol"
    ...
    prop = PropMeta("str", "dscp", "dscp", 49811, PropCategory.REGULAR)
    prop.label = "SLA DSCP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "jitter", "jitter", 49808, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "latency", "latency", 49810, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "loss", "loss", 49809, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 49829, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
