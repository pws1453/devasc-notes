...
# ##################################################
class RsGroupPRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.edm.RsGroupPRef", "cobra.model.extdev.GroupP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "edmRsGroupPRef"
    meta.rnFormat = "rsGroupPRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Integrations Group"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53892, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53891, PropCategory.REGULAR)
