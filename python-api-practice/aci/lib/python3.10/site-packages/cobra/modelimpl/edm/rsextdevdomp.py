...
# ##################################################
class RsExtDevDomP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.edm.RsExtDevDomP", "cobra.model.infra.ADomP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "edmRsExtDevDomP"
    meta.rnFormat = "rsextDevDomP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43892, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43893, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43868, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43831, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43830, PropCategory.REGULAR)
