...
# ##################################################
class SDWanVrfEntry(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SDWanVrfEntry")

    meta.moClassName = "edmSDWanVrfEntry"
    meta.rnFormat = "vrfEntry-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SDWAN vrf Entry reported from datapath"
    ...
    meta.childClasses.add("cobra.model.edm.SDWanPrefixListCont")
    meta.childClasses.add("cobra.model.edm.SDWanPrefixEntry")
    meta.childClasses.add("cobra.model.edm.SDWanVpnEntry")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.SDWanPrefixListCont", "prefixlistcont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.SDWanPrefixEntry", "prefixEntry-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.SDWanVpnEntry", "vpnEntry-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55603, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 55589, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prefixId", "prefixId", 55568, PropCategory.REGULAR)
    prop.label = "Mapped Prefix list Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("prefixId", prop)
    ...
    prop = PropMeta("str", "vpnId", "vpnId", 55567, PropCategory.REGULAR)
    prop.label = "Mapped VPN list Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
