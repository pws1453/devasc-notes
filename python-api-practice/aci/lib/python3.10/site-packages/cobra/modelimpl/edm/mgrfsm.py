...
class MgrFsm(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.MgrFsm")

    meta.moClassName = "edmMgrFsm"
    meta.rnFormat = "edmMgrFsm-%(id)s"
    ...
    meta.childClasses.add("cobra.model.edm.MgrContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.MgrContext", "edmMgr"))
    ...
    prop = PropMeta("str", "currStage", "currStage", 43741, PropCategory.REGULAR)
    prop.label = "Current Stage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("RemoveBegin", "removebegin", 476)
    prop._addConstant("RemoveCleanup", "removecleanup", 477)
    prop._addConstant("RemoveFail", "removefail", 479)
    prop._addConstant("RemoveMitClean", "removemitclean", 478)
    prop._addConstant("RemoveSuccess", "removesuccess", 480)
    ...
    prop = PropMeta("str", "flags", "flags", 43743, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("ifc:edmgr:EdmMgrRemove:switchManager", "ifc:edmgr:edmmgrremove:switchmanager", 2048)
    meta.props.add("flags", prop)

    prop = PropMeta("str", "id", "id", 43740, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("Remove", "remove", 3216)
    prop._addConstant("none", "none", 0)
    ...
    prop = PropMeta("str", "prevStage", "prevStage", 43742, PropCategory.REGULAR)
