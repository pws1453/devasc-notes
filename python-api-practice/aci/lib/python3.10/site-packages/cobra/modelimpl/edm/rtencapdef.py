...
class RtEncapDef(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.edm.RtEncapDef", "cobra.model.edm.NicProf")

    meta.moClassName = "edmRtEncapDef"
    meta.rnFormat = "rtencapDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43837, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12657
    prop.defaultValueStr = "edmNicProf"
    prop._addConstant("edmNicProf", None, 12657)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43836, PropCategory.REGULAR)
