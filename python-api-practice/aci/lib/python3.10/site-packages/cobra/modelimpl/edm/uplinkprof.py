...
class UplinkProf(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.UplinkProf")

    meta.moClassName = "edmUplinkProf"
    meta.rnFormat = "uplinkprof-[%(externalId)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Uplink Profile"
    ...
    prop = PropMeta("str", "apicControlled", "apicControlled", 43694, PropCategory.REGULAR)
    prop.label = "APIC Controlled Uplink Profile"
    ...
    prop = PropMeta("str", "externFound", "externFound", 43696, PropCategory.REGULAR)
    prop.label = "Externally Found Uplink Profile"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    ...
    prop = PropMeta("str", "externalId", "externalId", 43697, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "faultDKey", "faultDKey", 43698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43872, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 43693, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "userConfigured", "userConfigured", 43695, PropCategory.REGULAR)
    prop.label = "User Configured Uplink Profile"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
