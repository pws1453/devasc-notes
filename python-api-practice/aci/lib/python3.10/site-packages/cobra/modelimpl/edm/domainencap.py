...
# ##################################################
class DomainEncap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.DomainEncap")

    meta.moClassName = "edmDomainEncap"
    meta.rnFormat = "encapcont-[%(domDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Container for Domain Encaps"
    ...
    meta.childClasses.add("cobra.model.edm.EncapDef")
    meta.childClasses.add("cobra.model.edm.RtCtrlrToDom")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RtCtrlrToDom", "rtctrlrToDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.EncapDef", "encap-"))

    meta.parentClasses.add("cobra.model.edm.DomainCont")
    ...
    prop = PropMeta("str", "domDn", "domDn", 43680, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "domUid", "domUid", 43681, PropCategory.REGULAR)
    prop.label = "Unique ID for the Domain"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("domUid", prop)
