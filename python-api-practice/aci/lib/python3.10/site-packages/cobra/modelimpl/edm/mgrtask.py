...
class MgrTask(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.MgrTask")

    meta.moClassName = "edmMgrTask"
    meta.rnFormat = "edmMgrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 43744, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SyncConfigOnMgr", "syncconfigonmgr", 3215)
