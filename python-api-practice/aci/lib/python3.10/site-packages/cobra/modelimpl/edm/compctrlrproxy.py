...
# ##################################################
class CompCtrlrProxy(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.CompCtrlrProxy")

    meta.moClassName = "edmCompCtrlrProxy"
    meta.rnFormat = "ctrlr-[%(ctrlrKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "proxy for compCtrlr MO"
    ...
    meta.childClasses.add("cobra.model.edm.RsCtrlrToDom")
    meta.childClasses.add("cobra.model.edm.ManagedNic")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RsCtrlrToDom", "rsctrlrToDom"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.ManagedNic", "hpnic-"))
    ...
    prop = PropMeta("str", "ctrlrKey", "ctrlrKey", 49805, PropCategory.REGULAR)
    prop.label = "Ctrlr Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("ctrlrKey", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49878, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "ctrlrKey"))
    getattr(meta.props, "ctrlrKey").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, ctrlrKey, markDirty=True, **creationProps):
        namingVals = [ctrlrKey]
