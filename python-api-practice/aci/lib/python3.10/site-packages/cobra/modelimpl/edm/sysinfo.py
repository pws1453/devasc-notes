...
class SysInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.SysInfo")

    meta.moClassName = "edmSysInfo"
    meta.rnFormat = "sysinf"
    meta.category = MoCategory.REGULAR
    meta.label = "External Device System Information"
    ...
    prop = PropMeta("str", "capabilities", "capabilities", 43676, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "manufacturer", "manufacturer", 43673, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("manufacturer", prop)
    ...
    prop = PropMeta("str", "model", "model", 43674, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "version", "version", 43675, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
