...
class LldpAdjEp(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.LldpAdjEp")

    meta.moClassName = "edmLldpAdjEp"
    meta.rnFormat = "lldp-%(id)s"
    ...
    prop = PropMeta("str", "capability", "capability", 49735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "chassisIdT", "chassisIdT", 49727, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "chassisIdV", "chassisIdV", 49728, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "enCap", "enCap", 49736, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 49725, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mgmtId", "mgmtId", 49739, PropCategory.REGULAR)
    prop.label = "Management ID"
    prop.isOper = True
    meta.props.add("mgmtId", prop)

    prop = PropMeta("str", "mgmtIp", "mgmtIp", 49737, PropCategory.REGULAR)
    prop.label = "Management Address"
    prop.isOper = True
    meta.props.add("mgmtIp", prop)

    prop = PropMeta("str", "mgmtPortMac", "mgmtPortMac", 49738, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portDesc", "portDesc", 49734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portIdT", "portIdT", 49729, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portIdV", "portIdV", 49730, PropCategory.REGULAR)
    prop.label = "Port ID Value"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("portIdV", prop)

    prop = PropMeta("str", "portVlan", "portVlan", 49740, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "stQual", "stQual", 49726, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysDesc", "sysDesc", 49733, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysName", "sysName", 49732, PropCategory.REGULAR)
    prop.label = "System Name"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("sysName", prop)

    prop = PropMeta("str", "ttl", "ttl", 49731, PropCategory.REGULAR)
    prop.label = "TTL"
    prop.isOper = True
