...
class RsAdj(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.edm.RsAdj", "cobra.model.fabric.LooseNode")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "edmRsAdj"
    meta.rnFormat = "rsadj"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation Fabric Loose Node"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49849, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 49848, PropCategory.REGULAR)
