...
# ##################################################
class RsSDWanPolContRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.edm.RsSDWanPolContRef", "cobra.model.extdev.SDWanPolCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "edmRsSDWanPolContRef"
    meta.rnFormat = "rsSDWanPolContRef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to SDWan Container"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49842, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14268
    prop.defaultValueStr = "extdevSDWanPolCont"
    prop._addConstant("extdevSDWanPolCont", None, 14268)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49841, PropCategory.REGULAR)
