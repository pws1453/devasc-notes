...
class RsNicProf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.edm.RsNicProf", "cobra.model.edm.NicProf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "edmRsNicProf"
    meta.rnFormat = "rsnicProf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49858, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 49857, PropCategory.REGULAR)
