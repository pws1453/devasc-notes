...
class RtToSvrNic(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.edm.RtToSvrNic", "cobra.model.edm.ManagedNic")

    meta.moClassName = "edmRtToSvrNic"
    meta.rnFormat = "rttoSvrNic"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49870, PropCategory.REGULAR)
