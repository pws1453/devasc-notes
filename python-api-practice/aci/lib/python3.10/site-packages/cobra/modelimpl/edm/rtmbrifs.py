...
class RtMbrIfs(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.edm.RtMbrIfs", "cobra.model.edm.AggrIf")

    meta.moClassName = "edmRtMbrIfs"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49853, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14282
    prop.defaultValueStr = "edmAggrIf"
