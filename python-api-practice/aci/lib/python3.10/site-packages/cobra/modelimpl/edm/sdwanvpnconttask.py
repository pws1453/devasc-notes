...
# ##################################################
class SDWanVpnContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SDWanVpnContTask")

    meta.moClassName = "edmSDWanVpnContTask"
    meta.rnFormat = "edmSDWanVpnContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 55584, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VpnConfig", "vpnconfig", 3655)
