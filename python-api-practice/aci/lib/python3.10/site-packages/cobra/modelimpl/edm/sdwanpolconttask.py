...
# ##################################################
class SDWanPolContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SDWanPolContTask")

    meta.moClassName = "edmSDWanPolContTask"
    meta.rnFormat = "edmSDWanPolContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 55582, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SlaPolConfig", "slapolconfig", 3654)
