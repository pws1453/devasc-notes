...
class DomainCont(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.DomainCont")

    meta.moClassName = "edmDomainCont"
    ...
    meta.childClasses.add("cobra.model.edm.RsDomRef")
    meta.childClasses.add("cobra.model.edm.DomainEncap")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.DomainEncap", "encapcont-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RsDomRef", "rsdomRef-"))
