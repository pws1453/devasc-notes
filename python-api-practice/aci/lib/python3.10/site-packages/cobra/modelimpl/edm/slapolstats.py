...
# ##################################################
class SlaPolStats(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.SlaPolStats")

    meta.moClassName = "edmSlaPolStats"
    meta.rnFormat = "slapolstats-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SLA Stats per policy for SDWAN"
    ...
    meta.childClasses.add("cobra.model.edm.SlaIntStats")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.SlaIntStats", "slaintstats-"))

    meta.parentClasses.add("cobra.model.edm.SlaStatsCont")

    meta.superClasses.add("cobra.model.edm.ASlaPolStats")
    ...
    prop = PropMeta("str", "name", "name", 52184, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
