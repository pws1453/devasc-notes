...
# ##################################################
class RtResMonFabricPol(Mo):
    """
    A target relation to the monitoring policy model for the fabric semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtResMonFabricPol", "cobra.model.fabric.Inst")

    meta.moClassName = "monRtResMonFabricPol"
    meta.rnFormat = "rtresMonFabricPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11749, PropCategory.REGULAR)
