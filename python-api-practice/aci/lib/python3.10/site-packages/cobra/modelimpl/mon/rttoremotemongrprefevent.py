...
# ##################################################
class RtToRemoteMonGrpRefEvent(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.mon.RtToRemoteMonGrpRefEvent", "cobra.model.fault.RelnHolder")

    meta.moClassName = "monRtToRemoteMonGrpRefEvent"
    meta.rnFormat = "rtfaultToRemoteMonGrpRefEvent-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfaultToRemoteMonGrpRefEvent-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23671, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23670, PropCategory.REGULAR)
