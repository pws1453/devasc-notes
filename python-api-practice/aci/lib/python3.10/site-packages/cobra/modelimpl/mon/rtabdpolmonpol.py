...
# ##################################################
class RtABDPolMonPol(Mo):
    """
    A target relation to the monitoring policy model for the endpoint group.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtABDPolMonPol", "cobra.model.fv.ABDPol")

    meta.moClassName = "monRtABDPolMonPol"
    meta.rnFormat = "rtfvABDPolMonPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Bridge Domain"
    meta.writeAccessMask = 0x800000000200001
    meta.readAccessMask = 0x800040000200601
    ...
    prop = PropMeta("str", "tCl", "tCl", 12163, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12162, PropCategory.REGULAR)
