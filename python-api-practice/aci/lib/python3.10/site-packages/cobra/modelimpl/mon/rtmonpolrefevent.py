...
# ##################################################
class RtMonPolRefEvent(Mo):
    """
    A target relation to the monitoring policy model.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonPolRefEvent", "cobra.model.fault.RelnHolder")

    meta.moClassName = "monRtMonPolRefEvent"
    meta.rnFormat = "rtfaultMonPolRefEvent-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16188, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16187, PropCategory.REGULAR)
