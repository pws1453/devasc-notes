...
class MonObjDn(Mo):
    ...
    meta = ClassMeta("cobra.model.mon.MonObjDn")

    meta.moClassName = "monMonObjDn"
    meta.rnFormat = "monobjdn-[%(monObjDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40543, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monObjDn", "monObjDn", 23239, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("monObjDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "monObjDn"))
    getattr(meta.props, "monObjDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, monObjDn, markDirty=True, **creationProps):
        namingVals = [monObjDn]
