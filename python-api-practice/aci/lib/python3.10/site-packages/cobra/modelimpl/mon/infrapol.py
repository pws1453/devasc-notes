...
class InfraPol(Mo):
    ...
    meta = ClassMeta("cobra.model.mon.InfraPol")

    meta.moClassName = "monInfraPol"
    meta.rnFormat = "moninfra-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Monitoring Policy"
    meta.writeAccessMask = 0x840100000000001
    meta.readAccessMask = 0x8c01c0000000011
    ...
    meta.childClasses.add("cobra.model.mon.RtSvrToMonPol")
    ...
    meta.childClasses.add("cobra.model.mon.RtMonFexInfraPol")
    ...
    meta.childClasses.add("cobra.model.mon.RtMonIfInfraPol")
    meta.childClasses.add("cobra.model.mon.RtMonPolLocalRefEvent")
    meta.childClasses.add("cobra.model.mon.RtCtrlrPMonPol")
    meta.childClasses.add("cobra.model.stats.ExportP")
    meta.childClasses.add("cobra.model.mon.RtMonNodeInfraPol")
    ...
    meta.childClasses.add("cobra.model.mon.RtMonModuleInfraPol")
    meta.childClasses.add("cobra.model.callhome.SmartSrc")
    meta.childClasses.add("cobra.model.syslog.Src")
    meta.childClasses.add("cobra.model.mon.RtResMonInfraPol")
    ...
    meta.childClasses.add("cobra.model.mon.InfraTarget")
    meta.childClasses.add("cobra.model.mon.RtMonBrkoutInfraPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonModuleInfraPol", "rtinfraMonModuleInfraPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonPolSystemPolCons", "rttopMonPolSystemPolCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonBrkoutInfraPol", "rtinfraMonBrkoutInfraPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonNodeInfraPol", "rtinfraMonNodeInfraPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonPolRefEvent", "rtfaultMonPolRefEvent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonFexInfraPol", "rtinfraMonFexInfraPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtMonIfInfraPol", "rtinfraMonIfInfraPol-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtSvrToMonPol", "rtauthSvrToMonPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtCtrlrPMonPol", "rtvmmCtrlrPMonPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtResMonInfraPol", "rtresMonInfraPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.InfraTarget", "tarinfra-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39432, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13795, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6941, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
