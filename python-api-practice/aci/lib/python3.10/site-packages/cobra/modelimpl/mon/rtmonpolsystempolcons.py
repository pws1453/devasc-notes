...
# ##################################################
class RtMonPolSystemPolCons(Mo):
    """
    A target relation to the monitoring policy model.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonPolSystemPolCons", "cobra.model.top.System")

    meta.moClassName = "monRtMonPolSystemPolCons"
    meta.rnFormat = "rttopMonPolSystemPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11234, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11233, PropCategory.REGULAR)
