...
# ##################################################
class RtMonPolLocalRefEvent(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonPolLocalRefEvent", "cobra.model.fault.RelnHolder")

    meta.moClassName = "monRtMonPolLocalRefEvent"
    meta.rnFormat = "rtfaultMonPolLocalRefEvent-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfaultMonPolLocalRefEvent-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27717, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27716, PropCategory.REGULAR)
