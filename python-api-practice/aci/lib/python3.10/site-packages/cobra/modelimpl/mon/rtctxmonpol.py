...
# ##################################################
class RtCtxMonPol(Mo):
    """
    A target relation to the monitoring policy model for the endpoint group (EPG) semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtCtxMonPol", "cobra.model.fv.Ctx")

    meta.moClassName = "monRtCtxMonPol"
    meta.rnFormat = "rtfvCtxMonPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "VRF"
    meta.writeAccessMask = 0x800000000200001
    meta.readAccessMask = 0x800040000203601
    ...
    prop = PropMeta("str", "tCl", "tCl", 12359, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12358, PropCategory.REGULAR)
