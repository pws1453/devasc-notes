...
# ##################################################
class RtAEPgMonPol(Mo):
    """
    A target relation to the monitoring policy model for the endpoint group.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtAEPgMonPol", "cobra.model.fv.AEPg")

    meta.moClassName = "monRtAEPgMonPol"
    meta.rnFormat = "rtfvAEPgMonPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12320, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12319, PropCategory.REGULAR)
