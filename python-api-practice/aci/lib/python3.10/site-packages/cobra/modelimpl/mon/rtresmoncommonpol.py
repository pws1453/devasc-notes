...
# ##################################################
class RtResMonCommonPol(Mo):
    """
    A target relation to the monitoring policy model for the common semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtResMonCommonPol", "cobra.model.fabric.Inst")

    meta.moClassName = "monRtResMonCommonPol"
    meta.rnFormat = "rtresMonCommonPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11746, PropCategory.REGULAR)
