...
# ##################################################
class RtTenantMonPol(Mo):
    """
    A target relation to the monitoring policy model for the endpoint group semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtTenantMonPol", "cobra.model.fv.Tenant")

    meta.moClassName = "monRtTenantMonPol"
    meta.rnFormat = "rtfvTenantMonPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Tenant"
    meta.writeAccessMask = 0x800000000200001
    meta.readAccessMask = 0x800040000201601
    ...
    prop = PropMeta("str", "tCl", "tCl", 12304, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12303, PropCategory.REGULAR)
