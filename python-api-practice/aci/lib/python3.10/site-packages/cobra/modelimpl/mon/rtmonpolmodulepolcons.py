...
# ##################################################
class RtMonPolModulePolCons(Mo):
    """
    A target relation to the monitoring policy model.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonPolModulePolCons", "cobra.model.eqpt.Card")

    meta.moClassName = "monRtMonPolModulePolCons"
    meta.rnFormat = "rteqptMonPolModulePolCons-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rteqptMonPolModulePolCons-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12684, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3200
    prop.defaultValueStr = "eqptCard"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12683, PropCategory.REGULAR)
