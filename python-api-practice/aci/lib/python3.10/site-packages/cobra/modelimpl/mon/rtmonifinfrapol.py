...
# ##################################################
class RtMonIfInfraPol(Mo):
    """
    A target relation to the monitoring policy model for the infra semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonIfInfraPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "monRtMonIfInfraPol"
    meta.rnFormat = "rtinfraMonIfInfraPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13232, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13231, PropCategory.REGULAR)
