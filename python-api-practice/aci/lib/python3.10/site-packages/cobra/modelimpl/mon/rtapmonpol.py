...
class RtApMonPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.mon.RtApMonPol", "cobra.model.fv.Ap")

    meta.moClassName = "monRtApMonPol"
    meta.rnFormat = "rtfvApMonPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12312, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1978
    prop.defaultValueStr = "fvAp"
    prop._addConstant("fvAp", None, 1978)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12311, PropCategory.REGULAR)
