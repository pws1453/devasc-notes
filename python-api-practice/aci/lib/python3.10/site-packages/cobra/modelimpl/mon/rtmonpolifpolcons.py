...
# ##################################################
class RtMonPolIfPolCons(Mo):
    """
    A target relation to the monitoring policy model.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonPolIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "monRtMonPolIfPolCons"
    meta.rnFormat = "rtl1MonPolIfPolCons-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Ethernet Interface"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x880180000000001
    ...
    prop = PropMeta("str", "tCl", "tCl", 12769, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12768, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15118, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
