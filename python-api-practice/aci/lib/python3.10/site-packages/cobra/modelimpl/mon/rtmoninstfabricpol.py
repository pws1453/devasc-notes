...
# ##################################################
class RtMonInstFabricPol(Mo):
    """
    A target relation to the monitoring policy model for the fabric semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonInstFabricPol", "cobra.model.fabric.ANodePGrp")

    meta.moClassName = "monRtMonInstFabricPol"
    meta.rnFormat = "rtfabricMonInstFabricPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11568, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11567, PropCategory.REGULAR)
