...
class CommonPol(Mo):
    ...
    meta = ClassMeta("cobra.model.mon.CommonPol")

    meta.moClassName = "monCommonPol"
    meta.rnFormat = "moncommon"
    ...
    meta.childClasses.add("cobra.model.mon.RtResMonCommonPol")
    ...
    meta.childClasses.add("cobra.model.syslog.SystemMsgP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mon.RtResMonCommonPol", "rtresMonCommonPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.syslog.SystemMsgP", "sysmsgp"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37297, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39436, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13799, PropCategory.REGULAR)
