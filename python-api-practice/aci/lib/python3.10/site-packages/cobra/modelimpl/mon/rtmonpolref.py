...
# ##################################################
class RtMonPolRef(Mo):
    """
    A target relation to the monitoring policy model.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtMonPolRef", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "monRtMonPolRef"
    meta.rnFormat = "rtpolMonPolRef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13453, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13452, PropCategory.REGULAR)
