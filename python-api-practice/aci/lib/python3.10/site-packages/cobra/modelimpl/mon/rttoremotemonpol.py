...
# ##################################################
class RtToRemoteMonPol(Mo):
    """
    A target relation to the monitoring policy model for the endpoint group semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtToRemoteMonPol", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "monRtToRemoteMonPol"
    meta.rnFormat = "rtfvToRemoteMonPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12451, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12450, PropCategory.REGULAR)
