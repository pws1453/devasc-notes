...
# ##################################################
class RtEppToMonPol(Mo):
    """
    A target relation to the monitoring policy model for the endpoint group (EPG) semantic scope.

    """

    meta = TargetRelationMeta("cobra.model.mon.RtEppToMonPol", "cobra.model.fv.AREpP")

    meta.moClassName = "monRtEppToMonPol"
    meta.rnFormat = "rtfvEppToMonPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x800000000200001
    meta.readAccessMask = 0x800040000201001
    ...
    prop = PropMeta("str", "tCl", "tCl", 12250, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12249, PropCategory.REGULAR)
