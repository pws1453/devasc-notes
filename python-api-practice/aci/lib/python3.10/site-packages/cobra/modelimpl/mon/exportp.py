...
# ##################################################
class ExportP(Mo):
    meta = ClassMeta("cobra.model.mon.ExportP")

    meta.isAbstract = True
    meta.moClassName = "monExportP"


    meta.moClassName = "monExportP"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Export Policy for a Given User"
    ...
    meta.concreteSubClasses.add("cobra.model.stats.ExportP")
    ...
    prop = PropMeta("str", "compression", "compression", 4857, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maximumRetryCount", "maximumRetryCount", 4858, PropCategory.REGULAR)
