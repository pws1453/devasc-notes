...
# ##################################################
class RtToRemoteMonGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.mon.RtToRemoteMonGrp", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "monRtToRemoteMonGrp"
    meta.rnFormat = "rtfvToRemoteMonGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23243, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23242, PropCategory.REGULAR)
