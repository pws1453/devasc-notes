...
class Entity(Mo):
    """
     Holds slowdrain control plane entity information 

    """

    meta = ClassMeta("cobra.model.slowdrain.Entity")

    meta.moClassName = "slowdrainEntity"
    meta.rnFormat = "slowdrain"
    meta.category = MoCategory.REGULAR
    meta.label = "Slowdrain Entity"
    ...
    meta.childClasses.add("cobra.model.slowdrain.Class")

    meta.childNamesAndRnPrefix.append(("cobra.model.slowdrain.Class", "classp-"))
