...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.acl.Inst")

    meta.moClassName = "aclInst"
    meta.rnFormat = "inst"
    ...
    meta.childClasses.add("cobra.model.acl.ACEHolder")

    meta.childNamesAndRnPrefix.append(("cobra.model.acl.ACEHolder", "aceholder-"))
