...
# ##################################################
class RsFcLacpPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pc.RsFcLacpPolCons", "cobra.model.lacp.LagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pcRsFcLacpPolCons"
    meta.rnFormat = "rsfcLacpPolCons"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39241, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 39171, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39170, PropCategory.REGULAR)
