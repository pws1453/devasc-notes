...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.pc.Entity")

    meta.moClassName = "pcEntity"
    meta.rnFormat = "pc"
    meta.category = MoCategory.REGULAR
    meta.label = "Port Channel Entity"
    ...
    meta.childClasses.add("cobra.model.pc.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.pc.Inst", "pc"))
