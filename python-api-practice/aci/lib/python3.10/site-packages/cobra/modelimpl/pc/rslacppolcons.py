...
# ##################################################
class RsLacpPolCons(Mo):
    """
    A source relation to the LACP policy.

    """

    meta = SourceRelationMeta("cobra.model.pc.RsLacpPolCons", "cobra.model.lacp.LagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pcRsLacpPolCons"
    meta.rnFormat = "rslacpPolCons"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15125, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12785, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12784, PropCategory.REGULAR)
