...
class RsMbrIfs(Mo):
    """
    A source relation to the Layer 1 physical Ethernet interface information object.

    """

    meta = SourceRelationMeta("cobra.model.pc.RsMbrIfs", "cobra.model.l1.PhysIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "pcRsMbrIfs"
    meta.rnFormat = "rsmbrIfs-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16120, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "parentSKey", "parentSKey", 15128, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("parentSKey", prop)

    prop = PropMeta("str", "pcmCfgFailedBmp", "pcmCfgFailedBmp", 15191, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("pc:RsMbrIfsforceResolve_failed_flag", None, 4)
    prop._addConstant("pc:RsMbrIfslcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("pc:RsMbrIfsmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("pc:RsMbrIfsmonPolDn_failed_flag", None, 128)
    prop._addConstant("pc:RsMbrIfsparentSKey_failed_flag", None, 256)
    prop._addConstant("pc:RsMbrIfsrType_failed_flag", None, 8)
    prop._addConstant("pc:RsMbrIfsstateQual_failed_flag", None, 32)
    prop._addConstant("pc:RsMbrIfsstate_failed_flag", None, 16)
    prop._addConstant("pc:RsMbrIfstCl_failed_flag", None, 1)
    prop._addConstant("pc:RsMbrIfstDn_failed_flag", None, 2)
    prop._addConstant("pc:RsMbrIfstSKey_failed_flag", None, 4096)
    prop._addConstant("pc:RsMbrIfstType_failed_flag", None, 64)
    meta.props.add("pcmCfgFailedBmp", prop)

    prop = PropMeta("str", "pcmCfgFailedTs", "pcmCfgFailedTs", 15193, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("pcmCfgFailedTs", prop)

    prop = PropMeta("str", "pcmCfgState", "pcmCfgState", 15192, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12789, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3627
    prop.defaultValueStr = "l1PhysIf"
    prop._addConstant("l1PhysIf", None, 3627)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12788, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15127, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
