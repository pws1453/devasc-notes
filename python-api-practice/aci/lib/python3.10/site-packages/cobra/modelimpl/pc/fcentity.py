...
class FcEntity(Mo):
    ...
    meta = ClassMeta("cobra.model.pc.FcEntity")

    meta.moClassName = "pcFcEntity"
    meta.rnFormat = "fcpc"
    meta.category = MoCategory.REGULAR
    meta.label = "Fc Port Channel Entity"
    ...
    meta.childClasses.add("cobra.model.pc.FcInst")

    meta.childNamesAndRnPrefix.append(("cobra.model.pc.FcInst", "fcpc"))
