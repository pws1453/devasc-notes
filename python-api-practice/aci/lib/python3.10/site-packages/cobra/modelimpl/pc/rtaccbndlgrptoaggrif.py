...
# ##################################################
class RtAccBndlGrpToAggrIf(Mo):
    """
    A target relation to the aggregated interface.

    """

    meta = TargetRelationMeta("cobra.model.pc.RtAccBndlGrpToAggrIf", "cobra.model.infra.AccBndlGrp")

    meta.moClassName = "pcRtAccBndlGrpToAggrIf"
    meta.rnFormat = "rtaccBndlGrpToAggrIf"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15454, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 15450, PropCategory.REGULAR)
