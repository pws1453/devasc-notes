...
# ##################################################
class AliasDelInstTask(Mo):
    """
    An alias deleted instance task.

    """

    meta = ClassMeta("cobra.model.tag.AliasDelInstTask")

    meta.moClassName = "tagAliasDelInstTask"
    meta.rnFormat = "tagAliasDelInstTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5640, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DelAliasDef", "delaliasdef", 6)
