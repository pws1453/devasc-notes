...
# ##################################################
class AliasInstTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.tag.AliasInstTask")

    meta.moClassName = "tagAliasInstTask"
    meta.rnFormat = "tagAliasInstTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5641, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfAliasDef", "confaliasdef", 5)
    prop._addConstant("SyncAliasInst", "syncaliasinst", 3996)
