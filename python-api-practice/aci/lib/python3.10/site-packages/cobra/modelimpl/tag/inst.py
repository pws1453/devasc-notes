...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.tag.Inst")

    meta.moClassName = "tagInst"
    meta.rnFormat = "tag-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Tag Instance"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37561, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39700, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14162, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7258, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
