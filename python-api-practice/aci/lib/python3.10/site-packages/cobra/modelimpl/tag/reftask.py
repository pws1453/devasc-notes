...
class RefTask(Mo):
    ...
    meta = ClassMeta("cobra.model.tag.RefTask")

    meta.moClassName = "tagRefTask"
    meta.rnFormat = "tagRefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5724, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DelInst", "delinst", 466)
    prop._addConstant("UpdateAlias", "updatealias", 1453)
