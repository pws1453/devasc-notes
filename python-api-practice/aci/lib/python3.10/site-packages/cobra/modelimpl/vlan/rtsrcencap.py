...
class RtSrcEncap(Mo):
    """
    A target relation to the VLAN object created for an endpoint group with an 802.1q encap.

    """

    meta = TargetRelationMeta("cobra.model.vlan.RtSrcEncap", "cobra.model.oam.Exec")

    meta.moClassName = "vlanRtSrcEncap"
    meta.rnFormat = "rtoamSrcEncap-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Exec"
    meta.writeAccessMask = 0x200000000001
    meta.readAccessMask = 0x228004100001
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15040, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12608, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12607, PropCategory.REGULAR)
