...
class CktEp(Mo):
    """
    A VLAN object created for an endpoint group with an 802.1q encap.

    """

    meta = ClassMeta("cobra.model.vlan.CktEp")

    meta.moClassName = "vlanCktEp"
    meta.rnFormat = "vlan-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Vlan"
    meta.writeAccessMask = 0x200000000001
    meta.readAccessMask = 0x228004120101
    ...
    meta.childClasses.add("cobra.model.vlan.RtSrcEncap")
    ...
    meta.childClasses.add("cobra.model.vlan.RtToVlanCkt")
    ...
    meta.childClasses.add("cobra.model.vlan.RsVlanEppAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vlan.RtSrcEncap", "rtoamSrcEncap-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vlan.RsVlanEppAtt", "rsvlanEppAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vlan.RtToVlanCkt", "rttoVlanCkt"))
    ...
    prop = PropMeta("str", "classPrefOperSt", "classPrefOperSt", 23443, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 7289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "excessiveTcnFlushCnt", "excessiveTcnFlushCnt", 22231, PropCategory.REGULAR)
    prop.label = "Number of excessive stp tcn flushes"
    prop.isOper = True
    meta.props.add("excessiveTcnFlushCnt", prop)

    prop = PropMeta("str", "fabEncap", "fabEncap", 3538, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14539, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 3540, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operState", "operState", 3539, PropCategory.REGULAR)
    prop.label = "Operational State"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 14987, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("vlan:CktEpadminSt_failed_flag", None, 2)
    prop._addConstant("vlan:CktEpclassPrefOperSt_failed_flag", None, 8388608)
    prop._addConstant("vlan:CktEpctrl_failed_flag", None, 8)
    prop._addConstant("vlan:CktEpencap_failed_flag", None, 65536)
    prop._addConstant("vlan:CktEpenfPref_failed_flag", None, 131072)
    prop._addConstant("vlan:CktEpepUpSeqNum_failed_flag", None, 16)
    prop._addConstant("vlan:CktEpepgDn_failed_flag", None, 262144)
    prop._addConstant("vlan:CktEpfabEncap_failed_flag", None, 33554432)
    prop._addConstant("vlan:CktEpfwdCtrl_failed_flag", None, 32)
    prop._addConstant("vlan:CktEpid_failed_flag", None, 128)
    prop._addConstant("vlan:CktEplcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("vlan:CktEpmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("vlan:CktEpmode_failed_flag", None, 256)
    prop._addConstant("vlan:CktEpmonPolDn_failed_flag", None, 67108864)
    prop._addConstant("vlan:CktEpname_failed_flag", None, 1)
    prop._addConstant("vlan:CktEppcTag_failed_flag", None, 1048576)
    prop._addConstant("vlan:CktEpqosPrio_failed_flag", None, 4194304)
    prop._addConstant("vlan:CktEptype_failed_flag", None, 1024)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 14989, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 14988, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
