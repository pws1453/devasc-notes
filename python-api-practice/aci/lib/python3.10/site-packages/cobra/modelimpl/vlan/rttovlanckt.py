...
# ##################################################
class RtToVlanCkt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vlan.RtToVlanCkt", "cobra.model.actrl.ARule")

    meta.moClassName = "vlanRtToVlanCkt"
    meta.rnFormat = "rttoVlanCkt"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 26383, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 26381, PropCategory.REGULAR)
