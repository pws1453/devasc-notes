...
# ##################################################
class RsVlanEppAtt(Mo):
    """
    A source relation to an abstract representation of the resolvable endpoint profile.

    """

    meta = SourceRelationMeta("cobra.model.vlan.RsVlanEppAtt", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vlanRsVlanEppAtt"
    meta.rnFormat = "rsvlanEppAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Epp Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15075, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12703, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12702, PropCategory.REGULAR)
