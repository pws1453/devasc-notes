...
# ##################################################
class RsPullRemotevVzRFltP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemotevVzRFltP", "cobra.model.vz.RFltP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemotevVzRFltP"
    meta.rnFormat = "rspullRemotevVzRFltP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51453, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1369
    prop.defaultValueStr = "vzRFltP"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzRFltP", None, 1369)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51452, PropCategory.REGULAR)
