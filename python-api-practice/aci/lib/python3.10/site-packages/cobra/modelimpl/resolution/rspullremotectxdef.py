...
# ##################################################
class RsPullRemoteCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemoteCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemoteCtxDef"
    meta.rnFormat = "rspullRemoteCtxDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51449, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51448, PropCategory.REGULAR)
