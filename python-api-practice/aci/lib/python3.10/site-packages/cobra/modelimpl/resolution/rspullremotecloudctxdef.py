...
# ##################################################
class RsPullRemoteCloudCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemoteCloudCtxDef", "cobra.model.cloud.CtxProfileDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemoteCloudCtxDef"
    meta.rnFormat = "rspullRemoteCloudCtxDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Cloud Ctx Resolved data"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51441, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14612
    prop.defaultValueStr = "cloudCtxProfileDef"
    prop._addConstant("cloudCtxProfileDef", None, 14612)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51440, PropCategory.REGULAR)
