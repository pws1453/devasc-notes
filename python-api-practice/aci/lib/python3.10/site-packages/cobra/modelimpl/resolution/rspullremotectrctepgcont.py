...
# ##################################################
class RsPullRemoteCtrctEPgCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemoteCtrctEPgCont", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemoteCtrctEPgCont"
    meta.rnFormat = "rspullRemoteCtrctEPgCont-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51445, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51444, PropCategory.REGULAR)
