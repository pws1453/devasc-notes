...
# ##################################################
class RsPullRemoteLDevDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemoteLDevDef", "cobra.model.cloud.LDevDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemoteLDevDef"
    meta.rnFormat = "rspullRemoteLDevDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51908, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15160
    prop.defaultValueStr = "cloudLDevDef"
    prop._addConstant("cloudLDevDef", None, 15160)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51907, PropCategory.REGULAR)
