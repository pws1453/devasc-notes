...
# ##################################################
class RsPullRemoteCloudAwsProviderDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemoteCloudAwsProviderDef", "cobra.model.cloud.AwsProviderDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemoteCloudAwsProviderDef"
    meta.rnFormat = "rspullRemoteCloudAwsProviderDef-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.resolution.RemotePolicyMgr")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")
    meta.superClasses.add("cobra.model.resolution.ARsToRemote")

    meta.rnPrefixes = [
        ('rspullRemoteCloudAwsProviderDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51437, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14638
    prop.defaultValueStr = "cloudAwsProviderDef"
    prop._addConstant("cloudAwsProviderDef", None, 14638)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51436, PropCategory.REGULAR)
