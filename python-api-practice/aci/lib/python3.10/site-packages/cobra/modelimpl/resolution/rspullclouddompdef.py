...
# ##################################################
class RsPullCloudDomPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullCloudDomPDef", "cobra.model.cloud.DomPDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullCloudDomPDef"
    meta.rnFormat = "rspullCloudDomPDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51433, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14655
    prop.defaultValueStr = "cloudDomPDef"
    prop._addConstant("cloudDomPDef", None, 14655)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51432, PropCategory.REGULAR)
