...
# ##################################################
class RsPullAccountDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullAccountDef", "cobra.model.cloud.AccountDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullAccountDef"
    meta.rnFormat = "rspullAccountDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55802, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16117
    prop.defaultValueStr = "cloudAccountDef"
    prop._addConstant("cloudAccountDef", None, 16117)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55801, PropCategory.REGULAR)
