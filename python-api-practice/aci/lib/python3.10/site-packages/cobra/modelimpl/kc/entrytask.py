...
class EntryTask(Mo):
    ...
    meta = ClassMeta("cobra.model.kc.EntryTask")

    meta.moClassName = "kcEntryTask"
    meta.rnFormat = "kcEntryTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33144, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("syncToSpine", "synctospine", 2729)
