...
# ##################################################
class ReconcileConfigJobTrig(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.recovery.ReconcileConfigJobTrig")

    meta.moClassName = "recoveryReconcileConfigJobTrig"
    meta.rnFormat = "recontrig"
