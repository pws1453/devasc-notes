...
# ##################################################
class ReconcileNodeTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.recovery.ReconcileNodeTask")

    meta.moClassName = "recoveryReconcileNodeTask"
    meta.rnFormat = "recoveryReconcileNodeTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('recoveryReconcileNodeTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 21579, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReconcileConfig", "reconcileconfig", 1899)
    prop._addConstant("ReportConfig", "reportconfig", 2952)
