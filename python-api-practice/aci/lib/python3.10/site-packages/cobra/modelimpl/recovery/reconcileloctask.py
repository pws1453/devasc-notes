...
# ##################################################
class ReconcileLocTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.recovery.ReconcileLocTask")

    meta.moClassName = "recoveryReconcileLocTask"
    meta.rnFormat = "recoveryReconcileLocTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 21576, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CheckConfig", "checkconfig", 2716)
    prop._addConstant("CheckerComplete", "checkercomplete", 2951)
    prop._addConstant("RefreshPolicies", "refreshpolicies", 1895)
    prop._addConstant("ReportCeps", "reportceps", 2920)
    prop._addConstant("SyncConfig", "syncconfig", 1896)
