...
# ##################################################
class RecStatusLocalContTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.recovery.RecStatusLocalContTask")

    meta.moClassName = "recoveryRecStatusLocalContTask"
    meta.rnFormat = "recoveryRecStatusLocalContTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('recoveryRecStatusLocalContTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 23660, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportRecoveryProgressStatus", "reportrecoveryprogressstatus", 2112)
