...
class StStShTask(Mo):
    ...
    meta = ClassMeta("cobra.model.recovery.StStShTask")

    meta.moClassName = "recoveryStStShTask"
    meta.rnFormat = "recoveryStStShTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 30706, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CheckSteadyState", "checksteadystate", 2700)
