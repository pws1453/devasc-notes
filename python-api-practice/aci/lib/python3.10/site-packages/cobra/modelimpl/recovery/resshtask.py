...
class ResShTask(Mo):
    ...
    meta = ClassMeta("cobra.model.recovery.ResShTask")

    meta.moClassName = "recoveryResShTask"
    meta.rnFormat = "recoveryResShTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 30401, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ResDistributeToPM", "resdistributetopm", 2679)
