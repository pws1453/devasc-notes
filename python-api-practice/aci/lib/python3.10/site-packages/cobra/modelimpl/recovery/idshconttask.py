...
# ##################################################
class IdShContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.recovery.IdShContTask")

    meta.moClassName = "recoveryIdShContTask"
    meta.rnFormat = "recoveryIdShContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 30403, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RecoverFromPd", "recoverfrompd", 2682)
