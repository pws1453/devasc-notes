...
# ##################################################
class PmCfgShTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.recovery.PmCfgShTask")

    meta.moClassName = "recoveryPmCfgShTask"
    meta.rnFormat = "recoveryPmCfgShTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 30402, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DistributePdShardToPm", "distributepdshardtopm", 2681)
