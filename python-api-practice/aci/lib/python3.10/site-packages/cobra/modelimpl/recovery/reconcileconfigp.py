...
# ##################################################
class ReconcileConfigP(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.recovery.ReconcileConfigP")

    meta.moClassName = "recoveryReconcileConfigP"
    meta.rnFormat = "recon"
    meta.category = MoCategory.REGULAR
    meta.label = "Reconcile user config with leafs"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38331, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40470, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mode", "mode", 35636, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21588, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "startTime", "startTime", 23304, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "triggerState", "triggerState", 23303, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("triggerState", prop)
    ...
    prop = PropMeta("str", "triggerType", "triggerType", 23302, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "postponed"
    prop._addConstant("immediate", "immediate", 1)
    prop._addConstant("postponed", "postponed", 0)
    meta.props.add("triggerType", prop)
