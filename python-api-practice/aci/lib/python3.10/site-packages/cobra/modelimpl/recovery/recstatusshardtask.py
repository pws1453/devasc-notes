...
# ##################################################
class RecStatusShardTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.recovery.RecStatusShardTask")

    meta.moClassName = "recoveryRecStatusShardTask"
    meta.rnFormat = "recoveryRecStatusShardTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('recoveryRecStatusShardTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 23661, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("InformCheckerStart", "informcheckerstart", 2953)
    prop._addConstant("InformReconcileStart", "informreconcilestart", 2113)
