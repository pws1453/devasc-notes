...
# ##################################################
class PmCfgShContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.recovery.PmCfgShContTask")

    meta.moClassName = "recoveryPmCfgShContTask"
    meta.rnFormat = "recoveryPmCfgShContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 31091, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("StartReconcilation", "startreconcilation", 2704)
