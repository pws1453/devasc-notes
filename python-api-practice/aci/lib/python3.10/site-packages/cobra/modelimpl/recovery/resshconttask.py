...
# ##################################################
class ResShContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.recovery.ResShContTask")

    meta.moClassName = "recoveryResShContTask"
    meta.rnFormat = "recoveryResShContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 30400, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ShardCompleteReportToPM", "shardcompletereporttopm", 2680)
