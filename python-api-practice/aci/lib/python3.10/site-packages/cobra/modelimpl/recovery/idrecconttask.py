...
# ##################################################
class IdRecContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.recovery.IdRecContTask")

    meta.moClassName = "recoveryIdRecContTask"
    meta.rnFormat = "recoveryIdRecContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 26463, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RecoverFromPmAfterUpg", "recoverfrompmafterupg", 2411)
