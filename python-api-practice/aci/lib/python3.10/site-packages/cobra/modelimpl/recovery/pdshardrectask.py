...
# ##################################################
class PdShardRecTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.recovery.PdShardRecTask")

    meta.moClassName = "recoveryPdShardRecTask"
    meta.rnFormat = "recoveryPdShardRecTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 26398, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RecoverFromPm", "recoverfrompm", 2400)
