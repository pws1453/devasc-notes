...
class IdRecTask(Mo):
    ...
    meta = ClassMeta("cobra.model.recovery.IdRecTask")

    meta.moClassName = "recoveryIdRecTask"
    meta.rnFormat = "recoveryIdRecTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 26465, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("RecoverFromIdMgr", "recoverfromidmgr", 2413)
