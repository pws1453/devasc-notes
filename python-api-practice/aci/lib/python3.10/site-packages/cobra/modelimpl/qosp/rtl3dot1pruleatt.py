...
# ##################################################
class RtL3dot1pRuleAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qosp.RtL3dot1pRuleAtt", "cobra.model.l3.If")

    meta.moClassName = "qospRtL3dot1pRuleAtt"
    meta.rnFormat = "rtl3L3dot1pRuleAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 42197, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 42196, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 42207, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
