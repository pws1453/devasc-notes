...
# ##################################################
class RtL3dscpRuleAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qosp.RtL3dscpRuleAtt", "cobra.model.l3.If")

    meta.moClassName = "qospRtL3dscpRuleAtt"
    meta.rnFormat = "rtl3L3dscpRuleAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 42203, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 42202, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 42209, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
