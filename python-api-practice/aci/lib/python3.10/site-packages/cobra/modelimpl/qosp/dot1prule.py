...
class Dot1pRule(Mo):
    """
    The QoS classification rules based on dot1p values.

    """

    meta = ClassMeta("cobra.model.qosp.Dot1pRule")

    meta.moClassName = "qospDot1pRule"
    meta.rnFormat = "dot1p-f-%(from)s-t-%(to)s-grp-%(qosGrp)s-dscp-%(markDscp)s-dot1p-%(markDot1P)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Dot1p QoS Classification Rule"
    meta.writeAccessMask = 0x100000000000001
    meta.readAccessMask = 0x100600000000001
    ...
    meta.childClasses.add("cobra.model.qosp.RtDot1pRuleAtt")
    meta.childClasses.add("cobra.model.qosp.RtL3dot1pRuleAtt")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.RtL3dot1pRuleAtt", "rtl3L3dot1pRuleAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.RtDot1pRuleAtt", "rtl2Dot1pRuleAtt-"))
    ...
    meta.superClasses.add("cobra.model.qosp.ClassRule")
    ...
    prop = PropMeta("str", "from", "from", 2178, PropCategory.REGULAR)
    prop.label = "From"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markDot1P", "markDot1P", 33452, PropCategory.REGULAR)
    prop.label = "DOT1P"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markDscp", "markDscp", 15319, PropCategory.REGULAR)
    prop.label = "DSCP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14424, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "qosGrp", "qosGrp", 15320, PropCategory.REGULAR)
    prop.label = "Group ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 14975, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosp:Dot1pRuledescr_failed_flag", None, 4)
    prop._addConstant("qosp:Dot1pRulefrom_failed_flag", None, 256)
    prop._addConstant("qosp:Dot1pRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("qosp:Dot1pRulemarkDot1P_failed_flag", None, 8)
    prop._addConstant("qosp:Dot1pRulemarkDscp_failed_flag", None, 16)
    prop._addConstant("qosp:Dot1pRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("qosp:Dot1pRulemonPolDn_failed_flag", None, 512)
    prop._addConstant("qosp:Dot1pRulenameAlias_failed_flag", None, 2)
    prop._addConstant("qosp:Dot1pRulename_failed_flag", None, 1)
    prop._addConstant("qosp:Dot1pRuleqosGrp_failed_flag", None, 128)
    prop._addConstant("qosp:Dot1pRuleto_failed_flag", None, 8192)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 14977, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 14976, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "to", "to", 2179, PropCategory.REGULAR)
    prop.label = "To"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("7", "network-control", 7)
    prop._addConstant("unspecified", "unspecified", 8)
    meta.props.add("to", prop)

    meta.namingProps.append(getattr(meta.props, "from"))
    meta.namingProps.append(getattr(meta.props, "to"))
    meta.namingProps.append(getattr(meta.props, "qosGrp"))
    meta.namingProps.append(getattr(meta.props, "markDscp"))
    meta.namingProps.append(getattr(meta.props, "markDot1P"))

    def __init__(self, parentMoOrDn, from_, to, qosGrp, markDscp, markDot1P, markDirty=True, **creationProps):
        namingVals = [from_, to, qosGrp, markDscp, markDot1P]
