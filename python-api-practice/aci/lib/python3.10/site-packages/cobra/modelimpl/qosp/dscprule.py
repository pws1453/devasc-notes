...
class DscpRule(Mo):
    """
    The QoS classification rules based on DSCP values.

    """

    meta = ClassMeta("cobra.model.qosp.DscpRule")

    meta.moClassName = "qospDscpRule"
    meta.rnFormat = "dscp-f-%(from)s-t-%(to)s-grp-%(qosGrp)s-dscp-%(markDscp)s-dot1p-%(markDot1P)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DSCP QoS Classification Rule"
    ...
    meta.childClasses.add("cobra.model.qosp.RtL3dscpRuleAtt")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.qosp.RtDscpRuleAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.RtL3dscpRuleAtt", "rtl3L3dscpRuleAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.RtDscpRuleAtt", "rtl2DscpRuleAtt-"))
    ...
    prop = PropMeta("str", "from", "from", 2176, PropCategory.REGULAR)
    prop.label = "From"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markDot1P", "markDot1P", 33453, PropCategory.REGULAR)
    prop.label = "DOT1P"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markDscp", "markDscp", 15321, PropCategory.REGULAR)
    prop.label = "DSCP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14423, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "qosGrp", "qosGrp", 15322, PropCategory.REGULAR)
    prop.label = "Group ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 14972, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosp:DscpRuledescr_failed_flag", None, 4)
    prop._addConstant("qosp:DscpRulefrom_failed_flag", None, 256)
    prop._addConstant("qosp:DscpRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("qosp:DscpRulemarkDot1P_failed_flag", None, 8)
    prop._addConstant("qosp:DscpRulemarkDscp_failed_flag", None, 16)
    prop._addConstant("qosp:DscpRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("qosp:DscpRulemonPolDn_failed_flag", None, 512)
    prop._addConstant("qosp:DscpRulenameAlias_failed_flag", None, 2)
    prop._addConstant("qosp:DscpRulename_failed_flag", None, 1)
    prop._addConstant("qosp:DscpRuleqosGrp_failed_flag", None, 128)
    prop._addConstant("qosp:DscpRuleto_failed_flag", None, 8192)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 14974, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 14973, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "to", "to", 2177, PropCategory.REGULAR)
    prop.label = "To"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
