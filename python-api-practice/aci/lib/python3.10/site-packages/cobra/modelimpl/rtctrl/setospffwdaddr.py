...
class SetOspfFwdAddr(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.SetOspfFwdAddr")

    meta.moClassName = "rtctrlSetOspfFwdAddr"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetOspfFwdAddr")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37371, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39510, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fwdAddr", "fwdAddr", 801, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 800, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 7
