...
# ##################################################
class SetOspfFwdAddrDef(Mo):
    """
    The set OSPF forward address definition.

    """

    meta = ClassMeta("cobra.model.rtctrl.SetOspfFwdAddrDef")

    meta.moClassName = "rtctrlSetOspfFwdAddrDef"
