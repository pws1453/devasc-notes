...
# ##################################################
class MatchCommTermDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.MatchCommTermDef")

    meta.moClassName = "rtctrlMatchCommTermDef"
    meta.rnFormat = "commtrm-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Match Community Term Definition"
    ...
    meta.childClasses.add("cobra.model.rtctrl.MatchCommFactorDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.rtctrl.MatchCommFactorDef", "commfct-"))
    ...
    prop = PropMeta("str", "name", "name", 23054, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
