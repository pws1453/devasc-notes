...
# ##################################################
class AMatchCommFactor(Mo):
    meta = ClassMeta("cobra.model.rtctrl.AMatchCommFactor")

    meta.isAbstract = True
    meta.moClassName = "rtctrlAMatchCommFactor"


    meta.moClassName = "rtctrlAMatchCommFactor"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Match Community Factor"
    ...
    prop = PropMeta("str", "community", "community", 23042, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
