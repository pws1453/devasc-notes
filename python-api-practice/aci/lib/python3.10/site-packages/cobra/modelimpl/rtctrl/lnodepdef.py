...
class LNodePDef(Mo):
    """
    The local node policy definition.

    """

    meta = ClassMeta("cobra.model.rtctrl.LNodePDef")

    meta.moClassName = "rtctrlLNodePDef"
    ...
    prop = PropMeta("str", "name", "name", 7128, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
