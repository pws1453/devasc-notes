...
class SetDamp(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.SetDamp")

    meta.moClassName = "rtctrlSetDamp"
    meta.rnFormat = "sdamp"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetDamp")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40538, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "halfLife", "halfLife", 23172, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxSuppressTime", "maxSuppressTime", 23175, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "reuse", "reuse", 23173, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "suppress", "suppress", 23174, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 23171, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 10
    prop.defaultValueStr = "dampening-pol"
