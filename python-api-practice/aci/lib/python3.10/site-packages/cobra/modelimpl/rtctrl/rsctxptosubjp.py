...
# ##################################################
class RsCtxPToSubjP(Mo):
    """
    A source relation to the subject profile.

    """

    meta = NamedSourceRelationMeta("cobra.model.rtctrl.RsCtxPToSubjP", "cobra.model.rtctrl.SubjP")
    meta.targetNameProps["name"] = "tnRtctrlSubjPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "rtctrlRsCtxPToSubjP"
    meta.rnFormat = "rsctxPToSubjP-%(tnRtctrlSubjPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Subject Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37361, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39500, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13893, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11375, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 580
    prop.defaultValueStr = "rtctrlSubjP"
    ...
    prop = PropMeta("str", "tnRtctrlSubjPName", "tnRtctrlSubjPName", 11374, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnRtctrlSubjPName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnRtctrlSubjPName"))
    ...
    def __init__(self, parentMoOrDn, tnRtctrlSubjPName, markDirty=True, **creationProps):
        namingVals = [tnRtctrlSubjPName]
