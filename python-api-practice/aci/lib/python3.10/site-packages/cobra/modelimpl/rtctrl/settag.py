...
class SetTag(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.SetTag")

    meta.moClassName = "rtctrlSetTag"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37366, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39505, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
