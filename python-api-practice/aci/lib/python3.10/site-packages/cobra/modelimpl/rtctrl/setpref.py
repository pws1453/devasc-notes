...
class SetPref(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.SetPref")

    meta.moClassName = "rtctrlSetPref"
    meta.rnFormat = "spref"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetPref")

    meta.rnPrefixes = [
        ('spref', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37369, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39508, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "localPref", "localPref", 797, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 796, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 4
