...
# ##################################################
class MatchRtSrcDef(Mo):
    """
    The match route source definition.

    """

    meta = ClassMeta("cobra.model.rtctrl.MatchRtSrcDef")

    meta.moClassName = "rtctrlMatchRtSrcDef"
    meta.rnFormat = "src-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Match Route Source Rule Definition"
    ...
    prop = PropMeta("str", "ip", "ip", 7136, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 782, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4
