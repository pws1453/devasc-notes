...
class SetWeight(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.SetWeight")

    meta.moClassName = "rtctrlSetWeight"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetWeight")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40546, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "type", "type", 23305, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "weight", "weight", 23306, PropCategory.REGULAR)
    prop.label = "Weight"
    prop.isConfig = True
    prop.isAdmin = True
