...
# ##################################################
class AMatchCommTerm(Mo):
    meta = ClassMeta("cobra.model.rtctrl.AMatchCommTerm")

    meta.isAbstract = True
    meta.moClassName = "rtctrlAMatchCommTerm"


    meta.moClassName = "rtctrlAMatchCommTerm"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Match Community Term"
