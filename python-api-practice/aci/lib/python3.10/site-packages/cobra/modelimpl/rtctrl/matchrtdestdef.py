...
# ##################################################
class MatchRtDestDef(Mo):
    """
    The match route destination definition.

    """

    meta = ClassMeta("cobra.model.rtctrl.MatchRtDestDef")

    meta.moClassName = "rtctrlMatchRtDestDef"
    meta.rnFormat = "dest-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Match Route Destination Rule Definition"
    ...
    prop = PropMeta("str", "ip", "ip", 7132, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 773, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
