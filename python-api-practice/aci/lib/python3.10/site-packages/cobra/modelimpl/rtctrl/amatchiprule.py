...
# ##################################################
class AMatchIpRule(Mo):
    meta = ClassMeta("cobra.model.rtctrl.AMatchIpRule")

    meta.isAbstract = True
    meta.moClassName = "rtctrlAMatchIpRule"
    ...
    prop = PropMeta("str", "ip", "ip", 771, PropCategory.REGULAR)
