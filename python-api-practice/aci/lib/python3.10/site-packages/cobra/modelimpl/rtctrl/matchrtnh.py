...
class MatchRtNh(Mo):
    """
    Match Rule based Route Next Hope

    """

    meta = ClassMeta("cobra.model.rtctrl.MatchRtNh")

    meta.moClassName = "rtctrlMatchRtNh"
    meta.rnFormat = "nh-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Match Route Next Hop Rule"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37357, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39496, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 7133, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 779, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
