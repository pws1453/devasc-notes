...
# ##################################################
class RsScopeToAttrP(Mo):
    """
    The action profile name.

    """

    meta = NamedSourceRelationMeta("cobra.model.rtctrl.RsScopeToAttrP", "cobra.model.rtctrl.AttrP")
    meta.targetNameProps["name"] = "tnRtctrlAttrPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "rtctrlRsScopeToAttrP"
    meta.rnFormat = "rsScopeToAttrP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attribute Profile"
    ...
    meta.rnPrefixes = [
        ('rsScopeToAttrP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37364, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39503, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13896, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11379, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 607
    prop.defaultValueStr = "rtctrlAttrP"
    ...
    prop = PropMeta("str", "tnRtctrlAttrPName", "tnRtctrlAttrPName", 11378, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnRtctrlAttrPName", prop)
