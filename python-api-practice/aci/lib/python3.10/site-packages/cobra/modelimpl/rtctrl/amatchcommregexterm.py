...
# ##################################################
class AMatchCommRegexTerm(Mo):
    meta = ClassMeta("cobra.model.rtctrl.AMatchCommRegexTerm")

    meta.isAbstract = True
    meta.moClassName = "rtctrlAMatchCommRegexTerm"


    meta.moClassName = "rtctrlAMatchCommRegexTerm"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction Match Rule Based on Community Regular Expression"
    ...
    prop = PropMeta("str", "commType", "commType", 23046, PropCategory.REGULAR)
