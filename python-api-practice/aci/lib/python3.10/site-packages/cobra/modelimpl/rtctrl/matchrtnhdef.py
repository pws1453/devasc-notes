...
# ##################################################
class MatchRtNhDef(Mo):
    """
    The match route next hop definition.

    """

    meta = ClassMeta("cobra.model.rtctrl.MatchRtNhDef")

    meta.moClassName = "rtctrlMatchRtNhDef"
    meta.rnFormat = "nh-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Match Route Next Hop Rule Definition"
    ...
    prop = PropMeta("str", "ip", "ip", 7134, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 780, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
