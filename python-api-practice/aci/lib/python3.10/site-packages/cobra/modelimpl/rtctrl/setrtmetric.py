...
# ##################################################
class SetRtMetric(Mo):
    """
    The set action rule based on metric.

    """

    meta = ClassMeta("cobra.model.rtctrl.SetRtMetric")

    meta.moClassName = "rtctrlSetRtMetric"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37368, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39507, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
