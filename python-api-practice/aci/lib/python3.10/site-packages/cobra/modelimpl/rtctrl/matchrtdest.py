...
# ##################################################
class MatchRtDest(Mo):
    """
    The match action rule based on the route destination.

    """

    meta = ClassMeta("cobra.model.rtctrl.MatchRtDest")

    meta.moClassName = "rtctrlMatchRtDest"
    meta.rnFormat = "dest-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Match Route Destination Rule"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37355, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39494, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 7131, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 772, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
