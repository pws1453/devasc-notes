...
# ##################################################
class SetRtMetricTypeDef(Mo):
    """
    The definition for a set action rule based on a metric type.

    """

    meta = ClassMeta("cobra.model.rtctrl.SetRtMetricTypeDef")

    meta.moClassName = "rtctrlSetRtMetricTypeDef"
