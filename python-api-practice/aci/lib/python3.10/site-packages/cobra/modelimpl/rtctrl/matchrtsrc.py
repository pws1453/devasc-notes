...
class MatchRtSrc(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.MatchRtSrc")

    meta.moClassName = "rtctrlMatchRtSrc"
    meta.rnFormat = "src-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Match Route Source Rule"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37358, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39497, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 7135, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 781, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4
