...
class DampPolDef(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.DampPolDef")

    meta.moClassName = "rtctrlDampPolDef"
    meta.rnFormat = "damppolDef-%(af)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Dampening Policy Definition"
    ...
    prop = PropMeta("str", "af", "af", 23170, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "polDn", "polDn", 23584, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
