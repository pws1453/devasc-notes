...
# ##################################################
class SetRtMetricType(Mo):
    """
    The set action rule based on a metric type.

    """

    meta = ClassMeta("cobra.model.rtctrl.SetRtMetricType")

    meta.moClassName = "rtctrlSetRtMetricType"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetRtMetricType")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40296, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "metricType", "metricType", 17658, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    meta.props.add("metricType", prop)
    ...
    prop = PropMeta("str", "type", "type", 17657, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 9
