...
class SetNh(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.SetNh")

    meta.moClassName = "rtctrlSetNh"
    meta.rnFormat = "nh"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetNh")
    ...
    prop = PropMeta("str", "addr", "addr", 17659, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 37370, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39509, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "type", "type", 798, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 8
