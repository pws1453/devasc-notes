...
class SetOspfNssa(Mo):
    """
    The set rule based on the OSPF-NSSA.

    """

    meta = ClassMeta("cobra.model.rtctrl.SetOspfNssa")

    meta.moClassName = "rtctrlSetOspfNssa"
    meta.rnFormat = "snssa"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetOspfNssa")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37372, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39511, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "type", "type", 802, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 6
