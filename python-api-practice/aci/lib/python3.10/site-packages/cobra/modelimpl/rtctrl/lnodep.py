...
class LNodeP(Mo):
    ...
    meta = ClassMeta("cobra.model.rtctrl.LNodeP")

    meta.moClassName = "rtctrlLNodeP"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37359, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39498, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 7127, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
