...
class IngrDrop1d(Mo):
    """
    A class that represents the most current statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDrop1d", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDrop1d"
    meta.rnFormat = "CDdppIngrDrop1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Data Plane Policer Drop Counters stats in 1 day"
