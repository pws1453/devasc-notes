...
# ##################################################
class IngrDropHist1h(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist1h", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist1h"
    meta.rnFormat = "HDdppIngrDrop1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 23702, PropCategory.REGULAR)
