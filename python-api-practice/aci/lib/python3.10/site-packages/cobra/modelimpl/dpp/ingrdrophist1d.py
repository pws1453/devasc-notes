...
# ##################################################
class IngrDropHist1d(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist1d", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist1d"
    meta.rnFormat = "HDdppIngrDrop1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 23701, PropCategory.REGULAR)
