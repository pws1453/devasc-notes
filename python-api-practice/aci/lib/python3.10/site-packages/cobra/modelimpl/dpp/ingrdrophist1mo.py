...
# ##################################################
class IngrDropHist1mo(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist1mo", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist1mo"
    meta.rnFormat = "HDdppIngrDrop1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 23703, PropCategory.REGULAR)
