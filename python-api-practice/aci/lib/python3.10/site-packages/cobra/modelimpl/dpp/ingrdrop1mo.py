...
# ##################################################
class IngrDrop1mo(Mo):
    """
    A class that represents the most current statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDrop1mo", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDrop1mo"
    meta.rnFormat = "CDdppIngrDrop1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Data Plane Policer Drop Counters stats in 1 month"
