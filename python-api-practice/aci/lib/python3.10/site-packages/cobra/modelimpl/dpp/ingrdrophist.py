...
# ##################################################
class IngrDropHist(Mo):
    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist"


    meta.moClassName = "dppIngrDropHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats"
    ...
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist1w")
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist15min")
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist1qtr")
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist1mo")
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist1year")
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist1d")
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist5min")
    meta.concreteSubClasses.add("cobra.model.dpp.IngrDropHist1h")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 23940, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Policer Dropped Bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 23936, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Ingress Policer Dropped Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 23939, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Policer Dropped Bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 23938, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Policer Dropped Bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 23937, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Ingress Policer Dropped Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 23944, PropCategory.IMPLICIT_RATE)
    prop.label = "Ingress Policer Dropped Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesRateAvg", "bytesRateAvg", 23956, PropCategory.IMPLICIT_AVG)
    prop.label = "Ingress Policer Dropped Bytes rate average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateAvg", prop)

    prop = PropMeta("str", "bytesRateMax", "bytesRateMax", 23955, PropCategory.IMPLICIT_MAX)
    prop.label = "Ingress Policer Dropped Bytes rate maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMax", prop)

    prop = PropMeta("str", "bytesRateMin", "bytesRateMin", 23954, PropCategory.IMPLICIT_MIN)
    prop.label = "Ingress Policer Dropped Bytes rate minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateMin", prop)

    prop = PropMeta("str", "bytesRateSpct", "bytesRateSpct", 23957, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Policer Dropped Bytes rate suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateSpct", prop)

    prop = PropMeta("str", "bytesRateThr", "bytesRateThr", 23958, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesRateTr", "bytesRateTr", 23959, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Policer Dropped Bytes rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRateTr", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 23941, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Policer Dropped Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 23942, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 23943, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsRateTr", "pktsRateTr", 23995, PropCategory.IMPLICIT_TREND)
    prop.label = "Ingress Policer Dropped Packets rate trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRateTr", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 23977, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Ingress Policer Dropped Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 23978, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 23979, PropCategory.IMPLICIT_TREND)
