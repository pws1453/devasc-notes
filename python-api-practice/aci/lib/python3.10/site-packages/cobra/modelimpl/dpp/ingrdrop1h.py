...
class IngrDrop1h(Mo):
    """
    A class that represents the most current statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDrop1h", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDrop1h"
    meta.rnFormat = "CDdppIngrDrop1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Data Plane Policer Drop Counters stats in 1 hour"
