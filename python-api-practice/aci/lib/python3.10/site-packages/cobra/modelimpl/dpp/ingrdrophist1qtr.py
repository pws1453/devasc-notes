...
# ##################################################
class IngrDropHist1qtr(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist1qtr", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist1qtr"
    meta.rnFormat = "HDdppIngrDrop1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 23704, PropCategory.REGULAR)
