...
# ##################################################
class IngrDrop1year(Mo):
    """
    A class that represents the most current statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDrop1year", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDrop1year"
    meta.rnFormat = "CDdppIngrDrop1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Data Plane Policer Drop Counters stats in 1 year"
