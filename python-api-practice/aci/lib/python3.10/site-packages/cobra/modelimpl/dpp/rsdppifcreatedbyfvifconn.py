...
# ##################################################
class RsDppIfCreatedByFvIfConn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.dpp.RsDppIfCreatedByFvIfConn", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "dppRsDppIfCreatedByFvIfConn"
    meta.rnFormat = "rsDppIfCreatedByFvIfConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "fvIfConn MO that caused this dppIf to be created"
    ...
    meta.rnPrefixes = [
        ('rsDppIfCreatedByFvIfConn', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 33579, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33578, PropCategory.REGULAR)
