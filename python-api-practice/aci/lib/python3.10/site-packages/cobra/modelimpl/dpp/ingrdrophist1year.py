...
# ##################################################
class IngrDropHist1year(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist1year", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist1year"
    meta.rnFormat = "HDdppIngrDrop1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 23706, PropCategory.REGULAR)
