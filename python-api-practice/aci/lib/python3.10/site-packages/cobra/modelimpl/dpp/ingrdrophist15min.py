...
# ##################################################
class IngrDropHist15min(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist15min", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist15min"
    meta.rnFormat = "HDdppIngrDrop15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.dpp.IngrDropHist")

    meta.rnPrefixes = [
        ('HDdppIngrDrop15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 23700, PropCategory.REGULAR)
