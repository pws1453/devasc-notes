...
# ##################################################
class IngrDrop5min(Mo):
    """
    A class that represents the most current statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDrop5min", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDrop5min"
    meta.rnFormat = "CDdppIngrDrop5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Data Plane Policer Drop Counters stats in 5 minute"
