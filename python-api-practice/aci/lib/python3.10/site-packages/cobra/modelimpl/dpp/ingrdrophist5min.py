...
# ##################################################
class IngrDropHist5min(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist5min", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist5min"
    meta.rnFormat = "HDdppIngrDrop5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 23707, PropCategory.REGULAR)
