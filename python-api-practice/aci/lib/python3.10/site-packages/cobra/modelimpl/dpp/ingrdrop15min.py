...
# ##################################################
class IngrDrop15min(Mo):
    """
    A class that represents the most current statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDrop15min", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDrop15min"
    meta.rnFormat = "CDdppIngrDrop15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Data Plane Policer Drop Counters stats in 15 minute"
