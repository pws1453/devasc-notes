...
class IngrDrop1w(Mo):
    """
    A class that represents the most current statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDrop1w", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDrop1w"
    meta.rnFormat = "CDdppIngrDrop1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Ingress Data Plane Policer Drop Counters stats in 1 week"
