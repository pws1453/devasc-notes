...
class Entity(Mo):
    """
     Holds dpp control plane entity information 

    """

    meta = ClassMeta("cobra.model.dpp.Entity")

    meta.moClassName = "dppEntity"
    meta.rnFormat = "dpp"
    meta.category = MoCategory.REGULAR
    meta.label = "DPP Entity"
    ...
    meta.childClasses.add("cobra.model.dpp.Class")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dpp.Class", "classp-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22419, PropCategory.REGULAR)
