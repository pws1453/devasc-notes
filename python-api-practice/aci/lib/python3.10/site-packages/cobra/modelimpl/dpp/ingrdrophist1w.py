...
# ##################################################
class IngrDropHist1w(Mo):
    """
    A class that represents historical statistics for  Ingress  Data  Plane  Policer  Drop  Counters in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.dpp.IngrDropHist1w", "Ingress Data Plane Policer Drop Counters")
    ...
    meta.moClassName = "dppIngrDropHist1w"
    meta.rnFormat = "HDdppIngrDrop1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Ingress Data Plane Policer Drop Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 23705, PropCategory.REGULAR)
