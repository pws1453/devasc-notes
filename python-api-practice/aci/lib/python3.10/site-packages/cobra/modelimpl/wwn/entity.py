...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.wwn.Entity")

    meta.moClassName = "wwnEntity"
    meta.rnFormat = "wwn"
    meta.category = MoCategory.REGULAR
    meta.label = "WWN Manager Entities"
    ...
    meta.childClasses.add("cobra.model.wwn.Oui")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.wwn.Oui", "oui-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56062, PropCategory.REGULAR)
