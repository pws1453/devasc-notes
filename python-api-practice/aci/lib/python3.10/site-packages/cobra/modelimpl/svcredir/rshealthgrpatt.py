...
# ##################################################
class RsHealthGrpAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.svcredir.RsHealthGrpAtt", "cobra.model.svcredir.HealthGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "svcredirRsHealthGrpAtt"
    meta.rnFormat = "rsHealthGrpAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Dest HealthGrp Attachment"
    ...
    meta.childClasses.add("cobra.model.svcredir.HgAttCons")

    meta.childNamesAndRnPrefix.append(("cobra.model.svcredir.HgAttCons", "consDn-"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 34144, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10945
    prop.defaultValueStr = "svcredirHealthGrp"
    prop._addConstant("svcredirHealthGrp", None, 10945)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34143, PropCategory.REGULAR)
