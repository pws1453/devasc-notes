...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.svcredir.Entity")

    meta.moClassName = "svcredirEntity"
    meta.rnFormat = "svcredir"
    ...
    meta.childClasses.add("cobra.model.svcredir.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.svcredir.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26388, PropCategory.REGULAR)
