...
# ##################################################
class RsSessionScheduler(Mo):
    """
     Relation from session to scheduler policy 

    """

    meta = NamedSourceRelationMeta("cobra.model.troubleshoot.RsSessionScheduler", "cobra.model.trig.SchedP")
    meta.targetNameProps["name"] = "tnTrigSchedPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "troubleshootRsSessionScheduler"
    meta.rnFormat = "rsSessionScheduler"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to a Scheduler Policy"
    ...
    meta.rnPrefixes = [
        ('rsSessionScheduler', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38223, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40362, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18654, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18648, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1810
    prop.defaultValueStr = "trigSchedP"
    ...
    prop = PropMeta("str", "tnTrigSchedPName", "tnTrigSchedPName", 18647, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTrigSchedPName", prop)
