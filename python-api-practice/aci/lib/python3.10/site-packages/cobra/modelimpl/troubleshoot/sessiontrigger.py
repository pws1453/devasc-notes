...
# ##################################################
class SessionTrigger(Mo):
    """
     Trigger on which the scheduler issues a callback. For internal use only. 

    """

    meta = ClassMeta("cobra.model.troubleshoot.SessionTrigger")

    meta.moClassName = "troubleshootSessionTrigger"
    meta.rnFormat = "sessiontrigger-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Session Trigger"
    ...
    prop = PropMeta("str", "name", "name", 18634, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
