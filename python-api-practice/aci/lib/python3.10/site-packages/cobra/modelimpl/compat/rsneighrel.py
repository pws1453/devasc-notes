...
class RsNeighRel(Mo):
    """
    A source relation to the firmware versions compatible between directly connected neighbors

    """

    meta = SourceRelationMeta("cobra.model.compat.RsNeighRel", "cobra.model.compat.Fw")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compatRsNeighRel"
    meta.rnFormat = "rsneighRel-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Directly Connected Neighbour Compatible Firmware Version"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11363, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 530
    prop.defaultValueStr = "compatFw"
    ...
    prop = PropMeta("str", "tDn", "tDn", 11362, PropCategory.REGULAR)
