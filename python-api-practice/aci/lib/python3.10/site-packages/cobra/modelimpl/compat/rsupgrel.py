...
class RsUpgRel(Mo):
    """
    A source relation to the firmware versions compatible for upgrade/downgrade.

    """

    meta = SourceRelationMeta("cobra.model.compat.RsUpgRel", "cobra.model.compat.Fw")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compatRsUpgRel"
    meta.rnFormat = "rsupgRel-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Upgrade/Downgrade Compatible Firmware Version"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11359, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11358, PropCategory.REGULAR)
