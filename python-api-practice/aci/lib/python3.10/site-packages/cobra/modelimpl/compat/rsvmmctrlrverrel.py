...
# ##################################################
class RsVmmCtrlrVerRel(Mo):
    """
    A source relation to the VMM controller version.

    """

    meta = SourceRelationMeta("cobra.model.compat.RsVmmCtrlrVerRel", "cobra.model.compat.VmmCtrlrVer")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compatRsVmmCtrlrVerRel"
    meta.rnFormat = "rsvmmCtrlrVerRel-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "VMM Controller Supported Versions by IFC"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11371, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 561
    prop.defaultValueStr = "compatVmmCtrlrVer"
    prop._addConstant("compatVmmCtrlrVer", None, 561)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11370, PropCategory.REGULAR)
