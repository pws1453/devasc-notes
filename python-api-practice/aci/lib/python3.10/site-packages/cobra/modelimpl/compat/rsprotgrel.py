...
class RsProtGRel(Mo):
    """
    A source relation to the firmware versions compatible between VPC peers.

    """

    meta = SourceRelationMeta("cobra.model.compat.RsProtGRel", "cobra.model.compat.Fw")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compatRsProtGRel"
    meta.rnFormat = "rsprotGRel-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Protection Group Compatible Firmware Version"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11355, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11354, PropCategory.REGULAR)
