...
class RsFabRel(Mo):
    """
    A source relation to the firmware versions that can co-exist in fabric.

    """

    meta = SourceRelationMeta("cobra.model.compat.RsFabRel", "cobra.model.compat.Fw")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compatRsFabRel"
    meta.rnFormat = "rsfabRel-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Compatible Firmware Versions"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11351, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11350, PropCategory.REGULAR)
