...
# ##################################################
class IDEpTxBytes1mo(Mo):
    """
    A class that represents the most current statistics for transmitted bytes in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes1mo", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes1mo"
    meta.rnFormat = "CDopflexIDEpTxBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted bytes stats in 1 month"
