...
# ##################################################
class OvsContractAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist1qtr", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist1qtr"
    meta.rnFormat = "HDopflexOvsContractAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34748, PropCategory.REGULAR)
