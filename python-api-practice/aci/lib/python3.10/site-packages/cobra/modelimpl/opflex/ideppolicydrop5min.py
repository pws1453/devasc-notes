...
# ##################################################
class IDEpPolicyDrop5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDrop5min", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDrop5min"
    meta.rnFormat = "CDopflexIDEpPolicyDrop5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current EPG policy drop statistics stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpPolicyDrop5min', False),
    ]
