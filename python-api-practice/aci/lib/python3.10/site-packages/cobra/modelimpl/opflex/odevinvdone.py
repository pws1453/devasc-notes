...
# ##################################################
class ODevInvDone(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.ODevInvDone")

    meta.moClassName = "opflexODevInvDone"
    meta.rnFormat = "odevinvdone"
    meta.category = MoCategory.REGULAR
    meta.label = "Opflex Device Inventory Done"
