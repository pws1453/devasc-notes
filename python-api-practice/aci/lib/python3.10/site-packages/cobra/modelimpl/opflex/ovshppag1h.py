...
class OvsHppAg1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.OvsHppAg1h", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAg1h"
    meta.rnFormat = "CDopflexOvsHppAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs host protection stats stats in 1 hour"
