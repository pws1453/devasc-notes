...
# ##################################################
class OvsHppPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart5min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart5min"
    meta.rnFormat = "CDopflexOvsHppPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34807, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
