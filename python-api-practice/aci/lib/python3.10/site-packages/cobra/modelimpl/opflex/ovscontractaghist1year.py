...
# ##################################################
class OvsContractAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist1year", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist1year"
    meta.rnFormat = "HDopflexOvsContractAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34750, PropCategory.REGULAR)
