...
# ##################################################
class IDEpTxBytes15min(Mo):
    """
    A class that represents the most current statistics for transmitted bytes in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes15min", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes15min"
    meta.rnFormat = "CDopflexIDEpTxBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.IDEpTxBytes")

    meta.rnPrefixes = [
        ('CDopflexIDEpTxBytes15min', False),
    ]
