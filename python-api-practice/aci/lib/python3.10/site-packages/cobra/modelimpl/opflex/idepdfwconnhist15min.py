...
# ##################################################
class IDEpDfwConnHist15min(Mo):
    """
    A class that represents historical statistics for DFW connection statistics in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnHist15min", "DFW connection statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnHist15min"
    meta.rnFormat = "HDopflexIDEpDfwConn15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection statistics stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 19136, PropCategory.REGULAR)
