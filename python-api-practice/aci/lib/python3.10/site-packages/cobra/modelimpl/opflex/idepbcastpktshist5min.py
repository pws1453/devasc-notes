...
# ##################################################
class IDEpBcastPktsHist5min(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist5min", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist5min"
    meta.rnFormat = "HDopflexIDEpBcastPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 5 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.IDEpBcastPktsHist")

    meta.rnPrefixes = [
        ('HDopflexIDEpBcastPkts5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 15888, PropCategory.REGULAR)
