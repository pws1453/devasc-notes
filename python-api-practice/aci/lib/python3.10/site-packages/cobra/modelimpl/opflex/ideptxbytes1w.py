...
# ##################################################
class IDEpTxBytes1w(Mo):
    """
    A class that represents the most current statistics for transmitted bytes in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes1w", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes1w"
    meta.rnFormat = "CDopflexIDEpTxBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted bytes stats in 1 week"
