...
class IDEpRxPktsHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.IDEpRxPktsHist1d", "received packets")
    ...
    meta.moClassName = "opflexIDEpRxPktsHist1d"
    meta.rnFormat = "HDopflexIDEpRxPkts1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6955, PropCategory.REGULAR)
