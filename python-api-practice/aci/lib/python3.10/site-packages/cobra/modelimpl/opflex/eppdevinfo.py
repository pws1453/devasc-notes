...
class EppDevInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.opflex.EppDevInfo")

    meta.moClassName = "opflexEppDevInfo"
    meta.rnFormat = "edi-%(epgID)s"
    ...
    prop = PropMeta("str", "encap", "encap", 952, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "epgCos", "epgCos", 33156, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "epgCosPref", "epgCosPref", 33185, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "epgID", "epgID", 951, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.range = [(1, 512)]
    meta.props.add("epgID", prop)

    prop = PropMeta("str", "eppdn", "eppdn", 18690, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "handle", "handle", 19126, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mcastAddr", "mcastAddr", 15695, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "netflowDir", "netflowDir", 31103, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "netflowPref", "netflowPref", 31102, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "primaryEncapInner", "primaryEncapInner", 34683, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "scopeId", "scopeId", 43433, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("scopeId", prop)

    prop = PropMeta("str", "secondaryEncapInner", "secondaryEncapInner", 34684, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 37163, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    meta.namingProps.append(getattr(meta.props, "epgID"))

    def __init__(self, parentMoOrDn, epgID, markDirty=True, **creationProps):
        namingVals = [epgID]
