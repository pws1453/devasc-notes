...
# ##################################################
class OvsContract1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContract1h", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContract1h"
    meta.rnFormat = "CDopflexOvsContract1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ovs contract stats stats in 1 hour"
