...
# ##################################################
class OvsContractHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist1h", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist1h"
    meta.rnFormat = "HDopflexOvsContract1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 34754, PropCategory.REGULAR)
