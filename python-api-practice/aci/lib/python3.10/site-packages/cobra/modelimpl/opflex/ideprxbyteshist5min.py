...
# ##################################################
class IDEpRxBytesHist5min(Mo):
    """
    A class that represents historical statistics for received bytes in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist5min", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist5min"
    meta.rnFormat = "HDopflexIDEpRxBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical received bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6953, PropCategory.REGULAR)
