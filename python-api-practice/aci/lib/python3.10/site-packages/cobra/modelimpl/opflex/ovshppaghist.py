...
# ##################################################
class OvsHppAgHist(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist"


    meta.moClassName = "opflexOvsHppAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAgHist1h")
