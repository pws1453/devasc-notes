...
# ##################################################
class IDEpTxBytes5min(Mo):
    """
    A class that represents the most current statistics for transmitted bytes in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes5min", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes5min"
    meta.rnFormat = "CDopflexIDEpTxBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted bytes stats in 5 minute"
