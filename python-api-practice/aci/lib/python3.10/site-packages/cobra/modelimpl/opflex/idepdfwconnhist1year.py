...
# ##################################################
class IDEpDfwConnHist1year(Mo):
    """
    A class that represents historical statistics for DFW connection statistics in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnHist1year", "DFW connection statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnHist1year"
    meta.rnFormat = "HDopflexIDEpDfwConn1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection statistics stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 19142, PropCategory.REGULAR)
