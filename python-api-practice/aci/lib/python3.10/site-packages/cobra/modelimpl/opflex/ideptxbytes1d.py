...
# ##################################################
class IDEpTxBytes1d(Mo):
    """
    A class that represents the most current statistics for transmitted bytes in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes1d", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes1d"
    meta.rnFormat = "CDopflexIDEpTxBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted bytes stats in 1 day"
