...
# ##################################################
class IDEpBcastPktsHist1d(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist1d", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist1d"
    meta.rnFormat = "HDopflexIDEpBcastPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 15882, PropCategory.REGULAR)
