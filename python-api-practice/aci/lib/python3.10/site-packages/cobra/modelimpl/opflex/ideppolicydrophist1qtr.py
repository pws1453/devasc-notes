...
# ##################################################
class IDEpPolicyDropHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist1qtr", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist1qtr"
    meta.rnFormat = "HDopflexIDEpPolicyDrop1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpPolicyDrop1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 23607, PropCategory.REGULAR)
