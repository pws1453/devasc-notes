...
# ##################################################
class IDEpPolicyDrop1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDrop1mo", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDrop1mo"
    meta.rnFormat = "CDopflexIDEpPolicyDrop1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current EPG policy drop statistics stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpPolicyDrop1mo', False),
    ]
