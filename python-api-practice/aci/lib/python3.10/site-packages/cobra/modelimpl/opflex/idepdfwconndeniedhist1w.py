...
# ##################################################
class IDEpDfwConnDeniedHist1w(Mo):
    """
    A class that represents historical statistics for DFW connection denied statistics in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnDeniedHist1w", "DFW connection denied statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnDeniedHist1w"
    meta.rnFormat = "HDopflexIDEpDfwConnDenied1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection denied statistics stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpDfwConnDenied1w-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19133, PropCategory.REGULAR)
