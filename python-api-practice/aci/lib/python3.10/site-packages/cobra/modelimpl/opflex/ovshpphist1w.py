...
# ##################################################
class OvsHppHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist1w", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist1w"
    meta.rnFormat = "HDopflexOvsHpp1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 34797, PropCategory.REGULAR)
