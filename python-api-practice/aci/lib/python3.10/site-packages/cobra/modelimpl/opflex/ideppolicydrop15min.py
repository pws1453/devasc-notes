...
# ##################################################
class IDEpPolicyDrop15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDrop15min", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDrop15min"
    meta.rnFormat = "CDopflexIDEpPolicyDrop15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current EPG policy drop statistics stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpPolicyDrop15min', False),
    ]
