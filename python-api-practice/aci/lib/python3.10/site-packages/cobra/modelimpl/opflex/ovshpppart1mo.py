...
# ##################################################
class OvsHppPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart1mo", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart1mo"
    meta.rnFormat = "CDopflexOvsHppPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34803, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
