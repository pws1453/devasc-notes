...
# ##################################################
class OvsHppAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist1w", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist1w"
    meta.rnFormat = "HDopflexOvsHppAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 34789, PropCategory.REGULAR)
