...
# ##################################################
class OvsHppPart1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart1h", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart1h"
    meta.rnFormat = "CDopflexOvsHppPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34802, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
