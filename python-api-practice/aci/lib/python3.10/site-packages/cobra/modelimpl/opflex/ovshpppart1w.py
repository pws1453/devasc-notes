...
# ##################################################
class OvsHppPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart1w", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart1w"
    meta.rnFormat = "CDopflexOvsHppPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34805, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
