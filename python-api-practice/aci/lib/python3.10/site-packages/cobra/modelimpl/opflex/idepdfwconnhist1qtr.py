...
# ##################################################
class IDEpDfwConnHist1qtr(Mo):
    """
    A class that represents historical statistics for DFW connection statistics in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnHist1qtr", "DFW connection statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnHist1qtr"
    meta.rnFormat = "HDopflexIDEpDfwConn1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection statistics stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 19140, PropCategory.REGULAR)
