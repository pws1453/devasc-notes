...
# ##################################################
class OvsContractHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist1qtr", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist1qtr"
    meta.rnFormat = "HDopflexOvsContract1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 34756, PropCategory.REGULAR)
