...
# ##################################################
class OvsContractPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist1year", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist1year"
    meta.rnFormat = "HDopflexOvsContractPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractPart1year-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34780, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34781, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
