...
class ODevCap(Mo):
    ...
    meta = ClassMeta("cobra.model.opflex.ODevCap")

    meta.moClassName = "opflexODevCap"
    meta.rnFormat = "odevcap"
    ...
    prop = PropMeta("str", "devId", "devId", 954, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "features", "features", 18695, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "lNodeDn", "lNodeDn", 955, PropCategory.REGULAR)
    prop.label = "LNode Dn"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "version", "version", 953, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
