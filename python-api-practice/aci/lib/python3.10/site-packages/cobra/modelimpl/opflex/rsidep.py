...
class RsIDEp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.opflex.RsIDEp", "cobra.model.opflex.IDEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "opflexRsIDEp"
    meta.rnFormat = "rsiDEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to IDEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39263, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39262, PropCategory.REGULAR)
