...
# ##################################################
class IDEpPolicyDrop1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDrop1w", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDrop1w"
    meta.rnFormat = "CDopflexIDEpPolicyDrop1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current EPG policy drop statistics stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpPolicyDrop1w', False),
    ]
