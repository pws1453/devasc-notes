...
# ##################################################
class IDEpBcastPkts1w(Mo):
    """
    A class that represents the most current statistics for broadcast packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPkts1w", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPkts1w"
    meta.rnFormat = "CDopflexIDEpBcastPkts1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current broadcast packets stats in 1 week"
