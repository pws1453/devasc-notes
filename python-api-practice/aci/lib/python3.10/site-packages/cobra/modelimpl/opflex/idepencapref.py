...
# ##################################################
class IDEpEncapRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.IDEpEncapRef")

    meta.moClassName = "opflexIDEpEncapRef"
    meta.rnFormat = "idepencapref-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Inband Discovered Endpoint Encap Reference"
    ...
    meta.parentClasses.add("cobra.model.opflex.IDEpRef")
    ...
    prop = PropMeta("str", "encap", "encap", 19943, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "idepDn", "idepDn", 19944, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
