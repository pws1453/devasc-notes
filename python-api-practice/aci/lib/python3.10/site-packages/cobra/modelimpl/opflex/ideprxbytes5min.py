...
class IDEpRxBytes5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes5min", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes5min"
    meta.rnFormat = "CDopflexIDEpRxBytes5min"
