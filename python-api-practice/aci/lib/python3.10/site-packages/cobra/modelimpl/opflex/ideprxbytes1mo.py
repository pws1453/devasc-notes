...
# ##################################################
class IDEpRxBytes1mo(Mo):
    """
    A class that represents the most current statistics for received bytes in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes1mo", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes1mo"
    meta.rnFormat = "CDopflexIDEpRxBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats in 1 month"
