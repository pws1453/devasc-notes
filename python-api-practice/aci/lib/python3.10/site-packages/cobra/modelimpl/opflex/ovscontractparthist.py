...
# ##################################################
class OvsContractPartHist(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist"


    meta.moClassName = "opflexOvsContractPartHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPartHist1year")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 34971, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 34967, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 34970, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 34969, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 34968, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 34975, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 34972, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 34973, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 34974, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 35026, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 35022, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 35025, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 35024, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 35023, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 35030, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 35027, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 35028, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 35029, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "revBytesAvg", "revBytesAvg", 35081, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes (reverse) average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesAvg", prop)

    prop = PropMeta("str", "revBytesCum", "revBytesCum", 35077, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesCum", prop)

    prop = PropMeta("str", "revBytesMax", "revBytesMax", 35080, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes (reverse) maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesMax", prop)

    prop = PropMeta("str", "revBytesMin", "revBytesMin", 35079, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes (reverse) minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesMin", prop)

    prop = PropMeta("str", "revBytesPer", "revBytesPer", 35078, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesPer", prop)

    prop = PropMeta("str", "revBytesRate", "revBytesRate", 35085, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesRate", prop)

    prop = PropMeta("str", "revBytesSpct", "revBytesSpct", 35082, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesSpct", prop)

    prop = PropMeta("str", "revBytesThr", "revBytesThr", 35083, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revBytesTr", "revBytesTr", 35084, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes (reverse) trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesTr", prop)

    prop = PropMeta("str", "revPktsAvg", "revPktsAvg", 35136, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets (reverse) average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsAvg", prop)

    prop = PropMeta("str", "revPktsCum", "revPktsCum", 35132, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsCum", prop)

    prop = PropMeta("str", "revPktsMax", "revPktsMax", 35135, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets (reverse) maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMax", prop)

    prop = PropMeta("str", "revPktsMin", "revPktsMin", 35134, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets (reverse) minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMin", prop)

    prop = PropMeta("str", "revPktsPer", "revPktsPer", 35133, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsPer", prop)

    prop = PropMeta("str", "revPktsRate", "revPktsRate", 35140, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsRate", prop)

    prop = PropMeta("str", "revPktsSpct", "revPktsSpct", 35137, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsSpct", prop)

    prop = PropMeta("str", "revPktsThr", "revPktsThr", 35138, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revPktsTr", "revPktsTr", 35139, PropCategory.IMPLICIT_TREND)
