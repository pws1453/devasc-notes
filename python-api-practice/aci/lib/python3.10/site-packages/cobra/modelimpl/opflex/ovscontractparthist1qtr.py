...
# ##################################################
class OvsContractPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist1qtr", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist1qtr"
    meta.rnFormat = "HDopflexOvsContractPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractPart1qtr-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34776, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34777, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
