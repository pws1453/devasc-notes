...
class IDEpRxBytesHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist1mo", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist1mo"
    meta.rnFormat = "HDopflexIDEpRxBytes1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6949, PropCategory.REGULAR)
