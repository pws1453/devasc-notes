...
# ##################################################
class IDEpDfwConnDeniedHist1h(Mo):
    """
    A class that represents historical statistics for DFW connection denied statistics in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnDeniedHist1h", "DFW connection denied statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnDeniedHist1h"
    meta.rnFormat = "HDopflexIDEpDfwConnDenied1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection denied statistics stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpDfwConnDenied1h-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19130, PropCategory.REGULAR)
