...
# ##################################################
class IDEpPolicyDrop1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDrop1h", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDrop1h"
    meta.rnFormat = "CDopflexIDEpPolicyDrop1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current EPG policy drop statistics stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpPolicyDrop1h', False),
    ]
