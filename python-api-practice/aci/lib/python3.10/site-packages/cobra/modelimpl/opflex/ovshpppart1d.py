...
# ##################################################
class OvsHppPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart1d", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart1d"
    meta.rnFormat = "CDopflexOvsHppPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34801, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
