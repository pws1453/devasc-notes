...
# ##################################################
class IDEpBcastPktsHist1w(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist1w", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist1w"
    meta.rnFormat = "HDopflexIDEpBcastPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 15886, PropCategory.REGULAR)
