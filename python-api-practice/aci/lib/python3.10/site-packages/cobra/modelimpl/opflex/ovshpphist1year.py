...
# ##################################################
class OvsHppHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist1year", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist1year"
    meta.rnFormat = "HDopflexOvsHpp1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 34798, PropCategory.REGULAR)
