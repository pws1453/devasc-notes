...
# ##################################################
class IDEpPolicyDrop1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDrop1year", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDrop1year"
    meta.rnFormat = "CDopflexIDEpPolicyDrop1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current EPG policy drop statistics stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpPolicyDrop1year', False),
    ]
