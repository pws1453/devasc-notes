...
# ##################################################
class IDEpDfwConnHist1mo(Mo):
    """
    A class that represents historical statistics for DFW connection statistics in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnHist1mo", "DFW connection statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnHist1mo"
    meta.rnFormat = "HDopflexIDEpDfwConn1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection statistics stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 19139, PropCategory.REGULAR)
