...
# ##################################################
class IDEpDfwConnDeniedHist1mo(Mo):
    """
    A class that represents historical statistics for DFW connection denied statistics in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnDeniedHist1mo", "DFW connection denied statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnDeniedHist1mo"
    meta.rnFormat = "HDopflexIDEpDfwConnDenied1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection denied statistics stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpDfwConnDenied1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19131, PropCategory.REGULAR)
