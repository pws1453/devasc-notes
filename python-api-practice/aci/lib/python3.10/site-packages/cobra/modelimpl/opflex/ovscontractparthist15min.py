...
# ##################################################
class OvsContractPartHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist15min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist15min"
    meta.rnFormat = "HDopflexOvsContractPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsContractPartHist")

    meta.rnPrefixes = [
        ('HDopflexOvsContractPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34768, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34769, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
