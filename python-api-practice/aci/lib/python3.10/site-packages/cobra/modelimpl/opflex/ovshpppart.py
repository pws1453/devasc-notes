...
# ##################################################
class OvsHppPart(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart"


    meta.moClassName = "opflexOvsHppPart"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppPart1d")
