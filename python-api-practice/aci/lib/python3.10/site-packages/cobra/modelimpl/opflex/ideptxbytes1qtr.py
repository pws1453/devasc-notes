...
class IDEpTxBytes1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes1qtr", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes1qtr"
    meta.rnFormat = "CDopflexIDEpTxBytes1qtr"
