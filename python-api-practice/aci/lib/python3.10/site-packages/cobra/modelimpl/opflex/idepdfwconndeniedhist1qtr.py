...
# ##################################################
class IDEpDfwConnDeniedHist1qtr(Mo):
    """
    A class that represents historical statistics for DFW connection denied statistics in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnDeniedHist1qtr", "DFW connection denied statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnDeniedHist1qtr"
    meta.rnFormat = "HDopflexIDEpDfwConnDenied1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection denied statistics stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpDfwConnDenied1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19132, PropCategory.REGULAR)
