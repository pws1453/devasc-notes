...
# ##################################################
class RsODevToIDEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.opflex.RsODevToIDEp", "cobra.model.opflex.IDEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "opflexRsODevToIDEp"
    meta.rnFormat = "rsoDevToIDEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45495, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45494, PropCategory.REGULAR)
