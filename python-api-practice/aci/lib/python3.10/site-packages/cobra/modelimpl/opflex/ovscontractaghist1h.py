...
# ##################################################
class OvsContractAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist1h", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist1h"
    meta.rnFormat = "HDopflexOvsContractAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 34746, PropCategory.REGULAR)
