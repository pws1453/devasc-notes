...
# ##################################################
class IDEpDfwConnHist1d(Mo):
    """
    A class that represents historical statistics for DFW connection statistics in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnHist1d", "DFW connection statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnHist1d"
    meta.rnFormat = "HDopflexIDEpDfwConn1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection statistics stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 19137, PropCategory.REGULAR)
