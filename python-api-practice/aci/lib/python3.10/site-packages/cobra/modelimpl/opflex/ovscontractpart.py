...
# ##################################################
class OvsContractPart(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart"


    meta.moClassName = "opflexOvsContractPart"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractPart1year")
