...
# ##################################################
class IDEpPolicyDropHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist1h", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist1h"
    meta.rnFormat = "HDopflexIDEpPolicyDrop1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 23605, PropCategory.REGULAR)
