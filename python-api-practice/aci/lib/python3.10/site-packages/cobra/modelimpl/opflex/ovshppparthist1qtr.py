...
# ##################################################
class OvsHppPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPartHist1qtr", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPartHist1qtr"
    meta.rnFormat = "HDopflexOvsHppPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs host protection stats stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 34816, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34817, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
