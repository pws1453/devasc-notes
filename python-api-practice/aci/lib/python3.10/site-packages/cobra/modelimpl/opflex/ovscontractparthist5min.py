...
# ##################################################
class OvsContractPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist5min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist5min"
    meta.rnFormat = "HDopflexOvsContractPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractPart5min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34782, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34783, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
