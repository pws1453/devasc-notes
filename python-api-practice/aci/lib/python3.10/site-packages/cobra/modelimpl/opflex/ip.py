...
class Ip(Mo):
    ...
    meta = ClassMeta("cobra.model.opflex.Ip")

    meta.moClassName = "opflexIp"
    ...
    meta.childClasses.add("cobra.model.opflexp.L3EpIDEpRef")

    meta.childNamesAndRnPrefix.append(("cobra.model.opflexp.L3EpIDEpRef", "l3epidepref-"))
    ...
    prop = PropMeta("str", "addr", "addr", 45735, PropCategory.REGULAR)
