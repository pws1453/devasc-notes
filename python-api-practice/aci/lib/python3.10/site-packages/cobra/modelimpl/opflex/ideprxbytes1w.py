...
# ##################################################
class IDEpRxBytes1w(Mo):
    """
    A class that represents the most current statistics for received bytes in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes1w", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes1w"
    meta.rnFormat = "CDopflexIDEpRxBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats in 1 week"
