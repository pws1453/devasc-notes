...
# ##################################################
class OvsHppAg(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsHppAg", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAg"


    meta.moClassName = "opflexOvsHppAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs host protection stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppAg1h")
    ...
    prop = PropMeta("str", "rxBytesCum", "rxBytesCum", 35196, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesCum", prop)

    prop = PropMeta("str", "rxBytesPer", "rxBytesPer", 35197, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesPer", prop)

    prop = PropMeta("str", "rxBytesRate", "rxBytesRate", 35202, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesRate", prop)

    prop = PropMeta("str", "rxBytesSpct", "rxBytesSpct", 35198, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesSpct", prop)

    prop = PropMeta("str", "rxBytesThr", "rxBytesThr", 35199, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxBytesTr", "rxBytesTr", 35201, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesTr", prop)

    prop = PropMeta("str", "rxBytesTrBase", "rxBytesTrBase", 35200, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "received bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesTrBase", prop)

    prop = PropMeta("str", "rxPktsCum", "rxPktsCum", 35251, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsCum", prop)

    prop = PropMeta("str", "rxPktsPer", "rxPktsPer", 35252, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsPer", prop)

    prop = PropMeta("str", "rxPktsRate", "rxPktsRate", 35257, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsRate", prop)

    prop = PropMeta("str", "rxPktsSpct", "rxPktsSpct", 35253, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsSpct", prop)

    prop = PropMeta("str", "rxPktsThr", "rxPktsThr", 35254, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxPktsTr", "rxPktsTr", 35256, PropCategory.IMPLICIT_TREND)
    prop.label = "received packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsTr", prop)

    prop = PropMeta("str", "rxPktsTrBase", "rxPktsTrBase", 35255, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "txBytesCum", "txBytesCum", 35306, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "transmitted bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesCum", prop)

    prop = PropMeta("str", "txBytesPer", "txBytesPer", 35307, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "transmitted bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesPer", prop)

    prop = PropMeta("str", "txBytesRate", "txBytesRate", 35312, PropCategory.IMPLICIT_RATE)
    prop.label = "transmitted bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesRate", prop)

    prop = PropMeta("str", "txBytesSpct", "txBytesSpct", 35308, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "transmitted bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesSpct", prop)

    prop = PropMeta("str", "txBytesThr", "txBytesThr", 35309, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txBytesTr", "txBytesTr", 35311, PropCategory.IMPLICIT_TREND)
    prop.label = "transmitted bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesTr", prop)

    prop = PropMeta("str", "txBytesTrBase", "txBytesTrBase", 35310, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "transmitted bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesTrBase", prop)

    prop = PropMeta("str", "txPktsCum", "txPktsCum", 35361, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "transmitted packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsCum", prop)

    prop = PropMeta("str", "txPktsPer", "txPktsPer", 35362, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "transmitted packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsPer", prop)

    prop = PropMeta("str", "txPktsRate", "txPktsRate", 35367, PropCategory.IMPLICIT_RATE)
    prop.label = "transmitted packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsRate", prop)

    prop = PropMeta("str", "txPktsSpct", "txPktsSpct", 35363, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "transmitted packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsSpct", prop)

    prop = PropMeta("str", "txPktsThr", "txPktsThr", 35364, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txPktsTr", "txPktsTr", 35366, PropCategory.IMPLICIT_TREND)
    prop.label = "transmitted packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsTr", prop)

    prop = PropMeta("str", "txPktsTrBase", "txPktsTrBase", 35365, PropCategory.IMPLICIT_TREND_BASE)
