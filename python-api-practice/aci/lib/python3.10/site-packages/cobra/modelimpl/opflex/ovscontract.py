...
# ##################################################
class OvsContract(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsContract", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContract"


    meta.moClassName = "opflexOvsContract"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ovs contract stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContract1qtr")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 34940, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesBase", "bytesBase", 34935, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesBase", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 34936, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesLast", "bytesLast", 34934, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesLast", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 34939, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 34938, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 34937, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 34945, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 34941, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 34942, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 34944, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesTr", prop)

    prop = PropMeta("str", "bytesTrBase", "bytesTrBase", 34943, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 34995, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsBase", "pktsBase", 34990, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsBase", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 34991, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsLast", "pktsLast", 34989, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsLast", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 34994, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 34993, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 34992, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 35000, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 34996, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 34997, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 34999, PropCategory.IMPLICIT_TREND)
    prop.label = "received packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsTr", prop)

    prop = PropMeta("str", "pktsTrBase", "pktsTrBase", 34998, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "revBytesAvg", "revBytesAvg", 35050, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes (reverse) average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesAvg", prop)

    prop = PropMeta("str", "revBytesBase", "revBytesBase", 35045, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received bytes (reverse) baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesBase", prop)

    prop = PropMeta("str", "revBytesCum", "revBytesCum", 35046, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesCum", prop)

    prop = PropMeta("str", "revBytesLast", "revBytesLast", 35044, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received bytes (reverse) current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesLast", prop)

    prop = PropMeta("str", "revBytesMax", "revBytesMax", 35049, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes (reverse) maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesMax", prop)

    prop = PropMeta("str", "revBytesMin", "revBytesMin", 35048, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes (reverse) minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesMin", prop)

    prop = PropMeta("str", "revBytesPer", "revBytesPer", 35047, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesPer", prop)

    prop = PropMeta("str", "revBytesRate", "revBytesRate", 35055, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesRate", prop)

    prop = PropMeta("str", "revBytesSpct", "revBytesSpct", 35051, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesSpct", prop)

    prop = PropMeta("str", "revBytesThr", "revBytesThr", 35052, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revBytesTr", "revBytesTr", 35054, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes (reverse) trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesTr", prop)

    prop = PropMeta("str", "revBytesTrBase", "revBytesTrBase", 35053, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "received bytes (reverse) trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesTrBase", prop)

    prop = PropMeta("str", "revPktsAvg", "revPktsAvg", 35105, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets (reverse) average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsAvg", prop)

    prop = PropMeta("str", "revPktsBase", "revPktsBase", 35100, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received packets (reverse) baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsBase", prop)

    prop = PropMeta("str", "revPktsCum", "revPktsCum", 35101, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsCum", prop)

    prop = PropMeta("str", "revPktsLast", "revPktsLast", 35099, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received packets (reverse) current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsLast", prop)

    prop = PropMeta("str", "revPktsMax", "revPktsMax", 35104, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets (reverse) maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMax", prop)

    prop = PropMeta("str", "revPktsMin", "revPktsMin", 35103, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets (reverse) minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMin", prop)

    prop = PropMeta("str", "revPktsPer", "revPktsPer", 35102, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsPer", prop)

    prop = PropMeta("str", "revPktsRate", "revPktsRate", 35110, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsRate", prop)

    prop = PropMeta("str", "revPktsSpct", "revPktsSpct", 35106, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsSpct", prop)

    prop = PropMeta("str", "revPktsThr", "revPktsThr", 35107, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revPktsTr", "revPktsTr", 35109, PropCategory.IMPLICIT_TREND)
    prop.label = "received packets (reverse) trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsTr", prop)

    prop = PropMeta("str", "revPktsTrBase", "revPktsTrBase", 35108, PropCategory.IMPLICIT_TREND_BASE)
