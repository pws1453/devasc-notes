...
# ##################################################
class OvsHppHist(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist"


    meta.moClassName = "opflexOvsHppHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHppHist1qtr")
    ...
    prop = PropMeta("str", "rxBytesAvg", "rxBytesAvg", 35170, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesAvg", prop)

    prop = PropMeta("str", "rxBytesCum", "rxBytesCum", 35166, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesCum", prop)

    prop = PropMeta("str", "rxBytesMax", "rxBytesMax", 35169, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesMax", prop)

    prop = PropMeta("str", "rxBytesMin", "rxBytesMin", 35168, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesMin", prop)

    prop = PropMeta("str", "rxBytesPer", "rxBytesPer", 35167, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesPer", prop)

    prop = PropMeta("str", "rxBytesRate", "rxBytesRate", 35174, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesRate", prop)

    prop = PropMeta("str", "rxBytesSpct", "rxBytesSpct", 35171, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesSpct", prop)

    prop = PropMeta("str", "rxBytesThr", "rxBytesThr", 35172, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxBytesTr", "rxBytesTr", 35173, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesTr", prop)

    prop = PropMeta("str", "rxPktsAvg", "rxPktsAvg", 35225, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsAvg", prop)

    prop = PropMeta("str", "rxPktsCum", "rxPktsCum", 35221, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsCum", prop)

    prop = PropMeta("str", "rxPktsMax", "rxPktsMax", 35224, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsMax", prop)

    prop = PropMeta("str", "rxPktsMin", "rxPktsMin", 35223, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsMin", prop)

    prop = PropMeta("str", "rxPktsPer", "rxPktsPer", 35222, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsPer", prop)

    prop = PropMeta("str", "rxPktsRate", "rxPktsRate", 35229, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsRate", prop)

    prop = PropMeta("str", "rxPktsSpct", "rxPktsSpct", 35226, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsSpct", prop)

    prop = PropMeta("str", "rxPktsThr", "rxPktsThr", 35227, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxPktsTr", "rxPktsTr", 35228, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "txBytesAvg", "txBytesAvg", 35280, PropCategory.IMPLICIT_AVG)
    prop.label = "transmitted bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesAvg", prop)

    prop = PropMeta("str", "txBytesCum", "txBytesCum", 35276, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "transmitted bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesCum", prop)

    prop = PropMeta("str", "txBytesMax", "txBytesMax", 35279, PropCategory.IMPLICIT_MAX)
    prop.label = "transmitted bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesMax", prop)

    prop = PropMeta("str", "txBytesMin", "txBytesMin", 35278, PropCategory.IMPLICIT_MIN)
    prop.label = "transmitted bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesMin", prop)

    prop = PropMeta("str", "txBytesPer", "txBytesPer", 35277, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "transmitted bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesPer", prop)

    prop = PropMeta("str", "txBytesRate", "txBytesRate", 35284, PropCategory.IMPLICIT_RATE)
    prop.label = "transmitted bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesRate", prop)

    prop = PropMeta("str", "txBytesSpct", "txBytesSpct", 35281, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "transmitted bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesSpct", prop)

    prop = PropMeta("str", "txBytesThr", "txBytesThr", 35282, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txBytesTr", "txBytesTr", 35283, PropCategory.IMPLICIT_TREND)
    prop.label = "transmitted bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesTr", prop)

    prop = PropMeta("str", "txPktsAvg", "txPktsAvg", 35335, PropCategory.IMPLICIT_AVG)
    prop.label = "transmitted packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsAvg", prop)

    prop = PropMeta("str", "txPktsCum", "txPktsCum", 35331, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "transmitted packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsCum", prop)

    prop = PropMeta("str", "txPktsMax", "txPktsMax", 35334, PropCategory.IMPLICIT_MAX)
    prop.label = "transmitted packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsMax", prop)

    prop = PropMeta("str", "txPktsMin", "txPktsMin", 35333, PropCategory.IMPLICIT_MIN)
    prop.label = "transmitted packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsMin", prop)

    prop = PropMeta("str", "txPktsPer", "txPktsPer", 35332, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "transmitted packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsPer", prop)

    prop = PropMeta("str", "txPktsRate", "txPktsRate", 35339, PropCategory.IMPLICIT_RATE)
    prop.label = "transmitted packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsRate", prop)

    prop = PropMeta("str", "txPktsSpct", "txPktsSpct", 35336, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "transmitted packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsSpct", prop)

    prop = PropMeta("str", "txPktsThr", "txPktsThr", 35337, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txPktsTr", "txPktsTr", 35338, PropCategory.IMPLICIT_TREND)
