...
# ##################################################
class OvsHppHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist1qtr", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist1qtr"
    meta.rnFormat = "HDopflexOvsHpp1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 34796, PropCategory.REGULAR)
