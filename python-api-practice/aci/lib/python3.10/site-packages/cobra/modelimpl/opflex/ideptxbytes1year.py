...
# ##################################################
class IDEpTxBytes1year(Mo):
    """
    A class that represents the most current statistics for transmitted bytes in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes1year", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes1year"
    meta.rnFormat = "CDopflexIDEpTxBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpTxBytes1year', False),
    ]
