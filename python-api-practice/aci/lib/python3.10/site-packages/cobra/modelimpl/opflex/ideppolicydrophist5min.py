...
# ##################################################
class IDEpPolicyDropHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist5min", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist5min"
    meta.rnFormat = "HDopflexIDEpPolicyDrop5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpPolicyDrop5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 23610, PropCategory.REGULAR)
