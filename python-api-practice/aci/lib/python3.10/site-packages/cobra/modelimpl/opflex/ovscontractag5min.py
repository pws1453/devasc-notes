...
# ##################################################
class OvsContractAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAg5min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAg5min"
    meta.rnFormat = "CDopflexOvsContractAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs contract stats stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractAg5min', False),
    ]
