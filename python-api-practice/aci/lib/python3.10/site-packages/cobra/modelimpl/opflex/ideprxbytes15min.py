...
# ##################################################
class IDEpRxBytes15min(Mo):
    """
    A class that represents the most current statistics for received bytes in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes15min", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes15min"
    meta.rnFormat = "CDopflexIDEpRxBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.IDEpRxBytes")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDopflexIDEpRxBytes15min', False),
    ]
