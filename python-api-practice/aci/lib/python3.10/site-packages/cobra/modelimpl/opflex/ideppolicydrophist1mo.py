...
# ##################################################
class IDEpPolicyDropHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist1mo", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist1mo"
    meta.rnFormat = "HDopflexIDEpPolicyDrop1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpPolicyDrop1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 23606, PropCategory.REGULAR)
