...
# ##################################################
class OvsContractPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist1mo", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist1mo"
    meta.rnFormat = "HDopflexOvsContractPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractPart1mo-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34774, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34775, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
