...
class IDEpRxBytesHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist1w", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist1w"
    meta.rnFormat = "HDopflexIDEpRxBytes1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6951, PropCategory.REGULAR)
