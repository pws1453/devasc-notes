...
# ##################################################
class IDEpBcastPkts5min(Mo):
    """
    A class that represents the most current statistics for broadcast packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPkts5min", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPkts5min"
    meta.rnFormat = "CDopflexIDEpBcastPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current broadcast packets stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpBcastPkts5min', False),
    ]
