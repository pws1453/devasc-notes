...
# ##################################################
class IDEpDfwConnHist5min(Mo):
    """
    A class that represents historical statistics for DFW connection statistics in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnHist5min", "DFW connection statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnHist5min"
    meta.rnFormat = "HDopflexIDEpDfwConn5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection statistics stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 19143, PropCategory.REGULAR)
