...
# ##################################################
class OvsContractHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist5min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist5min"
    meta.rnFormat = "HDopflexOvsContract5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 34759, PropCategory.REGULAR)
