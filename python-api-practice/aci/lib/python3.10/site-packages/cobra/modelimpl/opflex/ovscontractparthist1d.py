...
# ##################################################
class OvsContractPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist1d", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist1d"
    meta.rnFormat = "HDopflexOvsContractPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractPart1d-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34770, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34771, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
