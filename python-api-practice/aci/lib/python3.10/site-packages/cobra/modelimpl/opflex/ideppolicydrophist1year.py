...
# ##################################################
class IDEpPolicyDropHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist1year", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist1year"
    meta.rnFormat = "HDopflexIDEpPolicyDrop1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpPolicyDrop1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 23609, PropCategory.REGULAR)
