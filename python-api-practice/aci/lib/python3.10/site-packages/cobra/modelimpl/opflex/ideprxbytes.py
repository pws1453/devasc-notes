...
# ##################################################
class IDEpRxBytes(Mo):
    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes"


    meta.moClassName = "opflexIDEpRxBytes"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes1d")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes1h")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes1year")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes5min")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes1w")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpRxBytes15min")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 10201, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesBase", "bytesBase", 10196, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesBase", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 10197, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesLast", "bytesLast", 10195, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesLast", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 10200, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 10199, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 10198, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 10206, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 10202, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 10203, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 10205, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesTr", prop)

    prop = PropMeta("str", "bytesTrBase", "bytesTrBase", 10204, PropCategory.IMPLICIT_TREND_BASE)
