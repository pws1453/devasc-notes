...
# ##################################################
class OvsContractPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist1w", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist1w"
    meta.rnFormat = "HDopflexOvsContractPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractPart1w-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34778, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34779, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
