...
# ##################################################
class OvsContractHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist1d", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist1d"
    meta.rnFormat = "HDopflexOvsContract1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 34753, PropCategory.REGULAR)
