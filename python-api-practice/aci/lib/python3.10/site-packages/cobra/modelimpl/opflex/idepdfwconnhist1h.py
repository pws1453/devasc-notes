...
# ##################################################
class IDEpDfwConnHist1h(Mo):
    """
    A class that represents historical statistics for DFW connection statistics in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnHist1h", "DFW connection statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnHist1h"
    meta.rnFormat = "HDopflexIDEpDfwConn1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection statistics stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 19138, PropCategory.REGULAR)
