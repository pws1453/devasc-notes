...
# ##################################################
class IDEpBcastPktsHist1qtr(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist1qtr", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist1qtr"
    meta.rnFormat = "HDopflexIDEpBcastPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpBcastPkts1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 15885, PropCategory.REGULAR)
