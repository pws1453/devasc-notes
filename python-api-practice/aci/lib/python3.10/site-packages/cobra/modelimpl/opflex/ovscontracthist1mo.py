...
# ##################################################
class OvsContractHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist1mo", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist1mo"
    meta.rnFormat = "HDopflexOvsContract1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 34755, PropCategory.REGULAR)
