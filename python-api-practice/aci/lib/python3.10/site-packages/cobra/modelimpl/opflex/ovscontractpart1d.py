...
# ##################################################
class OvsContractPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart1d", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart1d"
    meta.rnFormat = "CDopflexOvsContractPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractPart1d-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34761, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
