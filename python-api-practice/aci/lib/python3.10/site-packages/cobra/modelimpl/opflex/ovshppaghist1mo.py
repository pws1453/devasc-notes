...
# ##################################################
class OvsHppAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist1mo", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist1mo"
    meta.rnFormat = "HDopflexOvsHppAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 34787, PropCategory.REGULAR)
