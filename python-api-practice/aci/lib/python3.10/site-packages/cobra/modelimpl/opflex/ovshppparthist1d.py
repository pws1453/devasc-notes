...
# ##################################################
class OvsHppPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPartHist1d", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPartHist1d"
    meta.rnFormat = "HDopflexOvsHppPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs host protection stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 34810, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34811, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
