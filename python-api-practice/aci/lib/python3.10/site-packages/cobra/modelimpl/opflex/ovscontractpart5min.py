...
# ##################################################
class OvsContractPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart5min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart5min"
    meta.rnFormat = "CDopflexOvsContractPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractPart5min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34767, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
