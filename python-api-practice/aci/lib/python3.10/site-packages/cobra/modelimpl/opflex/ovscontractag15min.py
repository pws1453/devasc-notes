...
# ##################################################
class OvsContractAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAg15min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAg15min"
    meta.rnFormat = "CDopflexOvsContractAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs contract stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsContractAg")
    meta.superClasses.add("cobra.model.stats.Curr")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDopflexOvsContractAg15min', False),
    ]
