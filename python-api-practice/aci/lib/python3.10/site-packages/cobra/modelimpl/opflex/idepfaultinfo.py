...
# ##################################################
class IDEpFaultInfo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.IDEpFaultInfo")

    meta.moClassName = "opflexIDEpFaultInfo"
    meta.rnFormat = "idepfault-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete class to raise faults for IDEp Issues"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25825, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 25564, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
