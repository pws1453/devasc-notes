...
# ##################################################
class IDEpDfwConnDeniedHist1d(Mo):
    """
    A class that represents historical statistics for DFW connection denied statistics in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnDeniedHist1d", "DFW connection denied statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnDeniedHist1d"
    meta.rnFormat = "HDopflexIDEpDfwConnDenied1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection denied statistics stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpDfwConnDenied1d-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19129, PropCategory.REGULAR)
