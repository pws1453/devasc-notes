...
# ##################################################
class OvsContractAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist5min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist5min"
    meta.rnFormat = "HDopflexOvsContractAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34751, PropCategory.REGULAR)
