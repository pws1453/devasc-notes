...
# ##################################################
class OvsContractAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist15min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist15min"
    meta.rnFormat = "HDopflexOvsContractAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsContractAgHist")

    meta.rnPrefixes = [
        ('HDopflexOvsContractAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34744, PropCategory.REGULAR)
