...
# ##################################################
class IDEpBcastPktsHist1year(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist1year", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist1year"
    meta.rnFormat = "HDopflexIDEpBcastPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpBcastPkts1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 15887, PropCategory.REGULAR)
