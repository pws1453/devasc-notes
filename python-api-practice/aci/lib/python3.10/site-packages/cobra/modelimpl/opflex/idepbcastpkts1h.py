...
# ##################################################
class IDEpBcastPkts1h(Mo):
    """
    A class that represents the most current statistics for broadcast packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPkts1h", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPkts1h"
    meta.rnFormat = "CDopflexIDEpBcastPkts1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current broadcast packets stats in 1 hour"
