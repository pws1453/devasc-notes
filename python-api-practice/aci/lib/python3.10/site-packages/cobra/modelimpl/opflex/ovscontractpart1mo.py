...
# ##################################################
class OvsContractPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart1mo", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart1mo"
    meta.rnFormat = "CDopflexOvsContractPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractPart1mo-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34763, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
