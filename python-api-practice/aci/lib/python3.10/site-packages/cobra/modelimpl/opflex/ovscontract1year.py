...
# ##################################################
class OvsContract1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContract1year", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContract1year"
    meta.rnFormat = "CDopflexOvsContract1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ovs contract stats stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContract1year', False),
    ]
