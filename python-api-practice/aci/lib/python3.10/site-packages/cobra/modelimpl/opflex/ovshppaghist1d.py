...
# ##################################################
class OvsHppAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist1d", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist1d"
    meta.rnFormat = "HDopflexOvsHppAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 34785, PropCategory.REGULAR)
