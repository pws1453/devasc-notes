...
# ##################################################
class OvsHppPart15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart15min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart15min"
    meta.rnFormat = "CDopflexOvsHppPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats in 15 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34800, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
