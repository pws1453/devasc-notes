...
class OvsHpp5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.opflex.OvsHpp5min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHpp5min"
    meta.rnFormat = "CDopflexOvsHpp5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ovs host protection stats stats in 5 minute"
