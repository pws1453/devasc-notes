...
# ##################################################
class IDEpBcastPkts1mo(Mo):
    """
    A class that represents the most current statistics for broadcast packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPkts1mo", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPkts1mo"
    meta.rnFormat = "CDopflexIDEpBcastPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current broadcast packets stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpBcastPkts1mo', False),
    ]
