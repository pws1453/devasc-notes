...
class UsegEpP(Mo):
    ...
    meta = ClassMeta("cobra.model.opflex.UsegEpP")

    meta.moClassName = "opflexUsegEpP"
    meta.rnFormat = "usegepp-%(epgDn)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Useg EpP Info"
    ...
    meta.parentClasses.add("cobra.model.opflex.UsegTenantCont")
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 37050, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
