...
class RtTsODev(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.opflex.RtTsODev", "cobra.model.dbgexp.TechSupODev")

    meta.moClassName = "opflexRtTsODev"
    meta.rnFormat = "rtdbgexpTsODev-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22572, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7618
    prop.defaultValueStr = "dbgexpTechSupODev"
    prop._addConstant("dbgexpTechSupODev", None, 7618)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22571, PropCategory.REGULAR)
