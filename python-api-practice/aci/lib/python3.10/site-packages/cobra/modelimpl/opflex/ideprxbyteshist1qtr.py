...
# ##################################################
class IDEpRxBytesHist1qtr(Mo):
    """
    A class that represents historical statistics for received bytes in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist1qtr", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist1qtr"
    meta.rnFormat = "HDopflexIDEpRxBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical received bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6950, PropCategory.REGULAR)
