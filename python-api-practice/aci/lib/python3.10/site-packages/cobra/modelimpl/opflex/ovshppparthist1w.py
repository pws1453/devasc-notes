...
# ##################################################
class OvsHppPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPartHist1w", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPartHist1w"
    meta.rnFormat = "HDopflexOvsHppPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs host protection stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 34818, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34819, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
