...
# ##################################################
class OvsHppHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist5min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist5min"
    meta.rnFormat = "HDopflexOvsHpp5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 34799, PropCategory.REGULAR)
