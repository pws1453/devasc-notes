...
# ##################################################
class OvsContractPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPartHist1h", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPartHist1h"
    meta.rnFormat = "HDopflexOvsContractPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs contract stats stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('HDopflexOvsContractPart1h-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34772, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34773, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
