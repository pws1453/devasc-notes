...
# ##################################################
class IDEpPolicyDropHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist1d", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist1d"
    meta.rnFormat = "HDopflexIDEpPolicyDrop1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 23604, PropCategory.REGULAR)
