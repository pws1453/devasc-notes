...
class VtepRef(Mo):
    ...
    meta = ClassMeta("cobra.model.opflex.VtepRef")

    meta.moClassName = "opflexVtepRef"
    meta.rnFormat = "vtepref-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Opflex Vtep Reference"
    ...
    meta.parentClasses.add("cobra.model.opflex.VtepRefCont")
    ...
    prop = PropMeta("str", "idepDn", "idepDn", 21032, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("idepDn", prop)

    prop = PropMeta("str", "ip", "ip", 21031, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
