...
# ##################################################
class RsODevToTunnelIDEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.opflex.RsODevToTunnelIDEp", "cobra.model.opflex.IDEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "opflexRsODevToTunnelIDEp"
    meta.rnFormat = "rsoDevToTunnelIDEp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to IDEp of Inst type Hv"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45498, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1104
    prop.defaultValueStr = "opflexIDEp"
    prop._addConstant("opflexIDEp", None, 1104)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45497, PropCategory.REGULAR)
