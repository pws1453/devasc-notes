...
# ##################################################
class OvsHppAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist1year", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist1year"
    meta.rnFormat = "HDopflexOvsHppAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 34790, PropCategory.REGULAR)
