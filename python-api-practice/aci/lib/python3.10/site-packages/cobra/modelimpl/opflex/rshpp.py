...
class RsHpp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.opflex.RsHpp", "cobra.model.hostprot.Pol")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "opflexRsHpp"
    meta.rnFormat = "rshpp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to HPP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43415, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9837
    prop.defaultValueStr = "hostprotPol"
    prop._addConstant("hostprotPol", None, 9837)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43414, PropCategory.REGULAR)
