...
# ##################################################
class OvsHppAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist5min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist5min"
    meta.rnFormat = "HDopflexOvsHppAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 34791, PropCategory.REGULAR)
