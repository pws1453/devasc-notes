...
# ##################################################
class OvsHppHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist1h", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist1h"
    meta.rnFormat = "HDopflexOvsHpp1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 34794, PropCategory.REGULAR)
