...
# ##################################################
class IDEpRxBytes1h(Mo):
    """
    A class that represents the most current statistics for received bytes in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes1h", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes1h"
    meta.rnFormat = "CDopflexIDEpRxBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats in 1 hour"
