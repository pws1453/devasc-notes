...
# ##################################################
class OvsHppHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist1mo", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist1mo"
    meta.rnFormat = "HDopflexOvsHpp1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 34795, PropCategory.REGULAR)
