...
# ##################################################
class OvsContractHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist1w", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist1w"
    meta.rnFormat = "HDopflexOvsContract1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 34757, PropCategory.REGULAR)
