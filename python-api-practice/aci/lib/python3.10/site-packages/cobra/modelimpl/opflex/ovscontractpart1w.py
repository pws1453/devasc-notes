...
# ##################################################
class OvsContractPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart1w", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart1w"
    meta.rnFormat = "CDopflexOvsContractPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractPart1w-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34765, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
