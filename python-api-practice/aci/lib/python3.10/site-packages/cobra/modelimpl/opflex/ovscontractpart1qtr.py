...
# ##################################################
class OvsContractPart1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart1qtr", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart1qtr"
    meta.rnFormat = "CDopflexOvsContractPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractPart1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34764, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
