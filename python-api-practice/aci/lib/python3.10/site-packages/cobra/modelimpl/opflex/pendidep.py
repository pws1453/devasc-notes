...
class PendIDEp(Mo):
    ...
    meta = ClassMeta("cobra.model.opflex.PendIDEp")

    meta.moClassName = "opflexPendIDEp"
    meta.rnFormat = "pendidep-[%(idepDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Pending IDEp resolve"
    ...
    meta.parentClasses.add("cobra.model.opflex.PendResIDEpCont")
    ...
    prop = PropMeta("str", "attachType", "attachType", 30049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "createdTS", "createdTS", 30050, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "idepDn", "idepDn", 30048, PropCategory.REGULAR)
    prop.label = "IDEp DN"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("idepDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "idepDn"))
    getattr(meta.props, "idepDn").needDelimiter = True

    def __init__(self, parentMoOrDn, idepDn, markDirty=True, **creationProps):
        namingVals = [idepDn]
