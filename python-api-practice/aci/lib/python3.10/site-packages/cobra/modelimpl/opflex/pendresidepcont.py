...
# ##################################################
class PendResIDEpCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.PendResIDEpCont")

    meta.moClassName = "opflexPendResIDEpCont"
    meta.rnFormat = "PendResIDEpCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Opflex Pending EP Resolve Container"
    ...
    meta.childClasses.add("cobra.model.opflex.PendIDEp")

    meta.childNamesAndRnPrefix.append(("cobra.model.opflex.PendIDEp", "pendidep-"))
