...
# ##################################################
class IDEpPolicyDrop1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDrop1qtr", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDrop1qtr"
    meta.rnFormat = "CDopflexIDEpPolicyDrop1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current EPG policy drop statistics stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpPolicyDrop1qtr', False),
    ]
