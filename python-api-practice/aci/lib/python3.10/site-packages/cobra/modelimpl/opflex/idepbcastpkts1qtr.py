...
# ##################################################
class IDEpBcastPkts1qtr(Mo):
    """
    A class that represents the most current statistics for broadcast packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPkts1qtr", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPkts1qtr"
    meta.rnFormat = "CDopflexIDEpBcastPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current broadcast packets stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpBcastPkts1qtr', False),
    ]
