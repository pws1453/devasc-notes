...
# ##################################################
class EppDevInfoContext(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.EppDevInfoContext")

    meta.moClassName = "opflexEppDevInfoContext"
    meta.rnFormat = "opflexEppDevInfo"
    ...
    prop = PropMeta("str", "type", "type", 37166, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
