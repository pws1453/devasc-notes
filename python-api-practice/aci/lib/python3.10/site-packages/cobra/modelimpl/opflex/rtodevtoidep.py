...
# ##################################################
class RtODevToIDEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.opflex.RtODevToIDEp", "cobra.model.opflex.ODev")

    meta.moClassName = "opflexRtODevToIDEp"
    meta.rnFormat = "rtoDevToIDEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45496, PropCategory.REGULAR)
