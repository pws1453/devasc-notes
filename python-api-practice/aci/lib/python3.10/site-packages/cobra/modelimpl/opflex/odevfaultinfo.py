...
# ##################################################
class ODevFaultInfo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.ODevFaultInfo")

    meta.moClassName = "opflexODevFaultInfo"
    meta.rnFormat = "odevfault-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete class to raise faults for ODev Issues"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25824, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 25565, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
