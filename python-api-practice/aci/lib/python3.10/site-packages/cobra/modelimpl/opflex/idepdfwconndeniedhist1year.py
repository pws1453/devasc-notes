...
# ##################################################
class IDEpDfwConnDeniedHist1year(Mo):
    """
    A class that represents historical statistics for DFW connection denied statistics in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnDeniedHist1year", "DFW connection denied statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnDeniedHist1year"
    meta.rnFormat = "HDopflexIDEpDfwConnDenied1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection denied statistics stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpDfwConnDenied1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19134, PropCategory.REGULAR)
