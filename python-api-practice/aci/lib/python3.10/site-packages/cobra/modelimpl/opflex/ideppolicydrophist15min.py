...
# ##################################################
class IDEpPolicyDropHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist15min", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist15min"
    meta.rnFormat = "HDopflexIDEpPolicyDrop15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.IDEpPolicyDropHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDopflexIDEpPolicyDrop15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 23603, PropCategory.REGULAR)
