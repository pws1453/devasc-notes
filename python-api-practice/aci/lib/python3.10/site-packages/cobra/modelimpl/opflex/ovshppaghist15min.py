...
# ##################################################
class OvsHppAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist15min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist15min"
    meta.rnFormat = "HDopflexOvsHppAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 34784, PropCategory.REGULAR)
