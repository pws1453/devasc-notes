...
# ##################################################
class IDEpRxBytesHist1year(Mo):
    """
    A class that represents historical statistics for received bytes in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist1year", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist1year"
    meta.rnFormat = "HDopflexIDEpRxBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical received bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6952, PropCategory.REGULAR)
