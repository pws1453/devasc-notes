...
# ##################################################
class OvsContractAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist1mo", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist1mo"
    meta.rnFormat = "HDopflexOvsContractAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 34747, PropCategory.REGULAR)
