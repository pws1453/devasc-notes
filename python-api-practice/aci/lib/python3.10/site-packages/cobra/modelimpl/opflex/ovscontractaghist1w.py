...
# ##################################################
class OvsContractAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist1w", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist1w"
    meta.rnFormat = "HDopflexOvsContractAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 34749, PropCategory.REGULAR)
