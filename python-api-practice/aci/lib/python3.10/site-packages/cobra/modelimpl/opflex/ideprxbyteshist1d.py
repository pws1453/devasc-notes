...
# ##################################################
class IDEpRxBytesHist1d(Mo):
    """
    A class that represents historical statistics for received bytes in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist1d", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist1d"
    meta.rnFormat = "HDopflexIDEpRxBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical received bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6947, PropCategory.REGULAR)
