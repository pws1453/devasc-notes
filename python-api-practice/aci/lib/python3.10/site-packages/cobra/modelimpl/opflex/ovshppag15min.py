...
# ##################################################
class OvsHppAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAg15min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAg15min"
    meta.rnFormat = "CDopflexOvsHppAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs host protection stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsHppAg")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDopflexOvsHppAg15min', False),
    ]
