...
# ##################################################
class OvsContractPart15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart15min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart15min"
    meta.rnFormat = "CDopflexOvsContractPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats in 15 minute"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34760, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
