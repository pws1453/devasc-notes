...
# ##################################################
class OvsHppPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPartHist1year", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPartHist1year"
    meta.rnFormat = "HDopflexOvsHppPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs host protection stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 34820, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34821, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
