...
# ##################################################
class OvsHpp(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsHpp", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHpp"


    meta.moClassName = "opflexOvsHpp"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ovs host protection stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsHpp1w")
    ...
    prop = PropMeta("str", "rxBytesAvg", "rxBytesAvg", 35160, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesAvg", prop)

    prop = PropMeta("str", "rxBytesBase", "rxBytesBase", 35155, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesBase", prop)

    prop = PropMeta("str", "rxBytesCum", "rxBytesCum", 35156, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesCum", prop)

    prop = PropMeta("str", "rxBytesLast", "rxBytesLast", 35154, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesLast", prop)

    prop = PropMeta("str", "rxBytesMax", "rxBytesMax", 35159, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesMax", prop)

    prop = PropMeta("str", "rxBytesMin", "rxBytesMin", 35158, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesMin", prop)

    prop = PropMeta("str", "rxBytesPer", "rxBytesPer", 35157, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesPer", prop)

    prop = PropMeta("str", "rxBytesRate", "rxBytesRate", 35165, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesRate", prop)

    prop = PropMeta("str", "rxBytesSpct", "rxBytesSpct", 35161, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesSpct", prop)

    prop = PropMeta("str", "rxBytesThr", "rxBytesThr", 35162, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxBytesTr", "rxBytesTr", 35164, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesTr", prop)

    prop = PropMeta("str", "rxBytesTrBase", "rxBytesTrBase", 35163, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "received bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxBytesTrBase", prop)

    prop = PropMeta("str", "rxPktsAvg", "rxPktsAvg", 35215, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsAvg", prop)

    prop = PropMeta("str", "rxPktsBase", "rxPktsBase", 35210, PropCategory.IMPLICIT_BASELINE)
    prop.label = "received packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsBase", prop)

    prop = PropMeta("str", "rxPktsCum", "rxPktsCum", 35211, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsCum", prop)

    prop = PropMeta("str", "rxPktsLast", "rxPktsLast", 35209, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "received packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsLast", prop)

    prop = PropMeta("str", "rxPktsMax", "rxPktsMax", 35214, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsMax", prop)

    prop = PropMeta("str", "rxPktsMin", "rxPktsMin", 35213, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsMin", prop)

    prop = PropMeta("str", "rxPktsPer", "rxPktsPer", 35212, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsPer", prop)

    prop = PropMeta("str", "rxPktsRate", "rxPktsRate", 35220, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsRate", prop)

    prop = PropMeta("str", "rxPktsSpct", "rxPktsSpct", 35216, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsSpct", prop)

    prop = PropMeta("str", "rxPktsThr", "rxPktsThr", 35217, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxPktsTr", "rxPktsTr", 35219, PropCategory.IMPLICIT_TREND)
    prop.label = "received packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPktsTr", prop)

    prop = PropMeta("str", "rxPktsTrBase", "rxPktsTrBase", 35218, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "txBytesAvg", "txBytesAvg", 35270, PropCategory.IMPLICIT_AVG)
    prop.label = "transmitted bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesAvg", prop)

    prop = PropMeta("str", "txBytesBase", "txBytesBase", 35265, PropCategory.IMPLICIT_BASELINE)
    prop.label = "transmitted bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesBase", prop)

    prop = PropMeta("str", "txBytesCum", "txBytesCum", 35266, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "transmitted bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesCum", prop)

    prop = PropMeta("str", "txBytesLast", "txBytesLast", 35264, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "transmitted bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesLast", prop)

    prop = PropMeta("str", "txBytesMax", "txBytesMax", 35269, PropCategory.IMPLICIT_MAX)
    prop.label = "transmitted bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesMax", prop)

    prop = PropMeta("str", "txBytesMin", "txBytesMin", 35268, PropCategory.IMPLICIT_MIN)
    prop.label = "transmitted bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesMin", prop)

    prop = PropMeta("str", "txBytesPer", "txBytesPer", 35267, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "transmitted bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesPer", prop)

    prop = PropMeta("str", "txBytesRate", "txBytesRate", 35275, PropCategory.IMPLICIT_RATE)
    prop.label = "transmitted bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesRate", prop)

    prop = PropMeta("str", "txBytesSpct", "txBytesSpct", 35271, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "transmitted bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesSpct", prop)

    prop = PropMeta("str", "txBytesThr", "txBytesThr", 35272, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txBytesTr", "txBytesTr", 35274, PropCategory.IMPLICIT_TREND)
    prop.label = "transmitted bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesTr", prop)

    prop = PropMeta("str", "txBytesTrBase", "txBytesTrBase", 35273, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "transmitted bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txBytesTrBase", prop)

    prop = PropMeta("str", "txPktsAvg", "txPktsAvg", 35325, PropCategory.IMPLICIT_AVG)
    prop.label = "transmitted packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsAvg", prop)

    prop = PropMeta("str", "txPktsBase", "txPktsBase", 35320, PropCategory.IMPLICIT_BASELINE)
    prop.label = "transmitted packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsBase", prop)

    prop = PropMeta("str", "txPktsCum", "txPktsCum", 35321, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "transmitted packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsCum", prop)

    prop = PropMeta("str", "txPktsLast", "txPktsLast", 35319, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "transmitted packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsLast", prop)

    prop = PropMeta("str", "txPktsMax", "txPktsMax", 35324, PropCategory.IMPLICIT_MAX)
    prop.label = "transmitted packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsMax", prop)

    prop = PropMeta("str", "txPktsMin", "txPktsMin", 35323, PropCategory.IMPLICIT_MIN)
    prop.label = "transmitted packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsMin", prop)

    prop = PropMeta("str", "txPktsPer", "txPktsPer", 35322, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "transmitted packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsPer", prop)

    prop = PropMeta("str", "txPktsRate", "txPktsRate", 35330, PropCategory.IMPLICIT_RATE)
    prop.label = "transmitted packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsRate", prop)

    prop = PropMeta("str", "txPktsSpct", "txPktsSpct", 35326, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "transmitted packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsSpct", prop)

    prop = PropMeta("str", "txPktsThr", "txPktsThr", 35327, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "txPktsTr", "txPktsTr", 35329, PropCategory.IMPLICIT_TREND)
    prop.label = "transmitted packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("txPktsTr", prop)

    prop = PropMeta("str", "txPktsTrBase", "txPktsTrBase", 35328, PropCategory.IMPLICIT_TREND_BASE)
