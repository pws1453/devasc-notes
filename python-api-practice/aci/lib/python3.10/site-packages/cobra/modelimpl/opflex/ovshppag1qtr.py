...
# ##################################################
class OvsHppAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAg1qtr", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAg1qtr"
    meta.rnFormat = "CDopflexOvsHppAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs host protection stats stats in 1 quarter"
