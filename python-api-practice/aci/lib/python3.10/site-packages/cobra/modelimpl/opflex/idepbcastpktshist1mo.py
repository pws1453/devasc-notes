...
# ##################################################
class IDEpBcastPktsHist1mo(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist1mo", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist1mo"
    meta.rnFormat = "HDopflexIDEpBcastPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 15884, PropCategory.REGULAR)
