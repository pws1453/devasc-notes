...
# ##################################################
class IDEpRxBytes1qtr(Mo):
    """
    A class that represents the most current statistics for received bytes in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes1qtr", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes1qtr"
    meta.rnFormat = "CDopflexIDEpRxBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats in 1 quarter"
