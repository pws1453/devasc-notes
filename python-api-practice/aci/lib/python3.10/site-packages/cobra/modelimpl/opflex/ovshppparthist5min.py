...
# ##################################################
class OvsHppPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPartHist5min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPartHist5min"
    meta.rnFormat = "HDopflexOvsHppPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs host protection stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 34822, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34823, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
