...
# ##################################################
class OvsHppHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppHist15min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppHist15min"
    meta.rnFormat = "HDopflexOvsHpp15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs host protection stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsHppHist")

    meta.rnPrefixes = [
        ('HDopflexOvsHpp15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34792, PropCategory.REGULAR)
