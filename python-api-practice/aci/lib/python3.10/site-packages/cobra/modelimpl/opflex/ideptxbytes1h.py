...
# ##################################################
class IDEpTxBytes1h(Mo):
    """
    A class that represents the most current statistics for transmitted bytes in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpTxBytes1h", "transmitted bytes")
    ...
    meta.moClassName = "opflexIDEpTxBytes1h"
    meta.rnFormat = "CDopflexIDEpTxBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current transmitted bytes stats in 1 hour"
