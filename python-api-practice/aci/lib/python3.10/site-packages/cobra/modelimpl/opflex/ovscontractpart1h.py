...
# ##################################################
class OvsContractPart1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractPart1h", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractPart1h"
    meta.rnFormat = "CDopflexOvsContractPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs contract stats stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDopflexOvsContractPart1h-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34762, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
