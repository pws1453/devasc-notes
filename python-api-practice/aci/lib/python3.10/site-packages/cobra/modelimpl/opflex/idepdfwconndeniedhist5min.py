...
# ##################################################
class IDEpDfwConnDeniedHist5min(Mo):
    """
    A class that represents historical statistics for DFW connection denied statistics in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpDfwConnDeniedHist5min", "DFW connection denied statistics")
    ...
    meta.moClassName = "opflexIDEpDfwConnDeniedHist5min"
    meta.rnFormat = "HDopflexIDEpDfwConnDenied5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical DFW connection denied statistics stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDopflexIDEpDfwConnDenied5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 19135, PropCategory.REGULAR)
