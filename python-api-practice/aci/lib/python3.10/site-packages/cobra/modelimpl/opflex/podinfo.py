...
class PodInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.opflex.PodInfo")

    meta.moClassName = "opflexPodInfo"
    meta.rnFormat = "podinfo"
    meta.category = MoCategory.REGULAR
    meta.label = "Pod Info for opflex agents"
    ...
    prop = PropMeta("str", "ip", "ip", 44895, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "peerIp", "peerIp", 44896, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("peerIp", prop)

    prop = PropMeta("str", "podId", "podId", 44897, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "srvStatus", "srvStatus", 49939, PropCategory.REGULAR)
