...
# ##################################################
class OvsContractHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist15min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist15min"
    meta.rnFormat = "HDopflexOvsContract15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsContractHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDopflexOvsContract15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 34752, PropCategory.REGULAR)
