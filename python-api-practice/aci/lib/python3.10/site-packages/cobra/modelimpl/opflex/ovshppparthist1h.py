...
# ##################################################
class OvsHppPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPartHist1h", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPartHist1h"
    meta.rnFormat = "HDopflexOvsHppPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs host protection stats stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 34812, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34813, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
