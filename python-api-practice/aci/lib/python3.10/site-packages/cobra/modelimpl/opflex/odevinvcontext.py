...
# ##################################################
class ODevInvContext(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.ODevInvContext")

    meta.moClassName = "opflexODevInvContext"
    meta.rnFormat = "opflexODevInv"
    ...
    prop = PropMeta("str", "type", "type", 37167, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
