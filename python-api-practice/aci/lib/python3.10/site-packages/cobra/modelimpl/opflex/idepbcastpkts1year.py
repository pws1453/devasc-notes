...
# ##################################################
class IDEpBcastPkts1year(Mo):
    """
    A class that represents the most current statistics for broadcast packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPkts1year", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPkts1year"
    meta.rnFormat = "CDopflexIDEpBcastPkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current broadcast packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpBcastPkts1year', False),
    ]
