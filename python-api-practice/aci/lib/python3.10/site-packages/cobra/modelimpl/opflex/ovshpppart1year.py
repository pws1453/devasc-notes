...
# ##################################################
class OvsHppPart1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPart1year", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPart1year"
    meta.rnFormat = "CDopflexOvsHppPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ovs host protection stats stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34806, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
