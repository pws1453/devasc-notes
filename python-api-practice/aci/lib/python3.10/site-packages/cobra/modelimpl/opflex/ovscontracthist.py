...
# ##################################################
class OvsContractHist(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist"


    meta.moClassName = "opflexOvsContractHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractHist5min")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesAvg", "bytesAvg", 34950, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesAvg", prop)

    prop = PropMeta("str", "bytesCum", "bytesCum", 34946, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesMax", "bytesMax", 34949, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMax", prop)

    prop = PropMeta("str", "bytesMin", "bytesMin", 34948, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesMin", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 34947, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 34954, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 34951, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 34952, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 34953, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 35005, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 35001, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 35004, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 35003, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 35002, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 35009, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 35006, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 35007, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 35008, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "revBytesAvg", "revBytesAvg", 35060, PropCategory.IMPLICIT_AVG)
    prop.label = "received bytes (reverse) average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesAvg", prop)

    prop = PropMeta("str", "revBytesCum", "revBytesCum", 35056, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesCum", prop)

    prop = PropMeta("str", "revBytesMax", "revBytesMax", 35059, PropCategory.IMPLICIT_MAX)
    prop.label = "received bytes (reverse) maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesMax", prop)

    prop = PropMeta("str", "revBytesMin", "revBytesMin", 35058, PropCategory.IMPLICIT_MIN)
    prop.label = "received bytes (reverse) minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesMin", prop)

    prop = PropMeta("str", "revBytesPer", "revBytesPer", 35057, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesPer", prop)

    prop = PropMeta("str", "revBytesRate", "revBytesRate", 35064, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesRate", prop)

    prop = PropMeta("str", "revBytesSpct", "revBytesSpct", 35061, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesSpct", prop)

    prop = PropMeta("str", "revBytesThr", "revBytesThr", 35062, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revBytesTr", "revBytesTr", 35063, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes (reverse) trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesTr", prop)

    prop = PropMeta("str", "revPktsAvg", "revPktsAvg", 35115, PropCategory.IMPLICIT_AVG)
    prop.label = "received packets (reverse) average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsAvg", prop)

    prop = PropMeta("str", "revPktsCum", "revPktsCum", 35111, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsCum", prop)

    prop = PropMeta("str", "revPktsMax", "revPktsMax", 35114, PropCategory.IMPLICIT_MAX)
    prop.label = "received packets (reverse) maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMax", prop)

    prop = PropMeta("str", "revPktsMin", "revPktsMin", 35113, PropCategory.IMPLICIT_MIN)
    prop.label = "received packets (reverse) minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMin", prop)

    prop = PropMeta("str", "revPktsPer", "revPktsPer", 35112, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsPer", prop)

    prop = PropMeta("str", "revPktsRate", "revPktsRate", 35119, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsRate", prop)

    prop = PropMeta("str", "revPktsSpct", "revPktsSpct", 35116, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsSpct", prop)

    prop = PropMeta("str", "revPktsThr", "revPktsThr", 35117, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revPktsTr", "revPktsTr", 35118, PropCategory.IMPLICIT_TREND)
