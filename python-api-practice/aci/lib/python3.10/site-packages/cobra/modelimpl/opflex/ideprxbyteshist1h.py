...
# ##################################################
class IDEpRxBytesHist1h(Mo):
    """
    A class that represents historical statistics for received bytes in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist1h", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist1h"
    meta.rnFormat = "HDopflexIDEpRxBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical received bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6948, PropCategory.REGULAR)
