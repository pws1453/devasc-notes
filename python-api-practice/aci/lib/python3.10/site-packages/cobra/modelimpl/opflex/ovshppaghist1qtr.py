...
# ##################################################
class OvsHppAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAgHist1qtr", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAgHist1qtr"
    meta.rnFormat = "HDopflexOvsHppAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs host protection stats stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 34788, PropCategory.REGULAR)
