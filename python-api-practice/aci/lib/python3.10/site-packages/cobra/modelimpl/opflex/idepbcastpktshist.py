...
# ##################################################
class IDEpBcastPktsHist(Mo):
    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist"


    meta.moClassName = "opflexIDEpBcastPktsHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist1year")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist1d")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist1qtr")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist15min")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist1h")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist5min")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist1w")
    meta.concreteSubClasses.add("cobra.model.opflex.IDEpBcastPktsHist1mo")
    ...
    prop = PropMeta("str", "rxAvg", "rxAvg", 15905, PropCategory.IMPLICIT_AVG)
    prop.label = "received broadcast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxAvg", prop)

    prop = PropMeta("str", "rxCum", "rxCum", 15901, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received broadcast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxCum", prop)

    prop = PropMeta("str", "rxMax", "rxMax", 15904, PropCategory.IMPLICIT_MAX)
    prop.label = "received broadcast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxMax", prop)

    prop = PropMeta("str", "rxMin", "rxMin", 15903, PropCategory.IMPLICIT_MIN)
    prop.label = "received broadcast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxMin", prop)

    prop = PropMeta("str", "rxPer", "rxPer", 15902, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received broadcast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxPer", prop)

    prop = PropMeta("str", "rxRate", "rxRate", 15909, PropCategory.IMPLICIT_RATE)
    prop.label = "received broadcast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxRate", prop)

    prop = PropMeta("str", "rxSpct", "rxSpct", 15906, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received broadcast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("rxSpct", prop)

    prop = PropMeta("str", "rxThr", "rxThr", 15907, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "rxTr", "rxTr", 15908, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "txTr", "txTr", 15929, PropCategory.IMPLICIT_TREND)
