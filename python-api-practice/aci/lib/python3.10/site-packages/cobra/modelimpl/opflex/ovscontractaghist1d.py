...
# ##################################################
class OvsContractAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractAgHist1d", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAgHist1d"
    meta.rnFormat = "HDopflexOvsContractAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ovs contract stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 34745, PropCategory.REGULAR)
