...
# ##################################################
class IDEpRxBytesHist15min(Mo):
    """
    A class that represents historical statistics for received bytes in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytesHist15min", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytesHist15min"
    meta.rnFormat = "HDopflexIDEpRxBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical received bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.IDEpRxBytesHist")

    meta.rnPrefixes = [
        ('HDopflexIDEpRxBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6946, PropCategory.REGULAR)
