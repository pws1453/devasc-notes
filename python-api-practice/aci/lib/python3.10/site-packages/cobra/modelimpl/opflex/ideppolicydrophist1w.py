...
# ##################################################
class IDEpPolicyDropHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpPolicyDropHist1w", "EPG policy drop statistics")
    ...
    meta.moClassName = "opflexIDEpPolicyDropHist1w"
    meta.rnFormat = "HDopflexIDEpPolicyDrop1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical EPG policy drop statistics stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 23608, PropCategory.REGULAR)
