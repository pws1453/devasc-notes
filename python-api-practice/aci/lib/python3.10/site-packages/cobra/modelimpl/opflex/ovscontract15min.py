...
# ##################################################
class OvsContract15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContract15min", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContract15min"
    meta.rnFormat = "CDopflexOvsContract15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ovs contract stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsContract")

    meta.rnPrefixes = [
        ('CDopflexOvsContract15min', False),
    ]
