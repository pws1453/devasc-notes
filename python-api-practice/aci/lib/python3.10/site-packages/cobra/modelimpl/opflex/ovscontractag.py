...
# ##################################################
class OvsContractAg(Mo):
    meta = StatsClassMeta("cobra.model.opflex.OvsContractAg", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractAg"


    meta.moClassName = "opflexOvsContractAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs contract stats stats"
    ...
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg1year")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg1w")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg15min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg1mo")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg5min")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg1h")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg1d")
    meta.concreteSubClasses.add("cobra.model.opflex.OvsContractAg1qtr")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "bytesCum", "bytesCum", 34976, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesCum", prop)

    prop = PropMeta("str", "bytesPer", "bytesPer", 34977, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesPer", prop)

    prop = PropMeta("str", "bytesRate", "bytesRate", 34982, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesRate", prop)

    prop = PropMeta("str", "bytesSpct", "bytesSpct", 34978, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesSpct", prop)

    prop = PropMeta("str", "bytesThr", "bytesThr", 34979, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "bytesTr", "bytesTr", 34981, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("bytesTr", prop)

    prop = PropMeta("str", "bytesTrBase", "bytesTrBase", 34980, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "pktsCum", "pktsCum", 35031, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 35032, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 35037, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 35033, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 35034, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 35036, PropCategory.IMPLICIT_TREND)
    prop.label = "received packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsTr", prop)

    prop = PropMeta("str", "pktsTrBase", "pktsTrBase", 35035, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "revBytesCum", "revBytesCum", 35086, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received bytes (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesCum", prop)

    prop = PropMeta("str", "revBytesPer", "revBytesPer", 35087, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received bytes (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesPer", prop)

    prop = PropMeta("str", "revBytesRate", "revBytesRate", 35092, PropCategory.IMPLICIT_RATE)
    prop.label = "received bytes (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesRate", prop)

    prop = PropMeta("str", "revBytesSpct", "revBytesSpct", 35088, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received bytes (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesSpct", prop)

    prop = PropMeta("str", "revBytesThr", "revBytesThr", 35089, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revBytesTr", "revBytesTr", 35091, PropCategory.IMPLICIT_TREND)
    prop.label = "received bytes (reverse) trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesTr", prop)

    prop = PropMeta("str", "revBytesTrBase", "revBytesTrBase", 35090, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "received bytes (reverse) trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revBytesTrBase", prop)

    prop = PropMeta("str", "revPktsCum", "revPktsCum", 35141, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "received packets (reverse) cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsCum", prop)

    prop = PropMeta("str", "revPktsPer", "revPktsPer", 35142, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "received packets (reverse) periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsPer", prop)

    prop = PropMeta("str", "revPktsRate", "revPktsRate", 35147, PropCategory.IMPLICIT_RATE)
    prop.label = "received packets (reverse) rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsRate", prop)

    prop = PropMeta("str", "revPktsSpct", "revPktsSpct", 35143, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "received packets (reverse) suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsSpct", prop)

    prop = PropMeta("str", "revPktsThr", "revPktsThr", 35144, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revPktsTr", "revPktsTr", 35146, PropCategory.IMPLICIT_TREND)
    prop.label = "received packets (reverse) trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsTr", prop)

    prop = PropMeta("str", "revPktsTrBase", "revPktsTrBase", 35145, PropCategory.IMPLICIT_TREND_BASE)
