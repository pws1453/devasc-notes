...
# ##################################################
class IDEpBcastPktsHist1h(Mo):
    """
    A class that represents historical statistics for broadcast packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPktsHist1h", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPktsHist1h"
    meta.rnFormat = "HDopflexIDEpBcastPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical broadcast packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 15883, PropCategory.REGULAR)
