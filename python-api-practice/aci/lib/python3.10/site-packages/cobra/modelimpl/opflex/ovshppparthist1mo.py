...
# ##################################################
class OvsHppPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppPartHist1mo", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppPartHist1mo"
    meta.rnFormat = "HDopflexOvsHppPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ovs host protection stats stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 34814, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 34815, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
