...
# ##################################################
class OvsHpp15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHpp15min", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHpp15min"
    meta.rnFormat = "CDopflexOvsHpp15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ovs host protection stats stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.opflex.OvsHpp")

    meta.rnPrefixes = [
        ('CDopflexOvsHpp15min', False),
    ]
