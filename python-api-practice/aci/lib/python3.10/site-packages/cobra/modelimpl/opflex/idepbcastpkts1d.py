...
# ##################################################
class IDEpBcastPkts1d(Mo):
    """
    A class that represents the most current statistics for broadcast packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpBcastPkts1d", "broadcast packets")
    ...
    meta.moClassName = "opflexIDEpBcastPkts1d"
    meta.rnFormat = "CDopflexIDEpBcastPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current broadcast packets stats in 1 day"
