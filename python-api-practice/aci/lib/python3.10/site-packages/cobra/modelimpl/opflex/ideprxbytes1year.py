...
# ##################################################
class IDEpRxBytes1year(Mo):
    """
    A class that represents the most current statistics for received bytes in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.opflex.IDEpRxBytes1year", "received bytes")
    ...
    meta.moClassName = "opflexIDEpRxBytes1year"
    meta.rnFormat = "CDopflexIDEpRxBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current received bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDopflexIDEpRxBytes1year', False),
    ]
