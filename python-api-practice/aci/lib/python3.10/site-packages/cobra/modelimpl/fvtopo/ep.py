...
class Ep(Mo):
    ...
    meta = ClassMeta("cobra.model.fvtopo.Ep")

    meta.moClassName = "fvtopoEp"
    meta.rnFormat = "ep-%(mac)s"
    ...
    meta.childClasses.add("cobra.model.fvtopo.RtEp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fvtopo.RtEp", "rtep-"))
    ...
    prop = PropMeta("str", "mac", "mac", 6586, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 1826, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "VM"
    prop._addConstant("VM", "vm", 0)
