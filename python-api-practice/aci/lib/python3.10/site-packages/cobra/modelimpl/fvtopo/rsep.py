...
class RsEp(Mo):
    """
    A source relation to the endpoint.

    """

    meta = SourceRelationMeta("cobra.model.fvtopo.RsEp", "cobra.model.fvtopo.Ep")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvtopoRsEp"
    meta.rnFormat = "rsep-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fvtopo.Port")
    ...
    prop = PropMeta("str", "configured", "configured", 12462, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "discovered", "discovered", 12463, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("discovered", prop)
    ...
    prop = PropMeta("str", "static", "static", 12464, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "tCl", "tCl", 12461, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2105
    prop.defaultValueStr = "fvtopoEp"
    prop._addConstant("fvtopoEp", None, 2105)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12460, PropCategory.REGULAR)
