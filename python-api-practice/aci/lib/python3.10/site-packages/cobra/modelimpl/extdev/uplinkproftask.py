...
# ##################################################
class UplinkProfTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.UplinkProfTask")

    meta.moClassName = "extdevUplinkProfTask"
    meta.rnFormat = "extdevUplinkProfTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.extdev.UplinkProfContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.UplinkProfContext", "extdevUplinkProf"))
    ...
    prop = PropMeta("str", "id", "id", 43753, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfigUplinkProf", "configuplinkprof", 3178)
