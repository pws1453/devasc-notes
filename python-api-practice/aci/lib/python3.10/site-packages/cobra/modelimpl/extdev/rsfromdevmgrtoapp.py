...
# ##################################################
class RsFromDevMgrToApp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.extdev.RsFromDevMgrToApp", "cobra.model.ap.Plugin")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "extdevRsFromDevMgrToApp"
    meta.rnFormat = "rsfromDevMgrToApp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to App"
    ...
    meta.rnPrefixes = [
        ('rsfromDevMgrToApp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 52344, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52345, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isDefaultConn", "isDefaultConn", 52335, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isDefaultConn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 52341, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 52337, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8929
    prop.defaultValueStr = "apPlugin"
    prop._addConstant("apPlugin", None, 8929)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52336, PropCategory.REGULAR)
