...
# ##################################################
class RsNicProfToDomPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.RsNicProfToDomPTask")

    meta.moClassName = "extdevRsNicProfToDomPTask"
    meta.rnFormat = "extdevRsNicProfToDomPTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('extdevRsNicProfToDomPTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 43752, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfigNicProfToDomP", "confignicproftodomp", 3176)
