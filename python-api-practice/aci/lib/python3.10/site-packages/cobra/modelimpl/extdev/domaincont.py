...
class DomainCont(Mo):
    ...
    meta = ClassMeta("cobra.model.extdev.DomainCont")

    meta.moClassName = "extdevDomainCont"
    meta.rnFormat = "domainCont"
    ...
    meta.childClasses.add("cobra.model.extdev.RsDomDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.RsDomDef", "rsdomDef-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43878, PropCategory.REGULAR)
