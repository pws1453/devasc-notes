...
class UplinkProf(Mo):
    ...
    meta = ClassMeta("cobra.model.extdev.UplinkProf")

    meta.moClassName = "extdevUplinkProf"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43914, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "apicControlled", "apicControlled", 43718, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43915, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "externalId", "externalId", 43720, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43881, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 43719, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
