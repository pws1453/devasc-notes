...
class SDWanVpnCont(Mo):
    ...
    meta = ClassMeta("cobra.model.extdev.SDWanVpnCont")

    meta.moClassName = "extdevSDWanVpnCont"
    meta.rnFormat = "sdwanvpncont"
    meta.category = MoCategory.REGULAR
    meta.label = "WAN SLA VPN Container"
    ...
    meta.childClasses.add("cobra.model.extdev.SDWanVpnEntry")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.SDWanVpnEntry", "sdwanvpnentry-"))
