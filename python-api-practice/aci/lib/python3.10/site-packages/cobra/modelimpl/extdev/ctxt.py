...
class Ctxt(Mo):
    ...
    meta = ClassMeta("cobra.model.extdev.Ctxt")

    meta.moClassName = "extdevCtxt"
    meta.rnFormat = "ctxt"
    meta.category = MoCategory.REGULAR
    meta.label = "extdev Context"
    ...
    prop = PropMeta("str", "mgrDn", "mgrDn", 43722, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("mgrDn", prop)
    ...
    prop = PropMeta("str", "replicaId", "replicaId", 43724, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "runId", "runId", 43728, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("runId", prop)

    prop = PropMeta("str", "shardId", "shardId", 43723, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "trigDn", "trigDn", 43726, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("trigDn", prop)

    prop = PropMeta("str", "trigId", "trigId", 43727, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("trigId", prop)

    prop = PropMeta("str", "trigT", "trigT", 43725, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
