...
class MgrPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.extdev.MgrPTask")

    meta.moClassName = "extdevMgrPTask"
    meta.rnFormat = "extdevMgrPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 43749, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Config", "config", 3173)
