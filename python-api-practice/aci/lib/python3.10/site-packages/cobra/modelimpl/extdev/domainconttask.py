...
# ##################################################
class DomainContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.DomainContTask")

    meta.moClassName = "extdevDomainContTask"
    meta.rnFormat = "extdevDomainContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 43748, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfigDomainCont", "configdomaincont", 3177)
