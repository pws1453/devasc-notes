...
class GroupP(Mo):
    ...
    meta = ClassMeta("cobra.model.extdev.GroupP")

    meta.moClassName = "extdevGroupP"
    meta.rnFormat = "grp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Integration Group"
    ...
    meta.childClasses.add("cobra.model.extdev.RtGroupPRef")
    meta.childClasses.add("cobra.model.infra.RtDomRef")
    meta.childClasses.add("cobra.model.extdev.MgrP")
    ...
    meta.childClasses.add("cobra.model.extdev.RtEsDompRel")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.RtEsDompRel", "rtpolEsDompRel-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.RtGroupPRef", "rtGroupPRef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.MgrP", "mgr-"))
    ...
    meta.superClasses.add("cobra.model.edm.GroupP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 43908, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43909, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43876, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 43764, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "txId", "txId", 43716, PropCategory.REGULAR)
    prop.label = "Transaction Id when GroupP was created"
    prop.isImplicit = True
    prop.isAdmin = True
