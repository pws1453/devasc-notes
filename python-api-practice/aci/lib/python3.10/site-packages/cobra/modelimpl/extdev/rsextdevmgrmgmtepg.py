...
# ##################################################
class RsExtdevMgrMgmtEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.extdev.RsExtdevMgrMgmtEPg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "extdevRsExtdevMgrMgmtEPg"
    meta.rnFormat = "rsextdevMgrMgmtEPg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Management EPg"
    ...
    meta.rnPrefixes = [
        ('rsextdevMgrMgmtEPg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43912, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43913, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 43847, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43846, PropCategory.REGULAR)
