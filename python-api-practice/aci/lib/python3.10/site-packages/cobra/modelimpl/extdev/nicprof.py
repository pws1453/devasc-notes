...
class NicProf(Mo):
    ...
    meta = ClassMeta("cobra.model.extdev.NicProf")

    meta.moClassName = "extdevNicProf"
    ...
    meta.childClasses.add("cobra.model.extdev.RsNicProfToDomP")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.RsNicProfToDomP", "rsnicProfToDomP-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 43916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43917, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "externalId", "externalId", 43766, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43882, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 43721, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
