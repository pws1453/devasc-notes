...
# ##################################################
class SwMgrFlagsTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.SwMgrFlagsTask")

    meta.moClassName = "extdevSwMgrFlagsTask"
    meta.rnFormat = "extdevSwMgrFlagsTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 50086, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfigSwMgrFlags", "configswmgrflags", 3340)
