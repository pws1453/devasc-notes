...
# ##################################################
class SDWanVpnDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.SDWanVpnDef")

    meta.moClassName = "extdevSDWanVpnDef"
    meta.rnFormat = "sdwanvpndef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "WAN SLA VPNDef"
    ...
    prop = PropMeta("str", "name", "name", 55590, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
