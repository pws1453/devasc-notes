...
class RtSdwanPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.extdev.RtSdwanPol", "cobra.model.vz.Subj")

    meta.moClassName = "extdevRtSdwanPol"
    meta.rnFormat = "rtvzSdwanPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49836, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 49835, PropCategory.REGULAR)
