...
# ##################################################
class RsToDevType(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.extdev.RsToDevType", "cobra.model.extdev.DevType")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "extdevRsToDevType"
    meta.rnFormat = "rstoDevType"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Target Device Type"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44680, PropCategory.REGULAR)
