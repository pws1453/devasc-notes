...
class RsDomDef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.extdev.RsDomDef", "cobra.model.infra.ADomP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "extdevRsDomDef"
    meta.rnFormat = "rsdomDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43850, PropCategory.REGULAR)
