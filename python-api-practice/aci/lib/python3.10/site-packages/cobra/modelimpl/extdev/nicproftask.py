...
# ##################################################
class NicProfTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.NicProfTask")

    meta.moClassName = "extdevNicProfTask"
    meta.rnFormat = "extdevNicProfTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.extdev.NicProfContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.NicProfContext", "extdevNicProf"))
    ...
    prop = PropMeta("str", "id", "id", 43750, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfigNic", "confignic", 3174)
