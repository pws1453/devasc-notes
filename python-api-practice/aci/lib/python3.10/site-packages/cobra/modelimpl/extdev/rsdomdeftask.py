...
# ##################################################
class RsDomDefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.RsDomDefTask")

    meta.moClassName = "extdevRsDomDefTask"
    meta.rnFormat = "extdevRsDomDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 43751, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ConfigDomDef", "configdomdef", 3175)
