...
# ##################################################
class SDWanSlaPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.extdev.SDWanSlaPol")

    meta.moClassName = "extdevSDWanSlaPol"
    meta.rnFormat = "sdwanslapol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "WAN SLA Policy"
    ...
    meta.childClasses.add("cobra.model.extdev.RtSdwanPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.extdev.RtSdwanPol", "rtvzSdwanPol-"))
    ...
    meta.superClasses.add("cobra.model.extdev.SDWanASlaPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 49888, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dscp", "dscp", 49718, PropCategory.REGULAR)
    prop.label = "SLA DSCP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "edmSlaDn", "edmSlaDn", 55570, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("edmSlaDn", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49889, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "jitter", "jitter", 49715, PropCategory.REGULAR)
    prop.label = "SLA Acceptable Jitter"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 1000)]
    prop.defaultValue = 100
    prop.defaultValueStr = "100"
    meta.props.add("jitter", prop)

    prop = PropMeta("str", "latency", "latency", 49717, PropCategory.REGULAR)
    prop.label = "SLA Acceptable Delay"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 1000)]
    prop.defaultValue = 100
    prop.defaultValueStr = "100"
    meta.props.add("latency", prop)
    ...
    prop = PropMeta("str", "loss", "loss", 49716, PropCategory.REGULAR)
    prop.label = "SLA Acceptable Loss"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 100)]
    prop.defaultValue = 10
    prop.defaultValueStr = "10"
    meta.props.add("loss", prop)
    ...
    prop = PropMeta("str", "name", "name", 49830, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
