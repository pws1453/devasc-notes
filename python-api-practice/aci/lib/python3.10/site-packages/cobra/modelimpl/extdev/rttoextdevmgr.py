...
# ##################################################
class RtToExtDevMgr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.extdev.RtToExtDevMgr", "cobra.model.vmm.CtrlrP")

    meta.moClassName = "extdevRtToExtDevMgr"
    meta.rnFormat = "rtvmmToExtDevMgr-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "VMM Controller"
    meta.writeAccessMask = 0x80084000000001
    meta.readAccessMask = 0x80084000000011
    ...
    prop = PropMeta("str", "tCl", "tCl", 49840, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 49839, PropCategory.REGULAR)
