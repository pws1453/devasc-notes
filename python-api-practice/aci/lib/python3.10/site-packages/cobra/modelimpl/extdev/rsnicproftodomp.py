...
# ##################################################
class RsNicProfToDomP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.extdev.RsNicProfToDomP", "cobra.model.infra.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "extdevRsNicProfToDomP"
    meta.rnFormat = "rsnicProfToDomP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to DomP"
    ...
    meta.rnPrefixes = [
        ('rsnicProfToDomP-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 43918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43919, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43883, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43855, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43854, PropCategory.REGULAR)
