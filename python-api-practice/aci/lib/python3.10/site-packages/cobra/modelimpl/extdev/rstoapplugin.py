...
# ##################################################
class RsToApPlugin(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.extdev.RsToApPlugin", "cobra.model.ap.Plugin")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "extdevRsToApPlugin"
    meta.rnFormat = "rstoApPlugin-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Target App Plugin"
    ...
    prop = PropMeta("str", "annotation", "annotation", 44698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44699, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "isAppManaged", "isAppManaged", 52334, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 44685, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44684, PropCategory.REGULAR)
