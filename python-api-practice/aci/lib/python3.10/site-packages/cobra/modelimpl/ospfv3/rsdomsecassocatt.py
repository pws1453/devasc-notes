...
# ##################################################
class RsDomSecAssocAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ospfv3.RsDomSecAssocAtt", "cobra.model.ipsec.StSecAssoc")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ospfv3RsDomSecAssocAtt"
    meta.rnFormat = "rsDomSecAssocAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33339, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33338, PropCategory.REGULAR)
