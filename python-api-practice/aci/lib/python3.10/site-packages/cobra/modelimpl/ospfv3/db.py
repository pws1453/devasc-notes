...
class Db(Mo):
    ...
    meta = ClassMeta("cobra.model.ospfv3.Db")

    meta.moClassName = "ospfv3Db"
    ...
    meta.childClasses.add("cobra.model.ospfv3.Route")
    meta.childClasses.add("cobra.model.ospfv3.LsaRec")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.LsaRec", "lsa-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.Route", "rt-"))
    ...
    prop = PropMeta("str", "type", "type", 17478, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
