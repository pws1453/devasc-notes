...
# ##################################################
class RsAreaSecAssocAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ospfv3.RsAreaSecAssocAtt", "cobra.model.ipsec.StSecAssoc")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ospfv3RsAreaSecAssocAtt"
    meta.rnFormat = "rsAreaSecAssocAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33347, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33346, PropCategory.REGULAR)
