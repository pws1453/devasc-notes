...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.ospfv3.Inst")

    meta.moClassName = "ospfv3Inst"
    meta.rnFormat = "inst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Instance"
    ...
    meta.childClasses.add("cobra.model.ospfv3.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.ospfv3.Entity")

    meta.superClasses.add("cobra.model.ospf.AInst")
    ...
    prop = PropMeta("str", "memAlert", "memAlert", 17274, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17544, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 17483, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
