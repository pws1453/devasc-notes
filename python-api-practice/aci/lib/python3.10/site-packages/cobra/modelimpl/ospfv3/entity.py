...
class Entity(Mo):
    """
    The OSPFV3 control plane entity information.

    """

    meta = ClassMeta("cobra.model.ospfv3.Entity")

    meta.moClassName = "ospfv3Entity"
    meta.rnFormat = "ospfv3"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Entity"
    ...
    meta.childClasses.add("cobra.model.ospfv3.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.Inst", "inst-"))
    ...
    meta.superClasses.add("cobra.model.ospf.AEntity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17543, PropCategory.REGULAR)
