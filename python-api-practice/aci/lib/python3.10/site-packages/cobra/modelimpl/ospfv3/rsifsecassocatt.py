...
# ##################################################
class RsIfSecAssocAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ospfv3.RsIfSecAssocAtt", "cobra.model.ipsec.StSecAssoc")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "ospfv3RsIfSecAssocAtt"
    meta.rnFormat = "rsifSecAssocAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "OSPF Ipsec Security Association"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 33351, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 33343, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10700
    prop.defaultValueStr = "ipsecStSecAssoc"
    prop._addConstant("ipsecStSecAssoc", None, 10700)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33342, PropCategory.REGULAR)
