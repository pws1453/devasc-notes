...
class If(Mo):
    ...
    meta = ClassMeta("cobra.model.ospfv3.If")

    meta.moClassName = "ospfv3If"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Interface"
    ...
    meta.childClasses.add("cobra.model.ospfv3.IfStats")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.ospfv3.TrafficStats")
    meta.childClasses.add("cobra.model.ospfv3.RtIfDefToOspfv3If")
    meta.childClasses.add("cobra.model.ospfv3.AdjEp")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")
    meta.childClasses.add("cobra.model.ospfv3.RsIfSecAssocAtt")
    meta.childClasses.add("cobra.model.ospfv3.Db")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.RtIfDefToOspfv3If", "rtospfIfDefToOspfv3If-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.RsIfSecAssocAtt", "rsifSecAssocAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.IfStats", "ifstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.TrafficStats", "trstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospfv3.AdjEp", "adj-"))
    ...
    meta.superClasses.add("cobra.model.ospf.AIf")
    ...
    prop = PropMeta("str", "id", "id", 17482, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17542, PropCategory.REGULAR)
