...
# ##################################################
class RuleHitPartHist1mo(Mo):
    """
    A class that represents historical portion of the statistics for rule hits in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPartHist1mo", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPartHist1mo"
    meta.rnFormat = "HDactrlRuleHitPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the rule hits stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 5845, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5846, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
