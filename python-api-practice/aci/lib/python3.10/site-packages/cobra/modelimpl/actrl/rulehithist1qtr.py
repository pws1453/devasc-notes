...
# ##################################################
class RuleHitHist1qtr(Mo):
    """
    A class that represents historical statistics for rule hits in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist1qtr", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist1qtr"
    meta.rnFormat = "HDactrlRuleHit1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 5827, PropCategory.REGULAR)
