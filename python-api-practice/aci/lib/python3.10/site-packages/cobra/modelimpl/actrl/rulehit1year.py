...
# ##################################################
class RuleHit1year(Mo):
    """
    A class that represents the most current statistics for rule hits in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHit1year", "rule hits")
    ...
    meta.moClassName = "actrlRuleHit1year"
    meta.rnFormat = "CDactrlRuleHit1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current rule hits stats in 1 year"
