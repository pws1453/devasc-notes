...
# ##################################################
class RuleHitHist1h(Mo):
    """
    A class that represents historical statistics for rule hits in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist1h", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist1h"
    meta.rnFormat = "HDactrlRuleHit1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 5825, PropCategory.REGULAR)
