...
# ##################################################
class RuleHitHist5min(Mo):
    """
    A class that represents historical statistics for rule hits in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist5min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist5min"
    meta.rnFormat = "HDactrlRuleHit5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 5830, PropCategory.REGULAR)
