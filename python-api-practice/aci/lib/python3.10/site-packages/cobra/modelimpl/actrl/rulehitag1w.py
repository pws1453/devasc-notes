...
# ##################################################
class RuleHitAg1w(Mo):
    """
    A class that represents the most current aggregated statistics for rule hits in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAg1w", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAg1w"
    meta.rnFormat = "CDactrlRuleHitAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated rule hits stats in 1 week"
