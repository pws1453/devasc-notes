...
# ##################################################
class RsToEpgProt(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsToEpgProt", "cobra.model.fv.ProtEPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "actrlRsToEpgProt"
    meta.rnFormat = "rstoEpgProt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ProtEpg Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15639, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2078
    prop.defaultValueStr = "fvProtEPg"
    prop._addConstant("fvProtEPg", None, 2078)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15638, PropCategory.REGULAR)
