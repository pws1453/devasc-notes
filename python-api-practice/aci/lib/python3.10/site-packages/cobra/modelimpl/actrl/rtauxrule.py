...
class RtAuxRule(Mo):
    """
    A target relation to the auxiliary rule information.

    """

    meta = TargetRelationMeta("cobra.model.actrl.RtAuxRule", "cobra.model.actrl.ARule")

    meta.moClassName = "actrlRtAuxRule"
    meta.rnFormat = "rtAuxRule"
    ...
    meta.parentClasses.add("cobra.model.actrl.AuxRule")
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15046, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12625, PropCategory.REGULAR)
