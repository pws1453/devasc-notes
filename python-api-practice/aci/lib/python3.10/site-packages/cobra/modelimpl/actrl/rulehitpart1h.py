...
# ##################################################
class RuleHitPart1h(Mo):
    """
    A class that represents the most current portion of the statistics for rule hits in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPart1h", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPart1h"
    meta.rnFormat = "CDactrlRuleHitPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the rule hits stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5833, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
