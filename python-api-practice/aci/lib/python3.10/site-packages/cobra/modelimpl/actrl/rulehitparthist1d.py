...
# ##################################################
class RuleHitPartHist1d(Mo):
    """
    A class that represents historical portion of the statistics for rule hits in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPartHist1d", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPartHist1d"
    meta.rnFormat = "HDactrlRuleHitPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the rule hits stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 5841, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5842, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
