...
# ##################################################
class RuleHitPart5min(Mo):
    """
    A class that represents the most current portion of the statistics for rule hits in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPart5min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPart5min"
    meta.rnFormat = "CDactrlRuleHitPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the rule hits stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5838, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
