...
# ##################################################
class RuleHitHist1year(Mo):
    """
    A class that represents historical statistics for rule hits in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist1year", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist1year"
    meta.rnFormat = "HDactrlRuleHit1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 5829, PropCategory.REGULAR)
