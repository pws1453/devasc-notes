...
class SnmpRule(Mo):
    ...
    prop = PropMeta("str", "actrlCfgFailedBmp", "actrlCfgFailedBmp", 14966, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop._addConstant("actrl:SnmpRuleintent_failed_flag", None, 512)
    prop._addConstant("actrl:SnmpRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("actrl:SnmpRulemarkDscp_failed_flag", None, 1024)
    prop._addConstant("actrl:SnmpRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:SnmpRulenameAlias_failed_flag", None, 2)
    prop._addConstant("actrl:SnmpRulename_failed_flag", None, 1)
    prop._addConstant("actrl:SnmpRuleprio_failed_flag", None, 8192)
    prop._addConstant("actrl:SnmpRuleqosGrp_failed_flag", None, 16384)
    prop._addConstant("actrl:SnmpRulesPcTag_failed_flag", None, 32768)
    prop._addConstant("actrl:SnmpRulescopeId_failed_flag", None, 65536)
    prop._addConstant("actrl:SnmpRuletype_failed_flag", None, 131072)
    meta.props.add("actrlCfgFailedBmp", prop)

    prop = PropMeta("str", "actrlCfgFailedTs", "actrlCfgFailedTs", 14968, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("actrlCfgFailedTs", prop)

    prop = PropMeta("str", "actrlCfgState", "actrlCfgState", 14967, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
