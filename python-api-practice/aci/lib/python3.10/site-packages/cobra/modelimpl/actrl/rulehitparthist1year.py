...
# ##################################################
class RuleHitPartHist1year(Mo):
    """
    A class that represents historical portion of the statistics for rule hits in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPartHist1year", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPartHist1year"
    meta.rnFormat = "HDactrlRuleHitPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the rule hits stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 5851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5852, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
