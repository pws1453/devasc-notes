...
# ##################################################
class RuleHitAgHist5min(Mo):
    """
    A class that represents historical aggregated statistics for rule hits in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAgHist5min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAgHist5min"
    meta.rnFormat = "HDactrlRuleHitAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated rule hits stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 5822, PropCategory.REGULAR)
