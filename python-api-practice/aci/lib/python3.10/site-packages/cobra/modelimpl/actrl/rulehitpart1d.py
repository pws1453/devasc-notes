...
# ##################################################
class RuleHitPart1d(Mo):
    """
    A class that represents the most current portion of the statistics for rule hits in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPart1d", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPart1d"
    meta.rnFormat = "CDactrlRuleHitPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the rule hits stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5832, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
