...
# ##################################################
class RuleHitPartHist5min(Mo):
    """
    A class that represents historical portion of the statistics for rule hits in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPartHist5min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPartHist5min"
    meta.rnFormat = "HDactrlRuleHitPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the rule hits stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 5853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5854, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
