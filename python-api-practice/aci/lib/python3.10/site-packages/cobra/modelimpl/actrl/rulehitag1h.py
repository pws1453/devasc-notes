...
# ##################################################
class RuleHitAg1h(Mo):
    """
    A class that represents the most current aggregated statistics for rule hits in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAg1h", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAg1h"
    meta.rnFormat = "CDactrlRuleHitAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated rule hits stats in 1 hour"
