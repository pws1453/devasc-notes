...
class Inst(Mo):
    """
    The ACTRL instance information.

    """

    meta = ClassMeta("cobra.model.actrl.Inst")

    meta.moClassName = "actrlInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Control Instance"
    ...
    prop = PropMeta("str", "accCtrl", "accCtrl", 2163, PropCategory.REGULAR)
    prop.label = "Access Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("ip-tiny-frag", "allow-ip-tiny-fragment-packets", 1)
    meta.props.add("accCtrl", prop)
    ...
    prop = PropMeta("str", "logClrIntvl", "logClrIntvl", 2164, PropCategory.REGULAR)
    prop.label = "Log Clear Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1000, 2800)]
    prop.defaultValue = 2800
    prop.defaultValueStr = "2800"
    meta.props.add("logClrIntvl", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14419, PropCategory.REGULAR)
