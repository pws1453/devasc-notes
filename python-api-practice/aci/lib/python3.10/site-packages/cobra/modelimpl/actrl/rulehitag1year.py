...
# ##################################################
class RuleHitAg1year(Mo):
    """
    A class that represents the most current aggregated statistics for rule hits in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAg1year", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAg1year"
    meta.rnFormat = "CDactrlRuleHitAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated rule hits stats in 1 year"
