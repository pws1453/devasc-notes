...
# ##################################################
class RsToVlanCkt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsToVlanCkt", "cobra.model.vlan.CktEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "actrlRsToVlanCkt"
    meta.rnFormat = "rstoVlanCkt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "vlanCkt Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26379, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 26382, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
