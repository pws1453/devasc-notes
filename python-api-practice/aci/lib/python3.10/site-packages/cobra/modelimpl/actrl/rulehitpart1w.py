...
# ##################################################
class RuleHitPart1w(Mo):
    """
    A class that represents the most current portion of the statistics for rule hits in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPart1w", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPart1w"
    meta.rnFormat = "CDactrlRuleHitPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the rule hits stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5836, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
