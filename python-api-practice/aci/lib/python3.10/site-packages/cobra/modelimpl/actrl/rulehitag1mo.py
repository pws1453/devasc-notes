...
# ##################################################
class RuleHitAg1mo(Mo):
    """
    A class that represents the most current aggregated statistics for rule hits in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAg1mo", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAg1mo"
    meta.rnFormat = "CDactrlRuleHitAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated rule hits stats in 1 month"
