...
# ##################################################
class RuleHitPart1year(Mo):
    """
    A class that represents the most current portion of the statistics for rule hits in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPart1year", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPart1year"
    meta.rnFormat = "CDactrlRuleHitPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the rule hits stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5837, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
