...
# ##################################################
class RuleHitPartHist1qtr(Mo):
    """
    A class that represents historical portion of the statistics for rule hits in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPartHist1qtr", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPartHist1qtr"
    meta.rnFormat = "HDactrlRuleHitPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the rule hits stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 5847, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5848, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
