...
class RsAuxRule(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.actrl.RsAuxRule", "cobra.model.actrl.AuxRule")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "actrlRsAuxRule"
    meta.rnFormat = "rsAuxRule"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Auxillary Rule Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12624, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2465
    prop.defaultValueStr = "actrlAuxRule"
    prop._addConstant("actrlAuxRule", None, 2465)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12623, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15045, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
