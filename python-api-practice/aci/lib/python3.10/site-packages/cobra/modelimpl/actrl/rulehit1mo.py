...
class RuleHit1mo(Mo):
    """
    A class that represents the most current statistics for rule hits in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHit1mo", "rule hits")
    ...
    meta.moClassName = "actrlRuleHit1mo"
    meta.rnFormat = "CDactrlRuleHit1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current rule hits stats in 1 month"
