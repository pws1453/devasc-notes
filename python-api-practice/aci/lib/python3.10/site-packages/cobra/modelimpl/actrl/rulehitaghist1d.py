...
# ##################################################
class RuleHitAgHist1d(Mo):
    """
    A class that represents historical aggregated statistics for rule hits in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAgHist1d", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAgHist1d"
    meta.rnFormat = "HDactrlRuleHitAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated rule hits stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 5816, PropCategory.REGULAR)
