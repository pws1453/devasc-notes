...
# ##################################################
class RuleHitHist15min(Mo):
    """
    A class that represents historical statistics for rule hits in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist15min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist15min"
    meta.rnFormat = "HDactrlRuleHit15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.actrl.RuleHitHist")

    meta.rnPrefixes = [
        ('HDactrlRuleHit15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 5823, PropCategory.REGULAR)
