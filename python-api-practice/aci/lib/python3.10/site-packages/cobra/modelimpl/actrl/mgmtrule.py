...
class MgmtRule(Mo):
    """
    The zoning rules for management endpoint groups.

    """

    meta = ClassMeta("cobra.model.actrl.MgmtRule")

    meta.moClassName = "actrlMgmtRule"
    meta.rnFormat = "mr-%(scopeId)s-s-%(sPcTag)s-d-%(dPcTag)s-f-%(fltId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Managment Rule"
    ...
    prop = PropMeta("str", "actrlCfgFailedBmp", "actrlCfgFailedBmp", 14963, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("actrl:MgmtRuleaction_failed_flag", None, 8)
    prop._addConstant("actrl:MgmtRulectrctName_failed_flag", None, 16)
    prop._addConstant("actrl:MgmtRuledPcTag_failed_flag", None, 32)
    prop._addConstant("actrl:MgmtRuledescr_failed_flag", None, 4)
    prop._addConstant("actrl:MgmtRuledirection_failed_flag", None, 64)
    prop._addConstant("actrl:MgmtRulefltId_failed_flag", None, 128)
    prop._addConstant("actrl:MgmtRuleid_failed_flag", None, 256)
    prop._addConstant("actrl:MgmtRuleintent_failed_flag", None, 512)
    prop._addConstant("actrl:MgmtRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("actrl:MgmtRulemarkDscp_failed_flag", None, 1024)
    prop._addConstant("actrl:MgmtRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:MgmtRulemonPolDn_failed_flag", None, 2097152)
    prop._addConstant("actrl:MgmtRulenameAlias_failed_flag", None, 2)
    prop._addConstant("actrl:MgmtRulename_failed_flag", None, 1)
    prop._addConstant("actrl:MgmtRuleprio_failed_flag", None, 8192)
    prop._addConstant("actrl:MgmtRuleqosGrp_failed_flag", None, 16384)
    prop._addConstant("actrl:MgmtRulesPcTag_failed_flag", None, 32768)
    prop._addConstant("actrl:MgmtRulescopeId_failed_flag", None, 65536)
    prop._addConstant("actrl:MgmtRuletype_failed_flag", None, 131072)
    meta.props.add("actrlCfgFailedBmp", prop)

    prop = PropMeta("str", "actrlCfgFailedTs", "actrlCfgFailedTs", 14965, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("actrlCfgFailedTs", prop)

    prop = PropMeta("str", "actrlCfgState", "actrlCfgState", 14964, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "dPcTag", "dPcTag", 5807, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fltId", "fltId", 5808, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14416, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sPcTag", "sPcTag", 5810, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scopeId", "scopeId", 5809, PropCategory.REGULAR)
    prop.label = "Scope ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
