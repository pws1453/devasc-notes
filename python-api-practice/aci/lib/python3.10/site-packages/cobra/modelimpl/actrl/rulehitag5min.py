...
# ##################################################
class RuleHitAg5min(Mo):
    """
    A class that represents the most current aggregated statistics for rule hits in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAg5min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAg5min"
    meta.rnFormat = "CDactrlRuleHitAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated rule hits stats in 5 minute"
