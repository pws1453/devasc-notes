...
class MgmtAuxFlt(Mo):
    ...
    meta = ClassMeta("cobra.model.actrl.MgmtAuxFlt")

    meta.moClassName = "actrlMgmtAuxFlt"
    meta.rnFormat = "mgmtauxflt-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Auxillary Managment Filter"
    ...
    prop = PropMeta("str", "id", "id", 2137, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mgmtruleIndex", "mgmtruleIndex", 2139, PropCategory.REGULAR)
    prop.label = "Rule Index"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 1024)]
    meta.props.add("mgmtruleIndex", prop)

    prop = PropMeta("str", "mgmtruleidArr", "mgmtruleidArr", 2138, PropCategory.REGULAR)
    prop.label = "Rule ID"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("mgmtruleidArr", prop)
