...
# ##################################################
class RuleHitAg1d(Mo):
    """
    A class that represents the most current aggregated statistics for rule hits in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAg1d", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAg1d"
    meta.rnFormat = "CDactrlRuleHitAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated rule hits stats in 1 day"
