...
class RuleHit1w(Mo):
    """
    A class that represents the most current statistics for rule hits in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHit1w", "rule hits")
    ...
    meta.moClassName = "actrlRuleHit1w"
    meta.rnFormat = "CDactrlRuleHit1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current rule hits stats in 1 week"
