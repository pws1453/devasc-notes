...
# ##################################################
class RsToRedirDestGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsToRedirDestGrp", "cobra.model.svcredir.DestGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "actrlRsToRedirDestGrp"
    meta.rnFormat = "rstoRedirDestGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Pbr Redirection Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20779, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6999
    prop.defaultValueStr = "svcredirDestGrp"
    prop._addConstant("svcredirDestGrp", None, 6999)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20778, PropCategory.REGULAR)
