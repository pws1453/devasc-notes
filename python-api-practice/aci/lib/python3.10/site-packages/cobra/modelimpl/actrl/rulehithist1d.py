...
# ##################################################
class RuleHitHist1d(Mo):
    """
    A class that represents historical statistics for rule hits in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist1d", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist1d"
    meta.rnFormat = "HDactrlRuleHit1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 5824, PropCategory.REGULAR)
