...
# ##################################################
class RuleHit(Mo):
    meta = StatsClassMeta("cobra.model.actrl.RuleHit", "rule hits")
    ...
    meta.moClassName = "actrlRuleHit"


    meta.moClassName = "actrlRuleHit"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current rule hits stats"
    ...
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit1year")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit1d")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit1w")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit1h")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit15min")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit1mo")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit1qtr")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHit5min")
    ...
    prop = PropMeta("str", "egrPktsAvg", "egrPktsAvg", 7440, PropCategory.IMPLICIT_AVG)
    prop.label = "egress hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsAvg", prop)

    prop = PropMeta("str", "egrPktsBase", "egrPktsBase", 7435, PropCategory.IMPLICIT_BASELINE)
    prop.label = "egress hit packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsBase", prop)

    prop = PropMeta("str", "egrPktsCum", "egrPktsCum", 7436, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsCum", prop)

    prop = PropMeta("str", "egrPktsLast", "egrPktsLast", 7434, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "egress hit packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsLast", prop)

    prop = PropMeta("str", "egrPktsMax", "egrPktsMax", 7439, PropCategory.IMPLICIT_MAX)
    prop.label = "egress hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsMax", prop)

    prop = PropMeta("str", "egrPktsMin", "egrPktsMin", 7438, PropCategory.IMPLICIT_MIN)
    prop.label = "egress hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsMin", prop)

    prop = PropMeta("str", "egrPktsPer", "egrPktsPer", 7437, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsPer", prop)

    prop = PropMeta("str", "egrPktsRate", "egrPktsRate", 7445, PropCategory.IMPLICIT_RATE)
    prop.label = "egress hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsRate", prop)

    prop = PropMeta("str", "egrPktsSpct", "egrPktsSpct", 7441, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsSpct", prop)

    prop = PropMeta("str", "egrPktsThr", "egrPktsThr", 7442, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "egrPktsTr", "egrPktsTr", 7444, PropCategory.IMPLICIT_TREND)
    prop.label = "egress hit packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsTr", prop)

    prop = PropMeta("str", "egrPktsTrBase", "egrPktsTrBase", 7443, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "egress hit packets trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsTrBase", prop)

    prop = PropMeta("str", "ingrPktsAvg", "ingrPktsAvg", 7501, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsAvg", prop)

    prop = PropMeta("str", "ingrPktsBase", "ingrPktsBase", 7496, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress hit packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsBase", prop)

    prop = PropMeta("str", "ingrPktsCum", "ingrPktsCum", 7497, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsCum", prop)

    prop = PropMeta("str", "ingrPktsLast", "ingrPktsLast", 7495, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress hit packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsLast", prop)

    prop = PropMeta("str", "ingrPktsMax", "ingrPktsMax", 7500, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsMax", prop)

    prop = PropMeta("str", "ingrPktsMin", "ingrPktsMin", 7499, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsMin", prop)

    prop = PropMeta("str", "ingrPktsPer", "ingrPktsPer", 7498, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsPer", prop)

    prop = PropMeta("str", "ingrPktsRate", "ingrPktsRate", 7506, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsRate", prop)

    prop = PropMeta("str", "ingrPktsSpct", "ingrPktsSpct", 7502, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsSpct", prop)

    prop = PropMeta("str", "ingrPktsThr", "ingrPktsThr", 7503, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "ingrPktsTr", "ingrPktsTr", 7505, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress hit packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsTr", prop)

    prop = PropMeta("str", "ingrPktsTrBase", "ingrPktsTrBase", 7504, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 24145, PropCategory.IMPLICIT_AVG)
    prop.label = "hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsBase", "pktsBase", 24140, PropCategory.IMPLICIT_BASELINE)
    prop.label = "hit packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsBase", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 24141, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsLast", "pktsLast", 24139, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "hit packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsLast", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 24144, PropCategory.IMPLICIT_MAX)
    prop.label = "hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 24143, PropCategory.IMPLICIT_MIN)
    prop.label = "hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 24142, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 24150, PropCategory.IMPLICIT_RATE)
    prop.label = "hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 24146, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 24147, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 24149, PropCategory.IMPLICIT_TREND)
    prop.label = "hit packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsTr", prop)

    prop = PropMeta("str", "pktsTrBase", "pktsTrBase", 24148, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "revPktsAvg", "revPktsAvg", 24200, PropCategory.IMPLICIT_AVG)
    prop.label = "reverse hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsAvg", prop)

    prop = PropMeta("str", "revPktsBase", "revPktsBase", 24195, PropCategory.IMPLICIT_BASELINE)
    prop.label = "reverse hit packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsBase", prop)

    prop = PropMeta("str", "revPktsCum", "revPktsCum", 24196, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "reverse hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsCum", prop)

    prop = PropMeta("str", "revPktsLast", "revPktsLast", 24194, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "reverse hit packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsLast", prop)

    prop = PropMeta("str", "revPktsMax", "revPktsMax", 24199, PropCategory.IMPLICIT_MAX)
    prop.label = "reverse hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMax", prop)

    prop = PropMeta("str", "revPktsMin", "revPktsMin", 24198, PropCategory.IMPLICIT_MIN)
    prop.label = "reverse hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMin", prop)

    prop = PropMeta("str", "revPktsPer", "revPktsPer", 24197, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "reverse hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsPer", prop)

    prop = PropMeta("str", "revPktsRate", "revPktsRate", 24205, PropCategory.IMPLICIT_RATE)
    prop.label = "reverse hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsRate", prop)

    prop = PropMeta("str", "revPktsSpct", "revPktsSpct", 24201, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "reverse hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsSpct", prop)

    prop = PropMeta("str", "revPktsThr", "revPktsThr", 24202, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revPktsTr", "revPktsTr", 24204, PropCategory.IMPLICIT_TREND)
    prop.label = "reverse hit packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsTr", prop)

    prop = PropMeta("str", "revPktsTrBase", "revPktsTrBase", 24203, PropCategory.IMPLICIT_TREND_BASE)
