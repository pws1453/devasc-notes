...
# ##################################################
class RsToStsVNode(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsToStsVNode", "cobra.model.sts.VNode")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "actrlRsToStsVNode"
    meta.rnFormat = "rstoStsVNode"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Service Redirection Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12631, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2301
    prop.defaultValueStr = "stsVNode"
    prop._addConstant("stsVNode", None, 2301)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12630, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15047, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
