...
class Entry(Mo):
    """
    The filter entry in the system, which is a unique set of classification filters identified by l4 parameters.

    """

    meta = ClassMeta("cobra.model.actrl.Entry")

    meta.moClassName = "actrlEntry"
    meta.rnFormat = "ent-%(name)s"
    ...
    meta.superClasses.add("cobra.model.vz.AFiltEntry")
    ...
    prop = PropMeta("str", "name", "name", 5805, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 2166, PropCategory.REGULAR)
    prop.label = "Entry Priority"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 8)]
    prop.defaultValue = 7
    prop.defaultValueStr = "def"
    prop._addConstant("def", "def", 7)
    prop._addConstant("dport", "dport", 3)
    prop._addConstant("flags", "flags", 1)
    prop._addConstant("frag", "frag", 6)
    prop._addConstant("implicit", "implicit", 8)
    prop._addConstant("proto", "proto", 5)
    prop._addConstant("sport", "sport", 4)
    prop._addConstant("sport_dport", "sport_dport", 2)
