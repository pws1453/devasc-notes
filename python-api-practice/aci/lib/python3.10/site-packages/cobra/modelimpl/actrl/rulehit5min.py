...
# ##################################################
class RuleHit5min(Mo):
    """
    A class that represents the most current statistics for rule hits in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHit5min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHit5min"
    meta.rnFormat = "CDactrlRuleHit5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current rule hits stats in 5 minute"
