...
# ##################################################
class RuleHitAg1qtr(Mo):
    """
    A class that represents the most current aggregated statistics for rule hits in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAg1qtr", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAg1qtr"
    meta.rnFormat = "CDactrlRuleHitAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated rule hits stats in 1 quarter"
