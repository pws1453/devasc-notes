...
# ##################################################
class RsToEpgConn(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsToEpgConn", "cobra.model.vz.ToEPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "actrlRsToEpgConn"
    meta.rnFormat = "rstoEpgConn-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ToEpg Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12627, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12626, PropCategory.REGULAR)
