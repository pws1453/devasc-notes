...
# ##################################################
class RuleHitHist(Mo):
    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist"


    meta.moClassName = "actrlRuleHitHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats"
    ...
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist1qtr")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist5min")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist1w")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist15min")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist1year")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist1d")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist1mo")
    meta.concreteSubClasses.add("cobra.model.actrl.RuleHitHist1h")
    ...
    prop = PropMeta("str", "egrPktsAvg", "egrPktsAvg", 7450, PropCategory.IMPLICIT_AVG)
    prop.label = "egress hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsAvg", prop)

    prop = PropMeta("str", "egrPktsCum", "egrPktsCum", 7446, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsCum", prop)

    prop = PropMeta("str", "egrPktsMax", "egrPktsMax", 7449, PropCategory.IMPLICIT_MAX)
    prop.label = "egress hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsMax", prop)

    prop = PropMeta("str", "egrPktsMin", "egrPktsMin", 7448, PropCategory.IMPLICIT_MIN)
    prop.label = "egress hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsMin", prop)

    prop = PropMeta("str", "egrPktsPer", "egrPktsPer", 7447, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsPer", prop)

    prop = PropMeta("str", "egrPktsRate", "egrPktsRate", 7454, PropCategory.IMPLICIT_RATE)
    prop.label = "egress hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsRate", prop)

    prop = PropMeta("str", "egrPktsSpct", "egrPktsSpct", 7451, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("egrPktsSpct", prop)

    prop = PropMeta("str", "egrPktsThr", "egrPktsThr", 7452, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "egrPktsTr", "egrPktsTr", 7453, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "ingrPktsAvg", "ingrPktsAvg", 7511, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsAvg", prop)

    prop = PropMeta("str", "ingrPktsCum", "ingrPktsCum", 7507, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsCum", prop)

    prop = PropMeta("str", "ingrPktsMax", "ingrPktsMax", 7510, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsMax", prop)

    prop = PropMeta("str", "ingrPktsMin", "ingrPktsMin", 7509, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsMin", prop)

    prop = PropMeta("str", "ingrPktsPer", "ingrPktsPer", 7508, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsPer", prop)

    prop = PropMeta("str", "ingrPktsRate", "ingrPktsRate", 7515, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsRate", prop)

    prop = PropMeta("str", "ingrPktsSpct", "ingrPktsSpct", 7512, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("ingrPktsSpct", prop)

    prop = PropMeta("str", "ingrPktsThr", "ingrPktsThr", 7513, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "ingrPktsTr", "ingrPktsTr", 7514, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "pktsAvg", "pktsAvg", 24155, PropCategory.IMPLICIT_AVG)
    prop.label = "hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsAvg", prop)

    prop = PropMeta("str", "pktsCum", "pktsCum", 24151, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsCum", prop)

    prop = PropMeta("str", "pktsMax", "pktsMax", 24154, PropCategory.IMPLICIT_MAX)
    prop.label = "hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMax", prop)

    prop = PropMeta("str", "pktsMin", "pktsMin", 24153, PropCategory.IMPLICIT_MIN)
    prop.label = "hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsMin", prop)

    prop = PropMeta("str", "pktsPer", "pktsPer", 24152, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsPer", prop)

    prop = PropMeta("str", "pktsRate", "pktsRate", 24159, PropCategory.IMPLICIT_RATE)
    prop.label = "hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsRate", prop)

    prop = PropMeta("str", "pktsSpct", "pktsSpct", 24156, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("pktsSpct", prop)

    prop = PropMeta("str", "pktsThr", "pktsThr", 24157, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "pktsTr", "pktsTr", 24158, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "revPktsAvg", "revPktsAvg", 24210, PropCategory.IMPLICIT_AVG)
    prop.label = "reverse hit packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsAvg", prop)

    prop = PropMeta("str", "revPktsCum", "revPktsCum", 24206, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "reverse hit packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsCum", prop)

    prop = PropMeta("str", "revPktsMax", "revPktsMax", 24209, PropCategory.IMPLICIT_MAX)
    prop.label = "reverse hit packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMax", prop)

    prop = PropMeta("str", "revPktsMin", "revPktsMin", 24208, PropCategory.IMPLICIT_MIN)
    prop.label = "reverse hit packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsMin", prop)

    prop = PropMeta("str", "revPktsPer", "revPktsPer", 24207, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "reverse hit packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsPer", prop)

    prop = PropMeta("str", "revPktsRate", "revPktsRate", 24214, PropCategory.IMPLICIT_RATE)
    prop.label = "reverse hit packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsRate", prop)

    prop = PropMeta("str", "revPktsSpct", "revPktsSpct", 24211, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "reverse hit packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("revPktsSpct", prop)

    prop = PropMeta("str", "revPktsThr", "revPktsThr", 24212, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "revPktsTr", "revPktsTr", 24213, PropCategory.IMPLICIT_TREND)
