...
# ##################################################
class RuleHitPartHist15min(Mo):
    """
    A class that represents historical portion of the statistics for rule hits in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPartHist15min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPartHist15min"
    meta.rnFormat = "HDactrlRuleHitPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the rule hits stats in 15 minute"
    ...
    prop = PropMeta("str", "index", "index", 5839, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5840, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
