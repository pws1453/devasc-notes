...
# ##################################################
class RsToCopyDestGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsToCopyDestGrp", "cobra.model.svccopy.DestGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "actrlRsToCopyDestGrp"
    meta.rnFormat = "rstoCopyDestGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Copy Service Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22014, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7459
    prop.defaultValueStr = "svccopyDestGrp"
    prop._addConstant("svccopyDestGrp", None, 7459)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22013, PropCategory.REGULAR)
