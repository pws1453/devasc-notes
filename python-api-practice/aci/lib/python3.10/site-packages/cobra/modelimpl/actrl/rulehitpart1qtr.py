...
# ##################################################
class RuleHitPart1qtr(Mo):
    """
    A class that represents the most current portion of the statistics for rule hits in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPart1qtr", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPart1qtr"
    meta.rnFormat = "CDactrlRuleHitPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the rule hits stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5835, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
