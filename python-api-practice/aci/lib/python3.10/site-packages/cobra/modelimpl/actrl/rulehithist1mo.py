...
# ##################################################
class RuleHitHist1mo(Mo):
    """
    A class that represents historical statistics for rule hits in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitHist1mo", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitHist1mo"
    meta.rnFormat = "HDactrlRuleHit1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical rule hits stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 5826, PropCategory.REGULAR)
