...
# ##################################################
class RuleHitPart15min(Mo):
    """
    A class that represents the most current portion of the statistics for rule hits in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitPart15min", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitPart15min"
    meta.rnFormat = "CDactrlRuleHitPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the rule hits stats in 15 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 5831, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
