...
class RuleHit1h(Mo):
    """
    A class that represents the most current statistics for rule hits in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHit1h", "rule hits")
    ...
    meta.moClassName = "actrlRuleHit1h"
    meta.rnFormat = "CDactrlRuleHit1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current rule hits stats in 1 hour"
