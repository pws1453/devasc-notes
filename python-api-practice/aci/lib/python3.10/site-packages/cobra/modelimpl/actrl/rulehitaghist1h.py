...
# ##################################################
class RuleHitAgHist1h(Mo):
    """
    A class that represents historical aggregated statistics for rule hits in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAgHist1h", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAgHist1h"
    meta.rnFormat = "HDactrlRuleHitAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated rule hits stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 5817, PropCategory.REGULAR)
