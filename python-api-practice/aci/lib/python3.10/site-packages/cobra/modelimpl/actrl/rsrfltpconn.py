...
# ##################################################
class RsRfltpConn(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsRfltpConn", "cobra.model.vz.RFltP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "actrlRsRfltpConn"
    meta.rnFormat = "rsrfltpConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Resloved Filter Attachement"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15053, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12637, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12636, PropCategory.REGULAR)
