...
class RsTenConn(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.actrl.RsTenConn", "cobra.model.l3.Ctx")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "actrlRsTenConn"
    meta.rnFormat = "rstenConn-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Tenant Attachement"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15050, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12634, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12633, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15049, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
