...
class Entity(Mo):
    """
    Contains system manager control plane entity information.

    """

    meta = ClassMeta("cobra.model.sysmgr.Entity")

    meta.moClassName = "sysmgrEntity"
    meta.rnFormat = "sysmgr"
    ...
    meta.childClasses.add("cobra.model.sysmgrp.Cores")
    meta.childClasses.add("cobra.model.sysmgr.SysSt")

    meta.childNamesAndRnPrefix.append(("cobra.model.sysmgrp.Cores", "core-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.sysmgr.SysSt", "sys"))
