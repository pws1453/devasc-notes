...
class RsClient(Mo):
    """
    Internal object: relation from the dhcpLease to the dhcpClient.

    """

    meta = SourceRelationMeta("cobra.model.dhcp.RsClient", "cobra.model.dhcp.Client")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "dhcpRsClient"
    meta.rnFormat = "rsclient"
    ...
    meta.parentClasses.add("cobra.model.dhcp.Lease")
    ...
    prop = PropMeta("str", "tCl", "tCl", 11972, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11971, PropCategory.REGULAR)
