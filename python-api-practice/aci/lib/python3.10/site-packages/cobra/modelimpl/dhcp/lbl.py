...
class Lbl(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.Lbl")

    meta.moClassName = "dhcpLbl"
    meta.rnFormat = "dhcplbl-%(name)s"
    ...
    meta.childClasses.add("cobra.model.dhcp.RsDhcpOptionPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.RsDhcpOptionPol", "rsdhcpOptionPol"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37497, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39636, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14120, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6137, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
