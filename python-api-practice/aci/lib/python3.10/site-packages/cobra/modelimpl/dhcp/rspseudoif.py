...
class RsPseudoIf(Mo):
    """
    A source relation to the abstract layer 3 interface. If the mode is pseudo interface, the list of all interfaces that the dhcp requests is flooded.

    """

    meta = SourceRelationMeta("cobra.model.dhcp.RsPseudoIf", "cobra.model.l3.If")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "dhcpRsPseudoIf"
    meta.rnFormat = "rspseudoIf-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Pseudo Interface"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15060, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15059, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
