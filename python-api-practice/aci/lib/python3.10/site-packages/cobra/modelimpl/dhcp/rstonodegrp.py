...
class RsToNodeGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dhcp.RsToNodeGrp", "cobra.model.dhcp.NodeGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dhcpRsToNodeGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38254, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40393, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20914, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20892, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1448
    prop.defaultValueStr = "dhcpNodeGrp"
    prop._addConstant("dhcpNodeGrp", None, 1448)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 20891, PropCategory.REGULAR)
