...
# ##################################################
class ExtPoolTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.dhcp.ExtPoolTask")

    meta.moClassName = "dhcpExtPoolTask"
    meta.rnFormat = "dhcpExtPoolTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 35527, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updatePool", "updatepool", 2933)
