...
class RsRelayP(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.dhcp.RsRelayP", "cobra.model.dhcp.RelayP")
    meta.targetNameProps["name"] = "tnDhcpRelayPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dhcpRsRelayP"
    meta.rnFormat = "rsrelayP-%(tnDhcpRelayPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DHCP Relay Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37504, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39643, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14127, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11968, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1430
    prop.defaultValueStr = "dhcpRelayP"
    ...
    prop = PropMeta("str", "tnDhcpRelayPName", "tnDhcpRelayPName", 11967, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnDhcpRelayPName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnDhcpRelayPName"))
    ...
    def __init__(self, parentMoOrDn, tnDhcpRelayPName, markDirty=True, **creationProps):
        namingVals = [tnDhcpRelayPName]
