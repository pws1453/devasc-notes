...
class CEp(Mo):
    """
    The client infrastructure endpoint.

    """

    meta = ClassMeta("cobra.model.dhcp.CEp")

    meta.moClassName = "dhcpCEp"
    meta.rnFormat = "dcep-%(name)s"
    ...
    meta.superClasses.add("cobra.model.infra.ACEp")
    ...
    prop = PropMeta("str", "name", "name", 6131, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
