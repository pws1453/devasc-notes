...
# ##################################################
class RtBDToRelayP(Mo):
    """
    A target relation to the DHCP relay profile.

    """

    meta = TargetRelationMeta("cobra.model.dhcp.RtBDToRelayP", "cobra.model.fv.ABDPol")

    meta.moClassName = "dhcpRtBDToRelayP"
    meta.rnFormat = "rtfvBDToRelayP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Bridge Domain"
    meta.writeAccessMask = 0x40001
    meta.readAccessMask = 0x4100000041001
    ...
    prop = PropMeta("str", "tCl", "tCl", 12176, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12175, PropCategory.REGULAR)
