...
# ##################################################
class RsAllowedSubnets(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.dhcp.RsAllowedSubnets", "cobra.model.dhcp.Subnet")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dhcpRsAllowedSubnets"
    meta.rnFormat = "rsallowedSubnets-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21435, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1458
    prop.defaultValueStr = "dhcpSubnet"
    prop._addConstant("dhcpSubnet", None, 1458)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21434, PropCategory.REGULAR)
