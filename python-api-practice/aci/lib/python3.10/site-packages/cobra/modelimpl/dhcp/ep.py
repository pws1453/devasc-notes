...
class Ep(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.Ep")

    meta.moClassName = "dhcpEp"
    meta.rnFormat = "dhcpopt-%(name)s"
    ...
    prop = PropMeta("str", "ack", "ack", 1132, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "addr", "addr", 1129, PropCategory.REGULAR)
    prop.label = "IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 37502, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39641, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mac", "mac", 1128, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 1127, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 1130, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    prop = PropMeta("str", "port", "port", 1131, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
