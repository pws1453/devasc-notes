...
class OptionDef(Mo):
    """
    The option definition. Each DHCP option is defined by a unique name, ID, and option data.

    """

    meta = ClassMeta("cobra.model.dhcp.OptionDef")

    meta.moClassName = "dhcpOptionDef"
    ...
    meta.childClasses.add("cobra.model.dhcp.DiscNode")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.DiscNode", "bd-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14125, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6141, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
