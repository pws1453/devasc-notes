...
class PEp(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.PEp")

    meta.moClassName = "dhcpPEp"
    meta.rnFormat = "dpep-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DHCP Relay EP"
    ...
    meta.superClasses.add("cobra.model.fv.PEp")
    ...
    meta.superClasses.add("cobra.model.infra.APEp")
    ...
    prop = PropMeta("str", "name", "name", 6143, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
