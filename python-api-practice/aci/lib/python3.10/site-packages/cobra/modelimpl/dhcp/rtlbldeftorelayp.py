...
# ##################################################
class RtLblDefToRelayP(Mo):
    """
    Internal object: Relation from dhcpLblDef to dhcpRelayP.

    """

    meta = TargetRelationMeta("cobra.model.dhcp.RtLblDefToRelayP", "cobra.model.dhcp.LblDef")

    meta.moClassName = "dhcpRtLblDefToRelayP"
    meta.rnFormat = "rtlblDefToRelayP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11966, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1437
    prop.defaultValueStr = "dhcpLblDef"
    prop._addConstant("dhcpLblDef", None, 1437)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11965, PropCategory.REGULAR)
