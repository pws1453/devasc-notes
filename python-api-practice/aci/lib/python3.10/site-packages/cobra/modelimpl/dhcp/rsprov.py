...
class RsProv(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dhcp.RsProv", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dhcpRsProv"
    meta.rnFormat = "rsprov-[%(tDn)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 11956, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 37496, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39635, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14118, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11955, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11954, PropCategory.REGULAR)
