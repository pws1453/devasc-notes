...
class ClientTask(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.ClientTask")

    meta.moClassName = "dhcpClientTask"
    meta.rnFormat = "dhcpClientTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16207, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("setFabricRecoveryMode", "setfabricrecoverymode", 2189)
    prop._addConstant("spinesQuery", "spinesquery", 2188)
    prop._addConstant("updateExtNodeDef", "updateextnodedef", 2878)
    prop._addConstant("updateFnv", "updatefnv", 1395)
