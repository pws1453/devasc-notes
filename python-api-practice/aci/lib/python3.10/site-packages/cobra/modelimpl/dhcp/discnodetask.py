...
# ##################################################
class DiscNodeTask(Mo):
    """
    The DHCP disc node task.

    """

    meta = ClassMeta("cobra.model.dhcp.DiscNodeTask")

    meta.moClassName = "dhcpDiscNodeTask"
    meta.rnFormat = "dhcpDiscNodeTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5660, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Report", "report", 389)
