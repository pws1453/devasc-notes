...
# ##################################################
class RsLblDefToRelayP(Mo):
    """
    Internal object: Relation from dhcpLblDef to dhcpRelayP.

    """

    meta = NamedSourceRelationMeta("cobra.model.dhcp.RsLblDefToRelayP", "cobra.model.dhcp.RelayP")
    meta.targetNameProps["name"] = "tnDhcpRelayPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dhcpRsLblDefToRelayP"
    meta.rnFormat = "rsLblDefToRelayP"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14123, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDhcpRelayPName", "tnDhcpRelayPName", 11963, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
