...
class PoolTask(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.PoolTask")

    meta.moClassName = "dhcpPoolTask"
    meta.rnFormat = "dhcpPoolTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 22486, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updatePool", "updatepool", 1952)
