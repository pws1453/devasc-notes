...
# ##################################################
class InfraProvPDef(Mo):
    """
    The infrastructure provider definition.

    """

    meta = ClassMeta("cobra.model.dhcp.InfraProvPDef")

    meta.moClassName = "dhcpInfraProvPDef"
    meta.rnFormat = "infraprovpdef"
