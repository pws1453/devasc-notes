...
# ##################################################
class RsAllowedPools(Mo):
    """
    A source relation to the DHCP address pool.

    """

    meta = SourceRelationMeta("cobra.model.dhcp.RsAllowedPools", "cobra.model.dhcp.Pool")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "dhcpRsAllowedPools"
    meta.rnFormat = "rsallowedPools-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.dhcp.ClientClass")
    ...
    prop = PropMeta("str", "tCl", "tCl", 11978, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1459
    prop.defaultValueStr = "dhcpPool"
    prop._addConstant("dhcpPool", None, 1459)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11977, PropCategory.REGULAR)
