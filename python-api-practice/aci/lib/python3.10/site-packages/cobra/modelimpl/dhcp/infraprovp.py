...
class InfraProvP(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.InfraProvP")

    meta.moClassName = "dhcpInfraProvP"
    meta.rnFormat = "infraprovp"
    meta.category = MoCategory.REGULAR
    meta.label = "Access DHCP Relay Provider Profile"
    meta.writeAccessMask = 0x8300000000001
    meta.readAccessMask = 0x8300000000011
    ...
    meta.superClasses.add("cobra.model.dhcp.AInfraProvP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37499, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39638, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mode", "mode", 1123, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
