...
class ClientNode(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.ClientNode")

    meta.moClassName = "dhcpClientNode"
    meta.rnFormat = "cnode-%(nodeId)s"
    ...
    prop = PropMeta("str", "fabricId", "fabricId", 25192, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "isConfigured", "isConfigured", 27799, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("isConfigured", prop)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 25190, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nodeRole", "nodeRole", 25194, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "podId", "podId", 25193, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 254)]
    ...
    prop = PropMeta("str", "serial", "serial", 25191, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
