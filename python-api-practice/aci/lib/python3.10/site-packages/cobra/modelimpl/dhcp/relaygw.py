...
class RelayGw(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.RelayGw")

    meta.moClassName = "dhcpRelayGw"
    meta.rnFormat = "gw-[%(address)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Relay Gateway"
    ...
    prop = PropMeta("str", "address", "address", 15860, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
