...
# ##################################################
class PoolReconcileShardLocTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.dhcp.PoolReconcileShardLocTask")

    meta.moClassName = "dhcpPoolReconcileShardLocTask"
    meta.rnFormat = "dhcpPoolReconcileShardLocTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('dhcpPoolReconcileShardLocTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 62638, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReleaseAllocatedPool", "releaseallocatedpool", 4095)
    prop._addConstant("RequestAllocatedPool", "requestallocatedpool", 4086)
