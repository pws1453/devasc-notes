...
class ProvLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.ProvLbl")

    meta.moClassName = "dhcpProvLbl"
    meta.rnFormat = "dhcpprov-%(name)s"
    ...
    prop = PropMeta("str", "addr", "addr", 1167, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 6146, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
