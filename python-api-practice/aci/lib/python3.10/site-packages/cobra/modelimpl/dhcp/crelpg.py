...
class CRelPg(Mo):
    """
    A group of DHCP relay function providers: A set of DHCP Server to which client DHCP requests are relayed.

    """

    meta = ClassMeta("cobra.model.dhcp.CRelPg")

    meta.moClassName = "dhcpCRelPg"
    meta.rnFormat = "cdhcp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DHCP Relay EPg"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14130, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6132, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
