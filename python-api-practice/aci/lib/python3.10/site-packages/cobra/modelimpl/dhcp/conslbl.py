...
class ConsLbl(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.ConsLbl")

    meta.moClassName = "dhcpConsLbl"
    meta.rnFormat = "dhcpcons-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DHCP Consumer"
    ...
    prop = PropMeta("str", "name", "name", 6136, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
