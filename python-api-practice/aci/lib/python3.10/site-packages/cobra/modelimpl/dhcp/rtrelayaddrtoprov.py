...
# ##################################################
class RtRelayAddrToProv(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.dhcp.RtRelayAddrToProv", "cobra.model.dhcp.RelayAddr")

    meta.moClassName = "dhcpRtRelayAddrToProv"
    meta.rnFormat = "rtrelayAddrToProv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17955, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2677
    prop.defaultValueStr = "dhcpRelayAddr"
    prop._addConstant("dhcpRelayAddr", None, 2677)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17954, PropCategory.REGULAR)
