...
class OptionPol(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.OptionPol")

    meta.moClassName = "dhcpOptionPol"
    meta.rnFormat = "dhcpoptpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DHCP Option Policy"
    meta.writeAccessMask = 0x8000000000001
    meta.readAccessMask = 0x8000000040001
    ...
    meta.childClasses.add("cobra.model.dhcp.RtDhcpOptionPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.dhcp.Option")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.RtDhcpOptionPol", "rtdhcpOptionPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.Option", "opt-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37500, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39639, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 6142, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
