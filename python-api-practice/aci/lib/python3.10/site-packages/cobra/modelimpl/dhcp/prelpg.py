...
class PRelPg(Mo):
    """
    A group of DHCP Relay Function Providers: A set of DHCP Servers to which client DHCP Requests are relayed.

    """

    meta = ClassMeta("cobra.model.dhcp.PRelPg")

    meta.moClassName = "dhcpPRelPg"
    meta.rnFormat = "pdhcp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DHCP Relay Function Provider"
    ...
    meta.childClasses.add("cobra.model.dhcp.ProvLbl")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.ProvLbl", "dhcpprov-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14129, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6144, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
