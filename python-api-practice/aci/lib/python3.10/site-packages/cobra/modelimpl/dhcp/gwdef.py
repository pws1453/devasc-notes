...
class GwDef(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.GwDef")

    meta.moClassName = "dhcpGwDef"
    meta.rnFormat = "gwdef-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Gateway information"
    ...
    prop = PropMeta("str", "addr", "addr", 15859, PropCategory.REGULAR)
