...
# ##################################################
class RsRelayAddrToProv(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.dhcp.RsRelayAddrToProv", "cobra.model.dhcp.ProvDhcp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dhcpRsRelayAddrToProv"
    meta.rnFormat = "rsrelayAddrToProv-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to DHCP provider definition"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17953, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1464
    prop.defaultValueStr = "dhcpProvDhcp"
    prop._addConstant("dhcpProvDhcp", None, 1464)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17952, PropCategory.REGULAR)
