...
# ##################################################
class RsDhcpOptionPol(Mo):
    """
    The DHCP option policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.dhcp.RsDhcpOptionPol", "cobra.model.dhcp.OptionPol")
    meta.targetNameProps["name"] = "tnDhcpOptionPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dhcpRsDhcpOptionPol"
    meta.rnFormat = "rsdhcpOptionPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "DHCP Option Policy"
    meta.writeAccessMask = 0x80000040001
    meta.readAccessMask = 0x80000040001
    ...
    meta.rnPrefixes = [
        ('rsdhcpOptionPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37498, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39637, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14121, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11960, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1443
    prop.defaultValueStr = "dhcpOptionPol"
    ...
    prop = PropMeta("str", "tnDhcpOptionPolName", "tnDhcpOptionPolName", 11959, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnDhcpOptionPolName", prop)
