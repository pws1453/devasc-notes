...
# ##################################################
class ARelayP(Mo):
    meta = ClassMeta("cobra.model.dhcp.ARelayP")

    meta.isAbstract = True
    meta.moClassName = "dhcpARelayP"


    meta.moClassName = "dhcpARelayP"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "DHCP Relay Profile"
    ...
    prop = PropMeta("str", "mode", "mode", 1121, PropCategory.REGULAR)
    prop.label = "Relay mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "visible"
    ...
    prop = PropMeta("str", "owner", "owner", 1120, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
