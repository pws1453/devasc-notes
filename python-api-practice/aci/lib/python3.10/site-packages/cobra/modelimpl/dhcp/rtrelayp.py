...
class RtRelayP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.dhcp.RtRelayP", "cobra.model.dhcp.NodeGrp")

    meta.moClassName = "dhcpRtRelayP"
    meta.rnFormat = "rtrelayP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "DHCP Node Group"
    meta.writeAccessMask = 0x40001
    meta.readAccessMask = 0x4100000040001
    ...
    prop = PropMeta("str", "tCl", "tCl", 11970, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11969, PropCategory.REGULAR)
