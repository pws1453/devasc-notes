...
class RsProvTask(Mo):
    """
    Internal object used to trigger a task.

    """

    meta = ClassMeta("cobra.model.dhcp.RsProvTask")

    meta.moClassName = "dhcpRsProvTask"
    meta.rnFormat = "dhcpRsProvTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5678, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdDhcpProvAddress", "upddhcpprovaddress", 447)
