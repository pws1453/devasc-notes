...
class RsLeaseDb(Mo):
    """
    A source relation to the DHCP Lease Database.

    """

    meta = SourceRelationMeta("cobra.model.dhcp.RsLeaseDb", "cobra.model.dhcp.LeaseDb")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "dhcpRsLeaseDb"
    meta.rnFormat = "rsleaseDb"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11975, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1451
    prop.defaultValueStr = "dhcpLeaseDb"
    prop._addConstant("dhcpLeaseDb", None, 1451)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11974, PropCategory.REGULAR)
