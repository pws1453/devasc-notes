...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.dhcp.Entity")

    meta.moClassName = "dhcpEntity"
    meta.rnFormat = "dhcp"
    meta.category = MoCategory.REGULAR
    meta.label = "DHCP Entity"
    ...
    meta.childClasses.add("cobra.model.dhcp.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14475, PropCategory.REGULAR)
