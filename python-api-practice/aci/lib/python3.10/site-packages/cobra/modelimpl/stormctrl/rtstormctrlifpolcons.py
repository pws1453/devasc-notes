...
# ##################################################
class RtStormctrlIfPolCons(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.stormctrl.RtStormctrlIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "stormctrlRtStormctrlIfPolCons"
    meta.rnFormat = "rtl1StormctrlIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16542, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 16557, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
