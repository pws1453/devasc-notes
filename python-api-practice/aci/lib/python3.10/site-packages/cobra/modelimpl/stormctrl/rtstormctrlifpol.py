...
# ##################################################
class RtStormctrlIfPol(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.stormctrl.RtStormctrlIfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "stormctrlRtStormctrlIfPol"
    meta.rnFormat = "rtinfraStormctrlIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16549, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16548, PropCategory.REGULAR)
