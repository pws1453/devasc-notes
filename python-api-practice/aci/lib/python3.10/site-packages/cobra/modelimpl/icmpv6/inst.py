...
class Inst(Mo):
    """
    Per Internet Control Message Protocol (ICMPv6) instance information. There is only one instance currently running in the system.

    """

    meta = ClassMeta("cobra.model.icmpv6.Inst")

    meta.moClassName = "icmpv6Inst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "ICMPv6 Instance"
    ...
    meta.childClasses.add("cobra.model.icmpv6.IfStats")
    meta.childClasses.add("cobra.model.icmpv6.If")

    meta.childNamesAndRnPrefix.append(("cobra.model.icmpv6.IfStats", "ifstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.icmpv6.If", "if-"))

    meta.parentClasses.add("cobra.model.icmpv6.Entity")

    meta.superClasses.add("cobra.model.icmp.Inst")
    ...
    prop = PropMeta("str", "operSt", "operSt", 17316, PropCategory.REGULAR)
