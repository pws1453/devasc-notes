...
class Entity(Mo):
    """
    Per Internet Control Message Protocol (ICMPv6) control plane entity information.

    """

    meta = ClassMeta("cobra.model.icmpv6.Entity")

    meta.moClassName = "icmpv6Entity"
    meta.rnFormat = "icmpv6"
    meta.category = MoCategory.REGULAR
    meta.label = "ICMPv6 Entity"
    ...
    meta.childClasses.add("cobra.model.icmpv6.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.icmpv6.Inst", "inst"))
