...
class If(Mo):
    """
    Per Internet Control Message Protocol (ICMPv6) information that is operated at the interface level.

    """

    meta = ClassMeta("cobra.model.icmpv6.If")

    meta.moClassName = "icmpv6If"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ICMPV6 Interface"
    ...
    meta.parentClasses.add("cobra.model.icmpv6.Inst")
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 17285, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("unreachables", "unreachables", 1)
    ...
    prop = PropMeta("str", "id", "id", 6600, PropCategory.REGULAR)
