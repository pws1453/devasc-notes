...
class RemoteSite(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudtemplate.RemoteSite")

    meta.moClassName = "cloudtemplateRemoteSite"
    meta.rnFormat = "rsite-%(remoteSiteId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Models one remote site."
    ...
    meta.childClasses.add("cobra.model.cloudtemplate.RemoteSitePeer")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.RemoteSitePeer", "localhostifp-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 52220, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52221, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "preSharedKey", "preSharedKey", 52212, PropCategory.REGULAR)
    prop.label = "Pre Shared Key for all tunnels to this remoteSiteId"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("preSharedKey", prop)

    prop = PropMeta("str", "remoteSiteId", "remoteSiteId", 52211, PropCategory.REGULAR)
    prop.label = "Remote Site Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.props.add("remoteSiteId", prop)

    prop = PropMeta("str", "remoteSiteSubnetPool", "remoteSiteSubnetPool", 52213, PropCategory.REGULAR)
    prop.label = "The RemoteSiteSubnetPool to be used for this remoteSiteId"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("remoteSiteSubnetPool", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "remoteSiteId"))
    ...
    def __init__(self, parentMoOrDn, remoteSiteId, markDirty=True, **creationProps):
        namingVals = [remoteSiteId]
