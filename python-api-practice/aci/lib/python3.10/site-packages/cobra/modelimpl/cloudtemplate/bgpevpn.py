...
class BgpEvpn(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudtemplate.BgpEvpn")

    meta.moClassName = "cloudtemplateBgpEvpn"
    meta.rnFormat = "bgpevpn-[%(peeraddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Template for BGP EVPN"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51738, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "asn", "asn", 50517, PropCategory.REGULAR)
    prop.label = "BGP ASN Number"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51739, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "password", "password", 51872, PropCategory.REGULAR)
    prop.label = "Password"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "peeraddr", "peeraddr", 50516, PropCategory.REGULAR)
    prop.label = "Peer BGP Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "siteId", "siteId", 50518, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, peeraddr, markDirty=True, **creationProps):
        namingVals = [peeraddr]
