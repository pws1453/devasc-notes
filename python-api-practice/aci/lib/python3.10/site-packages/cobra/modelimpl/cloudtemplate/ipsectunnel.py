...
# ##################################################
class IpSecTunnel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudtemplate.IpSecTunnel")

    meta.moClassName = "cloudtemplateIpSecTunnel"
    meta.rnFormat = "ipsec-[%(peeraddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Template for IpSec tunnel"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51735, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "peeraddr", "peeraddr", 50513, PropCategory.REGULAR)
    prop.label = "IpSec Tunnel Peer Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
