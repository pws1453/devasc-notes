...
# ##################################################
class InfraNetwork(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudtemplate.InfraNetwork")

    meta.moClassName = "cloudtemplateInfraNetwork"
    meta.rnFormat = "infranetwork-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Infra Network Template"
    meta.writeAccessMask = 0x1002001
    meta.readAccessMask = 0xc01002001
    ...
    meta.childClasses.add("cobra.model.cloudtemplate.ExtNetwork")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.cloudtemplate.IntNetwork")
    meta.childClasses.add("cobra.model.cloudtemplate.Profile")
    meta.childClasses.add("cobra.model.cloudtemplate.ExtSubnetPool")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.ExtSubnetPool", "extsubnetpool-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.ExtNetwork", "extnetwork-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.IntNetwork", "intnetwork-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.Profile", "profile-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51724, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51725, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50721, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "numRemoteSiteSubnetPool", "numRemoteSiteSubnetPool", 52210, PropCategory.REGULAR)
    prop.label = "Number of RemoteSiteSubnetPool to be created"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "2"
    meta.props.add("numRemoteSiteSubnetPool", prop)

    prop = PropMeta("str", "numRoutersPerRegion", "numRoutersPerRegion", 50511, PropCategory.REGULAR)
    prop.label = "Number of routers in each provider region"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 2
    prop.defaultValueStr = "2"
    meta.props.add("numRoutersPerRegion", prop)
    ...
    prop = PropMeta("str", "vrfName", "vrfName", 50510, PropCategory.REGULAR)
    prop.label = "Name of the infra network"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    prop.defaultValue = "overlay-1"
    prop.defaultValueStr = "overlay-1"
