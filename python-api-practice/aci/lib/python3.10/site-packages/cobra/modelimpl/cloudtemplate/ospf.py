...
class Ospf(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudtemplate.Ospf")

    meta.moClassName = "cloudtemplateOspf"
    meta.rnFormat = "ospf-[%(area)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Template for OSPF"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51736, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "area", "area", 50515, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51737, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    def __init__(self, parentMoOrDn, area, markDirty=True, **creationProps):
        namingVals = [area]
