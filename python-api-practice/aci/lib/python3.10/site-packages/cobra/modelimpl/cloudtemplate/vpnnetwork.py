...
class VpnNetwork(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudtemplate.VpnNetwork")

    meta.moClassName = "cloudtemplateVpnNetwork"
    meta.rnFormat = "vpnnetwork-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Template for VPN Network"
    ...
    meta.childClasses.add("cobra.model.cloudtemplate.Ospf")
    meta.childClasses.add("cobra.model.cloudtemplate.IpSecTunnel")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.cloudtemplate.RemoteSite")
    meta.childClasses.add("cobra.model.cloudtemplate.RemoteSiteSubnetPool")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.RemoteSiteSubnetPool", "remotesitesubnetpool-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.IpSecTunnel", "ipsec-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.RemoteSite", "rsite-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.Ospf", "ospf-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51732, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51733, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50724, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
