...
# ##################################################
class ExtSubnetPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudtemplate.ExtSubnetPool")

    meta.moClassName = "cloudtemplateExtSubnetPool"
    meta.rnFormat = "extsubnetpool-[%(subnetpool)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "External Subnet Pool for Infra Network"
    ...
    meta.superClasses.add("cobra.model.cloudtemplate.ASubnetPool")

    meta.rnPrefixes = [
        ('extsubnetpool-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51726, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51727, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "subnetpool", "subnetpool", 50720, PropCategory.REGULAR)
    prop.label = "Subnet Pool"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("subnetpool", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "subnetpool"))
    getattr(meta.props, "subnetpool").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, subnetpool, markDirty=True, **creationProps):
        namingVals = [subnetpool]
