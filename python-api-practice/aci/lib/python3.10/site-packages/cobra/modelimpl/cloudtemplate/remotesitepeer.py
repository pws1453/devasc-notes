...
# ##################################################
class RemoteSitePeer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudtemplate.RemoteSitePeer")

    meta.moClassName = "cloudtemplateRemoteSitePeer"
    meta.rnFormat = "localhostifp-[%(localHostIfPDn)s]-peeraddr-[%(peeraddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Models one tunnel to a remote site."
    ...
    prop = PropMeta("str", "annotation", "annotation", 52222, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52223, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "localHostIfPDn", "localHostIfPDn", 52214, PropCategory.REGULAR)
    prop.label = "The DN of the cloudHostIfP that contains the source cloudL3TunnelIfP and cloudIpSecTunnelIfP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("localHostIfPDn", prop)

    prop = PropMeta("str", "localInnerIp", "localInnerIp", 52240, PropCategory.REGULAR)
    prop.label = "The tunnel inner address allocated from parent's remoteSiteSubnetPool"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("localInnerIp", prop)

    prop = PropMeta("str", "localOuterIp", "localOuterIp", 52241, PropCategory.REGULAR)
    prop.label = "The tunnel outer address, i.e. the elastic IP allocated to the cloudHostIfP captured in localHostIfPDn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("localOuterIp", prop)
    ...
    prop = PropMeta("str", "peeraddr", "peeraddr", 52215, PropCategory.REGULAR)
    prop.label = "IP address of the public elastic IP of an interface in the remote site"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("peeraddr", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "localHostIfPDn"))
    getattr(meta.props, "localHostIfPDn").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "peeraddr"))
    getattr(meta.props, "peeraddr").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, localHostIfPDn, peeraddr, markDirty=True, **creationProps):
        namingVals = [localHostIfPDn, peeraddr]
