...
# ##################################################
class RemoteSiteSubnetPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloudtemplate.RemoteSiteSubnetPool")

    meta.moClassName = "cloudtemplateRemoteSiteSubnetPool"
    meta.rnFormat = "remotesitesubnetpool-[%(subnetpool)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Part of ExtSubnetPool, used for site to site tunnels"
    ...
    prop = PropMeta("str", "subnetpool", "subnetpool", 52219, PropCategory.REGULAR)
