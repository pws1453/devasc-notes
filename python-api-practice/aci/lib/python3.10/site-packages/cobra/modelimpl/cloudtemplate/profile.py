...
class Profile(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudtemplate.Profile")

    meta.moClassName = "cloudtemplateProfile"
    meta.rnFormat = "profile-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 52708, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52709, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 52456, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "routerLicenseToken", "routerLicenseToken", 52790, PropCategory.REGULAR)
    prop.label = "License Token of the routers"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("routerLicenseToken", prop)

    prop = PropMeta("str", "routerPassword", "routerPassword", 52393, PropCategory.REGULAR)
    prop.label = "Password"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isPassword = True
    meta.props.add("routerPassword", prop)

    prop = PropMeta("str", "routerTcpMss", "routerTcpMss", 62449, PropCategory.REGULAR)
    prop.label = "Indicates the TCP MSS value on all Tunnel Interfaces in the Router"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(500, 1460)]
    prop.defaultValue = 1400
    prop.defaultValueStr = "1400"
    meta.props.add("routerTcpMss", prop)

    prop = PropMeta("str", "routerThroughput", "routerThroughput", 52791, PropCategory.REGULAR)
    prop.label = "Throughput of the routers"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1000
    prop.defaultValueStr = "1G"
    ...
    meta.props.add("routerThroughput", prop)

    prop = PropMeta("str", "routerUsername", "routerUsername", 52392, PropCategory.REGULAR)
    prop.label = "Username"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    prop.defaultValue = "admin"
    prop.defaultValueStr = "admin"
    meta.props.add("routerUsername", prop)
