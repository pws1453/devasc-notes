...
class ExtNetwork(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudtemplate.ExtNetwork")

    meta.moClassName = "cloudtemplateExtNetwork"
    meta.rnFormat = "extnetwork-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Template for External Network"
    ...
    meta.childClasses.add("cobra.model.cloudtemplate.VpnNetwork")
    meta.childClasses.add("cobra.model.cloudtemplate.BgpEvpn")
    meta.childClasses.add("cobra.model.cloud.RegionName")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.VpnNetwork", "vpnnetwork-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RegionName", "provider-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudtemplate.BgpEvpn", "bgpevpn-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51730, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51731, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50719, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
