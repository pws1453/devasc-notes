...
class Inst(Mo):
    """
    Glean instance information.

    """

    meta = ClassMeta("cobra.model.glean.Inst")

    meta.moClassName = "gleanInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Glean Instance"
    ...
    meta.childClasses.add("cobra.model.glean.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.glean.Dom", "dom-"))

    meta.parentClasses.add("cobra.model.glean.Entity")
