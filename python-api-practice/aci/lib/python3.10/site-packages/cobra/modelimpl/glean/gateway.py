...
class Gateway(Mo):
    """
    Gateway information. For a given BD, there can be multiple gateways.

    """

    meta = ClassMeta("cobra.model.glean.Gateway")

    meta.moClassName = "gleanGateway"
    meta.rnFormat = "gw-[%(ip)s]"
    ...
    meta.parentClasses.add("cobra.model.glean.BD")
    ...
    prop = PropMeta("str", "ip", "ip", 2116, PropCategory.REGULAR)
