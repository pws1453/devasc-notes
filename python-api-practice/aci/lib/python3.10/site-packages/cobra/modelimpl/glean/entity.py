...
class Entity(Mo):
    """
    Control plane entity information for this glean.

    """

    meta = ClassMeta("cobra.model.glean.Entity")

    meta.moClassName = "gleanEntity"
    meta.rnFormat = "glean"
    meta.category = MoCategory.REGULAR
    meta.label = "Glean Entity"
    ...
    meta.childClasses.add("cobra.model.glean.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.glean.Inst", "inst"))
