...
class Dom(Mo):
    """
    Domain (VRF) information for this glean.

    """

    meta = ClassMeta("cobra.model.glean.Dom")

    meta.moClassName = "gleanDom"
    ...
    meta.childClasses.add("cobra.model.glean.BD")

    meta.childNamesAndRnPrefix.append(("cobra.model.glean.BD", "bd-"))

    meta.parentClasses.add("cobra.model.glean.Inst")
    ...
    prop = PropMeta("str", "encap", "encap", 2112, PropCategory.REGULAR)
    prop.label = "VRF Encapsulation"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
