...
# ##################################################
class Group(Mo):
    meta = ClassMeta("cobra.model.hsrp.Group")

    meta.isAbstract = True
    meta.moClassName = "hsrpGroup"
    ...
    meta.concreteSubClasses.add("cobra.model.hsrp.GroupV1")
    meta.concreteSubClasses.add("cobra.model.hsrp.GroupV2")
