...
class Inst(Mo):
    """
     This objects holds HSRP instance information. There is  

    """

    meta = ClassMeta("cobra.model.hsrp.Inst")

    meta.moClassName = "hsrpInst"
    meta.rnFormat = "inst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "HSRP Instance"
    ...
    meta.childClasses.add("cobra.model.hsrp.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hsrp.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27660, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 24752, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
