...
class RsIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.hsrp.RsIfPol", "cobra.model.hsrp.IfPol")
    meta.targetNameProps["name"] = "tnHsrpIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hsrpRsIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38541, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40680, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27311, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27294, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9178
    prop.defaultValueStr = "hsrpIfPol"
    ...
    prop = PropMeta("str", "tnHsrpIfPolName", "tnHsrpIfPolName", 27293, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnHsrpIfPolName", prop)
