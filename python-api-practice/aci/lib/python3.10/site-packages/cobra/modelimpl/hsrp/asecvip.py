...
# ##################################################
class ASecVip(Mo):
    meta = ClassMeta("cobra.model.hsrp.ASecVip")

    meta.isAbstract = True
    meta.moClassName = "hsrpASecVip"


    meta.moClassName = "hsrpASecVip"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Secondary Virtual IP Abstract Policy"
    ...
    prop = PropMeta("str", "ip", "ip", 27260, PropCategory.REGULAR)
