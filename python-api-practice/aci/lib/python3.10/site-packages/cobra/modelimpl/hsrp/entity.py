...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.hsrp.Entity")

    meta.moClassName = "hsrpEntity"
    meta.rnFormat = "hsrp"
    meta.category = MoCategory.REGULAR
    meta.label = "HSRP Entity"
    ...
    meta.childClasses.add("cobra.model.hsrp.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hsrp.Inst", "inst-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28597, PropCategory.REGULAR)
