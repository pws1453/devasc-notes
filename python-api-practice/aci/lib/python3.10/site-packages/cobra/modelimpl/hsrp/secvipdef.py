...
class SecVipDef(Mo):
    ...
    meta = ClassMeta("cobra.model.hsrp.SecVipDef")

    meta.moClassName = "hsrpSecVipDef"
    meta.rnFormat = "hsrpSecVipDef-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Hsrp Secondary VIP Definition"
    ...
    prop = PropMeta("str", "ip", "ip", 27288, PropCategory.REGULAR)
