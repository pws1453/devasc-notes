...
class RsGroupPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.hsrp.RsGroupPol", "cobra.model.hsrp.GroupPol")
    meta.targetNameProps["name"] = "tnHsrpGroupPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hsrpRsGroupPol"
    meta.rnFormat = "rsGroupPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Group Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38538, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40677, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27308, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27290, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9180
    prop.defaultValueStr = "hsrpGroupPol"
    ...
    prop = PropMeta("str", "tnHsrpGroupPolName", "tnHsrpGroupPolName", 27289, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnHsrpGroupPolName", prop)
