...
class GroupV1(Mo):
    """
     Object represents HSRP group for HSRP version 1.  

    """

    meta = ClassMeta("cobra.model.hsrp.GroupV1")

    meta.moClassName = "hsrpGroupV1"
    meta.rnFormat = "grpv1-%(id)s"
    ...
    prop = PropMeta("str", "hsrpCfgFailedBmp", "hsrpCfgFailedBmp", 28477, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("hsrp:GroupV1ctrl_failed_flag", None, 2)
    prop._addConstant("hsrp:GroupV1helloIntvl_failed_flag", None, 8)
    prop._addConstant("hsrp:GroupV1holdIntvl_failed_flag", None, 16)
    prop._addConstant("hsrp:GroupV1id_failed_flag", None, 67108864)
    prop._addConstant("hsrp:GroupV1ipObtainMode_failed_flag", None, 64)
    prop._addConstant("hsrp:GroupV1ip_failed_flag", None, 32)
    prop._addConstant("hsrp:GroupV1lcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("hsrp:GroupV1mac_failed_flag", None, 256)
    prop._addConstant("hsrp:GroupV1modTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("hsrp:GroupV1monPolDn_failed_flag", None, 134217728)
    prop._addConstant("hsrp:GroupV1name_failed_flag", None, 512)
    prop._addConstant("hsrp:GroupV1preemptDelayMin_failed_flag", None, 262144)
    prop._addConstant("hsrp:GroupV1preemptDelayReload_failed_flag", None, 524288)
    prop._addConstant("hsrp:GroupV1preemptDelaySync_failed_flag", None, 1048576)
    prop._addConstant("hsrp:GroupV1prio_failed_flag", None, 2097152)
    meta.props.add("hsrpCfgFailedBmp", prop)

    prop = PropMeta("str", "hsrpCfgFailedTs", "hsrpCfgFailedTs", 28479, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("hsrpCfgFailedTs", prop)

    prop = PropMeta("str", "hsrpCfgState", "hsrpCfgState", 28478, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("hsrpCfgState", prop)

    prop = PropMeta("str", "id", "id", 24631, PropCategory.REGULAR)
    prop.label = "Group ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27662, PropCategory.REGULAR)
