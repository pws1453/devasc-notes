...
class IfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.dwdm.IfPol")

    meta.moClassName = "dwdmIfPol"
    meta.rnFormat = "dwdmifpol-%(name)s"
    ...
    meta.childClasses.add("cobra.model.dwdm.RtDwdmIfPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.dwdm.RtDwdmIfPolCons")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.dwdm.RtDwdmIfPolCons", "rtl1DwdmIfPolCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dwdm.RtDwdmIfPol", "rtinfraDwdmIfPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38781, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40920, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 35529, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
