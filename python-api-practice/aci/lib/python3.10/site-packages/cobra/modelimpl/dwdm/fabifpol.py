...
class FabIfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.dwdm.FabIfPol")

    meta.moClassName = "dwdmFabIfPol"
    meta.rnFormat = "dwdmfabifpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Profiles for DWDM to be applied at the interface level"
    ...
    meta.childClasses.add("cobra.model.dwdm.RtDwdmFabIfPol")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.dwdm.RtDwdmFabIfPolCons")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.dwdm.RtDwdmFabIfPol", "rtfabricDwdmFabIfPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dwdm.RtDwdmFabIfPolCons", "rtl1DwdmFabIfPolCons-"))
    ...
    meta.superClasses.add("cobra.model.dwdm.AOptChnlIfPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38782, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40921, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fcotChannelNumber", "fcotChannelNumber", 35526, PropCategory.REGULAR)
    prop.label = "Channel Number, which has fixed wavelength value"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 96)]
    ...
    prop = PropMeta("str", "name", "name", 35528, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
