...
# ##################################################
class RsSysFwdScaleProfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysFwdScaleProfPolCons", "cobra.model.topoctrl.FwdScaleProfilePol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysFwdScaleProfPolCons"
    meta.rnFormat = "rssysFwdScaleProfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fowarding Scale Profile Policy"
    ...
    meta.rnPrefixes = [
        ('rssysFwdScaleProfPolCons', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 33325, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10641
    prop.defaultValueStr = "topoctrlFwdScaleProfilePol"
    prop._addConstant("topoctrlFwdScaleProfilePol", None, 10641)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33324, PropCategory.REGULAR)
