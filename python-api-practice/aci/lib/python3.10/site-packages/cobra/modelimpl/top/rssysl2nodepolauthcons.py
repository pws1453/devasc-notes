...
# ##################################################
class RsSysL2NodePolAuthCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysL2NodePolAuthCons", "cobra.model.l2.NodeAuthPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysL2NodePolAuthCons"
    meta.rnFormat = "rssysL2NodePolAuthCons"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33505, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10740
    prop.defaultValueStr = "l2NodeAuthPol"
    prop._addConstant("l2NodeAuthPol", None, 10740)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33504, PropCategory.REGULAR)
