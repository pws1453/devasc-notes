...
# ##################################################
class RsSysFastLinkFailoverInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysFastLinkFailoverInstPolCons", "cobra.model.topoctrl.FastLinkFailoverInstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysFastLinkFailoverInstPolCons"
    meta.rnFormat = "rssysFastLinkFailoverInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fast Link Failover Instance Policy"
    ...
    meta.rnPrefixes = [
        ('rssysFastLinkFailoverInstPolCons', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 35396, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11270
    prop.defaultValueStr = "topoctrlFastLinkFailoverInstPol"
    prop._addConstant("topoctrlFastLinkFailoverInstPol", None, 11270)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 35395, PropCategory.REGULAR)
