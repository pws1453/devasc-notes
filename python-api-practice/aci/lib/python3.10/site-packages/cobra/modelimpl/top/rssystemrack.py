...
# ##################################################
class RsSystemRack(Mo):
    """
    A source relation to the rack identifier where the node is located.

    """

    meta = SourceRelationMeta("cobra.model.top.RsSystemRack", "cobra.model.geo.Rack")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "topRsSystemRack"
    meta.rnFormat = "rssystemRack-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Location"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11236, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 522
    prop.defaultValueStr = "geoRack"
    prop._addConstant("geoRack", None, 522)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 11235, PropCategory.REGULAR)
