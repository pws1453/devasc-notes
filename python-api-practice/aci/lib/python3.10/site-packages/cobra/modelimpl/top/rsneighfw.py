...
class RsNeighFw(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.top.RsNeighFw", "cobra.model.compat.Fw")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "topRsNeighFw"
    meta.rnFormat = "rsneighFw-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Running Neighbour Firmware Version"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11226, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11225, PropCategory.REGULAR)
