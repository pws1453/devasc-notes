...
class SystemTask(Mo):
    ...
    meta = ClassMeta("cobra.model.top.SystemTask")

    meta.moClassName = "topSystemTask"
    meta.rnFormat = "topSystemTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5649, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateApicConfig", "updateapicconfig", 3923)
    prop._addConstant("UpdateGipoPool", "updategipopool", 1542)
    prop._addConstant("UpdateInfraVlan", "updateinfravlan", 3910)
    prop._addConstant("UpdateMcastGipoPool", "updatemcastgipopool", 2237)
    prop._addConstant("controllerChassis", "controllerchassis", 1242)
    prop._addConstant("none", "none", 0)
    prop._addConstant("sendDefaultApicOobPolicy", "senddefaultapicoobpolicy", 3762)
    prop._addConstant("sendTopSystem", "sendtopsystem", 66)
    prop._addConstant("sendTopSystemAD", "sendtopsystemad", 1263)
    prop._addConstant("sendTopSystemPM", "sendtopsystempm", 68)
    prop._addConstant("switchChassis", "switchchassis", 1243)
    prop._addConstant("updateFabricNode", "updatefabricnode", 664)
    prop._addConstant("updateRunningVer", "updaterunningver", 1356)
    prop._addConstant("updateTopSystem", "updatetopsystem", 663)
