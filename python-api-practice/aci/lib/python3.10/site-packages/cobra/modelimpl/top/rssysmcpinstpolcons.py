...
# ##################################################
class RsSysMcpInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysMcpInstPolCons", "cobra.model.mcp.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysMcpInstPolCons"
    meta.rnFormat = "rssysMcpInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MCP Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26259, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5718
    prop.defaultValueStr = "mcpInstPol"
    prop._addConstant("mcpInstPol", None, 5718)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26258, PropCategory.REGULAR)
