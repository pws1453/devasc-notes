...
# ##################################################
class RsSysNetflowNodePolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysNetflowNodePolCons", "cobra.model.netflow.NodePol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysNetflowNodePolCons"
    meta.rnFormat = "rssysNetflowNodePolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Netflow Node Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28370, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9208
    prop.defaultValueStr = "netflowNodePol"
    prop._addConstant("netflowNodePol", None, 9208)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28369, PropCategory.REGULAR)
