...
class Info(Mo):
    ...
    meta = ClassMeta("cobra.model.top.Info")

    meta.moClassName = "topInfo"
    meta.rnFormat = "info"
    meta.category = MoCategory.TOP_INFO
    meta.label = "None"
    ...
    prop = PropMeta("str", "currentTime", "currentTime", 31, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 29, PropCategory.REGULAR)
    prop.label = "Node ID"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "podId", "podId", 26111, PropCategory.REGULAR)
    prop.label = "Pod ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 254)]
    ...
    prop = PropMeta("str", "role", "role", 30, PropCategory.REGULAR)
    prop.label = "Role"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
