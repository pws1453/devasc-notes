...
# ##################################################
class RsSysIaclProfilePolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysIaclProfilePolCons", "cobra.model.iacl.AProfile")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysIaclProfilePolCons"
    meta.rnFormat = "rssysIaclProfilePolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Iacl Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 37160, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10974
    prop.defaultValueStr = "iaclAProfile"
    ...
    prop = PropMeta("str", "tDn", "tDn", 37159, PropCategory.REGULAR)
