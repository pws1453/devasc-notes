...
# ##################################################
class RsSysPoeInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysPoeInstPolCons", "cobra.model.poe.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysPoeInstPolCons"
    meta.rnFormat = "rssysPoeInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "POE Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34072, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10929
    prop.defaultValueStr = "poeInstPol"
    prop._addConstant("poeInstPol", None, 10929)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 34071, PropCategory.REGULAR)
