...
# ##################################################
class RsSysBfdIpv6PolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysBfdIpv6PolCons", "cobra.model.bfd.Ipv6InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysBfdIpv6PolCons"
    meta.rnFormat = "rssysBfdIpv6PolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "BFD IPV6 Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26002, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7692
    prop.defaultValueStr = "bfdIpv6InstPol"
    prop._addConstant("bfdIpv6InstPol", None, 7692)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26001, PropCategory.REGULAR)
