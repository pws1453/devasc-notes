...
class RsProtGFw(Mo):
    """
    A source relation to the firmware version.

    """

    meta = SourceRelationMeta("cobra.model.top.RsProtGFw", "cobra.model.compat.Fw")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "topRsProtGFw"
    meta.rnFormat = "rsprotGFw-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Running Protection Group Firmware Version"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11229, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11228, PropCategory.REGULAR)
