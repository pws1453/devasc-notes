...
# ##################################################
class RsSysFlashConfigPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysFlashConfigPolCons", "cobra.model.equipment.FlashConfigPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysFlashConfigPolCons"
    meta.rnFormat = "rssysFlashConfigPolCons"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53102, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 53101, PropCategory.REGULAR)
