...
# ##################################################
class RsSysBfdIpv4PolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysBfdIpv4PolCons", "cobra.model.bfd.Ipv4InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysBfdIpv4PolCons"
    meta.rnFormat = "rssysBfdIpv4PolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "BFD IPV4 Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25999, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7691
    prop.defaultValueStr = "bfdIpv4InstPol"
    prop._addConstant("bfdIpv4InstPol", None, 7691)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 25998, PropCategory.REGULAR)
