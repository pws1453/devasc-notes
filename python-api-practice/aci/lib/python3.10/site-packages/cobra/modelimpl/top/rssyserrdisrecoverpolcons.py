...
# ##################################################
class RsSysErrDisRecoverPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysErrDisRecoverPolCons", "cobra.model.edr.ErrDisRecoverPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysErrDisRecoverPolCons"
    meta.rnFormat = "rssysErrDisRecoverPolCons"
    ...
    meta.rnPrefixes = [
        ('rssysErrDisRecoverPolCons', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 33508, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33507, PropCategory.REGULAR)
