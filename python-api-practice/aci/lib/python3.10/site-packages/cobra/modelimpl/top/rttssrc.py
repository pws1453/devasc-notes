...
class RtTsSrc(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.top.RtTsSrc", "cobra.model.dbgexp.TechSupOnDBase")

    meta.moClassName = "topRtTsSrc"
    meta.rnFormat = "rtdbgexpTsSrc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12970, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7624
    prop.defaultValueStr = "dbgexpTechSupOnDBase"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12969, PropCategory.REGULAR)
