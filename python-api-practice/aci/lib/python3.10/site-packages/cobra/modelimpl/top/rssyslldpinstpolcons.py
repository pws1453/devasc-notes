...
# ##################################################
class RsSysLldpInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysLldpInstPolCons", "cobra.model.lldp.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysLldpInstPolCons"
    meta.rnFormat = "rssysLldpInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Lldp Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26014, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26013, PropCategory.REGULAR)
