...
# ##################################################
class RsSysFcFabricPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysFcFabricPolCons", "cobra.model.fc.FabricPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysFcFabricPolCons"
    meta.rnFormat = "rssysFcFabricPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fiber Channel Fabric Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26008, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8733
    prop.defaultValueStr = "fcFabricPol"
    prop._addConstant("fcFabricPol", None, 8733)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26007, PropCategory.REGULAR)
