...
# ##################################################
class RsSysCdpInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysCdpInstPolCons", "cobra.model.cdp.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysCdpInstPolCons"
    meta.rnFormat = "rssysCdpInstPolCons"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26005, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 682
    prop.defaultValueStr = "cdpInstPol"
    prop._addConstant("cdpInstPol", None, 682)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26004, PropCategory.REGULAR)
