...
# ##################################################
class RsSysMstInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysMstInstPolCons", "cobra.model.stp.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysMstInstPolCons"
    meta.rnFormat = "rssysMstInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "STP Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26017, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 564
    prop.defaultValueStr = "stpInstPol"
    prop._addConstant("stpInstPol", None, 564)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26016, PropCategory.REGULAR)
