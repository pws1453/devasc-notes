...
# ##################################################
class RsSysPsuInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysPsuInstPolCons", "cobra.model.psu.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysPsuInstPolCons"
    meta.rnFormat = "rssysPsuInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "PSU Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26020, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26019, PropCategory.REGULAR)
