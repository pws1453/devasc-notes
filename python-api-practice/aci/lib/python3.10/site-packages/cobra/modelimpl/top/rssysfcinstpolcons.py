...
# ##################################################
class RsSysFcInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysFcInstPolCons", "cobra.model.fc.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysFcInstPolCons"
    meta.rnFormat = "rssysFcInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fiber Channel Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26011, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8735
    prop.defaultValueStr = "fcInstPol"
    prop._addConstant("fcInstPol", None, 8735)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26010, PropCategory.REGULAR)
