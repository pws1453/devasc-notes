...
# ##################################################
class RsMonPolSystemPolCons(Mo):
    """
    A source relation to the monitoring policy consumed by this node.

    """

    meta = SourceRelationMeta("cobra.model.top.RsMonPolSystemPolCons", "cobra.model.mon.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "topRsMonPolSystemPolCons"
    meta.rnFormat = "rsmonPolSystemPolCons"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11232, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11231, PropCategory.REGULAR)
