...
# ##################################################
class If(Mo):
    meta = ClassMeta("cobra.model.npv.If")

    meta.isAbstract = True
    meta.moClassName = "npvIf"
    ...
    meta.concreteSubClasses.add("cobra.model.npv.SrvIf")
    meta.concreteSubClasses.add("cobra.model.npv.ExtIf")
    ...
    prop = PropMeta("str", "id", "id", 24661, PropCategory.REGULAR)
