...
class SrvVsan(Mo):
    ...
    meta = ClassMeta("cobra.model.npv.SrvVsan")

    meta.moClassName = "npvSrvVsan"
    meta.rnFormat = "vsan-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "NPV Server Interface Vsan"
    ...
    prop = PropMeta("str", "fsmSt", "fsmSt", 24680, PropCategory.REGULAR)
    prop.label = "Server Interface Vsan State"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 24679, PropCategory.REGULAR)
    prop.label = "Server Interface Vsan ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
