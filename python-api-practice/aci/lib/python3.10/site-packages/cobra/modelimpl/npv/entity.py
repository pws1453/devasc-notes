...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.npv.Entity")

    meta.moClassName = "npvEntity"
    meta.rnFormat = "npv"
    meta.category = MoCategory.REGULAR
    meta.label = "N Port Virtualization Entity"
    ...
    meta.childClasses.add("cobra.model.npv.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.npv.Inst", "inst"))
