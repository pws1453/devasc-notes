...
class Inst(Mo):
    """
    Per NPV instance information. There is only one instance of NPV instance running in the system.

    """

    meta = ClassMeta("cobra.model.npv.Inst")

    meta.moClassName = "npvInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "N Port Virtualization Instance"
    ...
    meta.childClasses.add("cobra.model.npv.SrvIf")
    meta.childClasses.add("cobra.model.npv.ExtIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.npv.SrvIf", "srvif-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.npv.ExtIf", "extif-"))

    meta.parentClasses.add("cobra.model.npv.Entity")
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 24660, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
