...
class Inst(Mo):
    """
     This objects hold per udld instance information. There is only one instance of udld running in the system today 

    """

    meta = ClassMeta("cobra.model.udld.Inst")

    meta.moClassName = "udldInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "UDLD Instance"
    ...
    meta.childClasses.add("cobra.model.udld.If")

    meta.childNamesAndRnPrefix.append(("cobra.model.udld.If", "if-"))

    meta.parentClasses.add("cobra.model.udld.Entity")
    ...
    prop = PropMeta("str", "probeMsgTime", "probeMsgTime", 26081, PropCategory.REGULAR)
    prop.label = "Time between probe msgs"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(7, 90)]
    prop.defaultValue = 15
    meta.props.add("probeMsgTime", prop)
