...
class Entity(Mo):
    """
     Holds udld control plane entity information 

    """

    meta = ClassMeta("cobra.model.udld.Entity")

    meta.moClassName = "udldEntity"
    meta.rnFormat = "udld"
    meta.category = MoCategory.REGULAR
    meta.label = "UDLD Entity"
    ...
    meta.childClasses.add("cobra.model.udld.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.udld.Inst", "inst"))
