...
class Profile(Mo):
    ...
    meta = ClassMeta("cobra.model.hcisakmp.Profile")

    meta.moClassName = "hcisakmpProfile"
    meta.rnFormat = "profile-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Isakmp Ike v1 Profile"
    ...
    meta.childClasses.add("cobra.model.hcisakmp.RsProfileToKeyring")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.hcisakmp.RtIsakmpProfile")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.RtIsakmpProfile", "rthctunnIsakmpProfile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.RsProfileToKeyring", "rsprofileToKeyring"))
    ...
    prop = PropMeta("str", "matchIdentityAddress", "matchIdentityAddress", 50246, PropCategory.REGULAR)
    prop.label = "Match Peer Identity using IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("matchIdentityAddress", prop)
    ...
    prop = PropMeta("str", "name", "name", 50245, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
