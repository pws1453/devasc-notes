...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.hcisakmp.Entity")

    meta.moClassName = "hcisakmpEntity"
    meta.rnFormat = "isakmp"
    ...
    meta.childClasses.add("cobra.model.hcisakmp.Inst")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.Inst", "inst"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51610, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51611, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
