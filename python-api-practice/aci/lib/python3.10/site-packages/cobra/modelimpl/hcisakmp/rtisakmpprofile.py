...
# ##################################################
class RtIsakmpProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcisakmp.RtIsakmpProfile", "cobra.model.hctunn.If")

    meta.moClassName = "hcisakmpRtIsakmpProfile"
    meta.rnFormat = "rthctunnIsakmpProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51379, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51378, PropCategory.REGULAR)
