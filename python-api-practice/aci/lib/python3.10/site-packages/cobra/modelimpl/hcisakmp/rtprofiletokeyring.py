...
# ##################################################
class RtProfileToKeyring(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcisakmp.RtProfileToKeyring", "cobra.model.hcisakmp.Profile")

    meta.moClassName = "hcisakmpRtProfileToKeyring"
    meta.rnFormat = "rtprofileToKeyring-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.hcisakmp.Keyring")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtprofileToKeyring-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51276, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14848
    prop.defaultValueStr = "hcisakmpProfile"
    prop._addConstant("hcisakmpProfile", None, 14848)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51275, PropCategory.REGULAR)
