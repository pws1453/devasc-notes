...
class GlobalPol(Mo):
    ...
    meta = ClassMeta("cobra.model.hcisakmp.GlobalPol")

    meta.moClassName = "hcisakmpGlobalPol"
    ...
    prop = PropMeta("str", "keepalive", "keepalive", 50253, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "retryInterval", "retryInterval", 50254, PropCategory.REGULAR)
