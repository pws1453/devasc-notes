...
class RsProfileToKeyring(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.hcisakmp.RsProfileToKeyring", "cobra.model.hcisakmp.Keyring")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcisakmpRsProfileToKeyring"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51608, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51609, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51274, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14847
    prop.defaultValueStr = "hcisakmpKeyring"
    prop._addConstant("hcisakmpKeyring", None, 14847)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51273, PropCategory.REGULAR)
