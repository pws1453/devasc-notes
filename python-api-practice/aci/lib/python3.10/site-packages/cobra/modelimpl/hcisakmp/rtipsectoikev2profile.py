...
# ##################################################
class RtIpsecToIkev2Profile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcisakmp.RtIpsecToIkev2Profile", "cobra.model.hcipsec.Profile")

    meta.moClassName = "hcisakmpRtIpsecToIkev2Profile"
    meta.rnFormat = "rthcipsecIpsecToIkev2Profile-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.hcisakmp.Ikev2Profile")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rthcipsecIpsecToIkev2Profile-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 54987, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14842
    prop.defaultValueStr = "hcipsecProfile"
    prop._addConstant("hcipsecProfile", None, 14842)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54986, PropCategory.REGULAR)
