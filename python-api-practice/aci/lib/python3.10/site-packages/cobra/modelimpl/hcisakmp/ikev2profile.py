...
# ##################################################
class Ikev2Profile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcisakmp.Ikev2Profile")

    meta.moClassName = "hcisakmpIkev2Profile"
    meta.rnFormat = "ikev2profile-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Isakmp Ike v2 Profile"
    ...
    meta.childClasses.add("cobra.model.hcisakmp.RtIkev2Profile")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.hcisakmp.RtIpsecToIkev2Profile")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.RtIpsecToIkev2Profile", "rthcipsecIpsecToIkev2Profile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.RtIkev2Profile", "rthctunnIkev2Profile-"))
    ...
    prop = PropMeta("str", "authMethodLocal", "authMethodLocal", 54934, PropCategory.REGULAR)
    prop.label = "Authentication method Local"
    ...
    meta.props.add("authMethodLocal", prop)

    prop = PropMeta("str", "authMethodRemote", "authMethodRemote", 54933, PropCategory.REGULAR)
    prop.label = "Authentication method Remote"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "pre-share"
    ...
    prop._addConstant("rsa-encr", "rivest-shamir-adleman-encryption", 1)
    prop._addConstant("rsa-sig", "rivest-shamir-adleman-signature", 2)
    meta.props.add("authMethodRemote", prop)
    ...
    prop = PropMeta("str", "dpdQueryType", "dpdQueryType", 54938, PropCategory.REGULAR)
    prop.label = "Dead peer detection query"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "on-demand"
    prop._addConstant("on-demand", "send-dpd-queries-only-as-needed", 0)
    prop._addConstant("periodic", "send-dpd-queries-at-regular-intervals", 1)
    meta.props.add("dpdQueryType", prop)

    prop = PropMeta("str", "dpdRetryInterval", "dpdRetryInterval", 54936, PropCategory.REGULAR)
    prop.label = "Dead peer detection retry Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(2, 60)]
    prop.defaultValue = 5
    prop.defaultValueStr = "5"
    meta.props.add("dpdRetryInterval", prop)

    prop = PropMeta("str", "dpdRuThereInterval", "dpdRuThereInterval", 54937, PropCategory.REGULAR)
    prop.label = "Dead peer detection, are you there interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(10, 3600)]
    prop.defaultValue = 10
    prop.defaultValueStr = "10"
    meta.props.add("dpdRuThereInterval", prop)

    prop = PropMeta("str", "key", "key", 54940, PropCategory.REGULAR)
    prop.label = "Key Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "keyType", "keyType", 54939, PropCategory.REGULAR)
    prop.label = "Key Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "lifetime", "lifetime", 54935, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 54932, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
