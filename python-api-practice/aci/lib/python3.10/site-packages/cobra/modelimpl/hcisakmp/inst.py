...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.hcisakmp.Inst")

    meta.moClassName = "hcisakmpInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Isakmp Instance"
    ...
    meta.childClasses.add("cobra.model.hcisakmp.Policy")
    meta.childClasses.add("cobra.model.hcisakmp.GlobalPol")
    meta.childClasses.add("cobra.model.hcisakmp.Ikev2Policy")
    meta.childClasses.add("cobra.model.hcisakmp.Keyring")
    meta.childClasses.add("cobra.model.hcisakmp.Ikev2Profile")
    meta.childClasses.add("cobra.model.hcisakmp.Profile")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.Ikev2Profile", "ikev2profile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.Ikev2Policy", "ikev2policy-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.GlobalPol", "globalpol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.Keyring", "keyring-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.Profile", "profile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcisakmp.Policy", "policy-"))
