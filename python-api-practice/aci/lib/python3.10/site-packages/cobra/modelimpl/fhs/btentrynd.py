...
class BtEntryNd(Mo):
    ...
    meta = ClassMeta("cobra.model.fhs.BtEntryNd")

    meta.moClassName = "fhsBtEntryNd"
    meta.rnFormat = "ndip-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BtEntryNd"
    ...
    prop = PropMeta("str", "ip", "ip", 28941, PropCategory.REGULAR)
