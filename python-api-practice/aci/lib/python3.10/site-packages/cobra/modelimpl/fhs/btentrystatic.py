...
# ##################################################
class BtEntryStatic(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fhs.BtEntryStatic")

    meta.moClassName = "fhsBtEntryStatic"
    meta.rnFormat = "staticip-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BtEntryStatic"
    ...
    prop = PropMeta("str", "ip", "ip", 28942, PropCategory.REGULAR)
