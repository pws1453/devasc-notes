...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.fhs.Inst")

    meta.moClassName = "fhsInst"
    meta.rnFormat = "inst"
    ...
    meta.childClasses.add("cobra.model.fhs.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fhs.Dom", "dom-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30310, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 32713, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 32714, PropCategory.REGULAR)
    prop.label = "Operational State Qualifier"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "up"
    prop._addConstant("up", "up", 0)
    prop._addConstant("violation-event-history-limit-reached", "violation-event-history-limit-reached", 1)
    ...
    prop = PropMeta("str", "violationEventHistLimit", "violationEventHistLimit", 32712, PropCategory.REGULAR)
    prop.label = "Violation events history limit per leaf"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 1000
    prop.defaultValueStr = "1000"
    meta.props.add("violationEventHistLimit", prop)
