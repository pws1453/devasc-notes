...
# ##################################################
class BtEntryDhcp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fhs.BtEntryDhcp")

    meta.moClassName = "fhsBtEntryDhcp"
    meta.rnFormat = "dhcpip-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BtEntryDhcp"
    ...
    prop = PropMeta("str", "ip", "ip", 28939, PropCategory.REGULAR)
