...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.fhs.Entity")

    meta.moClassName = "fhsEntity"
    meta.rnFormat = "fhs"
    ...
    meta.childClasses.add("cobra.model.fhs.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fhs.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30309, PropCategory.REGULAR)
