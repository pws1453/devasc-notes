...
# ##################################################
class BtEntryData(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fhs.BtEntryData")

    meta.moClassName = "fhsBtEntryData"
    meta.rnFormat = "dataip-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BtEntryData"
    ...
    prop = PropMeta("str", "ip", "ip", 28938, PropCategory.REGULAR)
