...
# ##################################################
class BtEntry(Mo):
    meta = ClassMeta("cobra.model.fhs.BtEntry")

    meta.isAbstract = True
    meta.moClassName = "fhsBtEntry"
    ...
    meta.concreteSubClasses.add("cobra.model.fhs.BtEntryArp")
    meta.concreteSubClasses.add("cobra.model.fhs.BtEntryDhcp")
    meta.concreteSubClasses.add("cobra.model.fhs.BtEntryData")
    meta.concreteSubClasses.add("cobra.model.fhs.BtEntryNd")
    meta.concreteSubClasses.add("cobra.model.fhs.BtEntryStatic")
    meta.concreteSubClasses.add("cobra.model.fhs.BtEntryLocal")
    ...
    prop = PropMeta("str", "ip", "ip", 28815, PropCategory.REGULAR)
