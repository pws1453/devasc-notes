...
class BtEntryArp(Mo):
    ...
    meta = ClassMeta("cobra.model.fhs.BtEntryArp")

    meta.moClassName = "fhsBtEntryArp"
    meta.rnFormat = "arpip-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "BtEntryArp"
    ...
    prop = PropMeta("str", "ip", "ip", 28937, PropCategory.REGULAR)
