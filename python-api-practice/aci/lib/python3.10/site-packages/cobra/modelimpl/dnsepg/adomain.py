...
# ##################################################
class ADomain(Mo):
    meta = ClassMeta("cobra.model.dnsepg.ADomain")

    meta.isAbstract = True
    meta.moClassName = "dnsepgADomain"


    meta.moClassName = "dnsepgADomain"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract DNS Domain"
    ...
    prop = PropMeta("str", "domain", "domain", 33275, PropCategory.REGULAR)
