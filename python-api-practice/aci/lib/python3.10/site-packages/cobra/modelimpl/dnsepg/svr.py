...
class Svr(Mo):
    ...
    meta = ClassMeta("cobra.model.dnsepg.Svr")

    meta.moClassName = "dnsepgSvr"
    meta.rnFormat = "ip-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Server"
    ...
    meta.childClasses.add("cobra.model.dnsepg.Domain")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dnsepg.Domain", "domain-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))

    meta.parentClasses.add("cobra.model.dnsepg.SvrGrp")

    meta.superClasses.add("cobra.model.dnsepg.ASvr")
    meta.superClasses.add("cobra.model.dnsepg.AMgmt")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38699, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40838, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "internalIp", "internalIp", 33273, PropCategory.REGULAR)
    prop.label = "internal ip address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("internalIp", prop)

    prop = PropMeta("str", "ip", "ip", 33286, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33307, PropCategory.REGULAR)
