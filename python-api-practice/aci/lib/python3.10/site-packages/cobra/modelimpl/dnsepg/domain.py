...
class Domain(Mo):
    ...
    meta = ClassMeta("cobra.model.dnsepg.Domain")

    meta.moClassName = "dnsepgDomain"
    meta.rnFormat = "domain-%(domain)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Domain"
    meta.writeAccessMask = 0x4000010000000001
    meta.readAccessMask = 0x4000010000000001
    ...
    meta.childClasses.add("cobra.model.dnsepg.ZoneDB")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.dnsepg.NwIssues")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dnsepg.ZoneDB", "zonedb-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dnsepg.NwIssues", "nwissue"))
    ...
    meta.superClasses.add("cobra.model.dnsepg.ADomain")

    meta.rnPrefixes = [
        ('domain-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38700, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "connectionStatus", "connectionStatus", 33589, PropCategory.REGULAR)
    prop.label = "Status for the connection to dns server"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "pending"
    prop._addConstant("datafound", "datafound", 6)
    prop._addConstant("failed", "failed", 3)
    prop._addConstant("internalip-failed", "internalip-failed", 5)
    prop._addConstant("nodata", "nodata", 4)
    prop._addConstant("pending", "pending", 1)
    prop._addConstant("preInit", "preinit", 0)
    prop._addConstant("success", "success", 2)
    meta.props.add("connectionStatus", prop)
    ...
    prop = PropMeta("str", "domain", "domain", 33285, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40839, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33308, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, domain, markDirty=True, **creationProps):
        namingVals = [domain]
