...
class ZoneEntry(Mo):
    ...
    meta = ClassMeta("cobra.model.dnsepg.ZoneEntry")

    meta.moClassName = "dnsepgZoneEntry"
    meta.rnFormat = "entry-%(host)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Zone Entry"
    ...
    meta.parentClasses.add("cobra.model.dnsepg.ZoneDB")
    ...
    prop = PropMeta("str", "host", "host", 33277, PropCategory.REGULAR)
    prop.label = "domain host"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "ip", "ip", 33278, PropCategory.REGULAR)
