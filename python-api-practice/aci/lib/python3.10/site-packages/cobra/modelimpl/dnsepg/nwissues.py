...
class NwIssues(Mo):
    ...
    meta = ClassMeta("cobra.model.dnsepg.NwIssues")

    meta.moClassName = "dnsepgNwIssues"
    meta.rnFormat = "nwissue"
    ...
    prop = PropMeta("str", "connectionStatus", "connectionStatus", 33561, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33562, PropCategory.REGULAR)
