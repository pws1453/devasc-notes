...
class SvrTask(Mo):
    ...
    meta = ClassMeta("cobra.model.dnsepg.SvrTask")

    meta.moClassName = "dnsepgSvrTask"
    meta.rnFormat = "dnsepgSvrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33282, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateVTap", "updatevtap", 2768)
