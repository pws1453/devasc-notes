...
# ##################################################
class RtDnsSvrRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.dnsepg.RtDnsSvrRel", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "dnsepgRtDnsSvrRel"
    meta.rnFormat = "rtpolDnsSvrRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33297, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33296, PropCategory.REGULAR)
