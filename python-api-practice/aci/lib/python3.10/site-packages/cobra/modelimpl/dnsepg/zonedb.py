...
class ZoneDB(Mo):
    ...
    meta = ClassMeta("cobra.model.dnsepg.ZoneDB")

    meta.moClassName = "dnsepgZoneDB"
    meta.rnFormat = "zonedb-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "DNS Zone DB"
    ...
    meta.childClasses.add("cobra.model.dnsepg.ZoneEntry")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.dnsepg.ZoneEntry", "entry-"))
    ...
    prop = PropMeta("str", "name", "name", 33288, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
