...
class SAPolicy(Mo):
    ...
    meta = ClassMeta("cobra.model.hcipsec.SAPolicy")

    meta.moClassName = "hcipsecSAPolicy"
    meta.rnFormat = "sapolicy"
    meta.category = MoCategory.REGULAR
    meta.label = "Ipsec Security Association Policy"
    ...
    prop = PropMeta("str", "replayWindowSize", "replayWindowSize", 50237, PropCategory.REGULAR)
    prop.label = "Ipsec SA Replay Window Size"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4
    prop.defaultValueStr = "1024"
    prop._addConstant("1024", "window-size-of-1024", 4)
    prop._addConstant("128", "window-size-of-128", 1)
    prop._addConstant("256", "window-size-of-256", 2)
    prop._addConstant("512", "window-size-of-512", 3)
    prop._addConstant("64", "window-size-of-64", 0)
    meta.props.add("replayWindowSize", prop)
