...
# ##################################################
class RsIpsecToIkev2Profile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcipsec.RsIpsecToIkev2Profile", "cobra.model.hcisakmp.Ikev2Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcipsecRsIpsecToIkev2Profile"
    meta.rnFormat = "rsipsecToIkev2Profile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ikev2 profile reference"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54985, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16122
    prop.defaultValueStr = "hcisakmpIkev2Profile"
    prop._addConstant("hcisakmpIkev2Profile", None, 16122)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54984, PropCategory.REGULAR)
