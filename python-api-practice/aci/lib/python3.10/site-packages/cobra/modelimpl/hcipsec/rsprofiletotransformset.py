...
# ##################################################
class RsProfileToTransformSet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcipsec.RsProfileToTransformSet", "cobra.model.hcipsec.TransformSet")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcipsecRsProfileToTransformSet"
    meta.rnFormat = "rsprofileToTransformSet"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Profile Attachment to TransformSet"
    ...
    meta.rnPrefixes = [
        ('rsprofileToTransformSet', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 51606, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51607, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 51270, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14846
    prop.defaultValueStr = "hcipsecTransformSet"
    prop._addConstant("hcipsecTransformSet", None, 14846)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 51269, PropCategory.REGULAR)
