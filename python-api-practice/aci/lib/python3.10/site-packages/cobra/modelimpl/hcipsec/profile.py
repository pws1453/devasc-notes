...
class Profile(Mo):
    ...
    meta = ClassMeta("cobra.model.hcipsec.Profile")

    meta.moClassName = "hcipsecProfile"
    meta.rnFormat = "profile-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IPSec Profile"
    ...
    meta.childClasses.add("cobra.model.hcipsec.RtIpsecProfile")
    meta.childClasses.add("cobra.model.hcipsec.RsProfileToTransformSet")
    meta.childClasses.add("cobra.model.hcipsec.RsIpsecToIkev2Profile")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcipsec.RsProfileToTransformSet", "rsprofileToTransformSet"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcipsec.RtIpsecProfile", "rthctunnIpsecProfile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcipsec.RsIpsecToIkev2Profile", "rsipsecToIkev2Profile"))
    ...
    prop = PropMeta("str", "lifetime", "lifetime", 50236, PropCategory.REGULAR)
    prop.label = "Lifetime for security association"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(120, 2592000)]
    prop.defaultValue = 36000
    prop.defaultValueStr = "36000"
    ...
    prop = PropMeta("str", "name", "name", 50234, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "pfsGroup", "pfsGroup", 50235, PropCategory.REGULAR)
    prop.label = "PFS Encryption Group"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
