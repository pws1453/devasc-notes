...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.hcipsec.Inst")

    meta.moClassName = "hcipsecInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Ipsec Instance"
    ...
    meta.childClasses.add("cobra.model.hcipsec.Profile")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.hcipsec.TransformSet")
    meta.childClasses.add("cobra.model.hcipsec.SAPolicy")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcipsec.TransformSet", "transformset-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcipsec.Profile", "profile-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcipsec.SAPolicy", "sapolicy"))
