...
# ##################################################
class RtIpsecProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcipsec.RtIpsecProfile", "cobra.model.hctunn.If")

    meta.moClassName = "hcipsecRtIpsecProfile"
    meta.rnFormat = "rthctunnIpsecProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51375, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51374, PropCategory.REGULAR)
