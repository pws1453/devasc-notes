...
# ##################################################
class RtProfileToTransformSet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcipsec.RtProfileToTransformSet", "cobra.model.hcipsec.Profile")

    meta.moClassName = "hcipsecRtProfileToTransformSet"
    meta.rnFormat = "rtprofileToTransformSet-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.hcipsec.TransformSet")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtprofileToTransformSet-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 51272, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51271, PropCategory.REGULAR)
