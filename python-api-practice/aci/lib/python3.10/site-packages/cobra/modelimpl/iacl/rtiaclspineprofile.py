...
# ##################################################
class RtIaclSpineProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.iacl.RtIaclSpineProfile", "cobra.model.infra.SpineAccNodePGrp")

    meta.moClassName = "iaclRtIaclSpineProfile"
    meta.rnFormat = "rtinfraIaclSpineProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34288, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34287, PropCategory.REGULAR)
