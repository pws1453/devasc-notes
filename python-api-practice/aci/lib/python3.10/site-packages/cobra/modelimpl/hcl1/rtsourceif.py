...
class RtSourceIf(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.hcl1.RtSourceIf", "cobra.model.hctunn.If")

    meta.moClassName = "hcl1RtSourceIf"
    meta.rnFormat = "rthctunnSourceIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51383, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51382, PropCategory.REGULAR)
