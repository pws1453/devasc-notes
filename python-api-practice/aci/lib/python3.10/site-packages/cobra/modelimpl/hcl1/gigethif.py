...
# ##################################################
class GigEthIf(Mo):
    meta = ClassMeta("cobra.model.hcl1.GigEthIf")

    meta.isAbstract = True
    meta.moClassName = "hcl1GigEthIf"


    meta.moClassName = "hcl1GigEthIf"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Gigabit Ethernet Interface"
    ...
    prop = PropMeta("str", "id", "id", 50255, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
