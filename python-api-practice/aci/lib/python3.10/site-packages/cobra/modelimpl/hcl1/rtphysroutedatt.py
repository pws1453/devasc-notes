...
# ##################################################
class RtPhysRoutedAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcl1.RtPhysRoutedAtt", "cobra.model.hcl3.RoutedIf")

    meta.moClassName = "hcl1RtPhysRoutedAtt"
    meta.rnFormat = "rtphysRoutedAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51279, PropCategory.REGULAR)
