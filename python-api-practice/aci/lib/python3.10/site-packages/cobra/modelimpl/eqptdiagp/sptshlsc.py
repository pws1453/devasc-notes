...
class SpTsHlSc(Mo):
    """
    The ongoing diagnostic health test set to run at bootup on spine supervisor cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsHlSc")

    meta.moClassName = "eqptdiagpSpTsHlSc"
    meta.rnFormat = "spHlScDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Sup-card Health Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1925, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37717, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1923, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39856, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6403, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
