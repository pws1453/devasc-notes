...
class LeTsOdEcc(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiagp.LeTsOdEcc")

    meta.moClassName = "eqptdiagpLeTsOdEcc"
    meta.rnFormat = "leOdEccDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "FEX On-demand Diags"
    ...
    meta.childClasses.add("cobra.model.eqptdiagp.RsExtChCardOdDiag")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.eqptdiagp.RsExtChCardOdDiag", "rsextChCardOdDiag-"))
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.ExtChCardTsOd")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1900, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37710, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1898, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39849, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1899, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6394, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
