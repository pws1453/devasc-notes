...
class SpTsBtFc(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiagp.SpTsBtFc")

    meta.moClassName = "eqptdiagpSpTsBtFc"
    meta.rnFormat = "spBtFcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Fabric-card Bootup Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1910, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37712, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1908, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39851, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1909, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6397, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
