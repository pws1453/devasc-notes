...
class TsOdFabP(Mo):
    """
    The diagnostic on-demand test set for fabric ports.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsOdFabP")

    meta.moClassName = "eqptdiagpTsOdFabP"
    meta.rnFormat = "odFpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "On-Demand Diag Policy Set for Fab Port Types"
    ...
    meta.childClasses.add("cobra.model.eqptdiagp.RsFpOdDiag")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqptdiagp.RsFpOdDiag", "rsfpOdDiag-"))
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.FpTsOd")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1962, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39874, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1963, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6413, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
