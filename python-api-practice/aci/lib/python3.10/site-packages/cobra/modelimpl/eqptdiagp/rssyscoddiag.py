...
# ##################################################
class RsSysCOdDiag(Mo):
    """
    A source relation to the system controller card. Note that this relation is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.eqptdiagp.RsSysCOdDiag", "cobra.model.eqpt.SysC")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "eqptdiagpRsSysCOdDiag"
    meta.rnFormat = "rssysCOdDiag-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to System Controller Module"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37726, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39865, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 12565, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(1, 16000)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12564, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3206
    prop.defaultValueStr = "eqptSysC"
    prop._addConstant("eqptSysC", None, 3206)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12563, PropCategory.REGULAR)
