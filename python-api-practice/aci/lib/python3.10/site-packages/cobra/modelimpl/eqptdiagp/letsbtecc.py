...
class LeTsBtEcc(Mo):
    """
    The diagnostic test set for leaf fabric nodes to run at bootup on extended chassis cards (FEXes).

    """

    meta = ClassMeta("cobra.model.eqptdiagp.LeTsBtEcc")

    meta.moClassName = "eqptdiagpLeTsBtEcc"
    meta.rnFormat = "leBtEccDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Leaf Bootup Diag Policy Set for the Extended Chassis Card Type"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1882, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37704, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39843, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1881, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6388, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
