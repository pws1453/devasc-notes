...
class RsLpOdDiag(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.eqptdiagp.RsLpOdDiag", "cobra.model.eqpt.LeafP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "eqptdiagpRsLpOdDiag"
    meta.rnFormat = "rslpOdDiag-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Leaf Port for On-Demand Diag Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37723, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39862, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 12553, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(1, 16000)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12552, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3005
    prop.defaultValueStr = "eqptLeafP"
    prop._addConstant("eqptLeafP", None, 3005)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12551, PropCategory.REGULAR)
