...
# ##################################################
class TsHlExtChHP(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsHlExtChHP")

    meta.moClassName = "eqptdiagpTsHlExtChHP"
    meta.rnFormat = "hlEHpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Health Diag Policy Set for ExtCh (fex) Host Port Types"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 15384, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 15382, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40226, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 15383, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 15403, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
