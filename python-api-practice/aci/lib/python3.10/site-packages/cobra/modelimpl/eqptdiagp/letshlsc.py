...
class LeTsHlSc(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiagp.LeTsHlSc")

    meta.moClassName = "eqptdiagpLeTsHlSc"
    meta.rnFormat = "leHlSupDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Leaf Health Diag Policy Set for the IO Line Card Type"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1885, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37705, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1883, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39844, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1884, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6393, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
