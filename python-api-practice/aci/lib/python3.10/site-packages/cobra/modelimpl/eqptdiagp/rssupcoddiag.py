...
class RsSupCOdDiag(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.eqptdiagp.RsSupCOdDiag", "cobra.model.eqpt.SupC")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "eqptdiagpRsSupCOdDiag"
    meta.rnFormat = "rssupCOdDiag-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Supervisor Module"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37725, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39864, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 12561, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(1, 16000)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12560, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3203
    prop.defaultValueStr = "eqptSupC"
    prop._addConstant("eqptSupC", None, 3203)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12559, PropCategory.REGULAR)
