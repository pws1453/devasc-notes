...
class SpTsOdFc(Mo):
    """
    The diagnostic on-demand test set to run on spine fabric cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsOdFc")

    meta.moClassName = "eqptdiagpSpTsOdFc"
    meta.rnFormat = "spOdFcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Fabric-card On-demand Diags"
    ...
    meta.childClasses.add("cobra.model.eqptdiagp.RsFcOdDiag")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqptdiagp.RsFcOdDiag", "rsfcOdDiag-"))
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.FcTsOd")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1934, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37720, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1932, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39859, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1933, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6405, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
