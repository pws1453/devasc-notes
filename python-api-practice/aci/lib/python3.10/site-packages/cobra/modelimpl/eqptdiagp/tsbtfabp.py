...
class TsBtFabP(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiagp.TsBtFabP")

    meta.moClassName = "eqptdiagpTsBtFabP"
    meta.rnFormat = "btFpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Bootup Diag Policy Set for Fabric Port Types"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1958, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37733, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1956, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39872, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1957, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6409, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
