...
# ##################################################
class TsHlExtChFP(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsHlExtChFP")

    meta.moClassName = "eqptdiagpTsHlExtChFP"
    meta.rnFormat = "hlEFpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Health Diag Policy Set for ExtCh Fabric Port Types"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 15393, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 15391, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40228, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 15392, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 15402, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
