...
class LeTsBtSc(Mo):
    """
    The diagnostic test set for leaf fabric nodes to run at bootup on supervisor cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.LeTsBtSc")

    meta.moClassName = "eqptdiagpLeTsBtSc"
    meta.rnFormat = "leBtSupDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Bootup Diag Policy for the Leaf Node Supervisor Line Cards"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1876, PropCategory.REGULAR)
    prop.label = "Bitmask of Diagnostics Test Groups any Failure                                  of which should Keep the Node Down"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37702, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1874, PropCategory.REGULAR)
    prop.label = "Bitmask of Diagnostics Test Groups to be Run"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39841, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1875, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6390, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
