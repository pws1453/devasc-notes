...
class TsBtLeafP(Mo):
    """
    The diagnostic test set for leaf fabric ports to run at bootup on line cards (I/O cards).

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsBtLeafP")

    meta.moClassName = "eqptdiagpTsBtLeafP"
    meta.rnFormat = "btLpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Bootup Diag Policy Set for Leaf Port Types"
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.PortTestSetBt")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1949, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37730, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1947, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39869, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1948, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6410, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
