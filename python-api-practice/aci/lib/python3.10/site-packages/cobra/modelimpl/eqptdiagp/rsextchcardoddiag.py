...
class RsExtChCardOdDiag(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.eqptdiagp.RsExtChCardOdDiag", "cobra.model.eqpt.ExtChCard")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "eqptdiagpRsExtChCardOdDiag"
    meta.rnFormat = "rsextChCardOdDiag-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Extended Chassis Module"
    ...
    meta.rnPrefixes = [
        ('rsextChCardOdDiag-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37729, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39868, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 12577, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(1, 16000)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12576, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3207
    prop.defaultValueStr = "eqptExtChCard"
    prop._addConstant("eqptExtChCard", None, 3207)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12575, PropCategory.REGULAR)
