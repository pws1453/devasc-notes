...
class LeTsHlLc(Mo):
    """
    The diagnostic ongoing health test set for leaf fabric nodes to run on line cards (I/O cards).

    """

    meta = ClassMeta("cobra.model.eqptdiagp.LeTsHlLc")

    meta.moClassName = "eqptdiagpLeTsHlLc"
    meta.rnFormat = "leHlLcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Leaf Linecard Health Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1888, PropCategory.REGULAR)
    prop.label = "Bitmask of Diagnostics Tests any Failure of                                  which should Keep the Node Down"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("asic", "asic", 16)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37706, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1886, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39845, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6392, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
