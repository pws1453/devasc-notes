...
class LeTsHlEcc(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiagp.LeTsHlEcc")

    meta.moClassName = "eqptdiagpLeTsHlEcc"
    meta.rnFormat = "leHlEccDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Leaf Health Diag Policy Set for the Extended Chassis Card Type"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1891, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37707, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1889, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39846, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1890, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6391, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
