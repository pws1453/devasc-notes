...
class SpTsBtSc(Mo):
    """
    The diagnostic test set to run at bootup on spine supervisor cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsBtSc")

    meta.moClassName = "eqptdiagpSpTsBtSc"
    meta.rnFormat = "spBtScDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Sup-card Bootup Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1913, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37713, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1911, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39852, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1912, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6399, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
