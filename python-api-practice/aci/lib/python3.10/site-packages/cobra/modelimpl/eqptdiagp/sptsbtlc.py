...
class SpTsBtLc(Mo):
    """
    The diagnostic test set to run at bootup on spine line cards (I/O cards).

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsBtLc")

    meta.moClassName = "eqptdiagpSpTsBtLc"
    meta.rnFormat = "spBtLcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Linecard Bootup Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1907, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1905, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39850, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1906, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6398, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
