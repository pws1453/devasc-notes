...
class SpTsHlFc(Mo):
    """
    The ongoing diagnostic health test set to run at bootup on spine fabric cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsHlFc")

    meta.moClassName = "eqptdiagpSpTsHlFc"
    meta.rnFormat = "spHlFcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Fabric-card Health Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1922, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37716, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1920, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39855, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6401, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
