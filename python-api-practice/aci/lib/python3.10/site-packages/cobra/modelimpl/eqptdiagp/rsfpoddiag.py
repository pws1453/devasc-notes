...
class RsFpOdDiag(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.eqptdiagp.RsFpOdDiag", "cobra.model.eqpt.FabP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "eqptdiagpRsFpOdDiag"
    meta.rnFormat = "rsfpOdDiag-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Fabric Port for On-Demand Diag Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37724, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39863, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 12557, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(1, 16000)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12556, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3004
    prop.defaultValueStr = "eqptFabP"
    prop._addConstant("eqptFabP", None, 3004)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12555, PropCategory.REGULAR)
