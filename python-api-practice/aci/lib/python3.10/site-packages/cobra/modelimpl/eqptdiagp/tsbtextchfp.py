...
# ##################################################
class TsBtExtChFP(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsBtExtChFP")

    meta.moClassName = "eqptdiagpTsBtExtChFP"
    meta.rnFormat = "btEFpDiags-%(name)s"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 15390, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38088, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 15388, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40227, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 15389, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 15400, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
