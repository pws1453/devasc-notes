...
class LeTsOdLc(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiagp.LeTsOdLc")

    meta.moClassName = "eqptdiagpLeTsOdLc"
    meta.rnFormat = "leOdLcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Leaf Linecard On-demand Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1897, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37709, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1895, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39848, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1896, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6395, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
