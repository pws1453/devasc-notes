...
class TsOdLeafP(Mo):
    """
    The diagnostic on-demand test set to run on leaf fabric ports.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsOdLeafP")

    meta.moClassName = "eqptdiagpTsOdLeafP"
    meta.rnFormat = "odLpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "On-Demand Diag Policy Set for Leaf Port Types"
    meta.writeAccessMask = 0x880100000000001
    meta.readAccessMask = 0x880100000000001
    ...
    meta.childClasses.add("cobra.model.eqptdiagp.RsLpOdDiag")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqptdiagp.RsLpOdDiag", "rslpOdDiag-"))
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.LpTsOd")
    meta.superClasses.add("cobra.model.eqptdiagp.PortTestSetOd")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1955, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37732, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1953, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39871, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1954, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6414, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
