...
class LeTsBtLc(Mo):
    """
    The diagnostic test set for leaf fabric nodes to run at bootup on line cards (I/O cards).

    """

    meta = ClassMeta("cobra.model.eqptdiagp.LeTsBtLc")

    meta.moClassName = "eqptdiagpLeTsBtLc"
    meta.rnFormat = "leBtLcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Leaf Linecard Bootup Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37703, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1877, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39842, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1878, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6389, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
