...
class LeTsOdSc(Mo):
    """
    The diagnostic on-demand test set for leaf fabric nodes to run on supervisor cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.LeTsOdSc")

    meta.moClassName = "eqptdiagpLeTsOdSc"
    meta.rnFormat = "leOdSupDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Leaf Line Card On-demand"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1894, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37708, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1892, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39847, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1893, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6396, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
