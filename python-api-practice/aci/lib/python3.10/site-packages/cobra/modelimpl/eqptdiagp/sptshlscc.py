...
class SpTsHlScc(Mo):
    """
    The ongoing diagnostic health test set to run at bootup on spine system controller cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsHlScc")

    meta.moClassName = "eqptdiagpSpTsHlScc"
    meta.rnFormat = "spHlSccDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Sys-controller-card Health Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1928, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37718, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1926, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39857, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1927, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6404, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
