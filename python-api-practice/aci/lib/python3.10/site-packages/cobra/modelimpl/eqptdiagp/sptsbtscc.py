...
class SpTsBtScc(Mo):
    """
    The diagnostic test set to run at bootup on spine system controller cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsBtScc")

    meta.moClassName = "eqptdiagpSpTsBtScc"
    meta.rnFormat = "spBtSccDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Sys-controller-card Bootup Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1916, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37714, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1914, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39853, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1915, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6400, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
