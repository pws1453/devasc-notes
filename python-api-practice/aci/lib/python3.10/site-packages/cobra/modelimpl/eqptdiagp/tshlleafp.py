...
class TsHlLeafP(Mo):
    """
    The ongoing diagnostic tests for leaf fabric ports.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsHlLeafP")

    meta.moClassName = "eqptdiagpTsHlLeafP"
    meta.rnFormat = "hlLpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Health Diag Policy Set for Leaf Port Types"
    meta.writeAccessMask = 0x8c0100000000001
    meta.readAccessMask = 0x8c0100000000001
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.PortTestSetHl")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.eqptdiagp.TestSetHealth")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1952, PropCategory.REGULAR)
    ...
    prop._addConstant("port", "port", 32)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37731, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1950, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39870, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "freq", "freq", 1944, PropCategory.REGULAR)
    prop.label = "Health Diag Test Frequency"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 300000
    prop.defaultValueStr = "every5mins"
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1951, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6412, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
