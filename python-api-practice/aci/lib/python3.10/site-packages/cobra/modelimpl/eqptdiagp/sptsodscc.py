...
class SpTsOdScc(Mo):
    """
    The diagnostic on-demand test set to run on spine system controller cards.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsOdScc")

    meta.moClassName = "eqptdiagpSpTsOdScc"
    meta.rnFormat = "spOdSccDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Sys-controller-card On-demand Diags"
    ...
    meta.childClasses.add("cobra.model.eqptdiagp.RsSysCOdDiag")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eqptdiagp.RsSysCOdDiag", "rssysCOdDiag-"))
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.SysCTsOd")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1940, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37722, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1938, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39861, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1939, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6408, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
