...
class SpTsHlLc(Mo):
    ...
    meta = ClassMeta("cobra.model.eqptdiagp.SpTsHlLc")

    meta.moClassName = "eqptdiagpSpTsHlLc"
    meta.rnFormat = "spHlLcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Linecard Health Diags"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1919, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37715, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1917, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39854, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6402, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
