...
class TsHlFabP(Mo):
    """
    The ongoing diagnostic health test set for fabric ports.

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsHlFabP")

    meta.moClassName = "eqptdiagpTsHlFabP"
    meta.rnFormat = "hlFpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Health Diag Policy Set for Fab Port Types"
    meta.writeAccessMask = 0x8000c0800000001
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1961, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1959, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39873, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1960, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6411, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
