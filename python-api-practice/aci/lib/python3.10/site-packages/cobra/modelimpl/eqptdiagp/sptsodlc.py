...
class SpTsOdLc(Mo):
    """
    The diagnostic on-demand test set to run on spine line cards (I/O cards).

    """

    meta = ClassMeta("cobra.model.eqptdiagp.SpTsOdLc")

    meta.moClassName = "eqptdiagpSpTsOdLc"
    meta.rnFormat = "spOdLcDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Spine Linecard On-demand Diags"
    ...
    meta.childClasses.add("cobra.model.eqptdiagp.RsLcOdDiag")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eqptdiagp.RsLcOdDiag", "rslcOdDiag-"))
    ...
    meta.superClasses.add("cobra.model.eqptdiagp.LcTsOd")
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 1931, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 37719, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 1929, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39858, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 1930, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6406, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
