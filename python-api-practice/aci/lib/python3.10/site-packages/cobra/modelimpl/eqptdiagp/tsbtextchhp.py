...
# ##################################################
class TsBtExtChHP(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.eqptdiagp.TsBtExtChHP")

    meta.moClassName = "eqptdiagpTsBtExtChHP"
    meta.rnFormat = "btEHpDiags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Bootup Diag Policy Set for ExtCh(fex) Host Port Types"
    ...
    prop = PropMeta("str", "actnFailBm", "actnFailBm", 15381, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38086, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "diagsBm", "diagsBm", 15379, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40225, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fullBm", "fullBm", 15380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 15401, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
