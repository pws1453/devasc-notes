...
class IngrBytesHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist1w", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist1w"
    meta.rnFormat = "HDl2IngrBytes1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6763, PropCategory.REGULAR)
