...
# ##################################################
class IngrPktsAgHist15min(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist15min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist15min"
    meta.rnFormat = "HDl2IngrPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrPktsAgHist")

    meta.rnPrefixes = [
        ('HDl2IngrPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6790, PropCategory.REGULAR)
