...
class BrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.l2.BrIf")

    meta.moClassName = "l2BrIf"
    meta.rnFormat = "br-[%(id)s]"
    ...
    meta.childClasses.add("cobra.model.l2.RsBrConf")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.RsBrConf", "rsbrConf"))
    ...
    prop = PropMeta("str", "id", "id", 6746, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14543, PropCategory.REGULAR)
