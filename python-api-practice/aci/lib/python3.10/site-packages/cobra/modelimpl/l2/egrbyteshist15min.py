...
# ##################################################
class EgrBytesHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist15min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist15min"
    meta.rnFormat = "HDl2EgrBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrBytesHist")

    meta.rnPrefixes = [
        ('HDl2EgrBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 21597, PropCategory.REGULAR)
