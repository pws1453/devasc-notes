...
# ##################################################
class IngrPktsAg1qtr(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg1qtr", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg1qtr"
    meta.rnFormat = "CDl2IngrPktsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 1 quarter"
