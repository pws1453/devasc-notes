...
# ##################################################
class IngrPktsPartHist5min(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist5min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist5min"
    meta.rnFormat = "HDl2IngrPktsPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6828, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6829, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
