...
# ##################################################
class EgrBytesAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAg1mo", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAg1mo"
    meta.rnFormat = "CDl2EgrBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress bytes stats in 1 month"
