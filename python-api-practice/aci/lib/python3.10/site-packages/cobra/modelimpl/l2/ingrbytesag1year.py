...
# ##################################################
class IngrBytesAg1year(Mo):
    """
    A class that represents the most current aggregated statistics for ingress bytes in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAg1year", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAg1year"
    meta.rnFormat = "CDl2IngrBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress bytes stats in 1 year"
