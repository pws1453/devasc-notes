...
class IngrPkts1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPkts1d", "ingress packets")
    ...
    meta.moClassName = "l2IngrPkts1d"
    meta.rnFormat = "CDl2IngrPkts1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress packets stats in 1 day"
