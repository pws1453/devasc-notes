...
# ##################################################
class IngrBytesAgHist1year(Mo):
    """
    A class that represents historical aggregated statistics for ingress bytes in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAgHist1year", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAgHist1year"
    meta.rnFormat = "HDl2IngrBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6756, PropCategory.REGULAR)
