...
# ##################################################
class IngrPktsPartHist1h(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist1h", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist1h"
    meta.rnFormat = "HDl2IngrPktsPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6818, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6819, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
