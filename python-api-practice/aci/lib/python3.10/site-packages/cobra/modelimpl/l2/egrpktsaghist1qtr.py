...
# ##################################################
class EgrPktsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAgHist1qtr", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAgHist1qtr"
    meta.rnFormat = "HDl2EgrPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 21633, PropCategory.REGULAR)
