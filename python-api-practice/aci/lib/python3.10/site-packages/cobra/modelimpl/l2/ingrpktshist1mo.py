...
class IngrPktsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPktsHist1mo", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsHist1mo"
    meta.rnFormat = "HDl2IngrPkts1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6801, PropCategory.REGULAR)
