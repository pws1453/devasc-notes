...
# ##################################################
class IngrBytesPart1year(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart1year", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart1year"
    meta.rnFormat = "CDl2IngrBytesPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6772, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
