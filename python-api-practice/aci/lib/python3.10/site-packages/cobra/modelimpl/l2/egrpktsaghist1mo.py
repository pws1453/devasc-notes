...
# ##################################################
class EgrPktsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAgHist1mo", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAgHist1mo"
    meta.rnFormat = "HDl2EgrPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 21632, PropCategory.REGULAR)
