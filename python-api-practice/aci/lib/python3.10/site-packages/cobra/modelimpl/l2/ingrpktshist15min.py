...
class IngrPktsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPktsHist15min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsHist15min"
    meta.rnFormat = "HDl2IngrPkts15min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6798, PropCategory.REGULAR)
