...
# ##################################################
class EgrPktsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAgHist1w", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAgHist1w"
    meta.rnFormat = "HDl2EgrPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 21634, PropCategory.REGULAR)
