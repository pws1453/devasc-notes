...
# ##################################################
class EgrBytes1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytes1qtr", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes1qtr"
    meta.rnFormat = "CDl2EgrBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats in 1 quarter"
