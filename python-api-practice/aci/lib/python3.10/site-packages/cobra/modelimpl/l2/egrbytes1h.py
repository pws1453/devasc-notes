...
class EgrBytes1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytes1h", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes1h"
    meta.rnFormat = "CDl2EgrBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats in 1 hour"
