...
class IngrPkts5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPkts5min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPkts5min"
    meta.rnFormat = "CDl2IngrPkts5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress packets stats in 5 minute"
