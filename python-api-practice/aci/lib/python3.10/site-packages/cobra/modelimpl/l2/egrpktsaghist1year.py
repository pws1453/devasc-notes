...
# ##################################################
class EgrPktsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAgHist1year", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAgHist1year"
    meta.rnFormat = "HDl2EgrPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 21635, PropCategory.REGULAR)
