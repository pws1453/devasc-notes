...
# ##################################################
class EgrBytesPart1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPart1year", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPart1year"
    meta.rnFormat = "CDl2EgrBytesPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21611, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
