...
# ##################################################
class IngrPktsPart15min(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart15min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart15min"
    meta.rnFormat = "CDl2IngrPktsPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrPktsPart")
    meta.superClasses.add("cobra.model.stats.Curr")
    meta.superClasses.add("cobra.model.stats.CurrAgPart")

    meta.rnPrefixes = [
        ('CDl2IngrPktsPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6806, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
