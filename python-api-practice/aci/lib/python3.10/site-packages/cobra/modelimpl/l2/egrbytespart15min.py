...
class EgrBytesPart15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesPart15min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPart15min"
    meta.rnFormat = "CDl2EgrBytesPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress bytes stats in 15 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21605, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
