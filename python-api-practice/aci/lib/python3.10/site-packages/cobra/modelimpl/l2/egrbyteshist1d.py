...
class EgrBytesHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist1d", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist1d"
    meta.rnFormat = "HDl2EgrBytes1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 21598, PropCategory.REGULAR)
