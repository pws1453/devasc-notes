...
# ##################################################
class EgrBytesPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist1h", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist1h"
    meta.rnFormat = "HDl2EgrBytesPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 21617, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21618, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
