...
# ##################################################
class IngrBytesAgHist1h(Mo):
    """
    A class that represents historical aggregated statistics for ingress bytes in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAgHist1h", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAgHist1h"
    meta.rnFormat = "HDl2IngrBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6752, PropCategory.REGULAR)
