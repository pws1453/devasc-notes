...
class IngrBytesHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist15min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist15min"
    meta.rnFormat = "HDl2IngrBytes15min-%(index)s"
    ...
    meta.superClasses.add("cobra.model.l2.IngrBytesHist")

    meta.rnPrefixes = [
        ('HDl2IngrBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6758, PropCategory.REGULAR)
