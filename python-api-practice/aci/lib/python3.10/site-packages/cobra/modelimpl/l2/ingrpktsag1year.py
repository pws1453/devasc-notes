...
# ##################################################
class IngrPktsAg1year(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg1year", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg1year"
    meta.rnFormat = "CDl2IngrPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 1 year"
