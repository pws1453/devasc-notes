...
# ##################################################
class IngrBytesPartHist5min(Mo):
    """
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist5min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist5min"
    meta.rnFormat = "HDl2IngrBytesPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6788, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6789, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
