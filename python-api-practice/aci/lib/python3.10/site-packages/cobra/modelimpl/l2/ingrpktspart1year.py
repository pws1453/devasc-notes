...
# ##################################################
class IngrPktsPart1year(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart1year", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart1year"
    meta.rnFormat = "CDl2IngrPktsPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6812, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
