...
class IngrPkts1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPkts1mo", "ingress packets")
    ...
    meta.moClassName = "l2IngrPkts1mo"
    meta.rnFormat = "CDl2IngrPkts1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress packets stats in 1 month"
