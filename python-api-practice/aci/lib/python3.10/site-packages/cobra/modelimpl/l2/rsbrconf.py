...
class RsBrConf(Mo):
    """
    A source relation to an L1 interface.

    """

    meta = SourceRelationMeta("cobra.model.l2.RsBrConf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "l2RsBrConf"
    meta.rnFormat = "rsbrConf"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15088, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12717, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12716, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15087, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
