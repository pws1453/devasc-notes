...
# ##################################################
class EgrPktsPart15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart15min", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart15min"
    meta.rnFormat = "CDl2EgrPktsPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrPktsPart")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl2EgrPktsPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21645, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
