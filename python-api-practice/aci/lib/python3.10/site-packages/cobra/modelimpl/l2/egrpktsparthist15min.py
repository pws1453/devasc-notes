...
# ##################################################
class EgrPktsPartHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist15min", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist15min"
    meta.rnFormat = "HDl2EgrPktsPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrPktsPartHist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDl2EgrPktsPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 21653, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21654, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
