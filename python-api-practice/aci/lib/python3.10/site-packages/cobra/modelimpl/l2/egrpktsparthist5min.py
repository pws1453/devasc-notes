...
# ##################################################
class EgrPktsPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist5min", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist5min"
    meta.rnFormat = "HDl2EgrPktsPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 21667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21668, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
