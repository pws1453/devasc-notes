...
# ##################################################
class RsDot1pRuleAtt(Mo):
    """
    A source relation to the set of Dot1P rules. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l2.RsDot1pRuleAtt", "cobra.model.qosp.Dot1pRule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l2RsDot1pRuleAtt"
    meta.rnFormat = "rsdot1pRuleAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15792, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operStQual", "operStQual", 12729, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "operState", "operState", 12730, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15097, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 15185, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("l2:RsDot1pRuleAttforceResolve_failed_flag", None, 4)
    prop._addConstant("l2:RsDot1pRuleAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("l2:RsDot1pRuleAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("l2:RsDot1pRuleAttmonPolDn_failed_flag", None, 128)
    prop._addConstant("l2:RsDot1pRuleAttparentSKey_failed_flag", None, 1024)
    prop._addConstant("l2:RsDot1pRuleAttrType_failed_flag", None, 8)
    prop._addConstant("l2:RsDot1pRuleAttstateQual_failed_flag", None, 32)
    prop._addConstant("l2:RsDot1pRuleAttstate_failed_flag", None, 16)
    prop._addConstant("l2:RsDot1pRuleAtttCl_failed_flag", None, 1)
    prop._addConstant("l2:RsDot1pRuleAtttDn_failed_flag", None, 2)
    prop._addConstant("l2:RsDot1pRuleAtttType_failed_flag", None, 64)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 15187, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 15186, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12728, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12727, PropCategory.REGULAR)
