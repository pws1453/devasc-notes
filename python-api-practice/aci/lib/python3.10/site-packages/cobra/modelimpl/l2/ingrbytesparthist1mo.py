...
# ##################################################
class IngrBytesPartHist1mo(Mo):
    """
    A class that represents historical portion of the statistics for ingress bytes in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist1mo", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist1mo"
    meta.rnFormat = "HDl2IngrBytesPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6780, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6781, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
