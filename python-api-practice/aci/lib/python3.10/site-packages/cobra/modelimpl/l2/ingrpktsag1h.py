...
# ##################################################
class IngrPktsAg1h(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg1h", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg1h"
    meta.rnFormat = "CDl2IngrPktsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 1 hour"
