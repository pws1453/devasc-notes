...
# ##################################################
class EgrPktsPart1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart1qtr", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart1qtr"
    meta.rnFormat = "CDl2EgrPktsPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21649, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
