...
# ##################################################
class EgrPktsPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist1year", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist1year"
    meta.rnFormat = "HDl2EgrPktsPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 21665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21666, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
