...
# ##################################################
class IngrBytesAgHist1d(Mo):
    """
    A class that represents historical aggregated statistics for ingress bytes in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAgHist1d", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAgHist1d"
    meta.rnFormat = "HDl2IngrBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6751, PropCategory.REGULAR)
