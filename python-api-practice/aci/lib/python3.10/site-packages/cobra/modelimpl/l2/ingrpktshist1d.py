...
class IngrPktsHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPktsHist1d", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsHist1d"
    meta.rnFormat = "HDl2IngrPkts1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6799, PropCategory.REGULAR)
