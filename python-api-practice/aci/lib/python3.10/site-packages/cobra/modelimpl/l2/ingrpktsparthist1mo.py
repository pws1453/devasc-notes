...
# ##################################################
class IngrPktsPartHist1mo(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist1mo", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist1mo"
    meta.rnFormat = "HDl2IngrPktsPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6820, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6821, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
