...
class IngrBytesHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist1d", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist1d"
    meta.rnFormat = "HDl2IngrBytes1d-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6759, PropCategory.REGULAR)
