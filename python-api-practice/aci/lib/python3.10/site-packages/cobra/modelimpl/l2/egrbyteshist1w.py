...
class EgrBytesHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist1w", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist1w"
    meta.rnFormat = "HDl2EgrBytes1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 21602, PropCategory.REGULAR)
