...
# ##################################################
class EgrBytesPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist1w", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist1w"
    meta.rnFormat = "HDl2EgrBytesPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 21623, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21624, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
