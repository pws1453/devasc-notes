...
# ##################################################
class IngrPktsPartHist1year(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist1year", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist1year"
    meta.rnFormat = "HDl2IngrPktsPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6826, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6827, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
