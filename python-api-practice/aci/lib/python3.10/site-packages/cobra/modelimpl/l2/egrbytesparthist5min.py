...
# ##################################################
class EgrBytesPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist5min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist5min"
    meta.rnFormat = "HDl2EgrBytesPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 21627, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21628, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
