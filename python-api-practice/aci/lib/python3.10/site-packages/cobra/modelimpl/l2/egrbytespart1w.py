...
# ##################################################
class EgrBytesPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPart1w", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPart1w"
    meta.rnFormat = "CDl2EgrBytesPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21610, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
