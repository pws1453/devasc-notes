...
# ##################################################
class RtL2PortSecurityPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l2.RtL2PortSecurityPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "l2RtL2PortSecurityPol"
    meta.rnFormat = "rtinfraL2PortSecurityPol-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x4300000000001
    ...
    prop = PropMeta("str", "tCl", "tCl", 25962, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25961, PropCategory.REGULAR)
