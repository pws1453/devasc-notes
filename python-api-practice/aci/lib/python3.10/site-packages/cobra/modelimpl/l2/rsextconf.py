...
class RsExtConf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l2.RsExtConf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "l2RsExtConf"
    meta.rnFormat = "rsextConf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Eth Interface Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15084, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12714, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12713, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15083, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
