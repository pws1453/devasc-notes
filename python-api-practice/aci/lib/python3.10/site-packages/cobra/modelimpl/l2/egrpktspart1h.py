...
# ##################################################
class EgrPktsPart1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart1h", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart1h"
    meta.rnFormat = "CDl2EgrPktsPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21647, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
