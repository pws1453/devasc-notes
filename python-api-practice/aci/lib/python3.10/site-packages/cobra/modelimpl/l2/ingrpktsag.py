...
# ##################################################
class IngrPktsAg(Mo):
    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg"


    meta.moClassName = "l2IngrPktsAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg1w")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg5min")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg1year")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg1mo")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg1qtr")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg1d")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg1h")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAg15min")
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 9951, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 9952, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 9957, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 9953, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 9954, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 9956, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 9955, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "ingress drop packets trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTrBase", prop)

    prop = PropMeta("str", "floodCum", "floodCum", 10012, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress flood packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodCum", prop)

    prop = PropMeta("str", "floodPer", "floodPer", 10013, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress flood packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPer", prop)

    prop = PropMeta("str", "floodRate", "floodRate", 10018, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress flood packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodRate", prop)

    prop = PropMeta("str", "floodSpct", "floodSpct", 10014, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress flood packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodSpct", prop)

    prop = PropMeta("str", "floodThr", "floodThr", 10015, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodTr", "floodTr", 10017, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress flood packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodTr", prop)

    prop = PropMeta("str", "floodTrBase", "floodTrBase", 10016, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "multicastCum", "multicastCum", 10073, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress multicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 10074, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress multicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 10079, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress multicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 10075, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress multicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 10076, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 10078, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress multicast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastTr", prop)

    prop = PropMeta("str", "multicastTrBase", "multicastTrBase", 10077, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 10134, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 10135, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 10140, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 10136, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 10137, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 10139, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress unicast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 10138, PropCategory.IMPLICIT_TREND_BASE)
