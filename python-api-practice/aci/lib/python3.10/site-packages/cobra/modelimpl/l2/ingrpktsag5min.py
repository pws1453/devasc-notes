...
# ##################################################
class IngrPktsAg5min(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg5min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg5min"
    meta.rnFormat = "CDl2IngrPktsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 5 minute"
