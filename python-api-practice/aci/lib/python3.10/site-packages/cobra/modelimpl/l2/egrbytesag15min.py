...
# ##################################################
class EgrBytesAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAg15min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAg15min"
    meta.rnFormat = "CDl2EgrBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress bytes stats in 15 minute"
