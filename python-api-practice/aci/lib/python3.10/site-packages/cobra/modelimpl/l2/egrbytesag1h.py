...
# ##################################################
class EgrBytesAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAg1h", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAg1h"
    meta.rnFormat = "CDl2EgrBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress bytes stats in 1 hour"
