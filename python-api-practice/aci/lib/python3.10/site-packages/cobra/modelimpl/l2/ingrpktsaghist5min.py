...
# ##################################################
class IngrPktsAgHist5min(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist5min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist5min"
    meta.rnFormat = "HDl2IngrPktsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 6797, PropCategory.REGULAR)
