...
# ##################################################
class EgrPktsPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist1qtr", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist1qtr"
    meta.rnFormat = "HDl2EgrPktsPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 21661, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21662, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
