...
# ##################################################
class IngrBytesPart1qtr(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart1qtr", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart1qtr"
    meta.rnFormat = "CDl2IngrBytesPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6770, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
