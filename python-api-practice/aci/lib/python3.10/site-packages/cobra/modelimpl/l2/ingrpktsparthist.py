...
# ##################################################
class IngrPktsPartHist(Mo):
    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist"


    meta.moClassName = "l2IngrPktsPartHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist1mo")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist1h")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist5min")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist1qtr")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist1d")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist15min")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist1year")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsPartHist1w")
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 9946, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress drop packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 9942, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 9945, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress drop packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 9944, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress drop packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 9943, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 9950, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 9947, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 9948, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 9949, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "floodAvg", "floodAvg", 10007, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress flood packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodAvg", prop)

    prop = PropMeta("str", "floodCum", "floodCum", 10003, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress flood packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodCum", prop)

    prop = PropMeta("str", "floodMax", "floodMax", 10006, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress flood packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMax", prop)

    prop = PropMeta("str", "floodMin", "floodMin", 10005, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress flood packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMin", prop)

    prop = PropMeta("str", "floodPer", "floodPer", 10004, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress flood packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPer", prop)

    prop = PropMeta("str", "floodRate", "floodRate", 10011, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress flood packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodRate", prop)

    prop = PropMeta("str", "floodSpct", "floodSpct", 10008, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress flood packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodSpct", prop)

    prop = PropMeta("str", "floodThr", "floodThr", 10009, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodTr", "floodTr", 10010, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 10068, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress multicast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 10064, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress multicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 10067, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress multicast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 10066, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress multicast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 10065, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress multicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 10072, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress multicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 10069, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress multicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 10070, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 10071, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 10129, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress unicast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 10125, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 10128, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress unicast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 10127, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress unicast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 10126, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 10133, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 10130, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 10131, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 10132, PropCategory.IMPLICIT_TREND)
