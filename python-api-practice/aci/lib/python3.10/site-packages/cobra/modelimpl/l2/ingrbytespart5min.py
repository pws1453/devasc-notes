...
# ##################################################
class IngrBytesPart5min(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart5min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart5min"
    meta.rnFormat = "CDl2IngrBytesPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6773, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
