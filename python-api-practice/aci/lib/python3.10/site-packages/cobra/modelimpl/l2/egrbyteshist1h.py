...
class EgrBytesHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist1h", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist1h"
    meta.rnFormat = "HDl2EgrBytes1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 21599, PropCategory.REGULAR)
