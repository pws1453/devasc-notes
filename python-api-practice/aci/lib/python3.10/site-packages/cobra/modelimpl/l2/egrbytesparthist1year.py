...
# ##################################################
class EgrBytesPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist1year", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist1year"
    meta.rnFormat = "HDl2EgrBytesPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 21625, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21626, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
