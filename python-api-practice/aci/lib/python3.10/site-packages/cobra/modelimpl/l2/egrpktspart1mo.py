...
# ##################################################
class EgrPktsPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart1mo", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart1mo"
    meta.rnFormat = "CDl2EgrPktsPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21648, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
