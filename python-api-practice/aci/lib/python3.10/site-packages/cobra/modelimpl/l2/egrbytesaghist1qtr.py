...
# ##################################################
class EgrBytesAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist1qtr", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist1qtr"
    meta.rnFormat = "HDl2EgrBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 21593, PropCategory.REGULAR)
