...
# ##################################################
class EgrPktsPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist1h", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist1h"
    meta.rnFormat = "HDl2EgrPktsPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 21657, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21658, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
