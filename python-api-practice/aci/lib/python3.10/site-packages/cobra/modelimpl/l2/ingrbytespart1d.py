...
# ##################################################
class IngrBytesPart1d(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart1d", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart1d"
    meta.rnFormat = "CDl2IngrBytesPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6767, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
