...
# ##################################################
class RtEPgDefToL2Dom(Mo):
    """
    A target relation to the layer 2 flood domain.

    """

    meta = TargetRelationMeta("cobra.model.l2.RtEPgDefToL2Dom", "cobra.model.fv.EPgDef")

    meta.moClassName = "l2RtEPgDefToL2Dom"
    meta.rnFormat = "rtfvEPgDefToL2Dom-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15305, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 15274, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2076
    prop.defaultValueStr = "fvEPgDef"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15273, PropCategory.REGULAR)
