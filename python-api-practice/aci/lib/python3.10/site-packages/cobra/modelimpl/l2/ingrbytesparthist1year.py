...
# ##################################################
class IngrBytesPartHist1year(Mo):
    """
    A class that represents historical portion of the statistics for ingress bytes in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist1year", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist1year"
    meta.rnFormat = "HDl2IngrBytesPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6786, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6787, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
