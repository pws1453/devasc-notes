...
# ##################################################
class IngrPktsPartHist1d(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist1d", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist1d"
    meta.rnFormat = "HDl2IngrPktsPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6816, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6817, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
