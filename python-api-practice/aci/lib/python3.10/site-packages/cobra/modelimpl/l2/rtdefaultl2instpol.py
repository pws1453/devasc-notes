...
# ##################################################
class RtDefaultL2InstPol(Mo):
    """
    A target relation to L2 instance policy information. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.l2.RtDefaultL2InstPol", "cobra.model.vmm.DomP")

    meta.moClassName = "l2RtDefaultL2InstPol"
    meta.rnFormat = "rtvmmDefaultL2InstPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "VMM Domain"
    meta.writeAccessMask = 0x4000000001
    meta.readAccessMask = 0x4000000011
    ...
    prop = PropMeta("str", "tCl", "tCl", 12474, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12473, PropCategory.REGULAR)
