...
# ##################################################
class EgrPktsPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist1mo", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist1mo"
    meta.rnFormat = "HDl2EgrPktsPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 21659, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21660, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
