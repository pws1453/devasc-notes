...
class IngrPkts1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPkts1year", "ingress packets")
    ...
    meta.moClassName = "l2IngrPkts1year"
    meta.rnFormat = "CDl2IngrPkts1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress packets stats in 1 year"
