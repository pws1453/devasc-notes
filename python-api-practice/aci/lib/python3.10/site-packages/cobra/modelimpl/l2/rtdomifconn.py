...
# ##################################################
class RtDomIfConn(Mo):
    """
    A target relation to the layer 2 flood domain.

    """

    meta = TargetRelationMeta("cobra.model.l2.RtDomIfConn", "cobra.model.fv.AIfConn")

    meta.moClassName = "l2RtDomIfConn"
    meta.rnFormat = "rtfvDomIfConn-[%(tDn)s]"
    ...
    meta.superClasses.add("cobra.model.fv.CustomRtDomIfConn")
    ...
    prop = PropMeta("str", "tCl", "tCl", 15261, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8798
    prop.defaultValueStr = "fvAIfConn"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15260, PropCategory.REGULAR)
