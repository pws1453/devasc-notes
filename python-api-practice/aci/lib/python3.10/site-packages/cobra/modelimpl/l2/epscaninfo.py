...
class EpScanInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.l2.EpScanInfo")

    meta.moClassName = "l2EpScanInfo"
    meta.rnFormat = "epsScanInfo"
    meta.category = MoCategory.REGULAR
    meta.label = "Information about EP Scan Logic"
    ...
    prop = PropMeta("str", "epUpSeqNum", "epUpSeqNum", 22040, PropCategory.REGULAR)
