...
# ##################################################
class RtL2InstPol(Mo):
    """
    A target relation to a policy providing physical configuration of the interfaces. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.l2.RtL2InstPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "l2RtL2InstPol"
    meta.rnFormat = "rtinfraL2InstPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13224, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13223, PropCategory.REGULAR)
