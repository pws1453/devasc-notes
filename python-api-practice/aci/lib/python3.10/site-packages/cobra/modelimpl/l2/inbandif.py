...
class InbandIf(Mo):
    ...
    meta = ClassMeta("cobra.model.l2.InbandIf")

    meta.moClassName = "l2InbandIf"
    meta.rnFormat = "inb-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Layer2 Inband Interface"
    meta.writeAccessMask = 0x200000000001
    meta.readAccessMask = 0x200000000025
    ...
    meta.childClasses.add("cobra.model.l2.RsInbandConf")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.RsInbandConf", "rsInbandConf"))
    ...
    meta.superClasses.add("cobra.model.l2.If")
    ...
    prop = PropMeta("str", "id", "id", 6749, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14541, PropCategory.REGULAR)
