...
# ##################################################
class IngrBytesAg15min(Mo):
    """
    A class that represents the most current aggregated statistics for ingress bytes in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAg15min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAg15min"
    meta.rnFormat = "CDl2IngrBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrBytesAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl2IngrBytesAg15min', False),
    ]
