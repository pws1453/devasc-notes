...
# ##################################################
class EgrBytesAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAg1d", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAg1d"
    meta.rnFormat = "CDl2EgrBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress bytes stats in 1 day"
