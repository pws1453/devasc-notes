...
# ##################################################
class EgrBytes5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytes5min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes5min"
    meta.rnFormat = "CDl2EgrBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats in 5 minute"
