...
# ##################################################
class RsAaaRadiusProviderGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l2.RsAaaRadiusProviderGroup", "cobra.model.aaa.RadiusProviderGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2RsAaaRadiusProviderGroup"
    meta.rnFormat = "rsaaaRadiusProviderGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Radius Provider Group Policy"
    ...
    meta.rnPrefixes = [
        ('rsaaaRadiusProviderGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38694, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40833, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33249, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33245, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1610
    prop.defaultValueStr = "aaaRadiusProviderGroup"
    prop._addConstant("aaaRadiusProviderGroup", None, 1610)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33489, PropCategory.REGULAR)
