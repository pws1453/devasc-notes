...
# ##################################################
class IngrPktsPart1d(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart1d", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart1d"
    meta.rnFormat = "CDl2IngrPktsPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6807, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
