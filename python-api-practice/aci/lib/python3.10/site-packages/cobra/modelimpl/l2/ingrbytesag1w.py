...
# ##################################################
class IngrBytesAg1w(Mo):
    """
    A class that represents the most current aggregated statistics for ingress bytes in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAg1w", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAg1w"
    meta.rnFormat = "CDl2IngrBytesAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress bytes stats in 1 week"
