...
# ##################################################
class IngrPktsAgHist1year(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist1year", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist1year"
    meta.rnFormat = "HDl2IngrPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6796, PropCategory.REGULAR)
