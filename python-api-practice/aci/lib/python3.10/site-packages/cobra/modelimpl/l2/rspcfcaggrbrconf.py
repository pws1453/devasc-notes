...
# ##################################################
class RsPcFcAggrBrConf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l2.RsPcFcAggrBrConf", "cobra.model.pc.FcAggrIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "l2RsPcFcAggrBrConf"
    meta.rnFormat = "rsPcFcAggrBrConf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "FC Aggregated Interface Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39236, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 39164, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39163, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 39235, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
