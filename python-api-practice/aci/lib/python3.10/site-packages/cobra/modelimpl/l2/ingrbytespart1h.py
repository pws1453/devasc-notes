...
# ##################################################
class IngrBytesPart1h(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart1h", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart1h"
    meta.rnFormat = "CDl2IngrBytesPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6768, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
