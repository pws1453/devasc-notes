...
# ##################################################
class IngrPktsAg15min(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg15min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg15min"
    meta.rnFormat = "CDl2IngrPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrPktsAg")

    meta.rnPrefixes = [
        ('CDl2IngrPktsAg15min', False),
    ]
