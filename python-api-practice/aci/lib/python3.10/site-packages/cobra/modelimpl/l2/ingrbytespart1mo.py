...
# ##################################################
class IngrBytesPart1mo(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart1mo", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart1mo"
    meta.rnFormat = "CDl2IngrBytesPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6769, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
