...
# ##################################################
class IngrBytesAgHist15min(Mo):
    """
    A class that represents historical aggregated statistics for ingress bytes in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAgHist15min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAgHist15min"
    meta.rnFormat = "HDl2IngrBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrBytesAgHist")

    meta.rnPrefixes = [
        ('HDl2IngrBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6750, PropCategory.REGULAR)
