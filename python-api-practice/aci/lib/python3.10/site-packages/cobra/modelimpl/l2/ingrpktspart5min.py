...
# ##################################################
class IngrPktsPart5min(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart5min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart5min"
    meta.rnFormat = "CDl2IngrPktsPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6813, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
