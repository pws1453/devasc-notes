...
# ##################################################
class EgrBytesAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAg1year", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAg1year"
    meta.rnFormat = "CDl2EgrBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress bytes stats in 1 year"
