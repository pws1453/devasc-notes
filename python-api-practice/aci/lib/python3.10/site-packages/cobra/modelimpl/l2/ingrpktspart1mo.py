...
# ##################################################
class IngrPktsPart1mo(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart1mo", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart1mo"
    meta.rnFormat = "CDl2IngrPktsPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6809, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
