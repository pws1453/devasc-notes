...
# ##################################################
class EgrBytesPartHist(Mo):
    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist"


    meta.moClassName = "l2EgrBytesPartHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist1d")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist5min")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist1h")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist1mo")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist15min")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist1year")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist1w")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesPartHist1qtr")
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 21706, PropCategory.IMPLICIT_AVG)
    prop.label = "egress multicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 21702, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress multicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 21705, PropCategory.IMPLICIT_MAX)
    prop.label = "egress multicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 21704, PropCategory.IMPLICIT_MIN)
    prop.label = "egress multicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 21703, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress multicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 21710, PropCategory.IMPLICIT_RATE)
    prop.label = "egress multicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 21707, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress multicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 21708, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 21709, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 21761, PropCategory.IMPLICIT_AVG)
    prop.label = "egress unicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 21757, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 21760, PropCategory.IMPLICIT_MAX)
    prop.label = "egress unicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 21759, PropCategory.IMPLICIT_MIN)
    prop.label = "egress unicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 21758, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 21765, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 21762, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 21763, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 21764, PropCategory.IMPLICIT_TREND)
