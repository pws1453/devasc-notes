...
class RsFcBrConf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l2.RsFcBrConf", "cobra.model.l1.FcIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "l2RsFcBrConf"
    meta.rnFormat = "rsfcBrConf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fiber Channel Interface Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 39232, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 39161, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39160, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 39231, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
