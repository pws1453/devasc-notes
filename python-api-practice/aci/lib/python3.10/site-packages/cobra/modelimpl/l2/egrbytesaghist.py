...
# ##################################################
class EgrBytesAgHist(Mo):
    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist"


    meta.moClassName = "l2EgrBytesAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist1w")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist15min")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist1qtr")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist5min")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist1h")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist1year")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesAgHist1d")
    ...
    prop = PropMeta("str", "multicastCum", "multicastCum", 21718, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress multicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 21719, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress multicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 21723, PropCategory.IMPLICIT_RATE)
    prop.label = "egress multicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 21720, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress multicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 21721, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 21722, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 21773, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 21774, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 21778, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 21775, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 21776, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 21777, PropCategory.IMPLICIT_TREND)
