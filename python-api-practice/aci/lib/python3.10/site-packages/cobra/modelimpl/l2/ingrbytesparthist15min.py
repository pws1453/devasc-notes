...
# ##################################################
class IngrBytesPartHist15min(Mo):
    """
    A class that represents historical portion of the statistics for ingress bytes in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist15min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist15min"
    meta.rnFormat = "HDl2IngrBytesPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrBytesPartHist")
    meta.superClasses.add("cobra.model.stats.HistAgPart")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDl2IngrBytesPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6774, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6775, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
