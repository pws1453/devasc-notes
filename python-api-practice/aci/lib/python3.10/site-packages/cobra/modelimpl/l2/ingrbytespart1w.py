...
# ##################################################
class IngrBytesPart1w(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart1w", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart1w"
    meta.rnFormat = "CDl2IngrBytesPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6771, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
