...
class IngrBytesHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist5min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist5min"
    meta.rnFormat = "HDl2IngrBytes5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6765, PropCategory.REGULAR)
