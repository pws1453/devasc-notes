...
class IngrBytes15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytes15min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytes15min"
    meta.rnFormat = "CDl2IngrBytes15min"
    ...
    meta.superClasses.add("cobra.model.l2.IngrBytes")

    meta.rnPrefixes = [
        ('CDl2IngrBytes15min', False),
    ]
