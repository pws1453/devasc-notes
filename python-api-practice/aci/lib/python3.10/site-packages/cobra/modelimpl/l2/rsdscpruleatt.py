...
# ##################################################
class RsDscpRuleAtt(Mo):
    """
    A source relation to a set of DSCP rules. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l2.RsDscpRuleAtt", "cobra.model.qosp.DscpRule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l2RsDscpRuleAtt"
    meta.rnFormat = "rsdscpRuleAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15791, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operStQual", "operStQual", 12735, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "operState", "operState", 12736, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15099, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 15182, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("l2:RsDscpRuleAttforceResolve_failed_flag", None, 4)
    prop._addConstant("l2:RsDscpRuleAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("l2:RsDscpRuleAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("l2:RsDscpRuleAttmonPolDn_failed_flag", None, 128)
    prop._addConstant("l2:RsDscpRuleAttparentSKey_failed_flag", None, 1024)
    prop._addConstant("l2:RsDscpRuleAttrType_failed_flag", None, 8)
    prop._addConstant("l2:RsDscpRuleAttstateQual_failed_flag", None, 32)
    prop._addConstant("l2:RsDscpRuleAttstate_failed_flag", None, 16)
    prop._addConstant("l2:RsDscpRuleAtttCl_failed_flag", None, 1)
    prop._addConstant("l2:RsDscpRuleAtttDn_failed_flag", None, 2)
    prop._addConstant("l2:RsDscpRuleAtttType_failed_flag", None, 64)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 15184, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 15183, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12733, PropCategory.REGULAR)
