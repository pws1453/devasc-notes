...
class EgrBytesHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist1year", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist1year"
    meta.rnFormat = "HDl2EgrBytes1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 21603, PropCategory.REGULAR)
