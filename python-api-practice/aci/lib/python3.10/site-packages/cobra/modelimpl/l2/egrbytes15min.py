...
# ##################################################
class EgrBytes15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytes15min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes15min"
    meta.rnFormat = "CDl2EgrBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrBytes")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl2EgrBytes15min', False),
    ]
