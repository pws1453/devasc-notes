...
# ##################################################
class EgrBytesAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist1d", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist1d"
    meta.rnFormat = "HDl2EgrBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 21590, PropCategory.REGULAR)
