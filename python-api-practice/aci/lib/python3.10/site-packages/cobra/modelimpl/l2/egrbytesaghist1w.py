...
# ##################################################
class EgrBytesAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist1w", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist1w"
    meta.rnFormat = "HDl2EgrBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 21594, PropCategory.REGULAR)
