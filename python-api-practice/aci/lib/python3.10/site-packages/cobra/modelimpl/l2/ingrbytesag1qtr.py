...
# ##################################################
class IngrBytesAg1qtr(Mo):
    """
    A class that represents the most current aggregated statistics for ingress bytes in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAg1qtr", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAg1qtr"
    meta.rnFormat = "CDl2IngrBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress bytes stats in 1 quarter"
