...
# ##################################################
class EgrBytes1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytes1year", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes1year"
    meta.rnFormat = "CDl2EgrBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats in 1 year"
