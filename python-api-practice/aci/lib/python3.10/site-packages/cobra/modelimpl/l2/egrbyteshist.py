...
class EgrBytesHist(Mo):
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist1h")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist1mo")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist5min")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist1qtr")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist1d")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist1year")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist1w")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytesHist15min")
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 21685, PropCategory.IMPLICIT_AVG)
    prop.label = "egress multicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 21681, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress multicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 21684, PropCategory.IMPLICIT_MAX)
    prop.label = "egress multicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 21683, PropCategory.IMPLICIT_MIN)
    prop.label = "egress multicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 21682, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress multicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 21689, PropCategory.IMPLICIT_RATE)
    prop.label = "egress multicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 21686, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress multicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 21687, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 21688, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 21740, PropCategory.IMPLICIT_AVG)
    prop.label = "egress unicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 21736, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 21739, PropCategory.IMPLICIT_MAX)
    prop.label = "egress unicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 21738, PropCategory.IMPLICIT_MIN)
    prop.label = "egress unicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 21737, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 21744, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 21741, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 21742, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 21743, PropCategory.IMPLICIT_TREND)
