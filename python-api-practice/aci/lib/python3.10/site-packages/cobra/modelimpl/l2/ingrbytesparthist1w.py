...
# ##################################################
class IngrBytesPartHist1w(Mo):
    """
    A class that represents historical portion of the statistics for ingress bytes in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist1w", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist1w"
    meta.rnFormat = "HDl2IngrBytesPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6784, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6785, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
