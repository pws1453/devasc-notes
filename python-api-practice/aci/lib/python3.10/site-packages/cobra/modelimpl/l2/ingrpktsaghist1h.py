...
# ##################################################
class IngrPktsAgHist1h(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist1h", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist1h"
    meta.rnFormat = "HDl2IngrPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6792, PropCategory.REGULAR)
