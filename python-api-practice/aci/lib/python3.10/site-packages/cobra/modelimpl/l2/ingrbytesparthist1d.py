...
# ##################################################
class IngrBytesPartHist1d(Mo):
    """
    A class that represents historical portion of the statistics for ingress bytes in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist1d", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist1d"
    meta.rnFormat = "HDl2IngrBytesPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6776, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6777, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
