...
# ##################################################
class RsToLocalPcTagSubstitute(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l2.RsToLocalPcTagSubstitute", "cobra.model.l2.LocalPcTagSubstitute")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2RsToLocalPcTagSubstitute"
    meta.rnFormat = "rsToLocalPcTagSubstitute"
    ...
    meta.rnPrefixes = [
        ('rsToLocalPcTagSubstitute', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27493, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9263
    prop.defaultValueStr = "l2LocalPcTagSubstitute"
    prop._addConstant("l2LocalPcTagSubstitute", None, 9263)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27492, PropCategory.REGULAR)
