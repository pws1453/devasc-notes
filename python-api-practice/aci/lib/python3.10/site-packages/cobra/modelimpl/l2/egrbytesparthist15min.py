...
# ##################################################
class EgrBytesPartHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist15min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist15min"
    meta.rnFormat = "HDl2EgrBytesPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrBytesPartHist")

    meta.rnPrefixes = [
        ('HDl2EgrBytesPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 21613, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21614, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
