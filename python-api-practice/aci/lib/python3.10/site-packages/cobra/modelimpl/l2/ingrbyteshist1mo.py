...
class IngrBytesHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist1mo", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist1mo"
    meta.rnFormat = "HDl2IngrBytes1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6761, PropCategory.REGULAR)
