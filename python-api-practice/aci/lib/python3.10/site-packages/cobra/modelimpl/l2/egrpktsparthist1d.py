...
# ##################################################
class EgrPktsPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist1d", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist1d"
    meta.rnFormat = "HDl2EgrPktsPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 21655, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21656, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
