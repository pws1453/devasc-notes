...
class RsEthIf(Mo):
    """
    A source relation to an L1 interface. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l2.RsEthIf", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2RsEthIf"
    meta.rnFormat = "rsethIf"
    ...
    meta.parentClasses.add("cobra.model.mldsnoop.StRtrIf")
    ...
    meta.parentClasses.add("cobra.model.igmpsnoop.StRtrIf")
    ...
    meta.parentClasses.add("cobra.model.lacp.If")
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15072, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12699, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12698, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15071, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
