...
# ##################################################
class IngrBytesAg1h(Mo):
    """
    A class that represents the most current aggregated statistics for ingress bytes in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAg1h", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAg1h"
    meta.rnFormat = "CDl2IngrBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress bytes stats in 1 hour"
