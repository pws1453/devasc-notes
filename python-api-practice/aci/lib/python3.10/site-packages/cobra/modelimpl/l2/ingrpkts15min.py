...
class IngrPkts15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPkts15min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPkts15min"
    meta.rnFormat = "CDl2IngrPkts15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrPkts")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl2IngrPkts15min', False),
    ]
