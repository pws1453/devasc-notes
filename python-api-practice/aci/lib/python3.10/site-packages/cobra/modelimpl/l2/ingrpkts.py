...
# ##################################################
class IngrPkts(Mo):
    meta = StatsClassMeta("cobra.model.l2.IngrPkts", "ingress packets")
    ...
    meta.moClassName = "l2IngrPkts"


    meta.moClassName = "l2IngrPkts"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts1mo")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts1d")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts5min")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts1h")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts15min")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts1w")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts1year")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPkts1qtr")
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 9915, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress drop packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropBase", "dropBase", 9910, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress drop packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBase", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 9911, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropLast", "dropLast", 9909, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress drop packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropLast", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 9914, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress drop packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 9913, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress drop packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 9912, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 9920, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 9916, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 9917, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 9919, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 9918, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "ingress drop packets trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTrBase", prop)

    prop = PropMeta("str", "floodAvg", "floodAvg", 9976, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress flood packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodAvg", prop)

    prop = PropMeta("str", "floodBase", "floodBase", 9971, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress flood packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodBase", prop)

    prop = PropMeta("str", "floodCum", "floodCum", 9972, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress flood packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodCum", prop)

    prop = PropMeta("str", "floodLast", "floodLast", 9970, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress flood packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodLast", prop)

    prop = PropMeta("str", "floodMax", "floodMax", 9975, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress flood packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMax", prop)

    prop = PropMeta("str", "floodMin", "floodMin", 9974, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress flood packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodMin", prop)

    prop = PropMeta("str", "floodPer", "floodPer", 9973, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress flood packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPer", prop)

    prop = PropMeta("str", "floodRate", "floodRate", 9981, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress flood packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodRate", prop)

    prop = PropMeta("str", "floodSpct", "floodSpct", 9977, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress flood packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodSpct", prop)

    prop = PropMeta("str", "floodThr", "floodThr", 9978, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodTr", "floodTr", 9980, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress flood packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodTr", prop)

    prop = PropMeta("str", "floodTrBase", "floodTrBase", 9979, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 10037, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress multicast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastBase", "multicastBase", 10032, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress multicast packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastBase", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 10033, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress multicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastLast", "multicastLast", 10031, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress multicast packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastLast", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 10036, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress multicast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 10035, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress multicast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 10034, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress multicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 10042, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress multicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 10038, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress multicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 10039, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 10041, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress multicast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastTr", prop)

    prop = PropMeta("str", "multicastTrBase", "multicastTrBase", 10040, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 10098, PropCategory.IMPLICIT_AVG)
    prop.label = "ingress unicast packets average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastBase", "unicastBase", 10093, PropCategory.IMPLICIT_BASELINE)
    prop.label = "ingress unicast packets baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastBase", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 10094, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastLast", "unicastLast", 10092, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "ingress unicast packets current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastLast", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 10097, PropCategory.IMPLICIT_MAX)
    prop.label = "ingress unicast packets maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 10096, PropCategory.IMPLICIT_MIN)
    prop.label = "ingress unicast packets minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 10095, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 10103, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 10099, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 10100, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 10102, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress unicast packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 10101, PropCategory.IMPLICIT_TREND_BASE)
