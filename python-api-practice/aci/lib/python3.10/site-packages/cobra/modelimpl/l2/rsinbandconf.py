...
# ##################################################
class RsInbandConf(Mo):
    """
    A source relation to an L1 Ethernet interface. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l2.RsInbandConf", "cobra.model.l1.PhysIf")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "l2RsInbandConf"
    meta.rnFormat = "rsInbandConf"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Inband Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15080, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12710, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15079, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
