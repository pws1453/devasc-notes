...
# ##################################################
class EgrBytesPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist1d", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist1d"
    meta.rnFormat = "HDl2EgrBytesPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 21615, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21616, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
