...
# ##################################################
class EgrPktsPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart1d", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart1d"
    meta.rnFormat = "CDl2EgrPktsPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21646, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
