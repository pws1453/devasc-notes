...
# ##################################################
class IngrBytesAgHist1qtr(Mo):
    """
    A class that represents historical aggregated statistics for ingress bytes in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAgHist1qtr", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAgHist1qtr"
    meta.rnFormat = "HDl2IngrBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6754, PropCategory.REGULAR)
