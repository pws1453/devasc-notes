...
# ##################################################
class IngrPktsPart1h(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart1h", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart1h"
    meta.rnFormat = "CDl2IngrPktsPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6808, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
