...
# ##################################################
class IngrPktsAgHist(Mo):
    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist"


    meta.moClassName = "l2IngrPktsAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist1d")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist1year")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist1h")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist1qtr")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist1w")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist15min")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist1mo")
    meta.concreteSubClasses.add("cobra.model.l2.IngrPktsAgHist5min")
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 9958, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress drop packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 9959, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress drop packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 9963, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress drop packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 9960, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress drop packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 9961, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 9962, PropCategory.IMPLICIT_TREND)
    prop.label = "ingress drop packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "floodCum", "floodCum", 10019, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress flood packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodCum", prop)

    prop = PropMeta("str", "floodPer", "floodPer", 10020, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress flood packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodPer", prop)

    prop = PropMeta("str", "floodRate", "floodRate", 10024, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress flood packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodRate", prop)

    prop = PropMeta("str", "floodSpct", "floodSpct", 10021, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress flood packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("floodSpct", prop)

    prop = PropMeta("str", "floodThr", "floodThr", 10022, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "floodTr", "floodTr", 10023, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "multicastCum", "multicastCum", 10080, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress multicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 10081, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress multicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 10085, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress multicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 10082, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress multicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 10083, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 10084, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "unicastCum", "unicastCum", 10141, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "ingress unicast packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 10142, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "ingress unicast packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 10146, PropCategory.IMPLICIT_RATE)
    prop.label = "ingress unicast packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 10143, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "ingress unicast packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 10144, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 10145, PropCategory.IMPLICIT_TREND)
