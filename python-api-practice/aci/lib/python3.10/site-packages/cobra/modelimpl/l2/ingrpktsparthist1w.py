...
# ##################################################
class IngrPktsPartHist1w(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist1w", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist1w"
    meta.rnFormat = "HDl2IngrPktsPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6824, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6825, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
