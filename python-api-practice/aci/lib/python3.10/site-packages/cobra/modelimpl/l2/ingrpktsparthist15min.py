...
# ##################################################
class IngrPktsPartHist15min(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist15min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist15min"
    meta.rnFormat = "HDl2IngrPktsPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrPktsPartHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.HistAgPart")

    meta.rnPrefixes = [
        ('HDl2IngrPktsPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 6814, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6815, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
