...
class IngrBytesHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist1qtr", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist1qtr"
    meta.rnFormat = "HDl2IngrBytes1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6762, PropCategory.REGULAR)
