...
# ##################################################
class EgrBytesPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist1mo", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist1mo"
    meta.rnFormat = "HDl2EgrBytesPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 21619, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21620, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
