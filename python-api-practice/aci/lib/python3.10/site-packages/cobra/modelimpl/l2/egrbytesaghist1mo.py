...
# ##################################################
class EgrBytesAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist1mo", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist1mo"
    meta.rnFormat = "HDl2EgrBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 21592, PropCategory.REGULAR)
