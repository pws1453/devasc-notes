...
class IngrPktsHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPktsHist5min", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsHist5min"
    meta.rnFormat = "HDl2IngrPkts5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6805, PropCategory.REGULAR)
