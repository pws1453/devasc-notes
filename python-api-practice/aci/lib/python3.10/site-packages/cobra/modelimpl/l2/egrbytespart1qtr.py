...
# ##################################################
class EgrBytesPart1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPart1qtr", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPart1qtr"
    meta.rnFormat = "CDl2EgrBytesPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21609, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
