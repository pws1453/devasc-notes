...
class RsMgmtIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l2.RsMgmtIf", "cobra.model.mgmt.MgmtIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2RsMgmtIf"
    meta.rnFormat = "rsmgmtIf"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 54554, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 54522, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3633
    prop.defaultValueStr = "mgmtMgmtIf"
    prop._addConstant("mgmtMgmtIf", None, 3633)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54521, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 54553, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
