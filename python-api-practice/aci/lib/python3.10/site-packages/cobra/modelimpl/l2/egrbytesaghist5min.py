...
# ##################################################
class EgrBytesAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist5min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist5min"
    meta.rnFormat = "HDl2EgrBytesAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 21596, PropCategory.REGULAR)
