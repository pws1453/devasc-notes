...
# ##################################################
class RsToLocalBdSubstitute(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l2.RsToLocalBdSubstitute", "cobra.model.l2.LocalBdSubstitute")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2RsToLocalBdSubstitute"
    meta.rnFormat = "rsToLocalBdSubstitute"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L2 Local Bd"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27489, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9262
    prop.defaultValueStr = "l2LocalBdSubstitute"
    prop._addConstant("l2LocalBdSubstitute", None, 9262)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27488, PropCategory.REGULAR)
