...
class IngrBytesHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist1year", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist1year"
    meta.rnFormat = "HDl2IngrBytes1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6764, PropCategory.REGULAR)
