...
# ##################################################
class IngrBytesPartHist1h(Mo):
    """
    A class that represents historical portion of the statistics for ingress bytes in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist1h", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist1h"
    meta.rnFormat = "HDl2IngrBytesPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6778, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6779, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
