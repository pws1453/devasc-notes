...
# ##################################################
class IngrBytesPartHist1qtr(Mo):
    """
    A class that represents historical portion of the statistics for ingress bytes in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPartHist1qtr", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPartHist1qtr"
    meta.rnFormat = "HDl2IngrBytesPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6782, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6783, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
