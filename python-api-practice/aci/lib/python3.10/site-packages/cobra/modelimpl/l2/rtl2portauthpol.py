...
# ##################################################
class RtL2PortAuthPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l2.RtL2PortAuthPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "l2RtL2PortAuthPol"
    meta.rnFormat = "rtinfraL2PortAuthPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33243, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33242, PropCategory.REGULAR)
