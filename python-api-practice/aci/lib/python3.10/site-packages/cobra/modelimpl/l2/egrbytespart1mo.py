...
# ##################################################
class EgrBytesPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPart1mo", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPart1mo"
    meta.rnFormat = "CDl2EgrBytesPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21608, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
