...
# ##################################################
class EgrPktsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAg15min", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAg15min"
    meta.rnFormat = "CDl2EgrPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrPktsAg")

    meta.rnPrefixes = [
        ('CDl2EgrPktsAg15min', False),
    ]
