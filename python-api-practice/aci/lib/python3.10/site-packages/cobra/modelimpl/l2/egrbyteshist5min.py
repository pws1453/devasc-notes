...
class EgrBytesHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist5min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist5min"
    meta.rnFormat = "HDl2EgrBytes5min-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 21604, PropCategory.REGULAR)
