...
# ##################################################
class EgrPktsPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPartHist1w", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPartHist1w"
    meta.rnFormat = "HDl2EgrPktsPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 21663, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21664, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
