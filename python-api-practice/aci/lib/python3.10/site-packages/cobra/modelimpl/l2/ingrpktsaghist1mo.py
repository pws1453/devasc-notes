...
# ##################################################
class IngrPktsAgHist1mo(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist1mo", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist1mo"
    meta.rnFormat = "HDl2IngrPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6793, PropCategory.REGULAR)
