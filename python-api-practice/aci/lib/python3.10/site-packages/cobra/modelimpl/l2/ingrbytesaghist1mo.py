...
# ##################################################
class IngrBytesAgHist1mo(Mo):
    """
    A class that represents historical aggregated statistics for ingress bytes in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAgHist1mo", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAgHist1mo"
    meta.rnFormat = "HDl2IngrBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6753, PropCategory.REGULAR)
