...
# ##################################################
class EgrBytesAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist1year", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist1year"
    meta.rnFormat = "HDl2EgrBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 21595, PropCategory.REGULAR)
