...
# ##################################################
class IngrPktsPart1qtr(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart1qtr", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart1qtr"
    meta.rnFormat = "CDl2IngrPktsPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6810, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
