...
# ##################################################
class EgrPktsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAgHist1d", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAgHist1d"
    meta.rnFormat = "HDl2EgrPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 21630, PropCategory.REGULAR)
