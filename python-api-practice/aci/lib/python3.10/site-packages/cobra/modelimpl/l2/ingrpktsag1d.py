...
# ##################################################
class IngrPktsAg1d(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg1d", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg1d"
    meta.rnFormat = "CDl2IngrPktsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 1 day"
