...
# ##################################################
class EgrBytesAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAg1qtr", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAg1qtr"
    meta.rnFormat = "CDl2EgrBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress bytes stats in 1 quarter"
