...
class RtL2IfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.l2.RtL2IfPol", "cobra.model.infra.AccGrp")

    meta.moClassName = "l2RtL2IfPol"
    meta.rnFormat = "rtinfraL2IfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18254, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18253, PropCategory.REGULAR)
