...
# ##################################################
class EgrPktsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAgHist15min", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAgHist15min"
    meta.rnFormat = "HDl2EgrPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrPktsAgHist")
    meta.superClasses.add("cobra.model.stats.Hist")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('HDl2EgrPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 21629, PropCategory.REGULAR)
