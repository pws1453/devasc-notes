...
# ##################################################
class EgrPktsPart1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart1year", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart1year"
    meta.rnFormat = "CDl2EgrPktsPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21651, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
