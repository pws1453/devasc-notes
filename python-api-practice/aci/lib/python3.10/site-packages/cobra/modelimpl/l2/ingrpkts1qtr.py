...
class IngrPkts1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPkts1qtr", "ingress packets")
    ...
    meta.moClassName = "l2IngrPkts1qtr"
    meta.rnFormat = "CDl2IngrPkts1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ingress packets stats in 1 quarter"
