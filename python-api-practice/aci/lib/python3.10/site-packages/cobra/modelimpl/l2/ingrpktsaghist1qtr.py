...
# ##################################################
class IngrPktsAgHist1qtr(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist1qtr", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist1qtr"
    meta.rnFormat = "HDl2IngrPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6794, PropCategory.REGULAR)
