...
class IngrBytesHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytesHist1h", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesHist1h"
    meta.rnFormat = "HDl2IngrBytes1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6760, PropCategory.REGULAR)
