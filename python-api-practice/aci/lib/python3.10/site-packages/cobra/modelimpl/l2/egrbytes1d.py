...
class EgrBytes1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytes1d", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes1d"
    meta.rnFormat = "CDl2EgrBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats in 1 day"
