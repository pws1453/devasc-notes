...
# ##################################################
class RtVswitchOverrideMtuPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l2.RtVswitchOverrideMtuPol", "cobra.model.vmm.VSwitchPolicyCont")

    meta.moClassName = "l2RtVswitchOverrideMtuPol"
    meta.rnFormat = "rtvmmVswitchOverrideMtuPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtvmmVswitchOverrideMtuPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 58979, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58978, PropCategory.REGULAR)
