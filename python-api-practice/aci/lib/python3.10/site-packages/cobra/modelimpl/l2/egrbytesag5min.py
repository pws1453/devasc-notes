...
# ##################################################
class EgrBytesAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAg5min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAg5min"
    meta.rnFormat = "CDl2EgrBytesAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated egress bytes stats in 5 minute"
