...
# ##################################################
class RsMacBaseEppAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l2.RsMacBaseEppAtt", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2RsMacBaseEppAtt"
    meta.rnFormat = "rsmacBaseEppAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Base Epp Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23502, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23501, PropCategory.REGULAR)
