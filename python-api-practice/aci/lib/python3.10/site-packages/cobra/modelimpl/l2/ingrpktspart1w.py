...
# ##################################################
class IngrPktsPart1w(Mo):
    """
    A class that represents the most current portion of the statistics for ingress packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPart1w", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPart1w"
    meta.rnFormat = "CDl2IngrPktsPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6811, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
