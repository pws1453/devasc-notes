...
# ##################################################
class EgrBytesAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist15min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist15min"
    meta.rnFormat = "HDl2EgrBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.EgrBytesAgHist")

    meta.rnPrefixes = [
        ('HDl2EgrBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 21589, PropCategory.REGULAR)
