...
# ##################################################
class IngrPktsAg1w(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg1w", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg1w"
    meta.rnFormat = "CDl2IngrPktsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 1 week"
