...
class RsExtBD(Mo):
    """
    A source relation to the interface connectivity. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l2.RsExtBD", "cobra.model.fv.IfConn")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l2RsExtBD"
    meta.rnFormat = "rsextBD-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "External BD Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15069, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12696, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12695, PropCategory.REGULAR)
