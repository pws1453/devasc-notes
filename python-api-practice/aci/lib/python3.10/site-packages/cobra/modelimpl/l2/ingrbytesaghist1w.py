...
# ##################################################
class IngrBytesAgHist1w(Mo):
    """
    A class that represents historical aggregated statistics for ingress bytes in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAgHist1w", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAgHist1w"
    meta.rnFormat = "HDl2IngrBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6755, PropCategory.REGULAR)
