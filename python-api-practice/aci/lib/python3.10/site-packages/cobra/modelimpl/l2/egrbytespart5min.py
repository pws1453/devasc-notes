...
# ##################################################
class EgrBytesPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPart5min", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPart5min"
    meta.rnFormat = "CDl2EgrBytesPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21612, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
