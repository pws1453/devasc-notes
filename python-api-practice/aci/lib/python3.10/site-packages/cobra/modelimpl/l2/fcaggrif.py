...
class FcAggrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.l2.FcAggrIf")

    meta.moClassName = "l2FcAggrIf"
    meta.rnFormat = "l2fcaggr-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "San Port Channel Interface"
    ...
    meta.childClasses.add("cobra.model.l2.RsPcFcAggrBrConf")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.RsPcFcAggrBrConf", "rsPcFcAggrBrConf"))
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 38877, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fcpmCfgFailedBmp", "fcpmCfgFailedBmp", 45483, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("l2:FcAggrIfadminSt_failed_flag", None, 8)
    prop._addConstant("l2:FcAggrIfcfgModeSt_failed_flag", None, 32)
    prop._addConstant("l2:FcAggrIfdescr_failed_flag", None, 2)
    prop._addConstant("l2:FcAggrIfid_failed_flag", None, 4)
    prop._addConstant("l2:FcAggrIflastLinkStChg_failed_flag", None, 64)
    prop._addConstant("l2:FcAggrIflcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("l2:FcAggrIfmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("l2:FcAggrIfmode_failed_flag", None, 128)
    prop._addConstant("l2:FcAggrIfmonPolDn_failed_flag", None, 2097152)
    prop._addConstant("l2:FcAggrIfname_failed_flag", None, 1)
    prop._addConstant("l2:FcAggrIftrkingMode_failed_flag", None, 16384)
    prop._addConstant("l2:FcAggrIfvfcCfgSt_failed_flag", None, 131072)
    meta.props.add("fcpmCfgFailedBmp", prop)

    prop = PropMeta("str", "fcpmCfgFailedTs", "fcpmCfgFailedTs", 45485, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("fcpmCfgFailedTs", prop)

    prop = PropMeta("str", "fcpmCfgState", "fcpmCfgState", 45484, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("fcpmCfgState", prop)

    prop = PropMeta("str", "id", "id", 39109, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 38879, PropCategory.REGULAR)
    prop.label = "Administrative Port Mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16384
    prop.defaultValueStr = "np"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44950, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "trkingMode", "trkingMode", 38878, PropCategory.REGULAR)
    prop.label = "Administrative Trunking Mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "trunk-off"
    prop._addConstant("auto", "auto", 3)
    prop._addConstant("trunk-off", "trunk-off", 1)
    prop._addConstant("trunk-on", "trunk-on", 2)
    prop._addConstant("un-init", "un-init", 0)
