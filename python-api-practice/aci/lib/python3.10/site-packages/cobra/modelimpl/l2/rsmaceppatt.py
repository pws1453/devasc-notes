...
# ##################################################
class RsMacEppAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l2.RsMacEppAtt", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l2RsMacEppAtt"
    meta.rnFormat = "rsmacEppAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23506, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23505, PropCategory.REGULAR)
