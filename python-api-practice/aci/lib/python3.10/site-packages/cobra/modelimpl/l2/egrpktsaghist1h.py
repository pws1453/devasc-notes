...
# ##################################################
class EgrPktsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsAgHist1h", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsAgHist1h"
    meta.rnFormat = "HDl2EgrPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 21631, PropCategory.REGULAR)
