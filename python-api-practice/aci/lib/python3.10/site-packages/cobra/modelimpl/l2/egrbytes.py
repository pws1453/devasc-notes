...
# ##################################################
class EgrBytes(Mo):
    meta = StatsClassMeta("cobra.model.l2.EgrBytes", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes"


    meta.moClassName = "l2EgrBytes"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats"
    ...
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes1qtr")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes1d")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes1year")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes5min")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes15min")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes1h")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes1mo")
    meta.concreteSubClasses.add("cobra.model.l2.EgrBytes1w")
    ...
    prop = PropMeta("str", "multicastAvg", "multicastAvg", 21675, PropCategory.IMPLICIT_AVG)
    prop.label = "egress multicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastAvg", prop)

    prop = PropMeta("str", "multicastBase", "multicastBase", 21670, PropCategory.IMPLICIT_BASELINE)
    prop.label = "egress multicast bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastBase", prop)

    prop = PropMeta("str", "multicastCum", "multicastCum", 21671, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress multicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastCum", prop)

    prop = PropMeta("str", "multicastLast", "multicastLast", 21669, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "egress multicast bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastLast", prop)

    prop = PropMeta("str", "multicastMax", "multicastMax", 21674, PropCategory.IMPLICIT_MAX)
    prop.label = "egress multicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMax", prop)

    prop = PropMeta("str", "multicastMin", "multicastMin", 21673, PropCategory.IMPLICIT_MIN)
    prop.label = "egress multicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastMin", prop)

    prop = PropMeta("str", "multicastPer", "multicastPer", 21672, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress multicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastPer", prop)

    prop = PropMeta("str", "multicastRate", "multicastRate", 21680, PropCategory.IMPLICIT_RATE)
    prop.label = "egress multicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastRate", prop)

    prop = PropMeta("str", "multicastSpct", "multicastSpct", 21676, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress multicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastSpct", prop)

    prop = PropMeta("str", "multicastThr", "multicastThr", 21677, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "multicastTr", "multicastTr", 21679, PropCategory.IMPLICIT_TREND)
    prop.label = "egress multicast bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("multicastTr", prop)

    prop = PropMeta("str", "multicastTrBase", "multicastTrBase", 21678, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "unicastAvg", "unicastAvg", 21730, PropCategory.IMPLICIT_AVG)
    prop.label = "egress unicast bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastAvg", prop)

    prop = PropMeta("str", "unicastBase", "unicastBase", 21725, PropCategory.IMPLICIT_BASELINE)
    prop.label = "egress unicast bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastBase", prop)

    prop = PropMeta("str", "unicastCum", "unicastCum", 21726, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "egress unicast bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastCum", prop)

    prop = PropMeta("str", "unicastLast", "unicastLast", 21724, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "egress unicast bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastLast", prop)

    prop = PropMeta("str", "unicastMax", "unicastMax", 21729, PropCategory.IMPLICIT_MAX)
    prop.label = "egress unicast bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMax", prop)

    prop = PropMeta("str", "unicastMin", "unicastMin", 21728, PropCategory.IMPLICIT_MIN)
    prop.label = "egress unicast bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastMin", prop)

    prop = PropMeta("str", "unicastPer", "unicastPer", 21727, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "egress unicast bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastPer", prop)

    prop = PropMeta("str", "unicastRate", "unicastRate", 21735, PropCategory.IMPLICIT_RATE)
    prop.label = "egress unicast bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastRate", prop)

    prop = PropMeta("str", "unicastSpct", "unicastSpct", 21731, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "egress unicast bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastSpct", prop)

    prop = PropMeta("str", "unicastThr", "unicastThr", 21732, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "unicastTr", "unicastTr", 21734, PropCategory.IMPLICIT_TREND)
    prop.label = "egress unicast bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("unicastTr", prop)

    prop = PropMeta("str", "unicastTrBase", "unicastTrBase", 21733, PropCategory.IMPLICIT_TREND_BASE)
