...
# ##################################################
class IngrBytesPart15min(Mo):
    """
    A class that represents the most current portion of the statistics for ingress bytes in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesPart15min", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesPart15min"
    meta.rnFormat = "CDl2IngrBytesPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l2.IngrBytesPart")
    meta.superClasses.add("cobra.model.stats.CurrAgPart")
    meta.superClasses.add("cobra.model.stats.Curr")
    meta.superClasses.add("cobra.model.stats.Item")

    meta.rnPrefixes = [
        ('CDl2IngrBytesPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6766, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
