...
# ##################################################
class EgrBytesPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPart1d", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPart1d"
    meta.rnFormat = "CDl2EgrBytesPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21606, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
