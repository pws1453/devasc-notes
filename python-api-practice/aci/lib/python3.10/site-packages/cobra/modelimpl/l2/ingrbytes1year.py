...
class IngrBytes1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrBytes1year", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytes1year"
    meta.rnFormat = "CDl2IngrBytes1year"
