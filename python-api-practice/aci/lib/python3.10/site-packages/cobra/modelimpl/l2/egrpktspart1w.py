...
# ##################################################
class EgrPktsPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart1w", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart1w"
    meta.rnFormat = "CDl2EgrPktsPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21650, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
