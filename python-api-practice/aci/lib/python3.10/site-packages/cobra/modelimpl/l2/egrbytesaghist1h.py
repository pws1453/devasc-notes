...
# ##################################################
class EgrBytesAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesAgHist1h", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesAgHist1h"
    meta.rnFormat = "HDl2EgrBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 21591, PropCategory.REGULAR)
