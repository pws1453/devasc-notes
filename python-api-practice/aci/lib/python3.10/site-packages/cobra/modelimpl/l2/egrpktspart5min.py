...
# ##################################################
class EgrPktsPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrPktsPart5min", "egress packets")
    ...
    meta.moClassName = "l2EgrPktsPart5min"
    meta.rnFormat = "CDl2EgrPktsPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the egress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21652, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
