...
class EgrBytesHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist1mo", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist1mo"
    meta.rnFormat = "HDl2EgrBytes1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 21600, PropCategory.REGULAR)
