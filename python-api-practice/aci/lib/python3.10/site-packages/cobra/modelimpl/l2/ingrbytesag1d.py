...
# ##################################################
class IngrBytesAg1d(Mo):
    """
    A class that represents the most current aggregated statistics for ingress bytes in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAg1d", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAg1d"
    meta.rnFormat = "CDl2IngrBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress bytes stats in 1 day"
