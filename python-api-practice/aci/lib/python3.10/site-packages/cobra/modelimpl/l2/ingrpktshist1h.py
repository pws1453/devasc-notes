...
class IngrPktsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPktsHist1h", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsHist1h"
    meta.rnFormat = "HDl2IngrPkts1h-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6800, PropCategory.REGULAR)
