...
# ##################################################
class EgrBytesPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l2.EgrBytesPartHist1qtr", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesPartHist1qtr"
    meta.rnFormat = "HDl2EgrBytesPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 21621, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 21622, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
