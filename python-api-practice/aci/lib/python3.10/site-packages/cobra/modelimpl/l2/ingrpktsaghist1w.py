...
# ##################################################
class IngrPktsAgHist1w(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist1w", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist1w"
    meta.rnFormat = "HDl2IngrPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6795, PropCategory.REGULAR)
