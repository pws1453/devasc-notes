...
class IngrPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPktsHist1w", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsHist1w"
    meta.rnFormat = "HDl2IngrPkts1w-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6803, PropCategory.REGULAR)
