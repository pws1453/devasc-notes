...
class EgrBytes1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytes1w", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytes1w"
    meta.rnFormat = "CDl2EgrBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current egress bytes stats in 1 week"
