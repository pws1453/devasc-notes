...
# ##################################################
class IngrPktsAg1mo(Mo):
    """
    A class that represents the most current aggregated statistics for ingress packets in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAg1mo", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAg1mo"
    meta.rnFormat = "CDl2IngrPktsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress packets stats in 1 month"
