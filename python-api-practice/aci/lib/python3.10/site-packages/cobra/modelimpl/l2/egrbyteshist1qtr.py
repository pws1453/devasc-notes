...
class EgrBytesHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.EgrBytesHist1qtr", "egress bytes")
    ...
    meta.moClassName = "l2EgrBytesHist1qtr"
    meta.rnFormat = "HDl2EgrBytes1qtr-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 21601, PropCategory.REGULAR)
