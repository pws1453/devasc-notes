...
class IngrPktsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l2.IngrPktsHist1year", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsHist1year"
    meta.rnFormat = "HDl2IngrPkts1year-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 6804, PropCategory.REGULAR)
