...
# ##################################################
class IngrPktsAgHist1d(Mo):
    """
    A class that represents historical aggregated statistics for ingress packets in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsAgHist1d", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsAgHist1d"
    meta.rnFormat = "HDl2IngrPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6791, PropCategory.REGULAR)
