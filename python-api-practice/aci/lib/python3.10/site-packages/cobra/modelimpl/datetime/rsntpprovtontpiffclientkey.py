...
# ##################################################
class RsNtpProvToNtpIFFClientKey(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.datetime.RsNtpProvToNtpIFFClientKey", "cobra.model.datetime.NtpIFFClientKey")
    meta.targetNameProps["iffKeyId"] = "tnDatetimeNtpIFFClientKeyIffKeyId"
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "datetimeRsNtpProvToNtpIFFClientKey"
    meta.rnFormat = "rsntpProvToNtpIFFClientKey-%(tnDatetimeNtpIFFClientKeyIffKeyId)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Datetime Secure Session Key"
    ...
    meta.rnPrefixes = [
        ('rsntpProvToNtpIFFClientKey-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 53325, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 53326, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 53322, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 53320, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15616
    prop.defaultValueStr = "datetimeNtpIFFClientKey"
    ...
    prop = PropMeta("str", "tnDatetimeNtpIFFClientKeyIffKeyId", "tnDatetimeNtpIFFClientKeyIffKeyId", 53319, PropCategory.REGULAR)
    prop.label = "IFF Key ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.props.add("tnDatetimeNtpIFFClientKeyIffKeyId", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnDatetimeNtpIFFClientKeyIffKeyId"))

    # Deployment Meta
    meta.deploymentQuery = True
    meta.deploymentType = "Ancestor"

    def __init__(self, parentMoOrDn, tnDatetimeNtpIFFClientKeyIffKeyId, markDirty=True, **creationProps):
        namingVals = [tnDatetimeNtpIFFClientKeyIffKeyId]
