...
# ##################################################
class RsNtpProvToEpp(Mo):
    """
    A source relation to the abstract representation of the resolvable endpoint profile. This is an abstract class and cannot be instantiated.

    """

    meta = SourceRelationMeta("cobra.model.datetime.RsNtpProvToEpp", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "datetimeRsNtpProvToEpp"
    meta.rnFormat = "rsNtpProvToEpp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Datetime Provider Reachability EPP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15288, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15287, PropCategory.REGULAR)
