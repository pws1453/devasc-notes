...
# ##################################################
class RsNtpProviderToNTPIffKey(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.datetime.RsNtpProviderToNTPIffKey", "cobra.model.datetime.NTPIffKey")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "datetimeRsNtpProviderToNTPIffKey"
    meta.rnFormat = "rsntpProviderToNTPIffKey-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ntp Security Session Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53317, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15619
    prop.defaultValueStr = "datetimeNTPIffKey"
    prop._addConstant("datetimeNTPIffKey", None, 15619)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 53316, PropCategory.REGULAR)
