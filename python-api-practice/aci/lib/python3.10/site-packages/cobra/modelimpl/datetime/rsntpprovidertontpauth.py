...
# ##################################################
class RsNtpProviderToNtpAuth(Mo):
    """
    A source relation to the date/time NTP authorization.

    """

    meta = SourceRelationMeta("cobra.model.datetime.RsNtpProviderToNtpAuth", "cobra.model.datetime.NtpAuth")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "datetimeRsNtpProviderToNtpAuth"
    meta.rnFormat = "rsntpProviderToNtpAuth-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ntp Authentication Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12865, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3956
    prop.defaultValueStr = "datetimeNtpAuth"
    prop._addConstant("datetimeNtpAuth", None, 3956)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12864, PropCategory.REGULAR)
