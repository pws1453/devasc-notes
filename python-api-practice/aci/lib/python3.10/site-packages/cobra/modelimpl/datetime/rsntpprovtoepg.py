...
# ##################################################
class RsNtpProvToEpg(Mo):
    """
    A source relation to the base class for the Attachable Target Group.

    """

    meta = SourceRelationMeta("cobra.model.datetime.RsNtpProvToEpg", "cobra.model.fv.ATg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "datetimeRsNtpProvToEpg"
    meta.rnFormat = "rsNtpProvToEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Reachability Epg"
    ...
    meta.rnPrefixes = [
        ('rsNtpProvToEpg', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37932, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40071, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 13314, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13313, PropCategory.REGULAR)
