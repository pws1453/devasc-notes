...
# ##################################################
class APol(Mo):
    meta = ClassMeta("cobra.model.datetime.APol")

    meta.isAbstract = True
    meta.moClassName = "datetimeAPol"
    ...
    meta.concreteSubClasses.add("cobra.model.datetime.Pol")
    meta.concreteSubClasses.add("cobra.model.datetime.ClkPol")
    ...
    prop = PropMeta("str", "name", "name", 4943, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
