...
# ##################################################
class RsHBucket2EpRec(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aentp.RsHBucket2EpRec", "cobra.model.coop.EpRec")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "aentpRsHBucket2EpRec"
    meta.rnFormat = "rshBucket2EpRec-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Hash Bucket collision MAC EPs"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54478, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2582
    prop.defaultValueStr = "coopEpRec"
    prop._addConstant("coopEpRec", None, 2582)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54477, PropCategory.REGULAR)
