...
# ##################################################
class RsHBucket2IpOnlyRec(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aentp.RsHBucket2IpOnlyRec", "cobra.model.coop.IpOnlyRec")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "aentpRsHBucket2IpOnlyRec"
    meta.rnFormat = "rshBucket2IpOnlyRec-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Hash Bucket collision IP only EPs"
    ...
    meta.parentClasses.add("cobra.model.aentp.Bucket")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rshBucket2IpOnlyRec-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 54481, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5747
    prop.defaultValueStr = "coopIpOnlyRec"
    prop._addConstant("coopIpOnlyRec", None, 5747)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54480, PropCategory.REGULAR)
