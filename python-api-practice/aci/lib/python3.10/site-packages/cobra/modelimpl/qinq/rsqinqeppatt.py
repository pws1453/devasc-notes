...
# ##################################################
class RsQinqEppAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.qinq.RsQinqEppAtt", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "qinqRsQinqEppAtt"
    meta.rnFormat = "rsqinqEppAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 33212, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 33205, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33204, PropCategory.REGULAR)
