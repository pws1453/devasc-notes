...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.pim6.Entity")

    meta.moClassName = "pim6Entity"
    meta.rnFormat = "pim6"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM6 Entity"
    ...
    meta.childClasses.add("cobra.model.pim6.Inst")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim6.Inst", "inst"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47664, PropCategory.REGULAR)
