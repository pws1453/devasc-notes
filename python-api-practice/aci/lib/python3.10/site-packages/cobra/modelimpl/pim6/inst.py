...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.pim6.Inst")

    meta.moClassName = "pim6Inst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "PIM6 Instance"
    ...
    meta.childClasses.add("cobra.model.pim6.Overload")
    meta.childClasses.add("cobra.model.pim6.Dom")

    meta.childNamesAndRnPrefix.append(("cobra.model.pim6.Overload", "overload"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim6.Dom", "dom-"))
    ...
    meta.superClasses.add("cobra.model.rtdmc.AInst")
    ...
    prop = PropMeta("str", "jpDelay", "jpDelay", 24556, PropCategory.REGULAR)
    prop.label = "Inter Packet Delay"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4294967295)]
    prop.defaultValue = 100
    prop.defaultValueStr = "100"
    meta.props.add("jpDelay", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nrDelay", "nrDelay", 24557, PropCategory.REGULAR)
    prop.label = "Null Register Inter Batch Delay"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 50000)]
    prop.defaultValue = 7500
    prop.defaultValueStr = "7500"
    meta.props.add("nrDelay", prop)

    prop = PropMeta("str", "nrNumRt", "nrNumRt", 24558, PropCategory.REGULAR)
    prop.label = "Null Register Number of Routes"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 32000)]
    prop.defaultValue = 10
    prop.defaultValueStr = "10"
    meta.props.add("nrNumRt", prop)
