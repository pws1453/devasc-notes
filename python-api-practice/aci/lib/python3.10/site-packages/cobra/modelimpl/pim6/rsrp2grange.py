...
# ##################################################
class RsRP2Grange(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pim6.RsRP2Grange", "cobra.model.pim6.RPGrange")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "pim6RsRP2Grange"
    meta.rnFormat = "rsRP2Grange-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "RP to Group range mapping"
    ...
    meta.parentClasses.add("cobra.model.pim6.RPInfo")
    ...
    prop = PropMeta("str", "tCl", "tCl", 47434, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13642
    prop.defaultValueStr = "pim6RPGrange"
    prop._addConstant("pim6RPGrange", None, 13642)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 47433, PropCategory.REGULAR)
