...
# ##################################################
class RsCtxToEpRet(Mo):
    """
    Name of the endpoint retention policy associated with this context.

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsCtxToEpRet", "cobra.model.fv.EpRetPol")
    meta.targetNameProps["name"] = "tnFvEpRetPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsCtxToEpRet"
    meta.rnFormat = "rsctxToEpRet"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37664, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39803, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14291, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12374, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvEpRetPolName", "tnFvEpRetPolName", 12373, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
