...
class RsCcepConn(Mo):
    """
    A source relation to an external IO port on a leaf. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsCcepConn", "cobra.model.eqpt.LeafP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsCcepConn"
    meta.rnFormat = "rsccepConn"
    ...
    meta.parentClasses.add("cobra.model.fv.CCEp")
    ...
    prop = PropMeta("str", "tCl", "tCl", 12407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12406, PropCategory.REGULAR)
