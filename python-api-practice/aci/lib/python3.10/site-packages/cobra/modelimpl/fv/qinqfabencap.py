...
# ##################################################
class QinqFabEncap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.QinqFabEncap")

    meta.moClassName = "fvQinqFabEncap"
    meta.rnFormat = "encap-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "QinqFabEncap Refcount"
    ...
    prop = PropMeta("str", "encap", "encap", 34106, PropCategory.REGULAR)
    prop.label = "Interface Encap"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "qinqFabEncap", "qinqFabEncap", 34107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("qinqFabEncap", prop)

    prop = PropMeta("str", "refCount", "refCount", 34108, PropCategory.REGULAR)
    prop.label = "Reference Count of Paths using this Encap"
    prop.isImplicit = True
    prop.isAdmin = True
