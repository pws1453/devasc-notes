...
# ##################################################
class RtProvToEpp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtProvToEpp", "cobra.model.aaa.AProvider")

    meta.moClassName = "fvRtProvToEpp"
    meta.rnFormat = "rtaaaProvToEpp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 25169, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25168, PropCategory.REGULAR)
