...
# ##################################################
class RtTrackListReln(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTrackListReln", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "fvRtTrackListReln"
    meta.rnFormat = "rtpolTrackListReln-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52321, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 52320, PropCategory.REGULAR)
