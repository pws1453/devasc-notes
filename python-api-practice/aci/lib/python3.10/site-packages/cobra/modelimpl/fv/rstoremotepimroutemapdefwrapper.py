...
# ##################################################
class RsToRemotePimRouteMapDefWrapper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemotePimRouteMapDefWrapper", "cobra.model.pim.RouteMapDefWrapper")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemotePimRouteMapDefWrapper"
    meta.rnFormat = "rstoRemotePimRouteMapDefWrapper-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Wrapper for route-map DEF objects needed to be added in the remote-polholder"
    ...
    meta.superClasses.add("cobra.model.fv.ARsToRemote")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rstoRemotePimRouteMapDefWrapper-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27691, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9338
    prop.defaultValueStr = "pimRouteMapDefWrapper"
    prop._addConstant("pimRouteMapDefWrapper", None, 9338)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27690, PropCategory.REGULAR)
