...
# ##################################################
class RsToRemoteCloudsecKeyDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteCloudsecKeyDefCont", "cobra.model.cloudsec.KeyDefCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteCloudsecKeyDefCont"
    meta.rnFormat = "rstoRemoteCloudsecKeyDefCont-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteCloudsecKeyDefCont-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 52020, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15226
    prop.defaultValueStr = "cloudsecKeyDefCont"
    prop._addConstant("cloudsecKeyDefCont", None, 15226)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52019, PropCategory.REGULAR)
