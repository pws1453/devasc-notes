...
class RsConsIf(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsConsIf", "cobra.model.vz.CPIf")
    meta.targetNameProps["name"] = "tnVzCPIfName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsConsIf"
    meta.rnFormat = "rsconsIf-%(tnVzCPIfName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Contract Interface"
    ...
    meta.superClasses.add("cobra.model.fv.EPgToInterface")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37653, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deplInfo", "deplInfo", 12217, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39792, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14258, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 12218, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12216, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzCPIfName", "tnVzCPIfName", 12215, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "updateCollection", "updateCollection", 20833, PropCategory.REGULAR)
