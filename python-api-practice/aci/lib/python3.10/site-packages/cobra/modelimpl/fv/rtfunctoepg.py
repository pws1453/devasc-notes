...
# ##################################################
class RtFuncToEpg(Mo):
    """
    A target relation to a set of endpoints. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtFuncToEpg", "cobra.model.infra.AFunc")

    meta.moClassName = "fvRtFuncToEpg"
    meta.rnFormat = "rtinfraFuncToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x600021000006c713
    ...
    prop = PropMeta("str", "tCl", "tCl", 13272, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4444
    prop.defaultValueStr = "infraAFunc"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13271, PropCategory.REGULAR)
