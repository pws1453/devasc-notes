...
# ##################################################
class ConfigState(Mo):
    """
    Policy element-specific information of a resolvable endpoint profile.

    """

    meta = ClassMeta("cobra.model.fv.ConfigState")

    meta.moClassName = "fvConfigState"
    meta.rnFormat = "conft"
    meta.category = MoCategory.REGULAR
    meta.label = "Configuration State"
    ...
    prop = PropMeta("str", "configSt", "configSt", 1835, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
