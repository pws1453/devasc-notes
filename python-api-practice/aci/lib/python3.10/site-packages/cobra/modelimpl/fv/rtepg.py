...
class RtEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtEpg", "cobra.model.snmp.ClientGrpP")

    meta.moClassName = "fvRtEpg"
    meta.rnFormat = "rtsnmpEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13339, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13338, PropCategory.REGULAR)
