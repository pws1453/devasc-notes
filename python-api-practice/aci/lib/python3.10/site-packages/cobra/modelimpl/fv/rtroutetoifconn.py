...
# ##################################################
class RtRouteToIfConn(Mo):
    """
    A target relation to the connectivity parameters for an interface. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtRouteToIfConn", "cobra.model.ip.Route")

    meta.moClassName = "fvRtRouteToIfConn"
    meta.rnFormat = "rtipRouteToIfConn-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12852, PropCategory.REGULAR)
