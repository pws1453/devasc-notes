...
# ##################################################
class RsToResolver(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToResolver", "cobra.model.pcons.Resolver")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsToResolver"
    meta.rnFormat = "rstoResolver"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22720, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 184
    prop.defaultValueStr = "pconsResolver"
    prop._addConstant("pconsResolver", None, 184)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22719, PropCategory.REGULAR)
