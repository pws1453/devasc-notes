...
# ##################################################
class RtQinqEppAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtQinqEppAtt", "cobra.model.qinq.CktEp")

    meta.moClassName = "fvRtQinqEppAtt"
    meta.rnFormat = "rtqinqQinqEppAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33207, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10644
    prop.defaultValueStr = "qinqCktEp"
    prop._addConstant("qinqCktEp", None, 10644)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33206, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 33213, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
