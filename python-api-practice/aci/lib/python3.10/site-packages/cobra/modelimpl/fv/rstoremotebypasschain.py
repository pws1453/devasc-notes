...
# ##################################################
class RsToRemoteByPassChain(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteByPassChain", "cobra.model.vns.ByPassChain")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteByPassChain"
    meta.rnFormat = "rstoRemoteByPassChain-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 53344, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15628
    prop.defaultValueStr = "vnsByPassChain"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsByPassChain", None, 15628)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 53343, PropCategory.REGULAR)
