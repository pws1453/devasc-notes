...
class VDEpTask(Mo):
    """
    A task for an internal process.

    """

    meta = ClassMeta("cobra.model.fv.VDEpTask")

    meta.moClassName = "fvVDEpTask"
    meta.rnFormat = "fvVDEpTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.fv.VDEpContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.VDEpContext", "fvVDEp"))
    ...
    prop = PropMeta("str", "id", "id", 5664, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DetachUnknownEp", "detachunknownep", 1920)
    prop._addConstant("EpAttachorDetach", "epattachordetach", 463)
    prop._addConstant("WaitForEpP", "waitforepp", 227)
