...
# ##################################################
class RtRouteTrack(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtRouteTrack", "cobra.model.ip.RouteP")

    meta.moClassName = "fvRtRouteTrack"
    meta.rnFormat = "rtipRouteTrack-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Static Route"
    meta.writeAccessMask = 0x10010000000001
    meta.readAccessMask = 0x10010001000001
    ...
    prop = PropMeta("str", "tCl", "tCl", 45657, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4279
    prop.defaultValueStr = "ipRouteP"
    prop._addConstant("ipRouteP", None, 4279)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45656, PropCategory.REGULAR)
