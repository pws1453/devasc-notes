...
# ##################################################
class RsToRemoteAnyDef(Mo):
    """
    @@ Pulls in vzAnyDef configuration

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteAnyDef", "cobra.model.vz.AnyDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteAnyDef"
    meta.rnFormat = "rstoRemoteAnyDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16615, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5642
    prop.defaultValueStr = "vzAnyDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzAnyDef", None, 5642)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16614, PropCategory.REGULAR)
