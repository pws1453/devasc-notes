...
# ##################################################
class RtTrExtEpIpDst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTrExtEpIpDst", "cobra.model.traceroutep.TrExtEp")

    meta.moClassName = "fvRtTrExtEpIpDst"
    meta.rnFormat = "rttrExtEpIpDst"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43509, PropCategory.REGULAR)
