...
class RsToCtrct(Mo):
    """
    An internal used for security rule deployment. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToCtrct", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToCtrct"
    meta.rnFormat = "rstoCtrct"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12268, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12267, PropCategory.REGULAR)
