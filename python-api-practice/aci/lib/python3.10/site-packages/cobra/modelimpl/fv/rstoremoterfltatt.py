...
# ##################################################
class RsToRemoteRFltAtt(Mo):
    """
    A source relation to an internal representation of a filter. This exists on the node to download filters. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRFltAtt", "cobra.model.vz.AFilterableUnit")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRFltAtt"
    meta.rnFormat = "rstoRemoteRFltAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12453, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12452, PropCategory.REGULAR)
