...
# ##################################################
class RtToEpForEpgToEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RtToEpForEpgToEpTask")

    meta.moClassName = "fvRtToEpForEpgToEpTask"
    meta.rnFormat = "fvRtToEpForEpgToEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24127, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DbgacEpForEpgToEp", "dbgacepforepgtoep", 2125)
