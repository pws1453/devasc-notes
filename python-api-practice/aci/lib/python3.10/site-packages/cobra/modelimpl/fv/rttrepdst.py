...
class RtTrEpDst(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtTrEpDst", "cobra.model.traceroutep.TrEp")

    meta.moClassName = "fvRtTrEpDst"
    meta.rnFormat = "rttraceroutepTrEpDst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13057, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13056, PropCategory.REGULAR)
