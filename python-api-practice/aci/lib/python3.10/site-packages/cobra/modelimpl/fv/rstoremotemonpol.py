...
# ##################################################
class RsToRemoteMonPol(Mo):
    """
    A source relation to the monitoring policy model for the endpoint group semantic scope. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteMonPol", "cobra.model.mon.Pol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteMonPol"
    meta.rnFormat = "rstoRemoteMonPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12449, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12448, PropCategory.REGULAR)
