...
# ##################################################
class RsIpslaMonPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsIpslaMonPol", "cobra.model.fv.IPSLAMonitoringPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsIpslaMonPol"
    meta.rnFormat = "rsIpslaMonPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Track member to IPSLA Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 45677, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45678, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 45663, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10951
    prop.defaultValueStr = "fvIPSLAMonitoringPol"
    prop._addConstant("fvIPSLAMonitoringPol", None, 10951)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 45662, PropCategory.REGULAR)
