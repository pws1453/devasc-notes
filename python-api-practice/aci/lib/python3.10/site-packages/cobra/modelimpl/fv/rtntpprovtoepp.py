...
# ##################################################
class RtNtpProvToEpp(Mo):
    """
    A target relation to an abstract representation of the resolvable endpoint profile.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtNtpProvToEpp", "cobra.model.datetime.NtpProv")

    meta.moClassName = "fvRtNtpProvToEpp"
    meta.rnFormat = "rtdatetimeNtpProvToEpp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15290, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4529
    prop.defaultValueStr = "datetimeNtpProv"
    prop._addConstant("datetimeNtpProv", None, 4529)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 15289, PropCategory.REGULAR)
