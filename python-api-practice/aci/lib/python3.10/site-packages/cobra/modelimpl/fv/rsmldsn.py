...
class RsMldsn(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsMldsn", "cobra.model.mld.SnoopPol")
    meta.targetNameProps["name"] = "tnMldSnoopPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsMldsn"
    meta.rnFormat = "rsmldsn"
    ...
    prop = PropMeta("str", "annotation", "annotation", 47387, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47388, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 47384, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 47374, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13614
    prop.defaultValueStr = "mldSnoopPol"
    ...
    prop = PropMeta("str", "tnMldSnoopPolName", "tnMldSnoopPolName", 47373, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMldSnoopPolName", prop)
