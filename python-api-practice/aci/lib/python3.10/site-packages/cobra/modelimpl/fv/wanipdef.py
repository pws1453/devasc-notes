...
class WanIpDef(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.WanIpDef")

    meta.moClassName = "fvWanIpDef"
    meta.rnFormat = "wanIp-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 41137, PropCategory.REGULAR)
    prop.label = "Wan CP-TEP IP Address"
    prop.isConfig = True
    prop.isAdmin = True
