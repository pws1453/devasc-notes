...
# ##################################################
class RsEPgDefToL2Dom(Mo):
    """
    A source relation to a generic layer 2 flood domain.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEPgDefToL2Dom", "cobra.model.l2.Dom")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEPgDefToL2Dom"
    meta.rnFormat = "rsEPgDefToL2Dom"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EPgDef to L2 Domain Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15272, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3411
    prop.defaultValueStr = "l2Dom"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15271, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15304, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
