...
# ##################################################
class RsBDToNetflowMonitorPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDToNetflowMonitorPol", "cobra.model.netflow.MonitorPol")
    meta.targetNameProps["name"] = "tnNetflowMonitorPolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsBDToNetflowMonitorPol"
    meta.rnFormat = "rsBDToNetflowMonitorPol-[%(tnNetflowMonitorPolName)s]-%(fltType)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Netflow Monitor Policy"
    ...
    meta.rnPrefixes = [
        ('rsBDToNetflowMonitorPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38552, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40691, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fltType", "fltType", 27824, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27396, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27348, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNetflowMonitorPolName", "tnNetflowMonitorPolName", 27347, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
