...
class RtBd(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtBd", "cobra.model.fv.AEPg")

    meta.moClassName = "fvRtBd"
    meta.rnFormat = "rtbd-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "EPG associated to the Bridge Domain"
    meta.writeAccessMask = 0x1001
    meta.readAccessMask = 0x6000400421843701
    ...
    prop = PropMeta("str", "tCl", "tCl", 12324, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12323, PropCategory.REGULAR)
