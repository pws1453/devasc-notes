...
# ##################################################
class RtTrEpIpSrc(Mo):
    """
    A target relation to the IP address of an endpoint.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTrEpIpSrc", "cobra.model.traceroutep.TrEp")

    meta.moClassName = "fvRtTrEpIpSrc"
    meta.rnFormat = "rttraceroutepTrEpIpSrc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15838, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15837, PropCategory.REGULAR)
