...
class RsTnlCtx(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsTnlCtx", "cobra.model.fv.TnlCtx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsTnlCtx"
    meta.rnFormat = "rstnlCtx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38566, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40705, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27859, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27855, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9373
    prop.defaultValueStr = "fvTnlCtx"
    prop._addConstant("fvTnlCtx", None, 9373)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27854, PropCategory.REGULAR)
