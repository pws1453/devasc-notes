...
class RsLNode(Mo):
    """
    A source relation to the logical node. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsLNode", "cobra.model.hvs.LNode")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsLNode"
    meta.rnFormat = "rslNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12430, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 103
    prop.defaultValueStr = "hvsLNode"
    prop._addConstant("hvsLNode", None, 103)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12429, PropCategory.REGULAR)
