...
# ##################################################
class RsStCEpDefToPathEp(Mo):
    """
    A source relation to an abstraction of the path endpoint.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStCEpDefToPathEp", "cobra.model.fabric.APathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsStCEpDefToPathEp"
    meta.rnFormat = "rsstCEpDefToPathEp-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fv.StCEpDef")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsstCEpDefToPathEp-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12402, PropCategory.REGULAR)
