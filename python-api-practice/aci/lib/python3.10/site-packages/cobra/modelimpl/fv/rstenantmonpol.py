...
class RsTenantMonPol(Mo):
    ...
    meta.rnPrefixes = [
        ('rsTenantMonPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37636, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39775, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14236, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12302, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonEPGPolName", "tnMonEPGPolName", 12301, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
