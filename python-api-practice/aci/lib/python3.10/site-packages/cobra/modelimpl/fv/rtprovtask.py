...
class RtProvTask(Mo):
    """
    An internal task that updates the policy manager of the endpoint group to domain relationship. This is an internal object.

    """

    meta = ClassMeta("cobra.model.fv.RtProvTask")

    meta.moClassName = "fvRtProvTask"
    meta.rnFormat = "fvRtProvTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5691, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ProvDhcpUpd", "provdhcpupd", 550)
