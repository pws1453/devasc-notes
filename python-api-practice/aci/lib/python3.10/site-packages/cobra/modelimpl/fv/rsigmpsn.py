...
class RsIgmpsn(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsIgmpsn", "cobra.model.igmp.SnoopPol")
    meta.targetNameProps["name"] = "tnIgmpSnoopPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsIgmpsn"
    meta.rnFormat = "rsigmpsn"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37642, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39781, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14245, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12192, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1662
    prop.defaultValueStr = "igmpSnoopPol"
    ...
    prop = PropMeta("str", "tnIgmpSnoopPolName", "tnIgmpSnoopPolName", 12191, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnIgmpSnoopPolName", prop)
