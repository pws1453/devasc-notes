...
class RsIntraEpg(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsIntraEpg", "cobra.model.vz.BrCP")
    meta.targetNameProps["name"] = "tnVzBrCPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsIntraEpg"
    meta.rnFormat = "rsintraEpg-%(tnVzBrCPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Intra EPg Contract"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38701, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40840, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33323, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33320, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzBrCPName", "tnVzBrCPName", 33319, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
