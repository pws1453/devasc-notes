...
class RsBDToOut(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDToOut", "cobra.model.l3ext.Out")
    meta.targetNameProps["name"] = "tnL3extOutName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsBDToOut"
    meta.rnFormat = "rsBDToOut-%(tnL3extOutName)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37646, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39785, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14249, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12165, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL3extOutName", "tnL3extOutName", 12164, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
