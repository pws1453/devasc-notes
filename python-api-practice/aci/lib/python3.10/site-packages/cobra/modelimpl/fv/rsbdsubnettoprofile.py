...
class RsBDSubnetToProfile(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDSubnetToProfile", "cobra.model.rtctrl.Profile")
    meta.targetNameProps["name"] = "tnRtctrlProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsBDSubnetToProfile"
    meta.rnFormat = "rsBDSubnetToProfile"
    ...
    meta.rnPrefixes = [
        ('rsBDSubnetToProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37632, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39771, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14229, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12148, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL3extOutName", "tnL3extOutName", 12149, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "tnRtctrlProfileName", "tnRtctrlProfileName", 12147, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
