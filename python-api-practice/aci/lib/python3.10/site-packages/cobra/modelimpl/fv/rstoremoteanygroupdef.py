...
# ##################################################
class RsToRemoteAnyGroupDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteAnyGroupDef", "cobra.model.vz.AnyGroupDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteAnyGroupDef"
    meta.rnFormat = "rstoRemoteAnyGroupDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27836, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9365
    prop.defaultValueStr = "vzAnyGroupDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzAnyGroupDef", None, 9365)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27835, PropCategory.REGULAR)
