...
class OverallHealthHist1mo(Mo):
    """
    A class that represents historical statistics for overall tenant health in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealthHist1mo", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealthHist1mo"
    meta.rnFormat = "HDfvOverallHealth1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical overall tenant health stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 6547, PropCategory.REGULAR)
