...
# ##################################################
class ARsToRemoteTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ARsToRemoteTask")

    meta.moClassName = "fvARsToRemoteTask"
    meta.rnFormat = "fvARsToRemoteTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33389, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReleasePolicy", "releasepolicy", 2789)
