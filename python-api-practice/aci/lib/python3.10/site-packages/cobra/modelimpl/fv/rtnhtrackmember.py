...
# ##################################################
class RtNHTrackMember(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtNHTrackMember", "cobra.model.ip.NexthopP")

    meta.moClassName = "fvRtNHTrackMember"
    meta.rnFormat = "rtipNHTrackMember-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 47676, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4282
    prop.defaultValueStr = "ipNexthopP"
    prop._addConstant("ipNexthopP", None, 4282)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 47675, PropCategory.REGULAR)
