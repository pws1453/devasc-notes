...
class RsPathAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsPathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsPathAtt"
    meta.rnFormat = "rspathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Static Path"
    meta.writeAccessMask = 0x601
    meta.readAccessMask = 0x4000000021601
    ...
    meta.childClasses.add("cobra.model.igmp.SnoopAccessGroup")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.igmp.SnoopStaticGroup")
    meta.childClasses.add("cobra.model.l2.PortSecurityPol")
    meta.childClasses.add("cobra.model.mld.SnoopAccessGroup")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.mld.SnoopStaticGroup")
    meta.childClasses.add("cobra.model.fv.NlbStaticGroup")
    meta.childClasses.add("cobra.model.ptp.EpgCfg")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mld.SnoopAccessGroup", "mldsnoopfilter"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mld.SnoopStaticGroup", "mldsnoopgroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.NlbStaticGroup", "nlbstaticgrp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.SnoopAccessGroup", "snoopfilter"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ptp.EpgCfg", "ptpEpgCfg"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.ExtMngdInst", "extmngd"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.SnoopStaticGroup", "group-"))
    ...
    meta.superClasses.add("cobra.model.fv.AEPgPathAtt")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37660, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 19109, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "encap", "encap", 12346, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39799, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "instrImedcy", "instrImedcy", 12347, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "lcC", "lcC", 12348, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mode", "mode", 12349, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26256, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "primaryEncap", "primaryEncap", 23080, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12345, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12344, PropCategory.REGULAR)
