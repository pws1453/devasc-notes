...
# ##################################################
class RsEpDefRefToStAdjEpV6(Mo):
    """
    A source relation to the static neighbor discovery adjacency definitions.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEpDefRefToStAdjEpV6", "cobra.model.nd.StAdjEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEpDefRefToStAdjEpV6"
    meta.rnFormat = "rsEpDefRefToStAdjEpV6"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17512, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5782
    prop.defaultValueStr = "ndStAdjEp"
    prop._addConstant("ndStAdjEp", None, 5782)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17511, PropCategory.REGULAR)
