...
class StCEp(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.StCEp")

    meta.moClassName = "fvStCEp"
    meta.rnFormat = "stcep-%(mac)s-type-%(type)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Static End Point"
    ...
    meta.childClasses.add("cobra.model.fv.RsStCEpToPathEp")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fv.StIp")
    meta.childClasses.add("cobra.model.fv.RsStCEpToNode")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsStCEpToPathEp", "rsstCEpToPathEp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsStCEpToNode", "rsstCEpToNode-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.StIp", "ip-"))

    meta.parentClasses.add("cobra.model.fv.AEPg")
    meta.parentClasses.add("cobra.model.fv.TnlEPg")

    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.fv.AStCEp")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37668, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 1781, PropCategory.REGULAR)
    ...
    prop._addConstant("path-not-present", "path-not-present", 1)
    ...
    prop = PropMeta("str", "encap", "encap", 15682, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39807, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ip", "ip", 15681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mac", "mac", 6556, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14299, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 1780, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "type", "type", 15238, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.defaultValue = 0
    prop.defaultValueStr = "silent-host"
    prop._addConstant("silent-host", "silent-host", 0)
    prop._addConstant("tep", "tep", 1)
    prop._addConstant("vep", "vep", 2)
    ...
    def __init__(self, parentMoOrDn, mac, type, markDirty=True, **creationProps):
        namingVals = [mac, type]
