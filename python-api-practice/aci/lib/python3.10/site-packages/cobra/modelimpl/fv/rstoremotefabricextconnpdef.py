...
# ##################################################
class RsToRemoteFabricExtConnPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteFabricExtConnPDef", "cobra.model.fv.FabricExtConnPDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsToRemoteFabricExtConnPDef"
    meta.rnFormat = "rstoRemoteFabricExtConnPDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Intrasite/Intersite Profile Definition"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteFabricExtConnPDef', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 21440, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7261
    prop.defaultValueStr = "fvFabricExtConnPDef"
    prop._addConstant("fvFabricExtConnPDef", None, 7261)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21439, PropCategory.REGULAR)
