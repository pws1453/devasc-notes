...
class RsCtx(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsCtx", "cobra.model.fv.Ctx")
    meta.targetNameProps["name"] = "tnFvCtxName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsCtx"
    meta.rnFormat = "rsctx"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39780, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14244, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12188, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvCtxName", "tnFvCtxName", 12187, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
