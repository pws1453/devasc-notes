...
# ##################################################
class RtSvcMgmtEpg(Mo):
    """
    A target relation to a set of endpoints. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSvcMgmtEpg", "cobra.model.vns.ALDev")

    meta.moClassName = "fvRtSvcMgmtEpg"
    meta.rnFormat = "rtvnsSvcMgmtEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13706, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13705, PropCategory.REGULAR)
