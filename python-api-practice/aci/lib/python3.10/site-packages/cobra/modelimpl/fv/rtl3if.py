...
class RtL3If(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtL3If", "cobra.model.l3.If")

    meta.moClassName = "fvRtL3If"
    meta.rnFormat = "rtl3If"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Interface"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x600020000081
    ...
    prop = PropMeta("str", "tCl", "tCl", 12819, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15150, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
