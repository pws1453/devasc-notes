...
# ##################################################
class RtToRemotePbrIpsla(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemotePbrIpsla", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemotePbrIpsla"
    meta.rnFormat = "rttoRemotePbrIpsla-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55785, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55784, PropCategory.REGULAR)
