...
# ##################################################
class AttrDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.AttrDefCont")

    meta.moClassName = "fvAttrDefCont"
    meta.rnFormat = "attrcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Member Container"
    ...
    meta.childClasses.add("cobra.model.fv.DyMacAttrDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.DyMacAttrDef", "dymacattrdef-"))
