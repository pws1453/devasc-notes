...
# ##################################################
class CtrctCtxDefContTask(Mo):
    """
    An internal container for objects used for deployment.

    """

    meta = ClassMeta("cobra.model.fv.CtrctCtxDefContTask")

    meta.moClassName = "fvCtrctCtxDefContTask"
    meta.rnFormat = "fvCtrctCtxDefContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16144, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateCtxDefWithEPgDef", "updatectxdefwithepgdef", 1384)
