...
# ##################################################
class RtREPpInfoToBD(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtREPpInfoToBD", "cobra.model.vns.REPpInfo")

    meta.moClassName = "fvRtREPpInfoToBD"
    meta.rnFormat = "rtvnsREPpInfoToBD-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43561, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5959
    prop.defaultValueStr = "vnsREPpInfo"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsREPpInfo", None, 5959)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43560, PropCategory.REGULAR)
