...
# ##################################################
class RtBDDefToBD(Mo):
    """
    A target relation to a bridge domain policy. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtBDDefToBD", "cobra.model.vns.BDDef")

    meta.moClassName = "fvRtBDDefToBD"
    meta.rnFormat = "rtvnsBDDefToBD-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13622, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13621, PropCategory.REGULAR)
