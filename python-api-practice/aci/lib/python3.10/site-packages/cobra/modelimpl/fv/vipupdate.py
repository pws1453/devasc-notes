...
class VipUpdate(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.VipUpdate")

    meta.moClassName = "fvVipUpdate"
    meta.rnFormat = "vipupdate-[%(ctxDefDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "VIP update"
    ...
    prop = PropMeta("str", "ctxDefDn", "ctxDefDn", 19823, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 19827, PropCategory.REGULAR)
