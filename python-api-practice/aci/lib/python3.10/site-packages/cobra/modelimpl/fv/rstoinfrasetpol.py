...
# ##################################################
class RsToInfraSetPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToInfraSetPol", "cobra.model.infra.SetPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToInfraSetPol"
    meta.rnFormat = "rstoInfraSetPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation Infra Knob Settings"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33551, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10720
    prop.defaultValueStr = "infraSetPol"
    prop._addConstant("infraSetPol", None, 10720)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33550, PropCategory.REGULAR)
