...
# ##################################################
class CepNetCfgPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.CepNetCfgPol")

    meta.moClassName = "fvCepNetCfgPol"
    meta.rnFormat = "cepNetCfgPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Client End point Network Configuration Policy For Microsoft"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38417, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dnsSearchSuffix", "dnsSearchSuffix", 23600, PropCategory.REGULAR)
    prop.label = "Dns Search Suffix for Network IP Pool"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("dnsSearchSuffix", prop)

    prop = PropMeta("str", "dnsServers", "dnsServers", 23597, PropCategory.REGULAR)
    prop.label = "Dns Server IP address for Network IP Pool"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("dnsServers", prop)

    prop = PropMeta("str", "dnsSuffix", "dnsSuffix", 23599, PropCategory.REGULAR)
    prop.label = "Dns Suffix for Network IP Pool"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("dnsSuffix", prop)

    prop = PropMeta("str", "endIp", "endIp", 23596, PropCategory.REGULAR)
    prop.label = "End IP address for Network IP Pool"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("endIp", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40556, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 23602, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "startIp", "startIp", 23595, PropCategory.REGULAR)
    prop.label = "Start IP address for Network IP Pool"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("startIp", prop)
    ...
    prop = PropMeta("str", "winsServers", "winsServers", 23598, PropCategory.REGULAR)
    prop.label = "Wins servers IP address for Network IP Pool"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("winsServers", prop)
