...
# ##################################################
class RtExtdevMgrMgmtEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtExtdevMgrMgmtEPg", "cobra.model.extdev.MgrP")

    meta.moClassName = "fvRtExtdevMgrMgmtEPg"
    meta.rnFormat = "rtextdevExtdevMgrMgmtEPg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43849, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43848, PropCategory.REGULAR)
