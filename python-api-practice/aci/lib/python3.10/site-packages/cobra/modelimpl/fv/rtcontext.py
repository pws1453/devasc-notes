...
class RtContext(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtContext", "cobra.model.dbgac.IpToIp")

    meta.moClassName = "fvRtContext"
    meta.rnFormat = "rtdbgacContext-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23107, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7823
    prop.defaultValueStr = "dbgacIpToIp"
    prop._addConstant("dbgacIpToIp", None, 7823)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23106, PropCategory.REGULAR)
