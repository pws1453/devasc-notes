...
# ##################################################
class RsToRemoteCtrctEPgCont(Mo):
    """
    A source relation to the container for a contract endpoint group. 

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteCtrctEPgCont", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteCtrctEPgCont"
    meta.rnFormat = "rstoRemoteCtrctEPgCont-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Contract EPG Container"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16428, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1378
    prop.defaultValueStr = "vzCtrctEPgCont"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzCtrctEPgCont", None, 1378)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16427, PropCategory.REGULAR)
