...
# ##################################################
class RsToRemoteRFltP(Mo):
    """
    A source relation to an abstraction of a filterable unit.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRFltP", "cobra.model.vz.AFilterableUnit")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRFltP"
    meta.rnFormat = "rstoRemoteRFltP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Relation used to pull policies to Node with Flow-Control"
    ...
    meta.superClasses.add("cobra.model.fv.ARsToRemoteFC")

    meta.rnPrefixes = [
        ('rstoRemoteRFltP-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 17678, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17677, PropCategory.REGULAR)
