...
class RsProtBy(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsProtBy", "cobra.model.vz.Taboo")
    meta.targetNameProps["name"] = "tnVzTabooName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsProtBy"
    meta.rnFormat = "rsprotBy-%(tnVzTabooName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Taboo Contract Association"
    ...
    meta.childClasses.add("cobra.model.fv.TabooCtxDefCont")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.TabooCtxDefCont", "tabooCtxdefDn-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37654, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39793, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14263, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12232, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1306
    prop.defaultValueStr = "vzTaboo"
    ...
    prop = PropMeta("str", "tnVzTabooName", "tnVzTabooName", 12231, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnVzTabooName", prop)

    prop = PropMeta("str", "triggerSt", "triggerSt", 16151, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.namingProps.append(getattr(meta.props, "tnVzTabooName"))
    ...
    def __init__(self, parentMoOrDn, tnVzTabooName, markDirty=True, **creationProps):
        namingVals = [tnVzTabooName]
