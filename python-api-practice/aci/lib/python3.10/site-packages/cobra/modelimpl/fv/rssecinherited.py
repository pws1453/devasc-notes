...
# ##################################################
class RsSecInherited(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsSecInherited", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsSecInherited"
    meta.rnFormat = "rssecInherited-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Security inheritance"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38671, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40810, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30566, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 30562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30561, PropCategory.REGULAR)
