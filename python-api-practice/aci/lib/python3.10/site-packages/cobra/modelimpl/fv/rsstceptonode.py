...
# ##################################################
class RsStCEpToNode(Mo):
    """
    A source relation to the root node for the APIC. 

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStCEpToNode", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsStCEpToNode"
    meta.rnFormat = "rsstCEpToNode-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40218, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 15263, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15262, PropCategory.REGULAR)
