...
class RtMgmtEPg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtMgmtEPg", "cobra.model.vmm.CtrlrP")

    meta.moClassName = "fvRtMgmtEPg"
    meta.rnFormat = "rtvmmMgmtEPg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "VMM Controller"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x6000010000040713
    ...
    prop = PropMeta("str", "tCl", "tCl", 12506, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12505, PropCategory.REGULAR)
