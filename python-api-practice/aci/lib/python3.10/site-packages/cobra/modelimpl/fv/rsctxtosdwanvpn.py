...
# ##################################################
class RsCtxToSDWanVpn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsCtxToSDWanVpn", "cobra.model.extdev.SDWanVpnEntry")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsCtxToSDWanVpn"
    meta.rnFormat = "rsctxToSDWanVpn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relationship to External SDWan VPN"
    ...
    meta.rnPrefixes = [
        ('rsctxToSDWanVpn', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55608, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55609, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55605, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 55596, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16318
    prop.defaultValueStr = "extdevSDWanVpnEntry"
    prop._addConstant("extdevSDWanVpnEntry", None, 16318)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55595, PropCategory.REGULAR)
