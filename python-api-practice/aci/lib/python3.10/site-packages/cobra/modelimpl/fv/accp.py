...
class AccP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.AccP")

    meta.moClassName = "fvAccP"
    meta.rnFormat = "accp"
    meta.category = MoCategory.REGULAR
    meta.label = "Legacy Mode"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38078, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "encap", "encap", 15219, PropCategory.REGULAR)
    prop.label = "BD Access Encap"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40217, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
