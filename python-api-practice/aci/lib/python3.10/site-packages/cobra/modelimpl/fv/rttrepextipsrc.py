...
# ##################################################
class RtTrEpExtIpSrc(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTrEpExtIpSrc", "cobra.model.traceroutep.TrEpExt")

    meta.moClassName = "fvRtTrEpExtIpSrc"
    meta.rnFormat = "rttraceroutepTrEpExtIpSrc-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rttraceroutepTrEpExtIpSrc-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 19074, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6372
    prop.defaultValueStr = "traceroutepTrEpExt"
    prop._addConstant("traceroutepTrEpExt", None, 6372)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 19073, PropCategory.REGULAR)
