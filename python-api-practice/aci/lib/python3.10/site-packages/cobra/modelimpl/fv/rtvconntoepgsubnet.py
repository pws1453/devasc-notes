...
# ##################################################
class RtVConnToEpgSubnet(Mo):
    """
    A target relation to a set of endpoints. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtVConnToEpgSubnet", "cobra.model.vns.VEpg")

    meta.moClassName = "fvRtVConnToEpgSubnet"
    meta.rnFormat = "rtvnsVConnToEpgSubnet-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13736, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4909
    prop.defaultValueStr = "vnsVEpg"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsVEpg", None, 4909)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13735, PropCategory.REGULAR)
