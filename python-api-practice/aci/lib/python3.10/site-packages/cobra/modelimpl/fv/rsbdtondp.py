...
class RsBDToNdP(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDToNdP", "cobra.model.nd.IfPol")
    meta.targetNameProps["name"] = "tnNdIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsBDToNdP"
    meta.rnFormat = "rsBDToNdP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ND Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38161, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40300, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17820, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17816, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5977
    prop.defaultValueStr = "ndIfPol"
    ...
    prop = PropMeta("str", "tnNdIfPolName", "tnNdIfPolName", 17815, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnNdIfPolName", prop)
