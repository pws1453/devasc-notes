...
# ##################################################
class RsBDToProfileDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDToProfileDef", "cobra.model.rtctrl.Profile")
    meta.targetNameProps["name"] = "tnRtctrlProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsBDToProfileDef"
    meta.rnFormat = "rsBDToProfileDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Route Control Profile Def"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 20362, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 20358, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL3extOutName", "tnL3extOutName", 20356, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "tnRtctrlProfileName", "tnRtctrlProfileName", 20357, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
