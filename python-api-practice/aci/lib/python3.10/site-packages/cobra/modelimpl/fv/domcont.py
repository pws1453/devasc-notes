...
class DomCont(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.DomCont")

    meta.moClassName = "fvDomCont"
    meta.rnFormat = "domcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Domain Container"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14233, PropCategory.REGULAR)
