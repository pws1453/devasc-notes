...
class EpDefTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.EpDefTask")

    meta.moClassName = "fvEpDefTask"
    meta.rnFormat = "fvEpDefTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.fv.EpDefContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.EpDefContext", "fvEpDef"))
    ...
    prop = PropMeta("str", "id", "id", 5662, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateEp", "updateep", 464)
