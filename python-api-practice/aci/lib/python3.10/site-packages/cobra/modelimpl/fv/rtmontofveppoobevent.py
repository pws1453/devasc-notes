...
# ##################################################
class RtMonToFvEppOobEvent(Mo):
    """
    A target relation to an out-of-band management endpoint profile for a fabric node management endpoint group.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtMonToFvEppOobEvent", "cobra.model.fault.RelnHolder")

    meta.moClassName = "fvRtMonToFvEppOobEvent"
    meta.rnFormat = "rtfaultMonToFvEppOobEvent-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfaultMonToFvEppOobEvent-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 16196, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16195, PropCategory.REGULAR)
