...
# ##################################################
class RtToEpgTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RtToEpgTask")

    meta.moClassName = "fvRtToEpgTask"
    meta.rnFormat = "fvRtToEpgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 25947, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DbgacToEpg", "dbgactoepg", 2266)
