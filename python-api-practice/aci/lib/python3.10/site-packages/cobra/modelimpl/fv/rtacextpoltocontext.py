...
# ##################################################
class RtAcExtPolToContext(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtAcExtPolToContext", "cobra.model.dbgac.TenantSpaceCmn")

    meta.moClassName = "fvRtAcExtPolToContext"
    meta.rnFormat = "rtdbgacAcExtPolToContext-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x601001002100f701
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 23325, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 23323, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4008
    prop.defaultValueStr = "dbgacTenantSpaceCmn"
    ...
    prop = PropMeta("str", "tDn", "tDn", 23322, PropCategory.REGULAR)
