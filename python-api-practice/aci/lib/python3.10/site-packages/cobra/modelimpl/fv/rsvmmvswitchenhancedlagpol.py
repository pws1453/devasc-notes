...
# ##################################################
class RsVmmVSwitchEnhancedLagPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsVmmVSwitchEnhancedLagPol", "cobra.model.lacp.EnhancedLagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsVmmVSwitchEnhancedLagPol"
    meta.rnFormat = "rsvmmVSwitchEnhancedLagPol"
    ...
    meta.rnPrefixes = [
        ('rsvmmVSwitchEnhancedLagPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 44920, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44921, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44914, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 44909, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44908, PropCategory.REGULAR)
