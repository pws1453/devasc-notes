...
# ##################################################
class UpdateContract(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.UpdateContract")

    meta.moClassName = "fvUpdateContract"
    meta.rnFormat = "updateContract"
    meta.category = MoCategory.REGULAR
    meta.label = "Update Contract"
