...
class InBEpPTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.InBEpPTask")

    meta.moClassName = "fvInBEpPTask"
    meta.rnFormat = "fvInBEpPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16259, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("InBUpd", "inbupd", 1402)
