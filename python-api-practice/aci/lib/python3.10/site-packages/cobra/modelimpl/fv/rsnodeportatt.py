...
# ##################################################
class RsNodePortAtt(Mo):
    """
    A source relation to an L1 interface. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsNodePortAtt", "cobra.model.l1.EthIf")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsNodePortAtt"
    meta.rnFormat = "rsnodePortAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "instrImedcy", "instrImedcy", 12298, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14282, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12297, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12296, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15031, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
