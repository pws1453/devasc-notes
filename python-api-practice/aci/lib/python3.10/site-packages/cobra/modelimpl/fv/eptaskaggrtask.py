...
# ##################################################
class EpTaskAggrTask(Mo):
    """
    An internal task for bridge domain deployment.

    """

    meta = ClassMeta("cobra.model.fv.EpTaskAggrTask")

    meta.moClassName = "fvEpTaskAggrTask"
    meta.rnFormat = "fvEpTaskAggrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5663, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EndPointAggrUpd", "endpointaggrupd", 554)
    prop._addConstant("UpdateEpAggr", "updateepaggr", 465)
