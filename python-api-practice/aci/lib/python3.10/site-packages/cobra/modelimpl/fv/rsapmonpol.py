...
class RsApMonPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsApMonPol", "cobra.model.mon.EPGPol")
    meta.targetNameProps["name"] = "tnMonEPGPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsApMonPol"
    meta.rnFormat = "rsApMonPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37637, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39776, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14237, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12310, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonEPGPolName", "tnMonEPGPolName", 12309, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
