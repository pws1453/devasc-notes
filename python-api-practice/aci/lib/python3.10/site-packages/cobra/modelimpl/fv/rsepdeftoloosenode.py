...
# ##################################################
class RsEpDefToLooseNode(Mo):
    """
    A source relation to an external unmanaged node.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEpDefToLooseNode", "cobra.model.leqpt.LooseNode")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEpDefToLooseNode"
    meta.rnFormat = "rsepDefToLooseNode"
    ...
    prop = PropMeta("str", "lcC", "lcC", 15659, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 15658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15657, PropCategory.REGULAR)
