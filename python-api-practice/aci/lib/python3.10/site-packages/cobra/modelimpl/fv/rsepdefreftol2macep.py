...
# ##################################################
class RsEpDefRefToL2MacEp(Mo):
    """
    A source relation to a static Mac endpoint.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEpDefRefToL2MacEp", "cobra.model.l2.MacEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEpDefRefToL2MacEp"
    meta.rnFormat = "rsEpDefRefToL2MacEp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Desired MAC Endpoint"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16276, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3409
    prop.defaultValueStr = "l2MacEp"
    prop._addConstant("l2MacEp", None, 3409)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16275, PropCategory.REGULAR)
