...
class RsToEpDef(Mo):
    """
    A source relation to an endpoint definition. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToEpDef", "cobra.model.fv.EpDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToEpDef"
    meta.rnFormat = "rstoEpDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12418, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12417, PropCategory.REGULAR)
