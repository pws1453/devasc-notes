...
# ##################################################
class RsToFvPrimaryEncapDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToFvPrimaryEncapDef", "cobra.model.fv.PrimaryEncapDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToFvPrimaryEncapDef"
    meta.rnFormat = "rstoFvPrimaryEncapDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Primary Encap"
    ...
    meta.childClasses.add("cobra.model.fv.ByDom")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ByDom", "byDom-"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 23493, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7815
    prop.defaultValueStr = "fvPrimaryEncapDef"
    prop._addConstant("fvPrimaryEncapDef", None, 7815)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23492, PropCategory.REGULAR)
