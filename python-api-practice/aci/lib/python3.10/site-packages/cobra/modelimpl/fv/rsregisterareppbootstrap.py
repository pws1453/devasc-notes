...
# ##################################################
class RsRegisterAREpPBootStrap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsRegisterAREpPBootStrap", "cobra.model.fv.AREpPBootStrap")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsRegisterAREpPBootStrap"
    meta.rnFormat = "rsregisterAREpPBootStrap"
    ...
    meta.rnPrefixes = [
        ('rsregisterAREpPBootStrap', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 21187, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7164
    prop.defaultValueStr = "fvAREpPBootStrap"
    prop._addConstant("fvAREpPBootStrap", None, 7164)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 21186, PropCategory.REGULAR)
