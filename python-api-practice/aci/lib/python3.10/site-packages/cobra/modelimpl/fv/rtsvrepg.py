...
class RtSvrEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtSvrEpg", "cobra.model.dnsepg.ASvrGrp")

    meta.moClassName = "fvRtSvrEpg"
    meta.rnFormat = "rtdnsepgSvrEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33304, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10669
    prop.defaultValueStr = "dnsepgASvrGrp"
    prop._addConstant("dnsepgASvrGrp", None, 10669)
    prop._addConstant("dnsepgSvrGrp", None, 10672)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 33303, PropCategory.REGULAR)
