...
# ##################################################
class RtVConnToEpgEp(Mo):
    """
    A target relation to a set of endpoints. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtVConnToEpgEp", "cobra.model.vns.VEpg")

    meta.moClassName = "fvRtVConnToEpgEp"
    meta.rnFormat = "rtvnsVConnToEpgEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13732, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13731, PropCategory.REGULAR)
