...
class OverallHealthHist1qtr(Mo):
    """
    A class that represents historical statistics for overall tenant health in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealthHist1qtr", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealthHist1qtr"
    meta.rnFormat = "HDfvOverallHealth1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical overall tenant health stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6548, PropCategory.REGULAR)
