...
# ##################################################
class RemoteIdTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RemoteIdTask")

    meta.moClassName = "fvRemoteIdTask"
    meta.rnFormat = "fvRemoteIdTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 28402, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("MultisiteUpd", "multisiteupd", 2578)
