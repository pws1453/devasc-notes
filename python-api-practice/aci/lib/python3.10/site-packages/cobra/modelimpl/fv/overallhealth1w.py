...
class OverallHealth1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.fv.OverallHealth1w", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealth1w"
    meta.rnFormat = "CDfvOverallHealth1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall tenant health stats in 1 week"
