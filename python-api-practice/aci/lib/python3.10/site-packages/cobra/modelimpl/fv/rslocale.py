...
class RsLocale(Mo):
    """
    The fabric node where this endpoint profile is present.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsLocale", "cobra.model.fv.Locale")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fvRsLocale"
    meta.rnFormat = "rslocale-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fv.PolResolver")
    ...
    prop = PropMeta("str", "tCl", "tCl", 15472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15471, PropCategory.REGULAR)
