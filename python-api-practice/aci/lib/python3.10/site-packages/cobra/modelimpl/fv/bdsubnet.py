...
class BDSubnet(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.BDSubnet")

    meta.moClassName = "fvBDSubnet"
    meta.rnFormat = "bdsub-[%(ip)s]"
    ...
    prop = PropMeta("str", "ip", "ip", 20342, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "scope", "scope", 20340, PropCategory.REGULAR)
