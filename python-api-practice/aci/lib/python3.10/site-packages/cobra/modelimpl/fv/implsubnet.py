...
class ImplSubnet(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.ImplSubnet")

    meta.moClassName = "fvImplSubnet"
    meta.rnFormat = "ImplSubnet-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ImplSubnet"
    ...
    meta.childClasses.add("cobra.model.fv.ImplEpAnycast")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ImplEpAnycast", "ImplepAnycast-"))
    ...
    prop = PropMeta("str", "ip", "ip", 15752, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26721, PropCategory.REGULAR)
