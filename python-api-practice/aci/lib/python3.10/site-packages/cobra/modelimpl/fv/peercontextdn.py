...
# ##################################################
class PeerContextDn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.PeerContextDn")

    meta.moClassName = "fvPeerContextDn"
    meta.rnFormat = "peerctx-[%(ctxDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Peer Context Dn"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38677, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 32630, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40816, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
