...
class RtFromEpIp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtFromEpIp", "cobra.model.dbgac.FromEpCmn")

    meta.moClassName = "fvRtFromEpIp"
    meta.rnFormat = "rtdbgacFromEpIp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15815, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15814, PropCategory.REGULAR)
