...
class RsStGrpAtt(Mo):
    """
    A source relation to the port functions. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStGrpAtt", "cobra.model.infra.AccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsStGrpAtt"
    meta.rnFormat = "rsstGrpAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "isDeployedUsingFilters", "isDeployedUsingFilters", 12277, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12275, PropCategory.REGULAR)
