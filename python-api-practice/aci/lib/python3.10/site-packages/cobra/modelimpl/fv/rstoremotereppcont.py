...
# ##################################################
class RsToRemoteREpPCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteREpPCont", "cobra.model.fv.REpPCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToRemoteREpPCont"
    meta.rnFormat = "rstoRemoteREpPCont"
    ...
    meta.parentClasses.add("cobra.model.fv.PullREpPCont")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rstoRemoteREpPCont', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 20452, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20451, PropCategory.REGULAR)
