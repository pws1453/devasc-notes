...
# ##################################################
class RtTenantInfra(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTenantInfra", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "fvRtTenantInfra"
    meta.rnFormat = "rttenantInfra"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23115, PropCategory.REGULAR)
