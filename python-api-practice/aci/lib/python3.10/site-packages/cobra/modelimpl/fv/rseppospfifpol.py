...
# ##################################################
class RsEppOspfIfPol(Mo):
    """
    A source relation to the OSPF interface-level policy information. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppOspfIfPol", "cobra.model.ospf.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEppOspfIfPol"
    meta.rnFormat = "rseppOspfIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12260, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12259, PropCategory.REGULAR)
