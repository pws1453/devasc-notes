...
# ##################################################
class OptedPlanSrvc(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fv.OptedPlanSrvc")

    meta.moClassName = "fvOptedPlanSrvc"
    meta.rnFormat = "srvc-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Opted Orchestrator Plan Service"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38138, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 17933, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40277, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 16593, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "srvcDn", "srvcDn", 16590, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("srvcDn", prop)
