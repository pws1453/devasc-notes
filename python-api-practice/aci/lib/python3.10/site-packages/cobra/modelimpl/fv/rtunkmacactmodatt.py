...
# ##################################################
class RtUnkMacActModAtt(Mo):
    """
    A target relation to the bridge domain policy modifier. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtUnkMacActModAtt", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "fvRtUnkMacActModAtt"
    meta.rnFormat = "rtvnsUnkMacActModAtt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fv.UnkMacUcastActMod")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtvnsUnkMacActModAtt-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 13649, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13648, PropCategory.REGULAR)
