...
# ##################################################
class RsCtxToExtRouteTagPol(Mo):
    """
    

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsCtxToExtRouteTagPol", "cobra.model.l3ext.RouteTagPol")
    meta.targetNameProps["name"] = "tnL3extRouteTagPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsCtxToExtRouteTagPol"
    meta.rnFormat = "rsctxToExtRouteTagPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relationship to External/Transit Route Tag Policy"
    ...
    meta.rnPrefixes = [
        ('rsctxToExtRouteTagPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38218, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40357, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18590, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18587, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6235
    prop.defaultValueStr = "l3extRouteTagPol"
    ...
    prop = PropMeta("str", "tnL3extRouteTagPolName", "tnL3extRouteTagPolName", 18586, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL3extRouteTagPolName", prop)
