...
# ##################################################
class ReportingNode(Mo):
    """
    The node reporting a corresponding endpoint. This enables a user to see on which nodes the endpoints are present.  This is an internally created object.

    """

    meta = ClassMeta("cobra.model.fv.ReportingNode")

    meta.moClassName = "fvReportingNode"
    meta.rnFormat = "node-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Node who has Reported Info Regarding this CEp"
    ...
    meta.parentClasses.add("cobra.model.fv.RsHyper")
    meta.parentClasses.add("cobra.model.fv.RsToNic")
    meta.parentClasses.add("cobra.model.fv.RsToVm")
    meta.parentClasses.add("cobra.model.fv.RsCEpToPathEp")
    meta.parentClasses.add("cobra.model.fv.Ip")
    meta.parentClasses.add("cobra.model.fv.PrimaryEncap")
    ...
    prop = PropMeta("str", "createTs", "createTs", 44618, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 1790, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "lcC", "lcC", 1791, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
