...
# ##################################################
class RsToRemoteRtdOutDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRtdOutDef", "cobra.model.l3ext.RtdOutDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRtdOutDef"
    meta.rnFormat = "rstoRemoteRtdOutDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Routed Out Definition"
    ...
    prop = PropMeta("str", "tCl", "tCl", 37260, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11838
    prop.defaultValueStr = "l3extRtdOutDef"
    prop._addConstant("l3extRtdOutDef", None, 11838)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 37259, PropCategory.REGULAR)
