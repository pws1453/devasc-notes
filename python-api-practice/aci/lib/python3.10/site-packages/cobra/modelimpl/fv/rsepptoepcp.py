...
# ##################################################
class RsEppToEpCP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppToEpCP", "cobra.model.fv.EpCP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEppToEpCP"
    meta.rnFormat = "rseppToEpCP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to EP criterion profile"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20973, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20972, PropCategory.REGULAR)
