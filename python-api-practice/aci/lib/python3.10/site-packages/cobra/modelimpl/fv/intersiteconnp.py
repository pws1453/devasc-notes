...
# ##################################################
class IntersiteConnP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.IntersiteConnP")

    meta.moClassName = "fvIntersiteConnP"
    meta.rnFormat = "intersiteConnP-[%(addr)s]"
    ...
    prop = PropMeta("str", "addr", "addr", 30385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38660, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40799, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30389, PropCategory.REGULAR)
