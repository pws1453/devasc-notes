...
# ##################################################
class StaleTunEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.StaleTunEpTask")

    meta.moClassName = "fvStaleTunEpTask"
    meta.rnFormat = "fvStaleTunEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 28530, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("StaleTunDetach", "staletundetach", 2590)
