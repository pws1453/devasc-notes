...
class RtCopyCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtCopyCtx", "cobra.model.vns.SvcRelnHolder")

    meta.moClassName = "fvRtCopyCtx"
    meta.rnFormat = "rtvnsCopyCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23292, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23291, PropCategory.REGULAR)
