...
# ##################################################
class SubnetBDDefContTask(Mo):
    """
    An internal container for objects used for deployment.

    """

    meta = ClassMeta("cobra.model.fv.SubnetBDDefContTask")

    meta.moClassName = "fvSubnetBDDefContTask"
    meta.rnFormat = "fvSubnetBDDefContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16145, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateBDDefWithRouteDef", "updatebddefwithroutedef", 1382)
    prop._addConstant("UpdateBDHolder", "updatebdholder", 1415)
