...
# ##################################################
class RtVxlanEppAtt(Mo):
    """
    A target relation to the resolvable endpoint profile. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtVxlanEppAtt", "cobra.model.vxlan.CktEp")

    meta.moClassName = "fvRtVxlanEppAtt"
    meta.rnFormat = "rtvxlanVxlanEppAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Vxlan"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x2000210021020683
    ...
    prop = PropMeta("str", "tCl", "tCl", 12709, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3393
    prop.defaultValueStr = "vxlanCktEp"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vxlanCktEp", None, 3393)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12708, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15078, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
