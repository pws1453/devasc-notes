...
class RtPoeEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtPoeEpg", "cobra.model.poe.IfPol")

    meta.moClassName = "fvRtPoeEpg"
    meta.rnFormat = "rtpoePoeEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 44907, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44906, PropCategory.REGULAR)
