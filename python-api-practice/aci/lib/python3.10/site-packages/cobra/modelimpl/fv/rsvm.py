...
class RsVm(Mo):
    """
    A source relation to a virtual machine connected to a hypervisor. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsVm"
    meta.rnFormat = "rsvm"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12394, PropCategory.REGULAR)
