...
# ##################################################
class RsTnlpathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsTnlpathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fvRsTnlpathAtt"
    meta.rnFormat = "rstnlpathAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 27300, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40682, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "lcC", "lcC", 27301, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 27303, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27302, PropCategory.REGULAR)
