...
# ##################################################
class EPgSummaryDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.EPgSummaryDef")

    meta.moClassName = "fvEPgSummaryDef"
    meta.rnFormat = "epgsummarydef-[%(epgDn)s]"
    ...
    prop = PropMeta("str", "areppDn", "areppDn", 35706, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("areppDn", prop)

    prop = PropMeta("str", "bdDefDn", "bdDefDn", 28465, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdDefDn", prop)

    prop = PropMeta("str", "bdDefStQual", "bdDefStQual", 28466, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ctxDefDn", "ctxDefDn", 28467, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ctxDefDn", prop)

    prop = PropMeta("str", "ctxDefStQual", "ctxDefStQual", 28468, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 28464, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28470, PropCategory.REGULAR)
