...
# ##################################################
class RsStCEpToPathEp(Mo):
    """
    A source relation to the abstraction of a path endpoint. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStCEpToPathEp", "cobra.model.fabric.APathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsStCEpToPathEp"
    meta.rnFormat = "rsstCEpToPathEp-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsstCEpToPathEp-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39808, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12398, PropCategory.REGULAR)
