...
# ##################################################
class RtDefInfraBd(Mo):
    """
    A target relation to a private layer 2 bridge domain (BD).

    """

    meta = TargetRelationMeta("cobra.model.fv.RtDefInfraBd", "cobra.model.pres.Registry")

    meta.moClassName = "fvRtDefInfraBd"
    meta.rnFormat = "rtpresDefInfraBd-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17858, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3963
    prop.defaultValueStr = "presRegistry"
    prop._addConstant("presRegistry", None, 3963)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17857, PropCategory.REGULAR)
