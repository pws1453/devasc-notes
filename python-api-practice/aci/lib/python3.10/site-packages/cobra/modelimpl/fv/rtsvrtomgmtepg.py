...
# ##################################################
class RtSvrToMgmtEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSvrToMgmtEPg", "cobra.model.auth.Svr")

    meta.moClassName = "fvRtSvrToMgmtEPg"
    meta.rnFormat = "rtauthSvrToMgmtEPg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Auth Server"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x600231000006c713
    ...
    prop = PropMeta("str", "tCl", "tCl", 43841, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12667
    prop.defaultValueStr = "authSvr"
    prop._addConstant("authSvr", None, 12667)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43840, PropCategory.REGULAR)
