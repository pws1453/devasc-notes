...
class RtFromEp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtFromEp", "cobra.model.dbgac.FromEpCmn")

    meta.moClassName = "fvRtFromEp"
    meta.rnFormat = "rtdbgacFromEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12926, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4087
    prop.defaultValueStr = "dbgacFromEpCmn"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12925, PropCategory.REGULAR)
