...
# ##################################################
class RtToRemoteMember(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteMember", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteMember"
    meta.rnFormat = "rttoRemoteMember-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49431, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 49430, PropCategory.REGULAR)
