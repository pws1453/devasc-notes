...
# ##################################################
class RsDomDefNsLocal(Mo):
    """
    A source relation to the VxLAN namespace policy definition. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsDomDefNsLocal", "cobra.model.fvns.VxlanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsDomDefNsLocal"
    meta.rnFormat = "rsdomDefNsLocal"
    ...
    meta.rnPrefixes = [
        ('rsdomDefNsLocal', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37635, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39774, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14235, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12156, PropCategory.REGULAR)
