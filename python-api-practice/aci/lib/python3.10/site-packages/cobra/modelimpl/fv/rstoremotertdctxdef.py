...
# ##################################################
class RsToRemoteRtdCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRtdCtxDef", "cobra.model.l3ext.RtdCtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRtdCtxDef"
    meta.rnFormat = "rstoRemoteRtdCtxDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Routed Ctx Definition"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52751, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15456
    prop.defaultValueStr = "l3extRtdCtxDef"
    prop._addConstant("l3extRtdCtxDef", None, 15456)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52750, PropCategory.REGULAR)
