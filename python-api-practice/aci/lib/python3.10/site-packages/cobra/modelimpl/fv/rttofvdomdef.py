...
# ##################################################
class RtToFvDomDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToFvDomDef", "cobra.model.fv.AEpDef")

    meta.moClassName = "fvRtToFvDomDef"
    meta.rnFormat = "rttoFvDomDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23491, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23490, PropCategory.REGULAR)
