...
# ##################################################
class RsAeToCtrct(Mo):
    """
    A source relation to the container for a contract endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsAeToCtrct", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsAeToCtrct"
    meta.rnFormat = "rsaeToCtrct"
    ...
    meta.parentClasses.add("cobra.model.fv.UtilizedCtrct")
    meta.parentClasses.add("cobra.model.fv.REpPCtrct")
    ...
    prop = PropMeta("str", "tCl", "tCl", 16525, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16524, PropCategory.REGULAR)
