...
# ##################################################
class AAREpPRequestorTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.AAREpPRequestorTask")

    meta.moClassName = "fvAAREpPRequestorTask"
    meta.rnFormat = "fvAAREpPRequestorTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23666, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AREpPRequest", "arepprequest", 2114)
