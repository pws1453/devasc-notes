...
# ##################################################
class GipoSyncTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.GipoSyncTask")

    meta.moClassName = "fvGipoSyncTask"
    meta.rnFormat = "fvGipoSyncTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33547, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SendLocallyAllocated", "sendlocallyallocated", 2809)
