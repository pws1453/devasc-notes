...
class RtToEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtToEpg", "cobra.model.dbgac.ToEpgCmn")

    meta.moClassName = "fvRtToEpg"
    meta.rnFormat = "rtdbgacToEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12885, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4069
    prop.defaultValueStr = "dbgacToEpgCmn"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12884, PropCategory.REGULAR)
