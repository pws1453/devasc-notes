...
# ##################################################
class RtCloudEPgCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtCloudEPgCtx", "cobra.model.cloud.AAEPg")

    meta.moClassName = "fvRtCloudEPgCtx"
    meta.rnFormat = "rtcloudCloudEPgCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51259, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14641
    prop.defaultValueStr = "cloudAAEPg"
    ...
    prop = PropMeta("str", "tDn", "tDn", 51258, PropCategory.REGULAR)
