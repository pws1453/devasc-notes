...
class RtTenant(Mo):
    """
    A target relation to a policy owner in the virtual fabric.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTenant", "cobra.model.vns.RelnHolder")

    meta.moClassName = "fvRtTenant"
    meta.rnFormat = "rtvnsTenant-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18192, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6115
    prop.defaultValueStr = "vnsRelnHolder"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsRelnHolder", None, 6115)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18191, PropCategory.REGULAR)
