...
# ##################################################
class RsToRemoteEpCP(Mo):
    """
    

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteEpCP", "cobra.model.fv.EpCP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteEpCP"
    meta.rnFormat = "rstoRemoteEpCP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18606, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6202
    prop.defaultValueStr = "fvEpCP"
    prop._addConstant("fvEpCP", None, 6202)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 18605, PropCategory.REGULAR)
