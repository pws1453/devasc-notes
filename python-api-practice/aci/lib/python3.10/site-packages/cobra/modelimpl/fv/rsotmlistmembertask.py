...
# ##################################################
class RsOtmListMemberTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RsOtmListMemberTask")

    meta.moClassName = "fvRsOtmListMemberTask"
    meta.rnFormat = "fvRsOtmListMemberTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 51759, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("sendTrackListReln", "sendtracklistreln", 3427)
