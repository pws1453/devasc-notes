...
# ##################################################
class ConfigLocale(Mo):
    """
    An internal object for managing endpoint profile deployment.

    """

    meta = ClassMeta("cobra.model.fv.ConfigLocale")

    meta.moClassName = "fvConfigLocale"
    meta.rnFormat = "configLocale"
    meta.category = MoCategory.REGULAR
    meta.label = "Anchor to Trigger Logic to Update Locale Configuration"
