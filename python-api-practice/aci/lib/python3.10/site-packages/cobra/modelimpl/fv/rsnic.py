...
class RsNic(Mo):
    """
    A source relation to an interface. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsNic", "cobra.model.comp.Nic")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsNic"
    meta.rnFormat = "rsnic"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12391, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12390, PropCategory.REGULAR)
