...
class RtToCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtToCtx", "cobra.model.cloud.CtxProfile")

    meta.moClassName = "fvRtToCtx"
    meta.rnFormat = "rtcloudToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51231, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51230, PropCategory.REGULAR)
