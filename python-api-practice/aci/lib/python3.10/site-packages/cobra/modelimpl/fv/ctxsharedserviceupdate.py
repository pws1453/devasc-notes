...
# ##################################################
class CtxSharedServiceUpdate(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.CtxSharedServiceUpdate")

    meta.moClassName = "fvCtxSharedServiceUpdate"
    meta.rnFormat = "ctxShrSrvUpd-[%(ctxDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Ctx Shared Service Update"
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 21346, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21361, PropCategory.REGULAR)
