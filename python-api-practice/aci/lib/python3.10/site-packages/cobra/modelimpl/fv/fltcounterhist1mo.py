...
# ##################################################
class FltCounterHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fv.FltCounterHist1mo", "Fault Counter")
    ...
    meta.moClassName = "fvFltCounterHist1mo"
    meta.rnFormat = "HDfvFltCounter1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fault Counter stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 30180, PropCategory.REGULAR)
