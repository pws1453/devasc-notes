...
class OverallHealth1h(Mo):
    """
    A class that represents the most current statistics for overall tenant health in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealth1h", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealth1h"
    meta.rnFormat = "CDfvOverallHealth1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall tenant health stats in 1 hour"
