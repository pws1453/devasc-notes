...
# ##################################################
class RsToRemoteCtxDef(Mo):
    """
    A source relation to a context definition. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteCtxDef", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteCtxDef"
    meta.rnFormat = "rstoRemoteCtxDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12445, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2008
    prop.defaultValueStr = "fvCtxDef"
    prop._addConstant("fvCtxDef", None, 2008)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12444, PropCategory.REGULAR)
