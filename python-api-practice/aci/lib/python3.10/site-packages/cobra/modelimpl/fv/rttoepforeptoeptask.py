...
# ##################################################
class RtToEpForEpToEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RtToEpForEpToEpTask")

    meta.moClassName = "fvRtToEpForEpToEpTask"
    meta.rnFormat = "fvRtToEpForEpToEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24126, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DbgacEpForEpToEp", "dbgacepforeptoep", 2124)
