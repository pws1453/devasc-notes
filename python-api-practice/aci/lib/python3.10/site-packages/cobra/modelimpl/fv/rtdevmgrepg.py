...
# ##################################################
class RtDevMgrEpg(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fv.RtDevMgrEpg", "cobra.model.vns.DevMgr")

    meta.moClassName = "fvRtDevMgrEpg"
    meta.rnFormat = "rtvnsDevMgrEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18388, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18387, PropCategory.REGULAR)
