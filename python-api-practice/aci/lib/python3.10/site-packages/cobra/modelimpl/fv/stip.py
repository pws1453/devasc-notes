...
class StIp(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.StIp")

    meta.moClassName = "fvStIp"
    ...
    meta.superClasses.add("cobra.model.fv.AStIp")

    meta.rnPrefixes = [
        ('ip-', True),
    ]

    prop = PropMeta("str", "addr", "addr", 17609, PropCategory.REGULAR)
    prop.label = "Static EP IP Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 38155, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40294, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
