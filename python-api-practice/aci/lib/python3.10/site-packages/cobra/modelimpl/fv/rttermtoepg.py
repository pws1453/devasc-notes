...
# ##################################################
class RtTermToEPg(Mo):
    """
    A target relation to a set of endpoints. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTermToEPg", "cobra.model.vns.ATerm")

    meta.moClassName = "fvRtTermToEPg"
    meta.rnFormat = "rtvnsTermToEPg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13527, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13526, PropCategory.REGULAR)
