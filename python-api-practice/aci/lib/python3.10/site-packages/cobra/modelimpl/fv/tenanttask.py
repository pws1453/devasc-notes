...
class TenantTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.TenantTask")

    meta.moClassName = "fvTenantTask"
    meta.rnFormat = "fvTenantTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33283, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateAddrBlkPM", "updateaddrblkpm", 2765)
    prop._addConstant("UpdateDnsPM", "updatednspm", 2764)
