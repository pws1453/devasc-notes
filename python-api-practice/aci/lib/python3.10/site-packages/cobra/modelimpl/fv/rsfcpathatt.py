...
# ##################################################
class RsFcPathAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsFcPathAtt", "cobra.model.fabric.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsFcPathAtt"
    meta.rnFormat = "rsfcPathAtt-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.fc.PinningLbl")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fc.PinningLbl", "pinninglbl-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38478, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 25331, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40617, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 25335, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 25334, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 26026, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "fcoe"
    prop._addConstant("fc", "fc", 1)
    prop._addConstant("fcoe", "fcoe", 0)
    ...
    prop = PropMeta("str", "vsan", "vsan", 26027, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("vsan", prop)

    prop = PropMeta("str", "vsanMode", "vsanMode", 26028, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "regular"
    prop._addConstant("native", "native", 1)
    prop._addConstant("regular", "regular", 0)
    meta.props.add("vsanMode", prop)
