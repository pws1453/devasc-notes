...
# ##################################################
class RtToEpgForEpgToEpgTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RtToEpgForEpgToEpgTask")

    meta.moClassName = "fvRtToEpgForEpgToEpgTask"
    meta.rnFormat = "fvRtToEpgForEpgToEpgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 25948, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DbgacEpgForEpgToEpg", "dbgacepgforepgtoepg", 2267)
