...
# ##################################################
class RsAssocBDDefContToBDHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsAssocBDDefContToBDHolder", "cobra.model.fv.BDHolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsAssocBDDefContToBDHolder"
    meta.rnFormat = "rsassocBDDefContToBDHolder-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fv.AssocBDDefCont")

    meta.superClasses.add("cobra.model.reln.Inst")
    meta.superClasses.add("cobra.model.reln.To")

    meta.rnPrefixes = [
        ('rsassocBDDefContToBDHolder-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 44702, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44701, PropCategory.REGULAR)
