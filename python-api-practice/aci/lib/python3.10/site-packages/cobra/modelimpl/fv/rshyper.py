...
class RsHyper(Mo):
    """
    A source relation to the hypervisor that controls and monitors the APIC VMs. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsHyper", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsHyper"
    meta.rnFormat = "rshyper-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Hypervisor"
    ...
    prop = PropMeta("str", "isBootstrapUpd", "isBootstrapUpd", 22718, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "attach"
    prop._addConstant("attach", "attach", 1)
    prop._addConstant("bootstrap", "bootstrap", 0)
    meta.props.add("isBootstrapUpd", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12382, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1291
    prop.defaultValueStr = "compHv"
    prop._addConstant("compHv", None, 1291)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12381, PropCategory.REGULAR)
