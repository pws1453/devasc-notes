...
class RtFvEppOob(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtFvEppOob", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "fvRtFvEppOob"
    meta.rnFormat = "rtaaaFvEppOob-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11994, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11993, PropCategory.REGULAR)
