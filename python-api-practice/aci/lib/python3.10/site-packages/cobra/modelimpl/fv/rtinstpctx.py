...
class RtInstPCtx(Mo):
    """
    A target relation to the private layer 3 network context that belongs to a specific tenant or is shared.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtInstPCtx", "cobra.model.mgmt.InstP")

    meta.moClassName = "fvRtInstPCtx"
    meta.rnFormat = "rtmgmtInstPCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16236, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2183
    prop.defaultValueStr = "mgmtInstP"
    prop._addConstant("mgmtInstP", None, 2183)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16235, PropCategory.REGULAR)
