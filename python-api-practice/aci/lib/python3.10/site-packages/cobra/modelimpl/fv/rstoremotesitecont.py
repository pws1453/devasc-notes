...
# ##################################################
class RsToRemoteSiteCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteSiteCont", "cobra.model.fv.SiteCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToRemoteSiteCont"
    meta.rnFormat = "rstoRemoteSiteCont"
    ...
    prop = PropMeta("str", "tCl", "tCl", 28411, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9503
    prop.defaultValueStr = "fvSiteCont"
    prop._addConstant("fvSiteCont", None, 9503)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 28410, PropCategory.REGULAR)
