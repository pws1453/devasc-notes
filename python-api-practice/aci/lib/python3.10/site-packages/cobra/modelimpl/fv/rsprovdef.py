...
class RsProvDef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsProvDef", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsProvDef"
    meta.rnFormat = "rsprovDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12353, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12352, PropCategory.REGULAR)
