...
# ##################################################
class RsToRemotePinningPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemotePinningPDef", "cobra.model.fc.PinningPDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemotePinningPDef"
    meta.rnFormat = "rstoRemotePinningPDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 26030, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8980
    prop.defaultValueStr = "fcPinningPDef"
    prop._addConstant("fcPinningPDef", None, 8980)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26029, PropCategory.REGULAR)
