...
# ##################################################
class PolResolver(Mo):
    """
    The policy resolver.

    """

    meta = ClassMeta("cobra.model.fv.PolResolver")

    meta.moClassName = "fvPolResolver"
    meta.rnFormat = "polresolver"
    ...
    meta.childClasses.add("cobra.model.fv.RsLocale")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsLocale", "rslocale-"))
