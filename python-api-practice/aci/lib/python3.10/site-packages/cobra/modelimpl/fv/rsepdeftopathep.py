...
# ##################################################
class RsEpDefToPathEp(Mo):
    """
    A source relation to the path endpoint. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEpDefToPathEp", "cobra.model.nw.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsEpDefToPathEp"
    meta.rnFormat = "rsepDefToPathEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "lcC", "lcC", 15270, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12410, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12409, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15033, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
