...
# ##################################################
class IntersiteMcastConnP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.IntersiteMcastConnP")

    meta.moClassName = "fvIntersiteMcastConnP"
    meta.rnFormat = "intersiteMcastConnP"
    ...
    meta.rnPrefixes = [
        ('intersiteMcastConnP', False),
    ]

    prop = PropMeta("str", "addr", "addr", 30382, PropCategory.REGULAR)
    prop.label = "Data TEP used for Intersite Communication for each POD"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 38661, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40800, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30390, PropCategory.REGULAR)
