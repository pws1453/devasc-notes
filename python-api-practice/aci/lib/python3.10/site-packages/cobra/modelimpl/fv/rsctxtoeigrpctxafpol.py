...
# ##################################################
class RsCtxToEigrpCtxAfPol(Mo):
    """
    A source relation to the per-address family EIGRP context policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsCtxToEigrpCtxAfPol", "cobra.model.eigrp.CtxAfPol")
    meta.targetNameProps["name"] = "tnEigrpCtxAfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsCtxToEigrpCtxAfPol"
    meta.rnFormat = "rsctxToEigrpCtxAfPol-[%(tnEigrpCtxAfPolName)s]-%(af)s"
    ...
    meta.rnPrefixes = [
        ('rsctxToEigrpCtxAfPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "af", "af", 18000, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 38173, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40312, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18016, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18002, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6037
    prop.defaultValueStr = "eigrpCtxAfPol"
    ...
    prop = PropMeta("str", "tnEigrpCtxAfPolName", "tnEigrpCtxAfPolName", 18001, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnEigrpCtxAfPolName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnEigrpCtxAfPolName"))
    getattr(meta.props, "tnEigrpCtxAfPolName").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, tnEigrpCtxAfPolName, af, markDirty=True, **creationProps):
        namingVals = [tnEigrpCtxAfPolName, af]
