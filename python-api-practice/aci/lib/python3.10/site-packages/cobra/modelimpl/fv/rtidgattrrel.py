...
# ##################################################
class RtIdgAttrRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtIdgAttrRel", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "fvRtIdgAttrRel"
    meta.rnFormat = "rtpolIdgAttrRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43786, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43785, PropCategory.REGULAR)
