...
# ##################################################
class FltCounterHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fv.FltCounterHist1qtr", "Fault Counter")
    ...
    meta.moClassName = "fvFltCounterHist1qtr"
    meta.rnFormat = "HDfvFltCounter1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fault Counter stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 30181, PropCategory.REGULAR)
