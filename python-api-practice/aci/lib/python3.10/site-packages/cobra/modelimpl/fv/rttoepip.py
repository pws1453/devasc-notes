...
class RtToEpIp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtToEpIp", "cobra.model.dbgac.ToEpCmn")

    meta.moClassName = "fvRtToEpIp"
    meta.rnFormat = "rtdbgacToEpIp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24136, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15819, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4090
    prop.defaultValueStr = "dbgacToEpCmn"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15818, PropCategory.REGULAR)
