...
class RsGraphDef(Mo):
    """
    A source relation to the graph container.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsGraphDef", "cobra.model.vz.GraphCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsGraphDef"
    meta.rnFormat = "rsgraphDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12333, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1404
    prop.defaultValueStr = "vzGraphCont"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzGraphCont", None, 1404)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12332, PropCategory.REGULAR)
