...
class TnlEpP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.TnlEpP")

    meta.moClassName = "fvTnlEpP"
    meta.rnFormat = "tnlp-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "dot1q-tunnel EpP"
    ...
    prop = PropMeta("str", "accEncap", "accEncap", 30404, PropCategory.REGULAR)
    prop.label = "Access Encapsulation"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("accEncap", prop)

    prop = PropMeta("str", "bcastP", "bcastP", 28317, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "bdSegid", "bdSegid", 27844, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdSegid", prop)
    ...
    prop = PropMeta("str", "ctxPcTag", "ctxPcTag", 27846, PropCategory.REGULAR)
    prop.label = "Policy Enforcement Tag of the TnlCtx"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxSegid", "ctxSegid", 27845, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ctxSegid", prop)
    ...
    prop = PropMeta("str", "epgName", "epgName", 27279, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 27282, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "fwdCtrl", "fwdCtrl", 30405, PropCategory.REGULAR)
    prop.label = "Forwarding Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "mac-learn-enable"
    prop._addConstant("mac-learn-disable", "disable-mac-learning", 2)
    prop._addConstant("mac-learn-enable", "enable-mac-learning", 1)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27317, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "npName", "npName", 27278, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "qiqL2ProtTunMask", "qiqL2ProtTunMask", 27280, PropCategory.REGULAR)
    prop.label = "dot1q-tunnel L2 Protocol Tunneling Mask"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    ...
    prop = PropMeta("str", "tName", "tName", 27277, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
