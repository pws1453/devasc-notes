...
class SvcEpP(Mo):
    """
    Abstract representation of a service endpoint profile, such as an endpoint profile created per node in the service graph.

    """

    meta = ClassMeta("cobra.model.fv.SvcEpP")

    meta.moClassName = "fvSvcEpP"
    meta.rnFormat = "vns-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Service Endpoint Profile"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x6000610021020683
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 6561, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14271, PropCategory.REGULAR)
