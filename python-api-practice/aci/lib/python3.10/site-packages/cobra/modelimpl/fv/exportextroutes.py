...
# ##################################################
class ExportExtRoutes(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ExportExtRoutes")

    meta.moClassName = "fvExportExtRoutes"
    meta.rnFormat = "exportextroutes"
    meta.category = MoCategory.REGULAR
    meta.label = "Export External Routes"
    ...
    meta.superClasses.add("cobra.model.fv.AExtRoutes")

    meta.rnPrefixes = [
        ('exportextroutes', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 47698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47699, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
