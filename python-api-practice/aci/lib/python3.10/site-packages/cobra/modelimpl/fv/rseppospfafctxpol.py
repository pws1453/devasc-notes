...
# ##################################################
class RsEppOspfAfCtxPol(Mo):
    """
    A source relation to the per-address family OSPF context policy.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppOspfAfCtxPol", "cobra.model.ospf.CtxPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsEppOspfAfCtxPol"
    meta.rnFormat = "rseppOspfAfCtxPol-[%(tDn)s]-%(af)s"
    ...
    meta.rnPrefixes = [
        ('rseppOspfAfCtxPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "af", "af", 17585, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 17587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17586, PropCategory.REGULAR)
