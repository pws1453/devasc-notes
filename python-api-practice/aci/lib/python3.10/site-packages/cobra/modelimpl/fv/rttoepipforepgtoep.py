...
# ##################################################
class RtToEpIpForEpgToEp(Mo):
    """
    A target relation to the IP address of an endpoint.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToEpIpForEpgToEp", "cobra.model.dbgac.EpgToEp")

    meta.moClassName = "fvRtToEpIpForEpgToEp"
    meta.rnFormat = "rtdbgacToEpIpForEpgToEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24135, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15811, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15810, PropCategory.REGULAR)
