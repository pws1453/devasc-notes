...
class InBEpP(Mo):
    """
    An in-band management endpoint profile for a fabric node management endpoint group.

    """

    meta = ClassMeta("cobra.model.fv.InBEpP")

    meta.moClassName = "fvInBEpP"
    meta.rnFormat = "inb-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "In-band Management Endpoint Profile"
    ...
    meta.childClasses.add("cobra.model.fv.RtToInbEpp")
    ...
    meta.childClasses.add("cobra.model.fv.RtMonToFvEppInband")
    ...
    meta.childClasses.add("cobra.model.fv.RtFvEppInband")
    ...
    meta.childClasses.add("cobra.model.fv.RtToInbandEpP")
    ...
    meta.childClasses.add("cobra.model.fv.RtMonToFvEppInbandEvent")
    meta.childClasses.add("cobra.model.l2.EgrPktsAg1d")
    meta.childClasses.add("cobra.model.l2.IngrPktsAgHist1mo")
    meta.childClasses.add("cobra.model.fv.RtToFvInbandEpp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtMonToFvEppInbandEvent", "rtfaultMonToFvEppInbandEvent-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtMonToFvEppInband", "rtpolMonToFvEppInband-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtFvEppInband", "rtaaaFvEppInband-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToFvInbandEpp", "rttoFvInbandEpp"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToInbandEpP", "rttoInbandEpP"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToInbEpp", "rttoInbEpp"))
    ...
    prop = PropMeta("str", "encap", "encap", 1739, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 6541, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14270, PropCategory.REGULAR)
