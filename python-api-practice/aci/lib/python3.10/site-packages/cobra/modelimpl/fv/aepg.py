...
class AEPg(Mo):
    ...
    meta.label = "Application EPG"
    meta.writeAccessMask = 0x601
    meta.readAccessMask = 0x628279440106f713
    ...
    meta.childClasses.add("cobra.model.vns.NATDynPATReq")
    ...
    meta.childClasses.add("cobra.model.fv.VipUpdate")
    meta.childClasses.add("cobra.model.vns.CtrlrEp")
    ...
    meta.childClasses.add("cobra.model.fv.SiteAssociated")
    meta.childClasses.add("cobra.model.vns.LBIPReq")
    ...
    meta.childClasses.add("cobra.model.fv.RtToEpg")
    meta.childClasses.add("cobra.model.fv.RtFromEpg")
    ...
    meta.childClasses.add("cobra.model.fv.RsDomAtt")
    meta.childClasses.add("cobra.model.fv.RsFcPathAtt")
    ...
    meta.childClasses.add("cobra.model.fv.StCEp")
    meta.childClasses.add("cobra.model.l2.IngrPktsAgHist1d")
    meta.childClasses.add("cobra.model.l2.EgrPktsPartHist1d")
    meta.childClasses.add("cobra.model.fv.QinqFabEncap")
    meta.childClasses.add("cobra.model.fv.RsGraphDef")
    ...
    meta.childClasses.add("cobra.model.fv.Crtrn")
    ...
    meta.childClasses.add("cobra.model.fv.RsNodeAtt")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.l2.IngrBytesAg1w")
    meta.childClasses.add("cobra.model.dhcp.ConsLbl")
    ...
    meta.childClasses.add("cobra.model.fv.RsDppPol")
    ...
    meta.childClasses.add("cobra.model.fv.Vip")
    meta.childClasses.add("cobra.model.vz.ConsLbl")
    meta.childClasses.add("cobra.model.fv.RtToEpgForEpgToEpg")
    ...
    meta.childClasses.add("cobra.model.fv.RtRtdEpPToNatMappingEPg")
    meta.childClasses.add("cobra.model.l2.EgrPktsPartHist1qtr")
    meta.childClasses.add("cobra.model.l2.EgrPktsAg1qtr")
    meta.childClasses.add("cobra.model.vns.LBRNatReq")
    ...
    meta.childClasses.add("cobra.model.vns.LBVSvcGrpSvrReq")
    ...
    meta.childClasses.add("cobra.model.fv.RsProvDef")
    meta.childClasses.add("cobra.model.vsvc.ConsLbl")
    meta.childClasses.add("cobra.model.vns.ParamInst")
    meta.childClasses.add("cobra.model.fv.RsTrustCtrl")
    ...
    meta.childClasses.add("cobra.model.fv.RtInstPToNatMappingEPg")
    meta.childClasses.add("cobra.model.fv.RsPathAtt")
    ...
    meta.childClasses.add("cobra.model.vns.LBVSvrReq")
    meta.childClasses.add("cobra.model.fv.RsAEPgMonPol")
    ...
    meta.childClasses.add("cobra.model.vns.AddrInst")
    ...
    meta.childClasses.add("cobra.model.vns.NATPATReq")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtInstPToNatMappingEPg", "rtl3extInstPToNatMappingEPg-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToEpgForEpgToEpg", "rtdbgacToEpgForEpgToEpg-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtRtdEpPToNatMappingEPg", "rtrtdEpPToNatMappingEPg-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.LBVSvcGrpSvrReq", "LB_SVC_GRP_SVR_C-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.NATDynPATReq", "FW_NAT_DYNPAT_C-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtFromEpg", "rtdbgacFromEpg-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AddrInst", "CtrlrAddrInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToEpg", "rtdbgacToEpg-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsFcPathAtt", "rsfcPathAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.ConsSubjLbl", "conssubjlbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsAEPgMonPol", "rsAEPgMonPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsGraphDef", "rsgraphDef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsTrustCtrl", "rstrustCtrl"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.VipUpdate", "vipupdate-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.LBIPReq", "LB_LBIP_C-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsNodeAtt", "rsnodeAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.LBRNatReq", "LB_RNAT_C-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.ProvCtrctLbl", "pCtrctLbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsProvDef", "rsprovDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ParamInst", "ParamInst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsPathAtt", "rspathAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.LBVSvrReq", "LB_VSVR_C-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsDomAtt", "rsdomAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsConsIf", "rsconsIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dhcp.ConsLbl", "dhcpcons-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.NATPATReq", "FW_NAT_C-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CtrlrEp", "ctrlrEp-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsDppPol", "rsdppPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.StCEp", "stcep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.QinqFabEncap", "encap-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.SiteAssociated", "stAsc"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.Crtrn", "crtrn"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vsvc.ConsLbl", "cons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.FolderInst", "FI_C-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.CEp", "cep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsBd", "rsbd"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Inst", "tag-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.Vip", "vip-"))
    ...
    meta.superClasses.add("cobra.model.fv.CEPg")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39797, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fwdCtrl", "fwdCtrl", 27136, PropCategory.REGULAR)
    prop.label = "Forwarding Control Bits"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("none", "none", 0)
    prop._addConstant("proxy-arp", "proxy-arp", 1)
    meta.props.add("fwdCtrl", prop)

    prop = PropMeta("str", "hasMcastSource", "hasMcastSource", 42335, PropCategory.REGULAR)
    prop.label = "EPg with Multisite Mcast Source"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("hasMcastSource", prop)

    prop = PropMeta("str", "isAttrBasedEPg", "isAttrBasedEPg", 21250, PropCategory.REGULAR)
    prop.label = "Attribute Based EPG"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isAttrBasedEPg", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14287, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6525, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "pcEnfPref", "pcEnfPref", 23079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "shutdown", "shutdown", 44225, PropCategory.REGULAR)
    prop.label = "Withdraw AEPg Configuration from all Nodes in the Fabric"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
