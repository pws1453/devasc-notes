...
class RsToDomDef(Mo):
    """
    A source relation to domain information. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToDomDef", "cobra.model.fv.DomDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToDomDef"
    meta.rnFormat = "rstoDomDef-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.fv.ByHv")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ByHv", "byHv-"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 12272, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1852
    prop.defaultValueStr = "fvDomDef"
    prop._addConstant("fvDomDef", None, 1852)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12271, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vmmSrc", "vmmSrc", 42286, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
