...
class OverallHealthHist1w(Mo):
    """
    A class that represents historical statistics for overall tenant health in a 1 week sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealthHist1w", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealthHist1w"
    meta.rnFormat = "HDfvOverallHealth1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical overall tenant health stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 6549, PropCategory.REGULAR)
