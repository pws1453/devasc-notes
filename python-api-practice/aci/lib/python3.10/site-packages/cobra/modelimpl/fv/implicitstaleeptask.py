...
# ##################################################
class ImplicitStaleEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ImplicitStaleEpTask")

    meta.moClassName = "fvImplicitStaleEpTask"
    meta.rnFormat = "fvImplicitStaleEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23223, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("StaleImplicitEpDetach", "staleimplicitepdetach", 2046)
