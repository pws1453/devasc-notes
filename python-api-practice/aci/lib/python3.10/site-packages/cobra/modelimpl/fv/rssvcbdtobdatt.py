...
# ##################################################
class RsSvcBDToBDAtt(Mo):
    """
    A source relation to the bridge domain associated to this endpoint group. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsSvcBDToBDAtt", "cobra.model.fv.BD")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsSvcBDToBDAtt"
    meta.rnFormat = "rsSvcBDToBDAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12196, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12195, PropCategory.REGULAR)
