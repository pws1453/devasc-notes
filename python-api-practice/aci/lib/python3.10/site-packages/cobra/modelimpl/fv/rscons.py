...
class RsCons(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsCons", "cobra.model.vz.BrCP")
    meta.targetNameProps["name"] = "tnVzBrCPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsCons"
    meta.rnFormat = "rscons-%(tnVzBrCPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Contract Consumer"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37652, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deplInfo", "deplInfo", 12200, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39791, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14257, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 12201, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12199, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzBrCPName", "tnVzBrCPName", 12198, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
