...
class OverallHealth1mo(Mo):
    """
    A class that represents the most current statistics for overall tenant health in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealth1mo", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealth1mo"
    meta.rnFormat = "CDfvOverallHealth1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall tenant health stats in 1 month"
