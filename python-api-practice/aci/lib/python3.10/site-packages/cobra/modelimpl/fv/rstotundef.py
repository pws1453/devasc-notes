...
class RsToTunDef(Mo):
    """
    A source relation to a tunnel. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToTunDef", "cobra.model.fv.TunDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToTunDef"
    meta.rnFormat = "rstoTunDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12422, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2062
    prop.defaultValueStr = "fvTunDef"
    prop._addConstant("fvTunDef", None, 2062)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12421, PropCategory.REGULAR)
