...
class KeyPolDef(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.KeyPolDef")

    meta.moClassName = "fvKeyPolDef"
    meta.rnFormat = "keypdef-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Key Policy"
    ...
    meta.superClasses.add("cobra.model.fv.AKeyPol")
    ...
    prop = PropMeta("str", "id", "id", 49911, PropCategory.REGULAR)
    prop.label = "Key Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
