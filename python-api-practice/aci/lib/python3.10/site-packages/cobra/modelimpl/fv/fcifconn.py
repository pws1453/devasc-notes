...
class FcIfConn(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.FcIfConn")

    meta.moClassName = "fvFcIfConn"
    meta.rnFormat = "fcconn-[%(vsan)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "FC Interface Connectivity"
    ...
    prop = PropMeta("str", "type", "type", 25990, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "vsan", "vsan", 25988, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "vsanMode", "vsanMode", 25989, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.namingProps.append(getattr(meta.props, "vsan"))
    getattr(meta.props, "vsan").needDelimiter = True

    def __init__(self, parentMoOrDn, vsan, markDirty=True, **creationProps):
        namingVals = [vsan]
