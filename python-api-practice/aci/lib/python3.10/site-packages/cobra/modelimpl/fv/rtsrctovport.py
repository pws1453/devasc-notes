...
# ##################################################
class RtSrcToVPort(Mo):
    """
    A target relation to a set of endpoints. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSrcToVPort", "cobra.model.span.AVSrc")

    meta.moClassName = "fvRtSrcToVPort"
    meta.rnFormat = "rtspanSrcToVPort-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstract VSPAN Source"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13040, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4175
    prop.defaultValueStr = "spanAVSrc"
    ...
    prop = PropMeta("str", "tDn", "tDn", 13039, PropCategory.REGULAR)
