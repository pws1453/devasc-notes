...
class TunDef(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.TunDef")

    meta.moClassName = "fvTunDef"
    meta.rnFormat = "tundef-%(mac)s"
    ...
    meta.childClasses.add("cobra.model.fv.RtToTunDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToTunDef", "rttoTunDef-"))
    ...
    meta.superClasses.add("cobra.model.fv.ATunDef")
    ...
    prop = PropMeta("str", "mac", "mac", 6563, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14303, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tType", "tType", 1794, PropCategory.REGULAR)
