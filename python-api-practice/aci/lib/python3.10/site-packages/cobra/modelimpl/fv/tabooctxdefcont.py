...
# ##################################################
class TabooCtxDefCont(Mo):
    """
    An internal container for objects used for deployment.

    """

    meta = ClassMeta("cobra.model.fv.TabooCtxDefCont")

    meta.moClassName = "fvTabooCtxDefCont"
    meta.rnFormat = "tabooCtxdefDn-[%(ctxdefDn)s]-taboodefDn-[%(taboodefDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Internal Mo Used to Update Context Shard with Taboo Info"
    ...
    meta.superClasses.add("cobra.model.fv.ACtxDefCont")
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 16142, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ctxDn", prop)

    prop = PropMeta("str", "ctxdefDn", "ctxdefDn", 16149, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "taboodefDn", "taboodefDn", 16143, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("taboodefDn", prop)

    meta.namingProps.append(getattr(meta.props, "ctxdefDn"))
    getattr(meta.props, "ctxdefDn").needDelimiter = True
    meta.namingProps.append(getattr(meta.props, "taboodefDn"))
    getattr(meta.props, "taboodefDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, ctxdefDn, taboodefDn, markDirty=True, **creationProps):
        namingVals = [ctxdefDn, taboodefDn]
