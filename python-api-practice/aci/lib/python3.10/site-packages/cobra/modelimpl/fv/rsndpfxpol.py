...
class RsNdPfxPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsNdPfxPol", "cobra.model.nd.PfxPol")
    meta.targetNameProps["name"] = "tnNdPfxPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsNdPfxPol"
    meta.rnFormat = "rsNdPfxPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38188, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40327, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 18203, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 18199, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNdPfxPolName", "tnNdPfxPolName", 18198, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
