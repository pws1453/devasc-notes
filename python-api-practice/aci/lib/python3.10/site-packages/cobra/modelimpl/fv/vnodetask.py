...
class VNodeTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.VNodeTask")

    meta.moClassName = "fvVNodeTask"
    meta.rnFormat = "fvVNodeTask-%(id)s"
    ...
    meta.childClasses.add("cobra.model.fv.VNodeContext")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.VNodeContext", "fvVNode"))
    ...
    prop = PropMeta("str", "id", "id", 45574, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("aveTimeout", "avetimeout", 3277)
