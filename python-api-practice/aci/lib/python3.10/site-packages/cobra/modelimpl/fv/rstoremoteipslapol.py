...
# ##################################################
class RsToRemoteIpslaPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteIpslaPol", "cobra.model.fv.SlaDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteIpslaPol"
    meta.rnFormat = "rstoRemoteIpslaPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49425, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14199
    prop.defaultValueStr = "fvSlaDef"
    prop._addConstant("fvSlaDef", None, 14199)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49424, PropCategory.REGULAR)
