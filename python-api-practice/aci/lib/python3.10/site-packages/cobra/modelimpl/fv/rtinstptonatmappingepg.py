...
# ##################################################
class RtInstPToNatMappingEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtInstPToNatMappingEPg", "cobra.model.l3ext.InstP")

    meta.moClassName = "fvRtInstPToNatMappingEPg"
    meta.rnFormat = "rtl3extInstPToNatMappingEPg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "External Network Instance Profile"
    meta.writeAccessMask = 0x601
    meta.readAccessMask = 0x6200410401043703
    ...
    meta.rnPrefixes = [
        ('rtl3extInstPToNatMappingEPg-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 22152, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22151, PropCategory.REGULAR)
