...
class RsTnDenyRule(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsTnDenyRule", "cobra.model.vz.Filter")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsTnDenyRule"
    meta.rnFormat = "rstnDenyRule-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Deny Filters"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37656, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39795, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14284, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12306, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12305, PropCategory.REGULAR)
