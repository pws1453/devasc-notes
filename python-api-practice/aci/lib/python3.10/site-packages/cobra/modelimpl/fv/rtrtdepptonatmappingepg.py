...
# ##################################################
class RtRtdEpPToNatMappingEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtRtdEpPToNatMappingEPg", "cobra.model.fv.RtdEpPInfoHolder")

    meta.moClassName = "fvRtRtdEpPToNatMappingEPg"
    meta.rnFormat = "rtrtdEpPToNatMappingEPg-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x620071040106f713
    ...
    prop = PropMeta("str", "tCl", "tCl", 22156, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22155, PropCategory.REGULAR)
