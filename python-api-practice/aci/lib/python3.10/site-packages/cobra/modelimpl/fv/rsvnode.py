...
class RsVNode(Mo):
    """
    A source relation to an opflex-capable virtual node that is connected to the fabric. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsVNode", "cobra.model.fv.VNode")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsVNode"
    meta.rnFormat = "rsvNode-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Virtual Node"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12426, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2070
    prop.defaultValueStr = "fvVNode"
    prop._addConstant("fvVNode", None, 2070)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12425, PropCategory.REGULAR)
