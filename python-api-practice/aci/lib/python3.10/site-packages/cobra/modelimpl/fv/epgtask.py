...
class EPgTask(Mo):
    """
    An endpoint group task.

    """

    meta = ClassMeta("cobra.model.fv.EPgTask")

    meta.moClassName = "fvEPgTask"
    meta.rnFormat = "fvEPgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5688, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpP", "epp", 547)
    prop._addConstant("UpdMgmtDeplCont", "updmgmtdeplcont", 549)
