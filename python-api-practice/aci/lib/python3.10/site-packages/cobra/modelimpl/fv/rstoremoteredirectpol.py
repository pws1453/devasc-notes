...
# ##################################################
class RsToRemoteRedirectPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRedirectPol", "cobra.model.vns.SvcRedirectPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRedirectPol"
    meta.rnFormat = "rstoRemoteRedirectPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Service Redirect Policy"
    ...
    meta.childClasses.add("cobra.model.fv.GraphCons")
    meta.childClasses.add("cobra.model.fv.Cons")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.GraphCons", "graphCons-"))
    ...
    prop = PropMeta("str", "tCl", "tCl", 27686, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7082
    prop.defaultValueStr = "vnsSvcRedirectPol"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsSvcRedirectPol", None, 7082)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27685, PropCategory.REGULAR)
