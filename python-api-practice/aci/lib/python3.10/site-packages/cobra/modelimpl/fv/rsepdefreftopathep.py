...
# ##################################################
class RsEpDefRefToPathEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEpDefRefToPathEp", "cobra.model.nw.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEpDefRefToPathEp"
    meta.rnFormat = "rsepDefRefToPathEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20137, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20136, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 20140, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
