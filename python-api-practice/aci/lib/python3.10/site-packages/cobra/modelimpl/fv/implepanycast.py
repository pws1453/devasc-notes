...
# ##################################################
class ImplEpAnycast(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ImplEpAnycast")

    meta.moClassName = "fvImplEpAnycast"
    meta.rnFormat = "ImplepAnycast-%(mac)s"
    ...
    meta.superClasses.add("cobra.model.fv.AEpAnycast")
    ...
    prop = PropMeta("str", "mac", "mac", 37195, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37199, PropCategory.REGULAR)
