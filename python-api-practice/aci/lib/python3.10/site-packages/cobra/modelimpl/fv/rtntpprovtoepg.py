...
# ##################################################
class RtNtpProvToEpg(Mo):
    """
    A target relation to an attachable target group. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtNtpProvToEpg", "cobra.model.datetime.NtpProv")

    meta.moClassName = "fvRtNtpProvToEpg"
    meta.rnFormat = "rtdatetimeNtpProvToEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13316, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13315, PropCategory.REGULAR)
