...
# ##################################################
class RtToEpForEpgToEp(Mo):
    """
    A target relation to the properties of the client-defined endpoint attached to the network. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToEpForEpgToEp", "cobra.model.dbgac.EpgToEp")

    meta.moClassName = "fvRtToEpForEpgToEp"
    meta.rnFormat = "rtdbgacToEpForEpgToEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24131, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12917, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4084
    prop.defaultValueStr = "dbgacEpgToEp"
    prop._addConstant("dbgacEpgToEp", None, 4084)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12916, PropCategory.REGULAR)
