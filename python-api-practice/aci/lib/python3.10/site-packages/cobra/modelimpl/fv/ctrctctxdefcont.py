...
# ##################################################
class CtrctCtxDefCont(Mo):
    """
    An internal container for objects used for deployment.

    """

    meta = ClassMeta("cobra.model.fv.CtrctCtxDefCont")

    meta.moClassName = "fvCtrctCtxDefCont"
    meta.rnFormat = "ctrctCtxdefDn-[%(ctxdefDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Internal Mo Used to Update Context Shard with Contract Info"
    ...
    prop = PropMeta("str", "ctxdefDn", "ctxdefDn", 16147, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 16155, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, ctxdefDn, markDirty=True, **creationProps):
        namingVals = [ctxdefDn]
