...
# ##################################################
class EPgToInterface(Mo):
    meta = ClassMeta("cobra.model.fv.EPgToInterface")

    meta.isAbstract = True
    meta.moClassName = "fvEPgToInterface"


    meta.moClassName = "fvEPgToInterface"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Each Epg to Collection Interface Relation"
    ...
    meta.concreteSubClasses.add("cobra.model.fv.RsConsIf")
