...
# ##################################################
class RtLIfCtxToInstP(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fv.RtLIfCtxToInstP", "cobra.model.vns.LIfCtx")

    meta.moClassName = "fvRtLIfCtxToInstP"
    meta.rnFormat = "rtvnsLIfCtxToInstP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18109, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18108, PropCategory.REGULAR)
