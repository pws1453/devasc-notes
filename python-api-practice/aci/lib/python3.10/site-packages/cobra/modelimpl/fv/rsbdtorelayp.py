...
class RsBDToRelayP(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37647, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39786, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14250, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12174, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDhcpRelayPName", "tnDhcpRelayPName", 12173, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
