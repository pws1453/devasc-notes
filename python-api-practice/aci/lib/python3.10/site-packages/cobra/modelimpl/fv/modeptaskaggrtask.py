...
# ##################################################
class ModEpTaskAggrTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.fv.ModEpTaskAggrTask")

    meta.moClassName = "fvModEpTaskAggrTask"
    meta.rnFormat = "fvModEpTaskAggrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 17781, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateEpAggr", "updateepaggr", 1525)
