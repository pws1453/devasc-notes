...
class RtIpAddr(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtIpAddr", "cobra.model.ip.Addr")

    meta.moClassName = "fvRtIpAddr"
    meta.rnFormat = "rtipAddr"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12846, PropCategory.REGULAR)
