...
# ##################################################
class RsToRemoteCtrct(Mo):
    """
    A source relation to a container for a contract endpoint group.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteCtrct", "cobra.model.vz.CtrctEPgCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteCtrct"
    meta.rnFormat = "rstoRemoteCtrct-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16816, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16815, PropCategory.REGULAR)
