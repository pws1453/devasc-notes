...
# ##################################################
class RtOtmListMember(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtOtmListMember", "cobra.model.fv.TrackList")

    meta.moClassName = "fvRtOtmListMember"
    meta.rnFormat = "rtotmListMember-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Track List"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45661, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45660, PropCategory.REGULAR)
