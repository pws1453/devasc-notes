...
class EpNlb(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.EpNlb")

    meta.moClassName = "fvEpNlb"
    meta.rnFormat = "epnlb"
    ...
    meta.superClasses.add("cobra.model.fv.AEpNlb")
    ...
    prop = PropMeta("str", "annotation", "annotation", 49458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49459, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "group", "group", 49451, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mac", "mac", 49449, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mode", "mode", 49450, PropCategory.REGULAR)
    prop.label = "NLB mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49455, PropCategory.REGULAR)
