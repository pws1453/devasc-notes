...
class RtDestEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtDestEpg", "cobra.model.span.ADest")

    meta.moClassName = "fvRtDestEpg"
    meta.rnFormat = "rtspanDestEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 13024, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13023, PropCategory.REGULAR)
