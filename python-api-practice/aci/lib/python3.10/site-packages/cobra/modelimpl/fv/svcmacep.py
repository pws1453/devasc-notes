...
class SvcMacEp(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.SvcMacEp")

    meta.moClassName = "fvSvcMacEp"
    meta.rnFormat = "SvcMacEp-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 Services Mac Endpoint"
    ...
    meta.parentClasses.add("cobra.model.fv.EncapDef")
    ...
    prop = PropMeta("str", "mac", "mac", 43421, PropCategory.REGULAR)
    prop.label = "Static MAC Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
