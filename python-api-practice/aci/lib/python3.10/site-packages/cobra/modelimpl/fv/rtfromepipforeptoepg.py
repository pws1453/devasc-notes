...
# ##################################################
class RtFromEpIpForEpToEpg(Mo):
    """
    A target relation to the IP address of an endpoint.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtFromEpIpForEpToEpg", "cobra.model.dbgac.EpToEpg")

    meta.moClassName = "fvRtFromEpIpForEpToEpg"
    meta.rnFormat = "rtdbgacFromEpIpForEpToEpg-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtdbgacFromEpIpForEpToEpg-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 15807, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15806, PropCategory.REGULAR)
