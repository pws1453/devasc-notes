...
class OverallHealth1qtr(Mo):
    """
    A class that represents the most current statistics for overall tenant health in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealth1qtr", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealth1qtr"
    meta.rnFormat = "CDfvOverallHealth1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall tenant health stats in 1 quarter"
