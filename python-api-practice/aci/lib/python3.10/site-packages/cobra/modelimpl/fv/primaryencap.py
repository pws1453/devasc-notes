...
# ##################################################
class PrimaryEncap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.PrimaryEncap")

    meta.moClassName = "fvPrimaryEncap"
    meta.rnFormat = "primaryEncap-[%(primaryEncap)s]"
    ...
    prop = PropMeta("str", "primaryEncap", "primaryEncap", 23434, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "primaryEncap"))
    getattr(meta.props, "primaryEncap").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, primaryEncap, markDirty=True, **creationProps):
        namingVals = [primaryEncap]
