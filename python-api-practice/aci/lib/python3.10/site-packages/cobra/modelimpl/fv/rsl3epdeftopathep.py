...
# ##################################################
class RsL3EpDefToPathEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsL3EpDefToPathEp", "cobra.model.nw.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsL3EpDefToPathEp"
    meta.rnFormat = "rsl3EpDefToPathEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "lcC", "lcC", 44798, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 44800, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 44799, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 44803, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
