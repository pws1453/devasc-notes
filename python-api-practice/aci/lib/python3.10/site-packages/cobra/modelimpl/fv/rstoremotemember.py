...
# ##################################################
class RsToRemoteMember(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteMember", "cobra.model.fv.TrackMember")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteMember"
    meta.rnFormat = "rstoRemoteMember-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49429, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13173
    prop.defaultValueStr = "fvTrackMember"
    prop._addConstant("fvTrackMember", None, 13173)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49428, PropCategory.REGULAR)
