...
# ##################################################
class RtClientGrpToEpp(Mo):
    """
    A target relation to the abstract representation of the resolvable endpoint profile.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtClientGrpToEpp", "cobra.model.snmp.ClientGrpP")

    meta.moClassName = "fvRtClientGrpToEpp"
    meta.rnFormat = "rtsnmpClientGrpToEpp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16076, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4579
    prop.defaultValueStr = "snmpClientGrpP"
    prop._addConstant("snmpClientGrpP", None, 4579)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16075, PropCategory.REGULAR)
