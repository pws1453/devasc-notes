...
# ##################################################
class ExtRoutableRemoteSitePodSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ExtRoutableRemoteSitePodSubnet")

    meta.moClassName = "fvExtRoutableRemoteSitePodSubnet"
    meta.rnFormat = "extrtremotesitepodsubnet-[%(pool)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "External Routable POD subnet associated with remote site"
    ...
    meta.superClasses.add("cobra.model.fv.AExtRoutableRemoteSitePodSubnet")
    meta.superClasses.add("cobra.model.pol.Comp")
    meta.superClasses.add("cobra.model.pol.Obj")

    meta.rnPrefixes = [
        ('extrtremotesitepodsubnet-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 49404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49405, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "podId", "podId", 49392, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pool", "pool", 49393, PropCategory.REGULAR)
    prop.label = "Secondary subnet pool"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("pool", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "pool"))
    getattr(meta.props, "pool").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, pool, markDirty=True, **creationProps):
        namingVals = [pool]
