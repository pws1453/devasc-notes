...
class RtTrEpSrc(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtTrEpSrc", "cobra.model.traceroutep.TrEp")

    meta.moClassName = "fvRtTrEpSrc"
    meta.rnFormat = "rttraceroutepTrEpSrc-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13064, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4216
    prop.defaultValueStr = "traceroutepTrEp"
    prop._addConstant("traceroutepTrEp", None, 4216)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13063, PropCategory.REGULAR)
