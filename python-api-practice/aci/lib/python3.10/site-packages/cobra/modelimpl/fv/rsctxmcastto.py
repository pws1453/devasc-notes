...
class RsCtxMcastTo(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsCtxMcastTo", "cobra.model.vz.Filter")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsCtxMcastTo"
    meta.rnFormat = "rsctxMcastTo-[%(tDn)s]"
    ...
    prop = PropMeta("str", "action", "action", 12370, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 12369, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12368, PropCategory.REGULAR)
