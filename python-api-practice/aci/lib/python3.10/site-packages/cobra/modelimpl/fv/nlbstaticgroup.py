...
# ##################################################
class NlbStaticGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.NlbStaticGroup")

    meta.moClassName = "fvNlbStaticGroup"
    meta.rnFormat = "nlbstaticgrp-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "NLB Static Group"
    meta.writeAccessMask = 0x1601
    meta.readAccessMask = 0x1601
    ...
    prop = PropMeta("str", "annotation", "annotation", 49456, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49457, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mac", "mac", 49448, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49454, PropCategory.REGULAR)
