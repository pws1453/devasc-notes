...
# ##################################################
class RsToRemoteQueryGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteQueryGroup", "cobra.model.callhome.QueryGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteQueryGroup"
    meta.rnFormat = "rstoRemoteQueryGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23245, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23244, PropCategory.REGULAR)
