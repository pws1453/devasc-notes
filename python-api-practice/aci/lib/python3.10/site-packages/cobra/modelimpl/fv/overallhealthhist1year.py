...
class OverallHealthHist1year(Mo):
    """
    A class that represents historical statistics for overall tenant health in a 1 year sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealthHist1year", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealthHist1year"
    meta.rnFormat = "HDfvOverallHealth1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical overall tenant health stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 6550, PropCategory.REGULAR)
