...
class AEPgTask(Mo):
    """
    The task for an internal process.

    """

    meta = ClassMeta("cobra.model.fv.AEPgTask")

    meta.moClassName = "fvAEPgTask"
    meta.rnFormat = "fvAEPgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5683, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpCPUpd", "epcpupd", 1683)
    prop._addConstant("LegacyEpP", "legacyepp", 833)
