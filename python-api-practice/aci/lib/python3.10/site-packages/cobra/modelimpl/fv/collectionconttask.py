...
class CollectionContTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.CollectionContTask")

    meta.moClassName = "fvCollectionContTask"
    meta.rnFormat = "fvCollectionContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5686, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BringInfoIntoCollectionShard", "bringinfointocollectionshard", 432)
