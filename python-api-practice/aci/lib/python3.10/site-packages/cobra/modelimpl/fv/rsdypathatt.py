...
# ##################################################
class RsDyPathAtt(Mo):
    """
    A source relation to the path endpoint. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsDyPathAtt", "cobra.model.nw.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsDyPathAtt"
    meta.rnFormat = "rsdyPathAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12288, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15029, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
