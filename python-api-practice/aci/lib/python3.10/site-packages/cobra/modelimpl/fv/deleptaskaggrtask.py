...
# ##################################################
class DelEpTaskAggrTask(Mo):
    """
    The delete endpoint task aggregator task.

    """

    meta = ClassMeta("cobra.model.fv.DelEpTaskAggrTask")

    meta.moClassName = "fvDelEpTaskAggrTask"
    meta.rnFormat = "fvDelEpTaskAggrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 15693, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateEpAggr", "updateepaggr", 1327)
