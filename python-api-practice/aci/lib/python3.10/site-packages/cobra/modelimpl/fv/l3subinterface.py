...
# ##################################################
class L3SubInterface(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.L3SubInterface")

    meta.moClassName = "fvL3SubInterface"
    meta.rnFormat = "subif-%(subIf)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L3 SubInterface info"
    ...
    prop = PropMeta("str", "subIf", "subIf", 44795, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.range = [(1, 512)]
    meta.props.add("subIf", prop)

    meta.namingProps.append(getattr(meta.props, "subIf"))
    ...
    def __init__(self, parentMoOrDn, subIf, markDirty=True, **creationProps):
        namingVals = [subIf]
