...
# ##################################################
class ProtoAttrDef(Mo):
    """
    The definition object for a protocol attribute.

    """

    meta = ClassMeta("cobra.model.fv.ProtoAttrDef")

    meta.moClassName = "fvProtoAttrDef"
    meta.rnFormat = "protoattrdef-%(name)s"
    ...
    prop = PropMeta("str", "name", "name", 18459, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
