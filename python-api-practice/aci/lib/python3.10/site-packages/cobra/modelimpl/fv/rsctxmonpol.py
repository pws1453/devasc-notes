...
# ##################################################
class RsCtxMonPol(Mo):
    """
    A source relation to the monitoring policy model for the endpoint group semantic scope. This is an internal object.

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsCtxMonPol", "cobra.model.mon.EPGPol")
    meta.targetNameProps["name"] = "tnMonEPGPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsCtxMonPol"
    meta.rnFormat = "rsCtxMonPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37639, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39778, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14239, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12357, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 253
    prop.defaultValueStr = "monEPGPol"
    ...
    prop = PropMeta("str", "tnMonEPGPolName", "tnMonEPGPolName", 12356, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMonEPGPolName", prop)
