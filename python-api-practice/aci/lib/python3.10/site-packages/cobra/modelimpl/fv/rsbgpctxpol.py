...
class RsBgpCtxPol(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39804, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14294, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12361, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnBgpCtxPolName", "tnBgpCtxPolName", 12360, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
