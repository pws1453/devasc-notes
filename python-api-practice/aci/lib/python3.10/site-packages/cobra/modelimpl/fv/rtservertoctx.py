...
# ##################################################
class RtServerToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtServerToCtx", "cobra.model.telemetry.AServerP")

    meta.moClassName = "fvRtServerToCtx"
    meta.rnFormat = "rttelemetryServerToCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstraction Class for Server"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x601001002102f701
    ...
    prop = PropMeta("str", "tCl", "tCl", 35699, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11364
    prop.defaultValueStr = "telemetryAServerP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 35698, PropCategory.REGULAR)
