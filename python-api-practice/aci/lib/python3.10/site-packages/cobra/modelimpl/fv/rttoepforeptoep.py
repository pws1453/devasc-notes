...
# ##################################################
class RtToEpForEpToEp(Mo):
    """
    A target relation to the properties of the client defined endpoint attached to the network. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToEpForEpToEp", "cobra.model.dbgac.EpToEp")

    meta.moClassName = "fvRtToEpForEpToEp"
    meta.rnFormat = "rtdbgacToEpForEpToEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24133, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12942, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4095
    prop.defaultValueStr = "dbgacEpToEp"
    prop._addConstant("dbgacEpToEp", None, 4095)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12941, PropCategory.REGULAR)
