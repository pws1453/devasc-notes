...
class RtToAbsEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtToAbsEpg", "cobra.model.dbgac.ToEpgCmn")

    meta.moClassName = "fvRtToAbsEpg"
    meta.rnFormat = "rtdbgacToAbsEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18642, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18641, PropCategory.REGULAR)
