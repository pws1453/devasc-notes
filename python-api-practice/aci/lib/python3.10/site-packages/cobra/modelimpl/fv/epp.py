...
class EpP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.EpP")

    meta.moClassName = "fvEpP"
    meta.rnFormat = "fv-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "End Point Group"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x604565102102c7a7
    ...
    meta.childClasses.add("cobra.model.fv.StCEpDef")
    ...
    meta.childClasses.add("cobra.model.useg.UsegEPgDefCont")
    meta.childClasses.add("cobra.model.fv.RtSrcToEpP")
    ...
    meta.childClasses.add("cobra.model.comp.DNic")
    ...
    meta.childClasses.add("cobra.model.fv.VStaticEpCont")
    ...
    meta.childClasses.add("cobra.model.fhs.TrustCtrlDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtSrcToEpP", "rtspanSrcToEpP-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.useg.UsegEPgDefCont", "usegEPgDefCont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fhs.TrustCtrlDef", "trustctrldef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.StCEpDef", "stcepdef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.VStaticEpCont", "vepcont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.DNic", "dnic-"))
    ...
    prop = PropMeta("str", "epgName", "epgName", 1738, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("epgName", prop)

    prop = PropMeta("str", "epgPKey", "epgPKey", 6536, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "fwdCtrl", "fwdCtrl", 27135, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14268, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "npName", "npName", 1737, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("npName", prop)
    ...
    prop = PropMeta("str", "tName", "tName", 1736, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tName", prop)
