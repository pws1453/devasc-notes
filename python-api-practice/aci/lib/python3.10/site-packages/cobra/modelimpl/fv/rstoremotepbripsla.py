...
# ##################################################
class RsToRemotePbrIpsla(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemotePbrIpsla", "cobra.model.fv.IPSLAMonitoringPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemotePbrIpsla"
    meta.rnFormat = "rstoRemotePbrIpsla-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55783, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55782, PropCategory.REGULAR)
