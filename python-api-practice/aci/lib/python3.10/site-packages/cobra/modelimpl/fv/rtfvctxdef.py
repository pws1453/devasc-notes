...
class RtFvCtxDef(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtFvCtxDef", "cobra.model.cloud.Bookeeping")

    meta.moClassName = "fvRtFvCtxDef"
    meta.rnFormat = "rtcloudFvCtxDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51247, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51246, PropCategory.REGULAR)
