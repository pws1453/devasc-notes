...
# ##################################################
class ImportExtRoutes(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ImportExtRoutes")

    meta.moClassName = "fvImportExtRoutes"
    meta.rnFormat = "importextroutes"
    meta.category = MoCategory.REGULAR
    meta.label = "Import External Routes"
    ...
    meta.rnPrefixes = [
        ('importextroutes', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 47700, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47701, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
