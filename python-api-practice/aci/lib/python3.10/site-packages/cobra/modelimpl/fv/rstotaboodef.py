...
# ##################################################
class RsToTabooDef(Mo):
    """
    A source relation to a taboo definition. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToTabooDef", "cobra.model.vz.TabooDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToTabooDef"
    meta.rnFormat = "rstoTabooDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12434, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12433, PropCategory.REGULAR)
