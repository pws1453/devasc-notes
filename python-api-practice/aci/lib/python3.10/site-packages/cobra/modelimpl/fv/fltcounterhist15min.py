...
# ##################################################
class FltCounterHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fv.FltCounterHist15min", "Fault Counter")
    ...
    meta.moClassName = "fvFltCounterHist15min"
    meta.rnFormat = "HDfvFltCounter15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fault Counter stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.fv.FltCounterHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDfvFltCounter15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 30177, PropCategory.REGULAR)
