...
class AKeyChainPol(Mo):
    meta = ClassMeta("cobra.model.fv.AKeyChainPol")

    meta.isAbstract = True
    meta.moClassName = "fvAKeyChainPol"


    meta.moClassName = "fvAKeyChainPol"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Tenant Keychain Policy"
    ...
    meta.concreteSubClasses.add("cobra.model.fv.KeyChainPolDef")
    meta.concreteSubClasses.add("cobra.model.fv.KeyChainPol")
