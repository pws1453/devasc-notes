...
# ##################################################
class RsEppEigrpCtxAfPol(Mo):
    """
    A source relation to a per-address family BGP context policy.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppEigrpCtxAfPol", "cobra.model.eigrp.CtxAfPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsEppEigrpCtxAfPol"
    meta.rnFormat = "rseppEigrpCtxAfPol-[%(tDn)s]-%(af)s"
    ...
    meta.rnPrefixes = [
        ('rseppEigrpCtxAfPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "af", "af", 17990, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 17992, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17991, PropCategory.REGULAR)
