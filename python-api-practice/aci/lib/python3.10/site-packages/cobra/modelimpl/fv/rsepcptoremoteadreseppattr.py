...
# ##################################################
class RsEpcpToRemoteADResEpPAttr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEpcpToRemoteADResEpPAttr", "cobra.model.adepg.ResEpPFltAttrCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fvRsEpcpToRemoteADResEpPAttr"
    meta.rnFormat = "rsepcpToRemoteADResEpPAttr-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Active Directory ResEpPFltrAttrCont"
    ...
    meta.rnPrefixes = [
        ('rsepcpToRemoteADResEpPAttr-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 43788, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12596
    prop.defaultValueStr = "adepgResEpPFltAttrCont"
    prop._addConstant("adepgResEpPFltAttrCont", None, 12596)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 43787, PropCategory.REGULAR)
