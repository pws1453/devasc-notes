...
# ##################################################
class AIfConn(Mo):
    meta = ClassMeta("cobra.model.fv.AIfConn")

    meta.isAbstract = True
    meta.moClassName = "fvAIfConn"
    ...
    meta.concreteSubClasses.add("cobra.model.fv.IfConn")
    meta.concreteSubClasses.add("cobra.model.fv.FcIfConn")
