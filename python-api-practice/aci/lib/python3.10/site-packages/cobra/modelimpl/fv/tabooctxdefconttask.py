...
# ##################################################
class TabooCtxDefContTask(Mo):
    """
    An internal container for objects used for deployment.

    """

    meta = ClassMeta("cobra.model.fv.TabooCtxDefContTask")

    meta.moClassName = "fvTabooCtxDefContTask"
    meta.rnFormat = "fvTabooCtxDefContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 16146, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateCtxDefWithTabooDef", "updatectxdefwithtaboodef", 1383)
