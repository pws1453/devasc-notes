...
class OverallHealthHist1d(Mo):
    """
    A class that represents historical statistics for overall tenant health in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealthHist1d", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealthHist1d"
    meta.rnFormat = "HDfvOverallHealth1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical overall tenant health stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 6545, PropCategory.REGULAR)
