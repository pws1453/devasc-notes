...
# ##################################################
class SharedService(Mo):
    """
    When an EPG contains this object, its pcTag is allocated from Shared.

    """

    meta = ClassMeta("cobra.model.fv.SharedService")

    meta.moClassName = "fvSharedService"
    meta.rnFormat = "sharedServiceAlloc"
    meta.category = MoCategory.REGULAR
    meta.label = "Alloc pcTag from Shared Service Pool"
    ...
    meta.childClasses.add("cobra.model.fv.CtxSharedServiceUpdate")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.vz.CreatedBy")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.CtxSharedServiceUpdate", "ctxShrSrvUpd-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.CreatedBy", "by-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21360, PropCategory.REGULAR)
