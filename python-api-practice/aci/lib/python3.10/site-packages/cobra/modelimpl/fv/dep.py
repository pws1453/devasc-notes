...
class DEp(Mo):
    """
    A dynamically-learned endpoint on the switch.

    """

    meta = ClassMeta("cobra.model.fv.DEp")

    meta.moClassName = "fvDEp"
    meta.rnFormat = "dep-%(mac)s-encap-[%(encap)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Dynamic Endpoint"
    ...
    prop = PropMeta("str", "encap", "encap", 1795, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mac", "mac", 6534, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, mac, encap, markDirty=True, **creationProps):
        namingVals = [mac, encap]
