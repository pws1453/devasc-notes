...
# ##################################################
class RsEppExtRouteTagPol(Mo):
    """
    A source relation to an external route tag policy.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppExtRouteTagPol", "cobra.model.l3ext.RouteTagPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEppExtRouteTagPol"
    meta.rnFormat = "rseppExtRouteTagPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18512, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18511, PropCategory.REGULAR)
