...
class CompIssues(Mo):
    """
    The compute configuration issues for each endpoint profile.

    """

    meta = ClassMeta("cobra.model.fv.CompIssues")

    meta.moClassName = "fvCompIssues"
    meta.rnFormat = "compissues"
    meta.category = MoCategory.REGULAR
    meta.label = "Compute Configuration Issues"
    ...
    prop = PropMeta("str", "configQual", "configQual", 1833, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
