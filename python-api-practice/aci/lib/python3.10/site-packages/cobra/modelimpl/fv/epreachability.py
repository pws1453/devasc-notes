...
# ##################################################
class EpReachability(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.EpReachability")

    meta.moClassName = "fvEpReachability"
    meta.rnFormat = "epReach"
    meta.category = MoCategory.REGULAR
    meta.label = "EpReachability"
    ...
    meta.childClasses.add("cobra.model.ip.NexthopEpP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.ip.NexthopEpP", "nh-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38704, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40843, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33379, PropCategory.REGULAR)
