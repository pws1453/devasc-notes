...
# ##################################################
class RtVsrcToEpg(Mo):
    """
    A target relation to a set of endpoints. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtVsrcToEpg", "cobra.model.span.VSrcDef")

    meta.moClassName = "fvRtVsrcToEpg"
    meta.rnFormat = "rtspanVsrcToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstract VSPAN Source Definition"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x600001000006c713
    ...
    prop = PropMeta("str", "tCl", "tCl", 13044, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4179
    prop.defaultValueStr = "spanVSrcDef"
    prop._addConstant("spanVSrcDef", None, 4179)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 13043, PropCategory.REGULAR)
