...
# ##################################################
class RsToSpanFilterGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToSpanFilterGrp", "cobra.model.span.FilterGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToSpanFilterGrp"
    meta.rnFormat = "rstoSpanFilterGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55633, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55632, PropCategory.REGULAR)
