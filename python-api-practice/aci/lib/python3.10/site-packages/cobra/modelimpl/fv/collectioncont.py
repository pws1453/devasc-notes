...
class CollectionCont(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.CollectionCont")

    meta.moClassName = "fvCollectionCont"
    meta.rnFormat = "collectionDn-[%(collectionDn)s]"
    ...
    prop = PropMeta("str", "collectionDn", "collectionDn", 1817, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14312, PropCategory.REGULAR)
