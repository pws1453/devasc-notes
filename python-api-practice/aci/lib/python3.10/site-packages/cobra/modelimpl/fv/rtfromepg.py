...
class RtFromEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtFromEpg", "cobra.model.dbgac.FromEpgCmn")

    meta.moClassName = "fvRtFromEpg"
    meta.rnFormat = "rtdbgacFromEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12879, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4066
    prop.defaultValueStr = "dbgacFromEpgCmn"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12878, PropCategory.REGULAR)
