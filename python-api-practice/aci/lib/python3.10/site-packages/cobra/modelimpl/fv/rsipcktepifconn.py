...
# ##################################################
class RsIpCktEpIfConn(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsIpCktEpIfConn", "cobra.model.l3.IpCktEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsIpCktEpIfConn"
    meta.rnFormat = "rsipCktEpIfConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ip Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52226, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6904
    prop.defaultValueStr = "l3IpCktEp"
    prop._addConstant("l3IpCktEp", None, 6904)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52225, PropCategory.REGULAR)
