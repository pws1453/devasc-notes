...
# ##################################################
class RtLIfCtxToBD(Mo):
    """
    A target relation to a private layer 2 bridge domain.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtLIfCtxToBD", "cobra.model.vns.ALIfCtx")

    meta.moClassName = "fvRtLIfCtxToBD"
    meta.rnFormat = "rtvnsLIfCtxToBD-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Logical Interface Context Abstract Class"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16114, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4660
    prop.defaultValueStr = "vnsALIfCtx"
    ...
    prop = PropMeta("str", "tDn", "tDn", 16113, PropCategory.REGULAR)
