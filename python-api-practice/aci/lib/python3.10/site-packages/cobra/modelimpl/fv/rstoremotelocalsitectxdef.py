...
# ##################################################
class RsToRemoteLocalSiteCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteLocalSiteCtxDef", "cobra.model.fv.LocalCtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteLocalSiteCtxDef"
    meta.rnFormat = "rstoRemoteLocalSiteCtxDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteLocalSiteCtxDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 49396, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9508
    prop.defaultValueStr = "fvLocalCtxDef"
    prop._addConstant("fvLocalCtxDef", None, 9508)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49395, PropCategory.REGULAR)
