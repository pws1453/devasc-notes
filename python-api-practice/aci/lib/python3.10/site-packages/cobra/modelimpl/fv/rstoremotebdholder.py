...
# ##################################################
class RsToRemoteBDHolder(Mo):
    """
    A source relation to a bridge domain holder.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteBDHolder", "cobra.model.fv.BDHolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteBDHolder"
    meta.rnFormat = "rstoRemoteBDHolder-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16324, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5546
    prop.defaultValueStr = "fvBDHolder"
    prop._addConstant("fvBDHolder", None, 5546)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 16323, PropCategory.REGULAR)
