...
# ##################################################
class RtToRemoteBDHolder(Mo):
    """
    A target relation to a bridge domain holder.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteBDHolder", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteBDHolder"
    meta.rnFormat = "rttoRemoteBDHolder-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16326, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16325, PropCategory.REGULAR)
