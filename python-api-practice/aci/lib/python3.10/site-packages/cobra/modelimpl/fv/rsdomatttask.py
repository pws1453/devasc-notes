...
# ##################################################
class RsDomAttTask(Mo):
    """
    An internal task that updates the policy manager of the endpoint group to domain relationship.

    """

    meta = ClassMeta("cobra.model.fv.RsDomAttTask")

    meta.moClassName = "fvRsDomAttTask"
    meta.rnFormat = "fvRsDomAttTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5689, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpPDUpd", "eppdupd", 548)
