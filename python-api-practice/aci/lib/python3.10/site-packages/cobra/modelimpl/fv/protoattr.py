...
class ProtoAttr(Mo):
    """
    The Layer 4 protocol attributes in the criterion.

    """

    meta = ClassMeta("cobra.model.fv.ProtoAttr")

    meta.moClassName = "fvProtoAttr"
    meta.rnFormat = "protoattr-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Protocol Attribute"
    ...
    meta.superClasses.add("cobra.model.fv.AProtoAttr")
    ...
    prop = PropMeta("str", "name", "name", 18458, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prot", "prot", 18440, PropCategory.REGULAR)
    prop.label = "Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    ...
    prop = PropMeta("str", "protPort", "protPort", 18617, PropCategory.REGULAR)
    prop.label = "L4 Protocol Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
