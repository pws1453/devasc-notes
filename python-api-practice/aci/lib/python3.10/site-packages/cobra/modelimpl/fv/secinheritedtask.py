...
# ##################################################
class SecInheritedTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.SecInheritedTask")

    meta.moClassName = "fvSecInheritedTask"
    meta.rnFormat = "fvSecInheritedTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 30560, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("BringInheritedEPgInfoIntoCtrct", "bringinheritedepginfointoctrct", 2696)
