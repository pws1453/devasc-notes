...
class RtSrcToEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtSrcToEpg", "cobra.model.span.ASrc")

    meta.moClassName = "fvRtSrcToEpg"
    meta.rnFormat = "rtspanSrcToEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12982, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12981, PropCategory.REGULAR)
