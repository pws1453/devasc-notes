...
# ##################################################
class RtVlanEppAtt(Mo):
    """
    A target relation to the resolvable endpoint profile. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtVlanEppAtt", "cobra.model.vlan.CktEp")

    meta.moClassName = "fvRtVlanEppAtt"
    meta.rnFormat = "rtvlanVlanEppAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12705, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12704, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15076, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4096)]
