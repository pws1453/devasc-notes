...
# ##################################################
class RsToRemoteNetflowMonitorPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteNetflowMonitorPolDef", "cobra.model.netflow.MonitorPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteNetflowMonitorPolDef"
    meta.rnFormat = "rstoRemoteNetflowMonitorPolDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteNetflowMonitorPolDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27352, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9219
    prop.defaultValueStr = "netflowMonitorPolDef"
    prop._addConstant("netflowMonitorPolDef", None, 9219)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27351, PropCategory.REGULAR)
