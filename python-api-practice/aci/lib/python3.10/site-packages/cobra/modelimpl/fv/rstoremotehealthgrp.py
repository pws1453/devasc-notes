...
# ##################################################
class RsToRemoteHealthGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteHealthGrp", "cobra.model.vns.RedirectHealthGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteHealthGrp"
    meta.rnFormat = "rstoRemoteHealthGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55779, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55778, PropCategory.REGULAR)
