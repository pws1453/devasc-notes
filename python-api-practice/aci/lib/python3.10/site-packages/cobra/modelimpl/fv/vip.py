...
class Vip(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.Vip")

    meta.moClassName = "fvVip"
    meta.rnFormat = "vip-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Virtual IP address"
    ...
    prop = PropMeta("str", "addr", "addr", 19825, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 38232, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40371, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
