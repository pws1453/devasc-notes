...
# ##################################################
class RtToRemoteCtxDef(Mo):
    """
    A target relation to a context definition. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteCtxDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteCtxDef"
    meta.rnFormat = "rttoRemoteCtxDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x10010020003601
    ...
    prop = PropMeta("str", "tCl", "tCl", 12447, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12446, PropCategory.REGULAR)
