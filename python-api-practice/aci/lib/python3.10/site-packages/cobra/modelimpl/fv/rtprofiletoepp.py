...
# ##################################################
class RtProfileToEpp(Mo):
    """
    An abstract representation of the resolvable endpoint profile.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtProfileToEpp", "cobra.model.dns.Profile")

    meta.moClassName = "fvRtProfileToEpp"
    meta.rnFormat = "rtdnsProfileToEpp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "DNS Profile"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x2000010021020681
    ...
    prop = PropMeta("str", "tCl", "tCl", 16129, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16128, PropCategory.REGULAR)
