...
class RsCustQosPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsCustQosPol", "cobra.model.qos.CustomPol")
    meta.targetNameProps["name"] = "tnQosCustomPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsCustQosPol"
    meta.rnFormat = "rscustQosPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Custom QOS Policy"
    meta.writeAccessMask = 0x681
    meta.readAccessMask = 0x681
    ...
    prop = PropMeta("str", "annotation", "annotation", 37650, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39789, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14255, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12222, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosCustomPolName", "tnQosCustomPolName", 12221, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
