...
# ##################################################
class RsToRemoteRtdEpPInfoHolder(Mo):
    """
    A source relation a target relation for a layer 3 routed outside present under a tenant.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRtdEpPInfoHolder", "cobra.model.fv.RtdEpPInfoHolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRtdEpPInfoHolder"
    meta.rnFormat = "rstoRemoteRtdEpPInfoHolder-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteRtdEpPInfoHolder-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 17958, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6034
    prop.defaultValueStr = "fvRtdEpPInfoHolder"
    prop._addConstant("fvRtdEpPInfoHolder", None, 6034)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 17957, PropCategory.REGULAR)
