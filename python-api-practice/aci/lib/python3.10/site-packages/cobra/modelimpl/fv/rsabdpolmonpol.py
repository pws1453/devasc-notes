...
class RsABDPolMonPol(Mo):
    ...
    meta.rnPrefixes = [
        ('rsABDPolMonPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39779, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14240, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12161, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonEPGPolName", "tnMonEPGPolName", 12160, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
