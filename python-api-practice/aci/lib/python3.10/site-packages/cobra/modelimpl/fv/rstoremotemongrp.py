...
# ##################################################
class RsToRemoteMonGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteMonGrp", "cobra.model.mon.Group")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteMonGrp"
    meta.rnFormat = "rstoRemoteMonGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23241, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23240, PropCategory.REGULAR)
