...
class RtCtxToEpP(Mo):
    """
    A target relation to a resolvable endpoint profile. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtCtxToEpP", "cobra.model.l3.Ctx")

    meta.moClassName = "fvRtCtxToEpP"
    meta.rnFormat = "rtctxToEpP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12816, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15148, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
