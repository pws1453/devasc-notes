...
# ##################################################
class RsShardedRegisterUpdates(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsShardedRegisterUpdates", "cobra.model.fv.ShardedAREpPUpd")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsShardedRegisterUpdates"
    meta.rnFormat = "rsshardedRegisterUpdates"
    ...
    meta.rnPrefixes = [
        ('rsshardedRegisterUpdates', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23236, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23235, PropCategory.REGULAR)
