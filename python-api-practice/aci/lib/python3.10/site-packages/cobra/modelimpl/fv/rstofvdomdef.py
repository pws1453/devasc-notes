...
# ##################################################
class RsToFvDomDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToFvDomDef", "cobra.model.fv.DomDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToFvDomDef"
    meta.rnFormat = "rstoFvDomDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23489, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23488, PropCategory.REGULAR)
