...
# ##################################################
class RtSecProvToEpg(Mo):
    """
    A target relation to an attachable target group. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSecProvToEpg", "cobra.model.aaa.AProvider")

    meta.moClassName = "fvRtSecProvToEpg"
    meta.rnFormat = "rtaaaSecProvToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x10000000603
    ...
    prop = PropMeta("str", "tCl", "tCl", 12017, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1600
    prop.defaultValueStr = "aaaAProvider"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12016, PropCategory.REGULAR)
