...
# ##################################################
class RsEppBgpCtxPol(Mo):
    """
    A source relation to the BGP context policy. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppBgpCtxPol", "cobra.model.bgp.CtxPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEppBgpCtxPol"
    meta.rnFormat = "rseppBgpCtxPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "BGP Timers Policy"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34473, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12252, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12251, PropCategory.REGULAR)
