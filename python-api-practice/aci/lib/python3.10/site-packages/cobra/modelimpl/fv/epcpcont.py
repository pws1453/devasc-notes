...
class EpCPCont(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.EpCPCont")

    meta.moClassName = "fvEpCPCont"
    meta.rnFormat = "epcpcont"
    ...
    meta.childClasses.add("cobra.model.fv.EpCP")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.EpCP", "epcp-"))
