...
# ##################################################
class CtxSharedServiceUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.CtxSharedServiceUpdateTask")

    meta.moClassName = "fvCtxSharedServiceUpdateTask"
    meta.rnFormat = "fvCtxSharedServiceUpdateTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fvCtxSharedServiceUpdateTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 21357, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ClassIdFromSharedPool", "classidfromsharedpool", 1868)
