...
# ##################################################
class QinqFabEncapDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.QinqFabEncapDef")

    meta.moClassName = "fvQinqFabEncapDef"
    ...
    prop = PropMeta("str", "encap", "encap", 34104, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "qinqFabEncap", "qinqFabEncap", 34105, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
