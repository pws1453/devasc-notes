...
# ##################################################
class RtExporterToEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtExporterToEPg", "cobra.model.netflow.AExporterPol")

    meta.moClassName = "fvRtExporterToEPg"
    meta.rnFormat = "rtnetflowExporterToEPg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Netflow External Collector"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x600031000006c713
    ...
    prop = PropMeta("str", "tCl", "tCl", 27370, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9204
    prop.defaultValueStr = "netflowAExporterPol"
    ...
    prop = PropMeta("str", "tDn", "tDn", 27369, PropCategory.REGULAR)
