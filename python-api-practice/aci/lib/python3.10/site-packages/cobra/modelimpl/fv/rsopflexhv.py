...
class RsOpflexHv(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsOpflexHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsOpflexHv"
    meta.rnFormat = "rsopflexHv"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21520, PropCategory.REGULAR)
