...
class RsAEPgMonPol(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39777, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14238, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12318, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnMonEPGPolName", "tnMonEPGPolName", 12317, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
