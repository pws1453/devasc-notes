...
class RtSrcToCtx(Mo):
    """
    A target relation to a private layer 3 network context that belongs to a specific tenant. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSrcToCtx", "cobra.model.span.Src")

    meta.moClassName = "fvRtSrcToCtx"
    meta.rnFormat = "rtspanSrcToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13004, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13003, PropCategory.REGULAR)
