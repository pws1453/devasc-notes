...
# ##################################################
class RtARemoteHostToEpp(Mo):
    """
    A target relation to the abstract representation of the resolvable endpoint profile.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtARemoteHostToEpp", "cobra.model.file.ARemoteHost")

    meta.moClassName = "fvRtARemoteHostToEpp"
    meta.rnFormat = "rtfileARemoteHostToEpp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Remote Location"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x2000010021020683
    ...
    prop = PropMeta("str", "tCl", "tCl", 15867, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1670
    prop.defaultValueStr = "fileARemoteHost"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15866, PropCategory.REGULAR)
