...
# ##################################################
class ModSDWanPrefixTaskAggrTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ModSDWanPrefixTaskAggrTask")

    meta.moClassName = "fvModSDWanPrefixTaskAggrTask"
    meta.rnFormat = "fvModSDWanPrefixTaskAggrTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fvModSDWanPrefixTaskAggrTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 55586, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdPrefix", "updprefix", 3657)
