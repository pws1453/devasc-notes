...
# ##################################################
class RsCloudAccount(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsCloudAccount", "cobra.model.cloud.Account")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsCloudAccount"
    meta.rnFormat = "rsCloudAccount"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Tenant to account association"
    ...
    meta.rnPrefixes = [
        ('rsCloudAccount', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55118, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55119, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 55105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 54980, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16110
    prop.defaultValueStr = "cloudAccount"
    prop._addConstant("cloudAccount", None, 16110)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 54979, PropCategory.REGULAR)
