...
class PodConnP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.PodConnP")

    meta.moClassName = "fvPodConnP"
    meta.rnFormat = "podConnP-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "POD Anycast DTEP IP"
    meta.writeAccessMask = 0x1000001
    meta.readAccessMask = 0x1000601
    ...
    meta.childClasses.add("cobra.model.fv.IntersiteConnP")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.fv.PasswordConfig")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fv.PeeringP")
    meta.childClasses.add("cobra.model.fv.ExtRoutableUcastConnP")
    meta.childClasses.add("cobra.model.fv.Ip")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ExtRoutableUcastConnP", "extRtUcastConnP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IntersiteConnP", "intersiteConnP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.PasswordConfig", "passwordConfig"))
    ...
    meta.superClasses.add("cobra.model.fv.APodConnP")

    meta.rnPrefixes = [
        ('podConnP-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38322, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "assocIntersitePodId", "assocIntersitePodId", 44469, PropCategory.REGULAR)
    prop.label = "Pod Id in main fabric to which this vpod is assocaiated"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    prop.defaultValue = 0
    prop.defaultValueStr = "0"
    meta.props.add("assocIntersitePodId", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40461, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 21423, PropCategory.REGULAR)
    prop.label = "POD Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "isVirtual", "isVirtual", 44468, PropCategory.REGULAR)
    prop.label = "is pod virtual"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 25820, PropCategory.REGULAR)
