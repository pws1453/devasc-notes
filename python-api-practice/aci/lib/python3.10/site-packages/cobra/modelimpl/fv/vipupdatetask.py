...
# ##################################################
class VipUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.VipUpdateTask")

    meta.moClassName = "fvVipUpdateTask"
    meta.rnFormat = "fvVipUpdateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 19824, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateCtxDefWithVipDef", "updatectxdefwithvipdef", 1720)
