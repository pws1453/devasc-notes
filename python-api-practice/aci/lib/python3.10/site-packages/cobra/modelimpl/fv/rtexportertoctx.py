...
# ##################################################
class RtExporterToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtExporterToCtx", "cobra.model.netflow.AExporterPol")

    meta.moClassName = "fvRtExporterToCtx"
    meta.rnFormat = "rtnetflowExporterToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27831, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27830, PropCategory.REGULAR)
