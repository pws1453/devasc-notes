...
class InstPEpP(Mo):
    """
    Instance Profile Management EpP for the Fabric Node Management EPG. This EpP is created per external management entity instance profile (InstP EPg).

    """

    meta = ClassMeta("cobra.model.fv.InstPEpP")

    meta.moClassName = "fvInstPEpP"
    meta.rnFormat = "instp-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Management Instance Profile"
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 15529, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15530, PropCategory.REGULAR)
