...
class RsDppPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsDppPol", "cobra.model.qos.DppPol")
    meta.targetNameProps["name"] = "tnQosDppPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsDppPol"
    meta.rnFormat = "rsdppPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "QOS DPP Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38679, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40818, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 32665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 32662, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosDppPolName", "tnQosDppPolName", 32661, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
