...
class RtTnlCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtTnlCtx", "cobra.model.fv.TnlEPg")

    meta.moClassName = "fvRtTnlCtx"
    meta.rnFormat = "rttnlCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "dot1q-tunnel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27857, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9196
    prop.defaultValueStr = "fvTnlEPg"
    prop._addConstant("fvTnlEPg", None, 9196)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27856, PropCategory.REGULAR)
