...
# ##################################################
class DelSDWanPrefixTaskAggrTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.DelSDWanPrefixTaskAggrTask")

    meta.moClassName = "fvDelSDWanPrefixTaskAggrTask"
    meta.rnFormat = "fvDelSDWanPrefixTaskAggrTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fvDelSDWanPrefixTaskAggrTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 55585, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdPrefix", "updprefix", 3658)
