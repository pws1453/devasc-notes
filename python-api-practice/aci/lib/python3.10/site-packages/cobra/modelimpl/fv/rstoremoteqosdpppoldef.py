...
# ##################################################
class RsToRemoteQosDppPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteQosDppPolDef", "cobra.model.qos.DppPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteQosDppPolDef"
    meta.rnFormat = "rstoRemoteQosDppPolDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22825, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7682
    prop.defaultValueStr = "qosDppPolDef"
    prop._addConstant("qosDppPolDef", None, 7682)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22824, PropCategory.REGULAR)
