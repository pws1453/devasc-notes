...
# ##################################################
class RsEpDefRefToStAdjEp(Mo):
    """
    A source relation to the ARP static adjacency endpoint.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEpDefRefToStAdjEp", "cobra.model.arp.StAdjEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEpDefRefToStAdjEp"
    meta.rnFormat = "rsEpDefRefToStAdjEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16131, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16130, PropCategory.REGULAR)
