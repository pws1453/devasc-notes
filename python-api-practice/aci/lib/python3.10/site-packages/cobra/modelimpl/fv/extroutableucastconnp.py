...
# ##################################################
class ExtRoutableUcastConnP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ExtRoutableUcastConnP")

    meta.moClassName = "fvExtRoutableUcastConnP"
    meta.rnFormat = "extRtUcastConnP-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Unicast  DTEP IP for a POD"
    ...
    meta.superClasses.add("cobra.model.fv.AIntersiteConnP")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Def")
    meta.superClasses.add("cobra.model.naming.NamedObject")

    meta.rnPrefixes = [
        ('extRtUcastConnP-', True),
    ]

    prop = PropMeta("str", "OverlapIssues", "OverlapIssues", 61504, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("duplicate-ucast-tep-configured", "duplicate-ucast-tep-configured-on-other-pod", 2)
    prop._addConstant("none", "none", 0)
    prop._addConstant("ucast-tep-overlaps-with-rlpool", "ucast-tep-configured-is-overlapping-with-rl-pool-configured", 4)
    prop._addConstant("ucast-tep-overlaps-with-routable-subnet", "ucast-tep-configured-is-part-of-unreseved-portion-of-routable-subnet", 1)
    meta.props.add("OverlapIssues", prop)

    prop = PropMeta("str", "addr", "addr", 45692, PropCategory.REGULAR)
    prop.label = "Data TEP used for Intersite Communication for each POD"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 45695, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45696, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45694, PropCategory.REGULAR)
