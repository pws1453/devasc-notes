...
# ##################################################
class RsToRemoteConnInstrPol(Mo):
    """
    A source relation to the various segments of the network that need improvement to allow a more efficient distribution of limited budget resources. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteConnInstrPol", "cobra.model.fv.ConnInstrPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsToRemoteConnInstrPol"
    meta.rnFormat = "rstoRemoteConnInstrPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12442, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2106
    prop.defaultValueStr = "fvConnInstrPol"
    prop._addConstant("fvConnInstrPol", None, 2106)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12441, PropCategory.REGULAR)
