...
# ##################################################
class RsShardedRegisterAREpPBootStrap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsShardedRegisterAREpPBootStrap", "cobra.model.fv.AREpPBootStrap")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsShardedRegisterAREpPBootStrap"
    meta.rnFormat = "rsshardedRegisterAREpPBootStrap"
    ...
    meta.rnPrefixes = [
        ('rsshardedRegisterAREpPBootStrap', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 23233, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23232, PropCategory.REGULAR)
