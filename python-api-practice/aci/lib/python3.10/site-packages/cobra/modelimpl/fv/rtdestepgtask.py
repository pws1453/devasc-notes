...
# ##################################################
class RtDestEpgTask(Mo):
    """
    A target relation to an internal object for endpoint task deployment. 

    """

    meta = ClassMeta("cobra.model.fv.RtDestEpgTask")

    meta.moClassName = "fvRtDestEpgTask"
    meta.rnFormat = "fvRtDestEpgTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5690, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SpanEpg", "spanepg", 636)
