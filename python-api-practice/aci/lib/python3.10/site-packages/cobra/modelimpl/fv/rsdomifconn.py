...
# ##################################################
class RsDomIfConn(Mo):
    """
    A source relation to a generic layer 2 flood domain.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsDomIfConn", "cobra.model.l2.ADom")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsDomIfConn"
    meta.rnFormat = "rsdomIfConn"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Domain Interface Attachment"
    ...
    meta.parentClasses.add("cobra.model.fv.FcIfConn")
    ...
    prop = PropMeta("str", "tCl", "tCl", 15259, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8789
    prop.defaultValueStr = "l2ADom"
    ...
    prop = PropMeta("str", "tDn", "tDn", 15258, PropCategory.REGULAR)
