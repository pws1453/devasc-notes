...
# ##################################################
class RtFromEpForEpToEpg(Mo):
    """
    A target relation to the properties of the client defined endpoint attached to the network. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtFromEpForEpToEpg", "cobra.model.dbgac.EpToEpg")

    meta.moClassName = "fvRtFromEpForEpToEpg"
    meta.rnFormat = "rtdbgacFromEpForEpToEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12908, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4081
    prop.defaultValueStr = "dbgacEpToEpg"
    prop._addConstant("dbgacEpToEpg", None, 4081)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12907, PropCategory.REGULAR)
