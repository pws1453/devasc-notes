...
# ##################################################
class UnkMacUcastActMod(Mo):
    """
    This is the bridge domain (BD) Policy Modifier for UnkMacUcastAct. In special cases, the BD Policy Modifier can override the desired state of BD.

    """

    meta = ClassMeta("cobra.model.fv.UnkMacUcastActMod")

    meta.moClassName = "fvUnkMacUcastActMod"
    meta.rnFormat = "unkMacAct"
    ...
    meta.childClasses.add("cobra.model.fv.RtUnkMacActModAtt")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtUnkMacActModAtt", "rtvnsUnkMacActModAtt-"))
    ...
    prop = PropMeta("str", "unkMacUcastAct", "unkMacUcastAct", 1701, PropCategory.REGULAR)
