...
# ##################################################
class RsEppEigrpIfPol(Mo):
    """
    A source relation to the EIGRP interface policy.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppEigrpIfPol", "cobra.model.eigrp.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEppEigrpIfPol"
    meta.rnFormat = "rseppEigrpIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 17997, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17996, PropCategory.REGULAR)
