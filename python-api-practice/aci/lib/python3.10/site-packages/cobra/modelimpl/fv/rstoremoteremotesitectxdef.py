...
# ##################################################
class RsToRemoteRemoteSiteCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRemoteSiteCtxDef", "cobra.model.fv.RemoteCtxDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRemoteSiteCtxDef"
    meta.rnFormat = "rstoRemoteRemoteSiteCtxDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteRemoteSiteCtxDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 49400, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9509
    prop.defaultValueStr = "fvRemoteCtxDef"
    prop._addConstant("fvRemoteCtxDef", None, 9509)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49399, PropCategory.REGULAR)
