...
# ##################################################
class IntersitePeeringP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.IntersitePeeringP")

    meta.moClassName = "fvIntersitePeeringP"
    meta.rnFormat = "ispeeringP"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP EVPN Intersite Peering Profile"
    ...
    meta.superClasses.add("cobra.model.fv.APeeringP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38627, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40766, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 29964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "password", "password", 21404, PropCategory.REGULAR)
    prop.label = "BGP EVPN Peering Password"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 21403, PropCategory.REGULAR)
    prop.label = "BGP EVPN Peering Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "automatic_with_full_mesh"
    prop._addConstant("automatic_with_full_mesh", "full-mesh", 2)
    prop._addConstant("automatic_with_rr", "route-reflector", 1)
