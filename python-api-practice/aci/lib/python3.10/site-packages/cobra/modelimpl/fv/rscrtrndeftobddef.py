...
# ##################################################
class RsCrtrnDefToBDDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsCrtrnDefToBDDef", "cobra.model.fv.BDDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fvRsCrtrnDefToBDDef"
    meta.rnFormat = "rscrtrnDefToBDDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to BDs"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51766, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 51765, PropCategory.REGULAR)
