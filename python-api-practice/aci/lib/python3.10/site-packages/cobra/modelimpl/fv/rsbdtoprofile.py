...
class RsBDToProfile(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDToProfile", "cobra.model.rtctrl.Profile")
    meta.targetNameProps["name"] = "tnRtctrlProfileName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsBDToProfile"
    meta.rnFormat = "rsBDToProfile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37645, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39784, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14248, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12169, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL3extOutName", "tnL3extOutName", 12170, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "tnRtctrlProfileName", "tnRtctrlProfileName", 12168, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
