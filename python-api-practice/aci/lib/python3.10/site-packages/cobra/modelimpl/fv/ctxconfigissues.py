...
# ##################################################
class CtxConfigIssues(Mo):
    """
    The context configuration issues.

    """

    meta = ClassMeta("cobra.model.fv.CtxConfigIssues")

    meta.moClassName = "fvCtxConfigIssues"
    meta.rnFormat = "ctxcfgissues"
    meta.category = MoCategory.REGULAR
    meta.label = "Ctx Configuration Issues"
    ...
    prop = PropMeta("str", "configQual", "configQual", 1836, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "not-applicable"
    prop._addConstant("dns-label-not-default", "dns-label-not-default", 2)
    prop._addConstant("dns-policy-not-present", "dns-policy-not-present", 1)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14319, PropCategory.REGULAR)
