...
# ##################################################
class RsLocaleToObservedEthIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsLocaleToObservedEthIf", "cobra.model.l1.ObservedEthIf")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsLocaleToObservedEthIf"
    meta.rnFormat = "rsLocaleToObservedEthIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21011, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21010, PropCategory.REGULAR)
