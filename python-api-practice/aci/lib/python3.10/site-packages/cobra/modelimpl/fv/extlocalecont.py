...
# ##################################################
class ExtLocaleCont(Mo):
    """
    A container for the extended fabric node information shared across all nodes.

    """

    meta = ClassMeta("cobra.model.fv.ExtLocaleCont")

    meta.moClassName = "fvExtLocaleCont"
    meta.rnFormat = "extlcont"
    ...
    meta.childClasses.add("cobra.model.fv.ExtLocale")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ExtLocale", "node-"))
