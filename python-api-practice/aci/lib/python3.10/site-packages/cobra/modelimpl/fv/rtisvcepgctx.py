...
# ##################################################
class RtISvcEPgCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtISvcEPgCtx", "cobra.model.cloud.ASvcEPg")

    meta.moClassName = "fvRtISvcEPgCtx"
    meta.rnFormat = "rtcloudISvcEPgCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Abstract Cloud Service EPg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 52866, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 15505
    prop.defaultValueStr = "cloudASvcEPg"
    prop._addConstant("cloudASvcEPg", None, 15505)
    prop._addConstant("cloudISvcEPg", None, 15164)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 52865, PropCategory.REGULAR)
