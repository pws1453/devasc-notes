...
# ##################################################
class GipoTaskAggrTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.GipoTaskAggrTask")

    meta.moClassName = "fvGipoTaskAggrTask"
    meta.rnFormat = "fvGipoTaskAggrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33548, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Gipo", "gipo", 2808)
