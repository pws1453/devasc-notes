...
# ##################################################
class RtIpslaMonPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtIpslaMonPol", "cobra.model.fv.TrackMember")

    meta.moClassName = "fvRtIpslaMonPol"
    meta.rnFormat = "rtipslaMonPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45664, PropCategory.REGULAR)
