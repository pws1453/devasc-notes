...
# ##################################################
class AStCEp(Mo):
    meta = ClassMeta("cobra.model.fv.AStCEp")

    meta.isAbstract = True
    meta.moClassName = "fvAStCEp"


    meta.moClassName = "fvAStCEp"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Static End Point"
    ...
    meta.concreteSubClasses.add("cobra.model.fv.StCEp")
    meta.concreteSubClasses.add("cobra.model.fv.StCEpDef")
    ...
    prop = PropMeta("str", "type", "type", 15221, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
