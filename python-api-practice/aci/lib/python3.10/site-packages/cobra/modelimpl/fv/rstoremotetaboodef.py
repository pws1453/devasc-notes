...
# ##################################################
class RsToRemoteTabooDef(Mo):
    """
    A source relation to a taboo definition. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteTabooDef", "cobra.model.vz.TabooDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteTabooDef"
    meta.rnFormat = "rstoRemoteTabooDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12457, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1375
    prop.defaultValueStr = "vzTabooDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vzTabooDef", None, 1375)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12456, PropCategory.REGULAR)
