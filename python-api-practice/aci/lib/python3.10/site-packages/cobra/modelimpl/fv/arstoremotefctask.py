...
# ##################################################
class ARsToRemoteFCTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ARsToRemoteFCTask")

    meta.moClassName = "fvARsToRemoteFCTask"
    meta.rnFormat = "fvARsToRemoteFCTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 22990, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReleasePolicy", "releasepolicy", 2010)
