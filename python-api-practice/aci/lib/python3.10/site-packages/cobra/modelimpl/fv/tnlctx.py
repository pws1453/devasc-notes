...
class TnlCtx(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.TnlCtx")

    meta.moClassName = "fvTnlCtx"
    meta.rnFormat = "tnlctx-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Tunnel VRF"
    ...
    meta.childClasses.add("cobra.model.fv.RtTnlCtx")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtTnlCtx", "rttnlCtx-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27860, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 27848, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "pcEnfDir", "pcEnfDir", 23111, PropCategory.REGULAR)
