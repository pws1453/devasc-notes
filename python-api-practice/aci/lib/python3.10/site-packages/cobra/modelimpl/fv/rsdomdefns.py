...
class RsDomDefNs(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsDomDefNs", "cobra.model.fvns.VxlanInstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsDomDefNs"
    meta.rnFormat = "rsdomDefNs"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37634, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39773, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 12153, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12152, PropCategory.REGULAR)
