...
# ##################################################
class RtTrEpIpDst(Mo):
    """
    A target relation to the IP address of an endpoint.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtTrEpIpDst", "cobra.model.traceroutep.TrEp")

    meta.moClassName = "fvRtTrEpIpDst"
    meta.rnFormat = "rttraceroutepTrEpIpDst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15830, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15829, PropCategory.REGULAR)
