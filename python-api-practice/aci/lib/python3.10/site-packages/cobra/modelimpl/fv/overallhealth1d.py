...
class OverallHealth1d(Mo):
    """
    A class that represents the most current statistics for overall tenant health in a 1 day sampling interval.  This class updates every hour.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealth1d", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealth1d"
    meta.rnFormat = "CDfvOverallHealth1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall tenant health stats in 1 day"
