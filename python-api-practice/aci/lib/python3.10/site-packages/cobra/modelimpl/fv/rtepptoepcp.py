...
# ##################################################
class RtEppToEpCP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtEppToEpCP", "cobra.model.fv.AREpP")

    meta.moClassName = "fvRtEppToEpCP"
    meta.rnFormat = "rteppToEpCP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20975, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20974, PropCategory.REGULAR)
