...
class RtDevEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtDevEpg", "cobra.model.vns.ALDev")

    meta.moClassName = "fvRtDevEpg"
    meta.rnFormat = "rtvnsDevEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13698, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13697, PropCategory.REGULAR)
