...
# ##################################################
class RsStPathAtt(Mo):
    """
    A source relation to the path endpoint. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStPathAtt", "cobra.model.nw.PathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsStPathAtt"
    meta.rnFormat = "rsstPathAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Network Path Endpoint"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14275, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12281, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3578
    prop.defaultValueStr = "nwPathEp"
    prop._addConstant("nwPathEp", None, 3578)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12280, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 15027, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
