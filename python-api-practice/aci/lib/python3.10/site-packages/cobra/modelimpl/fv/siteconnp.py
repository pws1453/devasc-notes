...
class SiteConnP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.SiteConnP")

    meta.moClassName = "fvSiteConnP"
    meta.rnFormat = "siteConnP-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Intersite Anycast DTEP IP for a POD"
    ...
    meta.childClasses.add("cobra.model.fv.ExtRoutableRemoteSitePodSubnet")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.cloudsec.CapabilityRemote")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.AliasDelInst")
    meta.childClasses.add("cobra.model.cloudsec.SaKeyPRemote")
    meta.childClasses.add("cobra.model.cloudsec.SaKeyStatusRemote")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ExtRoutableRemoteSitePodSubnet", "extrtremotesitepodsubnet-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IntersiteMcastConnP", "intersiteMcastConnP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.CapabilityRemote", "cloudseccapremote"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.SaKeyStatusRemote", "sakeystatusremote"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IntersiteConnP", "intersiteConnP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.SaKeyPRemote", "sakeypremote"))
    ...
    meta.superClasses.add("cobra.model.fv.ASiteConnP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38662, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40801, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 30387, PropCategory.REGULAR)
    prop.label = "Site ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30391, PropCategory.REGULAR)
