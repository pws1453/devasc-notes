...
# ##################################################
class RtPolModAtt(Mo):
    """
    A target relation to a bridge domain policy modifier that can override the desired state of the bridge domain. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtPolModAtt", "cobra.model.vns.FuncConnInst")

    meta.moClassName = "fvRtPolModAtt"
    meta.rnFormat = "rtvnsPolModAtt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fv.PolMod")
    ...
    prop = PropMeta("str", "tCl", "tCl", 13645, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 13644, PropCategory.REGULAR)
