...
# ##################################################
class RtToRemoteIpslaPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteIpslaPol", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteIpslaPol"
    meta.rnFormat = "rttoRemoteIpslaPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49427, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 49426, PropCategory.REGULAR)
