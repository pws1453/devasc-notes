...
class AEPgCont(Mo):
    """
    An abstract container class for endpoint groups. This is an abstract class and cannot be instantiated

    """

    meta = ClassMeta("cobra.model.fv.AEPgCont")

    meta.moClassName = "fvAEPgCont"
    meta.rnFormat = "epgDn-[%(epgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Application EPG Container"
    ...
    meta.childClasses.add("cobra.model.fv.VipDef")
    ...
    meta.childClasses.add("cobra.model.vns.SvcEpgCont")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.VipDef", "vipdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.BDSubnet", "bdsub-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SvcEpgCont", "epgDn-"))
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 6526, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14310, PropCategory.REGULAR)
