...
# ##################################################
class RtFromAbsEpg(Mo):
    """
    

    """

    meta = TargetRelationMeta("cobra.model.fv.RtFromAbsEpg", "cobra.model.dbgac.FromEpgCmn")

    meta.moClassName = "fvRtFromAbsEpg"
    meta.rnFormat = "rtdbgacFromAbsEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18637, PropCategory.REGULAR)
