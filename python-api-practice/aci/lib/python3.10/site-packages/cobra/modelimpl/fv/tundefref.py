...
class TunDefRef(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.TunDefRef")

    meta.moClassName = "fvTunDefRef"
    meta.rnFormat = "tundefref-%(mac)s"
    ...
    meta.childClasses.add("cobra.model.fv.RsToTunDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToTunDef", "rstoTunDef"))
    ...
    prop = PropMeta("str", "mac", "mac", 6564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14304, PropCategory.REGULAR)
