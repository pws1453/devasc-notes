...
# ##################################################
class RsToRemoteNetflowExporterPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteNetflowExporterPolDef", "cobra.model.netflow.ExporterPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteNetflowExporterPolDef"
    meta.rnFormat = "rstoRemoteNetflowExporterPolDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteNetflowExporterPolDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 31075, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9224
    prop.defaultValueStr = "netflowExporterPolDef"
    prop._addConstant("netflowExporterPolDef", None, 9224)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 31074, PropCategory.REGULAR)
