...
# ##################################################
class RsBDSubnetToOut(Mo):
    """
    A source relation to the L3 routed outside network.

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDSubnetToOut", "cobra.model.l3ext.Out")
    meta.targetNameProps["name"] = "tnL3extOutName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsBDSubnetToOut"
    meta.rnFormat = "rsBDSubnetToOut-%(tnL3extOutName)s"
    ...
    meta.rnPrefixes = [
        ('rsBDSubnetToOut-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37633, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39772, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14230, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12144, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnL3extOutName", "tnL3extOutName", 12143, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL3extOutName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnL3extOutName"))
    ...
    def __init__(self, parentMoOrDn, tnL3extOutName, markDirty=True, **creationProps):
        namingVals = [tnL3extOutName]
