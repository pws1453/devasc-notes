...
# ##################################################
class KeyChainPolDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.KeyChainPolDefCont")

    meta.moClassName = "fvKeyChainPolDefCont"
    meta.rnFormat = "keychainpolcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Container for Resolved KeyChain policies"
    ...
    meta.childClasses.add("cobra.model.fv.KeyChainPolDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.KeyChainPolDef", "keychainpoldef-"))
