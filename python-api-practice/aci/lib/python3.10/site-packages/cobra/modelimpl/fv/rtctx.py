...
class RtCtx(Mo):
    """
    A target relation to a private layer 3 network context that is shared or belongs to a specific tenant. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtCtx", "cobra.model.fv.ABDPol")

    meta.moClassName = "fvRtCtx"
    meta.rnFormat = "rtctx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Bridge Domain"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x6010010021003701
    ...
    prop = PropMeta("str", "tCl", "tCl", 12190, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12189, PropCategory.REGULAR)
