...
class RsEppToMonPol(Mo):
    ...
    prop = PropMeta("str", "tCl", "tCl", 12248, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12247, PropCategory.REGULAR)
