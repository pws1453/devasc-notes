...
# ##################################################
class RtToEpIpForEpgToEpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RtToEpIpForEpgToEpTask")

    meta.moClassName = "fvRtToEpIpForEpgToEpTask"
    meta.rnFormat = "fvRtToEpIpForEpgToEpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24130, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DbgacEpIpForEpgToEp", "dbgacepipforepgtoep", 2128)
