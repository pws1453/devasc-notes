...
# ##################################################
class RsHyperTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RsHyperTask")

    meta.moClassName = "fvRsHyperTask"
    meta.rnFormat = "fvRsHyperTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 23224, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("StaleEpDetach", "staleepdetach", 2045)
