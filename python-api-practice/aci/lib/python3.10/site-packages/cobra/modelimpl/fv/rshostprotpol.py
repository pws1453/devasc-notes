...
# ##################################################
class RsHostprotPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsHostprotPol", "cobra.model.hostprot.PolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsHostprotPol"
    meta.rnFormat = "rshostprotPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 29981, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9838
    prop.defaultValueStr = "hostprotPolDef"
    prop._addConstant("hostprotPolDef", None, 9838)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 29980, PropCategory.REGULAR)
