...
class PeeringP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.PeeringP")

    meta.moClassName = "fvPeeringP"
    meta.rnFormat = "peeringP"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP EVPN Peering Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38323, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40462, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
