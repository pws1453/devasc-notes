...
# ##################################################
class RtToRemoteConnInstrPol(Mo):
    """
    A target relation to the various segments of the network that need improvement to allow a more efficient distribution of limited budget resources.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteConnInstrPol", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteConnInstrPol"
    meta.rnFormat = "rttoRemoteConnInstrPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12443, PropCategory.REGULAR)
