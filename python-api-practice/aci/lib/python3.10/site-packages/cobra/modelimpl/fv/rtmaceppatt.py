...
# ##################################################
class RtMacEppAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtMacEppAtt", "cobra.model.l2.MacCktEp")

    meta.moClassName = "fvRtMacEppAtt"
    meta.rnFormat = "rtl2MacEppAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23508, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 23507, PropCategory.REGULAR)
