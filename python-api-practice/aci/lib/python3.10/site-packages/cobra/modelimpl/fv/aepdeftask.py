...
class AEpDefTask(Mo):
    """
    The abstract endpoint definition task.

    """

    meta = ClassMeta("cobra.model.fv.AEpDefTask")

    meta.moClassName = "fvAEpDefTask"
    meta.rnFormat = "fvAEpDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5684, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EndPointUpd", "endpointupd", 553)
