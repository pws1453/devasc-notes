...
# ##################################################
class RsToRemoteBDDef(Mo):
    """
    A source relation to a network context that is shared or belongs to a specific tenant or context. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteBDDef", "cobra.model.fv.BDDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteBDDef"
    meta.rnFormat = "rstoRemoteBDDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12438, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1871
    prop.defaultValueStr = "fvBDDef"
    prop._addConstant("fvBDDef", None, 1871)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 12437, PropCategory.REGULAR)
