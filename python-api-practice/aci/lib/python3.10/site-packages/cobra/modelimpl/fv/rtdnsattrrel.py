...
# ##################################################
class RtDnsAttrRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtDnsAttrRel", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "fvRtDnsAttrRel"
    meta.rnFormat = "rtpolDnsAttrRel-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 33293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33292, PropCategory.REGULAR)
