...
# ##################################################
class PasswordConfig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.PasswordConfig")

    meta.moClassName = "fvPasswordConfig"
    meta.rnFormat = "passwordConfig"
    ...
    prop = PropMeta("str", "annotation", "annotation", 44527, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 44528, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "password", "password", 44474, PropCategory.REGULAR)
    prop.label = "password"
    prop.isConfig = True
    prop.isAdmin = True
