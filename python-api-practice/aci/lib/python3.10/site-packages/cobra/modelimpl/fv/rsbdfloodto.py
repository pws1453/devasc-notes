...
class RsBdFloodTo(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsBdFloodTo", "cobra.model.vz.Filter")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsBdFloodTo"
    meta.rnFormat = "rsbdFloodTo-[%(tDn)s]"
    ...
    prop = PropMeta("str", "action", "action", 12179, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "annotation", "annotation", 37644, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39783, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14247, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12178, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12177, PropCategory.REGULAR)
