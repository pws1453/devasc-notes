...
# ##################################################
class RtProfileToEpg(Mo):
    """
    An attachable target group. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtProfileToEpg", "cobra.model.dns.Profile")

    meta.moClassName = "fvRtProfileToEpg"
    meta.rnFormat = "rtdnsProfileToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "DNS Profile"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x10000000601
    ...
    prop = PropMeta("str", "tCl", "tCl", 11287, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11286, PropCategory.REGULAR)
