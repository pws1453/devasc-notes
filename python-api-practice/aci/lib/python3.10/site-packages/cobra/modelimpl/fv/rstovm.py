...
class RsToVm(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsToVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToVm"
    meta.rnFormat = "rstoVm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "isBootstrapUpd", "isBootstrapUpd", 27727, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 27656, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1294
    prop.defaultValueStr = "compVm"
    prop._addConstant("compVm", None, 1294)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27655, PropCategory.REGULAR)
