...
# ##################################################
class RsEppOspfCtxPol(Mo):
    """
    A source relation to the context-level OSPF timer policy. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppOspfCtxPol", "cobra.model.ospf.CtxPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEppOspfCtxPol"
    meta.rnFormat = "rseppOspfCtxPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12256, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12255, PropCategory.REGULAR)
