...
# ##################################################
class RsToRemoteKeyChainPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteKeyChainPolDef", "cobra.model.fv.KeyChainPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteKeyChainPolDef"
    meta.rnFormat = "rstoRemoteKeyChainPolDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49913, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14330
    prop.defaultValueStr = "fvKeyChainPolDef"
    prop._addConstant("fvKeyChainPolDef", None, 14330)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49912, PropCategory.REGULAR)
