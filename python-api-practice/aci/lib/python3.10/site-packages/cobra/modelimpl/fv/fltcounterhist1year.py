...
# ##################################################
class FltCounterHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fv.FltCounterHist1year", "Fault Counter")
    ...
    meta.moClassName = "fvFltCounterHist1year"
    meta.rnFormat = "HDfvFltCounter1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Fault Counter stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 30183, PropCategory.REGULAR)
