...
class RsBd(Mo):
    ...
    meta.label = "Bridge Domain for the EPG"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37662, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39801, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12322, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvBDName", "tnFvBDName", 12321, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
