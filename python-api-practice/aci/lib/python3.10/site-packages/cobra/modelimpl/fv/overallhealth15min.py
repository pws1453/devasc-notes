...
class OverallHealth15min(Mo):
    """
    A class that represents the most current statistics for overall tenant health in a 15 minute sampling interval.  This class updates every 5 minutes.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealth15min", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealth15min"
    meta.rnFormat = "CDfvOverallHealth15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall tenant health stats in 15 minute"
