...
# ##################################################
class FabricExtConnP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.FabricExtConnP")

    meta.moClassName = "fvFabricExtConnP"
    meta.rnFormat = "fabricExtConnP-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Intrasite/Intersite Profile"
    meta.writeAccessMask = 0x1000001
    meta.readAccessMask = 0x21000601
    ...
    meta.childClasses.add("cobra.model.fv.SiteConnP")
    meta.childClasses.add("cobra.model.cloudsec.SaKeyStatusLocal")
    meta.childClasses.add("cobra.model.cloudsec.Control")
    meta.childClasses.add("cobra.model.l3ext.FabricExtRoutingP")
    meta.childClasses.add("cobra.model.fv.IntersiteMcastConnP")
    meta.childClasses.add("cobra.model.cloudsec.SaKeyPLocal")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.fv.PodConnP")
    meta.childClasses.add("cobra.model.cloudsec.SaKeyUsage")
    meta.childClasses.add("cobra.model.fv.IntersitePeeringP")
    meta.childClasses.add("cobra.model.fv.PeeringP")
    ...
    meta.childClasses.add("cobra.model.cloudsec.CapabilityLocal")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IntersiteMcastConnP", "intersiteMcastConnP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.FabricExtRoutingP", "fabricExtRoutingP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.SaKeyStatusLocal", "sakeystatuslocal-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.CapabilityLocal", "cloudseccaplocal"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.Control", "cloudseccontrol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.SaKeyPLocal", "sakeyplocal-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.SaKeyUsage", "sakeyusage-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.SiteConnP", "siteConnP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IntersitePeeringP", "ispeeringP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.PodConnP", "podConnP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.PeeringP", "peeringP"))
    ...
    meta.superClasses.add("cobra.model.fv.AFabricExtConnP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 38321, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40460, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 21420, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21474, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rt", "rt", 21397, PropCategory.REGULAR)
    prop.label = "Global EVPN Route Target"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("rt", prop)

    prop = PropMeta("str", "siteId", "siteId", 30375, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 1000)]
