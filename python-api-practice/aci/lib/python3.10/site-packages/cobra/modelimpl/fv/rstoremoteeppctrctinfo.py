...
# ##################################################
class RsToRemoteEpPCtrctInfo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteEpPCtrctInfo", "cobra.model.fv.EpPCtrctInfo")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteEpPCtrctInfo"
    meta.rnFormat = "rstoRemoteEpPCtrctInfo-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22994, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7777
    prop.defaultValueStr = "fvEpPCtrctInfo"
    prop._addConstant("fvEpPCtrctInfo", None, 7777)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 22993, PropCategory.REGULAR)
