...
class RsBDToFhs(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsBDToFhs", "cobra.model.fhs.BDPol")
    meta.targetNameProps["name"] = "tnFhsBDPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsBDToFhs"
    meta.rnFormat = "rsBDToFhs"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38716, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40855, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33500, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 33497, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 10752
    prop.defaultValueStr = "fhsBDPol"
    ...
    prop = PropMeta("str", "tnFhsBDPolName", "tnFhsBDPolName", 33496, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFhsBDPolName", prop)
