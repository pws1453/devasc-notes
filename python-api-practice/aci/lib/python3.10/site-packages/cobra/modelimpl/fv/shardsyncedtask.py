...
# ##################################################
class ShardSyncedTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ShardSyncedTask")

    meta.moClassName = "fvShardSyncedTask"
    meta.rnFormat = "fvShardSyncedTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 33549, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReallocateGipos", "reallocategipos", 2810)
