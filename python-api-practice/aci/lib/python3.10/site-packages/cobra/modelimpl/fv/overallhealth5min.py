...
class OverallHealth5min(Mo):
    """
    A class that represents the most current statistics for overall tenant health in a 5 minute sampling interval.  This class updates every 10 seconds.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealth5min", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealth5min"
    meta.rnFormat = "CDfvOverallHealth5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current overall tenant health stats in 5 minute"
