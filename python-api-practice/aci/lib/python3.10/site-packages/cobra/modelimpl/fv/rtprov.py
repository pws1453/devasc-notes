...
class RtProv(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtProv", "cobra.model.dhcp.RelayP")

    meta.moClassName = "fvRtProv"
    meta.rnFormat = "rtdhcpProv-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "DHCP Relay Policy"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x6000010000040701
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14119, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11958, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11957, PropCategory.REGULAR)
