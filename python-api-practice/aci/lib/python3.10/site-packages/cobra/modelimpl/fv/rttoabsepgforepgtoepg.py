...
# ##################################################
class RtToAbsEpgForEpgToEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToAbsEpgForEpgToEpg", "cobra.model.dbgac.EpgToEpg")

    meta.moClassName = "fvRtToAbsEpgForEpgToEpg"
    meta.rnFormat = "rtdbgacToAbsEpgForEpgToEpg-[%(tDn)s]"
    ...
    meta.readAccessMask = 0x600001000004c713
    ...
    meta.rnPrefixes = [
        ('rtdbgacToAbsEpgForEpgToEpg-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 35380, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 35379, PropCategory.REGULAR)
