...
# ##################################################
class RtEPpInfoToBD(Mo):
    """
    A target relation to the abstract representation of a bridge domain policy.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtEPpInfoToBD", "cobra.model.vns.EPpInfo")

    meta.moClassName = "fvRtEPpInfoToBD"
    meta.rnFormat = "rtvnsEPpInfoToBD-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 16118, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16117, PropCategory.REGULAR)
