...
# ##################################################
class RsStAttEntPAtt(Mo):
    """
    A source relation to the attached entity profile.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStAttEntPAtt", "cobra.model.infra.AttEntityP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsStAttEntPAtt"
    meta.rnFormat = "rsstAttEntPAtt"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12285, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12284, PropCategory.REGULAR)
