...
class RtOoBCtx(Mo):
    """
    The target relation to the private layer 3 network context that belongs to a specific tenant or is shared.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtOoBCtx", "cobra.model.mgmt.OoB")

    meta.moClassName = "fvRtOoBCtx"
    meta.rnFormat = "rtmgmtOoBCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Out-Of-Band Management EPg"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x6010010021007701
    ...
    prop = PropMeta("str", "tCl", "tCl", 16223, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 16222, PropCategory.REGULAR)
