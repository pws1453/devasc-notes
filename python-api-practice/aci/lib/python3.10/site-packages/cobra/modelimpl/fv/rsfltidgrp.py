...
class RsFltIdGrp(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsFltIdGrp", "cobra.model.adepg.Group")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsFltIdGrp"
    meta.rnFormat = "rsfltIdGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Identity group filter"
    ...
    prop = PropMeta("str", "tCl", "tCl", 43823, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43822, PropCategory.REGULAR)
