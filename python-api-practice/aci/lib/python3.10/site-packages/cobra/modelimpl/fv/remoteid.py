...
class RemoteId(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.RemoteId")

    meta.moClassName = "fvRemoteId"
    meta.rnFormat = "site-%(siteId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Remote Site ID Mappings"
    ...
    meta.childClasses.add("cobra.model.fv.ImportExtRoutes")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ImportExtRoutes", "importextroutes"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 38587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40726, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 28416, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "remoteCtxPcTag", "remoteCtxPcTag", 34444, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("any", "any", 0)
    meta.props.add("remoteCtxPcTag", prop)

    prop = PropMeta("str", "remotePcTag", "remotePcTag", 28392, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("any", "any", 0)
    meta.props.add("remotePcTag", prop)
    ...
    prop = PropMeta("str", "siteId", "siteId", 28391, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
