...
# ##################################################
class PolDeliveryStatus(Mo):
    """
    Status of policy deployment indicates if APIC has delivered/is delivering policy to node -  Policy to node cannot be delivered (node is a spine).

    """

    meta = ClassMeta("cobra.model.fv.PolDeliveryStatus")

    meta.moClassName = "fvPolDeliveryStatus"
    meta.rnFormat = "polDelSt"
    meta.category = MoCategory.REGULAR
    meta.label = "Policy Delivery status"
    ...
    prop = PropMeta("str", "deploymentState", "deploymentState", 15587, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("deploymentState", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15617, PropCategory.REGULAR)
