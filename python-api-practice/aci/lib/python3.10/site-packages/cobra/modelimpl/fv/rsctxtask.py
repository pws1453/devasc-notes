...
class RsCtxTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.RsCtxTask")

    meta.moClassName = "fvRsCtxTask"
    meta.rnFormat = "fvRsCtxTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 43432, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateAssocBDDefCont", "updateassocbddefcont", 3144)
