...
class RtIpEppAtt(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtIpEppAtt", "cobra.model.l3.IpCktEp")

    meta.moClassName = "fvRtIpEppAtt"
    meta.rnFormat = "rtl3IpEppAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 20979, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 20978, PropCategory.REGULAR)
