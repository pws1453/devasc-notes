...
class RsToNic(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsToNic", "cobra.model.comp.Nic")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToNic"
    meta.rnFormat = "rstoNic-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Nic Interface"
    ...
    prop = PropMeta("str", "isBootstrapUpd", "isBootstrapUpd", 27726, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 27652, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1115
    prop.defaultValueStr = "compNic"
    ...
    prop = PropMeta("str", "tDn", "tDn", 27651, PropCategory.REGULAR)
