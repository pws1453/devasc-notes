...
# ##################################################
class RsVNodeToHv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsVNodeToHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsVNodeToHv"
    meta.rnFormat = "rsVNodeToHv"
    ...
    prop = PropMeta("str", "tCl", "tCl", 27802, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 27801, PropCategory.REGULAR)
