...
# ##################################################
class RtDestToVPort(Mo):
    """
    A target relation to an endpoint. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtDestToVPort", "cobra.model.span.AVDest")

    meta.moClassName = "fvRtDestToVPort"
    meta.rnFormat = "rtspanDestToVPort-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 13047, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4188
    prop.defaultValueStr = "spanAVDest"
    ...
    prop = PropMeta("str", "tDn", "tDn", 16544, PropCategory.REGULAR)
