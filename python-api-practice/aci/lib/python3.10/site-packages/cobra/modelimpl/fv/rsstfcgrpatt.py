...
# ##################################################
class RsStFcGrpAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsStFcGrpAtt", "cobra.model.infra.FcAccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsStFcGrpAtt"
    meta.rnFormat = "rsstFcGrpAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "isDeployedUsingFilters", "isDeployedUsingFilters", 39114, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop._addConstant("no", None, False)
    prop._addConstant("yes", None, True)
    meta.props.add("isDeployedUsingFilters", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 39116, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11862
    prop.defaultValueStr = "infraFcAccGrp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 39115, PropCategory.REGULAR)
