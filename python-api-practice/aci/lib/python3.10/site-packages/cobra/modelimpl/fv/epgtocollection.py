...
# ##################################################
class EPgToCollection(Mo):
    meta = ClassMeta("cobra.model.fv.EPgToCollection")

    meta.isAbstract = True
    meta.moClassName = "fvEPgToCollection"


    meta.moClassName = "fvEPgToCollection"
    meta.rnFormat = ""
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Super Class for Each Epg to Collection Relation"
    ...
    meta.concreteSubClasses.add("cobra.model.fv.RsIntraEpg")
    meta.concreteSubClasses.add("cobra.model.fv.RsCons")
    meta.concreteSubClasses.add("cobra.model.fv.RsProv")
