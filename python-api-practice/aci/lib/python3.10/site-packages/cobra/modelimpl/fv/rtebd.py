...
class RtEBd(Mo):
    """
    A target relation to the bridge domain associated to this endpoint group. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtEBd", "cobra.model.l2ext.Out")

    meta.moClassName = "fvRtEBd"
    meta.rnFormat = "rtl2extEBd-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12069, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12068, PropCategory.REGULAR)
