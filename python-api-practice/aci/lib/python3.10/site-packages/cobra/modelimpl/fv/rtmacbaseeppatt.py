...
# ##################################################
class RtMacBaseEppAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtMacBaseEppAtt", "cobra.model.l2.MacCktEp")

    meta.moClassName = "fvRtMacBaseEppAtt"
    meta.rnFormat = "rtl2MacBaseEppAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 23504, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6903
    prop.defaultValueStr = "l2MacCktEp"
    prop._addConstant("l2MacCktEp", None, 6903)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 23503, PropCategory.REGULAR)
