...
# ##################################################
class RsLsNodeAtt(Mo):
    """
    A source relation to a loose node. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsLsNodeAtt", "cobra.model.leqpt.LooseNode")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsLsNodeAtt"
    meta.rnFormat = "rslsNodeAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12292, PropCategory.REGULAR)
