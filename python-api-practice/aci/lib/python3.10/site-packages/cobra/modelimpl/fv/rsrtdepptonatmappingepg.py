...
# ##################################################
class RsRtdEpPToNatMappingEPg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsRtdEpPToNatMappingEPg", "cobra.model.fv.AEPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsRtdEpPToNatMappingEPg"
    meta.rnFormat = "rsRtdEpPToNatMappingEPg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 22154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 22153, PropCategory.REGULAR)
