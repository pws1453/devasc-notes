...
# ##################################################
class RtSecInherited(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSecInherited", "cobra.model.fv.EPg")

    meta.moClassName = "fvRtSecInherited"
    meta.rnFormat = "rtsecInherited-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "End Point Group"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x6000010000040703
    ...
    prop = PropMeta("str", "tCl", "tCl", 30564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 30563, PropCategory.REGULAR)
