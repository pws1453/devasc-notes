...
# ##################################################
class RtAcExtPolToContextTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RtAcExtPolToContextTask")

    meta.moClassName = "fvRtAcExtPolToContextTask"
    meta.rnFormat = "fvRtAcExtPolToContextTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fvRtAcExtPolToContextTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 23319, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("AcExtIpL3Out", "acextipl3out", 2066)
