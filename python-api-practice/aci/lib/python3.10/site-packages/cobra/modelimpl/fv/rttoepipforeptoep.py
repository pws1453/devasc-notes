...
# ##################################################
class RtToEpIpForEpToEp(Mo):
    """
    A target relation to the IP address of an endpoint.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToEpIpForEpToEp", "cobra.model.dbgac.EpToEp")

    meta.moClassName = "fvRtToEpIpForEpToEp"
    meta.rnFormat = "rtdbgacToEpIpForEpToEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24137, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 15823, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15822, PropCategory.REGULAR)
