...
# ##################################################
class RtARemoteHostToEpg(Mo):
    """
    A target relation to teh abstract representation of the resolvable endpoint profile. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtARemoteHostToEpg", "cobra.model.file.ARemoteHost")

    meta.moClassName = "fvRtARemoteHostToEpg"
    meta.rnFormat = "rtfileARemoteHostToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Remote Location"
    meta.writeAccessMask = 0x0
    meta.readAccessMask = 0x800010000000603
    ...
    prop = PropMeta("str", "tCl", "tCl", 12021, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12020, PropCategory.REGULAR)
