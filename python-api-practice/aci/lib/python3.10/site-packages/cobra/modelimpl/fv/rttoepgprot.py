...
# ##################################################
class RtToEpgProt(Mo):
    """
    A target relation to an endpoint group associated with a taboo policy in a given context.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToEpgProt", "cobra.model.actrl.ARule")

    meta.moClassName = "fvRtToEpgProt"
    meta.rnFormat = "rtactrlToEpgProt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15640, PropCategory.REGULAR)
