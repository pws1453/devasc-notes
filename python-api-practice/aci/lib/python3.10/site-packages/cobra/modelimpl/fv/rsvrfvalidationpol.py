...
# ##################################################
class RsVrfValidationPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsVrfValidationPol", "cobra.model.l3ext.VrfValidationPol")
    meta.targetNameProps["name"] = "tnL3extVrfValidationPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsVrfValidationPol"
    meta.rnFormat = "rsvrfValidationPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "VRF Validation Policy"
    ...
    meta.rnPrefixes = [
        ('rsvrfValidationPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38803, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40942, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 35756, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 35752, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11387
    prop.defaultValueStr = "l3extVrfValidationPol"
    ...
    prop = PropMeta("str", "tnL3extVrfValidationPolName", "tnL3extVrfValidationPolName", 35751, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnL3extVrfValidationPolName", prop)
