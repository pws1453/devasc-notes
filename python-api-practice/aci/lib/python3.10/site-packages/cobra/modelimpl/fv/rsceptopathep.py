...
# ##################################################
class RsCEpToPathEp(Mo):
    """
    A source relation to a path endpoint. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsCEpToPathEp", "cobra.model.fabric.APathEp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsCEpToPathEp"
    meta.rnFormat = "rscEpToPathEp-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.fv.L3Out")
    meta.childClasses.add("cobra.model.fv.L3SubInterface")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.L3SubInterface", "subif-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.ReportingNode", "node-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.L3Out", "out-"))
    ...
    prop = PropMeta("str", "lcC", "lcC", 12387, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12386, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 492
    prop.defaultValueStr = "fabricAPathEp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 12385, PropCategory.REGULAR)
