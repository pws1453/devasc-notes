...
# ##################################################
class RsToRemoteBackupPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteBackupPol", "cobra.model.vns.BackupPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteBackupPol"
    meta.rnFormat = "rstoRemoteBackupPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55775, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16020
    prop.defaultValueStr = "vnsBackupPol"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsBackupPol", None, 16020)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55774, PropCategory.REGULAR)
