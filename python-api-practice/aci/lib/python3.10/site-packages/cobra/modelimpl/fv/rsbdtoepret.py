...
class RsBdToEpRet(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsBdToEpRet", "cobra.model.fv.EpRetPol")
    meta.targetNameProps["name"] = "tnFvEpRetPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsBdToEpRet"
    meta.rnFormat = "rsbdToEpRet"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37643, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39782, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14246, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "resolveAct", "resolveAct", 12184, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "resolve"
    prop._addConstant("inherit", "inherit", 2)
    prop._addConstant("resolve", "resolve", 1)
    meta.props.add("resolveAct", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12183, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1893
    prop.defaultValueStr = "fvEpRetPol"
    ...
    prop = PropMeta("str", "tnFvEpRetPolName", "tnFvEpRetPolName", 12182, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFvEpRetPolName", prop)
