...
# ##################################################
class RtToEpIpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RtToEpIpTask")

    meta.moClassName = "fvRtToEpIpTask"
    meta.rnFormat = "fvRtToEpIpTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 24128, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DbgacToEpIp", "dbgactoepip", 2129)
