...
# ##################################################
class RsEppBgpCtxAfPol(Mo):
    """
    A source relation to a per-address family BGP context policy.

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEppBgpCtxAfPol", "cobra.model.bgp.CtxAfPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsEppBgpCtxAfPol"
    meta.rnFormat = "rseppBgpCtxAfPol-[%(tDn)s]-%(af)s"
    ...
    meta.rnPrefixes = [
        ('rseppBgpCtxAfPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "af", "af", 17579, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 17581, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 17580, PropCategory.REGULAR)
