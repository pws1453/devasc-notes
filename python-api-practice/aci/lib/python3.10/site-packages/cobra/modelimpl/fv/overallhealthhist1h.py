...
class OverallHealthHist1h(Mo):
    """
    A class that represents historical statistics for overall tenant health in a 1 hour sampling interval.  This class updates every 15 minutes.

    """

    meta = StatsClassMeta("cobra.model.fv.OverallHealthHist1h", "overall tenant health")
    ...
    meta.moClassName = "fvOverallHealthHist1h"
    meta.rnFormat = "HDfvOverallHealth1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical overall tenant health stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 6546, PropCategory.REGULAR)
