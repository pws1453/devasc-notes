...
# ##################################################
class RsCtxToBgpCtxAfPol(Mo):
    """
    A source relation to the BGP address family context policy.

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsCtxToBgpCtxAfPol", "cobra.model.bgp.CtxAfPol")
    meta.targetNameProps["name"] = "tnBgpCtxAfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsCtxToBgpCtxAfPol"
    meta.rnFormat = "rsctxToBgpCtxAfPol-[%(tnBgpCtxAfPolName)s]-%(af)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "BGP  Address Family Context Policy"
    ...
    meta.rnPrefixes = [
        ('rsctxToBgpCtxAfPol-', True),
        ('-', True),
    ]

    prop = PropMeta("str", "af", "af", 17591, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 38154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40293, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17604, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 17593, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 5891
    prop.defaultValueStr = "bgpCtxAfPol"
    ...
    prop = PropMeta("str", "tnBgpCtxAfPolName", "tnBgpCtxAfPolName", 17592, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBgpCtxAfPolName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnBgpCtxAfPolName"))
    getattr(meta.props, "tnBgpCtxAfPolName").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, tnBgpCtxAfPolName, af, markDirty=True, **creationProps):
        namingVals = [tnBgpCtxAfPolName, af]
