...
# ##################################################
class RsRegisterUpdates(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsRegisterUpdates", "cobra.model.fv.AREpPUpd")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsRegisterUpdates"
    meta.rnFormat = "rsregisterUpdates"
    ...
    prop = PropMeta("str", "tCl", "tCl", 19923, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 6656
    prop.defaultValueStr = "fvAREpPUpd"
    prop._addConstant("fvAREpPUpd", None, 6656)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 19922, PropCategory.REGULAR)
