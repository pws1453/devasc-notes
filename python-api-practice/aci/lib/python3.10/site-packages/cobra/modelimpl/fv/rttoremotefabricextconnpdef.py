...
# ##################################################
class RtToRemoteFabricExtConnPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteFabricExtConnPDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteFabricExtConnPDef"
    meta.rnFormat = "rttoRemoteFabricExtConnPDef"
    ...
    meta.rnPrefixes = [
        ('rttoRemoteFabricExtConnPDef', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 21441, PropCategory.REGULAR)
