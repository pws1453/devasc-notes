...
class RtdEpP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.RtdEpP")

    meta.moClassName = "fvRtdEpP"
    meta.rnFormat = "rtd-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Routed External EpP"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x600061002102c783
    ...
    meta.childClasses.add("cobra.model.bgp.CtxDef")
    meta.childClasses.add("cobra.model.l2.IngrBytesPartHist1mo")
    meta.childClasses.add("cobra.model.bgp.RtTargetInstrPDef")
    ...
    meta.childClasses.add("cobra.model.fv.RsEppBgpCtxAfPol")
    meta.childClasses.add("cobra.model.l3ext.LNodePDef")
    ...
    meta.childClasses.add("cobra.model.fv.RsEppExtRouteTagPol")
    ...
    meta.childClasses.add("cobra.model.ospf.ExtDef")
    ...
    meta.childClasses.add("cobra.model.pim.ExtDef")
    ...
    meta.childClasses.add("cobra.model.rtctrl.DampPolDef")
    meta.childClasses.add("cobra.model.fv.PullREpPCont")
    meta.childClasses.add("cobra.model.fv.NwIssues")
    meta.childClasses.add("cobra.model.ospf.CtxDefAf")
    ...
    meta.childClasses.add("cobra.model.fv.RtInfraOutRtdEpP")
    meta.childClasses.add("cobra.model.l3ext.RouteTagDef")
    ...
    meta.childClasses.add("cobra.model.l3ext.ConsLblDef")
    meta.childClasses.add("cobra.model.dbgac.TenantSpaceCmnDef")
    ...
    meta.childClasses.add("cobra.model.fv.RsEppOspfCtxPol")
    meta.childClasses.add("cobra.model.l2.IngrBytesAgHist1qtr")
    meta.childClasses.add("cobra.model.eigrp.CtxAfDef")
    meta.childClasses.add("cobra.model.fv.StDepl")
    meta.childClasses.add("cobra.model.l2.IngrPktsAgHist1mo")
    meta.childClasses.add("cobra.model.l3ext.DefaultRouteLeakDef")
    ...
    meta.childClasses.add("cobra.model.fv.RsEppEigrpIfPol")
    ...
    meta.childClasses.add("cobra.model.l3ext.RtdOutDefRef")
    meta.childClasses.add("cobra.model.rtctrl.SubjDef")
    ...
    meta.childClasses.add("cobra.model.bgp.ExtDef")
    ...
    meta.childClasses.add("cobra.model.rtctrl.InterleakPolDef")
    meta.childClasses.add("cobra.model.eigrp.ExtDef")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.l3ext.ExtEncapDef")
    meta.childClasses.add("cobra.model.l2.EgrPktsAgHist1mo")
    meta.childClasses.add("cobra.model.fv.RsEppOspfAfCtxPol")
    meta.childClasses.add("cobra.model.l2.IngrPktsAg1year")
    meta.childClasses.add("cobra.model.fv.ExtNwDepl")
    meta.childClasses.add("cobra.model.l3ext.DomDef")
    ...
    meta.childClasses.add("cobra.model.fv.RsEppOspfIfPol")
    meta.childClasses.add("cobra.model.l2.EgrBytesAg1year")
    meta.childClasses.add("cobra.model.ospf.CtxDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppExtRouteTagPol", "rseppExtRouteTagPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppEigrpCtxAfPol", "rseppEigrpCtxAfPol-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppOspfAfCtxPol", "rseppOspfAfCtxPol-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppBgpCtxAfPol", "rseppBgpCtxAfPol-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtInfraOutRtdEpP", "rtinfraOutRtdEpP"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppOspfCtxPol", "rseppOspfCtxPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.EgrPktsAg1w", "CDl2EgrPktsAg1w"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppEigrpIfPol", "rseppEigrpIfPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtProvToEpp", "rtaaaProvToEpp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtTargetInstrPDef", "rttargetinstrp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppBgpCtxPol", "rseppBgpCtxPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtMacEppAtt", "rtl2MacEppAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppOspfIfPol", "rseppOspfIfPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtdOutDefRef", "rtdOutDefRef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEppToEpCP", "rseppToEpCP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.rtctrl.DampPolDef", "damppolDef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.CtxAfDef", "eigrpCtxP-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.ExtDef", "pimextdef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.CtxDefAf", "ospfCtxP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.DefaultRouteLeakDef", "defrtleak"))
    meta.childNamesAndRnPrefix.append(("cobra.model.rtctrl.InterleakPolDef", "interleak"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.ExtDef", "eigrpExtP"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.ExtDef", "ospfExtP"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ProvLblDef", "provlbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ConsLblDef", "conslbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.CtxDef", "ospfCtxP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.AttrDefCont", "attrcont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.CtxDef", "bgpCtxP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.LNodePDef", "lnodep-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.ExtDef", "bgpExtP"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ExtEncapDef", "encap-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.DomDef", "l3dom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RouteTagDef", "rttag"))
    meta.childNamesAndRnPrefix.append(("cobra.model.rtctrl.SubjDef", "subj-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.Locale", "node-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.LEpP", "lEpP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgac.TenantSpaceCmnDef", "ac-"))
    ...
    meta.superClasses.add("cobra.model.fv.ExtEpP")
    ...
    prop = PropMeta("str", "enforceRtctrl", "enforceRtctrl", 18036, PropCategory.REGULAR)
    prop.label = "Enforce Route Control for Following Directions"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "export"
    prop._addConstant("export", "export-control", 2)
    prop._addConstant("import", "import-control", 1)
    meta.props.add("enforceRtctrl", prop)
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 6555, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mcast", "mcast", 24917, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14267, PropCategory.REGULAR)
