...
class RtSrvCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtSrvCtx", "cobra.model.analytics.ACfgSrv")

    meta.moClassName = "fvRtSrvCtx"
    meta.rnFormat = "rtanalyticsSrvCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 24110, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 24109, PropCategory.REGULAR)
