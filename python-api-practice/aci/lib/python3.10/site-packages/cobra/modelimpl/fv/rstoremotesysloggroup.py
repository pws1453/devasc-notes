...
# ##################################################
class RsToRemoteSyslogGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteSyslogGroup", "cobra.model.syslog.Group")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteSyslogGroup"
    meta.rnFormat = "rstoRemoteSyslogGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 21980, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 21979, PropCategory.REGULAR)
