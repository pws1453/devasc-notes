...
# ##################################################
class RsTrustCtrl(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsTrustCtrl", "cobra.model.fhs.TrustCtrlPol")
    meta.targetNameProps["name"] = "tnFhsTrustCtrlPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsTrustCtrl"
    meta.rnFormat = "rstrustCtrl"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "FHS trust control Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38561, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40700, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27628, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27591, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9281
    prop.defaultValueStr = "fhsTrustCtrlPol"
    ...
    prop = PropMeta("str", "tnFhsTrustCtrlPolName", "tnFhsTrustCtrlPolName", 27590, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnFhsTrustCtrlPolName", prop)
